...
- 2026-05-30: Widget icons unified on Phosphor ([[Bug_Icon_Sprite_Inner_Dimension_Strip]]) — all chrome glyphs (wizard/lightbox/photo-strip) via shared `icons/ui-icons.js` + `iconUseNode()`; compact chevron the only off-family glyph.
