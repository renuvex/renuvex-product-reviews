...
- When the active lightbox media is a video, the bottom thumbnail rail is hidden only while playback is active and returns on pause/end. This keeps Mux Player controls readable without removing review-to-review navigation before playback starts.
...
## Change Log
- 2026-06-28: Hid the bottom thumbnail rail while an active lightbox video is playing and isolated mobile rail touch gestures from previous/next lightbox swipes.
