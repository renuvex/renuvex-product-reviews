...
- Video control gestures are isolated from lightbox swipe navigation. Horizontal swipes still move between media-backed reviews when they start in the main media area, but touches that start in the lower video control band belong to Mux Player controls such as the timeline scrubber and must not trigger previous/next review navigation.
