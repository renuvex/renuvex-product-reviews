...
- In the lightbox, the gallery rail is visible before playback and while paused, but it hides while the active video is playing so it does not compete with Mux Player controls. Touch gestures that start on the rail are reserved for horizontal rail interaction, not previous/next lightbox navigation.
...
## Change Log
- 2026-06-28: Media-gallery lightbox rail now hides while the active video is playing and reserves mobile rail touch gestures so horizontal rail interaction does not change reviews.
