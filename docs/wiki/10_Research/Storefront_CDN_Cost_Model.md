...
| Current Cloudflare V2 Worker read API requests per mount-present pageview | `4` | `settings:1`, `ratings:1`, `reviews:2` after the settings read/sync split |
...
- Current Cloudflare V2 scope is static asset delivery plus selected public read
  API Worker cache. Write, upload, Mux, QStash, Cloudinary, lazy sync, admin, OAuth, and DB
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 100 | 10,000,000 | 200,000,000 | 835 | $228.00 | $0.00 | $228.00 | 40,000,000 | $14.00 |
| 200 | 20,000,000 | 400,000,000 | 1,670 | $468.00 | $54.94 | $522.94 | 80,000,000 | $26.00 |
| 300 | 30,000,000 | 600,000,000 | 2,505 | $708.00 | $125.93 | $833.93 | 120,000,000 | $38.00 |
| 400 | 40,000,000 | 800,000,000 | 3,341 | $948.00 | $196.92 | $1,144.92 | 160,000,000 | $50.00 |
| 500 | 50,000,000 | 1,000,000,000 | 4,176 | $1,188.00 | $267.90 | $1,455.90 | 200,000,000 | $62.00 |
| 1,000 | 100,000,000 | 2,000,000,000 | 8,352 | $2,388.00 | $622.85 | $3,010.85 | 400,000,000 | $122.00 |
| 2,000 | 200,000,000 | 4,000,000,000 | 16,703 | $4,788.00 | $1,305.54 | $6,093.54 | 800,000,000 | $242.00 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 100 | 10,000,000 | $14.00 | $8.35 | $33.41 | $228.00 | $380.00 | $216.81 | $990.00 | $282.22 | $284.32 |
| 200 | 20,000,000 | $26.00 | $16.70 | $66.81 | $522.94 | $876.95 | $433.63 | $990.00 | >= $382.44 | >= $398.64 |
| 300 | 30,000,000 | $38.00 | $25.05 | $100.22 | $833.93 | $1,402.22 | $650.44 | $990.00 | >= $482.66 | >= $467.96 |
| 400 | 40,000,000 | $50.00 | $33.41 | $133.63 | $1,144.92 | $1,927.50 | $867.25 | $990.00 | >= $582.88 | >= $537.27 |
| 500 | 50,000,000 | $62.00 | $41.76 | $167.03 | $1,455.90 | $2,452.77 | $1,084.07 | $990.00 | >= $683.10 | >= $606.59 |
| 1,000 | 100,000,000 | $122.00 | $83.52 | $334.07 | $3,010.85 | $5,079.15 | $2,168.13 | $990.00 | >= $1,184.20 | >= $953.19 |
| 2,000 | 200,000,000 | $242.00 | $167.03 | $603.50 | $6,093.54 | $10,331.89 | $4,174.68 | $990.00 | >= $1,927.86 | >= $1,536.50 |
...
AWS CloudFront/S3 remains useful as a documented performance canary, not as an
active migration track. The measured local Turkey path showed AWS slightly
faster than the live Cloudflare Worker route for the same static widget assets,
but the performance gain is too small to override the cost and operational
complexity difference for the current MVP.
...
delivery. Treat AWS CloudFront/S3 as an archived, reproducible canary option
only; do not keep AWS cutover as an active open issue.

If an AWS production cutover is reopened later, require:
