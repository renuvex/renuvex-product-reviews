...
export var CLASSIC_CSS = `
  ...
  .ikr-summary-bars{gap:10px;display:flex;flex-direction:column;align-items:flex-start;width:100%;}
  .ikr-bar-row{
    display:inline-flex;align-items:center;justify-content:flex-start;gap:var(--ikr-col-gap);
  ...
  .ikr-bar-track{flex:0 0 auto;width:var(--ikr-bar-track-width,240px);max-width:calc(100% - var(--ikr-col-label) - var(--ikr-col-count) - (var(--ikr-col-gap) * 2));background:var(--ikr-bar-track,var(--ikr-track-bg,rgba(0,0,0,0.10)));border-radius:var(--ikr-radius-sm,4px);height:10px;overflow:hidden;}
