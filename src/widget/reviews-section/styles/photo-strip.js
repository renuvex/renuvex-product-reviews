// reviews-section/styles/photo-strip.js
// Shared photo strip/gallery CSS. Review-card/list/gallery item photos stay in
// review-layouts/*/styles.js; lightbox-only media rules stay in lightbox.js.

export var PHOTO_STRIP_CSS = `
