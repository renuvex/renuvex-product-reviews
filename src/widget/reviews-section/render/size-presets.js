...
export var SIZE_PRESETS = {
  small: {
    ...
    loadMoreMinHeight: 36, loadMorePadY: 8, loadMorePadX: 22,
    paginationButtonSize: 36, paginationPadX: 8, paginationGap: 4,
  ...
  medium: {
    ...
    loadMoreMinHeight: 40, loadMorePadY: 10, loadMorePadX: 28,
    paginationButtonSize: 40, paginationPadX: 10, paginationGap: 6,
    paginationMarginTop: 20, paginationGapMin: 24,
  ...
  large: {
    ...
    loadMoreMinHeight: 44, loadMorePadY: 12, loadMorePadX: 34,
    paginationButtonSize: 44, paginationPadX: 12, paginationGap: 8,
    paginationMarginTop: 22, paginationGapMin: 28,
