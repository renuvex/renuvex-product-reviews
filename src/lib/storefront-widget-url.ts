...
export function buildStorefrontWidgetScript(publicApiKey: string) {
  ...
  return `<script src="${buildStorefrontWidgetUrl(publicApiKey)}" async data-renuvex-app="${STOREFRONT_WIDGET_APP_MARKER}" data-renuvex-store-id="${escapedPublicApiKey}"></script>`;
}
