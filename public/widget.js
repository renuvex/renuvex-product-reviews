...
`;var gr={};me(gr,{meta:()=>ct,render:()=>pt});function Ee(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var s=r[l-1]||0,c=i>0?Math.round(s/i*100):0,f=a===l,m=document.createElement("div");m.className="ikr-bar-row"+(f?" ikr-bar-active":""),a&&!f&&(m.style.opacity="0.35");for(var d="",k=1;k<=5;k++){var v=k<=l;d+='<span class="ikr-bar-star ikr-icon '+(v?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(v?t.filled:t.empty)+"</span>"}m.innerHTML='<span class="ikr-bar-label">'+d+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(u){m.onclick=function(){n(u)}})(l),o.appendChild(m)}return o}var ee=[],ii=!1;function Qi(e){for(var r=ee.length-1;r>=0;r--){var i=ee[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function et(e){if(e.key==="Escape")for(var r=ee.length-1;r>=0;r--)ee[r].close()}function rt(){ii||typeof document=="undefined"||(document.addEventListener("click",Qi,!0),document.addEventListener("keydown",et),ii=!0)}function Je(e){for(var r=0;r<ee.length;r++)ee[r]!==e&&ee[r].close()}function $e(e){rt();var r={trigger:e.trigger,element:e.element,close:e.close};return ee.push(r),function(){var t=ee.indexOf(r);t!==-1&&ee.splice(t,1)}}function re(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,o.appendChild(l);var s=document.createElement("div");s.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele");var f=A&&A.filterIcon||"lines";c.innerHTML=Vr(f);var m=document.createElement("div");m.className="ikr-filter-menu";var d=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function k(){m.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function v(){Je(u),m.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}d.forEach(function(p){var h=p[2],g=h?t:!t&&(i||"newest")===p[0],y=document.createElement("div");y.className="ikr-filter-item"+(g?" ikr-filter-item-active":""),y.textContent=p[1],y.onclick=function(){k(),n(p[0],h)},m.appendChild(y)}),c.onclick=function(){m.classList.contains("ikr-open")?k():v()};var u=$e({trigger:s,element:m,close:k});return s.appendChild(c),s.appendChild(m),o.appendChild(s),o}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var n=document.createElement("button");n.className="ikr-fwizard-close",n.type="button",n.setAttribute("aria-label","Kapat"),n.innerHTML="\u2715",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-content",a.appendChild(o);var l=!1,s="",c="";function f(){var p=window.innerWidth-document.documentElement.clientWidth;s=document.body.style.overflow,c=document.body.style.paddingRight,document.body.style.overflow="hidden",p>0&&(document.body.style.paddingRight=p+"px")}function m(){document.body.style.overflow=s,document.body.style.paddingRight=c}function d(){l||(l=!0,document.removeEventListener("keydown",k),t.removeEventListener("click",v),n.removeEventListener("click",d),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),m();try{r()}catch(p){}},200))}function k(p){p.key==="Escape"&&d()}function v(p){p.target===t&&i&&d()}document.addEventListener("keydown",k),t.addEventListener("click",v),n.addEventListener("click",d);function u(p){p&&o.appendChild(p),document.body.appendChild(t),f(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open")})}return{open:u,close:d,content:o,setAllowOutsideClose:function(p){i=!!p},setStepAttr:function(p){a.setAttribute("data-step",String(p))}}}var ai=`
...
`;var vr=4;function ni(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],productId:e.productId||"",productName:e.productName||""};function t(){r.forEach(function(a){try{a(i)}catch(n){}})}return{get:function(){return i},set:function(a){Object.assign(i,a),t()},goNext:function(){i.currentStep<vr&&(i.currentStep+=1,t())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,t())},onChange:function(a){return r.push(a),function(){r=r.filter(function(n){return n!==a})}}}}var it='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function oi(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],t=e.onBack||function(){},a=e.onSkip||function(){},n=e.onNext||function(){},o=document.createElement("div");o.className="ikr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=it+"<span>Geri</span>",l.addEventListener("click",function(){t()}),o.appendChild(l);var s=document.createElement("div");s.className="ikr-fwizard-footer-progress";for(var c=[],f=0;f<vr;f++){var m=document.createElement("span");m.className="ikr-fwizard-progress-seg",s.appendChild(m),c.push(m)}o.appendChild(s);var d=document.createElement("button");d.type="button";var k=null;function v(p){k&&d.removeEventListener("click",k),k=p,p&&d.addEventListener("click",p)}o.appendChild(d);function u(p){var h=r.indexOf(p)!==-1,g=i.indexOf(p)!==-1;h?(d.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",d.setAttribute("aria-label","Atla"),d.innerHTML="<span>Atla</span>",d.disabled=!1,d.classList.remove("ikr-fwizard-cta-btn--disabled"),d.style.visibility="",d.tabIndex=0,v(function(){a()})):g?(d.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",d.setAttribute("aria-label","Sonraki"),d.innerHTML="Sonraki",d.style.visibility="",d.tabIndex=0,v(function(){d.disabled||n()})):(d.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",d.innerHTML="",d.style.visibility="hidden",d.tabIndex=-1,d.disabled=!0,v(null))}return{el:o,update:function(p){c.forEach(function(g,y){y+1<=p?g.classList.add("ikr-fwizard-progress-seg-active"):g.classList.remove("ikr-fwizard-progress-seg-active")});var h=p<=1;l.style.visibility=h?"hidden":"",l.style.pointerEvents=h?"none":"",l.tabIndex=h?-1:0,u(p)},setNextDisabled:function(p){d.classList.contains("ikr-fwizard-cta-btn")&&(d.disabled=!!p,d.classList.toggle("ikr-fwizard-cta-btn--disabled",!!p))}}}function li(e){var r=document.createElement("div");r.className="ikr-fwizard-step ikr-fwizard-step-rating";var i=document.createElement("div");i.className="ikr-fwizard-step-title",i.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",r.appendChild(i);var t=document.createElement("div");t.className="ikr-fwizard-stars",t.setAttribute("role","radiogroup"),t.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var a=we(A||{}),n=[];function o(s){n.forEach(function(c,f){var m=f<s;c.classList.toggle("ikr-fwizard-star-active",m),c.innerHTML=m?a.filled:a.empty})}for(var l=1;l<=5;l++)(function(s){var c=document.createElement("button");c.type="button",c.className="ikr-fwizard-star",c.setAttribute("role","radio"),c.setAttribute("aria-label",s+" y\u0131ld\u0131z"),c.innerHTML=a.empty,c.addEventListener("mouseenter",function(){o(s)}),c.addEventListener("mouseleave",function(){o(e.get().rating)}),c.addEventListener("click",function(){e.set({rating:s}),o(s),setTimeout(function(){e.goNext()},280)}),n.push(c),t.appendChild(c)})(l);return o(e.get().rating),r.appendChild(t),{el:r,destroy:function(){}}}var di=3,tt=5*1024*1024;function si(e){var r=document.createElement("div");r.className="ikr-fwizard-step ikr-fwizard-step-photos";var i=document.createElement("div");i.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",i.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",r.appendChild(i);var t=document.createElement("div");t.className="ikr-fwizard-step-subtitle",t.textContent="Foto\u011Fraf ekleyebilirsiniz.",r.appendChild(t);var a=document.createElement("div");a.className="ikr-fwizard-photo-card";var n=document.createElement("label");n.className="ikr-fwizard-photo-add",n.setAttribute("aria-label","Foto\u011Fraf ekle"),n.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var o=document.createElement("input");o.type="file",o.accept="image/*",o.multiple=!0,o.style.display="none",n.appendChild(o),a.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-photo-previews",l.setAttribute("aria-live","polite"),a.appendChild(l),r.appendChild(a);var s=!1;function c(){var v=e.get().images||[];v.forEach(function(u){m(u)}),f()}function f(){var v=(e.get().images||[]).length;v>=di?(o.disabled=!0,n.classList.add("ikr-fwizard-photo-add--disabled")):(o.disabled=!1,n.classList.remove("ikr-fwizard-photo-add--disabled"))}function m(v){var u=document.createElement("div");u.className="ikr-fwizard-photo-thumb",u.innerHTML='<img src="'+v+'" alt="">';var p=document.createElement("button");p.type="button",p.className="ikr-fwizard-photo-remove",p.setAttribute("aria-label","Foto\u011Fraf\u0131 kald\u0131r"),p.innerHTML="&#x2715;",p.onclick=function(){var h=(e.get().images||[]).filter(function(g){return g!==v});e.set({images:h}),u.remove(),f()},u.appendChild(p),l.appendChild(u)}function d(v){var u=document.createElement("div");return u.className="ikr-fwizard-photo-thumb",u.innerHTML='<img src="'+v+'" alt=""><div class="ikr-fwizard-photo-loading"><div class="ikr-spinner"></div></div>',l.appendChild(u),u}o.onchange=async function(v){if(!s){s=!0,o.disabled=!0;for(var u=e.get().images||[],p=u.length,h=di-u.length,g=Array.from(v.target.files).slice(0,h),y=0;y<g.length;y++){var x=g[y];if(x.size>tt){alert(x.name+" dosyas\u0131 5MB s\u0131n\u0131r\u0131n\u0131 a\u015F\u0131yor. L\xFCtfen daha k\xFC\xE7\xFCk bir g\xF6rsel se\xE7in.");continue}var L=URL.createObjectURL(x),S=d(L),b=S.querySelector(".ikr-fwizard-photo-loading");if(typeof window!="undefined"&&window.__ikasPreviewMode){var w=(e.get().images||[]).slice();w.push(L),e.set({images:w}),k(S,b,L);continue}try{var T=await D(F+"/api/public/upload/sign",{method:"POST"});if(!T.ok)throw T.status===429?new Error("rate_limit"):new Error("sign failed");var E=await T.json(),z=new FormData;z.append("file",x),z.append("api_key",E.api_key),z.append("timestamp",E.timestamp),z.append("signature",E.signature),z.append("folder","review_images");var _=await fetch("https://api.cloudinary.com/v1_1/"+E.cloud_name+"/image/upload",{method:"POST",body:z}),H=await _.json();if(H.secure_url){var I=H.secure_url,V=(e.get().images||[]).slice();V.push(I),e.set({images:V}),k(S,b,I)}}catch(ae){console.error("[ikr] Image upload failed:",ae);var ie=ae.message==="rate_limit"?"\xC7ok fazla deneme. L\xFCtfen bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";b.innerHTML='<span class="ikr-upload-error">\u2717 '+ie+"</span>"}}s=!1,o.value="",f();var te=e.get().images||[];p===0&&te.length>0&&setTimeout(function(){e.goNext()},1e3)}};function k(v,u,p){u.innerHTML='<span class="ikr-upload-check">\u2713</span>',setTimeout(function(){u.style.opacity="0",u.style.transition="opacity 0.4s",setTimeout(function(){u.style.display="none";var h=document.createElement("button");h.type="button",h.className="ikr-fwizard-photo-remove",h.setAttribute("aria-label","Foto\u011Fraf\u0131 kald\u0131r"),h.innerHTML="&#x2715;",h.onclick=function(){var g=(e.get().images||[]).filter(function(y){return y!==p});e.set({images:g}),v.remove(),f()},v.appendChild(h)},400)},600),f()}return c(),{el:r,destroy:function(){o.onchange=null}}}var kr=2e3,at=60;function ci(e,r){r=r||{};var i=r.onValidityChange||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-content";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",t.appendChild(a);var n=document.createElement("div");n.className="ikr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="ikr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=at,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),n.appendChild(o);var l=document.createElement("textarea");l.className="ikr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=kr,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",n.appendChild(l);var s=document.createElement("div");s.className="ikr-fwizard-char-counter",s.setAttribute("aria-live","polite"),n.appendChild(s);function c(){var m=l.value.length;s.textContent=m+"/"+kr,s.classList.toggle("ikr-fwizard-char-counter--max",m>=kr)}function f(){return l.value.trim().length>0}return l.addEventListener("input",function(){e.set({comment:l.value}),c(),i(f())}),t.appendChild(n),c(),setTimeout(function(){i(f())},0),{el:t,destroy:function(){}}}var nt=40;function pi(e,r){r=r||{};var i=r.onValidityChange||function(){},t=r.onSuccess||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-author";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Hakk\u0131n\u0131zda",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-author-form";var l=document.createElement("div");l.className="ikr-fwizard-field";var s=document.createElement("label");s.className="ikr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var c=document.createElement("input");c.type="text",c.className="ikr-fwizard-input",c.maxLength=nt,c.setAttribute("aria-required","true"),c.value=e.get().author||"",l.appendChild(s),l.appendChild(c),o.appendChild(l);var f=document.createElement("div");f.className="ikr-fwizard-field";var m=document.createElement("label");m.className="ikr-fwizard-label",m.textContent="E-posta (opsiyonel)";var d=document.createElement("input");d.type="email",d.className="ikr-fwizard-input",d.setAttribute("autocomplete","email"),d.value=e.get().email||"",f.appendChild(m),f.appendChild(d),o.appendChild(f);var k=document.createElement("div");k.className="ikr-fwizard-notice",k.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(k);var v=document.createElement("div");v.className="ikr-fwizard-msg",v.setAttribute("role","alert"),v.setAttribute("aria-live","assertive"),o.appendChild(v);var u=document.createElement("button");u.type="button",u.className="ikr-fwizard-submit-btn",u.textContent="G\xF6nder",o.appendChild(u),a.appendChild(o);function p(){return c.value.trim().length>0}function h(){var g=!p();u.disabled=g,u.classList.toggle("ikr-fwizard-submit-btn--disabled",g)}return c.addEventListener("input",function(){e.set({author:c.value}),h(),i(p())}),d.addEventListener("input",function(){e.set({email:d.value})}),h(),setTimeout(function(){i(p())},0),u.onclick=async function(){if(!u.disabled){var g=e.get(),y=(g.author||"").trim(),x=(g.comment||"").trim();if(!y){v.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen ad\u0131n\u0131z\u0131 girin.</div>';return}if(!g.rating){v.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}u.disabled=!0,u.classList.add("ikr-fwizard-submit-btn--disabled");var L=u.textContent;if(u.textContent="G\xF6nderiliyor\u2026",v.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){t()},600);return}try{var S=O(window.location.href),b=g.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),w=await D(F+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:P,productId:g.productId||null,slug:S||null,productName:b,author:y,title:(g.title||"").trim()||null,comment:x||null,rating:g.rating,images:g.images||[]})},15e3);if(w.ok)t();else{var T=await w.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(_){var E=_&&(_.name==="AbortError"||/signal/i.test(_.message||"")),z=E?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":_.message||"Yorum g\xF6nderilemedi.";v.innerHTML='<div class="ikr-fwizard-msg-error">'+z+"</div>",u.disabled=!1,u.classList.remove("ikr-fwizard-submit-btn--disabled"),u.textContent=L}}},{el:a,destroy:function(){u.onclick=null}}}var mi=!1;function ot(){if(!mi){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=ai,document.head.appendChild(e),mi=!0}}function lt(e,r,i){if(i=i||{},e===1)return li(r);if(e===2)return si(r);if(e===3)return ci(r,{onValidityChange:i.onValidityChange});if(e===4)return pi(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess});var t=document.createElement("div");return t.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:t,destroy:function(){}}}function dt(){var e=document.createElement("div");return e.className="ikr-fwizard-thanks",e.innerHTML='<div class="ikr-fwizard-thanks-icon" aria-hidden="true"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div><div class="ikr-fwizard-thanks-title">Yorumunuz i\xE7in te\u015Fekk\xFCrler!</div><div class="ikr-fwizard-thanks-text">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function ui(e){e=e||{},ot();var r=ni({productId:e.productId,productName:e.productName}),i=ti({onClose:e.onClose,allowOutsideClose:!0}),t=document.createElement("div");t.className="ikr-fwizard-step-wrap";var a=oi({skippableSteps:[2],nextableSteps:[3],onBack:function(){r.goBack()},onSkip:function(){r.goNext()},onNext:function(){r.goNext()}}),n=document.createElement("div");n.className="ikr-fwizard-layout",n.appendChild(t),n.appendChild(a.el);var o=null,l="idle",s=null,c=!0;function f(v,u){var p=lt(v,r,{onValidityChange:function(g){a.setNextDisabled(!g)},onSuccess:m});if(o=p,u){l="entering",p.el.classList.add("ikr-fwizard-step--enter");var h=function(){p.el.removeEventListener("animationend",h),p.el.classList.remove("ikr-fwizard-step--enter"),l="idle",s!==null&&s!==r.get().currentStep?(s=null,d()):s=null};p.el.addEventListener("animationend",h)}else l="idle";t.appendChild(p.el),a.update(v),i.setStepAttr&&i.setStepAttr(v),v===3&&a.setNextDisabled(!0)}function m(){o&&o.destroy&&o.destroy(),o=null,l="idle",s=null,t.innerHTML="",t.appendChild(dt()),a.el.style.display="none"}function d(){var v=r.get().currentStep;if(l!=="idle"){s=v;return}if(!o){var u=!c;c=!1,f(v,u);return}var p=o;l="exiting",p.el.classList.add("ikr-fwizard-step--exit");var h=function(){if(p.el.removeEventListener("animationend",h),p.destroy)try{p.destroy()}catch(y){}if(o===p){t.innerHTML="",o=null;var g=s!==null?s:r.get().currentStep;s=null,f(g,!0)}};p.el.addEventListener("animationend",h)}d();var k=r.get().currentStep;return r.onChange(function(v){v.currentStep!==k&&(k=v.currentStep,d())}),i.open(n),{close:i.close}}function st(){var e=document.getElementById("ikr-form-accordion");if(e){var r=e.style.maxHeight&&e.style.maxHeight!=="0px";r?(e.style.maxHeight="0px",e.style.opacity="0"):(e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",setTimeout(function(){e.style.maxHeight="none"},360),setTimeout(function(){var i=document.querySelector("header"),t=i?i.getBoundingClientRect().height:0,a=e.getBoundingClientRect().top+window.pageYOffset-t-16;window.scrollTo({top:a,behavior:"smooth"})},50))}}function G(){var e=A&&A.reviewFormStyle||"accordion";if(e==="modal"){ui({productId:Z||"",productName:ue||""});return}st()}var ct={id:"classic",name:"Klasik (A\xE7\u0131k)"};function pt(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,s=e.currentRatingFilter,c=e.currentOrderBy,f=e.currentHasImages,m=e.onFilterChange,d=e.onSortChange,k=document.createElement("div");k.className="ikr-summary";var v=(o[3]||0)+(o[4]||0),u=n>0?Math.round(v/n*100):0,p=document.createElement("div");p.className="ikr-summary-block ikr-summary-avg",p.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+l+"</span>",k.appendChild(p);var h=document.createElement("div");if(h.className="ikr-summary-block ikr-summary-count",h.textContent=n.toLocaleString("tr-TR")+" Yorum",k.appendChild(h),t.showRecommendation!==!1&&u>0){var g=document.createElement("div");g.className="ikr-summary-block ikr-summary-recommend",g.innerHTML='<span class="ikr-recommend-pct">%'+u+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(g)}return k.appendChild(Ee({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:s,onFilterChange:m})),k.appendChild(re({widget:r,currentOrderBy:c,currentHasImages:f,onWriteClick:G,onSortChange:d})),k}var hr={};me(hr,{css:()=>ut,meta:()=>mt,render:()=>ft});var fi=`
...
`;var mt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ut=fi;function ft(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,f=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var v=document.createElement("div");v.className="ikr-compact-trigger-wrap";var u=document.createElement("button");u.className="ikr-compact-trigger",u.type="button",u.setAttribute("aria-expanded","false"),u.innerHTML='<span class="ikr-compact-trigger-stars">'+$(o,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',v.appendChild(u),k.appendChild(v);var p=re({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:G,onSortChange:m}),h=p.querySelector(".ikr-filter-wrap"),g=p.querySelector(".ikr-write-btn"),y=document.createElement("div");y.className="ikr-compact-actions-slot",g&&y.appendChild(g),h&&y.appendChild(h),k.appendChild(y),d.appendChild(k);var x=document.createElement("div");x.className="ikr-compact-panel",x.setAttribute("role","dialog"),x.setAttribute("aria-hidden","true");var L=document.createElement("div");L.className="ikr-compact-panel-inner";var S=document.createElement("div");S.className="ikr-compact-avg",S.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+o+"</span>",L.appendChild(S),L.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:f})),x.appendChild(L);var b=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(K){var W=K?d:v;x.parentNode!==W&&(x.classList.contains("ikr-open")&&(x.classList.remove("ikr-open"),x.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")),W.appendChild(x))}if(w(b?b.matches:!1),b){var T=function(K){w(K.matches)};b.addEventListener?b.addEventListener("change",T):b.addListener&&b.addListener(T)}if(g){var E=document.createElement("button");E.className="ikr-write-btn",E.textContent="Yorum Yap",E.onclick=G;var z=document.createElement("div");z.className="ikr-compact-write-row",z.appendChild(E),d.appendChild(z)}function _(){x.classList.remove("ikr-open"),x.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")}function H(){Je(I),x.classList.add("ikr-open"),x.setAttribute("aria-hidden","false"),u.setAttribute("aria-expanded","true")}u.onclick=function(){x.classList.contains("ikr-open")?_():H()};var I=null;function V(K){I&&(I(),I=null),K||(I=$e({trigger:v,element:x,close:_}))}if(V(b?b.matches:!1),b){var ie=function(K){V(K.matches)};b.addEventListener?b.addEventListener("change",ie):b.addListener&&b.addListener(ie)}if(i.showRecommendation!==!1){var te=(n[3]||0)+(n[4]||0),ae=a>0?Math.round(te/a*100):0;if(ae>0){var pe=document.createElement("div");pe.className="ikr-summary-block ikr-summary-recommend",pe.style.marginTop="8px",pe.innerHTML='<span class="ikr-recommend-pct">%'+ae+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",L.appendChild(pe)}}return d}var br={};me(br,{css:()=>kt,meta:()=>vt,render:()=>gt});var vi=`
...
`;var vt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},kt=vi;function gt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,f=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",v.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+o+"</span>",k.appendChild(v);var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-count ikr-split-left-count",u.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(u),d.appendChild(k);var p=document.createElement("div");p.className="ikr-split-col ikr-split-mid",p.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:f})),d.appendChild(p);var h=re({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:G,onSortChange:m}),g=h.querySelector(".ikr-filter-wrap"),y=h.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-split-col ikr-split-right",y&&x.appendChild(y),g&&x.appendChild(g),d.appendChild(x),i.showRecommendation!==!1){var L=(n[3]||0)+(n[4]||0),S=a>0?Math.round(L/a*100):0;if(S>0){var b=document.createElement("div");b.className="ikr-summary-block ikr-summary-recommend",b.innerHTML='<span class="ikr-recommend-pct">%'+S+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(b)}}return d}var xr={};me(xr,{css:()=>bt,meta:()=>ht,render:()=>xt});var ki=`
...
`;var Tt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"90px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"120px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},Lt=bi;function At(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length),t=document.createElement("div");t.className="ikr-review-list"+(i?"":" ikr-review-list--no-media");var a=document.createElement("div");a.className="ikr-review-list-author";var n=document.createElement("span");n.className="ikr-review-stars ikr-review-list-author-stars",n.innerHTML=le(e.rating,A),a.appendChild(n);var o=document.createElement("span");o.className="ikr-review-list-author-name",o.textContent=e.author||"",a.appendChild(o);var l=document.createElement("span");l.className="ikr-date ikr-review-list-author-date",l.textContent=de(e.createdAt),a.appendChild(l),t.appendChild(a);var s=document.createElement("div");if(s.className="ikr-review-list-content",e.title){var c=document.createElement("div");c.className="ikr-review-list-title",c.textContent=e.title,s.appendChild(c)}var f=(e.comment||"").trim();if(f){var m=document.createElement("div");m.className="ikr-review-list-body ikr-body-clamped",m.textContent=f,s.appendChild(m);var d=document.createElement("span");d.className="ikr-read-more",d.textContent="Devam\u0131n\u0131 oku",d.style.display="none",s.appendChild(d),requestAnimationFrame(function(){if(m.scrollHeight>m.clientHeight+2){d.style.display="inline";var u=!1;d.onclick=function(){u=!u,m.classList.toggle("ikr-body-clamped",!u),d.textContent=u?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var k=Te(e.merchantReply);if(k&&s.appendChild(k),t.appendChild(s),i){var v=document.createElement("div");v.className="ikr-review-list-media",e.images.forEach(function(u){if(!(!u||u.indexOf("https://")!==0&&u.indexOf("data:image/")!==0)){var p=document.createElement("img");p.src=U(u),p.setAttribute("data-ikr-img-url",u),(function(h){p.onclick=function(){Q(e,h,r)}})(u),v.appendChild(p)}}),t.appendChild(v)}return t}var Cr={};me(Cr,{css:()=>Bt,meta:()=>Nt,render:()=>_t});var xi=`
