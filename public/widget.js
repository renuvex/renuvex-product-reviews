...
`;var ur=4;function Ne(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Qr(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(t){try{t(i)}catch(n){}})}return{get:function(){return i},set:function(t){Object.assign(i,t),a()},goNext:function(){i.currentStep<ur&&(i.currentStep+=1,a())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,a())},onChange:function(t){return r.push(t),function(){r=r.filter(function(n){return n!==t})}}}}var Ji='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function ei(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],a=e.onBack||function(){},t=e.onSkip||function(){},n=e.onNext||function(){},s=document.createElement("div");s.className="ikr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=Ji+"<span>Geri</span>",o.addEventListener("click",function(){a()}),s.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-footer-progress";for(var p=[],m=0;m<ur;m++){var c=document.createElement("span");c.className="ikr-fwizard-progress-seg",d.appendChild(c),p.push(c)}s.appendChild(d);var l=document.createElement("button");l.type="button";var k=null;function u(f){k&&l.removeEventListener("click",k),k=f,f&&l.addEventListener("click",f)}s.appendChild(l);function v(f,w){var y=r.indexOf(f)!==-1,b=i.indexOf(f)!==-1,g=w&&w.images&&w.images.length>0;if(y)f===2&&g?(l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Devam Et"),l.innerHTML="Devam Et",u(function(){n()})):(l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",l.setAttribute("aria-label","Atla"),l.innerHTML="<span>Atla</span>",u(function(){t()})),l.disabled=!1,l.classList.remove("ikr-fwizard-cta-btn--disabled"),l.style.visibility="",l.tabIndex=0;else if(b){l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Sonraki"),l.innerHTML="Sonraki",l.style.visibility="",l.tabIndex=0;var z=Ne(f,w);l.disabled=!z,l.classList.toggle("ikr-fwizard-cta-btn--disabled",!z),u(function(){l.disabled||n()})}else l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",l.innerHTML="",l.style.visibility="hidden",l.tabIndex=-1,l.disabled=!0,u(null)}return{el:s,update:function(f,w){p.forEach(function(b,g){g+1<=f?b.classList.add("ikr-fwizard-progress-seg-active"):b.classList.remove("ikr-fwizard-progress-seg-active")});var y=f<=1;o.style.visibility=y?"hidden":"",o.style.pointerEvents=y?"none":"",o.tabIndex=y?-1:0,v(f,w)},setNextDisabled:function(f){l.classList.contains("ikr-fwizard-cta-btn")&&(l.disabled=!!f,l.classList.toggle("ikr-fwizard-cta-btn--disabled",!!f))},setThanksState:function(f){o.style.visibility="hidden",d.style.visibility="hidden",l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Devam Et"),l.innerHTML="Devam Et",l.style.visibility="",l.disabled=!1,l.classList.remove("ikr-fwizard-cta-btn--disabled"),u(f)}}}function ri(e,r){r=r||{};var i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-rating";var a=!1,t=document.createElement("div");t.className="ikr-fwizard-step-title",t.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",i.appendChild(t);var n=document.createElement("div");n.className="ikr-fwizard-stars",n.setAttribute("role","radiogroup"),n.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var s=Le(_||{}),o=[];function d(m){o.forEach(function(c,l){var k=l<m;c.classList.toggle("ikr-fwizard-star-active",k),c.innerHTML=k?s.filled:s.empty})}for(var p=1;p<=5;p++)(function(m){var c=document.createElement("button");c.type="button",c.className="ikr-fwizard-star",c.setAttribute("role","radio"),c.setAttribute("aria-label",m+" y\u0131ld\u0131z"),c.innerHTML=s.empty,c.addEventListener("mouseenter",function(){d(m)}),c.addEventListener("mouseleave",function(){d(e.get().rating)}),c.addEventListener("click",function(){a||(a=!0,e.set({rating:m}),d(m),setTimeout(function(){var l=!r.canNavigate||r.canNavigate();l&&e.goNext()},280))}),o.push(c),n.appendChild(c)})(p);return d(e.get().rating),i.appendChild(n),{el:i,destroy:function(){}}}var ii=3,$i=5*1024*1024;function ti(e,r){r=r||{};var i=!1,a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-photos";var t=document.createElement("div");t.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",t.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(t);var n=document.createElement("div");n.className="ikr-fwizard-step-subtitle",n.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(n);var s=document.createElement("div");s.className="ikr-fwizard-photo-card";var o=document.createElement("label");o.className="ikr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle"),o.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",o.appendChild(d),s.appendChild(o);var p=document.createElement("div");p.className="ikr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),s.appendChild(p),a.appendChild(s);var m=r.blobMap||{},c=r.urlToFinger||{};function l(){if(!i){var b=e.get().images||[],g=e.get().pendingImages||[],z=b.map(function(h){return{url:h,isPending:!1}}).concat(g.map(function(h){return{url:h.url,file:h.file,isPending:!0,error:h.error}}));p.innerHTML="",z.forEach(function(h){var x=m[h.url]||h.url,S=k(h,x);p.appendChild(S)}),w()}}function k(b,g){var z=document.createElement("div");z.className="ikr-fwizard-photo-thumb",z.innerHTML='<img src="'+g+'" alt="" style="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;">';var h=document.createElement("div");h.className="ikr-fwizard-photo-loading",h.style.display="none",z.appendChild(h);var x=document.createElement("button");return x.type="button",x.className="ikr-fwizard-photo-remove",x.innerHTML="&#x2715;",z.appendChild(x),u(z,b,g),z}function u(b,g,z){var h=b.querySelector("img");h.src!==z&&(h.src=z);var x=b.querySelector(".ikr-fwizard-photo-loading");g.isPending&&g.error?(x.style.display="flex",x.innerHTML='<span class="ikr-upload-error">\u2717 '+g.error+"</span>"):x.style.display="none";var S=b.querySelector(".ikr-fwizard-photo-remove");S.onclick=function(){var C=c[g.url]||(g.file?g.file.name+"_"+g.file.size:null);if(g.url.startsWith("blob:")&&URL.revokeObjectURL(g.url),C){var E=(e.get().fingerprints||[]).filter(function(N){return N!==C});e.set({fingerprints:E})}if(g.isPending){var A=(e.get().pendingImages||[]).filter(function(N){return N.url!==g.url});e.set({pendingImages:A})}else{var M=(e.get().images||[]).filter(function(N){return N!==g.url});e.set({images:M})}}}var v='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',f='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function w(){var b=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,z=b+g,h=z>=ii,x=g>0;z>0?(s.classList.add("ikr-fwizard-photo-card--compact"),o.innerHTML=f):(s.classList.remove("ikr-fwizard-photo-card--compact"),o.innerHTML=v+"<span>Foto\u011Fraf Ekle</span>"),h?(o.style.display="none",d.disabled=!0):(o.style.display="flex",d.disabled=x,o.classList.toggle("ikr-fwizard-photo-add--disabled",x),o.appendChild(d))}d.onchange=async function(b){var g=(e.get().pendingImages||[]).length;if(!(g>0)){var z=e.get().images||[],h=z.length,x=ii-z.length,S=(e.get().images||[]).map(function(O){return""}),C=e.get().pendingImages||[],E=Array.from(b.target.files).slice(0,x);if(E.length!==0){for(var A=[],M=[],N=0;N<E.length;N++){var R=E[N],V=R.name+"_"+R.size,he=(e.get().fingerprints||[]).some(function(O){return O===V})||A.some(function(O){return O.file.name+"_"+O.file.size===V});if(he){console.log("[ikr] Duplicate file detected, skipping:",R.name);continue}if(R.size>$i){alert(R.name+" dosyas\u0131 5MB s\u0131n\u0131r\u0131n\u0131 a\u015F\u0131yor. L\xFCtfen daha k\xFC\xE7\xFCk bir g\xF6rsel se\xE7in.");continue}var se=URL.createObjectURL(R);c[se]=V,A.push({url:se,file:R,error:null}),M.push({url:se,file:R});var ce=(e.get().fingerprints||[]).slice();ce.push(V),e.set({fingerprints:ce})}if(A.length!==0){var q=(e.get().pendingImages||[]).concat(A),Y=async function(){for(var O=0;O<M.length;O++){var pe=M[O],Re=pe.file,H=pe.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Ee=(e.get().pendingImages||[]).filter(function(L){return L.url!==H}),ie=(e.get().images||[]).slice();ie.push(H),e.set({pendingImages:Ee,images:ie});continue}try{var $=await re(Q+"/api/public/upload/sign",{method:"POST"});if(!$.ok)throw $.status===429?new Error("rate_limit"):new Error("sign failed");var U=await $.json(),K=new FormData;K.append("file",Re),K.append("api_key",U.api_key),K.append("timestamp",U.timestamp),K.append("signature",U.signature),K.append("folder","review_images");var Me=await fetch("https://api.cloudinary.com/v1_1/"+U.cloud_name+"/image/upload",{method:"POST",body:K}),me=await Me.json();if(me.secure_url){var F=(e.get().pendingImages||[]).some(function(L){return L.url===H});if(!F){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}m[me.secure_url]=H,c[me.secure_url]=c[H];var Z=(e.get().pendingImages||[]).filter(function(L){return L.url!==H}),Pe=(e.get().images||[]).slice();Pe.push(me.secure_url),e.set({pendingImages:Z,images:Pe})}}catch(L){console.error("[ikr] Image upload failed:",L);var we=L.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.",T=(e.get().pendingImages||[]).map(function(B){return B.url===H?{url:B.url,file:B.file,error:we}:B});e.set({pendingImages:T})}}};if(h===0){i=!0;var J=!r.canNavigate||r.canNavigate();J&&e.goNext()}e.set({pendingImages:q}),Y(),d.value=""}}}};var y=e.onChange(l);return l(),{el:a,destroy:function(){i=!0,d.onchange=null,y&&y()}}}var fr=2e3,Qi=60;function ai(e,r){r=r||{};var i=r.onValidityChange||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-content";var t=document.createElement("div");t.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",t.textContent="Deneyiminizi anlat\u0131n",a.appendChild(t);var n=document.createElement("div");n.className="ikr-fwizard-content-form";var s=document.createElement("input");s.type="text",s.className="ikr-fwizard-input",s.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",s.maxLength=Qi,s.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),s.value=e.get().title||"",s.addEventListener("input",function(){e.set({title:s.value})}),n.appendChild(s);var o=document.createElement("textarea");o.className="ikr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=fr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",n.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-char-counter",d.setAttribute("aria-live","polite"),n.appendChild(d);function p(){var c=o.value.length;d.textContent=c+"/"+fr,d.classList.toggle("ikr-fwizard-char-counter--max",c>=fr)}function m(){return Ne(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),p(),i(m())}),a.appendChild(n),p(),setTimeout(function(){i(m())},0),{el:a,destroy:function(){}}}var et=40;function ni(e,r){r=r||{};var i=r.onValidityChange||function(){},a=r.onSuccess||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-author";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Hakk\u0131n\u0131zda",t.appendChild(n);var s=document.createElement("div");s.className="ikr-fwizard-author-form";var o=document.createElement("div");o.className="ikr-fwizard-field";var d=document.createElement("label");d.className="ikr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var p=document.createElement("input");p.type="text",p.className="ikr-fwizard-input",p.maxLength=et,p.setAttribute("aria-required","true"),p.value=e.get().author||"",o.appendChild(d),o.appendChild(p),s.appendChild(o);var m=document.createElement("div");m.className="ikr-fwizard-field";var c=document.createElement("label");c.className="ikr-fwizard-label",c.textContent="E-posta (opsiyonel)";var l=document.createElement("input");l.type="email",l.className="ikr-fwizard-input",l.setAttribute("autocomplete","email"),l.value=e.get().email||"",m.appendChild(c),m.appendChild(l),s.appendChild(m);var k=document.createElement("div");k.className="ikr-fwizard-notice",k.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",s.appendChild(k);var u=document.createElement("div");u.className="ikr-fwizard-msg",u.setAttribute("role","alert"),u.setAttribute("aria-live","assertive"),s.appendChild(u);var v=document.createElement("button");v.type="button",v.className="ikr-fwizard-submit-btn",v.textContent="G\xF6nder",s.appendChild(v),t.appendChild(s);function f(){return Ne(4,e.get())}function w(){var b=!f(),g=(e.get().pendingImages||[]).length,z=g>0;z?(v.disabled=!0,v.classList.add("ikr-fwizard-submit-btn--disabled"),v.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=b,v.classList.toggle("ikr-fwizard-submit-btn--disabled",b),v.textContent="G\xF6nder")}p.addEventListener("input",function(){e.set({author:p.value}),w(),i(f())}),l.addEventListener("input",function(){e.set({email:l.value})}),w(),setTimeout(function(){i(f())},0),v.onclick=async function(){if(!v.disabled){var b=e.get(),g=(b.author||"").trim(),z=(b.comment||"").trim();if(l.value.trim()&&!l.checkValidity()){l.reportValidity();return}if(!g){u.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen ad\u0131n\u0131z\u0131 girin.</div>';return}if(!b.rating){u.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}v.disabled=!0,v.classList.add("ikr-fwizard-submit-btn--disabled");var h=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",u.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var x=j(window.location.href),S=b.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),C=await re(Q+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:G,productId:b.productId||null,slug:x||null,productName:S,author:g,title:(b.title||"").trim()||null,comment:z||null,rating:b.rating,images:b.images||[]})},15e3);if(C.ok)a();else{var E=await C.json().catch(function(){return{}});throw new Error(E.error||"Yorum kaydedilemedi.")}}catch(N){var A=N&&(N.name==="AbortError"||/signal/i.test(N.message||"")),M=A?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":N.message||"Yorum g\xF6nderilemedi.";u.innerHTML='<div class="ikr-fwizard-msg-error">'+M+"</div>",v.disabled=!1,v.classList.remove("ikr-fwizard-submit-btn--disabled"),v.textContent=h}}};var y=e.onChange(w);return{el:t,destroy:function(){v.onclick=null,y&&y()}}}var oi=!1;function rt(){if(!oi){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=$r,document.head.appendChild(e),oi=!0}}function it(e,r,i){if(i=i||{},e===1)return ri(r,{canNavigate:i.canNavigate});if(e===2)return ti(r,{canNavigate:i.canNavigate,blobMap:i.blobMap,urlToFinger:i.urlToFinger});if(e===3)return ai(r,{onValidityChange:i.onValidityChange});if(e===4)return ni(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess});var a=document.createElement("div");return a.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function li(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function di(e){e=e||{},rt();var r=Qr({productId:e.productId,productName:e.productName}),i={},a={},t=Jr({onClose:function(){window.removeEventListener("popstate",s),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(i).forEach(function(h){var x=i[h];x&&x.startsWith("blob:")&&URL.revokeObjectURL(x)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),n={ikrReviewModal:!0};window.history.pushState(n,null,"");var s=function(h){t&&t.close&&t.close()};window.addEventListener("popstate",s);var o=document.createElement("div");o.className="ikr-fwizard-step-wrap";var d=ei({skippableSteps:[2],nextableSteps:[3],onBack:function(){c==="idle"&&r.goBack()},onSkip:function(){c==="idle"&&r.goNext()},onNext:function(){c==="idle"&&r.goNext()}}),p=document.createElement("div");p.className="ikr-fwizard-layout",p.appendChild(o),p.appendChild(d.el);var m=null,c="idle",l=null,k=!0,u=null;function v(h,x){o.innerHTML="";var S=it(h,r,{canNavigate:function(){return c==="idle"},blobMap:i,urlToFinger:a,onValidityChange:function(A){d.setNextDisabled(!A)},onSuccess:w});if(m=S,d.update(h,r.get()),x){c="entering",S.el.classList.add("ikr-fwizard-step--enter");var C=null,E=function(){C&&clearTimeout(C),S.el.removeEventListener("animationend",E),S.el.classList.remove("ikr-fwizard-step--enter"),c="idle",l!==null&&y()};S.el.addEventListener("animationend",E),C=setTimeout(E,700)}else c="idle";o.appendChild(S.el),t.setStepAttr&&t.setStepAttr(h),h===3&&d.setNextDisabled(!0)}var f=!1;function w(){if(!f){if(f=!0,!m){o.innerHTML="";var h=li();h.classList.add("ikr-fwizard-step--enter"),o.appendChild(h),t.setStepAttr("thanks"),d.setThanksState(t.close);return}var x=m;c="exiting",x.el.classList.add("ikr-fwizard-step--exit");var S=function(){if(u&&clearTimeout(u),x.el.removeEventListener("animationend",S),x.destroy)try{x.destroy()}catch(E){}m===x&&(m=null),o.innerHTML="";var C=li();C.classList.add("ikr-fwizard-step--enter"),o.appendChild(C),t.setStepAttr("thanks"),d.setThanksState(t.close),c="idle"};x.el.addEventListener("animationend",S),u=setTimeout(S,300)}}function y(){var h=r.get().currentStep;if(c!=="idle"){l=h;return}if(!m){var x=!k;k=!1,v(h,x);return}var S=m;c="exiting",S.el.classList.add("ikr-fwizard-step--exit");var C=function(){if(u&&clearTimeout(u),S.el.removeEventListener("animationend",C),S.destroy)try{S.destroy()}catch(A){}if(m===S){o.innerHTML="",m=null;var E=l!==null?l:r.get().currentStep;l=null,v(E,!0),c="idle"}};S.el.addEventListener("animationend",C),u=setTimeout(C,350)}y();var b=r.get().currentStep,g=r.onChange(function(h){h.currentStep!==b?(b=h.currentStep,y()):d.update(h.currentStep,h)}),z=t.close;return t.close=function(){g&&g(),typeof u!="undefined"&&u&&clearTimeout(u),z()},t.open(p),{close:t.close}}function D(){di({productId:ee||"",productName:ye||""})}var tt={id:"classic",name:"Klasik (A\xE7\u0131k)"};function at(e){var r=e.widget,i=e.data,a=e.settings,t=e.iconPair,n=e.allCount,s=e.ratingCounts,o=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,m=e.currentHasImages,c=e.onFilterChange,l=e.onSortChange,k=document.createElement("div");k.className="ikr-summary";var u=(s[3]||0)+(s[4]||0),v=n>0?Math.round(u/n*100):0,f=document.createElement("div");f.className="ikr-summary-block ikr-summary-avg",f.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+o+"</span>",k.appendChild(f);var w=document.createElement("div");if(w.className="ikr-summary-block ikr-summary-count",w.textContent=n.toLocaleString("tr-TR")+" Yorum",k.appendChild(w),a.showRecommendation!==!1&&v>0){var y=document.createElement("div");y.className="ikr-summary-block ikr-summary-recommend",y.innerHTML='<span class="ikr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(y)}return k.appendChild(Ae({ratingCounts:s,allCount:n,iconPair:t,currentRatingFilter:d,onFilterChange:c})),k.appendChild(de({widget:r,currentOrderBy:p,currentHasImages:m,onWriteClick:D,onSortChange:l})),k}var kr={};be(kr,{css:()=>ot,meta:()=>nt,render:()=>lt});var si=`
...
`;var nt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ot=si;function lt(e){var r=e.widget,i=e.settings,a=e.iconPair,t=e.allCount,n=e.ratingCounts,s=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,p=e.currentHasImages,m=e.onFilterChange,c=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var u=document.createElement("div");u.className="ikr-compact-trigger-wrap";var v=document.createElement("button");v.className="ikr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="ikr-compact-trigger-stars">'+ne(s,a)+'</span><span class="ikr-compact-trigger-text">'+t.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',u.appendChild(v),k.appendChild(u);var f=de({widget:r,currentOrderBy:d,currentHasImages:p,onWriteClick:D,onSortChange:c}),w=f.querySelector(".ikr-filter-wrap"),y=f.querySelector(".ikr-write-btn"),b=document.createElement("div");b.className="ikr-compact-actions-slot",y&&b.appendChild(y),w&&b.appendChild(w),k.appendChild(b),l.appendChild(k);var g=document.createElement("div");g.className="ikr-compact-panel",g.setAttribute("role","dialog"),g.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="ikr-compact-panel-inner";var h=document.createElement("div");h.className="ikr-compact-avg",h.innerHTML='<span class="ikr-icon">'+a.filled+"</span><span>"+s+"</span>",z.appendChild(h),z.appendChild(Ae({ratingCounts:n,allCount:t,iconPair:a,currentRatingFilter:o,onFilterChange:m})),g.appendChild(z);var x=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function S(Y){var J=Y?l:u;g.parentNode!==J&&(g.classList.contains("ikr-open")&&(g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),J.appendChild(g))}if(S(x?x.matches:!1),x){var C=function(Y){S(Y.matches)};x.addEventListener?x.addEventListener("change",C):x.addListener&&x.addListener(C)}if(y){var E=document.createElement("button");E.className="ikr-write-btn",E.textContent="Yorum Yap",E.onclick=D;var A=document.createElement("div");A.className="ikr-compact-write-row",A.appendChild(E),l.appendChild(A)}function M(){g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function N(){$e(R),g.classList.add("ikr-open"),g.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){g.classList.contains("ikr-open")?M():N()};var R=null;function V(Y){R&&(R(),R=null),Y||(R=Qe({trigger:u,element:g,close:M}))}if(V(x?x.matches:!1),x){var he=function(Y){V(Y.matches)};x.addEventListener?x.addEventListener("change",he):x.addListener&&x.addListener(he)}if(i.showRecommendation!==!1){var se=(n[3]||0)+(n[4]||0),ce=t>0?Math.round(se/t*100):0;if(ce>0){var q=document.createElement("div");q.className="ikr-summary-block ikr-summary-recommend",q.style.marginTop="8px",q.innerHTML='<span class="ikr-recommend-pct">%'+ce+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(q)}}return l}var gr={};be(gr,{css:()=>st,meta:()=>dt,render:()=>ct});var ci=`
...
`;var dt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},st=ci;function ct(e){var r=e.widget,i=e.settings,a=e.iconPair,t=e.allCount,n=e.ratingCounts,s=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,p=e.currentHasImages,m=e.onFilterChange,c=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",u.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+s+"</span>",k.appendChild(u);var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-count ikr-split-left-count",v.textContent=t.toLocaleString("tr-TR")+" Yorum",k.appendChild(v),l.appendChild(k);var f=document.createElement("div");f.className="ikr-split-col ikr-split-mid",f.appendChild(Ae({ratingCounts:n,allCount:t,iconPair:a,currentRatingFilter:o,onFilterChange:m})),l.appendChild(f);var w=de({widget:r,currentOrderBy:d,currentHasImages:p,onWriteClick:D,onSortChange:c}),y=w.querySelector(".ikr-filter-wrap"),b=w.querySelector(".ikr-write-btn"),g=document.createElement("div");if(g.className="ikr-split-col ikr-split-right",b&&g.appendChild(b),y&&g.appendChild(y),l.appendChild(g),i.showRecommendation!==!1){var z=(n[3]||0)+(n[4]||0),h=t>0?Math.round(z/t*100):0;if(h>0){var x=document.createElement("div");x.className="ikr-summary-block ikr-summary-recommend",x.innerHTML='<span class="ikr-recommend-pct">%'+h+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(x)}}return l}var hr={};be(hr,{css:()=>mt,meta:()=>pt,render:()=>ut});var pi=`
