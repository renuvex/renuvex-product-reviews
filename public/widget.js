...
`;var Mt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ht=Yr;function qt(e){var r=e.widget,t=e.settings,i=e.iconPair,a=e.allCount,n=e.ratingCounts,c=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,d=e.currentHasImages,o=e.onFilterChange,p=e.onSortChange,m=document.createElement("div");m.className="ikr-summary ikr-summary-split";var f=document.createElement("div");f.className="ikr-split-col ikr-split-left";for(var u="",g=1;g<=5;g++)u+='<span class="ikr-icon">'+i.filled+"</span>";var k=document.createElement("div");k.className="ikr-split-left-stars",k.innerHTML=u,f.appendChild(k);var h=document.createElement("div");h.className="ikr-split-left-avg",h.textContent=c+" / 5",f.appendChild(h);var v=document.createElement("div");v.className="ikr-split-left-count",v.textContent=a.toLocaleString("tr-TR")+" yorum",f.appendChild(v),m.appendChild(f);var C=document.createElement("div");C.className="ikr-split-col ikr-split-mid",C.appendChild(ye({ratingCounts:n,allCount:a,iconPair:i,currentRatingFilter:l,onFilterChange:o})),m.appendChild(C);var w=Z({widget:r,currentOrderBy:s,currentHasImages:d,onWriteClick:j,onSortChange:p}),x=w.querySelector(".ikr-filter-wrap"),y=w.querySelector(".ikr-write-btn"),E=document.createElement("div");if(E.className="ikr-split-col ikr-split-right",x&&E.appendChild(x),y&&E.appendChild(y),m.appendChild(E),t.showRecommendation!==!1){var T=(n[3]||0)+(n[4]||0),b=a>0?Math.round(T/a*100):0;if(b>0){var z=document.createElement("div");z.className="ikr-summary-block ikr-summary-recommend",z.style.marginTop="4px",z.innerHTML='<span class="ikr-recommend-pct">%'+b+"</span> tavsiye ediyor",f.appendChild(z)}}return m}var sr={};he(sr,{css:()=>Ft,meta:()=>jt,render:()=>Dt});var Gr=`
...
`;var jt={id:"minimal",name:"Minimal (Yal\u0131n)",defaultTitle:""},Ft=Gr;function Dt(e){var r=e.widget,t=e.iconPair,i=e.allCount,a=e.avgRatingVal,n=e.currentOrderBy,c=e.currentHasImages,l=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var d=document.createElement("div");d.className="ikr-minimal-info";var o=document.createElement("div");o.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=a,o.appendChild(p);var m=document.createElement("span");m.className="ikr-minimal-stars";for(var f="",u=1;u<=5;u++)f+='<span class="ikr-icon">'+t.filled+"</span>";m.innerHTML=f,o.appendChild(m),d.appendChild(o);var g=document.createElement("div");g.className="ikr-minimal-count",g.textContent=i.toLocaleString("tr-TR")+" yorum \xFCzerinden",d.appendChild(g),s.appendChild(d);var k=Z({widget:r,currentOrderBy:n,currentHasImages:c,onWriteClick:j,onSortChange:l}),h=k.querySelector(".ikr-filter-wrap"),v=k.querySelector(".ikr-write-btn"),C=document.createElement("div");if(C.className="ikr-minimal-actions",v&&C.appendChild(v),h&&C.appendChild(h),s.appendChild(C),v){var w=document.createElement("button");w.className="ikr-write-btn",w.textContent="Yorum Yap",w.onclick=j;var x=document.createElement("div");x.className="ikr-minimal-write-row",x.appendChild(w),s.appendChild(x)}return s}var dr={};he(dr,{css:()=>Gt,meta:()=>Yt,render:()=>Ut});var Ur=`
