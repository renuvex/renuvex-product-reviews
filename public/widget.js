...
`;var Nt=".product-name",Pt=".add-to-basket-modal",_t="h1.product-name",qe=".single-product-container-main",Or=".single-product-product-name",Bt=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),Rt=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var Yr={};Te(Yr,{meta:()=>ea,render:()=>ra});function Ge(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,i=e.currentRatingFilter,a=e.onFilterChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-bars";for(var o=5;o>=1;o--){var d=r[o-1]||0,c=t>0?Math.round(d/t*100):0,m=i===o,p=document.createElement("div");p.className="ikr-bar-row"+(m?" ikr-bar-active":""),i&&!m&&(p.style.opacity="0.35");for(var l="",v=1;v<=5;v++){var f=v<=o;l+='<span class="ikr-bar-star ikr-icon '+(f?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(f?n.filled:n.empty)+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+l+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(g){p.onclick=function(){a(g)}})(o),s.appendChild(p)}return s}var pe=[],Mt=!1;function Vi(e){for(var r=pe.length-1;r>=0;r--){var t=pe[r];t.trigger&&t.trigger.contains(e.target)||t.element&&t.element.contains(e.target)||t.close()}}function Ui(e){if(e.key==="Escape")for(var r=pe.length-1;r>=0;r--)pe[r].close()}function Zi(){Mt||typeof document=="undefined"||(document.addEventListener("click",Vi,!0),document.addEventListener("keydown",Ui),Mt=!0)}function kr(e){for(var r=0;r<pe.length;r++)pe[r]!==e&&pe[r].close()}function hr(e){Zi();var r={trigger:e.trigger,element:e.element,close:e.close};return pe.push(r),function(){var n=pe.indexOf(r);n!==-1&&pe.splice(n,1)}}function te(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,i=e.onWriteClick,a=e.onSortChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-actions";var o=document.createElement("button");o.className="ikr-write-btn",o.textContent=L&&L.writeButtonText||"Yorum Yap",o.onclick=i,s.appendChild(o);var d=document.createElement("div");d.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele");var m=L&&L.filterIcon||"lines";c.innerHTML=bt(m);var p=document.createElement("div");p.className="ikr-filter-menu";var l=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function v(){p.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function f(){kr(g),p.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}l.forEach(function(u){var k=u[2],w=k?n:!n&&(t||"newest")===u[0],h=document.createElement("div");h.className="ikr-filter-item"+(w?" ikr-filter-item-active":""),h.textContent=u[1],h.onclick=function(){v(),a(u[0],k)},p.appendChild(h)}),c.onclick=function(){p.classList.contains("ikr-open")?v():f()};var g=hr({trigger:d,element:p,close:v});return d.appendChild(c),d.appendChild(p),s.appendChild(d),s}function Ht(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,n=document.createElement("div");n.className="ikr-fwizard-overlay",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true");var i=document.createElement("div");i.className="ikr-fwizard",n.appendChild(i);var a=document.createElement("button");a.className="ikr-fwizard-close",a.type="button",a.setAttribute("aria-label","Kapat"),a.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',i.appendChild(a);var s=document.createElement("div");s.className="ikr-fwizard-content",i.appendChild(s);var o=!1,d="",c="";function m(){var h=window.innerWidth-document.documentElement.clientWidth;d=document.body.style.overflow,c=document.body.style.paddingRight,document.body.style.overflow="hidden",h>0&&(document.body.style.paddingRight=h+"px")}function p(){document.body.style.overflow=d,document.body.style.paddingRight=c}function l(){o||(o=!0,document.removeEventListener("keydown",v),n.removeEventListener("click",f),a.removeEventListener("click",l),n.classList.remove("ikr-fwizard-open"),setTimeout(function(){n.parentNode&&n.parentNode.removeChild(n),p();try{r()}catch(h){}},200))}function v(h){h.key==="Escape"&&l()}function f(h){h.target===n&&t&&l()}document.addEventListener("keydown",v),n.addEventListener("click",f),a.addEventListener("click",l);function g(h){h&&s.appendChild(h),document.body.appendChild(n),m(),requestAnimationFrame(function(){n.classList.add("ikr-fwizard-open")})}var u=null,k=null;function w(h,y){if(y=y||"error",u){try{u.remove()}catch(C){}u=null}k&&(clearTimeout(k),k=null),u=document.createElement("div"),u.className="ikr-fwizard-toast ikr-fwizard-toast--"+y,u.textContent=h,i.appendChild(u),k=setTimeout(function(){u&&(u.classList.add("ikr-fwizard-toast--exit"),setTimeout(function(){if(u){try{u.remove()}catch(C){}u=null}},300))},4e3)}return{open:g,close:l,content:s,setAllowOutsideClose:function(h){t=!!h},setStepAttr:function(h){i.setAttribute("data-step",String(h))},showToast:w}}var Ot=`
...
`;var Fr=4;function Ve(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Ft(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(i){try{i(t)}catch(a){}})}return{get:function(){return t},set:function(i){Object.assign(t,i),n()},goNext:function(){t.currentStep<Fr&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(i){return r.push(i),function(){r=r.filter(function(a){return a!==i})}}}}var Wi='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function Dt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},i=e.onSkip||function(){},a=e.onNext||function(){},s=document.createElement("div");s.className="ikr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=Wi+"<span>Geri</span>",o.addEventListener("click",function(){n()}),s.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-footer-progress";for(var c=[],m=0;m<Fr;m++){var p=document.createElement("span");p.className="ikr-fwizard-progress-seg",d.appendChild(p),c.push(p)}s.appendChild(d);var l=document.createElement("button");l.type="button";var v=null;function f(u){v&&l.removeEventListener("click",v),v=u,u&&l.addEventListener("click",u)}s.appendChild(l);function g(u,k){var w=r.indexOf(u)!==-1,h=t.indexOf(u)!==-1,y=k&&(k.images&&k.images.length>0||k.pendingImages&&k.pendingImages.length>0);if(w)u===2&&y?(l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Devam Et"),l.innerHTML="Devam Et",f(function(){a()})):(l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",l.setAttribute("aria-label","Atla"),l.innerHTML="<span>Atla</span>",f(function(){i()})),l.disabled=!1,l.classList.remove("ikr-fwizard-cta-btn--disabled"),l.style.visibility="",l.tabIndex=0;else if(h){l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Sonraki"),l.innerHTML="Sonraki",l.style.visibility="",l.tabIndex=0;var C=Ve(u,k);l.disabled=!C,l.classList.toggle("ikr-fwizard-cta-btn--disabled",!C),f(function(){l.disabled||a()})}else l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",l.innerHTML="",l.style.visibility="hidden",l.tabIndex=-1,l.disabled=!0,f(null)}return{el:s,update:function(u,k){c.forEach(function(h,y){y+1<=u?h.classList.add("ikr-fwizard-progress-seg-active"):h.classList.remove("ikr-fwizard-progress-seg-active")});var w=u<=1;o.style.visibility=w?"hidden":"",o.style.pointerEvents=w?"none":"",o.tabIndex=w?-1:0,g(u,k)},setNextDisabled:function(u){l.classList.contains("ikr-fwizard-cta-btn")&&(l.disabled=!!u,l.classList.toggle("ikr-fwizard-cta-btn--disabled",!!u))},setThanksState:function(u){o.style.visibility="hidden",d.style.visibility="hidden",l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Devam Et"),l.innerHTML="Devam Et",l.style.visibility="",l.disabled=!1,l.classList.remove("ikr-fwizard-cta-btn--disabled"),f(u)}}}function jt(e,r){r=r||{};var t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-rating";var n=!1,i=document.createElement("div");i.className="ikr-fwizard-step-title",i.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(i);var a=document.createElement("div");a.className="ikr-fwizard-stars",a.setAttribute("role","radiogroup"),a.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var s=Me(L||{}),o=[];function d(p){o.forEach(function(l,v){var f=v<p;l.classList.toggle("ikr-fwizard-star-active",f),l.innerHTML=f?s.filled:s.empty})}for(var c=1;c<=5;c++)(function(p){var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-star",l.setAttribute("role","radio"),l.setAttribute("aria-label",p+" y\u0131ld\u0131z"),l.innerHTML=s.empty,l.addEventListener("mouseenter",function(){d(p)}),l.addEventListener("mouseleave",function(){d(e.get().rating)}),l.addEventListener("click",function(){n||(n=!0,e.set({rating:p}),d(p),setTimeout(function(){var v=!r.canNavigate||r.canNavigate();v&&e.goNext()},400))}),o.push(l),a.appendChild(l)})(c);d(e.get().rating);var m=function(){s=Me(L||{}),d(e.get().rating)};return window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",m),t.appendChild(a),{el:t,destroy:function(){window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",m)}}}var Dr=3,Ki=10*1024*1024;function Yt(e,r){r=r||{};var t=!1,n=document.createElement("div");n.className="ikr-fwizard-step ikr-fwizard-step-photos";var i=document.createElement("div");i.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",i.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",n.appendChild(i);var a=document.createElement("div");a.className="ikr-fwizard-step-subtitle",a.textContent="Foto\u011Fraf ekleyebilirsiniz.",n.appendChild(a);var s=document.createElement("div");s.className="ikr-fwizard-photo-card";var o=document.createElement("label");o.className="ikr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle"),o.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",o.appendChild(d),s.appendChild(o);var c=document.createElement("div");c.className="ikr-fwizard-photo-previews",c.setAttribute("aria-live","polite"),s.appendChild(c),n.appendChild(s);var m=r.blobMap||{},p=r.urlToFinger||{};function l(){if(!t){var h=e.get().images||[],y=e.get().pendingImages||[],C=h.map(function(z){return{url:z,isPending:!1}}).concat(y.map(function(z){return{url:z.url,file:z.file,isPending:!0,error:z.error}}));c.innerHTML="",C.forEach(function(z){var b=m[z.url]||z.url,x=v(z,b);c.appendChild(x)}),k()}}function v(h,y){var C=document.createElement("div");C.className="ikr-fwizard-photo-thumb";var z=document.createElement("img");z.src=y,z.alt="",z.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",C.appendChild(z);var b=document.createElement("div");b.className="ikr-fwizard-photo-loading",b.style.display="none",C.appendChild(b);var x=document.createElement("button");return x.type="button",x.className="ikr-fwizard-photo-remove",x.innerHTML="&#x2715;",C.appendChild(x),f(C,h,y),C}function f(h,y,C){var z=h.querySelector("img");z.src!==C&&(z.src=C);var b=h.querySelector(".ikr-fwizard-photo-loading");y.isPending&&y.error?(b.style.display="flex",b.innerHTML='<span class="ikr-upload-error">\u2717 '+y.error+"</span>"):b.style.display="none";var x=h.querySelector(".ikr-fwizard-photo-remove");x.onclick=function(){var E=p[y.url]||(y.file?y.file.name+"_"+y.file.size:null);if(y.url.startsWith("blob:")&&URL.revokeObjectURL(y.url),E){var S=(e.get().fingerprints||[]).filter(function(T){return T!==E});e.set({fingerprints:S})}if(y.isPending){var I=(e.get().pendingImages||[]).filter(function(T){return T.url!==y.url});e.set({pendingImages:I})}else{var N=(e.get().images||[]).filter(function(T){return T!==y.url});e.set({images:N})}}}var g='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',u='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function k(){var h=(e.get().images||[]).length,y=(e.get().pendingImages||[]).length,C=h+y,z=C>=Dr,b=y>0;C>0?(s.classList.add("ikr-fwizard-photo-card--compact"),o.innerHTML=u):(s.classList.remove("ikr-fwizard-photo-card--compact"),o.innerHTML=g+"<span>Foto\u011Fraf Ekle</span>"),z?(o.style.display="none",d.disabled=!0):(o.style.display="flex",d.disabled=b,o.classList.toggle("ikr-fwizard-photo-add--disabled",b),o.appendChild(d))}d.onchange=async function(h){var y=Array.from(h.target.files).slice(0,Dr-(e.get().images||[]).length);d.value="";var C=(e.get().pendingImages||[]).length;if(!(C>0)){var z=e.get().images||[],b=z.length,x=Dr-z.length;if(y.length!==0){for(var E=[],S=[],I=0;I<y.length;I++){var N=y[I],T=N.name+"_"+N.size,H=(e.get().fingerprints||[]).some(function(O){return O===T})||E.some(function(O){return O.file.name+"_"+O.file.size===T});if(H){console.log("[ikr] Duplicate file detected, skipping:",N.name);continue}if(N.size>Ki){var ue="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(ue,"error"):alert(ue);continue}var K=URL.createObjectURL(N);p[K]=T,E.push({url:K,file:N,error:null}),S.push({url:K,file:N});var fe=(e.get().fingerprints||[]).slice();fe.push(T),e.set({fingerprints:fe})}if(E.length!==0){var ve=(e.get().pendingImages||[]).concat(E),X=async function(){for(var O=0;O<S.length;O++){var ge=S[O],ke=ge.file,U=ge.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Ee=(e.get().pendingImages||[]).filter(function(J){return J.url!==U}),Fe=(e.get().images||[]).slice();Fe.push(U),e.set({pendingImages:Ee,images:Fe});continue}try{var he=await re(q+"/api/public/upload/sign",{method:"POST"});if(!he.ok)throw he.status===429?new Error("rate_limit"):new Error("sign failed");var ie=await he.json(),D=new FormData;D.append("file",ke),D.append("api_key",ie.api_key),D.append("timestamp",ie.timestamp),D.append("signature",ie.signature),D.append("folder","review_images");var Ke=await fetch("https://api.cloudinary.com/v1_1/"+ie.cloud_name+"/image/upload",{method:"POST",body:D}),ye=await Ke.json();if(ye.secure_url&&Rr(ye.secure_url)){var Ne=(e.get().pendingImages||[]).some(function(J){return J.url===U});if(!Ne){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}m[ye.secure_url]=U,p[ye.secure_url]=p[U];var we=(e.get().pendingImages||[]).filter(function(J){return J.url!==U}),Q=(e.get().images||[]).slice();Q.push(ye.secure_url),e.set({pendingImages:we,images:Q})}else throw new Error("invalid image url")}catch(J){console.error("[ikr] Image upload failed:",J);var ae=J.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ae,"error");var Pe=(e.get().pendingImages||[]).map(function(B){return B.url===U?{url:B.url,file:B.file,error:ae}:B});e.set({pendingImages:Pe})}}};if(b===0){t=!0;var V=!r.canNavigate||r.canNavigate();V&&e.goNext()}e.set({pendingImages:ve}),X()}}}};var w=e.onChange(l);return l(),{el:n,destroy:function(){t=!0,d.onchange=null,w&&w()}}}var jr=2e3,Xi=60;function qt(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="ikr-fwizard-step ikr-fwizard-step-content";var i=document.createElement("div");i.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",i.textContent="Deneyiminizi anlat\u0131n",n.appendChild(i);var a=document.createElement("div");a.className="ikr-fwizard-content-form";var s=document.createElement("input");s.type="text",s.className="ikr-fwizard-input",s.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",s.maxLength=Xi,s.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),s.value=e.get().title||"",s.addEventListener("input",function(){e.set({title:s.value})}),a.appendChild(s);var o=document.createElement("textarea");o.className="ikr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=jr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",a.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-char-counter",d.setAttribute("aria-live","polite"),a.appendChild(d);function c(){var p=o.value.length;d.textContent=p+"/"+jr,d.classList.toggle("ikr-fwizard-char-counter--max",p>=jr)}function m(){return Ve(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),c(),t(m())}),n.appendChild(a),c(),setTimeout(function(){t(m())},0),{el:n,destroy:function(){}}}var Ji=40;function Gt(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-author";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Hakk\u0131n\u0131zda",i.appendChild(a);var s=document.createElement("div");s.className="ikr-fwizard-author-form";var o=document.createElement("div");o.className="ikr-fwizard-field";var d=document.createElement("label");d.className="ikr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var c=document.createElement("input");c.type="text",c.className="ikr-fwizard-input",c.maxLength=Ji,c.setAttribute("aria-required","true"),c.value=e.get().author||"",o.appendChild(d),o.appendChild(c),s.appendChild(o);var m=document.createElement("div");m.className="ikr-fwizard-field";var p=document.createElement("label");p.className="ikr-fwizard-label",p.textContent="E-posta (opsiyonel)";var l=document.createElement("input");l.type="email",l.className="ikr-fwizard-input",l.setAttribute("autocomplete","email"),l.value=e.get().email||"",m.appendChild(p),m.appendChild(l),s.appendChild(m);var v=document.createElement("div");v.className="ikr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",s.appendChild(v);var f=document.createElement("div");f.className="ikr-fwizard-msg",f.setAttribute("role","alert"),f.setAttribute("aria-live","assertive"),s.appendChild(f);var g=document.createElement("button");g.type="button",g.className="ikr-fwizard-submit-btn",g.textContent="G\xF6nder",s.appendChild(g),i.appendChild(s);function u(){return Ve(4,e.get())}function k(){var h=!u(),y=(e.get().pendingImages||[]).length,C=y>0;C?(g.disabled=!0,g.classList.add("ikr-fwizard-submit-btn--disabled"),g.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(g.disabled=h,g.classList.toggle("ikr-fwizard-submit-btn--disabled",h),g.textContent="G\xF6nder")}c.addEventListener("input",function(){e.set({author:c.value}),k(),t(u())}),l.addEventListener("input",function(){e.set({email:l.value})}),k(),setTimeout(function(){t(u())},0),g.onclick=async function(){if(!g.disabled){var h=e.get(),y=(h.author||"").trim(),C=(h.comment||"").trim();if(l.value.trim()&&!l.checkValidity()){l.reportValidity();return}if(!y){f.innerHTML='<div class="ikr-fwizard-msg-error">Gerekli alan</div>';return}if(!h.rating){f.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}g.disabled=!0,g.classList.add("ikr-fwizard-submit-btn--disabled");var z=g.textContent;if(g.textContent="G\xF6nderiliyor\u2026",f.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){n()},600);return}try{var b=j(window.location.href),x=h.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),E=await re(q+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:F,productId:h.productId||null,slug:b||null,productName:x,author:y,title:(h.title||"").trim()||null,comment:C||null,rating:h.rating,images:h.images||[]})},15e3);if(E.ok)n();else{var S=await E.json().catch(function(){return{}});throw new Error(S.error||"Yorum kaydedilemedi.")}}catch(T){var I=T&&(T.name==="AbortError"||/signal/i.test(T.message||"")),N=I?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":T.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(N,"error"):f.innerHTML='<div class="ikr-fwizard-msg-error">'+N+"</div>",g.disabled=!1,g.classList.remove("ikr-fwizard-submit-btn--disabled"),g.textContent=z}}};var w=e.onChange(k);return{el:i,destroy:function(){g.onclick=null,w&&w()}}}var Vt=!1;function $i(){if(!Vt){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=Ot,document.head.appendChild(e),Vt=!0}}function Qi(e,r,t){if(t=t||{},e===1)return jt(r,{canNavigate:t.canNavigate});if(e===2)return Yt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,showToast:t.showToast});if(e===3)return qt(r,{onValidityChange:t.onValidityChange});if(e===4)return Gt(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Ut(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Zt(e){e=e||{},$i();var r=Ft({productId:e.productId,productName:e.productName}),t={},n={},i=Ht({onClose:function(){window.removeEventListener("popstate",s),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(t).forEach(function(z){var b=t[z];b&&b.startsWith("blob:")&&URL.revokeObjectURL(b)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),a={ikrReviewModal:!0};window.history.pushState(a,null,"");var s=function(z){i&&i.close&&i.close()};window.addEventListener("popstate",s);var o=document.createElement("div");o.className="ikr-fwizard-step-wrap";var d=Dt({skippableSteps:[2],nextableSteps:[3],onBack:function(){p==="idle"&&r.goBack()},onSkip:function(){p==="idle"&&r.goNext()},onNext:function(){p==="idle"&&r.goNext()}}),c=document.createElement("div");c.className="ikr-fwizard-layout",c.appendChild(o),c.appendChild(d.el);var m=null,p="idle",l=null,v=!0,f=null;function g(z,b){o.innerHTML="";var x=Qi(z,r,{canNavigate:function(){return p==="idle"},blobMap:t,urlToFinger:n,onValidityChange:function(I){d.setNextDisabled(!I)},onSuccess:k,showToast:i.showToast});if(m=x,d.update(z,r.get()),b){p="entering",x.el.classList.add("ikr-fwizard-step--enter");var E=null,S=function(){E&&clearTimeout(E),x.el.removeEventListener("animationend",S),x.el.classList.remove("ikr-fwizard-step--enter"),p="idle",l!==null&&w()};x.el.addEventListener("animationend",S),E=setTimeout(S,700)}else p="idle";o.appendChild(x.el),i.setStepAttr&&i.setStepAttr(z),z===3&&d.setNextDisabled(!0)}var u=!1;function k(){if(!u){if(u=!0,!m){o.innerHTML="";var z=Ut();z.classList.add("ikr-fwizard-step--enter"),o.appendChild(z),i.setStepAttr("thanks"),d.setThanksState(i.close);return}var b=m;p="exiting",b.el.classList.add("ikr-fwizard-step--exit");var x=function(){if(f&&clearTimeout(f),b.el.removeEventListener("animationend",x),b.destroy)try{b.destroy()}catch(S){}m===b&&(m=null),o.innerHTML="";var E=Ut();E.classList.add("ikr-fwizard-step--enter"),o.appendChild(E),i.setStepAttr("thanks"),d.setThanksState(i.close),p="idle"};b.el.addEventListener("animationend",x),f=setTimeout(x,300)}}function w(){var z=r.get().currentStep;if(p!=="idle"){l=z;return}if(!m){var b=!v;v=!1,g(z,b);return}var x=m;p="exiting",x.el.classList.add("ikr-fwizard-step--exit");var E=function(){if(f&&clearTimeout(f),x.el.removeEventListener("animationend",E),x.destroy)try{x.destroy()}catch(I){}if(m===x){o.innerHTML="",m=null;var S=l!==null?l:r.get().currentStep;l=null,g(S,!0),p="idle"}};x.el.addEventListener("animationend",E),f=setTimeout(E,350)}w();var h=r.get().currentStep,y=r.onChange(function(z){z.currentStep!==h?(h=z.currentStep,w()):d.update(z.currentStep,z)}),C=i.close;return i.close=function(){y&&y(),typeof f!="undefined"&&f&&clearTimeout(f),C()},i.open(c),{close:i.close}}function Y(){Zt({productId:Z||"",productName:be||""})}var ea={id:"classic",name:"Klasik (A\xE7\u0131k)"};function ra(e){var r=e.widget,t=e.data,n=e.settings,i=e.iconPair,a=e.allCount,s=e.ratingCounts,o=e.avgRatingVal,d=e.currentRatingFilter,c=e.currentOrderBy,m=e.currentHasImages,p=e.onFilterChange,l=e.onSortChange,v=document.createElement("div");v.className="ikr-summary";var f=(s[3]||0)+(s[4]||0),g=a>0?Math.round(f/a*100):0,u=document.createElement("div");u.className="ikr-summary-block ikr-summary-avg",u.innerHTML='<span class="ikr-avg-star ikr-icon">'+i.filled+'</span><span class="ikr-avg-num">'+o+"</span>",v.appendChild(u);var k=document.createElement("div");if(k.className="ikr-summary-block ikr-summary-count",k.textContent=a.toLocaleString("tr-TR")+" Yorum",v.appendChild(k),n.showRecommendation!==!1&&g>0){var w=document.createElement("div");w.className="ikr-summary-block ikr-summary-recommend",w.innerHTML='<span class="ikr-recommend-pct">%'+g+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(w)}return v.appendChild(Ge({ratingCounts:s,allCount:a,iconPair:i,currentRatingFilter:d,onFilterChange:p})),v.appendChild(te({widget:r,currentOrderBy:c,currentHasImages:m,onWriteClick:Y,onSortChange:l})),v}var qr={};Te(qr,{css:()=>ia,meta:()=>ta,render:()=>aa});var Wt=`
...
`;var ta={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ia=Wt;function aa(e){var r=e.widget,t=e.settings,n=e.iconPair,i=e.allCount,a=e.ratingCounts,s=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,m=e.onFilterChange,p=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var v=document.createElement("div");v.className="ikr-compact-header";var f=document.createElement("div");f.className="ikr-compact-trigger-wrap";var g=document.createElement("button");g.className="ikr-compact-trigger",g.type="button",g.setAttribute("aria-expanded","false"),g.innerHTML='<span class="ikr-compact-trigger-stars">'+oe(s,n)+'</span><span class="ikr-compact-trigger-text">'+i.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',f.appendChild(g),v.appendChild(f);var u=te({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),k=u.querySelector(".ikr-filter-wrap"),w=u.querySelector(".ikr-write-btn"),h=document.createElement("div");h.className="ikr-compact-actions-slot",w&&h.appendChild(w),k&&h.appendChild(k),v.appendChild(h),l.appendChild(v);var y=document.createElement("div");y.className="ikr-compact-panel",y.setAttribute("role","dialog"),y.setAttribute("aria-hidden","true");var C=document.createElement("div");C.className="ikr-compact-panel-inner";var z=document.createElement("div");z.className="ikr-compact-avg",z.innerHTML='<span class="ikr-icon">'+n.filled+"</span><span>"+s+"</span>",C.appendChild(z),C.appendChild(Ge({ratingCounts:a,allCount:i,iconPair:n,currentRatingFilter:o,onFilterChange:m})),y.appendChild(C);var b=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function x(V){var O=V?l:f;y.parentNode!==O&&(y.classList.contains("ikr-open")&&(y.classList.remove("ikr-open"),y.setAttribute("aria-hidden","true"),g.setAttribute("aria-expanded","false")),O.appendChild(y))}if(x(b?b.matches:!1),b){var E=function(V){x(V.matches)};b.addEventListener?b.addEventListener("change",E):b.addListener&&b.addListener(E)}if(w){var S=document.createElement("button");S.className="ikr-write-btn",S.textContent=L&&L.writeButtonText||"Yorum Yap",S.onclick=Y;var I=document.createElement("div");I.className="ikr-compact-write-row",I.appendChild(S),l.appendChild(I)}function N(){y.classList.remove("ikr-open"),y.setAttribute("aria-hidden","true"),g.setAttribute("aria-expanded","false")}function T(){kr(H),y.classList.add("ikr-open"),y.setAttribute("aria-hidden","false"),g.setAttribute("aria-expanded","true")}g.onclick=function(){y.classList.contains("ikr-open")?N():T()};var H=null;function ue(V){H&&(H(),H=null),V||(H=hr({trigger:f,element:y,close:N}))}if(ue(b?b.matches:!1),b){var K=function(V){ue(V.matches)};b.addEventListener?b.addEventListener("change",K):b.addListener&&b.addListener(K)}if(t.showRecommendation!==!1){var fe=(a[3]||0)+(a[4]||0),ve=i>0?Math.round(fe/i*100):0;if(ve>0){var X=document.createElement("div");X.className="ikr-summary-block ikr-summary-recommend",X.style.marginTop="8px",X.innerHTML='<span class="ikr-recommend-pct">%'+ve+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",C.appendChild(X)}}return l}var Gr={};Te(Gr,{css:()=>oa,meta:()=>na,render:()=>la});var Kt=`
...
`;var na={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},oa=Kt;function la(e){var r=e.widget,t=e.settings,n=e.iconPair,i=e.allCount,a=e.ratingCounts,s=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,m=e.onFilterChange,p=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-split";var v=document.createElement("div");v.className="ikr-split-col ikr-split-left";var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",f.innerHTML='<span class="ikr-avg-star ikr-icon">'+n.filled+'</span><span class="ikr-avg-num">'+s+"</span>",v.appendChild(f);var g=document.createElement("div");g.className="ikr-summary-block ikr-summary-count ikr-split-left-count",g.textContent=i.toLocaleString("tr-TR")+" Yorum",v.appendChild(g),l.appendChild(v);var u=document.createElement("div");u.className="ikr-split-col ikr-split-mid",u.appendChild(Ge({ratingCounts:a,allCount:i,iconPair:n,currentRatingFilter:o,onFilterChange:m})),l.appendChild(u);var k=te({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),w=k.querySelector(".ikr-filter-wrap"),h=k.querySelector(".ikr-write-btn"),y=document.createElement("div");y.className="ikr-split-col ikr-split-right",h&&y.appendChild(h),w&&y.appendChild(w),l.appendChild(y);var C=(a[3]||0)+(a[4]||0),z=i>0?Math.round(C/i*100):0,b=document.createElement("div");b.className="ikr-summary-block ikr-summary-recommend",b.innerHTML='<span class="ikr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var x=t.showRecommendation===!1||z===0;return x&&b.classList.add("ikr-split-rec-hidden"),v.appendChild(b),l}var Vr={};Te(Vr,{css:()=>da,meta:()=>sa,render:()=>ca});var Xt=`
...
`;var sa={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},da=Xt;function ca(e){var r=e.widget,t=e.iconPair,n=e.allCount,i=e.avgRatingVal,a=e.currentOrderBy,s=e.currentHasImages,o=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var m=document.createElement("div");m.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=i,m.appendChild(p);var l=document.createElement("span");l.className="ikr-minimal-stars",l.innerHTML=oe(i,t),m.appendChild(l);var v=document.createElement("span");v.className="ikr-minimal-count",v.textContent=n.toLocaleString("tr-TR")+" Yorum",m.appendChild(v),c.appendChild(m),d.appendChild(c);var f=te({widget:r,currentOrderBy:a,currentHasImages:s,onWriteClick:Y,onSortChange:o}),g=f.querySelector(".ikr-filter-wrap"),u=f.querySelector(".ikr-write-btn"),k=document.createElement("div");if(k.className="ikr-minimal-actions",u&&k.appendChild(u),g&&k.appendChild(g),d.appendChild(k),u){var w=document.createElement("button");w.className="ikr-write-btn",w.textContent=L&&L.writeButtonText||"Yorum Yap",w.onclick=Y;var h=document.createElement("div");h.className="ikr-minimal-write-row",h.appendChild(w),d.appendChild(h)}return d}var Ur={};Te(Ur,{css:()=>ma,meta:()=>pa,render:()=>ua});var Jt=`
...
`;var pa={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},ma=Jt;function ua(e){var r=e.widget,t=e.iconPair,n=e.allCount,i=e.avgRatingVal,a=e.currentOrderBy,s=e.currentHasImages,o=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-hero";var c=document.createElement("div");c.className="ikr-hero-info";var m=document.createElement("div");m.className="ikr-hero-rating-col";var p=document.createElement("span");p.className="ikr-hero-avg",p.textContent=i,m.appendChild(p);var l=document.createElement("div");l.className="ikr-hero-meta-row";var v=document.createElement("span");v.className="ikr-hero-stars",v.innerHTML=oe(i,t),l.appendChild(v);var f=document.createElement("div");f.className="ikr-hero-count",f.textContent=n.toLocaleString("tr-TR")+" Yorum",l.appendChild(f),m.appendChild(l),c.appendChild(m),d.appendChild(c);var g=te({widget:r,currentOrderBy:a,currentHasImages:s,onWriteClick:Y,onSortChange:o}),u=g.querySelector(".ikr-filter-wrap"),k=g.querySelector(".ikr-write-btn"),w=document.createElement("div");w.className="ikr-hero-actions ikr-desktop-only",k&&w.appendChild(k),u&&w.appendChild(u),d.appendChild(w);var h=te({widget:r,currentOrderBy:a,currentHasImages:s,onWriteClick:Y,onSortChange:o}),y=h.querySelector(".ikr-filter-wrap"),C=h.querySelector(".ikr-write-btn"),z=document.createElement("div");return z.className="ikr-hero-write-row",C&&z.appendChild(C),y&&z.appendChild(y),d.appendChild(z),d}var yr={classic:Yr,compact:qr,split:Gr,minimal:Vr,hero:Ur};function wr(e){return yr[e]||yr.classic}function $t(){return Object.keys(yr).map(function(e){return yr[e].css||""}).join(`
`)}var Zr={};Te(Zr,{css:()=>va,meta:()=>fa,render:()=>ga});function Ue(e,r){if(!e)return null;var t=document.createElement("div");t.className="ikr-reply";var n=document.createElement("div");n.className="ikr-reply-header";var i=document.createElement("span");i.className="ikr-reply-label",i.textContent="Ma\u011Faza Sahibi",n.appendChild(i),t.appendChild(n);var a=document.createElement("div");a.className="ikr-reply-text ikr-reply-text-clamped",a.textContent=e,t.appendChild(a);var s=document.createElement("span");return s.className="ikr-read-more ikr-reply-read-more",s.textContent="Devam\u0131n\u0131 oku",s.style.display="none",t.appendChild(s),requestAnimationFrame(function(){if(a.scrollHeight>a.clientHeight+2)if(s.style.display="inline",typeof r=="function")s.onclick=r;else{var o=!1;s.onclick=function(){o=!o,a.classList.toggle("ikr-reply-text-clamped",!o),s.textContent=o?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),t}var fa={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--ikr-card-photo-w":"80px"},medium:{"--ikr-card-photo-w":"110px"},large:{"--ikr-card-photo-w":"140px"}}},va="";function ga(e,r){var t=document.createElement("div");t.className="ikr-review ikr-review-card";var n=document.createElement("div");n.className="ikr-review-top";var i=document.createElement("div");i.className="ikr-review-top-left";var a=document.createElement("span");a.className="ikr-review-stars",a.innerHTML=xe(e.rating,L),i.appendChild(a);var s=document.createElement("span");if(s.className="ikr-date",s.textContent=ze(e.createdAt),n.appendChild(i),n.appendChild(s),t.appendChild(n),e.title){var o=document.createElement("div");o.className="ikr-review-title",o.textContent=e.title,t.appendChild(o)}var d=document.createElement("div");d.className="ikr-author",d.textContent=e.author||"",t.appendChild(d);var c=(e.comment||"").trim();if(c){var m=document.createElement("div");m.className="ikr-body ikr-body-clamped",m.textContent=c,t.appendChild(m);var p=document.createElement("span");p.className="ikr-read-more",p.textContent="Devam\u0131n\u0131 oku",p.style.display="none",t.appendChild(p),requestAnimationFrame(function(){if(m.scrollHeight>m.clientHeight+2){p.style.display="inline";var g=!1;p.onclick=function(){g=!g,m.classList.toggle("ikr-body-clamped",!g),p.textContent=g?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var l=Ce(e);if(l.length){var v=document.createElement("div");v.className="ikr-gallery",l.forEach(function(g){var u=document.createElement("img"),k=le(g,W);u.src=k.src,u.srcset=k.srcset,u.loading="lazy",u.decoding="async",u.width=W,u.height=W,u.className="ikr-img",se(u),u.setAttribute("data-ikr-img-url",g),(function(w){u.onclick=function(){ce(e,w,r)}})(g),v.appendChild(u)}),t.appendChild(v)}var f=Ue(e.merchantReply);return f&&t.appendChild(f),t}var Wr={};Te(Wr,{css:()=>ha,meta:()=>ka,render:()=>ya});var Qt=`
  .ikr-review-list{
    display:grid;
...
`;var wa={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"80px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"110px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},ba=ei;function xa(e,r){var t=fr(e),n=!!t,i=document.createElement("div");i.className="ikr-review-gallery"+(n?"":" ikr-review-gallery--no-media");var a=document.createElement("div");a.className="ikr-review-gallery-content";var s=document.createElement("span");if(s.className="ikr-review-stars ikr-review-gallery-stars",s.innerHTML=xe(e.rating,L),a.appendChild(s),e.title){var o=document.createElement("div");o.className="ikr-review-gallery-title",o.textContent=e.title,a.appendChild(o)}var d=document.createElement("div");d.className="ikr-review-gallery-author",d.textContent=e.author||"",a.appendChild(d);var c=document.createElement("div");c.className="ikr-review-gallery-date",c.textContent=ze(e.createdAt),a.appendChild(c);var m=(e.comment||"").trim();if(m){var p=document.createElement("div");p.className="ikr-review-gallery-body ikr-body-clamped",p.textContent=m,a.appendChild(p);var l=document.createElement("span");l.className="ikr-read-more",l.textContent="Devam\u0131n\u0131 oku",l.style.display="none",l.style.cursor="pointer";var v=!1;l.onclick=function(){if(t){ce(e,t,r);return}v=!v,p.classList.toggle("ikr-body-clamped",!v),l.textContent=v?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"},a.appendChild(l),requestAnimationFrame(function(){p.scrollHeight>p.clientHeight+2&&(l.style.display="inline")})}if(i.appendChild(a),n){var f=document.createElement("div");f.className="ikr-review-gallery-media";var g=document.createElement("img"),u=le(t,vr);g.src=u.src,g.srcset=u.srcset,g.loading="lazy",g.decoding="async",g.width=vr,g.height=Math.round(vr*4/3),se(g),g.setAttribute("data-ikr-img-url",t),g.onclick=function(){ce(e,t,r)},f.appendChild(g),i.appendChild(f)}var k=Ue(e.merchantReply,t?function(){ce(e,t,r)}:null);return k&&(k.classList.add("ikr-review-gallery-reply"),i.appendChild(k)),i}var br={card:Zr,list:Wr,gallery:Kr};function nr(e){return br[e]||br.card}function ri(){return Object.keys(br).map(function(e){return br[e].css||""}).join(`
`)}function He(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),i=parseInt(t[2],16),a=parseInt(t[3],16);return"rgba("+n+","+i+","+a+","+r+")"}function za(){var e=document.getElementById("ikas-reviews-anchor");if(e)return e;e=document.createElement("div"),e.id="ikas-reviews-anchor",e.setAttribute("data-ikr-auto-anchor","1");var r=null;try{r=document.querySelector(qe)}catch(n){}if(r&&r.parentNode)return r.parentNode.insertBefore(e,r.nextSibling),e;var t=document.querySelector("main")||document.body;return t?(t.appendChild(e),e):null}var ti={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},ii={small:80,medium:110,large:140};function Ca(e,r){var t=document.createElement("div");t.className="ikr-state-msg ikr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="ikr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var i=document.createElement("button");return i.type="button",i.className="ikr-state-retry",i.textContent="Tekrar Dene",i.onclick=async function(){i.disabled=!0,i.textContent="Tekrar deneniyor...",await r()},t.appendChild(i),t}function Sa(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",i=r.headerCountColor||"#111111",a=r.headerRecommendColor||"#111111",s=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",c=He(s,.06),m=r.reviewStarColor||"#f59e0b",p=m,l=r.btnBgColor||"#111111",v=r.btnTextColor||"#ffffff",f=r.btnBorderColor||"#111111",g=r.filterBtnBgColor||"#111111",u=r.filterBtnTextColor||"#ffffff",k=r.filterBtnBorderColor||"#111111",w=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",y=r.filterItemTextColor||"#111111",C=r.filterItemHoverBgColor||"#f3f4f6",z=r.filterItemActiveColor||"#111111",b=r.reviewTitleColor||"#111111",x=r.reviewAuthorColor||"#111111",E=r.reviewDateColor||"#5e5e5e",S=r.reviewBodyColor||"#111111",I=r.reviewBorderColor||"#e5e7eb",N=r.replyBgColor||"#f9fafb",T=r.replyBorderColor||"#747474",H=r.replyLabelColor||"#111111",ue=r.replyTextColor||"#111111",K=r.photoTitleColor||"#111111",fe=He("#111111",.05),ve=r.photoArrowBgColor||"#ffffff",X=r.photoArrowTextColor||"#111111",V=He("#111111",.12),O=r.formBgColor||"#ffffff",ge=r.formPrimaryTextColor||"#111111",ke=r.formSecondaryTextColor||"#3b3b3b",U=r.inputTextColor||ge,Ee=r.inputBorderColor||"#d1d5db",Fe=r.placeholderColor||"#9ca3af",he=r.formStepBarColor||"#111111",ie=r.formBtnBgColor||"#111111",D=r.formBtnTextColor||"#ffffff",Ke=r.formBtnBorderColor||"#111111",ye=He(ie,.06),Ne=He(ie,.18),we=He(D,.85),Q=He(ge,.06),ae=r.loadMoreBgColor||"#ffffff",Pe=r.loadMoreTextColor||"#111111",J=r.loadMoreBorderColor||"#111111",B={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":t,"--ikr-header-avg":n,"--ikr-header-count":i,"--ikr-header-recommend":a,"--ikr-bar-fill":s,"--ikr-bar-track":o,"--ikr-star-empty-color":p,"--ikr-bar-count":d,"--ikr-bar-hover-bg":c,"--ikr-btn-bg":l,"--ikr-btn-text":v,"--ikr-btn-border":f,"--ikr-filter-btn-bg":g,"--ikr-filter-btn-text":u,"--ikr-filter-btn-border":k,"--ikr-filter-menu-bg":w,"--ikr-filter-menu-border":h,"--ikr-filter-item-text":y,"--ikr-filter-item-hover-bg":C,"--ikr-filter-item-active":z,"--ikr-review-title":b,"--ikr-review-author":x,"--ikr-review-date":E,"--ikr-review-body":S,"--ikr-review-border":I,"--ikr-review-star-color":m,"--ikr-reply-bg-color":N,"--ikr-reply-border":T,"--ikr-reply-label":H,"--ikr-reply-text":ue,"--ikr-photo-title":K,"--ikr-photo-image-border":fe,"--ikr-photo-arrow-bg":ve,"--ikr-photo-arrow-text":X,"--ikr-photo-arrow-border":V,"--ikr-fwizard-bg":O,"--ikr-fwizard-text":ge,"--ikr-fwizard-secondary-text":ke,"--ikr-fwizard-input-bg":O,"--ikr-fwizard-input-text":U,"--ikr-fwizard-input-border":Ee,"--ikr-fwizard-placeholder":Fe,"--ikr-fwizard-close-text":ge,"--ikr-fwizard-close-hover-bg":Q,"--ikr-fwizard-progress-bg":Q,"--ikr-fwizard-progress-active":he,"--ikr-fwizard-btn-bg":ie,"--ikr-fwizard-btn-text":D,"--ikr-fwizard-btn-border":Ke,"--ikr-fwizard-btn-disabled-bg":Ne,"--ikr-fwizard-btn-disabled-text":we,"--ikr-fwizard-nav-hover-bg":ye,"--ikr-load-more-bg":ae,"--ikr-load-more-text":Pe,"--ikr-load-more-border":J};Object.keys(B).forEach(function(ne){e.style.setProperty(ne,B[ne])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function me(e,r,t,n,i,a,s){if(_r){cr({productId:e,settings:r,reviewsData:t,productName:n,orderBy:i,page:a,badgeSettings:s});return}dr(!0),ot(e),lt(r),s!==void 0&&st(s),dt(n),i&&je(i),a&&Be(a),t!=null&&ct(t);try{let Cr=function(A,_){if(!(!A||!A.meta||!A.meta.sizeOverrides)){var R=A.meta.sizeOverrides[_];R&&Object.keys(R).forEach(function(_e){l.style.setProperty(_e,R[_e])})}};var Ga=Cr,o=wr(r.summaryLayout),d=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),c=r.showTitle!==!1,m=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",p=d&&c?m:"",l=document.documentElement;Sa(l,r),xt("#111111",It+$t()+ri());var v=r.borderRadius!==void 0?r.borderRadius:8,f=ti[r.size]||ti.medium,g=ii[r.thumbnailSize]||ii.medium,u=nr(r.reviewLayout);if(u.meta&&u.meta.sizeOverrides&&u.meta.sizeOverrides[r.size]){var k=u.meta.sizeOverrides[r.size],w=k["--ikr-list-photo-w"]||k["--ikr-gallery-photo-w"];w&&(g=parseInt(w))}l.style.setProperty("--ikr-title-size",f.titleSize+"px"),l.style.setProperty("--ikr-review-text-size",f.reviewTextSize+"px"),l.style.setProperty("--ikr-review-title-size",f.reviewTitleSize+"px"),l.style.setProperty("--ikr-author-size",f.authorSize+"px"),l.style.setProperty("--ikr-reply-name-size",f.replyNameSize+"px"),l.style.setProperty("--ikr-reply-text-size",f.replyTextSize+"px"),l.style.setProperty("--ikr-radius",v+"px"),l.style.setProperty("--ikr-radius-sm",Math.max(0,v-4)+"px"),l.style.setProperty("--ikr-photo-title-size",f.photoTitleSize+"px"),l.style.setProperty("--ikr-avg-rating-size",f.avgRatingSize+"px"),l.style.setProperty("--ikr-review-count-size",f.reviewCountSize+"px"),l.style.setProperty("--ikr-compact-count-size",f.compactCountSize+"px"),l.style.setProperty("--ikr-recommend-size",f.recommendSize+"px"),l.style.setProperty("--ikr-btn-text-size",f.btnTextSize+"px"),l.style.setProperty("--ikr-bar-label-size",f.barLabelSize+"px"),l.style.setProperty("--ikr-minimal-avg-size",f.minimalAvgSize+"px"),l.style.setProperty("--ikr-hero-avg-size",f.heroAvgSize+"px"),l.style.setProperty("--ikr-bar-count-size",f.barCountSize+"px"),l.style.setProperty("--ikr-review-date-size",f.reviewDateSize+"px"),l.style.setProperty("--ikr-filter-text-size",f.filterTextSize+"px"),l.style.setProperty("--ikr-load-more-size",f.loadMoreSize+"px"),l.style.setProperty("--ikr-read-more-size",f.readMoreSize+"px"),l.style.setProperty("--ikr-thumbnail-size",g+"px");var h=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";l.style.setProperty("--ikr-review-star-color",h),l.style.setProperty("--ikr-star-empty-color",h),l.style.setProperty("--ikr-star-size",f.reviewStarSize+"px"),l.style.setProperty("--ikr-avg-star-size",f.avgStarSize+"px"),Cr(wr(r.summaryLayout),r.size),Cr(nr(r.reviewLayout),r.size);var y=Me(r),C=document.getElementById("ikas-reviews");if(!C){var z=za();if(!z)return;C=document.createElement("div"),C.id="ikas-reviews",C.style.minHeight="200px",z.appendChild(C)}if(r.enabled===!1){C.style.minHeight="auto",C.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',dr(!1);var b=Je;cr(null),b&&me(b.productId,b.settings,b.reviewsData,b.productName,b.orderBy,b.page,b.badgeSettings);return}C.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var x=t||{},E=Xr(x),S=E?[]:x.data&&x.data.reviews||[],I=E?0:x.data&&x.data.totalCount||0;ft(S);var N=C.cloneNode(!1);C.parentNode.replaceChild(N,C),C=N;var T=document.createElement("div");if(T.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(T.style.width="100%",T.style.maxWidth="100%",T.style.marginLeft="0",T.style.marginRight="0"),p){var H=document.createElement("div"),ue=r.summaryLayout||"classic";H.className="ikr-title ikr-title-"+ue,H.textContent=p,T.appendChild(H)}if(E){T.appendChild(Ca(x.message,async function(){var A=await Oe(Z,$,1,Le,Ae);await me(Z,L,A,be,$,1,lr)})),C.appendChild(T);return}var K=x.data&&x.data.allCount||0,fe=x.data&&x.data.ratingCounts||null,ve=fe||[0,0,0,0,0],X=x.data&&x.data.avgRating||"0.0";if(!fe&&S.length>0){S.forEach(function(A){A.rating>=1&&A.rating<=5&&ve[A.rating-1]++});var V=S.reduce(function(A,_){return A+_.rating},0);X=(V/S.length).toFixed(1)}if(K>0){var O=wr(r.summaryLayout),ge=O.render({widget:T,data:x,settings:r,iconPair:y,allCount:K,ratingCounts:ve,avgRatingVal:X,currentRatingFilter:Le,currentOrderBy:$,currentHasImages:Ae,onFilterChange:async function(A){sr(Le===A?null:A),Be(1);var _=await Oe(Z,$,1,Le,Ae);await me(Z,L,_,be,$,1)},onSortChange:async function(A,_){Be(1),_?(Pr(!0),je("newest")):(Pr(!1),je(A));var R=await Oe(Z,$,1,Le,Ae);await me(Z,L,R,be,$,1)}});T.appendChild(ge)}else{var ke=document.createElement("button");ke.className="ikr-write-btn",ke.style.cssText="display:block;margin:16px auto 0;",ke.textContent=r.writeButtonText||"Yorum Yap",ke.onclick=Y,T.appendChild(ke)}var U=(Nr||[]).filter(function(A){return Ce(A).length>0});if(r.showPhotoGallery!==!1&&!Ae&&U.length>0){var Ee=document.createElement("div");if(Ee.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var Fe=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",he=document.createElement("div");he.className="ikr-photo-title",he.textContent=Fe,Ee.appendChild(he)}var ie=r.reviewLayout==="card"?"1/1":"3/4";l.style.setProperty("--ikr-photo-thumb-aspect",ie);var D=document.createElement("div");D.className="ikr-photo-strip";var Ke=W,ye=r.reviewLayout==="card"?W:Math.round(W*4/3),Ne=0;U.forEach(function(A){if(!(Ne>=15)){var _=fr(A);if(_){var R=document.createElement("img"),_e=le(_,W);R.src=_e.src,R.srcset=_e.srcset,R.loading=Ne<3?"eager":"lazy",R.decoding="async",R.width=Ke,R.height=ye,R.className="ikr-photo-strip-thumb",R.alt="Yorum foto\u011Fraf\u0131",se(R),(function(hi,yi){R.onclick=function(){ce(yi,hi,U)}})(_,A),D.appendChild(R),Ne++}}});var we=document.createElement("button");we.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",we.innerHTML="&#8249;",we.setAttribute("aria-label","\xD6nceki"),we.onclick=function(){D.scrollBy({left:-200,behavior:"smooth"})};var Q=document.createElement("button");Q.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",Q.innerHTML="&#8250;",Q.setAttribute("aria-label","Sonraki"),Q.onclick=function(){D.scrollBy({left:200,behavior:"smooth"})};var ae=document.createElement("div");ae.className="ikr-photo-strip-wrap",ae.appendChild(we),ae.appendChild(D),ae.appendChild(Q),Ee.appendChild(ae),T.appendChild(Ee)}if(S.length===0){var Pe=document.createElement("p");Pe.className="ikr-state-msg",Pe.textContent="Hen\xFCz yorum yok.",T.appendChild(Pe)}else{var u=nr(r.reviewLayout);S.forEach(function(_){T.appendChild(u.render(_,De))})}var J=x.data&&x.data.hasMore;if(J){var B=document.createElement("button");B.className="ikr-load-more",B.textContent="Daha Fazla G\xF6ster",B.onclick=async function(){B.disabled=!0,B.textContent="Y\xFCkleniyor...";var A=Xe+1,_=await Oe(Z,$,A,Le,Ae);if(_&&!Xr(_)&&_.data&&Array.isArray(_.data.reviews)){vt(_.data.reviews),Be(A);var R=nr(L.reviewLayout);_.data.reviews.forEach(function(_e){T.insertBefore(R.render(_e,De),B)}),_.data.hasMore?(B.disabled=!1,B.textContent="Daha Fazla G\xF6ster"):B.remove()}else B.disabled=!1,B.textContent="Tekrar Dene"},T.appendChild(B)}C.appendChild(T),At(K>0?X:null,I,n,lr)}catch(A){console.error("[ikr] render error:",A),C.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(dr(!1),Je){var ne=Je;cr(null),me(ne.productId,ne.settings,ne.reviewsData,ne.productName,ne.orderBy,ne.page,ne.badgeSettings)}}}var Ea=15,Ie="ikr_settings_"+F,Ta=300*1e3,La=10080*60*1e3,Aa=30*1e3;async function $r(){if(window.__ikasPreviewMode){try{var e=window.__ikasPreviewBaseUrl||q,r=window.__ikasPreviewSettings||sessionStorage.getItem("ikr_preview_settings")||"",t={};if(r)try{t=JSON.parse(r)}catch(p){}var n=await re(e+"/api/preview/settings");if(n.ok){var i=await n.json();return i.widgets&&i.widgets.reviews&&Object.keys(t).length&&(i.widgets.reviews=Object.assign({},i.widgets.reviews,t)),i}}catch(p){}return null}var a=null,s=er(Ie);if(s)try{var o=JSON.parse(s);if(o&&o.t!==void 0)if(o.notFound){if(Date.now()-o.t<Aa)return null;M(Ie,"")}else if(o.v){var d=Date.now()-o.t;if(d<Ta)return o.v;d<La?a=o.v:M(Ie,"")}else M(Ie,"");else M(Ie,"")}catch(p){M(Ie,"")}try{var c=await re(q+"/api/public/settings?publicApiKey="+encodeURIComponent(F));if(!c.ok)return c.status===404&&M(Ie,JSON.stringify({t:Date.now(),notFound:!0})),a||null;var m=await c.json();return M(Ie,JSON.stringify({t:Date.now(),v:m})),m}catch(p){return console.error("[ikr] fetchSettings error:",p),a||null}}var Ia=60*1e3,ai="__ikrReviewsFetchError";function xr(e){return{type:ai,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function Xr(e){return!!(e&&e.type===ai)}async function Oe(e,r,t,n,i,a){if(window.__ikasPreviewMode){try{var s=window.__ikasPreviewBaseUrl||q,o=s+"/api/preview/reviews?page="+encodeURIComponent(t||1),d=await re(o);if(d.ok)return await d.json()}catch(k){}return xr()}r=r||"newest",t=t||1;var c=a?"_l"+a:"",m="ikr_reviews_"+F+"_"+e+"_"+r+"_"+t+"_"+(n||"")+"_"+(i?"1":"0")+c,p=null,l=er(m);if(l)try{var v=JSON.parse(l);if(v&&v.t!==void 0&&v.v){if(Date.now()-v.t<Ia)return v.v;p=v.v,M(m,"")}else M(m,"")}catch(k){M(m,"")}try{var f=q+"/api/public/reviews?storeId="+encodeURIComponent(F)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(t)+(n?"&rating="+encodeURIComponent(n):"")+(i?"&hasImages=true":"")+(a?"&limit="+encodeURIComponent(a):""),g=await re(f);if(!g.ok)return p||xr();var u=await g.json();return M(m,JSON.stringify({t:Date.now(),v:u})),u}catch(k){return console.error("[ikr] fetchReviews error:",k),p||xr()}}async function Na(e){var r=await Oe(e,"newest",1,null,!0,Ea);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}var Jr={};async function Ze(e,r){var t=document.getElementById("ikr-rating-badge");t&&t.remove();var n=document.getElementById("ikr-jsonld");if(n&&n.remove(),!Jr[e]){Jr[e]=!0;var i={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},a={enabled:!0,icon:"star",size:"medium",color:"#f59e0b"};try{var s=await $r();if(!s)return;var o=s.widgets&&s.widgets.reviews||i,d=s.widgets&&s.widgets.badge||a;if(o.enabled===!1)return;je("newest"),Be(1),sr(null);var c=await Promise.all([Oe(e,"newest",1,null),Na(e)]),m=c[0];pt(c[1]),await me(e,o,m,r,"newest",1,d)}catch(p){console.error("[ikr] bootstrap error:",p),await me(e,i,xr(),r,void 0,void 0,a)}finally{delete Jr[e]}}}function Qr(){try{var e=window.__NEXT_DATA__&&window.__NEXT_DATA__.props&&window.__NEXT_DATA__.props.pageProps;if(e&&e.pageType==="PRODUCT"&&e.pageSpecificData&&e.pageSpecificData.id)return{id:e.pageSpecificData.id,name:e.pageSpecificData.name||null}}catch(n){}if(window.IkasStorefront&&window.IkasStorefront.product&&window.IkasStorefront.product.id)return{id:window.IkasStorefront.product.id,name:window.IkasStorefront.product.name||null};var r=window.location.pathname.match(/--([a-f0-9-]{36})(?:\/|$|\?)/);if(r)return{id:r[1],name:null};var t=new URLSearchParams(window.location.search).get("productId");return t?{id:t,name:null}:null}function ni(){var e={},r={};return document.querySelectorAll("a[href]").forEach(function(t){try{var n=t.getAttribute("href");if(!n||n.charAt(0)==="#"||n.charAt(0)==="?")return;var i=j(t.href);if(!i||r[i]||!/^[a-z0-9][a-z0-9-]{2,}$/.test(i)||ur.test(i))return;r[i]=!0,e[i]=null}catch(a){}}),Object.keys($e).forEach(function(t){e[t]=$e[t]}),e}var Pa=300*1e3,oi=50;async function li(e){var r="ikr_ratings_"+F,t={},n=er(r);if(n)try{var i=JSON.parse(n);i&&i.t!==void 0&&Date.now()-i.t<Pa?t=i.v||{}:M(r,"")}catch(c){M(r,"")}var a=e.filter(function(c){return!t[c]});if(!a.length)return t;for(var s=[],o=0;o<a.length;o+=oi)s.push(a.slice(o,o+oi));var d=await Promise.all(s.map(function(c){var m=q+"/api/public/ratings-by-slug?storeId="+encodeURIComponent(F)+"&slugs="+c.map(encodeURIComponent).join(",");return re(m).then(function(p){return p.ok?p.json().then(function(l){return l.data||{}}):{}}).catch(function(){return{}})}));return d.forEach(function(c){a.forEach(function(m){t[m]||(t[m]={average:0,count:0,_empty:!0})}),Object.keys(c).forEach(function(m){t[m]=c[m]})}),M(r,JSON.stringify({t:Date.now(),v:t})),t}var _a="var(--ikr-badge-color,#f59e0b)",si=13,Ba="display:flex;align-items:center;gap:3px;margin-top:0px;margin-bottom:4px;font-size:13px;font-weight:400;color:#555;pointer-events:none;";function Ra(e){var r=rr("star","classic"),t="width:"+si+"px;height:"+si+"px;";return'<span style="color:'+_a+';display:inline-flex;align-items:center;">'+oe(e,r,{sizeStyle:t})+"</span>"}function or(e,r){var t=document.createElement("div");return t.setAttribute("data-ikr-listing-badge","1"),t.style.cssText=Ba+"justify-content:"+(r||"flex-start")+";",t.innerHTML=Ra(e.avg)+'<span style="font-weight:400;">'+e.avg+" ("+e.count+")</span>",t}var di='[class*="productTitle"],[class*="productName"],[class*="product_title"],[class*="product_name"],[class*="product-title"],[class*="product-name"]',Ma=/^(tükendi|sold out|out of stock|stokta yok|satıldı|unavailable)$/i;function et(e,r){var t=e.querySelector(Nt);if(t)return t;if(e.matches&&e.matches(di))return e;var n=e.querySelector(di);if(n)return n;if(r){for(var i=e.querySelectorAll("*"),a=0;a<i.length;a++)if(i[a].children.length===0&&i[a].textContent.trim()===r)return i[a]}for(var s=e.querySelectorAll("p, h1, h2, h3, h4, h5, h6, span, div"),o=0;o<s.length;o++){var d=s[o],c=d.textContent.trim();if(!(!c||c.length<2||c.length>150)&&!/^[\d\s.,₺$€£%]+$/.test(c)&&!Ma.test(c)&&!(d.closest("figure")||d.closest("picture"))&&!(d.children.length>1))return d}return null}function Ha(e,r,t,n){if(!e.getAttribute("data-ikr-badge")){var i=j(e.href);if(e.id==="ikr-rating-badge"){e.setAttribute("data-ikr-badge","1");return}if(i===n&&e.getAttribute("href")&&e.getAttribute("href").charAt(0)==="#"){e.setAttribute("data-ikr-badge","1");return}if(e.closest("header")||e.closest("nav")){e.setAttribute("data-ikr-badge","1");return}if(e.closest('[class*="basket"]')||e.closest('[class*="cart"]')){e.setAttribute("data-ikr-badge","1");return}if(e.closest(qe)&&!e.closest(Or)){e.setAttribute("data-ikr-badge","1");return}if(i===n&&e.closest(Or)){e.setAttribute("data-ikr-badge","1");return}if(e.closest(Bt)){e.setAttribute("data-ikr-badge","1");return}var a=!!e.querySelector("a[href]"),s=Array.from(e.childNodes).filter(function(f){return f.nodeType===3}).map(function(f){return f.textContent.trim()}).join("").trim(),o=!!et(e,t);if(!s&&!o&&!a){e.setAttribute("data-ikr-badge","1");return}if(e.setAttribute("data-ikr-badge","1"),a){e.querySelectorAll("a[href]").forEach(function(f){f.setAttribute("data-ikr-badge","1")});var d=et(e,t);if(!d||d.querySelector("[data-ikr-listing-badge]"))return;var c=window.getComputedStyle(d).textAlign;d.appendChild(or(r,c==="center"?"center":c==="right"?"flex-end":"flex-start"));return}var m=et(e,t);if(!(m&&m.querySelector("[data-ikr-listing-badge]")))if(m){var p=window.getComputedStyle(m).textAlign;m.appendChild(or(r,p==="center"?"center":p==="right"?"flex-end":"flex-start"))}else{var l=or(r,"flex-start"),v=e.firstElementChild;v?e.insertBefore(l,v):e.appendChild(l)}}}function Oa(e,r){var t=document.querySelector(Pt);if(t){var n=t.querySelector(_t);if(!(!n||n.querySelector("[data-ikr-listing-badge]"))){var i=null;if(Qe&&r[Qe]&&(i=Qe),!i){var a=j(window.location.pathname);a&&r[a]&&(i=a)}if(!i){var s=n.textContent.trim();Object.keys(e).forEach(function(p){if(!i){var l=e[p];l&&l.trim()===s&&r[p]&&(i=p)}})}if(!i){var o=document.querySelector(qe);if(o){var d=o.querySelector("a[href]");if(d){var c=j(d.href);c&&r[c]&&(i=c)}}}if(!i){var m=n.textContent.trim().toLowerCase();document.querySelectorAll("a[href]").forEach(function(p){if(!i&&!(p.closest("header")||p.closest("nav"))&&!p.closest(qe)){var l=p.textContent.trim().toLowerCase();if(l&&l===m){var v=j(p.href);v&&r[v]&&(i=v)}}})}!i||!r[i]||r[i]._empty||r[i].count===0||n.appendChild(or(r[i],"flex-start"))}}}function ci(e,r){var t=j(window.location.pathname),n=document.querySelectorAll(Rt),i=[];n.forEach(function(a){a.tagName==="A"&&a.href?i.push(a):a.querySelectorAll("a[href]").forEach(function(s){i.push(s)})}),Object.keys(e).forEach(function(a){var s=r[a];if(!(!s||s._empty||s.count===0)){var o=e[a];i.forEach(function(d){j(d.href)===a&&Ha(d,s,o,t)})}}),Oa(e,r)}async function We(){if(P.inProgress){P.queued=!0;return}if(!P.rendered){P.rendered=!0,P.inProgress=!0;try{var e=P.navCleanup;e&&(P.navCleanup=!1);var r=ni();if(!Object.keys(r).length){P.rendered=!1;return}var t=await Promise.all([$r(),li(Object.keys(r))]),n=t[0];if(!n){P.rendered=!1;return}var i=t[1],a=n&&n.widgets||{},s=a.badge&&a.badge.color||"#f59e0b";if(a.badge&&a.badge.enabled===!1){P.rendered=!1;return}document.documentElement.style.setProperty("--ikr-badge-color",s),e&&(document.querySelectorAll("[data-ikr-listing-badge]").forEach(function(o){o.remove()}),document.querySelectorAll("[data-ikr-badge]").forEach(function(o){o.removeAttribute("data-ikr-badge")})),ci(r,i)}finally{P.inProgress=!1,P.queued&&(P.queued=!1,P.rendered=!1,We())}}}var pi=!1,mi=!1;function vi(){mi||(mi=!0,document.addEventListener("click",function(e){var r=e.target.closest("a[href]");if(r&&!(r.closest("header")||r.closest("nav"))&&!(r.closest('[class*="basket"]')||r.closest('[class*="cart"]'))){var t=j(r.href);!t||t.length<3||gt(t)}},!0))}var ui=!1,fi=typeof location!="undefined"?location.pathname:"";function zr(){try{if(location.pathname===fi)return;fi=location.pathname;var e=document.getElementById("ikr-rating-badge");e&&e.remove();var r=document.getElementById("ikr-jsonld");r&&r.remove()}catch(t){}}function Fa(){if(!ui){ui=!0;var e=history.pushState,r=history.replaceState;history.pushState=function(){var t=e.apply(this,arguments);return zr(),t},history.replaceState=function(){var t=r.apply(this,arguments);return zr(),t},window.addEventListener("popstate",zr),window.addEventListener("hashchange",zr)}}function rt(){if(Fa(),window.IkasEvents){if(pi)return;pi=!0,window.IkasEvents.subscribe({id:"ikas-reviews-widget",callback:function(a){if(a&&a.type==="VIEW_LISTING"){var s=a.data&&a.data.productDetails;Array.isArray(s)&&s.forEach(function(m){m&&m.metaData&&m.metaData.slug&&m.name&&($e[m.metaData.slug]=m.name)})}if(a&&a.type==="PRODUCT_VIEW"){var o=a.data&&a.data.productDetail&&a.data.productDetail.id,d=a.data&&a.data.productDetail&&a.data.productDetail.name;o&&(M("ikr_reviews_"+F+"_"+o,""),Ze(o,d))}if(a&&a.type==="PAGE_VIEW"){var c=Date.now();if(P.lastPageView&&c-P.lastPageView<800)return;P.lastPageView=c,P.navCleanup=!0,P.rendered=!1,We()}}});var e=Qr();if(e)Ze(e.id,e.name);else{let a=function(){var s=Qr();s?Ze(s.id,s.name):r<20&&(r++,setTimeout(a,100))};var n=a,r=0;setTimeout(a,100)}setTimeout(function(){P.rendered||We()},2e3)}else{let a=function(){window.IkasEvents?rt():t<100&&(t++,setTimeout(a,50))};var i=a,t=0;setTimeout(a,50)}}var gi=null;function ki(){if(typeof MutationObserver!="undefined"){var e=new MutationObserver(function(r){var t=r.some(function(n){return Array.from(n.addedNodes).some(function(i){return!(i.nodeType!==1||i.hasAttribute&&(i.hasAttribute("data-ikr-listing-badge")||i.id==="ikr-rating-badge"||i.id==="ikr-reviews-widget")||i.closest&&(i.closest("[data-ikr-listing-badge]")||i.closest("#ikr-rating-badge")||i.closest("#ikr-reviews-widget"))||i.querySelector&&i.querySelector("[data-ikr-listing-badge],#ikr-reviews-widget,#ikr-rating-badge"))})});t&&(clearTimeout(gi),gi=setTimeout(function(){var n=Array.from(document.querySelectorAll("a[href]")).some(function(i){if(i.getAttribute("data-ikr-badge"))return!1;var a=j(i.href);return a&&a.length>=3&&!ur.test(a)});n&&(P.rendered=!1,We())},300))});e.observe(document.body,{childList:!0,subtree:!0})}}var Da=window.__ikasPreviewMode===!0;if(Da){let e=function(){try{window.parent.postMessage({type:"IKR_WIDGET_READY"},"*")}catch(t){}},r=function(){Ze("mock-product","\xD6rnek \xDCr\xFCn"),e()};ja=e,Ya=r,window.addEventListener("message",function(t){var n=t.data;if(!(!n||n.type!=="IKR_SETTINGS_UPDATE")){var i=n.settings;if(!(!i||!L)){var a=Object.assign({},L,i);me(Z,a,Ir,be,$,Xe),window.dispatchEvent(new CustomEvent("IKR_SETTINGS_UPDATED_PREVIEW"))}}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()}else if(F){let e=function(){rt(),vi(),ki()};qa=e,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}var ja,Ya,qa;})();
