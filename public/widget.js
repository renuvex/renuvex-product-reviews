/* ikas Reviews Widget — built 2026-05-12T01:42:33.754Z | theme: default */
...
`;var va={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ka=ti;function ga(e){var r=e.widget,t=e.settings,n=e.iconPair,i=e.allCount,a=e.ratingCounts,l=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,u=e.onFilterChange,p=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-compact";var f=document.createElement("div");f.className="ikr-compact-header";var v=document.createElement("div");v.className="ikr-compact-trigger-wrap";var k=document.createElement("button");k.className="ikr-compact-trigger",k.type="button",k.setAttribute("aria-expanded","false"),k.innerHTML='<span class="ikr-compact-trigger-stars">'+se(l,n)+'</span><span class="ikr-compact-trigger-text">'+i.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',v.appendChild(k),f.appendChild(v);var m=ie({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),g=m.querySelector(".ikr-filter-wrap"),b=m.querySelector(".ikr-write-btn"),x=document.createElement("div");x.className="ikr-compact-actions-slot",b&&x.appendChild(b),g&&x.appendChild(g),f.appendChild(x),s.appendChild(f);var w=document.createElement("div");w.className="ikr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="ikr-compact-panel-inner";var z=document.createElement("div");z.className="ikr-compact-avg",z.innerHTML='<span class="ikr-icon">'+n.filled+"</span><span>"+l+"</span>",S.appendChild(z),S.appendChild(Ve({ratingCounts:a,allCount:i,iconPair:n,currentRatingFilter:o,onFilterChange:u})),w.appendChild(S);var C=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function h(U){var O=U?s:v;w.parentNode!==O&&(w.classList.contains("ikr-open")&&(w.classList.remove("ikr-open"),w.setAttribute("aria-hidden","true"),k.setAttribute("aria-expanded","false")),O.appendChild(w))}if(h(C?C.matches:!1),C){var E=function(U){h(U.matches)};C.addEventListener?C.addEventListener("change",E):C.addListener&&C.addListener(E)}if(b){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent=I&&I.writeButtonText||"Yorum Yap",T.onclick=Y;var y=document.createElement("div");y.className="ikr-compact-write-row",y.appendChild(T),s.appendChild(y)}function A(){w.classList.remove("ikr-open"),w.setAttribute("aria-hidden","true"),k.setAttribute("aria-expanded","false")}function L(){hr(B),w.classList.add("ikr-open"),w.setAttribute("aria-hidden","false"),k.setAttribute("aria-expanded","true")}k.onclick=function(){w.classList.contains("ikr-open")?A():L()};var B=null;function V(U){B&&(B(),B=null),U||(B=yr({trigger:v,element:w,close:A}))}if(V(C?C.matches:!1),C){var J=function(U){V(U.matches)};C.addEventListener?C.addEventListener("change",J):C.addListener&&C.addListener(J)}if(t.showRecommendation!==!1){var ve=(a[3]||0)+(a[4]||0),ke=i>0?Math.round(ve/i*100):0;if(ke>0){var $=document.createElement("div");$.className="ikr-summary-block ikr-summary-recommend",$.style.marginTop="8px",$.innerHTML='<span class="ikr-recommend-pct">%'+ke+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild($)}}return s}var Wr={};Te(Wr,{css:()=>ya,meta:()=>ha,render:()=>ba});var ii=`
...
`;var wa={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},xa=ai;function za(e){var r=e.widget,t=e.iconPair,n=e.allCount,i=e.avgRatingVal,a=e.currentOrderBy,l=e.currentHasImages,o=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var u=document.createElement("div");u.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=i,u.appendChild(p);var s=document.createElement("span");s.className="ikr-minimal-stars",s.innerHTML=se(i,t),u.appendChild(s);var f=document.createElement("span");f.className="ikr-minimal-count",f.textContent=n.toLocaleString("tr-TR")+" Yorum",u.appendChild(f),c.appendChild(u),d.appendChild(c);var v=ie({widget:r,currentOrderBy:a,currentHasImages:l,onWriteClick:Y,onSortChange:o}),k=v.querySelector(".ikr-filter-wrap"),m=v.querySelector(".ikr-write-btn"),g=document.createElement("div");if(g.className="ikr-minimal-actions",m&&g.appendChild(m),k&&g.appendChild(k),d.appendChild(g),m){var b=document.createElement("button");b.className="ikr-write-btn",b.textContent=I&&I.writeButtonText||"Yorum Yap",b.onclick=Y;var x=document.createElement("div");x.className="ikr-minimal-write-row",x.appendChild(b),d.appendChild(x)}return d}var Jr={};Te(Jr,{css:()=>Sa,meta:()=>Ca,render:()=>Ea});var ni=`
