...
`;var et={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},rt=oi;function it(e){var r=e.widget,i=e.settings,a=e.iconPair,t=e.allCount,n=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,m=e.onFilterChange,p=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var u=document.createElement("div");u.className="ikr-compact-trigger-wrap";var v=document.createElement("button");v.className="ikr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="ikr-compact-trigger-stars">'+oe(d,a)+'</span><span class="ikr-compact-trigger-text">'+t.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',u.appendChild(v),k.appendChild(u);var f=re({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:D,onSortChange:p}),z=f.querySelector(".ikr-filter-wrap"),b=f.querySelector(".ikr-write-btn"),y=document.createElement("div");y.className="ikr-compact-actions-slot",b&&y.appendChild(b),z&&y.appendChild(z),k.appendChild(y),l.appendChild(k);var g=document.createElement("div");g.className="ikr-compact-panel",g.setAttribute("role","dialog"),g.setAttribute("aria-hidden","true");var w=document.createElement("div");w.className="ikr-compact-panel-inner";var h=document.createElement("div");h.className="ikr-compact-avg",h.innerHTML='<span class="ikr-icon">'+a.filled+"</span><span>"+d+"</span>",w.appendChild(h),w.appendChild(Ne({ratingCounts:n,allCount:t,iconPair:a,currentRatingFilter:o,onFilterChange:m})),g.appendChild(w);var x=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(Y){var W=Y?l:u;g.parentNode!==W&&(g.classList.contains("ikr-open")&&(g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),W.appendChild(g))}if(C(x?x.matches:!1),x){var S=function(Y){C(Y.matches)};x.addEventListener?x.addEventListener("change",S):x.addListener&&x.addListener(S)}if(b){var E=document.createElement("button");E.className="ikr-write-btn",E.textContent=A&&A.writeButtonText||"Yorum Yap",E.onclick=D;var N=document.createElement("div");N.className="ikr-compact-write-row",N.appendChild(E),l.appendChild(N)}function P(){g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function I(){$e(R),g.classList.add("ikr-open"),g.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){g.classList.contains("ikr-open")?P():I()};var R=null;function V(Y){R&&(R(),R=null),Y||(R=Qe({trigger:u,element:g,close:P}))}if(V(x?x.matches:!1),x){var ke=function(Y){V(Y.matches)};x.addEventListener?x.addEventListener("change",ke):x.addListener&&x.addListener(ke)}if(i.showRecommendation!==!1){var de=(n[3]||0)+(n[4]||0),ce=t>0?Math.round(de/t*100):0;if(ce>0){var j=document.createElement("div");j.className="ikr-summary-block ikr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="ikr-recommend-pct">%'+ce+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",w.appendChild(j)}}return l}var kr={};be(kr,{css:()=>at,meta:()=>tt,render:()=>nt});var li=`
...
`;var ot={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},lt=si;function st(e){var r=e.widget,i=e.iconPair,a=e.allCount,t=e.avgRatingVal,n=e.currentOrderBy,d=e.currentHasImages,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var m=document.createElement("div");m.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=t,m.appendChild(p);var l=document.createElement("span");l.className="ikr-minimal-stars",l.innerHTML=oe(t,i),m.appendChild(l);var k=document.createElement("span");k.className="ikr-minimal-count",k.textContent=a.toLocaleString("tr-TR")+" Yorum",m.appendChild(k),c.appendChild(m),s.appendChild(c);var u=re({widget:r,currentOrderBy:n,currentHasImages:d,onWriteClick:D,onSortChange:o}),v=u.querySelector(".ikr-filter-wrap"),f=u.querySelector(".ikr-write-btn"),z=document.createElement("div");if(z.className="ikr-minimal-actions",f&&z.appendChild(f),v&&z.appendChild(v),s.appendChild(z),f){var b=document.createElement("button");b.className="ikr-write-btn",b.textContent=A&&A.writeButtonText||"Yorum Yap",b.onclick=D;var y=document.createElement("div");y.className="ikr-minimal-write-row",y.appendChild(b),s.appendChild(y)}return s}var hr={};be(hr,{css:()=>ct,meta:()=>dt,render:()=>pt});var di=`
