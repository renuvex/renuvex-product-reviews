...
`;var mt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ut=fi;function ft(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,u=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-compact";var v=document.createElement("div");v.className="ikr-compact-header";var k=document.createElement("div");k.className="ikr-compact-trigger-wrap";var f=document.createElement("button");f.className="ikr-compact-trigger",f.type="button",f.setAttribute("aria-expanded","false"),f.innerHTML='<span class="ikr-compact-trigger-stars">'+re(o,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',k.appendChild(f),v.appendChild(k);var p=ae({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:G,onSortChange:m}),g=p.querySelector(".ikr-filter-wrap"),h=p.querySelector(".ikr-write-btn"),x=document.createElement("div");x.className="ikr-compact-actions-slot",h&&x.appendChild(h),g&&x.appendChild(g),v.appendChild(x),d.appendChild(v);var b=document.createElement("div");b.className="ikr-compact-panel",b.setAttribute("role","dialog"),b.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="ikr-compact-panel-inner";var S=document.createElement("div");S.className="ikr-compact-avg",S.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+o+"</span>",T.appendChild(S),T.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:u})),b.appendChild(T);var y=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(Z){var $=Z?d:k;b.parentNode!==$&&(b.classList.contains("ikr-open")&&(b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")),$.appendChild(b))}if(w(y?y.matches:!1),y){var L=function(Z){w(Z.matches)};y.addEventListener?y.addEventListener("change",L):y.addListener&&y.addListener(L)}if(h){var E=document.createElement("button");E.className="ikr-write-btn",E.textContent="Yorum Yap",E.onclick=G;var z=document.createElement("div");z.className="ikr-compact-write-row",z.appendChild(E),d.appendChild(z)}function _(){b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")}function I(){Je(M),b.classList.add("ikr-open"),b.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true")}f.onclick=function(){b.classList.contains("ikr-open")?_():I()};var M=null;function V(Z){M&&(M(),M=null),Z||(M=$e({trigger:k,element:b,close:_}))}if(V(y?y.matches:!1),y){var X=function(Z){V(Z.matches)};y.addEventListener?y.addEventListener("change",X):y.addListener&&y.addListener(X)}if(i.showRecommendation!==!1){var J=(n[3]||0)+(n[4]||0),pe=a>0?Math.round(J/a*100):0;if(pe>0){var K=document.createElement("div");K.className="ikr-summary-block ikr-summary-recommend",K.style.marginTop="8px",K.innerHTML='<span class="ikr-recommend-pct">%'+pe+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(K)}}return d}var br={};me(br,{css:()=>vt,meta:()=>kt,render:()=>gt});var ki=`
...
`;var kt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},vt=ki;function gt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,u=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-split";var v=document.createElement("div");v.className="ikr-split-col ikr-split-left";var k=document.createElement("div");k.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",k.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+o+"</span>",v.appendChild(k);var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-count ikr-split-left-count",f.textContent=a.toLocaleString("tr-TR")+" Yorum",v.appendChild(f),d.appendChild(v);var p=document.createElement("div");p.className="ikr-split-col ikr-split-mid",p.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:u})),d.appendChild(p);var g=ae({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:G,onSortChange:m}),h=g.querySelector(".ikr-filter-wrap"),x=g.querySelector(".ikr-write-btn"),b=document.createElement("div");if(b.className="ikr-split-col ikr-split-right",x&&b.appendChild(x),h&&b.appendChild(h),d.appendChild(b),i.showRecommendation!==!1){var T=(n[3]||0)+(n[4]||0),S=a>0?Math.round(T/a*100):0;if(S>0){var y=document.createElement("div");y.className="ikr-summary-block ikr-summary-recommend",y.innerHTML='<span class="ikr-recommend-pct">%'+S+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(y)}}return d}var xr={};me(xr,{css:()=>bt,meta:()=>ht,render:()=>xt});var vi=`
...
`;var ht={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1}},bt=vi;function xt(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,n=e.currentOrderBy,o=e.currentHasImages,l=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var u=document.createElement("div");u.className="ikr-minimal-row";var m=document.createElement("span");m.className="ikr-minimal-avg",m.textContent=a,u.appendChild(m);var d=document.createElement("span");d.className="ikr-minimal-stars",d.innerHTML=re(a,i),u.appendChild(d);var v=document.createElement("span");v.className="ikr-minimal-count",v.textContent=t.toLocaleString("tr-TR")+" Yorum",u.appendChild(v),c.appendChild(u),s.appendChild(c);var k=ae({widget:r,currentOrderBy:n,currentHasImages:o,onWriteClick:G,onSortChange:l}),f=k.querySelector(".ikr-filter-wrap"),p=k.querySelector(".ikr-write-btn"),g=document.createElement("div");if(g.className="ikr-minimal-actions",p&&g.appendChild(p),f&&g.appendChild(f),s.appendChild(g),p){var h=document.createElement("button");h.className="ikr-write-btn",h.textContent="Yorum Yap",h.onclick=G;var x=document.createElement("div");x.className="ikr-minimal-write-row",x.appendChild(h),s.appendChild(x)}return s}var yr={};me(yr,{css:()=>wt,meta:()=>yt,render:()=>zt});var gi=`
