...
`;var Nt=".product-name",Rt=".add-to-basket-modal",Bt="h1.product-name",Ge=".single-product-container-main",Fr=".single-product-product-name",Mt=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),Ht=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var Gr={};Te(Gr,{meta:()=>aa,render:()=>na});function Ve(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,i=e.currentRatingFilter,a=e.onFilterChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-bars";for(var o=5;o>=1;o--){var d=r[o-1]||0,c=t>0?Math.round(d/t*100):0,u=i===o,p=document.createElement("div");p.className="ikr-bar-row"+(u?" ikr-bar-active":""),i&&!u&&(p.style.opacity="0.35");for(var l="",v=1;v<=5;v++){var f=v<=o;l+='<span class="ikr-bar-star ikr-icon '+(f?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(f?n.filled:n.empty)+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+l+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(g){p.onclick=function(){a(g)}})(o),s.appendChild(p)}return s}var pe=[],Ot=!1;function Ki(e){for(var r=pe.length-1;r>=0;r--){var t=pe[r];t.trigger&&t.trigger.contains(e.target)||t.element&&t.element.contains(e.target)||t.close()}}function Xi(e){if(e.key==="Escape")for(var r=pe.length-1;r>=0;r--)pe[r].close()}function Ji(){Ot||typeof document=="undefined"||(document.addEventListener("click",Ki,!0),document.addEventListener("keydown",Xi),Ot=!0)}function kr(e){for(var r=0;r<pe.length;r++)pe[r]!==e&&pe[r].close()}function hr(e){Ji();var r={trigger:e.trigger,element:e.element,close:e.close};return pe.push(r),function(){var n=pe.indexOf(r);n!==-1&&pe.splice(n,1)}}function te(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,i=e.onWriteClick,a=e.onSortChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-actions";var o=document.createElement("button");o.className="ikr-write-btn",o.textContent=I&&I.writeButtonText||"Yorum Yap",o.onclick=i,s.appendChild(o);var d=document.createElement("div");d.className="ikr-filter-wrap";var c=document.createElement("button");c.type="button",c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele"),c.setAttribute("aria-haspopup","menu"),c.setAttribute("aria-expanded","false");var u=I&&I.filterIcon||"lines";c.innerHTML=zt(u);var p=document.createElement("div");p.className="ikr-filter-menu",p.setAttribute("role","menu");var l=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function v(m){var h=p.classList.contains("ikr-open");if(p.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active"),c.setAttribute("aria-expanded","false"),h&&m&&m.restoreFocus)try{c.focus({preventScroll:!0})}catch(x){try{c.focus()}catch(b){}}}function f(){kr(g),p.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active"),c.setAttribute("aria-expanded","true");var m=p.querySelector(".ikr-filter-item-active")||p.querySelector(".ikr-filter-item");m&&requestAnimationFrame(function(){try{m.focus({preventScroll:!0})}catch(h){try{m.focus()}catch(x){}}})}l.forEach(function(m){var h=m[2],x=h?n:!n&&(t||"newest")===m[0],b=document.createElement("button");b.type="button",b.className="ikr-filter-item"+(x?" ikr-filter-item-active":""),b.setAttribute("role","menuitem"),b.textContent=m[1],b.onclick=function(){v({restoreFocus:!0}),a(m[0],h)},p.appendChild(b)}),c.onclick=function(){p.classList.contains("ikr-open")?v({restoreFocus:!0}):f()},d.addEventListener("keydown",function(m){m.key==="Escape"&&p.classList.contains("ikr-open")&&(m.stopPropagation(),v({restoreFocus:!0}))}),d.addEventListener("focusout",function(m){if(p.classList.contains("ikr-open")){var h=m.relatedTarget;h&&d.contains(h)||v()}});var g=hr({trigger:d,element:p,close:v});return d.appendChild(c),d.appendChild(p),s.appendChild(d),s}function Ft(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,n=document.createElement("div");n.className="ikr-fwizard-overlay",n.tabIndex=-1,n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Yorum yapma formu");var i=document.createElement("div");i.className="ikr-fwizard",n.appendChild(i);var a=document.createElement("button");a.className="ikr-fwizard-close",a.type="button",a.setAttribute("aria-label","Kapat"),a.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',i.appendChild(a);var s=document.createElement("div");s.className="ikr-fwizard-content",i.appendChild(s);var o=!1,d=null,c="",u="";function p(){var k=document.activeElement;return!k||k===document.body||k===document.documentElement?null:k}function l(k){if(!(!k||!document.contains(k)||typeof k.focus!="function"))try{k.focus({preventScroll:!0})}catch(L){try{k.focus()}catch(A){}}}function v(k){if(!k||k.disabled||k.getAttribute("aria-hidden")==="true")return!1;var L=window.getComputedStyle?window.getComputedStyle(k):null;return L&&(L.display==="none"||L.visibility==="hidden")?!1:!!(k.offsetWidth||k.offsetHeight||k.getClientRects().length)}function f(k){var L=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(k.querySelectorAll(L)).filter(v)}function g(){var k=f(s),L=f(n),A=k[0]||L[0]||n;l(A)}function m(k){if(k.key==="Tab"){var L=f(n);if(!L.length){k.preventDefault(),l(n);return}var A=L[0],T=L[L.length-1],N=document.activeElement;if(!n.contains(N)){k.preventDefault(),l(A);return}k.shiftKey&&N===A?(k.preventDefault(),l(T)):!k.shiftKey&&N===T&&(k.preventDefault(),l(A))}}function h(){var k=window.innerWidth-document.documentElement.clientWidth;c=document.body.style.overflow,u=document.body.style.paddingRight,document.body.style.overflow="hidden",k>0&&(document.body.style.paddingRight=k+"px")}function x(){document.body.style.overflow=c,document.body.style.paddingRight=u}function b(){o||(o=!0,document.removeEventListener("keydown",z),n.removeEventListener("click",S),a.removeEventListener("click",b),n.classList.remove("ikr-fwizard-open"),setTimeout(function(){n.parentNode&&n.parentNode.removeChild(n),x(),l(d);try{r()}catch(k){}},200))}function z(k){if(k.key==="Escape"){b();return}m(k)}function S(k){k.target===n&&t&&b()}document.addEventListener("keydown",z),n.addEventListener("click",S),a.addEventListener("click",b);function C(k){d=p(),k&&s.appendChild(k),document.body.appendChild(n),h(),requestAnimationFrame(function(){n.classList.add("ikr-fwizard-open"),g()})}var y=null,w=null;function E(k,L){if(L=L||"error",y){try{y.remove()}catch(A){}y=null}w&&(clearTimeout(w),w=null),y=document.createElement("div"),y.className="ikr-fwizard-toast ikr-fwizard-toast--"+L,y.textContent=k,i.appendChild(y),w=setTimeout(function(){y&&(y.classList.add("ikr-fwizard-toast--exit"),setTimeout(function(){if(y){try{y.remove()}catch(A){}y=null}},300))},4e3)}return{open:C,close:b,content:s,setAllowOutsideClose:function(k){t=!!k},setStepAttr:function(k){i.setAttribute("data-step",String(k))},focusFirstControl:g,showToast:E}}var Dt=`
...
`;var Dr=4;function Ue(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function jt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(i){try{i(t)}catch(a){}})}return{get:function(){return t},set:function(i){Object.assign(t,i),n()},goNext:function(){t.currentStep<Dr&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(i){return r.push(i),function(){r=r.filter(function(a){return a!==i})}}}}var $i='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function qt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},i=e.onSkip||function(){},a=e.onNext||function(){},s=document.createElement("div");s.className="ikr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=$i+"<span>Geri</span>",o.addEventListener("click",function(){n()}),s.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-footer-progress";for(var c=[],u=0;u<Dr;u++){var p=document.createElement("span");p.className="ikr-fwizard-progress-seg",d.appendChild(p),c.push(p)}s.appendChild(d);var l=document.createElement("button");l.type="button";var v=null;function f(m){v&&l.removeEventListener("click",v),v=m,m&&l.addEventListener("click",m)}s.appendChild(l);function g(m,h){var x=r.indexOf(m)!==-1,b=t.indexOf(m)!==-1,z=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0);if(x)m===2&&z?(l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Devam Et"),l.innerHTML="Devam Et",f(function(){a()})):(l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",l.setAttribute("aria-label","Atla"),l.innerHTML="<span>Atla</span>",f(function(){i()})),l.disabled=!1,l.classList.remove("ikr-fwizard-cta-btn--disabled"),l.style.visibility="",l.tabIndex=0;else if(b){l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Sonraki"),l.innerHTML="Sonraki",l.style.visibility="",l.tabIndex=0;var S=Ue(m,h);l.disabled=!S,l.classList.toggle("ikr-fwizard-cta-btn--disabled",!S),f(function(){l.disabled||a()})}else l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",l.innerHTML="",l.style.visibility="hidden",l.tabIndex=-1,l.disabled=!0,f(null)}return{el:s,update:function(m,h){c.forEach(function(b,z){z+1<=m?b.classList.add("ikr-fwizard-progress-seg-active"):b.classList.remove("ikr-fwizard-progress-seg-active")});var x=m<=1;o.style.visibility=x?"hidden":"",o.style.pointerEvents=x?"none":"",o.tabIndex=x?-1:0,g(m,h)},setNextDisabled:function(m){l.classList.contains("ikr-fwizard-cta-btn")&&(l.disabled=!!m,l.classList.toggle("ikr-fwizard-cta-btn--disabled",!!m))},setThanksState:function(m){o.style.visibility="hidden",d.style.visibility="hidden",l.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",l.setAttribute("aria-label","Devam Et"),l.innerHTML="Devam Et",l.style.visibility="",l.disabled=!1,l.classList.remove("ikr-fwizard-cta-btn--disabled"),f(m)}}}function Yt(e,r){r=r||{};var t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-rating";var n=!1,i=document.createElement("div");i.className="ikr-fwizard-step-title",i.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(i);var a=document.createElement("div");a.className="ikr-fwizard-stars",a.setAttribute("role","radiogroup"),a.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var s=Me(I||{}),o=[];function d(p){o.forEach(function(l,v){var f=v<p;l.classList.toggle("ikr-fwizard-star-active",f),l.setAttribute("aria-checked",v+1===p?"true":"false"),l.innerHTML=f?s.filled:s.empty})}for(var c=1;c<=5;c++)(function(p){var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-star",l.setAttribute("role","radio"),l.setAttribute("aria-label",p+" y\u0131ld\u0131z"),l.innerHTML=s.empty,l.addEventListener("mouseenter",function(){d(p)}),l.addEventListener("mouseleave",function(){d(e.get().rating)}),l.addEventListener("click",function(){n||(n=!0,e.set({rating:p}),d(p),setTimeout(function(){var v=!r.canNavigate||r.canNavigate();v&&e.goNext()},400))}),o.push(l),a.appendChild(l)})(c);d(e.get().rating);var u=function(){s=Me(I||{}),d(e.get().rating)};return window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),t.appendChild(a),{el:t,destroy:function(){window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u)}}}var jr=3,Qi=10*1024*1024;function Gt(e,r){r=r||{};var t=!1,n=document.createElement("div");n.className="ikr-fwizard-step ikr-fwizard-step-photos";var i=document.createElement("div");i.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",i.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",n.appendChild(i);var a=document.createElement("div");a.className="ikr-fwizard-step-subtitle",a.textContent="Foto\u011Fraf ekleyebilirsiniz.",n.appendChild(a);var s=document.createElement("div");s.className="ikr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle"),o.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",s.appendChild(o),s.appendChild(d);var c=document.createElement("div");c.className="ikr-fwizard-photo-previews",c.setAttribute("aria-live","polite"),s.appendChild(c),n.appendChild(s);var u=r.blobMap||{},p=r.urlToFinger||{};function l(){if(!t){var b=e.get().images||[],z=e.get().pendingImages||[],S=b.map(function(C){return{url:C,isPending:!1}}).concat(z.map(function(C){return{url:C.url,file:C.file,isPending:!0,error:C.error}}));c.innerHTML="",S.forEach(function(C){var y=u[C.url]||C.url,w=v(C,y);c.appendChild(w)}),h()}}function v(b,z){var S=document.createElement("div");S.className="ikr-fwizard-photo-thumb";var C=document.createElement("img");C.src=z,C.alt="",C.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",S.appendChild(C);var y=document.createElement("div");y.className="ikr-fwizard-photo-loading",y.style.display="none",S.appendChild(y);var w=document.createElement("button");return w.type="button",w.className="ikr-fwizard-photo-remove",w.innerHTML="&#x2715;",S.appendChild(w),f(S,b,z),S}function f(b,z,S){var C=b.querySelector("img");C.src!==S&&(C.src=S);var y=b.querySelector(".ikr-fwizard-photo-loading");z.isPending&&z.error?(y.style.display="flex",y.innerHTML='<span class="ikr-upload-error">\u2717 '+z.error+"</span>"):y.style.display="none";var w=b.querySelector(".ikr-fwizard-photo-remove");w.onclick=function(){var E=p[z.url]||(z.file?z.file.name+"_"+z.file.size:null);if(z.url.startsWith("blob:")&&URL.revokeObjectURL(z.url),E){var k=(e.get().fingerprints||[]).filter(function(T){return T!==E});e.set({fingerprints:k})}if(z.isPending){var L=(e.get().pendingImages||[]).filter(function(T){return T.url!==z.url});e.set({pendingImages:L})}else{var A=(e.get().images||[]).filter(function(T){return T!==z.url});e.set({images:A})}}}var g='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',m='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function h(){var b=(e.get().images||[]).length,z=(e.get().pendingImages||[]).length,S=b+z,C=S>=jr,y=z>0;S>0?(s.classList.add("ikr-fwizard-photo-card--compact"),o.innerHTML=m):(s.classList.remove("ikr-fwizard-photo-card--compact"),o.innerHTML=g+"<span>Foto\u011Fraf Ekle</span>"),C?(o.style.display="none",o.disabled=!0,d.disabled=!0):(o.style.display="flex",o.disabled=y,d.disabled=y,o.classList.toggle("ikr-fwizard-photo-add--disabled",y))}o.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(b){var z=Array.from(b.target.files).slice(0,jr-(e.get().images||[]).length);d.value="";var S=(e.get().pendingImages||[]).length;if(!(S>0)){var C=e.get().images||[],y=C.length,w=jr-C.length;if(z.length!==0){for(var E=[],k=[],L=0;L<z.length;L++){var A=z[L],T=A.name+"_"+A.size,N=(e.get().fingerprints||[]).some(function(O){return O===T})||E.some(function(O){return O.file.name+"_"+O.file.size===T});if(N){console.log("[ikr] Duplicate file detected, skipping:",A.name);continue}if(A.size>Qi){var me="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(me,"error"):alert(me);continue}var K=URL.createObjectURL(A);p[K]=T,E.push({url:K,file:A,error:null}),k.push({url:K,file:A});var fe=(e.get().fingerprints||[]).slice();fe.push(T),e.set({fingerprints:fe})}if(E.length!==0){var ve=(e.get().pendingImages||[]).concat(E),X=async function(){for(var O=0;O<k.length;O++){var ge=k[O],ke=ge.file,U=ge.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Ee=(e.get().pendingImages||[]).filter(function(J){return J.url!==U}),Fe=(e.get().images||[]).slice();Fe.push(U),e.set({pendingImages:Ee,images:Fe});continue}try{var he=await re(Y+"/api/public/upload/sign",{method:"POST"});if(!he.ok)throw he.status===429?new Error("rate_limit"):new Error("sign failed");var ie=await he.json(),D=new FormData;D.append("file",ke),D.append("api_key",ie.api_key),D.append("timestamp",ie.timestamp),D.append("signature",ie.signature),D.append("folder","review_images");var Xe=await fetch("https://api.cloudinary.com/v1_1/"+ie.cloud_name+"/image/upload",{method:"POST",body:D}),ye=await Xe.json();if(ye.secure_url&&Br(ye.secure_url)){var Pe=(e.get().pendingImages||[]).some(function(J){return J.url===U});if(!Pe){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}u[ye.secure_url]=U,p[ye.secure_url]=p[U];var be=(e.get().pendingImages||[]).filter(function(J){return J.url!==U}),Q=(e.get().images||[]).slice();Q.push(ye.secure_url),e.set({pendingImages:be,images:Q})}else throw new Error("invalid image url")}catch(J){console.error("[ikr] Image upload failed:",J);var ae=J.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ae,"error");var _e=(e.get().pendingImages||[]).map(function(B){return B.url===U?{url:B.url,file:B.file,error:ae}:B});e.set({pendingImages:_e})}}};if(y===0){t=!0;var V=!r.canNavigate||r.canNavigate();V&&e.goNext()}e.set({pendingImages:ve}),X()}}}};var x=e.onChange(l);return l(),{el:n,destroy:function(){t=!0,d.onchange=null,x&&x()}}}var qr=2e3,ea=60;function Vt(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="ikr-fwizard-step ikr-fwizard-step-content";var i=document.createElement("div");i.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",i.textContent="Deneyiminizi anlat\u0131n",n.appendChild(i);var a=document.createElement("div");a.className="ikr-fwizard-content-form";var s=document.createElement("input");s.type="text",s.className="ikr-fwizard-input",s.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",s.maxLength=ea,s.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),s.value=e.get().title||"",s.addEventListener("input",function(){e.set({title:s.value})}),a.appendChild(s);var o=document.createElement("textarea");o.className="ikr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=qr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",a.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-char-counter",d.setAttribute("aria-live","polite"),a.appendChild(d);function c(){var p=o.value.length;d.textContent=p+"/"+qr,d.classList.toggle("ikr-fwizard-char-counter--max",p>=qr)}function u(){return Ue(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),c(),t(u())}),n.appendChild(a),c(),setTimeout(function(){t(u())},0),{el:n,destroy:function(){}}}var ra=40;function Ut(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-author";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Hakk\u0131n\u0131zda",i.appendChild(a);var s=document.createElement("div");s.className="ikr-fwizard-author-form";var o=document.createElement("div");o.className="ikr-fwizard-field";var d=document.createElement("label");d.className="ikr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var c=document.createElement("input");c.type="text",c.className="ikr-fwizard-input",c.maxLength=ra,c.setAttribute("aria-required","true"),c.value=e.get().author||"",o.appendChild(d),o.appendChild(c),s.appendChild(o);var u=document.createElement("div");u.className="ikr-fwizard-field";var p=document.createElement("label");p.className="ikr-fwizard-label",p.textContent="E-posta (opsiyonel)";var l=document.createElement("input");l.type="email",l.className="ikr-fwizard-input",l.setAttribute("autocomplete","email"),l.value=e.get().email||"",u.appendChild(p),u.appendChild(l),s.appendChild(u);var v=document.createElement("div");v.className="ikr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",s.appendChild(v);var f=document.createElement("div");f.className="ikr-fwizard-msg",f.setAttribute("role","alert"),f.setAttribute("aria-live","assertive"),s.appendChild(f);var g=document.createElement("button");g.type="button",g.className="ikr-fwizard-submit-btn",g.textContent="G\xF6nder",s.appendChild(g),i.appendChild(s);function m(){return Ue(4,e.get())}function h(){var b=!m(),z=(e.get().pendingImages||[]).length,S=z>0;S?(g.disabled=!0,g.classList.add("ikr-fwizard-submit-btn--disabled"),g.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(g.disabled=b,g.classList.toggle("ikr-fwizard-submit-btn--disabled",b),g.textContent="G\xF6nder")}c.addEventListener("input",function(){e.set({author:c.value}),h(),t(m())}),l.addEventListener("input",function(){e.set({email:l.value})}),h(),setTimeout(function(){t(m())},0),g.onclick=async function(){if(!g.disabled){var b=e.get(),z=(b.author||"").trim(),S=(b.comment||"").trim();if(l.value.trim()&&!l.checkValidity()){l.reportValidity();return}if(!z){f.innerHTML='<div class="ikr-fwizard-msg-error">Gerekli alan</div>';return}if(!b.rating){f.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}g.disabled=!0,g.classList.add("ikr-fwizard-submit-btn--disabled");var C=g.textContent;if(g.textContent="G\xF6nderiliyor\u2026",f.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){n()},600);return}try{var y=j(window.location.href),w=b.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),E=await re(Y+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:F,productId:b.productId||null,slug:y||null,productName:w,author:z,title:(b.title||"").trim()||null,comment:S||null,rating:b.rating,images:b.images||[]})},15e3);if(E.ok)n();else{var k=await E.json().catch(function(){return{}});throw new Error(k.error||"Yorum kaydedilemedi.")}}catch(T){var L=T&&(T.name==="AbortError"||/signal/i.test(T.message||"")),A=L?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":T.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(A,"error"):f.innerHTML='<div class="ikr-fwizard-msg-error">'+A+"</div>",g.disabled=!1,g.classList.remove("ikr-fwizard-submit-btn--disabled"),g.textContent=C}}};var x=e.onChange(h);return{el:i,destroy:function(){g.onclick=null,x&&x()}}}var Zt=!1;function ta(){if(!Zt){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=Dt,document.head.appendChild(e),Zt=!0}}function ia(e,r,t){if(t=t||{},e===1)return Yt(r,{canNavigate:t.canNavigate});if(e===2)return Gt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,showToast:t.showToast});if(e===3)return Vt(r,{onValidityChange:t.onValidityChange});if(e===4)return Ut(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Wt(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Yr(e){!e||!e.focusFirstControl||setTimeout(function(){e.focusFirstControl()},0)}function Kt(e){e=e||{},ta();var r=jt({productId:e.productId,productName:e.productName}),t={},n={},i=Ft({onClose:function(){window.removeEventListener("popstate",s),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(t).forEach(function(C){var y=t[C];y&&y.startsWith("blob:")&&URL.revokeObjectURL(y)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),a={ikrReviewModal:!0};window.history.pushState(a,null,"");var s=function(C){i&&i.close&&i.close()};window.addEventListener("popstate",s);var o=document.createElement("div");o.className="ikr-fwizard-step-wrap";var d=qt({skippableSteps:[2],nextableSteps:[3],onBack:function(){p==="idle"&&r.goBack()},onSkip:function(){p==="idle"&&r.goNext()},onNext:function(){p==="idle"&&r.goNext()}}),c=document.createElement("div");c.className="ikr-fwizard-layout",c.appendChild(o),c.appendChild(d.el);var u=null,p="idle",l=null,v=!0,f=null;function g(C,y){o.innerHTML="";var w=ia(C,r,{canNavigate:function(){return p==="idle"},blobMap:t,urlToFinger:n,onValidityChange:function(L){d.setNextDisabled(!L)},onSuccess:h,showToast:i.showToast});if(u=w,d.update(C,r.get()),y){p="entering",w.el.classList.add("ikr-fwizard-step--enter");var E=null,k=function(){E&&clearTimeout(E),w.el.removeEventListener("animationend",k),w.el.classList.remove("ikr-fwizard-step--enter"),p="idle",l!==null&&x()};w.el.addEventListener("animationend",k),E=setTimeout(k,700)}else p="idle";o.appendChild(w.el),i.setStepAttr&&i.setStepAttr(C),C===3&&d.setNextDisabled(!0),Yr(i)}var m=!1;function h(){if(!m){if(m=!0,!u){o.innerHTML="";var C=Wt();C.classList.add("ikr-fwizard-step--enter"),o.appendChild(C),i.setStepAttr("thanks"),d.setThanksState(i.close),Yr(i);return}var y=u;p="exiting",y.el.classList.add("ikr-fwizard-step--exit");var w=function(){if(f&&clearTimeout(f),y.el.removeEventListener("animationend",w),y.destroy)try{y.destroy()}catch(k){}u===y&&(u=null),o.innerHTML="";var E=Wt();E.classList.add("ikr-fwizard-step--enter"),o.appendChild(E),i.setStepAttr("thanks"),d.setThanksState(i.close),p="idle",Yr(i)};y.el.addEventListener("animationend",w),f=setTimeout(w,300)}}function x(){var C=r.get().currentStep;if(p!=="idle"){l=C;return}if(!u){var y=!v;v=!1,g(C,y);return}var w=u;p="exiting",w.el.classList.add("ikr-fwizard-step--exit");var E=function(){if(f&&clearTimeout(f),w.el.removeEventListener("animationend",E),w.destroy)try{w.destroy()}catch(L){}if(u===w){o.innerHTML="",u=null;var k=l!==null?l:r.get().currentStep;l=null,g(k,!0),p="idle"}};w.el.addEventListener("animationend",E),f=setTimeout(E,350)}x();var b=r.get().currentStep,z=r.onChange(function(C){C.currentStep!==b?(b=C.currentStep,x()):d.update(C.currentStep,C)}),S=i.close;return i.close=function(){z&&z(),typeof f!="undefined"&&f&&clearTimeout(f),S()},i.open(c),{close:i.close}}function q(){Kt({productId:Z||"",productName:we||""})}var aa={id:"classic",name:"Klasik (A\xE7\u0131k)"};function na(e){var r=e.widget,t=e.data,n=e.settings,i=e.iconPair,a=e.allCount,s=e.ratingCounts,o=e.avgRatingVal,d=e.currentRatingFilter,c=e.currentOrderBy,u=e.currentHasImages,p=e.onFilterChange,l=e.onSortChange,v=document.createElement("div");v.className="ikr-summary";var f=(s[3]||0)+(s[4]||0),g=a>0?Math.round(f/a*100):0,m=document.createElement("div");m.className="ikr-summary-block ikr-summary-avg",m.innerHTML='<span class="ikr-avg-star ikr-icon">'+i.filled+'</span><span class="ikr-avg-num">'+o+"</span>",v.appendChild(m);var h=document.createElement("div");if(h.className="ikr-summary-block ikr-summary-count",h.textContent=a.toLocaleString("tr-TR")+" Yorum",v.appendChild(h),n.showRecommendation!==!1&&g>0){var x=document.createElement("div");x.className="ikr-summary-block ikr-summary-recommend",x.innerHTML='<span class="ikr-recommend-pct">%'+g+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(x)}return v.appendChild(Ve({ratingCounts:s,allCount:a,iconPair:i,currentRatingFilter:d,onFilterChange:p})),v.appendChild(te({widget:r,currentOrderBy:c,currentHasImages:u,onWriteClick:q,onSortChange:l})),v}var Vr={};Te(Vr,{css:()=>la,meta:()=>oa,render:()=>sa});var Xt=`
...
`;var oa={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},la=Xt;function sa(e){var r=e.widget,t=e.settings,n=e.iconPair,i=e.allCount,a=e.ratingCounts,s=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,u=e.onFilterChange,p=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var v=document.createElement("div");v.className="ikr-compact-header";var f=document.createElement("div");f.className="ikr-compact-trigger-wrap";var g=document.createElement("button");g.className="ikr-compact-trigger",g.type="button",g.setAttribute("aria-expanded","false"),g.innerHTML='<span class="ikr-compact-trigger-stars">'+oe(s,n)+'</span><span class="ikr-compact-trigger-text">'+i.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',f.appendChild(g),v.appendChild(f);var m=te({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:q,onSortChange:p}),h=m.querySelector(".ikr-filter-wrap"),x=m.querySelector(".ikr-write-btn"),b=document.createElement("div");b.className="ikr-compact-actions-slot",x&&b.appendChild(x),h&&b.appendChild(h),v.appendChild(b),l.appendChild(v);var z=document.createElement("div");z.className="ikr-compact-panel",z.setAttribute("role","dialog"),z.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="ikr-compact-panel-inner";var C=document.createElement("div");C.className="ikr-compact-avg",C.innerHTML='<span class="ikr-icon">'+n.filled+"</span><span>"+s+"</span>",S.appendChild(C),S.appendChild(Ve({ratingCounts:a,allCount:i,iconPair:n,currentRatingFilter:o,onFilterChange:u})),z.appendChild(S);var y=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(V){var O=V?l:f;z.parentNode!==O&&(z.classList.contains("ikr-open")&&(z.classList.remove("ikr-open"),z.setAttribute("aria-hidden","true"),g.setAttribute("aria-expanded","false")),O.appendChild(z))}if(w(y?y.matches:!1),y){var E=function(V){w(V.matches)};y.addEventListener?y.addEventListener("change",E):y.addListener&&y.addListener(E)}if(x){var k=document.createElement("button");k.className="ikr-write-btn",k.textContent=I&&I.writeButtonText||"Yorum Yap",k.onclick=q;var L=document.createElement("div");L.className="ikr-compact-write-row",L.appendChild(k),l.appendChild(L)}function A(){z.classList.remove("ikr-open"),z.setAttribute("aria-hidden","true"),g.setAttribute("aria-expanded","false")}function T(){kr(N),z.classList.add("ikr-open"),z.setAttribute("aria-hidden","false"),g.setAttribute("aria-expanded","true")}g.onclick=function(){z.classList.contains("ikr-open")?A():T()};var N=null;function me(V){N&&(N(),N=null),V||(N=hr({trigger:f,element:z,close:A}))}if(me(y?y.matches:!1),y){var K=function(V){me(V.matches)};y.addEventListener?y.addEventListener("change",K):y.addListener&&y.addListener(K)}if(t.showRecommendation!==!1){var fe=(a[3]||0)+(a[4]||0),ve=i>0?Math.round(fe/i*100):0;if(ve>0){var X=document.createElement("div");X.className="ikr-summary-block ikr-summary-recommend",X.style.marginTop="8px",X.innerHTML='<span class="ikr-recommend-pct">%'+ve+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild(X)}}return l}var Ur={};Te(Ur,{css:()=>ca,meta:()=>da,render:()=>pa});var Jt=`
