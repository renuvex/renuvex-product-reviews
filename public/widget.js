...
`;var ft={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},vt=gi;function kt(e){var r=e.widget,i=e.settings,a=e.iconPair,t=e.allCount,n=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,c=e.currentOrderBy,p=e.currentHasImages,m=e.onFilterChange,s=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var v=document.createElement("div");v.className="ikr-compact-trigger-wrap";var f=document.createElement("button");f.className="ikr-compact-trigger",f.type="button",f.setAttribute("aria-expanded","false"),f.innerHTML='<span class="ikr-compact-trigger-stars">'+ce(d,a)+'</span><span class="ikr-compact-trigger-text">'+t.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',v.appendChild(f),k.appendChild(v);var u=ue({widget:r,currentOrderBy:c,currentHasImages:p,onWriteClick:Y,onSortChange:s}),w=u.querySelector(".ikr-filter-wrap"),z=u.querySelector(".ikr-write-btn"),b=document.createElement("div");b.className="ikr-compact-actions-slot",z&&b.appendChild(z),w&&b.appendChild(w),k.appendChild(b),l.appendChild(k);var h=document.createElement("div");h.className="ikr-compact-panel",h.setAttribute("role","dialog"),h.setAttribute("aria-hidden","true");var C=document.createElement("div");C.className="ikr-compact-panel-inner";var x=document.createElement("div");x.className="ikr-compact-avg",x.innerHTML='<span class="ikr-icon">'+a.filled+"</span><span>"+d+"</span>",C.appendChild(x),C.appendChild(Re({ratingCounts:n,allCount:t,iconPair:a,currentRatingFilter:o,onFilterChange:m})),h.appendChild(C);var g=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function y(K){var W=K?l:v;h.parentNode!==W&&(h.classList.contains("ikr-open")&&(h.classList.remove("ikr-open"),h.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")),W.appendChild(h))}if(y(g?g.matches:!1),g){var E=function(K){y(K.matches)};g.addEventListener?g.addEventListener("change",E):g.addListener&&g.addListener(E)}if(z){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent="Yorum Yap",T.onclick=Y;var S=document.createElement("div");S.className="ikr-compact-write-row",S.appendChild(T),l.appendChild(S)}function M(){h.classList.remove("ikr-open"),h.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")}function A(){ir(I),h.classList.add("ikr-open"),h.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true")}f.onclick=function(){h.classList.contains("ikr-open")?M():A()};var I=null;function G(K){I&&(I(),I=null),K||(I=tr({trigger:v,element:h,close:M}))}if(G(g?g.matches:!1),g){var fe=function(K){G(K.matches)};g.addEventListener?g.addEventListener("change",fe):g.addListener&&g.addListener(fe)}if(i.showRecommendation!==!1){var $=(n[3]||0)+(n[4]||0),ve=t>0?Math.round($/t*100):0;if(ve>0){var ne=document.createElement("div");ne.className="ikr-summary-block ikr-summary-recommend",ne.style.marginTop="8px",ne.innerHTML='<span class="ikr-recommend-pct">%'+ve+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",C.appendChild(ne)}}return l}var yr={};ze(yr,{css:()=>ht,meta:()=>gt,render:()=>bt});var hi=`
...
`;var gt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},ht=hi;function bt(e){var r=e.widget,i=e.settings,a=e.iconPair,t=e.allCount,n=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,c=e.currentOrderBy,p=e.currentHasImages,m=e.onFilterChange,s=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",v.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+d+"</span>",k.appendChild(v);var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-count ikr-split-left-count",f.textContent=t.toLocaleString("tr-TR")+" Yorum",k.appendChild(f),l.appendChild(k);var u=document.createElement("div");u.className="ikr-split-col ikr-split-mid",u.appendChild(Re({ratingCounts:n,allCount:t,iconPair:a,currentRatingFilter:o,onFilterChange:m})),l.appendChild(u);var w=ue({widget:r,currentOrderBy:c,currentHasImages:p,onWriteClick:Y,onSortChange:s}),z=w.querySelector(".ikr-filter-wrap"),b=w.querySelector(".ikr-write-btn"),h=document.createElement("div");if(h.className="ikr-split-col ikr-split-right",b&&h.appendChild(b),z&&h.appendChild(z),l.appendChild(h),i.showRecommendation!==!1){var C=(n[3]||0)+(n[4]||0),x=t>0?Math.round(C/t*100):0;if(x>0){var g=document.createElement("div");g.className="ikr-summary-block ikr-summary-recommend",g.innerHTML='<span class="ikr-recommend-pct">%'+x+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(g)}}return l}var wr={};ze(wr,{css:()=>yt,meta:()=>xt,render:()=>wt});var bi=`
...
`;var _t={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"90px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"120px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},Bt=zi;function Mt(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length&&e.images[0]&&(e.images[0].indexOf("https://")===0||e.images[0].indexOf("data:image/")===0)),a=document.createElement("div");a.className="ikr-review-gallery"+(i?"":" ikr-review-gallery--no-media");var t=document.createElement("div");t.className="ikr-review-gallery-content";var n=document.createElement("span");if(n.className="ikr-review-stars ikr-review-gallery-stars",n.innerHTML=ge(e.rating,N),t.appendChild(n),e.title){var d=document.createElement("div");d.className="ikr-review-gallery-title",d.textContent=e.title,t.appendChild(d)}var o=document.createElement("div");o.className="ikr-review-gallery-author",o.textContent=e.author||"",t.appendChild(o);var c=document.createElement("div");c.className="ikr-review-gallery-date",c.textContent=he(e.createdAt),t.appendChild(c);var p=(e.comment||"").trim();if(p){var m=document.createElement("div");m.className="ikr-review-gallery-body ikr-body-clamped",m.textContent=p,t.appendChild(m);var s=document.createElement("span");s.className="ikr-read-more",s.textContent="Devam\u0131n\u0131 oku",s.style.display="none",s.style.cursor="pointer",s.onclick=function(){var u=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;pe(e,u,r)},t.appendChild(s),requestAnimationFrame(function(){m.scrollHeight>m.clientHeight+2&&(s.style.display="inline")})}if(a.appendChild(t),i){var l=e.images[0],k=document.createElement("div");k.className="ikr-review-gallery-media";var v=document.createElement("img");v.src=J(l),v.loading="lazy",v.setAttribute("data-ikr-img-url",l),v.onclick=function(){pe(e,l,r)},k.appendChild(v),a.appendChild(k)}var f=Oe(e.merchantReply,function(){var u=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;pe(e,u,r)});return f&&(f.classList.add("ikr-review-gallery-reply"),a.appendChild(f)),a}var or={card:Cr,list:Sr,gallery:Er};function lr(e){return or[e]||or.card}function Ci(){return Object.keys(or).map(function(e){return or[e].css||""}).join(`
`)}function ae(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var a=parseInt(i[1],16),t=parseInt(i[2],16),n=parseInt(i[3],16);return"rgba("+a+","+t+","+n+","+r+")"}var Si={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:14,recommendSize:12,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:52},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:16,recommendSize:14,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:64},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:18,recommendSize:16,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:76}},Ei={small:80,medium:110,large:140};function Rt(e,r){var i=r.bgColor||"#ffffff",a=r.textColor||"#111111",t=r.replyBgColor||"#f9fafb",n=r.inputBgColor||"#ffffff",d=r.headerTitleColor||a,o=r.headerAvgColor||a,c=r.headerCountColor||a,p=r.headerRecommendColor||a,m=r.barFillColor||a,s=r.barTrackColor||"#e5e7eb",l=r.starEmptyColor||"#e5e7eb",k=r.barCountColor||a,v=ae(m,.06),f=r.primaryColor||"#111111",u=r.primaryTextColor||"#ffffff",w=r.btnBgColor||f,z=r.btnTextColor||u,b=r.btnBorderColor||f,h=r.filterBtnBgColor||"#111111",C=r.filterBtnTextColor||"#ffffff",x=r.filterBtnBorderColor||"#111111",g=r.filterMenuBgColor||"#ffffff",y=r.filterMenuBorderColor||"#e5e7eb",E=r.filterItemTextColor||a,T=r.filterItemHoverBgColor||"#f3f4f6",S=r.filterItemActiveColor||"#111111",M=r.reviewTitleColor||a,A=r.reviewAuthorColor||a,I=r.reviewDateColor||a,G=r.reviewBodyColor||a,fe=r.reviewBorderColor||"#e5e7eb",$=r.reviewStarColor||"#f59e0b",ve=r.replyBgColor||t,ne=r.replyBorderColor||"#747474",K=r.replyLabelColor||a,W=r.replyTextColor||a,H=r.photoTitleColor||a,Ee=r.photoImageBorderColor||ae(a,.05),ye=r.photoArrowBgColor||"#ffffff",Q=r.photoArrowTextColor||a,Te=r.photoArrowBorderColor||ae(a,.12),Le=r.formBgColor||i,P=r.formTextColor||a,ee=ae(P,.72),q=r.inputBgColor||n,oe=r.inputTextColor||P,Z=r.inputBorderColor||ae(P,.2),we=r.placeholderColor||ae(P,.42),qe=r.formStepBarColor||w,Ae=ae(P,.06),j=r.loadMoreBgColor||"#ffffff00",re=r.loadMoreTextColor||a,ie=r.loadMoreBorderColor||a,le=r.modalBgColor||i,L=r.modalCloseBgColor||"#00000080",_=r.modalCloseTextColor||u,D=r.modalCloseBorderColor||"#ffffff33",X=r.modalNavBgColor||"#00000059",cr=r.modalNavTextColor||"#ffffff",Ui=r.modalNavBorderColor||"#ffffff33",Br={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":d,"--ikr-header-avg":o,"--ikr-header-count":c,"--ikr-header-recommend":p,"--ikr-bar-fill":m,"--ikr-bar-track":s,"--ikr-star-empty-color":l,"--ikr-bar-count":k,"--ikr-bar-hover-bg":v,"--ikr-btn-bg":w,"--ikr-btn-text":z,"--ikr-btn-border":b,"--ikr-fwizard-cta-bg":w,"--ikr-fwizard-cta-text":z,"--ikr-fwizard-cta-border":b,"--ikr-fwizard-nav-text":w,"--ikr-fwizard-nav-hover-bg":ae(w,.06),"--ikr-filter-btn-bg":h,"--ikr-filter-btn-text":C,"--ikr-filter-btn-border":x,"--ikr-filter-menu-bg":g,"--ikr-filter-menu-border":y,"--ikr-filter-item-text":E,"--ikr-filter-item-hover-bg":T,"--ikr-filter-item-active":S,"--ikr-review-title":M,"--ikr-review-author":A,"--ikr-review-date":I,"--ikr-review-body":G,"--ikr-review-border":fe,"--ikr-review-star-color":$,"--ikr-reply-bg-color":ve,"--ikr-reply-border":ne,"--ikr-reply-label":K,"--ikr-reply-text":W,"--ikr-photo-title":H,"--ikr-photo-image-border":Ee,"--ikr-photo-arrow-bg":ye,"--ikr-photo-arrow-text":Q,"--ikr-photo-arrow-border":Te,"--ikr-form-bg":Le,"--ikr-form-text":P,"--ikr-form-muted":ee,"--ikr-input-bg-color":q,"--ikr-input-text-color":oe,"--ikr-input-border":Z,"--ikr-placeholder":we,"--ikr-fwizard-bg":Le,"--ikr-fwizard-text":P,"--ikr-fwizard-muted":ee,"--ikr-fwizard-input-bg":q,"--ikr-fwizard-input-text":oe,"--ikr-fwizard-input-border":Z,"--ikr-fwizard-placeholder":we,"--ikr-fwizard-close-text":ee,"--ikr-fwizard-close-hover-bg":Ae,"--ikr-fwizard-progress-bg":Ae,"--ikr-fwizard-progress-active":qe,"--ikr-load-more-bg":j,"--ikr-load-more-text":re,"--ikr-load-more-border":ie,"--ikr-modal-bg":le,"--ikr-modal-close-bg":L,"--ikr-modal-close-text":_,"--ikr-modal-close-border":D,"--ikr-modal-nav-bg":X,"--ikr-modal-nav-text":cr,"--ikr-modal-nav-border":Ui,"--ikr-bg":i,"--ikr-surface":i,"--ikr-text":a,"--ikr-text-faint":ae(a,.45),"--ikr-border":ae(a,.12),"--ikr-track-bg":ae(a,.22),"--ikr-reply-bg":t,"--ikr-input-bg":n,"--ikr-input-text":a};Object.keys(Br).forEach(function(Mr){e.style.setProperty(Mr,Br[Mr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function xe(e,r,i,a,t,n,d){if(vr){Je({productId:e,settings:r,reviewsData:i,productName:a,orderBy:t,page:n,badgeSettings:d});return}Xe(!0),Pr(e),Or(r),d!==void 0&&Hr(d),Fr(a),t&&Me(t),n&&_e(n),i!=null&&qr(i);try{let le=function(L,_){if(!(!L||!L.meta||!L.meta.sizeOverrides)){var D=L.meta.sizeOverrides[_];D&&Object.keys(D).forEach(function(X){l.style.setProperty(X,D[X])})}};var ie=le,o=nr(r.summaryLayout),c=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),p=r.showTitle!==!1,m=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",s=c&&p?m:"",l=document.documentElement;Rt(l,r);var k=r.primaryColor||"#111111",v=r.primaryTextColor||"#ffffff";Wr(k,ti+yi()+Ci());var f=r.borderRadius!==void 0?r.borderRadius:8,u=Si[r.size]||Si.medium,w=Ei[r.thumbnailSize]||Ei.medium;l.style.setProperty("--ikr-title-size",u.titleSize+"px"),l.style.setProperty("--ikr-review-text-size",u.reviewTextSize+"px"),l.style.setProperty("--ikr-review-title-size",u.reviewTitleSize+"px"),l.style.setProperty("--ikr-author-size",u.authorSize+"px"),l.style.setProperty("--ikr-reply-name-size",u.replyNameSize+"px"),l.style.setProperty("--ikr-reply-text-size",u.replyTextSize+"px"),l.style.setProperty("--ikr-color-text",v),l.style.setProperty("--ikr-radius",f+"px"),l.style.setProperty("--ikr-radius-sm",Math.max(0,f-4)+"px"),l.style.setProperty("--ikr-photo-title-size",u.photoTitleSize+"px"),l.style.setProperty("--ikr-avg-rating-size",u.avgRatingSize+"px"),l.style.setProperty("--ikr-review-count-size",u.reviewCountSize+"px"),l.style.setProperty("--ikr-recommend-size",u.recommendSize+"px"),l.style.setProperty("--ikr-btn-text-size",u.btnTextSize+"px"),l.style.setProperty("--ikr-bar-label-size",u.barLabelSize+"px"),l.style.setProperty("--ikr-minimal-avg-size",u.minimalAvgSize+"px"),l.style.setProperty("--ikr-hero-avg-size",u.heroAvgSize+"px"),l.style.setProperty("--ikr-bar-count-size",u.barCountSize+"px"),l.style.setProperty("--ikr-review-date-size",u.reviewDateSize+"px"),l.style.setProperty("--ikr-filter-text-size",u.filterTextSize+"px"),l.style.setProperty("--ikr-load-more-size",u.loadMoreSize+"px"),l.style.setProperty("--ikr-read-more-size",u.readMoreSize+"px"),l.style.setProperty("--ikr-thumbnail-size",w+"px");var z=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";l.style.setProperty("--ikr-review-star-color",z),l.style.setProperty("--ikr-star-size",u.reviewStarSize+"px"),l.style.setProperty("--ikr-avg-star-size",u.avgStarSize+"px"),le(nr(r.summaryLayout),r.size),le(lr(r.reviewLayout),r.size);var b=Be(r),h=document.getElementById("ikas-reviews");if(!h){var C=document.getElementById("ikas-reviews-anchor");if(!C)return;h=document.createElement("div"),h.id="ikas-reviews",h.style.minHeight="200px",C.appendChild(h)}if(r.enabled===!1){h.style.minHeight="auto",h.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',Xe(!1);var x=De;Je(null),x&&xe(x.productId,x.settings,x.reviewsData,x.productName,x.orderBy,x.page,x.badgeSettings);return}h.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var g=i||{},y=g.data&&g.data.reviews||[],E=g.data&&g.data.totalCount||0,T=h.cloneNode(!1);h.parentNode.replaceChild(T,h),h=T;var S=document.createElement("div");if(S.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),s){var M=document.createElement("div"),A=r.summaryLayout||"classic";M.className="ikr-title ikr-title-"+A,M.textContent=s,S.appendChild(M)}var I=g.data&&g.data.allCount||0,G=g.data&&g.data.ratingCounts||null,fe=G||[0,0,0,0,0],$=g.data&&g.data.avgRating||"0.0";if(!G&&y.length>0){y.forEach(function(L){L.rating>=1&&L.rating<=5&&fe[L.rating-1]++});var ve=y.reduce(function(L,_){return L+_.rating},0);$=(ve/y.length).toFixed(1)}if(I>0){var ne=nr(r.summaryLayout),K=ne.render({widget:S,data:g,settings:r,iconPair:b,allCount:I,ratingCounts:fe,avgRatingVal:$,currentRatingFilter:Ne,currentOrderBy:de,currentHasImages:Ie,onFilterChange:async function(L){We(Ne===L?null:L),_e(1);var _=await Ke(te,de,1,Ne,Ie);await xe(te,N,_,Ce,de,1)},onSortChange:async function(L,_){_e(1),_?(fr(!0),Me("newest")):(fr(!1),Me(L));var D=await Ke(te,de,1,Ne,Ie);await xe(te,N,D,Ce,de,1)}});S.appendChild(K)}else{var W=document.createElement("button");W.className="ikr-write-btn",W.style.cssText="display:block;margin:16px auto 0;",W.textContent="Yorum Yap",W.onclick=Y,S.appendChild(W)}if(r.reviewFormStyle!=="modal"){var H=document.createElement("div");H.id="ikr-form-accordion",H.style.cssText="overflow:hidden;max-height:0px;opacity:0;transition:max-height 0.35s ease,opacity 0.25s ease;",H.appendChild(Qr(e,a)),S.appendChild(H)}var Ee=y.filter(function(L){return L.images&&Array.isArray(L.images)&&L.images.some(function(_){return _&&(_.indexOf("https://")===0||_.indexOf("data:image/")===0)})});if(r.showPhotoGallery!==!1&&!Ie&&Ee.length>0){var ye=document.createElement("div");if(ye.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var Q=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",Te=document.createElement("div");Te.className="ikr-photo-title",Te.textContent=Q,ye.appendChild(Te)}var Le=r.reviewLayout==="card"?"1/1":"3/4";l.style.setProperty("--ikr-photo-thumb-aspect",Le);var P=document.createElement("div");P.className="ikr-photo-strip";var ee=0;Ee.forEach(function(L){if(!(ee>=10)){var _=L.images.find(function(X){return X&&(X.indexOf("https://")===0||X.indexOf("data:image/")===0)});if(_){var D=document.createElement("img");D.src=J(_),D.className="ikr-photo-strip-thumb",D.alt="Yorum foto\u011Fraf\u0131",(function(X,cr){D.onclick=function(){pe(cr,X,y)}})(_,L),P.appendChild(D),ee++}}});var q=document.createElement("button");q.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",q.innerHTML="&#8249;",q.setAttribute("aria-label","\xD6nceki"),q.onclick=function(){P.scrollBy({left:-200,behavior:"smooth"})};var oe=document.createElement("button");oe.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",oe.innerHTML="&#8250;",oe.setAttribute("aria-label","Sonraki"),oe.onclick=function(){P.scrollBy({left:200,behavior:"smooth"})};var Z=document.createElement("div");Z.className="ikr-photo-strip-wrap",Z.appendChild(q),Z.appendChild(P),Z.appendChild(oe),ye.appendChild(Z),S.appendChild(ye)}if(y.length===0){var we=document.createElement("p");we.className="ikr-state-msg",we.textContent="Hen\xFCz yorum yok.",S.appendChild(we)}else{var qe=lr(r.reviewLayout);y.forEach(function(L){S.appendChild(qe.render(L,y))})}var Ae=g.data&&g.data.hasMore;if(Ae){var j=document.createElement("button");j.className="ikr-load-more",j.textContent="Daha Fazla G\xF6ster",j.onclick=async function(){j.disabled=!0,j.textContent="Y\xFCkleniyor...";var L=je+1,_=await Ke(te,de,L,Ne,Ie);if(_&&_.data&&_.data.reviews){_e(L);var D=lr(N.reviewLayout);_.data.reviews.forEach(function(X){S.insertBefore(D.render(X,_.data.reviews),j)}),_.data.hasMore?(j.disabled=!1,j.textContent="Daha Fazla G\xF6ster"):j.remove()}else j.remove()},S.appendChild(j)}h.appendChild(S),ii(I>0?$:null,E,a,mr)}catch(L){console.error("[ikr] render error:",L),h.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(Xe(!1),De){var re=De;Je(null),xe(re.productId,re.settings,re.reviewsData,re.productName,re.orderBy,re.page,re.badgeSettings)}}}var Se="ikr_settings_"+F,Pt=300*1e3,Ot=30*1e3;async function Lr(){if(window.__ikasPreviewMode){try{var e=window.__ikasPreviewBaseUrl||U,r=window.__ikasPreviewSettings||sessionStorage.getItem("ikr_preview_settings")||"",i={};if(r)try{i=JSON.parse(r)}catch(m){}var a=await V(e+"/api/preview/settings");if(a.ok){var t=await a.json();return t.widgets&&t.widgets.reviews&&Object.keys(i).length&&(t.widgets.reviews=Object.assign({},t.widgets.reviews,i)),t}}catch(m){}return null}var n=null,d=Ue(Se);if(d)try{var o=JSON.parse(d);if(o&&o.t!==void 0)if(o.notFound){if(Date.now()-o.t<Ot)return null;R(Se,"")}else if(o.v){if(Date.now()-o.t<Pt)return o.v;n=o.v,R(Se,"")}else R(Se,"");else R(Se,"")}catch(m){R(Se,"")}try{var c=await V(U+"/api/public/settings?publicApiKey="+encodeURIComponent(F));if(!c.ok)return c.status===404&&R(Se,JSON.stringify({t:Date.now(),notFound:!0})),n||null;var p=await c.json();return R(Se,JSON.stringify({t:Date.now(),v:p})),p}catch(m){return console.error("[ikr] fetchSettings error:",m),n||null}}var Ht=60*1e3;async function Ke(e,r,i,a,t){if(window.__ikasPreviewMode){try{var n=window.__ikasPreviewBaseUrl||U,d=n+"/api/preview/reviews?page="+encodeURIComponent(i||1),o=await V(d);if(o.ok)return await o.json()}catch(f){}return null}r=r||"newest",i=i||1;var c="ikr_reviews_"+F+"_"+e+"_"+r+"_"+i+"_"+(a||"")+"_"+(t?"1":"0"),p=null,m=Ue(c);if(m)try{var s=JSON.parse(m);if(s&&s.t!==void 0&&s.v){if(Date.now()-s.t<Ht)return s.v;p=s.v,R(c,"")}else R(c,"")}catch(f){R(c,"")}try{var l=U+"/api/public/reviews?storeId="+encodeURIComponent(F)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(a?"&rating="+encodeURIComponent(a):"")+(t?"&hasImages=true":""),k=await V(l);if(!k.ok)return p||null;var v=await k.json();return R(c,JSON.stringify({t:Date.now(),v})),v}catch(f){return console.error("[ikr] fetchReviews error:",f),p||null}}var Tr={};async function He(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var a=document.getElementById("ikr-jsonld");if(a&&a.remove(),!Tr[e]){Tr[e]=!0;var t={primaryColor:"#111111",title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},n={enabled:!0,icon:"star",size:"medium",color:"#f59e0b"};try{var d=await Lr();if(!d)return;var o=d.widgets&&d.widgets.reviews||t,c=d.widgets&&d.widgets.badge||n;if(o.enabled===!1)return;Me("newest"),_e(1),We(null);var p=await Ke(e,"newest",1,null);await xe(e,o,p,r,"newest",1,c)}catch(m){console.error("[ikr] bootstrap error:",m),await xe(e,t,null,r,void 0,void 0,n)}finally{delete Tr[e]}}}function Ar(){try{var e=window.__NEXT_DATA__&&window.__NEXT_DATA__.props&&window.__NEXT_DATA__.props.pageProps;if(e&&e.pageType==="PRODUCT"&&e.pageSpecificData&&e.pageSpecificData.id)return{id:e.pageSpecificData.id,name:e.pageSpecificData.name||null}}catch(a){}if(window.IkasStorefront&&window.IkasStorefront.product&&window.IkasStorefront.product.id)return{id:window.IkasStorefront.product.id,name:window.IkasStorefront.product.name||null};var r=window.location.pathname.match(/--([a-f0-9-]{36})(?:\/|$|\?)/);if(r)return{id:r[1],name:null};var i=new URLSearchParams(window.location.search).get("productId");return i?{id:i,name:null}:null}function Ti(){var e={},r={};return document.querySelectorAll("a[href]").forEach(function(i){try{var a=i.getAttribute("href");if(!a||a.charAt(0)==="#"||a.charAt(0)==="?")return;var t=O(i.href);if(!t||r[t]||!/^[a-z0-9][a-z0-9-]{2,}$/.test(t)||rr.test(t))return;r[t]=!0,e[t]=null}catch(n){}}),Object.keys(Ye).forEach(function(i){e[i]=Ye[i]}),e}var Ft=300*1e3,Li=50;async function Ai(e){var r="ikr_ratings_"+F,i={},a=Ue(r);if(a)try{var t=JSON.parse(a);t&&t.t!==void 0&&Date.now()-t.t<Ft?i=t.v||{}:R(r,"")}catch(p){R(r,"")}var n=e.filter(function(p){return!i[p]});if(!n.length)return i;for(var d=[],o=0;o<n.length;o+=Li)d.push(n.slice(o,o+Li));var c=await Promise.all(d.map(function(p){var m=U+"/api/public/ratings-by-slug?storeId="+encodeURIComponent(F)+"&slugs="+p.map(encodeURIComponent).join(",");return V(m).then(function(s){return s.ok?s.json().then(function(l){return l.data||{}}):{}}).catch(function(){return{}})}));return c.forEach(function(p){n.forEach(function(m){i[m]||(i[m]={average:0,count:0,_empty:!0})}),Object.keys(p).forEach(function(m){i[m]=p[m]})}),R(r,JSON.stringify({t:Date.now(),v:i})),i}var qt="var(--ikr-badge-color,#f59e0b)",Ni=13,jt="display:flex;align-items:center;gap:3px;margin-top:0px;margin-bottom:4px;font-size:13px;font-weight:400;color:#555;pointer-events:none;";function Dt(e){var r=Ve("star","classic"),i="width:"+Ni+"px;height:"+Ni+"px;";return'<span style="color:'+qt+';display:inline-flex;align-items:center;">'+ce(e,r,{sizeStyle:i})+"</span>"}function Ze(e,r){var i=document.createElement("div");return i.setAttribute("data-ikr-listing-badge","1"),i.style.cssText=jt+"justify-content:"+(r||"flex-start")+";",i.innerHTML=Dt(e.avg)+'<span style="font-weight:400;">'+e.avg+" ("+e.count+")</span>",i}var Ii=".product-name",_i=".add-to-basket-modal",Bi="h1.product-name",dr=".single-product-container-main",Nr=".single-product-product-name",Mi=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),Ri=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var Pi='[class*="productTitle"],[class*="productName"],[class*="product_title"],[class*="product_name"],[class*="product-title"],[class*="product-name"]',Yt=/^(tükendi|sold out|out of stock|stokta yok|satıldı|unavailable)$/i;function Ir(e,r){var i=e.querySelector(Ii);if(i)return i;if(e.matches&&e.matches(Pi))return e;var a=e.querySelector(Pi);if(a)return a;if(r){for(var t=e.querySelectorAll("*"),n=0;n<t.length;n++)if(t[n].children.length===0&&t[n].textContent.trim()===r)return t[n]}for(var d=e.querySelectorAll("p, h1, h2, h3, h4, h5, h6, span, div"),o=0;o<d.length;o++){var c=d[o],p=c.textContent.trim();if(!(!p||p.length<2||p.length>150)&&!/^[\d\s.,₺$€£%]+$/.test(p)&&!Yt.test(p)&&!(c.closest("figure")||c.closest("picture"))&&!(c.children.length>1))return c}return null}function Gt(e,r,i,a){if(!e.getAttribute("data-ikr-badge")){var t=O(e.href);if(e.id==="ikr-rating-badge"){e.setAttribute("data-ikr-badge","1");return}if(t===a&&e.getAttribute("href")&&e.getAttribute("href").charAt(0)==="#"){e.setAttribute("data-ikr-badge","1");return}if(e.closest("header")||e.closest("nav")){e.setAttribute("data-ikr-badge","1");return}if(e.closest('[class*="basket"]')||e.closest('[class*="cart"]')){e.setAttribute("data-ikr-badge","1");return}if(e.closest(dr)&&!e.closest(Nr)){e.setAttribute("data-ikr-badge","1");return}if(t===a&&e.closest(Nr)){e.setAttribute("data-ikr-badge","1");return}if(e.closest(Mi)){e.setAttribute("data-ikr-badge","1");return}var n=!!e.querySelector("a[href]"),d=Array.from(e.childNodes).filter(function(v){return v.nodeType===3}).map(function(v){return v.textContent.trim()}).join("").trim(),o=!!Ir(e,i);if(!d&&!o&&!n){e.setAttribute("data-ikr-badge","1");return}if(e.setAttribute("data-ikr-badge","1"),n){e.querySelectorAll("a[href]").forEach(function(v){v.setAttribute("data-ikr-badge","1")});var c=Ir(e,i);if(!c||c.querySelector("[data-ikr-listing-badge]"))return;var p=window.getComputedStyle(c).textAlign;c.appendChild(Ze(r,p==="center"?"center":p==="right"?"flex-end":"flex-start"));return}var m=Ir(e,i);if(!(m&&m.querySelector("[data-ikr-listing-badge]")))if(m){var s=window.getComputedStyle(m).textAlign;m.appendChild(Ze(r,s==="center"?"center":s==="right"?"flex-end":"flex-start"))}else{var l=Ze(r,"flex-start"),k=e.firstElementChild;k?e.insertBefore(l,k):e.appendChild(l)}}}function Ut(e,r){var i=document.querySelector(_i);if(i){var a=i.querySelector(Bi);if(!(!a||a.querySelector("[data-ikr-listing-badge]"))){var t=null;if(Ge&&r[Ge]&&(t=Ge),!t){var n=O(window.location.pathname);n&&r[n]&&(t=n)}if(!t){var d=a.textContent.trim();Object.keys(e).forEach(function(s){if(!t){var l=e[s];l&&l.trim()===d&&r[s]&&(t=s)}})}if(!t){var o=document.querySelector(dr);if(o){var c=o.querySelector("a[href]");if(c){var p=O(c.href);p&&r[p]&&(t=p)}}}if(!t){var m=a.textContent.trim().toLowerCase();document.querySelectorAll("a[href]").forEach(function(s){if(!t&&!(s.closest("header")||s.closest("nav"))&&!s.closest(dr)){var l=s.textContent.trim().toLowerCase();if(l&&l===m){var k=O(s.href);k&&r[k]&&(t=k)}}})}!t||!r[t]||r[t]._empty||r[t].count===0||a.appendChild(Ze(r[t],"flex-start"))}}}function Oi(e,r){var i=O(window.location.pathname),a=document.querySelectorAll(Ri),t=[];a.forEach(function(n){n.tagName==="A"&&n.href?t.push(n):n.querySelectorAll("a[href]").forEach(function(d){t.push(d)})}),Object.keys(e).forEach(function(n){var d=r[n];if(!(!d||d._empty||d.count===0)){var o=e[n];t.forEach(function(c){O(c.href)===n&&Gt(c,d,o,i)})}}),Ut(e,r)}async function Fe(){if(B.inProgress){B.queued=!0;return}if(!B.rendered){B.rendered=!0,B.inProgress=!0;try{var e=B.navCleanup;e&&(B.navCleanup=!1);var r=Ti();if(!Object.keys(r).length){B.rendered=!1;return}var i=await Promise.all([Lr(),Ai(Object.keys(r))]),a=i[0];if(!a){B.rendered=!1;return}var t=i[1],n=a&&a.widgets||{},d=n.badge&&n.badge.color||"#f59e0b";if(n.badge&&n.badge.enabled===!1){B.rendered=!1;return}document.documentElement.style.setProperty("--ikr-badge-color",d),e&&(document.querySelectorAll("[data-ikr-listing-badge]").forEach(function(o){o.remove()}),document.querySelectorAll("[data-ikr-badge]").forEach(function(o){o.removeAttribute("data-ikr-badge")})),Oi(r,t)}finally{B.inProgress=!1,B.queued&&(B.queued=!1,B.rendered=!1,Fe())}}}var Hi=!1,Fi=!1;function Di(){Fi||(Fi=!0,document.addEventListener("click",function(e){var r=e.target.closest("a[href]");if(r&&!(r.closest("header")||r.closest("nav"))&&!(r.closest('[class*="basket"]')||r.closest('[class*="cart"]'))){var i=O(r.href);!i||i.length<3||jr(i)}},!0))}var qi=!1,ji=typeof location!="undefined"?location.pathname:"";function sr(){try{if(location.pathname===ji)return;ji=location.pathname;var e=document.getElementById("ikr-rating-badge");e&&e.remove();var r=document.getElementById("ikr-jsonld");r&&r.remove()}catch(i){}}function Vt(){if(!qi){qi=!0;var e=history.pushState,r=history.replaceState;history.pushState=function(){var i=e.apply(this,arguments);return sr(),i},history.replaceState=function(){var i=r.apply(this,arguments);return sr(),i},window.addEventListener("popstate",sr),window.addEventListener("hashchange",sr)}}function _r(){if(Vt(),window.IkasEvents){if(Hi)return;Hi=!0,window.IkasEvents.subscribe({id:"ikas-reviews-widget",callback:function(n){if(n&&n.type==="VIEW_LISTING"){var d=n.data&&n.data.productDetails;Array.isArray(d)&&d.forEach(function(m){m&&m.metaData&&m.metaData.slug&&m.name&&(Ye[m.metaData.slug]=m.name)})}if(n&&n.type==="PRODUCT_VIEW"){var o=n.data&&n.data.productDetail&&n.data.productDetail.id,c=n.data&&n.data.productDetail&&n.data.productDetail.name;o&&(R("ikr_reviews_"+F+"_"+o,""),He(o,c))}if(n&&n.type==="PAGE_VIEW"){var p=Date.now();if(B.lastPageView&&p-B.lastPageView<800)return;B.lastPageView=p,B.navCleanup=!0,B.rendered=!1,Fe()}}});var e=Ar();if(e)He(e.id,e.name);else{let n=function(){var d=Ar();d?He(d.id,d.name):r<20&&(r++,setTimeout(n,100))};var a=n,r=0;setTimeout(n,100)}setTimeout(function(){B.rendered||Fe()},2e3)}else{let n=function(){window.IkasEvents?_r():i<100&&(i++,setTimeout(n,50))};var t=n,i=0;setTimeout(n,50)}}var Yi=null;function Gi(){if(typeof MutationObserver!="undefined"){var e=new MutationObserver(function(r){var i=r.some(function(a){return Array.from(a.addedNodes).some(function(t){return!(t.nodeType!==1||t.hasAttribute&&(t.hasAttribute("data-ikr-listing-badge")||t.id==="ikr-rating-badge"||t.id==="ikr-reviews-widget")||t.closest&&(t.closest("[data-ikr-listing-badge]")||t.closest("#ikr-rating-badge")||t.closest("#ikr-reviews-widget"))||t.querySelector&&t.querySelector("[data-ikr-listing-badge],#ikr-reviews-widget,#ikr-rating-badge"))})});i&&(clearTimeout(Yi),Yi=setTimeout(function(){var a=Array.from(document.querySelectorAll("a[href]")).some(function(t){if(t.getAttribute("data-ikr-badge"))return!1;var n=O(t.href);return n&&n.length>=3&&!rr.test(n)});a&&(B.rendered=!1,Fe())},300))});e.observe(document.body,{childList:!0,subtree:!0})}}var Kt=window.__ikasPreviewMode===!0;if(Kt){let e=function(){try{window.parent.postMessage({type:"IKR_WIDGET_READY"},"*")}catch(i){}},r=function(){He("mock-product","\xD6rnek \xDCr\xFCn"),e()};Zt=e,Wt=r,window.addEventListener("message",function(i){var a=i.data;if(!(!a||a.type!=="IKR_SETTINGS_UPDATE")){var t=a.settings;if(!(!t||!N)){var n=Object.assign({},N,t);xe(te,n,ur,Ce,de,je)}}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()}else if(F){let e=function(){_r(),Di(),Gi()};Xt=e,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}var Zt,Wt,Xt;})();
