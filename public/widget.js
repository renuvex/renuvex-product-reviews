...
`;var et={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},rt=oi;function it(e){var r=e.widget,i=e.settings,a=e.iconPair,t=e.allCount,n=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,p=e.currentHasImages,m=e.onFilterChange,c=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var u=document.createElement("div");u.className="ikr-compact-trigger-wrap";var v=document.createElement("button");v.className="ikr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="ikr-compact-trigger-stars">'+le(d,a)+'</span><span class="ikr-compact-trigger-text">'+t.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',u.appendChild(v),k.appendChild(u);var f=ce({widget:r,currentOrderBy:s,currentHasImages:p,onWriteClick:j,onSortChange:c}),w=f.querySelector(".ikr-filter-wrap"),y=f.querySelector(".ikr-write-btn"),b=document.createElement("div");b.className="ikr-compact-actions-slot",y&&b.appendChild(y),w&&b.appendChild(w),k.appendChild(b),l.appendChild(k);var g=document.createElement("div");g.className="ikr-compact-panel",g.setAttribute("role","dialog"),g.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="ikr-compact-panel-inner";var h=document.createElement("div");h.className="ikr-compact-avg",h.innerHTML='<span class="ikr-icon">'+a.filled+"</span><span>"+d+"</span>",z.appendChild(h),z.appendChild(Ne({ratingCounts:n,allCount:t,iconPair:a,currentRatingFilter:o,onFilterChange:m})),g.appendChild(z);var x=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function S(q){var J=q?l:u;g.parentNode!==J&&(g.classList.contains("ikr-open")&&(g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),J.appendChild(g))}if(S(x?x.matches:!1),x){var C=function(q){S(q.matches)};x.addEventListener?x.addEventListener("change",C):x.addListener&&x.addListener(C)}if(y){var E=document.createElement("button");E.className="ikr-write-btn",E.textContent="Yorum Yap",E.onclick=j;var A=document.createElement("div");A.className="ikr-compact-write-row",A.appendChild(E),l.appendChild(A)}function R(){g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function N(){Je(B),g.classList.add("ikr-open"),g.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){g.classList.contains("ikr-open")?R():N()};var B=null;function G(q){B&&(B(),B=null),q||(B=$e({trigger:u,element:g,close:R}))}if(G(x?x.matches:!1),x){var pe=function(q){G(q.matches)};x.addEventListener?x.addEventListener("change",pe):x.addListener&&x.addListener(pe)}if(i.showRecommendation!==!1){var K=(n[3]||0)+(n[4]||0),me=t>0?Math.round(K/t*100):0;if(me>0){var D=document.createElement("div");D.className="ikr-summary-block ikr-summary-recommend",D.style.marginTop="8px",D.innerHTML='<span class="ikr-recommend-pct">%'+me+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(D)}}return l}var kr={};ye(kr,{css:()=>at,meta:()=>tt,render:()=>nt});var li=`
...
`;var ht={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"90px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"120px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},bt=mi;function yt(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length&&e.images[0]&&(e.images[0].indexOf("https://")===0||e.images[0].indexOf("data:image/")===0)),a=document.createElement("div");a.className="ikr-review-gallery"+(i?"":" ikr-review-gallery--no-media");var t=document.createElement("div");t.className="ikr-review-gallery-content";var n=document.createElement("span");if(n.className="ikr-review-stars ikr-review-gallery-stars",n.innerHTML=fe(e.rating,_),t.appendChild(n),e.title){var d=document.createElement("div");d.className="ikr-review-gallery-title",d.textContent=e.title,t.appendChild(d)}var o=document.createElement("div");o.className="ikr-review-gallery-author",o.textContent=e.author||"",t.appendChild(o);var s=document.createElement("div");s.className="ikr-review-gallery-date",s.textContent=ve(e.createdAt),t.appendChild(s);var p=(e.comment||"").trim();if(p){var m=document.createElement("div");m.className="ikr-review-gallery-body ikr-body-clamped",m.textContent=p,t.appendChild(m);var c=document.createElement("span");c.className="ikr-read-more",c.textContent="Devam\u0131n\u0131 oku",c.style.display="none",c.style.cursor="pointer",c.onclick=function(){var f=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;se(e,f,r)},t.appendChild(c),requestAnimationFrame(function(){m.scrollHeight>m.clientHeight+2&&(c.style.display="inline")})}if(a.appendChild(t),i){var l=e.images[0],k=document.createElement("div");k.className="ikr-review-gallery-media";var u=document.createElement("img");u.src=X(l),u.loading="lazy",u.setAttribute("data-ikr-img-url",l),u.onclick=function(){se(e,l,r)},k.appendChild(u),a.appendChild(k)}var v=_e(e.merchantReply,function(){var f=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;se(e,f,r)});return v&&(v.classList.add("ikr-review-gallery-reply"),a.appendChild(v)),a}var rr={card:br,list:yr,gallery:xr};function ir(e){return rr[e]||rr.card}function ui(){return Object.keys(rr).map(function(e){return rr[e].css||""}).join(`
`)}function ge(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var a=parseInt(i[1],16),t=parseInt(i[2],16),n=parseInt(i[3],16);return"rgba("+a+","+t+","+n+","+r+")"}var fi={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:14,recommendSize:12,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:52},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:16,recommendSize:14,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:64},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:18,recommendSize:16,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:76}},vi={small:80,medium:110,large:140};function xt(e,r){var i=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",t=r.headerCountColor||"#111111",n=r.headerRecommendColor||"#111111",d=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",s=r.barCountColor||"#111111",p=ge(d,.06),m=r.reviewStarColor||"#f59e0b",c=ge(m,.25),l=r.btnBgColor||"#111111",k=r.btnTextColor||"#ffffff",u=r.btnBorderColor||"#111111",v=r.filterBtnBgColor||"#111111",f=r.filterBtnTextColor||"#ffffff",w=r.filterBtnBorderColor||"#111111",y=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",g=r.filterItemTextColor||"#111111",z=r.filterItemHoverBgColor||"#f3f4f6",h=r.filterItemActiveColor||"#111111",x=r.replyBgColor||"#f9fafb",S=r.replyBorderColor||"#747474",C=r.replyLabelColor||"#111111",E=r.replyTextColor||"#111111",A=r.photoTitleColor||"#111111",R=ge("#111111",.05),N=r.photoArrowBgColor||"#ffffff",B=r.photoArrowTextColor||"#111111",G=ge("#111111",.12),pe=r.formBgColor||"#ffffff",K=r.formPrimaryTextColor||"#111111",me=r.formSecondaryTextColor||"#3b3b3b",D=r.inputTextColor||K,q=r.inputBorderColor||"#d1d5db",J=r.placeholderColor||"#9ca3af",V=r.formStepBarColor||"#111111",ie=r.formBtnBgColor||"#111111",Ee=r.formBtnTextColor||"#ffffff",H=r.formBtnBorderColor||"#111111",Te=ge(ie,.06),te=ge(ie,.18),$=ge(Ee,.85),U=ge(K,.06),Z=r.loadMoreBgColor||"#ffffff",Me=r.loadMoreTextColor||"#111111",be=r.loadMoreBorderColor||"#111111",O={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":i,"--ikr-header-avg":a,"--ikr-header-count":t,"--ikr-header-recommend":n,"--ikr-bar-fill":d,"--ikr-bar-track":o,"--ikr-star-empty-color":c,"--ikr-bar-count":s,"--ikr-bar-hover-bg":p,"--ikr-btn-bg":l,"--ikr-btn-text":k,"--ikr-btn-border":u,"--ikr-filter-btn-bg":v,"--ikr-filter-btn-text":f,"--ikr-filter-btn-border":w,"--ikr-filter-menu-bg":y,"--ikr-filter-menu-border":b,"--ikr-filter-item-text":g,"--ikr-filter-item-hover-bg":z,"--ikr-filter-item-active":h,"--ikr-review-title":reviewTitleColor,"--ikr-review-author":reviewAuthorColor,"--ikr-review-date":reviewDateColor,"--ikr-review-body":reviewBodyColor,"--ikr-review-border":reviewBorderColor,"--ikr-review-star-color":m,"--ikr-reply-bg-color":x,"--ikr-reply-border":S,"--ikr-reply-label":C,"--ikr-reply-text":E,"--ikr-photo-title":A,"--ikr-photo-image-border":R,"--ikr-photo-arrow-bg":N,"--ikr-photo-arrow-text":B,"--ikr-photo-arrow-border":G,"--ikr-fwizard-bg":pe,"--ikr-fwizard-text":K,"--ikr-fwizard-secondary-text":me,"--ikr-fwizard-input-bg":pe,"--ikr-fwizard-input-text":D,"--ikr-fwizard-input-border":q,"--ikr-fwizard-placeholder":J,"--ikr-fwizard-close-text":K,"--ikr-fwizard-close-hover-bg":U,"--ikr-fwizard-progress-bg":U,"--ikr-fwizard-progress-active":V,"--ikr-fwizard-btn-bg":ie,"--ikr-fwizard-btn-text":Ee,"--ikr-fwizard-btn-border":H,"--ikr-fwizard-btn-disabled-bg":te,"--ikr-fwizard-btn-disabled-text":$,"--ikr-fwizard-nav-hover-bg":Te,"--ikr-load-more-bg":Z,"--ikr-load-more-text":Me,"--ikr-load-more-border":be};Object.keys(O).forEach(function(W){e.style.setProperty(W,O[W])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function he(e,r,i,a,t,n,d){if(cr){Ke({productId:e,settings:r,reviewsData:i,productName:a,orderBy:t,page:n,badgeSettings:d});return}Ue(!0),Ar(e),Nr(r),d!==void 0&&Ir(d),_r(a),t&&Le(t),n&&Se(n),i!=null&&Br(i);try{let Pe=function(T,L){if(!(!T||!T.meta||!T.meta.sizeOverrides)){var M=T.meta.sizeOverrides[L];M&&Object.keys(M).forEach(function(ae){l.style.setProperty(ae,M[ae])})}};var nr=Pe,o=er(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),p=r.showTitle!==!1,m=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",c=s&&p?m:"",l=document.documentElement;xt(l,r),jr("#111111",Ur+ci()+ui());var k=r.borderRadius!==void 0?r.borderRadius:8,u=fi[r.size]||fi.medium,v=vi[r.thumbnailSize]||vi.medium;l.style.setProperty("--ikr-title-size",u.titleSize+"px"),l.style.setProperty("--ikr-review-text-size",u.reviewTextSize+"px"),l.style.setProperty("--ikr-review-title-size",u.reviewTitleSize+"px"),l.style.setProperty("--ikr-author-size",u.authorSize+"px"),l.style.setProperty("--ikr-reply-name-size",u.replyNameSize+"px"),l.style.setProperty("--ikr-reply-text-size",u.replyTextSize+"px"),l.style.setProperty("--ikr-radius",k+"px"),l.style.setProperty("--ikr-radius-sm",Math.max(0,k-4)+"px"),l.style.setProperty("--ikr-photo-title-size",u.photoTitleSize+"px"),l.style.setProperty("--ikr-avg-rating-size",u.avgRatingSize+"px"),l.style.setProperty("--ikr-review-count-size",u.reviewCountSize+"px"),l.style.setProperty("--ikr-recommend-size",u.recommendSize+"px"),l.style.setProperty("--ikr-btn-text-size",u.btnTextSize+"px"),l.style.setProperty("--ikr-bar-label-size",u.barLabelSize+"px"),l.style.setProperty("--ikr-minimal-avg-size",u.minimalAvgSize+"px"),l.style.setProperty("--ikr-hero-avg-size",u.heroAvgSize+"px"),l.style.setProperty("--ikr-bar-count-size",u.barCountSize+"px"),l.style.setProperty("--ikr-review-date-size",u.reviewDateSize+"px"),l.style.setProperty("--ikr-filter-text-size",u.filterTextSize+"px"),l.style.setProperty("--ikr-load-more-size",u.loadMoreSize+"px"),l.style.setProperty("--ikr-read-more-size",u.readMoreSize+"px"),l.style.setProperty("--ikr-thumbnail-size",v+"px");var f=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";l.style.setProperty("--ikr-review-star-color",f),l.style.setProperty("--ikr-star-empty-color",ge(f,.25)),l.style.setProperty("--ikr-star-size",u.reviewStarSize+"px"),l.style.setProperty("--ikr-avg-star-size",u.avgStarSize+"px"),Pe(er(r.summaryLayout),r.size),Pe(ir(r.reviewLayout),r.size);var w=Ae(r),y=document.getElementById("ikas-reviews");if(!y){var b=document.getElementById("ikas-reviews-anchor");if(!b)return;y=document.createElement("div"),y.id="ikas-reviews",y.style.minHeight="200px",b.appendChild(y)}if(r.enabled===!1){y.style.minHeight="auto",y.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',Ue(!1);var g=He;Ke(null),g&&he(g.productId,g.settings,g.reviewsData,g.productName,g.orderBy,g.page,g.badgeSettings);return}y.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var z=i||{},h=z.data&&z.data.reviews||[],x=z.data&&z.data.totalCount||0,S=y.cloneNode(!1);y.parentNode.replaceChild(S,y),y=S;var C=document.createElement("div");if(C.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(C.style.width="100%",C.style.maxWidth="100%",C.style.marginLeft="0",C.style.marginRight="0"),c){var E=document.createElement("div"),A=r.summaryLayout||"classic";E.className="ikr-title ikr-title-"+A,E.textContent=c,C.appendChild(E)}var R=z.data&&z.data.allCount||0,N=z.data&&z.data.ratingCounts||null,B=N||[0,0,0,0,0],G=z.data&&z.data.avgRating||"0.0";if(!N&&h.length>0){h.forEach(function(T){T.rating>=1&&T.rating<=5&&B[T.rating-1]++});var pe=h.reduce(function(T,L){return T+L.rating},0);G=(pe/h.length).toFixed(1)}if(R>0){var K=er(r.summaryLayout),me=K.render({widget:C,data:z,settings:r,iconPair:w,allCount:R,ratingCounts:B,avgRatingVal:G,currentRatingFilter:ze,currentOrderBy:ne,currentHasImages:Ce,onFilterChange:async function(T){Ve(ze===T?null:T),Se(1);var L=await Ye(ee,ne,1,ze,Ce);await he(ee,_,L,xe,ne,1)},onSortChange:async function(T,L){Se(1),L?(dr(!0),Le("newest")):(dr(!1),Le(T));var M=await Ye(ee,ne,1,ze,Ce);await he(ee,_,M,xe,ne,1)}});C.appendChild(me)}else{var D=document.createElement("button");D.className="ikr-write-btn",D.style.cssText="display:block;margin:16px auto 0;",D.textContent="Yorum Yap",D.onclick=j,C.appendChild(D)}var q=h.filter(function(T){return T.images&&Array.isArray(T.images)&&T.images.some(function(L){return L&&(L.indexOf("https://")===0||L.indexOf("data:image/")===0)})});if(r.showPhotoGallery!==!1&&!Ce&&q.length>0){var J=document.createElement("div");if(J.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var V=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",ie=document.createElement("div");ie.className="ikr-photo-title",ie.textContent=V,J.appendChild(ie)}var Ee=r.reviewLayout==="card"?"1/1":"3/4";l.style.setProperty("--ikr-photo-thumb-aspect",Ee);var H=document.createElement("div");H.className="ikr-photo-strip";var Te=0;q.forEach(function(T){if(!(Te>=10)){var L=T.images.find(function(ae){return ae&&(ae.indexOf("https://")===0||ae.indexOf("data:image/")===0)});if(L){var M=document.createElement("img");M.src=X(L),M.className="ikr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",(function(ae,Ri){M.onclick=function(){se(Ri,ae,h)}})(L,T),H.appendChild(M),Te++}}});var te=document.createElement("button");te.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",te.innerHTML="&#8249;",te.setAttribute("aria-label","\xD6nceki"),te.onclick=function(){H.scrollBy({left:-200,behavior:"smooth"})};var $=document.createElement("button");$.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",$.innerHTML="&#8250;",$.setAttribute("aria-label","Sonraki"),$.onclick=function(){H.scrollBy({left:200,behavior:"smooth"})};var U=document.createElement("div");U.className="ikr-photo-strip-wrap",U.appendChild(te),U.appendChild(H),U.appendChild($),J.appendChild(U),C.appendChild(J)}if(h.length===0){var Z=document.createElement("p");Z.className="ikr-state-msg",Z.textContent="Hen\xFCz yorum yok.",C.appendChild(Z)}else{var Me=ir(r.reviewLayout);h.forEach(function(T){C.appendChild(Me.render(T,h))})}var be=z.data&&z.data.hasMore;if(be){var O=document.createElement("button");O.className="ikr-load-more",O.textContent="Daha Fazla G\xF6ster",O.onclick=async function(){O.disabled=!0,O.textContent="Y\xFCkleniyor...";var T=Oe+1,L=await Ye(ee,ne,T,ze,Ce);if(L&&L.data&&L.data.reviews){Se(T);var M=ir(_.reviewLayout);L.data.reviews.forEach(function(ae){C.insertBefore(M.render(ae,L.data.reviews),O)}),L.data.hasMore?(O.disabled=!1,O.textContent="Daha Fazla G\xF6ster"):O.remove()}else O.remove()},C.appendChild(O)}y.appendChild(C),Vr(R>0?G:null,x,a,lr)}catch(T){console.error("[ikr] render error:",T),y.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(Ue(!1),He){var W=He;Ke(null),he(W.productId,W.settings,W.reviewsData,W.productName,W.orderBy,W.page,W.badgeSettings)}}}var we="ikr_settings_"+Y,wt=300*1e3,zt=30*1e3;async function zr(){if(window.__ikasPreviewMode){try{var e=window.__ikasPreviewBaseUrl||Q,r=window.__ikasPreviewSettings||sessionStorage.getItem("ikr_preview_settings")||"",i={};if(r)try{i=JSON.parse(r)}catch(m){}var a=await re(e+"/api/preview/settings");if(a.ok){var t=await a.json();return t.widgets&&t.widgets.reviews&&Object.keys(i).length&&(t.widgets.reviews=Object.assign({},t.widgets.reviews,i)),t}}catch(m){}return null}var n=null,d=De(we);if(d)try{var o=JSON.parse(d);if(o&&o.t!==void 0)if(o.notFound){if(Date.now()-o.t<zt)return null;P(we,"")}else if(o.v){if(Date.now()-o.t<wt)return o.v;n=o.v,P(we,"")}else P(we,"");else P(we,"")}catch(m){P(we,"")}try{var s=await re(Q+"/api/public/settings?publicApiKey="+encodeURIComponent(Y));if(!s.ok)return s.status===404&&P(we,JSON.stringify({t:Date.now(),notFound:!0})),n||null;var p=await s.json();return P(we,JSON.stringify({t:Date.now(),v:p})),p}catch(m){return console.error("[ikr] fetchSettings error:",m),n||null}}var Ct=60*1e3;async function Ye(e,r,i,a,t){if(window.__ikasPreviewMode){try{var n=window.__ikasPreviewBaseUrl||Q,d=n+"/api/preview/reviews?page="+encodeURIComponent(i||1),o=await re(d);if(o.ok)return await o.json()}catch(v){}return null}r=r||"newest",i=i||1;var s="ikr_reviews_"+Y+"_"+e+"_"+r+"_"+i+"_"+(a||"")+"_"+(t?"1":"0"),p=null,m=De(s);if(m)try{var c=JSON.parse(m);if(c&&c.t!==void 0&&c.v){if(Date.now()-c.t<Ct)return c.v;p=c.v,P(s,"")}else P(s,"")}catch(v){P(s,"")}try{var l=Q+"/api/public/reviews?storeId="+encodeURIComponent(Y)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(a?"&rating="+encodeURIComponent(a):"")+(t?"&hasImages=true":""),k=await re(l);if(!k.ok)return p||null;var u=await k.json();return P(s,JSON.stringify({t:Date.now(),v:u})),u}catch(v){return console.error("[ikr] fetchReviews error:",v),p||null}}var wr={};async function Be(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var a=document.getElementById("ikr-jsonld");if(a&&a.remove(),!wr[e]){wr[e]=!0;var t={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},n={enabled:!0,icon:"star",size:"medium",color:"#f59e0b"};try{var d=await zr();if(!d)return;var o=d.widgets&&d.widgets.reviews||t,s=d.widgets&&d.widgets.badge||n;if(o.enabled===!1)return;Le("newest"),Se(1),Ve(null);var p=await Ye(e,"newest",1,null);await he(e,o,p,r,"newest",1,s)}catch(m){console.error("[ikr] bootstrap error:",m),await he(e,t,null,r,void 0,void 0,n)}finally{delete wr[e]}}}function Cr(){try{var e=window.__NEXT_DATA__&&window.__NEXT_DATA__.props&&window.__NEXT_DATA__.props.pageProps;if(e&&e.pageType==="PRODUCT"&&e.pageSpecificData&&e.pageSpecificData.id)return{id:e.pageSpecificData.id,name:e.pageSpecificData.name||null}}catch(a){}if(window.IkasStorefront&&window.IkasStorefront.product&&window.IkasStorefront.product.id)return{id:window.IkasStorefront.product.id,name:window.IkasStorefront.product.name||null};var r=window.location.pathname.match(/--([a-f0-9-]{36})(?:\/|$|\?)/);if(r)return{id:r[1],name:null};var i=new URLSearchParams(window.location.search).get("productId");return i?{id:i,name:null}:null}function ki(){var e={},r={};return document.querySelectorAll("a[href]").forEach(function(i){try{var a=i.getAttribute("href");if(!a||a.charAt(0)==="#"||a.charAt(0)==="?")return;var t=F(i.href);if(!t||r[t]||!/^[a-z0-9][a-z0-9-]{2,}$/.test(t)||Xe.test(t))return;r[t]=!0,e[t]=null}catch(n){}}),Object.keys(Fe).forEach(function(i){e[i]=Fe[i]}),e}var St=300*1e3,gi=50;async function hi(e){var r="ikr_ratings_"+Y,i={},a=De(r);if(a)try{var t=JSON.parse(a);t&&t.t!==void 0&&Date.now()-t.t<St?i=t.v||{}:P(r,"")}catch(p){P(r,"")}var n=e.filter(function(p){return!i[p]});if(!n.length)return i;for(var d=[],o=0;o<n.length;o+=gi)d.push(n.slice(o,o+gi));var s=await Promise.all(d.map(function(p){var m=Q+"/api/public/ratings-by-slug?storeId="+encodeURIComponent(Y)+"&slugs="+p.map(encodeURIComponent).join(",");return re(m).then(function(c){return c.ok?c.json().then(function(l){return l.data||{}}):{}}).catch(function(){return{}})}));return s.forEach(function(p){n.forEach(function(m){i[m]||(i[m]={average:0,count:0,_empty:!0})}),Object.keys(p).forEach(function(m){i[m]=p[m]})}),P(r,JSON.stringify({t:Date.now(),v:i})),i}var Et="var(--ikr-badge-color,#f59e0b)",bi=13,Tt="display:flex;align-items:center;gap:3px;margin-top:0px;margin-bottom:4px;font-size:13px;font-weight:400;color:#555;pointer-events:none;";function Lt(e){var r=qe("star","classic"),i="width:"+bi+"px;height:"+bi+"px;";return'<span style="color:'+Et+';display:inline-flex;align-items:center;">'+le(e,r,{sizeStyle:i})+"</span>"}function Ge(e,r){var i=document.createElement("div");return i.setAttribute("data-ikr-listing-badge","1"),i.style.cssText=Tt+"justify-content:"+(r||"flex-start")+";",i.innerHTML=Lt(e.avg)+'<span style="font-weight:400;">'+e.avg+" ("+e.count+")</span>",i}var yi=".product-name",xi=".add-to-basket-modal",wi="h1.product-name",tr=".single-product-container-main",Sr=".single-product-product-name",zi=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),Ci=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var Si='[class*="productTitle"],[class*="productName"],[class*="product_title"],[class*="product_name"],[class*="product-title"],[class*="product-name"]',At=/^(tükendi|sold out|out of stock|stokta yok|satıldı|unavailable)$/i;function Er(e,r){var i=e.querySelector(yi);if(i)return i;if(e.matches&&e.matches(Si))return e;var a=e.querySelector(Si);if(a)return a;if(r){for(var t=e.querySelectorAll("*"),n=0;n<t.length;n++)if(t[n].children.length===0&&t[n].textContent.trim()===r)return t[n]}for(var d=e.querySelectorAll("p, h1, h2, h3, h4, h5, h6, span, div"),o=0;o<d.length;o++){var s=d[o],p=s.textContent.trim();if(!(!p||p.length<2||p.length>150)&&!/^[\d\s.,₺$€£%]+$/.test(p)&&!At.test(p)&&!(s.closest("figure")||s.closest("picture"))&&!(s.children.length>1))return s}return null}function Nt(e,r,i,a){if(!e.getAttribute("data-ikr-badge")){var t=F(e.href);if(e.id==="ikr-rating-badge"){e.setAttribute("data-ikr-badge","1");return}if(t===a&&e.getAttribute("href")&&e.getAttribute("href").charAt(0)==="#"){e.setAttribute("data-ikr-badge","1");return}if(e.closest("header")||e.closest("nav")){e.setAttribute("data-ikr-badge","1");return}if(e.closest('[class*="basket"]')||e.closest('[class*="cart"]')){e.setAttribute("data-ikr-badge","1");return}if(e.closest(tr)&&!e.closest(Sr)){e.setAttribute("data-ikr-badge","1");return}if(t===a&&e.closest(Sr)){e.setAttribute("data-ikr-badge","1");return}if(e.closest(zi)){e.setAttribute("data-ikr-badge","1");return}var n=!!e.querySelector("a[href]"),d=Array.from(e.childNodes).filter(function(u){return u.nodeType===3}).map(function(u){return u.textContent.trim()}).join("").trim(),o=!!Er(e,i);if(!d&&!o&&!n){e.setAttribute("data-ikr-badge","1");return}if(e.setAttribute("data-ikr-badge","1"),n){e.querySelectorAll("a[href]").forEach(function(u){u.setAttribute("data-ikr-badge","1")});var s=Er(e,i);if(!s||s.querySelector("[data-ikr-listing-badge]"))return;var p=window.getComputedStyle(s).textAlign;s.appendChild(Ge(r,p==="center"?"center":p==="right"?"flex-end":"flex-start"));return}var m=Er(e,i);if(!(m&&m.querySelector("[data-ikr-listing-badge]")))if(m){var c=window.getComputedStyle(m).textAlign;m.appendChild(Ge(r,c==="center"?"center":c==="right"?"flex-end":"flex-start"))}else{var l=Ge(r,"flex-start"),k=e.firstElementChild;k?e.insertBefore(l,k):e.appendChild(l)}}}function It(e,r){var i=document.querySelector(xi);if(i){var a=i.querySelector(wi);if(!(!a||a.querySelector("[data-ikr-listing-badge]"))){var t=null;if(je&&r[je]&&(t=je),!t){var n=F(window.location.pathname);n&&r[n]&&(t=n)}if(!t){var d=a.textContent.trim();Object.keys(e).forEach(function(c){if(!t){var l=e[c];l&&l.trim()===d&&r[c]&&(t=c)}})}if(!t){var o=document.querySelector(tr);if(o){var s=o.querySelector("a[href]");if(s){var p=F(s.href);p&&r[p]&&(t=p)}}}if(!t){var m=a.textContent.trim().toLowerCase();document.querySelectorAll("a[href]").forEach(function(c){if(!t&&!(c.closest("header")||c.closest("nav"))&&!c.closest(tr)){var l=c.textContent.trim().toLowerCase();if(l&&l===m){var k=F(c.href);k&&r[k]&&(t=k)}}})}!t||!r[t]||r[t]._empty||r[t].count===0||a.appendChild(Ge(r[t],"flex-start"))}}}function Ei(e,r){var i=F(window.location.pathname),a=document.querySelectorAll(Ci),t=[];a.forEach(function(n){n.tagName==="A"&&n.href?t.push(n):n.querySelectorAll("a[href]").forEach(function(d){t.push(d)})}),Object.keys(e).forEach(function(n){var d=r[n];if(!(!d||d._empty||d.count===0)){var o=e[n];t.forEach(function(s){F(s.href)===n&&Nt(s,d,o,i)})}}),It(e,r)}async function Re(){if(I.inProgress){I.queued=!0;return}if(!I.rendered){I.rendered=!0,I.inProgress=!0;try{var e=I.navCleanup;e&&(I.navCleanup=!1);var r=ki();if(!Object.keys(r).length){I.rendered=!1;return}var i=await Promise.all([zr(),hi(Object.keys(r))]),a=i[0];if(!a){I.rendered=!1;return}var t=i[1],n=a&&a.widgets||{},d=n.badge&&n.badge.color||"#f59e0b";if(n.badge&&n.badge.enabled===!1){I.rendered=!1;return}document.documentElement.style.setProperty("--ikr-badge-color",d),e&&(document.querySelectorAll("[data-ikr-listing-badge]").forEach(function(o){o.remove()}),document.querySelectorAll("[data-ikr-badge]").forEach(function(o){o.removeAttribute("data-ikr-badge")})),Ei(r,t)}finally{I.inProgress=!1,I.queued&&(I.queued=!1,I.rendered=!1,Re())}}}var Ti=!1,Li=!1;function Ii(){Li||(Li=!0,document.addEventListener("click",function(e){var r=e.target.closest("a[href]");if(r&&!(r.closest("header")||r.closest("nav"))&&!(r.closest('[class*="basket"]')||r.closest('[class*="cart"]'))){var i=F(r.href);!i||i.length<3||Rr(i)}},!0))}var Ai=!1,Ni=typeof location!="undefined"?location.pathname:"";function ar(){try{if(location.pathname===Ni)return;Ni=location.pathname;var e=document.getElementById("ikr-rating-badge");e&&e.remove();var r=document.getElementById("ikr-jsonld");r&&r.remove()}catch(i){}}function _t(){if(!Ai){Ai=!0;var e=history.pushState,r=history.replaceState;history.pushState=function(){var i=e.apply(this,arguments);return ar(),i},history.replaceState=function(){var i=r.apply(this,arguments);return ar(),i},window.addEventListener("popstate",ar),window.addEventListener("hashchange",ar)}}function Tr(){if(_t(),window.IkasEvents){if(Ti)return;Ti=!0,window.IkasEvents.subscribe({id:"ikas-reviews-widget",callback:function(n){if(n&&n.type==="VIEW_LISTING"){var d=n.data&&n.data.productDetails;Array.isArray(d)&&d.forEach(function(m){m&&m.metaData&&m.metaData.slug&&m.name&&(Fe[m.metaData.slug]=m.name)})}if(n&&n.type==="PRODUCT_VIEW"){var o=n.data&&n.data.productDetail&&n.data.productDetail.id,s=n.data&&n.data.productDetail&&n.data.productDetail.name;o&&(P("ikr_reviews_"+Y+"_"+o,""),Be(o,s))}if(n&&n.type==="PAGE_VIEW"){var p=Date.now();if(I.lastPageView&&p-I.lastPageView<800)return;I.lastPageView=p,I.navCleanup=!0,I.rendered=!1,Re()}}});var e=Cr();if(e)Be(e.id,e.name);else{let n=function(){var d=Cr();d?Be(d.id,d.name):r<20&&(r++,setTimeout(n,100))};var a=n,r=0;setTimeout(n,100)}setTimeout(function(){I.rendered||Re()},2e3)}else{let n=function(){window.IkasEvents?Tr():i<100&&(i++,setTimeout(n,50))};var t=n,i=0;setTimeout(n,50)}}var _i=null;function Bi(){if(typeof MutationObserver!="undefined"){var e=new MutationObserver(function(r){var i=r.some(function(a){return Array.from(a.addedNodes).some(function(t){return!(t.nodeType!==1||t.hasAttribute&&(t.hasAttribute("data-ikr-listing-badge")||t.id==="ikr-rating-badge"||t.id==="ikr-reviews-widget")||t.closest&&(t.closest("[data-ikr-listing-badge]")||t.closest("#ikr-rating-badge")||t.closest("#ikr-reviews-widget"))||t.querySelector&&t.querySelector("[data-ikr-listing-badge],#ikr-reviews-widget,#ikr-rating-badge"))})});i&&(clearTimeout(_i),_i=setTimeout(function(){var a=Array.from(document.querySelectorAll("a[href]")).some(function(t){if(t.getAttribute("data-ikr-badge"))return!1;var n=F(t.href);return n&&n.length>=3&&!Xe.test(n)});a&&(I.rendered=!1,Re())},300))});e.observe(document.body,{childList:!0,subtree:!0})}}var Bt=window.__ikasPreviewMode===!0;if(Bt){let e=function(){try{window.parent.postMessage({type:"IKR_WIDGET_READY"},"*")}catch(i){}},r=function(){Be("mock-product","\xD6rnek \xDCr\xFCn"),e()};Rt=e,Mt=r,window.addEventListener("message",function(i){var a=i.data;if(!(!a||a.type!=="IKR_SETTINGS_UPDATE")){var t=a.settings;if(!(!t||!_)){var n=Object.assign({},_,t);he(ee,n,sr,xe,ne,Oe)}}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()}else if(Y){let e=function(){Tr(),Ii(),Bi()};Pt=e,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}var Rt,Mt,Pt;})();
