...
`;var Yi={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Gi=Zr;function Ui(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,o=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,n=e.onFilterChange,p=e.onSortChange,v=document.createElement("div");v.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var m=document.createElement("div");m.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",m.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+s+"</span>",k.appendChild(m);var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-count ikr-split-left-count",u.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(u),v.appendChild(k);var f=document.createElement("div");f.className="ikr-split-col ikr-split-mid",f.appendChild(we({ratingCounts:o,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:n})),v.appendChild(f);var h=ee({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),g=h.querySelector(".ikr-filter-wrap"),C=h.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-split-col ikr-split-right",C&&x.appendChild(C),g&&x.appendChild(g),v.appendChild(x),i.showRecommendation!==!1){var z=(o[3]||0)+(o[4]||0),E=a>0?Math.round(z/a*100):0;if(E>0){var w=document.createElement("div");w.className="ikr-summary-block ikr-summary-recommend",w.innerHTML='<span class="ikr-recommend-pct">%'+E+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(w)}}return v}var mr={};le(mr,{css:()=>Vi,meta:()=>Ki,render:()=>Zi});var Wr=`
