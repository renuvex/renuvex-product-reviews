/* ikas Reviews Widget — built 2026-04-06T22:02:44.295Z | theme: default */
"use strict";
(() => {
  ...
  .ikr-modal-close{position:absolute;top:-42px;right:-4px;background:#000;border:2px solid #000;color:#fff;font-size:14px;cursor:pointer;line-height:1;padding:0;border-radius:8px;width:32px;height:32px;display:flex;align-items:center;justify-content:center;z-index:100000;box-shadow:0 2px 8px rgba(0,0,0,0.20);}
