/* ikas Reviews Widget — built 2026-04-28T09:48:24.481Z | theme: default */
...
`;var gr={};ce(gr,{meta:()=>st,render:()=>ct});function Ee(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,s=i>0?Math.round(d/i*100):0,u=a===l,m=document.createElement("div");m.className="ikr-bar-row"+(u?" ikr-bar-active":""),a&&!u&&(m.style.opacity="0.35");for(var c="",k=1;k<=5;k++){var v=k<=l;c+='<span class="ikr-bar-star ikr-icon '+(v?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(v?t.filled:t.empty)+"</span>"}m.innerHTML='<span class="ikr-bar-label">'+c+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+s+'%;"></div></div><span class="ikr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(p){m.onclick=function(){n(p)}})(l),o.appendChild(m)}return o}var re=[],ii=!1;function Qi(e){for(var r=re.length-1;r>=0;r--){var i=re[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function et(e){if(e.key==="Escape")for(var r=re.length-1;r>=0;r--)re[r].close()}function rt(){ii||typeof document=="undefined"||(document.addEventListener("click",Qi,!0),document.addEventListener("keydown",et),ii=!0)}function Je(e){for(var r=0;r<re.length;r++)re[r]!==e&&re[r].close()}function $e(e){rt();var r={trigger:e.trigger,element:e.element,close:e.close};return re.push(r),function(){var t=re.indexOf(r);t!==-1&&re.splice(t,1)}}function ie(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,o.appendChild(l);var d=document.createElement("div");d.className="ikr-filter-wrap";var s=document.createElement("button");s.className="ikr-filter-btn",s.setAttribute("aria-label","Filtrele");var u=A&&A.filterIcon||"lines";s.innerHTML=Vr(u);var m=document.createElement("div");m.className="ikr-filter-menu";var c=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function k(){m.classList.remove("ikr-open"),s.classList.remove("ikr-filter-btn-active")}function v(){Je(p),m.classList.add("ikr-open"),s.classList.add("ikr-filter-btn-active")}c.forEach(function(f){var h=f[2],g=h?t:!t&&(i||"newest")===f[0],y=document.createElement("div");y.className="ikr-filter-item"+(g?" ikr-filter-item-active":""),y.textContent=f[1],y.onclick=function(){k(),n(f[0],h)},m.appendChild(y)}),s.onclick=function(){m.classList.contains("ikr-open")?k():v()};var p=$e({trigger:d,element:m,close:k});return d.appendChild(s),d.appendChild(m),o.appendChild(d),o}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var n=document.createElement("button");n.className="ikr-fwizard-close",n.type="button",n.setAttribute("aria-label","Kapat"),n.innerHTML="\u2715",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-content",a.appendChild(o);var l=!1,d="",s="";function u(){var f=window.innerWidth-document.documentElement.clientWidth;d=document.body.style.overflow,s=document.body.style.paddingRight,document.body.style.overflow="hidden",f>0&&(document.body.style.paddingRight=f+"px")}function m(){document.body.style.overflow=d,document.body.style.paddingRight=s}function c(){l||(l=!0,document.removeEventListener("keydown",k),t.removeEventListener("click",v),n.removeEventListener("click",c),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),m();try{r()}catch(f){}},200))}function k(f){f.key==="Escape"&&c()}function v(f){f.target===t&&i&&c()}document.addEventListener("keydown",k),t.addEventListener("click",v),n.addEventListener("click",c);function p(f){f&&o.appendChild(f),document.body.appendChild(t),u(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open")})}return{open:p,close:c,content:o,setAllowOutsideClose:function(f){i=!!f}}}var ai=`
  ...
  .ikr-fwizard-footer{
    flex:0 0 auto;
    padding:16px 24px;
    /* min-height: butonlar\u0131n en y\xFCkse\u011Fi (CTA ~34px) + dikey padding,
       step 2 (kompakt Atla) ile step 3 (kal\u0131n Sonraki) aras\u0131nda footer
       y\xFCksekli\u011Fi de\u011Fi\u015Fip progress'in dikey kaymas\u0131n\u0131 engeller. */
    min-height:66px;
    box-sizing:border-box;
