...
`;var mt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ut=fi;function ft(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,l=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,m=e.onFilterChange,u=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var v=document.createElement("div");v.className="ikr-compact-trigger-wrap";var f=document.createElement("button");f.className="ikr-compact-trigger",f.type="button",f.setAttribute("aria-expanded","false"),f.innerHTML='<span class="ikr-compact-trigger-stars">'+te(l,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',v.appendChild(f),k.appendChild(v);var p=oe({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:Z,onSortChange:u}),b=p.querySelector(".ikr-filter-wrap"),g=p.querySelector(".ikr-write-btn"),h=document.createElement("div");h.className="ikr-compact-actions-slot",g&&h.appendChild(g),b&&h.appendChild(b),k.appendChild(h),d.appendChild(k);var x=document.createElement("div");x.className="ikr-compact-panel",x.setAttribute("role","dialog"),x.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="ikr-compact-panel-inner";var z=document.createElement("div");z.className="ikr-compact-avg",z.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+l+"</span>",S.appendChild(z),S.appendChild(Ae({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:o,onFilterChange:m})),x.appendChild(S);var y=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(j){var q=j?d:v;x.parentNode!==q&&(x.classList.contains("ikr-open")&&(x.classList.remove("ikr-open"),x.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")),q.appendChild(x))}if(w(y?y.matches:!1),y){var T=function(j){w(j.matches)};y.addEventListener?y.addEventListener("change",T):y.addListener&&y.addListener(T)}if(g){var L=document.createElement("button");L.className="ikr-write-btn",L.textContent="Yorum Yap",L.onclick=Z;var E=document.createElement("div");E.className="ikr-compact-write-row",E.appendChild(L),d.appendChild(E)}function P(){x.classList.remove("ikr-open"),x.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")}function B(){Qe(_),x.classList.add("ikr-open"),x.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true")}f.onclick=function(){x.classList.contains("ikr-open")?P():B()};var _=null;function W(j){_&&(_(),_=null),j||(_=er({trigger:v,element:x,close:P}))}if(W(y?y.matches:!1),y){var le=function(j){W(j.matches)};y.addEventListener?y.addEventListener("change",le):y.addListener&&y.addListener(le)}if(i.showRecommendation!==!1){var D=(n[3]||0)+(n[4]||0),ke=a>0?Math.round(D/a*100):0;if(ke>0){var $=document.createElement("div");$.className="ikr-summary-block ikr-summary-recommend",$.style.marginTop="8px",$.innerHTML='<span class="ikr-recommend-pct">%'+ke+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild($)}}return d}var br={};he(br,{css:()=>kt,meta:()=>vt,render:()=>gt});var vi=`
