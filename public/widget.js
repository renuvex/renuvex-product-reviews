...
`;var Yi={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Gi=Vr;function Ui(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,o=e.onFilterChange,p=e.onSortChange,u=document.createElement("div");u.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var m=document.createElement("div");m.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",m.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+s+"</span>",k.appendChild(m);var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-count ikr-split-left-count",v.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(v),u.appendChild(k);var g=document.createElement("div");g.className="ikr-split-col ikr-split-mid",g.appendChild(we({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:o})),u.appendChild(g);var h=ee({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),f=h.querySelector(".ikr-filter-wrap"),S=h.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-split-col ikr-split-right",S&&x.appendChild(S),f&&x.appendChild(f),u.appendChild(x),i.showRecommendation!==!1){var z=(n[3]||0)+(n[4]||0),E=a>0?Math.round(z/a*100):0;if(E>0){var w=document.createElement("div");w.className="ikr-summary-block ikr-summary-recommend",w.innerHTML='<span class="ikr-recommend-pct">%'+E+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(w)}}return u}var pr={};le(pr,{css:()=>Vi,meta:()=>Ki,render:()=>Zi});var Zr=`
...
`;var Ki={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Vi=Zr;function Zi(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,n=e.currentOrderBy,s=e.currentHasImages,l=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var o=document.createElement("div");o.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=a,o.appendChild(p);var u=document.createElement("span");u.className="ikr-minimal-stars",u.innerHTML=J(a,i),o.appendChild(u);var k=document.createElement("span");k.className="ikr-minimal-count",k.textContent=t.toLocaleString("tr-TR")+" Yorum",o.appendChild(k),c.appendChild(o),d.appendChild(c);var m=ee({widget:r,currentOrderBy:n,currentHasImages:s,onWriteClick:Y,onSortChange:l}),v=m.querySelector(".ikr-filter-wrap"),g=m.querySelector(".ikr-write-btn"),h=document.createElement("div");if(h.className="ikr-minimal-actions",g&&h.appendChild(g),v&&h.appendChild(v),d.appendChild(h),g){var f=document.createElement("button");f.className="ikr-write-btn",f.textContent="Yorum Yap",f.onclick=Y;var S=document.createElement("div");S.className="ikr-minimal-write-row",S.appendChild(f),d.appendChild(S)}return d}var mr={};le(mr,{css:()=>Ji,meta:()=>Wi,render:()=>Xi});var Wr=`
