...
`;var cr={};le(cr,{meta:()=>Hi,render:()=>qi});function Ce(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,c=i>0?Math.round(d/i*100):0,o=a===l,p=document.createElement("div");p.className="ikr-bar-row"+(o?" ikr-bar-active":""),a&&!o&&(p.style.opacity="0.35");for(var v="",k=1;k<=5;k++){var m=k<=l;v+='<span class="ikr-bar-star ikr-icon '+(m?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(m?t.filled:t.empty)+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+v+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(u){p.onclick=function(){n(u)}})(l),s.appendChild(p)}return s}var Q=[],Vr=!1;function Oi(e){for(var r=Q.length-1;r>=0;r--){var i=Q[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function Pi(e){if(e.key==="Escape")for(var r=Q.length-1;r>=0;r--)Q[r].close()}function Mi(){Vr||typeof document=="undefined"||(document.addEventListener("click",Oi,!0),document.addEventListener("keydown",Pi),Vr=!0)}function Ve(e){for(var r=0;r<Q.length;r++)Q[r]!==e&&Q[r].close()}function Ze(e){Mi();var r={trigger:e.trigger,element:e.element,close:e.close};return Q.push(r),function(){var t=Q.indexOf(r);t!==-1&&Q.splice(t,1)}}function ee(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,s.appendChild(l);var d=document.createElement("div");d.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele"),c.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="4" y1="6" x2="20" y2="6"/><line x1="7" y1="12" x2="17" y2="12"/><line x1="10" y1="18" x2="14" y2="18"/></svg>';var o=document.createElement("div");o.className="ikr-filter-menu";var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function v(){o.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function k(){Ve(m),o.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}p.forEach(function(u){var g=u[2],h=g?t:!t&&(i||"newest")===u[0],f=document.createElement("div");f.className="ikr-filter-item"+(h?" ikr-filter-item-active":""),f.textContent=u[1],f.onclick=function(){v(),n(u[0],g)},o.appendChild(f)}),c.onclick=function(){o.classList.contains("ikr-open")?v():k()};var m=Ze({trigger:d,element:o,close:v});return d.appendChild(c),d.appendChild(o),s.appendChild(d),s}function Y(){var e=document.getElementById("ikr-form-accordion");if(e){var r=e.style.maxHeight&&e.style.maxHeight!=="0px";r?(e.style.maxHeight="0px",e.style.opacity="0"):(e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",setTimeout(function(){e.style.maxHeight="none"},360),setTimeout(function(){var i=document.querySelector("header"),t=i?i.getBoundingClientRect().height:0,a=e.getBoundingClientRect().top+window.pageYOffset-t-16;window.scrollTo({top:a,behavior:"smooth"})},50))}}var Hi={id:"classic",name:"Klasik (A\xE7\u0131k)"};function qi(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,n=e.allCount,s=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,c=e.currentOrderBy,o=e.currentHasImages,p=e.onFilterChange,v=e.onSortChange,k=document.createElement("div");k.className="ikr-summary";var m=(s[3]||0)+(s[4]||0),u=n>0?Math.round(m/n*100):0,g=document.createElement("div");g.className="ikr-summary-block ikr-summary-avg",g.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+l+"</span>",k.appendChild(g);var h=document.createElement("div");if(h.className="ikr-summary-block ikr-summary-count",h.textContent=n.toLocaleString("tr-TR")+" Yorum",k.appendChild(h),t.showRecommendation!==!1&&u>0){var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-recommend",f.innerHTML='<span class="ikr-recommend-pct">%'+u+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(f)}return k.appendChild(Ce({ratingCounts:s,allCount:n,iconPair:a,currentRatingFilter:d,onFilterChange:p})),k.appendChild(ee({widget:r,currentOrderBy:c,currentHasImages:o,onWriteClick:Y,onSortChange:v})),k}var pr={};le(pr,{css:()=>ji,meta:()=>Di,render:()=>Fi});var Zr=`
...
`;var Di={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ji=Zr;function Fi(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,o=e.onFilterChange,p=e.onSortChange,v=document.createElement("div");v.className="ikr-summary ikr-summary-compact";var k=document.createElement("div");k.className="ikr-compact-header";var m=document.createElement("div");m.className="ikr-compact-trigger-wrap";var u=document.createElement("button");u.className="ikr-compact-trigger",u.type="button",u.setAttribute("aria-expanded","false"),u.innerHTML='<span class="ikr-compact-trigger-stars">'+J(s,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',m.appendChild(u),k.appendChild(m);var g=ee({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),h=g.querySelector(".ikr-filter-wrap"),f=g.querySelector(".ikr-write-btn"),C=document.createElement("div");C.className="ikr-compact-actions-slot",f&&C.appendChild(f),h&&C.appendChild(h),k.appendChild(C),v.appendChild(k);var x=document.createElement("div");x.className="ikr-compact-panel",x.setAttribute("role","dialog"),x.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="ikr-compact-panel-inner";var E=document.createElement("div");E.className="ikr-compact-avg",E.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+s+"</span>",z.appendChild(E),z.appendChild(Ce({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:o})),x.appendChild(z);var w=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function S(M){var ce=M?v:m;x.parentNode!==ce&&(x.classList.contains("ikr-open")&&(x.classList.remove("ikr-open"),x.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")),ce.appendChild(x))}if(S(w?w.matches:!1),w){var y=function(M){S(M.matches)};w.addEventListener?w.addEventListener("change",y):w.addListener&&w.addListener(y)}if(f){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent="Yorum Yap",T.onclick=Y;var N=document.createElement("div");N.className="ikr-compact-write-row",N.appendChild(T),v.appendChild(N)}function D(){x.classList.remove("ikr-open"),x.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")}function j(){Ve(I),x.classList.add("ikr-open"),x.setAttribute("aria-hidden","false"),u.setAttribute("aria-expanded","true")}u.onclick=function(){x.classList.contains("ikr-open")?D():j()};var I=null;function K(M){I&&(I(),I=null),M||(I=Ze({trigger:m,element:x,close:D}))}if(K(w?w.matches:!1),w){var he=function(M){K(M.matches)};w.addEventListener?w.addEventListener("change",he):w.addListener&&w.addListener(he)}if(i.showRecommendation!==!1){var Te=(n[3]||0)+(n[4]||0),xe=a>0?Math.round(Te/a*100):0;if(xe>0){var G=document.createElement("div");G.className="ikr-summary-block ikr-summary-recommend",G.style.marginTop="8px",G.innerHTML='<span class="ikr-recommend-pct">%'+xe+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(G)}}return v}var mr={};le(mr,{css:()=>Gi,meta:()=>Yi,render:()=>Ui});var Wr=`
...
`;var Yi={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Gi=Wr;function Ui(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,o=e.onFilterChange,p=e.onSortChange,v=document.createElement("div");v.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var m=document.createElement("div");m.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",m.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+s+"</span>",k.appendChild(m);var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-count ikr-split-left-count",u.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(u),v.appendChild(k);var g=document.createElement("div");g.className="ikr-split-col ikr-split-mid",g.appendChild(Ce({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:o})),v.appendChild(g);var h=ee({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),f=h.querySelector(".ikr-filter-wrap"),C=h.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-split-col ikr-split-right",C&&x.appendChild(C),f&&x.appendChild(f),v.appendChild(x),i.showRecommendation!==!1){var z=(n[3]||0)+(n[4]||0),E=a>0?Math.round(z/a*100):0;if(E>0){var w=document.createElement("div");w.className="ikr-summary-block ikr-summary-recommend",w.innerHTML='<span class="ikr-recommend-pct">%'+E+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(w)}}return v}var ur={};le(ur,{css:()=>Vi,meta:()=>Ki,render:()=>Zi});var Jr=`
...
`;var Ki={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1}},Vi=Jr;function Zi(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,n=e.currentOrderBy,s=e.currentHasImages,l=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var o=document.createElement("div");o.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=a,o.appendChild(p);var v=document.createElement("span");v.className="ikr-minimal-stars",v.innerHTML=J(a,i),o.appendChild(v);var k=document.createElement("span");k.className="ikr-minimal-count",k.textContent=t.toLocaleString("tr-TR")+" Yorum",o.appendChild(k),c.appendChild(o),d.appendChild(c);var m=ee({widget:r,currentOrderBy:n,currentHasImages:s,onWriteClick:Y,onSortChange:l}),u=m.querySelector(".ikr-filter-wrap"),g=m.querySelector(".ikr-write-btn"),h=document.createElement("div");if(h.className="ikr-minimal-actions",g&&h.appendChild(g),u&&h.appendChild(u),d.appendChild(h),g){var f=document.createElement("button");f.className="ikr-write-btn",f.textContent="Yorum Yap",f.onclick=Y;var C=document.createElement("div");C.className="ikr-minimal-write-row",C.appendChild(f),d.appendChild(C)}return d}var vr={};le(vr,{css:()=>Ji,meta:()=>Wi,render:()=>Xi});var Xr=`
...
`;var at={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"90px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"120px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},nt=ei;function ot(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length&&e.images[0]&&(e.images[0].indexOf("https://")===0||e.images[0].indexOf("data:image/")===0)),t=document.createElement("div");t.className="ikr-review-gallery"+(i?"":" ikr-review-gallery--no-media");var a=document.createElement("div");a.className="ikr-review-gallery-content";var n=document.createElement("span");if(n.className="ikr-review-stars ikr-review-gallery-stars",n.innerHTML=te(e.rating,_),a.appendChild(n),e.title){var s=document.createElement("div");s.className="ikr-review-gallery-title",s.textContent=e.title,a.appendChild(s)}var l=document.createElement("div");l.className="ikr-review-gallery-author",l.textContent=e.author||"",a.appendChild(l);var d=document.createElement("div");d.className="ikr-review-gallery-date",d.textContent=ae(e.createdAt),a.appendChild(d);var c=(e.comment||"").trim();if(c){var o=document.createElement("div");o.className="ikr-review-gallery-body ikr-body-clamped",o.textContent=c,a.appendChild(o);var p=document.createElement("span");p.className="ikr-read-more",p.textContent="Devam\u0131n\u0131 oku",p.style.display="none",p.style.cursor="pointer",p.onclick=function(){var g=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;$(e,g,r)},a.appendChild(p),requestAnimationFrame(function(){o.scrollHeight>o.clientHeight+2&&(p.style.display="inline")})}if(t.appendChild(a),i){var v=e.images[0],k=document.createElement("div");k.className="ikr-review-gallery-media";var m=document.createElement("img");m.src=U(v),m.loading="lazy",m.setAttribute("data-ikr-img-url",v),m.onclick=function(){$(e,v,r)},k.appendChild(m),t.appendChild(k)}var u=Se(e.merchantReply,function(){var g=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;$(e,g,r)});return u&&(u.classList.add("ikr-review-gallery-reply"),t.appendChild(u)),t}var Xe={card:kr,list:gr,gallery:fr};function $e(e){return Xe[e]||Xe.card}function ri(){return Object.keys(Xe).map(function(e){return Xe[e].css||""}).join(`
`)}function P(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var t=parseInt(i[1],16),a=parseInt(i[2],16),n=parseInt(i[3],16);return"rgba("+t+","+a+","+n+","+r+")"}var ii={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:14,recommendSize:12,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:52},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:16,recommendSize:14,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:64},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:18,recommendSize:16,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:76}},ti={small:80,medium:110,large:140};function lt(e,r){var i=r.bgColor||"#ffffff",t=r.textColor||"#111111",a=r.replyBgColor||"#f3f4f6",n=r.inputBgColor||"#ffffff",s=r.widgetBgColor||i,l=r.widgetBorderColor||"transparent",d=r.separatorColor||P(t,.08),c=r.headerTitleColor||t,o=r.headerAvgColor||t,p=r.headerCountColor||t,v=r.headerRecommendColor||t,k=r.barLabelColor||t,m=r.barFillColor||t,u=r.barTrackColor||P(t,.1),g=r.barCountColor||t,h=r.barHoverBgColor||P(t,.05),f=r.primaryColor||"#111111",C=r.primaryTextColor||"#ffffff",x=r.btnBgColor||f,z=r.btnTextColor||C,E=r.btnBorderColor||f,w=r.filterBtnBgColor||f,S=r.filterBtnTextColor||C,y=r.filterBtnBorderColor||f,T=r.filterMenuBgColor||i,N=r.filterMenuBorderColor||P(t,.12),D=r.filterItemTextColor||t,j=r.filterItemHoverBgColor||P(f,.07),I=r.filterItemActiveColor||f,K=r.reviewTitleColor||t,he=r.reviewAuthorColor||t,Te=r.reviewDateColor||t,xe=r.reviewBodyColor||t,G=r.reviewBorderColor||P(t,.08),M=r.reviewStarColor||"#f59e0b",ce=r.replyBgColor||a,ye=r.replyBorderColor||f,Le=r.replyLabelColor||t,rr=r.replyTextColor||t,pe=r.photoBgColor||P(t,.03),je=r.photoBorderColor||P(t,.1),me=r.photoTitleColor||t,ue=r.formBgColor||i,ve=r.formBorderColor||P(t,.08),Ae=r.inputBgColor||n,ir=r.inputTextColor||t,tr=r.inputBorderColor||P(t,.2),F=r.placeholderColor||P(t,.35),re=r.loadMoreBgColor||i,Sr=r.loadMoreTextColor||t,Ne=r.loadMoreBorderColor||P(t,.3),b=r.modalBgColor||i,L=r.modalTextColor||t,B=r.modalCloseBgColor||f,H=r.modalCloseTextColor||C,_e=r.modalCloseBorderColor||f,wi=r.modalNavBgColor||"rgba(0,0,0,0.45)",Ci=r.modalNavTextColor||"#ffffff",Si=r.modalReplyBgColor||a,zi=r.modalReplyBorderColor||f,zr={"--ikr-widget-bg":s,"--ikr-widget-border":l,"--ikr-separator":d,"--ikr-header-title":c,"--ikr-header-avg":o,"--ikr-header-count":p,"--ikr-header-recommend":v,"--ikr-bar-label":k,"--ikr-bar-fill":m,"--ikr-bar-track":u,"--ikr-bar-count":g,"--ikr-bar-hover-bg":h,"--ikr-btn-bg":x,"--ikr-btn-text":z,"--ikr-btn-border":E,"--ikr-filter-btn-bg":w,"--ikr-filter-btn-text":S,"--ikr-filter-btn-border":y,"--ikr-filter-menu-bg":T,"--ikr-filter-menu-border":N,"--ikr-filter-item-text":D,"--ikr-filter-item-hover-bg":j,"--ikr-filter-item-active":I,"--ikr-review-title":K,"--ikr-review-author":he,"--ikr-review-date":Te,"--ikr-review-body":xe,"--ikr-review-border":G,"--ikr-review-star-color":M,"--ikr-reply-bg-color":ce,"--ikr-reply-border":ye,"--ikr-reply-label":Le,"--ikr-reply-text":rr,"--ikr-photo-bg":pe,"--ikr-photo-border":je,"--ikr-photo-title":me,"--ikr-form-bg":ue,"--ikr-form-border":ve,"--ikr-input-bg-color":Ae,"--ikr-input-text-color":ir,"--ikr-input-border":tr,"--ikr-placeholder":F,"--ikr-load-more-bg":re,"--ikr-load-more-text":Sr,"--ikr-load-more-border":Ne,"--ikr-modal-bg":b,"--ikr-modal-text":L,"--ikr-modal-close-bg":B,"--ikr-modal-close-text":H,"--ikr-modal-close-border":_e,"--ikr-modal-nav-bg":wi,"--ikr-modal-nav-text":Ci,"--ikr-modal-reply-bg":Si,"--ikr-modal-reply-border":zi,"--ikr-bg":i,"--ikr-surface":i,"--ikr-text":t,"--ikr-text-faint":P(t,.45),"--ikr-border":P(t,.12),"--ikr-track-bg":P(t,.22),"--ikr-reply-bg":a,"--ikr-input-bg":n,"--ikr-input-text":t};Object.keys(zr).forEach(function(Er){e.style.setProperty(Er,zr[Er])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background=i)}async function oe(e,r,i,t,a,n,s){if(sr){Ge({productId:e,settings:r,reviewsData:i,productName:t,orderBy:a,page:n,badgeSettings:s});return}Ye(!0),Lr(e),Ar(r),s!==void 0&&Nr(s),_r(t),a&&we(a),n&&fe(n),i!=null&&Br(i);try{let Ne=function(b,L){if(!(!b||!b.meta||!b.meta.sizeOverrides)){var B=b.meta.sizeOverrides[L];B&&Object.keys(B).forEach(function(H){o.style.setProperty(H,B[H])})}};var Sr=Ne,l=Je(r.summaryLayout),d=l.meta&&l.meta.defaultTitle!==void 0?l.meta.defaultTitle:"M\xFC\u015Fteri Yorumlar\u0131",c=d===""?"":r.title!==void 0?r.title:d,o=document.documentElement;lt(o,r);var p=r.primaryColor||"#111111",v=r.primaryTextColor||"#ffffff";Hr(p,Kr+$r()+ri());var k=r.borderRadius!==void 0?r.borderRadius:8,m=ii[r.size]||ii.medium,u=ti[r.thumbnailSize]||ti.medium;o.style.setProperty("--ikr-title-size",m.titleSize+"px"),o.style.setProperty("--ikr-review-text-size",m.reviewTextSize+"px"),o.style.setProperty("--ikr-review-title-size",m.reviewTitleSize+"px"),o.style.setProperty("--ikr-author-size",m.authorSize+"px"),o.style.setProperty("--ikr-reply-name-size",m.replyNameSize+"px"),o.style.setProperty("--ikr-reply-text-size",m.replyTextSize+"px"),o.style.setProperty("--ikr-color-text",v),o.style.setProperty("--ikr-radius",k+"px"),o.style.setProperty("--ikr-radius-sm",Math.max(0,k-4)+"px"),o.style.setProperty("--ikr-photo-title-size",m.photoTitleSize+"px"),o.style.setProperty("--ikr-avg-rating-size",m.avgRatingSize+"px"),o.style.setProperty("--ikr-review-count-size",m.reviewCountSize+"px"),o.style.setProperty("--ikr-recommend-size",m.recommendSize+"px"),o.style.setProperty("--ikr-btn-text-size",m.btnTextSize+"px"),o.style.setProperty("--ikr-bar-label-size",m.barLabelSize+"px"),o.style.setProperty("--ikr-minimal-avg-size",m.minimalAvgSize+"px"),o.style.setProperty("--ikr-hero-avg-size",m.heroAvgSize+"px"),o.style.setProperty("--ikr-bar-count-size",m.barCountSize+"px"),o.style.setProperty("--ikr-review-date-size",m.reviewDateSize+"px"),o.style.setProperty("--ikr-filter-text-size",m.filterTextSize+"px"),o.style.setProperty("--ikr-load-more-size",m.loadMoreSize+"px"),o.style.setProperty("--ikr-read-more-size",m.readMoreSize+"px"),o.style.setProperty("--ikr-thumbnail-size",u+"px");var g=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";o.style.setProperty("--ikr-review-star-color",g),o.style.setProperty("--ikr-star-size",m.reviewStarSize+"px"),o.style.setProperty("--ikr-avg-star-size",m.avgStarSize+"px"),Ne(Je(r.summaryLayout),r.size),Ne($e(r.reviewLayout),r.size);var h=He(r),f=document.getElementById("ikas-reviews");if(!f){var C=document.getElementById("ikas-reviews-anchor");if(!C)return;f=document.createElement("div"),f.id="ikas-reviews",f.style.minHeight="200px",C.appendChild(f)}if(r.enabled===!1){f.style.minHeight="auto",f.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',Ye(!1);var x=Re;Ge(null),x&&oe(x.productId,x.settings,x.reviewsData,x.productName,x.orderBy,x.page,x.badgeSettings);return}f.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var z=i||{},E=z.data&&z.data.reviews||[],w=z.data&&z.data.totalCount||0,S=f.cloneNode(!1);f.parentNode.replaceChild(S,f),f=S;var y=document.createElement("div");if(y.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(y.style.width="100%",y.style.maxWidth="100%",y.style.marginLeft="0",y.style.marginRight="0"),c){var T=document.createElement("div"),N=r.summaryLayout||"classic";T.className="ikr-title ikr-title-"+N,T.textContent=c,y.appendChild(T)}var D=z.data&&z.data.allCount||0,j=z.data&&z.data.ratingCounts||null,I=j||[0,0,0,0,0],K=z.data&&z.data.avgRating||"0.0";if(!j&&E.length>0){E.forEach(function(b){b.rating>=1&&b.rating<=5&&I[b.rating-1]++});var he=E.reduce(function(b,L){return b+L.rating},0);K=(he/E.length).toFixed(1)}if(D>0){var Te=Je(r.summaryLayout),xe=Te.render({widget:y,data:z,settings:r,iconPair:h,allCount:D,ratingCounts:I,avgRatingVal:K,currentRatingFilter:ke,currentOrderBy:Z,currentHasImages:ge,onFilterChange:async function(b){Fe(ke===b?null:b),fe(1);var L=await qe(ie,Z,1,ke,ge);await oe(ie,_,L,be,Z,1)},onSortChange:async function(b,L){fe(1),L?(lr(!0),we("newest")):(lr(!1),we(b));var B=await qe(ie,Z,1,ke,ge);await oe(ie,_,B,be,Z,1)}});y.appendChild(xe)}else{var G=document.createElement("button");G.className="ikr-write-btn",G.style.cssText="display:block;margin:16px auto 0;",G.textContent="Yorum Yap",G.onclick=function(){var b=document.getElementById("ikr-form-accordion");if(b){var L=b.style.maxHeight&&b.style.maxHeight!=="0px";L?(b.style.maxHeight="0px",b.style.opacity="0"):(b.style.maxHeight=b.scrollHeight+"px",b.style.opacity="1",setTimeout(function(){b.style.maxHeight="none"},360),setTimeout(function(){var B=document.querySelector("header"),H=B?B.getBoundingClientRect().height:0,_e=b.getBoundingClientRect().top+window.pageYOffset-H-16;window.scrollTo({top:_e,behavior:"smooth"})},50))}},y.appendChild(G)}var M=document.createElement("div");M.id="ikr-form-accordion",M.style.cssText="overflow:hidden;max-height:0px;opacity:0;transition:max-height 0.35s ease,opacity 0.25s ease;",M.appendChild(Fr(e,t)),y.appendChild(M);var ce=E.filter(function(b){return b.images&&Array.isArray(b.images)&&b.images.some(function(L){return L&&(L.indexOf("https://")===0||L.indexOf("data:image/")===0)})});if(r.showPhotoGallery!==!1&&!ge&&ce.length>0){var ye=document.createElement("div");ye.className="ikr-photo-section";var Le=document.createElement("div");Le.className="ikr-photo-title",Le.textContent="Foto\u011Frafl\u0131 Yorumlar",ye.appendChild(Le);var rr=r.reviewLayout==="card"?"1/1":"3/4";o.style.setProperty("--ikr-photo-thumb-aspect",rr);var pe=document.createElement("div");pe.className="ikr-photo-strip";var je=0;ce.forEach(function(b){if(!(je>=10)){var L=b.images.find(function(H){return H&&(H.indexOf("https://")===0||H.indexOf("data:image/")===0)});if(L){var B=document.createElement("img");B.src=U(L),B.className="ikr-photo-strip-thumb",B.alt="Yorum foto\u011Fraf\u0131",(function(H,_e){B.onclick=function(){$(_e,H,E)}})(L,b),pe.appendChild(B),je++}}});var me=document.createElement("button");me.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",me.innerHTML="&#8249;",me.setAttribute("aria-label","\xD6nceki"),me.onclick=function(){pe.scrollBy({left:-200,behavior:"smooth"})};var ue=document.createElement("button");ue.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",ue.innerHTML="&#8250;",ue.setAttribute("aria-label","Sonraki"),ue.onclick=function(){pe.scrollBy({left:200,behavior:"smooth"})};var ve=document.createElement("div");ve.className="ikr-photo-strip-wrap",ve.appendChild(me),ve.appendChild(pe),ve.appendChild(ue),ye.appendChild(ve),y.appendChild(ye)}if(E.length===0){var Ae=document.createElement("p");Ae.className="ikr-state-msg",Ae.textContent="Hen\xFCz yorum yok.",y.appendChild(Ae)}else{var ir=$e(r.reviewLayout);E.forEach(function(b){y.appendChild(ir.render(b,E))})}var tr=z.data&&z.data.hasMore;if(tr){var F=document.createElement("button");F.className="ikr-load-more",F.textContent="Daha Fazla G\xF6ster",F.onclick=async function(){F.disabled=!0,F.textContent="Y\xFCkleniyor...";var b=Be+1,L=await qe(ie,Z,b,ke,ge);if(L&&L.data&&L.data.reviews){fe(b);var B=$e(_.reviewLayout);L.data.reviews.forEach(function(H){y.insertBefore(B.render(H,L.data.reviews),F)}),L.data.hasMore?(F.disabled=!1,F.textContent="Daha Fazla G\xF6ster"):F.remove()}else F.remove()},y.appendChild(F)}f.appendChild(y),Ur(D>0?K:null,w,t,nr)}catch(b){console.error("[ikr] render error:",b),f.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(Ye(!1),Re){var re=Re;Ge(null),oe(re.productId,re.settings,re.reviewsData,re.productName,re.orderBy,re.page,re.badgeSettings)}}}var de="ikr_settings_"+q,st=300*1e3,dt=30*1e3;async function xr(){if(window.__ikasPreviewMode){try{var e=window.__ikasPreviewBaseUrl||V,r=window.__ikasPreviewSettings||sessionStorage.getItem("ikr_preview_settings")||"",i={};if(r)try{i=JSON.parse(r)}catch(o){}var t=await X(e+"/api/preview/settings");if(t.ok){var a=await t.json();return a.widgets&&a.widgets.reviews&&Object.keys(i).length&&(a.widgets.reviews=Object.assign({},a.widgets.reviews,i)),a}}catch(o){}return null}var n=null,s=Pe(de);if(s)try{var l=JSON.parse(s);if(l&&l.t!==void 0)if(l.notFound){if(Date.now()-l.t<dt)return null;R(de,"")}else if(l.v){if(Date.now()-l.t<st)return l.v;n=l.v,R(de,"")}else R(de,"");else R(de,"")}catch(o){R(de,"")}try{var d=await X(V+"/api/public/settings?publicApiKey="+encodeURIComponent(q));if(!d.ok)return d.status===404&&R(de,JSON.stringify({t:Date.now(),notFound:!0})),n||null;var c=await d.json();return R(de,JSON.stringify({t:Date.now(),v:c})),c}catch(o){return console.error("[ikr] fetchSettings error:",o),n||null}}var ct=60*1e3;async function qe(e,r,i,t,a){if(window.__ikasPreviewMode){try{var n=window.__ikasPreviewBaseUrl||V,s=n+"/api/preview/reviews?page="+encodeURIComponent(i||1),l=await X(s);if(l.ok)return await l.json()}catch(u){}return null}r=r||"newest",i=i||1;var d="ikr_reviews_"+q+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(a?"1":"0"),c=null,o=Pe(d);if(o)try{var p=JSON.parse(o);if(p&&p.t!==void 0&&p.v){if(Date.now()-p.t<ct)return p.v;c=p.v,R(d,"")}else R(d,"")}catch(u){R(d,"")}try{var v=V+"/api/public/reviews?storeId="+encodeURIComponent(q)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(a?"&hasImages=true":""),k=await X(v);if(!k.ok)return c||null;var m=await k.json();return R(d,JSON.stringify({t:Date.now(),v:m})),m}catch(u){return console.error("[ikr] fetchReviews error:",u),c||null}}var hr={};async function ze(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!hr[e]){hr[e]=!0;var a={primaryColor:"#111111",title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},n={enabled:!0,icon:"star",size:"medium",color:"#f59e0b"};try{var s=await xr();if(!s)return;var l=s.widgets&&s.widgets.reviews||a,d=s.widgets&&s.widgets.badge||n;if(l.enabled===!1)return;we("newest"),fe(1),Fe(null);var c=await qe(e,"newest",1,null);await oe(e,l,c,r,"newest",1,d)}catch(o){console.error("[ikr] bootstrap error:",o),await oe(e,a,null,r,void 0,void 0,n)}finally{delete hr[e]}}}function yr(){try{var e=window.__NEXT_DATA__&&window.__NEXT_DATA__.props&&window.__NEXT_DATA__.props.pageProps;if(e&&e.pageType==="PRODUCT"&&e.pageSpecificData&&e.pageSpecificData.id)return{id:e.pageSpecificData.id,name:e.pageSpecificData.name||null}}catch(t){}if(window.IkasStorefront&&window.IkasStorefront.product&&window.IkasStorefront.product.id)return{id:window.IkasStorefront.product.id,name:window.IkasStorefront.product.name||null};var r=window.location.pathname.match(/--([a-f0-9-]{36})(?:\/|$|\?)/);if(r)return{id:r[1],name:null};var i=new URLSearchParams(window.location.search).get("productId");return i?{id:i,name:null}:null}function ai(){var e={},r={};return document.querySelectorAll("a[href]").forEach(function(i){try{var t=i.getAttribute("href");if(!t||t.charAt(0)==="#"||t.charAt(0)==="?")return;var a=O(i.href);if(!a||r[a]||!/^[a-z0-9][a-z0-9-]{2,}$/.test(a)||Ke.test(a))return;r[a]=!0,e[a]=null}catch(n){}}),Object.keys(Ie).forEach(function(i){e[i]=Ie[i]}),e}var pt=300*1e3,ni=50;async function oi(e){var r="ikr_ratings_"+q,i={},t=Pe(r);if(t)try{var a=JSON.parse(t);a&&a.t!==void 0&&Date.now()-a.t<pt?i=a.v||{}:R(r,"")}catch(c){R(r,"")}var n=e.filter(function(c){return!i[c]});if(!n.length)return i;for(var s=[],l=0;l<n.length;l+=ni)s.push(n.slice(l,l+ni));var d=await Promise.all(s.map(function(c){var o=V+"/api/public/ratings-by-slug?storeId="+encodeURIComponent(q)+"&slugs="+c.map(encodeURIComponent).join(",");return X(o).then(function(p){return p.ok?p.json().then(function(v){return v.data||{}}):{}}).catch(function(){return{}})}));return d.forEach(function(c){n.forEach(function(o){i[o]||(i[o]={average:0,count:0,_empty:!0})}),Object.keys(c).forEach(function(o){i[o]=c[o]})}),R(r,JSON.stringify({t:Date.now(),v:i})),i}var mt="var(--ikr-badge-color,#f59e0b)",li=13,ut="display:flex;align-items:center;gap:3px;margin-top:0px;margin-bottom:4px;font-size:13px;font-weight:400;color:#555;pointer-events:none;";function vt(e){var r=Me("star","classic"),i="width:"+li+"px;height:"+li+"px;";return'<span style="color:'+mt+';display:inline-flex;align-items:center;">'+J(e,r,{sizeStyle:i})+"</span>"}function De(e,r){var i=document.createElement("div");return i.setAttribute("data-ikr-listing-badge","1"),i.style.cssText=ut+"justify-content:"+(r||"flex-start")+";",i.innerHTML=vt(e.avg)+'<span style="font-weight:400;">'+e.avg+" ("+e.count+")</span>",i}var si=".product-name",di=".add-to-basket-modal",ci="h1.product-name",Qe=".single-product-container-main",br=".single-product-product-name",pi=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),mi=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var ui='[class*="productTitle"],[class*="productName"],[class*="product_title"],[class*="product_name"],[class*="product-title"],[class*="product-name"]',kt=/^(tükendi|sold out|out of stock|stokta yok|satıldı|unavailable)$/i;function wr(e,r){var i=e.querySelector(si);if(i)return i;if(e.matches&&e.matches(ui))return e;var t=e.querySelector(ui);if(t)return t;if(r){for(var a=e.querySelectorAll("*"),n=0;n<a.length;n++)if(a[n].children.length===0&&a[n].textContent.trim()===r)return a[n]}for(var s=e.querySelectorAll("p, h1, h2, h3, h4, h5, h6, span, div"),l=0;l<s.length;l++){var d=s[l],c=d.textContent.trim();if(!(!c||c.length<2||c.length>150)&&!/^[\d\s.,₺$€£%]+$/.test(c)&&!kt.test(c)&&!(d.closest("figure")||d.closest("picture"))&&!(d.children.length>1))return d}return null}function gt(e,r,i,t){if(!e.getAttribute("data-ikr-badge")){var a=O(e.href);if(e.id==="ikr-rating-badge"){e.setAttribute("data-ikr-badge","1");return}if(a===t&&e.getAttribute("href")&&e.getAttribute("href").charAt(0)==="#"){e.setAttribute("data-ikr-badge","1");return}if(e.closest("header")||e.closest("nav")){e.setAttribute("data-ikr-badge","1");return}if(e.closest('[class*="basket"]')||e.closest('[class*="cart"]')){e.setAttribute("data-ikr-badge","1");return}if(e.closest(Qe)&&!e.closest(br)){e.setAttribute("data-ikr-badge","1");return}if(a===t&&e.closest(br)){e.setAttribute("data-ikr-badge","1");return}if(e.closest(pi)){e.setAttribute("data-ikr-badge","1");return}var n=!!e.querySelector("a[href]"),s=Array.from(e.childNodes).filter(function(m){return m.nodeType===3}).map(function(m){return m.textContent.trim()}).join("").trim(),l=!!wr(e,i);if(!s&&!l&&!n){e.setAttribute("data-ikr-badge","1");return}if(e.setAttribute("data-ikr-badge","1"),n){e.querySelectorAll("a[href]").forEach(function(m){m.setAttribute("data-ikr-badge","1")});var d=wr(e,i);if(!d||d.querySelector("[data-ikr-listing-badge]"))return;var c=window.getComputedStyle(d).textAlign;d.appendChild(De(r,c==="center"?"center":c==="right"?"flex-end":"flex-start"));return}var o=wr(e,i);if(!(o&&o.querySelector("[data-ikr-listing-badge]")))if(o){var p=window.getComputedStyle(o).textAlign;o.appendChild(De(r,p==="center"?"center":p==="right"?"flex-end":"flex-start"))}else{var v=De(r,"flex-start"),k=e.firstElementChild;k?e.insertBefore(v,k):e.appendChild(v)}}}function ft(e,r){var i=document.querySelector(di);if(i){var t=i.querySelector(ci);if(!(!t||t.querySelector("[data-ikr-listing-badge]"))){var a=null;if(Oe&&r[Oe]&&(a=Oe),!a){var n=O(window.location.pathname);n&&r[n]&&(a=n)}if(!a){var s=t.textContent.trim();Object.keys(e).forEach(function(p){if(!a){var v=e[p];v&&v.trim()===s&&r[p]&&(a=p)}})}if(!a){var l=document.querySelector(Qe);if(l){var d=l.querySelector("a[href]");if(d){var c=O(d.href);c&&r[c]&&(a=c)}}}if(!a){var o=t.textContent.trim().toLowerCase();document.querySelectorAll("a[href]").forEach(function(p){if(!a&&!(p.closest("header")||p.closest("nav"))&&!p.closest(Qe)){var v=p.textContent.trim().toLowerCase();if(v&&v===o){var k=O(p.href);k&&r[k]&&(a=k)}}})}!a||!r[a]||r[a]._empty||r[a].count===0||t.appendChild(De(r[a],"flex-start"))}}}function vi(e,r){var i=O(window.location.pathname),t=document.querySelectorAll(mi),a=[];t.forEach(function(n){n.tagName==="A"&&n.href?a.push(n):n.querySelectorAll("a[href]").forEach(function(s){a.push(s)})}),Object.keys(e).forEach(function(n){var s=r[n];if(!(!s||s._empty||s.count===0)){var l=e[n];a.forEach(function(d){O(d.href)===n&&gt(d,s,l,i)})}}),ft(e,r)}async function Ee(){if(A.inProgress){A.queued=!0;return}if(!A.rendered){A.rendered=!0,A.inProgress=!0;try{var e=A.navCleanup;e&&(A.navCleanup=!1);var r=ai();if(!Object.keys(r).length){A.rendered=!1;return}var i=await Promise.all([xr(),oi(Object.keys(r))]),t=i[0];if(!t){A.rendered=!1;return}var a=i[1],n=t&&t.widgets||{},s=n.badge&&n.badge.color||"#f59e0b";if(n.badge&&n.badge.enabled===!1){A.rendered=!1;return}document.documentElement.style.setProperty("--ikr-badge-color",s),e&&(document.querySelectorAll("[data-ikr-listing-badge]").forEach(function(l){l.remove()}),document.querySelectorAll("[data-ikr-badge]").forEach(function(l){l.removeAttribute("data-ikr-badge")})),vi(r,a)}finally{A.inProgress=!1,A.queued&&(A.queued=!1,A.rendered=!1,Ee())}}}var ki=!1,gi=!1;function xi(){gi||(gi=!0,document.addEventListener("click",function(e){var r=e.target.closest("a[href]");if(r&&!(r.closest("header")||r.closest("nav"))&&!(r.closest('[class*="basket"]')||r.closest('[class*="cart"]'))){var i=O(r.href);!i||i.length<3||Rr(i)}},!0))}var fi=!1,hi=typeof location!="undefined"?location.pathname:"";function er(){try{if(location.pathname===hi)return;hi=location.pathname;var e=document.getElementById("ikr-rating-badge");e&&e.remove();var r=document.getElementById("ikr-jsonld");r&&r.remove()}catch(i){}}function ht(){if(!fi){fi=!0;var e=history.pushState,r=history.replaceState;history.pushState=function(){var i=e.apply(this,arguments);return er(),i},history.replaceState=function(){var i=r.apply(this,arguments);return er(),i},window.addEventListener("popstate",er),window.addEventListener("hashchange",er)}}function Cr(){if(ht(),window.IkasEvents){if(ki)return;ki=!0,window.IkasEvents.subscribe({id:"ikas-reviews-widget",callback:function(n){if(n&&n.type==="VIEW_LISTING"){var s=n.data&&n.data.productDetails;Array.isArray(s)&&s.forEach(function(o){o&&o.metaData&&o.metaData.slug&&o.name&&(Ie[o.metaData.slug]=o.name)})}if(n&&n.type==="PRODUCT_VIEW"){var l=n.data&&n.data.productDetail&&n.data.productDetail.id,d=n.data&&n.data.productDetail&&n.data.productDetail.name;l&&(R("ikr_reviews_"+q+"_"+l,""),ze(l,d))}if(n&&n.type==="PAGE_VIEW"){var c=Date.now();if(A.lastPageView&&c-A.lastPageView<800)return;A.lastPageView=c,A.navCleanup=!0,A.rendered=!1,Ee()}}});var e=yr();if(e)ze(e.id,e.name);else{let n=function(){var s=yr();s?ze(s.id,s.name):r<20&&(r++,setTimeout(n,100))};var t=n,r=0;setTimeout(n,100)}setTimeout(function(){A.rendered||Ee()},2e3)}else{let n=function(){window.IkasEvents?Cr():i<100&&(i++,setTimeout(n,50))};var a=n,i=0;setTimeout(n,50)}}var yi=null;function bi(){if(typeof MutationObserver!="undefined"){var e=new MutationObserver(function(r){var i=r.some(function(t){return Array.from(t.addedNodes).some(function(a){return!(a.nodeType!==1||a.hasAttribute&&(a.hasAttribute("data-ikr-listing-badge")||a.id==="ikr-rating-badge"||a.id==="ikr-reviews-widget")||a.closest&&(a.closest("[data-ikr-listing-badge]")||a.closest("#ikr-rating-badge")||a.closest("#ikr-reviews-widget"))||a.querySelector&&a.querySelector("[data-ikr-listing-badge],#ikr-reviews-widget,#ikr-rating-badge"))})});i&&(clearTimeout(yi),yi=setTimeout(function(){var t=Array.from(document.querySelectorAll("a[href]")).some(function(a){if(a.getAttribute("data-ikr-badge"))return!1;var n=O(a.href);return n&&n.length>=3&&!Ke.test(n)});t&&(A.rendered=!1,Ee())},300))});e.observe(document.body,{childList:!0,subtree:!0})}}var xt=window.__ikasPreviewMode===!0;if(xt){let e=function(){try{window.parent.postMessage({type:"IKR_WIDGET_READY"},"*")}catch(i){}},r=function(){ze("mock-product","\xD6rnek \xDCr\xFCn"),e()};yt=e,bt=r,window.addEventListener("message",function(i){var t=i.data;if(!(!t||t.type!=="IKR_SETTINGS_UPDATE")){var a=t.settings;if(!(!a||!_)){var n=Object.assign({},_,a);oe(ie,n,or,be,Z,Be)}}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()}else if(q){let e=function(){Cr(),xi(),bi()};wt=e,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}var yt,bt,wt;})();
