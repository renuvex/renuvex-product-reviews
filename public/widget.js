...
`;var vt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},kt=vi;function gt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,c=e.currentOrderBy,s=e.currentHasImages,u=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",v.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+o+"</span>",k.appendChild(v);var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-count ikr-split-left-count",f.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(f),d.appendChild(k);var p=document.createElement("div");p.className="ikr-split-col ikr-split-mid",p.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:u})),d.appendChild(p);var y=ae({widget:r,currentOrderBy:c,currentHasImages:s,onWriteClick:K,onSortChange:m}),g=y.querySelector(".ikr-filter-wrap"),h=y.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-split-col ikr-split-right",h&&x.appendChild(h),g&&x.appendChild(g),d.appendChild(x),i.showRecommendation!==!1){var E=(n[3]||0)+(n[4]||0),z=a>0?Math.round(E/a*100):0;if(z>0){var b=document.createElement("div");b.className="ikr-summary-block ikr-summary-recommend",b.innerHTML='<span class="ikr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(b)}}return d}var br={};me(br,{css:()=>xt,meta:()=>ht,render:()=>bt});var ki=`
