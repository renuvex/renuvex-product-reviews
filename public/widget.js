...
`;var vt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"90px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"120px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},kt=pi;function gt(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length),a=document.createElement("div");a.className="ikr-review-list"+(i?"":" ikr-review-list--no-media");var t=document.createElement("div");t.className="ikr-review-list-author";var n=document.createElement("span");n.className="ikr-review-stars ikr-review-list-author-stars",n.innerHTML=ue(e.rating,_),t.appendChild(n);var d=document.createElement("span");d.className="ikr-review-list-author-name",d.textContent=e.author||"",t.appendChild(d);var o=document.createElement("span");o.className="ikr-date ikr-review-list-author-date",o.textContent=fe(e.createdAt),t.appendChild(o),a.appendChild(t);var s=document.createElement("div");if(s.className="ikr-review-list-content",e.title){var p=document.createElement("div");p.className="ikr-review-list-title",p.textContent=e.title,s.appendChild(p)}var m=(e.comment||"").trim();if(m){var c=document.createElement("div");c.className="ikr-review-list-body ikr-body-clamped",c.textContent=m,s.appendChild(c);var l=document.createElement("span");l.className="ikr-read-more",l.textContent="Devam\u0131n\u0131 oku",l.style.display="none",s.appendChild(l),requestAnimationFrame(function(){if(c.scrollHeight>c.clientHeight+2){l.style.display="inline";var v=!1;l.onclick=function(){v=!v,c.classList.toggle("ikr-body-clamped",!v),l.textContent=v?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var k=Be(e.merchantReply);if(k&&s.appendChild(k),a.appendChild(s),i){var u=document.createElement("div");u.className="ikr-review-list-media",e.images.forEach(function(v){if(!(!v||v.indexOf("https://")!==0&&v.indexOf("data:image/")!==0)){var f=document.createElement("img");f.src=W(v),f.setAttribute("data-ikr-img-url",v),(function(w){f.onclick=function(){oe(e,w,r)}})(v),u.appendChild(f)}}),a.appendChild(u)}return a}var xr={};be(xr,{css:()=>bt,meta:()=>ht,render:()=>yt});var mi=`
