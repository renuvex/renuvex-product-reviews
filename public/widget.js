/* ikas Reviews Widget — built 2026-04-06T21:12:50.965Z | theme: default */
"use strict";
(() => {
  ...
  .ikr-modal-close{position:absolute;top:-14px;right:-14px;background:#fff;border:1px solid rgba(0,0,0,0.12);color:rgba(0,0,0,0.60);font-size:14px;cursor:pointer;line-height:1;padding:0;border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;z-index:100000;box-shadow:0 2px 8px rgba(0,0,0,0.15);}
  .ikr-modal-close:hover{color:rgba(0,0,0,0.9);}
