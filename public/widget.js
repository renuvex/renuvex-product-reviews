...
`;var hr={};xe(hr,{meta:()=>ct,render:()=>pt});function _e(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,d=document.createElement("div");d.className="ikr-summary-block ikr-summary-bars";for(var o=5;o>=1;o--){var s=r[o-1]||0,c=i>0?Math.round(s/i*100):0,p=a===o,m=document.createElement("div");m.className="ikr-bar-row"+(p?" ikr-bar-active":""),a&&!p&&(m.style.opacity="0.35");for(var l="",v=1;v<=5;v++){var k=v<=o;l+='<span class="ikr-bar-star ikr-icon '+(k?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(k?t.filled:t.empty)+"</span>"}m.innerHTML='<span class="ikr-bar-label">'+l+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(f){m.onclick=function(){n(f)}})(o),d.appendChild(m)}return d}var de=[],ii=!1;function et(e){for(var r=de.length-1;r>=0;r--){var i=de[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function rt(e){if(e.key==="Escape")for(var r=de.length-1;r>=0;r--)de[r].close()}function it(){ii||typeof document=="undefined"||(document.addEventListener("click",et,!0),document.addEventListener("keydown",rt),ii=!0)}function ir(e){for(var r=0;r<de.length;r++)de[r]!==e&&de[r].close()}function tr(e){it();var r={trigger:e.trigger,element:e.element,close:e.close};return de.push(r),function(){var t=de.indexOf(r);t!==-1&&de.splice(t,1)}}function se(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,d=document.createElement("div");d.className="ikr-summary-block ikr-summary-actions";var o=document.createElement("button");o.className="ikr-write-btn",o.textContent="Yorum Yap",o.onclick=a,d.appendChild(o);var s=document.createElement("div");s.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele");var p=A&&A.filterIcon||"lines";c.innerHTML=Ur(p);var m=document.createElement("div");m.className="ikr-filter-menu";var l=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function v(){m.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function k(){ir(f),m.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}l.forEach(function(u){var w=u[2],y=w?t:!t&&(i||"newest")===u[0],g=document.createElement("div");g.className="ikr-filter-item"+(y?" ikr-filter-item-active":""),g.textContent=u[1],g.onclick=function(){v(),n(u[0],w)},m.appendChild(g)}),c.onclick=function(){m.classList.contains("ikr-open")?v():k()};var f=tr({trigger:s,element:m,close:v});return s.appendChild(c),s.appendChild(m),d.appendChild(s),d}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var n=document.createElement("button");n.className="ikr-fwizard-close",n.type="button",n.setAttribute("aria-label","Kapat"),n.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',a.appendChild(n);var d=document.createElement("div");d.className="ikr-fwizard-content",a.appendChild(d);var o=!1,s="",c="";function p(){var u=window.innerWidth-document.documentElement.clientWidth;s=document.body.style.overflow,c=document.body.style.paddingRight,document.body.style.overflow="hidden",u>0&&(document.body.style.paddingRight=u+"px")}function m(){document.body.style.overflow=s,document.body.style.paddingRight=c}function l(){o||(o=!0,document.removeEventListener("keydown",v),t.removeEventListener("click",k),n.removeEventListener("click",l),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),m();try{r()}catch(u){}},200))}function v(u){u.key==="Escape"&&l()}function k(u){u.target===t&&i&&l()}document.addEventListener("keydown",v),t.addEventListener("click",k),n.addEventListener("click",l);function f(u){u&&d.appendChild(u),document.body.appendChild(t),p(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open")})}return{open:f,close:l,content:d,setAllowOutsideClose:function(u){i=!!u},setStepAttr:function(u){a.setAttribute("data-step",String(u))}}}var ai=`
  ...
  .ikr-fwizard-step-wrap{
    ...
    flex:1 1 auto;
    overflow-y:auto;
    padding:60px 24px 32px; /* Dikeyde sabit hizalama i\xE7in padding-top art\u0131r\u0131ld\u0131 */
    display:flex;
    flex-direction:column;
    align-items:center;
    /* justify-content: center kald\u0131r\u0131ld\u0131 \xE7\xFCnk\xFC farkl\u0131 y\xFCksekliklerde z\u0131plamaya neden oluyor */
    text-align:center;
  }
  ...
  .ikr-fwizard-step--enter{
    ...
    backface-visibility: hidden; /* Yaz\u0131 titremesini/bulan\u0131kl\u0131\u011F\u0131n\u0131 \xF6nler */
  }
...
`;var mt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ut=vi;function ft(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,p=e.onFilterChange,m=e.onSortChange,l=document.createElement("div");l.className="ikr-summary ikr-summary-compact";var v=document.createElement("div");v.className="ikr-compact-header";var k=document.createElement("div");k.className="ikr-compact-trigger-wrap";var f=document.createElement("button");f.className="ikr-compact-trigger",f.type="button",f.setAttribute("aria-expanded","false"),f.innerHTML='<span class="ikr-compact-trigger-stars">'+oe(d,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',k.appendChild(f),v.appendChild(k);var u=se({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:Z,onSortChange:m}),w=u.querySelector(".ikr-filter-wrap"),y=u.querySelector(".ikr-write-btn"),g=document.createElement("div");g.className="ikr-compact-actions-slot",y&&g.appendChild(y),w&&g.appendChild(w),v.appendChild(g),l.appendChild(v);var b=document.createElement("div");b.className="ikr-compact-panel",b.setAttribute("role","dialog"),b.setAttribute("aria-hidden","true");var x=document.createElement("div");x.className="ikr-compact-panel-inner";var z=document.createElement("div");z.className="ikr-compact-avg",z.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+d+"</span>",x.appendChild(z),x.appendChild(_e({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:o,onFilterChange:p})),b.appendChild(x);var h=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(V){var M=V?l:k;b.parentNode!==M&&(b.classList.contains("ikr-open")&&(b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")),M.appendChild(b))}if(C(h?h.matches:!1),h){var E=function(V){C(V.matches)};h.addEventListener?h.addEventListener("change",E):h.addListener&&h.addListener(E)}if(y){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent="Yorum Yap",T.onclick=Z;var S=document.createElement("div");S.className="ikr-compact-write-row",S.appendChild(T),l.appendChild(S)}function B(){b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")}function N(){ir(R),b.classList.add("ikr-open"),b.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true")}f.onclick=function(){b.classList.contains("ikr-open")?B():N()};var R=null;function J(V){R&&(R(),R=null),V||(R=tr({trigger:k,element:b,close:B}))}if(J(h?h.matches:!1),h){var re=function(V){J(V.matches)};h.addEventListener?h.addEventListener("change",re):h.addListener&&h.addListener(re)}if(i.showRecommendation!==!1){var ie=(n[3]||0)+(n[4]||0),he=a>0?Math.round(ie/a*100):0;if(he>0){var te=document.createElement("div");te.className="ikr-summary-block ikr-summary-recommend",te.style.marginTop="8px",te.innerHTML='<span class="ikr-recommend-pct">%'+he+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",x.appendChild(te)}}return l}var xr={};xe(xr,{css:()=>kt,meta:()=>vt,render:()=>gt});var ki=`
