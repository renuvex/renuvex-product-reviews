...
`;var sr={};le(sr,{meta:()=>Hi,render:()=>qi});function we(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,o=e.onFilterChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,c=i>0?Math.round(d/i*100):0,n=a===l,p=document.createElement("div");p.className="ikr-bar-row"+(n?" ikr-bar-active":""),a&&!n&&(p.style.opacity="0.35");for(var u="",k=1;k<=5;k++){var m=k<=l;u+='<span class="ikr-bar-star ikr-icon '+(m?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(m?t.filled:t.empty)+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+u+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(v){p.onclick=function(){o(v)}})(l),s.appendChild(p)}return s}var Q=[],Ur=!1;function Oi(e){for(var r=Q.length-1;r>=0;r--){var i=Q[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function Pi(e){if(e.key==="Escape")for(var r=Q.length-1;r>=0;r--)Q[r].close()}function Mi(){Ur||typeof document=="undefined"||(document.addEventListener("click",Oi,!0),document.addEventListener("keydown",Pi),Ur=!0)}function Ke(e){for(var r=0;r<Q.length;r++)Q[r]!==e&&Q[r].close()}function Ve(e){Mi();var r={trigger:e.trigger,element:e.element,close:e.close};return Q.push(r),function(){var t=Q.indexOf(r);t!==-1&&Q.splice(t,1)}}function ee(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,s.appendChild(l);var d=document.createElement("div");d.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele"),c.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="4" y1="6" x2="20" y2="6"/><line x1="7" y1="12" x2="17" y2="12"/><line x1="10" y1="18" x2="14" y2="18"/></svg>';var n=document.createElement("div");n.className="ikr-filter-menu";var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function u(){n.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function k(){Ke(m),n.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}p.forEach(function(v){var g=v[2],h=g?t:!t&&(i||"newest")===v[0],f=document.createElement("div");f.className="ikr-filter-item"+(h?" ikr-filter-item-active":""),f.textContent=v[1],f.onclick=function(){u(),o(v[0],g)},n.appendChild(f)}),c.onclick=function(){n.classList.contains("ikr-open")?u():k()};var m=Ve({trigger:d,element:n,close:u});return d.appendChild(c),d.appendChild(n),s.appendChild(d),s}function Y(){var e=document.getElementById("ikr-form-accordion");if(e){var r=e.style.maxHeight&&e.style.maxHeight!=="0px";r?(e.style.maxHeight="0px",e.style.opacity="0"):(e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",setTimeout(function(){e.style.maxHeight="none"},360),setTimeout(function(){var i=document.querySelector("header"),t=i?i.getBoundingClientRect().height:0,a=e.getBoundingClientRect().top+window.pageYOffset-t-16;window.scrollTo({top:a,behavior:"smooth"})},50))}}var Hi={id:"classic",name:"Klasik (A\xE7\u0131k)"};function qi(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,o=e.allCount,s=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,c=e.currentOrderBy,n=e.currentHasImages,p=e.onFilterChange,u=e.onSortChange,k=document.createElement("div");k.className="ikr-summary";var m=(s[3]||0)+(s[4]||0),v=o>0?Math.round(m/o*100):0,g=document.createElement("div");g.className="ikr-summary-block ikr-summary-avg",g.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+l+"</span>",k.appendChild(g);var h=document.createElement("div");if(h.className="ikr-summary-block ikr-summary-count",h.textContent=o.toLocaleString("tr-TR")+" Yorum",k.appendChild(h),t.showRecommendation!==!1&&v>0){var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-recommend",f.innerHTML='<span class="ikr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(f)}return k.appendChild(we({ratingCounts:s,allCount:o,iconPair:a,currentRatingFilter:d,onFilterChange:p})),k.appendChild(ee({widget:r,currentOrderBy:c,currentHasImages:n,onWriteClick:Y,onSortChange:u})),k}var dr={};le(dr,{css:()=>Di,meta:()=>ji,render:()=>Fi});var Kr=`
...
`;var Yi={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Gi=Vr;function Ui(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,o=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,n=e.onFilterChange,p=e.onSortChange,u=document.createElement("div");u.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var m=document.createElement("div");m.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",m.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+s+"</span>",k.appendChild(m);var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-count ikr-split-left-count",v.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(v),u.appendChild(k);var g=document.createElement("div");g.className="ikr-split-col ikr-split-mid",g.appendChild(we({ratingCounts:o,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:n})),u.appendChild(g);var h=ee({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:Y,onSortChange:p}),f=h.querySelector(".ikr-filter-wrap"),C=h.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-split-col ikr-split-right",C&&x.appendChild(C),f&&x.appendChild(f),u.appendChild(x),i.showRecommendation!==!1){var z=(o[3]||0)+(o[4]||0),E=a>0?Math.round(z/a*100):0;if(E>0){var w=document.createElement("div");w.className="ikr-summary-block ikr-summary-recommend",w.innerHTML='<span class="ikr-recommend-pct">%'+E+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(w)}}return u}var pr={};le(pr,{css:()=>Vi,meta:()=>Ki,render:()=>Zi});var Zr=`
...
`;var Ki={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Vi=Zr;function Zi(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,o=e.currentOrderBy,s=e.currentHasImages,l=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var n=document.createElement("div");n.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=a,n.appendChild(p);var u=document.createElement("span");u.className="ikr-minimal-stars",u.innerHTML=J(a,i),n.appendChild(u);var k=document.createElement("span");k.className="ikr-minimal-count",k.textContent=t.toLocaleString("tr-TR")+" Yorum",n.appendChild(k),c.appendChild(n),d.appendChild(c);var m=ee({widget:r,currentOrderBy:o,currentHasImages:s,onWriteClick:Y,onSortChange:l}),v=m.querySelector(".ikr-filter-wrap"),g=m.querySelector(".ikr-write-btn"),h=document.createElement("div");if(h.className="ikr-minimal-actions",g&&h.appendChild(g),v&&h.appendChild(v),d.appendChild(h),g){var f=document.createElement("button");f.className="ikr-write-btn",f.textContent="Yorum Yap",f.onclick=Y;var C=document.createElement("div");C.className="ikr-minimal-write-row",C.appendChild(f),d.appendChild(C)}return d}var mr={};le(mr,{css:()=>Ji,meta:()=>Wi,render:()=>Xi});var Wr=`
