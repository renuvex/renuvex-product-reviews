...
`;var Tt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"90px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"120px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},Lt=xi;function At(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length),t=document.createElement("div");t.className="ikr-review-list"+(i?"":" ikr-review-list--no-media");var a=document.createElement("div");a.className="ikr-review-list-author";var n=document.createElement("span");n.className="ikr-review-stars ikr-review-list-author-stars",n.innerHTML=ge(e.rating,N),a.appendChild(n);var d=document.createElement("span");d.className="ikr-review-list-author-name",d.textContent=e.author||"",a.appendChild(d);var o=document.createElement("span");o.className="ikr-date ikr-review-list-author-date",o.textContent=he(e.createdAt),a.appendChild(o),t.appendChild(a);var s=document.createElement("div");if(s.className="ikr-review-list-content",e.title){var c=document.createElement("div");c.className="ikr-review-list-title",c.textContent=e.title,s.appendChild(c)}var p=(e.comment||"").trim();if(p){var m=document.createElement("div");m.className="ikr-review-list-body ikr-body-clamped",m.textContent=p,s.appendChild(m);var l=document.createElement("span");l.className="ikr-read-more",l.textContent="Devam\u0131n\u0131 oku",l.style.display="none",s.appendChild(l),requestAnimationFrame(function(){if(m.scrollHeight>m.clientHeight+2){l.style.display="inline";var f=!1;l.onclick=function(){f=!f,m.classList.toggle("ikr-body-clamped",!f),l.textContent=f?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var v=Pe(e.merchantReply);if(v&&s.appendChild(v),t.appendChild(s),i){var k=document.createElement("div");k.className="ikr-review-list-media",e.images.forEach(function(f){if(!(!f||f.indexOf("https://")!==0&&f.indexOf("data:image/")!==0)){var u=document.createElement("img");u.src=J(f),u.setAttribute("data-ikr-img-url",f),(function(C){u.onclick=function(){se(e,C,r)}})(f),k.appendChild(u)}}),t.appendChild(k)}return t}var Sr={};we(Sr,{css:()=>It,meta:()=>Nt,render:()=>Bt});var yi=`
