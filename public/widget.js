...
`;var st={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"90px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"120px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},dt=oi;function ct(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length&&e.images[0]&&(e.images[0].indexOf("https://")===0||e.images[0].indexOf("data:image/")===0)),t=document.createElement("div");t.className="ikr-review-gallery"+(i?"":" ikr-review-gallery--no-media");var a=document.createElement("div");a.className="ikr-review-gallery-content";var n=document.createElement("span");if(n.className="ikr-review-stars ikr-review-gallery-stars",n.innerHTML=ae(e.rating,_),a.appendChild(n),e.title){var l=document.createElement("div");l.className="ikr-review-gallery-title",l.textContent=e.title,a.appendChild(l)}var o=document.createElement("div");o.className="ikr-review-gallery-author",o.textContent=e.author||"",a.appendChild(o);var s=document.createElement("div");s.className="ikr-review-gallery-date",s.textContent=ne(e.createdAt),a.appendChild(s);var c=(e.comment||"").trim();if(c){var m=document.createElement("div");m.className="ikr-review-gallery-body ikr-body-clamped",m.textContent=c,a.appendChild(m);var d=document.createElement("span");d.className="ikr-read-more",d.textContent="Devam\u0131n\u0131 oku",d.style.display="none",d.style.cursor="pointer",d.onclick=function(){var v=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;X(e,v,r)},a.appendChild(d),requestAnimationFrame(function(){m.scrollHeight>m.clientHeight+2&&(d.style.display="inline")})}if(t.appendChild(a),i){var p=e.images[0],k=document.createElement("div");k.className="ikr-review-gallery-media";var g=document.createElement("img");g.src=Y(p),g.loading="lazy",g.setAttribute("data-ikr-img-url",p),g.onclick=function(){X(e,p,r)},k.appendChild(g),t.appendChild(k)}var u=Le(e.merchantReply,function(){var v=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;X(e,v,r)});return u&&(u.classList.add("ikr-review-gallery-reply"),t.appendChild(u)),t}var rr={card:xr,list:yr,gallery:br};function ir(e){return rr[e]||rr.card}function li(){return Object.keys(rr).map(function(e){return rr[e].css||""}).join(`
`)}function P(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var t=parseInt(i[1],16),a=parseInt(i[2],16),n=parseInt(i[3],16);return"rgba("+t+","+a+","+n+","+r+")"}var si={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:14,recommendSize:12,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:52},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:16,recommendSize:14,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:64},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:18,recommendSize:16,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:76}},di={small:80,medium:110,large:140};function pt(e,r){var i=r.bgColor||"#ffffff",t=r.textColor||"#111111",a=r.replyBgColor||"#f3f4f6",n=r.inputBgColor||"#ffffff",l=r.widgetBgColor||i,o=r.widgetBorderColor||"transparent",s=r.separatorColor||P(t,.08),c=r.headerTitleColor||t,m=r.headerAvgColor||t,d=r.headerCountColor||t,p=r.headerRecommendColor||t,k=r.barLabelColor||t,g=r.barFillColor||t,u=r.barTrackColor||P(t,.1),v=r.barCountColor||t,b=r.barHoverBgColor||P(t,.05),x=r.primaryColor||"#111111",w=r.primaryTextColor||"#ffffff",h=r.btnBgColor||x,L=r.btnTextColor||w,z=r.btnBorderColor||x,f=r.filterBtnBgColor||x,y=r.filterBtnTextColor||w,T=r.filterBtnBorderColor||x,E=r.filterMenuBgColor||i,S=r.filterMenuBorderColor||P(t,.12),q=r.filterItemTextColor||t,j=r.filterItemHoverBgColor||P(x,.07),I=r.filterItemActiveColor||x,ee=r.reviewTitleColor||t,pe=r.reviewAuthorColor||t,me=r.reviewDateColor||t,ye=r.reviewBodyColor||t,se=r.reviewBorderColor||P(t,.08),G=r.reviewStarColor||"#f59e0b",U=r.replyBgColor||a,be=r.replyBorderColor||x,Ge=r.replyLabelColor||t,we=r.replyTextColor||t,_e=r.photoBgColor||P(t,.03),nr=r.photoBorderColor||P(t,.1),ue=r.photoTitleColor||t,Ue=r.formBgColor||i,ve=r.formBorderColor||P(t,.08),ke=r.inputBgColor||n,ge=r.inputTextColor||t,Be=r.inputBorderColor||P(t,.2),or=r.placeholderColor||P(t,.35),lr=r.loadMoreBgColor||i,D=r.loadMoreTextColor||t,re=r.loadMoreBorderColor||P(t,.3),Lr=r.modalBgColor||i,Re=r.modalTextColor||t,C=r.modalCloseBgColor||x,A=r.modalCloseTextColor||w,B=r.modalCloseBorderColor||x,H=r.modalNavBgColor||"rgba(0,0,0,0.45)",Ie=r.modalNavTextColor||"#ffffff",Li=r.modalReplyBgColor||a,Ai=r.modalReplyBorderColor||x,Ar={"--ikr-widget-bg":l,"--ikr-widget-border":o,"--ikr-separator":s,"--ikr-header-title":c,"--ikr-header-avg":m,"--ikr-header-count":d,"--ikr-header-recommend":p,"--ikr-bar-label":k,"--ikr-bar-fill":g,"--ikr-bar-track":u,"--ikr-bar-count":v,"--ikr-bar-hover-bg":b,"--ikr-btn-bg":h,"--ikr-btn-text":L,"--ikr-btn-border":z,"--ikr-filter-btn-bg":f,"--ikr-filter-btn-text":y,"--ikr-filter-btn-border":T,"--ikr-filter-menu-bg":E,"--ikr-filter-menu-border":S,"--ikr-filter-item-text":q,"--ikr-filter-item-hover-bg":j,"--ikr-filter-item-active":I,"--ikr-review-title":ee,"--ikr-review-author":pe,"--ikr-review-date":me,"--ikr-review-body":ye,"--ikr-review-border":se,"--ikr-review-star-color":G,"--ikr-reply-bg-color":U,"--ikr-reply-border":be,"--ikr-reply-label":Ge,"--ikr-reply-text":we,"--ikr-photo-bg":_e,"--ikr-photo-border":nr,"--ikr-photo-title":ue,"--ikr-form-bg":Ue,"--ikr-form-border":ve,"--ikr-input-bg-color":ke,"--ikr-input-text-color":ge,"--ikr-input-border":Be,"--ikr-placeholder":or,"--ikr-load-more-bg":lr,"--ikr-load-more-text":D,"--ikr-load-more-border":re,"--ikr-modal-bg":Lr,"--ikr-modal-text":Re,"--ikr-modal-close-bg":C,"--ikr-modal-close-text":A,"--ikr-modal-close-border":B,"--ikr-modal-nav-bg":H,"--ikr-modal-nav-text":Ie,"--ikr-modal-reply-bg":Li,"--ikr-modal-reply-border":Ai,"--ikr-bg":i,"--ikr-surface":i,"--ikr-text":t,"--ikr-text-faint":P(t,.45),"--ikr-border":P(t,.12),"--ikr-track-bg":P(t,.22),"--ikr-reply-bg":a,"--ikr-input-bg":n,"--ikr-input-text":t};Object.keys(Ar).forEach(function(Nr){e.style.setProperty(Nr,Ar[Nr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background=i)}async function le(e,r,i,t,a,n,l){if(mr){Ve({productId:e,settings:r,reviewsData:i,productName:t,orderBy:a,page:n,badgeSettings:l});return}Ke(!0),Br(e),Rr(r),l!==void 0&&Ir(l),Or(t),a&&Se(a),n&&xe(n),i!=null&&Pr(i);try{let Re=function(C,A){if(!(!C||!C.meta||!C.meta.sizeOverrides)){var B=C.meta.sizeOverrides[A];B&&Object.keys(B).forEach(function(H){p.style.setProperty(H,B[H])})}};var Lr=Re,o=er(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),c=r.showTitle!==!1,m=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",d=s&&c?m:"",p=document.documentElement;pt(p,r);var k=r.primaryColor||"#111111",g=r.primaryTextColor||"#ffffff";Gr(k,$r+ai()+li());var u=r.borderRadius!==void 0?r.borderRadius:8,v=si[r.size]||si.medium,b=di[r.thumbnailSize]||di.medium;p.style.setProperty("--ikr-title-size",v.titleSize+"px"),p.style.setProperty("--ikr-review-text-size",v.reviewTextSize+"px"),p.style.setProperty("--ikr-review-title-size",v.reviewTitleSize+"px"),p.style.setProperty("--ikr-author-size",v.authorSize+"px"),p.style.setProperty("--ikr-reply-name-size",v.replyNameSize+"px"),p.style.setProperty("--ikr-reply-text-size",v.replyTextSize+"px"),p.style.setProperty("--ikr-color-text",g),p.style.setProperty("--ikr-radius",u+"px"),p.style.setProperty("--ikr-radius-sm",Math.max(0,u-4)+"px"),p.style.setProperty("--ikr-photo-title-size",v.photoTitleSize+"px"),p.style.setProperty("--ikr-avg-rating-size",v.avgRatingSize+"px"),p.style.setProperty("--ikr-review-count-size",v.reviewCountSize+"px"),p.style.setProperty("--ikr-recommend-size",v.recommendSize+"px"),p.style.setProperty("--ikr-btn-text-size",v.btnTextSize+"px"),p.style.setProperty("--ikr-bar-label-size",v.barLabelSize+"px"),p.style.setProperty("--ikr-minimal-avg-size",v.minimalAvgSize+"px"),p.style.setProperty("--ikr-hero-avg-size",v.heroAvgSize+"px"),p.style.setProperty("--ikr-bar-count-size",v.barCountSize+"px"),p.style.setProperty("--ikr-review-date-size",v.reviewDateSize+"px"),p.style.setProperty("--ikr-filter-text-size",v.filterTextSize+"px"),p.style.setProperty("--ikr-load-more-size",v.loadMoreSize+"px"),p.style.setProperty("--ikr-read-more-size",v.readMoreSize+"px"),p.style.setProperty("--ikr-thumbnail-size",b+"px");var x=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";p.style.setProperty("--ikr-review-star-color",x),p.style.setProperty("--ikr-star-size",v.reviewStarSize+"px"),p.style.setProperty("--ikr-avg-star-size",v.avgStarSize+"px"),Re(er(r.summaryLayout),r.size),Re(ir(r.reviewLayout),r.size);var w=Fe(r),h=document.getElementById("ikas-reviews");if(!h){var L=document.getElementById("ikas-reviews-anchor");if(!L)return;h=document.createElement("div"),h.id="ikas-reviews",h.style.minHeight="200px",L.appendChild(h)}if(r.enabled===!1){h.style.minHeight="auto",h.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',Ke(!1);var z=Pe;Ve(null),z&&le(z.productId,z.settings,z.reviewsData,z.productName,z.orderBy,z.page,z.badgeSettings);return}h.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var f=i||{},y=f.data&&f.data.reviews||[],T=f.data&&f.data.totalCount||0,E=h.cloneNode(!1);h.parentNode.replaceChild(E,h),h=E;var S=document.createElement("div");if(S.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),d){var q=document.createElement("div"),j=r.summaryLayout||"classic";q.className="ikr-title ikr-title-"+j,q.textContent=d,S.appendChild(q)}var I=f.data&&f.data.allCount||0,ee=f.data&&f.data.ratingCounts||null,pe=ee||[0,0,0,0,0],me=f.data&&f.data.avgRating||"0.0";if(!ee&&y.length>0){y.forEach(function(C){C.rating>=1&&C.rating<=5&&pe[C.rating-1]++});var ye=y.reduce(function(C,A){return C+A.rating},0);me=(ye/y.length).toFixed(1)}if(I>0){var se=er(r.summaryLayout),G=se.render({widget:S,data:f,settings:r,iconPair:w,allCount:I,ratingCounts:pe,avgRatingVal:me,currentRatingFilter:fe,currentOrderBy:K,currentHasImages:he,onFilterChange:async function(C){Ze(fe===C?null:C),xe(1);var A=await je(ie,K,1,fe,he);await le(ie,_,A,Ce,K,1)},onSortChange:async function(C,A){xe(1),A?(pr(!0),Se("newest")):(pr(!1),Se(C));var B=await je(ie,K,1,fe,he);await le(ie,_,B,Ce,K,1)}});S.appendChild(G)}else{var U=document.createElement("button");U.className="ikr-write-btn",U.style.cssText="display:block;margin:16px auto 0;",U.textContent="Yorum Yap",U.onclick=function(){var C=document.getElementById("ikr-form-accordion");if(C){var A=C.style.maxHeight&&C.style.maxHeight!=="0px";A?(C.style.maxHeight="0px",C.style.opacity="0"):(C.style.maxHeight=C.scrollHeight+"px",C.style.opacity="1",setTimeout(function(){C.style.maxHeight="none"},360),setTimeout(function(){var B=document.querySelector("header"),H=B?B.getBoundingClientRect().height:0,Ie=C.getBoundingClientRect().top+window.pageYOffset-H-16;window.scrollTo({top:Ie,behavior:"smooth"})},50))}},S.appendChild(U)}var be=document.createElement("div");be.id="ikr-form-accordion",be.style.cssText="overflow:hidden;max-height:0px;opacity:0;transition:max-height 0.35s ease,opacity 0.25s ease;",be.appendChild(Vr(e,t)),S.appendChild(be);var Ge=y.filter(function(C){return C.images&&Array.isArray(C.images)&&C.images.some(function(A){return A&&(A.indexOf("https://")===0||A.indexOf("data:image/")===0)})});if(r.showPhotoGallery!==!1&&!he&&Ge.length>0){var we=document.createElement("div");we.className="ikr-photo-section";var _e=document.createElement("div");_e.className="ikr-photo-title",_e.textContent="Foto\u011Frafl\u0131 Yorumlar",we.appendChild(_e);var nr=r.reviewLayout==="card"?"1/1":"3/4";p.style.setProperty("--ikr-photo-thumb-aspect",nr);var ue=document.createElement("div");ue.className="ikr-photo-strip";var Ue=0;Ge.forEach(function(C){if(!(Ue>=10)){var A=C.images.find(function(H){return H&&(H.indexOf("https://")===0||H.indexOf("data:image/")===0)});if(A){var B=document.createElement("img");B.src=Y(A),B.className="ikr-photo-strip-thumb",B.alt="Yorum foto\u011Fraf\u0131",(function(H,Ie){B.onclick=function(){X(Ie,H,y)}})(A,C),ue.appendChild(B),Ue++}}});var ve=document.createElement("button");ve.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",ve.innerHTML="&#8249;",ve.setAttribute("aria-label","\xD6nceki"),ve.onclick=function(){ue.scrollBy({left:-200,behavior:"smooth"})};var ke=document.createElement("button");ke.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",ke.innerHTML="&#8250;",ke.setAttribute("aria-label","Sonraki"),ke.onclick=function(){ue.scrollBy({left:200,behavior:"smooth"})};var ge=document.createElement("div");ge.className="ikr-photo-strip-wrap",ge.appendChild(ve),ge.appendChild(ue),ge.appendChild(ke),we.appendChild(ge),S.appendChild(we)}if(y.length===0){var Be=document.createElement("p");Be.className="ikr-state-msg",Be.textContent="Hen\xFCz yorum yok.",S.appendChild(Be)}else{var or=ir(r.reviewLayout);y.forEach(function(C){S.appendChild(or.render(C,y))})}var lr=f.data&&f.data.hasMore;if(lr){var D=document.createElement("button");D.className="ikr-load-more",D.textContent="Daha Fazla G\xF6ster",D.onclick=async function(){D.disabled=!0,D.textContent="Y\xFCkleniyor...";var C=Oe+1,A=await je(ie,K,C,fe,he);if(A&&A.data&&A.data.reviews){xe(C);var B=ir(_.reviewLayout);A.data.reviews.forEach(function(H){S.insertBefore(B.render(H,A.data.reviews),D)}),A.data.hasMore?(D.disabled=!1,D.textContent="Daha Fazla G\xF6ster"):D.remove()}else D.remove()},S.appendChild(D)}h.appendChild(S),Xr(I>0?me:null,T,t,dr)}catch(C){console.error("[ikr] render error:",C),h.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(Ke(!1),Pe){var re=Pe;Ve(null),le(re.productId,re.settings,re.reviewsData,re.productName,re.orderBy,re.page,re.badgeSettings)}}}var ce="ikr_settings_"+M,mt=300*1e3,ut=30*1e3;async function Cr(){if(window.__ikasPreviewMode){try{var e=window.__ikasPreviewBaseUrl||Z,r=window.__ikasPreviewSettings||sessionStorage.getItem("ikr_preview_settings")||"",i={};if(r)try{i=JSON.parse(r)}catch(m){}var t=await J(e+"/api/preview/settings");if(t.ok){var a=await t.json();return a.widgets&&a.widgets.reviews&&Object.keys(i).length&&(a.widgets.reviews=Object.assign({},a.widgets.reviews,i)),a}}catch(m){}return null}var n=null,l=qe(ce);if(l)try{var o=JSON.parse(l);if(o&&o.t!==void 0)if(o.notFound){if(Date.now()-o.t<ut)return null;R(ce,"")}else if(o.v){if(Date.now()-o.t<mt)return o.v;n=o.v,R(ce,"")}else R(ce,"");else R(ce,"")}catch(m){R(ce,"")}try{var s=await J(Z+"/api/public/settings?publicApiKey="+encodeURIComponent(M));if(!s.ok)return s.status===404&&R(ce,JSON.stringify({t:Date.now(),notFound:!0})),n||null;var c=await s.json();return R(ce,JSON.stringify({t:Date.now(),v:c})),c}catch(m){return console.error("[ikr] fetchSettings error:",m),n||null}}var vt=60*1e3;async function je(e,r,i,t,a){if(window.__ikasPreviewMode){try{var n=window.__ikasPreviewBaseUrl||Z,l=n+"/api/preview/reviews?page="+encodeURIComponent(i||1),o=await J(l);if(o.ok)return await o.json()}catch(u){}return null}r=r||"newest",i=i||1;var s="ikr_reviews_"+M+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(a?"1":"0"),c=null,m=qe(s);if(m)try{var d=JSON.parse(m);if(d&&d.t!==void 0&&d.v){if(Date.now()-d.t<vt)return d.v;c=d.v,R(s,"")}else R(s,"")}catch(u){R(s,"")}try{var p=Z+"/api/public/reviews?storeId="+encodeURIComponent(M)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(a?"&hasImages=true":""),k=await J(p);if(!k.ok)return c||null;var g=await k.json();return R(s,JSON.stringify({t:Date.now(),v:g})),g}catch(u){return console.error("[ikr] fetchReviews error:",u),c||null}}var wr={};async function Ae(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!wr[e]){wr[e]=!0;var a={primaryColor:"#111111",title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},n={enabled:!0,icon:"star",size:"medium",color:"#f59e0b"};try{var l=await Cr();if(!l)return;var o=l.widgets&&l.widgets.reviews||a,s=l.widgets&&l.widgets.badge||n;if(o.enabled===!1)return;Se("newest"),xe(1),Ze(null);var c=await je(e,"newest",1,null);await le(e,o,c,r,"newest",1,s)}catch(m){console.error("[ikr] bootstrap error:",m),await le(e,a,null,r,void 0,void 0,n)}finally{delete wr[e]}}}function Sr(){try{var e=window.__NEXT_DATA__&&window.__NEXT_DATA__.props&&window.__NEXT_DATA__.props.pageProps;if(e&&e.pageType==="PRODUCT"&&e.pageSpecificData&&e.pageSpecificData.id)return{id:e.pageSpecificData.id,name:e.pageSpecificData.name||null}}catch(t){}if(window.IkasStorefront&&window.IkasStorefront.product&&window.IkasStorefront.product.id)return{id:window.IkasStorefront.product.id,name:window.IkasStorefront.product.name||null};var r=window.location.pathname.match(/--([a-f0-9-]{36})(?:\/|$|\?)/);if(r)return{id:r[1],name:null};var i=new URLSearchParams(window.location.search).get("productId");return i?{id:i,name:null}:null}function ci(){var e={},r={};return document.querySelectorAll("a[href]").forEach(function(i){try{var t=i.getAttribute("href");if(!t||t.charAt(0)==="#"||t.charAt(0)==="?")return;var a=O(i.href);if(!a||r[a]||!/^[a-z0-9][a-z0-9-]{2,}$/.test(a)||Je.test(a))return;r[a]=!0,e[a]=null}catch(n){}}),Object.keys(He).forEach(function(i){e[i]=He[i]}),e}var kt=300*1e3,pi=50;async function mi(e){var r="ikr_ratings_"+M,i={},t=qe(r);if(t)try{var a=JSON.parse(t);a&&a.t!==void 0&&Date.now()-a.t<kt?i=a.v||{}:R(r,"")}catch(c){R(r,"")}var n=e.filter(function(c){return!i[c]});if(!n.length)return i;for(var l=[],o=0;o<n.length;o+=pi)l.push(n.slice(o,o+pi));var s=await Promise.all(l.map(function(c){var m=Z+"/api/public/ratings-by-slug?storeId="+encodeURIComponent(M)+"&slugs="+c.map(encodeURIComponent).join(",");return J(m).then(function(d){return d.ok?d.json().then(function(p){return p.data||{}}):{}}).catch(function(){return{}})}));return s.forEach(function(c){n.forEach(function(m){i[m]||(i[m]={average:0,count:0,_empty:!0})}),Object.keys(c).forEach(function(m){i[m]=c[m]})}),R(r,JSON.stringify({t:Date.now(),v:i})),i}var gt="var(--ikr-badge-color,#f59e0b)",ui=13,ft="display:flex;align-items:center;gap:3px;margin-top:0px;margin-bottom:4px;font-size:13px;font-weight:400;color:#555;pointer-events:none;";function ht(e){var r=De("star","classic"),i="width:"+ui+"px;height:"+ui+"px;";return'<span style="color:'+gt+';display:inline-flex;align-items:center;">'+W(e,r,{sizeStyle:i})+"</span>"}function Ye(e,r){var i=document.createElement("div");return i.setAttribute("data-ikr-listing-badge","1"),i.style.cssText=ft+"justify-content:"+(r||"flex-start")+";",i.innerHTML=ht(e.avg)+'<span style="font-weight:400;">'+e.avg+" ("+e.count+")</span>",i}var vi=".product-name",ki=".add-to-basket-modal",gi="h1.product-name",tr=".single-product-container-main",zr=".single-product-product-name",fi=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),hi=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var xi='[class*="productTitle"],[class*="productName"],[class*="product_title"],[class*="product_name"],[class*="product-title"],[class*="product-name"]',xt=/^(tükendi|sold out|out of stock|stokta yok|satıldı|unavailable)$/i;function Er(e,r){var i=e.querySelector(vi);if(i)return i;if(e.matches&&e.matches(xi))return e;var t=e.querySelector(xi);if(t)return t;if(r){for(var a=e.querySelectorAll("*"),n=0;n<a.length;n++)if(a[n].children.length===0&&a[n].textContent.trim()===r)return a[n]}for(var l=e.querySelectorAll("p, h1, h2, h3, h4, h5, h6, span, div"),o=0;o<l.length;o++){var s=l[o],c=s.textContent.trim();if(!(!c||c.length<2||c.length>150)&&!/^[\d\s.,₺$€£%]+$/.test(c)&&!xt.test(c)&&!(s.closest("figure")||s.closest("picture"))&&!(s.children.length>1))return s}return null}function yt(e,r,i,t){if(!e.getAttribute("data-ikr-badge")){var a=O(e.href);if(e.id==="ikr-rating-badge"){e.setAttribute("data-ikr-badge","1");return}if(a===t&&e.getAttribute("href")&&e.getAttribute("href").charAt(0)==="#"){e.setAttribute("data-ikr-badge","1");return}if(e.closest("header")||e.closest("nav")){e.setAttribute("data-ikr-badge","1");return}if(e.closest('[class*="basket"]')||e.closest('[class*="cart"]')){e.setAttribute("data-ikr-badge","1");return}if(e.closest(tr)&&!e.closest(zr)){e.setAttribute("data-ikr-badge","1");return}if(a===t&&e.closest(zr)){e.setAttribute("data-ikr-badge","1");return}if(e.closest(fi)){e.setAttribute("data-ikr-badge","1");return}var n=!!e.querySelector("a[href]"),l=Array.from(e.childNodes).filter(function(g){return g.nodeType===3}).map(function(g){return g.textContent.trim()}).join("").trim(),o=!!Er(e,i);if(!l&&!o&&!n){e.setAttribute("data-ikr-badge","1");return}if(e.setAttribute("data-ikr-badge","1"),n){e.querySelectorAll("a[href]").forEach(function(g){g.setAttribute("data-ikr-badge","1")});var s=Er(e,i);if(!s||s.querySelector("[data-ikr-listing-badge]"))return;var c=window.getComputedStyle(s).textAlign;s.appendChild(Ye(r,c==="center"?"center":c==="right"?"flex-end":"flex-start"));return}var m=Er(e,i);if(!(m&&m.querySelector("[data-ikr-listing-badge]")))if(m){var d=window.getComputedStyle(m).textAlign;m.appendChild(Ye(r,d==="center"?"center":d==="right"?"flex-end":"flex-start"))}else{var p=Ye(r,"flex-start"),k=e.firstElementChild;k?e.insertBefore(p,k):e.appendChild(p)}}}function bt(e,r){var i=document.querySelector(ki);if(i){var t=i.querySelector(gi);if(!(!t||t.querySelector("[data-ikr-listing-badge]"))){var a=null;if(Me&&r[Me]&&(a=Me),!a){var n=O(window.location.pathname);n&&r[n]&&(a=n)}if(!a){var l=t.textContent.trim();Object.keys(e).forEach(function(d){if(!a){var p=e[d];p&&p.trim()===l&&r[d]&&(a=d)}})}if(!a){var o=document.querySelector(tr);if(o){var s=o.querySelector("a[href]");if(s){var c=O(s.href);c&&r[c]&&(a=c)}}}if(!a){var m=t.textContent.trim().toLowerCase();document.querySelectorAll("a[href]").forEach(function(d){if(!a&&!(d.closest("header")||d.closest("nav"))&&!d.closest(tr)){var p=d.textContent.trim().toLowerCase();if(p&&p===m){var k=O(d.href);k&&r[k]&&(a=k)}}})}!a||!r[a]||r[a]._empty||r[a].count===0||t.appendChild(Ye(r[a],"flex-start"))}}}function yi(e,r){var i=O(window.location.pathname),t=document.querySelectorAll(hi),a=[];t.forEach(function(n){n.tagName==="A"&&n.href?a.push(n):n.querySelectorAll("a[href]").forEach(function(l){a.push(l)})}),Object.keys(e).forEach(function(n){var l=r[n];if(!(!l||l._empty||l.count===0)){var o=e[n];a.forEach(function(s){O(s.href)===n&&yt(s,l,o,i)})}}),bt(e,r)}async function Ne(){if(N.inProgress){N.queued=!0;return}if(!N.rendered){N.rendered=!0,N.inProgress=!0;try{var e=N.navCleanup;e&&(N.navCleanup=!1);var r=ci();if(!Object.keys(r).length){N.rendered=!1;return}var i=await Promise.all([Cr(),mi(Object.keys(r))]),t=i[0];if(!t){N.rendered=!1;return}var a=i[1],n=t&&t.widgets||{},l=n.badge&&n.badge.color||"#f59e0b";if(n.badge&&n.badge.enabled===!1){N.rendered=!1;return}document.documentElement.style.setProperty("--ikr-badge-color",l),e&&(document.querySelectorAll("[data-ikr-listing-badge]").forEach(function(o){o.remove()}),document.querySelectorAll("[data-ikr-badge]").forEach(function(o){o.removeAttribute("data-ikr-badge")})),yi(r,a)}finally{N.inProgress=!1,N.queued&&(N.queued=!1,N.rendered=!1,Ne())}}}var bi=!1,wi=!1;function zi(){wi||(wi=!0,document.addEventListener("click",function(e){var r=e.target.closest("a[href]");if(r&&!(r.closest("header")||r.closest("nav"))&&!(r.closest('[class*="basket"]')||r.closest('[class*="cart"]'))){var i=O(r.href);!i||i.length<3||Hr(i)}},!0))}var Ci=!1,Si=typeof location!="undefined"?location.pathname:"";function ar(){try{if(location.pathname===Si)return;Si=location.pathname;var e=document.getElementById("ikr-rating-badge");e&&e.remove();var r=document.getElementById("ikr-jsonld");r&&r.remove()}catch(i){}}function wt(){if(!Ci){Ci=!0;var e=history.pushState,r=history.replaceState;history.pushState=function(){var i=e.apply(this,arguments);return ar(),i},history.replaceState=function(){var i=r.apply(this,arguments);return ar(),i},window.addEventListener("popstate",ar),window.addEventListener("hashchange",ar)}}function Tr(){if(wt(),window.IkasEvents){if(bi)return;bi=!0,window.IkasEvents.subscribe({id:"ikas-reviews-widget",callback:function(n){if(n&&n.type==="VIEW_LISTING"){var l=n.data&&n.data.productDetails;Array.isArray(l)&&l.forEach(function(m){m&&m.metaData&&m.metaData.slug&&m.name&&(He[m.metaData.slug]=m.name)})}if(n&&n.type==="PRODUCT_VIEW"){var o=n.data&&n.data.productDetail&&n.data.productDetail.id,s=n.data&&n.data.productDetail&&n.data.productDetail.name;o&&(R("ikr_reviews_"+M+"_"+o,""),Ae(o,s))}if(n&&n.type==="PAGE_VIEW"){var c=Date.now();if(N.lastPageView&&c-N.lastPageView<800)return;N.lastPageView=c,N.navCleanup=!0,N.rendered=!1,Ne()}}});var e=Sr();if(e)Ae(e.id,e.name);else{let n=function(){var l=Sr();l?Ae(l.id,l.name):r<20&&(r++,setTimeout(n,100))};var t=n,r=0;setTimeout(n,100)}setTimeout(function(){N.rendered||Ne()},2e3)}else{let n=function(){window.IkasEvents?Tr():i<100&&(i++,setTimeout(n,50))};var a=n,i=0;setTimeout(n,50)}}var Ei=null;function Ti(){if(typeof MutationObserver!="undefined"){var e=new MutationObserver(function(r){var i=r.some(function(t){return Array.from(t.addedNodes).some(function(a){return!(a.nodeType!==1||a.hasAttribute&&(a.hasAttribute("data-ikr-listing-badge")||a.id==="ikr-rating-badge"||a.id==="ikr-reviews-widget")||a.closest&&(a.closest("[data-ikr-listing-badge]")||a.closest("#ikr-rating-badge")||a.closest("#ikr-reviews-widget"))||a.querySelector&&a.querySelector("[data-ikr-listing-badge],#ikr-reviews-widget,#ikr-rating-badge"))})});i&&(clearTimeout(Ei),Ei=setTimeout(function(){var t=Array.from(document.querySelectorAll("a[href]")).some(function(a){if(a.getAttribute("data-ikr-badge"))return!1;var n=O(a.href);return n&&n.length>=3&&!Je.test(n)});t&&(N.rendered=!1,Ne())},300))});e.observe(document.body,{childList:!0,subtree:!0})}}var Ct=window.__ikasPreviewMode===!0;if(Ct){let e=function(){try{window.parent.postMessage({type:"IKR_WIDGET_READY"},"*")}catch(i){}},r=function(){Ae("mock-product","\xD6rnek \xDCr\xFCn"),e()};St=e,zt=r,window.addEventListener("message",function(i){var t=i.data;if(!(!t||t.type!=="IKR_SETTINGS_UPDATE")){var a=t.settings;if(!(!a||!_)){var n=Object.assign({},_,a);le(ie,n,cr,Ce,K,Oe)}}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()}else if(M){let e=function(){Tr(),zi(),Ti()};Et=e,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}var St,zt,Et;})();
