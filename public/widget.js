...
`;var gr={};me(gr,{meta:()=>ct,render:()=>pt});function Ee(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var s=r[l-1]||0,c=i>0?Math.round(s/i*100):0,u=a===l,m=document.createElement("div");m.className="ikr-bar-row"+(u?" ikr-bar-active":""),a&&!u&&(m.style.opacity="0.35");for(var d="",v=1;v<=5;v++){var k=v<=l;d+='<span class="ikr-bar-star ikr-icon '+(k?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(k?t.filled:t.empty)+"</span>"}m.innerHTML='<span class="ikr-bar-label">'+d+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(f){m.onclick=function(){n(f)}})(l),o.appendChild(m)}return o}var ie=[],ii=!1;function Qi(e){for(var r=ie.length-1;r>=0;r--){var i=ie[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function et(e){if(e.key==="Escape")for(var r=ie.length-1;r>=0;r--)ie[r].close()}function rt(){ii||typeof document=="undefined"||(document.addEventListener("click",Qi,!0),document.addEventListener("keydown",et),ii=!0)}function Je(e){for(var r=0;r<ie.length;r++)ie[r]!==e&&ie[r].close()}function $e(e){rt();var r={trigger:e.trigger,element:e.element,close:e.close};return ie.push(r),function(){var t=ie.indexOf(r);t!==-1&&ie.splice(t,1)}}function te(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,o.appendChild(l);var s=document.createElement("div");s.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele");var u=A&&A.filterIcon||"lines";c.innerHTML=Ur(u);var m=document.createElement("div");m.className="ikr-filter-menu";var d=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function v(){m.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function k(){Je(f),m.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}d.forEach(function(p){var x=p[2],g=x?t:!t&&(i||"newest")===p[0],h=document.createElement("div");h.className="ikr-filter-item"+(g?" ikr-filter-item-active":""),h.textContent=p[1],h.onclick=function(){v(),n(p[0],x)},m.appendChild(h)}),c.onclick=function(){m.classList.contains("ikr-open")?v():k()};var f=$e({trigger:s,element:m,close:v});return s.appendChild(c),s.appendChild(m),o.appendChild(s),o}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var n=document.createElement("button");n.className="ikr-fwizard-close",n.type="button",n.setAttribute("aria-label","Kapat"),n.innerHTML="\u2715",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-content",a.appendChild(o);var l=!1,s="",c="";function u(){var p=window.innerWidth-document.documentElement.clientWidth;s=document.body.style.overflow,c=document.body.style.paddingRight,document.body.style.overflow="hidden",p>0&&(document.body.style.paddingRight=p+"px")}function m(){document.body.style.overflow=s,document.body.style.paddingRight=c}function d(){l||(l=!0,document.removeEventListener("keydown",v),t.removeEventListener("click",k),n.removeEventListener("click",d),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),m();try{r()}catch(p){}},200))}function v(p){p.key==="Escape"&&d()}function k(p){p.target===t&&i&&d()}document.addEventListener("keydown",v),t.addEventListener("click",k),n.addEventListener("click",d);function f(p){p&&o.appendChild(p),document.body.appendChild(t),u(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open")})}return{open:f,close:d,content:o,setAllowOutsideClose:function(p){i=!!p},setStepAttr:function(p){a.setAttribute("data-step",String(p))}}}var ai=`
...
`;var kr=4;function ni(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],productId:e.productId||"",productName:e.productName||""};function t(){r.forEach(function(a){try{a(i)}catch(n){}})}return{get:function(){return i},set:function(a){Object.assign(i,a),t()},goNext:function(){i.currentStep<kr&&(i.currentStep+=1,t())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,t())},onChange:function(a){return r.push(a),function(){r=r.filter(function(n){return n!==a})}}}}var it='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function oi(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],t=e.onBack||function(){},a=e.onSkip||function(){},n=e.onNext||function(){},o=document.createElement("div");o.className="ikr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=it+"<span>Geri</span>",l.addEventListener("click",function(){t()}),o.appendChild(l);var s=document.createElement("div");s.className="ikr-fwizard-footer-progress";for(var c=[],u=0;u<kr;u++){var m=document.createElement("span");m.className="ikr-fwizard-progress-seg",s.appendChild(m),c.push(m)}o.appendChild(s);var d=document.createElement("button");d.type="button";var v=null;function k(p){v&&d.removeEventListener("click",v),v=p,p&&d.addEventListener("click",p)}o.appendChild(d);function f(p,x){var g=r.indexOf(p)!==-1,h=i.indexOf(p)!==-1,b=x&&x.images&&x.images.length>0;g?(p===2&&b?(d.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",k(function(){n()})):(d.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",d.setAttribute("aria-label","Atla"),d.innerHTML="<span>Atla</span>",k(function(){a()})),d.disabled=!1,d.classList.remove("ikr-fwizard-cta-btn--disabled"),d.style.visibility="",d.tabIndex=0):h?(d.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",d.setAttribute("aria-label","Sonraki"),d.innerHTML="Sonraki",d.style.visibility="",d.tabIndex=0,k(function(){d.disabled||n()})):(d.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",d.innerHTML="",d.style.visibility="hidden",d.tabIndex=-1,d.disabled=!0,k(null))}return{el:o,update:function(p,x){c.forEach(function(h,b){b+1<=p?h.classList.add("ikr-fwizard-progress-seg-active"):h.classList.remove("ikr-fwizard-progress-seg-active")});var g=p<=1;l.style.visibility=g?"hidden":"",l.style.pointerEvents=g?"none":"",l.tabIndex=g?-1:0,f(p,x)},setNextDisabled:function(p){d.classList.contains("ikr-fwizard-cta-btn")&&(d.disabled=!!p,d.classList.toggle("ikr-fwizard-cta-btn--disabled",!!p))}}}function li(e){var r=document.createElement("div");r.className="ikr-fwizard-step ikr-fwizard-step-rating";var i=document.createElement("div");i.className="ikr-fwizard-step-title",i.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",r.appendChild(i);var t=document.createElement("div");t.className="ikr-fwizard-stars",t.setAttribute("role","radiogroup"),t.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var a=we(A||{}),n=[];function o(s){n.forEach(function(c,u){var m=u<s;c.classList.toggle("ikr-fwizard-star-active",m),c.innerHTML=m?a.filled:a.empty})}for(var l=1;l<=5;l++)(function(s){var c=document.createElement("button");c.type="button",c.className="ikr-fwizard-star",c.setAttribute("role","radio"),c.setAttribute("aria-label",s+" y\u0131ld\u0131z"),c.innerHTML=a.empty,c.addEventListener("mouseenter",function(){o(s)}),c.addEventListener("mouseleave",function(){o(e.get().rating)}),c.addEventListener("click",function(){e.set({rating:s}),o(s),setTimeout(function(){e.goNext()},280)}),n.push(c),t.appendChild(c)})(l);return o(e.get().rating),r.appendChild(t),{el:r,destroy:function(){}}}var di=3,tt=5*1024*1024;function si(e){var r=document.createElement("div");r.className="ikr-fwizard-step ikr-fwizard-step-photos";var i=document.createElement("div");i.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",i.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",r.appendChild(i);var t=document.createElement("div");t.className="ikr-fwizard-step-subtitle",t.textContent="Foto\u011Fraf ekleyebilirsiniz.",r.appendChild(t);var a=document.createElement("div");a.className="ikr-fwizard-photo-card";var n=document.createElement("label");n.className="ikr-fwizard-photo-add",n.setAttribute("aria-label","Foto\u011Fraf ekle"),n.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var o=document.createElement("input");o.type="file",o.accept="image/*",o.multiple=!0,o.style.display="none",n.appendChild(o),a.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-photo-previews",l.setAttribute("aria-live","polite"),a.appendChild(l),r.appendChild(a);var s=!1,c=[];function u(){var g=e.get().images||[];g.forEach(function(h){c.indexOf(h)===-1&&(k(h),c.push(h))}),v()}var m='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',d='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function v(){var g=(e.get().images||[]).length,h=g>=di;g>0?(a.classList.add("ikr-fwizard-photo-card--compact"),n.innerHTML=d):(a.classList.remove("ikr-fwizard-photo-card--compact"),n.innerHTML=m+"<span>Foto\u011Fraf Ekle</span>"),h?(n.style.display="none",o.disabled=!0):(n.style.display="flex",o.disabled=s,n.classList.toggle("ikr-fwizard-photo-add--disabled",s),n.appendChild(o))}function k(g){var h=document.createElement("div");h.className="ikr-fwizard-photo-thumb",h.innerHTML='<img src="'+g+'" alt="">';var b=document.createElement("button");b.type="button",b.className="ikr-fwizard-photo-remove",b.setAttribute("aria-label","Foto\u011Fraf\u0131 kald\u0131r"),b.innerHTML="&#x2715;",b.onclick=function(){var E=(e.get().images||[]).filter(function(S){return S!==g});e.set({images:E}),h.remove(),v()},h.appendChild(b),l.appendChild(h)}function f(g){var h=document.createElement("div");return h.className="ikr-fwizard-photo-thumb",h.innerHTML='<img src="'+g+'" alt=""><div class="ikr-fwizard-photo-loading"><div class="ikr-spinner"></div></div>',l.appendChild(h),h}o.onchange=async function(g){if(!s){var h=e.get().images||[],b=h.length,E=di-h.length,S=Array.from(g.target.files).slice(0,E);if(S.length!==0){b===0&&e.goNext(),s=!0,o.disabled=!0;for(var y=0;y<S.length;y++){var w=S[y];if(w.size>tt){alert(w.name+" dosyas\u0131 5MB s\u0131n\u0131r\u0131n\u0131 a\u015F\u0131yor. L\xFCtfen daha k\xFC\xE7\xFCk bir g\xF6rsel se\xE7in.");continue}var L=URL.createObjectURL(w),T=f(L),z=T.querySelector(".ikr-fwizard-photo-loading");if(typeof window!="undefined"&&window.__ikasPreviewMode){var I=(e.get().images||[]).slice();I.push(L),e.set({images:I}),p(T,z,L);continue}try{var P=await Y(D+"/api/public/upload/sign",{method:"POST"});if(!P.ok)throw P.status===429?new Error("rate_limit"):new Error("sign failed");var _=await P.json(),H=new FormData;H.append("file",w),H.append("api_key",_.api_key),H.append("timestamp",_.timestamp),H.append("signature",_.signature),H.append("folder","review_images");var ae=await fetch("https://api.cloudinary.com/v1_1/"+_.cloud_name+"/image/upload",{method:"POST",body:H}),J=await ae.json();if(J.secure_url){var ne=J.secure_url,W=(e.get().images||[]).slice();W.push(ne),e.set({images:W}),p(T,z,ne)}}catch(U){console.error("[ikr] Image upload failed:",U);var G=U.message==="rate_limit"?"\xC7ok fazla deneme. L\xFCtfen bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";z.innerHTML='<span class="ikr-upload-error">\u2717 '+G+"</span>"}}s=!1,o.value="",v()}}};function p(g,h,b){h.innerHTML='<span class="ikr-upload-check">\u2713</span>',setTimeout(function(){h.style.opacity="0",h.style.transition="opacity 0.4s",setTimeout(function(){h.style.display="none";var E=document.createElement("button");E.type="button",E.className="ikr-fwizard-photo-remove",E.setAttribute("aria-label","Foto\u011Fraf\u0131 kald\u0131r"),E.innerHTML="&#x2715;",E.onclick=function(){var S=(e.get().images||[]).filter(function(y){return y!==b});e.set({images:S}),g.remove(),v()},g.appendChild(E)},400)},600),v()}var x=e.onChange(u);return u(),{el:r,destroy:function(){o.onchange=null,x&&x()}}}var vr=2e3,at=60;function ci(e,r){r=r||{};var i=r.onValidityChange||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-content";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",t.appendChild(a);var n=document.createElement("div");n.className="ikr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="ikr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=at,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),n.appendChild(o);var l=document.createElement("textarea");l.className="ikr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=vr,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",n.appendChild(l);var s=document.createElement("div");s.className="ikr-fwizard-char-counter",s.setAttribute("aria-live","polite"),n.appendChild(s);function c(){var m=l.value.length;s.textContent=m+"/"+vr,s.classList.toggle("ikr-fwizard-char-counter--max",m>=vr)}function u(){return l.value.trim().length>0}return l.addEventListener("input",function(){e.set({comment:l.value}),c(),i(u())}),t.appendChild(n),c(),setTimeout(function(){i(u())},0),{el:t,destroy:function(){}}}var nt=40;function pi(e,r){r=r||{};var i=r.onValidityChange||function(){},t=r.onSuccess||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-author";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Hakk\u0131n\u0131zda",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-author-form";var l=document.createElement("div");l.className="ikr-fwizard-field";var s=document.createElement("label");s.className="ikr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var c=document.createElement("input");c.type="text",c.className="ikr-fwizard-input",c.maxLength=nt,c.setAttribute("aria-required","true"),c.value=e.get().author||"",l.appendChild(s),l.appendChild(c),o.appendChild(l);var u=document.createElement("div");u.className="ikr-fwizard-field";var m=document.createElement("label");m.className="ikr-fwizard-label",m.textContent="E-posta (opsiyonel)";var d=document.createElement("input");d.type="email",d.className="ikr-fwizard-input",d.setAttribute("autocomplete","email"),d.value=e.get().email||"",u.appendChild(m),u.appendChild(d),o.appendChild(u);var v=document.createElement("div");v.className="ikr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(v);var k=document.createElement("div");k.className="ikr-fwizard-msg",k.setAttribute("role","alert"),k.setAttribute("aria-live","assertive"),o.appendChild(k);var f=document.createElement("button");f.type="button",f.className="ikr-fwizard-submit-btn",f.textContent="G\xF6nder",o.appendChild(f),a.appendChild(o);function p(){return c.value.trim().length>0}function x(){var g=!p();f.disabled=g,f.classList.toggle("ikr-fwizard-submit-btn--disabled",g)}return c.addEventListener("input",function(){e.set({author:c.value}),x(),i(p())}),d.addEventListener("input",function(){e.set({email:d.value})}),x(),setTimeout(function(){i(p())},0),f.onclick=async function(){if(!f.disabled){var g=e.get(),h=(g.author||"").trim(),b=(g.comment||"").trim();if(!h){k.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen ad\u0131n\u0131z\u0131 girin.</div>';return}if(!g.rating){k.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}f.disabled=!0,f.classList.add("ikr-fwizard-submit-btn--disabled");var E=f.textContent;if(f.textContent="G\xF6nderiliyor\u2026",k.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){t()},600);return}try{var S=O(window.location.href),y=g.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),w=await Y(D+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:j,productId:g.productId||null,slug:S||null,productName:y,author:h,title:(g.title||"").trim()||null,comment:b||null,rating:g.rating,images:g.images||[]})},15e3);if(w.ok)t();else{var L=await w.json().catch(function(){return{}});throw new Error(L.error||"Yorum kaydedilemedi.")}}catch(I){var T=I&&(I.name==="AbortError"||/signal/i.test(I.message||"")),z=T?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":I.message||"Yorum g\xF6nderilemedi.";k.innerHTML='<div class="ikr-fwizard-msg-error">'+z+"</div>",f.disabled=!1,f.classList.remove("ikr-fwizard-submit-btn--disabled"),f.textContent=E}}},{el:a,destroy:function(){f.onclick=null}}}var mi=!1;function ot(){if(!mi){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=ai,document.head.appendChild(e),mi=!0}}function lt(e,r,i){if(i=i||{},e===1)return li(r);if(e===2)return si(r);if(e===3)return ci(r,{onValidityChange:i.onValidityChange});if(e===4)return pi(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess});var t=document.createElement("div");return t.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:t,destroy:function(){}}}function dt(){var e=document.createElement("div");return e.className="ikr-fwizard-thanks",e.innerHTML='<div class="ikr-fwizard-thanks-icon" aria-hidden="true"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div><div class="ikr-fwizard-thanks-title">Yorumunuz i\xE7in te\u015Fekk\xFCrler!</div><div class="ikr-fwizard-thanks-text">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function ui(e){e=e||{},ot();var r=ni({productId:e.productId,productName:e.productName}),i=ti({onClose:e.onClose,allowOutsideClose:!0}),t=document.createElement("div");t.className="ikr-fwizard-step-wrap";var a=oi({skippableSteps:[2],nextableSteps:[3],onBack:function(){r.goBack()},onSkip:function(){r.goNext()},onNext:function(){r.goNext()}}),n=document.createElement("div");n.className="ikr-fwizard-layout",n.appendChild(t),n.appendChild(a.el);var o=null,l="idle",s=null,c=!0;function u(k,f){var p=lt(k,r,{onValidityChange:function(g){a.setNextDisabled(!g)},onSuccess:m});if(o=p,f){l="entering",p.el.classList.add("ikr-fwizard-step--enter");var x=function(){p.el.removeEventListener("animationend",x),p.el.classList.remove("ikr-fwizard-step--enter"),l="idle",s!==null&&s!==r.get().currentStep?(s=null,d()):s=null};p.el.addEventListener("animationend",x)}else l="idle";t.appendChild(p.el),a.update(k,r.get()),i.setStepAttr&&i.setStepAttr(k),k===3&&a.setNextDisabled(!0)}function m(){o&&o.destroy&&o.destroy(),o=null,l="idle",s=null,t.innerHTML="",t.appendChild(dt()),a.el.style.display="none"}function d(){var k=r.get().currentStep;if(l!=="idle"){s=k;return}if(!o){var f=!c;c=!1,u(k,f);return}var p=o;l="exiting",p.el.classList.add("ikr-fwizard-step--exit");var x=function(){if(p.el.removeEventListener("animationend",x),p.destroy)try{p.destroy()}catch(h){}if(o===p){t.innerHTML="",o=null;var g=s!==null?s:r.get().currentStep;s=null,u(g,!0)}};p.el.addEventListener("animationend",x)}d();var v=r.get().currentStep;return r.onChange(function(k){k.currentStep!==v&&(v=k.currentStep,d()),a.update(k.currentStep,k)}),i.open(n),{close:i.close}}function st(){var e=document.getElementById("ikr-form-accordion");if(e){var r=e.style.maxHeight&&e.style.maxHeight!=="0px";r?(e.style.maxHeight="0px",e.style.opacity="0"):(e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",setTimeout(function(){e.style.maxHeight="none"},360),setTimeout(function(){var i=document.querySelector("header"),t=i?i.getBoundingClientRect().height:0,a=e.getBoundingClientRect().top+window.pageYOffset-t-16;window.scrollTo({top:a,behavior:"smooth"})},50))}}function K(){var e=A&&A.reviewFormStyle||"accordion";if(e==="modal"){ui({productId:X||"",productName:ue||""});return}st()}var ct={id:"classic",name:"Klasik (A\xE7\u0131k)"};function pt(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,s=e.currentRatingFilter,c=e.currentOrderBy,u=e.currentHasImages,m=e.onFilterChange,d=e.onSortChange,v=document.createElement("div");v.className="ikr-summary";var k=(o[3]||0)+(o[4]||0),f=n>0?Math.round(k/n*100):0,p=document.createElement("div");p.className="ikr-summary-block ikr-summary-avg",p.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+l+"</span>",v.appendChild(p);var x=document.createElement("div");if(x.className="ikr-summary-block ikr-summary-count",x.textContent=n.toLocaleString("tr-TR")+" Yorum",v.appendChild(x),t.showRecommendation!==!1&&f>0){var g=document.createElement("div");g.className="ikr-summary-block ikr-summary-recommend",g.innerHTML='<span class="ikr-recommend-pct">%'+f+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(g)}return v.appendChild(Ee({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:s,onFilterChange:m})),v.appendChild(te({widget:r,currentOrderBy:c,currentHasImages:u,onWriteClick:K,onSortChange:d})),v}var hr={};me(hr,{css:()=>ut,meta:()=>mt,render:()=>ft});var fi=`
...
`;var mt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ut=fi;function ft(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,u=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-compact";var v=document.createElement("div");v.className="ikr-compact-header";var k=document.createElement("div");k.className="ikr-compact-trigger-wrap";var f=document.createElement("button");f.className="ikr-compact-trigger",f.type="button",f.setAttribute("aria-expanded","false"),f.innerHTML='<span class="ikr-compact-trigger-stars">'+ee(o,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',k.appendChild(f),v.appendChild(k);var p=te({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:K,onSortChange:m}),x=p.querySelector(".ikr-filter-wrap"),g=p.querySelector(".ikr-write-btn"),h=document.createElement("div");h.className="ikr-compact-actions-slot",g&&h.appendChild(g),x&&h.appendChild(x),v.appendChild(h),d.appendChild(v);var b=document.createElement("div");b.className="ikr-compact-panel",b.setAttribute("role","dialog"),b.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="ikr-compact-panel-inner";var S=document.createElement("div");S.className="ikr-compact-avg",S.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+o+"</span>",E.appendChild(S),E.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:u})),b.appendChild(E);var y=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(G){var U=G?d:k;b.parentNode!==U&&(b.classList.contains("ikr-open")&&(b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")),U.appendChild(b))}if(w(y?y.matches:!1),y){var L=function(G){w(G.matches)};y.addEventListener?y.addEventListener("change",L):y.addListener&&y.addListener(L)}if(g){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent="Yorum Yap",T.onclick=K;var z=document.createElement("div");z.className="ikr-compact-write-row",z.appendChild(T),d.appendChild(z)}function I(){b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")}function P(){Je(_),b.classList.add("ikr-open"),b.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true")}f.onclick=function(){b.classList.contains("ikr-open")?I():P()};var _=null;function H(G){_&&(_(),_=null),G||(_=$e({trigger:k,element:b,close:I}))}if(H(y?y.matches:!1),y){var ae=function(G){H(G.matches)};y.addEventListener?y.addEventListener("change",ae):y.addListener&&y.addListener(ae)}if(i.showRecommendation!==!1){var J=(n[3]||0)+(n[4]||0),ne=a>0?Math.round(J/a*100):0;if(ne>0){var W=document.createElement("div");W.className="ikr-summary-block ikr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="ikr-recommend-pct">%'+ne+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(W)}}return d}var br={};me(br,{css:()=>vt,meta:()=>kt,render:()=>gt});var ki=`
...
`;var kt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},vt=ki;function gt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,c=e.currentHasImages,u=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-split";var v=document.createElement("div");v.className="ikr-split-col ikr-split-left";var k=document.createElement("div");k.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",k.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+o+"</span>",v.appendChild(k);var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-count ikr-split-left-count",f.textContent=a.toLocaleString("tr-TR")+" Yorum",v.appendChild(f),d.appendChild(v);var p=document.createElement("div");p.className="ikr-split-col ikr-split-mid",p.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:u})),d.appendChild(p);var x=te({widget:r,currentOrderBy:s,currentHasImages:c,onWriteClick:K,onSortChange:m}),g=x.querySelector(".ikr-filter-wrap"),h=x.querySelector(".ikr-write-btn"),b=document.createElement("div");if(b.className="ikr-split-col ikr-split-right",h&&b.appendChild(h),g&&b.appendChild(g),d.appendChild(b),i.showRecommendation!==!1){var E=(n[3]||0)+(n[4]||0),S=a>0?Math.round(E/a*100):0;if(S>0){var y=document.createElement("div");y.className="ikr-summary-block ikr-summary-recommend",y.innerHTML='<span class="ikr-recommend-pct">%'+S+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(y)}}return d}var xr={};me(xr,{css:()=>bt,meta:()=>ht,render:()=>xt});var vi=`
...
`;var ht={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1}},bt=vi;function xt(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,n=e.currentOrderBy,o=e.currentHasImages,l=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var c=document.createElement("div");c.className="ikr-minimal-info";var u=document.createElement("div");u.className="ikr-minimal-row";var m=document.createElement("span");m.className="ikr-minimal-avg",m.textContent=a,u.appendChild(m);var d=document.createElement("span");d.className="ikr-minimal-stars",d.innerHTML=ee(a,i),u.appendChild(d);var v=document.createElement("span");v.className="ikr-minimal-count",v.textContent=t.toLocaleString("tr-TR")+" Yorum",u.appendChild(v),c.appendChild(u),s.appendChild(c);var k=te({widget:r,currentOrderBy:n,currentHasImages:o,onWriteClick:K,onSortChange:l}),f=k.querySelector(".ikr-filter-wrap"),p=k.querySelector(".ikr-write-btn"),x=document.createElement("div");if(x.className="ikr-minimal-actions",p&&x.appendChild(p),f&&x.appendChild(f),s.appendChild(x),p){var g=document.createElement("button");g.className="ikr-write-btn",g.textContent="Yorum Yap",g.onclick=K;var h=document.createElement("div");h.className="ikr-minimal-write-row",h.appendChild(g),s.appendChild(h)}return s}var yr={};me(yr,{css:()=>wt,meta:()=>yt,render:()=>zt});var gi=`
