...
`;var gr={};ce(gr,{meta:()=>st,render:()=>ct});function Ee(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var s=r[l-1]||0,d=i>0?Math.round(s/i*100):0,c=a===l,p=document.createElement("div");p.className="ikr-bar-row"+(c?" ikr-bar-active":""),a&&!c&&(p.style.opacity="0.35");for(var m="",k=1;k<=5;k++){var f=k<=l;m+='<span class="ikr-bar-star ikr-icon '+(f?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(f?t.filled:t.empty)+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+m+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+d+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(u){p.onclick=function(){n(u)}})(l),o.appendChild(p)}return o}var re=[],ii=!1;function Qi(e){for(var r=re.length-1;r>=0;r--){var i=re[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function et(e){if(e.key==="Escape")for(var r=re.length-1;r>=0;r--)re[r].close()}function rt(){ii||typeof document=="undefined"||(document.addEventListener("click",Qi,!0),document.addEventListener("keydown",et),ii=!0)}function Je(e){for(var r=0;r<re.length;r++)re[r]!==e&&re[r].close()}function $e(e){rt();var r={trigger:e.trigger,element:e.element,close:e.close};return re.push(r),function(){var t=re.indexOf(r);t!==-1&&re.splice(t,1)}}function ie(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,o=document.createElement("div");o.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,o.appendChild(l);var s=document.createElement("div");s.className="ikr-filter-wrap";var d=document.createElement("button");d.className="ikr-filter-btn",d.setAttribute("aria-label","Filtrele");var c=A&&A.filterIcon||"lines";d.innerHTML=Vr(c);var p=document.createElement("div");p.className="ikr-filter-menu";var m=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function k(){p.classList.remove("ikr-open"),d.classList.remove("ikr-filter-btn-active")}function f(){Je(u),p.classList.add("ikr-open"),d.classList.add("ikr-filter-btn-active")}m.forEach(function(v){var h=v[2],g=h?t:!t&&(i||"newest")===v[0],y=document.createElement("div");y.className="ikr-filter-item"+(g?" ikr-filter-item-active":""),y.textContent=v[1],y.onclick=function(){k(),n(v[0],h)},p.appendChild(y)}),d.onclick=function(){p.classList.contains("ikr-open")?k():f()};var u=$e({trigger:s,element:p,close:k});return s.appendChild(d),s.appendChild(p),o.appendChild(s),o}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var n=document.createElement("button");n.className="ikr-fwizard-close",n.type="button",n.setAttribute("aria-label","Kapat"),n.innerHTML="\u2715",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-content",a.appendChild(o);var l=!1,s="",d="";function c(){var v=window.innerWidth-document.documentElement.clientWidth;s=document.body.style.overflow,d=document.body.style.paddingRight,document.body.style.overflow="hidden",v>0&&(document.body.style.paddingRight=v+"px")}function p(){document.body.style.overflow=s,document.body.style.paddingRight=d}function m(){l||(l=!0,document.removeEventListener("keydown",k),t.removeEventListener("click",f),n.removeEventListener("click",m),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),p();try{r()}catch(v){}},200))}function k(v){v.key==="Escape"&&m()}function f(v){v.target===t&&i&&m()}document.addEventListener("keydown",k),t.addEventListener("click",f),n.addEventListener("click",m);function u(v){v&&o.appendChild(v),document.body.appendChild(t),c(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open")})}return{open:u,close:m,content:o,setAllowOutsideClose:function(v){i=!!v}}}var ai=`
...
`;var fr=4;function ni(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],productId:e.productId||"",productName:e.productName||""};function t(){r.forEach(function(a){try{a(i)}catch(n){}})}return{get:function(){return i},set:function(a){Object.assign(i,a),t()},goNext:function(){i.currentStep<fr&&(i.currentStep+=1,t())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,t())},onChange:function(a){return r.push(a),function(){r=r.filter(function(n){return n!==a})}}}}function oi(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],t=e.onBack||function(){},a=e.onSkip||function(){},n=e.onNext||function(){},o=document.createElement("div");o.className="ikr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg><span>Geri</span>',l.onclick=function(){t()},o.appendChild(l);var s=document.createElement("div");s.className="ikr-fwizard-footer-progress";for(var d=[],c=0;c<fr;c++){var p=document.createElement("span");p.className="ikr-fwizard-progress-seg",s.appendChild(p),d.push(p)}o.appendChild(s);var m=document.createElement("div");m.className="ikr-fwizard-footer-right";var k=document.createElement("button");k.type="button",k.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",k.setAttribute("aria-label","Atla"),k.innerHTML='<span>Atla</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg>',k.onclick=function(){a()};var f=document.createElement("button");return f.type="button",f.className="ikr-fwizard-cta-btn",f.textContent="Sonraki",f.onclick=function(){f.disabled||n()},m.appendChild(k),m.appendChild(f),o.appendChild(m),{el:o,update:function(u){d.forEach(function(g,y){y+1<=u?g.classList.add("ikr-fwizard-progress-seg-active"):g.classList.remove("ikr-fwizard-progress-seg-active")}),l.hidden=u<=1;var v=r.indexOf(u)!==-1,h=i.indexOf(u)!==-1;k.hidden=!v,f.hidden=!h},setNextDisabled:function(u){f.disabled=!!u,f.classList.toggle("ikr-fwizard-cta-btn--disabled",!!u)}}}function li(e){var r=document.createElement("div");r.className="ikr-fwizard-step ikr-fwizard-step-rating";var i=document.createElement("div");i.className="ikr-fwizard-step-title",i.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",r.appendChild(i);var t=document.createElement("div");t.className="ikr-fwizard-stars",t.setAttribute("role","radiogroup"),t.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var a=ye(A||{}),n=[];function o(s){n.forEach(function(d,c){var p=c<s;d.classList.toggle("ikr-fwizard-star-active",p),d.innerHTML=p?a.filled:a.empty})}for(var l=1;l<=5;l++)(function(s){var d=document.createElement("button");d.type="button",d.className="ikr-fwizard-star",d.setAttribute("role","radio"),d.setAttribute("aria-label",s+" y\u0131ld\u0131z"),d.innerHTML=a.empty,d.addEventListener("mouseenter",function(){o(s)}),d.addEventListener("mouseleave",function(){o(e.get().rating)}),d.addEventListener("click",function(){e.set({rating:s}),o(s),setTimeout(function(){e.goNext()},280)}),n.push(d),t.appendChild(d)})(l);return o(e.get().rating),r.appendChild(t),{el:r,destroy:function(){}}}var di=3,it=5*1024*1024;function si(e){var r=document.createElement("div");r.className="ikr-fwizard-step ikr-fwizard-step-photos";var i=document.createElement("div");i.className="ikr-fwizard-step-title",i.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",r.appendChild(i);var t=document.createElement("div");t.className="ikr-fwizard-step-subtitle",t.textContent="Foto\u011Fraf ekleyebilirsiniz.",r.appendChild(t);var a=document.createElement("div");a.className="ikr-fwizard-photo-card";var n=document.createElement("label");n.className="ikr-fwizard-photo-add",n.setAttribute("aria-label","Foto\u011Fraf ekle"),n.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var o=document.createElement("input");o.type="file",o.accept="image/*",o.multiple=!0,o.style.display="none",n.appendChild(o),a.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-photo-previews",l.setAttribute("aria-live","polite"),a.appendChild(l),r.appendChild(a);var s=!1;function d(){var f=e.get().images||[];f.forEach(function(u){p(u)}),c()}function c(){var f=(e.get().images||[]).length;f>=di?(o.disabled=!0,n.classList.add("ikr-fwizard-photo-add--disabled")):(o.disabled=!1,n.classList.remove("ikr-fwizard-photo-add--disabled"))}function p(f){var u=document.createElement("div");u.className="ikr-fwizard-photo-thumb",u.innerHTML='<img src="'+f+'" alt="">';var v=document.createElement("button");v.type="button",v.className="ikr-fwizard-photo-remove",v.setAttribute("aria-label","Foto\u011Fraf\u0131 kald\u0131r"),v.innerHTML="&#x2715;",v.onclick=function(){var h=(e.get().images||[]).filter(function(g){return g!==f});e.set({images:h}),u.remove(),c()},u.appendChild(v),l.appendChild(u)}function m(f){var u=document.createElement("div");return u.className="ikr-fwizard-photo-thumb",u.innerHTML='<img src="'+f+'" alt=""><div class="ikr-fwizard-photo-loading"><div class="ikr-spinner"></div></div>',l.appendChild(u),u}o.onchange=async function(f){if(!s){s=!0,o.disabled=!0;for(var u=e.get().images||[],v=di-u.length,h=Array.from(f.target.files).slice(0,v),g=0;g<h.length;g++){var y=h[g];if(y.size>it){alert(y.name+" dosyas\u0131 5MB s\u0131n\u0131r\u0131n\u0131 a\u015F\u0131yor. L\xFCtfen daha k\xFC\xE7\xFCk bir g\xF6rsel se\xE7in.");continue}var b=URL.createObjectURL(y),L=m(b),E=L.querySelector(".ikr-fwizard-photo-loading");if(typeof window!="undefined"&&window.__ikasPreviewMode){var x=(e.get().images||[]).slice();x.push(b),e.set({images:x}),k(L,E,b);continue}try{var w=await D(F+"/api/public/upload/sign",{method:"POST"});if(!w.ok)throw w.status===429?new Error("rate_limit"):new Error("sign failed");var T=await w.json(),S=new FormData;S.append("file",y),S.append("api_key",T.api_key),S.append("timestamp",T.timestamp),S.append("signature",T.signature),S.append("folder","review_images");var z=await fetch("https://api.cloudinary.com/v1_1/"+T.cloud_name+"/image/upload",{method:"POST",body:S}),B=await z.json();if(B.secure_url){var H=B.secure_url,I=(e.get().images||[]).slice();I.push(H),e.set({images:I}),k(L,E,H)}}catch(W){console.error("[ikr] Image upload failed:",W);var U=W.message==="rate_limit"?"\xC7ok fazla deneme. L\xFCtfen bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";E.innerHTML='<span class="ikr-upload-error">\u2717 '+U+"</span>"}}s=!1,o.value="",c()}};function k(f,u,v){u.innerHTML='<span class="ikr-upload-check">\u2713</span>',setTimeout(function(){u.style.opacity="0",u.style.transition="opacity 0.4s",setTimeout(function(){u.style.display="none";var h=document.createElement("button");h.type="button",h.className="ikr-fwizard-photo-remove",h.setAttribute("aria-label","Foto\u011Fraf\u0131 kald\u0131r"),h.innerHTML="&#x2715;",h.onclick=function(){var g=(e.get().images||[]).filter(function(y){return y!==v});e.set({images:g}),f.remove(),c()},f.appendChild(h)},400)},600),c()}return d(),{el:r,destroy:function(){o.onchange=null}}}var kr=2e3,tt=60;function ci(e,r){r=r||{};var i=r.onValidityChange||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-content";var a=document.createElement("div");a.className="ikr-fwizard-step-title",a.textContent="Deneyiminizi anlat\u0131n",t.appendChild(a);var n=document.createElement("div");n.className="ikr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="ikr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=tt,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),n.appendChild(o);var l=document.createElement("textarea");l.className="ikr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=kr,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",n.appendChild(l);var s=document.createElement("div");s.className="ikr-fwizard-char-counter",s.setAttribute("aria-live","polite"),n.appendChild(s);function d(){var p=l.value.length;s.textContent=p+"/"+kr,s.classList.toggle("ikr-fwizard-char-counter--max",p>=kr)}function c(){return l.value.trim().length>0}return l.addEventListener("input",function(){e.set({comment:l.value}),d(),i(c())}),t.appendChild(n),d(),setTimeout(function(){i(c())},0),{el:t,destroy:function(){}}}var at=40;function pi(e,r){r=r||{};var i=r.onValidityChange||function(){},t=r.onSuccess||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-author";var n=document.createElement("div");n.className="ikr-fwizard-step-title",n.textContent="Hakk\u0131n\u0131zda",a.appendChild(n);var o=document.createElement("div");o.className="ikr-fwizard-author-form";var l=document.createElement("div");l.className="ikr-fwizard-field";var s=document.createElement("label");s.className="ikr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var d=document.createElement("input");d.type="text",d.className="ikr-fwizard-input",d.maxLength=at,d.setAttribute("aria-required","true"),d.value=e.get().author||"",l.appendChild(s),l.appendChild(d),o.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-field";var p=document.createElement("label");p.className="ikr-fwizard-label",p.textContent="E-posta (opsiyonel)";var m=document.createElement("input");m.type="email",m.className="ikr-fwizard-input",m.placeholder="ornek@email.com",m.setAttribute("autocomplete","email"),m.value=e.get().email||"",c.appendChild(p),c.appendChild(m),o.appendChild(c);var k=document.createElement("div");k.className="ikr-fwizard-notice",k.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(k);var f=document.createElement("div");f.className="ikr-fwizard-msg",f.setAttribute("role","alert"),f.setAttribute("aria-live","assertive"),o.appendChild(f);var u=document.createElement("button");u.type="button",u.className="ikr-fwizard-submit-btn",u.textContent="G\xF6nder",o.appendChild(u),a.appendChild(o);function v(){return d.value.trim().length>0}function h(){var g=!v();u.disabled=g,u.classList.toggle("ikr-fwizard-submit-btn--disabled",g)}return d.addEventListener("input",function(){e.set({author:d.value}),h(),i(v())}),m.addEventListener("input",function(){e.set({email:m.value})}),h(),setTimeout(function(){i(v())},0),u.onclick=async function(){if(!u.disabled){var g=e.get(),y=(g.author||"").trim(),b=(g.comment||"").trim();if(!y){f.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen ad\u0131n\u0131z\u0131 girin.</div>';return}if(!g.rating){f.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}u.disabled=!0,u.classList.add("ikr-fwizard-submit-btn--disabled");var L=u.textContent;if(u.textContent="G\xF6nderiliyor\u2026",f.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){t()},600);return}try{var E=P(window.location.href),x=g.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),w=await D(F+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:O,productId:g.productId||null,slug:E||null,productName:x,author:y,title:(g.title||"").trim()||null,comment:b||null,rating:g.rating,images:g.images||[]})},15e3);if(w.ok)t();else{var T=await w.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(B){var S=B&&(B.name==="AbortError"||/signal/i.test(B.message||"")),z=S?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":B.message||"Yorum g\xF6nderilemedi.";f.innerHTML='<div class="ikr-fwizard-msg-error">'+z+"</div>",u.disabled=!1,u.classList.remove("ikr-fwizard-submit-btn--disabled"),u.textContent=L}}},{el:a,destroy:function(){u.onclick=null}}}var mi=!1;function nt(){if(!mi){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=ai,document.head.appendChild(e),mi=!0}}function ot(e,r,i){if(i=i||{},e===1)return li(r);if(e===2)return si(r);if(e===3)return ci(r,{onValidityChange:i.onValidityChange});if(e===4)return pi(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess});var t=document.createElement("div");return t.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:t,destroy:function(){}}}function lt(){var e=document.createElement("div");return e.className="ikr-fwizard-thanks",e.innerHTML='<div class="ikr-fwizard-thanks-icon" aria-hidden="true"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div><div class="ikr-fwizard-thanks-title">Yorumunuz i\xE7in te\u015Fekk\xFCrler!</div><div class="ikr-fwizard-thanks-text">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function ui(e){e=e||{},nt();var r=ni({productId:e.productId,productName:e.productName}),i=ti({onClose:e.onClose,allowOutsideClose:!0}),t=document.createElement("div");t.className="ikr-fwizard-step-wrap";var a=oi({skippableSteps:[2],nextableSteps:[3],onBack:function(){r.goBack()},onSkip:function(){r.goNext()},onNext:function(){r.goNext()}}),n=document.createElement("div");n.className="ikr-fwizard-layout",n.appendChild(t),n.appendChild(a.el);var o=null;function l(){o&&o.destroy&&o.destroy(),t.innerHTML="",t.appendChild(lt()),a.el.style.display="none"}function s(){o&&o.destroy&&o.destroy(),t.innerHTML="";var c=r.get().currentStep;o=ot(c,r,{onValidityChange:function(p){a.setNextDisabled(!p)},onSuccess:l}),t.appendChild(o.el),a.update(c),c===3&&a.setNextDisabled(!0)}s();var d=r.get().currentStep;return r.onChange(function(c){c.currentStep!==d&&(d=c.currentStep,s())}),i.open(n),{close:i.close}}function dt(){var e=document.getElementById("ikr-form-accordion");if(e){var r=e.style.maxHeight&&e.style.maxHeight!=="0px";r?(e.style.maxHeight="0px",e.style.opacity="0"):(e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",setTimeout(function(){e.style.maxHeight="none"},360),setTimeout(function(){var i=document.querySelector("header"),t=i?i.getBoundingClientRect().height:0,a=e.getBoundingClientRect().top+window.pageYOffset-t-16;window.scrollTo({top:a,behavior:"smooth"})},50))}}function G(){var e=A&&A.reviewFormStyle||"accordion";if(e==="modal"){ui({productId:Z||"",productName:pe||""});return}dt()}var st={id:"classic",name:"Klasik (A\xE7\u0131k)"};function ct(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,s=e.currentRatingFilter,d=e.currentOrderBy,c=e.currentHasImages,p=e.onFilterChange,m=e.onSortChange,k=document.createElement("div");k.className="ikr-summary";var f=(o[3]||0)+(o[4]||0),u=n>0?Math.round(f/n*100):0,v=document.createElement("div");v.className="ikr-summary-block ikr-summary-avg",v.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+l+"</span>",k.appendChild(v);var h=document.createElement("div");if(h.className="ikr-summary-block ikr-summary-count",h.textContent=n.toLocaleString("tr-TR")+" Yorum",k.appendChild(h),t.showRecommendation!==!1&&u>0){var g=document.createElement("div");g.className="ikr-summary-block ikr-summary-recommend",g.innerHTML='<span class="ikr-recommend-pct">%'+u+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(g)}return k.appendChild(Ee({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:s,onFilterChange:p})),k.appendChild(ie({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:G,onSortChange:m})),k}var hr={};ce(hr,{css:()=>mt,meta:()=>pt,render:()=>ut});var vi=`
...
`;var vt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},ft=fi;function kt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,s=e.currentOrderBy,d=e.currentHasImages,c=e.onFilterChange,p=e.onSortChange,m=document.createElement("div");m.className="ikr-summary ikr-summary-split";var k=document.createElement("div");k.className="ikr-split-col ikr-split-left";var f=document.createElement("div");f.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",f.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+o+"</span>",k.appendChild(f);var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-count ikr-split-left-count",u.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(u),m.appendChild(k);var v=document.createElement("div");v.className="ikr-split-col ikr-split-mid",v.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:c})),m.appendChild(v);var h=ie({widget:r,currentOrderBy:s,currentHasImages:d,onWriteClick:G,onSortChange:p}),g=h.querySelector(".ikr-filter-wrap"),y=h.querySelector(".ikr-write-btn"),b=document.createElement("div");if(b.className="ikr-split-col ikr-split-right",y&&b.appendChild(y),g&&b.appendChild(g),m.appendChild(b),i.showRecommendation!==!1){var L=(n[3]||0)+(n[4]||0),E=a>0?Math.round(L/a*100):0;if(E>0){var x=document.createElement("div");x.className="ikr-summary-block ikr-summary-recommend",x.innerHTML='<span class="ikr-recommend-pct">%'+E+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(x)}}return m}var br={};ce(br,{css:()=>ht,meta:()=>gt,render:()=>xt});var ki=`
...
`;var gt={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1}},ht=ki;function xt(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,n=e.currentOrderBy,o=e.currentHasImages,l=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var d=document.createElement("div");d.className="ikr-minimal-info";var c=document.createElement("div");c.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=a,c.appendChild(p);var m=document.createElement("span");m.className="ikr-minimal-stars",m.innerHTML=Q(a,i),c.appendChild(m);var k=document.createElement("span");k.className="ikr-minimal-count",k.textContent=t.toLocaleString("tr-TR")+" Yorum",c.appendChild(k),d.appendChild(c),s.appendChild(d);var f=ie({widget:r,currentOrderBy:n,currentHasImages:o,onWriteClick:G,onSortChange:l}),u=f.querySelector(".ikr-filter-wrap"),v=f.querySelector(".ikr-write-btn"),h=document.createElement("div");if(h.className="ikr-minimal-actions",v&&h.appendChild(v),u&&h.appendChild(u),s.appendChild(h),v){var g=document.createElement("button");g.className="ikr-write-btn",g.textContent="Yorum Yap",g.onclick=G;var y=document.createElement("div");y.className="ikr-minimal-write-row",y.appendChild(g),s.appendChild(y)}return s}var yr={};ce(yr,{css:()=>yt,meta:()=>bt,render:()=>wt});var gi=`
...
`;var Et={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"90px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"120px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},Tt=xi;function Lt(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length),t=document.createElement("div");t.className="ikr-review-list"+(i?"":" ikr-review-list--no-media");var a=document.createElement("div");a.className="ikr-review-list-author";var n=document.createElement("span");n.className="ikr-review-stars ikr-review-list-author-stars",n.innerHTML=ne(e.rating,A),a.appendChild(n);var o=document.createElement("span");o.className="ikr-review-list-author-name",o.textContent=e.author||"",a.appendChild(o);var l=document.createElement("span");l.className="ikr-date ikr-review-list-author-date",l.textContent=oe(e.createdAt),a.appendChild(l),t.appendChild(a);var s=document.createElement("div");if(s.className="ikr-review-list-content",e.title){var d=document.createElement("div");d.className="ikr-review-list-title",d.textContent=e.title,s.appendChild(d)}var c=(e.comment||"").trim();if(c){var p=document.createElement("div");p.className="ikr-review-list-body ikr-body-clamped",p.textContent=c,s.appendChild(p);var m=document.createElement("span");m.className="ikr-read-more",m.textContent="Devam\u0131n\u0131 oku",m.style.display="none",s.appendChild(m),requestAnimationFrame(function(){if(p.scrollHeight>p.clientHeight+2){m.style.display="inline";var u=!1;m.onclick=function(){u=!u,p.classList.toggle("ikr-body-clamped",!u),m.textContent=u?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var k=Te(e.merchantReply);if(k&&s.appendChild(k),t.appendChild(s),i){var f=document.createElement("div");f.className="ikr-review-list-media",e.images.forEach(function(u){if(!(!u||u.indexOf("https://")!==0&&u.indexOf("data:image/")!==0)){var v=document.createElement("img");v.src=V(u),v.setAttribute("data-ikr-img-url",u),(function(h){v.onclick=function(){ee(e,h,r)}})(u),f.appendChild(v)}}),t.appendChild(f)}return t}var zr={};ce(zr,{css:()=>Nt,meta:()=>At,render:()=>_t});var bi=`
