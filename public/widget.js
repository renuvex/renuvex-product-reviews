...
`;var gr={};xe(gr,{meta:()=>ct,render:()=>pt});function Ae(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,l=document.createElement("div");l.className="ikr-summary-block ikr-summary-bars";for(var o=5;o>=1;o--){var s=r[o-1]||0,c=i>0?Math.round(s/i*100):0,p=a===o,m=document.createElement("div");m.className="ikr-bar-row"+(p?" ikr-bar-active":""),a&&!p&&(m.style.opacity="0.35");for(var d="",k=1;k<=5;k++){var v=k<=o;d+='<span class="ikr-bar-star ikr-icon '+(v?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(v?t.filled:t.empty)+"</span>"}m.innerHTML='<span class="ikr-bar-label">'+d+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(f){m.onclick=function(){n(f)}})(o),l.appendChild(m)}return l}var de=[],ii=!1;function Qi(e){for(var r=de.length-1;r>=0;r--){var i=de[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function et(e){if(e.key==="Escape")for(var r=de.length-1;r>=0;r--)de[r].close()}function rt(){ii||typeof document=="undefined"||(document.addEventListener("click",Qi,!0),document.addEventListener("keydown",et),ii=!0)}function Qe(e){for(var r=0;r<de.length;r++)de[r]!==e&&de[r].close()}function er(e){rt();var r={trigger:e.trigger,element:e.element,close:e.close};return de.push(r),function(){var t=de.indexOf(r);t!==-1&&de.splice(t,1)}}function se(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,l=document.createElement("div");l.className="ikr-summary-block ikr-summary-actions";var o=document.createElement("button");o.className="ikr-write-btn",o.textContent="Yorum Yap",o.onclick=a,l.appendChild(o);var s=document.createElement("div");s.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele");var p=A&&A.filterIcon||"lines";c.innerHTML=Ur(p);var m=document.createElement("div");m.className="ikr-filter-menu";var d=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function k(){m.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function v(){Qe(f),m.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}d.forEach(function(u){var x=u[2],b=x?t:!t&&(i||"newest")===u[0],g=document.createElement("div");g.className="ikr-filter-item"+(b?" ikr-filter-item-active":""),g.textContent=u[1],g.onclick=function(){k(),n(u[0],x)},m.appendChild(g)}),c.onclick=function(){m.classList.contains("ikr-open")?k():v()};var f=er({trigger:s,element:m,close:k});return s.appendChild(c),s.appendChild(m),l.appendChild(s),l}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var n=document.createElement("button");n.className="ikr-fwizard-close",n.type="button",n.setAttribute("aria-label","Kapat"),n.innerHTML="\u2715",a.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-content",a.appendChild(l);var o=!1,s="",c="";function p(){var u=window.innerWidth-document.documentElement.clientWidth;s=document.body.style.overflow,c=document.body.style.paddingRight,document.body.style.overflow="hidden",u>0&&(document.body.style.paddingRight=u+"px")}function m(){document.body.style.overflow=s,document.body.style.paddingRight=c}function d(){o||(o=!0,document.removeEventListener("keydown",k),t.removeEventListener("click",v),n.removeEventListener("click",d),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),m();try{r()}catch(u){}},200))}function k(u){u.key==="Escape"&&d()}function v(u){u.target===t&&i&&d()}document.addEventListener("keydown",k),t.addEventListener("click",v),n.addEventListener("click",d);function f(u){u&&l.appendChild(u),document.body.appendChild(t),p(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open")})}return{open:f,close:d,content:l,setAllowOutsideClose:function(u){i=!!u},setStepAttr:function(u){a.setAttribute("data-step",String(u))}}}var ai=`
  ...
  .ikr-fwizard{
    ...
    border:1px solid var(--ikr-fwizard-border, #dddddd);
    border-radius:12px;
