...
`;var It={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"90px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"120px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},Bt=wi;function _t(e,r){var i=!!(e.images&&Array.isArray(e.images)&&e.images.length&&e.images[0]&&(e.images[0].indexOf("https://")===0||e.images[0].indexOf("data:image/")===0)),t=document.createElement("div");t.className="ikr-review-gallery"+(i?"":" ikr-review-gallery--no-media");var a=document.createElement("div");a.className="ikr-review-gallery-content";var n=document.createElement("span");if(n.className="ikr-review-stars ikr-review-gallery-stars",n.innerHTML=ge(e.rating,N),a.appendChild(n),e.title){var d=document.createElement("div");d.className="ikr-review-gallery-title",d.textContent=e.title,a.appendChild(d)}var o=document.createElement("div");o.className="ikr-review-gallery-author",o.textContent=e.author||"",a.appendChild(o);var c=document.createElement("div");c.className="ikr-review-gallery-date",c.textContent=he(e.createdAt),a.appendChild(c);var p=(e.comment||"").trim();if(p){var m=document.createElement("div");m.className="ikr-review-gallery-body ikr-body-clamped",m.textContent=p,a.appendChild(m);var s=document.createElement("span");s.className="ikr-read-more",s.textContent="Devam\u0131n\u0131 oku",s.style.display="none",s.style.cursor="pointer",s.onclick=function(){var u=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;se(e,u,r)},a.appendChild(s),requestAnimationFrame(function(){m.scrollHeight>m.clientHeight+2&&(s.style.display="inline")})}if(t.appendChild(a),i){var l=e.images[0],k=document.createElement("div");k.className="ikr-review-gallery-media";var v=document.createElement("img");v.src=J(l),v.loading="lazy",v.setAttribute("data-ikr-img-url",l),v.onclick=function(){se(e,l,r)},k.appendChild(v),t.appendChild(k)}var f=Oe(e.merchantReply,function(){var u=e.images&&Array.isArray(e.images)&&e.images.length?e.images[0]:null;se(e,u,r)});return f&&(f.classList.add("ikr-review-gallery-reply"),t.appendChild(f)),t}var lr={card:Cr,list:Sr,gallery:Er};function dr(e){return lr[e]||lr.card}function zi(){return Object.keys(lr).map(function(e){return lr[e].css||""}).join(`
`)}function j(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var t=parseInt(i[1],16),a=parseInt(i[2],16),n=parseInt(i[3],16);return"rgba("+t+","+a+","+n+","+r+")"}var Ci={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:14,recommendSize:12,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:52},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:16,recommendSize:14,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:64},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:18,recommendSize:16,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:76}},Si={small:80,medium:110,large:140};function Rt(e,r){var i=r.bgColor||"#ffffff",t=r.textColor||"#111111",a=r.replyBgColor||"#f3f4f6",n=r.inputBgColor||"#ffffff",d=r.widgetBgColor||i,o=r.widgetBorderColor||"transparent",c=r.separatorColor||j(t,.08),p=r.headerTitleColor||t,m=r.headerAvgColor||t,s=r.headerCountColor||t,l=r.headerRecommendColor||t,k=r.barLabelColor||t,v=r.barFillColor||t,f=r.barTrackColor||j(t,.1),u=r.barCountColor||t,z=r.barHoverBgColor||j(t,.05),w=r.primaryColor||"#111111",b=r.primaryTextColor||"#ffffff",h=r.btnBgColor||w,C=r.btnTextColor||b,x=r.btnBorderColor||w,g=r.filterBtnBgColor||w,y=r.filterBtnTextColor||b,E=r.filterBtnBorderColor||w,T=r.filterMenuBgColor||i,S=r.filterMenuBorderColor||j(t,.12),R=r.filterItemTextColor||t,A=r.filterItemHoverBgColor||j(w,.07),I=r.filterItemActiveColor||w,D=r.reviewTitleColor||t,me=r.reviewAuthorColor||t,$=r.reviewDateColor||t,ue=r.reviewBodyColor||t,ae=r.reviewBorderColor||j(t,.08),K=r.reviewStarColor||"#f59e0b",W=r.replyBgColor||a,H=r.replyBorderColor||w,Se=r.replyLabelColor||t,ye=r.replyTextColor||t,Q=r.photoBgColor||j(t,.03),Ee=r.photoBorderColor||j(t,.1),Be=r.photoTitleColor||t,ee=r.formBgColor||i,fe=r.formBorderColor||j(t,.08),Y=r.inputBgColor||n,ve=r.inputTextColor||t,X=r.inputBorderColor||j(t,.2),Te=r.placeholderColor||j(t,.35),qe=r.loadMoreBgColor||i,_e=r.loadMoreTextColor||t,q=r.loadMoreBorderColor||j(t,.3),re=r.modalBgColor||i,ie=r.modalTextColor||t,ne=r.modalCloseBgColor||w,L=r.modalCloseTextColor||b,B=r.modalCloseBorderColor||w,M=r.modalNavBgColor||"rgba(0,0,0,0.45)",G=r.modalNavTextColor||"#ffffff",je=r.modalReplyBgColor||a,Gi=r.modalReplyBorderColor||w,_r={"--ikr-widget-bg":d,"--ikr-widget-border":o,"--ikr-separator":c,"--ikr-header-title":p,"--ikr-header-avg":m,"--ikr-header-count":s,"--ikr-header-recommend":l,"--ikr-bar-label":k,"--ikr-bar-fill":v,"--ikr-bar-track":f,"--ikr-bar-count":u,"--ikr-bar-hover-bg":z,"--ikr-btn-bg":h,"--ikr-btn-text":C,"--ikr-btn-border":x,"--ikr-filter-btn-bg":g,"--ikr-filter-btn-text":y,"--ikr-filter-btn-border":E,"--ikr-filter-menu-bg":T,"--ikr-filter-menu-border":S,"--ikr-filter-item-text":R,"--ikr-filter-item-hover-bg":A,"--ikr-filter-item-active":I,"--ikr-review-title":D,"--ikr-review-author":me,"--ikr-review-date":$,"--ikr-review-body":ue,"--ikr-review-border":ae,"--ikr-review-star-color":K,"--ikr-reply-bg-color":W,"--ikr-reply-border":H,"--ikr-reply-label":Se,"--ikr-reply-text":ye,"--ikr-photo-bg":Q,"--ikr-photo-border":Ee,"--ikr-photo-title":Be,"--ikr-form-bg":ee,"--ikr-form-border":fe,"--ikr-input-bg-color":Y,"--ikr-input-text-color":ve,"--ikr-input-border":X,"--ikr-placeholder":Te,"--ikr-load-more-bg":qe,"--ikr-load-more-text":_e,"--ikr-load-more-border":q,"--ikr-modal-bg":re,"--ikr-modal-text":ie,"--ikr-modal-close-bg":ne,"--ikr-modal-close-text":L,"--ikr-modal-close-border":B,"--ikr-modal-nav-bg":M,"--ikr-modal-nav-text":G,"--ikr-modal-reply-bg":je,"--ikr-modal-reply-border":Gi,"--ikr-bg":i,"--ikr-surface":i,"--ikr-text":t,"--ikr-text-faint":j(t,.45),"--ikr-border":j(t,.12),"--ikr-track-bg":j(t,.22),"--ikr-reply-bg":a,"--ikr-input-bg":n,"--ikr-input-text":t};Object.keys(_r).forEach(function(Rr){e.style.setProperty(Rr,_r[Rr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background=i)}async function xe(e,r,i,t,a,n,d){if(vr){$e({productId:e,settings:r,reviewsData:i,productName:t,orderBy:a,page:n,badgeSettings:d});return}Je(!0),Pr(e),Or(r),d!==void 0&&Hr(d),Fr(t),a&&Re(a),n&&Ne(n),i!=null&&qr(i);try{let ne=function(L,B){if(!(!L||!L.meta||!L.meta.sizeOverrides)){var M=L.meta.sizeOverrides[B];M&&Object.keys(M).forEach(function(G){l.style.setProperty(G,M[G])})}};var ie=ne,o=or(r.summaryLayout),c=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),p=r.showTitle!==!1,m=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",s=c&&p?m:"",l=document.documentElement;Rt(l,r);var k=r.primaryColor||"#111111",v=r.primaryTextColor||"#ffffff";Zr(k,ii+xi()+zi());var f=r.borderRadius!==void 0?r.borderRadius:8,u=Ci[r.size]||Ci.medium,z=Si[r.thumbnailSize]||Si.medium;l.style.setProperty("--ikr-title-size",u.titleSize+"px"),l.style.setProperty("--ikr-review-text-size",u.reviewTextSize+"px"),l.style.setProperty("--ikr-review-title-size",u.reviewTitleSize+"px"),l.style.setProperty("--ikr-author-size",u.authorSize+"px"),l.style.setProperty("--ikr-reply-name-size",u.replyNameSize+"px"),l.style.setProperty("--ikr-reply-text-size",u.replyTextSize+"px"),l.style.setProperty("--ikr-color-text",v),l.style.setProperty("--ikr-radius",f+"px"),l.style.setProperty("--ikr-radius-sm",Math.max(0,f-4)+"px"),l.style.setProperty("--ikr-photo-title-size",u.photoTitleSize+"px"),l.style.setProperty("--ikr-avg-rating-size",u.avgRatingSize+"px"),l.style.setProperty("--ikr-review-count-size",u.reviewCountSize+"px"),l.style.setProperty("--ikr-recommend-size",u.recommendSize+"px"),l.style.setProperty("--ikr-btn-text-size",u.btnTextSize+"px"),l.style.setProperty("--ikr-bar-label-size",u.barLabelSize+"px"),l.style.setProperty("--ikr-minimal-avg-size",u.minimalAvgSize+"px"),l.style.setProperty("--ikr-hero-avg-size",u.heroAvgSize+"px"),l.style.setProperty("--ikr-bar-count-size",u.barCountSize+"px"),l.style.setProperty("--ikr-review-date-size",u.reviewDateSize+"px"),l.style.setProperty("--ikr-filter-text-size",u.filterTextSize+"px"),l.style.setProperty("--ikr-load-more-size",u.loadMoreSize+"px"),l.style.setProperty("--ikr-read-more-size",u.readMoreSize+"px"),l.style.setProperty("--ikr-thumbnail-size",z+"px");var w=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";l.style.setProperty("--ikr-review-star-color",w),l.style.setProperty("--ikr-star-size",u.reviewStarSize+"px"),l.style.setProperty("--ikr-avg-star-size",u.avgStarSize+"px"),ne(or(r.summaryLayout),r.size),ne(dr(r.reviewLayout),r.size);var b=Ie(r),h=document.getElementById("ikas-reviews");if(!h){var C=document.getElementById("ikas-reviews-anchor");if(!C)return;h=document.createElement("div"),h.id="ikas-reviews",h.style.minHeight="200px",C.appendChild(h)}if(r.enabled===!1){h.style.minHeight="auto",h.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',Je(!1);var x=Ye;$e(null),x&&xe(x.productId,x.settings,x.reviewsData,x.productName,x.orderBy,x.page,x.badgeSettings);return}h.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var g=i||{},y=g.data&&g.data.reviews||[],E=g.data&&g.data.totalCount||0,T=h.cloneNode(!1);h.parentNode.replaceChild(T,h),h=T;var S=document.createElement("div");if(S.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),s){var R=document.createElement("div"),A=r.summaryLayout||"classic";R.className="ikr-title ikr-title-"+A,R.textContent=s,S.appendChild(R)}var I=g.data&&g.data.allCount||0,D=g.data&&g.data.ratingCounts||null,me=D||[0,0,0,0,0],$=g.data&&g.data.avgRating||"0.0";if(!D&&y.length>0){y.forEach(function(L){L.rating>=1&&L.rating<=5&&me[L.rating-1]++});var ue=y.reduce(function(L,B){return L+B.rating},0);$=(ue/y.length).toFixed(1)}if(I>0){var ae=or(r.summaryLayout),K=ae.render({widget:S,data:g,settings:r,iconPair:b,allCount:I,ratingCounts:me,avgRatingVal:$,currentRatingFilter:Le,currentOrderBy:oe,currentHasImages:Ae,onFilterChange:async function(L){Xe(Le===L?null:L),Ne(1);var B=await Ze(te,oe,1,Le,Ae);await xe(te,N,B,ze,oe,1)},onSortChange:async function(L,B){Ne(1),B?(fr(!0),Re("newest")):(fr(!1),Re(L));var M=await Ze(te,oe,1,Le,Ae);await xe(te,N,M,ze,oe,1)}});S.appendChild(K)}else{var W=document.createElement("button");W.className="ikr-write-btn",W.style.cssText="display:block;margin:16px auto 0;",W.textContent="Yorum Yap",W.onclick=function(){var L=document.getElementById("ikr-form-accordion");if(L){var B=L.style.maxHeight&&L.style.maxHeight!=="0px";B?(L.style.maxHeight="0px",L.style.opacity="0"):(L.style.maxHeight=L.scrollHeight+"px",L.style.opacity="1",setTimeout(function(){L.style.maxHeight="none"},360),setTimeout(function(){var M=document.querySelector("header"),G=M?M.getBoundingClientRect().height:0,je=L.getBoundingClientRect().top+window.pageYOffset-G-16;window.scrollTo({top:je,behavior:"smooth"})},50))}},S.appendChild(W)}var H=document.createElement("div");H.id="ikr-form-accordion",H.style.cssText="overflow:hidden;max-height:0px;opacity:0;transition:max-height 0.35s ease,opacity 0.25s ease;",H.appendChild($r(e,t)),S.appendChild(H);var Se=y.filter(function(L){return L.images&&Array.isArray(L.images)&&L.images.some(function(B){return B&&(B.indexOf("https://")===0||B.indexOf("data:image/")===0)})});if(r.showPhotoGallery!==!1&&!Ae&&Se.length>0){var ye=document.createElement("div");if(ye.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var Q=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",Ee=document.createElement("div");Ee.className="ikr-photo-title",Ee.textContent=Q,ye.appendChild(Ee)}var Be=r.reviewLayout==="card"?"1/1":"3/4";l.style.setProperty("--ikr-photo-thumb-aspect",Be);var ee=document.createElement("div");ee.className="ikr-photo-strip";var fe=0;Se.forEach(function(L){if(!(fe>=10)){var B=L.images.find(function(G){return G&&(G.indexOf("https://")===0||G.indexOf("data:image/")===0)});if(B){var M=document.createElement("img");M.src=J(B),M.className="ikr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",(function(G,je){M.onclick=function(){se(je,G,y)}})(B,L),ee.appendChild(M),fe++}}});var Y=document.createElement("button");Y.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",Y.innerHTML="&#8249;",Y.setAttribute("aria-label","\xD6nceki"),Y.onclick=function(){ee.scrollBy({left:-200,behavior:"smooth"})};var ve=document.createElement("button");ve.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",ve.innerHTML="&#8250;",ve.setAttribute("aria-label","Sonraki"),ve.onclick=function(){ee.scrollBy({left:200,behavior:"smooth"})};var X=document.createElement("div");X.className="ikr-photo-strip-wrap",X.appendChild(Y),X.appendChild(ee),X.appendChild(ve),ye.appendChild(X),S.appendChild(ye)}if(y.length===0){var Te=document.createElement("p");Te.className="ikr-state-msg",Te.textContent="Hen\xFCz yorum yok.",S.appendChild(Te)}else{var qe=dr(r.reviewLayout);y.forEach(function(L){S.appendChild(qe.render(L,y))})}var _e=g.data&&g.data.hasMore;if(_e){var q=document.createElement("button");q.className="ikr-load-more",q.textContent="Daha Fazla G\xF6ster",q.onclick=async function(){q.disabled=!0,q.textContent="Y\xFCkleniyor...";var L=De+1,B=await Ze(te,oe,L,Le,Ae);if(B&&B.data&&B.data.reviews){Ne(L);var M=dr(N.reviewLayout);B.data.reviews.forEach(function(G){S.insertBefore(M.render(G,B.data.reviews),q)}),B.data.hasMore?(q.disabled=!1,q.textContent="Daha Fazla G\xF6ster"):q.remove()}else q.remove()},S.appendChild(q)}h.appendChild(S),ri(I>0?$:null,E,t,mr)}catch(L){console.error("[ikr] render error:",L),h.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(Je(!1),Ye){var re=Ye;$e(null),xe(re.productId,re.settings,re.reviewsData,re.productName,re.orderBy,re.page,re.badgeSettings)}}}var Ce="ikr_settings_"+F,Mt=300*1e3,Pt=30*1e3;async function Lr(){if(window.__ikasPreviewMode){try{var e=window.__ikasPreviewBaseUrl||U,r=window.__ikasPreviewSettings||sessionStorage.getItem("ikr_preview_settings")||"",i={};if(r)try{i=JSON.parse(r)}catch(m){}var t=await V(e+"/api/preview/settings");if(t.ok){var a=await t.json();return a.widgets&&a.widgets.reviews&&Object.keys(i).length&&(a.widgets.reviews=Object.assign({},a.widgets.reviews,i)),a}}catch(m){}return null}var n=null,d=Ve(Ce);if(d)try{var o=JSON.parse(d);if(o&&o.t!==void 0)if(o.notFound){if(Date.now()-o.t<Pt)return null;P(Ce,"")}else if(o.v){if(Date.now()-o.t<Mt)return o.v;n=o.v,P(Ce,"")}else P(Ce,"");else P(Ce,"")}catch(m){P(Ce,"")}try{var c=await V(U+"/api/public/settings?publicApiKey="+encodeURIComponent(F));if(!c.ok)return c.status===404&&P(Ce,JSON.stringify({t:Date.now(),notFound:!0})),n||null;var p=await c.json();return P(Ce,JSON.stringify({t:Date.now(),v:p})),p}catch(m){return console.error("[ikr] fetchSettings error:",m),n||null}}var Ot=60*1e3;async function Ze(e,r,i,t,a){if(window.__ikasPreviewMode){try{var n=window.__ikasPreviewBaseUrl||U,d=n+"/api/preview/reviews?page="+encodeURIComponent(i||1),o=await V(d);if(o.ok)return await o.json()}catch(f){}return null}r=r||"newest",i=i||1;var c="ikr_reviews_"+F+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(a?"1":"0"),p=null,m=Ve(c);if(m)try{var s=JSON.parse(m);if(s&&s.t!==void 0&&s.v){if(Date.now()-s.t<Ot)return s.v;p=s.v,P(c,"")}else P(c,"")}catch(f){P(c,"")}try{var l=U+"/api/public/reviews?storeId="+encodeURIComponent(F)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(a?"&hasImages=true":""),k=await V(l);if(!k.ok)return p||null;var v=await k.json();return P(c,JSON.stringify({t:Date.now(),v})),v}catch(f){return console.error("[ikr] fetchReviews error:",f),p||null}}var Tr={};async function He(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!Tr[e]){Tr[e]=!0;var a={primaryColor:"#111111",title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},n={enabled:!0,icon:"star",size:"medium",color:"#f59e0b"};try{var d=await Lr();if(!d)return;var o=d.widgets&&d.widgets.reviews||a,c=d.widgets&&d.widgets.badge||n;if(o.enabled===!1)return;Re("newest"),Ne(1),Xe(null);var p=await Ze(e,"newest",1,null);await xe(e,o,p,r,"newest",1,c)}catch(m){console.error("[ikr] bootstrap error:",m),await xe(e,a,null,r,void 0,void 0,n)}finally{delete Tr[e]}}}function Ar(){try{var e=window.__NEXT_DATA__&&window.__NEXT_DATA__.props&&window.__NEXT_DATA__.props.pageProps;if(e&&e.pageType==="PRODUCT"&&e.pageSpecificData&&e.pageSpecificData.id)return{id:e.pageSpecificData.id,name:e.pageSpecificData.name||null}}catch(t){}if(window.IkasStorefront&&window.IkasStorefront.product&&window.IkasStorefront.product.id)return{id:window.IkasStorefront.product.id,name:window.IkasStorefront.product.name||null};var r=window.location.pathname.match(/--([a-f0-9-]{36})(?:\/|$|\?)/);if(r)return{id:r[1],name:null};var i=new URLSearchParams(window.location.search).get("productId");return i?{id:i,name:null}:null}function Ei(){var e={},r={};return document.querySelectorAll("a[href]").forEach(function(i){try{var t=i.getAttribute("href");if(!t||t.charAt(0)==="#"||t.charAt(0)==="?")return;var a=O(i.href);if(!a||r[a]||!/^[a-z0-9][a-z0-9-]{2,}$/.test(a)||ir.test(a))return;r[a]=!0,e[a]=null}catch(n){}}),Object.keys(Ge).forEach(function(i){e[i]=Ge[i]}),e}var Ht=300*1e3,Ti=50;async function Li(e){var r="ikr_ratings_"+F,i={},t=Ve(r);if(t)try{var a=JSON.parse(t);a&&a.t!==void 0&&Date.now()-a.t<Ht?i=a.v||{}:P(r,"")}catch(p){P(r,"")}var n=e.filter(function(p){return!i[p]});if(!n.length)return i;for(var d=[],o=0;o<n.length;o+=Ti)d.push(n.slice(o,o+Ti));var c=await Promise.all(d.map(function(p){var m=U+"/api/public/ratings-by-slug?storeId="+encodeURIComponent(F)+"&slugs="+p.map(encodeURIComponent).join(",");return V(m).then(function(s){return s.ok?s.json().then(function(l){return l.data||{}}):{}}).catch(function(){return{}})}));return c.forEach(function(p){n.forEach(function(m){i[m]||(i[m]={average:0,count:0,_empty:!0})}),Object.keys(p).forEach(function(m){i[m]=p[m]})}),P(r,JSON.stringify({t:Date.now(),v:i})),i}var Ft="var(--ikr-badge-color,#f59e0b)",Ai=13,qt="display:flex;align-items:center;gap:3px;margin-top:0px;margin-bottom:4px;font-size:13px;font-weight:400;color:#555;pointer-events:none;";function jt(e){var r=Ke("star","classic"),i="width:"+Ai+"px;height:"+Ai+"px;";return'<span style="color:'+Ft+';display:inline-flex;align-items:center;">'+de(e,r,{sizeStyle:i})+"</span>"}function We(e,r){var i=document.createElement("div");return i.setAttribute("data-ikr-listing-badge","1"),i.style.cssText=qt+"justify-content:"+(r||"flex-start")+";",i.innerHTML=jt(e.avg)+'<span style="font-weight:400;">'+e.avg+" ("+e.count+")</span>",i}var Ni=".product-name",Ii=".add-to-basket-modal",Bi="h1.product-name",sr=".single-product-container-main",Nr=".single-product-product-name",_i=[".hero-image-banner-main",".hero-image-main",".home-slider-main",'[class*="hero-"]','[class*="banner-"]','[class*="slider-banner"]','[class*="marquee"]'].join(","),Ri=[".category-products-main",".products-slider-main",".infinite-scroll-component",'[class*="product-list"]',".single-product-container-main",".product-block-container"].join(",");var Mi='[class*="productTitle"],[class*="productName"],[class*="product_title"],[class*="product_name"],[class*="product-title"],[class*="product-name"]',Dt=/^(tükendi|sold out|out of stock|stokta yok|satıldı|unavailable)$/i;function Ir(e,r){var i=e.querySelector(Ni);if(i)return i;if(e.matches&&e.matches(Mi))return e;var t=e.querySelector(Mi);if(t)return t;if(r){for(var a=e.querySelectorAll("*"),n=0;n<a.length;n++)if(a[n].children.length===0&&a[n].textContent.trim()===r)return a[n]}for(var d=e.querySelectorAll("p, h1, h2, h3, h4, h5, h6, span, div"),o=0;o<d.length;o++){var c=d[o],p=c.textContent.trim();if(!(!p||p.length<2||p.length>150)&&!/^[\d\s.,₺$€£%]+$/.test(p)&&!Dt.test(p)&&!(c.closest("figure")||c.closest("picture"))&&!(c.children.length>1))return c}return null}function Yt(e,r,i,t){if(!e.getAttribute("data-ikr-badge")){var a=O(e.href);if(e.id==="ikr-rating-badge"){e.setAttribute("data-ikr-badge","1");return}if(a===t&&e.getAttribute("href")&&e.getAttribute("href").charAt(0)==="#"){e.setAttribute("data-ikr-badge","1");return}if(e.closest("header")||e.closest("nav")){e.setAttribute("data-ikr-badge","1");return}if(e.closest('[class*="basket"]')||e.closest('[class*="cart"]')){e.setAttribute("data-ikr-badge","1");return}if(e.closest(sr)&&!e.closest(Nr)){e.setAttribute("data-ikr-badge","1");return}if(a===t&&e.closest(Nr)){e.setAttribute("data-ikr-badge","1");return}if(e.closest(_i)){e.setAttribute("data-ikr-badge","1");return}var n=!!e.querySelector("a[href]"),d=Array.from(e.childNodes).filter(function(v){return v.nodeType===3}).map(function(v){return v.textContent.trim()}).join("").trim(),o=!!Ir(e,i);if(!d&&!o&&!n){e.setAttribute("data-ikr-badge","1");return}if(e.setAttribute("data-ikr-badge","1"),n){e.querySelectorAll("a[href]").forEach(function(v){v.setAttribute("data-ikr-badge","1")});var c=Ir(e,i);if(!c||c.querySelector("[data-ikr-listing-badge]"))return;var p=window.getComputedStyle(c).textAlign;c.appendChild(We(r,p==="center"?"center":p==="right"?"flex-end":"flex-start"));return}var m=Ir(e,i);if(!(m&&m.querySelector("[data-ikr-listing-badge]")))if(m){var s=window.getComputedStyle(m).textAlign;m.appendChild(We(r,s==="center"?"center":s==="right"?"flex-end":"flex-start"))}else{var l=We(r,"flex-start"),k=e.firstElementChild;k?e.insertBefore(l,k):e.appendChild(l)}}}function Gt(e,r){var i=document.querySelector(Ii);if(i){var t=i.querySelector(Bi);if(!(!t||t.querySelector("[data-ikr-listing-badge]"))){var a=null;if(Ue&&r[Ue]&&(a=Ue),!a){var n=O(window.location.pathname);n&&r[n]&&(a=n)}if(!a){var d=t.textContent.trim();Object.keys(e).forEach(function(s){if(!a){var l=e[s];l&&l.trim()===d&&r[s]&&(a=s)}})}if(!a){var o=document.querySelector(sr);if(o){var c=o.querySelector("a[href]");if(c){var p=O(c.href);p&&r[p]&&(a=p)}}}if(!a){var m=t.textContent.trim().toLowerCase();document.querySelectorAll("a[href]").forEach(function(s){if(!a&&!(s.closest("header")||s.closest("nav"))&&!s.closest(sr)){var l=s.textContent.trim().toLowerCase();if(l&&l===m){var k=O(s.href);k&&r[k]&&(a=k)}}})}!a||!r[a]||r[a]._empty||r[a].count===0||t.appendChild(We(r[a],"flex-start"))}}}function Pi(e,r){var i=O(window.location.pathname),t=document.querySelectorAll(Ri),a=[];t.forEach(function(n){n.tagName==="A"&&n.href?a.push(n):n.querySelectorAll("a[href]").forEach(function(d){a.push(d)})}),Object.keys(e).forEach(function(n){var d=r[n];if(!(!d||d._empty||d.count===0)){var o=e[n];a.forEach(function(c){O(c.href)===n&&Yt(c,d,o,i)})}}),Gt(e,r)}async function Fe(){if(_.inProgress){_.queued=!0;return}if(!_.rendered){_.rendered=!0,_.inProgress=!0;try{var e=_.navCleanup;e&&(_.navCleanup=!1);var r=Ei();if(!Object.keys(r).length){_.rendered=!1;return}var i=await Promise.all([Lr(),Li(Object.keys(r))]),t=i[0];if(!t){_.rendered=!1;return}var a=i[1],n=t&&t.widgets||{},d=n.badge&&n.badge.color||"#f59e0b";if(n.badge&&n.badge.enabled===!1){_.rendered=!1;return}document.documentElement.style.setProperty("--ikr-badge-color",d),e&&(document.querySelectorAll("[data-ikr-listing-badge]").forEach(function(o){o.remove()}),document.querySelectorAll("[data-ikr-badge]").forEach(function(o){o.removeAttribute("data-ikr-badge")})),Pi(r,a)}finally{_.inProgress=!1,_.queued&&(_.queued=!1,_.rendered=!1,Fe())}}}var Oi=!1,Hi=!1;function ji(){Hi||(Hi=!0,document.addEventListener("click",function(e){var r=e.target.closest("a[href]");if(r&&!(r.closest("header")||r.closest("nav"))&&!(r.closest('[class*="basket"]')||r.closest('[class*="cart"]'))){var i=O(r.href);!i||i.length<3||jr(i)}},!0))}var Fi=!1,qi=typeof location!="undefined"?location.pathname:"";function cr(){try{if(location.pathname===qi)return;qi=location.pathname;var e=document.getElementById("ikr-rating-badge");e&&e.remove();var r=document.getElementById("ikr-jsonld");r&&r.remove()}catch(i){}}function Ut(){if(!Fi){Fi=!0;var e=history.pushState,r=history.replaceState;history.pushState=function(){var i=e.apply(this,arguments);return cr(),i},history.replaceState=function(){var i=r.apply(this,arguments);return cr(),i},window.addEventListener("popstate",cr),window.addEventListener("hashchange",cr)}}function Br(){if(Ut(),window.IkasEvents){if(Oi)return;Oi=!0,window.IkasEvents.subscribe({id:"ikas-reviews-widget",callback:function(n){if(n&&n.type==="VIEW_LISTING"){var d=n.data&&n.data.productDetails;Array.isArray(d)&&d.forEach(function(m){m&&m.metaData&&m.metaData.slug&&m.name&&(Ge[m.metaData.slug]=m.name)})}if(n&&n.type==="PRODUCT_VIEW"){var o=n.data&&n.data.productDetail&&n.data.productDetail.id,c=n.data&&n.data.productDetail&&n.data.productDetail.name;o&&(P("ikr_reviews_"+F+"_"+o,""),He(o,c))}if(n&&n.type==="PAGE_VIEW"){var p=Date.now();if(_.lastPageView&&p-_.lastPageView<800)return;_.lastPageView=p,_.navCleanup=!0,_.rendered=!1,Fe()}}});var e=Ar();if(e)He(e.id,e.name);else{let n=function(){var d=Ar();d?He(d.id,d.name):r<20&&(r++,setTimeout(n,100))};var t=n,r=0;setTimeout(n,100)}setTimeout(function(){_.rendered||Fe()},2e3)}else{let n=function(){window.IkasEvents?Br():i<100&&(i++,setTimeout(n,50))};var a=n,i=0;setTimeout(n,50)}}var Di=null;function Yi(){if(typeof MutationObserver!="undefined"){var e=new MutationObserver(function(r){var i=r.some(function(t){return Array.from(t.addedNodes).some(function(a){return!(a.nodeType!==1||a.hasAttribute&&(a.hasAttribute("data-ikr-listing-badge")||a.id==="ikr-rating-badge"||a.id==="ikr-reviews-widget")||a.closest&&(a.closest("[data-ikr-listing-badge]")||a.closest("#ikr-rating-badge")||a.closest("#ikr-reviews-widget"))||a.querySelector&&a.querySelector("[data-ikr-listing-badge],#ikr-reviews-widget,#ikr-rating-badge"))})});i&&(clearTimeout(Di),Di=setTimeout(function(){var t=Array.from(document.querySelectorAll("a[href]")).some(function(a){if(a.getAttribute("data-ikr-badge"))return!1;var n=O(a.href);return n&&n.length>=3&&!ir.test(n)});t&&(_.rendered=!1,Fe())},300))});e.observe(document.body,{childList:!0,subtree:!0})}}var Vt=window.__ikasPreviewMode===!0;if(Vt){let e=function(){try{window.parent.postMessage({type:"IKR_WIDGET_READY"},"*")}catch(i){}},r=function(){He("mock-product","\xD6rnek \xDCr\xFCn"),e()};Kt=e,Zt=r,window.addEventListener("message",function(i){var t=i.data;if(!(!t||t.type!=="IKR_SETTINGS_UPDATE")){var a=t.settings;if(!(!a||!N)){var n=Object.assign({},N,a);xe(te,n,ur,ze,oe,De)}}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()}else if(F){let e=function(){Br(),ji(),Yi()};Wt=e,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}var Kt,Zt,Wt;})();
