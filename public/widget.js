...
`;var or={};ke(or,{meta:()=>Rt,render:()=>It});function be(e){var r=e.ratingCounts,t=e.allCount,i=e.iconPair,a=e.currentRatingFilter,n=e.onFilterChange,d=document.createElement("div");d.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var s=r[l-1]||0,c=t>0?Math.round(s/t*100):0,o=a===l,p=document.createElement("div");p.className="ikr-bar-row"+(o?" ikr-bar-active":""),a&&!o&&(p.style.opacity="0.35");for(var m="",f=1;f<=5;f++){var u=f<=l;m+='<span class="ikr-bar-star ikr-icon '+(u?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(u?i.filled:i.empty)+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+m+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+c+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(k){p.onclick=function(){n(k)}})(l),d.appendChild(p)}return d}var J=[],Fr=!1;function _t(e){for(var r=J.length-1;r>=0;r--){var t=J[r];t.trigger&&t.trigger.contains(e.target)||t.element&&t.element.contains(e.target)||t.close()}}function Nt(e){if(e.key==="Escape")for(var r=J.length-1;r>=0;r--)J[r].close()}function Bt(){Fr||typeof document=="undefined"||(document.addEventListener("click",_t,!0),document.addEventListener("keydown",Nt),Fr=!0)}function Ve(e){for(var r=0;r<J.length;r++)J[r]!==e&&J[r].close()}function Ke(e){Bt();var r={trigger:e.trigger,element:e.element,close:e.close};return J.push(r),function(){var i=J.indexOf(r);i!==-1&&J.splice(i,1)}}function X(e){var r=e.widget,t=e.currentOrderBy,i=e.currentHasImages,a=e.onWriteClick,n=e.onSortChange,d=document.createElement("div");d.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent="Yorum Yap",l.onclick=a,d.appendChild(l);var s=document.createElement("div");s.className="ikr-filter-wrap";var c=document.createElement("button");c.className="ikr-filter-btn",c.setAttribute("aria-label","Filtrele"),c.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="4" y1="6" x2="20" y2="6"/><line x1="7" y1="12" x2="17" y2="12"/><line x1="10" y1="18" x2="14" y2="18"/></svg>';var o=document.createElement("div");o.className="ikr-filter-menu";var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function m(){o.classList.remove("ikr-open"),c.classList.remove("ikr-filter-btn-active")}function f(){Ve(u),o.classList.add("ikr-open"),c.classList.add("ikr-filter-btn-active")}p.forEach(function(k){var g=k[2],h=g?i:!i&&(t||"newest")===k[0],v=document.createElement("div");v.className="ikr-filter-item"+(h?" ikr-filter-item-active":""),v.textContent=k[1],v.onclick=function(){m(),n(k[0],g)},o.appendChild(v)}),c.onclick=function(){o.classList.contains("ikr-open")?m():f()};var u=Ke({trigger:s,element:o,close:m});return s.appendChild(c),s.appendChild(o),d.appendChild(s),d}function q(){var e=document.getElementById("ikr-form-accordion");if(e){var r=e.style.maxHeight&&e.style.maxHeight!=="0px";r?(e.style.maxHeight="0px",e.style.opacity="0"):(e.style.maxHeight=e.scrollHeight+"px",e.style.opacity="1",setTimeout(function(){e.style.maxHeight="none"},360),setTimeout(function(){var t=document.querySelector("header"),i=t?t.getBoundingClientRect().height:0,a=e.getBoundingClientRect().top+window.pageYOffset-i-16;window.scrollTo({top:a,behavior:"smooth"})},50))}}var Rt={id:"classic",name:"Klasik (A\xE7\u0131k)"};function It(e){var r=e.widget,t=e.data,i=e.settings,a=e.iconPair,n=e.allCount,d=e.ratingCounts,l=e.avgRatingVal,s=e.currentRatingFilter,c=e.currentOrderBy,o=e.currentHasImages,p=e.onFilterChange,m=e.onSortChange,f=document.createElement("div");f.className="ikr-summary";var u=(d[3]||0)+(d[4]||0),k=n>0?Math.round(u/n*100):0,g=document.createElement("div");g.className="ikr-summary-block ikr-summary-avg",g.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+l+"</span>",f.appendChild(g);var h=document.createElement("div");if(h.className="ikr-summary-block ikr-summary-count",h.textContent=n.toLocaleString("tr-TR")+" Yorum",f.appendChild(h),i.showRecommendation!==!1&&k>0){var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-recommend",v.innerHTML='<span class="ikr-recommend-pct">%'+k+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",f.appendChild(v)}return f.appendChild(be({ratingCounts:d,allCount:n,iconPair:a,currentRatingFilter:s,onFilterChange:p})),f.appendChild(X({widget:r,currentOrderBy:c,currentHasImages:o,onWriteClick:q,onSortChange:m})),f}var lr={};ke(lr,{css:()=>Ot,meta:()=>Pt,render:()=>Mt});var Yr=`
