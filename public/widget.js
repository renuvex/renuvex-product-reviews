/* ikas Reviews Widget — built 2026-04-06T14:47:31.725Z | theme: default */
"use strict";
(() => {
  ...
  .ikr-modal{background:#fff;border-radius:16px;overflow:hidden;display:flex;width:100%;max-width:860px;height:90vh;box-shadow:0 16px 48px rgba(0,0,0,0.25);}
