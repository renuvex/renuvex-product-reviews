...
`;var mt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ut=fi;function ft(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,n=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,c=e.currentOrderBy,s=e.currentHasImages,u=e.onFilterChange,m=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-compact";var v=document.createElement("div");v.className="ikr-compact-header";var k=document.createElement("div");k.className="ikr-compact-trigger-wrap";var f=document.createElement("button");f.className="ikr-compact-trigger",f.type="button",f.setAttribute("aria-expanded","false"),f.innerHTML='<span class="ikr-compact-trigger-stars">'+re(o,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',k.appendChild(f),v.appendChild(k);var p=ae({widget:r,currentOrderBy:c,currentHasImages:s,onWriteClick:K,onSortChange:m}),y=p.querySelector(".ikr-filter-wrap"),g=p.querySelector(".ikr-write-btn"),h=document.createElement("div");h.className="ikr-compact-actions-slot",g&&h.appendChild(g),y&&h.appendChild(y),v.appendChild(h),d.appendChild(v);var b=document.createElement("div");b.className="ikr-compact-panel",b.setAttribute("role","dialog"),b.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="ikr-compact-panel-inner";var z=document.createElement("div");z.className="ikr-compact-avg",z.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+o+"</span>",E.appendChild(z),E.appendChild(Ee({ratingCounts:n,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:u})),b.appendChild(E);var x=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(G){var V=G?d:k;b.parentNode!==V&&(b.classList.contains("ikr-open")&&(b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")),V.appendChild(b))}if(w(x?x.matches:!1),x){var L=function(G){w(G.matches)};x.addEventListener?x.addEventListener("change",L):x.addListener&&x.addListener(L)}if(g){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent="Yorum Yap",T.onclick=K;var C=document.createElement("div");C.className="ikr-compact-write-row",C.appendChild(T),d.appendChild(C)}function I(){b.classList.remove("ikr-open"),b.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false")}function P(){Je(_),b.classList.add("ikr-open"),b.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true")}f.onclick=function(){b.classList.contains("ikr-open")?I():P()};var _=null;function H(G){_&&(_(),_=null),G||(_=$e({trigger:k,element:b,close:I}))}if(H(x?x.matches:!1),x){var ne=function(G){H(G.matches)};x.addEventListener?x.addEventListener("change",ne):x.addListener&&x.addListener(ne)}if(i.showRecommendation!==!1){var $=(n[3]||0)+(n[4]||0),W=a>0?Math.round($/a*100):0;if(W>0){var X=document.createElement("div");X.className="ikr-summary-block ikr-summary-recommend",X.style.marginTop="8px",X.innerHTML='<span class="ikr-recommend-pct">%'+W+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(X)}}return d}var br={};me(br,{css:()=>vt,meta:()=>kt,render:()=>gt});var ki=`
