...
`;var _a=`
  ...
  .renuvex-pr-modal-main-video{border:0;--media-object-fit:contain;--media-object-position:center;--seek-backward-button:none;--seek-forward-button:none;--airplay-button:none;--pip-button:none;--cast-button:none;--fullscreen-button:none;--playback-rate-button:none;--rendition-menu-button:none;--audio-track-menu-button:none;--controls-backdrop-color:rgba(0,0,0,0.58);--media-primary-color:var(--renuvex-pr-review-lightbox-video-icon,#ffffff);--media-secondary-color:var(--renuvex-pr-review-lightbox-video-button-bg,#000000);}
...
`}var $o=Na(Qn),ei=Na(sr);function ri(e,r){var l;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let n=t.get("media-theme-gerwig"),a=n==null?void 0:n.template;if(!n||!(a instanceof HTMLTemplateElement))return;let i=a.cloneNode(!0);i.id=e,(l=i.content.querySelector("media-controller"))==null||l.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class p extends n{}p.template=i,t.define(e,p)}function ti(e,r){return typeof window=="undefined"?Promise.resolve():(Xr!=null||(Xr=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),Xr.then(()=>{ri(e,r)}))}function Ba(){return ti(Zn,ei)}var yt=null;function ai(){return yt||(yt=Ba()),yt}function ni(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=Ur(e.url);return r&&t&&r!==t?"":r||t}function ii(e,r){var t=ni(r);if(!t)return!1;var n=Ge(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("playsinline",""),e.setAttribute("hotkeys","noarrowleft noarrowright"),e.setAttribute("lang","tr"),e.setAttribute("theme",Ra),e.setAttribute("accent-color",sr.controlForeground),e.setAttribute("primary-color",sr.controlForeground),e.setAttribute("secondary-color",sr.controlBackground),n&&e.setAttribute("poster",n),e.setAttribute("playback-id",t),!0}function Ia(e){e.preventDefault()}function Oa(e,r){var t=!1,n=document.createElement("mux-player");n.className=r||"renuvex-pr-modal-main-video",n.setAttribute("aria-label","Yorum videosu"),n.addEventListener("contextmenu",Ia);var a=ii(n,e);return a?ai().catch(function(){t||n.dispatchEvent(new Event("error"))}):setTimeout(function(){t||n.dispatchEvent(new Event("error"))},0),{element:n,cleanup:function(){t=!0;try{typeof n.pause=="function"&&n.pause()}catch(o){}n.removeAttribute("playback-id"),n.removeAttribute("playback-token"),n.removeAttribute("thumbnail-token"),n.removeAttribute("poster"),n.removeEventListener("contextmenu",Ia)}}}function Ze(e){return Ce(e)}function kt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Ua(e,r,t,n,a,i){e&&e.shadowRoot&&kt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),jr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Pr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(a)}function oi(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ke(e.rating,N);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Se(e.createdAt),n.appendChild(a),n.appendChild(i),t.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-modal-author",p.textContent=e.author||"",t.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-modal-body",l.textContent=(e.comment||"").trim(),l.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=H(N&&N.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",d.appendChild(m),d.appendChild(v),d.style.display=e.merchantReply?"":"none",t.appendChild(d),r.appendChild(t),r}function Fa(e,r,t){var n=t||N,a=e.querySelector(".renuvex-pr-modal-scroll-content"),i=a.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ke(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=Se(r.createdAt);var o=a.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var p=a.querySelector(".renuvex-pr-modal-body");p.textContent=(r.comment||"").trim(),p.style.display=r.comment&&r.comment.trim()?"":"none";var l=a.querySelector(".renuvex-pr-modal-reply");l.querySelector(".renuvex-pr-modal-reply-label").textContent=H(n&&n.merchantReplyLabel,"Ma\u011Faza Sahibi"),l.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",l.style.display=r.merchantReply?"":"none",e.scrollTop=0}function St(e,r,t,n,a,i,o,p,l){var d=Ze(e),m=Math.max(0,Math.min(t||0,d.length-1)),v=d[m],u=document.createElement("div");u.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Oa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),f=x.element;f.addEventListener("error",function(){if(!u.querySelector(".renuvex-pr-modal-img-error")){var M=document.createElement("div");M.className="renuvex-pr-modal-img-error",M.setAttribute("role","status"),M.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",u.insertBefore(M,f)}}),u.__renuvexMediaCleanup=x.cleanup,u.appendChild(f)}else{var c=document.createElement("img");if(c.className="renuvex-pr-modal-main-img"+(s?" "+s:""),c.src=ft(v?v.url:""),c.decoding="async",c.width=mt,c.height=Math.round(mt*4/3),c.alt="Yorum foto\u011Fraf\u0131",!s){c.classList.add("renuvex-pr-modal-img-loading");var h=function(){c.classList.remove("renuvex-pr-modal-img-loading")};c.complete&&c.naturalWidth>0?h():(c.addEventListener("load",h,{once:!0}),c.addEventListener("error",h,{once:!0}))}ma(c,function(M){if(M.style.display="none",!u.querySelector(".renuvex-pr-modal-img-error")){var P=document.createElement("div");P.className="renuvex-pr-modal-img-error",P.setAttribute("role","status"),P.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",u.insertBefore(P,M)}}),u.appendChild(c)}var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var w=ee(we);w&&b.appendChild(w),b.setAttribute("aria-label","Kapat"),b.onclick=function(M){M.stopPropagation(),i()},u.appendChild(b);var E=0;if(u.addEventListener("touchstart",function(M){E=M.touches[0].clientX},{passive:!0}),u.addEventListener("touchend",function(M){var P=E-M.changedTouches[0].clientX;if(!(Math.abs(P)<50)){if(P>0){if(g)Ee(e,r,m+1,n,a,i,!0,"next",p,l);else if(C){var B=n[r+1];Ee(B,r+1,0,n,a,i,!1,"next",p,l)}}else if(S)Ee(e,r,m-1,n,a,i,!0,"prev",p,l);else if(k){var R=n[r-1],j=Ze(R);Ee(R,r-1,j.length-1,n,a,i,!1,"prev",p,l)}}},{passive:!0}),d.length>1){var T=document.createElement("div");T.className="renuvex-pr-modal-thumbs",d.forEach(function(M,P){var B=M.type==="video"?M.posterUrl:M.url,R=document.createElement("img"),j=Ir(B,Br);R.src=j.src,R.srcset=j.srcset,R.loading="lazy",R.decoding="async",R.width=Br,R.height=Br,R.className="renuvex-pr-modal-thumb"+(P===m?" renuvex-pr-modal-thumb-active":""),R.alt="K\xFC\xE7\xFCk resim "+(P+1),Or(R),R.tabIndex=0,R.setAttribute("role","button"),R.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(P+1)+" se\xE7"),P===m&&R.setAttribute("aria-current","true"),(function(J){function Y(){Ee(e,r,J,n,a,i,!0,null,p,l)}R.onclick=Y,R.onkeydown=function(F){(F.key==="Enter"||F.key===" ")&&(F.preventDefault(),Y())}})(P),T.appendChild(R)}),u.appendChild(T)}var S=m>0,g=m<d.length-1,k=r>0,C=r<n.length-1,z=S||k,A=g||C;if(z){var L=document.createElement("button");L.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var I=ee(qe);I&&L.appendChild(I),L.setAttribute("aria-label","\xD6nceki"),L.onclick=function(M){if(M.stopPropagation(),S)Ee(e,r,m-1,n,a,i,!0,"prev",p,l);else if(k){var P=n[r-1],B=Ze(P);Ee(P,r-1,B.length-1,n,a,i,!1,"prev",p,l)}},u.appendChild(L)}if(A){var _=document.createElement("button");_.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var y=ee(_r);y&&_.appendChild(y),_.setAttribute("aria-label","Sonraki"),_.onclick=function(M){if(M.stopPropagation(),g)Ee(e,r,m+1,n,a,i,!0,"next",p,l);else if(C){var P=n[r+1];Ee(P,r+1,0,n,a,i,!1,"next",p,l)}},u.appendChild(_)}return u}function Ha(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Ze(n);a[0]&&a[0].type==="image"&&(new Image().src=ft(a[0].url))}})}function wt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function li(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){wt(t),wt(n),wt(a)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Ee(e,r,t,n,a,i,o,p,l,d){if(d&&(d.currentReview=e),o){var m=St(e,r,t,n,a,i,p,l,d);a.firstChild&&(kt(a.firstChild),a.replaceChild(m,a.firstChild))}else{var m=St(e,r,t,n,a,i,p,l,d),v=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&(kt(a.firstChild),a.replaceChild(m,a.firstChild)),v&&Fa(v,e,d&&d.currentSettings),li(l,a)}Ha(r,n)}function ge(e,r,t){var n=Ze(e);if(!n.length)return;var a=(t||[]).filter(function(k){return Ze(k).length>0}),i=a.findIndex(function(k){return k===e||k.id===e.id});i===-1&&(a.unshift(e),i=0);var o=n.findIndex(function(k){return k.url===r});o<0&&(o=0);var p=document.createElement("div");p.className="renuvex-pr-modal-overlay";var l=document.createElement("div");l.className="renuvex-pr-modal";var d=!1,m=null,v=Wr(),u=Pe(),s=Yr(),x=Gr(),f={currentReview:e,currentSettings:N},c=null;function h(k){var C=k&&k.detail&&k.detail.settings;if(!(C&&C===c)){c=C||null,f.currentSettings=C||N;var z=l.querySelector(".renuvex-pr-modal-right");!z||!f.currentReview||Fa(z,f.currentReview,f.currentSettings)}}function b(){d||(d=!0,window.removeEventListener(Ue,h),Ua(m&&m.host,w,b,s,v,u))}function w(k){if(k.key==="Escape"){E();return}qr(k,p,m&&m.root)}function E(){d||(d=!0,window.removeEventListener(Ue,h),Ua(m&&m.host,w,b,s,v,u),Kr(x))}document.addEventListener("keydown",w),window.addEventListener("popstate",b),window.addEventListener(Ue,h),p.onclick=function(){E()},l.onclick=function(k){k.stopPropagation()},l.appendChild(St(e,i,o,a,l,E,null,p,f)),l.appendChild(oi(e)),Ha(i,a);var T=document.createElement("div");T.className="renuvex-pr-modal-wrap",T.tabIndex=-1,T.setAttribute("role","dialog"),T.setAttribute("aria-modal","true"),T.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),T.appendChild(l);var S=document.createElement("button");S.className="renuvex-pr-modal-close";var g=ee(we);g&&S.appendChild(g),S.setAttribute("aria-label","Kapat"),S.onclick=function(k){k.stopPropagation(),E()},T.appendChild(S),p.appendChild(T),m=Vr(),Xe(m.root,Ke+We+Dr),m.root.appendChild(p),Oe(m.root),ve(T)}function vr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(n){(n.key==="Enter"||n.key===" "||n.key==="Spacebar")&&(n.preventDefault(),r())})}var Mt={};Ae(Mt,{css:()=>qi,meta:()=>Wi,render:()=>Gi});function Qe(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,i=e.onFilterChange;Me(n);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var p=5;p>=1;p--){var l=r[p-1]||0,d=t>0?Math.round(l/t*100):0,m=a===p,v=l>0,u=H(N&&N.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(a&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",p+" y\u0131ld\u0131z, "+l.toLocaleString("tr-TR")+" "+u+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",p+" y\u0131ld\u0131z, 0 "+u);for(var x="",f=1;f<=5;f++){var c=f<=p;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(c?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(c?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+d+'%;"></div></div><span class="renuvex-pr-bar-count">('+l.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Space"||w.key==="Spacebar")&&(w.preventDefault(),b())}})(p),o.appendChild(s)}return o}var Ya="data-renuvex-pr-dismiss-gesture",Ve=[],Va=!1,$r=!1,cr=[],er=null;function Da(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function zt(){for(var e=Ve.length-1;e>=0;e--){var r=Ve[e].element;r&&r.isConnected===!1&&Ve.splice(e,1)}return Ve}function pi(e){!e||typeof e.setAttribute!="function"||(cr.indexOf(e)===-1&&cr.push(e),e.setAttribute(Ya,""))}function ja(){for(var e=0;e<cr.length;e++){var r=cr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Ya)}cr=[],er&&typeof clearTimeout=="function"&&clearTimeout(er),er=null}function di(e){if($r){$r=!1,ja(),e.preventDefault(),e.stopPropagation();return}for(var r=zt(),t=!1,n=r.length-1;n>=0;n--){var a=r[n];Da(e,a.trigger)||Da(e,a.element)||a.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function ui(e){if(e.key==="Escape")for(var r=zt(),t=r.length-1;t>=0;t--)r[t].close()}function Wa(){Va||typeof document=="undefined"||(document.addEventListener("click",di,!0),document.addEventListener("keydown",ui),Va=!0)}function si(e){Wa(),$r=!0,pi(e),er&&typeof clearTimeout=="function"&&clearTimeout(er),typeof setTimeout=="function"&&(er=setTimeout(function(){$r=!1,ja()},700))}function Ct(e){si(e)}function Jr(e){Wa();var r={trigger:e.trigger,element:e.element,close:e.close};return Ve.push(r),{unregister:function(){var t=Ve.indexOf(r);t!==-1&&Ve.splice(t,1)},notifyOpening:function(){for(var t=zt(),n=0;n<t.length;n++)t[n]!==r&&t[n].close()}}}function pe(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var p=document.createElement("button");p.className="renuvex-pr-write-btn",p.textContent=H(N&&N.writeButtonText,"Yorum Yap"),p.onclick=a,o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-filter-wrap";var d=document.createElement("button");d.type="button",d.className="renuvex-pr-filter-btn",d.setAttribute("aria-label","Filtrele"),d.setAttribute("aria-haspopup","menu"),d.setAttribute("aria-expanded","false");var m=N&&N.filterIcon||"lines";d.innerHTML=se(pa(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],s=!1;function x(){return r&&r.parentNode||r||null}function f(w,E){if(!(E===!0||!w)){if(w.type==="touchstart"){Ct(x());return}if(w.type==="pointerdown"){var T=w.pointerType||"";T&&T!=="mouse"&&Ct(x());return}}}function c(w){var E=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),d.classList.remove("renuvex-pr-filter-btn-active"),d.setAttribute("aria-expanded","false");var T=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(E&&T)try{d.focus({preventScroll:!0})}catch(S){try{d.focus()}catch(g){}}return E}function h(){b.notifyOpening(),v.classList.add("renuvex-pr-open"),d.classList.add("renuvex-pr-filter-btn-active"),d.setAttribute("aria-expanded","true");var w=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(E){try{w.focus()}catch(T){}}})}u.forEach(function(w){var E=w[2],T=E?n:!n&&(t||"newest")===w[0],S=document.createElement("button");S.type="button",S.className="renuvex-pr-filter-item"+(T?" renuvex-pr-filter-item-active":""),S.setAttribute("role","menuitem"),S.textContent=w[1];var g=!1;function k(C,z){C&&(C.preventDefault(),C.stopPropagation()),!g&&(g=!0,s=!0,f(C,z),c({restoreFocus:z}),i(w[0],E),setTimeout(function(){g=!1,s=!1},0))}S.addEventListener("pointerdown",function(C){C.button!==void 0&&C.button!==0||C.pointerType!=="mouse"&&k(C,!1)}),typeof window!="undefined"&&!window.PointerEvent&&S.addEventListener("touchstart",function(C){k(C,!1)},{passive:!1}),S.addEventListener("keydown",function(C){(C.key==="Enter"||C.key===" ")&&k(C,!0)}),S.onclick=function(C){k(C,!1)},v.appendChild(S)}),d.onclick=function(){v.classList.contains("renuvex-pr-open")?c({restoreFocus:"auto"}):h()},l.addEventListener("keydown",function(w){w.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),c({restoreFocus:!0}))}),l.addEventListener("focusout",function(w){if(v.classList.contains("renuvex-pr-open")&&!s){var E=w.relatedTarget;E&&l.contains(E)||c()}});var b=Jr({trigger:l,element:v,close:c});return l.appendChild(d),l.appendChild(v),o.appendChild(l),o}var qa=`
...
`;var Ki={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Xi=wn,$i="__unknown_product__",gr=Object.create(null);function Ji(e){return e?String(e):$i}var De=null,hr=null;function Zi(){!De||!hr||(De.removeEventListener?De.removeEventListener("change",hr):De.removeListener&&De.removeListener(hr),De=null,hr=null)}function Qi(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange,s=Ji(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var f=document.createElement("div");f.className="renuvex-pr-compact-header";var c=document.createElement("div");c.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Le(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(da)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),w=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+H(n.countLabel,"Yorum")),b&&w){var E=document.createElement("span");E.className="renuvex-pr-compact-trigger-count",h.insertBefore(E,b),E.appendChild(b),E.appendChild(w)}c.appendChild(h),f.appendChild(c);var T=pe({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:te,onSortChange:u}),S=T.querySelector(".renuvex-pr-filter-wrap"),g=T.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-compact-actions-slot",g&&k.appendChild(g),S&&k.appendChild(S),f.appendChild(k),x.appendChild(f);var C=document.createElement("div");C.className="renuvex-pr-compact-panel",C.setAttribute("role","dialog"),C.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),C.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="renuvex-pr-compact-panel-inner";var A=document.createElement("div");A.className="renuvex-pr-compact-avg",A.innerHTML='<span class="renuvex-pr-icon">'+ue("full")+"</span><span>"+p+"</span>",z.appendChild(A),z.appendChild(Qe({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(O){I()&&C.classList.contains("renuvex-pr-open")&&(gr[s]=!0),v(O)}})),C.appendChild(z);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function I(){return!!(L&&L.matches)}function _(O){O?C.classList.add("renuvex-pr-open"):C.classList.remove("renuvex-pr-open"),C.setAttribute("aria-hidden",O?"false":"true"),h.setAttribute("aria-expanded",O?"true":"false")}function y(O){var U=O?x:c;if(C.parentNode!==U){var W=!!C.parentNode;C.classList.contains("renuvex-pr-open")&&_(!1),W&&(gr[s]=!1),U.appendChild(C)}}y(L?L.matches:!1);var M=pe({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:te,onSortChange:u}),P=M.querySelector(".renuvex-pr-filter-wrap"),B=M.querySelector(".renuvex-pr-write-btn"),R=document.createElement("div");R.className="renuvex-pr-compact-write-row",B&&R.appendChild(B),P&&R.appendChild(P),x.appendChild(R);function j(){var O=C.classList.contains("renuvex-pr-open");return _(!1),I()&&(gr[s]=!1),O}function J(){Y&&Y.notifyOpening(),_(!0),I()&&(gr[s]=!0)}h.onclick=function(){C.classList.contains("renuvex-pr-open")?j():J()};var Y=null;function F(O){Y&&(Y.unregister(),Y=null),O||(Y=Jr({trigger:c,element:C,close:j}))}if(F(L?L.matches:!1),Zi(),L){var G=function(O){y(O.matches),F(O.matches)};L.addEventListener?L.addEventListener("change",G):L.addListener&&L.addListener(G),De=L,hr=G}if(I()&&gr[s]&&_(!0),n.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),V=i>0?Math.round(X/i*100):0;if(V>0){var K=document.createElement("div");K.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",K.style.marginTop="8px",K.innerHTML='<span class="renuvex-pr-recommend-pct">%'+V+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(K)}}return x}var Rt={};Ae(Rt,{css:()=>ro,meta:()=>eo,render:()=>to});var kn=`
...
`;var eo={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},ro=kn;function to(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,p=e.currentRatingFilter,l=e.currentOrderBy,d=e.currentHasImages,m=e.onFilterChange,v=e.onSortChange;Me(n);var u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(x);var f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",f.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),s.appendChild(f),u.appendChild(s);var c=document.createElement("div");c.className="renuvex-pr-split-col renuvex-pr-split-mid",c.appendChild(Qe({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:p,onFilterChange:m})),u.appendChild(c);var h=pe({widget:r,currentOrderBy:l,currentHasImages:d,onWriteClick:te,onSortChange:v}),b=h.querySelector(".renuvex-pr-filter-wrap"),w=h.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");E.className="renuvex-pr-split-col renuvex-pr-split-right",w&&E.appendChild(w),b&&E.appendChild(b),u.appendChild(E);var T=(i[3]||0)+(i[4]||0),S=a>0?Math.round(T/a*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",g.innerHTML='<span class="renuvex-pr-recommend-pct">%'+S+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var k=t.showRecommendation===!1||S===0;return k&&g.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(g),u}var Nt={};Ae(Nt,{css:()=>no,meta:()=>ao,render:()=>io});var Sn=`
