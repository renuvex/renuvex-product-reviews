...
`;var wi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ki=tn,zi="__unknown_product__",mr=Object.create(null);function Si(e){return e?String(e):zi}var He=null,fr=null;function Ci(){!He||!fr||(He.removeEventListener?He.removeEventListener("change",fr):He.removeListener&&He.removeListener(fr),He=null,fr=null)}function Ei(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,v=e.currentHasImages,c=e.onFilterChange,s=e.onSortChange,m=Si(t),b=document.createElement("div");b.className="renuvex-pr-summary renuvex-pr-summary-compact";var d=document.createElement("div");d.className="renuvex-pr-compact-header";var x=document.createElement("div");x.className="renuvex-pr-compact-trigger-wrap";var g=document.createElement("button");g.className="renuvex-pr-compact-trigger",g.type="button",g.setAttribute("aria-expanded","false"),g.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+_e(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+ue(Jt)+"</span>";var y=g.querySelector(".renuvex-pr-compact-trigger-text"),w=g.querySelector(".renuvex-pr-compact-chevron");if(y&&(y.textContent=i.toLocaleString("tr-TR")+" "+F(n.countLabel,"Yorum")),y&&w){var A=document.createElement("span");A.className="renuvex-pr-compact-trigger-count",g.insertBefore(A,y),A.appendChild(y),A.appendChild(w)}x.appendChild(g),d.appendChild(x);var h=ie({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:ee,onSortChange:s}),k=h.querySelector(".renuvex-pr-filter-wrap"),z=h.querySelector(".renuvex-pr-write-btn"),C=document.createElement("div");C.className="renuvex-pr-compact-actions-slot",z&&C.appendChild(z),k&&C.appendChild(k),d.appendChild(C),b.appendChild(d);var T=document.createElement("div");T.className="renuvex-pr-compact-panel",T.setAttribute("role","dialog"),T.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),T.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="renuvex-pr-compact-panel-inner";var f=document.createElement("div");f.className="renuvex-pr-compact-avg",f.innerHTML='<span class="renuvex-pr-icon">'+pe("full")+"</span><span>"+p+"</span>",E.appendChild(f),E.appendChild(Je({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(V){N()&&T.classList.contains("renuvex-pr-open")&&(mr[m]=!0),c(V)}})),T.appendChild(E);var P=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function N(){return!!(P&&P.matches)}function S(V){V?T.classList.add("renuvex-pr-open"):T.classList.remove("renuvex-pr-open"),T.setAttribute("aria-hidden",V?"false":"true"),g.setAttribute("aria-expanded",V?"true":"false")}function M(V){var W=V?b:x;if(T.parentNode!==W){var $=!!T.parentNode;T.classList.contains("renuvex-pr-open")&&S(!1),$&&(mr[m]=!1),W.appendChild(T)}}M(P?P.matches:!1);var R=ie({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:ee,onSortChange:s}),I=R.querySelector(".renuvex-pr-filter-wrap"),L=R.querySelector(".renuvex-pr-write-btn"),O=document.createElement("div");O.className="renuvex-pr-compact-write-row",L&&O.appendChild(L),I&&O.appendChild(I),b.appendChild(O);function H(){var V=T.classList.contains("renuvex-pr-open");return S(!1),N()&&(mr[m]=!1),V}function j(){D&&D.notifyOpening(),S(!0),N()&&(mr[m]=!0)}g.onclick=function(){T.classList.contains("renuvex-pr-open")?H():j()};var D=null;function B(V){D&&(D.unregister(),D=null),V||(D=qr({trigger:x,element:T,close:H}))}if(B(P?P.matches:!1),Ci(),P){var Y=function(V){M(V.matches),B(V.matches)};P.addEventListener?P.addEventListener("change",Y):P.addListener&&P.addListener(Y),He=P,fr=Y}if(N()&&mr[m]&&S(!0),n.showRecommendation!==!1){var q=(o[3]||0)+(o[4]||0),Z=i>0?Math.round(q/i*100):0;if(Z>0){var ve=document.createElement("div");ve.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",ve.style.marginTop="8px",ve.innerHTML='<span class="renuvex-pr-recommend-pct">%'+Z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(ve)}}return b}var zt={};Ae(zt,{css:()=>Ai,meta:()=>Ti,render:()=>Pi});var an=`
...
`;var Bi={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},Fi=un;function Oi(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var n=document.createElement("div");n.className="renuvex-pr-review-top";var a=document.createElement("div");a.className="renuvex-pr-review-top-left";var i=document.createElement("span");i.className="renuvex-pr-review-stars",i.innerHTML=we(e.rating,_),a.appendChild(i);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=ke(e.createdAt),n.appendChild(a),n.appendChild(o),t.appendChild(n),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-title",p.textContent=e.title,t.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-author",l.textContent=e.author||"",t.appendChild(l);var u=(e.comment||"").trim();u&&t.appendChild(tr(u,"renuvex-pr-body").fragment);var v=Se(e);if(v.length){var c=document.createElement("div");c.className="renuvex-pr-gallery",v.forEach(function(m){var b=Le(m,{className:"renuvex-pr-img",sourceWidth:ne,width:ne,height:ne,onOpen:function(){ge(e,m.url,r)}});b&&c.appendChild(b)}),t.appendChild(c)}var s=ar(e.merchantReply);return s&&t.appendChild(s),t}var Tt={};Ae(Tt,{css:()=>Hi,meta:()=>Ui,render:()=>Vi});var dn=`
  .renuvex-pr-review-list{
    display:grid;
