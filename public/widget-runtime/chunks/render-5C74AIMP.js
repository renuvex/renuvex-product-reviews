...
`}var Qo=La(ei),ri=La(ur);function ti(e,r){var d;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let a=t.get("media-theme-gerwig"),n=a==null?void 0:a.template;if(!a||!(n instanceof HTMLTemplateElement))return;let i=n.cloneNode(!0);i.id=e,(d=i.content.querySelector("media-controller"))==null||d.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class l extends a{}l.template=i,t.define(e,l)}function ai(e,r){return typeof window=="undefined"?Promise.resolve():(Xr!=null||(Xr=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),Xr.then(()=>{ti(e,r)}))}function Ra(){return ai(Qn,ri)}var gt=null,Ia="--center-play-button";function ni(){return gt||(gt=Ra()),gt}function ii(e){return new Promise(function(r){function t(a){if(a<=0){r();return}requestAnimationFrame(function(){t(a-1)})}t(e)})}function oi(e){e.style.setProperty(Ia,"none")}function Na(e){e.style.removeProperty(Ia)}function li(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=fa(e.url);return r&&t&&r!==t?"":r||t}function di(e,r){var t=li(r);if(!t)return!1;var a=Or(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("nohotkeys",""),e.setAttribute("lang","tr"),e.setAttribute("theme",_a),e.setAttribute("accent-color",ur.controlForeground),e.setAttribute("primary-color",ur.controlForeground),e.setAttribute("secondary-color",ur.controlBackground),a&&e.setAttribute("poster",a),e.setAttribute("playback-id",t),!0}function Ba(e){e.preventDefault()}function Fa(e,r){var t=!1,a=document.createElement("mux-player");a.className=r||"renuvex-pr-modal-main-video",a.setAttribute("aria-label","Yorum videosu"),oi(a),a.addEventListener("contextmenu",Ba);var n=di(a,e);return n?ni().then(function(){if(window.customElements&&typeof window.customElements.whenDefined=="function")return window.customElements.whenDefined("mux-player")}).then(function(){if(!t){try{typeof a.pause=="function"&&a.pause()}catch(i){}return ii(2)}}).then(function(){t||Na(a)}).catch(function(){t||a.dispatchEvent(new Event("error"))}):setTimeout(function(){t||a.dispatchEvent(new Event("error"))},0),{element:a,cleanup:function(){t=!0;try{typeof a.pause=="function"&&a.pause()}catch(o){}a.removeAttribute("playback-id"),a.removeAttribute("playback-token"),a.removeAttribute("thumbnail-token"),a.removeAttribute("poster"),Na(a),a.removeEventListener("contextmenu",Ba)}}}function $e(e){return Le(e)}function bt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Oa(e,r,t,a,n,i){e&&e.shadowRoot&&bt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),Yr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Pr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(n)}function pi(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=we(e.rating,N);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=ke(e.createdAt),a.appendChild(n),a.appendChild(i),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=U(N&&N.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",p.appendChild(m),p.appendChild(v),p.style.display=e.merchantReply?"":"none",t.appendChild(p),r.appendChild(t),r}function Ua(e,r,t){var a=t||N,n=e.querySelector(".renuvex-pr-modal-scroll-content"),i=n.querySelector(".renuvex-pr-modal-stars");i.innerHTML=we(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=ke(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=n.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=U(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}var ui=112;function yt(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function si(e,r,t){if(!r||r.type!=="video"||!t)return!1;var a=yt(e);if(!a)return!1;var n=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!n||typeof n.getBoundingClientRect!="function")return!1;var i=n.getBoundingClientRect();if(!i.width||!i.height||a.clientX<i.left||a.clientX>i.right||a.clientY<i.top||a.clientY>i.bottom)return!1;var o=Math.min(ui,Math.max(72,i.height*.2));return a.clientY>=i.bottom-o}function wt(e,r,t,a,n,i,o,l,d){var p=$e(e),m=Math.max(0,Math.min(t||0,p.length-1)),v=p[m],u=document.createElement("div");u.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Fa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),c=x.element;c.addEventListener("error",function(){if(!u.querySelector(".renuvex-pr-modal-img-error")){var T=document.createElement("div");T.className="renuvex-pr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",u.insertBefore(T,c)}}),u.__renuvexMediaCleanup=x.cleanup,u.appendChild(c)}else{var f=document.createElement("img");if(f.className="renuvex-pr-modal-main-img"+(s?" "+s:""),f.src=ct(v?v.url:""),f.decoding="async",f.width=vt,f.height=Math.round(vt*4/3),f.alt="Yorum foto\u011Fraf\u0131",!s){f.classList.add("renuvex-pr-modal-img-loading");var h=function(){f.classList.remove("renuvex-pr-modal-img-loading")};f.complete&&f.naturalWidth>0?h():(f.addEventListener("load",h,{once:!0}),f.addEventListener("error",h,{once:!0}))}sa(f,function(T){if(T.style.display="none",!u.querySelector(".renuvex-pr-modal-img-error")){var L=document.createElement("div");L.className="renuvex-pr-modal-img-error",L.setAttribute("role","status"),L.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",u.insertBefore(L,T)}}),u.appendChild(f)}var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var E=re(ye);E&&b.appendChild(E),b.setAttribute("aria-label","Kapat"),b.onclick=function(T){T.stopPropagation(),i()},u.appendChild(b);var P=0,k=!1;if(u.addEventListener("touchstart",function(T){var L=yt(T);L&&(P=L.clientX,k=si(T,v,u))},{passive:!0}),u.addEventListener("touchend",function(T){if(k){k=!1;return}var L=yt(T);if(L){var F=P-L.clientX;if(!(Math.abs(F)<50)){if(F>0){if(w)Se(e,r,m+1,a,n,i,!0,"next",l,d);else if(z){var B=a[r+1];Se(B,r+1,0,a,n,i,!1,"next",l,d)}}else if(g)Se(e,r,m-1,a,n,i,!0,"prev",l,d);else if(A){var j=a[r-1],V=$e(j);Se(j,r-1,V.length-1,a,n,i,!1,"prev",l,d)}}}},{passive:!0}),p.length>1){var S=document.createElement("div");S.className="renuvex-pr-modal-thumbs",p.forEach(function(T,L){var F=T.type==="video"?T.posterUrl:T.url,B=document.createElement("img"),j=Ir(F,Br);B.src=j.src,B.srcset=j.srcset,B.loading="lazy",B.decoding="async",B.width=Br,B.height=Br,B.className="renuvex-pr-modal-thumb"+(L===m?" renuvex-pr-modal-thumb-active":""),B.alt="K\xFC\xE7\xFCk resim "+(L+1),Fr(B),B.tabIndex=0,B.setAttribute("role","button"),B.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(L+1)+" se\xE7"),L===m&&B.setAttribute("aria-current","true"),(function(V){function H(){Se(e,r,V,a,n,i,!0,null,l,d)}B.onclick=H,B.onkeydown=function(D){(D.key==="Enter"||D.key===" ")&&(D.preventDefault(),H())}})(L),S.appendChild(B)}),u.appendChild(S)}var g=m>0,w=m<p.length-1,A=r>0,z=r<a.length-1,C=g||A,_=w||z;if(C){var R=document.createElement("button");R.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var I=re(We);I&&R.appendChild(I),R.setAttribute("aria-label","\xD6nceki"),R.onclick=function(T){if(T.stopPropagation(),g)Se(e,r,m-1,a,n,i,!0,"prev",l,d);else if(A){var L=a[r-1],F=$e(L);Se(L,r-1,F.length-1,a,n,i,!1,"prev",l,d)}},u.appendChild(R)}if(_){var y=document.createElement("button");y.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var M=re(_r);M&&y.appendChild(M),y.setAttribute("aria-label","Sonraki"),y.onclick=function(T){if(T.stopPropagation(),w)Se(e,r,m+1,a,n,i,!0,"next",l,d);else if(z){var L=a[r+1];Se(L,r+1,0,a,n,i,!1,"next",l,d)}},u.appendChild(y)}return u}function Va(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=$e(a);n[0]&&n[0].type==="image"&&(new Image().src=ct(n[0].url))}})}function ht(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function vi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){ht(t),ht(a),ht(n)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Se(e,r,t,a,n,i,o,l,d,p){if(p&&(p.currentReview=e),o){var m=wt(e,r,t,a,n,i,l,d,p);n.firstChild&&(bt(n.firstChild),n.replaceChild(m,n.firstChild))}else{var m=wt(e,r,t,a,n,i,l,d,p),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&(bt(n.firstChild),n.replaceChild(m,n.firstChild)),v&&Ua(v,e,p&&p.currentSettings),vi(d,n)}Va(r,a)}function xe(e,r,t){var a=$e(e);if(!a.length)return;var n=(t||[]).filter(function(w){return $e(w).length>0}),i=n.findIndex(function(w){return w===e||w.id===e.id});i===-1&&(n.unshift(e),i=0);var o=a.findIndex(function(w){return w.url===r});o<0&&(o=0);var l=document.createElement("div");l.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var p=!1,m=null,v=jr(),u=Ae(),s=Dr(),x=Gr(),c={currentReview:e,currentSettings:N},f=null;function h(w){var A=w&&w.detail&&w.detail.settings;if(!(A&&A===f)){f=A||null,c.currentSettings=A||N;var z=d.querySelector(".renuvex-pr-modal-right");!z||!c.currentReview||Ua(z,c.currentReview,c.currentSettings)}}function b(){p||(p=!0,window.removeEventListener(Oe,h),Oa(m&&m.host,E,b,s,v,u))}function E(w){if(w.key==="Escape"){P();return}Wr(w,l,m&&m.root)}function P(){p||(p=!0,window.removeEventListener(Oe,h),Oa(m&&m.host,E,b,s,v,u),qr(x))}document.addEventListener("keydown",E),window.addEventListener("popstate",b),window.addEventListener(Oe,h),l.onclick=function(){P()},d.onclick=function(w){w.stopPropagation()},d.appendChild(wt(e,i,o,n,d,P,null,l,c)),d.appendChild(pi(e)),Va(i,n);var k=document.createElement("div");k.className="renuvex-pr-modal-wrap",k.tabIndex=-1,k.setAttribute("role","dialog"),k.setAttribute("aria-modal","true"),k.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),k.appendChild(d);var S=document.createElement("button");S.className="renuvex-pr-modal-close";var g=re(ye);g&&S.appendChild(g),S.setAttribute("aria-label","Kapat"),S.onclick=function(w){w.stopPropagation(),P()},k.appendChild(S),l.appendChild(k),m=Vr(),qe(m.root,Ge+je+Hr),m.root.appendChild(l),Fe(m.root),ve(k)}function sr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Mt={};Te(Mt,{css:()=>Ji,meta:()=>$i,render:()=>Zi});function Je(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,i=e.onFilterChange;Pe(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,p=t>0?Math.round(d/t*100):0,m=n===l,v=d>0,u=U(N&&N.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(n&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+u+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+u);for(var x="",c=1;c<=5;c++){var f=c<=l;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(f?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+p+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(E){(E.key==="Enter"||E.key===" "||E.key==="Space"||E.key==="Spacebar")&&(E.preventDefault(),b())}})(l),o.appendChild(s)}return o}var Ya="data-renuvex-pr-dismiss-gesture",Ve=[],Ha=!1,$r=!1,vr=[],Ze=null;function Da(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function kt(){for(var e=Ve.length-1;e>=0;e--){var r=Ve[e].element;r&&r.isConnected===!1&&Ve.splice(e,1)}return Ve}function ci(e){!e||typeof e.setAttribute!="function"||(vr.indexOf(e)===-1&&vr.push(e),e.setAttribute(Ya,""))}function ja(){for(var e=0;e<vr.length;e++){var r=vr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Ya)}vr=[],Ze&&typeof clearTimeout=="function"&&clearTimeout(Ze),Ze=null}function mi(e){if($r){$r=!1,ja(),e.preventDefault(),e.stopPropagation();return}for(var r=kt(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Da(e,n.trigger)||Da(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function fi(e){if(e.key==="Escape")for(var r=kt(),t=r.length-1;t>=0;t--)r[t].close()}function Wa(){Ha||typeof document=="undefined"||(document.addEventListener("click",mi,!0),document.addEventListener("keydown",fi),Ha=!0)}function xi(e){Wa(),$r=!0,ci(e),Ze&&typeof clearTimeout=="function"&&clearTimeout(Ze),typeof setTimeout=="function"&&(Ze=setTimeout(function(){$r=!1,ja()},700))}function zt(e){xi(e)}function Jr(e){Wa();var r={trigger:e.trigger,element:e.element,close:e.close};return Ve.push(r),{unregister:function(){var t=Ve.indexOf(r);t!==-1&&Ve.splice(t,1)},notifyOpening:function(){for(var t=kt(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function de(e){var r=e.widget,t=e.currentOrderBy,a=e.currentMediaFilter||"none",n=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=U(N&&N.writeButtonText,"Yorum Yap"),l.onclick=n,o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-filter-btn",p.setAttribute("aria-label","Filtrele"),p.setAttribute("aria-haspopup","menu"),p.setAttribute("aria-expanded","false");var m=N&&N.filterIcon||"lines";p.innerHTML=se(ia(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var u=Gt===!0?"media":"images",s=u==="media"?"Foto\u011Fraf ve Video":"Foto\u011Frafl\u0131",x=[{orderBy:"newest",label:"En Yeni",mediaFilter:"none"},{orderBy:"highest",label:"En Y\xFCksek Puan",mediaFilter:"none"},{orderBy:"lowest",label:"En D\xFC\u015F\xFCk Puan",mediaFilter:"none"},{orderBy:"newest",label:s,mediaFilter:u}],c=!1;function f(){return r&&r.parentNode||r||null}function h(k,S){if(!(S===!0||!k)){if(k.type==="touchstart"){zt(f());return}if(k.type==="pointerdown"){var g=k.pointerType||"";g&&g!=="mouse"&&zt(f())}}}function b(k){var S=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),p.classList.remove("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","false");var g=k&&(k.restoreFocus===!0||k.restoreFocus==="auto"&&Ae());if(S&&g)try{p.focus({preventScroll:!0})}catch(w){try{p.focus()}catch(A){}}return S}function E(){P.notifyOpening(),v.classList.add("renuvex-pr-open"),p.classList.add("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","true");var k=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");k&&requestAnimationFrame(function(){try{k.focus({preventScroll:!0})}catch(S){try{k.focus()}catch(g){}}})}x.forEach(function(k){var S=k.mediaFilter!=="none",g=S?a===k.mediaFilter:a==="none"&&(t||"newest")===k.orderBy,w=document.createElement("button");w.type="button",w.className="renuvex-pr-filter-item"+(g?" renuvex-pr-filter-item-active":""),w.setAttribute("role","menuitem"),w.textContent=k.label;var A=!1;function z(C,_){C&&(C.preventDefault(),C.stopPropagation()),!A&&(A=!0,c=!0,h(C,_),b({restoreFocus:_}),i(k.orderBy,k.mediaFilter),setTimeout(function(){A=!1,c=!1},0))}w.addEventListener("pointerdown",function(C){C.button!==void 0&&C.button!==0||C.pointerType!=="mouse"&&z(C,!1)}),typeof window!="undefined"&&!window.PointerEvent&&w.addEventListener("touchstart",function(C){z(C,!1)},{passive:!1}),w.addEventListener("keydown",function(C){(C.key==="Enter"||C.key===" ")&&z(C,!0)}),w.onclick=function(C){z(C,!1)},v.appendChild(w)}),p.onclick=function(){v.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):E()},d.addEventListener("keydown",function(k){k.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(k.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(k){if(v.classList.contains("renuvex-pr-open")&&!c){var S=k.relatedTarget;S&&d.contains(S)||b()}});var P=Jr({trigger:d,element:v,close:b});return d.appendChild(p),d.appendChild(v),o.appendChild(d),o}var Ga=`
...
`;var Qi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},eo=wn,ro="__unknown_product__",xr=Object.create(null);function to(e){return e?String(e):ro}var He=null,gr=null;function ao(){!He||!gr||(He.removeEventListener?He.removeEventListener("change",gr):He.removeListener&&He.removeListener(gr),He=null,gr=null)}function no(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,m=e.currentMediaFilter,v=e.onFilterChange,u=e.onSortChange,s=to(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+_e(l,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(oa)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),E=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+U(a.countLabel,"Yorum")),b&&E){var P=document.createElement("span");P.className="renuvex-pr-compact-trigger-count",h.insertBefore(P,b),P.appendChild(b),P.appendChild(E)}f.appendChild(h),c.appendChild(f);var k=de({widget:r,currentOrderBy:p,currentMediaFilter:m,onWriteClick:ae,onSortChange:u}),S=k.querySelector(".renuvex-pr-filter-wrap"),g=k.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-compact-actions-slot",g&&w.appendChild(g),S&&w.appendChild(S),c.appendChild(w),x.appendChild(c);var A=document.createElement("div");A.className="renuvex-pr-compact-panel",A.setAttribute("role","dialog"),A.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),A.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+ue("full")+"</span><span>"+l+"</span>",z.appendChild(C),z.appendChild(Je({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:d,onFilterChange:function(O){R()&&A.classList.contains("renuvex-pr-open")&&(xr[s]=!0),v(O)}})),A.appendChild(z);var _=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function R(){return!!(_&&_.matches)}function I(O){O?A.classList.add("renuvex-pr-open"):A.classList.remove("renuvex-pr-open"),A.setAttribute("aria-hidden",O?"false":"true"),h.setAttribute("aria-expanded",O?"true":"false")}function y(O){var $=O?x:f;if(A.parentNode!==$){var J=!!A.parentNode;A.classList.contains("renuvex-pr-open")&&I(!1),J&&(xr[s]=!1),$.appendChild(A)}}y(_?_.matches:!1);var M=de({widget:r,currentOrderBy:p,currentMediaFilter:m,onWriteClick:ae,onSortChange:u}),T=M.querySelector(".renuvex-pr-filter-wrap"),L=M.querySelector(".renuvex-pr-write-btn"),F=document.createElement("div");F.className="renuvex-pr-compact-write-row",L&&F.appendChild(L),T&&F.appendChild(T),x.appendChild(F);function B(){var O=A.classList.contains("renuvex-pr-open");return I(!1),R()&&(xr[s]=!1),O}function j(){V&&V.notifyOpening(),I(!0),R()&&(xr[s]=!0)}h.onclick=function(){A.classList.contains("renuvex-pr-open")?B():j()};var V=null;function H(O){V&&(V.unregister(),V=null),O||(V=Jr({trigger:f,element:A,close:B}))}if(H(_?_.matches:!1),ao(),_){var D=function(O){y(O.matches),H(O.matches)};_.addEventListener?_.addEventListener("change",D):_.addListener&&_.addListener(D),He=_,gr=D}if(R()&&xr[s]&&I(!0),a.showRecommendation!==!1){var q=(o[3]||0)+(o[4]||0),W=i>0?Math.round(q/i*100):0;if(W>0){var ee=document.createElement("div");ee.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",ee.style.marginTop="8px",ee.innerHTML='<span class="renuvex-pr-recommend-pct">%'+W+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(ee)}}return x}var _t={};Te(_t,{css:()=>oo,meta:()=>io,render:()=>lo});var kn=`
