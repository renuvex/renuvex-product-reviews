...
import{a as Pe,d as Ne}from"./chunk-N7KC6W47.js";import{b as _r,c as Me}from"./chunk-ZM24JLBV.js";import{A as ur,B as sr,a as ee,b as or,c as oe,d as le,e as H,f as R,g as nt,h as Re,j as Rr,k as it,l as lr,m as Ie,n as ot,o as lt,p as pt,q as ut,r as st,s as dt,t as vt,v as ct,w as mt,x as xt,y as ft,z as pr}from"./chunk-NQF4A7IV.js";import{A as kt,B as ke,C as cr,D as X,E as mr,F as xr,G as Ir,H as Br,I as ue,J as St,K as se,L as Ct,M as Et,c as Nr,e as ze,f as re,g as xe,h as te,i as Ce,j as dr,k as Ze,l as gt,m as Be,n as vr,o as ht,p as Ee,q as bt,r as yt,t as B,u as wt,v as fe,w as _e,y as zt,z as ge}from"./chunk-SANB57XJ.js";import{a as $e}from"./chunk-GSBAPHFO.js";import{a as we,b as Xe,c as Je,k as Tt,l as Te}from"./chunk-YCWIZ2SG.js";var Fe=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function At(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Oe(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function fr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function Lt(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function Pt(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var Nt=`
...
`;var gr=[Nt,zt,It,Bt,_t,Mt,Rt].join(`
`);function ka(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function de(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function Sa(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Ca(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",o=Sa()&&!n;if(a>0){var l=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",l+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Ea(e){var r=document.body.style,t=document.documentElement.style;de(t,"overflow",e.rootOverflow,e.rootOverflowPriority),de(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),de(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),de(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),de(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),de(r,"position",e.bodyPosition,e.bodyPositionPriority),de(r,"top",e.bodyTop,e.bodyTopPriority),de(r,"left",e.bodyLeft,e.bodyLeftPriority),de(r,"right",e.bodyRight,e.bodyRightPriority),de(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Qe=0,He=null;function hr(){return Qe+=1,Qe>1||(He=ka(),Ca(He)),He}function br(){if(Qe!==0&&(Qe-=1,!(Qe>0))){var e=He;He=null,e&&Ea(e)}}function Ta(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function yr(){var e=Ta();return!e||e===document.body||e===document.documentElement?null:e}function ae(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Aa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Mr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Aa)}function La(e,r){var t=e,a=Mr(e);!a.length&&r&&(t=r,a=Mr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;ae(n)}function wr(e,r,t){if(e.key==="Tab"){var a=Mr(r);if(!a.length){e.preventDefault(),La(r);return}var n=a[0],o=a[a.length-1],l=Lt(t);if(!r.contains(l)){e.preventDefault(),ae(n);return}if(a.indexOf(l)===-1){e.preventDefault(),ae(e.shiftKey?o:n);return}e.shiftKey&&l===n?(e.preventDefault(),ae(o)):!e.shiftKey&&l===o&&(e.preventDefault(),ae(n))}}var Ft="renuvexPrOverlay";function zr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Ft]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Pa(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Ft]===e.id)}function kr(e){if(Pa(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Ye(e){return ke(e)}function Ot(e,r,t,a,n,o){br(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&dr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),o&&ae(n)}function Na(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=fe(e.rating,R);var o=document.createElement("span");o.className="renuvex-pr-modal-date",o.textContent=ge(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-modal-title",l.textContent=e.title||"",l.style.display=e.title?"":"none",t.appendChild(l);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=B(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi");var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",u.appendChild(f),u.appendChild(s),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Ht(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),o=n.querySelector(".renuvex-pr-modal-stars");o.innerHTML=fe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=ge(r.createdAt);var l=n.querySelector(".renuvex-pr-modal-title");l.textContent=r.title||"",l.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=B(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Or(e,r,t,a,n,o,l,i,d){var u=Ye(e),f=Math.max(0,Math.min(t||0,u.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var p=document.createElement("img"),v=l==="next"?"renuvex-pr-modal-img-enter-right":l==="prev"?"renuvex-pr-modal-img-enter-left":"";if(p.className="renuvex-pr-modal-main-img"+(v?" "+v:""),p.src=Br(u[f]||""),p.decoding="async",p.width=Ir,p.height=Math.round(Ir*4/3),p.alt="Yorum foto\u011Fraf\u0131",!v){p.classList.add("renuvex-pr-modal-img-loading");var y=function(){p.classList.remove("renuvex-pr-modal-img-loading")};p.complete&&p.naturalWidth>0?y():(p.addEventListener("load",y,{once:!0}),p.addEventListener("error",y,{once:!0}))}St(p,function(P){if(P.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var C=document.createElement("div");C.className="renuvex-pr-modal-img-error",C.setAttribute("role","status"),C.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(C,P)}}),s.appendChild(p);var c=document.createElement("button");c.className="renuvex-pr-modal-close-mobile";var b=te(Ee);b&&c.appendChild(b),c.setAttribute("aria-label","Kapat"),c.onclick=function(P){P.stopPropagation(),o()},s.appendChild(c);var m=0;if(s.addEventListener("touchstart",function(P){m=P.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(P){var C=m-P.changedTouches[0].clientX;if(!(Math.abs(C)<50)){if(C>0){if(k)he(e,r,f+1,a,n,o,!0,"next",i,d);else if(z){var N=a[r+1];he(N,r+1,0,a,n,o,!1,"next",i,d)}}else if(x)he(e,r,f-1,a,n,o,!0,"prev",i,d);else if(h){var Y=a[r-1],G=Ye(Y);he(Y,r-1,G.length-1,a,n,o,!1,"prev",i,d)}}},{passive:!0}),u.length>1){var g=document.createElement("div");g.className="renuvex-pr-modal-thumbs",u.forEach(function(P,C){var N=document.createElement("img"),Y=ue(P,xr);N.src=Y.src,N.srcset=Y.srcset,N.loading="lazy",N.decoding="async",N.width=xr,N.height=xr,N.className="renuvex-pr-modal-thumb"+(C===f?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(C+1),se(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(C+1)+" se\xE7"),C===f&&N.setAttribute("aria-current","true"),(function(G){function Z(){he(e,r,G,a,n,o,!0,null,i,d)}N.onclick=Z,N.onkeydown=function(D){(D.key==="Enter"||D.key===" ")&&(D.preventDefault(),Z())}})(C),g.appendChild(N)}),s.appendChild(g)}var x=f>0,k=f<u.length-1,h=r>0,z=r<a.length-1,E=x||h,A=k||z;if(E){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var T=te(Be);T&&w.appendChild(T),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(P){if(P.stopPropagation(),x)he(e,r,f-1,a,n,o,!0,"prev",i,d);else if(h){var C=a[r-1],N=Ye(C);he(C,r-1,N.length-1,a,n,o,!1,"prev",i,d)}},s.appendChild(w)}if(A){var S=document.createElement("button");S.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=te(vr);L&&S.appendChild(L),S.setAttribute("aria-label","Sonraki"),S.onclick=function(P){if(P.stopPropagation(),k)he(e,r,f+1,a,n,o,!0,"next",i,d);else if(z){var C=a[r+1];he(C,r+1,0,a,n,o,!1,"next",i,d)}},s.appendChild(S)}return s}function Yt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=Ye(a);n[0]&&(new Image().src=Br(n[0]))}})}function Fr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Ra(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function o(){Fr(t),Fr(a),Fr(n)}o(),t&&ae(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function he(e,r,t,a,n,o,l,i,d,u){if(u&&(u.currentReview=e),l){var f=Or(e,r,t,a,n,o,i,d,u);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=Or(e,r,t,a,n,o,i,d,u),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),s&&Ht(s,e,u&&u.currentSettings),Ra(d,n)}Yt(r,a)}function ve(e,r,t){var a=Ye(e);if(!a.length)return;var n=(t||[]).filter(function(A){return Ye(A).length>0}),o=n.findIndex(function(A){return A===e||A.id===e.id});o===-1&&(n.unshift(e),o=0);var l=a.indexOf(r);l<0&&(l=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var u=!1,f=null,s=yr(),p=Ne(),v=hr(),y=zr(),c={currentReview:e,currentSettings:R},b=null;function m(A){var w=A&&A.detail&&A.detail.settings;if(!(w&&w===b)){b=w||null,c.currentSettings=w||R;var T=d.querySelector(".renuvex-pr-modal-right");!T||!c.currentReview||Ht(T,c.currentReview,c.currentSettings)}}function g(){u||(u=!0,window.removeEventListener(Te,m),Ot(f&&f.host,x,g,v,s,p))}function x(A){if(A.key==="Escape"){k();return}wr(A,i,f&&f.root)}function k(){u||(u=!0,window.removeEventListener(Te,m),Ot(f&&f.host,x,g,v,s,p),kr(y))}document.addEventListener("keydown",x),window.addEventListener("popstate",g),window.addEventListener(Te,m),i.onclick=function(){k()},d.onclick=function(A){A.stopPropagation()},d.appendChild(Or(e,o,l,n,d,k,null,i,c)),d.appendChild(Na(e)),Yt(o,n);var h=document.createElement("div");h.className="renuvex-pr-modal-wrap",h.tabIndex=-1,h.setAttribute("role","dialog"),h.setAttribute("aria-modal","true"),h.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),h.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var E=te(Ee);E&&z.appendChild(E),z.setAttribute("aria-label","Kapat"),z.onclick=function(A){A.stopPropagation(),k()},h.appendChild(z),i.appendChild(h),f=fr(),Oe(f.root,Fe+Pe+gr),f.root.appendChild(i),Ce(f.root),ae(h)}function Se(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Ur={};we(Ur,{css:()=>ja,meta:()=>Da,render:()=>Ua});function De(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,o=e.onFilterChange;ze(a);var l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,u=t>0?Math.round(d/t*100):0,f=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":"")+(n&&!f?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",f?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+B(R&&R.countLabel,"Yorum")+", "+(f?"filtreyi kald\u0131r":"filtrele"));for(var p="",v=1;v<=5;v++){var y=v<=i;p+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+re(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+p+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(c){function b(){o(c)}s.onclick=b,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),b())}})(i),l.appendChild(s)}return l}var Ut="data-renuvex-pr-dismiss-gesture",Ae=[],Dt=!1,Sr=!1,er=[],je=null;function jt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Hr(){for(var e=Ae.length-1;e>=0;e--){var r=Ae[e].element;r&&r.isConnected===!1&&Ae.splice(e,1)}return Ae}function Ia(e){!e||typeof e.setAttribute!="function"||(er.indexOf(e)===-1&&er.push(e),e.setAttribute(Ut,""))}function Vt(){for(var e=0;e<er.length;e++){var r=er[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Ut)}er=[],je&&typeof clearTimeout=="function"&&clearTimeout(je),je=null}function Ba(e){if(Sr){Sr=!1,Vt(),e.preventDefault(),e.stopPropagation();return}for(var r=Hr(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];jt(e,n.trigger)||jt(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function _a(e){if(e.key==="Escape")for(var r=Hr(),t=r.length-1;t>=0;t--)r[t].close()}function Wt(){Dt||typeof document=="undefined"||(document.addEventListener("click",Ba,!0),document.addEventListener("keydown",_a),Dt=!0)}function Ma(e){Wt(),Sr=!0,Ia(e),je&&typeof clearTimeout=="function"&&clearTimeout(je),typeof setTimeout=="function"&&(je=setTimeout(function(){Sr=!1,Vt()},700))}function Yr(e){Ma(e)}function Cr(e){Wt();var r={trigger:e.trigger,element:e.element,close:e.close};return Ae.push(r),{unregister:function(){var t=Ae.indexOf(r);t!==-1&&Ae.splice(t,1)},notifyOpening:function(){for(var t=Hr(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function J(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,o=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=B(R&&R.writeButtonText,"Yorum Yap"),i.onclick=n,l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var f=R&&R.filterIcon||"lines";u.innerHTML=xe(gt(f));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function y(){return r&&r.parentNode||r||null}function c(x,k){if(!(k===!0||!x)){if(x.type==="touchstart"){Yr(y());return}if(x.type==="pointerdown"){var h=x.pointerType||"";h&&h!=="mouse"&&Yr(y());return}}}function b(x){var k=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var h=x&&(x.restoreFocus===!0||x.restoreFocus==="auto"&&Ne());if(k&&h)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(E){}}return k}function m(){g.notifyOpening(),s.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var x=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");x&&requestAnimationFrame(function(){try{x.focus({preventScroll:!0})}catch(k){try{x.focus()}catch(h){}}})}p.forEach(function(x){var k=x[2],h=k?a:!a&&(t||"newest")===x[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(h?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=x[1];var E=!1;function A(w,T){w&&(w.preventDefault(),w.stopPropagation()),!E&&(E=!0,v=!0,c(w,T),b({restoreFocus:T}),o(x[0],k),setTimeout(function(){E=!1,v=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&A(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){A(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&A(w,!0)}),z.onclick=function(w){A(w,!1)},s.appendChild(z)}),u.onclick=function(){s.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(x){x.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(x.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(x){if(s.classList.contains("renuvex-pr-open")&&!v){var k=x.relatedTarget;k&&d.contains(k)||b()}});var g=Cr({trigger:d,element:s,close:b});return d.appendChild(u),d.appendChild(s),l.appendChild(d),l}var qt=`
...
`;var Va={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Wa=na,qa="__unknown_product__",rr=Object.create(null);function Ga(e){return e?String(e):qa}var Le=null,tr=null;function Ka(){!Le||!tr||(Le.removeEventListener?Le.removeEventListener("change",tr):Le.removeListener&&Le.removeListener(tr),Le=null,tr=null)}function Xa(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange,v=Ga(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var b=document.createElement("div");b.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+_e(i,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+xe(ht)+"</span>";var g=m.querySelector(".renuvex-pr-compact-trigger-text"),x=m.querySelector(".renuvex-pr-compact-chevron");if(g&&(g.textContent=o.toLocaleString("tr-TR")+" "+B(a.countLabel,"Yorum")),g&&x){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",m.insertBefore(k,g),k.appendChild(g),k.appendChild(x)}b.appendChild(m),c.appendChild(b);var h=J({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p}),z=h.querySelector(".renuvex-pr-filter-wrap"),E=h.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+re("full")+"</span><span>"+i+"</span>",T.appendChild(S),T.appendChild(De({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){P()&&w.classList.contains("renuvex-pr-open")&&(rr[v]=!0),s(I)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function C(I){I?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",I?"false":"true"),m.setAttribute("aria-expanded",I?"true":"false")}function N(I){var M=I?y:b;if(w.parentNode!==M){var q=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&C(!1),q&&(rr[v]=!1),M.appendChild(w)}}N(L?L.matches:!1);var Y=J({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p}),G=Y.querySelector(".renuvex-pr-filter-wrap"),Z=Y.querySelector(".renuvex-pr-write-btn"),D=document.createElement("div");D.className="renuvex-pr-compact-write-row",Z&&D.appendChild(Z),G&&D.appendChild(G),y.appendChild(D);function O(){var I=w.classList.contains("renuvex-pr-open");return C(!1),P()&&(rr[v]=!1),I}function pe(){V&&V.notifyOpening(),C(!0),P()&&(rr[v]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?O():pe()};var V=null;function W(I){V&&(V.unregister(),V=null),I||(V=Cr({trigger:b,element:w,close:O}))}if(W(L?L.matches:!1),Ka(),L){var K=function(I){N(I.matches),W(I.matches)};L.addEventListener?L.addEventListener("change",K):L.addListener&&L.addListener(K),Le=L,tr=K}if(P()&&rr[v]&&C(!0),a.showRecommendation!==!1){var ce=(l[3]||0)+(l[4]||0),$=o>0?Math.round(ce/o*100):0;if($>0){var j=document.createElement("div");j.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="renuvex-pr-recommend-pct">%'+$+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(j)}}return y}var Wr={};we(Wr,{css:()=>Za,meta:()=>Ja,render:()=>$a});var ia=`
...
`;var on={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},ln=sa;function pn(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var o=document.createElement("span");o.className="renuvex-pr-review-stars",o.innerHTML=fe(e.rating,R),n.appendChild(o);var l=document.createElement("time");if(l.className="renuvex-pr-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=ge(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var u=(e.comment||"").trim();u&&t.appendChild(Ve(u,"renuvex-pr-body").fragment);var f=ke(e);if(f.length){var s=document.createElement("div");s.className="renuvex-pr-gallery",f.forEach(function(v){var y=document.createElement("img"),c=ue(v,X);y.src=c.src,y.srcset=c.srcset,y.loading="lazy",y.decoding="async",y.width=X,y.height=X,y.className="renuvex-pr-img",se(y),y.setAttribute("data-renuvex-img-url",v),(function(b){Se(y,function(){ve(e,b,r)})})(v),s.appendChild(y)}),t.appendChild(s)}var p=We(e.merchantReply);return p&&t.appendChild(p),t}var Xr={};we(Xr,{css:()=>sn,meta:()=>un,render:()=>dn});var da=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var un={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},sn=da;function dn(e,r){var t=ke(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-list-author";var l=document.createElement("span");l.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",l.innerHTML=fe(e.rating,R),o.appendChild(l);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",o.appendChild(i);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=ge(e.createdAt),o.appendChild(d),n.appendChild(o);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var f=document.createElement("div");f.className="renuvex-pr-review-list-title",f.textContent=e.title,u.appendChild(f)}var s=(e.comment||"").trim();s&&u.appendChild(Ve(s,"renuvex-pr-review-list-body").fragment);var p=We(e.merchantReply);if(p&&u.appendChild(p),n.appendChild(u),a){var v=document.createElement("div");v.className="renuvex-pr-review-list-media",t.forEach(function(y){var c=document.createElement("img"),b=ue(y,X);c.src=b.src,c.srcset=b.srcset,c.loading="lazy",c.decoding="async",c.width=X,c.height=Math.round(X*4/3),c.setAttribute("data-renuvex-img-url",y),se(c),(function(m){Se(c,function(){ve(e,m,r)})})(y),v.appendChild(c)}),n.appendChild(v)}return n}var Jr={};we(Jr,{css:()=>cn,meta:()=>vn,render:()=>mn});var va=`
...
`;var vn={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},cn=va;function mn(e,r){var t=cr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-gallery-content";var l=document.createElement("span");if(l.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",l.innerHTML=fe(e.rating,R),o.appendChild(l),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,o.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",o.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=ge(e.createdAt),o.appendChild(u);var f=(e.comment||"").trim();if(f&&o.appendChild(Ve(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ve(e,t,r)}}:null).fragment),n.appendChild(o),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var p=document.createElement("img"),v=ue(t,mr);p.src=v.src,p.srcset=v.srcset,p.loading="lazy",p.decoding="async",p.width=mr,p.height=Math.round(mr*4/3),se(p),p.setAttribute("data-renuvex-img-url",t),Se(p,function(){ve(e,t,r)}),s.appendChild(p),n.appendChild(s)}var y=We(e.merchantReply,t?function(){ve(e,t,r)}:null);return y&&(y.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(y)),n}var Ar={card:Kr,list:Xr,gallery:Jr};function Lr(e){return Ar[e]||Ar.card}function ca(){return Object.keys(Ar).map(function(e){return Ar[e].css||""}).join(`
`)}var Zr=0;function qe(){return Zr++,Zr}function Ge(e,r){return e!==Zr?!1:r?!(r.productId!==void 0&&H!==r.productId||r.orderBy!==void 0&&ee!==r.orderBy||r.page!==void 0&&or!==r.page||r.ratingFilter!==void 0&&oe!==r.ratingFilter||r.hasImages!==void 0&&le!==r.hasImages):!0}var $r={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Qr={small:80,medium:110,large:140},et={small:80,medium:100,large:110};function ma(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var o=document.createElementNS(t,"line");o.setAttribute("x1","1"),o.setAttribute("y1","1"),o.setAttribute("x2","23"),o.setAttribute("y2","23"),a.appendChild(n),a.appendChild(o);var l=document.createElement("div");l.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",l.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(l),r.appendChild(i),r}function xa(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function be(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),o=parseInt(t[3],16);return"rgba("+a+","+n+","+o+","+r+")"}function Pr(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function rt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function fa(e){return .2126*rt(e.r)+.7152*rt(e.g)+.0722*rt(e.b)}function ga(e,r){var t=fa(e),a=fa(r),n=Math.max(t,a),o=Math.min(t,a);return(n+.05)/(o+.05)}function xn(e){var r=Pr(e)||Pr("#ffffff"),t=Pr("#111111"),a=Pr("#ffffff");return ga(t,r)>=ga(a,r)?"#111111":"#ffffff"}function fn(e){return be(e,e==="#ffffff"?.1:.06)}function ha(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",o=r.headerRecommendColor||"#111111",l=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=be(l,.06),f=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",v=r.btnBorderColor||"#111111",y=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",b=r.filterBtnBorderColor||"#111111",m=r.filterMenuBgColor||"#ffffff",g=r.filterMenuBorderColor||"#e5e7eb",x=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",h=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",E=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",w=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",S=be(w,.65),L=r.replyBgColor||"#f9fafb",P=r.replyBorderColor||"#747474",C=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",Y=r.photoTitleColor||"#111111",G=be("#111111",.05),Z=r.photoArrowBgColor||"#ffffff",D=r.photoArrowTextColor||"#111111",O=be("#111111",.12),pe=r.formBgColor||"#ffffff",V=r.formPrimaryTextColor||"#111111",W=r.formSecondaryTextColor||"#3b3b3b",K=r.inputTextColor||V,ce=r.inputBorderColor||"#d1d5db",$=r.placeholderColor||"#9ca3af",j=r.formStepBarColor||"#111111",I=r.formBtnBgColor||"#111111",M=r.formBtnTextColor||"#ffffff",q=r.formBtnBorderColor||"#111111",ne=be(I,.06),ar=be(I,.18),ye=be(M,.85),_=be(V,.06),ie=xn(pe),F=fn(ie),Q=r.loadMoreBgColor||"#ffffff",nr=r.loadMoreTextColor||"#111111",ir=r.loadMoreBorderColor||"#111111",Ke={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":o,"--renuvex-pr-bar-fill":l,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":v,"--renuvex-pr-filter-btn-bg":y,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":b,"--renuvex-pr-filter-menu-bg":m,"--renuvex-pr-filter-menu-border":g,"--renuvex-pr-filter-item-text":x,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":h,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":E,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":w,"--renuvex-pr-review-border":T,"--renuvex-pr-state-text":S,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":P,"--renuvex-pr-reply-label":C,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":Y,"--renuvex-pr-photo-image-border":G,"--renuvex-pr-photo-arrow-bg":Z,"--renuvex-pr-photo-arrow-text":D,"--renuvex-pr-photo-arrow-border":O,"--renuvex-pr-fwizard-bg":pe,"--renuvex-pr-fwizard-text":V,"--renuvex-pr-fwizard-secondary-text":W,"--renuvex-pr-fwizard-input-bg":pe,"--renuvex-pr-fwizard-input-text":K,"--renuvex-pr-fwizard-input-border":ce,"--renuvex-pr-fwizard-placeholder":$,"--renuvex-pr-fwizard-close-text":ie,"--renuvex-pr-fwizard-close-hover-bg":F,"--renuvex-pr-fwizard-progress-bg":_,"--renuvex-pr-fwizard-progress-active":j,"--renuvex-pr-fwizard-btn-bg":I,"--renuvex-pr-fwizard-btn-text":M,"--renuvex-pr-fwizard-btn-border":q,"--renuvex-pr-fwizard-btn-disabled-bg":ar,"--renuvex-pr-fwizard-btn-disabled-text":ye,"--renuvex-pr-fwizard-nav-hover-bg":ne,"--renuvex-pr-load-more-bg":Q,"--renuvex-pr-load-more-text":nr,"--renuvex-pr-load-more-border":ir};Object.keys(Ke).forEach(function(me){e.style.setProperty(me,Ke[me])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function ba(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,o=e.wireLightboxTrigger,l=(e.photoStripReviews||[]).filter(function(k){return ke(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&l.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=B(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),u=document.createElement("div");u.className="renuvex-pr-photo-title",u.textContent=d,i.appendChild(u)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var p=X,v=r.reviewLayout==="card"?X:Math.round(X*4/3),y=0;l.forEach(function(k){if(!(y>=15)){var h=cr(k);if(h){var z=document.createElement("img"),E=ue(h,X);z.src=E.src,z.srcset=E.srcset,z.loading=y<3?"eager":"lazy",z.decoding="async",z.width=p,z.height=v,z.className="renuvex-pr-photo-strip-thumb",z.alt="Yorum foto\u011Fraf\u0131",se(z),(function(A,w){o(z,function(){n(w,A,l)})})(h,k),s.appendChild(z),y++}}});var c=document.createElement("button");c.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var b=te(Be);b&&c.appendChild(b),c.setAttribute("aria-label","\xD6nceki"),c.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var g=te(vr);g&&m.appendChild(g),m.setAttribute("aria-label","Sonraki"),m.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var x=document.createElement("div");return x.className="renuvex-pr-photo-strip-wrap",x.appendChild(c),x.appendChild(s),x.appendChild(m),i.appendChild(x),i}function ya(e){var r=e.render;async function t(){var o=qe(),l=H,i=ee,d=oe,u=le,f=await Me(H,ee,1,oe,le);Ge(o,{productId:l,orderBy:i,ratingFilter:d,hasImages:u})&&await r(H,R,f,Re,ee,1,nt)}async function a(o){var l=qe(),i=oe===o?null:o,d=H,u=ee,f=le;ot(i),Ie(1);var s=await Me(H,ee,1,i,le);Ge(l,{productId:d,orderBy:u,page:1,ratingFilter:i,hasImages:f})&&await r(H,R,s,Re,ee,1)}async function n(o,l){var i=qe(),d=H,u=oe;Ie(1);var f=o,s=!1;l&&(s=!0,f="newest"),lt(s),lr(f);var p=await Me(H,f,1,oe,s);Ge(i,{productId:d,orderBy:f,page:1,ratingFilter:u,hasImages:s})&&await r(H,R,p,Re,f,1)}return{onRetry:t,onFilterChange:a,onSortChange:n}}function gn(){return Tt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function hn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=Ct({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),Et(t,{surface:"reviews",productId:r||""}),t}async function tt(e,r,t,a,n,o,l){if(ft){sr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:o,badgeSettings:l});return}ur(!0),pt(e),ut(r),l!==void 0&&st(l),dt(a),n&&lr(n),o&&Ie(o),t!=null&&vt(t);var i=ya({render:tt});try{let ye=function(_,ie){if(!(!_||!_.meta||!_.meta.sizeOverrides)){var F=_.meta.sizeOverrides[ie];F&&Object.keys(F).forEach(function(Q){v.style.setProperty(Q,F[Q])})}};var ar=ye,d=Tr(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,s=B(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),p=u&&f?s:"",v=document.documentElement;ha(v,r);var y=r.borderRadius!==void 0?r.borderRadius:8,c=$r[r.size]||$r.medium,b=Qr[r.thumbnailSize]||Qr.medium,m=b;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(m=et[r.thumbnailSize]||et.medium),v.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),v.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),v.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),v.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),v.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),v.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),v.style.setProperty("--renuvex-pr-radius",y+"px"),v.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),v.style.setProperty("--renuvex-pr-photo-title-size",c.photoTitleSize+"px"),v.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),v.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),v.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),v.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),v.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),v.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),v.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),v.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),v.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),v.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),v.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),v.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),v.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),v.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),v.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size",b+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size-mobile",m+"px");var g=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";v.style.setProperty("--renuvex-pr-review-star-color",g),v.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),v.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),ye(Tr(r.summaryLayout),r.size),ye(Lr(r.reviewLayout),r.size);var x=Ze(r),k=gn();if(!k)return;var h=hn(k,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==h&&h.appendChild(z);var E=At(z),A=Fe+Pe+gr+ua()+ca();Oe(E,A);var w=Pt(E);if(r.enabled===!1){z.style.minHeight="auto",w.replaceChildren(ma(r.borderRadius!==void 0?r.borderRadius:8)),ur(!1);var T=pr;sr(null),T&&tt(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var S=t||{},L=_r(S),P=L?[]:S.data&&S.data.reviews||[];ct(P),w.replaceChildren();var C=document.createElement("section");if(C.id="renuvex-reviews-widget",C.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),C.className="renuvex-pr-reviews-widget",C.setAttribute("data-renuvex-surface","reviews"),e&&C.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(C.style.width="100%",C.style.maxWidth="100%",C.style.marginLeft="0",C.style.marginRight="0"),p){var N=document.createElement("div"),Y=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+Y,N.textContent=p,C.appendChild(N)}if(L){C.appendChild(xa(S.message,i.onRetry)),w.appendChild(C),Ce(E),Nr(C,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return E.getElementById("renuvex-reviews-widget")});return}var G=S.data&&S.data.allCount||0,Z=S.data&&S.data.ratingCounts||null,D=Z||[0,0,0,0,0],O=S.data&&S.data.avgRating||"0.0";if(!Z&&P.length>0){P.forEach(function(_){_.rating>=1&&_.rating<=5&&D[_.rating-1]++});var pe=P.reduce(function(_,ie){return _+ie.rating},0);O=(pe/P.length).toFixed(1)}if(G>0){var V=Tr(r.summaryLayout),W=V.render({widget:C,productId:e,data:S,settings:r,iconPair:x,allCount:G,ratingCounts:D,avgRatingVal:O,currentRatingFilter:oe,currentOrderBy:ee,currentHasImages:le,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});C.appendChild(W)}else{var K=document.createElement("button");K.className="renuvex-pr-write-btn",K.style.cssText="display:block;margin:16px auto 0;",K.textContent=B(r.writeButtonText,"Yorum Yap"),K.onclick=U,C.appendChild(K)}var ce=ba({settings:r,root:v,currentHasImages:le,photoStripReviews:it,openReviewModal:ve,wireLightboxTrigger:Se});if(ce&&C.appendChild(ce),P.length===0){var $=document.createElement("p");$.className="renuvex-pr-state-msg",$.textContent="Hen\xFCz yorum yok.",C.appendChild($)}else{var j=Lr(r.reviewLayout);P.forEach(function(_){C.appendChild(j.render(_,Rr))})}var I=S.data&&S.data.hasMore;if(I){var M=document.createElement("button");M.className="renuvex-pr-load-more",M.textContent="Daha Fazla G\xF6ster",M.onclick=async function(){M.disabled=!0,M.textContent="Y\xFCkleniyor...";var _=qe(),ie=H,F=ee,Q=or,nr=oe,ir=le,Ke=Q+1,me=await Me(ie,F,Ke,nr,ir);if(Ge(_,{productId:ie,orderBy:F,page:Q,ratingFilter:nr,hasImages:ir}))if(me&&!_r(me)&&me.data&&Array.isArray(me.data.reviews)){var at=mt(me.data.reviews);xt(at),Ie(Ke);var wa=Lr(R.reviewLayout);at.forEach(function(za){C.insertBefore(wa.render(za,Rr),M)}),me.data.hasMore?(M.disabled=!1,M.textContent="Daha Fazla G\xF6ster"):M.remove()}else M.disabled=!1,M.textContent="Tekrar Dene"},C.appendChild(M)}w.appendChild(C),Ce(E),Nr(C,"reviews-widget",{productId:e||""},function(){return E.getElementById("renuvex-reviews-widget")})}catch(_){console.error("[renuvex-pr] render error:",_);var q=document.createElement("p");q.style.cssText="text-align:center;color:#dc2626;",q.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",w&&w.replaceChildren(q)}}finally{if(ur(!1),pr){var ne=pr;sr(null),tt(ne.productId,ne.settings,ne.reviewsData,ne.productName,ne.orderBy,ne.page,ne.badgeSettings)}}}export{tt as render};
