...
`}var il=La(ri),ti=La(xr);function ai(e,r){var d;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let a=t.get("media-theme-gerwig"),n=a==null?void 0:a.template;if(!a||!(n instanceof HTMLTemplateElement))return;let i=n.cloneNode(!0);i.id=e,(d=i.content.querySelector("media-controller"))==null||d.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class l extends a{}l.template=i,t.define(e,l)}function ni(e,r){return typeof window=="undefined"?Promise.resolve():(Jr!=null||(Jr=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),Jr.then(()=>{ai(e,r)}))}function Ra(){return ni(ei,ti)}var bt=null,Ia="--center-play-button";function ii(){return bt||(bt=Ra()),bt}function oi(e){return new Promise(function(r){function t(a){if(a<=0){r();return}requestAnimationFrame(function(){t(a-1)})}t(e)})}function li(e){e.style.setProperty(Ia,"none")}function Na(e){e.style.removeProperty(Ia)}function di(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=ga(e.url);return r&&t&&r!==t?"":r||t}function pi(e,r){var t=di(r);if(!t)return!1;var a=Xe(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("nohotkeys",""),e.setAttribute("lang","tr"),e.setAttribute("theme",_a),e.setAttribute("accent-color",xr.controlForeground),e.setAttribute("primary-color",xr.controlForeground),e.setAttribute("secondary-color",xr.controlBackground),a&&e.setAttribute("poster",a),e.setAttribute("playback-id",t),!0}function Ba(e){e.preventDefault()}function Fa(e,r){var t=!1,a=document.createElement("mux-player");a.className=r||"renuvex-pr-modal-main-video",a.setAttribute("aria-label","Yorum videosu"),li(a),a.addEventListener("contextmenu",Ba);var n=pi(a,e);return n?ii().then(function(){if(window.customElements&&typeof window.customElements.whenDefined=="function")return window.customElements.whenDefined("mux-player")}).then(function(){if(!t){try{typeof a.pause=="function"&&a.pause()}catch(i){}return oi(2)}}).then(function(){t||Na(a)}).catch(function(){t||a.dispatchEvent(new Event("error"))}):setTimeout(function(){t||a.dispatchEvent(new Event("error"))},0),{element:a,cleanup:function(){t=!0;try{typeof a.pause=="function"&&a.pause()}catch(o){}a.removeAttribute("playback-id"),a.removeAttribute("playback-token"),a.removeAttribute("thumbnail-token"),a.removeAttribute("poster"),Na(a),a.removeEventListener("contextmenu",Ba)}}}function er(e){return Ne(e)}function Ua(e){return e&&e.source==="mediaGallery"}function ui(e,r){if(!Ua(r))return er(e);var t=fe(e);return t?[t]:[]}function si(e,r){return(e||[]).filter(function(t){return r==="mediaGallery"?!!fe(t):er(t).length>0})}function wt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Oa(e,r,t,a,n,i){e&&e.shadowRoot&&wt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),Wr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Ir(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(n)}function vi(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ze(e.rating,N);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Se(e.createdAt),a.appendChild(n),a.appendChild(i),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var c=document.createElement("div");c.className="renuvex-pr-modal-reply-label",c.textContent=D(N&&N.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",u.appendChild(c),u.appendChild(v),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Va(e,r,t){var a=t||N,n=e.querySelector(".renuvex-pr-modal-scroll-content"),i=n.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ze(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=Se(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=n.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=D(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}var ci=112;function kt(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function mi(e,r,t){if(!r||r.type!=="video"||!t)return!1;var a=kt(e);if(!a)return!1;var n=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!n||typeof n.getBoundingClientRect!="function")return!1;var i=n.getBoundingClientRect();if(!i.width||!i.height||a.clientX<i.left||a.clientX>i.right||a.clientY<i.top||a.clientY>i.bottom)return!1;var o=Math.min(ci,Math.max(72,i.height*.2));return a.clientY>=i.bottom-o}function fi(e){var r=e&&e.type==="video"?e.posterUrl:e&&e.url;if(e&&e.type==="video"){var t={width:Ce,height:Ce,fit:"crop"};return{src:Xe(r,t),srcset:Vr(r,t)}}return cr(r,Ce)}function xi(e,r,t){var a=e&&e.media;if(!a)return null;var n=document.createElement("button");n.type="button",n.className="renuvex-pr-modal-thumb renuvex-pr-modal-thumb-button"+(a.type==="video"?" renuvex-pr-modal-thumb-video":"")+(r?" renuvex-pr-modal-thumb-active":""),n.setAttribute("aria-label","Galeri medyas\u0131 "+(e.index+1)+" se\xE7"),r&&n.setAttribute("aria-current","true");var i=document.createElement("img");i.className="renuvex-pr-modal-thumb-img";var o=fi(a);if(i.src=o.src,o.srcset&&(i.srcset=o.srcset),i.loading="lazy",i.decoding="async",i.width=Ce,i.height=Ce,i.alt="",mr(i),n.appendChild(i),a.type==="video"){var l=document.createElement("span");l.className="renuvex-pr-modal-thumb-play";var d=re(Ke);d&&l.appendChild(d),n.appendChild(l);var u=Hr(a.durationMs);if(u){var c=document.createElement("span");c.className="renuvex-pr-modal-thumb-duration",c.textContent=u,n.appendChild(c)}}return n.onclick=t,n}function gi(e){var r=[];return(e||[]).forEach(function(t,a){var n=fe(t);n&&r.push({review:t,reviewIdx:a,media:n,index:r.length})}),r}function zt(e,r,t,a,n,i,o,l,d){var u=ui(e,d),c=Math.max(0,Math.min(t||0,u.length-1)),v=u[c],p=document.createElement("div");p.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Fa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),m=x.element;m.addEventListener("error",function(){if(!p.querySelector(".renuvex-pr-modal-img-error")){var _=document.createElement("div");_.className="renuvex-pr-modal-img-error",_.setAttribute("role","status"),_.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",p.insertBefore(_,m)}}),p.__renuvexMediaCleanup=x.cleanup,p.appendChild(m)}else{var f=document.createElement("img");if(f.className="renuvex-pr-modal-main-img"+(s?" "+s:""),f.src=ft(v?v.url:""),f.decoding="async",f.width=mt,f.height=Math.round(mt*4/3),f.alt="Yorum foto\u011Fraf\u0131",!s){f.classList.add("renuvex-pr-modal-img-loading");var h=function(){f.classList.remove("renuvex-pr-modal-img-loading")};f.complete&&f.naturalWidth>0?h():(f.addEventListener("load",h,{once:!0}),f.addEventListener("error",h,{once:!0}))}ca(f,function(_){if(_.style.display="none",!p.querySelector(".renuvex-pr-modal-img-error")){var B=document.createElement("div");B.className="renuvex-pr-modal-img-error",B.setAttribute("role","status"),B.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(B,_)}}),p.appendChild(f)}var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var E=re(ke);E&&b.appendChild(E),b.setAttribute("aria-label","Kapat"),b.onclick=function(_){_.stopPropagation(),i()},p.appendChild(b);var P=0,z=!1;if(p.addEventListener("touchstart",function(_){var B=kt(_);B&&(P=B.clientX,z=mi(_,v,p))},{passive:!0}),p.addEventListener("touchend",function(_){if(z){z=!1;return}var B=kt(_);if(B){var j=P-B.clientX;if(!(Math.abs(j)<50)){if(j>0){if(w)ge(e,r,c+1,a,n,i,!0,"next",l,d);else if(T){var I=a[r+1];ge(I,r+1,0,a,n,i,!1,"next",l,d)}}else if(A)ge(e,r,c-1,a,n,i,!0,"prev",l,d);else if(S){var U=a[r-1],Y=er(U);ge(U,r-1,Y.length-1,a,n,i,!1,"prev",l,d)}}}},{passive:!0}),Ua(d)){var C=gi(a);if(C.length>1){var g=document.createElement("div");g.className="renuvex-pr-modal-thumbs renuvex-pr-modal-thumbs--gallery",C.forEach(function(_){var B=xi(_,_.reviewIdx===r,function(){ge(_.review,_.reviewIdx,0,a,n,i,!1,null,l,d)});B&&g.appendChild(B)}),p.appendChild(g)}}else if(u.length>1){var k=document.createElement("div");k.className="renuvex-pr-modal-thumbs",u.forEach(function(_,B){var j=_.type==="video"?_.posterUrl:_.url,I=document.createElement("img"),U=cr(j,Ce);I.src=U.src,I.srcset=U.srcset,I.loading="lazy",I.decoding="async",I.width=Ce,I.height=Ce,I.className="renuvex-pr-modal-thumb"+(B===c?" renuvex-pr-modal-thumb-active":""),I.alt="K\xFC\xE7\xFCk resim "+(B+1),mr(I),I.tabIndex=0,I.setAttribute("role","button"),I.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(B+1)+" se\xE7"),B===c&&I.setAttribute("aria-current","true"),(function(Y){function W(){ge(e,r,Y,a,n,i,!0,null,l,d)}I.onclick=W,I.onkeydown=function(H){(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),W())}})(B),k.appendChild(I)}),p.appendChild(k)}var A=c>0,w=c<u.length-1,S=r>0,T=r<a.length-1,L=A||S,O=w||T;if(L){var y=document.createElement("button");y.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var M=re(qe);M&&y.appendChild(M),y.setAttribute("aria-label","\xD6nceki"),y.onclick=function(_){if(_.stopPropagation(),A)ge(e,r,c-1,a,n,i,!0,"prev",l,d);else if(S){var B=a[r-1],j=er(B);ge(B,r-1,j.length-1,a,n,i,!1,"prev",l,d)}},p.appendChild(y)}if(O){var R=document.createElement("button");R.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var F=re(Fr);F&&R.appendChild(F),R.setAttribute("aria-label","Sonraki"),R.onclick=function(_){if(_.stopPropagation(),w)ge(e,r,c+1,a,n,i,!0,"next",l,d);else if(T){var B=a[r+1];ge(B,r+1,0,a,n,i,!1,"next",l,d)}},p.appendChild(R)}return p}function Ha(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=er(a);n[0]&&n[0].type==="image"&&(new Image().src=ft(n[0].url))}})}function yt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function hi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){yt(t),yt(a),yt(n)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function ge(e,r,t,a,n,i,o,l,d,u){if(u&&(u.currentReview=e),o){var c=zt(e,r,t,a,n,i,l,d,u);n.firstChild&&(wt(n.firstChild),n.replaceChild(c,n.firstChild))}else{var c=zt(e,r,t,a,n,i,l,d,u),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&(wt(n.firstChild),n.replaceChild(c,n.firstChild)),v&&Va(v,e,u&&u.currentSettings),hi(d,n)}Ha(r,a)}function he(e,r,t,a){var n=a&&a.source==="mediaGallery"?"mediaGallery":"review",i=n==="mediaGallery"?fe(e)?[fe(e)]:[]:er(e);if(!i.length)return;var o=si(t,n),l=o.findIndex(function(w){return w===e||w.id===e.id});l===-1&&(o.unshift(e),l=0);var d=i.findIndex(function(w){return w.url===r});d<0&&(d=0);var u=document.createElement("div");u.className="renuvex-pr-modal-overlay";var c=document.createElement("div");c.className="renuvex-pr-modal";var v=!1,p=null,s=Gr(),x=Pe(),m=jr(),f=Kr(),h={currentReview:e,currentSettings:N,source:n},b=null;function E(w){var S=w&&w.detail&&w.detail.settings;if(!(S&&S===b)){b=S||null,h.currentSettings=S||N;var T=c.querySelector(".renuvex-pr-modal-right");!T||!h.currentReview||Va(T,h.currentReview,h.currentSettings)}}function P(){v||(v=!0,window.removeEventListener(Ve,E),Oa(p&&p.host,z,P,m,s,x))}function z(w){if(w.key==="Escape"){C();return}qr(w,u,p&&p.root)}function C(){v||(v=!0,window.removeEventListener(Ve,E),Oa(p&&p.host,z,P,m,s,x),Xr(f))}document.addEventListener("keydown",z),window.addEventListener("popstate",P),window.addEventListener(Ve,E),u.onclick=function(){C()},c.onclick=function(w){w.stopPropagation()},c.appendChild(zt(e,l,d,o,c,C,null,u,h)),c.appendChild(vi(e)),Ha(l,o);var g=document.createElement("div");g.className="renuvex-pr-modal-wrap",g.tabIndex=-1,g.setAttribute("role","dialog"),g.setAttribute("aria-modal","true"),g.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),g.appendChild(c);var k=document.createElement("button");k.className="renuvex-pr-modal-close";var A=re(ke);A&&k.appendChild(A),k.setAttribute("aria-label","Kapat"),k.onclick=function(w){w.stopPropagation(),C()},g.appendChild(k),u.appendChild(g),p=Dr(),Je(p.root,$e+Ge+Yr),p.root.appendChild(u),Ue(p.root),ve(g)}function gr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var _t={};Me(_t,{css:()=>ao,meta:()=>to,render:()=>no});function rr(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,i=e.onFilterChange;Le(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,u=t>0?Math.round(d/t*100):0,c=n===l,v=d>0,p=D(N&&N.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(c?" renuvex-pr-bar-active":"")+(n&&!c?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",c?"true":"false"),s.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+p+", "+(c?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+p);for(var x="",m=1;m<=5;m++){var f=m<=l;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(f?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(E){(E.key==="Enter"||E.key===" "||E.key==="Space"||E.key==="Spacebar")&&(E.preventDefault(),b())}})(l),o.appendChild(s)}return o}var ja="data-renuvex-pr-dismiss-gesture",De=[],Da=!1,Zr=!1,hr=[],tr=null;function Ya(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function St(){for(var e=De.length-1;e>=0;e--){var r=De[e].element;r&&r.isConnected===!1&&De.splice(e,1)}return De}function bi(e){!e||typeof e.setAttribute!="function"||(hr.indexOf(e)===-1&&hr.push(e),e.setAttribute(ja,""))}function Wa(){for(var e=0;e<hr.length;e++){var r=hr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(ja)}hr=[],tr&&typeof clearTimeout=="function"&&clearTimeout(tr),tr=null}function yi(e){if(Zr){Zr=!1,Wa(),e.preventDefault(),e.stopPropagation();return}for(var r=St(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Ya(e,n.trigger)||Ya(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function wi(e){if(e.key==="Escape")for(var r=St(),t=r.length-1;t>=0;t--)r[t].close()}function Ga(){Da||typeof document=="undefined"||(document.addEventListener("click",yi,!0),document.addEventListener("keydown",wi),Da=!0)}function ki(e){Ga(),Zr=!0,bi(e),tr&&typeof clearTimeout=="function"&&clearTimeout(tr),typeof setTimeout=="function"&&(tr=setTimeout(function(){Zr=!1,Wa()},700))}function Ct(e){ki(e)}function Qr(e){Ga();var r={trigger:e.trigger,element:e.element,close:e.close};return De.push(r),{unregister:function(){var t=De.indexOf(r);t!==-1&&De.splice(t,1)},notifyOpening:function(){for(var t=St(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function de(e){var r=e.widget,t=e.currentOrderBy,a=e.currentMediaFilter||"none",n=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=D(N&&N.writeButtonText,"Yorum Yap"),l.onclick=n,o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var c=N&&N.filterIcon||"lines";u.innerHTML=se(la(c));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var p=Kt===!0?"media":"images",s=p==="media"?"Foto\u011Fraf ve Video":"Foto\u011Frafl\u0131",x=[{orderBy:"newest",label:"En Yeni",mediaFilter:"none"},{orderBy:"highest",label:"En Y\xFCksek Puan",mediaFilter:"none"},{orderBy:"lowest",label:"En D\xFC\u015F\xFCk Puan",mediaFilter:"none"},{orderBy:"newest",label:s,mediaFilter:p}],m=!1;function f(){return r&&r.parentNode||r||null}function h(z,C){if(!(C===!0||!z)){if(z.type==="touchstart"){Ct(f());return}if(z.type==="pointerdown"){var g=z.pointerType||"";g&&g!=="mouse"&&Ct(f())}}}function b(z){var C=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var g=z&&(z.restoreFocus===!0||z.restoreFocus==="auto"&&Pe());if(C&&g)try{u.focus({preventScroll:!0})}catch(k){try{u.focus()}catch(A){}}return C}function E(){P.notifyOpening(),v.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var z=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");z&&requestAnimationFrame(function(){try{z.focus({preventScroll:!0})}catch(C){try{z.focus()}catch(g){}}})}x.forEach(function(z){var C=z.mediaFilter!=="none",g=C?a===z.mediaFilter:a==="none"&&(t||"newest")===z.orderBy,k=document.createElement("button");k.type="button",k.className="renuvex-pr-filter-item"+(g?" renuvex-pr-filter-item-active":""),k.setAttribute("role","menuitem"),k.textContent=z.label;var A=!1;function w(S,T){S&&(S.preventDefault(),S.stopPropagation()),!A&&(A=!0,m=!0,h(S,T),b({restoreFocus:T}),i(z.orderBy,z.mediaFilter),setTimeout(function(){A=!1,m=!1},0))}k.addEventListener("pointerdown",function(S){S.button!==void 0&&S.button!==0||S.pointerType!=="mouse"&&w(S,!1)}),typeof window!="undefined"&&!window.PointerEvent&&k.addEventListener("touchstart",function(S){w(S,!1)},{passive:!1}),k.addEventListener("keydown",function(S){(S.key==="Enter"||S.key===" ")&&w(S,!0)}),k.onclick=function(S){w(S,!1)},v.appendChild(k)}),u.onclick=function(){v.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):E()},d.addEventListener("keydown",function(z){z.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(z.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(z){if(v.classList.contains("renuvex-pr-open")&&!m){var C=z.relatedTarget;C&&d.contains(C)||b()}});var P=Qr({trigger:d,element:v,close:b});return d.appendChild(u),d.appendChild(v),o.appendChild(d),o}var qa=`
...
`;function Ka(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,a=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,n=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",o.appendChild(l);var d=document.createElement("button");d.className="renuvex-pr-fwizard-close",d.type="button",d.setAttribute("aria-label","Kapat");var u=re(ke);u&&d.appendChild(u),o.appendChild(d);var c=!1,v=null,p=null,s=!1;function x(){ve(i)}function m(g){qr(g,i,v&&v.root)}function f(){if(!c){if(c=!0,document.removeEventListener("keydown",h),i.removeEventListener("click",b),d.removeEventListener("click",f),s)ve(p);else{var g=v&&v.root?v.root.activeElement:null;if(g&&typeof g.blur=="function")try{g.blur()}catch(k){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){v?(Ir(v.root),v.host&&v.host.parentNode&&v.host.parentNode.removeChild(v.host)):i.parentNode&&i.parentNode.removeChild(i),Wr();try{r()}catch(k){}},200)}}function h(g){if(g.key==="Escape"){f();return}m(g)}function b(g){g.target===i&&n&&f()}document.addEventListener("keydown",h),i.addEventListener("click",b),d.addEventListener("click",f);function E(g){p=t||Gr(),s=a===null?Pe():a,g&&l.appendChild(g),v=Dr(),Je(v.root,$e+Ge+qa),v.root.appendChild(i),Ue(v.root),jr(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),x()})}var P=null,z=null;function C(g,k){if(k=k||"error",P){try{P.remove()}catch(A){}P=null}z&&(clearTimeout(z),z=null),P=document.createElement("div"),P.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+k,P.textContent=g,o.appendChild(P),z=setTimeout(function(){P&&(P.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(P){try{P.remove()}catch(A){}P=null}},300))},4e3)}return{open:E,close:f,content:l,setAllowOutsideClose:function(g){n=!!g},setStepAttr:function(g){o.setAttribute("data-step",String(g))},showToast:C}}var Et=4;function ar(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Xa(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(i){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Et&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(i){return i!==n})}}}}function $a(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=se(qe)+"<span>Geri</span>",l.addEventListener("click",function(){a()}),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var u=[],c=0;c<Et;c++){var v=document.createElement("span");v.className="renuvex-pr-fwizard-progress-seg",d.appendChild(v),u.push(v)}o.appendChild(d);var p=document.createElement("button");p.type="button";var s=null;function x(f){s&&p.removeEventListener("click",s),s=f,f&&p.addEventListener("click",f)}o.appendChild(p);function m(f,h){var b=r.indexOf(f)!==-1,E=t.indexOf(f)!==-1,P=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0||!!h.videoUpload);if(b)f===2&&P?(p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",x(function(){i()})):(p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.setAttribute("aria-label","Atla"),p.innerHTML="<span>Atla</span>",x(function(){n()})),p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),p.style.visibility="",p.tabIndex=0;else if(E){p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Sonraki"),p.innerHTML="Sonraki",p.style.visibility="",p.tabIndex=0;var z=ar(f,h);p.disabled=!z,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!z),x(function(){p.disabled||i()})}else p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.innerHTML="",p.style.visibility="hidden",p.tabIndex=-1,p.disabled=!0,x(null)}return{el:o,update:function(f,h){u.forEach(function(E,P){P+1<=f?E.classList.add("renuvex-pr-fwizard-progress-seg-active"):E.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var b=f<=1;l.style.visibility=b?"hidden":"",l.style.pointerEvents=b?"none":"",l.tabIndex=b?-1:0,m(f,h)},setNextDisabled:function(f){p.classList.contains("renuvex-pr-fwizard-cta-btn")&&(p.disabled=!!f,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!f))},setThanksState:function(f){l.style.visibility="hidden",d.style.visibility="hidden",p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",p.style.visibility="",p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),x(f)}}}var zi={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ce(e){var r=N&&N[e];return!r&&e==="formStepMediaTitle"&&(r=N&&N.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=N&&N.formStepPhotosSubtitle),D(r,zi[e])}function Ja(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ce("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var l=vr(N||{});Le(l);var d=[];function u(f){d.forEach(function(h,b){var E=b<f;h.classList.toggle("renuvex-pr-fwizard-star-active",E),h.setAttribute("aria-checked",b+1===f?"true":"false"),h.innerHTML=E?ue("full"):ue("outline")})}function c(f){e.set({rating:f}),u(f)}function v(f){var h=d[f-1];if(h)try{h.focus()}catch(b){}}function p(f,h){h&&typeof h.preventDefault=="function"&&h.preventDefault(),h&&typeof h.stopPropagation=="function"&&h.stopPropagation(),!a&&(a=!0,c(f),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var s=1;s<=5;s++)(function(f){var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",f+" y\u0131ld\u0131z"),h.innerHTML=ue("outline"),h.addEventListener("mouseenter",function(){u(f)}),h.addEventListener("mouseleave",function(){u(e.get().rating)}),h.addEventListener("pointerdown",function(b){b.button&&b.button!==0||p(f,b)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){p(f,b)},{passive:!1}),h.addEventListener("mousedown",function(b){window.PointerEvent||p(f,b)}),h.addEventListener("keydown",function(b){if(b.key==="Enter"||b.key===" "){p(f,b);return}var E=0;b.key==="ArrowRight"||b.key==="ArrowUp"?E=Math.min(5,f+1):b.key==="ArrowLeft"||b.key==="ArrowDown"?E=Math.max(1,f-1):b.key==="Home"?E=1:b.key==="End"&&(E=5),E&&(b.preventDefault(),c(E),v(E))}),h.addEventListener("click",function(b){p(f,b)}),d.push(h),o.appendChild(h)})(s);u(e.get().rating);var x=null,m=function(f){var h=f&&f.detail&&f.detail.settings;h&&h===x||(x=h||null,l=vr(h||N||{}),u(e.get().rating))};return window.addEventListener(Ve,m),t.appendChild(o),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ve,m)}}}var et=3,Si=10*1024*1024;function rt(e,r){r=r||{};var t=!1,a=r.hideAddButton===!0,n=r.revealAddButtonAfterMedia===!0,i=!a||n,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=ce("formStepPhotosTitle"),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-step-subtitle",d.textContent=ce("formStepPhotosSubtitle"),o.appendChild(d)}var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&u.classList.add("renuvex-pr-fwizard-photo-card--embedded");var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-photo-add",c.setAttribute("aria-label","Foto\u011Fraf ekle");var v=document.createElement("input");v.type="file",v.accept="image/*",v.multiple=!0,v.style.display="none",i&&u.appendChild(c),u.appendChild(v);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),u.appendChild(p),o.appendChild(u);var s=r.revokeBlobUrl||function(z){z&&typeof z=="string"&&z.startsWith("blob:")&&URL.revokeObjectURL(z)},x=r.blobMap||{},m=r.urlToFinger||{};function f(){if(!t){var z=e.get().images||[],C=e.get().pendingImages||[],g=z.map(function(k){return{url:k,isPending:!1}}).concat(C.map(function(k){return{url:k.url,file:k.file,isPending:!0,error:k.error}}));p.innerHTML="",g.forEach(function(k){var A=x[k.url]||k.url,w=h(k,A);p.appendChild(w)}),E()}}function h(z,C){var g=document.createElement("div");g.className="renuvex-pr-fwizard-photo-thumb";var k=document.createElement("img");k.src=C,k.alt="",k.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",g.appendChild(k);var A=document.createElement("div");A.className="renuvex-pr-fwizard-photo-loading",A.style.display="none",g.appendChild(A);var w=document.createElement("button");w.type="button",w.className="renuvex-pr-fwizard-photo-remove",w.setAttribute("aria-label","Kald\u0131r");var S=re(ke);return S&&w.appendChild(S),g.appendChild(w),b(g,z,C),g}function b(z,C,g){var k=z.querySelector("img");k.src!==g&&(k.src=g);var A=z.querySelector(".renuvex-pr-fwizard-photo-loading");if(C.isPending&&C.error){A.style.display="flex",A.textContent="";var w=document.createElement("span");w.className="renuvex-pr-upload-error",w.textContent="\u2717 "+C.error,A.appendChild(w)}else A.style.display="none",A.textContent="";var S=z.querySelector(".renuvex-pr-fwizard-photo-remove");S.onclick=function(){var T=m[C.url]||(C.file?C.file.name+"_"+C.file.size:null),L=x[C.url],O={};T&&(O.fingerprints=(e.get().fingerprints||[]).filter(function(y){return y!==T})),C.isPending?O.pendingImages=(e.get().pendingImages||[]).filter(function(y){return y.url!==C.url}):O.images=(e.get().images||[]).filter(function(y){return y!==C.url}),e.set(O),s(C.url),s(L),delete m[C.url],L&&delete m[L],x[C.url]&&delete x[C.url]}}function E(){var z=(e.get().images||[]).length,C=(e.get().pendingImages||[]).length,g=z+C,k=g>=et;u.classList.toggle("renuvex-pr-fwizard-photo-card--compact",g>0),i&&(c.innerHTML=g>0?se(pa):se(Or)+"<span>Foto\u011Fraf Ekle</span>"),k?(i&&(c.style.display="none"),c.disabled=!0,v.disabled=!0):(i&&(c.style.display=n&&g===0?"none":"flex"),c.disabled=!1,v.disabled=!1,c.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}c.addEventListener("click",function(){v.disabled||v.click()}),v.onchange=async function(z){var C=(e.get().images||[]).length+(e.get().pendingImages||[]).length,g=Array.from(z.target.files).slice(0,et-C);v.value="";var k=(e.get().pendingImages||[]).length,A=e.get().images||[],w=A.length;if(g.length!==0){for(var S=[],T=[],L=0;L<g.length;L++){var O=g[L],y=O.name+"_"+O.size,M=(e.get().fingerprints||[]).some(function(U){return U===y})||S.some(function(U){return U.file.name+"_"+U.file.size===y});if(!M){if(O.size>Si){var R="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(R,"error"):alert(R);continue}var F=URL.createObjectURL(O);m[F]=y,S.push({url:F,file:O,error:null}),T.push({url:F,file:O});var _=(e.get().fingerprints||[]).slice();_.push(y),e.set({fingerprints:_})}}if(S.length!==0){var B=(e.get().pendingImages||[]).concat(S),j=async function(){for(var U=0;U<T.length;U++){var Y=T[U],W=Y.file,H=Y.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ee=(e.get().pendingImages||[]).filter(function(Z){return Z.url!==H}),V=(e.get().images||[]).slice();V.push(H),e.set({pendingImages:ee,images:V});continue}try{var $=await Ee(we+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe})});if(!$.ok)throw $.status===429?new Error("rate_limit"):new Error("sign failed");var J=await $.json();if(!J.folder)throw new Error("sign folder missing");var q=new FormData;q.append("file",W),q.append("api_key",J.api_key),q.append("timestamp",J.timestamp),q.append("signature",J.signature),q.append("folder",J.folder);var K=await fetch("https://api.cloudinary.com/v1_1/"+J.cloud_name+"/image/upload",{method:"POST",body:q}),X=await K.json();if(X.secure_url&&va(X.secure_url)){var me=(e.get().pendingImages||[]).some(function(Z){return Z.url===H});if(!me)continue;x[X.secure_url]=H,m[X.secure_url]=m[H];var Sr=(e.get().pendingImages||[]).filter(function(Z){return Z.url!==H}),pr=(e.get().images||[]).slice();pr.push(X.secure_url),e.set({pendingImages:Sr,images:pr});try{Ee(we+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,secureUrl:X.secure_url,metadata:{assetId:X.asset_id,publicId:X.public_id,version:X.version,resourceType:X.resource_type,format:X.format,width:X.width,height:X.height,bytes:X.bytes,signature:X.signature}})}).catch(function(){})}catch(Z){}}else throw new Error("invalid image url")}catch(Z){console.error("[renuvex-pr] Image upload failed:",Z);var Ae=Z.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(Ae,"error");var G=(e.get().pendingImages||[]).map(function(ne){return ne.url===H?{url:ne.url,file:ne.file,error:Ae}:ne});e.set({pendingImages:G})}}};if(w===0&&k===0){t=!0;var I=!r.canNavigate||r.canNavigate();I&&e.goNext()}e.set({pendingImages:B}),j()}}};var P=e.onChange(f);return f(),{el:o,openPicker:function(){v.disabled||v.click()},destroy:function(){t=!0,v.onchange=null,P&&P()}}}var Ci=150*1024*1024,Ei=2,Ti=60,tn=8192,an=5,Ai=3e4,Mi=["video/mp4","video/quicktime"],Pi="renuvex_pr_video_upload_",nn="renuvex_pr_video_cancel_",br=null,Za=!1,_i={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},Li={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},be=class extends Error{constructor(r,t,a){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=a||null}};function on(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:_i[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:Li[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function ln(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function Tt(e){return new Promise(function(r){setTimeout(r,e)})}function nr(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function ir(e){return Math.max(0,Math.round(nr()-e))}function Ri(){if(typeof window!="undefined"){var e=Number(window.__renuvexPrVideoUploadStallMs);if(Number.isFinite(e)&&e>=250)return e}return Ai}function Ni(e,r){return new Promise(function(t,a){var n=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(n),r&&r.removeEventListener("abort",o),a(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function At(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function Mt(e,r){return Pi+pe+"_"+e+"_"+At(r)}function dn(e,r){try{var t=window.sessionStorage.getItem(Mt(e,r)),a=t?JSON.parse(t):null;return!a||typeof a.token!="string"||!a.expiresAt||new Date(a.expiresAt).getTime()<=Date.now()?null:a}catch(n){return null}}function Bi(e,r,t){try{window.sessionStorage.setItem(Mt(e,r),JSON.stringify(t))}catch(a){}}function wr(e,r){try{window.sessionStorage.removeItem(Mt(e,r))}catch(t){}}function Ii(e,r){return nn+pe+"_"+e+"_"+At(r)}function Fi(e,r,t,a){if(!(!e||!r||!t)){var n={token:e,productId:r,expiresAt:a||null};try{window.sessionStorage.setItem(Ii(r,t),JSON.stringify(n))}catch(i){}}}function Oi(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(nn+pe+"_")!==0)){var a=window.sessionStorage.getItem(t),n=a?JSON.parse(a):null;if(!n||typeof n.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:n.token})}}}catch(i){}return e}function Qa(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function or(e,r,t){var a=await Ee(we+e,r,t||2e4),n=await a.json().catch(function(){return{}});if(!a.ok){var i=Number(a.headers.get("Retry-After"));throw new be(n.error||"video_request_failed",a.status,Number.isFinite(i)&&i>0?i:null)}return n.data||{}}async function yr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await or("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:ir(r.startedAt),finalStatus:t})},4e3)}catch(a){}}async function Ui(e){try{return await or("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Qa(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Qa(e.key),!0):!1}}function tt(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():br||(br=(async function(){for(var e=Oi(),r=0;r<e.length;r+=1)await Ui(e[r])})().finally(function(){br=null}),br)}function at(){typeof window=="undefined"||Za||(Za=!0,window.addEventListener("online",function(){tt()}),tt())}async function Vi(){var e=await import("./upchunk-KBSCWYRQ.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function en(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}var Hi={http_408:!0,http_502:!0,http_503:!0,http_504:!0};function Di(e){return Hi[e]!==!0}async function Yi(e){var r=await Vi();return new Promise(function(t,a){var n=!1,i=null,o=null,l=Ri(),d=null;function u(x){n||(n=!0,o&&clearTimeout(o),e.signal&&e.signal.removeEventListener("abort",s),d&&d(),x?a(x):t())}function c(x){n||(o&&clearTimeout(o),!(!x&&typeof navigator!="undefined"&&navigator.onLine===!1)&&(o=setTimeout(function(){if(!n){e.onUploadError&&e.onUploadError("video_upload_stalled"),u(new be("video_upload_stalled",0,null));try{i&&i.abort()}catch(m){}}},l)))}function v(){return n?!1:(c(),!0)}function p(){if(!n){e.onUploadError&&e.onUploadError("video_upload_offline"),u(new be("video_upload_offline",0,null));try{i&&i.abort()}catch(x){}}}function s(){try{i&&i.abort()}catch(x){}u(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return a(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",s,{once:!0})}if(i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||tn,attempts:e.chunkAttempts||an,dynamicChunkSize:!0}),typeof window!="undefined"&&typeof window.addEventListener=="function"&&typeof window.removeEventListener=="function"&&(window.addEventListener("offline",p),d=function(){window.removeEventListener("offline",p)}),typeof navigator!="undefined"&&navigator.onLine===!1){p();return}c(),i.on("attempt",function(){v()&&e.onStatus("uploading")}),i.on("attemptFailure",function(x){if(v()){var m=x&&x.detail,f=en(m);if(e.onAttemptFailure&&e.onAttemptFailure(f),Di(f)){e.onUploadError&&e.onUploadError(f),u(new be(f,0,null));try{i&&i.abort()}catch(h){}return}e.onStatus("upload_retrying")}}),i.on("chunkSuccess",function(){v()}),i.on("progress",function(x){if(v()){var m=Number(x&&x.detail);if(Number.isFinite(m)){var f=Math.min(95,Math.max(0,Math.round(m*.95)));Number.isFinite(e.minProgress)&&(f=Math.max(e.minProgress,f)),e.onProgress(f)}}}),i.on("offline",p),i.on("error",function(x){if(v()){var m=x&&x.detail,f=en(m);e.onUploadError&&e.onUploadError(f),u(new be(f,0,null))}}),i.on("success",function(){v()&&(e.onProgress(95),u())})})}function ji(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function rn(e,r,t){for(var a=Date.now(),n=a+600*1e3,i=0;Date.now()<n;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-a;try{var l=await or("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":l.status||"processing"),l.status==="ready")return l;if(l.status==="failed"||l.status==="aborted")throw new be(l.errorCode||"video_processing_failed",409,null)}catch(d){if(r.aborted||d instanceof be&&d.status===409||ln(d)||(i+=1,i>=3))throw d}await Ni(ji(o),r)}throw new be("video_processing_delayed",0,null)}async function Wi(e){for(var r=null,t=1;t<=3;t+=1)try{return await or("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(a){if(ln(a))return null;r=a,t<3&&await Tt(400*t)}throw r||new Error("video_status_failed")}async function Gi(e,r,t,a){for(var n=10;n<=90;n+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(n),await Tt(120)}return a("processing"),await Tt(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function pn(e){return!e||Mi.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>Ci?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function un(e){return new Promise(function(r){var t=URL.createObjectURL(e),a=document.createElement("video"),n=!1;function i(o){if(!n){n=!0,a.removeAttribute("src");try{a.load()}catch(l){}URL.revokeObjectURL(t),r(o)}}a.preload="metadata",a.onloadedmetadata=function(){i(Number.isFinite(a.duration)?a.duration:null)},a.onerror=function(){i(null)},a.src=t,setTimeout(function(){i(null)},8e3)})}function sn(e){return e===null?{ok:!0}:e<Ei||e>Ti?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function vn(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return Gi(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:nr(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(x){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=x||"upload_attempt_failed")}function a(){wr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}async function n(x,m){var f=await Wi(x);if(!f)return{action:"discard"};if(f.status==="ready")return e.onToken&&e.onToken(x),e.onProgress(100),wr(e.productId,e.file),await yr(x,r,"ready"),{action:"return",value:Object.assign({token:x},f)};if(f.status==="uploaded"||f.status==="processing"){e.onToken&&e.onToken(x),e.onStatus("processing");var h=nr(),b=await rn(x,e.signal,e.onStatus);return r.processingPollMs=ir(h),wr(e.productId,e.file),e.onProgress(100),await yr(x,r,"ready"),{action:"return",value:Object.assign({token:x},b)}}return f.status==="failed"||f.status==="aborted"?{action:"discard"}:!m||typeof m.uploadUrl!="string"||!m.uploadUrl?{action:"discard"}:{action:"upload"}}at(),await tt();var i=dn(e.productId,e.file),o=i&&i.token,l=i;if(o){var d=await n(o,l);if(d.action==="return")return d.value;d.action==="discard"&&(a(),o=null,l=null)}for(;;){if(!o){var u=await or("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:At(e.file)})});o=u.token,l=u,Bi(e.productId,e.file,u)}e.onToken&&e.onToken(o),r.chunkSizeKb=l.chunkSize||tn,r.chunkAttempts=l.chunkAttempts||an,e.onStatus("uploading");var c=nr();try{await Yi({uploadUrl:l.uploadUrl,file:e.file,chunkSize:l.chunkSize,chunkAttempts:l.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=(r.directUploadMs||0)+ir(c),e.onStatus("processing");var v=nr();await or("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:o})},3e4),r.completeMs=ir(v);var p=nr(),s=await rn(o,e.signal,e.onStatus);return r.processingPollMs=ir(p),wr(e.productId,e.file),e.onProgress(100),await yr(o,r,"ready"),Object.assign({token:o},s)}catch(x){throw r.directUploadMs=(r.directUploadMs||0)+ir(c),e.signal&&e.signal.aborted?(await yr(o,r,"aborted"),x):(await yr(o,r,"failed"),x)}}}async function nt(e,r,t){var a=r&&t?dn(r,t):null;e&&r&&t&&Fi(e,r,t,a&&a.expiresAt),r&&t&&wr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(at(),await tt())}function cn(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function qi(e){return"Video Y\xFCkleniyor"}function Ki(e){return!0}function mn(e,r){r=r||{};var t=!1,a=null,n=null,i=0,o=document.createElement("div");o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=ce("formStepMediaTitle"),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-step-subtitle",d.textContent=ce("formStepMediaSubtitle"),o.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-fwizard-media-card";var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",c.setAttribute("aria-label","Foto\u011Fraf ekle"),c.innerHTML=se(Or)+"<span>Foto\u011Fraf Ekle</span>";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",v.setAttribute("aria-label","Video ekle"),v.innerHTML=se(Ke)+"<span>Video Ekle</span>",u.appendChild(c),u.appendChild(v);var p=document.createElement("div");p.className="renuvex-pr-fwizard-media-content",u.appendChild(p),o.appendChild(u);var s=document.createElement("input");s.type="file",s.accept="video/mp4,video/quicktime,.mp4,.mov",s.style.display="none",o.appendChild(s);function x(){var y=e.get();return(y.images||[]).length>0||(y.pendingImages||[]).length>0}function m(){var y=e.get();return(y.images||[]).length+(y.pendingImages||[]).length}function f(){return e.get().videoUpload||null}function h(){return i+=1,i}function b(y,M){var R=f();return i===y&&!!R&&R.controller===M}function E(){if(!n){p.innerHTML="";return}n.retry.onclick=null,p.innerHTML="",n=null}function P(){a&&(a.destroy&&a.destroy(),a=null)}function z(y){P(),p.innerHTML="";var M=cn(y),R=document.createElement("div");R.className=M==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":M==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var F=null,_=null,B=null,j=null,I=document.createElement("button");if(I.type="button",I.className="renuvex-pr-fwizard-video-retry",I.textContent="Tekrar dene",I.setAttribute("aria-label","Video y\xFCklenemedi, tekrar dene"),M==="ready"){var U=y.posterUrl||y.localUrl||"";U&&U!==y.localUrl?(F=document.createElement("img"),F.alt="",F.src=U):(F=document.createElement("video"),F.muted=!0,F.playsInline=!0,F.preload="metadata",F.src=y.localUrl||""),F.className="renuvex-pr-fwizard-video-preview",R.appendChild(F)}else M==="busy"?(j=document.createElement("div"),j.className="renuvex-pr-fwizard-video-uploading-status",j.setAttribute("role","status"),j.setAttribute("aria-live","polite"),R.appendChild(j)):_=R;if(M==="ready"){let ee=function(V){V&&(V.preventDefault(),V.stopPropagation()),S()};var H=ee,Y=document.createElement("button");Y.type="button",Y.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",Y.setAttribute("aria-label","Videoyu kald\u0131r");var W=re(ke);W&&Y.appendChild(W),Y.addEventListener("pointerdown",ee),Y.addEventListener("click",ee),R.appendChild(Y)}p.appendChild(R),n={mode:M,card:R,preview:F,previewUrl:M==="ready"&&(y.posterUrl||y.localUrl)||"",details:_,name:B,status:j,retry:I}}function C(){if(!t){var y=f();if(!y){E();return}var M=cn(y),R=M==="ready"&&(y.posterUrl||y.localUrl)||"";if((!n||n.mode!==M||n.previewUrl!==R)&&z(y),n.name&&(n.name.textContent=y.file?y.file.name:"Video"),n.status&&M==="busy"){var F=qi(y),_=Ki(y)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+F+"</span>":"<span>"+F+"</span>";n.status.innerHTML!==_&&(n.status.innerHTML=_)}var B=M==="failed"&&!!(y.error&&y.file&&y.retryable!==!1);n.retry.onclick=B?function(){w(y.file,y.localUrl,y.durationMs)}:null,B&&n.details&&!n.retry.isConnected?n.details.appendChild(n.retry):!B&&n.retry.isConnected&&n.retry.remove()}}function g(){var y=x(),M=m()>=et,R=!!f(),F=y||R;c.hidden=F,v.hidden=F,c.disabled=R||M,v.disabled=y||R,u.classList.toggle("renuvex-pr-fwizard-media-card--has-media",F),u.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",y),u.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",R),c.classList.toggle("renuvex-pr-fwizard-media-action--active",y),v.classList.toggle("renuvex-pr-fwizard-media-action--active",R)}function k(y){var M=f();if(M){var R=Object.keys(y),F=R.some(function(_){return M[_]!==y[_]});F&&e.set({videoUpload:Object.assign({},M,y)})}}function A(y,M,R){b(y,M)&&k(R)}async function w(y,M,R){var F=f(),_=!!(M&&F&&F.file===y),B=_?Math.max(0,Math.min(95,Number(F.progress)||0)):0,j=_?(Number(F.retryClicks)||0)+1:0,I=pn(y);if(!I.ok){r.showToast&&r.showToast(I.message,"error");return}var U=M||URL.createObjectURL(y),Y=Number.isFinite(R)?R:null,W=new AbortController,H=h();e.set({videoUpload:{file:y,localUrl:U,token:_&&F.token||null,status:"uploading",progress:B,durationMs:Y,error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:j,controller:W}}),!_&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var ee=R!==void 0?Number.isFinite(R)?R/1e3:null:await un(y),V=sn(ee);if(!V.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:V.message});var $=await vn({file:y,productId:e.get().productId,signal:W.signal,minProgress:B,retryClicks:j,onToken:function(K){A(H,W,{token:K})},onProgress:function(K){A(H,W,{progress:K})},onStatus:function(K){A(H,W,{status:K})},onSessionReset:function(){A(H,W,{token:null,progress:0})}});if(!b(H,W))return;if($.previewOnly&&$.posterUrl&&$.posterUrl!==U)try{URL.revokeObjectURL($.posterUrl)}catch(K){}k({token:$.token,status:"ready",progress:100,posterUrl:$.previewOnly?U:$.posterUrl,durationMs:$.durationMs||(ee===null?null:Math.round(ee*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),_&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(K){if(W.signal.aborted||!b(H,W))return;var J=on(K);if(K&&K.code==="invalid_video_duration"&&(J={code:"invalid_video_duration",message:K.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),k({status:"failed",error:J.message,errorCode:J.code,retryable:J.retryable,retryAfterSec:J.retryAfterSec,controller:null}),r.showToast){var q=J.code==="invalid_video_duration"?J.message:"Video y\xFCklenemedi";r.showToast(q,"error")}}}function S(){var y=f();y&&(h(),y.controller&&y.controller.abort(),nt(y.token,e.get().productId,y.file),r.revokeBlobUrl&&r.revokeBlobUrl(y.localUrl),e.set({videoUpload:null}))}function T(y){if(a){y&&a.openPicker&&a.openPicker();return}n=null,p.innerHTML="",a=rt(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),p.appendChild(a.el),y&&a.openPicker&&a.openPicker()}c.onclick=function(){c.disabled||T(!0)},v.onclick=function(){v.disabled||(P(),p.innerHTML="",s.click())},s.onchange=function(){var y=s.files&&s.files[0];s.value="",y&&w(y,null,void 0)};var L=!!f(),O=e.onChange(function(){g();var y=!!f();(y||L)&&C(),L=y});return g(),x()&&T(!1),f()&&C(),{el:o,destroy:function(){t=!0,c.onclick=null,v.onclick=null,s.onchange=null,a&&a.destroy&&a.destroy(),O&&O()}}}var Pt=2e3,Xi=60;function fn(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=ce("formStepContentTitle"),a.appendChild(n);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Xi,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var l=document.createElement("textarea");l.className="renuvex-pr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=Pt,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",i.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),i.appendChild(d);function u(){var v=l.value.length;d.textContent=v+"/"+Pt,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",v>=Pt)}function c(){return ar(3,e.get())}return l.addEventListener("input",function(){e.set({comment:l.value}),u(),t(c())}),a.appendChild(i),u(),setTimeout(function(){t(c())},0),{el:a,destroy:function(){}}}var $i=40;function xn(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ce("formStepAuthorTitle"),n.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var l=document.createElement("div");l.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=$i,u.setAttribute("aria-required","true"),u.value=e.get().author||"",l.appendChild(d),l.appendChild(u),o.appendChild(l);var c=document.createElement("div");c.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.textContent="E-posta (opsiyonel)";var p=document.createElement("input");p.type="email",p.className="renuvex-pr-fwizard-input",p.setAttribute("autocomplete","email"),p.value=e.get().email||"",c.appendChild(v),c.appendChild(p),o.appendChild(c);var s=document.createElement("div");s.className="renuvex-pr-fwizard-notice",s.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(s);var x=document.createElement("div");x.className="renuvex-pr-fwizard-msg",x.setAttribute("role","alert"),x.setAttribute("aria-live","assertive"),o.appendChild(x);var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-submit-btn",m.textContent="G\xF6nder",o.appendChild(m),n.appendChild(o);function f(){return ar(4,e.get())}function h(g){m.classList.remove("renuvex-pr-fwizard-submit-btn--video-pending"),m.textContent=g}function b(){m.classList.add("renuvex-pr-fwizard-submit-btn--video-pending"),m.textContent="";var g=document.createElement("span");g.className="renuvex-pr-fwizard-video-dots",g.setAttribute("aria-hidden","true"),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span"));var k=document.createElement("span");k.textContent="Video Haz\u0131rlan\u0131yor",m.appendChild(g),m.appendChild(k)}function E(){var g=!f(),k=(e.get().pendingImages||[]).length,A=k>0,w=e.get().videoUpload,S=!!(w&&w.status==="failed"),T=!!(w&&w.status!=="ready"&&w.status!=="failed");A||T||S?(m.disabled=!0,m.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),S?h("Video Y\xFCklenemedi"):T?b():h("Foto\u011Fraflar Y\xFCkleniyor...")):(m.disabled=g,m.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",g),h("G\xF6nder"))}u.addEventListener("input",function(){e.set({author:u.value}),E(),t(f())}),p.addEventListener("input",function(){e.set({email:p.value})}),E(),setTimeout(function(){t(f())},0);function P(){x.textContent=""}function z(g){P();var k=document.createElement("div");k.className="renuvex-pr-fwizard-msg-error",k.textContent=g||"",x.appendChild(k)}m.onclick=async function(){if(!m.disabled){var g=e.get(),k=(g.author||"").trim(),A=(g.comment||"").trim();if(p.value.trim()&&!p.checkValidity()){p.reportValidity();return}if(!k){z("Gerekli alan");return}if(!g.rating){z("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}m.disabled=!0,m.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var w=m.textContent;if(m.textContent="G\xF6nderiliyor\u2026",P(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),a()},600);return}try{var S=ua(window.location.href),T=g.productName||null,L=await Ee(we+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,productId:g.productId||null,slug:S||null,productName:T,author:k,title:(g.title||"").trim()||null,comment:A||null,rating:g.rating,images:g.videoUpload?[]:g.images||[],videoToken:g.videoUpload&&g.videoUpload.status==="ready"?g.videoUpload.token:null})},15e3);if(L.ok)g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),a();else{var O=await L.json().catch(function(){return{}});throw new Error(O.error||"Yorum kaydedilemedi.")}}catch(R){var y=R&&(R.name==="AbortError"||/signal/i.test(R.message||"")),M=y?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":R.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(M,"error"):z(M),m.disabled=!1,m.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),m.textContent=w}}};var C=e.onChange(E);return{el:n,destroy:function(){m.onclick=null,C&&C()}}}function Ji(e,r,t){if(t=t||{},e===1)return Ja(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return mn(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return rt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return fn(r,{onValidityChange:t.onValidityChange});if(e===4)return xn(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function gn(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function hn(e){e=e||{},at();var r=Xa({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:N&&N.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},a={},n={};function i(w){if(!(!w||typeof w!="string"||!w.startsWith("blob:")||n[w])){n[w]=!0;try{URL.revokeObjectURL(w)}catch(S){}}}function o(){Object.keys(a).forEach(function(S){i(S)}),Object.keys(t).forEach(function(S){i(t[S])});var w=r.get();(w.pendingImages||[]).forEach(function(S){i(S&&S.url)}),(w.images||[]).forEach(function(S){i(S)}),w.videoUpload&&i(w.videoUpload.localUrl)}function l(){var w=r.get(),S=w.videoUpload;!S||w.videoSubmitted||(S.controller&&S.controller.abort(),nt(S.token,w.productId,S.file))}var d=Ka({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",c),Xr(u),l(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=Kr(),c=function(w){d&&d.close&&d.close()};window.addEventListener("popstate",c);var v=document.createElement("div");v.className="renuvex-pr-fwizard-step-wrap";var p=$a({skippableSteps:[2],nextableSteps:[3],onBack:function(){m==="idle"&&r.goBack()},onSkip:function(){m==="idle"&&r.goNext()},onNext:function(){m==="idle"&&r.goNext()}}),s=document.createElement("div");s.className="renuvex-pr-fwizard-layout",s.appendChild(v),s.appendChild(p.el);var x=null,m="idle",f=null,h=!0,b=null;function E(w,S){v.innerHTML="";var T=Ji(w,r,{canNavigate:function(){return m==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:i,onValidityChange:function(y){p.setNextDisabled(!y)},onSuccess:z,showToast:d.showToast});if(x=T,p.update(w,r.get()),S){m="entering",T.el.classList.add("renuvex-pr-fwizard-step--enter");var L=null,O=function(){L&&clearTimeout(L),T.el.removeEventListener("animationend",O),T.el.classList.remove("renuvex-pr-fwizard-step--enter"),m="idle",f!==null&&C()};T.el.addEventListener("animationend",O),L=setTimeout(O,700)}else m="idle";v.appendChild(T.el),d.setStepAttr&&d.setStepAttr(w),w===3&&p.setNextDisabled(!0)}var P=!1;function z(){if(!P){if(P=!0,!x){v.innerHTML="";var w=gn();w.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(w),d.setStepAttr("thanks"),p.setThanksState(d.close);return}var S=x;m="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(b&&clearTimeout(b),S.el.removeEventListener("animationend",T),S.destroy)try{S.destroy()}catch(O){}x===S&&(x=null),v.innerHTML="";var L=gn();L.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(L),d.setStepAttr("thanks"),p.setThanksState(d.close),m="idle"};S.el.addEventListener("animationend",T),b=setTimeout(T,300)}}function C(){var w=r.get().currentStep;if(m!=="idle"){f=w;return}if(!x){var S=!h;h=!1,E(w,S);return}var T=x;m="exiting",T.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(b&&clearTimeout(b),T.el.removeEventListener("animationend",L),T.destroy)try{T.destroy()}catch(y){}if(x===T){v.innerHTML="",x=null;var O=f!==null?f:r.get().currentStep;f=null,E(O,!0),m="idle"}};T.el.addEventListener("animationend",L),b=setTimeout(L,350)}C();var g=r.get().currentStep,k=r.onChange(function(w){w.currentStep!==g?(g=w.currentStep,C()):p.update(w.currentStep,w)}),A=d.close;return d.close=function(){k&&k(),typeof b!="undefined"&&b&&clearTimeout(b),A()},d.open(s),{close:d.close}}var Zi=4e3;async function bn(){var e=await Ee(we+"/api/public/upload/video/capability?storeId="+encodeURIComponent(pe),{method:"GET",cache:"no-store"},Zi);if(!e.ok){var r=new Error("video_capability_unavailable");throw r.code="video_capability_http",r.status=e.status,r}var t=await e.json().catch(function(){return{}}),a=t&&t.data;if(!a||typeof a.enabled!="boolean"){var n=new Error("video_capability_invalid");throw n.code="video_capability_invalid",n}return{enabled:a.enabled===!0,reason:typeof a.reason=="string"?a.reason:null}}var it=null;function yn(){return N&&N.videoReviewsEnabled===!0}function Qi(e){var r=e&&Number(e.status),t=Number.isFinite(r)&&r>=100;return yn()&&!t?{enabled:!0,reason:"capability_unavailable"}:{enabled:!1,reason:"capability_unavailable"}}function eo(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function ro(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:yn(),reason:null};else try{t=await bn()}catch(a){t=Qi(a)}hn({productId:Q||"",productName:Fe||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function ae(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=eo(r);return it||(it=ro(r,Pe()).finally(function(){it=null})),it.finally(t)}var wn=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var to={id:"classic",name:"Klasik (A\xE7\u0131k)"},ao=wn;function no(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,c=e.currentMediaFilter,v=e.onFilterChange,p=e.onSortChange;Le(n);var s=document.createElement("div");s.className="renuvex-pr-summary";var x=(o[3]||0)+(o[4]||0),m=i>0?Math.round(x/i*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-avg",f.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",s.appendChild(f);var h=document.createElement("div");if(h.className="renuvex-pr-summary-block renuvex-pr-summary-count",h.textContent=i.toLocaleString("tr-TR")+" "+D(a.countLabel,"Yorum"),s.appendChild(h),a.showRecommendation!==!1&&m>0){var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",b.innerHTML='<span class="renuvex-pr-recommend-pct">%'+m+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",s.appendChild(b)}return s.appendChild(rr({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:d,onFilterChange:v})),s.appendChild(de({widget:r,currentOrderBy:u,currentMediaFilter:c,onWriteClick:ae,onSortChange:p})),s}var Lt={};Me(Lt,{css:()=>oo,meta:()=>io,render:()=>so});var kn=`
...
`;var io={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},oo=kn,lo="__unknown_product__",kr=Object.create(null);function po(e){return e?String(e):lo}var Ye=null,zr=null;function uo(){!Ye||!zr||(Ye.removeEventListener?Ye.removeEventListener("change",zr):Ye.removeListener&&Ye.removeListener(zr),Ye=null,zr=null)}function so(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,c=e.currentMediaFilter,v=e.onFilterChange,p=e.onSortChange,s=po(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var m=document.createElement("div");m.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Re(l,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(da)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),E=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+D(a.countLabel,"Yorum")),b&&E){var P=document.createElement("span");P.className="renuvex-pr-compact-trigger-count",h.insertBefore(P,b),P.appendChild(b),P.appendChild(E)}f.appendChild(h),m.appendChild(f);var z=de({widget:r,currentOrderBy:u,currentMediaFilter:c,onWriteClick:ae,onSortChange:p}),C=z.querySelector(".renuvex-pr-filter-wrap"),g=z.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-compact-actions-slot",g&&k.appendChild(g),C&&k.appendChild(C),m.appendChild(k),x.appendChild(m);var A=document.createElement("div");A.className="renuvex-pr-compact-panel",A.setAttribute("role","dialog"),A.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),A.setAttribute("aria-hidden","true");var w=document.createElement("div");w.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+ue("full")+"</span><span>"+l+"</span>",w.appendChild(S),w.appendChild(rr({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:d,onFilterChange:function(V){L()&&A.classList.contains("renuvex-pr-open")&&(kr[s]=!0),v(V)}})),A.appendChild(w);var T=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function L(){return!!(T&&T.matches)}function O(V){V?A.classList.add("renuvex-pr-open"):A.classList.remove("renuvex-pr-open"),A.setAttribute("aria-hidden",V?"false":"true"),h.setAttribute("aria-expanded",V?"true":"false")}function y(V){var $=V?x:f;if(A.parentNode!==$){var J=!!A.parentNode;A.classList.contains("renuvex-pr-open")&&O(!1),J&&(kr[s]=!1),$.appendChild(A)}}y(T?T.matches:!1);var M=de({widget:r,currentOrderBy:u,currentMediaFilter:c,onWriteClick:ae,onSortChange:p}),R=M.querySelector(".renuvex-pr-filter-wrap"),F=M.querySelector(".renuvex-pr-write-btn"),_=document.createElement("div");_.className="renuvex-pr-compact-write-row",F&&_.appendChild(F),R&&_.appendChild(R),x.appendChild(_);function B(){var V=A.classList.contains("renuvex-pr-open");return O(!1),L()&&(kr[s]=!1),V}function j(){I&&I.notifyOpening(),O(!0),L()&&(kr[s]=!0)}h.onclick=function(){A.classList.contains("renuvex-pr-open")?B():j()};var I=null;function U(V){I&&(I.unregister(),I=null),V||(I=Qr({trigger:f,element:A,close:B}))}if(U(T?T.matches:!1),uo(),T){var Y=function(V){y(V.matches),U(V.matches)};T.addEventListener?T.addEventListener("change",Y):T.addListener&&T.addListener(Y),Ye=T,zr=Y}if(L()&&kr[s]&&O(!0),a.showRecommendation!==!1){var W=(o[3]||0)+(o[4]||0),H=i>0?Math.round(W/i*100):0;if(H>0){var ee=document.createElement("div");ee.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",ee.style.marginTop="8px",ee.innerHTML='<span class="renuvex-pr-recommend-pct">%'+H+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",w.appendChild(ee)}}return x}var Rt={};Me(Rt,{css:()=>co,meta:()=>vo,render:()=>mo});var zn=`
...
`;var vo={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},co=zn;function mo(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentMediaFilter,c=e.onFilterChange,v=e.onSortChange;Le(a);var p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(x);var m=document.createElement("div");m.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",m.textContent=n.toLocaleString("tr-TR")+" "+D(t.countLabel,"Yorum"),s.appendChild(m),p.appendChild(s);var f=document.createElement("div");f.className="renuvex-pr-split-col renuvex-pr-split-mid",f.appendChild(rr({ratingCounts:i,allCount:n,iconPair:a,currentRatingFilter:l,onFilterChange:c})),p.appendChild(f);var h=de({widget:r,currentOrderBy:d,currentMediaFilter:u,onWriteClick:ae,onSortChange:v}),b=h.querySelector(".renuvex-pr-filter-wrap"),E=h.querySelector(".renuvex-pr-write-btn"),P=document.createElement("div");P.className="renuvex-pr-split-col renuvex-pr-split-right",E&&P.appendChild(E),b&&P.appendChild(b),p.appendChild(P);var z=(i[3]||0)+(i[4]||0),C=n>0?Math.round(z/n*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",g.innerHTML='<span class="renuvex-pr-recommend-pct">%'+C+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var k=t.showRecommendation===!1||C===0;return k&&g.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(g),p}var Nt={};Me(Nt,{css:()=>xo,meta:()=>fo,render:()=>go});var Sn=`
...
`;var fo={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},xo=Sn;function go(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,l=e.currentMediaFilter,d=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-minimal";var c=document.createElement("div");c.className="renuvex-pr-minimal-info";var v=document.createElement("div");v.className="renuvex-pr-minimal-row";var p=document.createElement("span");p.className="renuvex-pr-minimal-avg",p.textContent=i,v.appendChild(p);var s=document.createElement("span");s.className="renuvex-pr-minimal-stars",s.innerHTML=Re(i,a),v.appendChild(s);var x=document.createElement("span");x.className="renuvex-pr-minimal-count",x.textContent=n.toLocaleString("tr-TR")+" "+D(t.countLabel,"Yorum"),v.appendChild(x),c.appendChild(v),u.appendChild(c);var m=de({widget:r,currentOrderBy:o,currentMediaFilter:l,onWriteClick:ae,onSortChange:d}),f=m.querySelector(".renuvex-pr-filter-wrap"),h=m.querySelector(".renuvex-pr-write-btn"),b=document.createElement("div");b.className="renuvex-pr-minimal-actions",h&&b.appendChild(h),f&&b.appendChild(f),u.appendChild(b);var E=de({widget:r,currentOrderBy:o,currentMediaFilter:l,onWriteClick:ae,onSortChange:d}),P=E.querySelector(".renuvex-pr-filter-wrap"),z=E.querySelector(".renuvex-pr-write-btn"),C=document.createElement("div");return C.className="renuvex-pr-minimal-write-row",z&&C.appendChild(z),P&&C.appendChild(P),u.appendChild(C),u}var Bt={};Me(Bt,{css:()=>bo,meta:()=>ho,render:()=>yo});var Cn=`
...
`;var ho={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},bo=Cn;function yo(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,l=e.currentMediaFilter,d=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var c=document.createElement("div");c.className="renuvex-pr-hero-info";var v=document.createElement("div");v.className="renuvex-pr-hero-rating-col";var p=document.createElement("span");p.className="renuvex-pr-hero-avg",p.textContent=i,v.appendChild(p);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var x=document.createElement("span");x.className="renuvex-pr-hero-stars",x.innerHTML=Re(i,a),s.appendChild(x);var m=document.createElement("div");m.className="renuvex-pr-hero-count",m.textContent=n.toLocaleString("tr-TR")+" "+D(t.countLabel,"Yorum"),s.appendChild(m),v.appendChild(s),c.appendChild(v),u.appendChild(c);var f=de({widget:r,currentOrderBy:o,currentMediaFilter:l,onWriteClick:ae,onSortChange:d}),h=f.querySelector(".renuvex-pr-filter-wrap"),b=f.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");E.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",b&&E.appendChild(b),h&&E.appendChild(h),u.appendChild(E);var P=de({widget:r,currentOrderBy:o,currentMediaFilter:l,onWriteClick:ae,onSortChange:d}),z=P.querySelector(".renuvex-pr-filter-wrap"),C=P.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");return g.className="renuvex-pr-hero-write-row",C&&g.appendChild(C),z&&g.appendChild(z),u.appendChild(g),u}var En=`
  .renuvex-pr-summary{
...
`;var wo={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},ko=An;function zo(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var i=document.createElement("span");i.className="renuvex-pr-review-stars",i.innerHTML=ze(e.rating,N),n.appendChild(i);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=Se(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a),e.title){var l=document.createElement("div");l.className="renuvex-pr-review-title",l.textContent=e.title,t.appendChild(l)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var u=(e.comment||"").trim();u&&t.appendChild(lr(u,"renuvex-pr-body").fragment);var c=Ne(e);if(c.length){var v=document.createElement("div");v.className="renuvex-pr-gallery",c.forEach(function(s){var x=Be(s,{className:"renuvex-pr-img",sourceWidth:le,width:le,height:le,onOpen:function(){he(e,s.url,r)}});x&&v.appendChild(x)}),t.appendChild(v)}var p=dr(e.merchantReply);return p&&t.appendChild(p),t}var Ft={};Me(Ft,{css:()=>Co,meta:()=>So,render:()=>Eo});var Mn=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var So={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},Co=Mn;function Eo(e,r){var t=Ne(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=ze(e.rating,N),i.appendChild(o);var l=document.createElement("span");l.className="renuvex-pr-review-list-author-name",l.textContent=e.author||"",i.appendChild(l);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=Se(e.createdAt),i.appendChild(d),n.appendChild(i);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var c=document.createElement("div");c.className="renuvex-pr-review-list-title",c.textContent=e.title,u.appendChild(c)}var v=(e.comment||"").trim();v&&u.appendChild(lr(v,"renuvex-pr-review-list-body").fragment);var p=dr(e.merchantReply);if(p&&u.appendChild(p),n.appendChild(u),a){var s=document.createElement("div");s.className="renuvex-pr-review-list-media",t.forEach(function(x){var m=Be(x,{sourceWidth:le,width:le,height:Math.round(le*4/3),onOpen:function(){he(e,x.url,r)}});m&&s.appendChild(m)}),n.appendChild(s)}return n}var Ot={};Me(Ot,{css:()=>Ao,meta:()=>To,render:()=>Mo});var Pn=`
...
`;var To={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Ao=Pn;function Mo(e,r){var t=fe(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=ze(e.rating,N),i.appendChild(o),e.title){var l=document.createElement("div");l.className="renuvex-pr-review-gallery-title",l.textContent=e.title,i.appendChild(l)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",i.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=Se(e.createdAt),i.appendChild(u);var c=(e.comment||"").trim();if(c&&i.appendChild(lr(c,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){he(e,t.url,r)}}:null).fragment),n.appendChild(i),a){var v=document.createElement("div");v.className="renuvex-pr-review-gallery-media";var p=Be(t,{sourceWidth:Ur,width:Ur,height:Math.round(Ur*4/3),onOpen:function(){he(e,t.url,r)}});p&&v.appendChild(p),n.appendChild(v)}var s=dr(e.merchantReply,t?function(){he(e,t.url,r)}:null);return s&&(s.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(s)),n}var dt={card:It,list:Ft,gallery:Ot};function pt(e){return dt[e]||dt.card}function _n(){return Object.keys(dt).map(function(e){return dt[e].css||""}).join(`
`)}var Ut=0;function je(){return Ut++,Ut}function We(e,r){return e!==Ut?!1:r?!(r.productId!==void 0&&Q!==r.productId||r.orderBy!==void 0&&te!==r.orderBy||r.page!==void 0&&sr!==r.page||r.ratingFilter!==void 0&&ie!==r.ratingFilter||r.mediaFilter!==void 0&&oe!==r.mediaFilter||r.nextCursor!==void 0&&_r!==r.nextCursor):!0}var Vt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,mediaGalleryTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,mediaGalleryTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,mediaGalleryTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Ht={small:80,medium:110,large:140},Dt={small:80,medium:100,large:110};function Ln(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),a.appendChild(n),a.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var l=document.createElement("div");return l.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",l.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(l),r}function Rn(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var a=document.createElement("div");a.className="renuvex-pr-empty-state-stars",a.innerHTML=Re(0,e.iconPair),t.appendChild(a);var n=document.createElement("p");n.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",n.setAttribute("role","status"),n.setAttribute("aria-live","polite"),n.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(n),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function Nn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function Bn(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function Te(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+a+","+n+","+i+","+r+")"}function ut(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Yt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function In(e){return .2126*Yt(e.r)+.7152*Yt(e.g)+.0722*Yt(e.b)}function Fn(e,r){var t=In(e),a=In(r),n=Math.max(t,a),i=Math.min(t,a);return(n+.05)/(i+.05)}function Po(e){var r=ut(e)||ut("#ffffff"),t=ut("#111111"),a=ut("#ffffff");return Fn(t,r)>=Fn(a,r)?"#111111":"#ffffff"}function _o(e){return Te(e,e==="#ffffff"?.1:.06)}function On(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",l=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=Te(o,.06),c=r.reviewStarColor||"#f59e0b",v=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",s=r.btnBorderColor||"#111111",x=r.filterBtnBgColor||"#111111",m=r.filterBtnTextColor||"#ffffff",f=r.filterBtnBorderColor||"#111111",h=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",E=r.filterItemTextColor||"#111111",P=r.filterItemHoverBgColor||"#f3f4f6",z=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",g=r.reviewAuthorColor||"#111111",k=r.reviewDateColor||"#5e5e5e",A=r.reviewBodyColor||"#111111",w=r.reviewBorderColor||"#e5e7eb",S=Te(A,.65),T=r.replyBgColor||"#f9fafb",L=r.replyBorderColor||"#747474",O=r.replyLabelColor||"#111111",y=r.replyTextColor||"#111111",M=r.mediaGalleryTitleColor||"#111111",R=Te("#111111",.05),F=r.mediaGalleryArrowBgColor||"#ffffff",_=r.mediaGalleryArrowTextColor||"#111111",B=Te("#111111",.12),j=r.reviewLightboxVideoIconColor||"#ffffff",I=r.reviewLightboxVideoProgressColor||"#ffffff",U=r.reviewLightboxVideoProgressTrackColor||"#000000",Y=r.formBgColor||"#ffffff",W=r.formPrimaryTextColor||"#111111",H=r.formSecondaryTextColor||"#3b3b3b",ee=r.inputTextColor||W,V=r.inputBorderColor||"#d1d5db",$=r.placeholderColor||"#9ca3af",J=r.formStepBarColor||"#111111",q=r.formBtnBgColor||"#111111",K=r.formBtnTextColor||"#ffffff",X=r.formBtnBorderColor||"#111111",me=Te(q,.06),Sr=Te(q,.18),pr=Te(K,.85),Ae=Te(W,.06),G=Po(Y),Z=_o(G),ne=r.loadMoreBgColor||"#ffffff",Ie=r.loadMoreTextColor||"#111111",Cr=r.loadMoreBorderColor||"#111111",Er=r.paginationBgColor||"#ffffff",Tr=r.paginationTextColor||"#111111",Ar=r.paginationBorderColor||"#e5e7eb",Mr=r.paginationActiveBgColor||"#111111",ye=r.paginationActiveTextColor||"#ffffff",ur={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":l,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":v,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":s,"--renuvex-pr-filter-btn-bg":x,"--renuvex-pr-filter-btn-text":m,"--renuvex-pr-filter-btn-border":f,"--renuvex-pr-filter-menu-bg":h,"--renuvex-pr-filter-menu-border":b,"--renuvex-pr-filter-item-text":E,"--renuvex-pr-filter-item-hover-bg":P,"--renuvex-pr-filter-item-active":z,"--renuvex-pr-review-title":C,"--renuvex-pr-review-author":g,"--renuvex-pr-review-date":k,"--renuvex-pr-review-body":A,"--renuvex-pr-review-border":w,"--renuvex-pr-state-text":S,"--renuvex-pr-review-star-color":c,"--renuvex-pr-reply-bg-color":T,"--renuvex-pr-reply-border":L,"--renuvex-pr-reply-label":O,"--renuvex-pr-reply-text":y,"--renuvex-pr-media-gallery-title":M,"--renuvex-pr-media-gallery-image-border":R,"--renuvex-pr-media-gallery-arrow-bg":F,"--renuvex-pr-media-gallery-arrow-text":_,"--renuvex-pr-media-gallery-arrow-border":B,"--renuvex-pr-review-lightbox-video-icon":j,"--renuvex-pr-review-lightbox-video-progress":I,"--renuvex-pr-review-lightbox-video-progress-track":U,"--renuvex-pr-fwizard-bg":Y,"--renuvex-pr-fwizard-text":W,"--renuvex-pr-fwizard-secondary-text":H,"--renuvex-pr-fwizard-input-bg":Y,"--renuvex-pr-fwizard-input-text":ee,"--renuvex-pr-fwizard-input-border":V,"--renuvex-pr-fwizard-placeholder":$,"--renuvex-pr-fwizard-close-text":G,"--renuvex-pr-fwizard-close-hover-bg":Z,"--renuvex-pr-fwizard-progress-bg":Ae,"--renuvex-pr-fwizard-progress-active":J,"--renuvex-pr-fwizard-btn-bg":q,"--renuvex-pr-fwizard-btn-text":K,"--renuvex-pr-fwizard-btn-border":X,"--renuvex-pr-fwizard-btn-disabled-bg":Sr,"--renuvex-pr-fwizard-btn-disabled-text":pr,"--renuvex-pr-fwizard-nav-hover-bg":me,"--renuvex-pr-load-more-bg":ne,"--renuvex-pr-load-more-text":Ie,"--renuvex-pr-load-more-border":Cr,"--renuvex-pr-pagination-bg":Er,"--renuvex-pr-pagination-text":Tr,"--renuvex-pr-pagination-border":Ar,"--renuvex-pr-pagination-active-bg":Mr,"--renuvex-pr-pagination-active-text":ye};Object.keys(ur).forEach(function(Pr){e.style.setProperty(Pr,ur[Pr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Un(e){var r=e.settings,t=e.root,a=e.currentMediaFilter||"none",n=e.openReviewModal,i=(e.mediaStripReviews||[]).filter(function(E){return Ne(E).length>0});if(!(r.showMediaGallery!==!1&&a==="none"&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-media-gallery-section",r.showMediaGalleryTitle!==!1){var l=D(r.mediaGalleryTitle,"M\xFC\u015Fteri G\xF6rselleri"),d=document.createElement("div");d.className="renuvex-pr-media-gallery-title",d.textContent=l,o.appendChild(d)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-media-gallery-thumb-aspect",u);var c=document.createElement("div");c.className="renuvex-pr-media-gallery-strip";var v=le,p=r.reviewLayout==="card"?le:Math.round(le*4/3),s=0;i.forEach(function(E){if(!(s>=15)){var P=fe(E);if(P){var z=Be(P,{className:"renuvex-pr-media-gallery-thumb",sourceWidth:le,width:v,height:p,loading:s<3?"eager":"lazy",onOpen:function(){n(E,P.url,i,{source:"mediaGallery"})}});z&&(c.appendChild(z),s++)}}});var x=document.createElement("button");x.className="renuvex-pr-media-gallery-arrow renuvex-pr-media-gallery-arrow-prev";var m=re(qe);m&&x.appendChild(m),x.setAttribute("aria-label","\xD6nceki"),x.onclick=function(){c.scrollBy({left:-200,behavior:"smooth"})};var f=document.createElement("button");f.className="renuvex-pr-media-gallery-arrow renuvex-pr-media-gallery-arrow-next";var h=re(Fr);h&&f.appendChild(h),f.setAttribute("aria-label","Sonraki"),f.onclick=function(){c.scrollBy({left:200,behavior:"smooth"})};var b=document.createElement("div");return b.className="renuvex-pr-media-gallery-strip-wrap",b.appendChild(x),b.appendChild(c),b.appendChild(f),o.appendChild(b),o}var Lo=1,Ro=7,jt="\u2026";function No(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Ro){for(var n=[],i=1;i<=t;i++)n.push(i);return n}for(var o=[],l=1;l<=t;l++)(l===1||l===t||Math.abs(l-a)<=Lo)&&o.push(l);for(var d=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&d.push(jt),d.push(o[u]);return d}function Vn(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function i(d){n.setAttribute("aria-busy","true");for(var u=n.querySelectorAll("button"),c=0;c<u.length;c++)u[c].disabled=!0;a(d)}function o(d,u){var c=document.createElement("span");c.className="renuvex-pr-pagination-label",c.setAttribute("aria-hidden","true"),c.textContent=u,d.appendChild(c)}function l(d,u,c,v){var p=document.createElement("button");return p.type="button",p.className="renuvex-pr-pagination-arrow",p.setAttribute("aria-label",d),o(p,u),v?p.disabled=!0:p.onclick=function(){i(c)},p}return n.appendChild(l("\xD6nceki sayfa","\u2039",t-1,t<=1)),No(t,r).forEach(function(d){if(d===jt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=jt,n.appendChild(u);return}var c=document.createElement("button");c.type="button",c.className="renuvex-pr-pagination-btn",c.setAttribute("aria-label","Sayfa "+d),o(c,String(d)),d===t?c.setAttribute("aria-current","page"):c.onclick=function(){i(d)},n.appendChild(c)}),n.appendChild(l("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Hn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Dn(e){var r=e.render;async function t(){var o=je(),l=Q,d=te,u=ie,c=oe;_e(null);var v=await He(Q,te,1,ie,oe);We(o,{productId:l,orderBy:d,ratingFilter:u,mediaFilter:c})&&await r(Q,N,v,Fe,te,1,qt)}async function a(o){var l=je(),d=ie===o?null:o,u=Q,c=te,v=oe;$t(d),Oe(1),_e(null);var p=await He(Q,te,1,d,oe);We(l,{productId:u,orderBy:c,page:1,ratingFilter:d,mediaFilter:v})&&await r(Q,N,p,Fe,te,1)}async function n(o,l){var d=je(),u=Q,c=ie;Oe(1),_e(null);var v=o,p=l==="images"||l==="media"?l:"none";p!=="none"&&(v="newest"),Jt(p),Lr(v);var s=await He(Q,v,1,ie,p);We(d,{productId:u,orderBy:v,page:1,ratingFilter:c,mediaFilter:p})&&await r(Q,N,s,Fe,v,1)}async function i(o){var l=je(),d=Q,u=te,c=ie,v=oe;Oe(o),_e(null);var p=await He(Q,te,o,ie,oe);if(We(l,{productId:d,orderBy:u,page:o,ratingFilter:c,mediaFilter:v})){await r(Q,N,p,Fe,te,o);var s=document.getElementById("renuvex-reviews"),x=s&&s.shadowRoot,m=x&&x.querySelector&&x.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(m){try{m.focus({preventScroll:!0})}catch(b){try{m.focus()}catch(E){}}Hn(x,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var f=document.getElementById("renuvex-reviews");if(f&&typeof f.scrollIntoView=="function"){var h=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;f.scrollIntoView({behavior:h?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:i}}function Bo(){return xa()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Io(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=ma({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),fa(t,{surface:"reviews",productId:r||""}),t}function Yn(e){return Math.round(Math.max(36,Math.min(52,e*.38)))}function jn(e){return Math.round(e*.5)}async function Wt(e,r,t,a,n,i,o){if(oa){Br({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:i,badgeSettings:o});return}Nr(!0),Zt(e),Qt(r),o!==void 0&&ea(o),ra(a),n&&Lr(n),i&&Oe(i),t!=null&&(ta(t),_e(t&&t.data?t.data.nextCursor:null));var l=Dn({render:Wt});try{let Ae=function(G,Z){if(!(!G||!G.meta||!G.meta.sizeOverrides)){var ne=G.meta.sizeOverrides[Z];ne&&Object.keys(ne).forEach(function(Ie){s.style.setProperty(Ie,ne[Ie])})}};var Sr=Ae,d=lt(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),c=r.showTitle!==!1,v=D(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),p=u&&c?v:"",s=document.documentElement;On(s,r);var x=r.borderRadius!==void 0?r.borderRadius:8,m=Vt[r.size]||Vt.medium,f=Ht[r.thumbnailSize]||Ht.medium,h=f;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(h=Dt[r.thumbnailSize]||Dt.medium),s.style.setProperty("--renuvex-pr-title-size",m.titleSize+"px"),s.style.setProperty("--renuvex-pr-review-text-size",m.reviewTextSize+"px"),s.style.setProperty("--renuvex-pr-review-title-size",m.reviewTitleSize+"px"),s.style.setProperty("--renuvex-pr-author-size",m.authorSize+"px"),s.style.setProperty("--renuvex-pr-reply-name-size",m.replyNameSize+"px"),s.style.setProperty("--renuvex-pr-reply-text-size",m.replyTextSize+"px"),s.style.setProperty("--renuvex-pr-radius",x+"px"),s.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,x-4)+"px"),s.style.setProperty("--renuvex-pr-media-gallery-title-size",m.mediaGalleryTitleSize+"px"),s.style.setProperty("--renuvex-pr-avg-rating-size",m.avgRatingSize+"px"),s.style.setProperty("--renuvex-pr-review-count-size",m.reviewCountSize+"px"),s.style.setProperty("--renuvex-pr-compact-count-size",m.compactCountSize+"px"),s.style.setProperty("--renuvex-pr-recommend-size",m.recommendSize+"px"),s.style.setProperty("--renuvex-pr-btn-text-size",m.btnTextSize+"px"),s.style.setProperty("--renuvex-pr-bar-label-size",m.barLabelSize+"px"),s.style.setProperty("--renuvex-pr-minimal-avg-size",m.minimalAvgSize+"px"),s.style.setProperty("--renuvex-pr-hero-avg-size",m.heroAvgSize+"px"),s.style.setProperty("--renuvex-pr-minimal-count-size",m.minimalCountSize+"px"),s.style.setProperty("--renuvex-pr-hero-count-size",m.heroCountSize+"px"),s.style.setProperty("--renuvex-pr-bar-count-size",m.barCountSize+"px"),s.style.setProperty("--renuvex-pr-review-date-size",m.reviewDateSize+"px"),s.style.setProperty("--renuvex-pr-filter-text-size",m.filterTextSize+"px"),s.style.setProperty("--renuvex-pr-load-more-size",m.loadMoreSize+"px"),s.style.setProperty("--renuvex-pr-load-more-min-height",m.loadMoreMinHeight+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-y",m.loadMorePadY+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-x",m.loadMorePadX+"px"),s.style.setProperty("--renuvex-pr-load-more-mobile-min-height",m.loadMoreMobileMinHeight+"px"),s.style.setProperty("--renuvex-pr-pagination-button-size",m.paginationButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-pad-x",m.paginationPadX+"px"),s.style.setProperty("--renuvex-pr-pagination-gap",m.paginationGap+"px"),s.style.setProperty("--renuvex-pr-pagination-margin-top",m.paginationMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-gap-min",m.paginationGapMin+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-button-size",m.paginationMobileButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-font-size",m.paginationMobileFontSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap",m.paginationMobileGap+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",m.paginationMobileMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",m.paginationMobileGapMin+"px"),s.style.setProperty("--renuvex-pr-read-more-size",m.readMoreSize+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size",f+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size-mobile",h+"px");var b=Yn(f),E=Yn(h);s.style.setProperty("--renuvex-pr-media-play-size",b+"px"),s.style.setProperty("--renuvex-pr-media-play-icon-size",jn(b)+"px"),s.style.setProperty("--renuvex-pr-media-play-size-mobile",E+"px"),s.style.setProperty("--renuvex-pr-media-play-icon-size-mobile",jn(E)+"px");var P=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";s.style.setProperty("--renuvex-pr-review-star-color",P),s.style.setProperty("--renuvex-pr-star-size",m.reviewStarSize+"px"),s.style.setProperty("--renuvex-pr-avg-star-size",m.avgStarSize+"px"),Ae(lt(r.summaryLayout),r.size),Ae(pt(r.reviewLayout),r.size);var z=vr(r),C=Bo();if(!C)return;var g=Io(C,e),k=document.getElementById("renuvex-reviews");k||(k=document.createElement("div"),k.id="renuvex-reviews",k.style.minHeight="200px"),k.parentNode!==g&&g.appendChild(k);var A=ba(k),w=$e+Ge+Yr+Tn()+_n();Je(A,w);var S=wa(A);if(r.enabled===!1){k.style.minHeight="auto",S.replaceChildren(Ln(r.borderRadius!==void 0?r.borderRadius:8)),Nr(!1);var T=Rr;Br(null),T&&Wt(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var L=t||{},O=xt(L),y=O?[]:L.data&&L.data.reviews||[];aa(y),S.replaceChildren();var M=document.createElement("section");if(M.id="renuvex-reviews-widget",M.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),M.className="renuvex-pr-reviews-widget",M.setAttribute("data-renuvex-surface","reviews"),e&&M.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(M.style.width="100%",M.style.maxWidth="100%",M.style.marginLeft="0",M.style.marginRight="0"),p){var R=document.createElement("div"),F=r.summaryLayout||"classic";R.className="renuvex-pr-title renuvex-pr-title-"+F,R.textContent=p,M.appendChild(R)}if(O){M.appendChild(Bn(L.message,l.onRetry)),S.appendChild(M),Ue(A),vt(M,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return A.getElementById("renuvex-reviews-widget")});return}var _=L.data&&L.data.allCount||0,B=L.data&&L.data.ratingCounts||null,j=B||[0,0,0,0,0],I=L.data&&L.data.avgRating||"0.0";if(!B&&y.length>0){y.forEach(function(G){G.rating>=1&&G.rating<=5&&j[G.rating-1]++});var U=y.reduce(function(G,Z){return G+Z.rating},0);I=(U/y.length).toFixed(1)}if(_===0)M.classList.add("renuvex-pr-reviews-empty"),M.appendChild(Rn({iconPair:z,writeButtonText:D(r.writeButtonText,"Yorum Yap"),emptyStateText:D(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:ae}));else{var Y=lt(r.summaryLayout),W=Y.render({widget:M,productId:e,data:L,settings:r,iconPair:z,allCount:_,ratingCounts:j,avgRatingVal:I,currentRatingFilter:ie,currentOrderBy:te,currentMediaFilter:oe,onFilterChange:l.onFilterChange,onSortChange:l.onSortChange});M.appendChild(W);var H=Un({settings:r,root:s,currentMediaFilter:oe,mediaStripReviews:Xt,openReviewModal:he,wireLightboxTrigger:gr});if(H&&M.appendChild(H),y.length===0)M.appendChild(Nn());else{var ee=pt(r.reviewLayout);y.forEach(function(G){M.appendChild(ee.render(G,ct))})}var V=r.paginationMode==="numbered"?"numbered":"loadMore";if(V==="numbered"){var $=L.data&&L.data.totalPages||1;$>1&&M.appendChild(Vn({page:L.data&&L.data.page||sr||1,totalPages:$,onPageChange:l.onPageChange}))}var J=V==="loadMore"&&L.data&&L.data.hasMore;if(J){let G=function(Z){K.textContent=Z,q.setAttribute("aria-label",Z)};var pr=G,q=document.createElement("button");q.className="renuvex-pr-load-more";var K=document.createElement("span");K.className="renuvex-pr-load-more-label",K.setAttribute("aria-hidden","true"),q.appendChild(K),G("Daha Fazla G\xF6ster"),q.onclick=async function(){q.disabled=!0,G("Y\xFCkleniyor...");var Z=je(),ne=Q,Ie=te,Cr=sr,Er=ie,Tr=oe,Ar=_r,Mr=Cr+1,ye=await He(ne,Ie,Mr,Er,Tr,null,Ar);if(We(Z,{productId:ne,orderBy:Ie,page:Cr,ratingFilter:Er,mediaFilter:Tr,nextCursor:Ar}))if(ye&&!xt(ye)&&ye.data&&Array.isArray(ye.data.reviews)){var ur=na(ye.data.reviews);ia(ur),Oe(Mr),_e(ye.data.nextCursor||null);var Pr=pt(N.reviewLayout);ur.forEach(function(Wn){M.insertBefore(Pr.render(Wn,ct),q)}),ye.data.hasMore?(q.disabled=!1,G("Daha Fazla G\xF6ster")):q.remove()}else q.disabled=!1,G("Tekrar Dene")},M.appendChild(q)}}S.appendChild(M),Ue(A),vt(M,"reviews-widget",{productId:e||""},function(){return A.getElementById("renuvex-reviews-widget")})}catch(G){console.error("[renuvex-pr] render error:",G);var X=document.createElement("p");X.style.cssText="text-align:center;color:#dc2626;",X.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",S&&S.replaceChildren(X)}}finally{if(Nr(!1),Rr){var me=Rr;Br(null),Wt(me.productId,me.settings,me.reviewsData,me.productName,me.orderBy,me.page,me.badgeSettings)}}}export{Wt as render};
