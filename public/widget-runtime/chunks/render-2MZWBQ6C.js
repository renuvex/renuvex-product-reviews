...
`}var ol=La(ei),ri=La(gr);function ti(e,r){var d;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let a=t.get("media-theme-gerwig"),n=a==null?void 0:a.template;if(!a||!(n instanceof HTMLTemplateElement))return;let i=n.cloneNode(!0);i.id=e,(d=i.content.querySelector("media-controller"))==null||d.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class l extends a{}l.template=i,t.define(e,l)}function ai(e,r){return typeof window=="undefined"?Promise.resolve():($r!=null||($r=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),$r.then(()=>{ti(e,r)}))}function Ra(){return ai(Qn,ri)}var bt=null,Ia="--center-play-button";function ni(){return bt||(bt=Ra()),bt}function ii(e){return new Promise(function(r){function t(a){if(a<=0){r();return}requestAnimationFrame(function(){t(a-1)})}t(e)})}function oi(e){e.style.setProperty(Ia,"none")}function Na(e){e.style.removeProperty(Ia)}function li(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=ga(e.url);return r&&t&&r!==t?"":r||t}function di(e,r){var t=li(r);if(!t)return!1;var a=Xe(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("nohotkeys",""),e.setAttribute("lang","tr"),e.setAttribute("theme",_a),e.setAttribute("accent-color",gr.controlForeground),e.setAttribute("primary-color",gr.controlForeground),e.setAttribute("secondary-color",gr.controlBackground),a&&e.setAttribute("poster",a),e.setAttribute("playback-id",t),!0}function Ba(e){e.preventDefault()}function Fa(e,r){var t=!1,a=document.createElement("mux-player");a.className=r||"renuvex-pr-modal-main-video",a.setAttribute("aria-label","Yorum videosu"),oi(a),a.addEventListener("contextmenu",Ba);var n=di(a,e);return n?ni().then(function(){if(window.customElements&&typeof window.customElements.whenDefined=="function")return window.customElements.whenDefined("mux-player")}).then(function(){if(!t){try{typeof a.pause=="function"&&a.pause()}catch(i){}return ii(2)}}).then(function(){t||Na(a)}).catch(function(){t||a.dispatchEvent(new Event("error"))}):setTimeout(function(){t||a.dispatchEvent(new Event("error"))},0),{element:a,cleanup:function(){t=!0;try{typeof a.pause=="function"&&a.pause()}catch(o){}a.removeAttribute("playback-id"),a.removeAttribute("playback-token"),a.removeAttribute("thumbnail-token"),a.removeAttribute("poster"),Na(a),a.removeEventListener("contextmenu",Ba)}}}function er(e){return Ne(e)}function Ua(e){return e&&e.source==="mediaGallery"}function pi(e,r){if(!Ua(r))return er(e);var t=xe(e);return t?[t]:[]}function ui(e,r){return(e||[]).filter(function(t){return r==="mediaGallery"?!!xe(t):er(t).length>0})}function wt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Oa(e,r,t,a,n,i){e&&e.shadowRoot&&wt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),jr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Ir(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(n)}function si(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ze(e.rating,I);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Se(e.createdAt),a.appendChild(n),a.appendChild(i),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=V(I&&I.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",u.appendChild(m),u.appendChild(v),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Ha(e,r,t){var a=t||I,n=e.querySelector(".renuvex-pr-modal-scroll-content"),i=n.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ze(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=Se(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=n.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=V(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}var vi=112;function kt(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function ci(e){var r=e&&e.target;return!!(r&&typeof r.closest=="function"&&r.closest(".renuvex-pr-modal-thumbs"))}function mi(e,r,t){if(!r||r.type!=="video"||!t)return!1;var a=kt(e);if(!a)return!1;var n=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!n||typeof n.getBoundingClientRect!="function")return!1;var i=n.getBoundingClientRect();if(!i.width||!i.height||a.clientX<i.left||a.clientX>i.right||a.clientY<i.top||a.clientY>i.bottom)return!1;var o=Math.min(vi,Math.max(72,i.height*.2));return a.clientY>=i.bottom-o}function fi(e){var r=e&&e.type==="video"?e.posterUrl:e&&e.url;if(e&&e.type==="video"){var t={width:Ce,height:Ce,fit:"crop"};return{src:Xe(r,t),srcset:Hr(r,t)}}return mr(r,Ce)}function xi(e,r,t){var a=e&&e.media;if(!a)return null;var n=document.createElement("button");n.type="button",n.className="renuvex-pr-modal-thumb renuvex-pr-modal-thumb-button"+(a.type==="video"?" renuvex-pr-modal-thumb-video":"")+(r?" renuvex-pr-modal-thumb-active":""),n.setAttribute("aria-label","Galeri medyas\u0131 "+(e.index+1)+" se\xE7"),r&&n.setAttribute("aria-current","true");var i=document.createElement("img");i.className="renuvex-pr-modal-thumb-img";var o=fi(a);if(i.src=o.src,o.srcset&&(i.srcset=o.srcset),i.loading="lazy",i.decoding="async",i.width=Ce,i.height=Ce,i.alt="",fr(i),n.appendChild(i),a.type==="video"){var l=document.createElement("span");l.className="renuvex-pr-modal-thumb-play";var d=re(Ke);d&&l.appendChild(d),n.appendChild(l)}return n.onclick=t,n}function gi(e){var r=[];return(e||[]).forEach(function(t,a){var n=xe(t);n&&r.push({review:t,reviewIdx:a,media:n,index:r.length})}),r}function zt(e,r,t,a,n,i,o,l,d){var u=pi(e,d),m=Math.max(0,Math.min(t||0,u.length-1)),v=u[m],p=document.createElement("div");p.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Fa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),c=x.element;c.addEventListener("error",function(){if(!p.querySelector(".renuvex-pr-modal-img-error")){var L=document.createElement("div");L.className="renuvex-pr-modal-img-error",L.setAttribute("role","status"),L.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",p.insertBefore(L,c)}});var f=!1,h=function(){p.classList.add("renuvex-pr-modal-left-video-playing")},b=function(){f=!0,h()},E=function(){f&&h()},P=function(){f=!1,p.classList.remove("renuvex-pr-modal-left-video-playing")};c.addEventListener("play",b),c.addEventListener("playing",b),c.addEventListener("pause",E),c.addEventListener("ended",P),p.__renuvexMediaCleanup=function(){c.removeEventListener("play",b),c.removeEventListener("playing",b),c.removeEventListener("pause",E),c.removeEventListener("ended",P),P(),x.cleanup()},p.appendChild(c)}else{var w=document.createElement("img");if(w.className="renuvex-pr-modal-main-img"+(s?" "+s:""),w.src=ft(v?v.url:""),w.decoding="async",w.width=mt,w.height=Math.round(mt*4/3),w.alt="Yorum foto\u011Fraf\u0131",!s){w.classList.add("renuvex-pr-modal-img-loading");var C=function(){w.classList.remove("renuvex-pr-modal-img-loading")};w.complete&&w.naturalWidth>0?C():(w.addEventListener("load",C,{once:!0}),w.addEventListener("error",C,{once:!0}))}ca(w,function(L){if(L.style.display="none",!p.querySelector(".renuvex-pr-modal-img-error")){var N=document.createElement("div");N.className="renuvex-pr-modal-img-error",N.setAttribute("role","status"),N.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(N,L)}}),p.appendChild(w)}var g=document.createElement("button");g.className="renuvex-pr-modal-close-mobile";var z=re(ke);z&&g.appendChild(z),g.setAttribute("aria-label","Kapat"),g.onclick=function(L){L.stopPropagation(),i()},p.appendChild(g);var M=0,k=!1,S=!1;if(p.addEventListener("touchstart",function(L){var N=kt(L);N&&(S=ci(L),M=N.clientX,k=!S&&mi(L,v,p))},{passive:!0}),p.addEventListener("touchend",function(L){if(S){S=!1,k=!1;return}if(k){k=!1;return}var N=kt(L);if(N){var G=M-N.clientX;if(!(Math.abs(G)<50)){if(G>0){if(A)he(e,r,m+1,a,n,i,!0,"next",l,d);else if(F){var B=a[r+1];he(B,r+1,0,a,n,i,!1,"next",l,d)}}else if(y)he(e,r,m-1,a,n,i,!0,"prev",l,d);else if(R){var D=a[r-1],$=er(D);he(D,r-1,$.length-1,a,n,i,!1,"prev",l,d)}}}},{passive:!0}),Ua(d)){var T=gi(a);if(T.length>1){var _=document.createElement("div");_.className="renuvex-pr-modal-thumbs renuvex-pr-modal-thumbs--gallery",T.forEach(function(L){var N=xi(L,L.reviewIdx===r,function(){he(L.review,L.reviewIdx,0,a,n,i,!1,null,l,d)});N&&_.appendChild(N)}),p.appendChild(_)}}else if(u.length>1){var O=document.createElement("div");O.className="renuvex-pr-modal-thumbs",u.forEach(function(L,N){var G=L.type==="video"?L.posterUrl:L.url,B=document.createElement("img"),D=mr(G,Ce);B.src=D.src,B.srcset=D.srcset,B.loading="lazy",B.decoding="async",B.width=Ce,B.height=Ce,B.className="renuvex-pr-modal-thumb"+(N===m?" renuvex-pr-modal-thumb-active":""),B.alt="K\xFC\xE7\xFCk resim "+(N+1),fr(B),B.tabIndex=0,B.setAttribute("role","button"),B.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(N+1)+" se\xE7"),N===m&&B.setAttribute("aria-current","true"),(function($){function Y(){he(e,r,$,a,n,i,!0,null,l,d)}B.onclick=Y,B.onkeydown=function(q){(q.key==="Enter"||q.key===" ")&&(q.preventDefault(),Y())}})(N),O.appendChild(B)}),p.appendChild(O)}var y=m>0,A=m<u.length-1,R=r>0,F=r<a.length-1,U=y||R,Z=A||F;if(U){var X=document.createElement("button");X.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var j=re(qe);j&&X.appendChild(j),X.setAttribute("aria-label","\xD6nceki"),X.onclick=function(L){if(L.stopPropagation(),y)he(e,r,m-1,a,n,i,!0,"prev",l,d);else if(R){var N=a[r-1],G=er(N);he(N,r-1,G.length-1,a,n,i,!1,"prev",l,d)}},p.appendChild(X)}if(Z){var H=document.createElement("button");H.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var W=re(Fr);W&&H.appendChild(W),H.setAttribute("aria-label","Sonraki"),H.onclick=function(L){if(L.stopPropagation(),A)he(e,r,m+1,a,n,i,!0,"next",l,d);else if(F){var N=a[r+1];he(N,r+1,0,a,n,i,!1,"next",l,d)}},p.appendChild(H)}return p}function Va(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=er(a);n[0]&&n[0].type==="image"&&(new Image().src=ft(n[0].url))}})}function yt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function hi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){yt(t),yt(a),yt(n)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function he(e,r,t,a,n,i,o,l,d,u){if(u&&(u.currentReview=e),o){var m=zt(e,r,t,a,n,i,l,d,u);n.firstChild&&(wt(n.firstChild),n.replaceChild(m,n.firstChild))}else{var m=zt(e,r,t,a,n,i,l,d,u),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&(wt(n.firstChild),n.replaceChild(m,n.firstChild)),v&&Ha(v,e,u&&u.currentSettings),hi(d,n)}Va(r,a)}function fe(e,r,t,a){var n=a&&a.source==="mediaGallery"?"mediaGallery":"review",i=n==="mediaGallery"?xe(e)?[xe(e)]:[]:er(e);if(!i.length)return;var o=ui(t,n),l=o.findIndex(function(k){return k===e||k.id===e.id});l===-1&&(o.unshift(e),l=0);var d=i.findIndex(function(k){return k.url===r});d<0&&(d=0);var u=document.createElement("div");u.className="renuvex-pr-modal-overlay";var m=document.createElement("div");m.className="renuvex-pr-modal";var v=!1,p=null,s=Wr(),x=Pe(),c=Yr(),f=qr(),h={currentReview:e,currentSettings:I,source:n},b=null;function E(k){var S=k&&k.detail&&k.detail.settings;if(!(S&&S===b)){b=S||null,h.currentSettings=S||I;var T=m.querySelector(".renuvex-pr-modal-right");!T||!h.currentReview||Ha(T,h.currentReview,h.currentSettings)}}function P(){v||(v=!0,window.removeEventListener(He,E),Oa(p&&p.host,w,P,c,s,x))}function w(k){if(k.key==="Escape"){C();return}Gr(k,u,p&&p.root)}function C(){v||(v=!0,window.removeEventListener(He,E),Oa(p&&p.host,w,P,c,s,x),Kr(f))}document.addEventListener("keydown",w),window.addEventListener("popstate",P),window.addEventListener(He,E),u.onclick=function(){C()},m.onclick=function(k){k.stopPropagation()},m.appendChild(zt(e,l,d,o,m,C,null,u,h)),m.appendChild(si(e)),Va(l,o);var g=document.createElement("div");g.className="renuvex-pr-modal-wrap",g.tabIndex=-1,g.setAttribute("role","dialog"),g.setAttribute("aria-modal","true"),g.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),g.appendChild(m);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var M=re(ke);M&&z.appendChild(M),z.setAttribute("aria-label","Kapat"),z.onclick=function(k){k.stopPropagation(),C()},g.appendChild(z),u.appendChild(g),p=Vr(),Je(p.root,$e+Ge+Dr),p.root.appendChild(u),Ue(p.root),ve(g)}function rr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var _t={};Me(_t,{css:()=>ao,meta:()=>to,render:()=>no});function tr(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,i=e.onFilterChange;Le(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,u=t>0?Math.round(d/t*100):0,m=n===l,v=d>0,p=V(I&&I.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(n&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+p+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+p);for(var x="",c=1;c<=5;c++){var f=c<=l;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(f?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(E){(E.key==="Enter"||E.key===" "||E.key==="Space"||E.key==="Spacebar")&&(E.preventDefault(),b())}})(l),o.appendChild(s)}return o}var ja="data-renuvex-pr-dismiss-gesture",De=[],Da=!1,Jr=!1,hr=[],ar=null;function Ya(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function St(){for(var e=De.length-1;e>=0;e--){var r=De[e].element;r&&r.isConnected===!1&&De.splice(e,1)}return De}function bi(e){!e||typeof e.setAttribute!="function"||(hr.indexOf(e)===-1&&hr.push(e),e.setAttribute(ja,""))}function Wa(){for(var e=0;e<hr.length;e++){var r=hr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(ja)}hr=[],ar&&typeof clearTimeout=="function"&&clearTimeout(ar),ar=null}function yi(e){if(Jr){Jr=!1,Wa(),e.preventDefault(),e.stopPropagation();return}for(var r=St(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Ya(e,n.trigger)||Ya(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function wi(e){if(e.key==="Escape")for(var r=St(),t=r.length-1;t>=0;t--)r[t].close()}function Ga(){Da||typeof document=="undefined"||(document.addEventListener("click",yi,!0),document.addEventListener("keydown",wi),Da=!0)}function ki(e){Ga(),Jr=!0,bi(e),ar&&typeof clearTimeout=="function"&&clearTimeout(ar),typeof setTimeout=="function"&&(ar=setTimeout(function(){Jr=!1,Wa()},700))}function Ct(e){ki(e)}function Zr(e){Ga();var r={trigger:e.trigger,element:e.element,close:e.close};return De.push(r),{unregister:function(){var t=De.indexOf(r);t!==-1&&De.splice(t,1)},notifyOpening:function(){for(var t=St(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function de(e){var r=e.widget,t=e.currentOrderBy,a=e.currentMediaFilter||"none",n=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=V(I&&I.writeButtonText,"Yorum Yap"),l.onclick=n,o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var m=I&&I.filterIcon||"lines";u.innerHTML=se(la(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var p=Xt===!0?"media":"images",s=p==="media"?"Foto\u011Fraf ve Video":"Foto\u011Frafl\u0131",x=[{orderBy:"newest",label:"En Yeni",mediaFilter:"none"},{orderBy:"highest",label:"En Y\xFCksek Puan",mediaFilter:"none"},{orderBy:"lowest",label:"En D\xFC\u015F\xFCk Puan",mediaFilter:"none"},{orderBy:"newest",label:s,mediaFilter:p}],c=!1;function f(){return r&&r.parentNode||r||null}function h(w,C){if(!(C===!0||!w)){if(w.type==="touchstart"){Ct(f());return}if(w.type==="pointerdown"){var g=w.pointerType||"";g&&g!=="mouse"&&Ct(f())}}}function b(w){var C=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var g=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(C&&g)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(M){}}return C}function E(){P.notifyOpening(),v.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var w=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(C){try{w.focus()}catch(g){}}})}x.forEach(function(w){var C=w.mediaFilter!=="none",g=C?a===w.mediaFilter:a==="none"&&(t||"newest")===w.orderBy,z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(g?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=w.label;var M=!1;function k(S,T){S&&(S.preventDefault(),S.stopPropagation()),!M&&(M=!0,c=!0,h(S,T),b({restoreFocus:T}),i(w.orderBy,w.mediaFilter),setTimeout(function(){M=!1,c=!1},0))}z.addEventListener("pointerdown",function(S){S.button!==void 0&&S.button!==0||S.pointerType!=="mouse"&&k(S,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(S){k(S,!1)},{passive:!1}),z.addEventListener("keydown",function(S){(S.key==="Enter"||S.key===" ")&&k(S,!0)}),z.onclick=function(S){k(S,!1)},v.appendChild(z)}),u.onclick=function(){v.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):E()},d.addEventListener("keydown",function(w){w.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(w){if(v.classList.contains("renuvex-pr-open")&&!c){var C=w.relatedTarget;C&&d.contains(C)||b()}});var P=Zr({trigger:d,element:v,close:b});return d.appendChild(u),d.appendChild(v),o.appendChild(d),o}var qa=`
