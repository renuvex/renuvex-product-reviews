...
`;var wi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ki=tn,zi="__unknown_product__",cr=Object.create(null);function Si(e){return e?String(e):zi}var Oe=null,mr=null;function Ci(){!Oe||!mr||(Oe.removeEventListener?Oe.removeEventListener("change",mr):Oe.removeListener&&Oe.removeListener(mr),Oe=null,mr=null)}function Ei(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,c=e.currentHasImages,m=e.onFilterChange,d=e.onSortChange,v=Si(t),k=document.createElement("div");k.className="renuvex-pr-summary renuvex-pr-summary-compact";var s=document.createElement("div");s.className="renuvex-pr-compact-header";var x=document.createElement("div");x.className="renuvex-pr-compact-trigger-wrap";var g=document.createElement("button");g.className="renuvex-pr-compact-trigger",g.type="button",g.setAttribute("aria-expanded","false"),g.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Pe(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+le(Jt)+"</span>";var y=g.querySelector(".renuvex-pr-compact-trigger-text"),h=g.querySelector(".renuvex-pr-compact-chevron");if(y&&(y.textContent=i.toLocaleString("tr-TR")+" "+U(n.countLabel,"Yorum")),y&&h){var w=document.createElement("span");w.className="renuvex-pr-compact-trigger-count",g.insertBefore(w,y),w.appendChild(y),w.appendChild(h)}x.appendChild(g),s.appendChild(x);var b=ne({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:$,onSortChange:d}),z=b.querySelector(".renuvex-pr-filter-wrap"),S=b.querySelector(".renuvex-pr-write-btn"),P=document.createElement("div");P.className="renuvex-pr-compact-actions-slot",S&&P.appendChild(S),z&&P.appendChild(z),s.appendChild(P),k.appendChild(s);var E=document.createElement("div");E.className="renuvex-pr-compact-panel",E.setAttribute("role","dialog"),E.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),E.setAttribute("aria-hidden","true");var A=document.createElement("div");A.className="renuvex-pr-compact-panel-inner";var f=document.createElement("div");f.className="renuvex-pr-compact-avg",f.innerHTML='<span class="renuvex-pr-icon">'+oe("full")+"</span><span>"+p+"</span>",A.appendChild(f),A.appendChild(Ke({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(O){M()&&E.classList.contains("renuvex-pr-open")&&(cr[v]=!0),m(O)}})),E.appendChild(A);var C=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function M(){return!!(C&&C.matches)}function T(O){O?E.classList.add("renuvex-pr-open"):E.classList.remove("renuvex-pr-open"),E.setAttribute("aria-hidden",O?"false":"true"),g.setAttribute("aria-expanded",O?"true":"false")}function N(O){var j=O?k:x;if(E.parentNode!==j){var ve=!!E.parentNode;E.classList.contains("renuvex-pr-open")&&T(!1),ve&&(cr[v]=!1),j.appendChild(E)}}N(C?C.matches:!1);var L=ne({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:$,onSortChange:d}),I=L.querySelector(".renuvex-pr-filter-wrap"),R=L.querySelector(".renuvex-pr-write-btn"),H=document.createElement("div");H.className="renuvex-pr-compact-write-row",R&&H.appendChild(R),I&&H.appendChild(I),k.appendChild(H);function D(){var O=E.classList.contains("renuvex-pr-open");return T(!1),M()&&(cr[v]=!1),O}function B(){Y&&Y.notifyOpening(),T(!0),M()&&(cr[v]=!0)}g.onclick=function(){E.classList.contains("renuvex-pr-open")?D():B()};var Y=null;function W(O){Y&&(Y.unregister(),Y=null),O||(Y=qr({trigger:x,element:E,close:D}))}if(W(C?C.matches:!1),Ci(),C){var F=function(O){N(O.matches),W(O.matches)};C.addEventListener?C.addEventListener("change",F):C.addListener&&C.addListener(F),Oe=C,mr=F}if(M()&&cr[v]&&T(!0),n.showRecommendation!==!1){var K=(o[3]||0)+(o[4]||0),se=i>0?Math.round(K/i*100):0;if(se>0){var Q=document.createElement("div");Q.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",Q.style.marginTop="8px",Q.innerHTML='<span class="renuvex-pr-recommend-pct">%'+se+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",A.appendChild(Q)}}return k}var zt={};Ce(zt,{css:()=>Ai,meta:()=>Ti,render:()=>Pi});var an=`
