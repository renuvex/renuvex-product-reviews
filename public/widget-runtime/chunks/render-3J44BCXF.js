...
`);function Ia(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function de(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function Ba(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Ma(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",p=Ba()&&!n;if(a>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),p&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function _a(e){var r=document.body.style,t=document.documentElement.style;de(t,"overflow",e.rootOverflow,e.rootOverflowPriority),de(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),de(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),de(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),de(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),de(r,"position",e.bodyPosition,e.bodyPositionPriority),de(r,"top",e.bodyTop,e.bodyTopPriority),de(r,"left",e.bodyLeft,e.bodyLeftPriority),de(r,"right",e.bodyRight,e.bodyRightPriority),de(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var or=0,We=null;function Er(){return or+=1,or>1||(We=Ia(),Ma(We)),We}function Tr(){if(or!==0&&(or-=1,!(or>0))){var e=We;We=null,e&&_a(e)}}function Fa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Ar(){var e=Fa();return!e||e===document.body||e===document.documentElement?null:e}function ie(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Oa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Vr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Oa)}function Ha(e,r){var t=e,a=Vr(e);!a.length&&r&&(t=r,a=Vr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;ie(n)}function Lr(e,r,t){if(e.key==="Tab"){var a=Vr(r);if(!a.length){e.preventDefault(),Ha(r);return}var n=a[0],p=a[a.length-1],o=Ft(t);if(!r.contains(o)){e.preventDefault(),ie(n);return}if(a.indexOf(o)===-1){e.preventDefault(),ie(e.shiftKey?p:n);return}e.shiftKey&&o===n?(e.preventDefault(),ie(p)):!e.shiftKey&&o===p&&(e.preventDefault(),ie(n))}}var Wt="renuvexPrOverlay";function Pr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Wt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Ya(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Wt]===e.id)}function Nr(e){if(Ya(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function qe(e){return Se(e)}function qt(e,r,t,a,n,p){Tr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&br(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),p&&ie(n)}function Da(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=xe(e.rating,R);var p=document.createElement("span");p.className="renuvex-pr-modal-date",p.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(p),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var l=document.createElement("div");l.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=M(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi");var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",l.appendChild(f),l.appendChild(s),l.style.display=e.merchantReply?"":"none",t.appendChild(l),r.appendChild(t),r}function Gt(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),p=n.querySelector(".renuvex-pr-modal-stars");p.innerHTML=xe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=fe(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=M(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function qr(e,r,t,a,n,p,o,i,d){var l=qe(e),f=Math.max(0,Math.min(t||0,l.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var u=document.createElement("img"),v=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(u.className="renuvex-pr-modal-main-img"+(v?" "+v:""),u.src=jr(l[f]||""),u.decoding="async",u.width=Dr,u.height=Math.round(Dr*4/3),u.alt="Yorum foto\u011Fraf\u0131",!v){u.classList.add("renuvex-pr-modal-img-loading");var y=function(){u.classList.remove("renuvex-pr-modal-img-loading")};u.complete&&u.naturalWidth>0?y():(u.addEventListener("load",y,{once:!0}),u.addEventListener("error",y,{once:!0}))}Rt(u,function(P){if(P.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var S=document.createElement("div");S.className="renuvex-pr-modal-img-error",S.setAttribute("role","status"),S.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(S,P)}}),s.appendChild(u);var c=document.createElement("button");c.className="renuvex-pr-modal-close-mobile";var g=ne(Re);g&&c.appendChild(g),c.setAttribute("aria-label","Kapat"),c.onclick=function(P){P.stopPropagation(),p()},s.appendChild(c);var m=0;if(s.addEventListener("touchstart",function(P){m=P.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(P){var S=m-P.changedTouches[0].clientX;if(!(Math.abs(S)<50)){if(S>0){if(k)ge(e,r,f+1,a,n,p,!0,"next",i,d);else if(z){var N=a[r+1];ge(N,r+1,0,a,n,p,!1,"next",i,d)}}else if(x)ge(e,r,f-1,a,n,p,!0,"prev",i,d);else if(b){var Y=a[r-1],G=qe(Y);ge(Y,r-1,G.length-1,a,n,p,!1,"prev",i,d)}}},{passive:!0}),l.length>1){var h=document.createElement("div");h.className="renuvex-pr-modal-thumbs",l.forEach(function(P,S){var N=document.createElement("img"),Y=pe(P,kr);N.src=Y.src,N.srcset=Y.srcset,N.loading="lazy",N.decoding="async",N.width=kr,N.height=kr,N.className="renuvex-pr-modal-thumb"+(S===f?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(S+1),ue(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(S+1)+" se\xE7"),S===f&&N.setAttribute("aria-current","true"),(function(G){function ee(){ge(e,r,G,a,n,p,!0,null,i,d)}N.onclick=ee,N.onkeydown=function(D){(D.key==="Enter"||D.key===" ")&&(D.preventDefault(),ee())}})(S),h.appendChild(N)}),s.appendChild(h)}var x=f>0,k=f<l.length-1,b=r>0,z=r<a.length-1,E=x||b,A=k||z;if(E){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var T=ne(De);T&&w.appendChild(T),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(P){if(P.stopPropagation(),x)ge(e,r,f-1,a,n,p,!0,"prev",i,d);else if(b){var S=a[r-1],N=qe(S);ge(S,r-1,N.length-1,a,n,p,!1,"prev",i,d)}},s.appendChild(w)}if(A){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=ne(yr);L&&C.appendChild(L),C.setAttribute("aria-label","Sonraki"),C.onclick=function(P){if(P.stopPropagation(),k)ge(e,r,f+1,a,n,p,!0,"next",i,d);else if(z){var S=a[r+1];ge(S,r+1,0,a,n,p,!1,"next",i,d)}},s.appendChild(C)}return s}function Kt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=qe(a);n[0]&&(new Image().src=jr(n[0]))}})}function Wr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function ja(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function p(){Wr(t),Wr(a),Wr(n)}p(),t&&ie(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){p(),requestAnimationFrame(p)}):setTimeout(p,0)}function ge(e,r,t,a,n,p,o,i,d,l){if(l&&(l.currentReview=e),o){var f=qr(e,r,t,a,n,p,i,d,l);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=qr(e,r,t,a,n,p,i,d,l),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),s&&Gt(s,e,l&&l.currentSettings),ja(d,n)}Kt(r,a)}function se(e,r,t){var a=qe(e);if(!a.length)return;var n=(t||[]).filter(function(A){return qe(A).length>0}),p=n.findIndex(function(A){return A===e||A.id===e.id});p===-1&&(n.unshift(e),p=0);var o=a.indexOf(r);o<0&&(o=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var l=!1,f=null,s=Ar(),u=Ye(),v=Er(),y=Pr(),c={currentReview:e,currentSettings:R},g=null;function m(A){var w=A&&A.detail&&A.detail.settings;if(!(w&&w===g)){g=w||null,c.currentSettings=w||R;var T=d.querySelector(".renuvex-pr-modal-right");!T||!c.currentReview||Gt(T,c.currentReview,c.currentSettings)}}function h(){l||(l=!0,window.removeEventListener(Ie,m),qt(f&&f.host,x,h,v,s,u))}function x(A){if(A.key==="Escape"){k();return}Lr(A,i,f&&f.root)}function k(){l||(l=!0,window.removeEventListener(Ie,m),qt(f&&f.host,x,h,v,s,u),Nr(y))}document.addEventListener("keydown",x),window.addEventListener("popstate",h),window.addEventListener(Ie,m),i.onclick=function(){k()},d.onclick=function(A){A.stopPropagation()},d.appendChild(qr(e,p,o,n,d,k,null,i,c)),d.appendChild(Da(e)),Kt(p,n);var b=document.createElement("div");b.className="renuvex-pr-modal-wrap",b.tabIndex=-1,b.setAttribute("role","dialog"),b.setAttribute("aria-modal","true"),b.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),b.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var E=ne(Re);E&&z.appendChild(E),z.setAttribute("aria-label","Kapat"),z.onclick=function(A){A.stopPropagation(),k()},b.appendChild(z),i.appendChild(b),f=Cr(),Ve(f.root,Ue+He+Sr),f.root.appendChild(i),Ne(f.root),ie(b)}function Ee(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Zr={};ze(Zr,{css:()=>Qa,meta:()=>$a,render:()=>en});function Ge(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,p=e.onFilterChange;Ce(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,l=t>0?Math.round(d/t*100):0,f=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":"")+(n&&!f?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",f?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+M(R&&R.countLabel,"Yorum")+", "+(f?"filtreyi kald\u0131r":"filtrele"));for(var u="",v=1;v<=5;v++){var y=v<=i;u+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ae(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+u+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+l+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(c){function g(){p(c)}s.onclick=g,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),g())}})(i),o.appendChild(s)}return o}var Zt="data-renuvex-pr-dismiss-gesture",Me=[],Xt=!1,Rr=!1,lr=[],Ke=null;function Jt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Gr(){for(var e=Me.length-1;e>=0;e--){var r=Me[e].element;r&&r.isConnected===!1&&Me.splice(e,1)}return Me}function Ua(e){!e||typeof e.setAttribute!="function"||(lr.indexOf(e)===-1&&lr.push(e),e.setAttribute(Zt,""))}function $t(){for(var e=0;e<lr.length;e++){var r=lr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Zt)}lr=[],Ke&&typeof clearTimeout=="function"&&clearTimeout(Ke),Ke=null}function Va(e){if(Rr){Rr=!1,$t(),e.preventDefault(),e.stopPropagation();return}for(var r=Gr(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Jt(e,n.trigger)||Jt(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Wa(e){if(e.key==="Escape")for(var r=Gr(),t=r.length-1;t>=0;t--)r[t].close()}function Qt(){Xt||typeof document=="undefined"||(document.addEventListener("click",Va,!0),document.addEventListener("keydown",Wa),Xt=!0)}function qa(e){Qt(),Rr=!0,Ua(e),Ke&&typeof clearTimeout=="function"&&clearTimeout(Ke),typeof setTimeout=="function"&&(Ke=setTimeout(function(){Rr=!1,$t()},700))}function Kr(e){qa(e)}function Ir(e){Qt();var r={trigger:e.trigger,element:e.element,close:e.close};return Me.push(r),{unregister:function(){var t=Me.indexOf(r);t!==-1&&Me.splice(t,1)},notifyOpening:function(){for(var t=Gr(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function Q(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,p=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=M(R&&R.writeButtonText,"Yorum Yap"),i.onclick=n,o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var l=document.createElement("button");l.type="button",l.className="renuvex-pr-filter-btn",l.setAttribute("aria-label","Filtrele"),l.setAttribute("aria-haspopup","menu"),l.setAttribute("aria-expanded","false");var f=R&&R.filterIcon||"lines";l.innerHTML=me(St(f));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function y(){return r&&r.parentNode||r||null}function c(x,k){if(!(k===!0||!x)){if(x.type==="touchstart"){Kr(y());return}if(x.type==="pointerdown"){var b=x.pointerType||"";b&&b!=="mouse"&&Kr(y());return}}}function g(x){var k=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),l.classList.remove("renuvex-pr-filter-btn-active"),l.setAttribute("aria-expanded","false");var b=x&&(x.restoreFocus===!0||x.restoreFocus==="auto"&&Ye());if(k&&b)try{l.focus({preventScroll:!0})}catch(z){try{l.focus()}catch(E){}}return k}function m(){h.notifyOpening(),s.classList.add("renuvex-pr-open"),l.classList.add("renuvex-pr-filter-btn-active"),l.setAttribute("aria-expanded","true");var x=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");x&&requestAnimationFrame(function(){try{x.focus({preventScroll:!0})}catch(k){try{x.focus()}catch(b){}}})}u.forEach(function(x){var k=x[2],b=k?a:!a&&(t||"newest")===x[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(b?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=x[1];var E=!1;function A(w,T){w&&(w.preventDefault(),w.stopPropagation()),!E&&(E=!0,v=!0,c(w,T),g({restoreFocus:T}),p(x[0],k),setTimeout(function(){E=!1,v=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&A(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){A(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&A(w,!0)}),z.onclick=function(w){A(w,!1)},s.appendChild(z)}),l.onclick=function(){s.classList.contains("renuvex-pr-open")?g({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(x){x.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(x.stopPropagation(),g({restoreFocus:!0}))}),d.addEventListener("focusout",function(x){if(s.classList.contains("renuvex-pr-open")&&!v){var k=x.relatedTarget;k&&d.contains(k)||g()}});var h=Ir({trigger:d,element:s,close:g});return d.appendChild(l),d.appendChild(s),o.appendChild(d),o}var ea=`
...
`;var rn={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},tn=va,an="__unknown_product__",pr=Object.create(null);function nn(e){return e?String(e):an}var _e=null,ur=null;function on(){!_e||!ur||(_e.removeEventListener?_e.removeEventListener("change",ur):_e.removeListener&&_e.removeListener(ur),_e=null,ur=null)}function ln(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,p=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,l=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange,v=nn(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var g=document.createElement("div");g.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+je(i,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+me(Et)+"</span>";var h=m.querySelector(".renuvex-pr-compact-trigger-text"),x=m.querySelector(".renuvex-pr-compact-chevron");if(h&&(h.textContent=p.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum")),h&&x){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",m.insertBefore(k,h),k.appendChild(h),k.appendChild(x)}g.appendChild(m),c.appendChild(g);var b=Q({widget:r,currentOrderBy:l,currentHasImages:f,onWriteClick:V,onSortChange:u}),z=b.querySelector(".renuvex-pr-filter-wrap"),E=b.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+ae("full")+"</span><span>"+i+"</span>",T.appendChild(C),T.appendChild(Ge({ratingCounts:o,allCount:p,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){P()&&w.classList.contains("renuvex-pr-open")&&(pr[v]=!0),s(I)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function S(I){I?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",I?"false":"true"),m.setAttribute("aria-expanded",I?"true":"false")}function N(I){var le=I?y:g;if(w.parentNode!==le){var _=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&S(!1),_&&(pr[v]=!1),le.appendChild(w)}}N(L?L.matches:!1);var Y=Q({widget:r,currentOrderBy:l,currentHasImages:f,onWriteClick:V,onSortChange:u}),G=Y.querySelector(".renuvex-pr-filter-wrap"),ee=Y.querySelector(".renuvex-pr-write-btn"),D=document.createElement("div");D.className="renuvex-pr-compact-write-row",ee&&D.appendChild(ee),G&&D.appendChild(G),y.appendChild(D);function O(){var I=w.classList.contains("renuvex-pr-open");return S(!1),P()&&(pr[v]=!1),I}function oe(){W&&W.notifyOpening(),S(!0),P()&&(pr[v]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?O():oe()};var W=null;function q(I){W&&(W.unregister(),W=null),I||(W=Ir({trigger:g,element:w,close:O}))}if(q(L?L.matches:!1),on(),L){var K=function(I){N(I.matches),q(I.matches)};L.addEventListener?L.addEventListener("change",K):L.addListener&&L.addListener(K),_e=L,ur=K}if(P()&&pr[v]&&S(!0),a.showRecommendation!==!1){var ve=(o[3]||0)+(o[4]||0),re=p>0?Math.round(ve/p*100):0;if(re>0){var j=document.createElement("div");j.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="renuvex-pr-recommend-pct">%'+re+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(j)}}return y}var Qr={};ze(Qr,{css:()=>un,meta:()=>pn,render:()=>dn});var ca=`
...
`;var kn={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Cn=ya;function Sn(e,r){var t=wr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var p=document.createElement("div");p.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=xe(e.rating,R),p.appendChild(o),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,p.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",p.appendChild(d);var l=document.createElement("time");l.className="renuvex-pr-review-gallery-date",l.style.display="block",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=fe(e.createdAt),p.appendChild(l);var f=(e.comment||"").trim();if(f&&p.appendChild(Je(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){se(e,t,r)}}:null).fragment),n.appendChild(p),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var u=document.createElement("img"),v=pe(t,zr);u.src=v.src,u.srcset=v.srcset,u.loading="lazy",u.decoding="async",u.width=zr,u.height=Math.round(zr*4/3),ue(u),u.setAttribute("data-renuvex-img-url",t),Ee(u,function(){se(e,t,r)}),s.appendChild(u),n.appendChild(s)}var y=Ze(e.merchantReply,t?function(){se(e,t,r)}:null);return y&&(y.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(y)),n}var _r={card:tt,list:at,gallery:nt};function Fr(e){return _r[e]||_r.card}function wa(){return Object.keys(_r).map(function(e){return _r[e].css||""}).join(`
`)}var it=0;function Fe(){return it++,it}function Oe(e,r){return e!==it?!1:r?!(r.productId!==void 0&&F!==r.productId||r.orderBy!==void 0&&U!==r.orderBy||r.page!==void 0&&ar!==r.page||r.ratingFilter!==void 0&&J!==r.ratingFilter||r.hasImages!==void 0&&Z!==r.hasImages||r.nextCursor!==void 0&&mr!==r.nextCursor):!0}var ot={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},lt={small:80,medium:110,large:140},pt={small:80,medium:100,large:110};function za(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var p=document.createElementNS(t,"line");p.setAttribute("x1","1"),p.setAttribute("y1","1"),p.setAttribute("x2","23"),p.setAttribute("y2","23"),a.appendChild(n),a.appendChild(p);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(i),r}function ka(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function be(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),p=parseInt(t[3],16);return"rgba("+a+","+n+","+p+","+r+")"}function Or(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function ut(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function Ca(e){return .2126*ut(e.r)+.7152*ut(e.g)+.0722*ut(e.b)}function Sa(e,r){var t=Ca(e),a=Ca(r),n=Math.max(t,a),p=Math.min(t,a);return(n+.05)/(p+.05)}function Ea(e){var r=Or(e)||Or("#ffffff"),t=Or("#111111"),a=Or("#ffffff");return Sa(t,r)>=Sa(a,r)?"#111111":"#ffffff"}function En(e){return be(e,e==="#ffffff"?.1:.06)}function Ta(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",p=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",l=be(o,.06),f=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",u=r.btnTextColor||"#ffffff",v=r.btnBorderColor||"#111111",y=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",g=r.filterBtnBorderColor||"#111111",m=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",x=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",b=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",E=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",w=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",C=be(w,.65),L=r.replyBgColor||"#f9fafb",P=r.replyBorderColor||"#747474",S=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",Y=r.photoTitleColor||"#111111",G=be("#111111",.05),ee=r.photoArrowBgColor||"#ffffff",D=r.photoArrowTextColor||"#111111",O=be("#111111",.12),oe=r.formBgColor||"#ffffff",W=r.formPrimaryTextColor||"#111111",q=r.formSecondaryTextColor||"#3b3b3b",K=r.inputTextColor||W,ve=r.inputBorderColor||"#d1d5db",re=r.placeholderColor||"#9ca3af",j=r.formStepBarColor||"#111111",I=r.formBtnBgColor||"#111111",le=r.formBtnTextColor||"#ffffff",_=r.formBtnBorderColor||"#111111",H=be(I,.06),Te=be(I,.18),te=be(le,.85),$e=be(W,.06),ye=Ea(oe),B=En(ye),X=r.loadMoreBgColor||"#ffffff",we=r.loadMoreTextColor||"#111111",Ae=r.loadMoreBorderColor||"#111111",dr=r.paginationBgColor||"#ffffff",sr=r.paginationTextColor||"#111111",vr=r.paginationBorderColor||"#e5e7eb",Qe=r.paginationActiveBgColor||"#111111",ce=Ea(Qe),er={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":p,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":l,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":u,"--renuvex-pr-btn-border":v,"--renuvex-pr-filter-btn-bg":y,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":g,"--renuvex-pr-filter-menu-bg":m,"--renuvex-pr-filter-menu-border":h,"--renuvex-pr-filter-item-text":x,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":b,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":E,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":w,"--renuvex-pr-review-border":T,"--renuvex-pr-state-text":C,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":P,"--renuvex-pr-reply-label":S,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":Y,"--renuvex-pr-photo-image-border":G,"--renuvex-pr-photo-arrow-bg":ee,"--renuvex-pr-photo-arrow-text":D,"--renuvex-pr-photo-arrow-border":O,"--renuvex-pr-fwizard-bg":oe,"--renuvex-pr-fwizard-text":W,"--renuvex-pr-fwizard-secondary-text":q,"--renuvex-pr-fwizard-input-bg":oe,"--renuvex-pr-fwizard-input-text":K,"--renuvex-pr-fwizard-input-border":ve,"--renuvex-pr-fwizard-placeholder":re,"--renuvex-pr-fwizard-close-text":ye,"--renuvex-pr-fwizard-close-hover-bg":B,"--renuvex-pr-fwizard-progress-bg":$e,"--renuvex-pr-fwizard-progress-active":j,"--renuvex-pr-fwizard-btn-bg":I,"--renuvex-pr-fwizard-btn-text":le,"--renuvex-pr-fwizard-btn-border":_,"--renuvex-pr-fwizard-btn-disabled-bg":Te,"--renuvex-pr-fwizard-btn-disabled-text":te,"--renuvex-pr-fwizard-nav-hover-bg":H,"--renuvex-pr-load-more-bg":X,"--renuvex-pr-load-more-text":we,"--renuvex-pr-load-more-border":Ae,"--renuvex-pr-pagination-bg":dr,"--renuvex-pr-pagination-text":sr,"--renuvex-pr-pagination-border":vr,"--renuvex-pr-pagination-active-bg":Qe,"--renuvex-pr-pagination-active-text":ce};Object.keys(er).forEach(function(cr){e.style.setProperty(cr,er[cr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Aa(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,p=e.wireLightboxTrigger,o=(e.photoStripReviews||[]).filter(function(k){return Se(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&o.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=M(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),l=document.createElement("div");l.className="renuvex-pr-photo-title",l.textContent=d,i.appendChild(l)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var u=$,v=r.reviewLayout==="card"?$:Math.round($*4/3),y=0;o.forEach(function(k){if(!(y>=15)){var b=wr(k);if(b){var z=document.createElement("img"),E=pe(b,$);z.src=E.src,z.srcset=E.srcset,z.loading=y<3?"eager":"lazy",z.decoding="async",z.width=u,z.height=v,z.className="renuvex-pr-photo-strip-thumb",z.alt="Yorum foto\u011Fraf\u0131",ue(z),(function(A,w){p(z,function(){n(w,A,o)})})(b,k),s.appendChild(z),y++}}});var c=document.createElement("button");c.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var g=ne(De);g&&c.appendChild(g),c.setAttribute("aria-label","\xD6nceki"),c.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=ne(yr);h&&m.appendChild(h),m.setAttribute("aria-label","Sonraki"),m.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var x=document.createElement("div");return x.className="renuvex-pr-photo-strip-wrap",x.appendChild(c),x.appendChild(s),x.appendChild(m),i.appendChild(x),i}var Tn=1,An=7,dt="\u2026";function Ln(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=An){for(var n=[],p=1;p<=t;p++)n.push(p);return n}for(var o=[],i=1;i<=t;i++)(i===1||i===t||Math.abs(i-a)<=Tn)&&o.push(i);for(var d=[],l=0;l<o.length;l++)l>0&&o[l]-o[l-1]>1&&d.push(dt),d.push(o[l]);return d}function La(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function p(i){n.setAttribute("aria-busy","true");for(var d=n.querySelectorAll("button"),l=0;l<d.length;l++)d[l].disabled=!0;a(i)}function o(i,d,l,f){var s=document.createElement("button");return s.type="button",s.className="renuvex-pr-pagination-arrow",s.setAttribute("aria-label",i),s.textContent=d,f?s.disabled=!0:s.onclick=function(){p(l)},s}return n.appendChild(o("\xD6nceki sayfa","\u2039",t-1,t<=1)),Ln(t,r).forEach(function(i){if(i===dt){var d=document.createElement("span");d.className="renuvex-pr-pagination-gap",d.setAttribute("aria-hidden","true"),d.textContent=dt,n.appendChild(d);return}var l=document.createElement("button");l.type="button",l.className="renuvex-pr-pagination-btn",l.textContent=String(i),l.setAttribute("aria-label","Sayfa "+i),i===t?l.setAttribute("aria-current","page"):l.onclick=function(){p(i)},n.appendChild(l)}),n.appendChild(o("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Pa(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Na(e){var r=e.render;async function t(){var o=Fe(),i=F,d=U,l=J,f=Z;ke(null);var s=await Be(F,U,1,J,Z);Oe(o,{productId:i,orderBy:d,ratingFilter:l,hasImages:f})&&await r(F,R,s,Le,U,1,vt)}async function a(o){var i=Fe(),d=J===o?null:o,l=F,f=U,s=Z;mt(d),Pe(1),ke(null);var u=await Be(F,U,1,d,Z);Oe(i,{productId:l,orderBy:f,page:1,ratingFilter:d,hasImages:s})&&await r(F,R,u,Le,U,1)}async function n(o,i){var d=Fe(),l=F,f=J;Pe(1),ke(null);var s=o,u=!1;i&&(u=!0,s="newest"),xt(u),xr(s);var v=await Be(F,s,1,J,u);Oe(d,{productId:l,orderBy:s,page:1,ratingFilter:f,hasImages:u})&&await r(F,R,v,Le,s,1)}async function p(o){var i=Fe(),d=F,l=U,f=J,s=Z;Pe(o),ke(null);var u=await Be(F,U,o,J,Z);if(Oe(i,{productId:d,orderBy:l,page:o,ratingFilter:f,hasImages:s})){await r(F,R,u,Le,U,o);var v=document.getElementById("renuvex-reviews"),y=v&&v.shadowRoot,c=y&&y.querySelector&&y.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(c){try{c.focus({preventScroll:!0})}catch(h){try{c.focus()}catch(x){}}Pa(y,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var g=document.getElementById("renuvex-reviews");if(g&&typeof g.scrollIntoView=="function"){var m=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;g.scrollIntoView({behavior:m?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:p}}function Pn(){return Mt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Nn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=It({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),Bt(t,{surface:"reviews",productId:r||""}),t}async function st(e,r,t,a,n,p,o){if(Ct){hr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:p,badgeSettings:o});return}gr(!0),ft(e),gt(r),o!==void 0&&ht(o),bt(a),n&&xr(n),p&&Pe(p),t!=null&&(yt(t),ke(t&&t.data?t.data.nextCursor:null));var i=Na({render:st});try{let ye=function(B,X){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var we=B.meta.sizeOverrides[X];we&&Object.keys(we).forEach(function(Ae){v.style.setProperty(Ae,we[Ae])})}};var $e=ye,d=Mr(r.summaryLayout),l=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,s=M(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),u=l&&f?s:"",v=document.documentElement;Ta(v,r);var y=r.borderRadius!==void 0?r.borderRadius:8,c=ot[r.size]||ot.medium,g=lt[r.thumbnailSize]||lt.medium,m=g;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(m=pt[r.thumbnailSize]||pt.medium),v.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),v.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),v.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),v.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),v.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),v.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),v.style.setProperty("--renuvex-pr-radius",y+"px"),v.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),v.style.setProperty("--renuvex-pr-photo-title-size",c.photoTitleSize+"px"),v.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),v.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),v.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),v.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),v.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),v.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),v.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),v.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),v.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),v.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),v.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),v.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),v.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),v.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),v.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size",g+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size-mobile",m+"px");var h=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";v.style.setProperty("--renuvex-pr-review-star-color",h),v.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),v.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),ye(Mr(r.summaryLayout),r.size),ye(Fr(r.reviewLayout),r.size);var x=nr(r),k=Pn();if(!k)return;var b=Nn(k,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==b&&b.appendChild(z);var E=_t(z),A=Ue+He+Sr+ga()+wa();Ve(E,A);var w=Ot(E);if(r.enabled===!1){z.style.minHeight="auto",w.replaceChildren(za(r.borderRadius!==void 0?r.borderRadius:8)),gr(!1);var T=fr;hr(null),T&&st(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var C=t||{},L=Ur(C),P=L?[]:C.data&&C.data.reviews||[];wt(P),w.replaceChildren();var S=document.createElement("section");if(S.id="renuvex-reviews-widget",S.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),S.className="renuvex-pr-reviews-widget",S.setAttribute("data-renuvex-surface","reviews"),e&&S.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),u){var N=document.createElement("div"),Y=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+Y,N.textContent=u,S.appendChild(N)}if(L){S.appendChild(ka(C.message,i.onRetry)),w.appendChild(S),Ne(E),Hr(S,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return E.getElementById("renuvex-reviews-widget")});return}var G=C.data&&C.data.allCount||0,ee=C.data&&C.data.ratingCounts||null,D=ee||[0,0,0,0,0],O=C.data&&C.data.avgRating||"0.0";if(!ee&&P.length>0){P.forEach(function(B){B.rating>=1&&B.rating<=5&&D[B.rating-1]++});var oe=P.reduce(function(B,X){return B+X.rating},0);O=(oe/P.length).toFixed(1)}if(G>0){var W=Mr(r.summaryLayout),q=W.render({widget:S,productId:e,data:C,settings:r,iconPair:x,allCount:G,ratingCounts:D,avgRatingVal:O,currentRatingFilter:J,currentOrderBy:U,currentHasImages:Z,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});S.appendChild(q)}else{var K=document.createElement("button");K.className="renuvex-pr-write-btn",K.style.cssText="display:block;margin:16px auto 0;",K.textContent=M(r.writeButtonText,"Yorum Yap"),K.onclick=V,S.appendChild(K)}var ve=Aa({settings:r,root:v,currentHasImages:Z,photoStripReviews:ct,openReviewModal:se,wireLightboxTrigger:Ee});if(ve&&S.appendChild(ve),P.length===0){var re=document.createElement("p");re.className="renuvex-pr-state-msg",re.textContent="Hen\xFCz yorum yok.",S.appendChild(re)}else{var j=Fr(r.reviewLayout);P.forEach(function(B){S.appendChild(j.render(B,Yr))})}var I=r.paginationMode==="numbered"?"numbered":"loadMore";if(I==="numbered"){var le=C.data&&C.data.totalPages||1;le>1&&S.appendChild(La({page:C.data&&C.data.page||ar||1,totalPages:le,onPageChange:i.onPageChange}))}var _=I==="loadMore"&&C.data&&C.data.hasMore;if(_){var H=document.createElement("button");H.className="renuvex-pr-load-more",H.textContent="Daha Fazla G\xF6ster",H.onclick=async function(){H.disabled=!0,H.textContent="Y\xFCkleniyor...";var B=Fe(),X=F,we=U,Ae=ar,dr=J,sr=Z,vr=mr,Qe=Ae+1,ce=await Be(X,we,Qe,dr,sr,null,vr);if(Oe(B,{productId:X,orderBy:we,page:Ae,ratingFilter:dr,hasImages:sr,nextCursor:vr}))if(ce&&!Ur(ce)&&ce.data&&Array.isArray(ce.data.reviews)){var er=zt(ce.data.reviews);kt(er),Pe(Qe),ke(ce.data.nextCursor||null);var cr=Fr(R.reviewLayout);er.forEach(function(Ra){S.insertBefore(cr.render(Ra,Yr),H)}),ce.data.hasMore?(H.disabled=!1,H.textContent="Daha Fazla G\xF6ster"):H.remove()}else H.disabled=!1,H.textContent="Tekrar Dene"},S.appendChild(H)}w.appendChild(S),Ne(E),Hr(S,"reviews-widget",{productId:e||""},function(){return E.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var Te=document.createElement("p");Te.style.cssText="text-align:center;color:#dc2626;",Te.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",w&&w.replaceChildren(Te)}}finally{if(gr(!1),fr){var te=fr;hr(null),st(te.productId,te.settings,te.reviewsData,te.productName,te.orderBy,te.page,te.badgeSettings)}}}export{st as render};
