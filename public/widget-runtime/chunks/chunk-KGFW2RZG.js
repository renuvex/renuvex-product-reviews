...
import{a as er,d as rr}from"./chunk-FW6W6ZQL.js";import{a as he,b as ft,c as sr,d as vr,e as gt,f as $e,g as ht,h as bt,k as yt,l as wt,m as kt}from"./chunk-LE6R3SA5.js";import{$ as st,A as tt,B as at,C as nt,D as it,E as ot,F as ar,G as nr,H as ir,N as xe,O as X,P as J,Q as Se,R as or,S as Je,T as lt,V as pt,W as de,X as fe,Y as dt,Z as ut,_ as ue,a as ve,aa as ge,b as ce,ba as lr,c as me,ca as q,da as pr,e as Pr,ea as dr,f as Ke,fa as Rr,g as Kr,ga as Br,h as ze,ha as ne,i as Xr,ia as vt,j as Be,ja as ie,k as Ie,ka as ct,l as Q,la as Ze,m as N,n as Lr,na as ur,o as Me,pa as mt,q as Nr,r as Jr,ra as xt,s as Xe,sa as Ee,t as Ce,u as tr,v as Zr,w as $r,x as Qr,y as et,z as rt}from"./chunk-ZNJI75VZ.js";var ta=15,aa=60*1e3,zt="__renuvexProductReviewsFetchError",Ir={};function cr(e){return{type:zt,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function mr(e){return!!(e&&e.type===zt)}async function Te(e,r,t,a,n,i){if(window.__ikasPreviewMode){try{var l=window.__ikasPreviewBaseUrl||me,p=l+"/api/preview/reviews?page="+encodeURIComponent(t||1),u=await he(p);if(u.ok)return await u.json()}catch(h){}return cr()}r=r||"newest",t=t||1;var v=i?"_l"+i:"",m="renuvex_pr_reviews_"+ce+"_"+e+"_"+r+"_"+t+"_"+(a||"")+"_"+(n?"1":"0")+v,c=null,o=ct(m);if(o)try{var y=JSON.parse(o);if(y&&y.t!==void 0&&y.v){if(Date.now()-y.t<aa)return y.v;c=y.v,Ze(m,"")}else Ze(m,"")}catch(h){Ze(m,"")}try{var d=me+"/api/public/reviews?storeId="+encodeURIComponent(ce)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(t)+(a?"&rating="+encodeURIComponent(a):"")+(n?"&hasImages=true":"")+(i?"&limit="+encodeURIComponent(i):""),s=await he(d);if(!s.ok)return c||cr();var x=await s.json();return Ze(m,JSON.stringify({t:Date.now(),v:x})),x}catch(h){return console.error("[renuvex-pr] fetchReviews error:",h),c||cr()}}async function na(e){var r=await Te(e,"newest",1,null,!0,ta);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function un(e,r){var t=document.getElementById("renuvex-pr-rating-badge");t&&t.remove();var a=document.getElementById("renuvex-pr-jsonld");if(a&&a.remove(),!Ir[e]){Ir[e]=!0;var n={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},i={enabled:!0,size:"medium"};try{var l=await ft();if(!l)return;var p=l.widgets&&l.widgets.reviews||n,u=l.widgets&&l.widgets.badge||i;if(p.enabled===!1)return;Xe("newest"),Ce(1),tr(null);var v=await Promise.all([Te(e,"newest",1,null),na(e)]),m=v[0];at(v[1]),await be(e,p,m,r,"newest",1,u)}catch(c){console.error("[renuvex-pr] bootstrap error:",c),await be(e,n,cr(),r,void 0,void 0,i)}finally{delete Ir[e]}}}var _e=":host{display:block;box-sizing:border-box;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function Ct(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Fe(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function xr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function fr(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function St(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var gr=`
