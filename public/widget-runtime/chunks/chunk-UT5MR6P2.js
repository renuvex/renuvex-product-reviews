...
import{b as Ue}from"./chunk-Z7432DLE.js";import{a as we,b as ai,c as tr,d as ar,e as ni,f as qe,g as oi}from"./chunk-HKWR7UXB.js";import{$ as Qe,A as Wr,B as Gr,C as qr,D as Kr,E as Ur,F as Je,G as Ze,H as $e,N as Be,O as he,P as We,Q as Xr,S as Jr,T as pe,U as be,V as Zr,W as $r,X as me,Y as Qr,Z as ei,_ as ye,a as ve,aa as j,b as ke,ba as er,c as ge,ca as rr,da as gr,e as Ye,ea as hr,f as je,fa as ee,g as Fr,ga as ri,h as Se,ha as re,i as _r,ia as ii,j as Pe,ja as Ge,k as Ae,ka as ti,l as q,m as A,ma as ir,n as vr,o as Re,q as kr,r as Or,s as Ve,t as Ee,u as Xe,v as Hr,w as Dr,x as Yr,y as jr,z as Vr}from"./chunk-C3FKX73A.js";var ji=15,Vi=60*1e3,li="__ikrReviewsFetchError",br={};function nr(e){return{type:li,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function yr(e){return!!(e&&e.type===li)}async function Te(e,r,i,t,a,o){if(window.__ikasPreviewMode){try{var s=window.__ikasPreviewBaseUrl||ge,l=s+"/api/preview/reviews?page="+encodeURIComponent(i||1),c=await we(l);if(c.ok)return await c.json()}catch(k){}return nr()}r=r||"newest",i=i||1;var m=o?"_l"+o:"",v="ikr_reviews_"+ke+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(a?"1":"0")+m,p=null,n=ii(v);if(n)try{var f=JSON.parse(n);if(f&&f.t!==void 0&&f.v){if(Date.now()-f.t<Vi)return f.v;p=f.v,Ge(v,"")}else Ge(v,"")}catch(k){Ge(v,"")}try{var d=ge+"/api/public/reviews?storeId="+encodeURIComponent(ke)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(a?"&hasImages=true":"")+(o?"&limit="+encodeURIComponent(o):""),u=await we(d);if(!u.ok)return p||nr();var g=await u.json();return Ge(v,JSON.stringify({t:Date.now(),v:g})),g}catch(k){return console.error("[ikr] fetchReviews error:",k),p||nr()}}async function Wi(e){var r=await Te(e,"newest",1,null,!0,ji);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function Ut(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!br[e]){br[e]=!0;var a={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},o={enabled:!0,size:"medium"};try{var s=await ai();if(!s)return;var l=s.widgets&&s.widgets.reviews||a,c=s.widgets&&s.widgets.badge||o;if(l.enabled===!1)return;Ve("newest"),Ee(1),Xe(null);var m=await Promise.all([Te(e,"newest",1,null),Wi(e)]),v=m[0];Gr(m[1]),await xe(e,l,v,r,"newest",1,c)}catch(p){console.error("[ikr] bootstrap error:",p),await xe(e,a,nr(),r,void 0,void 0,o)}finally{delete br[e]}}}function Ie(e){return ye(e)}function Gi(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,i,t){i?e.setProperty(r,i,t||""):e.removeProperty(r)}function qi(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",i=navigator.maxTouchPoints||0,t=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&i>1;return t&&/AppleWebKit/i.test(r)}function Ki(){var e=Gi(),r=document.body.style,i=document.documentElement.style,t=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",o=qi()&&!a;if(t>0){var s=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",s+t+"px","important")}return i.setProperty("overflow","hidden","important"),i.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important")),e}function Ui(e){if(e){var r=document.body.style,i=document.documentElement.style;ie(i,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(i,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}}function Xi(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function Me(e){if(!(!e||!document.contains(e)||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(i){}}}function Ji(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function si(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Ji)}function ci(e){var r=si(e),i=r[0]||e.querySelector('[role="dialog"]')||e;Me(i)}function Zi(e,r){if(e.key==="Tab"){var i=si(r);if(!i.length){e.preventDefault(),ci(r);return}var t=i[0],a=i[i.length-1],o=document.activeElement;if(!r.contains(o)){e.preventDefault(),Me(t);return}e.shiftKey&&o===t?(e.preventDefault(),Me(a)):!e.shiftKey&&o===a&&(e.preventDefault(),Me(t))}}function $i(){var e={id:"ikr-modal-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state,history.pushState({ikrModal:e.id},"",e.url),e.pushed=!0}catch(r){}return e}function Qi(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state.ikrModal===e.id)}function et(e){if(Qi(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function di(e,r,i,t,a){Ui(t),document.removeEventListener("keydown",r),window.removeEventListener("popstate",i),e.parentNode&&e.parentNode.removeChild(e),Me(a)}function rt(e){var r=document.createElement("div");r.className="ikr-modal-right";var i=document.createElement("div");i.className="ikr-modal-scroll-content";var t=document.createElement("div");t.className="ikr-modal-top-row";var a=document.createElement("div");a.className="ikr-modal-stars",a.innerHTML=pe(e.rating,A);var o=document.createElement("span");o.className="ikr-modal-date",o.textContent=me(e.createdAt),t.appendChild(a),t.appendChild(o),i.appendChild(t);var s=document.createElement("div");s.className="ikr-modal-title",s.textContent=e.title||"",s.style.display=e.title?"":"none",i.appendChild(s);var l=document.createElement("div");l.className="ikr-modal-author",l.textContent=e.author||"",i.appendChild(l);var c=document.createElement("div");c.className="ikr-modal-body",c.textContent=(e.comment||"").trim(),c.style.display=e.comment&&e.comment.trim()?"":"none",i.appendChild(c);var m=document.createElement("div");m.className="ikr-modal-reply";var v=document.createElement("div");v.className="ikr-modal-reply-label",v.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var p=document.createElement("div");return p.className="ikr-modal-reply-text",p.textContent=e.merchantReply||"",m.appendChild(v),m.appendChild(p),m.style.display=e.merchantReply?"":"none",i.appendChild(m),r.appendChild(i),r}function pi(e,r,i){var t=i||A,a=e.querySelector(".ikr-modal-scroll-content"),o=a.querySelector(".ikr-modal-stars");o.innerHTML=pe(r.rating,t),a.querySelector(".ikr-modal-date").textContent=me(r.createdAt);var s=a.querySelector(".ikr-modal-title");s.textContent=r.title||"",s.style.display=r.title?"":"none",a.querySelector(".ikr-modal-author").textContent=r.author||"";var l=a.querySelector(".ikr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var c=a.querySelector(".ikr-modal-reply");c.querySelector(".ikr-modal-reply-label").textContent=t&&t.merchantReplyLabel||"Ma\u011Faza Sahibi",c.querySelector(".ikr-modal-reply-text").textContent=r.merchantReply||"",c.style.display=r.merchantReply?"":"none",e.scrollTop=0}function xr(e,r,i,t,a,o,s,l,c){var m=Ie(e),v=Math.max(0,Math.min(i||0,m.length-1)),p=document.createElement("div");p.className="ikr-modal-left";var n=document.createElement("img"),f=s==="next"?"ikr-modal-img-enter-right":s==="prev"?"ikr-modal-img-enter-left":"";n.className="ikr-modal-main-img"+(f?" "+f:""),n.src=hr(m[v]||""),n.decoding="async",n.width=gr,n.height=Math.round(gr*4/3),n.alt="Yorum foto\u011Fraf\u0131",ri(n,function(S){if(S.style.display="none",!p.querySelector(".ikr-modal-img-error")){var T=document.createElement("div");T.className="ikr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(T,S)}}),p.appendChild(n);var d=document.createElement("button");d.className="ikr-modal-close-mobile",d.textContent="\u2715",d.setAttribute("aria-label","Kapat"),d.onclick=function(S){S.stopPropagation(),o()},p.appendChild(d);var u=0;if(p.addEventListener("touchstart",function(S){u=S.touches[0].clientX},{passive:!0}),p.addEventListener("touchend",function(S){var T=u-S.changedTouches[0].clientX;if(!(Math.abs(T)<50)){if(T>0){if(x)ue(e,r,v+1,t,a,o,!0,"next",l,c);else if(h){var y=t[r+1];ue(y,r+1,0,t,a,o,!1,"next",l,c)}}else if(k)ue(e,r,v-1,t,a,o,!0,"prev",l,c);else if(z){var L=t[r-1],P=Ie(L);ue(L,r-1,P.length-1,t,a,o,!1,"prev",l,c)}}},{passive:!0}),m.length>1){var g=document.createElement("div");g.className="ikr-modal-thumbs",m.forEach(function(S,T){var y=document.createElement("img"),L=ee(S,rr);y.src=L.src,y.srcset=L.srcset,y.loading="lazy",y.decoding="async",y.width=rr,y.height=rr,y.className="ikr-modal-thumb"+(T===v?" ikr-modal-thumb-active":""),y.alt="K\xFC\xE7\xFCk resim "+(T+1),re(y),y.tabIndex=0,y.setAttribute("role","button"),y.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(T+1)+" se\xE7"),T===v&&y.setAttribute("aria-current","true"),(function(P){function N(){ue(e,r,P,t,a,o,!0,null,l,c)}y.onclick=N,y.onkeydown=function(M){(M.key==="Enter"||M.key===" ")&&(M.preventDefault(),N())}})(T),g.appendChild(y)}),p.appendChild(g)}var k=v>0,x=v<m.length-1,z=r>0,h=r<t.length-1,E=k||z,w=x||h;if(E){var b=document.createElement("button");b.className="ikr-modal-nav ikr-modal-nav-prev",b.innerHTML="&#8249;",b.setAttribute("aria-label","\xD6nceki"),b.onclick=function(S){if(S.stopPropagation(),k)ue(e,r,v-1,t,a,o,!0,"prev",l,c);else if(z){var T=t[r-1],y=Ie(T);ue(T,r-1,y.length-1,t,a,o,!1,"prev",l,c)}},p.appendChild(b)}if(w){var C=document.createElement("button");C.className="ikr-modal-nav ikr-modal-nav-next",C.innerHTML="&#8250;",C.setAttribute("aria-label","Sonraki"),C.onclick=function(S){if(S.stopPropagation(),x)ue(e,r,v+1,t,a,o,!0,"next",l,c);else if(h){var T=t[r+1];ue(T,r+1,0,t,a,o,!1,"next",l,c)}},p.appendChild(C)}return p}function mi(e,r){[-1,1].forEach(function(i){var t=r[e+i];if(t){var a=Ie(t);a[0]&&(new Image().src=hr(a[0]))}})}function wr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function it(e,r){var i=e&&e.querySelector(".ikr-modal-wrap"),t=r&&r.querySelector(".ikr-modal-right"),a=r&&r.querySelector(".ikr-modal-scroll-content");function o(){wr(i),wr(t),wr(a)}o(),i&&Me(i),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function ue(e,r,i,t,a,o,s,l,c,m){if(m&&(m.currentReview=e),s){var v=xr(e,r,i,t,a,o,l,c,m);a.firstChild&&a.replaceChild(v,a.firstChild)}else{var v=xr(e,r,i,t,a,o,l,c,m),p=a.querySelector(".ikr-modal-right");a.firstChild&&a.replaceChild(v,a.firstChild),p&&pi(p,e,m&&m.currentSettings),it(c,a)}mi(r,t)}function te(e,r,i){var t=Ie(e);if(!t.length)return;var a=(i||[]).filter(function(h){return Ie(h).length>0}),o=a.findIndex(function(h){return h===e||h.id===e.id});o===-1&&(a.unshift(e),o=0);var s=t.indexOf(r);s<0&&(s=0);var l=document.createElement("div");l.className="ikr-modal-overlay";var c=document.createElement("div");c.className="ikr-modal";var m=!1,v=Xi(),p=Ki(),n=$i(),f={currentReview:e,currentSettings:A};function d(h){var E=h&&h.detail&&h.detail.settings;f.currentSettings=E||A;var w=c.querySelector(".ikr-modal-right");!w||!f.currentReview||pi(w,f.currentReview,f.currentSettings)}function u(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),di(l,g,u,p,v))}function g(h){if(h.key==="Escape"){k();return}Zi(h,l)}function k(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),di(l,g,u,p,v),et(n))}document.addEventListener("keydown",g),window.addEventListener("popstate",u),window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),l.onclick=function(){k()},c.onclick=function(h){h.stopPropagation()},c.appendChild(xr(e,o,s,a,c,k,null,l,f)),c.appendChild(rt(e)),mi(o,a);var x=document.createElement("div");x.className="ikr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(c);var z=document.createElement("button");z.className="ikr-modal-close",z.textContent="\u2715",z.setAttribute("aria-label","Kapat"),z.onclick=function(h){h.stopPropagation(),k()},x.appendChild(z),l.appendChild(x),document.body.appendChild(l),ci(l)}function ui(e){var r=ir();if(r&&typeof r.findProductTitle=="function")try{var i=r.findProductTitle(e);if(i)return i}catch(s){}if(e)for(var t=document.querySelectorAll("h1,h2,h3,h4,h5,h6,div,span,p"),a=0;a<t.length;a++){var o=t[a];if(o.children.length===0&&o.textContent.trim()===e&&o.tagName!=="TITLE"&&!o.closest("[data-ikr-listing-badge]")&&!o.closest("[data-renuvex-slot]")&&!o.closest("#ikas-reviews")&&!o.closest("nav")&&!o.closest("header")&&!o.closest('[class*="breadcrumb"]')&&!o.closest('[aria-label*="breadcrumb"]'))return o}return document.querySelector("h1")}function fi(e){return!e||!e.parentNode?null:{parent:e.parentNode,anchorEl:e,position:"after"}}function zr(e){return!e||!e.parent?null:e.position==="after"&&e.anchorEl?{parent:e.parent,anchorEl:e.anchorEl,position:"after"}:{parent:e.parent,beforeEl:e.beforeEl||null,position:"before"}}function vi(e,r){var i=zr(r);return!e||!i||e.parentNode!==i.parent?!1:i.position==="after"?i.anchorEl&&i.anchorEl.parentNode===i.parent&&i.anchorEl.nextSibling===e:i.beforeEl&&i.beforeEl.parentNode===i.parent?e.nextSibling===i.beforeEl:e.nextSibling===null}function Cr(e,r){var i=zr(r);if(!e||!i||!i.parent||vi(e,i))return!1;if(i.position==="after")return!i.anchorEl||i.anchorEl.parentNode!==i.parent?!1:(i.parent.insertBefore(e,i.anchorEl.nextSibling||null),!0);var t=i.beforeEl&&i.beforeEl.parentNode===i.parent?i.beforeEl:null;return i.parent.insertBefore(e,t),!0}function ki(e,r,i){i=i||{};var t=zr(r);if(typeof MutationObserver=="undefined"||!e||!t||!t.parent)return null;var a=0,o=!1,s=typeof i.maxCorrections=="number"?i.maxCorrections:3,l=typeof i.durationMs=="number"?i.durationMs:15e3,c=i.surface||"owned-slot",m=i.reason||"position_reanchored",v=i.message||"Owned storefront slot reordered after render",p=i.extra||{},n=new MutationObserver(function(){if(!e.isConnected||!t.parent.isConnected){n.disconnect();return}if(t.position==="after"&&(!t.anchorEl||!t.anchorEl.isConnected||t.anchorEl.parentNode!==t.parent)){n.disconnect();return}vi(e,t)||(a+=1,Cr(e,t),o||(o=!0,Ye("dom-conflict",v,Object.assign({surface:c,reason:m},p))),a>=s&&n.disconnect())});return n.observe(t.parent,{childList:!0}),setTimeout(function(){n.disconnect()},l),n}var or=null,lr=null;function tt(e,r){return be(e,r)}function at(e){var r=ir();if(r&&typeof r.getProductBadgeMountPoint=="function")try{var i=r.getProductBadgeMountPoint(e);if(i&&i.parent)return i}catch(t){}return fi(e)}function Sr(e,r,i,t,a,o,s){or&&(or.disconnect(),or=null),lr&&(lr.disconnect(),lr=null),ni("product-title-rating","product-title-badge");var l=document.querySelector(".ikr-rating-badge--pdp");if(l&&l.remove(),!!e&&!(t&&t.enabled===!1)){var c=document.getElementById("ikr-jsonld");c&&c.remove();var m=document.createElement("script");m.id="ikr-jsonld",m.type="application/ld+json",m.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Product",name:i||document.title,url:window.location.href,aggregateRating:{"@type":"AggregateRating",ratingValue:e,reviewCount:r,bestRating:"5",worstRating:"1"}}),document.head.appendChild(m);var v=ui(i);if(!v||!v.parentNode){Ye("dom-conflict","PDP product title could not be found for badge placement",{surface:"pdp-badge",reason:"title_not_found",productName:i||"",productId:o||""});return}var p=at(v);if(!p||!p.parent){Ye("dom-conflict","PDP badge mount point could not be resolved",{surface:"pdp-badge",reason:"mount_not_found",productName:i||"",productId:o||""});return}var n=t&&t.size||"medium",f=qe[n]||qe.medium,d=null;if(t&&t.mobileOverride===!0){var u=t.mobileSize||"small";d=qe[u]||qe.small}oi(f,d);var g=tr({slot:"product-title-rating",legacySlot:"product-title-badge",className:"renuvex-pr-product-badge-slot ikr-product-badge-slot",context:{surface:"pdp",productId:o||""}}),k=document.createElement("a");k.className="renuvex-pr-rating-badge ikr-rating-badge ikr-rating-badge--pdp",k.href="#ikas-reviews";var x=Zr(e,r);k.setAttribute("aria-labelledby",x.id),k.setAttribute("data-ikr-surface","pdp"),k.setAttribute("data-renuvex-surface","pdp"),k.setAttribute("data-ikr-rating",String(e)),k.setAttribute("data-renuvex-rating",String(e)),k.setAttribute("data-ikr-count",String(r)),k.setAttribute("data-renuvex-count",String(r)),ar(k,{surface:"pdp",productId:o||""});var z=window.getComputedStyle(v).textAlign,h=z==="center"?"center":z==="right"?"right":"left";k.setAttribute("data-ikr-align",h),k.insertAdjacentHTML("beforeend",x.html+tt(e,a));var E=document.createElement("span");E.className="ikr-rating-badge__label",E.textContent=e+" ("+r+" yorum)",k.appendChild(E),k.onclick=function(w){w.preventDefault();var b=document.getElementById("ikas-reviews-widget")||document.getElementById("ikas-reviews");if(b){var C=document.querySelector("header"),S=C?C.getBoundingClientRect().height:0,T=b.getBoundingClientRect().top+window.pageYOffset-S-16;window.scrollTo({top:T,behavior:"smooth"})}},g.appendChild(k),Cr(g,p),lr=ki(g,p,{surface:"pdp-badge",reason:"position_reanchored",message:"PDP badge slot reordered after render",extra:{productName:i||"",productId:o||""}}),je(g,"pdp-badge",{productName:i||"",productId:o||""}),s||(or=Fr(g,"pdp-badge",function(){Sr(e,r,i,t,a,o,!0)},{productName:i||"",productId:o||""}))}}var gi=`
...
`;var Lr={};ve(Lr,{meta:()=>ft,render:()=>vt});function Fe(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,o=e.onFilterChange;Be(t);var s=document.createElement("div");s.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var c=r[l-1]||0,m=i>0?Math.round(c/i*100):0,v=a===l,p=document.createElement("div");p.className="ikr-bar-row"+(v?" ikr-bar-active":""),a&&!v&&(p.style.opacity="0.35");for(var n="",f=1;f<=5;f++){var d=f<=l;n+='<span class="ikr-bar-star ikr-icon '+(d?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+he(d?"full":"outline")+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+n+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+m+'%;"></div></div><span class="ikr-bar-count">('+c.toLocaleString("tr-TR")+")</span>",(function(u){p.onclick=function(){o(u)}})(l),s.appendChild(p)}return s}var ae=[],hi=!1;function nt(e){for(var r=ae.length-1;r>=0;r--){var i=ae[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function ot(e){if(e.key==="Escape")for(var r=ae.length-1;r>=0;r--)ae[r].close()}function lt(){hi||typeof document=="undefined"||(document.addEventListener("click",nt,!0),document.addEventListener("keydown",ot),hi=!0)}function dr(e){for(var r=0;r<ae.length;r++)ae[r]!==e&&ae[r].close()}function sr(e){lt();var r={trigger:e.trigger,element:e.element,close:e.close};return ae.push(r),function(){var t=ae.indexOf(r);t!==-1&&ae.splice(t,1)}}function K(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent=A&&A.writeButtonText||"Yorum Yap",l.onclick=a,s.appendChild(l);var c=document.createElement("div");c.className="ikr-filter-wrap";var m=document.createElement("button");m.type="button",m.className="ikr-filter-btn",m.setAttribute("aria-label","Filtrele"),m.setAttribute("aria-haspopup","menu"),m.setAttribute("aria-expanded","false");var v=A&&A.filterIcon||"lines";m.innerHTML=Xr(v);var p=document.createElement("div");p.className="ikr-filter-menu",p.setAttribute("role","menu");var n=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],f=!1;function d(k){var x=p.classList.contains("ikr-open");p.classList.remove("ikr-open"),m.classList.remove("ikr-filter-btn-active"),m.setAttribute("aria-expanded","false");var z=k&&(k.restoreFocus===!0||k.restoreFocus==="auto"&&Ue());if(x&&z)try{m.focus({preventScroll:!0})}catch(h){try{m.focus()}catch(E){}}}function u(){dr(g),p.classList.add("ikr-open"),m.classList.add("ikr-filter-btn-active"),m.setAttribute("aria-expanded","true");var k=p.querySelector(".ikr-filter-item-active")||p.querySelector(".ikr-filter-item");k&&requestAnimationFrame(function(){try{k.focus({preventScroll:!0})}catch(x){try{k.focus()}catch(z){}}})}n.forEach(function(k){var x=k[2],z=x?t:!t&&(i||"newest")===k[0],h=document.createElement("button");h.type="button",h.className="ikr-filter-item"+(z?" ikr-filter-item-active":""),h.setAttribute("role","menuitem"),h.textContent=k[1];var E=!1;function w(b,C){b&&(b.preventDefault(),b.stopPropagation()),!E&&(E=!0,f=!0,d({restoreFocus:C}),o(k[0],x),setTimeout(function(){E=!1,f=!1},0))}h.addEventListener("pointerdown",function(b){b.button!==void 0&&b.button!==0||w(b,!1)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){w(b,!1)},{passive:!1}),h.addEventListener("mousedown",function(b){b.button!==void 0&&b.button!==0||w(b,!1)}),h.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&w(b,!0)}),h.onclick=function(b){w(b,!1)},p.appendChild(h)}),m.onclick=function(){p.classList.contains("ikr-open")?d({restoreFocus:"auto"}):u()},c.addEventListener("keydown",function(k){k.key==="Escape"&&p.classList.contains("ikr-open")&&(k.stopPropagation(),d({restoreFocus:!0}))}),c.addEventListener("focusout",function(k){if(p.classList.contains("ikr-open")&&!f){var x=k.relatedTarget;x&&c.contains(x)||d()}});var g=sr({trigger:c,element:p,close:d});return c.appendChild(m),c.appendChild(p),s.appendChild(c),s}function bi(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.tabIndex=-1,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Yorum yapma formu");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var o=document.createElement("button");o.className="ikr-fwizard-close",o.type="button",o.setAttribute("aria-label","Kapat"),o.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',a.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-content",a.appendChild(s);var l=!1,c=null,m=!1,v="",p="";function n(){var y=document.activeElement;return!y||y===document.body||y===document.documentElement?null:y}function f(y){if(!(!y||!document.contains(y)||typeof y.focus!="function"))try{y.focus({preventScroll:!0})}catch(L){try{y.focus()}catch(P){}}}function d(y){if(!y||y.disabled||y.getAttribute("aria-hidden")==="true")return!1;var L=window.getComputedStyle?window.getComputedStyle(y):null;return L&&(L.display==="none"||L.visibility==="hidden")?!1:!!(y.offsetWidth||y.offsetHeight||y.getClientRects().length)}function u(y){var L=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(y.querySelectorAll(L)).filter(d)}function g(){var y=u(s),L=u(t),P=y[0]||L[0]||t;f(P)}function k(y){if(y.key==="Tab"){var L=u(t);if(!L.length){y.preventDefault(),f(t);return}var P=L[0],N=L[L.length-1],M=document.activeElement;if(!t.contains(M)){y.preventDefault(),f(P);return}y.shiftKey&&M===P?(y.preventDefault(),f(N)):!y.shiftKey&&M===N&&(y.preventDefault(),f(P))}}function x(){var y=window.innerWidth-document.documentElement.clientWidth;v=document.body.style.overflow,p=document.body.style.paddingRight,document.body.style.overflow="hidden",y>0&&(document.body.style.paddingRight=y+"px")}function z(){document.body.style.overflow=v,document.body.style.paddingRight=p}function h(){l||(l=!0,document.removeEventListener("keydown",E),t.removeEventListener("click",w),o.removeEventListener("click",h),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),z(),m&&f(c);try{r()}catch(y){}},200))}function E(y){if(y.key==="Escape"){h();return}k(y)}function w(y){y.target===t&&i&&h()}document.addEventListener("keydown",E),t.addEventListener("click",w),o.addEventListener("click",h);function b(y){c=n(),m=Ue(),y&&s.appendChild(y),document.body.appendChild(t),x(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open"),g()})}var C=null,S=null;function T(y,L){if(L=L||"error",C){try{C.remove()}catch(P){}C=null}S&&(clearTimeout(S),S=null),C=document.createElement("div"),C.className="ikr-fwizard-toast ikr-fwizard-toast--"+L,C.textContent=y,a.appendChild(C),S=setTimeout(function(){C&&(C.classList.add("ikr-fwizard-toast--exit"),setTimeout(function(){if(C){try{C.remove()}catch(P){}C=null}},300))},4e3)}return{open:b,close:h,content:s,setAllowOutsideClose:function(y){i=!!y},setStepAttr:function(y){a.setAttribute("data-step",String(y))},focusFirstControl:g,showToast:T}}var yi=`
...
`;var Er=4;function _e(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function wi(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function t(){r.forEach(function(a){try{a(i)}catch(o){}})}return{get:function(){return i},set:function(a){Object.assign(i,a),t()},goNext:function(){i.currentStep<Er&&(i.currentStep+=1,t())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,t())},onChange:function(a){return r.push(a),function(){r=r.filter(function(o){return o!==a})}}}}var dt='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function xi(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],t=e.onBack||function(){},a=e.onSkip||function(){},o=e.onNext||function(){},s=document.createElement("div");s.className="ikr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=dt+"<span>Geri</span>",l.addEventListener("click",function(){t()}),s.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-footer-progress";for(var m=[],v=0;v<Er;v++){var p=document.createElement("span");p.className="ikr-fwizard-progress-seg",c.appendChild(p),m.push(p)}s.appendChild(c);var n=document.createElement("button");n.type="button";var f=null;function d(g){f&&n.removeEventListener("click",f),f=g,g&&n.addEventListener("click",g)}s.appendChild(n);function u(g,k){var x=r.indexOf(g)!==-1,z=i.indexOf(g)!==-1,h=k&&(k.images&&k.images.length>0||k.pendingImages&&k.pendingImages.length>0);if(x)g===2&&h?(n.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",n.setAttribute("aria-label","Devam Et"),n.innerHTML="Devam Et",d(function(){o()})):(n.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",n.setAttribute("aria-label","Atla"),n.innerHTML="<span>Atla</span>",d(function(){a()})),n.disabled=!1,n.classList.remove("ikr-fwizard-cta-btn--disabled"),n.style.visibility="",n.tabIndex=0;else if(z){n.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",n.setAttribute("aria-label","Sonraki"),n.innerHTML="Sonraki",n.style.visibility="",n.tabIndex=0;var E=_e(g,k);n.disabled=!E,n.classList.toggle("ikr-fwizard-cta-btn--disabled",!E),d(function(){n.disabled||o()})}else n.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",n.innerHTML="",n.style.visibility="hidden",n.tabIndex=-1,n.disabled=!0,d(null)}return{el:s,update:function(g,k){m.forEach(function(z,h){h+1<=g?z.classList.add("ikr-fwizard-progress-seg-active"):z.classList.remove("ikr-fwizard-progress-seg-active")});var x=g<=1;l.style.visibility=x?"hidden":"",l.style.pointerEvents=x?"none":"",l.tabIndex=x?-1:0,u(g,k)},setNextDisabled:function(g){n.classList.contains("ikr-fwizard-cta-btn")&&(n.disabled=!!g,n.classList.toggle("ikr-fwizard-cta-btn--disabled",!!g))},setThanksState:function(g){l.style.visibility="hidden",c.style.visibility="hidden",n.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",n.setAttribute("aria-label","Devam Et"),n.innerHTML="Devam Et",n.style.visibility="",n.disabled=!1,n.classList.remove("ikr-fwizard-cta-btn--disabled"),d(g)}}}function zi(e,r){r=r||{};var i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-rating";var t=!1,a=null,o=document.createElement("div");o.className="ikr-fwizard-step-title",o.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",i.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-stars",s.setAttribute("role","radiogroup"),s.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var l=We(A||{}),c=[];function m(f){c.forEach(function(d,u){var g=u<f;d.classList.toggle("ikr-fwizard-star-active",g),d.setAttribute("aria-checked",u+1===f?"true":"false"),d.innerHTML=g?l.filled:l.empty})}function v(f,d){d&&typeof d.preventDefault=="function"&&d.preventDefault(),d&&typeof d.stopPropagation=="function"&&d.stopPropagation(),!t&&(t=!0,e.set({rating:f}),m(f),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var p=1;p<=5;p++)(function(f){var d=document.createElement("button");d.type="button",d.className="ikr-fwizard-star",d.setAttribute("role","radio"),d.setAttribute("aria-label",f+" y\u0131ld\u0131z"),d.innerHTML=l.empty,d.addEventListener("mouseenter",function(){m(f)}),d.addEventListener("mouseleave",function(){m(e.get().rating)}),d.addEventListener("pointerdown",function(u){u.button&&u.button!==0||v(f,u)}),typeof window!="undefined"&&!window.PointerEvent&&d.addEventListener("touchstart",function(u){v(f,u)},{passive:!1}),d.addEventListener("mousedown",function(u){window.PointerEvent||v(f,u)}),d.addEventListener("keydown",function(u){(u.key==="Enter"||u.key===" ")&&v(f,u)}),d.addEventListener("click",function(u){v(f,u)}),c.push(d),s.appendChild(d)})(p);m(e.get().rating);var n=function(f){var d=f&&f.detail&&f.detail.settings;l=We(d||A||{}),m(e.get().rating)};return window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",n),i.appendChild(s),{el:i,destroy:function(){a&&clearTimeout(a),window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",n)}}}var Ci=3,st=10*1024*1024;function Si(e,r){r=r||{};var i=!1,t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-photos";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",t.appendChild(a);var o=document.createElement("div");o.className="ikr-fwizard-step-subtitle",o.textContent="Foto\u011Fraf ekleyebilirsiniz.",t.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-photo-card";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-photo-add",l.setAttribute("aria-label","Foto\u011Fraf ekle"),l.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var c=document.createElement("input");c.type="file",c.accept="image/*",c.multiple=!0,c.style.display="none",s.appendChild(l),s.appendChild(c);var m=document.createElement("div");m.className="ikr-fwizard-photo-previews",m.setAttribute("aria-live","polite"),s.appendChild(m),t.appendChild(s);var v=r.blobMap||{},p=r.urlToFinger||{};function n(){if(!i){var z=e.get().images||[],h=e.get().pendingImages||[],E=z.map(function(w){return{url:w,isPending:!1}}).concat(h.map(function(w){return{url:w.url,file:w.file,isPending:!0,error:w.error}}));m.innerHTML="",E.forEach(function(w){var b=v[w.url]||w.url,C=f(w,b);m.appendChild(C)}),k()}}function f(z,h){var E=document.createElement("div");E.className="ikr-fwizard-photo-thumb";var w=document.createElement("img");w.src=h,w.alt="",w.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",E.appendChild(w);var b=document.createElement("div");b.className="ikr-fwizard-photo-loading",b.style.display="none",E.appendChild(b);var C=document.createElement("button");return C.type="button",C.className="ikr-fwizard-photo-remove",C.innerHTML="&#x2715;",E.appendChild(C),d(E,z,h),E}function d(z,h,E){var w=z.querySelector("img");w.src!==E&&(w.src=E);var b=z.querySelector(".ikr-fwizard-photo-loading");h.isPending&&h.error?(b.style.display="flex",b.innerHTML='<span class="ikr-upload-error">\u2717 '+h.error+"</span>"):b.style.display="none";var C=z.querySelector(".ikr-fwizard-photo-remove");C.onclick=function(){var S=p[h.url]||(h.file?h.file.name+"_"+h.file.size:null);if(h.url.startsWith("blob:")&&URL.revokeObjectURL(h.url),S){var T=(e.get().fingerprints||[]).filter(function(P){return P!==S});e.set({fingerprints:T})}if(h.isPending){var y=(e.get().pendingImages||[]).filter(function(P){return P.url!==h.url});e.set({pendingImages:y})}else{var L=(e.get().images||[]).filter(function(P){return P!==h.url});e.set({images:L})}}}var u='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',g='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function k(){var z=(e.get().images||[]).length,h=(e.get().pendingImages||[]).length,E=z+h,w=E>=Ci;E>0?(s.classList.add("ikr-fwizard-photo-card--compact"),l.innerHTML=g):(s.classList.remove("ikr-fwizard-photo-card--compact"),l.innerHTML=u+"<span>Foto\u011Fraf Ekle</span>"),w?(l.style.display="none",l.disabled=!0,c.disabled=!0):(l.style.display="flex",l.disabled=!1,c.disabled=!1,l.classList.remove("ikr-fwizard-photo-add--disabled"))}l.addEventListener("click",function(){c.disabled||c.click()}),c.onchange=async function(z){var h=(e.get().images||[]).length+(e.get().pendingImages||[]).length,E=Array.from(z.target.files).slice(0,Ci-h);c.value="";var w=(e.get().pendingImages||[]).length,b=e.get().images||[],C=b.length;if(E.length!==0){for(var S=[],T=[],y=0;y<E.length;y++){var L=E[y],P=L.name+"_"+L.size,N=(e.get().fingerprints||[]).some(function(F){return F===P})||S.some(function(F){return F.file.name+"_"+F.file.size===P});if(N){console.log("[ikr] Duplicate file detected, skipping:",L.name);continue}if(L.size>st){var M="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(M,"error"):alert(M);continue}var U=URL.createObjectURL(L);p[U]=P,S.push({url:U,file:L,error:null}),T.push({url:U,file:L});var X=(e.get().fingerprints||[]).slice();X.push(P),e.set({fingerprints:X})}if(S.length!==0){var ne=(e.get().pendingImages||[]).concat(S),W=async function(){for(var F=0;F<T.length;F++){var Ne=T[F],He=Ne.file,H=Ne.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ze=(e.get().pendingImages||[]).filter(function(O){return O.url!==H}),oe=(e.get().images||[]).slice();oe.push(H),e.set({pendingImages:ze,images:oe});continue}try{var le=await we(ge+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ke})});if(!le.ok)throw le.status===429?new Error("rate_limit"):new Error("sign failed");var Y=await le.json();if(!Y.folder)throw new Error("sign folder missing");var J=new FormData;J.append("file",He),J.append("api_key",Y.api_key),J.append("timestamp",Y.timestamp),J.append("signature",Y.signature),J.append("folder",Y.folder);var de=await fetch("https://api.cloudinary.com/v1_1/"+Y.cloud_name+"/image/upload",{method:"POST",body:J}),Z=await de.json();if(Z.secure_url&&ei(Z.secure_url)){var De=(e.get().pendingImages||[]).some(function(O){return O.url===H});if(!De){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}v[Z.secure_url]=H,p[Z.secure_url]=p[H];var fe=(e.get().pendingImages||[]).filter(function(O){return O.url!==H}),$=(e.get().images||[]).slice();$.push(Z.secure_url),e.set({pendingImages:fe,images:$});try{we(ge+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ke,secureUrl:Z.secure_url})}).catch(function(){})}catch(O){}}else throw new Error("invalid image url")}catch(O){console.error("[ikr] Image upload failed:",O);var Q=O.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(Q,"error");var se=(e.get().pendingImages||[]).map(function(ce){return ce.url===H?{url:ce.url,file:ce.file,error:Q}:ce});e.set({pendingImages:se})}}};if(C===0&&w===0){i=!0;var _=!r.canNavigate||r.canNavigate();_&&e.goNext()}e.set({pendingImages:ne}),W()}}};var x=e.onChange(n);return n(),{el:t,destroy:function(){i=!0,c.onchange=null,x&&x()}}}var Tr=2e3,ct=60;function Ei(e,r){r=r||{};var i=r.onValidityChange||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-content";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",t.appendChild(a);var o=document.createElement("div");o.className="ikr-fwizard-content-form";var s=document.createElement("input");s.type="text",s.className="ikr-fwizard-input",s.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",s.maxLength=ct,s.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),s.value=e.get().title||"",s.addEventListener("input",function(){e.set({title:s.value})}),o.appendChild(s);var l=document.createElement("textarea");l.className="ikr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=Tr,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",o.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-char-counter",c.setAttribute("aria-live","polite"),o.appendChild(c);function m(){var p=l.value.length;c.textContent=p+"/"+Tr,c.classList.toggle("ikr-fwizard-char-counter--max",p>=Tr)}function v(){return _e(3,e.get())}return l.addEventListener("input",function(){e.set({comment:l.value}),m(),i(v())}),t.appendChild(o),m(),setTimeout(function(){i(v())},0),{el:t,destroy:function(){}}}var pt=40;function Ti(e,r){r=r||{};var i=r.onValidityChange||function(){},t=r.onSuccess||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-author";var o=document.createElement("div");o.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",o.textContent="Hakk\u0131n\u0131zda",a.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-author-form";var l=document.createElement("div");l.className="ikr-fwizard-field";var c=document.createElement("label");c.className="ikr-fwizard-label",c.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var m=document.createElement("input");m.type="text",m.className="ikr-fwizard-input",m.maxLength=pt,m.setAttribute("aria-required","true"),m.value=e.get().author||"",l.appendChild(c),l.appendChild(m),s.appendChild(l);var v=document.createElement("div");v.className="ikr-fwizard-field";var p=document.createElement("label");p.className="ikr-fwizard-label",p.textContent="E-posta (opsiyonel)";var n=document.createElement("input");n.type="email",n.className="ikr-fwizard-input",n.setAttribute("autocomplete","email"),n.value=e.get().email||"",v.appendChild(p),v.appendChild(n),s.appendChild(v);var f=document.createElement("div");f.className="ikr-fwizard-notice",f.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",s.appendChild(f);var d=document.createElement("div");d.className="ikr-fwizard-msg",d.setAttribute("role","alert"),d.setAttribute("aria-live","assertive"),s.appendChild(d);var u=document.createElement("button");u.type="button",u.className="ikr-fwizard-submit-btn",u.textContent="G\xF6nder",s.appendChild(u),a.appendChild(s);function g(){return _e(4,e.get())}function k(){var z=!g(),h=(e.get().pendingImages||[]).length,E=h>0;E?(u.disabled=!0,u.classList.add("ikr-fwizard-submit-btn--disabled"),u.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(u.disabled=z,u.classList.toggle("ikr-fwizard-submit-btn--disabled",z),u.textContent="G\xF6nder")}m.addEventListener("input",function(){e.set({author:m.value}),k(),i(g())}),n.addEventListener("input",function(){e.set({email:n.value})}),k(),setTimeout(function(){i(g())},0),u.onclick=async function(){if(!u.disabled){var z=e.get(),h=(z.author||"").trim(),E=(z.comment||"").trim();if(n.value.trim()&&!n.checkValidity()){n.reportValidity();return}if(!h){d.innerHTML='<div class="ikr-fwizard-msg-error">Gerekli alan</div>';return}if(!z.rating){d.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}u.disabled=!0,u.classList.add("ikr-fwizard-submit-btn--disabled");var w=u.textContent;if(u.textContent="G\xF6nderiliyor\u2026",d.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){t()},600);return}try{var b=Jr(window.location.href),C=z.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),S=await we(ge+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ke,productId:z.productId||null,slug:b||null,productName:C,author:h,title:(z.title||"").trim()||null,comment:E||null,rating:z.rating,images:z.images||[]})},15e3);if(S.ok)t();else{var T=await S.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(P){var y=P&&(P.name==="AbortError"||/signal/i.test(P.message||"")),L=y?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":P.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(L,"error"):d.innerHTML='<div class="ikr-fwizard-msg-error">'+L+"</div>",u.disabled=!1,u.classList.remove("ikr-fwizard-submit-btn--disabled"),u.textContent=w}}};var x=e.onChange(k);return{el:a,destroy:function(){u.onclick=null,x&&x()}}}var Li=!1;function mt(){if(!Li){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=yi,document.head.appendChild(e),Li=!0}}function ut(e,r,i){if(i=i||{},e===1)return zi(r,{canNavigate:i.canNavigate});if(e===2)return Si(r,{canNavigate:i.canNavigate,blobMap:i.blobMap,urlToFinger:i.urlToFinger,showToast:i.showToast});if(e===3)return Ei(r,{onValidityChange:i.onValidityChange});if(e===4)return Ti(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess,showToast:i.showToast});var t=document.createElement("div");return t.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:t,destroy:function(){}}}function Ni(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Pi(e){e=e||{},mt();var r=wi({productId:e.productId,productName:e.productName}),i={},t={},a=bi({onClose:function(){window.removeEventListener("popstate",s),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(i).forEach(function(w){var b=i[w];b&&b.startsWith("blob:")&&URL.revokeObjectURL(b)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),o={ikrReviewModal:!0};window.history.pushState(o,null,"");var s=function(w){a&&a.close&&a.close()};window.addEventListener("popstate",s);var l=document.createElement("div");l.className="ikr-fwizard-step-wrap";var c=xi({skippableSteps:[2],nextableSteps:[3],onBack:function(){p==="idle"&&r.goBack()},onSkip:function(){p==="idle"&&r.goNext()},onNext:function(){p==="idle"&&r.goNext()}}),m=document.createElement("div");m.className="ikr-fwizard-layout",m.appendChild(l),m.appendChild(c.el);var v=null,p="idle",n=null,f=!0,d=null;function u(w,b){l.innerHTML="";var C=ut(w,r,{canNavigate:function(){return p==="idle"},blobMap:i,urlToFinger:t,onValidityChange:function(y){c.setNextDisabled(!y)},onSuccess:k,showToast:a.showToast});if(v=C,c.update(w,r.get()),b){p="entering",C.el.classList.add("ikr-fwizard-step--enter");var S=null,T=function(){S&&clearTimeout(S),C.el.removeEventListener("animationend",T),C.el.classList.remove("ikr-fwizard-step--enter"),p="idle",n!==null&&x()};C.el.addEventListener("animationend",T),S=setTimeout(T,700)}else p="idle";l.appendChild(C.el),a.setStepAttr&&a.setStepAttr(w),w===3&&c.setNextDisabled(!0)}var g=!1;function k(){if(!g){if(g=!0,!v){l.innerHTML="";var w=Ni();w.classList.add("ikr-fwizard-step--enter"),l.appendChild(w),a.setStepAttr("thanks"),c.setThanksState(a.close);return}var b=v;p="exiting",b.el.classList.add("ikr-fwizard-step--exit");var C=function(){if(d&&clearTimeout(d),b.el.removeEventListener("animationend",C),b.destroy)try{b.destroy()}catch(T){}v===b&&(v=null),l.innerHTML="";var S=Ni();S.classList.add("ikr-fwizard-step--enter"),l.appendChild(S),a.setStepAttr("thanks"),c.setThanksState(a.close),p="idle"};b.el.addEventListener("animationend",C),d=setTimeout(C,300)}}function x(){var w=r.get().currentStep;if(p!=="idle"){n=w;return}if(!v){var b=!f;f=!1,u(w,b);return}var C=v;p="exiting",C.el.classList.add("ikr-fwizard-step--exit");var S=function(){if(d&&clearTimeout(d),C.el.removeEventListener("animationend",S),C.destroy)try{C.destroy()}catch(y){}if(v===C){l.innerHTML="",v=null;var T=n!==null?n:r.get().currentStep;n=null,u(T,!0),p="idle"}};C.el.addEventListener("animationend",S),d=setTimeout(S,350)}x();var z=r.get().currentStep,h=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,x()):c.update(w.currentStep,w)}),E=a.close;return a.close=function(){h&&h(),typeof d!="undefined"&&d&&clearTimeout(d),E()},a.open(m),{close:a.close}}function D(){Pi({productId:q||"",productName:Re||""})}var ft={id:"classic",name:"Klasik (A\xE7\u0131k)"};function vt(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,o=e.allCount,s=e.ratingCounts,l=e.avgRatingVal,c=e.currentRatingFilter,m=e.currentOrderBy,v=e.currentHasImages,p=e.onFilterChange,n=e.onSortChange;Be(a);var f=document.createElement("div");f.className="ikr-summary";var d=(s[3]||0)+(s[4]||0),u=o>0?Math.round(d/o*100):0,g=document.createElement("div");g.className="ikr-summary-block ikr-summary-avg",g.innerHTML='<span class="ikr-avg-star ikr-icon">'+he("full")+'</span><span class="ikr-avg-num">'+l+"</span>",f.appendChild(g);var k=document.createElement("div");if(k.className="ikr-summary-block ikr-summary-count",k.textContent=o.toLocaleString("tr-TR")+" Yorum",f.appendChild(k),t.showRecommendation!==!1&&u>0){var x=document.createElement("div");x.className="ikr-summary-block ikr-summary-recommend",x.innerHTML='<span class="ikr-recommend-pct">%'+u+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",f.appendChild(x)}return f.appendChild(Fe({ratingCounts:s,allCount:o,iconPair:a,currentRatingFilter:c,onFilterChange:p})),f.appendChild(K({widget:r,currentOrderBy:m,currentHasImages:v,onWriteClick:D,onSortChange:n})),f}var Nr={};ve(Nr,{css:()=>gt,meta:()=>kt,render:()=>ht});var Ai=`
...
`;var kt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},gt=Ai;function ht(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,o=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,c=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,p=e.onSortChange,n=document.createElement("div");n.className="ikr-summary ikr-summary-compact";var f=document.createElement("div");f.className="ikr-compact-header";var d=document.createElement("div");d.className="ikr-compact-trigger-wrap";var u=document.createElement("button");u.className="ikr-compact-trigger",u.type="button",u.setAttribute("aria-expanded","false"),u.innerHTML='<span class="ikr-compact-trigger-stars">'+be(s,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',d.appendChild(u),f.appendChild(d);var g=K({widget:r,currentOrderBy:c,currentHasImages:m,onWriteClick:D,onSortChange:p}),k=g.querySelector(".ikr-filter-wrap"),x=g.querySelector(".ikr-write-btn"),z=document.createElement("div");z.className="ikr-compact-actions-slot",x&&z.appendChild(x),k&&z.appendChild(k),f.appendChild(z),n.appendChild(f);var h=document.createElement("div");h.className="ikr-compact-panel",h.setAttribute("role","dialog"),h.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="ikr-compact-panel-inner";var w=document.createElement("div");w.className="ikr-compact-avg",w.innerHTML='<span class="ikr-icon">'+he("full")+"</span><span>"+s+"</span>",E.appendChild(w),E.appendChild(Fe({ratingCounts:o,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:v})),h.appendChild(E);var b=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(_){var F=_?n:d;h.parentNode!==F&&(h.classList.contains("ikr-open")&&(h.classList.remove("ikr-open"),h.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")),F.appendChild(h))}if(C(b?b.matches:!1),b){var S=function(_){C(_.matches)};b.addEventListener?b.addEventListener("change",S):b.addListener&&b.addListener(S)}if(x){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent=A&&A.writeButtonText||"Yorum Yap",T.onclick=D;var y=document.createElement("div");y.className="ikr-compact-write-row",y.appendChild(T),n.appendChild(y)}function L(){h.classList.remove("ikr-open"),h.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")}function P(){dr(N),h.classList.add("ikr-open"),h.setAttribute("aria-hidden","false"),u.setAttribute("aria-expanded","true")}u.onclick=function(){h.classList.contains("ikr-open")?L():P()};var N=null;function M(_){N&&(N(),N=null),_||(N=sr({trigger:d,element:h,close:L}))}if(M(b?b.matches:!1),b){var U=function(_){M(_.matches)};b.addEventListener?b.addEventListener("change",U):b.addListener&&b.addListener(U)}if(i.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),ne=a>0?Math.round(X/a*100):0;if(ne>0){var W=document.createElement("div");W.className="ikr-summary-block ikr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="ikr-recommend-pct">%'+ne+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(W)}}return n}var Pr={};ve(Pr,{css:()=>yt,meta:()=>bt,render:()=>wt});var Ri=`
...
`;var bt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},yt=Ri;function wt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,o=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,c=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,p=e.onSortChange;Be(t);var n=document.createElement("div");n.className="ikr-summary ikr-summary-split";var f=document.createElement("div");f.className="ikr-split-col ikr-split-left";var d=document.createElement("div");d.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",d.innerHTML='<span class="ikr-avg-star ikr-icon">'+he("full")+'</span><span class="ikr-avg-num">'+s+"</span>",f.appendChild(d);var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-count ikr-split-left-count",u.textContent=a.toLocaleString("tr-TR")+" Yorum",f.appendChild(u),n.appendChild(f);var g=document.createElement("div");g.className="ikr-split-col ikr-split-mid",g.appendChild(Fe({ratingCounts:o,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:v})),n.appendChild(g);var k=K({widget:r,currentOrderBy:c,currentHasImages:m,onWriteClick:D,onSortChange:p}),x=k.querySelector(".ikr-filter-wrap"),z=k.querySelector(".ikr-write-btn"),h=document.createElement("div");h.className="ikr-split-col ikr-split-right",z&&h.appendChild(z),x&&h.appendChild(x),n.appendChild(h);var E=(o[3]||0)+(o[4]||0),w=a>0?Math.round(E/a*100):0,b=document.createElement("div");b.className="ikr-summary-block ikr-summary-recommend",b.innerHTML='<span class="ikr-recommend-pct">%'+w+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var C=i.showRecommendation===!1||w===0;return C&&b.classList.add("ikr-split-rec-hidden"),f.appendChild(b),n}var Ar={};ve(Ar,{css:()=>zt,meta:()=>xt,render:()=>Ct});var Bi=`
...
`;var It={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"80px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"110px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},Mt=_i;function Ft(e,r){var i=Qe(e),t=!!i,a=document.createElement("div");a.className="ikr-review-gallery"+(t?"":" ikr-review-gallery--no-media");var o=document.createElement("div");o.className="ikr-review-gallery-content";var s=document.createElement("span");if(s.className="ikr-review-stars ikr-review-gallery-stars",s.innerHTML=pe(e.rating,A),o.appendChild(s),e.title){var l=document.createElement("div");l.className="ikr-review-gallery-title",l.textContent=e.title,o.appendChild(l)}var c=document.createElement("div");c.className="ikr-review-gallery-author",c.textContent=e.author||"",o.appendChild(c);var m=document.createElement("div");m.className="ikr-review-gallery-date",m.textContent=me(e.createdAt),o.appendChild(m);var v=(e.comment||"").trim();if(v){var p=document.createElement("div");p.className="ikr-review-gallery-body ikr-body-clamped",p.textContent=v,o.appendChild(p);var n=document.createElement("span");n.className="ikr-read-more",n.textContent="Devam\u0131n\u0131 oku",n.style.display="none",n.style.cursor="pointer";var f=!1;n.onclick=function(){if(i){te(e,i,r);return}f=!f,p.classList.toggle("ikr-body-clamped",!f),n.textContent=f?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"},o.appendChild(n),requestAnimationFrame(function(){p.scrollHeight>p.clientHeight+2&&(n.style.display="inline")})}if(a.appendChild(o),t){var d=document.createElement("div");d.className="ikr-review-gallery-media";var u=document.createElement("img"),g=ee(i,er);u.src=g.src,u.srcset=g.srcset,u.loading="lazy",u.decoding="async",u.width=er,u.height=Math.round(er*4/3),re(u),u.setAttribute("data-ikr-img-url",i),u.onclick=function(){te(e,i,r)},d.appendChild(u),a.appendChild(d)}var k=Oe(e.merchantReply,i?function(){te(e,i,r)}:null);return k&&(k.classList.add("ikr-review-gallery-reply"),a.appendChild(k)),a}var mr={card:Br,list:Ir,gallery:Mr};function Ke(e){return mr[e]||mr.card}function Oi(){return Object.keys(mr).map(function(e){return mr[e].css||""}).join(`
`)}function Le(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var t=parseInt(i[1],16),a=parseInt(i[2],16),o=parseInt(i[3],16);return"rgba("+t+","+a+","+o+","+r+")"}function _t(){var e=document.getElementById("ikas-reviews-anchor");if(e)return e;e=document.createElement("div"),e.id="ikas-reviews-anchor",e.setAttribute("data-ikr-auto-anchor","1");var r=null;try{r=document.querySelector(ti)}catch(t){}if(r&&r.parentNode)return r.parentNode.insertBefore(e,r.nextSibling),e;var i=document.querySelector("main")||document.body;return i?(i.appendChild(e),e):null}function Ot(e,r){var i=e.querySelector('[data-renuvex-slot="product-reviews"],[data-ikr-slot="product-reviews"]');return i||(i=tr({slot:"product-reviews",legacySlot:"product-reviews",className:"renuvex-pr-reviews-slot ikr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(i)),ar(i,{surface:"reviews",productId:r||""}),i}var Hi={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Di={small:80,medium:110,large:140};function Ht(e,r){var i=document.createElement("div");i.className="ikr-state-msg ikr-state-error",i.setAttribute("role","status"),i.setAttribute("aria-live","polite");var t=document.createElement("div");t.className="ikr-state-error-text",t.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",i.appendChild(t);var a=document.createElement("button");return a.type="button",a.className="ikr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},i.appendChild(a),i}function Dt(e,r){var i=r.headerTitleColor||"#111111",t=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",o=r.headerRecommendColor||"#111111",s=r.barFillColor||"#111111",l=r.barTrackColor||"#e5e7eb",c=r.barCountColor||"#111111",m=Le(s,.06),v=r.reviewStarColor||"#f59e0b",p=r.btnBgColor||"#111111",n=r.btnTextColor||"#ffffff",f=r.btnBorderColor||"#111111",d=r.filterBtnBgColor||"#111111",u=r.filterBtnTextColor||"#ffffff",g=r.filterBtnBorderColor||"#111111",k=r.filterMenuBgColor||"#ffffff",x=r.filterMenuBorderColor||"#e5e7eb",z=r.filterItemTextColor||"#111111",h=r.filterItemHoverBgColor||"#f3f4f6",E=r.filterItemActiveColor||"#111111",w=r.reviewTitleColor||"#111111",b=r.reviewAuthorColor||"#111111",C=r.reviewDateColor||"#5e5e5e",S=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",y=r.replyBgColor||"#f9fafb",L=r.replyBorderColor||"#747474",P=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",M=r.photoTitleColor||"#111111",U=Le("#111111",.05),X=r.photoArrowBgColor||"#ffffff",ne=r.photoArrowTextColor||"#111111",W=Le("#111111",.12),_=r.formBgColor||"#ffffff",F=r.formPrimaryTextColor||"#111111",Ne=r.formSecondaryTextColor||"#3b3b3b",He=r.inputTextColor||F,H=r.inputBorderColor||"#d1d5db",ze=r.placeholderColor||"#9ca3af",oe=r.formStepBarColor||"#111111",le=r.formBtnBgColor||"#111111",Y=r.formBtnTextColor||"#ffffff",J=r.formBtnBorderColor||"#111111",de=Le(le,.06),Z=Le(le,.18),De=Le(Y,.85),fe=Le(F,.06),$=r.loadMoreBgColor||"#ffffff",Q=r.loadMoreTextColor||"#111111",se=r.loadMoreBorderColor||"#111111",O={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":i,"--ikr-header-avg":t,"--ikr-header-count":a,"--ikr-header-recommend":o,"--ikr-bar-fill":s,"--ikr-bar-track":l,"--ikr-bar-count":c,"--ikr-bar-hover-bg":m,"--ikr-btn-bg":p,"--ikr-btn-text":n,"--ikr-btn-border":f,"--ikr-filter-btn-bg":d,"--ikr-filter-btn-text":u,"--ikr-filter-btn-border":g,"--ikr-filter-menu-bg":k,"--ikr-filter-menu-border":x,"--ikr-filter-item-text":z,"--ikr-filter-item-hover-bg":h,"--ikr-filter-item-active":E,"--ikr-review-title":w,"--ikr-review-author":b,"--ikr-review-date":C,"--ikr-review-body":S,"--ikr-review-border":T,"--ikr-review-star-color":v,"--ikr-reply-bg-color":y,"--ikr-reply-border":L,"--ikr-reply-label":P,"--ikr-reply-text":N,"--ikr-photo-title":M,"--ikr-photo-image-border":U,"--ikr-photo-arrow-bg":X,"--ikr-photo-arrow-text":ne,"--ikr-photo-arrow-border":W,"--ikr-fwizard-bg":_,"--ikr-fwizard-text":F,"--ikr-fwizard-secondary-text":Ne,"--ikr-fwizard-input-bg":_,"--ikr-fwizard-input-text":He,"--ikr-fwizard-input-border":H,"--ikr-fwizard-placeholder":ze,"--ikr-fwizard-close-text":F,"--ikr-fwizard-close-hover-bg":fe,"--ikr-fwizard-progress-bg":fe,"--ikr-fwizard-progress-active":oe,"--ikr-fwizard-btn-bg":le,"--ikr-fwizard-btn-text":Y,"--ikr-fwizard-btn-border":J,"--ikr-fwizard-btn-disabled-bg":Z,"--ikr-fwizard-btn-disabled-text":De,"--ikr-fwizard-nav-hover-bg":de,"--ikr-load-more-bg":$,"--ikr-load-more-text":Q,"--ikr-load-more-border":se};Object.keys(O).forEach(function(ce){e.style.setProperty(ce,O[ce])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function xe(e,r,i,t,a,o,s){if(Ur){$e({productId:e,settings:r,reviewsData:i,productName:t,orderBy:a,page:o,badgeSettings:s});return}Ze(!0),Dr(e),Yr(r),s!==void 0&&jr(s),Vr(t),a&&Ve(a),o&&Ee(o),i!=null&&Wr(i);try{let ur=function(R,I){if(!(!R||!R.meta||!R.meta.sizeOverrides)){var B=R.meta.sizeOverrides[I];B&&Object.keys(B).forEach(function(G){n.style.setProperty(G,B[G])})}};var Yt=ur,l=pr(r.summaryLayout),c=!(l.meta&&l.meta.supports&&l.meta.supports.title===!1),m=r.showTitle!==!1,v=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",p=c&&m?v:"",n=document.documentElement;Dt(n,r),Qr("#111111",gi+Mi()+Oi());var f=r.borderRadius!==void 0?r.borderRadius:8,d=Hi[r.size]||Hi.medium,u=Di[r.thumbnailSize]||Di.medium,g=Ke(r.reviewLayout);if(g.meta&&g.meta.sizeOverrides&&g.meta.sizeOverrides[r.size]){var k=g.meta.sizeOverrides[r.size],x=k["--ikr-list-photo-w"]||k["--ikr-gallery-photo-w"];x&&(u=parseInt(x))}n.style.setProperty("--ikr-title-size",d.titleSize+"px"),n.style.setProperty("--ikr-review-text-size",d.reviewTextSize+"px"),n.style.setProperty("--ikr-review-title-size",d.reviewTitleSize+"px"),n.style.setProperty("--ikr-author-size",d.authorSize+"px"),n.style.setProperty("--ikr-reply-name-size",d.replyNameSize+"px"),n.style.setProperty("--ikr-reply-text-size",d.replyTextSize+"px"),n.style.setProperty("--ikr-radius",f+"px"),n.style.setProperty("--ikr-radius-sm",Math.max(0,f-4)+"px"),n.style.setProperty("--ikr-photo-title-size",d.photoTitleSize+"px"),n.style.setProperty("--ikr-avg-rating-size",d.avgRatingSize+"px"),n.style.setProperty("--ikr-review-count-size",d.reviewCountSize+"px"),n.style.setProperty("--ikr-compact-count-size",d.compactCountSize+"px"),n.style.setProperty("--ikr-recommend-size",d.recommendSize+"px"),n.style.setProperty("--ikr-btn-text-size",d.btnTextSize+"px"),n.style.setProperty("--ikr-bar-label-size",d.barLabelSize+"px"),n.style.setProperty("--ikr-minimal-avg-size",d.minimalAvgSize+"px"),n.style.setProperty("--ikr-hero-avg-size",d.heroAvgSize+"px"),n.style.setProperty("--ikr-bar-count-size",d.barCountSize+"px"),n.style.setProperty("--ikr-review-date-size",d.reviewDateSize+"px"),n.style.setProperty("--ikr-filter-text-size",d.filterTextSize+"px"),n.style.setProperty("--ikr-load-more-size",d.loadMoreSize+"px"),n.style.setProperty("--ikr-read-more-size",d.readMoreSize+"px"),n.style.setProperty("--ikr-thumbnail-size",u+"px");var z=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";n.style.setProperty("--ikr-review-star-color",z),n.style.setProperty("--ikr-star-size",d.reviewStarSize+"px"),n.style.setProperty("--ikr-avg-star-size",d.avgStarSize+"px"),ur(pr(r.summaryLayout),r.size),ur(Ke(r.reviewLayout),r.size);var h=We(r),E=_t();if(!E)return;var w=Ot(E,e),b=document.getElementById("ikas-reviews");if(b||(b=document.createElement("div"),b.id="ikas-reviews",b.style.minHeight="200px"),b.parentNode!==w&&w.appendChild(b),r.enabled===!1){b.style.minHeight="auto",b.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',Ze(!1);var C=Je;$e(null),C&&xe(C.productId,C.settings,C.reviewsData,C.productName,C.orderBy,C.page,C.badgeSettings);return}b.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var S=i||{},T=yr(S),y=T?[]:S.data&&S.data.reviews||[],L=T?0:S.data&&S.data.totalCount||0;qr(y);var P=b.cloneNode(!1);b.parentNode.replaceChild(P,b),b=P;var N=document.createElement("div");if(N.id="ikas-reviews-widget",N.className="renuvex-pr-reviews-widget",N.setAttribute("data-renuvex-surface","reviews"),N.setAttribute("data-ikr-surface","reviews"),e&&(N.setAttribute("data-renuvex-product-id",String(e)),N.setAttribute("data-ikr-product-id",String(e))),typeof window!="undefined"&&window.__ikasPreviewMode&&(N.style.width="100%",N.style.maxWidth="100%",N.style.marginLeft="0",N.style.marginRight="0"),p){var M=document.createElement("div"),U=r.summaryLayout||"classic";M.className="ikr-title ikr-title-"+U,M.textContent=p,N.appendChild(M)}if(T){N.appendChild(Ht(S.message,async function(){var R=await Te(q,Se,1,Pe,Ae);await xe(q,A,R,Re,Se,1,vr)})),b.appendChild(N),je(N,"reviews-widget",{productId:e||"",reason:"fetch_error"});return}var X=S.data&&S.data.allCount||0,ne=S.data&&S.data.ratingCounts||null,W=ne||[0,0,0,0,0],_=S.data&&S.data.avgRating||"0.0";if(!ne&&y.length>0){y.forEach(function(R){R.rating>=1&&R.rating<=5&&W[R.rating-1]++});var F=y.reduce(function(R,I){return R+I.rating},0);_=(F/y.length).toFixed(1)}if(X>0){var Ne=pr(r.summaryLayout),He=Ne.render({widget:N,data:S,settings:r,iconPair:h,allCount:X,ratingCounts:W,avgRatingVal:_,currentRatingFilter:Pe,currentOrderBy:Se,currentHasImages:Ae,onFilterChange:async function(R){var I=Pe===R?null:R;Xe(I),Ee(1);var B=await Te(q,Se,1,I,Ae);await xe(q,A,B,Re,Se,1)},onSortChange:async function(R,I){Ee(1);var B=R,G=!1;I&&(G=!0,B="newest"),Hr(G),Ve(B);var fr=await Te(q,B,1,Pe,G);await xe(q,A,fr,Re,B,1)}});N.appendChild(He)}else{var H=document.createElement("button");H.className="ikr-write-btn",H.style.cssText="display:block;margin:16px auto 0;",H.textContent=r.writeButtonText||"Yorum Yap",H.onclick=D,N.appendChild(H)}var ze=(Or||[]).filter(function(R){return ye(R).length>0});if(r.showPhotoGallery!==!1&&!Ae&&ze.length>0){var oe=document.createElement("div");if(oe.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var le=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",Y=document.createElement("div");Y.className="ikr-photo-title",Y.textContent=le,oe.appendChild(Y)}var J=r.reviewLayout==="card"?"1/1":"3/4";n.style.setProperty("--ikr-photo-thumb-aspect",J);var de=document.createElement("div");de.className="ikr-photo-strip";var Z=j,De=r.reviewLayout==="card"?j:Math.round(j*4/3),fe=0;ze.forEach(function(R){if(!(fe>=15)){var I=Qe(R);if(I){var B=document.createElement("img"),G=ee(I,j);B.src=G.src,B.srcset=G.srcset,B.loading=fe<3?"eager":"lazy",B.decoding="async",B.width=Z,B.height=De,B.className="ikr-photo-strip-thumb",B.alt="Yorum foto\u011Fraf\u0131",re(B),(function(fr,Yi){B.onclick=function(){te(Yi,fr,ze)}})(I,R),de.appendChild(B),fe++}}});var $=document.createElement("button");$.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",$.innerHTML="&#8249;",$.setAttribute("aria-label","\xD6nceki"),$.onclick=function(){de.scrollBy({left:-200,behavior:"smooth"})};var Q=document.createElement("button");Q.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",Q.innerHTML="&#8250;",Q.setAttribute("aria-label","Sonraki"),Q.onclick=function(){de.scrollBy({left:200,behavior:"smooth"})};var se=document.createElement("div");se.className="ikr-photo-strip-wrap",se.appendChild($),se.appendChild(de),se.appendChild(Q),oe.appendChild(se),N.appendChild(oe)}if(y.length===0){var O=document.createElement("p");O.className="ikr-state-msg",O.textContent="Hen\xFCz yorum yok.",N.appendChild(O)}else{var g=Ke(r.reviewLayout);y.forEach(function(I){N.appendChild(g.render(I,kr))})}var ce=S.data&&S.data.hasMore;if(ce){var V=document.createElement("button");V.className="ikr-load-more",V.textContent="Daha Fazla G\xF6ster",V.onclick=async function(){V.disabled=!0,V.textContent="Y\xFCkleniyor...";var R=_r+1,I=await Te(q,Se,R,Pe,Ae);if(I&&!yr(I)&&I.data&&Array.isArray(I.data.reviews)){Kr(I.data.reviews),Ee(R);var B=Ke(A.reviewLayout);I.data.reviews.forEach(function(G){N.insertBefore(B.render(G,kr),V)}),I.data.hasMore?(V.disabled=!1,V.textContent="Daha Fazla G\xF6ster"):V.remove()}else V.disabled=!1,V.textContent="Tekrar Dene"},N.appendChild(V)}b.appendChild(N),je(N,"reviews-widget",{productId:e||""}),Sr(X>0?_:null,L,t,vr,h,q)}catch(R){console.error("[ikr] render error:",R),b.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(Ze(!1),Je){var Ce=Je;$e(null),xe(Ce.productId,Ce.settings,Ce.reviewsData,Ce.productName,Ce.orderBy,Ce.page,Ce.badgeSettings)}}}export{xe as a,nr as b,yr as c,Te as d,Wi as e,Ut as f};
