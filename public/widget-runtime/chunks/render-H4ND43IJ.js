...
`);function ba(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function le(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function ya(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function wa(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",o=ya()&&!n;if(a>0){var l=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",l+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function za(e){var r=document.body.style,t=document.documentElement.style;le(t,"overflow",e.rootOverflow,e.rootOverflowPriority),le(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),le(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),le(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),le(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),le(r,"position",e.bodyPosition,e.bodyPositionPriority),le(r,"top",e.bodyTop,e.bodyTopPriority),le(r,"left",e.bodyLeft,e.bodyLeftPriority),le(r,"right",e.bodyRight,e.bodyRightPriority),le(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Ze=0,Fe=null;function gr(){return Ze+=1,Ze>1||(Fe=ba(),wa(Fe)),Fe}function hr(){if(Ze!==0&&(Ze-=1,!(Ze>0))){var e=Fe;Fe=null,e&&za(e)}}function Ca(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function br(){var e=Ca();return!e||e===document.body||e===document.documentElement?null:e}function K(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function ka(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function _r(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(ka)}function Sa(e,r){var t=e,a=_r(e);!a.length&&r&&(t=r,a=_r(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;K(n)}function yr(e,r,t){if(e.key==="Tab"){var a=_r(r);if(!a.length){e.preventDefault(),Sa(r);return}var n=a[0],o=a[a.length-1],l=Et(t);if(!r.contains(l)){e.preventDefault(),K(n);return}if(a.indexOf(l)===-1){e.preventDefault(),K(e.shiftKey?o:n);return}e.shiftKey&&l===n?(e.preventDefault(),K(o)):!e.shiftKey&&l===o&&(e.preventDefault(),K(n))}}var Bt="renuvexPrOverlay";function wr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Bt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Ea(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Bt]===e.id)}function zr(e){if(Ea(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Oe(e){return ye(e)}function _t(e,r,t,a,n){hr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&dr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),K(n)}function Ta(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ce(e.rating,N);var o=document.createElement("span");o.className="renuvex-pr-modal-date",o.textContent=me(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-modal-title",l.textContent=e.title||"",l.style.display=e.title?"":"none",t.appendChild(l);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-modal-reply";var x=document.createElement("div");x.className="renuvex-pr-modal-reply-label",x.textContent=N&&N.merchantReplyLabel||"Ma\u011Faza Sahibi";var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",p.appendChild(x),p.appendChild(s),p.style.display=e.merchantReply?"":"none",t.appendChild(p),r.appendChild(t),r}function Mt(e,r,t){var a=t||N,n=e.querySelector(".renuvex-pr-modal-scroll-content"),o=n.querySelector(".renuvex-pr-modal-stars");o.innerHTML=ce(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=me(r.createdAt);var l=n.querySelector(".renuvex-pr-modal-title");l.textContent=r.title||"",l.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Fr(e,r,t,a,n,o,l,i,d){var p=Oe(e),x=Math.max(0,Math.min(t||0,p.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var u=document.createElement("img"),v=l==="next"?"renuvex-pr-modal-img-enter-right":l==="prev"?"renuvex-pr-modal-img-enter-left":"";u.className="renuvex-pr-modal-main-img"+(v?" "+v:""),u.src=Ir(p[x]||""),u.decoding="async",u.width=Rr,u.height=Math.round(Rr*4/3),u.alt="Yorum foto\u011Fraf\u0131",wt(u,function(T){if(T.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var E=document.createElement("div");E.className="renuvex-pr-modal-img-error",E.setAttribute("role","status"),E.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(E,T)}}),s.appendChild(u);var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var m=X(Se);m&&b.appendChild(m),b.setAttribute("aria-label","Kapat"),b.onclick=function(T){T.stopPropagation(),o()},s.appendChild(b);var y=0;if(s.addEventListener("touchstart",function(T){y=T.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(T){var E=y-T.changedTouches[0].clientX;if(!(Math.abs(E)<50)){if(E>0){if(f)xe(e,r,x+1,a,n,o,!0,"next",i,d);else if(g){var P=a[r+1];xe(P,r+1,0,a,n,o,!1,"next",i,d)}}else if(h)xe(e,r,x-1,a,n,o,!0,"prev",i,d);else if(C){var B=a[r-1],j=Oe(B);xe(B,r-1,j.length-1,a,n,o,!1,"prev",i,d)}}},{passive:!0}),p.length>1){var c=document.createElement("div");c.className="renuvex-pr-modal-thumbs",p.forEach(function(T,E){var P=document.createElement("img"),B=ie(T,mr);P.src=B.src,P.srcset=B.srcset,P.loading="lazy",P.decoding="async",P.width=mr,P.height=mr,P.className="renuvex-pr-modal-thumb"+(E===x?" renuvex-pr-modal-thumb-active":""),P.alt="K\xFC\xE7\xFCk resim "+(E+1),oe(P),P.tabIndex=0,P.setAttribute("role","button"),P.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(E+1)+" se\xE7"),E===x&&P.setAttribute("aria-current","true"),(function(j){function F(){xe(e,r,j,a,n,o,!0,null,i,d)}P.onclick=F,P.onkeydown=function(V){(V.key==="Enter"||V.key===" ")&&(V.preventDefault(),F())}})(E),c.appendChild(P)}),s.appendChild(c)}var h=x>0,f=x<p.length-1,C=r>0,g=r<a.length-1,w=h||C,k=f||g;if(w){var A=document.createElement("button");A.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var z=X(Re);z&&A.appendChild(z),A.setAttribute("aria-label","\xD6nceki"),A.onclick=function(T){if(T.stopPropagation(),h)xe(e,r,x-1,a,n,o,!0,"prev",i,d);else if(C){var E=a[r-1],P=Oe(E);xe(E,r-1,P.length-1,a,n,o,!1,"prev",i,d)}},s.appendChild(A)}if(k){var S=document.createElement("button");S.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=X(sr);L&&S.appendChild(L),S.setAttribute("aria-label","Sonraki"),S.onclick=function(T){if(T.stopPropagation(),f)xe(e,r,x+1,a,n,o,!0,"next",i,d);else if(g){var E=a[r+1];xe(E,r+1,0,a,n,o,!1,"next",i,d)}},s.appendChild(S)}return s}function Ft(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=Oe(a);n[0]&&(new Image().src=Ir(n[0]))}})}function Mr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Aa(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function o(){Mr(t),Mr(a),Mr(n)}o(),t&&K(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function xe(e,r,t,a,n,o,l,i,d,p){if(p&&(p.currentReview=e),l){var x=Fr(e,r,t,a,n,o,i,d,p);n.firstChild&&n.replaceChild(x,n.firstChild)}else{var x=Fr(e,r,t,a,n,o,i,d,p),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(x,n.firstChild),s&&Mt(s,e,p&&p.currentSettings),Aa(d,n)}Ft(r,a)}function pe(e,r,t){var a=Oe(e);if(!a.length)return;var n=(t||[]).filter(function(k){return Oe(k).length>0}),o=n.findIndex(function(k){return k===e||k.id===e.id});o===-1&&(n.unshift(e),o=0);var l=a.indexOf(r);l<0&&(l=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var p=!1,x=null,s=br(),u=gr(),v=wr(),b={currentReview:e,currentSettings:N},m=null;function y(k){var A=k&&k.detail&&k.detail.settings;if(!(A&&A===m)){m=A||null,b.currentSettings=A||N;var z=d.querySelector(".renuvex-pr-modal-right");!z||!b.currentReview||Mt(z,b.currentReview,b.currentSettings)}}function c(){p||(p=!0,window.removeEventListener(Ee,y),_t(x&&x.host,h,c,u,s))}function h(k){if(k.key==="Escape"){f();return}yr(k,i,x&&x.root)}function f(){p||(p=!0,window.removeEventListener(Ee,y),_t(x&&x.host,h,c,u,s),zr(v))}document.addEventListener("keydown",h),window.addEventListener("popstate",c),window.addEventListener(Ee,y),i.onclick=function(){f()},d.onclick=function(k){k.stopPropagation()},d.appendChild(Fr(e,o,l,n,d,f,null,i,b)),d.appendChild(Ta(e)),Ft(o,n);var C=document.createElement("div");C.className="renuvex-pr-modal-wrap",C.tabIndex=-1,C.setAttribute("role","dialog"),C.setAttribute("aria-modal","true"),C.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),C.appendChild(d);var g=document.createElement("button");g.className="renuvex-pr-modal-close";var w=X(Se);w&&g.appendChild(w),g.setAttribute("aria-label","Kapat"),g.onclick=function(k){k.stopPropagation(),f()},C.appendChild(g),i.appendChild(C),x=xr(),Me(x.root,_e+Le+fr),x.root.appendChild(i),ke(x.root),K(C)}function we(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var jr={};he(jr,{css:()=>Oa,meta:()=>Fa,render:()=>Ha});function He(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,o=e.onFilterChange;be(a);var l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,p=t>0?Math.round(d/t*100):0,x=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(x?" renuvex-pr-bar-active":"")+(n&&!x?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",x?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" yorum, "+(x?"filtreyi kald\u0131r":"filtrele"));for(var u="",v=1;v<=5;v++){var b=v<=i;u+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(b?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+G(b?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+u+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+p+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(m){function y(){o(m)}s.onclick=y,s.onkeydown=function(c){(c.key==="Enter"||c.key===" "||c.key==="Space"||c.key==="Spacebar")&&(c.preventDefault(),y())}})(i),l.appendChild(s)}return l}var Yt="data-renuvex-pr-dismiss-gesture",Te=[],Ot=!1,Cr=!1,$e=[],Ye=null;function Ht(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Or(){for(var e=Te.length-1;e>=0;e--){var r=Te[e].element;r&&r.isConnected===!1&&Te.splice(e,1)}return Te}function La(e){!e||typeof e.setAttribute!="function"||($e.indexOf(e)===-1&&$e.push(e),e.setAttribute(Yt,""))}function Dt(){for(var e=0;e<$e.length;e++){var r=$e[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Yt)}$e=[],Ye&&typeof clearTimeout=="function"&&clearTimeout(Ye),Ye=null}function Pa(e){if(Cr){Cr=!1,Dt(),e.preventDefault(),e.stopPropagation();return}for(var r=Or(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Ht(e,n.trigger)||Ht(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Na(e){if(e.key==="Escape")for(var r=Or(),t=r.length-1;t>=0;t--)r[t].close()}function jt(){Ot||typeof document=="undefined"||(document.addEventListener("click",Pa,!0),document.addEventListener("keydown",Na),Ot=!0)}function Ra(e){jt(),Cr=!0,La(e),Ye&&typeof clearTimeout=="function"&&clearTimeout(Ye),typeof setTimeout=="function"&&(Ye=setTimeout(function(){Cr=!1,Dt()},700))}function Hr(e){Ra(e)}function kr(e){jt();var r={trigger:e.trigger,element:e.element,close:e.close};return Te.push(r),{unregister:function(){var t=Te.indexOf(r);t!==-1&&Te.splice(t,1)},notifyOpening:function(){for(var t=Or(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function re(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,o=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=N&&N.writeButtonText||"Yorum Yap",i.onclick=n,l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-filter-btn",p.setAttribute("aria-label","Filtrele"),p.setAttribute("aria-haspopup","menu"),p.setAttribute("aria-expanded","false");var x=N&&N.filterIcon||"lines";p.innerHTML=ve(mt(x));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function b(){return r&&r.parentNode||r||null}function m(f,C){if(!(C===!0||!f)){if(f.type==="touchstart"){Hr(b());return}if(f.type==="pointerdown"){var g=f.pointerType||"";g&&g!=="mouse"&&Hr(b());return}}}function y(f){var C=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),p.classList.remove("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","false");var g=f&&(f.restoreFocus===!0||f.restoreFocus==="auto"&&nr());if(C&&g)try{p.focus({preventScroll:!0})}catch(w){try{p.focus()}catch(k){}}return C}function c(){h.notifyOpening(),s.classList.add("renuvex-pr-open"),p.classList.add("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","true");var f=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");f&&requestAnimationFrame(function(){try{f.focus({preventScroll:!0})}catch(C){try{f.focus()}catch(g){}}})}u.forEach(function(f){var C=f[2],g=C?a:!a&&(t||"newest")===f[0],w=document.createElement("button");w.type="button",w.className="renuvex-pr-filter-item"+(g?" renuvex-pr-filter-item-active":""),w.setAttribute("role","menuitem"),w.textContent=f[1];var k=!1;function A(z,S){z&&(z.preventDefault(),z.stopPropagation()),!k&&(k=!0,v=!0,m(z,S),y({restoreFocus:S}),o(f[0],C),setTimeout(function(){k=!1,v=!1},0))}w.addEventListener("pointerdown",function(z){z.button!==void 0&&z.button!==0||z.pointerType!=="mouse"&&A(z,!1)}),typeof window!="undefined"&&!window.PointerEvent&&w.addEventListener("touchstart",function(z){A(z,!1)},{passive:!1}),w.addEventListener("keydown",function(z){(z.key==="Enter"||z.key===" ")&&A(z,!0)}),w.onclick=function(z){A(z,!1)},s.appendChild(w)}),p.onclick=function(){s.classList.contains("renuvex-pr-open")?y({restoreFocus:"auto"}):c()},d.addEventListener("keydown",function(f){f.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(f.stopPropagation(),y({restoreFocus:!0}))}),d.addEventListener("focusout",function(f){if(s.classList.contains("renuvex-pr-open")&&!v){var C=f.relatedTarget;C&&d.contains(C)||y()}});var h=kr({trigger:d,element:s,close:y});return d.appendChild(p),d.appendChild(s),l.appendChild(d),l}var Vt=`
...
`;var Ya={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Da=ra,ja="__unknown_product__",Qe=Object.create(null);function Va(e){return e?String(e):ja}var Ae=null,er=null;function Ua(){!Ae||!er||(Ae.removeEventListener?Ae.removeEventListener("change",er):Ae.removeListener&&Ae.removeListener(er),Ae=null,er=null)}function Wa(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,x=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange,v=Va(t),b=document.createElement("div");b.className="renuvex-pr-summary renuvex-pr-summary-compact";var m=document.createElement("div");m.className="renuvex-pr-compact-header";var y=document.createElement("div");y.className="renuvex-pr-compact-trigger-wrap";var c=document.createElement("button");c.className="renuvex-pr-compact-trigger",c.type="button",c.setAttribute("aria-expanded","false"),c.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Ie(i,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+o.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+ve(xt)+"</span>",y.appendChild(c),m.appendChild(y);var h=re({widget:r,currentOrderBy:p,currentHasImages:x,onWriteClick:Y,onSortChange:u}),f=h.querySelector(".renuvex-pr-filter-wrap"),C=h.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");g.className="renuvex-pr-compact-actions-slot",C&&g.appendChild(C),f&&g.appendChild(f),m.appendChild(g),b.appendChild(m);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var k=document.createElement("div");k.className="renuvex-pr-compact-panel-inner";var A=document.createElement("div");A.className="renuvex-pr-compact-avg",A.innerHTML='<span class="renuvex-pr-icon">'+G("full")+"</span><span>"+i+"</span>",k.appendChild(A),k.appendChild(He({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:function(R){S()&&w.classList.contains("renuvex-pr-open")&&(Qe[v]=!0),s(R)}})),w.appendChild(k);var z=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function S(){return!!(z&&z.matches)}function L(R){R?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",R?"false":"true"),c.setAttribute("aria-expanded",R?"true":"false")}function T(R){var ue=R?b:y;if(w.parentNode!==ue){var ae=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&L(!1),ae&&(Qe[v]=!1),ue.appendChild(w)}}if(T(z?z.matches:!1),C){var E=document.createElement("button");E.className="renuvex-pr-write-btn",E.textContent=N&&N.writeButtonText||"Yorum Yap",E.onclick=Y;var P=document.createElement("div");P.className="renuvex-pr-compact-write-row",P.appendChild(E),b.appendChild(P)}function B(){var R=w.classList.contains("renuvex-pr-open");return L(!1),S()&&(Qe[v]=!1),R}function j(){F&&F.notifyOpening(),L(!0),S()&&(Qe[v]=!0)}c.onclick=function(){w.classList.contains("renuvex-pr-open")?B():j()};var F=null;function V(R){F&&(F.unregister(),F=null),R||(F=kr({trigger:y,element:w,close:B}))}if(V(z?z.matches:!1),Ua(),z){var te=function(R){T(R.matches),V(R.matches)};z.addEventListener?z.addEventListener("change",te):z.addListener&&z.addListener(te),Ae=z,er=te}if(S()&&Qe[v]&&L(!0),a.showRecommendation!==!1){var D=(l[3]||0)+(l[4]||0),J=o>0?Math.round(D/o*100):0;if(J>0){var W=document.createElement("div");W.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="renuvex-pr-recommend-pct">%'+J+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(W)}}return b}var Ur={};he(Ur,{css:()=>Ga,meta:()=>qa,render:()=>Xa});var ta=`
...
`;var rn={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},tn=oa;function an(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var o=document.createElement("span");o.className="renuvex-pr-review-stars",o.innerHTML=ce(e.rating,N),n.appendChild(o);var l=document.createElement("time");if(l.className="renuvex-pr-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=me(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var p=(e.comment||"").trim();p&&t.appendChild(je(p,"renuvex-pr-body").fragment);var x=ye(e);if(x.length){var s=document.createElement("div");s.className="renuvex-pr-gallery",x.forEach(function(v){var b=document.createElement("img"),m=ie(v,U);b.src=m.src,b.srcset=m.srcset,b.loading="lazy",b.decoding="async",b.width=U,b.height=U,b.className="renuvex-pr-img",oe(b),b.setAttribute("data-renuvex-img-url",v),(function(y){we(b,function(){pe(e,y,r)})})(v),s.appendChild(b)}),t.appendChild(s)}var u=Ve(e.merchantReply);return u&&t.appendChild(u),t}var Xr={};he(Xr,{css:()=>on,meta:()=>nn,render:()=>ln});var la=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var pn={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},un=pa;function dn(e,r){var t=vr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-gallery-content";var l=document.createElement("span");if(l.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",l.innerHTML=ce(e.rating,N),o.appendChild(l),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,o.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",o.appendChild(d);var p=document.createElement("time");p.className="renuvex-pr-review-gallery-date",p.style.display="block",e.createdAt&&p.setAttribute("datetime",e.createdAt),p.textContent=me(e.createdAt),o.appendChild(p);var x=(e.comment||"").trim();if(x&&o.appendChild(je(x,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){pe(e,t,r)}}:null).fragment),n.appendChild(o),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var u=document.createElement("img"),v=ie(t,cr);u.src=v.src,u.srcset=v.srcset,u.loading="lazy",u.decoding="async",u.width=cr,u.height=Math.round(cr*4/3),oe(u),u.setAttribute("data-renuvex-img-url",t),we(u,function(){pe(e,t,r)}),s.appendChild(u),n.appendChild(s)}var b=Ve(e.merchantReply,t?function(){pe(e,t,r)}:null);return b&&(b.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(b)),n}var Tr={card:Gr,list:Xr,gallery:Kr};function Ar(e){return Tr[e]||Tr.card}function ua(){return Object.keys(Tr).map(function(e){return Tr[e].css||""}).join(`
`)}var Jr=0;function Ue(){return Jr++,Jr}function We(e,r){return e!==Jr?!1:r?!(r.productId!==void 0&&H!==r.productId||r.orderBy!==void 0&&q!==r.orderBy||r.page!==void 0&&ir!==r.page||r.ratingFilter!==void 0&&Q!==r.ratingFilter||r.hasImages!==void 0&&ee!==r.hasImages):!0}var Zr={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},$r={small:80,medium:110,large:140};function da(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var o=document.createElementNS(t,"line");o.setAttribute("x1","1"),o.setAttribute("y1","1"),o.setAttribute("x2","23"),o.setAttribute("y2","23"),a.appendChild(n),a.appendChild(o);var l=document.createElement("div");l.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",l.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(l),r.appendChild(i),r}function sa(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function fe(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),o=parseInt(t[3],16);return"rgba("+a+","+n+","+o+","+r+")"}function Lr(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Qr(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function va(e){return .2126*Qr(e.r)+.7152*Qr(e.g)+.0722*Qr(e.b)}function ca(e,r){var t=va(e),a=va(r),n=Math.max(t,a),o=Math.min(t,a);return(n+.05)/(o+.05)}function sn(e){var r=Lr(e)||Lr("#ffffff"),t=Lr("#111111"),a=Lr("#ffffff");return ca(t,r)>=ca(a,r)?"#111111":"#ffffff"}function vn(e){return fe(e,e==="#ffffff"?.1:.06)}function ma(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",o=r.headerRecommendColor||"#111111",l=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",p=fe(l,.06),x=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",u=r.btnTextColor||"#ffffff",v=r.btnBorderColor||"#111111",b=r.filterBtnBgColor||"#111111",m=r.filterBtnTextColor||"#ffffff",y=r.filterBtnBorderColor||"#111111",c=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",f=r.filterItemTextColor||"#111111",C=r.filterItemHoverBgColor||"#f3f4f6",g=r.filterItemActiveColor||"#111111",w=r.reviewTitleColor||"#111111",k=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",z=r.reviewBodyColor||"#111111",S=r.reviewBorderColor||"#e5e7eb",L=fe(z,.65),T=r.replyBgColor||"#f9fafb",E=r.replyBorderColor||"#747474",P=r.replyLabelColor||"#111111",B=r.replyTextColor||"#111111",j=r.photoTitleColor||"#111111",F=fe("#111111",.05),V=r.photoArrowBgColor||"#ffffff",te=r.photoArrowTextColor||"#111111",D=fe("#111111",.12),J=r.formBgColor||"#ffffff",W=r.formPrimaryTextColor||"#111111",R=r.formSecondaryTextColor||"#3b3b3b",ue=r.inputTextColor||W,ae=r.inputBorderColor||"#d1d5db",ze=r.placeholderColor||"#9ca3af",ne=r.formStepBarColor||"#111111",I=r.formBtnBgColor||"#111111",ge=r.formBtnTextColor||"#ffffff",O=r.formBtnBorderColor||"#111111",rr=fe(I,.06),Ce=fe(I,.18),_=fe(ge,.85),Z=fe(W,.06),$=sn(J),M=vn($),de=r.loadMoreBgColor||"#ffffff",tr=r.loadMoreTextColor||"#111111",ar=r.loadMoreBorderColor||"#111111",se={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":o,"--renuvex-pr-bar-fill":l,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":p,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":u,"--renuvex-pr-btn-border":v,"--renuvex-pr-filter-btn-bg":b,"--renuvex-pr-filter-btn-text":m,"--renuvex-pr-filter-btn-border":y,"--renuvex-pr-filter-menu-bg":c,"--renuvex-pr-filter-menu-border":h,"--renuvex-pr-filter-item-text":f,"--renuvex-pr-filter-item-hover-bg":C,"--renuvex-pr-filter-item-active":g,"--renuvex-pr-review-title":w,"--renuvex-pr-review-author":k,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":z,"--renuvex-pr-review-border":S,"--renuvex-pr-state-text":L,"--renuvex-pr-review-star-color":x,"--renuvex-pr-reply-bg-color":T,"--renuvex-pr-reply-border":E,"--renuvex-pr-reply-label":P,"--renuvex-pr-reply-text":B,"--renuvex-pr-photo-title":j,"--renuvex-pr-photo-image-border":F,"--renuvex-pr-photo-arrow-bg":V,"--renuvex-pr-photo-arrow-text":te,"--renuvex-pr-photo-arrow-border":D,"--renuvex-pr-fwizard-bg":J,"--renuvex-pr-fwizard-text":W,"--renuvex-pr-fwizard-secondary-text":R,"--renuvex-pr-fwizard-input-bg":J,"--renuvex-pr-fwizard-input-text":ue,"--renuvex-pr-fwizard-input-border":ae,"--renuvex-pr-fwizard-placeholder":ze,"--renuvex-pr-fwizard-close-text":$,"--renuvex-pr-fwizard-close-hover-bg":M,"--renuvex-pr-fwizard-progress-bg":Z,"--renuvex-pr-fwizard-progress-active":ne,"--renuvex-pr-fwizard-btn-bg":I,"--renuvex-pr-fwizard-btn-text":ge,"--renuvex-pr-fwizard-btn-border":O,"--renuvex-pr-fwizard-btn-disabled-bg":Ce,"--renuvex-pr-fwizard-btn-disabled-text":_,"--renuvex-pr-fwizard-nav-hover-bg":rr,"--renuvex-pr-load-more-bg":de,"--renuvex-pr-load-more-text":tr,"--renuvex-pr-load-more-border":ar};Object.keys(se).forEach(function(qe){e.style.setProperty(qe,se[qe])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function xa(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,o=e.wireLightboxTrigger,l=(e.photoStripReviews||[]).filter(function(C){return ye(C).length>0});if(!(r.showPhotoGallery!==!1&&!a&&l.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",p=document.createElement("div");p.className="renuvex-pr-photo-title",p.textContent=d,i.appendChild(p)}var x=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",x);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var u=U,v=r.reviewLayout==="card"?U:Math.round(U*4/3),b=0;l.forEach(function(C){if(!(b>=15)){var g=vr(C);if(g){var w=document.createElement("img"),k=ie(g,U);w.src=k.src,w.srcset=k.srcset,w.loading=b<3?"eager":"lazy",w.decoding="async",w.width=u,w.height=v,w.className="renuvex-pr-photo-strip-thumb",w.alt="Yorum foto\u011Fraf\u0131",oe(w),(function(A,z){o(w,function(){n(z,A,l)})})(g,C),s.appendChild(w),b++}}});var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var y=X(Re);y&&m.appendChild(y),m.setAttribute("aria-label","\xD6nceki"),m.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var c=document.createElement("button");c.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=X(sr);h&&c.appendChild(h),c.setAttribute("aria-label","Sonraki"),c.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var f=document.createElement("div");return f.className="renuvex-pr-photo-strip-wrap",f.appendChild(m),f.appendChild(s),f.appendChild(c),i.appendChild(f),i}function fa(e){var r=e.render;async function t(){var o=Ue(),l=H,i=q,d=Q,p=ee,x=await Be(H,q,1,Q,ee);We(o,{productId:l,orderBy:i,ratingFilter:d,hasImages:p})&&await r(H,N,x,Pe,q,1,rt)}async function a(o){var l=Ue(),i=Q===o?null:o,d=H,p=q,x=ee;at(i),Ne(1);var s=await Be(H,q,1,i,ee);We(l,{productId:d,orderBy:p,page:1,ratingFilter:i,hasImages:x})&&await r(H,N,s,Pe,q,1)}async function n(o,l){var i=Ue(),d=H,p=Q;Ne(1);var x=o,s=!1;l&&(s=!0,x="newest"),nt(s),or(x);var u=await Be(H,x,1,Q,s);We(i,{productId:d,orderBy:x,page:1,ratingFilter:p,hasImages:s})&&await r(H,N,u,Pe,x,1)}return{onRetry:t,onFilterChange:a,onSortChange:n}}function cn(){return kt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function mn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=zt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),Ct(t,{surface:"reviews",productId:r||""}),t}async function et(e,r,t,a,n,o,l){if(ct){ur({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:o,badgeSettings:l});return}pr(!0),it(e),ot(r),l!==void 0&&lt(l),pt(a),n&&or(n),o&&Ne(o),t!=null&&ut(t);var i=fa({render:et});try{let Ce=function(_,Z){if(!(!_||!_.meta||!_.meta.sizeOverrides)){var $=_.meta.sizeOverrides[Z];$&&Object.keys($).forEach(function(M){v.style.setProperty(M,$[M])})}};var rr=Ce,d=Er(r.summaryLayout),p=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),x=r.showTitle!==!1,s=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",u=p&&x?s:"",v=document.documentElement;ma(v,r);var b=r.borderRadius!==void 0?r.borderRadius:8,m=Zr[r.size]||Zr.medium,y=$r[r.thumbnailSize]||$r.medium;v.style.setProperty("--renuvex-pr-title-size",m.titleSize+"px"),v.style.setProperty("--renuvex-pr-review-text-size",m.reviewTextSize+"px"),v.style.setProperty("--renuvex-pr-review-title-size",m.reviewTitleSize+"px"),v.style.setProperty("--renuvex-pr-author-size",m.authorSize+"px"),v.style.setProperty("--renuvex-pr-reply-name-size",m.replyNameSize+"px"),v.style.setProperty("--renuvex-pr-reply-text-size",m.replyTextSize+"px"),v.style.setProperty("--renuvex-pr-radius",b+"px"),v.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,b-4)+"px"),v.style.setProperty("--renuvex-pr-photo-title-size",m.photoTitleSize+"px"),v.style.setProperty("--renuvex-pr-avg-rating-size",m.avgRatingSize+"px"),v.style.setProperty("--renuvex-pr-review-count-size",m.reviewCountSize+"px"),v.style.setProperty("--renuvex-pr-compact-count-size",m.compactCountSize+"px"),v.style.setProperty("--renuvex-pr-recommend-size",m.recommendSize+"px"),v.style.setProperty("--renuvex-pr-btn-text-size",m.btnTextSize+"px"),v.style.setProperty("--renuvex-pr-bar-label-size",m.barLabelSize+"px"),v.style.setProperty("--renuvex-pr-minimal-avg-size",m.minimalAvgSize+"px"),v.style.setProperty("--renuvex-pr-hero-avg-size",m.heroAvgSize+"px"),v.style.setProperty("--renuvex-pr-bar-count-size",m.barCountSize+"px"),v.style.setProperty("--renuvex-pr-review-date-size",m.reviewDateSize+"px"),v.style.setProperty("--renuvex-pr-filter-text-size",m.filterTextSize+"px"),v.style.setProperty("--renuvex-pr-load-more-size",m.loadMoreSize+"px"),v.style.setProperty("--renuvex-pr-read-more-size",m.readMoreSize+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size",y+"px");var c=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";v.style.setProperty("--renuvex-pr-review-star-color",c),v.style.setProperty("--renuvex-pr-star-size",m.reviewStarSize+"px"),v.style.setProperty("--renuvex-pr-avg-star-size",m.avgStarSize+"px"),Ce(Er(r.summaryLayout),r.size),Ce(Ar(r.reviewLayout),r.size);var h=Ke(r),f=cn();if(!f)return;var C=mn(f,e),g=document.getElementById("renuvex-reviews");g||(g=document.createElement("div"),g.id="renuvex-reviews",g.style.minHeight="200px"),g.parentNode!==C&&C.appendChild(g);var w=St(g),k=_e+Le+fr+ia()+ua();Me(w,k);var A=Tt(w);if(r.enabled===!1){g.style.minHeight="auto",A.replaceChildren(da(r.borderRadius!==void 0?r.borderRadius:8)),pr(!1);var z=lr;ur(null),z&&et(z.productId,z.settings,z.reviewsData,z.productName,z.orderBy,z.page,z.badgeSettings);return}try{var S=t||{},L=Br(S),T=L?[]:S.data&&S.data.reviews||[];dt(T),A.replaceChildren();var E=document.createElement("section");if(E.id="renuvex-reviews-widget",E.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),E.className="renuvex-pr-reviews-widget",E.setAttribute("data-renuvex-surface","reviews"),e&&E.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(E.style.width="100%",E.style.maxWidth="100%",E.style.marginLeft="0",E.style.marginRight="0"),u){var P=document.createElement("div"),B=r.summaryLayout||"classic";P.className="renuvex-pr-title renuvex-pr-title-"+B,P.textContent=u,E.appendChild(P)}if(L){E.appendChild(sa(S.message,i.onRetry)),A.appendChild(E),ke(w),Pr(E,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return w.getElementById("renuvex-reviews-widget")});return}var j=S.data&&S.data.allCount||0,F=S.data&&S.data.ratingCounts||null,V=F||[0,0,0,0,0],te=S.data&&S.data.avgRating||"0.0";if(!F&&T.length>0){T.forEach(function(_){_.rating>=1&&_.rating<=5&&V[_.rating-1]++});var D=T.reduce(function(_,Z){return _+Z.rating},0);te=(D/T.length).toFixed(1)}if(j>0){var J=Er(r.summaryLayout),W=J.render({widget:E,productId:e,data:S,settings:r,iconPair:h,allCount:j,ratingCounts:V,avgRatingVal:te,currentRatingFilter:Q,currentOrderBy:q,currentHasImages:ee,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});E.appendChild(W)}else{var R=document.createElement("button");R.className="renuvex-pr-write-btn",R.style.cssText="display:block;margin:16px auto 0;",R.textContent=r.writeButtonText||"Yorum Yap",R.onclick=Y,E.appendChild(R)}var ue=xa({settings:r,root:v,currentHasImages:ee,photoStripReviews:tt,openReviewModal:pe,wireLightboxTrigger:we});if(ue&&E.appendChild(ue),T.length===0){var ae=document.createElement("p");ae.className="renuvex-pr-state-msg",ae.textContent="Hen\xFCz yorum yok.",E.appendChild(ae)}else{var ze=Ar(r.reviewLayout);T.forEach(function(_){E.appendChild(ze.render(_,Nr))})}var ne=S.data&&S.data.hasMore;if(ne){var I=document.createElement("button");I.className="renuvex-pr-load-more",I.textContent="Daha Fazla G\xF6ster",I.onclick=async function(){I.disabled=!0,I.textContent="Y\xFCkleniyor...";var _=Ue(),Z=H,$=q,M=ir,de=Q,tr=ee,ar=M+1,se=await Be(Z,$,ar,de,tr);if(We(_,{productId:Z,orderBy:$,page:M,ratingFilter:de,hasImages:tr}))if(se&&!Br(se)&&se.data&&Array.isArray(se.data.reviews)){var qe=st(se.data.reviews);vt(qe),Ne(ar);var ga=Ar(N.reviewLayout);qe.forEach(function(ha){E.insertBefore(ga.render(ha,Nr),I)}),se.data.hasMore?(I.disabled=!1,I.textContent="Daha Fazla G\xF6ster"):I.remove()}else I.disabled=!1,I.textContent="Tekrar Dene"},E.appendChild(I)}A.appendChild(E),ke(w),Pr(E,"reviews-widget",{productId:e||""},function(){return w.getElementById("renuvex-reviews-widget")})}catch(_){console.error("[renuvex-pr] render error:",_);var ge=document.createElement("p");ge.style.cssText="text-align:center;color:#dc2626;",ge.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",A&&A.replaceChildren(ge)}}finally{if(pr(!1),lr){var O=lr;ur(null),et(O.productId,O.settings,O.reviewsData,O.productName,O.orderBy,O.page,O.badgeSettings)}}}export{et as render};
