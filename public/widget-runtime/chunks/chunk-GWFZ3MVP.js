...
import{b as Ve}from"./chunk-Z7432DLE.js";import{a as he,b as qr,c as je,d as Kr}from"./chunk-DFR7URQP.js";import{$ as dr,A as Br,B as Mr,C as Fr,D as Hr,E as We,F as qe,G as Ke,M as Oe,N as _r,P as Or,Q as se,R as ve,S as Yr,T as ce,U as jr,V as Dr,W as ge,X as Ue,Y as V,Z as Xe,_ as Je,a as ue,aa as sr,b as fe,ba as ee,c as ke,ca as Vr,da as re,e as Sr,ea as Gr,f as Er,fa as Ye,g as de,ga as Wr,h as Tr,i as Ce,j as Se,k as Q,l as A,m as nr,n as Pe,p as or,q as Lr,r as Re,s as Ee,t as Ge,u as lr,v as Nr,w as Ar,x as Pr,y as Rr,z as Ir}from"./chunk-IL6PGN7C.js";var Ti=15,Li=60*1e3,Ur="__ikrReviewsFetchError",cr={};function Ze(e){return{type:Ur,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function pr(e){return!!(e&&e.type===Ur)}async function Te(e,r,i,t,n,l){if(window.__ikasPreviewMode){try{var c=window.__ikasPreviewBaseUrl||ke,o=c+"/api/preview/reviews?page="+encodeURIComponent(i||1),d=await he(o);if(d.ok)return await d.json()}catch(b){}return Ze()}r=r||"newest",i=i||1;var m=l?"_l"+l:"",k="ikr_reviews_"+fe+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(n?"1":"0")+m,s=null,a=Gr(k);if(a)try{var f=JSON.parse(a);if(f&&f.t!==void 0&&f.v){if(Date.now()-f.t<Li)return f.v;s=f.v,Ye(k,"")}else Ye(k,"")}catch(b){Ye(k,"")}try{var p=ke+"/api/public/reviews?storeId="+encodeURIComponent(fe)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(n?"&hasImages=true":"")+(l?"&limit="+encodeURIComponent(l):""),v=await he(p);if(!v.ok)return s||Ze();var u=await v.json();return Ye(k,JSON.stringify({t:Date.now(),v:u})),u}catch(b){return console.error("[ikr] fetchReviews error:",b),s||Ze()}}async function Ni(e){var r=await Te(e,"newest",1,null,!0,Ti);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function Pt(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!cr[e]){cr[e]=!0;var n={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},l={enabled:!0,size:"medium"};try{var c=await qr();if(!c)return;var o=c.widgets&&c.widgets.reviews||n,d=c.widgets&&c.widgets.badge||l;if(o.enabled===!1)return;Re("newest"),Ee(1),Ge(null);var m=await Promise.all([Te(e,"newest",1,null),Ni(e)]),k=m[0];Br(m[1]),await be(e,o,k,r,"newest",1,d)}catch(s){console.error("[ikr] bootstrap error:",s),await be(e,n,Ze(),r,void 0,void 0,l)}finally{delete cr[e]}}}function Ie(e){return ge(e)}function Ai(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,i,t){i?e.setProperty(r,i,t||""):e.removeProperty(r)}function Pi(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",i=navigator.maxTouchPoints||0,t=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&i>1;return t&&/AppleWebKit/i.test(r)}function Ri(){var e=Ai(),r=document.body.style,i=document.documentElement.style,t=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=Pi()&&!n;if(t>0){var c=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",c+t+"px","important")}return i.setProperty("overflow","hidden","important"),i.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important")),e}function Ii(e){if(e){var r=document.body.style,i=document.documentElement.style;ie(i,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(i,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}}function Bi(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function Be(e){if(!(!e||!document.contains(e)||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(i){}}}function Mi(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Jr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Mi)}function Zr(e){var r=Jr(e),i=r[0]||e.querySelector('[role="dialog"]')||e;Be(i)}function Fi(e,r){if(e.key==="Tab"){var i=Jr(r);if(!i.length){e.preventDefault(),Zr(r);return}var t=i[0],n=i[i.length-1],l=document.activeElement;if(!r.contains(l)){e.preventDefault(),Be(t);return}e.shiftKey&&l===t?(e.preventDefault(),Be(n)):!e.shiftKey&&l===n&&(e.preventDefault(),Be(t))}}function Hi(){var e={id:"ikr-modal-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state,history.pushState({ikrModal:e.id},"",e.url),e.pushed=!0}catch(r){}return e}function _i(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state.ikrModal===e.id)}function Oi(e){if(_i(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Xr(e,r,i,t,n){Ii(t),document.removeEventListener("keydown",r),window.removeEventListener("popstate",i),e.parentNode&&e.parentNode.removeChild(e),Be(n)}function Yi(e){var r=document.createElement("div");r.className="ikr-modal-right";var i=document.createElement("div");i.className="ikr-modal-scroll-content";var t=document.createElement("div");t.className="ikr-modal-top-row";var n=document.createElement("div");n.className="ikr-modal-stars",n.innerHTML=se(e.rating,A);var l=document.createElement("span");l.className="ikr-modal-date",l.textContent=ce(e.createdAt),t.appendChild(n),t.appendChild(l),i.appendChild(t);var c=document.createElement("div");c.className="ikr-modal-title",c.textContent=e.title||"",c.style.display=e.title?"":"none",i.appendChild(c);var o=document.createElement("div");o.className="ikr-modal-author",o.textContent=e.author||"",i.appendChild(o);var d=document.createElement("div");d.className="ikr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",i.appendChild(d);var m=document.createElement("div");m.className="ikr-modal-reply";var k=document.createElement("div");k.className="ikr-modal-reply-label",k.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var s=document.createElement("div");return s.className="ikr-modal-reply-text",s.textContent=e.merchantReply||"",m.appendChild(k),m.appendChild(s),m.style.display=e.merchantReply?"":"none",i.appendChild(m),r.appendChild(i),r}function $r(e,r,i){var t=i||A,n=e.querySelector(".ikr-modal-scroll-content"),l=n.querySelector(".ikr-modal-stars");l.innerHTML=se(r.rating,t),n.querySelector(".ikr-modal-date").textContent=ce(r.createdAt);var c=n.querySelector(".ikr-modal-title");c.textContent=r.title||"",c.style.display=r.title?"":"none",n.querySelector(".ikr-modal-author").textContent=r.author||"";var o=n.querySelector(".ikr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".ikr-modal-reply");d.querySelector(".ikr-modal-reply-label").textContent=t&&t.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".ikr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function ur(e,r,i,t,n,l,c,o,d){var m=Ie(e),k=Math.max(0,Math.min(i||0,m.length-1)),s=document.createElement("div");s.className="ikr-modal-left";var a=document.createElement("img"),f=c==="next"?"ikr-modal-img-enter-right":c==="prev"?"ikr-modal-img-enter-left":"";a.className="ikr-modal-main-img"+(f?" "+f:""),a.src=sr(m[k]||""),a.decoding="async",a.width=dr,a.height=Math.round(dr*4/3),a.alt="Yorum foto\u011Fraf\u0131",Vr(a,function(E){if(E.style.display="none",!s.querySelector(".ikr-modal-img-error")){var T=document.createElement("div");T.className="ikr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(T,E)}}),s.appendChild(a);var p=document.createElement("button");p.className="ikr-modal-close-mobile",p.textContent="\u2715",p.setAttribute("aria-label","Kapat"),p.onclick=function(E){E.stopPropagation(),l()},s.appendChild(p);var v=0;if(s.addEventListener("touchstart",function(E){v=E.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(E){var T=v-E.changedTouches[0].clientX;if(!(Math.abs(T)<50)){if(T>0){if(z)pe(e,r,k+1,t,n,l,!0,"next",o,d);else if(g){var h=t[r+1];pe(h,r+1,0,t,n,l,!1,"next",o,d)}}else if(b)pe(e,r,k-1,t,n,l,!0,"prev",o,d);else if(y){var N=t[r-1],L=Ie(N);pe(N,r-1,L.length-1,t,n,l,!1,"prev",o,d)}}},{passive:!0}),m.length>1){var u=document.createElement("div");u.className="ikr-modal-thumbs",m.forEach(function(E,T){var h=document.createElement("img"),N=ee(E,Je);h.src=N.src,h.srcset=N.srcset,h.loading="lazy",h.decoding="async",h.width=Je,h.height=Je,h.className="ikr-modal-thumb"+(T===k?" ikr-modal-thumb-active":""),h.alt="K\xFC\xE7\xFCk resim "+(T+1),re(h),h.tabIndex=0,h.setAttribute("role","button"),h.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(T+1)+" se\xE7"),T===k&&h.setAttribute("aria-current","true"),(function(L){function B(){pe(e,r,L,t,n,l,!0,null,o,d)}h.onclick=B,h.onkeydown=function(H){(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),B())}})(T),u.appendChild(h)}),s.appendChild(u)}var b=k>0,z=k<m.length-1,y=r>0,g=r<t.length-1,S=b||y,x=z||g;if(S){var C=document.createElement("button");C.className="ikr-modal-nav ikr-modal-nav-prev",C.innerHTML="&#8249;",C.setAttribute("aria-label","\xD6nceki"),C.onclick=function(E){if(E.stopPropagation(),b)pe(e,r,k-1,t,n,l,!0,"prev",o,d);else if(y){var T=t[r-1],h=Ie(T);pe(T,r-1,h.length-1,t,n,l,!1,"prev",o,d)}},s.appendChild(C)}if(x){var w=document.createElement("button");w.className="ikr-modal-nav ikr-modal-nav-next",w.innerHTML="&#8250;",w.setAttribute("aria-label","Sonraki"),w.onclick=function(E){if(E.stopPropagation(),z)pe(e,r,k+1,t,n,l,!0,"next",o,d);else if(g){var T=t[r+1];pe(T,r+1,0,t,n,l,!1,"next",o,d)}},s.appendChild(w)}return s}function Qr(e,r){[-1,1].forEach(function(i){var t=r[e+i];if(t){var n=Ie(t);n[0]&&(new Image().src=sr(n[0]))}})}function mr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function ji(e,r){var i=e&&e.querySelector(".ikr-modal-wrap"),t=r&&r.querySelector(".ikr-modal-right"),n=r&&r.querySelector(".ikr-modal-scroll-content");function l(){mr(i),mr(t),mr(n)}l(),i&&Be(i),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function pe(e,r,i,t,n,l,c,o,d,m){if(m&&(m.currentReview=e),c){var k=ur(e,r,i,t,n,l,o,d,m);n.firstChild&&n.replaceChild(k,n.firstChild)}else{var k=ur(e,r,i,t,n,l,o,d,m),s=n.querySelector(".ikr-modal-right");n.firstChild&&n.replaceChild(k,n.firstChild),s&&$r(s,e,m&&m.currentSettings),ji(d,n)}Qr(r,t)}function te(e,r,i){var t=Ie(e);if(!t.length)return;var n=(i||[]).filter(function(g){return Ie(g).length>0}),l=n.findIndex(function(g){return g===e||g.id===e.id});l===-1&&(n.unshift(e),l=0);var c=t.indexOf(r);c<0&&(c=0);var o=document.createElement("div");o.className="ikr-modal-overlay";var d=document.createElement("div");d.className="ikr-modal";var m=!1,k=Bi(),s=Ri(),a=Hi(),f={currentReview:e,currentSettings:A};function p(g){var S=g&&g.detail&&g.detail.settings;f.currentSettings=S||A;var x=d.querySelector(".ikr-modal-right");!x||!f.currentReview||$r(x,f.currentReview,f.currentSettings)}function v(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",p),Xr(o,u,v,s,k))}function u(g){if(g.key==="Escape"){b();return}Fi(g,o)}function b(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",p),Xr(o,u,v,s,k),Oi(a))}document.addEventListener("keydown",u),window.addEventListener("popstate",v),window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",p),o.onclick=function(){b()},d.onclick=function(g){g.stopPropagation()},d.appendChild(ur(e,l,c,n,d,b,null,o,f)),d.appendChild(Yi(e)),Qr(l,n);var z=document.createElement("div");z.className="ikr-modal-wrap",z.tabIndex=-1,z.setAttribute("role","dialog"),z.setAttribute("aria-modal","true"),z.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),z.appendChild(d);var y=document.createElement("button");y.className="ikr-modal-close",y.textContent="\u2715",y.setAttribute("aria-label","Kapat"),y.onclick=function(g){g.stopPropagation(),b()},z.appendChild(y),o.appendChild(z),document.body.appendChild(o),Zr(o)}function ei(e){if(e)for(var r=document.querySelectorAll("h1,h2,h3,h4,h5,h6,div,span,p"),i=0;i<r.length;i++){var t=r[i];if(t.children.length===0&&t.textContent.trim()===e&&t.tagName!=="TITLE"&&!t.closest("[data-ikr-listing-badge]")&&!t.closest("#ikas-reviews")&&!t.closest("nav")&&!t.closest("header")&&!t.closest('[class*="breadcrumb"]')&&!t.closest('[aria-label*="breadcrumb"]'))return t}return document.querySelector("h1")}var $e=null;function Di(e,r){return ve(e,r)}function fr(e,r,i,t,n,l){$e&&($e.disconnect(),$e=null);var c=document.getElementById("ikr-rating-badge");if(c&&c.remove(),!!e&&!(t&&t.enabled===!1)){var o=document.getElementById("ikr-jsonld");o&&o.remove();var d=document.createElement("script");d.id="ikr-jsonld",d.type="application/ld+json",d.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Product",name:i||document.title,url:window.location.href,aggregateRating:{"@type":"AggregateRating",ratingValue:e,reviewCount:r,bestRating:"5",worstRating:"1"}}),document.head.appendChild(d);var m=ei(i);if(!(!m||!m.parentNode)){var k=t&&t.size||"medium",s=je[k]||je.medium,a=null;if(t&&t.mobileOverride===!0){var f=t.mobileSize||"small";a=je[f]||je.small}Kr(s,a);var p=document.createElement("a");p.id="ikr-rating-badge",p.className="ikr-rating-badge ikr-rating-badge--pdp",p.href="#ikas-reviews",p.setAttribute("role","figure"),p.setAttribute("aria-label",e+" \xFCzerinden 5 y\u0131ld\u0131z, "+r+" yorum"),p.setAttribute("data-ikr-surface","pdp"),p.setAttribute("data-ikr-rating",String(e)),p.setAttribute("data-ikr-count",String(r));var v=window.getComputedStyle(m).textAlign,u=v==="center"?"center":v==="right"?"flex-end":"flex-start";p.style.cssText="justify-content:"+u+";",p.insertAdjacentHTML("beforeend",Di(e,n));var b=document.createElement("span");b.className="ikr-rating-badge__label",b.textContent=e+" ("+r+" yorum)",p.appendChild(b),p.onclick=function(z){z.preventDefault();var y=document.getElementById("ikas-reviews-widget")||document.getElementById("ikas-reviews");if(y){var g=document.querySelector("header"),S=g?g.getBoundingClientRect().height:0,x=y.getBoundingClientRect().top+window.pageYOffset-S-16;window.scrollTo({top:x,behavior:"smooth"})}},m.parentNode.insertBefore(p,m.nextSibling),Sr(p,"pdp-badge",{productName:i||""}),l||($e=Er(p,"pdp-badge",function(){fr(e,r,i,t,n,!0)},{productName:i||""}))}}}var ri=`
...
`;var gr={};ue(gr,{meta:()=>$i,render:()=>Qi});function Me(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,n=e.currentRatingFilter,l=e.onFilterChange,c=document.createElement("div");c.className="ikr-summary-block ikr-summary-bars";for(var o=5;o>=1;o--){var d=r[o-1]||0,m=i>0?Math.round(d/i*100):0,k=n===o,s=document.createElement("div");s.className="ikr-bar-row"+(k?" ikr-bar-active":""),n&&!k&&(s.style.opacity="0.35");for(var a="",f=1;f<=5;f++){var p=f<=o;a+='<span class="ikr-bar-star ikr-icon '+(p?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(p?t.filled:t.empty)+"</span>"}s.innerHTML='<span class="ikr-bar-label">'+a+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+m+'%;"></div></div><span class="ikr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(v){s.onclick=function(){l(v)}})(o),c.appendChild(s)}return c}var ae=[],ii=!1;function Vi(e){for(var r=ae.length-1;r>=0;r--){var i=ae[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function Gi(e){if(e.key==="Escape")for(var r=ae.length-1;r>=0;r--)ae[r].close()}function Wi(){ii||typeof document=="undefined"||(document.addEventListener("click",Vi,!0),document.addEventListener("keydown",Gi),ii=!0)}function Qe(e){for(var r=0;r<ae.length;r++)ae[r]!==e&&ae[r].close()}function er(e){Wi();var r={trigger:e.trigger,element:e.element,close:e.close};return ae.push(r),function(){var t=ae.indexOf(r);t!==-1&&ae.splice(t,1)}}function U(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,n=e.onWriteClick,l=e.onSortChange,c=document.createElement("div");c.className="ikr-summary-block ikr-summary-actions";var o=document.createElement("button");o.className="ikr-write-btn",o.textContent=A&&A.writeButtonText||"Yorum Yap",o.onclick=n,c.appendChild(o);var d=document.createElement("div");d.className="ikr-filter-wrap";var m=document.createElement("button");m.type="button",m.className="ikr-filter-btn",m.setAttribute("aria-label","Filtrele"),m.setAttribute("aria-haspopup","menu"),m.setAttribute("aria-expanded","false");var k=A&&A.filterIcon||"lines";m.innerHTML=_r(k);var s=document.createElement("div");s.className="ikr-filter-menu",s.setAttribute("role","menu");var a=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function f(u){var b=s.classList.contains("ikr-open");s.classList.remove("ikr-open"),m.classList.remove("ikr-filter-btn-active"),m.setAttribute("aria-expanded","false");var z=u&&(u.restoreFocus===!0||u.restoreFocus==="auto"&&Ve());if(b&&z)try{m.focus({preventScroll:!0})}catch(y){try{m.focus()}catch(g){}}}function p(){Qe(v),s.classList.add("ikr-open"),m.classList.add("ikr-filter-btn-active"),m.setAttribute("aria-expanded","true");var u=s.querySelector(".ikr-filter-item-active")||s.querySelector(".ikr-filter-item");u&&requestAnimationFrame(function(){try{u.focus({preventScroll:!0})}catch(b){try{u.focus()}catch(z){}}})}a.forEach(function(u){var b=u[2],z=b?t:!t&&(i||"newest")===u[0],y=document.createElement("button");y.type="button",y.className="ikr-filter-item"+(z?" ikr-filter-item-active":""),y.setAttribute("role","menuitem"),y.textContent=u[1],y.onclick=function(){f({restoreFocus:"auto"}),l(u[0],b)},s.appendChild(y)}),m.onclick=function(){s.classList.contains("ikr-open")?f({restoreFocus:"auto"}):p()},d.addEventListener("keydown",function(u){u.key==="Escape"&&s.classList.contains("ikr-open")&&(u.stopPropagation(),f({restoreFocus:!0}))}),d.addEventListener("focusout",function(u){if(s.classList.contains("ikr-open")){var b=u.relatedTarget;b&&d.contains(b)||f()}});var v=er({trigger:d,element:s,close:f});return d.appendChild(m),d.appendChild(s),c.appendChild(d),c}function ti(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.tabIndex=-1,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="ikr-fwizard",t.appendChild(n);var l=document.createElement("button");l.className="ikr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat"),l.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',n.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-content",n.appendChild(c);var o=!1,d=null,m=!1,k="",s="";function a(){var h=document.activeElement;return!h||h===document.body||h===document.documentElement?null:h}function f(h){if(!(!h||!document.contains(h)||typeof h.focus!="function"))try{h.focus({preventScroll:!0})}catch(N){try{h.focus()}catch(L){}}}function p(h){if(!h||h.disabled||h.getAttribute("aria-hidden")==="true")return!1;var N=window.getComputedStyle?window.getComputedStyle(h):null;return N&&(N.display==="none"||N.visibility==="hidden")?!1:!!(h.offsetWidth||h.offsetHeight||h.getClientRects().length)}function v(h){var N=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(h.querySelectorAll(N)).filter(p)}function u(){var h=v(c),N=v(t),L=h[0]||N[0]||t;f(L)}function b(h){if(h.key==="Tab"){var N=v(t);if(!N.length){h.preventDefault(),f(t);return}var L=N[0],B=N[N.length-1],H=document.activeElement;if(!t.contains(H)){h.preventDefault(),f(L);return}h.shiftKey&&H===L?(h.preventDefault(),f(B)):!h.shiftKey&&H===B&&(h.preventDefault(),f(L))}}function z(){var h=window.innerWidth-document.documentElement.clientWidth;k=document.body.style.overflow,s=document.body.style.paddingRight,document.body.style.overflow="hidden",h>0&&(document.body.style.paddingRight=h+"px")}function y(){document.body.style.overflow=k,document.body.style.paddingRight=s}function g(){o||(o=!0,document.removeEventListener("keydown",S),t.removeEventListener("click",x),l.removeEventListener("click",g),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),y(),m&&f(d);try{r()}catch(h){}},200))}function S(h){if(h.key==="Escape"){g();return}b(h)}function x(h){h.target===t&&i&&g()}document.addEventListener("keydown",S),t.addEventListener("click",x),l.addEventListener("click",g);function C(h){d=a(),m=Ve(),h&&c.appendChild(h),document.body.appendChild(t),z(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open"),u()})}var w=null,E=null;function T(h,N){if(N=N||"error",w){try{w.remove()}catch(L){}w=null}E&&(clearTimeout(E),E=null),w=document.createElement("div"),w.className="ikr-fwizard-toast ikr-fwizard-toast--"+N,w.textContent=h,n.appendChild(w),E=setTimeout(function(){w&&(w.classList.add("ikr-fwizard-toast--exit"),setTimeout(function(){if(w){try{w.remove()}catch(L){}w=null}},300))},4e3)}return{open:C,close:g,content:c,setAllowOutsideClose:function(h){i=!!h},setStepAttr:function(h){n.setAttribute("data-step",String(h))},focusFirstControl:u,showToast:T}}var ai=`
...
`;var kr=4;function Fe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function ni(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function t(){r.forEach(function(n){try{n(i)}catch(l){}})}return{get:function(){return i},set:function(n){Object.assign(i,n),t()},goNext:function(){i.currentStep<kr&&(i.currentStep+=1,t())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,t())},onChange:function(n){return r.push(n),function(){r=r.filter(function(l){return l!==n})}}}}var qi='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function oi(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],t=e.onBack||function(){},n=e.onSkip||function(){},l=e.onNext||function(){},c=document.createElement("div");c.className="ikr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=qi+"<span>Geri</span>",o.addEventListener("click",function(){t()}),c.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-footer-progress";for(var m=[],k=0;k<kr;k++){var s=document.createElement("span");s.className="ikr-fwizard-progress-seg",d.appendChild(s),m.push(s)}c.appendChild(d);var a=document.createElement("button");a.type="button";var f=null;function p(u){f&&a.removeEventListener("click",f),f=u,u&&a.addEventListener("click",u)}c.appendChild(a);function v(u,b){var z=r.indexOf(u)!==-1,y=i.indexOf(u)!==-1,g=b&&(b.images&&b.images.length>0||b.pendingImages&&b.pendingImages.length>0);if(z)u===2&&g?(a.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",a.setAttribute("aria-label","Devam Et"),a.innerHTML="Devam Et",p(function(){l()})):(a.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",a.setAttribute("aria-label","Atla"),a.innerHTML="<span>Atla</span>",p(function(){n()})),a.disabled=!1,a.classList.remove("ikr-fwizard-cta-btn--disabled"),a.style.visibility="",a.tabIndex=0;else if(y){a.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",a.setAttribute("aria-label","Sonraki"),a.innerHTML="Sonraki",a.style.visibility="",a.tabIndex=0;var S=Fe(u,b);a.disabled=!S,a.classList.toggle("ikr-fwizard-cta-btn--disabled",!S),p(function(){a.disabled||l()})}else a.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",a.innerHTML="",a.style.visibility="hidden",a.tabIndex=-1,a.disabled=!0,p(null)}return{el:c,update:function(u,b){m.forEach(function(y,g){g+1<=u?y.classList.add("ikr-fwizard-progress-seg-active"):y.classList.remove("ikr-fwizard-progress-seg-active")});var z=u<=1;o.style.visibility=z?"hidden":"",o.style.pointerEvents=z?"none":"",o.tabIndex=z?-1:0,v(u,b)},setNextDisabled:function(u){a.classList.contains("ikr-fwizard-cta-btn")&&(a.disabled=!!u,a.classList.toggle("ikr-fwizard-cta-btn--disabled",!!u))},setThanksState:function(u){o.style.visibility="hidden",d.style.visibility="hidden",a.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",a.setAttribute("aria-label","Devam Et"),a.innerHTML="Devam Et",a.style.visibility="",a.disabled=!1,a.classList.remove("ikr-fwizard-cta-btn--disabled"),p(u)}}}function li(e,r){r=r||{};var i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-rating";var t=!1,n=document.createElement("div");n.className="ikr-fwizard-step-title",n.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",i.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-stars",l.setAttribute("role","radiogroup"),l.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var c=Oe(A||{}),o=[];function d(s){o.forEach(function(a,f){var p=f<s;a.classList.toggle("ikr-fwizard-star-active",p),a.setAttribute("aria-checked",f+1===s?"true":"false"),a.innerHTML=p?c.filled:c.empty})}for(var m=1;m<=5;m++)(function(s){var a=document.createElement("button");a.type="button",a.className="ikr-fwizard-star",a.setAttribute("role","radio"),a.setAttribute("aria-label",s+" y\u0131ld\u0131z"),a.innerHTML=c.empty,a.addEventListener("mouseenter",function(){d(s)}),a.addEventListener("mouseleave",function(){d(e.get().rating)}),a.addEventListener("click",function(){t||(t=!0,e.set({rating:s}),d(s),setTimeout(function(){var f=!r.canNavigate||r.canNavigate();f&&e.goNext()},400))}),o.push(a),l.appendChild(a)})(m);d(e.get().rating);var k=function(s){var a=s&&s.detail&&s.detail.settings;c=Oe(a||A||{}),d(e.get().rating)};return window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",k),i.appendChild(l),{el:i,destroy:function(){window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",k)}}}var di=3,Ki=10*1024*1024;function si(e,r){r=r||{};var i=!1,t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-photos";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",t.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",t.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle"),o.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",c.appendChild(o),c.appendChild(d);var m=document.createElement("div");m.className="ikr-fwizard-photo-previews",m.setAttribute("aria-live","polite"),c.appendChild(m),t.appendChild(c);var k=r.blobMap||{},s=r.urlToFinger||{};function a(){if(!i){var y=e.get().images||[],g=e.get().pendingImages||[],S=y.map(function(x){return{url:x,isPending:!1}}).concat(g.map(function(x){return{url:x.url,file:x.file,isPending:!0,error:x.error}}));m.innerHTML="",S.forEach(function(x){var C=k[x.url]||x.url,w=f(x,C);m.appendChild(w)}),b()}}function f(y,g){var S=document.createElement("div");S.className="ikr-fwizard-photo-thumb";var x=document.createElement("img");x.src=g,x.alt="",x.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",S.appendChild(x);var C=document.createElement("div");C.className="ikr-fwizard-photo-loading",C.style.display="none",S.appendChild(C);var w=document.createElement("button");return w.type="button",w.className="ikr-fwizard-photo-remove",w.innerHTML="&#x2715;",S.appendChild(w),p(S,y,g),S}function p(y,g,S){var x=y.querySelector("img");x.src!==S&&(x.src=S);var C=y.querySelector(".ikr-fwizard-photo-loading");g.isPending&&g.error?(C.style.display="flex",C.innerHTML='<span class="ikr-upload-error">\u2717 '+g.error+"</span>"):C.style.display="none";var w=y.querySelector(".ikr-fwizard-photo-remove");w.onclick=function(){var E=s[g.url]||(g.file?g.file.name+"_"+g.file.size:null);if(g.url.startsWith("blob:")&&URL.revokeObjectURL(g.url),E){var T=(e.get().fingerprints||[]).filter(function(L){return L!==E});e.set({fingerprints:T})}if(g.isPending){var h=(e.get().pendingImages||[]).filter(function(L){return L.url!==g.url});e.set({pendingImages:h})}else{var N=(e.get().images||[]).filter(function(L){return L!==g.url});e.set({images:N})}}}var v='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',u='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function b(){var y=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,S=y+g,x=S>=di;S>0?(c.classList.add("ikr-fwizard-photo-card--compact"),o.innerHTML=u):(c.classList.remove("ikr-fwizard-photo-card--compact"),o.innerHTML=v+"<span>Foto\u011Fraf Ekle</span>"),x?(o.style.display="none",o.disabled=!0,d.disabled=!0):(o.style.display="flex",o.disabled=!1,d.disabled=!1,o.classList.remove("ikr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(y){var g=(e.get().images||[]).length+(e.get().pendingImages||[]).length,S=Array.from(y.target.files).slice(0,di-g);d.value="";var x=(e.get().pendingImages||[]).length,C=e.get().images||[],w=C.length;if(S.length!==0){for(var E=[],T=[],h=0;h<S.length;h++){var N=S[h],L=N.name+"_"+N.size,B=(e.get().fingerprints||[]).some(function(F){return F===L})||E.some(function(F){return F.file.name+"_"+F.file.size===L});if(B){console.log("[ikr] Duplicate file detected, skipping:",N.name);continue}if(N.size>Ki){var H="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(H,"error"):alert(H);continue}var G=URL.createObjectURL(N);s[G]=L,E.push({url:G,file:N,error:null}),T.push({url:G,file:N});var ne=(e.get().fingerprints||[]).slice();ne.push(L),e.set({fingerprints:ne})}if(E.length!==0){var oe=(e.get().pendingImages||[]).concat(E),W=async function(){for(var F=0;F<T.length;F++){var Ne=T[F],le=Ne.file,D=Ne.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var me=(e.get().pendingImages||[]).filter(function(j){return j.url!==D}),Ae=(e.get().images||[]).slice();Ae.push(D),e.set({pendingImages:me,images:Ae});continue}try{var q=await he(ke+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:fe})});if(!q.ok)throw q.status===429?new Error("rate_limit"):new Error("sign failed");var K=await q.json();if(!K.folder)throw new Error("sign folder missing");var Y=new FormData;Y.append("file",le),Y.append("api_key",K.api_key),Y.append("timestamp",K.timestamp),Y.append("signature",K.signature),Y.append("folder",K.folder);var _e=await fetch("https://api.cloudinary.com/v1_1/"+K.cloud_name+"/image/upload",{method:"POST",body:Y}),X=await _e.json();if(X.secure_url&&Dr(X.secure_url)){var ye=(e.get().pendingImages||[]).some(function(j){return j.url===D});if(!ye){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}k[X.secure_url]=D,s[X.secure_url]=s[D];var J=(e.get().pendingImages||[]).filter(function(j){return j.url!==D}),Z=(e.get().images||[]).slice();Z.push(X.secure_url),e.set({pendingImages:J,images:Z});try{he(ke+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:fe,secureUrl:X.secure_url})}).catch(function(){})}catch(j){}}else throw new Error("invalid image url")}catch(j){console.error("[ikr] Image upload failed:",j);var $=j.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast($,"error");var we=(e.get().pendingImages||[]).map(function(I){return I.url===D?{url:I.url,file:I.file,error:$}:I});e.set({pendingImages:we})}}};if(w===0&&x===0){i=!0;var O=!r.canNavigate||r.canNavigate();O&&e.goNext()}e.set({pendingImages:oe}),W()}}};var z=e.onChange(a);return a(),{el:t,destroy:function(){i=!0,d.onchange=null,z&&z()}}}var vr=2e3,Ui=60;function ci(e,r){r=r||{};var i=r.onValidityChange||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-content";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",t.appendChild(n);var l=document.createElement("div");l.className="ikr-fwizard-content-form";var c=document.createElement("input");c.type="text",c.className="ikr-fwizard-input",c.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",c.maxLength=Ui,c.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),c.value=e.get().title||"",c.addEventListener("input",function(){e.set({title:c.value})}),l.appendChild(c);var o=document.createElement("textarea");o.className="ikr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=vr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",l.appendChild(o);var d=document.createElement("div");d.className="ikr-fwizard-char-counter",d.setAttribute("aria-live","polite"),l.appendChild(d);function m(){var s=o.value.length;d.textContent=s+"/"+vr,d.classList.toggle("ikr-fwizard-char-counter--max",s>=vr)}function k(){return Fe(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),m(),i(k())}),t.appendChild(l),m(),setTimeout(function(){i(k())},0),{el:t,destroy:function(){}}}var Xi=40;function pi(e,r){r=r||{};var i=r.onValidityChange||function(){},t=r.onSuccess||function(){},n=document.createElement("div");n.className="ikr-fwizard-step ikr-fwizard-step-author";var l=document.createElement("div");l.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",n.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-author-form";var o=document.createElement("div");o.className="ikr-fwizard-field";var d=document.createElement("label");d.className="ikr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var m=document.createElement("input");m.type="text",m.className="ikr-fwizard-input",m.maxLength=Xi,m.setAttribute("aria-required","true"),m.value=e.get().author||"",o.appendChild(d),o.appendChild(m),c.appendChild(o);var k=document.createElement("div");k.className="ikr-fwizard-field";var s=document.createElement("label");s.className="ikr-fwizard-label",s.textContent="E-posta (opsiyonel)";var a=document.createElement("input");a.type="email",a.className="ikr-fwizard-input",a.setAttribute("autocomplete","email"),a.value=e.get().email||"",k.appendChild(s),k.appendChild(a),c.appendChild(k);var f=document.createElement("div");f.className="ikr-fwizard-notice",f.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",c.appendChild(f);var p=document.createElement("div");p.className="ikr-fwizard-msg",p.setAttribute("role","alert"),p.setAttribute("aria-live","assertive"),c.appendChild(p);var v=document.createElement("button");v.type="button",v.className="ikr-fwizard-submit-btn",v.textContent="G\xF6nder",c.appendChild(v),n.appendChild(c);function u(){return Fe(4,e.get())}function b(){var y=!u(),g=(e.get().pendingImages||[]).length,S=g>0;S?(v.disabled=!0,v.classList.add("ikr-fwizard-submit-btn--disabled"),v.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=y,v.classList.toggle("ikr-fwizard-submit-btn--disabled",y),v.textContent="G\xF6nder")}m.addEventListener("input",function(){e.set({author:m.value}),b(),i(u())}),a.addEventListener("input",function(){e.set({email:a.value})}),b(),setTimeout(function(){i(u())},0),v.onclick=async function(){if(!v.disabled){var y=e.get(),g=(y.author||"").trim(),S=(y.comment||"").trim();if(a.value.trim()&&!a.checkValidity()){a.reportValidity();return}if(!g){p.innerHTML='<div class="ikr-fwizard-msg-error">Gerekli alan</div>';return}if(!y.rating){p.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}v.disabled=!0,v.classList.add("ikr-fwizard-submit-btn--disabled");var x=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",p.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){t()},600);return}try{var C=Or(window.location.href),w=y.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),E=await he(ke+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:fe,productId:y.productId||null,slug:C||null,productName:w,author:g,title:(y.title||"").trim()||null,comment:S||null,rating:y.rating,images:y.images||[]})},15e3);if(E.ok)t();else{var T=await E.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(L){var h=L&&(L.name==="AbortError"||/signal/i.test(L.message||"")),N=h?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":L.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(N,"error"):p.innerHTML='<div class="ikr-fwizard-msg-error">'+N+"</div>",v.disabled=!1,v.classList.remove("ikr-fwizard-submit-btn--disabled"),v.textContent=x}}};var z=e.onChange(b);return{el:n,destroy:function(){v.onclick=null,z&&z()}}}var mi=!1;function Ji(){if(!mi){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=ai,document.head.appendChild(e),mi=!0}}function Zi(e,r,i){if(i=i||{},e===1)return li(r,{canNavigate:i.canNavigate});if(e===2)return si(r,{canNavigate:i.canNavigate,blobMap:i.blobMap,urlToFinger:i.urlToFinger,showToast:i.showToast});if(e===3)return ci(r,{onValidityChange:i.onValidityChange});if(e===4)return pi(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess,showToast:i.showToast});var t=document.createElement("div");return t.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:t,destroy:function(){}}}function ui(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function fi(e){e=e||{},Ji();var r=ni({productId:e.productId,productName:e.productName}),i={},t={},n=ti({onClose:function(){window.removeEventListener("popstate",c),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(i).forEach(function(x){var C=i[x];C&&C.startsWith("blob:")&&URL.revokeObjectURL(C)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),l={ikrReviewModal:!0};window.history.pushState(l,null,"");var c=function(x){n&&n.close&&n.close()};window.addEventListener("popstate",c);var o=document.createElement("div");o.className="ikr-fwizard-step-wrap";var d=oi({skippableSteps:[2],nextableSteps:[3],onBack:function(){s==="idle"&&r.goBack()},onSkip:function(){s==="idle"&&r.goNext()},onNext:function(){s==="idle"&&r.goNext()}}),m=document.createElement("div");m.className="ikr-fwizard-layout",m.appendChild(o),m.appendChild(d.el);var k=null,s="idle",a=null,f=!0,p=null;function v(x,C){o.innerHTML="";var w=Zi(x,r,{canNavigate:function(){return s==="idle"},blobMap:i,urlToFinger:t,onValidityChange:function(h){d.setNextDisabled(!h)},onSuccess:b,showToast:n.showToast});if(k=w,d.update(x,r.get()),C){s="entering",w.el.classList.add("ikr-fwizard-step--enter");var E=null,T=function(){E&&clearTimeout(E),w.el.removeEventListener("animationend",T),w.el.classList.remove("ikr-fwizard-step--enter"),s="idle",a!==null&&z()};w.el.addEventListener("animationend",T),E=setTimeout(T,700)}else s="idle";o.appendChild(w.el),n.setStepAttr&&n.setStepAttr(x),x===3&&d.setNextDisabled(!0)}var u=!1;function b(){if(!u){if(u=!0,!k){o.innerHTML="";var x=ui();x.classList.add("ikr-fwizard-step--enter"),o.appendChild(x),n.setStepAttr("thanks"),d.setThanksState(n.close);return}var C=k;s="exiting",C.el.classList.add("ikr-fwizard-step--exit");var w=function(){if(p&&clearTimeout(p),C.el.removeEventListener("animationend",w),C.destroy)try{C.destroy()}catch(T){}k===C&&(k=null),o.innerHTML="";var E=ui();E.classList.add("ikr-fwizard-step--enter"),o.appendChild(E),n.setStepAttr("thanks"),d.setThanksState(n.close),s="idle"};C.el.addEventListener("animationend",w),p=setTimeout(w,300)}}function z(){var x=r.get().currentStep;if(s!=="idle"){a=x;return}if(!k){var C=!f;f=!1,v(x,C);return}var w=k;s="exiting",w.el.classList.add("ikr-fwizard-step--exit");var E=function(){if(p&&clearTimeout(p),w.el.removeEventListener("animationend",E),w.destroy)try{w.destroy()}catch(h){}if(k===w){o.innerHTML="",k=null;var T=a!==null?a:r.get().currentStep;a=null,v(T,!0),s="idle"}};w.el.addEventListener("animationend",E),p=setTimeout(E,350)}z();var y=r.get().currentStep,g=r.onChange(function(x){x.currentStep!==y?(y=x.currentStep,z()):d.update(x.currentStep,x)}),S=n.close;return n.close=function(){g&&g(),typeof p!="undefined"&&p&&clearTimeout(p),S()},n.open(m),{close:n.close}}function _(){fi({productId:Q||"",productName:Pe||""})}var $i={id:"classic",name:"Klasik (A\xE7\u0131k)"};function Qi(e){var r=e.widget,i=e.data,t=e.settings,n=e.iconPair,l=e.allCount,c=e.ratingCounts,o=e.avgRatingVal,d=e.currentRatingFilter,m=e.currentOrderBy,k=e.currentHasImages,s=e.onFilterChange,a=e.onSortChange,f=document.createElement("div");f.className="ikr-summary";var p=(c[3]||0)+(c[4]||0),v=l>0?Math.round(p/l*100):0,u=document.createElement("div");u.className="ikr-summary-block ikr-summary-avg",u.innerHTML='<span class="ikr-avg-star ikr-icon">'+n.filled+'</span><span class="ikr-avg-num">'+o+"</span>",f.appendChild(u);var b=document.createElement("div");if(b.className="ikr-summary-block ikr-summary-count",b.textContent=l.toLocaleString("tr-TR")+" Yorum",f.appendChild(b),t.showRecommendation!==!1&&v>0){var z=document.createElement("div");z.className="ikr-summary-block ikr-summary-recommend",z.innerHTML='<span class="ikr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",f.appendChild(z)}return f.appendChild(Me({ratingCounts:c,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:s})),f.appendChild(U({widget:r,currentOrderBy:m,currentHasImages:k,onWriteClick:_,onSortChange:a})),f}var hr={};ue(hr,{css:()=>rt,meta:()=>et,render:()=>it});var ki=`
...
`;var et={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},rt=ki;function it(e){var r=e.widget,i=e.settings,t=e.iconPair,n=e.allCount,l=e.ratingCounts,c=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,m=e.currentHasImages,k=e.onFilterChange,s=e.onSortChange,a=document.createElement("div");a.className="ikr-summary ikr-summary-compact";var f=document.createElement("div");f.className="ikr-compact-header";var p=document.createElement("div");p.className="ikr-compact-trigger-wrap";var v=document.createElement("button");v.className="ikr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="ikr-compact-trigger-stars">'+ve(c,t)+'</span><span class="ikr-compact-trigger-text">'+n.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',p.appendChild(v),f.appendChild(p);var u=U({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:_,onSortChange:s}),b=u.querySelector(".ikr-filter-wrap"),z=u.querySelector(".ikr-write-btn"),y=document.createElement("div");y.className="ikr-compact-actions-slot",z&&y.appendChild(z),b&&y.appendChild(b),f.appendChild(y),a.appendChild(f);var g=document.createElement("div");g.className="ikr-compact-panel",g.setAttribute("role","dialog"),g.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="ikr-compact-panel-inner";var x=document.createElement("div");x.className="ikr-compact-avg",x.innerHTML='<span class="ikr-icon">'+t.filled+"</span><span>"+c+"</span>",S.appendChild(x),S.appendChild(Me({ratingCounts:l,allCount:n,iconPair:t,currentRatingFilter:o,onFilterChange:k})),g.appendChild(S);var C=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(O){var F=O?a:p;g.parentNode!==F&&(g.classList.contains("ikr-open")&&(g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),F.appendChild(g))}if(w(C?C.matches:!1),C){var E=function(O){w(O.matches)};C.addEventListener?C.addEventListener("change",E):C.addListener&&C.addListener(E)}if(z){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent=A&&A.writeButtonText||"Yorum Yap",T.onclick=_;var h=document.createElement("div");h.className="ikr-compact-write-row",h.appendChild(T),a.appendChild(h)}function N(){g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function L(){Qe(B),g.classList.add("ikr-open"),g.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){g.classList.contains("ikr-open")?N():L()};var B=null;function H(O){B&&(B(),B=null),O||(B=er({trigger:p,element:g,close:N}))}if(H(C?C.matches:!1),C){var G=function(O){H(O.matches)};C.addEventListener?C.addEventListener("change",G):C.addListener&&C.addListener(G)}if(i.showRecommendation!==!1){var ne=(l[3]||0)+(l[4]||0),oe=n>0?Math.round(ne/n*100):0;if(oe>0){var W=document.createElement("div");W.className="ikr-summary-block ikr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="ikr-recommend-pct">%'+oe+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild(W)}}return a}var br={};ue(br,{css:()=>at,meta:()=>tt,render:()=>nt});var vi=`
...
`;var tt={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},at=vi;function nt(e){var r=e.widget,i=e.settings,t=e.iconPair,n=e.allCount,l=e.ratingCounts,c=e.avgRatingVal,o=e.currentRatingFilter,d=e.currentOrderBy,m=e.currentHasImages,k=e.onFilterChange,s=e.onSortChange,a=document.createElement("div");a.className="ikr-summary ikr-summary-split";var f=document.createElement("div");f.className="ikr-split-col ikr-split-left";var p=document.createElement("div");p.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",p.innerHTML='<span class="ikr-avg-star ikr-icon">'+t.filled+'</span><span class="ikr-avg-num">'+c+"</span>",f.appendChild(p);var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-count ikr-split-left-count",v.textContent=n.toLocaleString("tr-TR")+" Yorum",f.appendChild(v),a.appendChild(f);var u=document.createElement("div");u.className="ikr-split-col ikr-split-mid",u.appendChild(Me({ratingCounts:l,allCount:n,iconPair:t,currentRatingFilter:o,onFilterChange:k})),a.appendChild(u);var b=U({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:_,onSortChange:s}),z=b.querySelector(".ikr-filter-wrap"),y=b.querySelector(".ikr-write-btn"),g=document.createElement("div");g.className="ikr-split-col ikr-split-right",y&&g.appendChild(y),z&&g.appendChild(z),a.appendChild(g);var S=(l[3]||0)+(l[4]||0),x=n>0?Math.round(S/n*100):0,C=document.createElement("div");C.className="ikr-summary-block ikr-summary-recommend",C.innerHTML='<span class="ikr-recommend-pct">%'+x+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var w=i.showRecommendation===!1||x===0;return w&&C.classList.add("ikr-split-rec-hidden"),f.appendChild(C),a}var yr={};ue(yr,{css:()=>lt,meta:()=>ot,render:()=>dt});var gi=`
...
`;var ot={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},lt=gi;function dt(e){var r=e.widget,i=e.iconPair,t=e.allCount,n=e.avgRatingVal,l=e.currentOrderBy,c=e.currentHasImages,o=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-minimal";var m=document.createElement("div");m.className="ikr-minimal-info";var k=document.createElement("div");k.className="ikr-minimal-row";var s=document.createElement("span");s.className="ikr-minimal-avg",s.textContent=n,k.appendChild(s);var a=document.createElement("span");a.className="ikr-minimal-stars",a.innerHTML=ve(n,i),k.appendChild(a);var f=document.createElement("span");f.className="ikr-minimal-count",f.textContent=t.toLocaleString("tr-TR")+" Yorum",k.appendChild(f),m.appendChild(k),d.appendChild(m);var p=U({widget:r,currentOrderBy:l,currentHasImages:c,onWriteClick:_,onSortChange:o}),v=p.querySelector(".ikr-filter-wrap"),u=p.querySelector(".ikr-write-btn"),b=document.createElement("div");if(b.className="ikr-minimal-actions",u&&b.appendChild(u),v&&b.appendChild(v),d.appendChild(b),u){var z=document.createElement("button");z.className="ikr-write-btn",z.textContent=A&&A.writeButtonText||"Yorum Yap",z.onclick=_;var y=document.createElement("div");y.className="ikr-minimal-write-row",y.appendChild(z),d.appendChild(y)}return d}var wr={};ue(wr,{css:()=>ct,meta:()=>st,render:()=>pt});var hi=`
...
`;var st={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},ct=hi;function pt(e){var r=e.widget,i=e.iconPair,t=e.allCount,n=e.avgRatingVal,l=e.currentOrderBy,c=e.currentHasImages,o=e.onSortChange,d=document.createElement("div");d.className="ikr-summary ikr-summary-hero";var m=document.createElement("div");m.className="ikr-hero-info";var k=document.createElement("div");k.className="ikr-hero-rating-col";var s=document.createElement("span");s.className="ikr-hero-avg",s.textContent=n,k.appendChild(s);var a=document.createElement("div");a.className="ikr-hero-meta-row";var f=document.createElement("span");f.className="ikr-hero-stars",f.innerHTML=ve(n,i),a.appendChild(f);var p=document.createElement("div");p.className="ikr-hero-count",p.textContent=t.toLocaleString("tr-TR")+" Yorum",a.appendChild(p),k.appendChild(a),m.appendChild(k),d.appendChild(m);var v=U({widget:r,currentOrderBy:l,currentHasImages:c,onWriteClick:_,onSortChange:o}),u=v.querySelector(".ikr-filter-wrap"),b=v.querySelector(".ikr-write-btn"),z=document.createElement("div");z.className="ikr-hero-actions ikr-desktop-only",b&&z.appendChild(b),u&&z.appendChild(u),d.appendChild(z);var y=U({widget:r,currentOrderBy:l,currentHasImages:c,onWriteClick:_,onSortChange:o}),g=y.querySelector(".ikr-filter-wrap"),S=y.querySelector(".ikr-write-btn"),x=document.createElement("div");return x.className="ikr-hero-write-row",S&&x.appendChild(S),g&&x.appendChild(g),d.appendChild(x),d}var rr={classic:gr,compact:hr,split:br,minimal:yr,hero:wr};function ir(e){return rr[e]||rr.classic}function bi(){return Object.keys(rr).map(function(e){return rr[e].css||""}).join(`
`)}var xr={};ue(xr,{css:()=>ut,meta:()=>mt,render:()=>ft});function He(e,r){if(!e)return null;var i=document.createElement("div");i.className="ikr-reply";var t=document.createElement("div");t.className="ikr-reply-header";var n=document.createElement("span");n.className="ikr-reply-label",n.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi",t.appendChild(n),i.appendChild(t);var l=document.createElement("div");l.className="ikr-reply-text ikr-reply-text-clamped",l.textContent=e,i.appendChild(l);var c=document.createElement("span");return c.className="ikr-read-more ikr-reply-read-more",c.textContent="Devam\u0131n\u0131 oku",c.style.display="none",i.appendChild(c),requestAnimationFrame(function(){if(l.scrollHeight>l.clientHeight+2)if(c.style.display="inline",typeof r=="function")c.onclick=r;else{var o=!1;c.onclick=function(){o=!o,l.classList.toggle("ikr-reply-text-clamped",!o),c.textContent=o?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),i}var mt={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--ikr-card-photo-w":"80px"},medium:{"--ikr-card-photo-w":"110px"},large:{"--ikr-card-photo-w":"140px"}}},ut="";function ft(e,r){var i=document.createElement("div");i.className="ikr-review ikr-review-card";var t=document.createElement("div");t.className="ikr-review-top";var n=document.createElement("div");n.className="ikr-review-top-left";var l=document.createElement("span");l.className="ikr-review-stars",l.innerHTML=se(e.rating,A),n.appendChild(l);var c=document.createElement("span");if(c.className="ikr-date",c.textContent=ce(e.createdAt),t.appendChild(n),t.appendChild(c),i.appendChild(t),e.title){var o=document.createElement("div");o.className="ikr-review-title",o.textContent=e.title,i.appendChild(o)}var d=document.createElement("div");d.className="ikr-author",d.textContent=e.author||"",i.appendChild(d);var m=(e.comment||"").trim();if(m){var k=document.createElement("div");k.className="ikr-body ikr-body-clamped",k.textContent=m,i.appendChild(k);var s=document.createElement("span");s.className="ikr-read-more",s.textContent="Devam\u0131n\u0131 oku",s.style.display="none",i.appendChild(s),requestAnimationFrame(function(){if(k.scrollHeight>k.clientHeight+2){s.style.display="inline";var v=!1;s.onclick=function(){v=!v,k.classList.toggle("ikr-body-clamped",!v),s.textContent=v?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var a=ge(e);if(a.length){var f=document.createElement("div");f.className="ikr-gallery",a.forEach(function(v){var u=document.createElement("img"),b=ee(v,V);u.src=b.src,u.srcset=b.srcset,u.loading="lazy",u.decoding="async",u.width=V,u.height=V,u.className="ikr-img",re(u),u.setAttribute("data-ikr-img-url",v),(function(z){u.onclick=function(){te(e,z,r)}})(v),f.appendChild(u)}),i.appendChild(f)}var p=He(e.merchantReply);return p&&i.appendChild(p),i}var zr={};ue(zr,{css:()=>vt,meta:()=>kt,render:()=>gt});var yi=`
  .ikr-review-list{
    display:grid;
...
`;var kt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"80px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"110px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},vt=yi;function gt(e,r){var i=ge(e),t=i.length>0,n=document.createElement("div");n.className="ikr-review-list"+(t?"":" ikr-review-list--no-media");var l=document.createElement("div");l.className="ikr-review-list-author";var c=document.createElement("span");c.className="ikr-review-stars ikr-review-list-author-stars",c.innerHTML=se(e.rating,A),l.appendChild(c);var o=document.createElement("span");o.className="ikr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var d=document.createElement("span");d.className="ikr-date ikr-review-list-author-date",d.textContent=ce(e.createdAt),l.appendChild(d),n.appendChild(l);var m=document.createElement("div");if(m.className="ikr-review-list-content",e.title){var k=document.createElement("div");k.className="ikr-review-list-title",k.textContent=e.title,m.appendChild(k)}var s=(e.comment||"").trim();if(s){var a=document.createElement("div");a.className="ikr-review-list-body ikr-body-clamped",a.textContent=s,m.appendChild(a);var f=document.createElement("span");f.className="ikr-read-more",f.textContent="Devam\u0131n\u0131 oku",f.style.display="none",m.appendChild(f),requestAnimationFrame(function(){if(a.scrollHeight>a.clientHeight+2){f.style.display="inline";var u=!1;f.onclick=function(){u=!u,a.classList.toggle("ikr-body-clamped",!u),f.textContent=u?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var p=He(e.merchantReply);if(p&&m.appendChild(p),n.appendChild(m),t){var v=document.createElement("div");v.className="ikr-review-list-media",i.forEach(function(u){var b=document.createElement("img"),z=ee(u,V);b.src=z.src,b.srcset=z.srcset,b.loading="lazy",b.decoding="async",b.width=V,b.height=Math.round(V*4/3),b.setAttribute("data-ikr-img-url",u),re(b),(function(y){b.onclick=function(){te(e,y,r)}})(u),v.appendChild(b)}),n.appendChild(v)}return n}var Cr={};ue(Cr,{css:()=>bt,meta:()=>ht,render:()=>yt});var wi=`
...
`;var ht={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"80px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"110px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},bt=wi;function yt(e,r){var i=Ue(e),t=!!i,n=document.createElement("div");n.className="ikr-review-gallery"+(t?"":" ikr-review-gallery--no-media");var l=document.createElement("div");l.className="ikr-review-gallery-content";var c=document.createElement("span");if(c.className="ikr-review-stars ikr-review-gallery-stars",c.innerHTML=se(e.rating,A),l.appendChild(c),e.title){var o=document.createElement("div");o.className="ikr-review-gallery-title",o.textContent=e.title,l.appendChild(o)}var d=document.createElement("div");d.className="ikr-review-gallery-author",d.textContent=e.author||"",l.appendChild(d);var m=document.createElement("div");m.className="ikr-review-gallery-date",m.textContent=ce(e.createdAt),l.appendChild(m);var k=(e.comment||"").trim();if(k){var s=document.createElement("div");s.className="ikr-review-gallery-body ikr-body-clamped",s.textContent=k,l.appendChild(s);var a=document.createElement("span");a.className="ikr-read-more",a.textContent="Devam\u0131n\u0131 oku",a.style.display="none",a.style.cursor="pointer";var f=!1;a.onclick=function(){if(i){te(e,i,r);return}f=!f,s.classList.toggle("ikr-body-clamped",!f),a.textContent=f?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"},l.appendChild(a),requestAnimationFrame(function(){s.scrollHeight>s.clientHeight+2&&(a.style.display="inline")})}if(n.appendChild(l),t){var p=document.createElement("div");p.className="ikr-review-gallery-media";var v=document.createElement("img"),u=ee(i,Xe);v.src=u.src,v.srcset=u.srcset,v.loading="lazy",v.decoding="async",v.width=Xe,v.height=Math.round(Xe*4/3),re(v),v.setAttribute("data-ikr-img-url",i),v.onclick=function(){te(e,i,r)},p.appendChild(v),n.appendChild(p)}var b=He(e.merchantReply,i?function(){te(e,i,r)}:null);return b&&(b.classList.add("ikr-review-gallery-reply"),n.appendChild(b)),n}var tr={card:xr,list:zr,gallery:Cr};function De(e){return tr[e]||tr.card}function xi(){return Object.keys(tr).map(function(e){return tr[e].css||""}).join(`
`)}function Le(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var t=parseInt(i[1],16),n=parseInt(i[2],16),l=parseInt(i[3],16);return"rgba("+t+","+n+","+l+","+r+")"}function wt(){var e=document.getElementById("ikas-reviews-anchor");if(e)return e;e=document.createElement("div"),e.id="ikas-reviews-anchor",e.setAttribute("data-ikr-auto-anchor","1");var r=null;try{r=document.querySelector(Wr)}catch(t){}if(r&&r.parentNode)return r.parentNode.insertBefore(e,r.nextSibling),e;var i=document.querySelector("main")||document.body;return i?(i.appendChild(e),e):null}var zi={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Ci={small:80,medium:110,large:140};function xt(e,r){var i=document.createElement("div");i.className="ikr-state-msg ikr-state-error",i.setAttribute("role","status"),i.setAttribute("aria-live","polite");var t=document.createElement("div");t.className="ikr-state-error-text",t.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",i.appendChild(t);var n=document.createElement("button");return n.type="button",n.className="ikr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},i.appendChild(n),i}function zt(e,r){var i=r.headerTitleColor||"#111111",t=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",c=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",m=Le(c,.06),k=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",a=r.btnTextColor||"#ffffff",f=r.btnBorderColor||"#111111",p=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",u=r.filterBtnBorderColor||"#111111",b=r.filterMenuBgColor||"#ffffff",z=r.filterMenuBorderColor||"#e5e7eb",y=r.filterItemTextColor||"#111111",g=r.filterItemHoverBgColor||"#f3f4f6",S=r.filterItemActiveColor||"#111111",x=r.reviewTitleColor||"#111111",C=r.reviewAuthorColor||"#111111",w=r.reviewDateColor||"#5e5e5e",E=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",h=r.replyBgColor||"#f9fafb",N=r.replyBorderColor||"#747474",L=r.replyLabelColor||"#111111",B=r.replyTextColor||"#111111",H=r.photoTitleColor||"#111111",G=Le("#111111",.05),ne=r.photoArrowBgColor||"#ffffff",oe=r.photoArrowTextColor||"#111111",W=Le("#111111",.12),O=r.formBgColor||"#ffffff",F=r.formPrimaryTextColor||"#111111",Ne=r.formSecondaryTextColor||"#3b3b3b",le=r.inputTextColor||F,D=r.inputBorderColor||"#d1d5db",me=r.placeholderColor||"#9ca3af",Ae=r.formStepBarColor||"#111111",q=r.formBtnBgColor||"#111111",K=r.formBtnTextColor||"#ffffff",Y=r.formBtnBorderColor||"#111111",_e=Le(q,.06),X=Le(q,.18),ye=Le(K,.85),J=Le(F,.06),Z=r.loadMoreBgColor||"#ffffff",$=r.loadMoreTextColor||"#111111",we=r.loadMoreBorderColor||"#111111",j={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":i,"--ikr-header-avg":t,"--ikr-header-count":n,"--ikr-header-recommend":l,"--ikr-bar-fill":c,"--ikr-bar-track":o,"--ikr-bar-count":d,"--ikr-bar-hover-bg":m,"--ikr-btn-bg":s,"--ikr-btn-text":a,"--ikr-btn-border":f,"--ikr-filter-btn-bg":p,"--ikr-filter-btn-text":v,"--ikr-filter-btn-border":u,"--ikr-filter-menu-bg":b,"--ikr-filter-menu-border":z,"--ikr-filter-item-text":y,"--ikr-filter-item-hover-bg":g,"--ikr-filter-item-active":S,"--ikr-review-title":x,"--ikr-review-author":C,"--ikr-review-date":w,"--ikr-review-body":E,"--ikr-review-border":T,"--ikr-review-star-color":k,"--ikr-reply-bg-color":h,"--ikr-reply-border":N,"--ikr-reply-label":L,"--ikr-reply-text":B,"--ikr-photo-title":H,"--ikr-photo-image-border":G,"--ikr-photo-arrow-bg":ne,"--ikr-photo-arrow-text":oe,"--ikr-photo-arrow-border":W,"--ikr-fwizard-bg":O,"--ikr-fwizard-text":F,"--ikr-fwizard-secondary-text":Ne,"--ikr-fwizard-input-bg":O,"--ikr-fwizard-input-text":le,"--ikr-fwizard-input-border":D,"--ikr-fwizard-placeholder":me,"--ikr-fwizard-close-text":F,"--ikr-fwizard-close-hover-bg":J,"--ikr-fwizard-progress-bg":J,"--ikr-fwizard-progress-active":Ae,"--ikr-fwizard-btn-bg":q,"--ikr-fwizard-btn-text":K,"--ikr-fwizard-btn-border":Y,"--ikr-fwizard-btn-disabled-bg":X,"--ikr-fwizard-btn-disabled-text":ye,"--ikr-fwizard-nav-hover-bg":_e,"--ikr-load-more-bg":Z,"--ikr-load-more-text":$,"--ikr-load-more-border":we};Object.keys(j).forEach(function(I){e.style.setProperty(I,j[I])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function be(e,r,i,t,n,l,c){if(Hr){Ke({productId:e,settings:r,reviewsData:i,productName:t,orderBy:n,page:l,badgeSettings:c});return}qe(!0),Nr(e),Ar(r),c!==void 0&&Pr(c),Rr(t),n&&Re(n),l&&Ee(l),i!=null&&Ir(i);try{let ar=function(P,R){if(!(!P||!P.meta||!P.meta.sizeOverrides)){var M=P.meta.sizeOverrides[R];M&&Object.keys(M).forEach(function(ze){a.style.setProperty(ze,M[ze])})}};var Ct=ar,o=ir(r.summaryLayout),d=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),m=r.showTitle!==!1,k=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",s=d&&m?k:"",a=document.documentElement;zt(a,r),jr("#111111",ri+bi()+xi());var f=r.borderRadius!==void 0?r.borderRadius:8,p=zi[r.size]||zi.medium,v=Ci[r.thumbnailSize]||Ci.medium,u=De(r.reviewLayout);if(u.meta&&u.meta.sizeOverrides&&u.meta.sizeOverrides[r.size]){var b=u.meta.sizeOverrides[r.size],z=b["--ikr-list-photo-w"]||b["--ikr-gallery-photo-w"];z&&(v=parseInt(z))}a.style.setProperty("--ikr-title-size",p.titleSize+"px"),a.style.setProperty("--ikr-review-text-size",p.reviewTextSize+"px"),a.style.setProperty("--ikr-review-title-size",p.reviewTitleSize+"px"),a.style.setProperty("--ikr-author-size",p.authorSize+"px"),a.style.setProperty("--ikr-reply-name-size",p.replyNameSize+"px"),a.style.setProperty("--ikr-reply-text-size",p.replyTextSize+"px"),a.style.setProperty("--ikr-radius",f+"px"),a.style.setProperty("--ikr-radius-sm",Math.max(0,f-4)+"px"),a.style.setProperty("--ikr-photo-title-size",p.photoTitleSize+"px"),a.style.setProperty("--ikr-avg-rating-size",p.avgRatingSize+"px"),a.style.setProperty("--ikr-review-count-size",p.reviewCountSize+"px"),a.style.setProperty("--ikr-compact-count-size",p.compactCountSize+"px"),a.style.setProperty("--ikr-recommend-size",p.recommendSize+"px"),a.style.setProperty("--ikr-btn-text-size",p.btnTextSize+"px"),a.style.setProperty("--ikr-bar-label-size",p.barLabelSize+"px"),a.style.setProperty("--ikr-minimal-avg-size",p.minimalAvgSize+"px"),a.style.setProperty("--ikr-hero-avg-size",p.heroAvgSize+"px"),a.style.setProperty("--ikr-bar-count-size",p.barCountSize+"px"),a.style.setProperty("--ikr-review-date-size",p.reviewDateSize+"px"),a.style.setProperty("--ikr-filter-text-size",p.filterTextSize+"px"),a.style.setProperty("--ikr-load-more-size",p.loadMoreSize+"px"),a.style.setProperty("--ikr-read-more-size",p.readMoreSize+"px"),a.style.setProperty("--ikr-thumbnail-size",v+"px");var y=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";a.style.setProperty("--ikr-review-star-color",y),a.style.setProperty("--ikr-star-size",p.reviewStarSize+"px"),a.style.setProperty("--ikr-avg-star-size",p.avgStarSize+"px"),ar(ir(r.summaryLayout),r.size),ar(De(r.reviewLayout),r.size);var g=Oe(r),S=document.getElementById("ikas-reviews");if(!S){var x=wt();if(!x)return;S=document.createElement("div"),S.id="ikas-reviews",S.style.minHeight="200px",x.appendChild(S)}if(r.enabled===!1){S.style.minHeight="auto",S.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',qe(!1);var C=We;Ke(null),C&&be(C.productId,C.settings,C.reviewsData,C.productName,C.orderBy,C.page,C.badgeSettings);return}S.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var w=i||{},E=pr(w),T=E?[]:w.data&&w.data.reviews||[],h=E?0:w.data&&w.data.totalCount||0;Mr(T);var N=S.cloneNode(!1);S.parentNode.replaceChild(N,S),S=N;var L=document.createElement("div");if(L.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(L.style.width="100%",L.style.maxWidth="100%",L.style.marginLeft="0",L.style.marginRight="0"),s){var B=document.createElement("div"),H=r.summaryLayout||"classic";B.className="ikr-title ikr-title-"+H,B.textContent=s,L.appendChild(B)}if(E){L.appendChild(xt(w.message,async function(){var P=await Te(Q,de,1,Ce,Se);await be(Q,A,P,Pe,de,1,nr)})),S.appendChild(L);return}var G=w.data&&w.data.allCount||0,ne=w.data&&w.data.ratingCounts||null,oe=ne||[0,0,0,0,0],W=w.data&&w.data.avgRating||"0.0";if(!ne&&T.length>0){T.forEach(function(P){P.rating>=1&&P.rating<=5&&oe[P.rating-1]++});var O=T.reduce(function(P,R){return P+R.rating},0);W=(O/T.length).toFixed(1)}if(G>0){var F=ir(r.summaryLayout),Ne=F.render({widget:L,data:w,settings:r,iconPair:g,allCount:G,ratingCounts:oe,avgRatingVal:W,currentRatingFilter:Ce,currentOrderBy:de,currentHasImages:Se,onFilterChange:async function(P){Ge(Ce===P?null:P),Ee(1);var R=await Te(Q,de,1,Ce,Se);await be(Q,A,R,Pe,de,1)},onSortChange:async function(P,R){Ee(1),R?(lr(!0),Re("newest")):(lr(!1),Re(P));var M=await Te(Q,de,1,Ce,Se);await be(Q,A,M,Pe,de,1)}});L.appendChild(Ne)}else{var le=document.createElement("button");le.className="ikr-write-btn",le.style.cssText="display:block;margin:16px auto 0;",le.textContent=r.writeButtonText||"Yorum Yap",le.onclick=_,L.appendChild(le)}var D=(Lr||[]).filter(function(P){return ge(P).length>0});if(r.showPhotoGallery!==!1&&!Se&&D.length>0){var me=document.createElement("div");if(me.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var Ae=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",q=document.createElement("div");q.className="ikr-photo-title",q.textContent=Ae,me.appendChild(q)}var K=r.reviewLayout==="card"?"1/1":"3/4";a.style.setProperty("--ikr-photo-thumb-aspect",K);var Y=document.createElement("div");Y.className="ikr-photo-strip";var _e=V,X=r.reviewLayout==="card"?V:Math.round(V*4/3),ye=0;D.forEach(function(P){if(!(ye>=15)){var R=Ue(P);if(R){var M=document.createElement("img"),ze=ee(R,V);M.src=ze.src,M.srcset=ze.srcset,M.loading=ye<3?"eager":"lazy",M.decoding="async",M.width=_e,M.height=X,M.className="ikr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",re(M),(function(Si,Ei){M.onclick=function(){te(Ei,Si,D)}})(R,P),Y.appendChild(M),ye++}}});var J=document.createElement("button");J.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",J.innerHTML="&#8249;",J.setAttribute("aria-label","\xD6nceki"),J.onclick=function(){Y.scrollBy({left:-200,behavior:"smooth"})};var Z=document.createElement("button");Z.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",Z.innerHTML="&#8250;",Z.setAttribute("aria-label","Sonraki"),Z.onclick=function(){Y.scrollBy({left:200,behavior:"smooth"})};var $=document.createElement("div");$.className="ikr-photo-strip-wrap",$.appendChild(J),$.appendChild(Y),$.appendChild(Z),me.appendChild($),L.appendChild(me)}if(T.length===0){var we=document.createElement("p");we.className="ikr-state-msg",we.textContent="Hen\xFCz yorum yok.",L.appendChild(we)}else{var u=De(r.reviewLayout);T.forEach(function(R){L.appendChild(u.render(R,or))})}var j=w.data&&w.data.hasMore;if(j){var I=document.createElement("button");I.className="ikr-load-more",I.textContent="Daha Fazla G\xF6ster",I.onclick=async function(){I.disabled=!0,I.textContent="Y\xFCkleniyor...";var P=Tr+1,R=await Te(Q,de,P,Ce,Se);if(R&&!pr(R)&&R.data&&Array.isArray(R.data.reviews)){Fr(R.data.reviews),Ee(P);var M=De(A.reviewLayout);R.data.reviews.forEach(function(ze){L.insertBefore(M.render(ze,or),I)}),R.data.hasMore?(I.disabled=!1,I.textContent="Daha Fazla G\xF6ster"):I.remove()}else I.disabled=!1,I.textContent="Tekrar Dene"},L.appendChild(I)}S.appendChild(L),fr(G>0?W:null,h,t,nr,g)}catch(P){console.error("[ikr] render error:",P),S.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(qe(!1),We){var xe=We;Ke(null),be(xe.productId,xe.settings,xe.reviewsData,xe.productName,xe.orderBy,xe.page,xe.badgeSettings)}}}export{be as a,Ze as b,pr as c,Te as d,Ni as e,Pt as f};
