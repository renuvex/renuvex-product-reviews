...
`);function sa(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function va(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function ca(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",o=va()&&!n;if(a>0){var l=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",l+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ma(e){var r=document.body.style,t=document.documentElement.style;ie(t,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Ke=0,_e=null;function vr(){return Ke+=1,Ke>1||(_e=sa(),ca(_e)),_e}function cr(){if(Ke!==0&&(Ke-=1,!(Ke>0))){var e=_e;_e=null,e&&ma(e)}}function xa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function mr(){var e=xa();return!e||e===document.body||e===document.documentElement?null:e}function G(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function fa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Pr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(fa)}function ga(e,r){var t=e,a=Pr(e);!a.length&&r&&(t=r,a=Pr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;G(n)}function xr(e,r,t){if(e.key==="Tab"){var a=Pr(r);if(!a.length){e.preventDefault(),ga(r);return}var n=a[0],o=a[a.length-1],l=wt(t);if(!r.contains(l)){e.preventDefault(),G(n);return}if(a.indexOf(l)===-1){e.preventDefault(),G(e.shiftKey?o:n);return}e.shiftKey&&l===n?(e.preventDefault(),G(o)):!e.shiftKey&&l===o&&(e.preventDefault(),G(n))}}var At="renuvexPrOverlay";function fr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[At]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function ha(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[At]===e.id)}function gr(e){if(ha(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Fe(e){return be(e)}function Lt(e,r,t,a,n){cr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&ir(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),G(n)}function ba(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=se(e.rating,P);var o=document.createElement("span");o.className="renuvex-pr-modal-date",o.textContent=ve(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-modal-title",l.textContent=e.title||"",l.style.display=e.title?"":"none",t.appendChild(l);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=P&&P.merchantReplyLabel||"Ma\u011Faza Sahibi";var c=document.createElement("div");return c.className="renuvex-pr-modal-reply-text",c.textContent=e.merchantReply||"",u.appendChild(f),u.appendChild(c),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Nt(e,r,t){var a=t||P,n=e.querySelector(".renuvex-pr-modal-scroll-content"),o=n.querySelector(".renuvex-pr-modal-stars");o.innerHTML=se(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=ve(r.createdAt);var l=n.querySelector(".renuvex-pr-modal-title");l.textContent=r.title||"",l.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Ir(e,r,t,a,n,o,l,i,d){var u=Fe(e),f=Math.max(0,Math.min(t||0,u.length-1)),c=document.createElement("div");c.className="renuvex-pr-modal-left";var p=document.createElement("img"),x=l==="next"?"renuvex-pr-modal-img-enter-right":l==="prev"?"renuvex-pr-modal-img-enter-left":"";p.className="renuvex-pr-modal-main-img"+(x?" "+x:""),p.src=Lr(u[f]||""),p.decoding="async",p.width=Ar,p.height=Math.round(Ar*4/3),p.alt="Yorum foto\u011Fraf\u0131",xt(p,function(T){if(T.style.display="none",!c.querySelector(".renuvex-pr-modal-img-error")){var E=document.createElement("div");E.className="renuvex-pr-modal-img-error",E.setAttribute("role","status"),E.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",c.insertBefore(E,T)}}),c.appendChild(p);var g=document.createElement("button");g.className="renuvex-pr-modal-close-mobile";var v=q(Se);v&&g.appendChild(v),g.setAttribute("aria-label","Kapat"),g.onclick=function(T){T.stopPropagation(),o()},c.appendChild(g);var b=0;if(c.addEventListener("touchstart",function(T){b=T.touches[0].clientX},{passive:!0}),c.addEventListener("touchend",function(T){var E=b-T.changedTouches[0].clientX;if(!(Math.abs(E)<50)){if(E>0){if(w)ce(e,r,f+1,a,n,o,!0,"next",i,d);else if(h){var N=a[r+1];ce(N,r+1,0,a,n,o,!1,"next",i,d)}}else if(m)ce(e,r,f-1,a,n,o,!0,"prev",i,d);else if(y){var I=a[r-1],D=Fe(I);ce(I,r-1,D.length-1,a,n,o,!1,"prev",i,d)}}},{passive:!0}),u.length>1){var s=document.createElement("div");s.className="renuvex-pr-modal-thumbs",u.forEach(function(T,E){var N=document.createElement("img"),I=ae(T,ur);N.src=I.src,N.srcset=I.srcset,N.loading="lazy",N.decoding="async",N.width=ur,N.height=ur,N.className="renuvex-pr-modal-thumb"+(E===f?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(E+1),ne(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(E+1)+" se\xE7"),E===f&&N.setAttribute("aria-current","true"),(function(D){function X(){ce(e,r,D,a,n,o,!0,null,i,d)}N.onclick=X,N.onkeydown=function(j){(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),X())}})(E),s.appendChild(N)}),c.appendChild(s)}var m=f>0,w=f<u.length-1,y=r>0,h=r<a.length-1,C=m||y,z=w||h;if(C){var L=document.createElement("button");L.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var k=q(Pe);k&&L.appendChild(k),L.setAttribute("aria-label","\xD6nceki"),L.onclick=function(T){if(T.stopPropagation(),m)ce(e,r,f-1,a,n,o,!0,"prev",i,d);else if(y){var E=a[r-1],N=Fe(E);ce(E,r-1,N.length-1,a,n,o,!1,"prev",i,d)}},c.appendChild(L)}if(z){var S=document.createElement("button");S.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var A=q(or);A&&S.appendChild(A),S.setAttribute("aria-label","Sonraki"),S.onclick=function(T){if(T.stopPropagation(),w)ce(e,r,f+1,a,n,o,!0,"next",i,d);else if(h){var E=a[r+1];ce(E,r+1,0,a,n,o,!1,"next",i,d)}},c.appendChild(S)}return c}function Pt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=Fe(a);n[0]&&(new Image().src=Lr(n[0]))}})}function Rr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function wa(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function o(){Rr(t),Rr(a),Rr(n)}o(),t&&G(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function ce(e,r,t,a,n,o,l,i,d,u){if(u&&(u.currentReview=e),l){var f=Ir(e,r,t,a,n,o,i,d,u);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=Ir(e,r,t,a,n,o,i,d,u),c=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),c&&Nt(c,e,u&&u.currentSettings),wa(d,n)}Pt(r,a)}function oe(e,r,t){var a=Fe(e);if(!a.length)return;var n=(t||[]).filter(function(z){return Fe(z).length>0}),o=n.findIndex(function(z){return z===e||z.id===e.id});o===-1&&(n.unshift(e),o=0);var l=a.indexOf(r);l<0&&(l=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var u=!1,f=null,c=mr(),p=vr(),x=fr(),g={currentReview:e,currentSettings:P},v=null;function b(z){var L=z&&z.detail&&z.detail.settings;if(!(L&&L===v)){v=L||null,g.currentSettings=L||P;var k=d.querySelector(".renuvex-pr-modal-right");!k||!g.currentReview||Nt(k,g.currentReview,g.currentSettings)}}function s(){u||(u=!0,window.removeEventListener(Ee,b),Lt(f&&f.host,m,s,p,c))}function m(z){if(z.key==="Escape"){w();return}xr(z,i,f&&f.root)}function w(){u||(u=!0,window.removeEventListener(Ee,b),Lt(f&&f.host,m,s,p,c),gr(x))}document.addEventListener("keydown",m),window.addEventListener("popstate",s),window.addEventListener(Ee,b),i.onclick=function(){w()},d.onclick=function(z){z.stopPropagation()},d.appendChild(Ir(e,o,l,n,d,w,null,i,g)),d.appendChild(ba(e)),Pt(o,n);var y=document.createElement("div");y.className="renuvex-pr-modal-wrap",y.tabIndex=-1,y.setAttribute("role","dialog"),y.setAttribute("aria-modal","true"),y.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),y.appendChild(d);var h=document.createElement("button");h.className="renuvex-pr-modal-close";var C=q(Se);C&&h.appendChild(C),h.setAttribute("aria-label","Kapat"),h.onclick=function(z){z.stopPropagation(),w()},y.appendChild(h),i.appendChild(y),f=dr(),Me(f.root,Be+Ae+sr),f.root.appendChild(i),ke(f.root),G(y)}function we(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var _r={};ge(_r,{css:()=>La,meta:()=>Aa,render:()=>Na});function Oe(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,o=e.onFilterChange;he(a);var l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,u=t>0?Math.round(d/t*100):0,f=n===i,c=document.createElement("div");c.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":""),n&&!f&&(c.style.opacity="0.35");for(var p="",x=1;x<=5;x++){var g=x<=i;p+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(g?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+W(g?"full":"outline")+"</span>"}c.innerHTML='<span class="renuvex-pr-bar-label">'+p+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(v){c.onclick=function(){o(v)}})(i),l.appendChild(c)}return l}var le=[],Rt=!1,hr=!1;function It(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function ya(e){if(hr){hr=!1,e.preventDefault(),e.stopPropagation();return}for(var r=!1,t=le.length-1;t>=0;t--){var a=le[t];It(e,a.trigger)||It(e,a.element)||a.close()&&(r=!0)}r&&(e.preventDefault(),e.stopPropagation())}function za(e){if(e.key==="Escape")for(var r=le.length-1;r>=0;r--)le[r].close()}function Ca(){Rt||typeof document=="undefined"||(document.addEventListener("click",ya,!0),document.addEventListener("keydown",za),Rt=!0)}function br(e){for(var r=0;r<le.length;r++)le[r]!==e&&le[r].close()}function Bt(){hr=!0,typeof setTimeout=="function"&&setTimeout(function(){hr=!1},700)}function wr(e){Ca();var r={trigger:e.trigger,element:e.element,close:e.close};return le.push(r),function(){var a=le.indexOf(r);a!==-1&&le.splice(a,1)}}function re(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,o=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=P&&P.writeButtonText||"Yorum Yap",i.onclick=n,l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var f=P&&P.filterIcon||"lines";u.innerHTML=de(pt(f));var c=document.createElement("div");c.className="renuvex-pr-filter-menu",c.setAttribute("role","menu");var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],x=!1;function g(s){var m=c.classList.contains("renuvex-pr-open");c.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var w=s&&(s.restoreFocus===!0||s.restoreFocus==="auto"&&Qe());if(m&&w)try{u.focus({preventScroll:!0})}catch(y){try{u.focus()}catch(h){}}return m}function v(){br(b),c.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var s=c.querySelector(".renuvex-pr-filter-item-active")||c.querySelector(".renuvex-pr-filter-item");s&&requestAnimationFrame(function(){try{s.focus({preventScroll:!0})}catch(m){try{s.focus()}catch(w){}}})}p.forEach(function(s){var m=s[2],w=m?a:!a&&(t||"newest")===s[0],y=document.createElement("button");y.type="button",y.className="renuvex-pr-filter-item"+(w?" renuvex-pr-filter-item-active":""),y.setAttribute("role","menuitem"),y.textContent=s[1];var h=!1;function C(z,L){z&&(z.preventDefault(),z.stopPropagation()),!h&&(h=!0,x=!0,L!==!0&&Bt(),g({restoreFocus:L}),o(s[0],m),setTimeout(function(){h=!1,x=!1},0))}y.addEventListener("pointerdown",function(z){z.button!==void 0&&z.button!==0||C(z,!1)}),typeof window!="undefined"&&!window.PointerEvent&&y.addEventListener("touchstart",function(z){C(z,!1)},{passive:!1}),y.addEventListener("mousedown",function(z){z.button!==void 0&&z.button!==0||C(z,!1)}),y.addEventListener("keydown",function(z){(z.key==="Enter"||z.key===" ")&&C(z,!0)}),y.onclick=function(z){C(z,!1)},c.appendChild(y)}),u.onclick=function(){c.classList.contains("renuvex-pr-open")?g({restoreFocus:"auto"}):v()},d.addEventListener("keydown",function(s){s.key==="Escape"&&c.classList.contains("renuvex-pr-open")&&(s.stopPropagation(),g({restoreFocus:!0}))}),d.addEventListener("focusout",function(s){if(c.classList.contains("renuvex-pr-open")&&!x){var m=s.relatedTarget;m&&d.contains(m)||g()}});var b=wr({trigger:d,element:c,close:g});return d.appendChild(u),d.appendChild(c),l.appendChild(d),l}var Mt=`
...
`;var Aa={id:"classic",name:"Klasik (A\xE7\u0131k)"},La=qt;function Na(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,c=e.onFilterChange,p=e.onSortChange;he(n);var x=document.createElement("div");x.className="renuvex-pr-summary";var g=(l[3]||0)+(l[4]||0),v=o>0?Math.round(g/o*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+W("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",x.appendChild(b);var s=document.createElement("div");if(s.className="renuvex-pr-summary-block renuvex-pr-summary-count",s.textContent=o.toLocaleString("tr-TR")+" Yorum",x.appendChild(s),a.showRecommendation!==!1&&v>0){var m=document.createElement("div");m.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",m.innerHTML='<span class="renuvex-pr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",x.appendChild(m)}return x.appendChild(Oe({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:c})),x.appendChild(re({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:Y,onSortChange:p})),x}var Fr={};ge(Fr,{css:()=>Ra,meta:()=>Pa,render:()=>Ia});var Gt=`
...
`;var Pa={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Ra=Gt;function Ia(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentHasImages,f=e.onFilterChange,c=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-compact";var x=document.createElement("div");x.className="renuvex-pr-compact-header";var g=document.createElement("div");g.className="renuvex-pr-compact-trigger-wrap";var v=document.createElement("button");v.className="renuvex-pr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Re(l,a)+'</span><span class="renuvex-pr-compact-trigger-text">'+n.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+de(ut)+"</span>",g.appendChild(v),x.appendChild(g);var b=re({widget:r,currentOrderBy:d,currentHasImages:u,onWriteClick:Y,onSortChange:c}),s=b.querySelector(".renuvex-pr-filter-wrap"),m=b.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-compact-actions-slot",m&&w.appendChild(m),s&&w.appendChild(s),x.appendChild(w),p.appendChild(x);var y=document.createElement("div");y.className="renuvex-pr-compact-panel",y.setAttribute("role","dialog"),y.setAttribute("aria-hidden","true");var h=document.createElement("div");h.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+W("full")+"</span><span>"+l+"</span>",h.appendChild(C),h.appendChild(Oe({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),y.appendChild(h);var z=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function L(M){var J=M?p:g;y.parentNode!==J&&(y.classList.contains("renuvex-pr-open")&&(y.classList.remove("renuvex-pr-open"),y.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),J.appendChild(y))}if(L(z?z.matches:!1),z){var k=function(M){L(M.matches)};z.addEventListener?z.addEventListener("change",k):z.addListener&&z.addListener(k)}if(m){var S=document.createElement("button");S.className="renuvex-pr-write-btn",S.textContent=P&&P.writeButtonText||"Yorum Yap",S.onclick=Y;var A=document.createElement("div");A.className="renuvex-pr-compact-write-row",A.appendChild(S),p.appendChild(A)}function T(){y.classList.remove("renuvex-pr-open"),y.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function E(){br(N),y.classList.add("renuvex-pr-open"),y.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){y.classList.contains("renuvex-pr-open")?T():E()};var N=null;function I(M){N&&(N(),N=null),M||(N=wr({trigger:g,element:y,close:T}))}if(I(z?z.matches:!1),z){var D=function(M){I(M.matches)};z.addEventListener?z.addEventListener("change",D):z.addListener&&z.addListener(D)}if(t.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),j=n>0?Math.round(X/n*100):0;if(j>0){var K=document.createElement("div");K.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",K.style.marginTop="8px",K.innerHTML='<span class="renuvex-pr-recommend-pct">%'+j+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",h.appendChild(K)}}return p}var Or={};ge(Or,{css:()=>Ma,meta:()=>Ba,render:()=>_a});var Xt=`
...
`;var Ba={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ma=Xt;function _a(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentHasImages,f=e.onFilterChange,c=e.onSortChange;he(a);var p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-split";var x=document.createElement("div");x.className="renuvex-pr-split-col renuvex-pr-split-left";var g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",g.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+W("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",x.appendChild(g);var v=document.createElement("div");v.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",v.textContent=n.toLocaleString("tr-TR")+" Yorum",x.appendChild(v),p.appendChild(x);var b=document.createElement("div");b.className="renuvex-pr-split-col renuvex-pr-split-mid",b.appendChild(Oe({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),p.appendChild(b);var s=re({widget:r,currentOrderBy:d,currentHasImages:u,onWriteClick:Y,onSortChange:c}),m=s.querySelector(".renuvex-pr-filter-wrap"),w=s.querySelector(".renuvex-pr-write-btn"),y=document.createElement("div");y.className="renuvex-pr-split-col renuvex-pr-split-right",w&&y.appendChild(w),m&&y.appendChild(m),p.appendChild(y);var h=(o[3]||0)+(o[4]||0),C=n>0?Math.round(h/n*100):0,z=document.createElement("div");z.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",z.innerHTML='<span class="renuvex-pr-recommend-pct">%'+C+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var L=t.showRecommendation===!1||C===0;return L&&z.classList.add("renuvex-pr-split-rec-hidden"),x.appendChild(z),p}var Hr={};ge(Hr,{css:()=>Oa,meta:()=>Fa,render:()=>Ha});var Kt=`
...
`;var Ka={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Ja=ea;function Za(e,r){var t=lr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-gallery-content";var l=document.createElement("span");if(l.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",l.innerHTML=se(e.rating,P),o.appendChild(l),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,o.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",o.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=ve(e.createdAt),o.appendChild(u);var f=(e.comment||"").trim();if(f&&o.appendChild(Ye(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){oe(e,t,r)}}:null).fragment),n.appendChild(o),a){var c=document.createElement("div");c.className="renuvex-pr-review-gallery-media";var p=document.createElement("img"),x=ae(t,pr);p.src=x.src,p.srcset=x.srcset,p.loading="lazy",p.decoding="async",p.width=pr,p.height=Math.round(pr*4/3),ne(p),p.setAttribute("data-renuvex-img-url",t),we(p,function(){oe(e,t,r)}),c.appendChild(p),n.appendChild(c)}var g=De(e.merchantReply,t?function(){oe(e,t,r)}:null);return g&&(g.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(g)),n}var Cr={card:Dr,list:jr,gallery:Vr};function kr(e){return Cr[e]||Cr.card}function ra(){return Object.keys(Cr).map(function(e){return Cr[e].css||""}).join(`
`)}var Ur=0;function je(){return Ur++,Ur}function Ve(e,r){return e!==Ur?!1:r?!(r.productId!==void 0&&O!==r.productId||r.orderBy!==void 0&&U!==r.orderBy||r.page!==void 0&&er!==r.page||r.ratingFilter!==void 0&&Q!==r.ratingFilter||r.hasImages!==void 0&&ee!==r.hasImages):!0}var Wr={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},qr={small:80,medium:110,large:140};function ta(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var o=document.createElementNS(t,"line");o.setAttribute("x1","1"),o.setAttribute("y1","1"),o.setAttribute("x2","23"),o.setAttribute("y2","23"),a.appendChild(n),a.appendChild(o);var l=document.createElement("div");l.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",l.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(l),r.appendChild(i),r}function aa(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function me(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),o=parseInt(t[3],16);return"rgba("+a+","+n+","+o+","+r+")"}function Sr(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Gr(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function na(e){return .2126*Gr(e.r)+.7152*Gr(e.g)+.0722*Gr(e.b)}function ia(e,r){var t=na(e),a=na(r),n=Math.max(t,a),o=Math.min(t,a);return(n+.05)/(o+.05)}function $a(e){var r=Sr(e)||Sr("#ffffff"),t=Sr("#111111"),a=Sr("#ffffff");return ia(t,r)>=ia(a,r)?"#111111":"#ffffff"}function Qa(e){return me(e,e==="#ffffff"?.1:.06)}function oa(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",o=r.headerRecommendColor||"#111111",l=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=me(l,.06),f=r.reviewStarColor||"#f59e0b",c=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",x=r.btnBorderColor||"#111111",g=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",b=r.filterBtnBorderColor||"#111111",s=r.filterMenuBgColor||"#ffffff",m=r.filterMenuBorderColor||"#e5e7eb",w=r.filterItemTextColor||"#111111",y=r.filterItemHoverBgColor||"#f3f4f6",h=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",z=r.reviewAuthorColor||"#111111",L=r.reviewDateColor||"#5e5e5e",k=r.reviewBodyColor||"#111111",S=r.reviewBorderColor||"#e5e7eb",A=me(k,.65),T=r.replyBgColor||"#f9fafb",E=r.replyBorderColor||"#747474",N=r.replyLabelColor||"#111111",I=r.replyTextColor||"#111111",D=r.photoTitleColor||"#111111",X=me("#111111",.05),j=r.photoArrowBgColor||"#ffffff",K=r.photoArrowTextColor||"#111111",M=me("#111111",.12),J=r.formBgColor||"#ffffff",ye=r.formPrimaryTextColor||"#111111",H=r.formSecondaryTextColor||"#3b3b3b",Te=r.inputTextColor||ye,xe=r.inputBorderColor||"#d1d5db",ze=r.placeholderColor||"#9ca3af",te=r.formStepBarColor||"#111111",R=r.formBtnBgColor||"#111111",fe=r.formBtnTextColor||"#ffffff",F=r.formBtnBorderColor||"#111111",Je=me(R,.06),Ce=me(R,.18),B=me(fe,.85),Z=me(ye,.06),$=$a(J),_=Qa($),pe=r.loadMoreBgColor||"#ffffff",Ze=r.loadMoreTextColor||"#111111",$e=r.loadMoreBorderColor||"#111111",ue={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":o,"--renuvex-pr-bar-fill":l,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":c,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":x,"--renuvex-pr-filter-btn-bg":g,"--renuvex-pr-filter-btn-text":v,"--renuvex-pr-filter-btn-border":b,"--renuvex-pr-filter-menu-bg":s,"--renuvex-pr-filter-menu-border":m,"--renuvex-pr-filter-item-text":w,"--renuvex-pr-filter-item-hover-bg":y,"--renuvex-pr-filter-item-active":h,"--renuvex-pr-review-title":C,"--renuvex-pr-review-author":z,"--renuvex-pr-review-date":L,"--renuvex-pr-review-body":k,"--renuvex-pr-review-border":S,"--renuvex-pr-state-text":A,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":T,"--renuvex-pr-reply-border":E,"--renuvex-pr-reply-label":N,"--renuvex-pr-reply-text":I,"--renuvex-pr-photo-title":D,"--renuvex-pr-photo-image-border":X,"--renuvex-pr-photo-arrow-bg":j,"--renuvex-pr-photo-arrow-text":K,"--renuvex-pr-photo-arrow-border":M,"--renuvex-pr-fwizard-bg":J,"--renuvex-pr-fwizard-text":ye,"--renuvex-pr-fwizard-secondary-text":H,"--renuvex-pr-fwizard-input-bg":J,"--renuvex-pr-fwizard-input-text":Te,"--renuvex-pr-fwizard-input-border":xe,"--renuvex-pr-fwizard-placeholder":ze,"--renuvex-pr-fwizard-close-text":$,"--renuvex-pr-fwizard-close-hover-bg":_,"--renuvex-pr-fwizard-progress-bg":Z,"--renuvex-pr-fwizard-progress-active":te,"--renuvex-pr-fwizard-btn-bg":R,"--renuvex-pr-fwizard-btn-text":fe,"--renuvex-pr-fwizard-btn-border":F,"--renuvex-pr-fwizard-btn-disabled-bg":Ce,"--renuvex-pr-fwizard-btn-disabled-text":B,"--renuvex-pr-fwizard-nav-hover-bg":Je,"--renuvex-pr-load-more-bg":pe,"--renuvex-pr-load-more-text":Ze,"--renuvex-pr-load-more-border":$e};Object.keys(ue).forEach(function(Ue){e.style.setProperty(Ue,ue[Ue])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function la(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,o=e.wireLightboxTrigger,l=(e.photoStripReviews||[]).filter(function(y){return be(y).length>0});if(!(r.showPhotoGallery!==!1&&!a&&l.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",u=document.createElement("div");u.className="renuvex-pr-photo-title",u.textContent=d,i.appendChild(u)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var c=document.createElement("div");c.className="renuvex-pr-photo-strip";var p=V,x=r.reviewLayout==="card"?V:Math.round(V*4/3),g=0;l.forEach(function(y){if(!(g>=15)){var h=lr(y);if(h){var C=document.createElement("img"),z=ae(h,V);C.src=z.src,C.srcset=z.srcset,C.loading=g<3?"eager":"lazy",C.decoding="async",C.width=p,C.height=x,C.className="renuvex-pr-photo-strip-thumb",C.alt="Yorum foto\u011Fraf\u0131",ne(C),(function(L,k){o(C,function(){n(k,L,l)})})(h,y),c.appendChild(C),g++}}});var v=document.createElement("button");v.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var b=q(Pe);b&&v.appendChild(b),v.setAttribute("aria-label","\xD6nceki"),v.onclick=function(){c.scrollBy({left:-200,behavior:"smooth"})};var s=document.createElement("button");s.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var m=q(or);m&&s.appendChild(m),s.setAttribute("aria-label","Sonraki"),s.onclick=function(){c.scrollBy({left:200,behavior:"smooth"})};var w=document.createElement("div");return w.className="renuvex-pr-photo-strip-wrap",w.appendChild(v),w.appendChild(c),w.appendChild(s),i.appendChild(w),i}function pa(e){var r=e.render;async function t(){var o=je(),l=O,i=U,d=Q,u=ee,f=await Ie(O,U,1,Q,ee);Ve(o,{productId:l,orderBy:i,ratingFilter:d,hasImages:u})&&await r(O,P,f,Le,U,1,Kr)}async function a(o){var l=je(),i=Q===o?null:o,d=O,u=U,f=ee;Zr(i),Ne(1);var c=await Ie(O,U,1,i,ee);Ve(l,{productId:d,orderBy:u,page:1,ratingFilter:i,hasImages:f})&&await r(O,P,c,Le,U,1)}async function n(o,l){var i=je(),d=O,u=Q;Ne(1);var f=o,c=!1;l&&(c=!0,f="newest"),$r(c),rr(f);var p=await Ie(O,f,1,Q,c);Ve(i,{productId:d,orderBy:f,page:1,ratingFilter:u,hasImages:c})&&await r(O,P,p,Le,f,1)}return{onRetry:t,onFilterChange:a,onSortChange:n}}function en(){return ht()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function rn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=ft({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),gt(t,{surface:"reviews",productId:r||""}),t}async function Xr(e,r,t,a,n,o,l){if(lt){nr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:o,badgeSettings:l});return}ar(!0),Qr(e),et(r),l!==void 0&&rt(l),tt(a),n&&rr(n),o&&Ne(o),t!=null&&at(t);var i=pa({render:Xr});try{let Ce=function(B,Z){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var $=B.meta.sizeOverrides[Z];$&&Object.keys($).forEach(function(_){x.style.setProperty(_,$[_])})}};var Je=Ce,d=zr(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,c=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",p=u&&f?c:"",x=document.documentElement;oa(x,r);var g=r.borderRadius!==void 0?r.borderRadius:8,v=Wr[r.size]||Wr.medium,b=qr[r.thumbnailSize]||qr.medium;x.style.setProperty("--renuvex-pr-title-size",v.titleSize+"px"),x.style.setProperty("--renuvex-pr-review-text-size",v.reviewTextSize+"px"),x.style.setProperty("--renuvex-pr-review-title-size",v.reviewTitleSize+"px"),x.style.setProperty("--renuvex-pr-author-size",v.authorSize+"px"),x.style.setProperty("--renuvex-pr-reply-name-size",v.replyNameSize+"px"),x.style.setProperty("--renuvex-pr-reply-text-size",v.replyTextSize+"px"),x.style.setProperty("--renuvex-pr-radius",g+"px"),x.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,g-4)+"px"),x.style.setProperty("--renuvex-pr-photo-title-size",v.photoTitleSize+"px"),x.style.setProperty("--renuvex-pr-avg-rating-size",v.avgRatingSize+"px"),x.style.setProperty("--renuvex-pr-review-count-size",v.reviewCountSize+"px"),x.style.setProperty("--renuvex-pr-compact-count-size",v.compactCountSize+"px"),x.style.setProperty("--renuvex-pr-recommend-size",v.recommendSize+"px"),x.style.setProperty("--renuvex-pr-btn-text-size",v.btnTextSize+"px"),x.style.setProperty("--renuvex-pr-bar-label-size",v.barLabelSize+"px"),x.style.setProperty("--renuvex-pr-minimal-avg-size",v.minimalAvgSize+"px"),x.style.setProperty("--renuvex-pr-hero-avg-size",v.heroAvgSize+"px"),x.style.setProperty("--renuvex-pr-bar-count-size",v.barCountSize+"px"),x.style.setProperty("--renuvex-pr-review-date-size",v.reviewDateSize+"px"),x.style.setProperty("--renuvex-pr-filter-text-size",v.filterTextSize+"px"),x.style.setProperty("--renuvex-pr-load-more-size",v.loadMoreSize+"px"),x.style.setProperty("--renuvex-pr-read-more-size",v.readMoreSize+"px"),x.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var s=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";x.style.setProperty("--renuvex-pr-review-star-color",s),x.style.setProperty("--renuvex-pr-star-size",v.reviewStarSize+"px"),x.style.setProperty("--renuvex-pr-avg-star-size",v.avgStarSize+"px"),Ce(zr(r.summaryLayout),r.size),Ce(kr(r.reviewLayout),r.size);var m=Ge(r),w=en();if(!w)return;var y=rn(w,e),h=document.getElementById("renuvex-reviews");h||(h=document.createElement("div"),h.id="renuvex-reviews",h.style.minHeight="200px"),h.parentNode!==y&&y.appendChild(h);var C=bt(h),z=Be+Ae+sr+Zt()+ra();Me(C,z);var L=yt(C);if(r.enabled===!1){h.style.minHeight="auto",L.replaceChildren(ta(r.borderRadius!==void 0?r.borderRadius:8)),ar(!1);var k=tr;nr(null),k&&Xr(k.productId,k.settings,k.reviewsData,k.productName,k.orderBy,k.page,k.badgeSettings);return}try{var S=t||{},A=Nr(S),T=A?[]:S.data&&S.data.reviews||[];nt(T),L.replaceChildren();var E=document.createElement("section");if(E.id="renuvex-reviews-widget",E.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),E.className="renuvex-pr-reviews-widget",E.setAttribute("data-renuvex-surface","reviews"),e&&E.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(E.style.width="100%",E.style.maxWidth="100%",E.style.marginLeft="0",E.style.marginRight="0"),p){var N=document.createElement("div"),I=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+I,N.textContent=p,E.appendChild(N)}if(A){E.appendChild(aa(S.message,i.onRetry)),L.appendChild(E),ke(C),Er(E,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return C.getElementById("renuvex-reviews-widget")});return}var D=S.data&&S.data.allCount||0,X=S.data&&S.data.ratingCounts||null,j=X||[0,0,0,0,0],K=S.data&&S.data.avgRating||"0.0";if(!X&&T.length>0){T.forEach(function(B){B.rating>=1&&B.rating<=5&&j[B.rating-1]++});var M=T.reduce(function(B,Z){return B+Z.rating},0);K=(M/T.length).toFixed(1)}if(D>0){var J=zr(r.summaryLayout),ye=J.render({widget:E,data:S,settings:r,iconPair:m,allCount:D,ratingCounts:j,avgRatingVal:K,currentRatingFilter:Q,currentOrderBy:U,currentHasImages:ee,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});E.appendChild(ye)}else{var H=document.createElement("button");H.className="renuvex-pr-write-btn",H.style.cssText="display:block;margin:16px auto 0;",H.textContent=r.writeButtonText||"Yorum Yap",H.onclick=Y,E.appendChild(H)}var Te=la({settings:r,root:x,currentHasImages:ee,photoStripReviews:Jr,openReviewModal:oe,wireLightboxTrigger:we});if(Te&&E.appendChild(Te),T.length===0){var xe=document.createElement("p");xe.className="renuvex-pr-state-msg",xe.textContent="Hen\xFCz yorum yok.",E.appendChild(xe)}else{var ze=kr(r.reviewLayout);T.forEach(function(B){E.appendChild(ze.render(B,Tr))})}var te=S.data&&S.data.hasMore;if(te){var R=document.createElement("button");R.className="renuvex-pr-load-more",R.textContent="Daha Fazla G\xF6ster",R.onclick=async function(){R.disabled=!0,R.textContent="Y\xFCkleniyor...";var B=je(),Z=O,$=U,_=er,pe=Q,Ze=ee,$e=_+1,ue=await Ie(Z,$,$e,pe,Ze);if(Ve(B,{productId:Z,orderBy:$,page:_,ratingFilter:pe,hasImages:Ze}))if(ue&&!Nr(ue)&&ue.data&&Array.isArray(ue.data.reviews)){var Ue=it(ue.data.reviews);ot(Ue),Ne($e);var ua=kr(P.reviewLayout);Ue.forEach(function(da){E.insertBefore(ua.render(da,Tr),R)}),ue.data.hasMore?(R.disabled=!1,R.textContent="Daha Fazla G\xF6ster"):R.remove()}else R.disabled=!1,R.textContent="Tekrar Dene"},E.appendChild(R)}L.appendChild(E),ke(C),Er(E,"reviews-widget",{productId:e||""},function(){return C.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var fe=document.createElement("p");fe.style.cssText="text-align:center;color:#dc2626;",fe.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",L&&L.replaceChildren(fe)}}finally{if(ar(!1),tr){var F=tr;nr(null),Xr(F.productId,F.settings,F.reviewsData,F.productName,F.orderBy,F.page,F.badgeSettings)}}}export{Xr as render};
