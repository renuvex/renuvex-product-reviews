...
import{a as fa,b as $e,c as Hr,d as Ne,e as xe,f as xa,h as gt,i as Ye,k as ga,l as ha}from"./chunk-2QX4IOFE.js";import{c as Ce}from"./chunk-WWGCW5YN.js";import{a as qe,d as Pe}from"./chunk-N7KC6W47.js";import{A as na,B as ia,C as oa,D as la,E as Rr,F as Nr,G as Br,a as te,b as mr,c as ie,d as ae,e as Z,f as F,g as Xt,h as Oe,j as _r,k as ct,l as $t,m as mt,n as Lr,o as Ue,p as Jt,q as Zt,r as Qt,s as ea,t as ra,u as ta,v as aa,w as _e}from"./chunk-DSBS2GI5.js";import{c as st}from"./chunk-SJ3AGLQV.js";import{A as Ur,B as Se,C as ft,D as xt,E as xr,F as ma,G as gr,a as Le,b as pe,c as ue,d as ee,e as He,f as Fr,g as fr,h as da,i as Ke,j as Ir,k as pa,l as we,m as Or,n as ua,o as Xe,q as D,r as sa,s as ke,t as Re,v as va,w as ze,x as ca,z as oe}from"./chunk-QNMMEXKU.js";import{a as de,b as ye,d as vt,k as Ve}from"./chunk-SUP34WWV.js";import"./chunk-W53BN4EO.js";import{a as ut,b as Kt,d as Me}from"./chunk-D4BSMMIO.js";var Je=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function ba(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Ze(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function Vr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function ya(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function wa(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var ka=`
...
`;var Yr=[ka,va,Sa,Ca,Ea,Ta,Ma,Aa,za].join(`
`);function qn(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ge(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function Kn(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Xn(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",i=Kn()&&!n;if(a>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),i&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function $n(e){var r=document.body.style,t=document.documentElement.style;ge(t,"overflow",e.rootOverflow,e.rootOverflowPriority),ge(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ge(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ge(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ge(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ge(r,"position",e.bodyPosition,e.bodyPositionPriority),ge(r,"top",e.bodyTop,e.bodyTopPriority),ge(r,"left",e.bodyLeft,e.bodyLeftPriority),ge(r,"right",e.bodyRight,e.bodyRightPriority),ge(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var hr=0,Qe=null;function Dr(){return hr+=1,hr>1||(Qe=qn(),Xn(Qe)),Qe}function jr(){if(hr!==0&&(hr-=1,!(hr>0))){var e=Qe;Qe=null,e&&$n(e)}}function Jn(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Gr(){var e=Jn();return!e||e===document.body||e===document.documentElement?null:e}function se(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Zn(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function ht(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Zn)}function Qn(e,r){var t=e,a=ht(e);!a.length&&r&&(t=r,a=ht(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;se(n)}function Wr(e,r,t){if(e.key==="Tab"){var a=ht(r);if(!a.length){e.preventDefault(),Qn(r);return}var n=a[0],i=a[a.length-1],o=ya(t);if(!r.contains(o)){e.preventDefault(),se(n);return}if(a.indexOf(o)===-1){e.preventDefault(),se(e.shiftKey?i:n);return}e.shiftKey&&o===n?(e.preventDefault(),se(i)):!e.shiftKey&&o===i&&(e.preventDefault(),se(n))}}var Pa="renuvexPrOverlay";function qr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Pa]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function ei(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Pa]===e.id)}function Kr(e){if(ei(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}var ri="media-theme-renuvex-review-storefront";var _a="renuvex-review-storefront",er={controlForeground:"#ffffff",controlBackground:"#000000",controlHoverBackground:"rgba(0,0,0,0.84)",centerPlayButtonBackground:"rgba(0,0,0,0.68)",centerPlayButtonHoverBackground:"rgba(0,0,0,0.72)",controlsBackdrop:"rgba(0,0,0,0.58)",menuBackground:"#000000",menuBorder:"rgba(255,255,255,0.18)",menuText:"#ffffff",menuCheckedText:"#ffffff",menuHoverBackground:"rgba(255,255,255,0.12)",menuCheckedBackground:"rgba(255,255,255,0.18)",menuHoverOutline:"rgba(255,255,255,0.54) solid 1px",progressPlayed:"#ffffff",progressTrack:"#000000",progressPointer:"rgba(255,255,255,0.72)",progressBuffered:"rgba(255,255,255,0.28)",progressThumbBorder:"1px solid rgba(255,255,255,0.72)",progressThumbShadow:"0 0 0 1px rgba(0,0,0,0.45)",progressPointerBorder:"1px solid rgba(0,0,0,0.55)"};function Xr(e,r){return`var(--renuvex-pr-review-lightbox-video-${e}, ${r})`}var ti=ut({},er),br=Kt(ut({},er),{controlForeground:Xr("icon",er.controlForeground),centerPlayButtonBackground:"rgba(0,0,0,0.35)",centerPlayButtonHoverBackground:"rgba(0,0,0,0.42)",progressPlayed:Xr("progress",er.progressPlayed),progressTrack:Xr("progress-track",er.progressTrack),progressThumbBorder:`1px solid ${Xr("progress",er.progressPlayed)}`}),$r=null;function La(e){return`
  :host {
...
`}var ll=La(ti),ai=La(br);function ni(e,r){var d;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let a=t.get("media-theme-gerwig"),n=a==null?void 0:a.template;if(!a||!(n instanceof HTMLTemplateElement))return;let i=n.cloneNode(!0);i.id=e,(d=i.content.querySelector("media-controller"))==null||d.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class l extends a{}l.template=i,t.define(e,l)}function ii(e,r){return typeof window=="undefined"?Promise.resolve():($r!=null||($r=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),$r.then(()=>{ni(e,r)}))}function Ra(){return ii(ri,ai)}var yt=null,Fa="--center-play-button";function oi(){return yt||(yt=Ra()),yt}function li(e){return new Promise(function(r){function t(a){if(a<=0){r();return}requestAnimationFrame(function(){t(a-1)})}t(e)})}function di(e){e.style.setProperty(Fa,"none")}function Na(e){e.style.removeProperty(Fa)}function pi(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=fa(e.url);return r&&t&&r!==t?"":r||t}function ui(e,r){var t=pi(r);if(!t)return!1;var a=$e(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("nohotkeys",""),e.setAttribute("lang","tr"),e.setAttribute("theme",_a),e.setAttribute("accent-color",br.controlForeground),e.setAttribute("primary-color",br.controlForeground),e.setAttribute("secondary-color",br.controlBackground),a&&e.setAttribute("poster",a),e.setAttribute("playback-id",t),!0}function Ba(e){e.preventDefault()}function Ia(e,r){var t=!1,a=document.createElement("mux-player");a.className=r||"renuvex-pr-modal-main-video",a.setAttribute("aria-label","Yorum videosu"),di(a),a.addEventListener("contextmenu",Ba);var n=ui(a,e);return n?oi().then(function(){if(window.customElements&&typeof window.customElements.whenDefined=="function")return window.customElements.whenDefined("mux-player")}).then(function(){if(!t){try{typeof a.pause=="function"&&a.pause()}catch(i){}return li(2)}}).then(function(){t||Na(a)}).catch(function(){t||a.dispatchEvent(new Event("error"))}):setTimeout(function(){t||a.dispatchEvent(new Event("error"))},0),{element:a,cleanup:function(){t=!0;try{typeof a.pause=="function"&&a.pause()}catch(o){}a.removeAttribute("playback-id"),a.removeAttribute("playback-token"),a.removeAttribute("thumbnail-token"),a.removeAttribute("poster"),Na(a),a.removeEventListener("contextmenu",Ba)}}}function rr(e){return Ne(e)}function Ua(e){return e&&e.source==="mediaGallery"}function si(e,r){if(!Ua(r))return rr(e);var t=xe(e);return t?[t]:[]}function vi(e,r){return(e||[]).filter(function(t){return r==="mediaGallery"?!!xe(t):rr(t).length>0})}function kt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Oa(e,r,t,a,n,i){e&&e.shadowRoot&&kt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),jr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Fr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&se(n)}function ci(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ke(e.rating,F);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=ze(e.createdAt),a.appendChild(n),a.appendChild(i),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=D(F&&F.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",u.appendChild(m),u.appendChild(v),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Ha(e,r,t){var a=t||F,n=e.querySelector(".renuvex-pr-modal-scroll-content"),i=n.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ke(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=ze(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=n.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=D(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}var mi=112;function zt(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function fi(e){var r=e&&e.target;return!!(r&&typeof r.closest=="function"&&r.closest(".renuvex-pr-modal-thumbs"))}function xi(e,r,t){if(!r||r.type!=="video"||!t)return!1;var a=zt(e);if(!a)return!1;var n=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!n||typeof n.getBoundingClientRect!="function")return!1;var i=n.getBoundingClientRect();if(!i.width||!i.height||a.clientX<i.left||a.clientX>i.right||a.clientY<i.top||a.clientY>i.bottom)return!1;var o=Math.min(mi,Math.max(72,i.height*.2));return a.clientY>=i.bottom-o}function gi(e){var r=e&&e.type==="video"?e.posterUrl:e&&e.url;if(e&&e.type==="video"){var t={width:Se,height:Se,fit:"crop"};return{src:$e(r,t),srcset:Hr(r,t)}}return xr(r,Se)}function hi(e,r,t){var a=e&&e.media;if(!a)return null;var n=document.createElement("button");n.type="button",n.className="renuvex-pr-modal-thumb renuvex-pr-modal-thumb-button"+(a.type==="video"?" renuvex-pr-modal-thumb-video":"")+(r?" renuvex-pr-modal-thumb-active":""),n.setAttribute("aria-label","Galeri medyas\u0131 "+(e.index+1)+" se\xE7"),r&&n.setAttribute("aria-current","true");var i=document.createElement("img");i.className="renuvex-pr-modal-thumb-img";var o=gi(a);if(i.src=o.src,o.srcset&&(i.srcset=o.srcset),i.loading="lazy",i.decoding="async",i.width=Se,i.height=Se,i.alt="",gr(i),n.appendChild(i),a.type==="video"){var l=document.createElement("span");l.className="renuvex-pr-modal-thumb-play";var d=ee(Xe);d&&l.appendChild(d),n.appendChild(l)}return n.onclick=t,n}function bi(e){var r=[];return(e||[]).forEach(function(t,a){var n=xe(t);n&&r.push({review:t,reviewIdx:a,media:n,index:r.length})}),r}function St(e,r,t,a,n,i,o,l,d){var u=si(e,d),m=Math.max(0,Math.min(t||0,u.length-1)),v=u[m],p=document.createElement("div");p.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Ia(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),c=x.element;c.addEventListener("error",function(){if(!p.querySelector(".renuvex-pr-modal-img-error")){var L=document.createElement("div");L.className="renuvex-pr-modal-img-error",L.setAttribute("role","status"),L.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",p.insertBefore(L,c)}});var f=!1,h=function(){p.classList.add("renuvex-pr-modal-left-video-playing")},b=function(){f=!0,h()},E=function(){f&&h()},P=function(){f=!1,p.classList.remove("renuvex-pr-modal-left-video-playing")};c.addEventListener("play",b),c.addEventListener("playing",b),c.addEventListener("pause",E),c.addEventListener("ended",P),p.__renuvexMediaCleanup=function(){c.removeEventListener("play",b),c.removeEventListener("playing",b),c.removeEventListener("pause",E),c.removeEventListener("ended",P),P(),x.cleanup()},p.appendChild(c)}else{var w=document.createElement("img");if(w.className="renuvex-pr-modal-main-img"+(s?" "+s:""),w.src=xt(v?v.url:""),w.decoding="async",w.width=ft,w.height=Math.round(ft*4/3),w.alt="Yorum foto\u011Fraf\u0131",!s){w.classList.add("renuvex-pr-modal-img-loading");var C=function(){w.classList.remove("renuvex-pr-modal-img-loading")};w.complete&&w.naturalWidth>0?C():(w.addEventListener("load",C,{once:!0}),w.addEventListener("error",C,{once:!0}))}ma(w,function(L){if(L.style.display="none",!p.querySelector(".renuvex-pr-modal-img-error")){var N=document.createElement("div");N.className="renuvex-pr-modal-img-error",N.setAttribute("role","status"),N.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(N,L)}}),p.appendChild(w)}var g=document.createElement("button");g.className="renuvex-pr-modal-close-mobile";var z=ee(we);z&&g.appendChild(z),g.setAttribute("aria-label","Kapat"),g.onclick=function(L){L.stopPropagation(),i()},p.appendChild(g);var M=0,k=!1,S=!1;if(p.addEventListener("touchstart",function(L){var N=zt(L);N&&(S=fi(L),M=N.clientX,k=!S&&xi(L,v,p))},{passive:!0}),p.addEventListener("touchend",function(L){if(S){S=!1,k=!1;return}if(k){k=!1;return}var N=zt(L);if(N){var j=M-N.clientX;if(!(Math.abs(j)<50)){if(j>0){if(T)he(e,r,m+1,a,n,i,!0,"next",l,d);else if(I){var B=a[r+1];he(B,r+1,0,a,n,i,!1,"next",l,d)}}else if(y)he(e,r,m-1,a,n,i,!0,"prev",l,d);else if(R){var G=a[r-1],K=rr(G);he(G,r-1,K.length-1,a,n,i,!1,"prev",l,d)}}}},{passive:!0}),Ua(d)){var A=bi(a);if(A.length>1){var _=document.createElement("div");_.className="renuvex-pr-modal-thumbs renuvex-pr-modal-thumbs--gallery",A.forEach(function(L){var N=hi(L,L.reviewIdx===r,function(){he(L.review,L.reviewIdx,0,a,n,i,!1,null,l,d)});N&&_.appendChild(N)}),p.appendChild(_)}}else if(u.length>1){var O=document.createElement("div");O.className="renuvex-pr-modal-thumbs",u.forEach(function(L,N){var j=L.type==="video"?L.posterUrl:L.url,B=document.createElement("img"),G=xr(j,Se);B.src=G.src,B.srcset=G.srcset,B.loading="lazy",B.decoding="async",B.width=Se,B.height=Se,B.className="renuvex-pr-modal-thumb"+(N===m?" renuvex-pr-modal-thumb-active":""),B.alt="K\xFC\xE7\xFCk resim "+(N+1),gr(B),B.tabIndex=0,B.setAttribute("role","button"),B.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(N+1)+" se\xE7"),N===m&&B.setAttribute("aria-current","true"),(function(K){function Q(){he(e,r,K,a,n,i,!0,null,l,d)}B.onclick=Q,B.onkeydown=function(H){(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),Q())}})(N),O.appendChild(B)}),p.appendChild(O)}var y=m>0,T=m<u.length-1,R=r>0,I=r<a.length-1,V=y||R,J=T||I;if(V){var X=document.createElement("button");X.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var W=ee(Ke);W&&X.appendChild(W),X.setAttribute("aria-label","\xD6nceki"),X.onclick=function(L){if(L.stopPropagation(),y)he(e,r,m-1,a,n,i,!0,"prev",l,d);else if(R){var N=a[r-1],j=rr(N);he(N,r-1,j.length-1,a,n,i,!1,"prev",l,d)}},p.appendChild(X)}if(J){var Y=document.createElement("button");Y.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var q=ee(Ir);q&&Y.appendChild(q),Y.setAttribute("aria-label","Sonraki"),Y.onclick=function(L){if(L.stopPropagation(),T)he(e,r,m+1,a,n,i,!0,"next",l,d);else if(I){var N=a[r+1];he(N,r+1,0,a,n,i,!1,"next",l,d)}},p.appendChild(Y)}return p}function Va(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=rr(a);n[0]&&n[0].type==="image"&&(new Image().src=xt(n[0].url))}})}function wt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function yi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){wt(t),wt(a),wt(n)}i(),t&&se(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function he(e,r,t,a,n,i,o,l,d,u){if(u&&(u.currentReview=e),o){var m=St(e,r,t,a,n,i,l,d,u);n.firstChild&&(kt(n.firstChild),n.replaceChild(m,n.firstChild))}else{var m=St(e,r,t,a,n,i,l,d,u),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&(kt(n.firstChild),n.replaceChild(m,n.firstChild)),v&&Ha(v,e,u&&u.currentSettings),yi(d,n)}Va(r,a)}function me(e,r,t,a){var n=a&&a.source==="mediaGallery"?"mediaGallery":"review",i=n==="mediaGallery"?xe(e)?[xe(e)]:[]:rr(e);if(!i.length)return;var o=vi(t,n),l=o.findIndex(function(k){return k===e||k.id===e.id});l===-1&&(o.unshift(e),l=0);var d=i.findIndex(function(k){return k.url===r});d<0&&(d=0);var u=document.createElement("div");u.className="renuvex-pr-modal-overlay";var m=document.createElement("div");m.className="renuvex-pr-modal";var v=!1,p=null,s=Gr(),x=Pe(),c=Dr(),f=qr(),h={currentReview:e,currentSettings:F,source:n},b=null;function E(k){var S=k&&k.detail&&k.detail.settings;if(!(S&&S===b)){b=S||null,h.currentSettings=S||F;var A=m.querySelector(".renuvex-pr-modal-right");!A||!h.currentReview||Ha(A,h.currentReview,h.currentSettings)}}function P(){v||(v=!0,window.removeEventListener(Ve,E),Oa(p&&p.host,w,P,c,s,x))}function w(k){if(k.key==="Escape"){C();return}Wr(k,u,p&&p.root)}function C(){v||(v=!0,window.removeEventListener(Ve,E),Oa(p&&p.host,w,P,c,s,x),Kr(f))}document.addEventListener("keydown",w),window.addEventListener("popstate",P),window.addEventListener(Ve,E),u.onclick=function(){C()},m.onclick=function(k){k.stopPropagation()},m.appendChild(St(e,l,d,o,m,C,null,u,h)),m.appendChild(ci(e)),Va(l,o);var g=document.createElement("div");g.className="renuvex-pr-modal-wrap",g.tabIndex=-1,g.setAttribute("role","dialog"),g.setAttribute("aria-modal","true"),g.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),g.appendChild(m);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var M=ee(we);M&&z.appendChild(M),z.setAttribute("aria-label","Kapat"),z.onclick=function(k){k.stopPropagation(),C()},g.appendChild(z),u.appendChild(g),p=Vr(),Ze(p.root,Je+qe+Yr),p.root.appendChild(u),He(p.root),se(g)}function tr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Lt={};Me(Lt,{css:()=>io,meta:()=>no,render:()=>oo});function ar(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,i=e.onFilterChange;Le(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,u=t>0?Math.round(d/t*100):0,m=n===l,v=d>0,p=D(F&&F.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(n&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+p+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+p);for(var x="",c=1;c<=5;c++){var f=c<=l;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+pe(f?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(E){(E.key==="Enter"||E.key===" "||E.key==="Space"||E.key==="Spacebar")&&(E.preventDefault(),b())}})(l),o.appendChild(s)}return o}var ja="data-renuvex-pr-dismiss-gesture",De=[],Ya=!1,Jr=!1,yr=[],nr=null;function Da(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Ct(){for(var e=De.length-1;e>=0;e--){var r=De[e].element;r&&r.isConnected===!1&&De.splice(e,1)}return De}function wi(e){!e||typeof e.setAttribute!="function"||(yr.indexOf(e)===-1&&yr.push(e),e.setAttribute(ja,""))}function Ga(){for(var e=0;e<yr.length;e++){var r=yr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(ja)}yr=[],nr&&typeof clearTimeout=="function"&&clearTimeout(nr),nr=null}function ki(e){if(Jr){Jr=!1,Ga(),e.preventDefault(),e.stopPropagation();return}for(var r=Ct(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Da(e,n.trigger)||Da(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function zi(e){if(e.key==="Escape")for(var r=Ct(),t=r.length-1;t>=0;t--)r[t].close()}function Wa(){Ya||typeof document=="undefined"||(document.addEventListener("click",ki,!0),document.addEventListener("keydown",zi),Ya=!0)}function Si(e){Wa(),Jr=!0,wi(e),nr&&typeof clearTimeout=="function"&&clearTimeout(nr),typeof setTimeout=="function"&&(nr=setTimeout(function(){Jr=!1,Ga()},700))}function Et(e){Si(e)}function Zr(e){Wa();var r={trigger:e.trigger,element:e.element,close:e.close};return De.push(r),{unregister:function(){var t=De.indexOf(r);t!==-1&&De.splice(t,1)},notifyOpening:function(){for(var t=Ct(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function le(e){var r=e.widget,t=e.currentOrderBy,a=e.currentMediaFilter||"none",n=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=D(F&&F.writeButtonText,"Yorum Yap"),l.onclick=n,o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var m=F&&F.filterIcon||"lines";u.innerHTML=ue(da(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var p=$t===!0?"media":"images",s=p==="media"?"Foto\u011Fraf ve Video":"Foto\u011Frafl\u0131",x=[{orderBy:"newest",label:"En Yeni",mediaFilter:"none"},{orderBy:"highest",label:"En Y\xFCksek Puan",mediaFilter:"none"},{orderBy:"lowest",label:"En D\xFC\u015F\xFCk Puan",mediaFilter:"none"},{orderBy:"newest",label:s,mediaFilter:p}],c=!1;function f(){return r&&r.parentNode||r||null}function h(w,C){if(!(C===!0||!w)){if(w.type==="touchstart"){Et(f());return}if(w.type==="pointerdown"){var g=w.pointerType||"";g&&g!=="mouse"&&Et(f())}}}function b(w){var C=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var g=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(C&&g)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(M){}}return C}function E(){P.notifyOpening(),v.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var w=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(C){try{w.focus()}catch(g){}}})}x.forEach(function(w){var C=w.mediaFilter!=="none",g=C?a===w.mediaFilter:a==="none"&&(t||"newest")===w.orderBy,z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(g?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=w.label;var M=!1;function k(S,A){S&&(S.preventDefault(),S.stopPropagation()),!M&&(M=!0,c=!0,h(S,A),b({restoreFocus:A}),i(w.orderBy,w.mediaFilter),setTimeout(function(){M=!1,c=!1},0))}z.addEventListener("pointerdown",function(S){S.button!==void 0&&S.button!==0||S.pointerType!=="mouse"&&k(S,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(S){k(S,!1)},{passive:!1}),z.addEventListener("keydown",function(S){(S.key==="Enter"||S.key===" ")&&k(S,!0)}),z.onclick=function(S){k(S,!1)},v.appendChild(z)}),u.onclick=function(){v.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):E()},d.addEventListener("keydown",function(w){w.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(w){if(v.classList.contains("renuvex-pr-open")&&!c){var C=w.relatedTarget;C&&d.contains(C)||b()}});var P=Zr({trigger:d,element:v,close:b});return d.appendChild(u),d.appendChild(v),o.appendChild(d),o}var qa=`
...
`;function Ka(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,a=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,n=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",o.appendChild(l);var d=document.createElement("button");d.className="renuvex-pr-fwizard-close",d.type="button",d.setAttribute("aria-label","Kapat");var u=ee(we);u&&d.appendChild(u),o.appendChild(d);var m=!1,v=null,p=null,s=!1;function x(){se(i)}function c(g){Wr(g,i,v&&v.root)}function f(){if(!m){if(m=!0,document.removeEventListener("keydown",h),i.removeEventListener("click",b),d.removeEventListener("click",f),s)se(p);else{var g=v&&v.root?v.root.activeElement:null;if(g&&typeof g.blur=="function")try{g.blur()}catch(z){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){v?(Fr(v.root),v.host&&v.host.parentNode&&v.host.parentNode.removeChild(v.host)):i.parentNode&&i.parentNode.removeChild(i),jr();try{r()}catch(z){}},200)}}function h(g){if(g.key==="Escape"){f();return}c(g)}function b(g){g.target===i&&n&&f()}document.addEventListener("keydown",h),i.addEventListener("click",b),d.addEventListener("click",f);function E(g){p=t||Gr(),s=a===null?Pe():a,g&&l.appendChild(g),v=Vr(),Ze(v.root,Je+qe+qa),v.root.appendChild(i),He(v.root),Dr(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),x()})}var P=null,w=null;function C(g,z){if(z=z||"error",P){try{P.remove()}catch(M){}P=null}w&&(clearTimeout(w),w=null),P=document.createElement("div"),P.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,P.textContent=g,o.appendChild(P),w=setTimeout(function(){P&&(P.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(P){try{P.remove()}catch(M){}P=null}},300))},4e3)}return{open:E,close:f,content:l,setAllowOutsideClose:function(g){n=!!g},setStepAttr:function(g){o.setAttribute("data-step",String(g))},showToast:C}}var Tt=4;function ir(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Xa(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(i){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Tt&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(i){return i!==n})}}}}function $a(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=ue(Ke)+"<span>Geri</span>",l.addEventListener("click",function(){a()}),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var u=[],m=0;m<Tt;m++){var v=document.createElement("span");v.className="renuvex-pr-fwizard-progress-seg",d.appendChild(v),u.push(v)}o.appendChild(d);var p=document.createElement("button");p.type="button";var s=null;function x(f){s&&p.removeEventListener("click",s),s=f,f&&p.addEventListener("click",f)}o.appendChild(p);function c(f,h){var b=r.indexOf(f)!==-1,E=t.indexOf(f)!==-1,P=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0||!!h.videoUpload);if(b)f===2&&P?(p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",x(function(){i()})):(p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.setAttribute("aria-label","Atla"),p.innerHTML="<span>Atla</span>",x(function(){n()})),p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),p.style.visibility="",p.tabIndex=0;else if(E){p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Sonraki"),p.innerHTML="Sonraki",p.style.visibility="",p.tabIndex=0;var w=ir(f,h);p.disabled=!w,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!w),x(function(){p.disabled||i()})}else p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.innerHTML="",p.style.visibility="hidden",p.tabIndex=-1,p.disabled=!0,x(null)}return{el:o,update:function(f,h){u.forEach(function(E,P){P+1<=f?E.classList.add("renuvex-pr-fwizard-progress-seg-active"):E.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var b=f<=1;l.style.visibility=b?"hidden":"",l.style.pointerEvents=b?"none":"",l.tabIndex=b?-1:0,c(f,h)},setNextDisabled:function(f){p.classList.contains("renuvex-pr-fwizard-cta-btn")&&(p.disabled=!!f,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!f))},setThanksState:function(f){l.style.visibility="hidden",d.style.visibility="hidden",p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",p.style.visibility="",p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),x(f)}}}var Ci={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ve(e){var r=F&&F[e];return!r&&e==="formStepMediaTitle"&&(r=F&&F.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=F&&F.formStepPhotosSubtitle),D(r,Ci[e])}function Ja(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ve("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var l=fr(F||{});Le(l);var d=[];function u(f){d.forEach(function(h,b){var E=b<f;h.classList.toggle("renuvex-pr-fwizard-star-active",E),h.setAttribute("aria-checked",b+1===f?"true":"false"),h.innerHTML=E?pe("full"):pe("outline")})}function m(f){e.set({rating:f}),u(f)}function v(f){var h=d[f-1];if(h)try{h.focus()}catch(b){}}function p(f,h){h&&typeof h.preventDefault=="function"&&h.preventDefault(),h&&typeof h.stopPropagation=="function"&&h.stopPropagation(),!a&&(a=!0,m(f),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var s=1;s<=5;s++)(function(f){var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",f+" y\u0131ld\u0131z"),h.innerHTML=pe("outline"),h.addEventListener("mouseenter",function(){u(f)}),h.addEventListener("mouseleave",function(){u(e.get().rating)}),h.addEventListener("pointerdown",function(b){b.button&&b.button!==0||p(f,b)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){p(f,b)},{passive:!1}),h.addEventListener("mousedown",function(b){window.PointerEvent||p(f,b)}),h.addEventListener("keydown",function(b){if(b.key==="Enter"||b.key===" "){p(f,b);return}var E=0;b.key==="ArrowRight"||b.key==="ArrowUp"?E=Math.min(5,f+1):b.key==="ArrowLeft"||b.key==="ArrowDown"?E=Math.max(1,f-1):b.key==="Home"?E=1:b.key==="End"&&(E=5),E&&(b.preventDefault(),m(E),v(E))}),h.addEventListener("click",function(b){p(f,b)}),d.push(h),o.appendChild(h)})(s);u(e.get().rating);var x=null,c=function(f){var h=f&&f.detail&&f.detail.settings;h&&h===x||(x=h||null,l=fr(h||F||{}),u(e.get().rating))};return window.addEventListener(Ve,c),t.appendChild(o),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ve,c)}}}var Qr=3,Ei=10*1024*1024;function et(e,r){r=r||{};var t=!1,a=r.hideAddButton===!0,n=r.revealAddButtonAfterMedia===!0,i=!a||n,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=ve("formStepPhotosTitle"),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-step-subtitle",d.textContent=ve("formStepPhotosSubtitle"),o.appendChild(d)}var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&u.classList.add("renuvex-pr-fwizard-photo-card--embedded");var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add",m.setAttribute("aria-label","Foto\u011Fraf ekle");var v=document.createElement("input");v.type="file",v.accept="image/*",v.multiple=!0,v.style.display="none",i&&u.appendChild(m),u.appendChild(v);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),u.appendChild(p),o.appendChild(u);var s=r.revokeBlobUrl||function(w){w&&typeof w=="string"&&w.startsWith("blob:")&&URL.revokeObjectURL(w)},x=r.blobMap||{},c=r.urlToFinger||{};function f(){if(!t){var w=e.get().images||[],C=e.get().pendingImages||[],g=w.map(function(z){return{url:z,isPending:!1}}).concat(C.map(function(z){return{url:z.url,file:z.file,isPending:!0,error:z.error}}));p.innerHTML="",g.forEach(function(z){var M=x[z.url]||z.url,k=h(z,M);p.appendChild(k)}),E()}}function h(w,C){var g=document.createElement("div");g.className="renuvex-pr-fwizard-photo-thumb";var z=document.createElement("img");z.src=C,z.alt="",z.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",g.appendChild(z);var M=document.createElement("div");M.className="renuvex-pr-fwizard-photo-loading",M.style.display="none",g.appendChild(M);var k=document.createElement("button");k.type="button",k.className="renuvex-pr-fwizard-photo-remove",k.setAttribute("aria-label","Kald\u0131r");var S=ee(we);return S&&k.appendChild(S),g.appendChild(k),b(g,w,C),g}function b(w,C,g){var z=w.querySelector("img");z.src!==g&&(z.src=g);var M=w.querySelector(".renuvex-pr-fwizard-photo-loading");if(C.isPending&&C.error){M.style.display="flex",M.textContent="";var k=document.createElement("span");k.className="renuvex-pr-upload-error",k.textContent="\u2717 "+C.error,M.appendChild(k)}else M.style.display="none",M.textContent="";var S=w.querySelector(".renuvex-pr-fwizard-photo-remove");S.onclick=function(){var A=c[C.url]||(C.file?C.file.name+"_"+C.file.size:null),_=x[C.url],O={};A&&(O.fingerprints=(e.get().fingerprints||[]).filter(function(y){return y!==A})),C.isPending?O.pendingImages=(e.get().pendingImages||[]).filter(function(y){return y.url!==C.url}):O.images=(e.get().images||[]).filter(function(y){return y!==C.url}),e.set(O),s(C.url),s(_),delete c[C.url],_&&delete c[_],x[C.url]&&delete x[C.url]}}function E(){var w=(e.get().images||[]).length,C=(e.get().pendingImages||[]).length,g=w+C,z=g>=Qr;u.classList.toggle("renuvex-pr-fwizard-photo-card--compact",g>0),i&&(m.innerHTML=g>0?ue(ua):ue(Or)+"<span>Foto\u011Fraf Ekle</span>"),z?(i&&(m.style.display="none"),m.disabled=!0,v.disabled=!0):(i&&(m.style.display=n&&g===0?"none":"flex"),m.disabled=!1,v.disabled=!1,m.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}m.addEventListener("click",function(){v.disabled||v.click()}),v.onchange=async function(w){var C=(e.get().images||[]).length+(e.get().pendingImages||[]).length,g=Array.from(w.target.files).slice(0,Qr-C);v.value="";var z=(e.get().pendingImages||[]).length,M=e.get().images||[],k=M.length;if(g.length!==0){for(var S=[],A=[],_=0;_<g.length;_++){var O=g[_],y=O.name+"_"+O.size,T=(e.get().fingerprints||[]).some(function(Y){return Y===y})||S.some(function(Y){return Y.file.name+"_"+Y.file.size===y});if(!T){if(O.size>Ei){var R="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(R,"error"):alert(R);continue}var I=URL.createObjectURL(O);c[I]=y,S.push({url:I,file:O,error:null}),A.push({url:I,file:O});var V=(e.get().fingerprints||[]).slice();V.push(y),e.set({fingerprints:V})}}if(S.length!==0){var J=(e.get().pendingImages||[]).concat(S),X=async function(){for(var Y=0;Y<A.length;Y++){var q=A[Y],L=q.file,N=q.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var j=(e.get().pendingImages||[]).filter(function(U){return U.url!==N}),B=(e.get().images||[]).slice();B.push(N),e.set({pendingImages:j,images:B});continue}try{var G=await Ce(ye+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de})});if(!G.ok)throw G.status===429?new Error("rate_limit"):new Error("sign failed");var K=await G.json();if(!K.folder)throw new Error("sign folder missing");var Q=new FormData;Q.append("file",L),Q.append("api_key",K.api_key),Q.append("timestamp",K.timestamp),Q.append("signature",K.signature),Q.append("folder",K.folder);var H=await fetch("https://api.cloudinary.com/v1_1/"+K.cloud_name+"/image/upload",{method:"POST",body:Q}),$=await H.json();if($.secure_url&&ca($.secure_url)){var Fe=(e.get().pendingImages||[]).some(function(U){return U.url===N});if(!Fe)continue;x[$.secure_url]=N,c[$.secure_url]=c[N];var ce=(e.get().pendingImages||[]).filter(function(U){return U.url!==N}),sr=(e.get().images||[]).slice();sr.push($.secure_url),e.set({pendingImages:ce,images:sr});try{Ce(ye+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de,secureUrl:$.secure_url,metadata:{assetId:$.asset_id,publicId:$.public_id,version:$.version,resourceType:$.resource_type,format:$.format,width:$.width,height:$.height,bytes:$.bytes,signature:$.signature}})}).catch(function(){})}catch(U){}}else throw new Error("invalid image url")}catch(U){console.error("[renuvex-pr] Image upload failed:",U);var vr=U.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(vr,"error");var Te=(e.get().pendingImages||[]).map(function(re){return re.url===N?{url:re.url,file:re.file,error:vr}:re});e.set({pendingImages:Te})}}};if(k===0&&z===0){t=!0;var W=!r.canNavigate||r.canNavigate();W&&e.goNext()}e.set({pendingImages:J}),X()}}};var P=e.onChange(f);return f(),{el:o,openPicker:function(){v.disabled||v.click()},destroy:function(){t=!0,v.onchange=null,P&&P()}}}var Ti=150*1024*1024,Ai=2,Mi=60,tn=8192,an=5,Pi=3e4,_i=["video/mp4","video/quicktime"],Li="renuvex_pr_video_upload_",nn="renuvex_pr_video_cancel_",wr=null,Za=!1,Ri={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},Ni={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},be=class extends Error{constructor(r,t,a){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=a||null}};function on(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:Ri[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:Ni[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function ln(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function At(e){return new Promise(function(r){setTimeout(r,e)})}function or(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function lr(e){return Math.max(0,Math.round(or()-e))}function Bi(){if(typeof window!="undefined"){var e=Number(window.__renuvexPrVideoUploadStallMs);if(Number.isFinite(e)&&e>=250)return e}return Pi}function Fi(e,r){return new Promise(function(t,a){var n=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(n),r&&r.removeEventListener("abort",o),a(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function Mt(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function Pt(e,r){return Li+de+"_"+e+"_"+Mt(r)}function dn(e,r){try{var t=window.sessionStorage.getItem(Pt(e,r)),a=t?JSON.parse(t):null;return!a||typeof a.token!="string"||!a.expiresAt||new Date(a.expiresAt).getTime()<=Date.now()?null:a}catch(n){return null}}function Ii(e,r,t){try{window.sessionStorage.setItem(Pt(e,r),JSON.stringify(t))}catch(a){}}function zr(e,r){try{window.sessionStorage.removeItem(Pt(e,r))}catch(t){}}function Oi(e,r){return nn+de+"_"+e+"_"+Mt(r)}function Ui(e,r,t,a){if(!(!e||!r||!t)){var n={token:e,productId:r,expiresAt:a||null};try{window.sessionStorage.setItem(Oi(r,t),JSON.stringify(n))}catch(i){}}}function Hi(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(nn+de+"_")!==0)){var a=window.sessionStorage.getItem(t),n=a?JSON.parse(a):null;if(!n||typeof n.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:n.token})}}}catch(i){}return e}function Qa(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function dr(e,r,t){var a=await Ce(ye+e,r,t||2e4),n=await a.json().catch(function(){return{}});if(!a.ok){var i=Number(a.headers.get("Retry-After"));throw new be(n.error||"video_request_failed",a.status,Number.isFinite(i)&&i>0?i:null)}return n.data||{}}async function kr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await dr("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:lr(r.startedAt),finalStatus:t})},4e3)}catch(a){}}async function Vi(e){try{return await dr("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Qa(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Qa(e.key),!0):!1}}function rt(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():wr||(wr=(async function(){for(var e=Hi(),r=0;r<e.length;r+=1)await Vi(e[r])})().finally(function(){wr=null}),wr)}function tt(){typeof window=="undefined"||Za||(Za=!0,window.addEventListener("online",function(){rt()}),rt())}async function Yi(){var e=await import("./upchunk-KBSCWYRQ.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function en(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}var Di={http_408:!0,http_502:!0,http_503:!0,http_504:!0};function ji(e){return Di[e]!==!0}async function Gi(e){var r=await Yi();return new Promise(function(t,a){var n=!1,i=null,o=null,l=Bi(),d=null;function u(x){n||(n=!0,o&&clearTimeout(o),e.signal&&e.signal.removeEventListener("abort",s),d&&d(),x?a(x):t())}function m(x){n||(o&&clearTimeout(o),!(!x&&typeof navigator!="undefined"&&navigator.onLine===!1)&&(o=setTimeout(function(){if(!n){e.onUploadError&&e.onUploadError("video_upload_stalled"),u(new be("video_upload_stalled",0,null));try{i&&i.abort()}catch(c){}}},l)))}function v(){return n?!1:(m(),!0)}function p(){if(!n){e.onUploadError&&e.onUploadError("video_upload_offline"),u(new be("video_upload_offline",0,null));try{i&&i.abort()}catch(x){}}}function s(){try{i&&i.abort()}catch(x){}u(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return a(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",s,{once:!0})}if(i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||tn,attempts:e.chunkAttempts||an,dynamicChunkSize:!0}),typeof window!="undefined"&&typeof window.addEventListener=="function"&&typeof window.removeEventListener=="function"&&(window.addEventListener("offline",p),d=function(){window.removeEventListener("offline",p)}),typeof navigator!="undefined"&&navigator.onLine===!1){p();return}m(),i.on("attempt",function(){v()&&e.onStatus("uploading")}),i.on("attemptFailure",function(x){if(v()){var c=x&&x.detail,f=en(c);if(e.onAttemptFailure&&e.onAttemptFailure(f),ji(f)){e.onUploadError&&e.onUploadError(f),u(new be(f,0,null));try{i&&i.abort()}catch(h){}return}e.onStatus("upload_retrying")}}),i.on("chunkSuccess",function(){v()}),i.on("progress",function(x){if(v()){var c=Number(x&&x.detail);if(Number.isFinite(c)){var f=Math.min(95,Math.max(0,Math.round(c*.95)));Number.isFinite(e.minProgress)&&(f=Math.max(e.minProgress,f)),e.onProgress(f)}}}),i.on("offline",p),i.on("error",function(x){if(v()){var c=x&&x.detail,f=en(c);e.onUploadError&&e.onUploadError(f),u(new be(f,0,null))}}),i.on("success",function(){v()&&(e.onProgress(95),u())})})}function Wi(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function rn(e,r,t){for(var a=Date.now(),n=a+600*1e3,i=0;Date.now()<n;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-a;try{var l=await dr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":l.status||"processing"),l.status==="ready")return l;if(l.status==="failed"||l.status==="aborted")throw new be(l.errorCode||"video_processing_failed",409,null)}catch(d){if(r.aborted||d instanceof be&&d.status===409||ln(d)||(i+=1,i>=3))throw d}await Fi(Wi(o),r)}throw new be("video_processing_delayed",0,null)}async function qi(e){for(var r=null,t=1;t<=3;t+=1)try{return await dr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(a){if(ln(a))return null;r=a,t<3&&await At(400*t)}throw r||new Error("video_status_failed")}async function Ki(e,r,t,a){for(var n=10;n<=90;n+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(n),await At(120)}return a("processing"),await At(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function pn(e){return!e||_i.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>Ti?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function un(e){return new Promise(function(r){var t=URL.createObjectURL(e),a=document.createElement("video"),n=!1;function i(o){if(!n){n=!0,a.removeAttribute("src");try{a.load()}catch(l){}URL.revokeObjectURL(t),r(o)}}a.preload="metadata",a.onloadedmetadata=function(){i(Number.isFinite(a.duration)?a.duration:null)},a.onerror=function(){i(null)},a.src=t,setTimeout(function(){i(null)},8e3)})}function sn(e){return e===null?{ok:!0}:e<Ai||e>Mi?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function vn(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return Ki(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:or(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(x){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=x||"upload_attempt_failed")}function a(){zr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}async function n(x,c){var f=await qi(x);if(!f)return{action:"discard"};if(f.status==="ready")return e.onToken&&e.onToken(x),e.onProgress(100),zr(e.productId,e.file),await kr(x,r,"ready"),{action:"return",value:Object.assign({token:x},f)};if(f.status==="uploaded"||f.status==="processing"){e.onToken&&e.onToken(x),e.onStatus("processing");var h=or(),b=await rn(x,e.signal,e.onStatus);return r.processingPollMs=lr(h),zr(e.productId,e.file),e.onProgress(100),await kr(x,r,"ready"),{action:"return",value:Object.assign({token:x},b)}}return f.status==="failed"||f.status==="aborted"?{action:"discard"}:!c||typeof c.uploadUrl!="string"||!c.uploadUrl?{action:"discard"}:{action:"upload"}}tt(),await rt();var i=dn(e.productId,e.file),o=i&&i.token,l=i;if(o){var d=await n(o,l);if(d.action==="return")return d.value;d.action==="discard"&&(a(),o=null,l=null)}for(;;){if(!o){var u=await dr("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:Mt(e.file)})});o=u.token,l=u,Ii(e.productId,e.file,u)}e.onToken&&e.onToken(o),r.chunkSizeKb=l.chunkSize||tn,r.chunkAttempts=l.chunkAttempts||an,e.onStatus("uploading");var m=or();try{await Gi({uploadUrl:l.uploadUrl,file:e.file,chunkSize:l.chunkSize,chunkAttempts:l.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=(r.directUploadMs||0)+lr(m),e.onStatus("processing");var v=or();await dr("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:o})},3e4),r.completeMs=lr(v);var p=or(),s=await rn(o,e.signal,e.onStatus);return r.processingPollMs=lr(p),zr(e.productId,e.file),e.onProgress(100),await kr(o,r,"ready"),Object.assign({token:o},s)}catch(x){throw r.directUploadMs=(r.directUploadMs||0)+lr(m),e.signal&&e.signal.aborted?(await kr(o,r,"aborted"),x):(await kr(o,r,"failed"),x)}}}async function at(e,r,t){var a=r&&t?dn(r,t):null;e&&r&&t&&Ui(e,r,t,a&&a.expiresAt),r&&t&&zr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(tt(),await rt())}function cn(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function Xi(e){return"Video Y\xFCkleniyor"}function $i(e){return!0}function mn(e,r){r=r||{};var t=!1,a=null,n=null,i=0,o=document.createElement("div");o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=ve("formStepMediaTitle"),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-step-subtitle",d.textContent=ve("formStepMediaSubtitle"),o.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-fwizard-media-card";var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",m.setAttribute("aria-label","Foto\u011Fraf ekle"),m.innerHTML=ue(Or)+"<span>Foto\u011Fraf Ekle</span>";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",v.setAttribute("aria-label","Video ekle"),v.innerHTML=ue(Xe)+"<span>Video Ekle</span>",u.appendChild(m),u.appendChild(v);var p=document.createElement("div");p.className="renuvex-pr-fwizard-media-content",u.appendChild(p),o.appendChild(u);var s=document.createElement("input");s.type="file",s.accept="video/mp4,video/quicktime,.mp4,.mov",s.style.display="none",o.appendChild(s);function x(){var y=e.get();return(y.images||[]).length>0||(y.pendingImages||[]).length>0}function c(){var y=e.get();return(y.images||[]).length+(y.pendingImages||[]).length}function f(){return e.get().videoUpload||null}function h(){return i+=1,i}function b(y,T){var R=f();return i===y&&!!R&&R.controller===T}function E(){if(!n){p.innerHTML="";return}n.retry.onclick=null,p.innerHTML="",n=null}function P(){a&&(a.destroy&&a.destroy(),a=null)}function w(y){P(),p.innerHTML="";var T=cn(y),R=document.createElement("div");R.className=T==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":T==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var I=null,V=null,J=null,X=null,W=document.createElement("button");if(W.type="button",W.className="renuvex-pr-fwizard-video-retry",W.textContent="Tekrar dene",W.setAttribute("aria-label","Video y\xFCklenemedi, tekrar dene"),T==="ready"){var Y=y.posterUrl||y.localUrl||"";Y&&Y!==y.localUrl?(I=document.createElement("img"),I.alt="",I.src=Y):(I=document.createElement("video"),I.muted=!0,I.playsInline=!0,I.preload="metadata",I.src=y.localUrl||""),I.className="renuvex-pr-fwizard-video-preview",R.appendChild(I)}else T==="busy"?(X=document.createElement("div"),X.className="renuvex-pr-fwizard-video-uploading-status",X.setAttribute("role","status"),X.setAttribute("aria-live","polite"),R.appendChild(X)):V=R;if(T==="ready"){let j=function(B){B&&(B.preventDefault(),B.stopPropagation()),S()};var N=j,q=document.createElement("button");q.type="button",q.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",q.setAttribute("aria-label","Videoyu kald\u0131r");var L=ee(we);L&&q.appendChild(L),q.addEventListener("pointerdown",j),q.addEventListener("click",j),R.appendChild(q)}p.appendChild(R),n={mode:T,card:R,preview:I,previewUrl:T==="ready"&&(y.posterUrl||y.localUrl)||"",details:V,name:J,status:X,retry:W}}function C(){if(!t){var y=f();if(!y){E();return}var T=cn(y),R=T==="ready"&&(y.posterUrl||y.localUrl)||"";if((!n||n.mode!==T||n.previewUrl!==R)&&w(y),n.name&&(n.name.textContent=y.file?y.file.name:"Video"),n.status&&T==="busy"){var I=Xi(y),V=$i(y)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+I+"</span>":"<span>"+I+"</span>";n.status.innerHTML!==V&&(n.status.innerHTML=V)}var J=T==="failed"&&!!(y.error&&y.file&&y.retryable!==!1);n.retry.onclick=J?function(){k(y.file,y.localUrl,y.durationMs)}:null,J&&n.details&&!n.retry.isConnected?n.details.appendChild(n.retry):!J&&n.retry.isConnected&&n.retry.remove()}}function g(){var y=x(),T=c()>=Qr,R=!!f(),I=y||R;m.hidden=I,v.hidden=I,m.disabled=R||T,v.disabled=y||R,u.classList.toggle("renuvex-pr-fwizard-media-card--has-media",I),u.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",y),u.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",R),m.classList.toggle("renuvex-pr-fwizard-media-action--active",y),v.classList.toggle("renuvex-pr-fwizard-media-action--active",R)}function z(y){var T=f();if(T){var R=Object.keys(y),I=R.some(function(V){return T[V]!==y[V]});I&&e.set({videoUpload:Object.assign({},T,y)})}}function M(y,T,R){b(y,T)&&z(R)}async function k(y,T,R){var I=f(),V=!!(T&&I&&I.file===y),J=V?Math.max(0,Math.min(95,Number(I.progress)||0)):0,X=V?(Number(I.retryClicks)||0)+1:0,W=pn(y);if(!W.ok){r.showToast&&r.showToast(W.message,"error");return}var Y=T||URL.createObjectURL(y),q=Number.isFinite(R)?R:null,L=new AbortController,N=h();e.set({videoUpload:{file:y,localUrl:Y,token:V&&I.token||null,status:"uploading",progress:J,durationMs:q,error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:X,controller:L}}),!V&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var j=R!==void 0?Number.isFinite(R)?R/1e3:null:await un(y),B=sn(j);if(!B.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:B.message});var G=await vn({file:y,productId:e.get().productId,signal:L.signal,minProgress:J,retryClicks:X,onToken:function(H){M(N,L,{token:H})},onProgress:function(H){M(N,L,{progress:H})},onStatus:function(H){M(N,L,{status:H})},onSessionReset:function(){M(N,L,{token:null,progress:0})}});if(!b(N,L))return;if(G.previewOnly&&G.posterUrl&&G.posterUrl!==Y)try{URL.revokeObjectURL(G.posterUrl)}catch(H){}z({token:G.token,status:"ready",progress:100,posterUrl:G.previewOnly?Y:G.posterUrl,durationMs:G.durationMs||(j===null?null:Math.round(j*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),V&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(H){if(L.signal.aborted||!b(N,L))return;var K=on(H);if(H&&H.code==="invalid_video_duration"&&(K={code:"invalid_video_duration",message:H.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),z({status:"failed",error:K.message,errorCode:K.code,retryable:K.retryable,retryAfterSec:K.retryAfterSec,controller:null}),r.showToast){var Q=K.code==="invalid_video_duration"?K.message:"Video y\xFCklenemedi";r.showToast(Q,"error")}}}function S(){var y=f();y&&(h(),y.controller&&y.controller.abort(),at(y.token,e.get().productId,y.file),r.revokeBlobUrl&&r.revokeBlobUrl(y.localUrl),e.set({videoUpload:null}))}function A(y){if(a){y&&a.openPicker&&a.openPicker();return}n=null,p.innerHTML="",a=et(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),p.appendChild(a.el),y&&a.openPicker&&a.openPicker()}m.onclick=function(){m.disabled||A(!0)},v.onclick=function(){v.disabled||(P(),p.innerHTML="",s.click())},s.onchange=function(){var y=s.files&&s.files[0];s.value="",y&&k(y,null,void 0)};var _=!!f(),O=e.onChange(function(){g();var y=!!f();(y||_)&&C(),_=y});return g(),x()&&A(!1),f()&&C(),{el:o,destroy:function(){t=!0,m.onclick=null,v.onclick=null,s.onchange=null,a&&a.destroy&&a.destroy(),O&&O()}}}var _t=2e3,Ji=60;function fn(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=ve("formStepContentTitle"),a.appendChild(n);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Ji,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var l=document.createElement("textarea");l.className="renuvex-pr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=_t,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",i.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),i.appendChild(d);function u(){var v=l.value.length;d.textContent=v+"/"+_t,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",v>=_t)}function m(){return ir(3,e.get())}return l.addEventListener("input",function(){e.set({comment:l.value}),u(),t(m())}),a.appendChild(i),u(),setTimeout(function(){t(m())},0),{el:a,destroy:function(){}}}var Zi=40;function xn(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ve("formStepAuthorTitle"),n.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var l=document.createElement("div");l.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Zi,u.setAttribute("aria-required","true"),u.value=e.get().author||"",l.appendChild(d),l.appendChild(u),o.appendChild(l);var m=document.createElement("div");m.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.textContent="E-posta (opsiyonel)";var p=document.createElement("input");p.type="email",p.className="renuvex-pr-fwizard-input",p.setAttribute("autocomplete","email"),p.value=e.get().email||"",m.appendChild(v),m.appendChild(p),o.appendChild(m);var s=document.createElement("div");s.className="renuvex-pr-fwizard-notice",s.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(s);var x=document.createElement("div");x.className="renuvex-pr-fwizard-msg",x.setAttribute("role","alert"),x.setAttribute("aria-live","assertive"),o.appendChild(x);var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-submit-btn",c.textContent="G\xF6nder",o.appendChild(c),n.appendChild(o);function f(){return ir(4,e.get())}function h(g){c.classList.remove("renuvex-pr-fwizard-submit-btn--video-pending"),c.textContent=g}function b(){c.classList.add("renuvex-pr-fwizard-submit-btn--video-pending"),c.textContent="";var g=document.createElement("span");g.className="renuvex-pr-fwizard-video-dots",g.setAttribute("aria-hidden","true"),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span"));var z=document.createElement("span");z.textContent="Video Haz\u0131rlan\u0131yor",c.appendChild(g),c.appendChild(z)}function E(){var g=!f(),z=(e.get().pendingImages||[]).length,M=z>0,k=e.get().videoUpload,S=!!(k&&k.status==="failed"),A=!!(k&&k.status!=="ready"&&k.status!=="failed");M||A||S?(c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),S?h("Video Y\xFCklenemedi"):A?b():h("Foto\u011Fraflar Y\xFCkleniyor...")):(c.disabled=g,c.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",g),h("G\xF6nder"))}u.addEventListener("input",function(){e.set({author:u.value}),E(),t(f())}),p.addEventListener("input",function(){e.set({email:p.value})}),E(),setTimeout(function(){t(f())},0);function P(){x.textContent=""}function w(g){P();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=g||"",x.appendChild(z)}c.onclick=async function(){if(!c.disabled){var g=e.get(),z=(g.author||"").trim(),M=(g.comment||"").trim();if(p.value.trim()&&!p.checkValidity()){p.reportValidity();return}if(!z){w("Gerekli alan");return}if(!g.rating){w("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var k=c.textContent;if(c.textContent="G\xF6nderiliyor\u2026",P(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),a()},600);return}try{var S=sa(window.location.href),A=g.productName||null,_=await Ce(ye+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de,productId:g.productId||null,slug:S||null,productName:A,author:z,title:(g.title||"").trim()||null,comment:M||null,rating:g.rating,images:g.videoUpload?[]:g.images||[],videoToken:g.videoUpload&&g.videoUpload.status==="ready"?g.videoUpload.token:null})},15e3);if(_.ok)g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),a();else{var O=await _.json().catch(function(){return{}});throw new Error(O.error||"Yorum kaydedilemedi.")}}catch(R){var y=R&&(R.name==="AbortError"||/signal/i.test(R.message||"")),T=y?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":R.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(T,"error"):w(T),c.disabled=!1,c.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent=k}}};var C=e.onChange(E);return{el:n,destroy:function(){c.onclick=null,C&&C()}}}function Qi(e,r,t){if(t=t||{},e===1)return Ja(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return mn(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return et(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return fn(r,{onValidityChange:t.onValidityChange});if(e===4)return xn(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function gn(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function hn(e){e=e||{},tt();var r=Xa({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:F&&F.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},a={},n={};function i(k){if(!(!k||typeof k!="string"||!k.startsWith("blob:")||n[k])){n[k]=!0;try{URL.revokeObjectURL(k)}catch(S){}}}function o(){Object.keys(a).forEach(function(S){i(S)}),Object.keys(t).forEach(function(S){i(t[S])});var k=r.get();(k.pendingImages||[]).forEach(function(S){i(S&&S.url)}),(k.images||[]).forEach(function(S){i(S)}),k.videoUpload&&i(k.videoUpload.localUrl)}function l(){var k=r.get(),S=k.videoUpload;!S||k.videoSubmitted||(S.controller&&S.controller.abort(),at(S.token,k.productId,S.file))}var d=Ka({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",m),Kr(u),l(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=qr(),m=function(k){d&&d.close&&d.close()};window.addEventListener("popstate",m);var v=document.createElement("div");v.className="renuvex-pr-fwizard-step-wrap";var p=$a({skippableSteps:[2],nextableSteps:[3],onBack:function(){c==="idle"&&r.goBack()},onSkip:function(){c==="idle"&&r.goNext()},onNext:function(){c==="idle"&&r.goNext()}}),s=document.createElement("div");s.className="renuvex-pr-fwizard-layout",s.appendChild(v),s.appendChild(p.el);var x=null,c="idle",f=null,h=!0,b=null;function E(k,S){v.innerHTML="";var A=Qi(k,r,{canNavigate:function(){return c==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:i,onValidityChange:function(y){p.setNextDisabled(!y)},onSuccess:w,showToast:d.showToast});if(x=A,p.update(k,r.get()),S){c="entering",A.el.classList.add("renuvex-pr-fwizard-step--enter");var _=null,O=function(){_&&clearTimeout(_),A.el.removeEventListener("animationend",O),A.el.classList.remove("renuvex-pr-fwizard-step--enter"),c="idle",f!==null&&C()};A.el.addEventListener("animationend",O),_=setTimeout(O,700)}else c="idle";v.appendChild(A.el),d.setStepAttr&&d.setStepAttr(k),k===3&&p.setNextDisabled(!0)}var P=!1;function w(){if(!P){if(P=!0,!x){v.innerHTML="";var k=gn();k.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(k),d.setStepAttr("thanks"),p.setThanksState(d.close);return}var S=x;c="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var A=function(){if(b&&clearTimeout(b),S.el.removeEventListener("animationend",A),S.destroy)try{S.destroy()}catch(O){}x===S&&(x=null),v.innerHTML="";var _=gn();_.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(_),d.setStepAttr("thanks"),p.setThanksState(d.close),c="idle"};S.el.addEventListener("animationend",A),b=setTimeout(A,300)}}function C(){var k=r.get().currentStep;if(c!=="idle"){f=k;return}if(!x){var S=!h;h=!1,E(k,S);return}var A=x;c="exiting",A.el.classList.add("renuvex-pr-fwizard-step--exit");var _=function(){if(b&&clearTimeout(b),A.el.removeEventListener("animationend",_),A.destroy)try{A.destroy()}catch(y){}if(x===A){v.innerHTML="",x=null;var O=f!==null?f:r.get().currentStep;f=null,E(O,!0),c="idle"}};A.el.addEventListener("animationend",_),b=setTimeout(_,350)}C();var g=r.get().currentStep,z=r.onChange(function(k){k.currentStep!==g?(g=k.currentStep,C()):p.update(k.currentStep,k)}),M=d.close;return d.close=function(){z&&z(),typeof b!="undefined"&&b&&clearTimeout(b),M()},d.open(s),{close:d.close}}var eo=4e3;async function bn(){var e=await Ce(ye+"/api/public/upload/video/capability?storeId="+encodeURIComponent(de),{method:"GET",cache:"no-store"},eo);if(!e.ok){var r=new Error("video_capability_unavailable");throw r.code="video_capability_http",r.status=e.status,r}var t=await e.json().catch(function(){return{}}),a=t&&t.data;if(!a||typeof a.enabled!="boolean"){var n=new Error("video_capability_invalid");throw n.code="video_capability_invalid",n}return{enabled:a.enabled===!0,reason:typeof a.reason=="string"?a.reason:null}}var nt=null;function yn(){return F&&F.videoReviewsEnabled===!0}function ro(e){var r=e&&Number(e.status),t=Number.isFinite(r)&&r>=100;return yn()&&!t?{enabled:!0,reason:"capability_unavailable"}:{enabled:!1,reason:"capability_unavailable"}}function to(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function ao(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:yn(),reason:null};else try{t=await bn()}catch(a){t=ro(a)}hn({productId:Z||"",productName:Oe||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function ne(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=to(r);return nt||(nt=ao(r,Pe()).finally(function(){nt=null})),nt.finally(t)}var wn=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var no={id:"classic",name:"Klasik (A\xE7\u0131k)"},io=wn;function oo(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentMediaFilter,v=e.onFilterChange,p=e.onSortChange;Le(n);var s=document.createElement("div");s.className="renuvex-pr-summary";var x=(o[3]||0)+(o[4]||0),c=i>0?Math.round(x/i*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-avg",f.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+pe("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",s.appendChild(f);var h=document.createElement("div");if(h.className="renuvex-pr-summary-block renuvex-pr-summary-count",h.textContent=i.toLocaleString("tr-TR")+" "+D(a.countLabel,"Yorum"),s.appendChild(h),a.showRecommendation!==!1&&c>0){var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",b.innerHTML='<span class="renuvex-pr-recommend-pct">%'+c+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",s.appendChild(b)}return s.appendChild(ar({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:d,onFilterChange:v})),s.appendChild(le({widget:r,currentOrderBy:u,currentMediaFilter:m,onWriteClick:ne,onSortChange:p})),s}var Rt={};Me(Rt,{css:()=>po,meta:()=>lo,render:()=>co});var kn=`
...
`;var lo={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},po=kn,uo="__unknown_product__",Sr=Object.create(null);function so(e){return e?String(e):uo}var je=null,Cr=null;function vo(){!je||!Cr||(je.removeEventListener?je.removeEventListener("change",Cr):je.removeListener&&je.removeListener(Cr),je=null,Cr=null)}function co(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentMediaFilter,v=e.onFilterChange,p=e.onSortChange,s=so(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Re(l,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+ue(pa)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),E=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+D(a.countLabel,"Yorum")),b&&E){var P=document.createElement("span");P.className="renuvex-pr-compact-trigger-count",h.insertBefore(P,b),P.appendChild(b),P.appendChild(E)}f.appendChild(h),c.appendChild(f);var w=le({widget:r,currentOrderBy:u,currentMediaFilter:m,onWriteClick:ne,onSortChange:p}),C=w.querySelector(".renuvex-pr-filter-wrap"),g=w.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");z.className="renuvex-pr-compact-actions-slot",g&&z.appendChild(g),C&&z.appendChild(C),c.appendChild(z),x.appendChild(c);var M=document.createElement("div");M.className="renuvex-pr-compact-panel",M.setAttribute("role","dialog"),M.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),M.setAttribute("aria-hidden","true");var k=document.createElement("div");k.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+pe("full")+"</span><span>"+l+"</span>",k.appendChild(S),k.appendChild(ar({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:d,onFilterChange:function(B){_()&&M.classList.contains("renuvex-pr-open")&&(Sr[s]=!0),v(B)}})),M.appendChild(k);var A=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function _(){return!!(A&&A.matches)}function O(B){B?M.classList.add("renuvex-pr-open"):M.classList.remove("renuvex-pr-open"),M.setAttribute("aria-hidden",B?"false":"true"),h.setAttribute("aria-expanded",B?"true":"false")}function y(B){var G=B?x:f;if(M.parentNode!==G){var K=!!M.parentNode;M.classList.contains("renuvex-pr-open")&&O(!1),K&&(Sr[s]=!1),G.appendChild(M)}}y(A?A.matches:!1);var T=le({widget:r,currentOrderBy:u,currentMediaFilter:m,onWriteClick:ne,onSortChange:p}),R=T.querySelector(".renuvex-pr-filter-wrap"),I=T.querySelector(".renuvex-pr-write-btn"),V=document.createElement("div");V.className="renuvex-pr-compact-write-row",I&&V.appendChild(I),R&&V.appendChild(R),x.appendChild(V);function J(){var B=M.classList.contains("renuvex-pr-open");return O(!1),_()&&(Sr[s]=!1),B}function X(){W&&W.notifyOpening(),O(!0),_()&&(Sr[s]=!0)}h.onclick=function(){M.classList.contains("renuvex-pr-open")?J():X()};var W=null;function Y(B){W&&(W.unregister(),W=null),B||(W=Zr({trigger:f,element:M,close:J}))}if(Y(A?A.matches:!1),vo(),A){var q=function(B){y(B.matches),Y(B.matches)};A.addEventListener?A.addEventListener("change",q):A.addListener&&A.addListener(q),je=A,Cr=q}if(_()&&Sr[s]&&O(!0),a.showRecommendation!==!1){var L=(o[3]||0)+(o[4]||0),N=i>0?Math.round(L/i*100):0;if(N>0){var j=document.createElement("div");j.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="renuvex-pr-recommend-pct">%'+N+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(j)}}return x}var Nt={};Me(Nt,{css:()=>fo,meta:()=>mo,render:()=>xo});var zn=`
...
`;var mo={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},fo=zn;function xo(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentMediaFilter,m=e.onFilterChange,v=e.onSortChange;Le(a);var p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+pe("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(x);var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",c.textContent=n.toLocaleString("tr-TR")+" "+D(t.countLabel,"Yorum"),s.appendChild(c),p.appendChild(s);var f=document.createElement("div");f.className="renuvex-pr-split-col renuvex-pr-split-mid",f.appendChild(ar({ratingCounts:i,allCount:n,iconPair:a,currentRatingFilter:l,onFilterChange:m})),p.appendChild(f);var h=le({widget:r,currentOrderBy:d,currentMediaFilter:u,onWriteClick:ne,onSortChange:v}),b=h.querySelector(".renuvex-pr-filter-wrap"),E=h.querySelector(".renuvex-pr-write-btn"),P=document.createElement("div");P.className="renuvex-pr-split-col renuvex-pr-split-right",E&&P.appendChild(E),b&&P.appendChild(b),p.appendChild(P);var w=(i[3]||0)+(i[4]||0),C=n>0?Math.round(w/n*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",g.innerHTML='<span class="renuvex-pr-recommend-pct">%'+C+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var z=t.showRecommendation===!1||C===0;return z&&g.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(g),p}var Bt={};Me(Bt,{css:()=>ho,meta:()=>go,render:()=>bo});var Sn=`
...
`;var yo={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},wo=Cn;function ko(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,l=e.currentMediaFilter,d=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var m=document.createElement("div");m.className="renuvex-pr-hero-info";var v=document.createElement("div");v.className="renuvex-pr-hero-rating-col";var p=document.createElement("span");p.className="renuvex-pr-hero-avg",p.textContent=i,v.appendChild(p);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var x=document.createElement("span");x.className="renuvex-pr-hero-stars",x.innerHTML=Re(i,a),s.appendChild(x);var c=document.createElement("div");c.className="renuvex-pr-hero-count",c.textContent=n.toLocaleString("tr-TR")+" "+D(t.countLabel,"Yorum"),s.appendChild(c),v.appendChild(s),m.appendChild(v),u.appendChild(m);var f=le({widget:r,currentOrderBy:o,currentMediaFilter:l,onWriteClick:ne,onSortChange:d}),h=f.querySelector(".renuvex-pr-filter-wrap"),b=f.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");E.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",b&&E.appendChild(b),h&&E.appendChild(h),u.appendChild(E);var P=le({widget:r,currentOrderBy:o,currentMediaFilter:l,onWriteClick:ne,onSortChange:d}),w=P.querySelector(".renuvex-pr-filter-wrap"),C=P.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");return g.className="renuvex-pr-hero-write-row",C&&g.appendChild(C),w&&g.appendChild(w),u.appendChild(g),u}var En=`
  .renuvex-pr-summary{
...
`;var Eo={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},To=Mn;function Ao(e,r){var t=Ne(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=ke(e.rating,F),i.appendChild(o);var l=document.createElement("span");l.className="renuvex-pr-review-list-author-name",l.textContent=e.author||"",i.appendChild(l);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=ze(e.createdAt),i.appendChild(d),n.appendChild(i);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var m=document.createElement("div");m.className="renuvex-pr-review-list-title",m.textContent=e.title,u.appendChild(m)}var v=(e.comment||"").trim();v&&u.appendChild(pr(v,"renuvex-pr-review-list-body").fragment);var p=ur(e.merchantReply);if(p&&u.appendChild(p),n.appendChild(u),a){var s=document.createElement("div");s.className="renuvex-pr-review-list-media",t.forEach(function(x){var c=Be(x,{sourceWidth:oe,width:oe,height:Math.round(oe*4/3),onOpen:function(){me(e,x.url,r)}});c&&s.appendChild(c)}),n.appendChild(s)}return n}var Ut={};Me(Ut,{css:()=>Po,meta:()=>Mo,render:()=>_o});var Pn=`
...
`;var Mo={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Po=Pn;function _o(e,r){var t=xe(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=ke(e.rating,F),i.appendChild(o),e.title){var l=document.createElement("div");l.className="renuvex-pr-review-gallery-title",l.textContent=e.title,i.appendChild(l)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",i.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=ze(e.createdAt),i.appendChild(u);var m=(e.comment||"").trim();if(m&&i.appendChild(pr(m,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){me(e,t.url,r)}}:null).fragment),n.appendChild(i),a){var v=document.createElement("div");v.className="renuvex-pr-review-gallery-media";var p=Be(t,{sourceWidth:Ur,width:Ur,height:Math.round(Ur*4/3),onOpen:function(){me(e,t.url,r)}});p&&v.appendChild(p),n.appendChild(v)}var s=ur(e.merchantReply,t?function(){me(e,t.url,r)}:null);return s&&(s.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(s)),n}var lt={card:It,list:Ot,gallery:Ut};function dt(e){return lt[e]||lt.card}function _n(){return Object.keys(lt).map(function(e){return lt[e].css||""}).join(`
`)}var Ht=0;function Ge(){return Ht++,Ht}function We(e,r){return e!==Ht?!1:r?!(r.productId!==void 0&&Z!==r.productId||r.orderBy!==void 0&&te!==r.orderBy||r.page!==void 0&&mr!==r.page||r.ratingFilter!==void 0&&ie!==r.ratingFilter||r.mediaFilter!==void 0&&ae!==r.mediaFilter||r.nextCursor!==void 0&&_r!==r.nextCursor):!0}var Vt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,mediaGalleryTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,mediaGalleryTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,mediaGalleryTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Yt={small:80,medium:110,large:140},Dt={small:80,medium:100,large:110};function Ln(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),a.appendChild(n),a.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var l=document.createElement("div");return l.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",l.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(l),r}function Rn(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var a=document.createElement("div");a.className="renuvex-pr-empty-state-stars",a.innerHTML=Re(0,e.iconPair),t.appendChild(a);var n=document.createElement("p");n.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",n.setAttribute("role","status"),n.setAttribute("aria-live","polite"),n.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(n),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function Nn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function Bn(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function Ee(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+a+","+n+","+i+","+r+")"}function pt(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function jt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function Fn(e){return .2126*jt(e.r)+.7152*jt(e.g)+.0722*jt(e.b)}function In(e,r){var t=Fn(e),a=Fn(r),n=Math.max(t,a),i=Math.min(t,a);return(n+.05)/(i+.05)}function Lo(e){var r=pt(e)||pt("#ffffff"),t=pt("#111111"),a=pt("#ffffff");return In(t,r)>=In(a,r)?"#111111":"#ffffff"}function Ro(e){return Ee(e,e==="#ffffff"?.1:.06)}function On(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",l=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=Ee(o,.06),m=r.reviewStarColor||"#f59e0b",v=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",s=r.btnBorderColor||"#111111",x=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",f=r.filterBtnBorderColor||"#111111",h=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",E=r.filterItemTextColor||"#111111",P=r.filterItemHoverBgColor||"#f3f4f6",w=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",g=r.reviewAuthorColor||"#111111",z=r.reviewDateColor||"#5e5e5e",M=r.reviewBodyColor||"#111111",k=r.reviewBorderColor||"#e5e7eb",S=Ee(M,.65),A=r.replyBgColor||"#f9fafb",_=r.replyBorderColor||"#747474",O=r.replyLabelColor||"#111111",y=r.replyTextColor||"#111111",T=r.mediaGalleryTitleColor||"#111111",R=Ee("#111111",.05),I=r.mediaGalleryArrowBgColor||"#ffffff",V=r.mediaGalleryArrowTextColor||"#111111",J=Ee("#111111",.12),X=r.reviewLightboxVideoIconColor||"#ffffff",W=r.reviewLightboxVideoProgressColor||"#ffffff",Y=r.reviewLightboxVideoProgressTrackColor||"#000000",q=r.formBgColor||"#ffffff",L=r.formPrimaryTextColor||"#111111",N=r.formSecondaryTextColor||"#3b3b3b",j=r.inputTextColor||L,B=r.inputBorderColor||"#d1d5db",G=r.placeholderColor||"#9ca3af",K=r.formStepBarColor||"#111111",Q=r.formBtnBgColor||"#111111",H=r.formBtnTextColor||"#ffffff",$=r.formBtnBorderColor||"#111111",Fe=Ee(Q,.06),ce=Ee(Q,.18),sr=Ee(H,.85),vr=Ee(L,.06),Te=Lo(q),U=Ro(Te),re=r.loadMoreBgColor||"#ffffff",Ae=r.loadMoreTextColor||"#111111",Ie=r.loadMoreBorderColor||"#111111",Er=r.paginationBgColor||"#ffffff",Tr=r.paginationTextColor||"#111111",Ar=r.paginationBorderColor||"#e5e7eb",Mr=r.paginationActiveBgColor||"#111111",Pr=r.paginationActiveTextColor||"#ffffff",fe={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":l,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":v,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":s,"--renuvex-pr-filter-btn-bg":x,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":f,"--renuvex-pr-filter-menu-bg":h,"--renuvex-pr-filter-menu-border":b,"--renuvex-pr-filter-item-text":E,"--renuvex-pr-filter-item-hover-bg":P,"--renuvex-pr-filter-item-active":w,"--renuvex-pr-review-title":C,"--renuvex-pr-review-author":g,"--renuvex-pr-review-date":z,"--renuvex-pr-review-body":M,"--renuvex-pr-review-border":k,"--renuvex-pr-state-text":S,"--renuvex-pr-review-star-color":m,"--renuvex-pr-reply-bg-color":A,"--renuvex-pr-reply-border":_,"--renuvex-pr-reply-label":O,"--renuvex-pr-reply-text":y,"--renuvex-pr-media-gallery-title":T,"--renuvex-pr-media-gallery-image-border":R,"--renuvex-pr-media-gallery-arrow-bg":I,"--renuvex-pr-media-gallery-arrow-text":V,"--renuvex-pr-media-gallery-arrow-border":J,"--renuvex-pr-review-lightbox-video-icon":X,"--renuvex-pr-review-lightbox-video-progress":W,"--renuvex-pr-review-lightbox-video-progress-track":Y,"--renuvex-pr-fwizard-bg":q,"--renuvex-pr-fwizard-text":L,"--renuvex-pr-fwizard-secondary-text":N,"--renuvex-pr-fwizard-input-bg":q,"--renuvex-pr-fwizard-input-text":j,"--renuvex-pr-fwizard-input-border":B,"--renuvex-pr-fwizard-placeholder":G,"--renuvex-pr-fwizard-close-text":Te,"--renuvex-pr-fwizard-close-hover-bg":U,"--renuvex-pr-fwizard-progress-bg":vr,"--renuvex-pr-fwizard-progress-active":K,"--renuvex-pr-fwizard-btn-bg":Q,"--renuvex-pr-fwizard-btn-text":H,"--renuvex-pr-fwizard-btn-border":$,"--renuvex-pr-fwizard-btn-disabled-bg":ce,"--renuvex-pr-fwizard-btn-disabled-text":sr,"--renuvex-pr-fwizard-nav-hover-bg":Fe,"--renuvex-pr-load-more-bg":re,"--renuvex-pr-load-more-text":Ae,"--renuvex-pr-load-more-border":Ie,"--renuvex-pr-pagination-bg":Er,"--renuvex-pr-pagination-text":Tr,"--renuvex-pr-pagination-border":Ar,"--renuvex-pr-pagination-active-bg":Mr,"--renuvex-pr-pagination-active-text":Pr};Object.keys(fe).forEach(function(cr){e.style.setProperty(cr,fe[cr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Un(e){var r=e.settings||{},t=e.root,a=e.currentMediaFilter||"none";if(!(r.showMediaGallery!==!1&&a==="none"))return null;var n=document.createElement("div");n.className="renuvex-pr-media-gallery-section renuvex-pr-media-gallery-section--placeholder",n.setAttribute("aria-hidden","true");var i=r.reviewLayout==="card"?"1/1":"3/4";if(t&&t.style.setProperty("--renuvex-pr-media-gallery-thumb-aspect",i),r.showMediaGalleryTitle!==!1){var o=document.createElement("div");o.className="renuvex-pr-media-gallery-title",o.textContent=D(r.mediaGalleryTitle,"M\xFC\u015Fteri G\xF6rselleri"),n.appendChild(o)}var l=document.createElement("div");l.className="renuvex-pr-media-gallery-strip-wrap";var d=document.createElement("div");d.className="renuvex-pr-media-gallery-strip";var u=document.createElement("div");return u.className="renuvex-pr-media-gallery-thumb renuvex-pr-media-gallery-thumb--placeholder",d.appendChild(u),l.appendChild(d),n.appendChild(l),n}function Gt(e){var r=e.settings,t=e.root,a=e.currentMediaFilter||"none",n=e.openReviewModal,i=(e.mediaStripReviews||[]).filter(function(E){return Ne(E).length>0});if(!(r.showMediaGallery!==!1&&a==="none"&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-media-gallery-section",r.showMediaGalleryTitle!==!1){var l=D(r.mediaGalleryTitle,"M\xFC\u015Fteri G\xF6rselleri"),d=document.createElement("div");d.className="renuvex-pr-media-gallery-title",d.textContent=l,o.appendChild(d)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-media-gallery-thumb-aspect",u);var m=document.createElement("div");m.className="renuvex-pr-media-gallery-strip";var v=oe,p=r.reviewLayout==="card"?oe:Math.round(oe*4/3),s=0;i.forEach(function(E){if(!(s>=15)){var P=xe(E);if(P){var w=Be(P,{className:"renuvex-pr-media-gallery-thumb",sourceWidth:oe,width:v,height:p,loading:s<3?"eager":"lazy",onOpen:function(){n(E,P.url,i,{source:"mediaGallery"})}});w&&(m.appendChild(w),s++)}}});var x=document.createElement("button");x.className="renuvex-pr-media-gallery-arrow renuvex-pr-media-gallery-arrow-prev";var c=ee(Ke);c&&x.appendChild(c),x.setAttribute("aria-label","\xD6nceki"),x.onclick=function(){m.scrollBy({left:-200,behavior:"smooth"})};var f=document.createElement("button");f.className="renuvex-pr-media-gallery-arrow renuvex-pr-media-gallery-arrow-next";var h=ee(Ir);h&&f.appendChild(h),f.setAttribute("aria-label","Sonraki"),f.onclick=function(){m.scrollBy({left:200,behavior:"smooth"})};var b=document.createElement("div");return b.className="renuvex-pr-media-gallery-strip-wrap",b.appendChild(x),b.appendChild(m),b.appendChild(f),o.appendChild(b),o}var No=1,Bo=7,Wt="\u2026";function Fo(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Bo){for(var n=[],i=1;i<=t;i++)n.push(i);return n}for(var o=[],l=1;l<=t;l++)(l===1||l===t||Math.abs(l-a)<=No)&&o.push(l);for(var d=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&d.push(Wt),d.push(o[u]);return d}function Hn(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function i(d){n.setAttribute("aria-busy","true");for(var u=n.querySelectorAll("button"),m=0;m<u.length;m++)u[m].disabled=!0;a(d)}function o(d,u){var m=document.createElement("span");m.className="renuvex-pr-pagination-label",m.setAttribute("aria-hidden","true"),m.textContent=u,d.appendChild(m)}function l(d,u,m,v){var p=document.createElement("button");return p.type="button",p.className="renuvex-pr-pagination-arrow",p.setAttribute("aria-label",d),o(p,u),v?p.disabled=!0:p.onclick=function(){i(m)},p}return n.appendChild(l("\xD6nceki sayfa","\u2039",t-1,t<=1)),Fo(t,r).forEach(function(d){if(d===Wt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=Wt,n.appendChild(u);return}var m=document.createElement("button");m.type="button",m.className="renuvex-pr-pagination-btn",m.setAttribute("aria-label","Sayfa "+d),o(m,String(d)),d===t?m.setAttribute("aria-current","page"):m.onclick=function(){i(d)},n.appendChild(m)}),n.appendChild(l("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Vn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Yn(e){var r=e.render;async function t(){var o=Ge(),l=Z,d=te,u=ie,m=ae;_e(null);var v=await Ye(Z,te,1,ie,ae);We(o,{productId:l,orderBy:d,ratingFilter:u,mediaFilter:m})&&await r(Z,F,v,Oe,te,1,Xt)}async function a(o){var l=Ge(),d=ie===o?null:o,u=Z,m=te,v=ae;Jt(d),Ue(1),_e(null);var p=await Ye(Z,te,1,d,ae);We(l,{productId:u,orderBy:m,page:1,ratingFilter:d,mediaFilter:v})&&await r(Z,F,p,Oe,te,1)}async function n(o,l){var d=Ge(),u=Z,m=ie;Ue(1),_e(null);var v=o,p=l==="images"||l==="media"?l:"none";p!=="none"&&(v="newest"),Zt(p),Lr(v);var s=await Ye(Z,v,1,ie,p);We(d,{productId:u,orderBy:v,page:1,ratingFilter:m,mediaFilter:p})&&await r(Z,F,s,Oe,v,1)}async function i(o){var l=Ge(),d=Z,u=te,m=ie,v=ae;Ue(o),_e(null);var p=await Ye(Z,te,o,ie,ae);if(We(l,{productId:d,orderBy:u,page:o,ratingFilter:m,mediaFilter:v})){await r(Z,F,p,Oe,te,o);var s=document.getElementById("renuvex-reviews"),x=s&&s.shadowRoot,c=x&&x.querySelector&&x.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(c){try{c.focus({preventScroll:!0})}catch(b){try{c.focus()}catch(E){}}Vn(x,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var f=document.getElementById("renuvex-reviews");if(f&&typeof f.scrollIntoView=="function"){var h=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;f.scrollIntoView({behavior:h?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:i}}function Dn(e){return Math.round(Math.max(36,Math.min(52,e*.38)))}function jn(e){return Math.round(e*.5)}function Io(e){return e.querySelector(".renuvex-pr-review, .renuvex-pr-review-list, .renuvex-pr-review-gallery, .renuvex-pr-state-msg, .renuvex-pr-load-more, .renuvex-pr-pagination")}function Oo(e){var r=e&&e.data;if(!r)return!1;var t=Number(r.mediaReviewCount);return Number.isFinite(t)&&t>0}function ls(e,r){if(String(Z||"")!==String(e||""))return!1;var t=document.getElementById("renuvex-reviews"),a=t&&t.shadowRoot,n=a&&a.getElementById("renuvex-reviews-widget");if(!n||n.getAttribute("data-renuvex-product-id")!==String(e||""))return!1;var i=Gt({settings:r,root:document.documentElement,currentMediaFilter:ae,mediaStripReviews:mt,openReviewModal:me,wireLightboxTrigger:tr});if(!i)return!1;var o=n.querySelector(".renuvex-pr-media-gallery-section");return o?o.replaceWith(i):n.insertBefore(i,Io(n)),!0}async function qt(e,r,t,a,n,i,o){if(la){Br({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:i,badgeSettings:o});return}Nr(!0),Qt(e),ea(r),o!==void 0&&ra(o),ta(a),n&&Lr(n),i&&Ue(i),t!=null&&(aa(t),_e(t&&t.data?t.data.nextCursor:null));var l=Yn({render:qt});try{let Te=function(U,re){if(!(!U||!U.meta||!U.meta.sizeOverrides)){var Ae=U.meta.sizeOverrides[re];Ae&&Object.keys(Ae).forEach(function(Ie){s.style.setProperty(Ie,Ae[Ie])})}};var sr=Te,d=ot(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),m=r.showTitle!==!1,v=D(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),p=u&&m?v:"",s=document.documentElement;On(s,r);var x=r.borderRadius!==void 0?r.borderRadius:8,c=Vt[r.size]||Vt.medium,f=Yt[r.thumbnailSize]||Yt.medium,h=f;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(h=Dt[r.thumbnailSize]||Dt.medium),s.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),s.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),s.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),s.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),s.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),s.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),s.style.setProperty("--renuvex-pr-radius",x+"px"),s.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,x-4)+"px"),s.style.setProperty("--renuvex-pr-media-gallery-title-size",c.mediaGalleryTitleSize+"px"),s.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),s.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),s.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),s.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),s.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),s.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),s.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),s.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),s.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),s.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),s.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),s.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),s.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),s.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),s.style.setProperty("--renuvex-pr-load-more-min-height",c.loadMoreMinHeight+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-y",c.loadMorePadY+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-x",c.loadMorePadX+"px"),s.style.setProperty("--renuvex-pr-load-more-mobile-min-height",c.loadMoreMobileMinHeight+"px"),s.style.setProperty("--renuvex-pr-pagination-button-size",c.paginationButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-pad-x",c.paginationPadX+"px"),s.style.setProperty("--renuvex-pr-pagination-gap",c.paginationGap+"px"),s.style.setProperty("--renuvex-pr-pagination-margin-top",c.paginationMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-gap-min",c.paginationGapMin+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-button-size",c.paginationMobileButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-font-size",c.paginationMobileFontSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap",c.paginationMobileGap+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",c.paginationMobileMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",c.paginationMobileGapMin+"px"),s.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size",f+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size-mobile",h+"px");var b=Dn(f),E=Dn(h);s.style.setProperty("--renuvex-pr-media-play-size",b+"px"),s.style.setProperty("--renuvex-pr-media-play-icon-size",jn(b)+"px"),s.style.setProperty("--renuvex-pr-media-play-size-mobile",E+"px"),s.style.setProperty("--renuvex-pr-media-play-icon-size-mobile",jn(E)+"px");var P=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";s.style.setProperty("--renuvex-pr-review-star-color",P),s.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),s.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),Te(ot(r.summaryLayout),r.size),Te(dt(r.reviewLayout),r.size);var w=fr(r),C=ga();if(!C)return;var g=ha(C,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==g&&g.appendChild(z);var M=ba(z),k=Je+qe+Yr+Tn()+_n();Ze(M,k);var S=wa(M);if(r.enabled===!1){z.style.minHeight="auto",S.replaceChildren(Ln(r.borderRadius!==void 0?r.borderRadius:8)),Nr(!1);var A=Rr;Br(null),A&&qt(A.productId,A.settings,A.reviewsData,A.productName,A.orderBy,A.page,A.badgeSettings);return}try{var _=t||{},O=gt(_),y=O?[]:_.data&&_.data.reviews||[];na(y),S.replaceChildren();var T=document.createElement("section");if(T.id="renuvex-reviews-widget",T.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),T.className="renuvex-pr-reviews-widget",T.setAttribute("data-renuvex-surface","reviews"),e&&T.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(T.style.width="100%",T.style.maxWidth="100%",T.style.marginLeft="0",T.style.marginRight="0"),p){var R=document.createElement("div"),I=r.summaryLayout||"classic";R.className="renuvex-pr-title renuvex-pr-title-"+I,R.textContent=p,T.appendChild(R)}if(O){T.appendChild(Bn(_.message,l.onRetry)),S.appendChild(T),He(M),st(T,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return M.getElementById("renuvex-reviews-widget")}),vt("reviews-widget-visible");return}var V=_.data&&_.data.allCount||0,J=_.data&&_.data.ratingCounts||null,X=J||[0,0,0,0,0],W=_.data&&_.data.avgRating||"0.0";if(!J&&y.length>0){y.forEach(function(U){U.rating>=1&&U.rating<=5&&X[U.rating-1]++});var Y=y.reduce(function(U,re){return U+re.rating},0);W=(Y/y.length).toFixed(1)}if(V===0)T.classList.add("renuvex-pr-reviews-empty"),T.appendChild(Rn({iconPair:w,writeButtonText:D(r.writeButtonText,"Yorum Yap"),emptyStateText:D(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:ne}));else{var q=ot(r.summaryLayout),L=q.render({widget:T,productId:e,data:_,settings:r,iconPair:w,allCount:V,ratingCounts:X,avgRatingVal:W,currentRatingFilter:ie,currentOrderBy:te,currentMediaFilter:ae,onFilterChange:l.onFilterChange,onSortChange:l.onSortChange});T.appendChild(L);var N=Gt({settings:r,root:s,currentMediaFilter:ae,mediaStripReviews:mt,openReviewModal:me,wireLightboxTrigger:tr});if(N)T.appendChild(N);else if(Oo(_)){var j=Un({settings:r,root:s,currentMediaFilter:ae});j&&T.appendChild(j)}if(y.length===0)T.appendChild(Nn());else{var B=dt(r.reviewLayout);y.forEach(function(U){T.appendChild(B.render(U,ct))})}var G=r.paginationMode==="numbered"?"numbered":"loadMore";if(G==="numbered"){var K=_.data&&_.data.totalPages||1;K>1&&T.appendChild(Hn({page:_.data&&_.data.page||mr||1,totalPages:K,onPageChange:l.onPageChange}))}var Q=G==="loadMore"&&_.data&&_.data.hasMore;if(Q){let U=function(re){$.textContent=re,H.setAttribute("aria-label",re)};var vr=U,H=document.createElement("button");H.className="renuvex-pr-load-more";var $=document.createElement("span");$.className="renuvex-pr-load-more-label",$.setAttribute("aria-hidden","true"),H.appendChild($),U("Daha Fazla G\xF6ster"),H.onclick=async function(){H.disabled=!0,U("Y\xFCkleniyor...");var re=Ge(),Ae=Z,Ie=te,Er=mr,Tr=ie,Ar=ae,Mr=_r,Pr=Er+1,fe=await Ye(Ae,Ie,Pr,Tr,Ar,null,Mr);if(We(re,{productId:Ae,orderBy:Ie,page:Er,ratingFilter:Tr,mediaFilter:Ar,nextCursor:Mr}))if(fe&&!gt(fe)&&fe.data&&Array.isArray(fe.data.reviews)){var cr=ia(fe.data.reviews);oa(cr),Ue(Pr),_e(fe.data.nextCursor||null);var Gn=dt(F.reviewLayout);cr.forEach(function(Wn){T.insertBefore(Gn.render(Wn,ct),H)}),fe.data.hasMore?(H.disabled=!1,U("Daha Fazla G\xF6ster")):H.remove()}else H.disabled=!1,U("Tekrar Dene")},T.appendChild(H)}}S.appendChild(T),He(M),st(T,"reviews-widget",{productId:e||""},function(){return M.getElementById("renuvex-reviews-widget")}),vt("reviews-widget-visible")}catch(U){console.error("[renuvex-pr] render error:",U);var Fe=document.createElement("p");Fe.style.cssText="text-align:center;color:#dc2626;",Fe.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",S&&S.replaceChildren(Fe)}}finally{if(Nr(!1),Rr){var ce=Rr;Br(null),qt(ce.productId,ce.settings,ce.reviewsData,ce.productName,ce.orderBy,ce.page,ce.badgeSettings)}}}export{qt as render,ls as renderDeferredMediaGallery};
