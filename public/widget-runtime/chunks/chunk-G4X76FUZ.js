...
import{b as qe}from"./chunk-Z7432DLE.js";import{a as ye,b as ii,c as rr,d as ir,e as ti,f as We,g as ai}from"./chunk-WF45MIDY.js";import{$ as $e,A as jr,B as Vr,C as Wr,D as Gr,E as qr,F as Ue,G as Xe,H as Je,N as je,O as Kr,Q as Ur,R as pe,S as he,T as Xr,U as Jr,V as me,W as Zr,X as $r,Y as be,Z as Ze,_ as j,a as ve,aa as Qe,b as ke,ba as vr,c as ge,ca as kr,da as ee,e as He,ea as Qr,f as De,fa as re,g as Ir,ga as ei,h as Ce,ha as Ve,i as Mr,ia as ri,j as Ne,k as Pe,ka as er,l as q,m as A,n as ur,o as Ae,q as fr,r as Fr,s as Ye,t as Se,u as Ke,v as _r,w as Or,x as Hr,y as Dr,z as Yr}from"./chunk-XEG5QGZW.js";var Di=15,Yi=60*1e3,ni="__ikrReviewsFetchError",gr={};function tr(e){return{type:ni,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function hr(e){return!!(e&&e.type===ni)}async function Ee(e,r,i,t,a,o){if(window.__ikasPreviewMode){try{var s=window.__ikasPreviewBaseUrl||ge,l=s+"/api/preview/reviews?page="+encodeURIComponent(i||1),c=await ye(l);if(c.ok)return await c.json()}catch(k){}return tr()}r=r||"newest",i=i||1;var m=o?"_l"+o:"",v="ikr_reviews_"+ke+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(a?"1":"0")+m,p=null,n=ei(v);if(n)try{var f=JSON.parse(n);if(f&&f.t!==void 0&&f.v){if(Date.now()-f.t<Yi)return f.v;p=f.v,Ve(v,"")}else Ve(v,"")}catch(k){Ve(v,"")}try{var d=ge+"/api/public/reviews?storeId="+encodeURIComponent(ke)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(a?"&hasImages=true":"")+(o?"&limit="+encodeURIComponent(o):""),u=await ye(d);if(!u.ok)return p||tr();var g=await u.json();return Ve(v,JSON.stringify({t:Date.now(),v:g})),g}catch(k){return console.error("[ikr] fetchReviews error:",k),p||tr()}}async function ji(e){var r=await Ee(e,"newest",1,null,!0,Di);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function qt(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!gr[e]){gr[e]=!0;var a={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},o={enabled:!0,size:"medium"};try{var s=await ii();if(!s)return;var l=s.widgets&&s.widgets.reviews||a,c=s.widgets&&s.widgets.badge||o;if(l.enabled===!1)return;Ye("newest"),Se(1),Ke(null);var m=await Promise.all([Ee(e,"newest",1,null),ji(e)]),v=m[0];Vr(m[1]),await we(e,l,v,r,"newest",1,c)}catch(p){console.error("[ikr] bootstrap error:",p),await we(e,a,tr(),r,void 0,void 0,o)}finally{delete gr[e]}}}function Re(e){return be(e)}function Vi(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,i,t){i?e.setProperty(r,i,t||""):e.removeProperty(r)}function Wi(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",i=navigator.maxTouchPoints||0,t=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&i>1;return t&&/AppleWebKit/i.test(r)}function Gi(){var e=Vi(),r=document.body.style,i=document.documentElement.style,t=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",o=Wi()&&!a;if(t>0){var s=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",s+t+"px","important")}return i.setProperty("overflow","hidden","important"),i.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important")),e}function qi(e){if(e){var r=document.body.style,i=document.documentElement.style;ie(i,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(i,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}}function Ki(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function Be(e){if(!(!e||!document.contains(e)||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(i){}}}function Ui(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function li(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Ui)}function di(e){var r=li(e),i=r[0]||e.querySelector('[role="dialog"]')||e;Be(i)}function Xi(e,r){if(e.key==="Tab"){var i=li(r);if(!i.length){e.preventDefault(),di(r);return}var t=i[0],a=i[i.length-1],o=document.activeElement;if(!r.contains(o)){e.preventDefault(),Be(t);return}e.shiftKey&&o===t?(e.preventDefault(),Be(a)):!e.shiftKey&&o===a&&(e.preventDefault(),Be(t))}}function Ji(){var e={id:"ikr-modal-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state,history.pushState({ikrModal:e.id},"",e.url),e.pushed=!0}catch(r){}return e}function Zi(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state.ikrModal===e.id)}function $i(e){if(Zi(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function oi(e,r,i,t,a){qi(t),document.removeEventListener("keydown",r),window.removeEventListener("popstate",i),e.parentNode&&e.parentNode.removeChild(e),Be(a)}function Qi(e){var r=document.createElement("div");r.className="ikr-modal-right";var i=document.createElement("div");i.className="ikr-modal-scroll-content";var t=document.createElement("div");t.className="ikr-modal-top-row";var a=document.createElement("div");a.className="ikr-modal-stars",a.innerHTML=pe(e.rating,A);var o=document.createElement("span");o.className="ikr-modal-date",o.textContent=me(e.createdAt),t.appendChild(a),t.appendChild(o),i.appendChild(t);var s=document.createElement("div");s.className="ikr-modal-title",s.textContent=e.title||"",s.style.display=e.title?"":"none",i.appendChild(s);var l=document.createElement("div");l.className="ikr-modal-author",l.textContent=e.author||"",i.appendChild(l);var c=document.createElement("div");c.className="ikr-modal-body",c.textContent=(e.comment||"").trim(),c.style.display=e.comment&&e.comment.trim()?"":"none",i.appendChild(c);var m=document.createElement("div");m.className="ikr-modal-reply";var v=document.createElement("div");v.className="ikr-modal-reply-label",v.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var p=document.createElement("div");return p.className="ikr-modal-reply-text",p.textContent=e.merchantReply||"",m.appendChild(v),m.appendChild(p),m.style.display=e.merchantReply?"":"none",i.appendChild(m),r.appendChild(i),r}function si(e,r,i){var t=i||A,a=e.querySelector(".ikr-modal-scroll-content"),o=a.querySelector(".ikr-modal-stars");o.innerHTML=pe(r.rating,t),a.querySelector(".ikr-modal-date").textContent=me(r.createdAt);var s=a.querySelector(".ikr-modal-title");s.textContent=r.title||"",s.style.display=r.title?"":"none",a.querySelector(".ikr-modal-author").textContent=r.author||"";var l=a.querySelector(".ikr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var c=a.querySelector(".ikr-modal-reply");c.querySelector(".ikr-modal-reply-label").textContent=t&&t.merchantReplyLabel||"Ma\u011Faza Sahibi",c.querySelector(".ikr-modal-reply-text").textContent=r.merchantReply||"",c.style.display=r.merchantReply?"":"none",e.scrollTop=0}function yr(e,r,i,t,a,o,s,l,c){var m=Re(e),v=Math.max(0,Math.min(i||0,m.length-1)),p=document.createElement("div");p.className="ikr-modal-left";var n=document.createElement("img"),f=s==="next"?"ikr-modal-img-enter-right":s==="prev"?"ikr-modal-img-enter-left":"";n.className="ikr-modal-main-img"+(f?" "+f:""),n.src=kr(m[v]||""),n.decoding="async",n.width=vr,n.height=Math.round(vr*4/3),n.alt="Yorum foto\u011Fraf\u0131",Qr(n,function(S){if(S.style.display="none",!p.querySelector(".ikr-modal-img-error")){var T=document.createElement("div");T.className="ikr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(T,S)}}),p.appendChild(n);var d=document.createElement("button");d.className="ikr-modal-close-mobile",d.textContent="\u2715",d.setAttribute("aria-label","Kapat"),d.onclick=function(S){S.stopPropagation(),o()},p.appendChild(d);var u=0;if(p.addEventListener("touchstart",function(S){u=S.touches[0].clientX},{passive:!0}),p.addEventListener("touchend",function(S){var T=u-S.changedTouches[0].clientX;if(!(Math.abs(T)<50)){if(T>0){if(x)ue(e,r,v+1,t,a,o,!0,"next",l,c);else if(h){var y=t[r+1];ue(y,r+1,0,t,a,o,!1,"next",l,c)}}else if(k)ue(e,r,v-1,t,a,o,!0,"prev",l,c);else if(z){var L=t[r-1],P=Re(L);ue(L,r-1,P.length-1,t,a,o,!1,"prev",l,c)}}},{passive:!0}),m.length>1){var g=document.createElement("div");g.className="ikr-modal-thumbs",m.forEach(function(S,T){var y=document.createElement("img"),L=ee(S,Qe);y.src=L.src,y.srcset=L.srcset,y.loading="lazy",y.decoding="async",y.width=Qe,y.height=Qe,y.className="ikr-modal-thumb"+(T===v?" ikr-modal-thumb-active":""),y.alt="K\xFC\xE7\xFCk resim "+(T+1),re(y),y.tabIndex=0,y.setAttribute("role","button"),y.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(T+1)+" se\xE7"),T===v&&y.setAttribute("aria-current","true"),(function(P){function N(){ue(e,r,P,t,a,o,!0,null,l,c)}y.onclick=N,y.onkeydown=function(M){(M.key==="Enter"||M.key===" ")&&(M.preventDefault(),N())}})(T),g.appendChild(y)}),p.appendChild(g)}var k=v>0,x=v<m.length-1,z=r>0,h=r<t.length-1,E=k||z,w=x||h;if(E){var b=document.createElement("button");b.className="ikr-modal-nav ikr-modal-nav-prev",b.innerHTML="&#8249;",b.setAttribute("aria-label","\xD6nceki"),b.onclick=function(S){if(S.stopPropagation(),k)ue(e,r,v-1,t,a,o,!0,"prev",l,c);else if(z){var T=t[r-1],y=Re(T);ue(T,r-1,y.length-1,t,a,o,!1,"prev",l,c)}},p.appendChild(b)}if(w){var C=document.createElement("button");C.className="ikr-modal-nav ikr-modal-nav-next",C.innerHTML="&#8250;",C.setAttribute("aria-label","Sonraki"),C.onclick=function(S){if(S.stopPropagation(),x)ue(e,r,v+1,t,a,o,!0,"next",l,c);else if(h){var T=t[r+1];ue(T,r+1,0,t,a,o,!1,"next",l,c)}},p.appendChild(C)}return p}function ci(e,r){[-1,1].forEach(function(i){var t=r[e+i];if(t){var a=Re(t);a[0]&&(new Image().src=kr(a[0]))}})}function br(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function et(e,r){var i=e&&e.querySelector(".ikr-modal-wrap"),t=r&&r.querySelector(".ikr-modal-right"),a=r&&r.querySelector(".ikr-modal-scroll-content");function o(){br(i),br(t),br(a)}o(),i&&Be(i),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function ue(e,r,i,t,a,o,s,l,c,m){if(m&&(m.currentReview=e),s){var v=yr(e,r,i,t,a,o,l,c,m);a.firstChild&&a.replaceChild(v,a.firstChild)}else{var v=yr(e,r,i,t,a,o,l,c,m),p=a.querySelector(".ikr-modal-right");a.firstChild&&a.replaceChild(v,a.firstChild),p&&si(p,e,m&&m.currentSettings),et(c,a)}ci(r,t)}function te(e,r,i){var t=Re(e);if(!t.length)return;var a=(i||[]).filter(function(h){return Re(h).length>0}),o=a.findIndex(function(h){return h===e||h.id===e.id});o===-1&&(a.unshift(e),o=0);var s=t.indexOf(r);s<0&&(s=0);var l=document.createElement("div");l.className="ikr-modal-overlay";var c=document.createElement("div");c.className="ikr-modal";var m=!1,v=Ki(),p=Gi(),n=Ji(),f={currentReview:e,currentSettings:A};function d(h){var E=h&&h.detail&&h.detail.settings;f.currentSettings=E||A;var w=c.querySelector(".ikr-modal-right");!w||!f.currentReview||si(w,f.currentReview,f.currentSettings)}function u(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),oi(l,g,u,p,v))}function g(h){if(h.key==="Escape"){k();return}Xi(h,l)}function k(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),oi(l,g,u,p,v),$i(n))}document.addEventListener("keydown",g),window.addEventListener("popstate",u),window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),l.onclick=function(){k()},c.onclick=function(h){h.stopPropagation()},c.appendChild(yr(e,o,s,a,c,k,null,l,f)),c.appendChild(Qi(e)),ci(o,a);var x=document.createElement("div");x.className="ikr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(c);var z=document.createElement("button");z.className="ikr-modal-close",z.textContent="\u2715",z.setAttribute("aria-label","Kapat"),z.onclick=function(h){h.stopPropagation(),k()},x.appendChild(z),l.appendChild(x),document.body.appendChild(l),di(l)}function pi(e){var r=er();if(r&&typeof r.findProductTitle=="function")try{var i=r.findProductTitle(e);if(i)return i}catch(s){}if(e)for(var t=document.querySelectorAll("h1,h2,h3,h4,h5,h6,div,span,p"),a=0;a<t.length;a++){var o=t[a];if(o.children.length===0&&o.textContent.trim()===e&&o.tagName!=="TITLE"&&!o.closest("[data-ikr-listing-badge]")&&!o.closest("[data-renuvex-slot]")&&!o.closest("#ikas-reviews")&&!o.closest("nav")&&!o.closest("header")&&!o.closest('[class*="breadcrumb"]')&&!o.closest('[aria-label*="breadcrumb"]'))return o}return document.querySelector("h1")}function mi(e){return!e||!e.parentNode?null:{parent:e.parentNode,anchorEl:e,position:"after"}}function wr(e){return!e||!e.parent?null:e.position==="after"&&e.anchorEl?{parent:e.parent,anchorEl:e.anchorEl,position:"after"}:{parent:e.parent,beforeEl:e.beforeEl||null,position:"before"}}function ui(e,r){var i=wr(r);return!e||!i||e.parentNode!==i.parent?!1:i.position==="after"?i.anchorEl&&i.anchorEl.parentNode===i.parent&&i.anchorEl.nextSibling===e:i.beforeEl&&i.beforeEl.parentNode===i.parent?e.nextSibling===i.beforeEl:e.nextSibling===null}function xr(e,r){var i=wr(r);if(!e||!i||!i.parent||ui(e,i))return!1;if(i.position==="after")return!i.anchorEl||i.anchorEl.parentNode!==i.parent?!1:(i.parent.insertBefore(e,i.anchorEl.nextSibling||null),!0);var t=i.beforeEl&&i.beforeEl.parentNode===i.parent?i.beforeEl:null;return i.parent.insertBefore(e,t),!0}function fi(e,r,i){i=i||{};var t=wr(r);if(typeof MutationObserver=="undefined"||!e||!t||!t.parent)return null;var a=0,o=!1,s=typeof i.maxCorrections=="number"?i.maxCorrections:3,l=typeof i.durationMs=="number"?i.durationMs:15e3,c=i.surface||"owned-slot",m=i.reason||"position_reanchored",v=i.message||"Owned storefront slot reordered after render",p=i.extra||{},n=new MutationObserver(function(){if(!e.isConnected||!t.parent.isConnected){n.disconnect();return}if(t.position==="after"&&(!t.anchorEl||!t.anchorEl.isConnected||t.anchorEl.parentNode!==t.parent)){n.disconnect();return}ui(e,t)||(a+=1,xr(e,t),o||(o=!0,He("dom-conflict",v,Object.assign({surface:c,reason:m},p))),a>=s&&n.disconnect())});return n.observe(t.parent,{childList:!0}),setTimeout(function(){n.disconnect()},l),n}var ar=null,nr=null;function rt(e,r){return he(e,r)}function it(e){var r=er();if(r&&typeof r.getProductBadgeMountPoint=="function")try{var i=r.getProductBadgeMountPoint(e);if(i&&i.parent)return i}catch(t){}return mi(e)}function zr(e,r,i,t,a,o,s){ar&&(ar.disconnect(),ar=null),nr&&(nr.disconnect(),nr=null),ti("product-title-rating","product-title-badge");var l=document.querySelector(".ikr-rating-badge--pdp");if(l&&l.remove(),!!e&&!(t&&t.enabled===!1)){var c=document.getElementById("ikr-jsonld");c&&c.remove();var m=document.createElement("script");m.id="ikr-jsonld",m.type="application/ld+json",m.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Product",name:i||document.title,url:window.location.href,aggregateRating:{"@type":"AggregateRating",ratingValue:e,reviewCount:r,bestRating:"5",worstRating:"1"}}),document.head.appendChild(m);var v=pi(i);if(!v||!v.parentNode){He("dom-conflict","PDP product title could not be found for badge placement",{surface:"pdp-badge",reason:"title_not_found",productName:i||"",productId:o||""});return}var p=it(v);if(!p||!p.parent){He("dom-conflict","PDP badge mount point could not be resolved",{surface:"pdp-badge",reason:"mount_not_found",productName:i||"",productId:o||""});return}var n=t&&t.size||"medium",f=We[n]||We.medium,d=null;if(t&&t.mobileOverride===!0){var u=t.mobileSize||"small";d=We[u]||We.small}ai(f,d);var g=rr({slot:"product-title-rating",legacySlot:"product-title-badge",className:"renuvex-pr-product-badge-slot ikr-product-badge-slot",context:{surface:"pdp",productId:o||""}}),k=document.createElement("a");k.className="renuvex-pr-rating-badge ikr-rating-badge ikr-rating-badge--pdp",k.href="#ikas-reviews";var x=Xr(e,r);k.setAttribute("aria-labelledby",x.id),k.setAttribute("data-ikr-surface","pdp"),k.setAttribute("data-renuvex-surface","pdp"),k.setAttribute("data-ikr-rating",String(e)),k.setAttribute("data-renuvex-rating",String(e)),k.setAttribute("data-ikr-count",String(r)),k.setAttribute("data-renuvex-count",String(r)),ir(k,{surface:"pdp",productId:o||""});var z=window.getComputedStyle(v).textAlign,h=z==="center"?"center":z==="right"?"right":"left";k.setAttribute("data-ikr-align",h),k.insertAdjacentHTML("beforeend",x.html+rt(e,a));var E=document.createElement("span");E.className="ikr-rating-badge__label",E.textContent=e+" ("+r+" yorum)",k.appendChild(E),k.onclick=function(w){w.preventDefault();var b=document.getElementById("ikas-reviews-widget")||document.getElementById("ikas-reviews");if(b){var C=document.querySelector("header"),S=C?C.getBoundingClientRect().height:0,T=b.getBoundingClientRect().top+window.pageYOffset-S-16;window.scrollTo({top:T,behavior:"smooth"})}},g.appendChild(k),xr(g,p),nr=fi(g,p,{surface:"pdp-badge",reason:"position_reanchored",message:"PDP badge slot reordered after render",extra:{productName:i||"",productId:o||""}}),De(g,"pdp-badge",{productName:i||"",productId:o||""}),s||(ar=Ir(g,"pdp-badge",function(){zr(e,r,i,t,a,o,!0)},{productName:i||"",productId:o||""}))}}var vi=`
