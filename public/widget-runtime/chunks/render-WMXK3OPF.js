...
`;var fr=[Nt,wt,Rt,It,Bt,_t,Pt].join(`
`);function za(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function de(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function ka(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Sa(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",o=ka()&&!n;if(a>0){var l=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",l+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Ca(e){var r=document.body.style,t=document.documentElement.style;de(t,"overflow",e.rootOverflow,e.rootOverflowPriority),de(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),de(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),de(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),de(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),de(r,"position",e.bodyPosition,e.bodyPositionPriority),de(r,"top",e.bodyTop,e.bodyTopPriority),de(r,"left",e.bodyLeft,e.bodyLeftPriority),de(r,"right",e.bodyRight,e.bodyRightPriority),de(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var $e=0,Oe=null;function gr(){return $e+=1,$e>1||(Oe=za(),Sa(Oe)),Oe}function hr(){if($e!==0&&($e-=1,!($e>0))){var e=Oe;Oe=null,e&&Ca(e)}}function Ea(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function br(){var e=Ea();return!e||e===document.body||e===document.documentElement?null:e}function te(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Ta(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function _r(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Ta)}function Aa(e,r){var t=e,a=_r(e);!a.length&&r&&(t=r,a=_r(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;te(n)}function yr(e,r,t){if(e.key==="Tab"){var a=_r(r);if(!a.length){e.preventDefault(),Aa(r);return}var n=a[0],o=a[a.length-1],l=At(t);if(!r.contains(l)){e.preventDefault(),te(n);return}if(a.indexOf(l)===-1){e.preventDefault(),te(e.shiftKey?o:n);return}e.shiftKey&&l===n?(e.preventDefault(),te(o)):!e.shiftKey&&l===o&&(e.preventDefault(),te(n))}}var Mt="renuvexPrOverlay";function wr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Mt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function La(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Mt]===e.id)}function zr(e){if(La(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function He(e){return ze(e)}function Ft(e,r,t,a,n,o){hr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&dr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),o&&te(n)}function Na(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=xe(e.rating,R);var o=document.createElement("span");o.className="renuvex-pr-modal-date",o.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-modal-title",l.textContent=e.title||"",l.style.display=e.title?"":"none",t.appendChild(l);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var x=document.createElement("div");x.className="renuvex-pr-modal-reply-label",x.textContent=R&&R.merchantReplyLabel||"Ma\u011Faza Sahibi";var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",u.appendChild(x),u.appendChild(s),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Ot(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),o=n.querySelector(".renuvex-pr-modal-stars");o.innerHTML=xe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=fe(r.createdAt);var l=n.querySelector(".renuvex-pr-modal-title");l.textContent=r.title||"",l.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Fr(e,r,t,a,n,o,l,i,d){var u=He(e),x=Math.max(0,Math.min(t||0,u.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var p=document.createElement("img"),v=l==="next"?"renuvex-pr-modal-img-enter-right":l==="prev"?"renuvex-pr-modal-img-enter-left":"";if(p.className="renuvex-pr-modal-main-img"+(v?" "+v:""),p.src=Ir(u[x]||""),p.decoding="async",p.width=Rr,p.height=Math.round(Rr*4/3),p.alt="Yorum foto\u011Fraf\u0131",!v){p.classList.add("renuvex-pr-modal-img-loading");var y=function(){p.classList.remove("renuvex-pr-modal-img-loading")};p.complete&&p.naturalWidth>0?y():(p.addEventListener("load",y,{once:!0}),p.addEventListener("error",y,{once:!0}))}kt(p,function(N){if(N.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var C=document.createElement("div");C.className="renuvex-pr-modal-img-error",C.setAttribute("role","status"),C.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(C,N)}}),s.appendChild(p);var c=document.createElement("button");c.className="renuvex-pr-modal-close-mobile";var b=re(Ce);b&&c.appendChild(b),c.setAttribute("aria-label","Kapat"),c.onclick=function(N){N.stopPropagation(),o()},s.appendChild(c);var m=0;if(s.addEventListener("touchstart",function(N){m=N.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(N){var C=m-N.changedTouches[0].clientX;if(!(Math.abs(C)<50)){if(C>0){if(k)ge(e,r,x+1,a,n,o,!0,"next",i,d);else if(z){var P=a[r+1];ge(P,r+1,0,a,n,o,!1,"next",i,d)}}else if(g)ge(e,r,x-1,a,n,o,!0,"prev",i,d);else if(f){var H=a[r-1],q=He(H);ge(H,r-1,q.length-1,a,n,o,!1,"prev",i,d)}}},{passive:!0}),u.length>1){var h=document.createElement("div");h.className="renuvex-pr-modal-thumbs",u.forEach(function(N,C){var P=document.createElement("img"),H=pe(N,mr);P.src=H.src,P.srcset=H.srcset,P.loading="lazy",P.decoding="async",P.width=mr,P.height=mr,P.className="renuvex-pr-modal-thumb"+(C===x?" renuvex-pr-modal-thumb-active":""),P.alt="K\xFC\xE7\xFCk resim "+(C+1),ue(P),P.tabIndex=0,P.setAttribute("role","button"),P.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(C+1)+" se\xE7"),C===x&&P.setAttribute("aria-current","true"),(function(q){function J(){ge(e,r,q,a,n,o,!0,null,i,d)}P.onclick=J,P.onkeydown=function(Y){(Y.key==="Enter"||Y.key===" ")&&(Y.preventDefault(),J())}})(C),h.appendChild(P)}),s.appendChild(h)}var g=x>0,k=x<u.length-1,f=r>0,z=r<a.length-1,T=g||f,A=k||z;if(T){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var E=re(Ie);E&&w.appendChild(E),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(N){if(N.stopPropagation(),g)ge(e,r,x-1,a,n,o,!0,"prev",i,d);else if(f){var C=a[r-1],P=He(C);ge(C,r-1,P.length-1,a,n,o,!1,"prev",i,d)}},s.appendChild(w)}if(A){var S=document.createElement("button");S.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=re(sr);L&&S.appendChild(L),S.setAttribute("aria-label","Sonraki"),S.onclick=function(N){if(N.stopPropagation(),k)ge(e,r,x+1,a,n,o,!0,"next",i,d);else if(z){var C=a[r+1];ge(C,r+1,0,a,n,o,!1,"next",i,d)}},s.appendChild(S)}return s}function Ht(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=He(a);n[0]&&(new Image().src=Ir(n[0]))}})}function Mr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Pa(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function o(){Mr(t),Mr(a),Mr(n)}o(),t&&te(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function ge(e,r,t,a,n,o,l,i,d,u){if(u&&(u.currentReview=e),l){var x=Fr(e,r,t,a,n,o,i,d,u);n.firstChild&&n.replaceChild(x,n.firstChild)}else{var x=Fr(e,r,t,a,n,o,i,d,u),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(x,n.firstChild),s&&Ot(s,e,u&&u.currentSettings),Pa(d,n)}Ht(r,a)}function se(e,r,t){var a=He(e);if(!a.length)return;var n=(t||[]).filter(function(A){return He(A).length>0}),o=n.findIndex(function(A){return A===e||A.id===e.id});o===-1&&(n.unshift(e),o=0);var l=a.indexOf(r);l<0&&(l=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var u=!1,x=null,s=br(),p=Ne(),v=gr(),y=wr(),c={currentReview:e,currentSettings:R},b=null;function m(A){var w=A&&A.detail&&A.detail.settings;if(!(w&&w===b)){b=w||null,c.currentSettings=w||R;var E=d.querySelector(".renuvex-pr-modal-right");!E||!c.currentReview||Ot(E,c.currentReview,c.currentSettings)}}function h(){u||(u=!0,window.removeEventListener(Ee,m),Ft(x&&x.host,g,h,v,s,p))}function g(A){if(A.key==="Escape"){k();return}yr(A,i,x&&x.root)}function k(){u||(u=!0,window.removeEventListener(Ee,m),Ft(x&&x.host,g,h,v,s,p),zr(y))}document.addEventListener("keydown",g),window.addEventListener("popstate",h),window.addEventListener(Ee,m),i.onclick=function(){k()},d.onclick=function(A){A.stopPropagation()},d.appendChild(Fr(e,o,l,n,d,k,null,i,c)),d.appendChild(Na(e)),Ht(o,n);var f=document.createElement("div");f.className="renuvex-pr-modal-wrap",f.tabIndex=-1,f.setAttribute("role","dialog"),f.setAttribute("aria-modal","true"),f.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),f.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var T=re(Ce);T&&z.appendChild(T),z.setAttribute("aria-label","Kapat"),z.onclick=function(A){A.stopPropagation(),k()},f.appendChild(z),i.appendChild(f),x=xr(),Fe(x.root,Me+Le+fr),x.root.appendChild(i),Se(x.root),te(f)}function ke(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var jr={};ye(jr,{css:()=>Da,meta:()=>Ya,render:()=>ja});function Ye(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,o=e.onFilterChange;we(a);var l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,u=t>0?Math.round(d/t*100):0,x=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(x?" renuvex-pr-bar-active":"")+(n&&!x?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",x?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" yorum, "+(x?"filtreyi kald\u0131r":"filtrele"));for(var p="",v=1;v<=5;v++){var y=v<=i;p+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ee(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+p+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(c){function b(){o(c)}s.onclick=b,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),b())}})(i),l.appendChild(s)}return l}var jt="data-renuvex-pr-dismiss-gesture",Te=[],Yt=!1,kr=!1,Qe=[],De=null;function Dt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Or(){for(var e=Te.length-1;e>=0;e--){var r=Te[e].element;r&&r.isConnected===!1&&Te.splice(e,1)}return Te}function Ra(e){!e||typeof e.setAttribute!="function"||(Qe.indexOf(e)===-1&&Qe.push(e),e.setAttribute(jt,""))}function Ut(){for(var e=0;e<Qe.length;e++){var r=Qe[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(jt)}Qe=[],De&&typeof clearTimeout=="function"&&clearTimeout(De),De=null}function Ia(e){if(kr){kr=!1,Ut(),e.preventDefault(),e.stopPropagation();return}for(var r=Or(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Dt(e,n.trigger)||Dt(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Ba(e){if(e.key==="Escape")for(var r=Or(),t=r.length-1;t>=0;t--)r[t].close()}function Vt(){Yt||typeof document=="undefined"||(document.addEventListener("click",Ia,!0),document.addEventListener("keydown",Ba),Yt=!0)}function _a(e){Vt(),kr=!0,Ra(e),De&&typeof clearTimeout=="function"&&clearTimeout(De),typeof setTimeout=="function"&&(De=setTimeout(function(){kr=!1,Ut()},700))}function Hr(e){_a(e)}function Sr(e){Vt();var r={trigger:e.trigger,element:e.element,close:e.close};return Te.push(r),{unregister:function(){var t=Te.indexOf(r);t!==-1&&Te.splice(t,1)},notifyOpening:function(){for(var t=Or(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function X(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,o=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=R&&R.writeButtonText||"Yorum Yap",i.onclick=n,l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var x=R&&R.filterIcon||"lines";u.innerHTML=me(ft(x));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function y(){return r&&r.parentNode||r||null}function c(g,k){if(!(k===!0||!g)){if(g.type==="touchstart"){Hr(y());return}if(g.type==="pointerdown"){var f=g.pointerType||"";f&&f!=="mouse"&&Hr(y());return}}}function b(g){var k=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var f=g&&(g.restoreFocus===!0||g.restoreFocus==="auto"&&Ne());if(k&&f)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(T){}}return k}function m(){h.notifyOpening(),s.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var g=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");g&&requestAnimationFrame(function(){try{g.focus({preventScroll:!0})}catch(k){try{g.focus()}catch(f){}}})}p.forEach(function(g){var k=g[2],f=k?a:!a&&(t||"newest")===g[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(f?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=g[1];var T=!1;function A(w,E){w&&(w.preventDefault(),w.stopPropagation()),!T&&(T=!0,v=!0,c(w,E),b({restoreFocus:E}),o(g[0],k),setTimeout(function(){T=!1,v=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&A(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){A(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&A(w,!0)}),z.onclick=function(w){A(w,!1)},s.appendChild(z)}),u.onclick=function(){s.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(g){g.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(g.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(g){if(s.classList.contains("renuvex-pr-open")&&!v){var k=g.relatedTarget;k&&d.contains(k)||b()}});var h=Sr({trigger:d,element:s,close:b});return d.appendChild(u),d.appendChild(s),l.appendChild(d),l}var Wt=`
...
`;function qt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content",n.appendChild(o);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var i=re(Ce);i&&l.appendChild(i),n.appendChild(l);var d=!1,u=null,x=null,s=!1;function p(){te(a)}function v(f){yr(f,a,u&&u.root)}function y(){if(!d){if(d=!0,document.removeEventListener("keydown",c),a.removeEventListener("click",b),l.removeEventListener("click",y),s)te(x);else{var f=u&&u.root?u.root.activeElement:null;if(f&&typeof f.blur=="function")try{f.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(dr(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):a.parentNode&&a.parentNode.removeChild(a),hr();try{r()}catch(z){}},200)}}function c(f){if(f.key==="Escape"){y();return}v(f)}function b(f){f.target===a&&t&&y()}document.addEventListener("keydown",c),a.addEventListener("click",b),l.addEventListener("click",y);function m(f){x=br(),s=Ne(),f&&o.appendChild(f),u=xr(),Fe(u.root,Me+Le+Wt),u.root.appendChild(a),Se(u.root),gr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),p()})}var h=null,g=null;function k(f,z){if(z=z||"error",h){try{h.remove()}catch(T){}h=null}g&&(clearTimeout(g),g=null),h=document.createElement("div"),h.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,h.textContent=f,n.appendChild(h),g=setTimeout(function(){h&&(h.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(h){try{h.remove()}catch(T){}h=null}},300))},4e3)}return{open:m,close:y,content:o,setAllowOutsideClose:function(f){t=!!f},setStepAttr:function(f){n.setAttribute("data-step",String(f))},showToast:k}}var Yr=4;function je(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Gt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(o){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Yr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(o){return o!==n})}}}}function Kt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},o=e.onNext||function(){},l=document.createElement("div");l.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=me(Ie)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var u=[],x=0;x<Yr;x++){var s=document.createElement("span");s.className="renuvex-pr-fwizard-progress-seg",d.appendChild(s),u.push(s)}l.appendChild(d);var p=document.createElement("button");p.type="button";var v=null;function y(b){v&&p.removeEventListener("click",v),v=b,b&&p.addEventListener("click",b)}l.appendChild(p);function c(b,m){var h=r.indexOf(b)!==-1,g=t.indexOf(b)!==-1,k=m&&(m.images&&m.images.length>0||m.pendingImages&&m.pendingImages.length>0);if(h)b===2&&k?(p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",y(function(){o()})):(p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.setAttribute("aria-label","Atla"),p.innerHTML="<span>Atla</span>",y(function(){n()})),p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),p.style.visibility="",p.tabIndex=0;else if(g){p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Sonraki"),p.innerHTML="Sonraki",p.style.visibility="",p.tabIndex=0;var f=je(b,m);p.disabled=!f,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!f),y(function(){p.disabled||o()})}else p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.innerHTML="",p.style.visibility="hidden",p.tabIndex=-1,p.disabled=!0,y(null)}return{el:l,update:function(b,m){u.forEach(function(g,k){k+1<=b?g.classList.add("renuvex-pr-fwizard-progress-seg-active"):g.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var h=b<=1;i.style.visibility=h?"hidden":"",i.style.pointerEvents=h?"none":"",i.tabIndex=h?-1:0,c(b,m)},setNextDisabled:function(b){p.classList.contains("renuvex-pr-fwizard-cta-btn")&&(p.disabled=!!b,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!b))},setThanksState:function(b){i.style.visibility="hidden",d.style.visibility="hidden",p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",p.style.visibility="",p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),y(b)}}}function Xt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title",o.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-stars",l.setAttribute("role","radiogroup"),l.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=Je(R||{});we(i);var d=[];function u(b){d.forEach(function(m,h){var g=h<b;m.classList.toggle("renuvex-pr-fwizard-star-active",g),m.setAttribute("aria-checked",h+1===b?"true":"false"),m.innerHTML=g?ee("full"):ee("outline")})}function x(b){e.set({rating:b}),u(b)}function s(b){var m=d[b-1];if(m)try{m.focus()}catch(h){}}function p(b,m){m&&typeof m.preventDefault=="function"&&m.preventDefault(),m&&typeof m.stopPropagation=="function"&&m.stopPropagation(),!a&&(a=!0,x(b),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var v=1;v<=5;v++)(function(b){var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-star",m.setAttribute("role","radio"),m.setAttribute("aria-label",b+" y\u0131ld\u0131z"),m.innerHTML=ee("outline"),m.addEventListener("mouseenter",function(){u(b)}),m.addEventListener("mouseleave",function(){u(e.get().rating)}),m.addEventListener("pointerdown",function(h){h.button&&h.button!==0||p(b,h)}),typeof window!="undefined"&&!window.PointerEvent&&m.addEventListener("touchstart",function(h){p(b,h)},{passive:!1}),m.addEventListener("mousedown",function(h){window.PointerEvent||p(b,h)}),m.addEventListener("keydown",function(h){if(h.key==="Enter"||h.key===" "){p(b,h);return}var g=0;h.key==="ArrowRight"||h.key==="ArrowUp"?g=Math.min(5,b+1):h.key==="ArrowLeft"||h.key==="ArrowDown"?g=Math.max(1,b-1):h.key==="Home"?g=1:h.key==="End"&&(g=5),g&&(h.preventDefault(),x(g),s(g))}),m.addEventListener("click",function(h){p(b,h)}),d.push(m),l.appendChild(m)})(v);u(e.get().rating);var y=null,c=function(b){var m=b&&b.detail&&b.detail.settings;m&&m===y||(y=m||null,i=Je(m||R||{}),u(e.get().rating))};return window.addEventListener(Ee,c),t.appendChild(l),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ee,c)}}}var Jt=3,Ma=10*1024*1024;function Zt(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-subtitle",o.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",l.appendChild(i),l.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),l.appendChild(u),a.appendChild(l);var x=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},s=r.blobMap||{},p=r.urlToFinger||{};function v(){if(!t){var h=e.get().images||[],g=e.get().pendingImages||[],k=h.map(function(f){return{url:f,isPending:!1}}).concat(g.map(function(f){return{url:f.url,file:f.file,isPending:!0,error:f.error}}));u.innerHTML="",k.forEach(function(f){var z=s[f.url]||f.url,T=y(f,z);u.appendChild(T)}),b()}}function y(h,g){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var f=document.createElement("img");f.src=g,f.alt="",f.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(f);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",k.appendChild(z);var T=document.createElement("button");T.type="button",T.className="renuvex-pr-fwizard-photo-remove",T.setAttribute("aria-label","Kald\u0131r");var A=re(Ce);return A&&T.appendChild(A),k.appendChild(T),c(k,h,g),k}function c(h,g,k){var f=h.querySelector("img");f.src!==k&&(f.src=k);var z=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(g.isPending&&g.error){z.style.display="flex",z.textContent="";var T=document.createElement("span");T.className="renuvex-pr-upload-error",T.textContent="\u2717 "+g.error,z.appendChild(T)}else z.style.display="none",z.textContent="";var A=h.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var w=p[g.url]||(g.file?g.file.name+"_"+g.file.size:null),E=s[g.url],S={};w&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(L){return L!==w})),g.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(L){return L.url!==g.url}):S.images=(e.get().images||[]).filter(function(L){return L!==g.url}),e.set(S),x(g.url),x(E),delete p[g.url],E&&delete p[E],s[g.url]&&delete s[g.url]}}function b(){var h=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,k=h+g,f=k>=Jt;k>0?(l.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(bt)):(l.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(ht)+"<span>Foto\u011Fraf Ekle</span>"),f?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(h){var g=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(h.target.files).slice(0,Jt-g);d.value="";var f=(e.get().pendingImages||[]).length,z=e.get().images||[],T=z.length;if(k.length!==0){for(var A=[],w=[],E=0;E<k.length;E++){var S=k[E],L=S.name+"_"+S.size,N=(e.get().fingerprints||[]).some(function(F){return F===L})||A.some(function(F){return F.file.name+"_"+F.file.size===L});if(!N){if(S.size>Ma){var C="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(C,"error"):alert(C);continue}var P=URL.createObjectURL(S);p[P]=L,A.push({url:P,file:S,error:null}),w.push({url:P,file:S});var H=(e.get().fingerprints||[]).slice();H.push(L),e.set({fingerprints:H})}}if(A.length!==0){var q=(e.get().pendingImages||[]).concat(A),J=async function(){for(var F=0;F<w.length;F++){var le=w[F],U=le.file,V=le.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var G=(e.get().pendingImages||[]).filter(function(M){return M.url!==V}),ve=(e.get().images||[]).slice();ve.push(V),e.set({pendingImages:G,images:ve});continue}try{var Z=await Ze(Xe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke})});if(!Z.ok)throw Z.status===429?new Error("rate_limit"):new Error("sign failed");var D=await Z.json();if(!D.folder)throw new Error("sign folder missing");var I=new FormData;I.append("file",U),I.append("api_key",D.api_key),I.append("timestamp",D.timestamp),I.append("signature",D.signature),I.append("folder",D.folder);var _=await fetch("https://api.cloudinary.com/v1_1/"+D.cloud_name+"/image/upload",{method:"POST",body:I}),W=await _.json();if(W.secure_url&&zt(W.secure_url)){var ae=(e.get().pendingImages||[]).some(function(M){return M.url===V});if(!ae)continue;s[W.secure_url]=V,p[W.secure_url]=p[V];var tr=(e.get().pendingImages||[]).filter(function(M){return M.url!==V}),be=(e.get().images||[]).slice();be.push(W.secure_url),e.set({pendingImages:tr,images:be});try{Ze(Xe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke,secureUrl:W.secure_url})}).catch(function(){})}catch(M){}}else throw new Error("invalid image url")}catch(M){console.error("[renuvex-pr] Image upload failed:",M);var B=M.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(B,"error");var ne=(e.get().pendingImages||[]).map(function($){return $.url===V?{url:$.url,file:$.file,error:B}:$});e.set({pendingImages:ne})}}};if(T===0&&f===0){t=!0;var Y=!r.canNavigate||r.canNavigate();Y&&e.goNext()}e.set({pendingImages:q}),J()}}};var m=e.onChange(v);return v(),{el:a,destroy:function(){t=!0,d.onchange=null,m&&m()}}}var Dr=2e3,Fa=60;function $t(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content-form";var l=document.createElement("input");l.type="text",l.className="renuvex-pr-fwizard-input",l.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",l.maxLength=Fa,l.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),l.value=e.get().title||"",l.addEventListener("input",function(){e.set({title:l.value})}),o.appendChild(l);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Dr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),o.appendChild(d);function u(){var s=i.value.length;d.textContent=s+"/"+Dr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",s>=Dr)}function x(){return je(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),u(),t(x())}),a.appendChild(o),u(),setTimeout(function(){t(x())},0),{el:a,destroy:function(){}}}var Oa=40;function Qt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent="Hakk\u0131n\u0131zda",n.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Oa,u.setAttribute("aria-required","true"),u.value=e.get().author||"",i.appendChild(d),i.appendChild(u),l.appendChild(i);var x=document.createElement("div");x.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.textContent="E-posta (opsiyonel)";var p=document.createElement("input");p.type="email",p.className="renuvex-pr-fwizard-input",p.setAttribute("autocomplete","email"),p.value=e.get().email||"",x.appendChild(s),x.appendChild(p),l.appendChild(x);var v=document.createElement("div");v.className="renuvex-pr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",l.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg",y.setAttribute("role","alert"),y.setAttribute("aria-live","assertive"),l.appendChild(y);var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-submit-btn",c.textContent="G\xF6nder",l.appendChild(c),n.appendChild(l);function b(){return je(4,e.get())}function m(){var f=!b(),z=(e.get().pendingImages||[]).length,T=z>0;T?(c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(c.disabled=f,c.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",f),c.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),m(),t(b())}),p.addEventListener("input",function(){e.set({email:p.value})}),m(),setTimeout(function(){t(b())},0);function h(){y.textContent=""}function g(f){h();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=f||"",y.appendChild(z)}c.onclick=async function(){if(!c.disabled){var f=e.get(),z=(f.author||"").trim(),T=(f.comment||"").trim();if(p.value.trim()&&!p.checkValidity()){p.reportValidity();return}if(!z){g("Gerekli alan");return}if(!f.rating){g("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=c.textContent;if(c.textContent="G\xF6nderiliyor\u2026",h(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var w=yt(window.location.href),E=f.productName||null,S=await Ze(Xe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke,productId:f.productId||null,slug:w||null,productName:E,author:z,title:(f.title||"").trim()||null,comment:T||null,rating:f.rating,images:f.images||[]})},15e3);if(S.ok)a();else{var L=await S.json().catch(function(){return{}});throw new Error(L.error||"Yorum kaydedilemedi.")}}catch(P){var N=P&&(P.name==="AbortError"||/signal/i.test(P.message||"")),C=N?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":P.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(C,"error"):g(C),c.disabled=!1,c.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent=A}}};var k=e.onChange(m);return{el:n,destroy:function(){c.onclick=null,k&&k()}}}function Ha(e,r,t){if(t=t||{},e===1)return Xt(r,{canNavigate:t.canNavigate});if(e===2)return Zt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return $t(r,{onValidityChange:t.onValidityChange});if(e===4)return Qt(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function ea(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function ra(e){e=e||{};var r=Gt({productId:e.productId,productName:e.productName}),t={},a={},n={};function o(w){if(!(!w||typeof w!="string"||!w.startsWith("blob:")||n[w])){n[w]=!0;try{URL.revokeObjectURL(w)}catch(E){}}}function l(){Object.keys(a).forEach(function(E){o(E)}),Object.keys(t).forEach(function(E){o(t[E])});var w=r.get();(w.pendingImages||[]).forEach(function(E){o(E&&E.url)}),(w.images||[]).forEach(function(E){o(E)})}var i=qt({onClose:function(){window.removeEventListener("popstate",u),zr(d),l(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=wr(),u=function(w){i&&i.close&&i.close()};window.addEventListener("popstate",u);var x=document.createElement("div");x.className="renuvex-pr-fwizard-step-wrap";var s=Kt({skippableSteps:[2],nextableSteps:[3],onBack:function(){y==="idle"&&r.goBack()},onSkip:function(){y==="idle"&&r.goNext()},onNext:function(){y==="idle"&&r.goNext()}}),p=document.createElement("div");p.className="renuvex-pr-fwizard-layout",p.appendChild(x),p.appendChild(s.el);var v=null,y="idle",c=null,b=!0,m=null;function h(w,E){x.innerHTML="";var S=Ha(w,r,{canNavigate:function(){return y==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:o,onValidityChange:function(C){s.setNextDisabled(!C)},onSuccess:k,showToast:i.showToast});if(v=S,s.update(w,r.get()),E){y="entering",S.el.classList.add("renuvex-pr-fwizard-step--enter");var L=null,N=function(){L&&clearTimeout(L),S.el.removeEventListener("animationend",N),S.el.classList.remove("renuvex-pr-fwizard-step--enter"),y="idle",c!==null&&f()};S.el.addEventListener("animationend",N),L=setTimeout(N,700)}else y="idle";x.appendChild(S.el),i.setStepAttr&&i.setStepAttr(w),w===3&&s.setNextDisabled(!0)}var g=!1;function k(){if(!g){if(g=!0,!v){x.innerHTML="";var w=ea();w.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(w),i.setStepAttr("thanks"),s.setThanksState(i.close);return}var E=v;y="exiting",E.el.classList.add("renuvex-pr-fwizard-step--exit");var S=function(){if(m&&clearTimeout(m),E.el.removeEventListener("animationend",S),E.destroy)try{E.destroy()}catch(N){}v===E&&(v=null),x.innerHTML="";var L=ea();L.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(L),i.setStepAttr("thanks"),s.setThanksState(i.close),y="idle"};E.el.addEventListener("animationend",S),m=setTimeout(S,300)}}function f(){var w=r.get().currentStep;if(y!=="idle"){c=w;return}if(!v){var E=!b;b=!1,h(w,E);return}var S=v;y="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(m&&clearTimeout(m),S.el.removeEventListener("animationend",L),S.destroy)try{S.destroy()}catch(C){}if(v===S){x.innerHTML="",v=null;var N=c!==null?c:r.get().currentStep;c=null,h(N,!0),y="idle"}};S.el.addEventListener("animationend",L),m=setTimeout(L,350)}f();var z=r.get().currentStep,T=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,f()):s.update(w.currentStep,w)}),A=i.close;return i.close=function(){T&&T(),typeof m!="undefined"&&m&&clearTimeout(m),A()},i.open(p),{close:i.close}}function j(){ra({productId:O||"",productName:Pe||""})}var ta=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Ya={id:"classic",name:"Klasik (A\xE7\u0131k)"},Da=ta;function ja(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,x=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange;we(n);var v=document.createElement("div");v.className="renuvex-pr-summary";var y=(l[3]||0)+(l[4]||0),c=o>0?Math.round(y/o*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ee("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",v.appendChild(b);var m=document.createElement("div");if(m.className="renuvex-pr-summary-block renuvex-pr-summary-count",m.textContent=o.toLocaleString("tr-TR")+" Yorum",v.appendChild(m),a.showRecommendation!==!1&&c>0){var h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+c+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(h)}return v.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:s})),v.appendChild(X({widget:r,currentOrderBy:u,currentHasImages:x,onWriteClick:j,onSortChange:p})),v}var Ur={};ye(Ur,{css:()=>Va,meta:()=>Ua,render:()=>Ka});var aa=`
...
`;var Ua={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Va=aa,Wa="__unknown_product__",er=Object.create(null);function qa(e){return e?String(e):Wa}var Ae=null,rr=null;function Ga(){!Ae||!rr||(Ae.removeEventListener?Ae.removeEventListener("change",rr):Ae.removeListener&&Ae.removeListener(rr),Ae=null,rr=null)}function Ka(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,x=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange,v=qa(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var b=document.createElement("div");b.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Be(i,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+o.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+me(gt)+"</span>";var h=m.querySelector(".renuvex-pr-compact-trigger-text"),g=m.querySelector(".renuvex-pr-compact-chevron");if(h&&g){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",m.insertBefore(k,h),k.appendChild(h),k.appendChild(g)}b.appendChild(m),c.appendChild(b);var f=X({widget:r,currentOrderBy:u,currentHasImages:x,onWriteClick:j,onSortChange:p}),z=f.querySelector(".renuvex-pr-filter-wrap"),T=f.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",T&&A.appendChild(T),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+ee("full")+"</span><span>"+i+"</span>",E.appendChild(S),E.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){N()&&w.classList.contains("renuvex-pr-open")&&(er[v]=!0),s(I)}})),w.appendChild(E);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function N(){return!!(L&&L.matches)}function C(I){I?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",I?"false":"true"),m.setAttribute("aria-expanded",I?"true":"false")}function P(I){var _=I?y:b;if(w.parentNode!==_){var W=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&C(!1),W&&(er[v]=!1),_.appendChild(w)}}P(L?L.matches:!1);var H=X({widget:r,currentOrderBy:u,currentHasImages:x,onWriteClick:j,onSortChange:p}),q=H.querySelector(".renuvex-pr-filter-wrap"),J=H.querySelector(".renuvex-pr-write-btn"),Y=document.createElement("div");Y.className="renuvex-pr-compact-write-row",J&&Y.appendChild(J),q&&Y.appendChild(q),y.appendChild(Y);function F(){var I=w.classList.contains("renuvex-pr-open");return C(!1),N()&&(er[v]=!1),I}function le(){U&&U.notifyOpening(),C(!0),N()&&(er[v]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?F():le()};var U=null;function V(I){U&&(U.unregister(),U=null),I||(U=Sr({trigger:b,element:w,close:F}))}if(V(L?L.matches:!1),Ga(),L){var G=function(I){P(I.matches),V(I.matches)};L.addEventListener?L.addEventListener("change",G):L.addListener&&L.addListener(G),Ae=L,rr=G}if(N()&&er[v]&&C(!0),a.showRecommendation!==!1){var ve=(l[3]||0)+(l[4]||0),Z=o>0?Math.round(ve/o*100):0;if(Z>0){var D=document.createElement("div");D.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",D.style.marginTop="8px",D.innerHTML='<span class="renuvex-pr-recommend-pct">%'+Z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(D)}}return y}var Vr={};ye(Vr,{css:()=>Ja,meta:()=>Xa,render:()=>Za});var na=`
...
`;var Xa={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ja=na;function Za(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentHasImages,x=e.onFilterChange,s=e.onSortChange;we(a);var p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-split";var v=document.createElement("div");v.className="renuvex-pr-split-col renuvex-pr-split-left";var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",y.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ee("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",c.textContent=n.toLocaleString("tr-TR")+" Yorum",v.appendChild(c),p.appendChild(v);var b=document.createElement("div");b.className="renuvex-pr-split-col renuvex-pr-split-mid",b.appendChild(Ye({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:x})),p.appendChild(b);var m=X({widget:r,currentOrderBy:d,currentHasImages:u,onWriteClick:j,onSortChange:s}),h=m.querySelector(".renuvex-pr-filter-wrap"),g=m.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-right",g&&k.appendChild(g),h&&k.appendChild(h),p.appendChild(k);var f=(o[3]||0)+(o[4]||0),z=n>0?Math.round(f/n*100):0,T=document.createElement("div");T.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",T.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||z===0;return A&&T.classList.add("renuvex-pr-split-rec-hidden"),v.appendChild(T),p}var Wr={};ye(Wr,{css:()=>Qa,meta:()=>$a,render:()=>en});var ia=`
...
`;var $a={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Qa=ia;function en(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,i=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-minimal";var u=document.createElement("div");u.className="renuvex-pr-minimal-info";var x=document.createElement("div");x.className="renuvex-pr-minimal-row";var s=document.createElement("span");s.className="renuvex-pr-minimal-avg",s.textContent=n,x.appendChild(s);var p=document.createElement("span");p.className="renuvex-pr-minimal-stars",p.innerHTML=Be(n,t),x.appendChild(p);var v=document.createElement("span");v.className="renuvex-pr-minimal-count",v.textContent=a.toLocaleString("tr-TR")+" Yorum",x.appendChild(v),u.appendChild(x),d.appendChild(u);var y=X({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:j,onSortChange:i}),c=y.querySelector(".renuvex-pr-filter-wrap"),b=y.querySelector(".renuvex-pr-write-btn"),m=document.createElement("div");m.className="renuvex-pr-minimal-actions",b&&m.appendChild(b),c&&m.appendChild(c),d.appendChild(m);var h=X({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:j,onSortChange:i}),g=h.querySelector(".renuvex-pr-filter-wrap"),k=h.querySelector(".renuvex-pr-write-btn"),f=document.createElement("div");return f.className="renuvex-pr-minimal-write-row",k&&f.appendChild(k),g&&f.appendChild(g),d.appendChild(f),d}var qr={};ye(qr,{css:()=>tn,meta:()=>rn,render:()=>an});var oa=`
...
`;var rn={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},tn=oa;function an(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,i=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-hero";var u=document.createElement("div");u.className="renuvex-pr-hero-info";var x=document.createElement("div");x.className="renuvex-pr-hero-rating-col";var s=document.createElement("span");s.className="renuvex-pr-hero-avg",s.textContent=n,x.appendChild(s);var p=document.createElement("div");p.className="renuvex-pr-hero-meta-row";var v=document.createElement("span");v.className="renuvex-pr-hero-stars",v.innerHTML=Be(n,t),p.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-hero-count",y.textContent=a.toLocaleString("tr-TR")+" Yorum",p.appendChild(y),x.appendChild(p),u.appendChild(x),d.appendChild(u);var c=X({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:j,onSortChange:i}),b=c.querySelector(".renuvex-pr-filter-wrap"),m=c.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");h.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",m&&h.appendChild(m),b&&h.appendChild(b),d.appendChild(h);var g=X({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:j,onSortChange:i}),k=g.querySelector(".renuvex-pr-filter-wrap"),f=g.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-hero-write-row",f&&z.appendChild(f),k&&z.appendChild(k),d.appendChild(z),d}var la=`
  .renuvex-pr-summary{
