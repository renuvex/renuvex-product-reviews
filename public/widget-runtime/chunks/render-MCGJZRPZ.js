...
import{a as Le,d as Qe}from"./chunk-FW6W6ZQL.js";import{b as Ar,c as Xe}from"./chunk-ZM24JLBV.js";import{A as tr,a as ke,b as Vr,c as Ae,d as Ne,e as te,f as L,g as Gr,h as Pe,j as Sr,k as Wr,l as Er,m as We,n as qr,o as Ur,p as Xr,q as Kr,r as Zr,s as Jr,t as $r,v as Qr,w as et,x as rt,y as er,z as rr}from"./chunk-4OXLOSZH.js";import{A as ae,B as ot,C as ne,D as lt,E as pt,c as Cr,e as ge,f as W,g as q,h as ze,i as ar,j as qe,k as tt,m as at,n as ue,o as Be,q as nt,r as se,s as it,t as he,u as nr,v as V,w as ir,x as or,y as Tr,z as Lr}from"./chunk-FDKNCOZ5.js";import{a as Ue}from"./chunk-GSBAPHFO.js";import{a as fe,b as Ve,c as Ge,k as dt,l as Ce}from"./chunk-YCWIZ2SG.js";var Re=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function ut(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Ie(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function lr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function st(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function vt(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var pr=`
...
`;function jt(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function Dt(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function Vt(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",l=Dt()&&!a;if(n>0){var p=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",p+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Gt(e){var r=document.body.style,t=document.documentElement.style;ie(t,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Ke=0,Me=null;function dr(){return Ke+=1,Ke>1||(Me=jt(),Vt(Me)),Me}function ur(){if(Ke!==0&&(Ke-=1,!(Ke>0))){var e=Me;Me=null,e&&Gt(e)}}function sr(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function ve(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Wt(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Nr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Wt)}function Ze(e,r){var t=e,n=Nr(e);!n.length&&r&&(t=r,n=Nr(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;ve(a)}function vr(e,r,t){if(e.key==="Tab"){var n=Nr(r);if(!n.length){e.preventDefault(),Ze(r);return}var a=n[0],l=n[n.length-1],p=st(t);if(!r.contains(p)){e.preventDefault(),ve(a);return}e.shiftKey&&p===a?(e.preventDefault(),ve(l)):!e.shiftKey&&p===l&&(e.preventDefault(),ve(a))}}var ct="renuvexPrOverlay";function cr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[ct]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function qt(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[ct]===e.id)}function mr(e){if(qt(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Fe(e){return he(e)}function mt(e,r,t,n,a){ur(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&ar(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),ve(a)}function Ut(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ue(e.rating,L);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=se(e.createdAt),n.appendChild(a),n.appendChild(l),t.appendChild(n);var p=document.createElement("div");p.className="renuvex-pr-modal-title",p.textContent=e.title||"",p.style.display=e.title?"":"none",t.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-modal-author",o.textContent=e.author||"",t.appendChild(o);var u=document.createElement("div");u.className="renuvex-pr-modal-body",u.textContent=(e.comment||"").trim(),u.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(u);var v=document.createElement("div");v.className="renuvex-pr-modal-reply";var x=document.createElement("div");x.className="renuvex-pr-modal-reply-label",x.textContent=L&&L.merchantReplyLabel||"Ma\u011Faza Sahibi";var c=document.createElement("div");return c.className="renuvex-pr-modal-reply-text",c.textContent=e.merchantReply||"",v.appendChild(x),v.appendChild(c),v.style.display=e.merchantReply?"":"none",t.appendChild(v),r.appendChild(t),r}function xt(e,r,t){var n=t||L,a=e.querySelector(".renuvex-pr-modal-scroll-content"),l=a.querySelector(".renuvex-pr-modal-stars");l.innerHTML=ue(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=se(r.createdAt);var p=a.querySelector(".renuvex-pr-modal-title");p.textContent=r.title||"",p.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var o=a.querySelector(".renuvex-pr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var u=a.querySelector(".renuvex-pr-modal-reply");u.querySelector(".renuvex-pr-modal-reply-label").textContent=n&&n.merchantReplyLabel||"Ma\u011Faza Sahibi",u.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",u.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Br(e,r,t,n,a,l,p,o,u){var v=Fe(e),x=Math.max(0,Math.min(t||0,v.length-1)),c=document.createElement("div");c.className="renuvex-pr-modal-left";var i=document.createElement("img"),y=p==="next"?"renuvex-pr-modal-img-enter-right":p==="prev"?"renuvex-pr-modal-img-enter-left":"";i.className="renuvex-pr-modal-main-img"+(y?" "+y:""),i.src=Lr(v[x]||""),i.decoding="async",i.width=Tr,i.height=Math.round(Tr*4/3),i.alt="Yorum foto\u011Fraf\u0131",ot(i,function(T){if(T.style.display="none",!c.querySelector(".renuvex-pr-modal-img-error")){var S=document.createElement("div");S.className="renuvex-pr-modal-img-error",S.setAttribute("role","status"),S.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",c.insertBefore(S,T)}}),c.appendChild(i);var d=document.createElement("button");d.className="renuvex-pr-modal-close-mobile",d.textContent="\u2715",d.setAttribute("aria-label","Kapat"),d.onclick=function(T){T.stopPropagation(),l()},c.appendChild(d);var s=0;if(c.addEventListener("touchstart",function(T){s=T.touches[0].clientX},{passive:!0}),c.addEventListener("touchend",function(T){var S=s-T.changedTouches[0].clientX;if(!(Math.abs(S)<50)){if(S>0){if(w)ce(e,r,x+1,n,a,l,!0,"next",o,u);else if(m){var E=n[r+1];ce(E,r+1,0,n,a,l,!1,"next",o,u)}}else if(b)ce(e,r,x-1,n,a,l,!0,"prev",o,u);else if(z){var B=n[r-1],N=Fe(B);ce(B,r-1,N.length-1,n,a,l,!1,"prev",o,u)}}},{passive:!0}),v.length>1){var g=document.createElement("div");g.className="renuvex-pr-modal-thumbs",v.forEach(function(T,S){var E=document.createElement("img"),B=ae(T,or);E.src=B.src,E.srcset=B.srcset,E.loading="lazy",E.decoding="async",E.width=or,E.height=or,E.className="renuvex-pr-modal-thumb"+(S===x?" renuvex-pr-modal-thumb-active":""),E.alt="K\xFC\xE7\xFCk resim "+(S+1),ne(E),E.tabIndex=0,E.setAttribute("role","button"),E.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(S+1)+" se\xE7"),S===x&&E.setAttribute("aria-current","true"),(function(N){function R(){ce(e,r,N,n,a,l,!0,null,o,u)}E.onclick=R,E.onkeydown=function(I){(I.key==="Enter"||I.key===" ")&&(I.preventDefault(),R())}})(S),g.appendChild(E)}),c.appendChild(g)}var b=x>0,w=x<v.length-1,z=r>0,m=r<n.length-1,k=b||z,h=w||m;if(k){var f=document.createElement("button");f.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev",f.innerHTML="&#8249;",f.setAttribute("aria-label","\xD6nceki"),f.onclick=function(T){if(T.stopPropagation(),b)ce(e,r,x-1,n,a,l,!0,"prev",o,u);else if(z){var S=n[r-1],E=Fe(S);ce(S,r-1,E.length-1,n,a,l,!1,"prev",o,u)}},c.appendChild(f)}if(h){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next",C.innerHTML="&#8250;",C.setAttribute("aria-label","Sonraki"),C.onclick=function(T){if(T.stopPropagation(),w)ce(e,r,x+1,n,a,l,!0,"next",o,u);else if(m){var S=n[r+1];ce(S,r+1,0,n,a,l,!1,"next",o,u)}},c.appendChild(C)}return c}function ft(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Fe(n);a[0]&&(new Image().src=Lr(a[0]))}})}function Pr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Xt(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Pr(t),Pr(n),Pr(a)}l(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ce(e,r,t,n,a,l,p,o,u,v){if(v&&(v.currentReview=e),p){var x=Br(e,r,t,n,a,l,o,u,v);a.firstChild&&a.replaceChild(x,a.firstChild)}else{var x=Br(e,r,t,n,a,l,o,u,v),c=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&a.replaceChild(x,a.firstChild),c&&xt(c,e,v&&v.currentSettings),Xt(u,a)}ft(r,n)}function oe(e,r,t){var n=Fe(e);if(!n.length)return;var a=(t||[]).filter(function(h){return Fe(h).length>0}),l=a.findIndex(function(h){return h===e||h.id===e.id});l===-1&&(a.unshift(e),l=0);var p=n.indexOf(r);p<0&&(p=0);var o=document.createElement("div");o.className="renuvex-pr-modal-overlay";var u=document.createElement("div");u.className="renuvex-pr-modal";var v=!1,x=null,c=sr(),i=dr(),y=cr(),d={currentReview:e,currentSettings:L},s=null;function g(h){var f=h&&h.detail&&h.detail.settings;if(!(f&&f===s)){s=f||null,d.currentSettings=f||L;var C=u.querySelector(".renuvex-pr-modal-right");!C||!d.currentReview||xt(C,d.currentReview,d.currentSettings)}}function b(){v||(v=!0,window.removeEventListener(Ce,g),mt(x&&x.host,w,b,i,c))}function w(h){if(h.key==="Escape"){z();return}vr(h,o,x&&x.root)}function z(){v||(v=!0,window.removeEventListener(Ce,g),mt(x&&x.host,w,b,i,c),mr(y))}document.addEventListener("keydown",w),window.addEventListener("popstate",b),window.addEventListener(Ce,g),o.onclick=function(){z()},u.onclick=function(h){h.stopPropagation()},u.appendChild(Br(e,l,p,a,u,z,null,o,d)),u.appendChild(Ut(e)),ft(l,a);var m=document.createElement("div");m.className="renuvex-pr-modal-wrap",m.tabIndex=-1,m.setAttribute("role","dialog"),m.setAttribute("aria-modal","true"),m.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),m.appendChild(u);var k=document.createElement("button");k.className="renuvex-pr-modal-close",k.textContent="\u2715",k.setAttribute("aria-label","Kapat"),k.onclick=function(h){h.stopPropagation(),z()},m.appendChild(k),o.appendChild(m),x=lr(),Ie(x.root,Re+Le+pr),x.root.appendChild(o),ze(x.root),Ze(o)}var Mr={};fe(Mr,{meta:()=>aa,render:()=>na});function He(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,l=e.onFilterChange;ge(n);var p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var o=5;o>=1;o--){var u=r[o-1]||0,v=t>0?Math.round(u/t*100):0,x=a===o,c=document.createElement("div");c.className="renuvex-pr-bar-row"+(x?" renuvex-pr-bar-active":""),a&&!x&&(c.style.opacity="0.35");for(var i="",y=1;y<=5;y++){var d=y<=o;i+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(d?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+W(d?"full":"outline")+"</span>"}c.innerHTML='<span class="renuvex-pr-bar-label">'+i+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+v+'%;"></div></div><span class="renuvex-pr-bar-count">('+u.toLocaleString("tr-TR")+")</span>",(function(s){c.onclick=function(){l(s)}})(o),p.appendChild(c)}return p}var le=[],gt=!1;function Kt(e){for(var r=le.length-1;r>=0;r--){var t=le[r];t.trigger&&t.trigger.contains(e.target)||t.element&&t.element.contains(e.target)||t.close()}}function Zt(e){if(e.key==="Escape")for(var r=le.length-1;r>=0;r--)le[r].close()}function Jt(){gt||typeof document=="undefined"||(document.addEventListener("click",Kt,!0),document.addEventListener("keydown",Zt),gt=!0)}function xr(e){for(var r=0;r<le.length;r++)le[r]!==e&&le[r].close()}function fr(e){Jt();var r={trigger:e.trigger,element:e.element,close:e.close};return le.push(r),function(){var n=le.indexOf(r);n!==-1&&le.splice(n,1)}}function J(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,l=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var o=document.createElement("button");o.className="renuvex-pr-write-btn",o.textContent=L&&L.writeButtonText||"Yorum Yap",o.onclick=a,p.appendChild(o);var u=document.createElement("div");u.className="renuvex-pr-filter-wrap";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-filter-btn",v.setAttribute("aria-label","Filtrele"),v.setAttribute("aria-haspopup","menu"),v.setAttribute("aria-expanded","false");var x=L&&L.filterIcon||"lines";v.innerHTML=q(tt(x));var c=document.createElement("div");c.className="renuvex-pr-filter-menu",c.setAttribute("role","menu");var i=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],y=!1;function d(b){var w=c.classList.contains("renuvex-pr-open");c.classList.remove("renuvex-pr-open"),v.classList.remove("renuvex-pr-filter-btn-active"),v.setAttribute("aria-expanded","false");var z=b&&(b.restoreFocus===!0||b.restoreFocus==="auto"&&Qe());if(w&&z)try{v.focus({preventScroll:!0})}catch(m){try{v.focus()}catch(k){}}}function s(){xr(g),c.classList.add("renuvex-pr-open"),v.classList.add("renuvex-pr-filter-btn-active"),v.setAttribute("aria-expanded","true");var b=c.querySelector(".renuvex-pr-filter-item-active")||c.querySelector(".renuvex-pr-filter-item");b&&requestAnimationFrame(function(){try{b.focus({preventScroll:!0})}catch(w){try{b.focus()}catch(z){}}})}i.forEach(function(b){var w=b[2],z=w?n:!n&&(t||"newest")===b[0],m=document.createElement("button");m.type="button",m.className="renuvex-pr-filter-item"+(z?" renuvex-pr-filter-item-active":""),m.setAttribute("role","menuitem"),m.textContent=b[1];var k=!1;function h(f,C){f&&(f.preventDefault(),f.stopPropagation()),!k&&(k=!0,y=!0,d({restoreFocus:C}),l(b[0],w),setTimeout(function(){k=!1,y=!1},0))}m.addEventListener("pointerdown",function(f){f.button!==void 0&&f.button!==0||h(f,!1)}),typeof window!="undefined"&&!window.PointerEvent&&m.addEventListener("touchstart",function(f){h(f,!1)},{passive:!1}),m.addEventListener("mousedown",function(f){f.button!==void 0&&f.button!==0||h(f,!1)}),m.addEventListener("keydown",function(f){(f.key==="Enter"||f.key===" ")&&h(f,!0)}),m.onclick=function(f){h(f,!1)},c.appendChild(m)}),v.onclick=function(){c.classList.contains("renuvex-pr-open")?d({restoreFocus:"auto"}):s()},u.addEventListener("keydown",function(b){b.key==="Escape"&&c.classList.contains("renuvex-pr-open")&&(b.stopPropagation(),d({restoreFocus:!0}))}),u.addEventListener("focusout",function(b){if(c.classList.contains("renuvex-pr-open")&&!y){var w=b.relatedTarget;w&&u.contains(w)||d()}});var g=fr({trigger:u,element:c,close:d});return u.appendChild(v),u.appendChild(c),p.appendChild(u),p}var ht=`
...
`;function bt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,n=document.createElement("div");n.className="renuvex-pr-fwizard-overlay",n.tabIndex=-1,n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Yorum yapma formu");var a=document.createElement("div");a.className="renuvex-pr-fwizard",n.appendChild(a);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat"),l.innerHTML=q('<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>'),a.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",a.appendChild(p);var o=!1,u=null,v=null,x=!1;function c(){Ze(p,n)}function i(m){vr(m,n,u&&u.root)}function y(){o||(o=!0,document.removeEventListener("keydown",d),n.removeEventListener("click",s),l.removeEventListener("click",y),n.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(ar(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):n.parentNode&&n.parentNode.removeChild(n),ur(),x&&ve(v);try{r()}catch(m){}},200))}function d(m){if(m.key==="Escape"){y();return}i(m)}function s(m){m.target===n&&t&&y()}document.addEventListener("keydown",d),n.addEventListener("click",s),l.addEventListener("click",y);function g(m){v=sr(),x=Qe(),m&&p.appendChild(m),u=lr(),Ie(u.root,Re+Le+ht),u.root.appendChild(n),ze(u.root),dr(),requestAnimationFrame(function(){n.classList.add("renuvex-pr-fwizard-open"),c()})}var b=null,w=null;function z(m,k){if(k=k||"error",b){try{b.remove()}catch(h){}b=null}w&&(clearTimeout(w),w=null),b=document.createElement("div"),b.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+k,b.textContent=m,a.appendChild(b),w=setTimeout(function(){b&&(b.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(b){try{b.remove()}catch(h){}b=null}},300))},4e3)}return{open:g,close:y,content:p,setAllowOutsideClose:function(m){t=!!m},setStepAttr:function(m){a.setAttribute("data-step",String(m))},focusFirstControl:c,showToast:z}}var Rr=4;function Oe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function yt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(l){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<Rr&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(l){return l!==a})}}}}var $t='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function wt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},l=e.onNext||function(){},p=document.createElement("div");p.className="renuvex-pr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=q($t)+"<span>Geri</span>",o.addEventListener("click",function(){n()}),p.appendChild(o);var u=document.createElement("div");u.className="renuvex-pr-fwizard-footer-progress";for(var v=[],x=0;x<Rr;x++){var c=document.createElement("span");c.className="renuvex-pr-fwizard-progress-seg",u.appendChild(c),v.push(c)}p.appendChild(u);var i=document.createElement("button");i.type="button";var y=null;function d(g){y&&i.removeEventListener("click",y),y=g,g&&i.addEventListener("click",g)}p.appendChild(i);function s(g,b){var w=r.indexOf(g)!==-1,z=t.indexOf(g)!==-1,m=b&&(b.images&&b.images.length>0||b.pendingImages&&b.pendingImages.length>0);if(w)g===2&&m?(i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",d(function(){l()})):(i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.setAttribute("aria-label","Atla"),i.innerHTML="<span>Atla</span>",d(function(){a()})),i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),i.style.visibility="",i.tabIndex=0;else if(z){i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Sonraki"),i.innerHTML="Sonraki",i.style.visibility="",i.tabIndex=0;var k=Oe(g,b);i.disabled=!k,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!k),d(function(){i.disabled||l()})}else i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.innerHTML="",i.style.visibility="hidden",i.tabIndex=-1,i.disabled=!0,d(null)}return{el:p,update:function(g,b){v.forEach(function(z,m){m+1<=g?z.classList.add("renuvex-pr-fwizard-progress-seg-active"):z.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var w=g<=1;o.style.visibility=w?"hidden":"",o.style.pointerEvents=w?"none":"",o.tabIndex=w?-1:0,s(g,b)},setNextDisabled:function(g){i.classList.contains("renuvex-pr-fwizard-cta-btn")&&(i.disabled=!!g,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!g))},setThanksState:function(g){o.style.visibility="hidden",u.style.visibility="hidden",i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",i.style.visibility="",i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),d(g)}}}function kt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-stars",p.setAttribute("role","radiogroup"),p.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var o=qe(L||{});ge(o);var u=[];function v(d){u.forEach(function(s,g){var b=g<d;s.classList.toggle("renuvex-pr-fwizard-star-active",b),s.setAttribute("aria-checked",g+1===d?"true":"false"),s.innerHTML=b?W("full"):W("outline")})}function x(d,s){s&&typeof s.preventDefault=="function"&&s.preventDefault(),s&&typeof s.stopPropagation=="function"&&s.stopPropagation(),!n&&(n=!0,e.set({rating:d}),v(d),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var c=1;c<=5;c++)(function(d){var s=document.createElement("button");s.type="button",s.className="renuvex-pr-fwizard-star",s.setAttribute("role","radio"),s.setAttribute("aria-label",d+" y\u0131ld\u0131z"),s.innerHTML=W("outline"),s.addEventListener("mouseenter",function(){v(d)}),s.addEventListener("mouseleave",function(){v(e.get().rating)}),s.addEventListener("pointerdown",function(g){g.button&&g.button!==0||x(d,g)}),typeof window!="undefined"&&!window.PointerEvent&&s.addEventListener("touchstart",function(g){x(d,g)},{passive:!1}),s.addEventListener("mousedown",function(g){window.PointerEvent||x(d,g)}),s.addEventListener("keydown",function(g){(g.key==="Enter"||g.key===" ")&&x(d,g)}),s.addEventListener("click",function(g){x(d,g)}),u.push(s),p.appendChild(s)})(c);v(e.get().rating);var i=null,y=function(d){var s=d&&d.detail&&d.detail.settings;s&&s===i||(i=s||null,o=qe(s||L||{}),v(e.get().rating))};return window.addEventListener(Ce,y),t.appendChild(p),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Ce,y)}}}var zt=3,Qt=10*1024*1024;function Ct(e,r){r=r||{};var t=!1,n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",n.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",n.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle"),o.innerHTML=q('<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>')+"<span>Foto\u011Fraf Ekle</span>";var u=document.createElement("input");u.type="file",u.accept="image/*",u.multiple=!0,u.style.display="none",p.appendChild(o),p.appendChild(u);var v=document.createElement("div");v.className="renuvex-pr-fwizard-photo-previews",v.setAttribute("aria-live","polite"),p.appendChild(v),n.appendChild(p);var x=r.blobMap||{},c=r.urlToFinger||{};function i(){if(!t){var z=e.get().images||[],m=e.get().pendingImages||[],k=z.map(function(h){return{url:h,isPending:!1}}).concat(m.map(function(h){return{url:h.url,file:h.file,isPending:!0,error:h.error}}));v.innerHTML="",k.forEach(function(h){var f=x[h.url]||h.url,C=y(h,f);v.appendChild(C)}),b()}}function y(z,m){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var h=document.createElement("img");h.src=m,h.alt="",h.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(h);var f=document.createElement("div");f.className="renuvex-pr-fwizard-photo-loading",f.style.display="none",k.appendChild(f);var C=document.createElement("button");return C.type="button",C.className="renuvex-pr-fwizard-photo-remove",C.innerHTML="&#x2715;",k.appendChild(C),d(k,z,m),k}function d(z,m,k){var h=z.querySelector("img");h.src!==k&&(h.src=k);var f=z.querySelector(".renuvex-pr-fwizard-photo-loading");if(m.isPending&&m.error){f.style.display="flex",f.textContent="";var C=document.createElement("span");C.className="renuvex-pr-upload-error",C.textContent="\u2717 "+m.error,f.appendChild(C)}else f.style.display="none",f.textContent="";var T=z.querySelector(".renuvex-pr-fwizard-photo-remove");T.onclick=function(){var S=c[m.url]||(m.file?m.file.name+"_"+m.file.size:null);if(m.url.startsWith("blob:")&&URL.revokeObjectURL(m.url),S){var E=(e.get().fingerprints||[]).filter(function(R){return R!==S});e.set({fingerprints:E})}if(m.isPending){var B=(e.get().pendingImages||[]).filter(function(R){return R.url!==m.url});e.set({pendingImages:B})}else{var N=(e.get().images||[]).filter(function(R){return R!==m.url});e.set({images:N})}}}var s='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',g='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function b(){var z=(e.get().images||[]).length,m=(e.get().pendingImages||[]).length,k=z+m,h=k>=zt;k>0?(p.classList.add("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=q(g)):(p.classList.remove("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=q(s)+"<span>Foto\u011Fraf Ekle</span>"),h?(o.style.display="none",o.disabled=!0,u.disabled=!0):(o.style.display="flex",o.disabled=!1,u.disabled=!1,o.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){u.disabled||u.click()}),u.onchange=async function(z){var m=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(z.target.files).slice(0,zt-m);u.value="";var h=(e.get().pendingImages||[]).length,f=e.get().images||[],C=f.length;if(k.length!==0){for(var T=[],S=[],E=0;E<k.length;E++){var B=k[E],N=B.name+"_"+B.size,R=(e.get().fingerprints||[]).some(function(H){return H===N})||T.some(function(H){return H.file.name+"_"+H.file.size===N});if(R){console.log("[renuvex-pr] Duplicate file detected, skipping:",B.name);continue}if(B.size>Qt){var I="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(I,"error"):alert(I);continue}var A=URL.createObjectURL(B);c[A]=N,T.push({url:A,file:B,error:null}),S.push({url:A,file:B});var $=(e.get().fingerprints||[]).slice();$.push(N),e.set({fingerprints:$})}if(T.length!==0){var me=(e.get().pendingImages||[]).concat(T),U=async function(){for(var H=0;H<S.length;H++){var be=S[H],je=be.file,X=be.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var De=(e.get().pendingImages||[]).filter(function(O){return O.url!==X}),Q=(e.get().images||[]).slice();Q.push(X),e.set({pendingImages:De,images:Q});continue}try{var K=await Ue(Ge+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ve})});if(!K.ok)throw K.status===429?new Error("rate_limit"):new Error("sign failed");var j=await K.json();if(!j.folder)throw new Error("sign folder missing");var ee=new FormData;ee.append("file",je),ee.append("api_key",j.api_key),ee.append("timestamp",j.timestamp),ee.append("signature",j.signature),ee.append("folder",j.folder);var ye=await fetch("https://api.cloudinary.com/v1_1/"+j.cloud_name+"/image/upload",{method:"POST",body:ee}),re=await ye.json();if(re.secure_url&&it(re.secure_url)){var pe=(e.get().pendingImages||[]).some(function(O){return O.url===X});if(!pe){console.log("[renuvex-pr] Upload finished but image was already deleted by user. Aborting state update.");return}x[re.secure_url]=X,c[re.secure_url]=c[X];var Ee=(e.get().pendingImages||[]).filter(function(O){return O.url!==X}),Te=(e.get().images||[]).slice();Te.push(re.secure_url),e.set({pendingImages:Ee,images:Te});try{Ue(Ge+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ve,secureUrl:re.secure_url})}).catch(function(){})}catch(O){}}else throw new Error("invalid image url")}catch(O){console.error("[renuvex-pr] Image upload failed:",O);var xe=O.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(xe,"error");var de=(e.get().pendingImages||[]).map(function(D){return D.url===X?{url:D.url,file:D.file,error:xe}:D});e.set({pendingImages:de})}}};if(C===0&&h===0){t=!0;var _=!r.canNavigate||r.canNavigate();_&&e.goNext()}e.set({pendingImages:me}),U()}}};var w=e.onChange(i);return i(),{el:n,destroy:function(){t=!0,u.onchange=null,w&&w()}}}var Ir=2e3,ea=60;function St(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",n.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",p.maxLength=ea,p.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),p.value=e.get().title||"",p.addEventListener("input",function(){e.set({title:p.value})}),l.appendChild(p);var o=document.createElement("textarea");o.className="renuvex-pr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=Ir,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",l.appendChild(o);var u=document.createElement("div");u.className="renuvex-pr-fwizard-char-counter",u.setAttribute("aria-live","polite"),l.appendChild(u);function v(){var c=o.value.length;u.textContent=c+"/"+Ir,u.classList.toggle("renuvex-pr-fwizard-char-counter--max",c>=Ir)}function x(){return Oe(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),v(),t(x())}),n.appendChild(l),v(),setTimeout(function(){t(x())},0),{el:n,destroy:function(){}}}var ra=40;function Et(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",a.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-author-form";var o=document.createElement("div");o.className="renuvex-pr-fwizard-field";var u=document.createElement("label");u.className="renuvex-pr-fwizard-label",u.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var v=document.createElement("input");v.type="text",v.className="renuvex-pr-fwizard-input",v.maxLength=ra,v.setAttribute("aria-required","true"),v.value=e.get().author||"",o.appendChild(u),o.appendChild(v),p.appendChild(o);var x=document.createElement("div");x.className="renuvex-pr-fwizard-field";var c=document.createElement("label");c.className="renuvex-pr-fwizard-label",c.textContent="E-posta (opsiyonel)";var i=document.createElement("input");i.type="email",i.className="renuvex-pr-fwizard-input",i.setAttribute("autocomplete","email"),i.value=e.get().email||"",x.appendChild(c),x.appendChild(i),p.appendChild(x);var y=document.createElement("div");y.className="renuvex-pr-fwizard-notice",y.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",p.appendChild(y);var d=document.createElement("div");d.className="renuvex-pr-fwizard-msg",d.setAttribute("role","alert"),d.setAttribute("aria-live","assertive"),p.appendChild(d);var s=document.createElement("button");s.type="button",s.className="renuvex-pr-fwizard-submit-btn",s.textContent="G\xF6nder",p.appendChild(s),a.appendChild(p);function g(){return Oe(4,e.get())}function b(){var k=!g(),h=(e.get().pendingImages||[]).length,f=h>0;f?(s.disabled=!0,s.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),s.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(s.disabled=k,s.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",k),s.textContent="G\xF6nder")}v.addEventListener("input",function(){e.set({author:v.value}),b(),t(g())}),i.addEventListener("input",function(){e.set({email:i.value})}),b(),setTimeout(function(){t(g())},0);function w(){d.textContent=""}function z(k){w();var h=document.createElement("div");h.className="renuvex-pr-fwizard-msg-error",h.textContent=k||"",d.appendChild(h)}s.onclick=async function(){if(!s.disabled){var k=e.get(),h=(k.author||"").trim(),f=(k.comment||"").trim();if(i.value.trim()&&!i.checkValidity()){i.reportValidity();return}if(!h){z("Gerekli alan");return}if(!k.rating){z("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}s.disabled=!0,s.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var C=s.textContent;if(s.textContent="G\xF6nderiliyor\u2026",w(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){n()},600);return}try{var T=at(window.location.href),S=k.productName||null,E=await Ue(Ge+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ve,productId:k.productId||null,slug:T||null,productName:S,author:h,title:(k.title||"").trim()||null,comment:f||null,rating:k.rating,images:k.images||[]})},15e3);if(E.ok)n();else{var B=await E.json().catch(function(){return{}});throw new Error(B.error||"Yorum kaydedilemedi.")}}catch(I){var N=I&&(I.name==="AbortError"||/signal/i.test(I.message||"")),R=N?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":I.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(R,"error"):z(R),s.disabled=!1,s.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),s.textContent=C}}};var m=e.onChange(b);return{el:a,destroy:function(){s.onclick=null,m&&m()}}}function ta(e,r,t){if(t=t||{},e===1)return kt(r,{canNavigate:t.canNavigate});if(e===2)return Ct(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,showToast:t.showToast});if(e===3)return St(r,{onValidityChange:t.onValidityChange});if(e===4)return Et(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Tt(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Lt(e){e=e||{};var r=yt({productId:e.productId,productName:e.productName}),t={},n={},a=bt({onClose:function(){window.removeEventListener("popstate",p),mr(l),Object.keys(t).forEach(function(h){var f=t[h];f&&f.startsWith("blob:")&&URL.revokeObjectURL(f)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),l=cr(),p=function(h){a&&a.close&&a.close()};window.addEventListener("popstate",p);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-wrap";var u=wt({skippableSteps:[2],nextableSteps:[3],onBack:function(){c==="idle"&&r.goBack()},onSkip:function(){c==="idle"&&r.goNext()},onNext:function(){c==="idle"&&r.goNext()}}),v=document.createElement("div");v.className="renuvex-pr-fwizard-layout",v.appendChild(o),v.appendChild(u.el);var x=null,c="idle",i=null,y=!0,d=null;function s(h,f){o.innerHTML="";var C=ta(h,r,{canNavigate:function(){return c==="idle"},blobMap:t,urlToFinger:n,onValidityChange:function(E){u.setNextDisabled(!E)},onSuccess:b,showToast:a.showToast});if(x=C,u.update(h,r.get()),f){c="entering",C.el.classList.add("renuvex-pr-fwizard-step--enter");var T=null,S=function(){T&&clearTimeout(T),C.el.removeEventListener("animationend",S),C.el.classList.remove("renuvex-pr-fwizard-step--enter"),c="idle",i!==null&&w()};C.el.addEventListener("animationend",S),T=setTimeout(S,700)}else c="idle";o.appendChild(C.el),a.setStepAttr&&a.setStepAttr(h),h===3&&u.setNextDisabled(!0)}var g=!1;function b(){if(!g){if(g=!0,!x){o.innerHTML="";var h=Tt();h.classList.add("renuvex-pr-fwizard-step--enter"),o.appendChild(h),a.setStepAttr("thanks"),u.setThanksState(a.close);return}var f=x;c="exiting",f.el.classList.add("renuvex-pr-fwizard-step--exit");var C=function(){if(d&&clearTimeout(d),f.el.removeEventListener("animationend",C),f.destroy)try{f.destroy()}catch(S){}x===f&&(x=null),o.innerHTML="";var T=Tt();T.classList.add("renuvex-pr-fwizard-step--enter"),o.appendChild(T),a.setStepAttr("thanks"),u.setThanksState(a.close),c="idle"};f.el.addEventListener("animationend",C),d=setTimeout(C,300)}}function w(){var h=r.get().currentStep;if(c!=="idle"){i=h;return}if(!x){var f=!y;y=!1,s(h,f);return}var C=x;c="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(d&&clearTimeout(d),C.el.removeEventListener("animationend",T),C.destroy)try{C.destroy()}catch(E){}if(x===C){o.innerHTML="",x=null;var S=i!==null?i:r.get().currentStep;i=null,s(S,!0),c="idle"}};C.el.addEventListener("animationend",T),d=setTimeout(T,350)}w();var z=r.get().currentStep,m=r.onChange(function(h){h.currentStep!==z?(z=h.currentStep,w()):u.update(h.currentStep,h)}),k=a.close;return a.close=function(){m&&m(),typeof d!="undefined"&&d&&clearTimeout(d),k()},a.open(v),{close:a.close}}function Y(){Lt({productId:te||"",productName:Pe||""})}var aa={id:"classic",name:"Klasik (A\xE7\u0131k)"};function na(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,l=e.allCount,p=e.ratingCounts,o=e.avgRatingVal,u=e.currentRatingFilter,v=e.currentOrderBy,x=e.currentHasImages,c=e.onFilterChange,i=e.onSortChange;ge(a);var y=document.createElement("div");y.className="renuvex-pr-summary";var d=(p[3]||0)+(p[4]||0),s=l>0?Math.round(d/l*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-avg",g.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+W("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",y.appendChild(g);var b=document.createElement("div");if(b.className="renuvex-pr-summary-block renuvex-pr-summary-count",b.textContent=l.toLocaleString("tr-TR")+" Yorum",y.appendChild(b),n.showRecommendation!==!1&&s>0){var w=document.createElement("div");w.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",w.innerHTML='<span class="renuvex-pr-recommend-pct">%'+s+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",y.appendChild(w)}return y.appendChild(He({ratingCounts:p,allCount:l,iconPair:a,currentRatingFilter:u,onFilterChange:c})),y.appendChild(J({widget:r,currentOrderBy:v,currentHasImages:x,onWriteClick:Y,onSortChange:i})),y}var Fr={};fe(Fr,{css:()=>oa,meta:()=>ia,render:()=>la});var At=`
...
`;var ia={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},oa=At;function la(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,l=e.ratingCounts,p=e.avgRatingVal,o=e.currentRatingFilter,u=e.currentOrderBy,v=e.currentHasImages,x=e.onFilterChange,c=e.onSortChange,i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-compact";var y=document.createElement("div");y.className="renuvex-pr-compact-header";var d=document.createElement("div");d.className="renuvex-pr-compact-trigger-wrap";var s=document.createElement("button");s.className="renuvex-pr-compact-trigger",s.type="button",s.setAttribute("aria-expanded","false"),s.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Be(p,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+q('<svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg>')+"</span>",d.appendChild(s),y.appendChild(d);var g=J({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:Y,onSortChange:c}),b=g.querySelector(".renuvex-pr-filter-wrap"),w=g.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");z.className="renuvex-pr-compact-actions-slot",w&&z.appendChild(w),b&&z.appendChild(b),y.appendChild(z),i.appendChild(y);var m=document.createElement("div");m.className="renuvex-pr-compact-panel",m.setAttribute("role","dialog"),m.setAttribute("aria-hidden","true");var k=document.createElement("div");k.className="renuvex-pr-compact-panel-inner";var h=document.createElement("div");h.className="renuvex-pr-compact-avg",h.innerHTML='<span class="renuvex-pr-icon">'+W("full")+"</span><span>"+p+"</span>",k.appendChild(h),k.appendChild(He({ratingCounts:l,allCount:a,iconPair:n,currentRatingFilter:o,onFilterChange:x})),m.appendChild(k);var f=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(_){var H=_?i:d;m.parentNode!==H&&(m.classList.contains("renuvex-pr-open")&&(m.classList.remove("renuvex-pr-open"),m.setAttribute("aria-hidden","true"),s.setAttribute("aria-expanded","false")),H.appendChild(m))}if(C(f?f.matches:!1),f){var T=function(_){C(_.matches)};f.addEventListener?f.addEventListener("change",T):f.addListener&&f.addListener(T)}if(w){var S=document.createElement("button");S.className="renuvex-pr-write-btn",S.textContent=L&&L.writeButtonText||"Yorum Yap",S.onclick=Y;var E=document.createElement("div");E.className="renuvex-pr-compact-write-row",E.appendChild(S),i.appendChild(E)}function B(){m.classList.remove("renuvex-pr-open"),m.setAttribute("aria-hidden","true"),s.setAttribute("aria-expanded","false")}function N(){xr(R),m.classList.add("renuvex-pr-open"),m.setAttribute("aria-hidden","false"),s.setAttribute("aria-expanded","true")}s.onclick=function(){m.classList.contains("renuvex-pr-open")?B():N()};var R=null;function I(_){R&&(R(),R=null),_||(R=fr({trigger:d,element:m,close:B}))}if(I(f?f.matches:!1),f){var A=function(_){I(_.matches)};f.addEventListener?f.addEventListener("change",A):f.addListener&&f.addListener(A)}if(t.showRecommendation!==!1){var $=(l[3]||0)+(l[4]||0),me=a>0?Math.round($/a*100):0;if(me>0){var U=document.createElement("div");U.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",U.style.marginTop="8px",U.innerHTML='<span class="renuvex-pr-recommend-pct">%'+me+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(U)}}return i}var Hr={};fe(Hr,{css:()=>da,meta:()=>pa,render:()=>ua});var Nt=`
...
`;var pa={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},da=Nt;function ua(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,l=e.ratingCounts,p=e.avgRatingVal,o=e.currentRatingFilter,u=e.currentOrderBy,v=e.currentHasImages,x=e.onFilterChange,c=e.onSortChange;ge(n);var i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-split";var y=document.createElement("div");y.className="renuvex-pr-split-col renuvex-pr-split-left";var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",d.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+W("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",y.appendChild(d);var s=document.createElement("div");s.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",s.textContent=a.toLocaleString("tr-TR")+" Yorum",y.appendChild(s),i.appendChild(y);var g=document.createElement("div");g.className="renuvex-pr-split-col renuvex-pr-split-mid",g.appendChild(He({ratingCounts:l,allCount:a,iconPair:n,currentRatingFilter:o,onFilterChange:x})),i.appendChild(g);var b=J({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:Y,onSortChange:c}),w=b.querySelector(".renuvex-pr-filter-wrap"),z=b.querySelector(".renuvex-pr-write-btn"),m=document.createElement("div");m.className="renuvex-pr-split-col renuvex-pr-split-right",z&&m.appendChild(z),w&&m.appendChild(w),i.appendChild(m);var k=(l[3]||0)+(l[4]||0),h=a>0?Math.round(k/a*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",f.innerHTML='<span class="renuvex-pr-recommend-pct">%'+h+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var C=t.showRecommendation===!1||h===0;return C&&f.classList.add("renuvex-pr-split-rec-hidden"),y.appendChild(f),i}var Or={};fe(Or,{css:()=>va,meta:()=>sa,render:()=>ca});var Pt=`
...
`;var sa={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},va=Pt;function ca(e){var r=e.widget,t=e.iconPair,n=e.allCount,a=e.avgRatingVal,l=e.currentOrderBy,p=e.currentHasImages,o=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-minimal";var v=document.createElement("div");v.className="renuvex-pr-minimal-info";var x=document.createElement("div");x.className="renuvex-pr-minimal-row";var c=document.createElement("span");c.className="renuvex-pr-minimal-avg",c.textContent=a,x.appendChild(c);var i=document.createElement("span");i.className="renuvex-pr-minimal-stars",i.innerHTML=Be(a,t),x.appendChild(i);var y=document.createElement("span");y.className="renuvex-pr-minimal-count",y.textContent=n.toLocaleString("tr-TR")+" Yorum",x.appendChild(y),v.appendChild(x),u.appendChild(v);var d=J({widget:r,currentOrderBy:l,currentHasImages:p,onWriteClick:Y,onSortChange:o}),s=d.querySelector(".renuvex-pr-filter-wrap"),g=d.querySelector(".renuvex-pr-write-btn"),b=document.createElement("div");if(b.className="renuvex-pr-minimal-actions",g&&b.appendChild(g),s&&b.appendChild(s),u.appendChild(b),g){var w=document.createElement("button");w.className="renuvex-pr-write-btn",w.textContent=L&&L.writeButtonText||"Yorum Yap",w.onclick=Y;var z=document.createElement("div");z.className="renuvex-pr-minimal-write-row",z.appendChild(w),u.appendChild(z)}return u}var _r={};fe(_r,{css:()=>xa,meta:()=>ma,render:()=>fa});var Bt=`
...
`;var ma={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},xa=Bt;function fa(e){var r=e.widget,t=e.iconPair,n=e.allCount,a=e.avgRatingVal,l=e.currentOrderBy,p=e.currentHasImages,o=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var v=document.createElement("div");v.className="renuvex-pr-hero-info";var x=document.createElement("div");x.className="renuvex-pr-hero-rating-col";var c=document.createElement("span");c.className="renuvex-pr-hero-avg",c.textContent=a,x.appendChild(c);var i=document.createElement("div");i.className="renuvex-pr-hero-meta-row";var y=document.createElement("span");y.className="renuvex-pr-hero-stars",y.innerHTML=Be(a,t),i.appendChild(y);var d=document.createElement("div");d.className="renuvex-pr-hero-count",d.textContent=n.toLocaleString("tr-TR")+" Yorum",i.appendChild(d),x.appendChild(i),v.appendChild(x),u.appendChild(v);var s=J({widget:r,currentOrderBy:l,currentHasImages:p,onWriteClick:Y,onSortChange:o}),g=s.querySelector(".renuvex-pr-filter-wrap"),b=s.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-hero-actions renuvex-pr-desktop-only",b&&w.appendChild(b),g&&w.appendChild(g),u.appendChild(w);var z=J({widget:r,currentOrderBy:l,currentHasImages:p,onWriteClick:Y,onSortChange:o}),m=z.querySelector(".renuvex-pr-filter-wrap"),k=z.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");return h.className="renuvex-pr-hero-write-row",k&&h.appendChild(k),m&&h.appendChild(m),u.appendChild(h),u}var gr={classic:Mr,compact:Fr,split:Hr,minimal:Or,hero:_r};function hr(e){return gr[e]||gr.classic}function Rt(){return Object.keys(gr).map(function(e){return gr[e].css||""}).join(`
`)}var Yr={};fe(Yr,{css:()=>ha,meta:()=>ga,render:()=>ba});function _e(e,r,t){var n=t||{},a=document.createDocumentFragment(),l=document.createElement("div");l.className=r+" renuvex-pr-body-clamped",l.textContent=e,a.appendChild(l);var p=document.createElement("button");return p.type="button",p.className="renuvex-pr-read-more",p.textContent="Devam\u0131n\u0131 oku",p.style.display="none",a.appendChild(p),requestAnimationFrame(function(){if(l.scrollHeight>l.clientHeight+2)if(p.style.display="inline-block",typeof n.onReadMore=="function")p.onclick=n.onReadMore;else{var o=!1;p.onclick=function(){o=!o,l.classList.toggle("renuvex-pr-body-clamped",!o),p.textContent=o?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),{fragment:a,body:l,readMore:p}}function Ye(e,r){if(!e)return null;var t=document.createElement("div");t.className="renuvex-pr-reply";var n=document.createElement("div");n.className="renuvex-pr-reply-header";var a=document.createElement("span");a.className="renuvex-pr-reply-label",a.textContent=L&&L.merchantReplyLabel||"Ma\u011Faza Sahibi",n.appendChild(a),t.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-reply-text renuvex-pr-reply-text-clamped",l.textContent=e,t.appendChild(l);var p=document.createElement("button");return p.type="button",p.className="renuvex-pr-read-more renuvex-pr-reply-read-more",p.textContent="Devam\u0131n\u0131 oku",p.style.display="none",t.appendChild(p),requestAnimationFrame(function(){if(l.scrollHeight>l.clientHeight+2)if(p.style.display="inline",typeof r=="function")p.onclick=r;else{var o=!1;p.onclick=function(){o=!o,l.classList.toggle("renuvex-pr-reply-text-clamped",!o),p.textContent=o?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),t}var ga={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},ha="";function ba(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var n=document.createElement("div");n.className="renuvex-pr-review-top";var a=document.createElement("div");a.className="renuvex-pr-review-top-left";var l=document.createElement("span");l.className="renuvex-pr-review-stars",l.innerHTML=ue(e.rating,L),a.appendChild(l);var p=document.createElement("time");if(p.className="renuvex-pr-date",e.createdAt&&p.setAttribute("datetime",e.createdAt),p.textContent=se(e.createdAt),n.appendChild(a),n.appendChild(p),t.appendChild(n),e.title){var o=document.createElement("div");o.className="renuvex-pr-review-title",o.textContent=e.title,t.appendChild(o)}var u=document.createElement("div");u.className="renuvex-pr-author",u.textContent=e.author||"",t.appendChild(u);var v=(e.comment||"").trim();v&&t.appendChild(_e(v,"renuvex-pr-body").fragment);var x=he(e);if(x.length){var c=document.createElement("div");c.className="renuvex-pr-gallery",x.forEach(function(y){var d=document.createElement("img"),s=ae(y,V);d.src=s.src,d.srcset=s.srcset,d.loading="lazy",d.decoding="async",d.width=V,d.height=V,d.className="renuvex-pr-img",ne(d),d.setAttribute("data-renuvex-img-url",y),d.setAttribute("role","button"),d.setAttribute("tabindex","0"),d.setAttribute("aria-label","Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),(function(g){var b=function(){oe(e,g,r)};d.onclick=b,d.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Spacebar")&&(w.preventDefault(),b())}})(y),c.appendChild(d)}),t.appendChild(c)}var i=Ye(e.merchantReply);return i&&t.appendChild(i),t}var jr={};fe(jr,{css:()=>wa,meta:()=>ya,render:()=>ka});var It=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var ya={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-w-mobile":"80px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-w-mobile":"100px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-w-mobile":"110px"}}},wa=It;function ka(e,r){var t=he(e),n=t.length>0,a=document.createElement("article");a.className="renuvex-pr-review-list"+(n?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var p=document.createElement("span");p.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",p.innerHTML=ue(e.rating,L),l.appendChild(p);var o=document.createElement("span");o.className="renuvex-pr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var u=document.createElement("time");u.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=se(e.createdAt),l.appendChild(u),a.appendChild(l);var v=document.createElement("div");if(v.className="renuvex-pr-review-list-content",e.title){var x=document.createElement("div");x.className="renuvex-pr-review-list-title",x.textContent=e.title,v.appendChild(x)}var c=(e.comment||"").trim();c&&v.appendChild(_e(c,"renuvex-pr-review-list-body").fragment);var i=Ye(e.merchantReply);if(i&&v.appendChild(i),a.appendChild(v),n){var y=document.createElement("div");y.className="renuvex-pr-review-list-media",t.forEach(function(d){var s=document.createElement("img"),g=ae(d,V);s.src=g.src,s.srcset=g.srcset,s.loading="lazy",s.decoding="async",s.width=V,s.height=Math.round(V*4/3),s.setAttribute("data-renuvex-img-url",d),ne(s),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-label","Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),(function(b){var w=function(){oe(e,b,r)};s.onclick=w,s.onkeydown=function(z){(z.key==="Enter"||z.key===" "||z.key==="Spacebar")&&(z.preventDefault(),w())}})(d),y.appendChild(s)}),a.appendChild(y)}return a}var Dr={};fe(Dr,{css:()=>Ca,meta:()=>za,render:()=>Sa});var Mt=`
...
`;var za={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Ca=Mt;function Sa(e,r){var t=nr(e),n=!!t,a=document.createElement("article");a.className="renuvex-pr-review-gallery"+(n?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var p=document.createElement("span");if(p.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",p.innerHTML=ue(e.rating,L),l.appendChild(p),e.title){var o=document.createElement("div");o.className="renuvex-pr-review-gallery-title",o.textContent=e.title,l.appendChild(o)}var u=document.createElement("div");u.className="renuvex-pr-review-gallery-author",u.textContent=e.author||"",l.appendChild(u);var v=document.createElement("time");v.className="renuvex-pr-review-gallery-date",v.style.display="block",e.createdAt&&v.setAttribute("datetime",e.createdAt),v.textContent=se(e.createdAt),l.appendChild(v);var x=(e.comment||"").trim();if(x&&l.appendChild(_e(x,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){oe(e,t,r)}}:null).fragment),a.appendChild(l),n){var c=document.createElement("div");c.className="renuvex-pr-review-gallery-media";var i=document.createElement("img"),y=ae(t,ir);i.src=y.src,i.srcset=y.srcset,i.loading="lazy",i.decoding="async",i.width=ir,i.height=Math.round(ir*4/3),ne(i),i.setAttribute("data-renuvex-img-url",t),i.setAttribute("role","button"),i.setAttribute("tabindex","0"),i.setAttribute("aria-label","Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt");var d=function(){oe(e,t,r)};i.onclick=d,i.onkeydown=function(g){(g.key==="Enter"||g.key===" "||g.key==="Spacebar")&&(g.preventDefault(),d())},c.appendChild(i),a.appendChild(c)}var s=Ye(e.merchantReply,t?function(){oe(e,t,r)}:null);return s&&(s.classList.add("renuvex-pr-review-gallery-reply"),a.appendChild(s)),a}var br={card:Yr,list:jr,gallery:Dr};function Je(e){return br[e]||br.card}function Ft(){return Object.keys(br).map(function(e){return br[e].css||""}).join(`
`)}function Se(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),a=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+n+","+a+","+l+","+r+")"}function Ea(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",n=document.createElementNS(t,"svg");n.setAttribute("width","32"),n.setAttribute("height","32"),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.style.cssText="color:#6e6d7a;margin-bottom:4px;";var a=document.createElementNS(t,"path");a.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),n.appendChild(a),n.appendChild(l);var p=document.createElement("div");p.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",p.textContent="Widget \u015Fu anda Pasif durumda";var o=document.createElement("div");return o.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",o.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(n),r.appendChild(p),r.appendChild(o),r}function Ta(){return dt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function La(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=lt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),pt(t,{surface:"reviews",productId:r||""}),t}var Ht={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Ot={small:80,medium:110,large:140};function Aa(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="renuvex-pr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var a=document.createElement("button");return a.type="button",a.className="renuvex-pr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},t.appendChild(a),t}function Na(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",p=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",u=r.barCountColor||"#111111",v=Se(p,.06),x=r.reviewStarColor||"#f59e0b",c=r.btnBgColor||"#111111",i=r.btnTextColor||"#ffffff",y=r.btnBorderColor||"#111111",d=r.filterBtnBgColor||"#111111",s=r.filterBtnTextColor||"#ffffff",g=r.filterBtnBorderColor||"#111111",b=r.filterMenuBgColor||"#ffffff",w=r.filterMenuBorderColor||"#e5e7eb",z=r.filterItemTextColor||"#111111",m=r.filterItemHoverBgColor||"#f3f4f6",k=r.filterItemActiveColor||"#111111",h=r.reviewTitleColor||"#111111",f=r.reviewAuthorColor||"#111111",C=r.reviewDateColor||"#5e5e5e",T=r.reviewBodyColor||"#111111",S=r.reviewBorderColor||"#e5e7eb",E=r.replyBgColor||"#f9fafb",B=r.replyBorderColor||"#747474",N=r.replyLabelColor||"#111111",R=r.replyTextColor||"#111111",I=r.photoTitleColor||"#111111",A=Se("#111111",.05),$=r.photoArrowBgColor||"#ffffff",me=r.photoArrowTextColor||"#111111",U=Se("#111111",.12),_=r.formBgColor||"#ffffff",H=r.formPrimaryTextColor||"#111111",be=r.formSecondaryTextColor||"#3b3b3b",je=r.inputTextColor||H,X=r.inputBorderColor||"#d1d5db",De=r.placeholderColor||"#9ca3af",Q=r.formStepBarColor||"#111111",K=r.formBtnBgColor||"#111111",j=r.formBtnTextColor||"#ffffff",ee=r.formBtnBorderColor||"#111111",ye=Se(K,.06),re=Se(K,.18),pe=Se(j,.85),Ee=Se(H,.06),Te=r.loadMoreBgColor||"#ffffff",xe=r.loadMoreTextColor||"#111111",de=r.loadMoreBorderColor||"#111111",O={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":n,"--renuvex-pr-header-count":a,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":p,"--renuvex-pr-bar-track":o,"--renuvex-pr-bar-count":u,"--renuvex-pr-bar-hover-bg":v,"--renuvex-pr-btn-bg":c,"--renuvex-pr-btn-text":i,"--renuvex-pr-btn-border":y,"--renuvex-pr-filter-btn-bg":d,"--renuvex-pr-filter-btn-text":s,"--renuvex-pr-filter-btn-border":g,"--renuvex-pr-filter-menu-bg":b,"--renuvex-pr-filter-menu-border":w,"--renuvex-pr-filter-item-text":z,"--renuvex-pr-filter-item-hover-bg":m,"--renuvex-pr-filter-item-active":k,"--renuvex-pr-review-title":h,"--renuvex-pr-review-author":f,"--renuvex-pr-review-date":C,"--renuvex-pr-review-body":T,"--renuvex-pr-review-border":S,"--renuvex-pr-review-star-color":x,"--renuvex-pr-reply-bg-color":E,"--renuvex-pr-reply-border":B,"--renuvex-pr-reply-label":N,"--renuvex-pr-reply-text":R,"--renuvex-pr-photo-title":I,"--renuvex-pr-photo-image-border":A,"--renuvex-pr-photo-arrow-bg":$,"--renuvex-pr-photo-arrow-text":me,"--renuvex-pr-photo-arrow-border":U,"--renuvex-pr-fwizard-bg":_,"--renuvex-pr-fwizard-text":H,"--renuvex-pr-fwizard-secondary-text":be,"--renuvex-pr-fwizard-input-bg":_,"--renuvex-pr-fwizard-input-text":je,"--renuvex-pr-fwizard-input-border":X,"--renuvex-pr-fwizard-placeholder":De,"--renuvex-pr-fwizard-close-text":H,"--renuvex-pr-fwizard-close-hover-bg":Ee,"--renuvex-pr-fwizard-progress-bg":Ee,"--renuvex-pr-fwizard-progress-active":Q,"--renuvex-pr-fwizard-btn-bg":K,"--renuvex-pr-fwizard-btn-text":j,"--renuvex-pr-fwizard-btn-border":ee,"--renuvex-pr-fwizard-btn-disabled-bg":re,"--renuvex-pr-fwizard-btn-disabled-text":pe,"--renuvex-pr-fwizard-nav-hover-bg":ye,"--renuvex-pr-load-more-bg":Te,"--renuvex-pr-load-more-text":xe,"--renuvex-pr-load-more-border":de};Object.keys(O).forEach(function(D){e.style.setProperty(D,O[D])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function $e(e,r,t,n,a,l,p){if(rt){tr({productId:e,settings:r,reviewsData:t,productName:n,orderBy:a,page:l,badgeSettings:p});return}rr(!0),Xr(e),Kr(r),p!==void 0&&Zr(p),Jr(n),a&&Er(a),l&&We(l),t!=null&&$r(t);try{let kr=function(P,F){if(!(!P||!P.meta||!P.meta.sizeOverrides)){var M=P.meta.sizeOverrides[F];M&&Object.keys(M).forEach(function(Z){i.style.setProperty(Z,M[Z])})}};var Pa=kr,o=hr(r.summaryLayout),u=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),v=r.showTitle!==!1,x=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",c=u&&v?x:"",i=document.documentElement;Na(i,r);var y=r.borderRadius!==void 0?r.borderRadius:8,d=Ht[r.size]||Ht.medium,s=Ot[r.thumbnailSize]||Ot.medium,g=Je(r.reviewLayout);if(g.meta&&g.meta.sizeOverrides&&g.meta.sizeOverrides[r.size]){var b=g.meta.sizeOverrides[r.size],w=b["--renuvex-pr-list-photo-w"]||b["--renuvex-pr-gallery-photo-w"];w&&(s=parseInt(w))}i.style.setProperty("--renuvex-pr-title-size",d.titleSize+"px"),i.style.setProperty("--renuvex-pr-review-text-size",d.reviewTextSize+"px"),i.style.setProperty("--renuvex-pr-review-title-size",d.reviewTitleSize+"px"),i.style.setProperty("--renuvex-pr-author-size",d.authorSize+"px"),i.style.setProperty("--renuvex-pr-reply-name-size",d.replyNameSize+"px"),i.style.setProperty("--renuvex-pr-reply-text-size",d.replyTextSize+"px"),i.style.setProperty("--renuvex-pr-radius",y+"px"),i.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),i.style.setProperty("--renuvex-pr-photo-title-size",d.photoTitleSize+"px"),i.style.setProperty("--renuvex-pr-avg-rating-size",d.avgRatingSize+"px"),i.style.setProperty("--renuvex-pr-review-count-size",d.reviewCountSize+"px"),i.style.setProperty("--renuvex-pr-compact-count-size",d.compactCountSize+"px"),i.style.setProperty("--renuvex-pr-recommend-size",d.recommendSize+"px"),i.style.setProperty("--renuvex-pr-btn-text-size",d.btnTextSize+"px"),i.style.setProperty("--renuvex-pr-bar-label-size",d.barLabelSize+"px"),i.style.setProperty("--renuvex-pr-minimal-avg-size",d.minimalAvgSize+"px"),i.style.setProperty("--renuvex-pr-hero-avg-size",d.heroAvgSize+"px"),i.style.setProperty("--renuvex-pr-bar-count-size",d.barCountSize+"px"),i.style.setProperty("--renuvex-pr-review-date-size",d.reviewDateSize+"px"),i.style.setProperty("--renuvex-pr-filter-text-size",d.filterTextSize+"px"),i.style.setProperty("--renuvex-pr-load-more-size",d.loadMoreSize+"px"),i.style.setProperty("--renuvex-pr-read-more-size",d.readMoreSize+"px"),i.style.setProperty("--renuvex-pr-thumbnail-size",s+"px");var z=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";i.style.setProperty("--renuvex-pr-review-star-color",z),i.style.setProperty("--renuvex-pr-star-size",d.reviewStarSize+"px"),i.style.setProperty("--renuvex-pr-avg-star-size",d.avgStarSize+"px"),kr(hr(r.summaryLayout),r.size),kr(Je(r.reviewLayout),r.size);var m=qe(r),k=Ta();if(!k)return;var h=La(k,e),f=document.getElementById("renuvex-reviews");f||(f=document.createElement("div"),f.id="renuvex-reviews",f.style.minHeight="200px"),f.parentNode!==h&&h.appendChild(f);var C=ut(f),T=Re+Le+pr+Rt()+Ft();Ie(C,T);var S=vt(C);if(r.enabled===!1){f.style.minHeight="auto",S.replaceChildren(Ea(r.borderRadius!==void 0?r.borderRadius:8)),rr(!1);var E=er;tr(null),E&&$e(E.productId,E.settings,E.reviewsData,E.productName,E.orderBy,E.page,E.badgeSettings);return}var B=document.createElement("p");B.className="renuvex-pr-state-msg renuvex-pr-state-loading",B.textContent="Yorumlar y\xFCkleniyor...",S.replaceChildren(B);try{var N=t||{},R=Ar(N),I=R?[]:N.data&&N.data.reviews||[];Qr(I),S.replaceChildren();var A=document.createElement("section");if(A.id="renuvex-reviews-widget",A.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),A.className="renuvex-pr-reviews-widget",A.setAttribute("data-renuvex-surface","reviews"),e&&A.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(A.style.width="100%",A.style.maxWidth="100%",A.style.marginLeft="0",A.style.marginRight="0"),c){var $=document.createElement("div"),me=r.summaryLayout||"classic";$.className="renuvex-pr-title renuvex-pr-title-"+me,$.textContent=c,A.appendChild($)}if(R){A.appendChild(Aa(N.message,async function(){var P=await Xe(te,ke,1,Ae,Ne);await $e(te,L,P,Pe,ke,1,Gr)})),S.appendChild(A),ze(C),Cr(A,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return C.getElementById("renuvex-reviews-widget")});return}var U=N.data&&N.data.allCount||0,_=N.data&&N.data.ratingCounts||null,H=_||[0,0,0,0,0],be=N.data&&N.data.avgRating||"0.0";if(!_&&I.length>0){I.forEach(function(P){P.rating>=1&&P.rating<=5&&H[P.rating-1]++});var je=I.reduce(function(P,F){return P+F.rating},0);be=(je/I.length).toFixed(1)}if(U>0){var X=hr(r.summaryLayout),De=X.render({widget:A,data:N,settings:r,iconPair:m,allCount:U,ratingCounts:H,avgRatingVal:be,currentRatingFilter:Ae,currentOrderBy:ke,currentHasImages:Ne,onFilterChange:async function(P){var F=Ae===P?null:P;qr(F),We(1);var M=await Xe(te,ke,1,F,Ne);await $e(te,L,M,Pe,ke,1)},onSortChange:async function(P,F){We(1);var M=P,Z=!1;F&&(Z=!0,M="newest"),Ur(Z),Er(M);var zr=await Xe(te,M,1,Ae,Z);await $e(te,L,zr,Pe,M,1)}});A.appendChild(De)}else{var Q=document.createElement("button");Q.className="renuvex-pr-write-btn",Q.style.cssText="display:block;margin:16px auto 0;",Q.textContent=r.writeButtonText||"Yorum Yap",Q.onclick=Y,A.appendChild(Q)}var K=(Wr||[]).filter(function(P){return he(P).length>0});if(r.showPhotoGallery!==!1&&!Ne&&K.length>0){var j=document.createElement("div");if(j.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var ee=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",ye=document.createElement("div");ye.className="renuvex-pr-photo-title",ye.textContent=ee,j.appendChild(ye)}var re=r.reviewLayout==="card"?"1/1":"3/4";i.style.setProperty("--renuvex-pr-photo-thumb-aspect",re);var pe=document.createElement("div");pe.className="renuvex-pr-photo-strip";var Ee=V,Te=r.reviewLayout==="card"?V:Math.round(V*4/3),xe=0;K.forEach(function(P){if(!(xe>=15)){var F=nr(P);if(F){var M=document.createElement("img"),Z=ae(F,V);M.src=Z.src,M.srcset=Z.srcset,M.loading=xe<3?"eager":"lazy",M.decoding="async",M.width=Ee,M.height=Te,M.className="renuvex-pr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",ne(M),(function(zr,Yt){M.onclick=function(){oe(Yt,zr,K)}})(F,P),pe.appendChild(M),xe++}}});var de=document.createElement("button");de.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev",de.innerHTML="&#8249;",de.setAttribute("aria-label","\xD6nceki"),de.onclick=function(){pe.scrollBy({left:-200,behavior:"smooth"})};var O=document.createElement("button");O.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next",O.innerHTML="&#8250;",O.setAttribute("aria-label","Sonraki"),O.onclick=function(){pe.scrollBy({left:200,behavior:"smooth"})};var D=document.createElement("div");D.className="renuvex-pr-photo-strip-wrap",D.appendChild(de),D.appendChild(pe),D.appendChild(O),j.appendChild(D),A.appendChild(j)}if(I.length===0){var yr=document.createElement("p");yr.className="renuvex-pr-state-msg",yr.textContent="Hen\xFCz yorum yok.",A.appendChild(yr)}else{var g=Je(r.reviewLayout);I.forEach(function(F){A.appendChild(g.render(F,Sr))})}var _t=N.data&&N.data.hasMore;if(_t){var G=document.createElement("button");G.className="renuvex-pr-load-more",G.textContent="Daha Fazla G\xF6ster",G.onclick=async function(){G.disabled=!0,G.textContent="Y\xFCkleniyor...";var P=Vr+1,F=await Xe(te,ke,P,Ae,Ne);if(F&&!Ar(F)&&F.data&&Array.isArray(F.data.reviews)){et(F.data.reviews),We(P);var M=Je(L.reviewLayout);F.data.reviews.forEach(function(Z){A.insertBefore(M.render(Z,Sr),G)}),F.data.hasMore?(G.disabled=!1,G.textContent="Daha Fazla G\xF6ster"):G.remove()}else G.disabled=!1,G.textContent="Tekrar Dene"},A.appendChild(G)}S.appendChild(A),ze(C),Cr(A,"reviews-widget",{productId:e||""},function(){return C.getElementById("renuvex-reviews-widget")})}catch(P){console.error("[renuvex-pr] render error:",P);var wr=document.createElement("p");wr.style.cssText="text-align:center;color:#dc2626;",wr.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",S&&S.replaceChildren(wr)}}finally{if(rr(!1),er){var we=er;tr(null),$e(we.productId,we.settings,we.reviewsData,we.productName,we.orderBy,we.page,we.badgeSettings)}}}export{$e as render};
