...
`;var Qr={classic:wt,compact:kt,split:St,minimal:zt,hero:Ct};function et(e){return Qr[e]||Qr.classic}function dn(){var e=Object.keys(Qr).map(function(r){return Qr[r].css||""}).join(`
`);return pn+`
