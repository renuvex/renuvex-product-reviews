...
`);function Pn(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function xe(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function Mn(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function _n(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",i=Mn()&&!a;if(n>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),i&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Nn(e){var r=document.body.style,t=document.documentElement.style;xe(t,"overflow",e.rootOverflow,e.rootOverflowPriority),xe(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),xe(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),xe(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),xe(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),xe(r,"position",e.bodyPosition,e.bodyPositionPriority),xe(r,"top",e.bodyTop,e.bodyTopPriority),xe(r,"left",e.bodyLeft,e.bodyLeftPriority),xe(r,"right",e.bodyRight,e.bodyRightPriority),xe(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var pr=0,Xe=null;function Ur(){return pr+=1,pr>1||(Xe=Pn(),_n(Xe)),Xe}function Hr(){if(pr!==0&&(pr-=1,!(pr>0))){var e=Xe;Xe=null,e&&Nn(e)}}function Ln(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Vr(){var e=Ln();return!e||e===document.body||e===document.documentElement?null:e}function ve(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Rn(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function dt(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Rn)}function In(e,r){var t=e,n=dt(e);!n.length&&r&&(t=r,n=dt(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;ve(a)}function Dr(e,r,t){if(e.key==="Tab"){var n=dt(r);if(!n.length){e.preventDefault(),In(r);return}var a=n[0],i=n[n.length-1],o=ua(t);if(!r.contains(o)){e.preventDefault(),ve(a);return}if(n.indexOf(o)===-1){e.preventDefault(),ve(e.shiftKey?i:a);return}e.shiftKey&&o===a?(e.preventDefault(),ve(i)):!e.shiftKey&&o===i&&(e.preventDefault(),ve(a))}}var ba="renuvexPrOverlay";function Yr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[ba]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Bn(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[ba]===e.id)}function jr(e){if(Bn(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Fn(e){var r=e||(typeof navigator!="undefined"?navigator:null),t=r&&(r.connection||r.webkitConnection||r.mozConnection);if(t&&t.saveData===!0)return!1;var n=t&&typeof t.effectiveType=="string"?t.effectiveType.toLowerCase():"";return n!=="slow-2g"&&n!=="2g"}function On(e){var r=Number(e&&e.width),t=Number(e&&e.height),n=Number(e&&(e.bitrate||e.bandwidth));return Number.isFinite(r)||Number.isFinite(t)?(Number.isFinite(t)?t:0)*1e5+(Number.isFinite(r)?r:0):Number.isFinite(n)?n:0}function Un(e,r,t){if(!Array.isArray(e)||!e.length)return-1;var n=t||(typeof window!="undefined"?window:null),a=r&&typeof r.getBoundingClientRect=="function"?r.getBoundingClientRect():{width:0,height:0},i=Math.max(Number(a.width)||0,Number(r&&r.clientWidth)||0,360),o=Math.max(Number(a.height)||0,Number(r&&r.clientHeight)||0,360),l=Number(n&&n.devicePixelRatio),p=Number.isFinite(l)&&l>0?Math.min(l,2):1,u=Math.round(i*p*1.15),m=Math.round(o*p*1.15),c=-1,d=-1,v=0,x=Number.POSITIVE_INFINITY;return e.forEach(function(s,f){var h=On(s);h<x&&(x=h,v=f);var b=Number(s&&s.width),w=Number(s&&s.height),T=!Number.isFinite(b)||b<=u,y=!Number.isFinite(w)||w<=m;T&&y&&h>d&&(d=h,c=f)}),c>=0?c:v}function Hn(e,r,t){if(Fn()){var n=e&&e.Events&&e.Events.MANIFEST_PARSED;if(!(!n||!r||typeof r.on!="function")){var a=function(){typeof r.off=="function"&&r.off(n,a);var i=Un(r.levels,t);if(i>=0)try{r.startLevel=i}catch(o){}};r.on(n,a)}}}function ya(e,r){var t=!1,n=null;return e.controls=!0,e.autoplay=!1,e.preload="metadata",e.playsInline=!0,e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.poster=qe(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"",e.canPlayType("application/vnd.apple.mpegurl")?e.src=r.url:import("./hls-64XD2IDA.js").then(function(a){if(!t){var i=a.default||a;if(!i||!i.isSupported||!i.isSupported()){e.dispatchEvent(new Event("error"));return}n=new i({enableWorker:!0,lowLatencyMode:!1,capLevelToPlayerSize:!0,backBufferLength:30}),Hn(i,n,e),n.loadSource(r.url),n.attachMedia(e)}}).catch(function(){t||e.dispatchEvent(new Event("error"))}),function(){t=!0;try{e.pause()}catch(i){}if(n){try{n.destroy()}catch(i){}n=null}e.removeAttribute("src");try{e.load()}catch(i){}}}function Je(e){return Ce(e)}function vt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function wa(e,r,t,n,a,i){e&&e.shadowRoot&&vt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),Hr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Er(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(a)}function Vn(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ze(e.rating,L);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=ke(e.createdAt),n.appendChild(a),n.appendChild(i),t.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-modal-body",p.textContent=(e.comment||"").trim(),p.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(p);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=H(L&&L.merchantReplyLabel,"Ma\u011Faza Sahibi");var c=document.createElement("div");return c.className="renuvex-pr-modal-reply-text",c.textContent=e.merchantReply||"",u.appendChild(m),u.appendChild(c),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function za(e,r,t){var n=t||L,a=e.querySelector(".renuvex-pr-modal-scroll-content"),i=a.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ze(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=ke(r.createdAt);var o=a.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=a.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var p=a.querySelector(".renuvex-pr-modal-reply");p.querySelector(".renuvex-pr-modal-reply-label").textContent=H(n&&n.merchantReplyLabel,"Ma\u011Faza Sahibi"),p.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",p.style.display=r.merchantReply?"":"none",e.scrollTop=0}function ct(e,r,t,n,a,i,o,l,p){var u=Je(e),m=Math.max(0,Math.min(t||0,u.length-1)),c=u[m],d=document.createElement("div");d.className="renuvex-pr-modal-left";var v=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(c&&c.type==="video"){var x=document.createElement("video");x.className="renuvex-pr-modal-main-video"+(v?" renuvex-pr-modal-video-enter":""),x.setAttribute("aria-label","Yorum videosu"),x.addEventListener("error",function(){if(!d.querySelector(".renuvex-pr-modal-img-error")){var g=document.createElement("div");g.className="renuvex-pr-modal-img-error",g.setAttribute("role","status"),g.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",d.insertBefore(g,x)}}),d.__renuvexMediaCleanup=ya(x,c),d.appendChild(x)}else{var s=document.createElement("img");if(s.className="renuvex-pr-modal-main-img"+(v?" "+v:""),s.src=lt(c?c.url:""),s.decoding="async",s.width=ot,s.height=Math.round(ot*4/3),s.alt="Yorum foto\u011Fraf\u0131",!v){s.classList.add("renuvex-pr-modal-img-loading");var f=function(){s.classList.remove("renuvex-pr-modal-img-loading")};s.complete&&s.naturalWidth>0?f():(s.addEventListener("load",f,{once:!0}),s.addEventListener("error",f,{once:!0}))}ra(s,function(g){if(g.style.display="none",!d.querySelector(".renuvex-pr-modal-img-error")){var _=document.createElement("div");_.className="renuvex-pr-modal-img-error",_.setAttribute("role","status"),_.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",d.insertBefore(_,g)}}),d.appendChild(s)}var h=document.createElement("button");h.className="renuvex-pr-modal-close-mobile";var b=ee(we);b&&h.appendChild(b),h.setAttribute("aria-label","Kapat"),h.onclick=function(g){g.stopPropagation(),i()},d.appendChild(h);var w=0;if(d.addEventListener("touchstart",function(g){w=g.touches[0].clientX},{passive:!0}),d.addEventListener("touchend",function(g){var _=w-g.changedTouches[0].clientX;if(!(Math.abs(_)<50)){if(_>0){if(z)Ee(e,r,m+1,n,a,i,!0,"next",l,p);else if(S){var R=n[r+1];Ee(R,r+1,0,n,a,i,!1,"next",l,p)}}else if(y)Ee(e,r,m-1,n,a,i,!0,"prev",l,p);else if(k){var M=n[r-1],B=Je(M);Ee(M,r-1,B.length-1,n,a,i,!1,"prev",l,p)}}},{passive:!0}),u.length>1){var T=document.createElement("div");T.className="renuvex-pr-modal-thumbs",u.forEach(function(g,_){var R=g.type==="video"?g.posterUrl:g.url,M=document.createElement("img"),B=Lr(R,Nr);M.src=B.src,M.srcset=B.srcset,M.loading="lazy",M.decoding="async",M.width=Nr,M.height=Nr,M.className="renuvex-pr-modal-thumb"+(_===m?" renuvex-pr-modal-thumb-active":""),M.alt="K\xFC\xE7\xFCk resim "+(_+1),Rr(M),M.tabIndex=0,M.setAttribute("role","button"),M.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(_+1)+" se\xE7"),_===m&&M.setAttribute("aria-current","true"),(function(K){function U(){Ee(e,r,K,n,a,i,!0,null,l,p)}M.onclick=U,M.onkeydown=function(V){(V.key==="Enter"||V.key===" ")&&(V.preventDefault(),U())}})(_),T.appendChild(M)}),d.appendChild(T)}var y=m>0,z=m<u.length-1,k=r>0,S=r<n.length-1,C=y||k,E=z||S;if(C){var A=document.createElement("button");A.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var N=ee(We);N&&A.appendChild(N),A.setAttribute("aria-label","\xD6nceki"),A.onclick=function(g){if(g.stopPropagation(),y)Ee(e,r,m-1,n,a,i,!0,"prev",l,p);else if(k){var _=n[r-1],R=Je(_);Ee(_,r-1,R.length-1,n,a,i,!1,"prev",l,p)}},d.appendChild(A)}if(E){var I=document.createElement("button");I.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var P=ee(Tr);P&&I.appendChild(P),I.setAttribute("aria-label","Sonraki"),I.onclick=function(g){if(g.stopPropagation(),z)Ee(e,r,m+1,n,a,i,!0,"next",l,p);else if(S){var _=n[r+1];Ee(_,r+1,0,n,a,i,!1,"next",l,p)}},d.appendChild(I)}return d}function ka(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Je(n);a[0]&&a[0].type==="image"&&(new Image().src=lt(a[0].url))}})}function st(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Dn(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){st(t),st(n),st(a)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Ee(e,r,t,n,a,i,o,l,p,u){if(u&&(u.currentReview=e),o){var m=ct(e,r,t,n,a,i,l,p,u);a.firstChild&&(vt(a.firstChild),a.replaceChild(m,a.firstChild))}else{var m=ct(e,r,t,n,a,i,l,p,u),c=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&(vt(a.firstChild),a.replaceChild(m,a.firstChild)),c&&za(c,e,u&&u.currentSettings),Dn(p,a)}ka(r,n)}function ge(e,r,t){var n=Je(e);if(!n.length)return;var a=(t||[]).filter(function(S){return Je(S).length>0}),i=a.findIndex(function(S){return S===e||S.id===e.id});i===-1&&(a.unshift(e),i=0);var o=n.findIndex(function(S){return S.url===r});o<0&&(o=0);var l=document.createElement("div");l.className="renuvex-pr-modal-overlay";var p=document.createElement("div");p.className="renuvex-pr-modal";var u=!1,m=null,c=Vr(),d=Me(),v=Ur(),x=Yr(),s={currentReview:e,currentSettings:L},f=null;function h(S){var C=S&&S.detail&&S.detail.settings;if(!(C&&C===f)){f=C||null,s.currentSettings=C||L;var E=p.querySelector(".renuvex-pr-modal-right");!E||!s.currentReview||za(E,s.currentReview,s.currentSettings)}}function b(){u||(u=!0,window.removeEventListener(Oe,h),wa(m&&m.host,w,b,v,c,d))}function w(S){if(S.key==="Escape"){T();return}Dr(S,l,m&&m.root)}function T(){u||(u=!0,window.removeEventListener(Oe,h),wa(m&&m.host,w,b,v,c,d),jr(x))}document.addEventListener("keydown",w),window.addEventListener("popstate",b),window.addEventListener(Oe,h),l.onclick=function(){T()},p.onclick=function(S){S.stopPropagation()},p.appendChild(ct(e,i,o,a,p,T,null,l,s)),p.appendChild(Vn(e)),ka(i,a);var y=document.createElement("div");y.className="renuvex-pr-modal-wrap",y.tabIndex=-1,y.setAttribute("role","dialog"),y.setAttribute("aria-modal","true"),y.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),y.appendChild(p);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var k=ee(we);k&&z.appendChild(k),z.setAttribute("aria-label","Kapat"),z.onclick=function(S){S.stopPropagation(),T()},y.appendChild(z),l.appendChild(y),m=Fr(),Ke(m.root,Ge+je+Or),m.root.appendChild(l),Fe(m.root),ve(y)}function ur(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(n){(n.key==="Enter"||n.key===" "||n.key==="Spacebar")&&(n.preventDefault(),r())})}var wt={};Pe(wt,{css:()=>Ti,meta:()=>Ei,render:()=>Ai});function Ze(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,i=e.onFilterChange;Ne(n);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var p=r[l-1]||0,u=t>0?Math.round(p/t*100):0,m=a===l,c=p>0,d=H(L&&L.countLabel,"Yorum"),v=document.createElement("div");v.className="renuvex-pr-bar-row"+(c?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(a&&!m?" renuvex-pr-bar-dimmed":""),c?(v.setAttribute("role","button"),v.setAttribute("tabindex","0"),v.setAttribute("aria-pressed",m?"true":"false"),v.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+p.toLocaleString("tr-TR")+" "+d+", "+(m?"filtreyi kald\u0131r":"filtrele"))):v.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+d);for(var x="",s=1;s<=5;s++){var f=s<=l;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+de(f?"full":"outline")+"</span>"}v.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+p.toLocaleString("tr-TR")+")</span>",c&&(function(h){function b(){i(h)}v.onclick=b,v.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Space"||w.key==="Spacebar")&&(w.preventDefault(),b())}})(l),o.appendChild(v)}return o}var Ea="data-renuvex-pr-dismiss-gesture",He=[],Sa=!1,Wr=!1,dr=[],$e=null;function Ca(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function mt(){for(var e=He.length-1;e>=0;e--){var r=He[e].element;r&&r.isConnected===!1&&He.splice(e,1)}return He}function Yn(e){!e||typeof e.setAttribute!="function"||(dr.indexOf(e)===-1&&dr.push(e),e.setAttribute(Ea,""))}function Ta(){for(var e=0;e<dr.length;e++){var r=dr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Ea)}dr=[],$e&&typeof clearTimeout=="function"&&clearTimeout($e),$e=null}function jn(e){if(Wr){Wr=!1,Ta(),e.preventDefault(),e.stopPropagation();return}for(var r=mt(),t=!1,n=r.length-1;n>=0;n--){var a=r[n];Ca(e,a.trigger)||Ca(e,a.element)||a.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Wn(e){if(e.key==="Escape")for(var r=mt(),t=r.length-1;t>=0;t--)r[t].close()}function Aa(){Sa||typeof document=="undefined"||(document.addEventListener("click",jn,!0),document.addEventListener("keydown",Wn),Sa=!0)}function qn(e){Aa(),Wr=!0,Yn(e),$e&&typeof clearTimeout=="function"&&clearTimeout($e),typeof setTimeout=="function"&&($e=setTimeout(function(){Wr=!1,Ta()},700))}function ft(e){qn(e)}function qr(e){Aa();var r={trigger:e.trigger,element:e.element,close:e.close};return He.push(r),{unregister:function(){var t=He.indexOf(r);t!==-1&&He.splice(t,1)},notifyOpening:function(){for(var t=mt(),n=0;n<t.length;n++)t[n]!==r&&t[n].close()}}}function pe(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=H(L&&L.writeButtonText,"Yorum Yap"),l.onclick=a,o.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var m=L&&L.filterIcon||"lines";u.innerHTML=se(Xt(m));var c=document.createElement("div");c.className="renuvex-pr-filter-menu",c.setAttribute("role","menu");var d=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function x(){return r&&r.parentNode||r||null}function s(w,T){if(!(T===!0||!w)){if(w.type==="touchstart"){ft(x());return}if(w.type==="pointerdown"){var y=w.pointerType||"";y&&y!=="mouse"&&ft(x());return}}}function f(w){var T=c.classList.contains("renuvex-pr-open");c.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var y=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Me());if(T&&y)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(k){}}return T}function h(){b.notifyOpening(),c.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var w=c.querySelector(".renuvex-pr-filter-item-active")||c.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(T){try{w.focus()}catch(y){}}})}d.forEach(function(w){var T=w[2],y=T?n:!n&&(t||"newest")===w[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(y?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=w[1];var k=!1;function S(C,E){C&&(C.preventDefault(),C.stopPropagation()),!k&&(k=!0,v=!0,s(C,E),f({restoreFocus:E}),i(w[0],T),setTimeout(function(){k=!1,v=!1},0))}z.addEventListener("pointerdown",function(C){C.button!==void 0&&C.button!==0||C.pointerType!=="mouse"&&S(C,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(C){S(C,!1)},{passive:!1}),z.addEventListener("keydown",function(C){(C.key==="Enter"||C.key===" ")&&S(C,!0)}),z.onclick=function(C){S(C,!1)},c.appendChild(z)}),u.onclick=function(){c.classList.contains("renuvex-pr-open")?f({restoreFocus:"auto"}):h()},p.addEventListener("keydown",function(w){w.key==="Escape"&&c.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),f({restoreFocus:!0}))}),p.addEventListener("focusout",function(w){if(c.classList.contains("renuvex-pr-open")&&!v){var T=w.relatedTarget;T&&p.contains(T)||f()}});var b=qr({trigger:p,element:c,close:f});return p.appendChild(u),p.appendChild(c),o.appendChild(p),o}var Pa=`
...
`;function Ma(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,n=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,a=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",o.appendChild(l);var p=document.createElement("button");p.className="renuvex-pr-fwizard-close",p.type="button",p.setAttribute("aria-label","Kapat");var u=ee(we);u&&p.appendChild(u),o.appendChild(p);var m=!1,c=null,d=null,v=!1;function x(){ve(i)}function s(k){Dr(k,i,c&&c.root)}function f(){if(!m){if(m=!0,document.removeEventListener("keydown",h),i.removeEventListener("click",b),p.removeEventListener("click",f),v)ve(d);else{var k=c&&c.root?c.root.activeElement:null;if(k&&typeof k.blur=="function")try{k.blur()}catch(S){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){c?(Er(c.root),c.host&&c.host.parentNode&&c.host.parentNode.removeChild(c.host)):i.parentNode&&i.parentNode.removeChild(i),Hr();try{r()}catch(S){}},200)}}function h(k){if(k.key==="Escape"){f();return}s(k)}function b(k){k.target===i&&a&&f()}document.addEventListener("keydown",h),i.addEventListener("click",b),p.addEventListener("click",f);function w(k){d=t||Vr(),v=n===null?Me():n,k&&l.appendChild(k),c=Fr(),Ke(c.root,Ge+je+Pa),c.root.appendChild(i),Fe(c.root),Ur(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),x()})}var T=null,y=null;function z(k,S){if(S=S||"error",T){try{T.remove()}catch(C){}T=null}y&&(clearTimeout(y),y=null),T=document.createElement("div"),T.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+S,T.textContent=k,o.appendChild(T),y=setTimeout(function(){T&&(T.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(T){try{T.remove()}catch(C){}T=null}},300))},4e3)}return{open:w,close:f,content:l,setAllowOutsideClose:function(k){a=!!k},setStepAttr:function(k){o.setAttribute("data-step",String(k))},showToast:z}}var xt=4;function Qe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function _a(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(i){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<xt&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(i){return i!==a})}}}}function Na(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=se(We)+"<span>Geri</span>",l.addEventListener("click",function(){n()}),o.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-footer-progress";for(var u=[],m=0;m<xt;m++){var c=document.createElement("span");c.className="renuvex-pr-fwizard-progress-seg",p.appendChild(c),u.push(c)}o.appendChild(p);var d=document.createElement("button");d.type="button";var v=null;function x(f){v&&d.removeEventListener("click",v),v=f,f&&d.addEventListener("click",f)}o.appendChild(d);function s(f,h){var b=r.indexOf(f)!==-1,w=t.indexOf(f)!==-1,T=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0||!!h.videoUpload);if(b)f===2&&T?(d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",x(function(){i()})):(d.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",d.setAttribute("aria-label","Atla"),d.innerHTML="<span>Atla</span>",x(function(){a()})),d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),d.style.visibility="",d.tabIndex=0;else if(w){d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Sonraki"),d.innerHTML="Sonraki",d.style.visibility="",d.tabIndex=0;var y=Qe(f,h);d.disabled=!y,d.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!y),x(function(){d.disabled||i()})}else d.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",d.innerHTML="",d.style.visibility="hidden",d.tabIndex=-1,d.disabled=!0,x(null)}return{el:o,update:function(f,h){u.forEach(function(w,T){T+1<=f?w.classList.add("renuvex-pr-fwizard-progress-seg-active"):w.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var b=f<=1;l.style.visibility=b?"hidden":"",l.style.pointerEvents=b?"none":"",l.tabIndex=b?-1:0,s(f,h)},setNextDisabled:function(f){d.classList.contains("renuvex-pr-fwizard-cta-btn")&&(d.disabled=!!f,d.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!f))},setThanksState:function(f){l.style.visibility="hidden",p.style.visibility="hidden",d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",d.style.visibility="",d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),x(f)}}}var Gn={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ce(e){var r=L&&L[e];return!r&&e==="formStepMediaTitle"&&(r=L&&L.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=L&&L.formStepPhotosSubtitle),H(r,Gn[e])}function La(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ce("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var l=lr(L||{});Ne(l);var p=[];function u(f){p.forEach(function(h,b){var w=b<f;h.classList.toggle("renuvex-pr-fwizard-star-active",w),h.setAttribute("aria-checked",b+1===f?"true":"false"),h.innerHTML=w?de("full"):de("outline")})}function m(f){e.set({rating:f}),u(f)}function c(f){var h=p[f-1];if(h)try{h.focus()}catch(b){}}function d(f,h){h&&typeof h.preventDefault=="function"&&h.preventDefault(),h&&typeof h.stopPropagation=="function"&&h.stopPropagation(),!n&&(n=!0,m(f),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var v=1;v<=5;v++)(function(f){var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",f+" y\u0131ld\u0131z"),h.innerHTML=de("outline"),h.addEventListener("mouseenter",function(){u(f)}),h.addEventListener("mouseleave",function(){u(e.get().rating)}),h.addEventListener("pointerdown",function(b){b.button&&b.button!==0||d(f,b)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){d(f,b)},{passive:!1}),h.addEventListener("mousedown",function(b){window.PointerEvent||d(f,b)}),h.addEventListener("keydown",function(b){if(b.key==="Enter"||b.key===" "){d(f,b);return}var w=0;b.key==="ArrowRight"||b.key==="ArrowUp"?w=Math.min(5,f+1):b.key==="ArrowLeft"||b.key==="ArrowDown"?w=Math.max(1,f-1):b.key==="Home"?w=1:b.key==="End"&&(w=5),w&&(b.preventDefault(),m(w),c(w))}),h.addEventListener("click",function(b){d(f,b)}),p.push(h),o.appendChild(h)})(v);u(e.get().rating);var x=null,s=function(f){var h=f&&f.detail&&f.detail.settings;h&&h===x||(x=h||null,l=lr(h||L||{}),u(e.get().rating))};return window.addEventListener(Oe,s),t.appendChild(o),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Oe,s)}}}var Gr=3,Kn=10*1024*1024;function Kr(e,r){r=r||{};var t=!1,n=r.hideAddButton===!0,a=r.revealAddButtonAfterMedia===!0,i=!n||a,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=ce("formStepPhotosTitle"),o.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-subtitle",p.textContent=ce("formStepPhotosSubtitle"),o.appendChild(p)}var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&u.classList.add("renuvex-pr-fwizard-photo-card--embedded");var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add",m.setAttribute("aria-label","Foto\u011Fraf ekle");var c=document.createElement("input");c.type="file",c.accept="image/*",c.multiple=!0,c.style.display="none",i&&u.appendChild(m),u.appendChild(c);var d=document.createElement("div");d.className="renuvex-pr-fwizard-photo-previews",d.setAttribute("aria-live","polite"),u.appendChild(d),o.appendChild(u);var v=r.revokeBlobUrl||function(y){y&&typeof y=="string"&&y.startsWith("blob:")&&URL.revokeObjectURL(y)},x=r.blobMap||{},s=r.urlToFinger||{};function f(){if(!t){var y=e.get().images||[],z=e.get().pendingImages||[],k=y.map(function(S){return{url:S,isPending:!1}}).concat(z.map(function(S){return{url:S.url,file:S.file,isPending:!0,error:S.error}}));d.innerHTML="",k.forEach(function(S){var C=x[S.url]||S.url,E=h(S,C);d.appendChild(E)}),w()}}function h(y,z){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var S=document.createElement("img");S.src=z,S.alt="",S.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(S);var C=document.createElement("div");C.className="renuvex-pr-fwizard-photo-loading",C.style.display="none",k.appendChild(C);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var A=ee(we);return A&&E.appendChild(A),k.appendChild(E),b(k,y,z),k}function b(y,z,k){var S=y.querySelector("img");S.src!==k&&(S.src=k);var C=y.querySelector(".renuvex-pr-fwizard-photo-loading");if(z.isPending&&z.error){C.style.display="flex",C.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+z.error,C.appendChild(E)}else C.style.display="none",C.textContent="";var A=y.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var N=s[z.url]||(z.file?z.file.name+"_"+z.file.size:null),I=x[z.url],P={};N&&(P.fingerprints=(e.get().fingerprints||[]).filter(function(g){return g!==N})),z.isPending?P.pendingImages=(e.get().pendingImages||[]).filter(function(g){return g.url!==z.url}):P.images=(e.get().images||[]).filter(function(g){return g!==z.url}),e.set(P),v(z.url),v(I),delete s[z.url],I&&delete s[I],x[z.url]&&delete x[z.url]}}function w(){var y=(e.get().images||[]).length,z=(e.get().pendingImages||[]).length,k=y+z,S=k>=Gr;u.classList.toggle("renuvex-pr-fwizard-photo-card--compact",k>0),i&&(m.innerHTML=k>0?se(Zt):se(Ar)+"<span>Foto\u011Fraf Ekle</span>"),S?(i&&(m.style.display="none"),m.disabled=!0,c.disabled=!0):(i&&(m.style.display=a&&k===0?"none":"flex"),m.disabled=!1,c.disabled=!1,m.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}m.addEventListener("click",function(){c.disabled||c.click()}),c.onchange=async function(y){var z=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(y.target.files).slice(0,Gr-z);c.value="";var S=(e.get().pendingImages||[]).length,C=e.get().images||[],E=C.length;if(k.length!==0){for(var A=[],N=[],I=0;I<k.length;I++){var P=k[I],g=P.name+"_"+P.size,_=(e.get().fingerprints||[]).some(function(Y){return Y===g})||A.some(function(Y){return Y.file.name+"_"+Y.file.size===g});if(!_){if(P.size>Kn){var R="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(R,"error"):alert(R);continue}var M=URL.createObjectURL(P);s[M]=g,A.push({url:M,file:P,error:null}),N.push({url:M,file:P});var B=(e.get().fingerprints||[]).slice();B.push(g),e.set({fingerprints:B})}}if(A.length!==0){var K=(e.get().pendingImages||[]).concat(A),U=async function(){for(var Y=0;Y<N.length;Y++){var G=N[Y],X=G.file,j=G.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var J=(e.get().pendingImages||[]).filter(function(Q){return Q.url!==j}),F=(e.get().images||[]).slice();F.push(j),e.set({pendingImages:J,images:F});continue}try{var O=await Se(ye+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue})});if(!O.ok)throw O.status===429?new Error("rate_limit"):new Error("sign failed");var W=await O.json();if(!W.folder)throw new Error("sign folder missing");var ae=new FormData;ae.append("file",X),ae.append("api_key",W.api_key),ae.append("timestamp",W.timestamp),ae.append("signature",W.signature),ae.append("folder",W.folder);var q=await fetch("https://api.cloudinary.com/v1_1/"+W.cloud_name+"/image/upload",{method:"POST",body:ae}),$=await q.json();if($.secure_url&&Mr($.secure_url)){var xr=(e.get().pendingImages||[]).some(function(Q){return Q.url===j});if(!xr)continue;x[$.secure_url]=j,s[$.secure_url]=s[j];var Ae=(e.get().pendingImages||[]).filter(function(Q){return Q.url!==j}),D=(e.get().images||[]).slice();D.push($.secure_url),e.set({pendingImages:Ae,images:D});try{Se(ye+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue,secureUrl:$.secure_url,metadata:{assetId:$.asset_id,publicId:$.public_id,version:$.version,resourceType:$.resource_type,format:$.format,width:$.width,height:$.height,bytes:$.bytes,signature:$.signature}})}).catch(function(){})}catch(Q){}}else throw new Error("invalid image url")}catch(Q){console.error("[renuvex-pr] Image upload failed:",Q);var ne=Q.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ne,"error");var me=(e.get().pendingImages||[]).map(function(be){return be.url===j?{url:be.url,file:be.file,error:ne}:be});e.set({pendingImages:me})}}};if(E===0&&S===0){t=!0;var V=!r.canNavigate||r.canNavigate();V&&e.goNext()}e.set({pendingImages:K}),U()}}};var T=e.onChange(f);return f(),{el:o,openPicker:function(){c.disabled||c.click()},destroy:function(){t=!0,c.onchange=null,T&&T()}}}var Xn=150*1024*1024,Jn=2,Zn=60,Oa=8192,Ua=5,$n=3e4,Qn=["video/mp4","video/quicktime"],ei="renuvex_pr_video_upload_",Ha="renuvex_pr_video_cancel_",sr=null,Ra=!1,ri={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},ti={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},he=class extends Error{constructor(r,t,n){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=n||null}};function Va(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:ri[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:ti[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function Da(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function gt(e){return new Promise(function(r){setTimeout(r,e)})}function er(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function rr(e){return Math.max(0,Math.round(er()-e))}function ai(){if(typeof window!="undefined"){var e=Number(window.__renuvexPrVideoUploadStallMs);if(Number.isFinite(e)&&e>=250)return e}return $n}function ni(e,r){return new Promise(function(t,n){var a=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(a),r&&r.removeEventListener("abort",o),n(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function ht(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function bt(e,r){return ei+ue+"_"+e+"_"+ht(r)}function Ya(e,r){try{var t=window.sessionStorage.getItem(bt(e,r)),n=t?JSON.parse(t):null;return!n||typeof n.token!="string"||!n.expiresAt||new Date(n.expiresAt).getTime()<=Date.now()?null:n}catch(a){return null}}function ii(e,r,t){try{window.sessionStorage.setItem(bt(e,r),JSON.stringify(t))}catch(n){}}function cr(e,r){try{window.sessionStorage.removeItem(bt(e,r))}catch(t){}}function oi(e,r){return Ha+ue+"_"+e+"_"+ht(r)}function li(e,r,t,n){if(!(!e||!r||!t)){var a={token:e,productId:r,expiresAt:n||null};try{window.sessionStorage.setItem(oi(r,t),JSON.stringify(a))}catch(i){}}}function pi(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(Ha+ue+"_")!==0)){var n=window.sessionStorage.getItem(t),a=n?JSON.parse(n):null;if(!a||typeof a.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:a.token})}}}catch(i){}return e}function Ia(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function tr(e,r,t){var n=await Se(ye+e,r,t||2e4),a=await n.json().catch(function(){return{}});if(!n.ok){var i=Number(n.headers.get("Retry-After"));throw new he(a.error||"video_request_failed",n.status,Number.isFinite(i)&&i>0?i:null)}return a.data||{}}async function vr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await tr("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:rr(r.startedAt),finalStatus:t})},4e3)}catch(n){}}async function ui(e){try{return await tr("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Ia(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Ia(e.key),!0):!1}}function Xr(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():sr||(sr=(async function(){for(var e=pi(),r=0;r<e.length;r+=1)await ui(e[r])})().finally(function(){sr=null}),sr)}function Jr(){typeof window=="undefined"||Ra||(Ra=!0,window.addEventListener("online",function(){Xr()}),Xr())}async function di(){var e=await import("./upchunk-QJXCGVJW.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function Ba(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}var si={http_408:!0,http_502:!0,http_503:!0,http_504:!0};function vi(e){return si[e]!==!0}async function ci(e){var r=await di();return new Promise(function(t,n){var a=!1,i=null,o=null,l=ai(),p=null;function u(x){a||(a=!0,o&&clearTimeout(o),e.signal&&e.signal.removeEventListener("abort",v),p&&p(),x?n(x):t())}function m(x){a||(o&&clearTimeout(o),!(!x&&typeof navigator!="undefined"&&navigator.onLine===!1)&&(o=setTimeout(function(){if(!a){e.onUploadError&&e.onUploadError("video_upload_stalled"),u(new he("video_upload_stalled",0,null));try{i&&i.abort()}catch(s){}}},l)))}function c(){return a?!1:(m(),!0)}function d(){if(!a){e.onUploadError&&e.onUploadError("video_upload_offline"),u(new he("video_upload_offline",0,null));try{i&&i.abort()}catch(x){}}}function v(){try{i&&i.abort()}catch(x){}u(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return n(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",v,{once:!0})}if(i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||Oa,attempts:e.chunkAttempts||Ua,dynamicChunkSize:!0}),typeof window!="undefined"&&typeof window.addEventListener=="function"&&typeof window.removeEventListener=="function"&&(window.addEventListener("offline",d),p=function(){window.removeEventListener("offline",d)}),typeof navigator!="undefined"&&navigator.onLine===!1){d();return}m(),i.on("attempt",function(){c()&&e.onStatus("uploading")}),i.on("attemptFailure",function(x){if(c()){var s=x&&x.detail,f=Ba(s);if(e.onAttemptFailure&&e.onAttemptFailure(f),vi(f)){e.onUploadError&&e.onUploadError(f),u(new he(f,0,null));try{i&&i.abort()}catch(h){}return}e.onStatus("upload_retrying")}}),i.on("chunkSuccess",function(){c()}),i.on("progress",function(x){if(c()){var s=Number(x&&x.detail);if(Number.isFinite(s)){var f=Math.min(95,Math.max(0,Math.round(s*.95)));Number.isFinite(e.minProgress)&&(f=Math.max(e.minProgress,f)),e.onProgress(f)}}}),i.on("offline",d),i.on("error",function(x){if(c()){var s=x&&x.detail,f=Ba(s);e.onUploadError&&e.onUploadError(f),u(new he(f,0,null))}}),i.on("success",function(){c()&&(e.onProgress(95),u())})})}function mi(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function Fa(e,r,t){for(var n=Date.now(),a=n+600*1e3,i=0;Date.now()<a;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-n;try{var l=await tr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":l.status||"processing"),l.status==="ready")return l;if(l.status==="failed"||l.status==="aborted")throw new he(l.errorCode||"video_processing_failed",409,null)}catch(p){if(r.aborted||p instanceof he&&p.status===409||Da(p)||(i+=1,i>=3))throw p}await ni(mi(o),r)}throw new he("video_processing_delayed",0,null)}async function fi(e){for(var r=null,t=1;t<=3;t+=1)try{return await tr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(n){if(Da(n))return null;r=n,t<3&&await gt(400*t)}throw r||new Error("video_status_failed")}async function xi(e,r,t,n){for(var a=10;a<=90;a+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(a),await gt(120)}return n("processing"),await gt(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function ja(e){return!e||Qn.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>Xn?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function Wa(e){return new Promise(function(r){var t=URL.createObjectURL(e),n=document.createElement("video"),a=!1;function i(o){if(!a){a=!0,n.removeAttribute("src");try{n.load()}catch(l){}URL.revokeObjectURL(t),r(o)}}n.preload="metadata",n.onloadedmetadata=function(){i(Number.isFinite(n.duration)?n.duration:null)},n.onerror=function(){i(null)},n.src=t,setTimeout(function(){i(null)},8e3)})}function qa(e){return e===null?{ok:!0}:e<Jn||e>Zn?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function Ga(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return xi(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:er(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(x){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=x||"upload_attempt_failed")}function n(){cr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}async function a(x,s){var f=await fi(x);if(!f)return{action:"discard"};if(f.status==="ready")return e.onToken&&e.onToken(x),e.onProgress(100),cr(e.productId,e.file),await vr(x,r,"ready"),{action:"return",value:Object.assign({token:x},f)};if(f.status==="uploaded"||f.status==="processing"){e.onToken&&e.onToken(x),e.onStatus("processing");var h=er(),b=await Fa(x,e.signal,e.onStatus);return r.processingPollMs=rr(h),cr(e.productId,e.file),e.onProgress(100),await vr(x,r,"ready"),{action:"return",value:Object.assign({token:x},b)}}return f.status==="failed"||f.status==="aborted"?{action:"discard"}:!s||typeof s.uploadUrl!="string"||!s.uploadUrl?{action:"discard"}:{action:"upload"}}Jr(),await Xr();var i=Ya(e.productId,e.file),o=i&&i.token,l=i;if(o){var p=await a(o,l);if(p.action==="return")return p.value;p.action==="discard"&&(n(),o=null,l=null)}for(;;){if(!o){var u=await tr("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:ht(e.file)})});o=u.token,l=u,ii(e.productId,e.file,u)}e.onToken&&e.onToken(o),r.chunkSizeKb=l.chunkSize||Oa,r.chunkAttempts=l.chunkAttempts||Ua,e.onStatus("uploading");var m=er();try{await ci({uploadUrl:l.uploadUrl,file:e.file,chunkSize:l.chunkSize,chunkAttempts:l.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=(r.directUploadMs||0)+rr(m),e.onStatus("processing");var c=er();await tr("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:o})},3e4),r.completeMs=rr(c);var d=er(),v=await Fa(o,e.signal,e.onStatus);return r.processingPollMs=rr(d),cr(e.productId,e.file),e.onProgress(100),await vr(o,r,"ready"),Object.assign({token:o},v)}catch(x){throw r.directUploadMs=(r.directUploadMs||0)+rr(m),e.signal&&e.signal.aborted?(await vr(o,r,"aborted"),x):(await vr(o,r,"failed"),x)}}}async function Zr(e,r,t){var n=r&&t?Ya(r,t):null;e&&r&&t&&li(e,r,t,n&&n.expiresAt),r&&t&&cr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(Jr(),await Xr())}function Ka(){return"Video y\xFCklenemedi"}function Xa(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function gi(e){return"Video y\xFCkleniyor"}function hi(e){return!0}function Ja(e,r){r=r||{};var t=!1,n=null,a=null,i=0,o=document.createElement("div");o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=ce("formStepMediaTitle"),o.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-subtitle",p.textContent=ce("formStepMediaSubtitle"),o.appendChild(p);var u=document.createElement("div");u.className="renuvex-pr-fwizard-media-card";var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",m.setAttribute("aria-label","Foto\u011Fraf ekle"),m.innerHTML=se(Ar)+"<span>Foto\u011Fraf Ekle</span>";var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",c.setAttribute("aria-label","Video ekle"),c.innerHTML=se(Pr)+"<span>Video Ekle</span>",u.appendChild(m),u.appendChild(c);var d=document.createElement("div");d.className="renuvex-pr-fwizard-media-content",u.appendChild(d),o.appendChild(u);var v=document.createElement("input");v.type="file",v.accept="video/mp4,video/quicktime,.mp4,.mov",v.style.display="none",o.appendChild(v);function x(){var g=e.get();return(g.images||[]).length>0||(g.pendingImages||[]).length>0}function s(){var g=e.get();return(g.images||[]).length+(g.pendingImages||[]).length}function f(){return e.get().videoUpload||null}function h(){return i+=1,i}function b(g,_){var R=f();return i===g&&!!R&&R.controller===_}function w(){if(!a){d.innerHTML="";return}a.retry.onclick=null,d.innerHTML="",a=null}function T(){n&&(n.destroy&&n.destroy(),n=null)}function y(g){T(),d.innerHTML="";var _=Xa(g),R=document.createElement("div");R.className=_==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":_==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var M=null,B=null,K=null,U=null,V=document.createElement("button");if(V.type="button",V.className="renuvex-pr-fwizard-video-retry",V.textContent="Tekrar dene",_==="ready"){var Y=g.posterUrl||g.localUrl||"";Y&&Y!==g.localUrl?(M=document.createElement("img"),M.alt="",M.src=Y):(M=document.createElement("video"),M.muted=!0,M.playsInline=!0,M.preload="metadata",M.src=g.localUrl||""),M.className="renuvex-pr-fwizard-video-preview",R.appendChild(M)}else _==="busy"?(U=document.createElement("div"),U.className="renuvex-pr-fwizard-video-uploading-status",U.setAttribute("role","status"),U.setAttribute("aria-live","polite"),R.appendChild(U)):(B=document.createElement("div"),B.className="renuvex-pr-fwizard-video-details renuvex-pr-fwizard-video-details--failed",U=document.createElement("div"),U.className="renuvex-pr-fwizard-video-status renuvex-pr-fwizard-video-status--error",U.setAttribute("role","alert"),U.setAttribute("aria-live","assertive"),B.appendChild(U),R.appendChild(B));if(_==="ready"){let J=function(F){F&&(F.preventDefault(),F.stopPropagation()),A()};var j=J,G=document.createElement("button");G.type="button",G.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",G.setAttribute("aria-label","Videoyu kald\u0131r");var X=ee(we);X&&G.appendChild(X),G.addEventListener("pointerdown",J),G.addEventListener("click",J),R.appendChild(G)}d.appendChild(R),a={mode:_,card:R,preview:M,previewUrl:_==="ready"&&(g.posterUrl||g.localUrl)||"",details:B,name:K,status:U,retry:V}}function z(){if(!t){var g=f();if(!g){w();return}var _=Xa(g),R=_==="ready"&&(g.posterUrl||g.localUrl)||"";if((!a||a.mode!==_||a.previewUrl!==R)&&y(g),a.name&&(a.name.textContent=g.file?g.file.name:"Video"),a.status&&_==="busy"){var M=gi(g),B=hi(g)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+M+"</span>":"<span>"+M+"</span>";a.status.innerHTML!==B&&(a.status.innerHTML=B)}a.status&&_==="failed"&&(a.status.className="renuvex-pr-fwizard-video-status renuvex-pr-fwizard-video-status--error",a.status.setAttribute("role","alert"),a.status.textContent=Ka(g));var K=_==="failed"&&!!(g.error&&g.file&&g.retryable!==!1);a.retry.onclick=K?function(){E(g.file,g.localUrl,g.durationMs)}:null,K&&a.details&&!a.retry.isConnected?a.details.appendChild(a.retry):!K&&a.retry.isConnected&&a.retry.remove()}}function k(){var g=x(),_=s()>=Gr,R=!!f(),M=g||R;m.hidden=M,c.hidden=M,m.disabled=R||_,c.disabled=g||R,u.classList.toggle("renuvex-pr-fwizard-media-card--has-media",M),u.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",g),u.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",R),m.classList.toggle("renuvex-pr-fwizard-media-action--active",g),c.classList.toggle("renuvex-pr-fwizard-media-action--active",R)}function S(g){var _=f();if(_){var R=Object.keys(g),M=R.some(function(B){return _[B]!==g[B]});M&&e.set({videoUpload:Object.assign({},_,g)})}}function C(g,_,R){b(g,_)&&S(R)}async function E(g,_,R){var M=f(),B=!!(_&&M&&M.file===g),K=B?Math.max(0,Math.min(95,Number(M.progress)||0)):0,U=B?(Number(M.retryClicks)||0)+1:0,V=ja(g);if(!V.ok){r.showToast&&r.showToast(V.message,"error");return}var Y=_||URL.createObjectURL(g),G=Number.isFinite(R)?R:null,X=new AbortController,j=h();e.set({videoUpload:{file:g,localUrl:Y,token:B&&M.token||null,status:"uploading",progress:K,durationMs:G,error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:U,controller:X}}),!B&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var J=R!==void 0?Number.isFinite(R)?R/1e3:null:await Wa(g),F=qa(J);if(!F.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:F.message});var O=await Ga({file:g,productId:e.get().productId,signal:X.signal,minProgress:K,retryClicks:U,onToken:function(q){C(j,X,{token:q})},onProgress:function(q){C(j,X,{progress:q})},onStatus:function(q){C(j,X,{status:q})},onSessionReset:function(){C(j,X,{token:null,progress:0})}});if(!b(j,X))return;if(O.previewOnly&&O.posterUrl&&O.posterUrl!==Y)try{URL.revokeObjectURL(O.posterUrl)}catch(q){}S({token:O.token,status:"ready",progress:100,posterUrl:O.previewOnly?Y:O.posterUrl,durationMs:O.durationMs||(J===null?null:Math.round(J*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),B&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(q){if(X.signal.aborted||!b(j,X))return;var W=Va(q);if(q&&q.code==="invalid_video_duration"&&(W={code:"invalid_video_duration",message:q.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),S({status:"failed",error:W.message,errorCode:W.code,retryable:W.retryable,retryAfterSec:W.retryAfterSec,controller:null}),r.showToast){var ae=W.code==="invalid_video_duration"?W.message:Ka();r.showToast(ae,"error")}}}function A(){var g=f();g&&(h(),g.controller&&g.controller.abort(),Zr(g.token,e.get().productId,g.file),r.revokeBlobUrl&&r.revokeBlobUrl(g.localUrl),e.set({videoUpload:null}))}function N(g){if(n){g&&n.openPicker&&n.openPicker();return}a=null,d.innerHTML="",n=Kr(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),d.appendChild(n.el),g&&n.openPicker&&n.openPicker()}m.onclick=function(){m.disabled||N(!0)},c.onclick=function(){c.disabled||(T(),d.innerHTML="",v.click())},v.onchange=function(){var g=v.files&&v.files[0];v.value="",g&&E(g,null,void 0)};var I=!!f(),P=e.onChange(function(){k();var g=!!f();(g||I)&&z(),I=g});return k(),x()&&N(!1),f()&&z(),{el:o,destroy:function(){t=!0,m.onclick=null,c.onclick=null,v.onchange=null,n&&n.destroy&&n.destroy(),P&&P()}}}var yt=2e3,bi=60;function Za(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=ce("formStepContentTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=bi,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var l=document.createElement("textarea");l.className="renuvex-pr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=yt,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",i.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-char-counter",p.setAttribute("aria-live","polite"),i.appendChild(p);function u(){var c=l.value.length;p.textContent=c+"/"+yt,p.classList.toggle("renuvex-pr-fwizard-char-counter--max",c>=yt)}function m(){return Qe(3,e.get())}return l.addEventListener("input",function(){e.set({comment:l.value}),u(),t(m())}),n.appendChild(i),u(),setTimeout(function(){t(m())},0),{el:n,destroy:function(){}}}var yi=40;function $a(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ce("formStepAuthorTitle"),a.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var l=document.createElement("div");l.className="renuvex-pr-fwizard-field";var p=document.createElement("label");p.className="renuvex-pr-fwizard-label",p.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=yi,u.setAttribute("aria-required","true"),u.value=e.get().author||"",l.appendChild(p),l.appendChild(u),o.appendChild(l);var m=document.createElement("div");m.className="renuvex-pr-fwizard-field";var c=document.createElement("label");c.className="renuvex-pr-fwizard-label",c.textContent="E-posta (opsiyonel)";var d=document.createElement("input");d.type="email",d.className="renuvex-pr-fwizard-input",d.setAttribute("autocomplete","email"),d.value=e.get().email||"",m.appendChild(c),m.appendChild(d),o.appendChild(m);var v=document.createElement("div");v.className="renuvex-pr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(v);var x=document.createElement("div");x.className="renuvex-pr-fwizard-msg",x.setAttribute("role","alert"),x.setAttribute("aria-live","assertive"),o.appendChild(x);var s=document.createElement("button");s.type="button",s.className="renuvex-pr-fwizard-submit-btn",s.textContent="G\xF6nder",o.appendChild(s),a.appendChild(o);function f(){return Qe(4,e.get())}function h(){var y=!f(),z=(e.get().pendingImages||[]).length,k=z>0,S=e.get().videoUpload,C=!!(S&&S.status==="failed"),E=!!(S&&S.status!=="ready"&&S.status!=="failed");k||E||C?(s.disabled=!0,s.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),s.textContent=C?"Video Y\xFCklenemedi":E?"Video Haz\u0131rlan\u0131yor...":"Foto\u011Fraflar Y\xFCkleniyor..."):(s.disabled=y,s.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",y),s.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),h(),t(f())}),d.addEventListener("input",function(){e.set({email:d.value})}),h(),setTimeout(function(){t(f())},0);function b(){x.textContent=""}function w(y){b();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=y||"",x.appendChild(z)}s.onclick=async function(){if(!s.disabled){var y=e.get(),z=(y.author||"").trim(),k=(y.comment||"").trim();if(d.value.trim()&&!d.checkValidity()){d.reportValidity();return}if(!z){w("Gerekli alan");return}if(!y.rating){w("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}s.disabled=!0,s.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var S=s.textContent;if(s.textContent="G\xF6nderiliyor\u2026",b(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){y.videoUpload&&y.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n()},600);return}try{var C=$t(window.location.href),E=y.productName||null,A=await Se(ye+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue,productId:y.productId||null,slug:C||null,productName:E,author:z,title:(y.title||"").trim()||null,comment:k||null,rating:y.rating,images:y.videoUpload?[]:y.images||[],videoToken:y.videoUpload&&y.videoUpload.status==="ready"?y.videoUpload.token:null})},15e3);if(A.ok)y.videoUpload&&y.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n();else{var N=await A.json().catch(function(){return{}});throw new Error(N.error||"Yorum kaydedilemedi.")}}catch(g){var I=g&&(g.name==="AbortError"||/signal/i.test(g.message||"")),P=I?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":g.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(P,"error"):w(P),s.disabled=!1,s.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),s.textContent=S}}};var T=e.onChange(h);return{el:a,destroy:function(){s.onclick=null,T&&T()}}}function wi(e,r,t){if(t=t||{},e===1)return La(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return Ja(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return Kr(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Za(r,{onValidityChange:t.onValidityChange});if(e===4)return $a(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Qa(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function en(e){e=e||{},Jr();var r=_a({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:L&&L.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},n={},a={};function i(E){if(!(!E||typeof E!="string"||!E.startsWith("blob:")||a[E])){a[E]=!0;try{URL.revokeObjectURL(E)}catch(A){}}}function o(){Object.keys(n).forEach(function(A){i(A)}),Object.keys(t).forEach(function(A){i(t[A])});var E=r.get();(E.pendingImages||[]).forEach(function(A){i(A&&A.url)}),(E.images||[]).forEach(function(A){i(A)}),E.videoUpload&&i(E.videoUpload.localUrl)}function l(){var E=r.get(),A=E.videoUpload;!A||E.videoSubmitted||(A.controller&&A.controller.abort(),Zr(A.token,E.productId,A.file))}var p=Ma({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",m),jr(u),l(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=Yr(),m=function(E){p&&p.close&&p.close()};window.addEventListener("popstate",m);var c=document.createElement("div");c.className="renuvex-pr-fwizard-step-wrap";var d=Na({skippableSteps:[2],nextableSteps:[3],onBack:function(){s==="idle"&&r.goBack()},onSkip:function(){s==="idle"&&r.goNext()},onNext:function(){s==="idle"&&r.goNext()}}),v=document.createElement("div");v.className="renuvex-pr-fwizard-layout",v.appendChild(c),v.appendChild(d.el);var x=null,s="idle",f=null,h=!0,b=null;function w(E,A){c.innerHTML="";var N=wi(E,r,{canNavigate:function(){return s==="idle"},blobMap:t,urlToFinger:n,revokeBlobUrl:i,onValidityChange:function(g){d.setNextDisabled(!g)},onSuccess:y,showToast:p.showToast});if(x=N,d.update(E,r.get()),A){s="entering",N.el.classList.add("renuvex-pr-fwizard-step--enter");var I=null,P=function(){I&&clearTimeout(I),N.el.removeEventListener("animationend",P),N.el.classList.remove("renuvex-pr-fwizard-step--enter"),s="idle",f!==null&&z()};N.el.addEventListener("animationend",P),I=setTimeout(P,700)}else s="idle";c.appendChild(N.el),p.setStepAttr&&p.setStepAttr(E),E===3&&d.setNextDisabled(!0)}var T=!1;function y(){if(!T){if(T=!0,!x){c.innerHTML="";var E=Qa();E.classList.add("renuvex-pr-fwizard-step--enter"),c.appendChild(E),p.setStepAttr("thanks"),d.setThanksState(p.close);return}var A=x;s="exiting",A.el.classList.add("renuvex-pr-fwizard-step--exit");var N=function(){if(b&&clearTimeout(b),A.el.removeEventListener("animationend",N),A.destroy)try{A.destroy()}catch(P){}x===A&&(x=null),c.innerHTML="";var I=Qa();I.classList.add("renuvex-pr-fwizard-step--enter"),c.appendChild(I),p.setStepAttr("thanks"),d.setThanksState(p.close),s="idle"};A.el.addEventListener("animationend",N),b=setTimeout(N,300)}}function z(){var E=r.get().currentStep;if(s!=="idle"){f=E;return}if(!x){var A=!h;h=!1,w(E,A);return}var N=x;s="exiting",N.el.classList.add("renuvex-pr-fwizard-step--exit");var I=function(){if(b&&clearTimeout(b),N.el.removeEventListener("animationend",I),N.destroy)try{N.destroy()}catch(g){}if(x===N){c.innerHTML="",x=null;var P=f!==null?f:r.get().currentStep;f=null,w(P,!0),s="idle"}};N.el.addEventListener("animationend",I),b=setTimeout(I,350)}z();var k=r.get().currentStep,S=r.onChange(function(E){E.currentStep!==k?(k=E.currentStep,z()):d.update(E.currentStep,E)}),C=p.close;return p.close=function(){S&&S(),typeof b!="undefined"&&b&&clearTimeout(b),C()},p.open(v),{close:p.close}}var zi=4e3;async function rn(){var e=await Se(ye+"/api/public/upload/video/capability?storeId="+encodeURIComponent(ue),{method:"GET",cache:"no-store"},zi);if(!e.ok){var r=new Error("video_capability_unavailable");throw r.code="video_capability_http",r.status=e.status,r}var t=await e.json().catch(function(){return{}}),n=t&&t.data;if(!n||typeof n.enabled!="boolean"){var a=new Error("video_capability_invalid");throw a.code="video_capability_invalid",a}return{enabled:n.enabled===!0,reason:typeof n.reason=="string"?n.reason:null}}var $r=null;function tn(){return L&&L.videoReviewsEnabled===!0}function ki(e){var r=e&&Number(e.status),t=Number.isFinite(r)&&r>=100;return tn()&&!t?{enabled:!0,reason:"capability_unavailable"}:{enabled:!1,reason:"capability_unavailable"}}function Si(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function Ci(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:tn(),reason:null};else try{t=await rn()}catch(n){t=ki(n)}en({productId:Z||"",productName:Ie||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function te(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=Si(r);return $r||($r=Ci(r,Me()).finally(function(){$r=null})),$r.finally(t)}var an=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Ei={id:"classic",name:"Klasik (A\xE7\u0131k)"},Ti=an;function Ai(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,p=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentHasImages,c=e.onFilterChange,d=e.onSortChange;Ne(a);var v=document.createElement("div");v.className="renuvex-pr-summary";var x=(o[3]||0)+(o[4]||0),s=i>0?Math.round(x/i*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-avg",f.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+de("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",v.appendChild(f);var h=document.createElement("div");if(h.className="renuvex-pr-summary-block renuvex-pr-summary-count",h.textContent=i.toLocaleString("tr-TR")+" "+H(n.countLabel,"Yorum"),v.appendChild(h),n.showRecommendation!==!1&&s>0){var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",b.innerHTML='<span class="renuvex-pr-recommend-pct">%'+s+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(b)}return v.appendChild(Ze({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:p,onFilterChange:c})),v.appendChild(pe({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:te,onSortChange:d})),v}var zt={};Pe(zt,{css:()=>Mi,meta:()=>Pi,render:()=>Ri});var nn=`
...
`;var Pi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Mi=nn,_i="__unknown_product__",mr=Object.create(null);function Ni(e){return e?String(e):_i}var Ve=null,fr=null;function Li(){!Ve||!fr||(Ve.removeEventListener?Ve.removeEventListener("change",fr):Ve.removeListener&&Ve.removeListener(fr),Ve=null,fr=null)}function Ri(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,p=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentHasImages,c=e.onFilterChange,d=e.onSortChange,v=Ni(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var s=document.createElement("div");s.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Le(l,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(Jt)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),w=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+H(n.countLabel,"Yorum")),b&&w){var T=document.createElement("span");T.className="renuvex-pr-compact-trigger-count",h.insertBefore(T,b),T.appendChild(b),T.appendChild(w)}f.appendChild(h),s.appendChild(f);var y=pe({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:te,onSortChange:d}),z=y.querySelector(".renuvex-pr-filter-wrap"),k=y.querySelector(".renuvex-pr-write-btn"),S=document.createElement("div");S.className="renuvex-pr-compact-actions-slot",k&&S.appendChild(k),z&&S.appendChild(z),s.appendChild(S),x.appendChild(s);var C=document.createElement("div");C.className="renuvex-pr-compact-panel",C.setAttribute("role","dialog"),C.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),C.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="renuvex-pr-compact-panel-inner";var A=document.createElement("div");A.className="renuvex-pr-compact-avg",A.innerHTML='<span class="renuvex-pr-icon">'+de("full")+"</span><span>"+l+"</span>",E.appendChild(A),E.appendChild(Ze({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:p,onFilterChange:function(F){I()&&C.classList.contains("renuvex-pr-open")&&(mr[v]=!0),c(F)}})),C.appendChild(E);var N=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function I(){return!!(N&&N.matches)}function P(F){F?C.classList.add("renuvex-pr-open"):C.classList.remove("renuvex-pr-open"),C.setAttribute("aria-hidden",F?"false":"true"),h.setAttribute("aria-expanded",F?"true":"false")}function g(F){var O=F?x:f;if(C.parentNode!==O){var W=!!C.parentNode;C.classList.contains("renuvex-pr-open")&&P(!1),W&&(mr[v]=!1),O.appendChild(C)}}g(N?N.matches:!1);var _=pe({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:te,onSortChange:d}),R=_.querySelector(".renuvex-pr-filter-wrap"),M=_.querySelector(".renuvex-pr-write-btn"),B=document.createElement("div");B.className="renuvex-pr-compact-write-row",M&&B.appendChild(M),R&&B.appendChild(R),x.appendChild(B);function K(){var F=C.classList.contains("renuvex-pr-open");return P(!1),I()&&(mr[v]=!1),F}function U(){V&&V.notifyOpening(),P(!0),I()&&(mr[v]=!0)}h.onclick=function(){C.classList.contains("renuvex-pr-open")?K():U()};var V=null;function Y(F){V&&(V.unregister(),V=null),F||(V=qr({trigger:f,element:C,close:K}))}if(Y(N?N.matches:!1),Li(),N){var G=function(F){g(F.matches),Y(F.matches)};N.addEventListener?N.addEventListener("change",G):N.addListener&&N.addListener(G),Ve=N,fr=G}if(I()&&mr[v]&&P(!0),n.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),j=i>0?Math.round(X/i*100):0;if(j>0){var J=document.createElement("div");J.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",J.style.marginTop="8px",J.innerHTML='<span class="renuvex-pr-recommend-pct">%'+j+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(J)}}return x}var kt={};Pe(kt,{css:()=>Bi,meta:()=>Ii,render:()=>Fi});var on=`
...
`;var Ii={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Bi=on;function Fi(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,l=e.currentRatingFilter,p=e.currentOrderBy,u=e.currentHasImages,m=e.onFilterChange,c=e.onSortChange;Ne(n);var d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-split";var v=document.createElement("div");v.className="renuvex-pr-split-col renuvex-pr-split-left";var x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+de("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",v.appendChild(x);var s=document.createElement("div");s.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",s.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),v.appendChild(s),d.appendChild(v);var f=document.createElement("div");f.className="renuvex-pr-split-col renuvex-pr-split-mid",f.appendChild(Ze({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:l,onFilterChange:m})),d.appendChild(f);var h=pe({widget:r,currentOrderBy:p,currentHasImages:u,onWriteClick:te,onSortChange:c}),b=h.querySelector(".renuvex-pr-filter-wrap"),w=h.querySelector(".renuvex-pr-write-btn"),T=document.createElement("div");T.className="renuvex-pr-split-col renuvex-pr-split-right",w&&T.appendChild(w),b&&T.appendChild(b),d.appendChild(T);var y=(i[3]||0)+(i[4]||0),z=a>0?Math.round(y/a*100):0,k=document.createElement("div");k.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",k.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var S=t.showRecommendation===!1||z===0;return S&&k.classList.add("renuvex-pr-split-rec-hidden"),v.appendChild(k),d}var St={};Pe(St,{css:()=>Ui,meta:()=>Oi,render:()=>Hi});var ln=`
...
`;var Oi={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Ui=ln;function Hi(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,p=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-minimal";var m=document.createElement("div");m.className="renuvex-pr-minimal-info";var c=document.createElement("div");c.className="renuvex-pr-minimal-row";var d=document.createElement("span");d.className="renuvex-pr-minimal-avg",d.textContent=i,c.appendChild(d);var v=document.createElement("span");v.className="renuvex-pr-minimal-stars",v.innerHTML=Le(i,n),c.appendChild(v);var x=document.createElement("span");x.className="renuvex-pr-minimal-count",x.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),c.appendChild(x),m.appendChild(c),u.appendChild(m);var s=pe({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:te,onSortChange:p}),f=s.querySelector(".renuvex-pr-filter-wrap"),h=s.querySelector(".renuvex-pr-write-btn"),b=document.createElement("div");b.className="renuvex-pr-minimal-actions",h&&b.appendChild(h),f&&b.appendChild(f),u.appendChild(b);var w=pe({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:te,onSortChange:p}),T=w.querySelector(".renuvex-pr-filter-wrap"),y=w.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-minimal-write-row",y&&z.appendChild(y),T&&z.appendChild(T),u.appendChild(z),u}var Ct={};Pe(Ct,{css:()=>Di,meta:()=>Vi,render:()=>Yi});var pn=`
...
`;var Vi={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},Di=pn;function Yi(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,p=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var m=document.createElement("div");m.className="renuvex-pr-hero-info";var c=document.createElement("div");c.className="renuvex-pr-hero-rating-col";var d=document.createElement("span");d.className="renuvex-pr-hero-avg",d.textContent=i,c.appendChild(d);var v=document.createElement("div");v.className="renuvex-pr-hero-meta-row";var x=document.createElement("span");x.className="renuvex-pr-hero-stars",x.innerHTML=Le(i,n),v.appendChild(x);var s=document.createElement("div");s.className="renuvex-pr-hero-count",s.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),v.appendChild(s),c.appendChild(v),m.appendChild(c),u.appendChild(m);var f=pe({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:te,onSortChange:p}),h=f.querySelector(".renuvex-pr-filter-wrap"),b=f.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",b&&w.appendChild(b),h&&w.appendChild(h),u.appendChild(w);var T=pe({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:te,onSortChange:p}),y=T.querySelector(".renuvex-pr-filter-wrap"),z=T.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");return k.className="renuvex-pr-hero-write-row",z&&k.appendChild(z),y&&k.appendChild(y),u.appendChild(k),u}var un=`
  .renuvex-pr-summary{
...
`;var Ji={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Zi=cn;function $i(e,r){var t=Br(e),n=!!t,a=document.createElement("article");a.className="renuvex-pr-review-gallery"+(n?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=ze(e.rating,L),i.appendChild(o),e.title){var l=document.createElement("div");l.className="renuvex-pr-review-gallery-title",l.textContent=e.title,i.appendChild(l)}var p=document.createElement("div");p.className="renuvex-pr-review-gallery-author",p.textContent=e.author||"",i.appendChild(p);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=ke(e.createdAt),i.appendChild(u);var m=(e.comment||"").trim();if(m&&i.appendChild(ar(m,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ge(e,t.url,r)}}:null).fragment),a.appendChild(i),n){var c=document.createElement("div");c.className="renuvex-pr-review-gallery-media";var d=Re(t,{sourceWidth:_r,width:_r,height:Math.round(_r*4/3),onOpen:function(){ge(e,t.url,r)}});d&&c.appendChild(d),a.appendChild(c)}var v=nr(e.merchantReply,t?function(){ge(e,t.url,r)}:null);return v&&(v.classList.add("renuvex-pr-review-gallery-reply"),a.appendChild(v)),a}var rt={card:Et,list:Tt,gallery:At};function tt(e){return rt[e]||rt.card}function mn(){return Object.keys(rt).map(function(e){return rt[e].css||""}).join(`
`)}var Pt=0;function De(){return Pt++,Pt}function Ye(e,r){return e!==Pt?!1:r?!(r.productId!==void 0&&Z!==r.productId||r.orderBy!==void 0&&re!==r.orderBy||r.page!==void 0&&or!==r.page||r.ratingFilter!==void 0&&ie!==r.ratingFilter||r.hasImages!==void 0&&oe!==r.hasImages||r.nextCursor!==void 0&&wr!==r.nextCursor):!0}var Mt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},_t={small:80,medium:110,large:140},Nt={small:80,medium:100,large:110};function fn(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",n=document.createElementNS(t,"svg");n.setAttribute("width","32"),n.setAttribute("height","32"),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.style.cssText="color:#6e6d7a;margin-bottom:4px;";var a=document.createElementNS(t,"path");a.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),n.appendChild(a),n.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var l=document.createElement("div");return l.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",l.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(n),r.appendChild(o),r.appendChild(l),r}function xn(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var n=document.createElement("div");n.className="renuvex-pr-empty-state-stars",n.innerHTML=Le(0,e.iconPair),t.appendChild(n);var a=document.createElement("p");a.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),a.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(a),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function gn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function hn(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="renuvex-pr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var a=document.createElement("button");return a.type="button",a.className="renuvex-pr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},t.appendChild(a),t}function Te(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),a=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+n+","+a+","+i+","+r+")"}function at(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Lt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function bn(e){return .2126*Lt(e.r)+.7152*Lt(e.g)+.0722*Lt(e.b)}function yn(e,r){var t=bn(e),n=bn(r),a=Math.max(t,n),i=Math.min(t,n);return(a+.05)/(i+.05)}function Qi(e){var r=at(e)||at("#ffffff"),t=at("#111111"),n=at("#ffffff");return yn(t,r)>=yn(n,r)?"#111111":"#ffffff"}function eo(e){return Te(e,e==="#ffffff"?.1:.06)}function wn(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",l=r.barTrackColor||"#e5e7eb",p=r.barCountColor||"#111111",u=Te(o,.06),m=r.reviewStarColor||"#f59e0b",c=r.btnBgColor||"#111111",d=r.btnTextColor||"#ffffff",v=r.btnBorderColor||"#111111",x=r.filterBtnBgColor||"#111111",s=r.filterBtnTextColor||"#ffffff",f=r.filterBtnBorderColor||"#111111",h=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",w=r.filterItemTextColor||"#111111",T=r.filterItemHoverBgColor||"#f3f4f6",y=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",k=r.reviewAuthorColor||"#111111",S=r.reviewDateColor||"#5e5e5e",C=r.reviewBodyColor||"#111111",E=r.reviewBorderColor||"#e5e7eb",A=Te(C,.65),N=r.replyBgColor||"#f9fafb",I=r.replyBorderColor||"#747474",P=r.replyLabelColor||"#111111",g=r.replyTextColor||"#111111",_=r.photoTitleColor||"#111111",R=Te("#111111",.05),M=r.photoArrowBgColor||"#ffffff",B=r.photoArrowTextColor||"#111111",K=Te("#111111",.12),U=r.formBgColor||"#ffffff",V=r.formPrimaryTextColor||"#111111",Y=r.formSecondaryTextColor||"#3b3b3b",G=r.inputTextColor||V,X=r.inputBorderColor||"#d1d5db",j=r.placeholderColor||"#9ca3af",J=r.formStepBarColor||"#111111",F=r.formBtnBgColor||"#111111",O=r.formBtnTextColor||"#ffffff",W=r.formBtnBorderColor||"#111111",ae=Te(F,.06),q=Te(F,.18),$=Te(O,.85),xr=Te(V,.06),Ae=Qi(U),D=eo(Ae),ne=r.loadMoreBgColor||"#ffffff",me=r.loadMoreTextColor||"#111111",Q=r.loadMoreBorderColor||"#111111",be=r.paginationBgColor||"#ffffff",gr=r.paginationTextColor||"#111111",hr=r.paginationBorderColor||"#e5e7eb",br=r.paginationActiveBgColor||"#111111",yr=r.paginationActiveTextColor||"#ffffff",fe={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":n,"--renuvex-pr-header-count":a,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":l,"--renuvex-pr-bar-count":p,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":c,"--renuvex-pr-btn-text":d,"--renuvex-pr-btn-border":v,"--renuvex-pr-filter-btn-bg":x,"--renuvex-pr-filter-btn-text":s,"--renuvex-pr-filter-btn-border":f,"--renuvex-pr-filter-menu-bg":h,"--renuvex-pr-filter-menu-border":b,"--renuvex-pr-filter-item-text":w,"--renuvex-pr-filter-item-hover-bg":T,"--renuvex-pr-filter-item-active":y,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":k,"--renuvex-pr-review-date":S,"--renuvex-pr-review-body":C,"--renuvex-pr-review-border":E,"--renuvex-pr-state-text":A,"--renuvex-pr-review-star-color":m,"--renuvex-pr-reply-bg-color":N,"--renuvex-pr-reply-border":I,"--renuvex-pr-reply-label":P,"--renuvex-pr-reply-text":g,"--renuvex-pr-photo-title":_,"--renuvex-pr-photo-image-border":R,"--renuvex-pr-photo-arrow-bg":M,"--renuvex-pr-photo-arrow-text":B,"--renuvex-pr-photo-arrow-border":K,"--renuvex-pr-fwizard-bg":U,"--renuvex-pr-fwizard-text":V,"--renuvex-pr-fwizard-secondary-text":Y,"--renuvex-pr-fwizard-input-bg":U,"--renuvex-pr-fwizard-input-text":G,"--renuvex-pr-fwizard-input-border":X,"--renuvex-pr-fwizard-placeholder":j,"--renuvex-pr-fwizard-close-text":Ae,"--renuvex-pr-fwizard-close-hover-bg":D,"--renuvex-pr-fwizard-progress-bg":xr,"--renuvex-pr-fwizard-progress-active":J,"--renuvex-pr-fwizard-btn-bg":F,"--renuvex-pr-fwizard-btn-text":O,"--renuvex-pr-fwizard-btn-border":W,"--renuvex-pr-fwizard-btn-disabled-bg":q,"--renuvex-pr-fwizard-btn-disabled-text":$,"--renuvex-pr-fwizard-nav-hover-bg":ae,"--renuvex-pr-load-more-bg":ne,"--renuvex-pr-load-more-text":me,"--renuvex-pr-load-more-border":Q,"--renuvex-pr-pagination-bg":be,"--renuvex-pr-pagination-text":gr,"--renuvex-pr-pagination-border":hr,"--renuvex-pr-pagination-active-bg":br,"--renuvex-pr-pagination-active-text":yr};Object.keys(fe).forEach(function(ir){e.style.setProperty(ir,fe[ir])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function zn(e){var r=e.settings,t=e.root,n=e.currentHasImages,a=e.openReviewModal,i=(e.photoStripReviews||[]).filter(function(w){return Ce(w).length>0});if(!(r.showPhotoGallery!==!1&&!n&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var l=H(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),p=document.createElement("div");p.className="renuvex-pr-photo-title",p.textContent=l,o.appendChild(p)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",u);var m=document.createElement("div");m.className="renuvex-pr-photo-strip";var c=le,d=r.reviewLayout==="card"?le:Math.round(le*4/3),v=0;i.forEach(function(w){if(!(v>=15)){var T=Br(w);if(T){var y=Re(T,{className:"renuvex-pr-photo-strip-thumb",sourceWidth:le,width:c,height:d,loading:v<3?"eager":"lazy",onOpen:function(){a(w,T.url,i)}});y&&(m.appendChild(y),v++)}}});var x=document.createElement("button");x.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var s=ee(We);s&&x.appendChild(s),x.setAttribute("aria-label","\xD6nceki"),x.onclick=function(){m.scrollBy({left:-200,behavior:"smooth"})};var f=document.createElement("button");f.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=ee(Tr);h&&f.appendChild(h),f.setAttribute("aria-label","Sonraki"),f.onclick=function(){m.scrollBy({left:200,behavior:"smooth"})};var b=document.createElement("div");return b.className="renuvex-pr-photo-strip-wrap",b.appendChild(x),b.appendChild(m),b.appendChild(f),o.appendChild(b),o}var ro=1,to=7,Rt="\u2026";function ao(e,r){var t=Math.max(1,Math.floor(Number(r))||1),n=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=to){for(var a=[],i=1;i<=t;i++)a.push(i);return a}for(var o=[],l=1;l<=t;l++)(l===1||l===t||Math.abs(l-n)<=ro)&&o.push(l);for(var p=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&p.push(Rt),p.push(o[u]);return p}function kn(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),n=typeof e.onPageChange=="function"?e.onPageChange:function(){},a=document.createElement("nav");a.className="renuvex-pr-pagination",a.setAttribute("aria-label","Yorum sayfalar\u0131");function i(p){a.setAttribute("aria-busy","true");for(var u=a.querySelectorAll("button"),m=0;m<u.length;m++)u[m].disabled=!0;n(p)}function o(p,u){var m=document.createElement("span");m.className="renuvex-pr-pagination-label",m.setAttribute("aria-hidden","true"),m.textContent=u,p.appendChild(m)}function l(p,u,m,c){var d=document.createElement("button");return d.type="button",d.className="renuvex-pr-pagination-arrow",d.setAttribute("aria-label",p),o(d,u),c?d.disabled=!0:d.onclick=function(){i(m)},d}return a.appendChild(l("\xD6nceki sayfa","\u2039",t-1,t<=1)),ao(t,r).forEach(function(p){if(p===Rt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=Rt,a.appendChild(u);return}var m=document.createElement("button");m.type="button",m.className="renuvex-pr-pagination-btn",m.setAttribute("aria-label","Sayfa "+p),o(m,String(p)),p===t?m.setAttribute("aria-current","page"):m.onclick=function(){i(p)},a.appendChild(m)}),a.appendChild(l("Sonraki sayfa","\u203A",t+1,t>=r)),a}function Sn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Cn(e){var r=e.render;async function t(){var o=De(),l=Z,p=re,u=ie,m=oe;_e(null);var c=await Ue(Z,re,1,ie,oe);Ye(o,{productId:l,orderBy:p,ratingFilter:u,hasImages:m})&&await r(Z,L,c,Ie,re,1,Bt)}async function n(o){var l=De(),p=ie===o?null:o,u=Z,m=re,c=oe;Ot(p),Be(1),_e(null);var d=await Ue(Z,re,1,p,oe);Ye(l,{productId:u,orderBy:m,page:1,ratingFilter:p,hasImages:c})&&await r(Z,L,d,Ie,re,1)}async function a(o,l){var p=De(),u=Z,m=ie;Be(1),_e(null);var c=o,d=!1;l&&(d=!0,c="newest"),Ut(d),zr(c);var v=await Ue(Z,c,1,ie,d);Ye(p,{productId:u,orderBy:c,page:1,ratingFilter:m,hasImages:d})&&await r(Z,L,v,Ie,c,1)}async function i(o){var l=De(),p=Z,u=re,m=ie,c=oe;Be(o),_e(null);var d=await Ue(Z,re,o,ie,oe);if(Ye(l,{productId:p,orderBy:u,page:o,ratingFilter:m,hasImages:c})){await r(Z,L,d,Ie,re,o);var v=document.getElementById("renuvex-reviews"),x=v&&v.shadowRoot,s=x&&x.querySelector&&x.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(s){try{s.focus({preventScroll:!0})}catch(b){try{s.focus()}catch(w){}}Sn(x,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var f=document.getElementById("renuvex-reviews");if(f&&typeof f.scrollIntoView=="function"){var h=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;f.scrollIntoView({behavior:h?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:n,onSortChange:a,onPageChange:i}}function no(){return na()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function io(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=ta({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),aa(t,{surface:"reviews",productId:r||""}),t}async function It(e,r,t,n,a,i,o){if(Kt){Cr({productId:e,settings:r,reviewsData:t,productName:n,orderBy:a,page:i,badgeSettings:o});return}Sr(!0),Ht(e),Vt(r),o!==void 0&&Dt(o),Yt(n),a&&zr(a),i&&Be(i),t!=null&&(jt(t),_e(t&&t.data?t.data.nextCursor:null));var l=Cn({render:It});try{let Ae=function(D,ne){if(!(!D||!D.meta||!D.meta.sizeOverrides)){var me=D.meta.sizeOverrides[ne];me&&Object.keys(me).forEach(function(Q){v.style.setProperty(Q,me[Q])})}};var $=Ae,p=et(r.summaryLayout),u=!(p.meta&&p.meta.supports&&p.meta.supports.title===!1),m=r.showTitle!==!1,c=H(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),d=u&&m?c:"",v=document.documentElement;wn(v,r);var x=r.borderRadius!==void 0?r.borderRadius:8,s=Mt[r.size]||Mt.medium,f=_t[r.thumbnailSize]||_t.medium,h=f;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(h=Nt[r.thumbnailSize]||Nt.medium),v.style.setProperty("--renuvex-pr-title-size",s.titleSize+"px"),v.style.setProperty("--renuvex-pr-review-text-size",s.reviewTextSize+"px"),v.style.setProperty("--renuvex-pr-review-title-size",s.reviewTitleSize+"px"),v.style.setProperty("--renuvex-pr-author-size",s.authorSize+"px"),v.style.setProperty("--renuvex-pr-reply-name-size",s.replyNameSize+"px"),v.style.setProperty("--renuvex-pr-reply-text-size",s.replyTextSize+"px"),v.style.setProperty("--renuvex-pr-radius",x+"px"),v.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,x-4)+"px"),v.style.setProperty("--renuvex-pr-photo-title-size",s.photoTitleSize+"px"),v.style.setProperty("--renuvex-pr-avg-rating-size",s.avgRatingSize+"px"),v.style.setProperty("--renuvex-pr-review-count-size",s.reviewCountSize+"px"),v.style.setProperty("--renuvex-pr-compact-count-size",s.compactCountSize+"px"),v.style.setProperty("--renuvex-pr-recommend-size",s.recommendSize+"px"),v.style.setProperty("--renuvex-pr-btn-text-size",s.btnTextSize+"px"),v.style.setProperty("--renuvex-pr-bar-label-size",s.barLabelSize+"px"),v.style.setProperty("--renuvex-pr-minimal-avg-size",s.minimalAvgSize+"px"),v.style.setProperty("--renuvex-pr-hero-avg-size",s.heroAvgSize+"px"),v.style.setProperty("--renuvex-pr-minimal-count-size",s.minimalCountSize+"px"),v.style.setProperty("--renuvex-pr-hero-count-size",s.heroCountSize+"px"),v.style.setProperty("--renuvex-pr-bar-count-size",s.barCountSize+"px"),v.style.setProperty("--renuvex-pr-review-date-size",s.reviewDateSize+"px"),v.style.setProperty("--renuvex-pr-filter-text-size",s.filterTextSize+"px"),v.style.setProperty("--renuvex-pr-load-more-size",s.loadMoreSize+"px"),v.style.setProperty("--renuvex-pr-load-more-min-height",s.loadMoreMinHeight+"px"),v.style.setProperty("--renuvex-pr-load-more-pad-y",s.loadMorePadY+"px"),v.style.setProperty("--renuvex-pr-load-more-pad-x",s.loadMorePadX+"px"),v.style.setProperty("--renuvex-pr-load-more-mobile-min-height",s.loadMoreMobileMinHeight+"px"),v.style.setProperty("--renuvex-pr-pagination-button-size",s.paginationButtonSize+"px"),v.style.setProperty("--renuvex-pr-pagination-pad-x",s.paginationPadX+"px"),v.style.setProperty("--renuvex-pr-pagination-gap",s.paginationGap+"px"),v.style.setProperty("--renuvex-pr-pagination-margin-top",s.paginationMarginTop+"px"),v.style.setProperty("--renuvex-pr-pagination-gap-min",s.paginationGapMin+"px"),v.style.setProperty("--renuvex-pr-pagination-mobile-button-size",s.paginationMobileButtonSize+"px"),v.style.setProperty("--renuvex-pr-pagination-mobile-font-size",s.paginationMobileFontSize+"px"),v.style.setProperty("--renuvex-pr-pagination-mobile-gap",s.paginationMobileGap+"px"),v.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",s.paginationMobileMarginTop+"px"),v.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",s.paginationMobileGapMin+"px"),v.style.setProperty("--renuvex-pr-read-more-size",s.readMoreSize+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size",f+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size-mobile",h+"px");var b=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";v.style.setProperty("--renuvex-pr-review-star-color",b),v.style.setProperty("--renuvex-pr-star-size",s.reviewStarSize+"px"),v.style.setProperty("--renuvex-pr-avg-star-size",s.avgStarSize+"px"),Ae(et(r.summaryLayout),r.size),Ae(tt(r.reviewLayout),r.size);var w=lr(r),T=no();if(!T)return;var y=io(T,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==y&&y.appendChild(z);var k=pa(z),S=Ge+je+Or+dn()+mn();Ke(k,S);var C=da(k);if(r.enabled===!1){z.style.minHeight="auto",C.replaceChildren(fn(r.borderRadius!==void 0?r.borderRadius:8)),Sr(!1);var E=kr;Cr(null),E&&It(E.productId,E.settings,E.reviewsData,E.productName,E.orderBy,E.page,E.badgeSettings);return}try{var A=t||{},N=pt(A),I=N?[]:A.data&&A.data.reviews||[];Wt(I),C.replaceChildren();var P=document.createElement("section");if(P.id="renuvex-reviews-widget",P.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),P.className="renuvex-pr-reviews-widget",P.setAttribute("data-renuvex-surface","reviews"),e&&P.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(P.style.width="100%",P.style.maxWidth="100%",P.style.marginLeft="0",P.style.marginRight="0"),d){var g=document.createElement("div"),_=r.summaryLayout||"classic";g.className="renuvex-pr-title renuvex-pr-title-"+_,g.textContent=d,P.appendChild(g)}if(N){P.appendChild(hn(A.message,l.onRetry)),C.appendChild(P),Fe(k),nt(P,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return k.getElementById("renuvex-reviews-widget")});return}var R=A.data&&A.data.allCount||0,M=A.data&&A.data.ratingCounts||null,B=M||[0,0,0,0,0],K=A.data&&A.data.avgRating||"0.0";if(!M&&I.length>0){I.forEach(function(D){D.rating>=1&&D.rating<=5&&B[D.rating-1]++});var U=I.reduce(function(D,ne){return D+ne.rating},0);K=(U/I.length).toFixed(1)}if(R===0)P.classList.add("renuvex-pr-reviews-empty"),P.appendChild(xn({iconPair:w,writeButtonText:H(r.writeButtonText,"Yorum Yap"),emptyStateText:H(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:te}));else{var V=et(r.summaryLayout),Y=V.render({widget:P,productId:e,data:A,settings:r,iconPair:w,allCount:R,ratingCounts:B,avgRatingVal:K,currentRatingFilter:ie,currentOrderBy:re,currentHasImages:oe,onFilterChange:l.onFilterChange,onSortChange:l.onSortChange});P.appendChild(Y);var G=zn({settings:r,root:v,currentHasImages:oe,photoStripReviews:Ft,openReviewModal:ge,wireLightboxTrigger:ur});if(G&&P.appendChild(G),I.length===0)P.appendChild(gn());else{var X=tt(r.reviewLayout);I.forEach(function(D){P.appendChild(X.render(D,it))})}var j=r.paginationMode==="numbered"?"numbered":"loadMore";if(j==="numbered"){var J=A.data&&A.data.totalPages||1;J>1&&P.appendChild(kn({page:A.data&&A.data.page||or||1,totalPages:J,onPageChange:l.onPageChange}))}var F=j==="loadMore"&&A.data&&A.data.hasMore;if(F){let D=function(ne){W.textContent=ne,O.setAttribute("aria-label",ne)};var xr=D,O=document.createElement("button");O.className="renuvex-pr-load-more";var W=document.createElement("span");W.className="renuvex-pr-load-more-label",W.setAttribute("aria-hidden","true"),O.appendChild(W),D("Daha Fazla G\xF6ster"),O.onclick=async function(){O.disabled=!0,D("Y\xFCkleniyor...");var ne=De(),me=Z,Q=re,be=or,gr=ie,hr=oe,br=wr,yr=be+1,fe=await Ue(me,Q,yr,gr,hr,null,br);if(Ye(ne,{productId:me,orderBy:Q,page:be,ratingFilter:gr,hasImages:hr,nextCursor:br}))if(fe&&!pt(fe)&&fe.data&&Array.isArray(fe.data.reviews)){var ir=qt(fe.data.reviews);Gt(ir),Be(yr),_e(fe.data.nextCursor||null);var En=tt(L.reviewLayout);ir.forEach(function(Tn){P.insertBefore(En.render(Tn,it),O)}),fe.data.hasMore?(O.disabled=!1,D("Daha Fazla G\xF6ster")):O.remove()}else O.disabled=!1,D("Tekrar Dene")},P.appendChild(O)}}C.appendChild(P),Fe(k),nt(P,"reviews-widget",{productId:e||""},function(){return k.getElementById("renuvex-reviews-widget")})}catch(D){console.error("[renuvex-pr] render error:",D);var ae=document.createElement("p");ae.style.cssText="text-align:center;color:#dc2626;",ae.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",C&&C.replaceChildren(ae)}}finally{if(Sr(!1),kr){var q=kr;Cr(null),It(q.productId,q.settings,q.reviewsData,q.productName,q.orderBy,q.page,q.badgeSettings)}}}export{It as render};
