...
`);function An(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function xe(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function Pn(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function Mn(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",i=Pn()&&!a;if(n>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),i&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Nn(e){var r=document.body.style,t=document.documentElement.style;xe(t,"overflow",e.rootOverflow,e.rootOverflowPriority),xe(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),xe(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),xe(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),xe(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),xe(r,"position",e.bodyPosition,e.bodyPositionPriority),xe(r,"top",e.bodyTop,e.bodyTopPriority),xe(r,"left",e.bodyLeft,e.bodyLeftPriority),xe(r,"right",e.bodyRight,e.bodyRightPriority),xe(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var lr=0,Ke=null;function Ur(){return lr+=1,lr>1||(Ke=An(),Mn(Ke)),Ke}function Hr(){if(lr!==0&&(lr-=1,!(lr>0))){var e=Ke;Ke=null,e&&Nn(e)}}function Ln(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Vr(){var e=Ln();return!e||e===document.body||e===document.documentElement?null:e}function se(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function _n(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function dt(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(_n)}function Rn(e,r){var t=e,n=dt(e);!n.length&&r&&(t=r,n=dt(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;se(a)}function Dr(e,r,t){if(e.key==="Tab"){var n=dt(r);if(!n.length){e.preventDefault(),Rn(r);return}var a=n[0],i=n[n.length-1],o=ua(t);if(!r.contains(o)){e.preventDefault(),se(a);return}if(n.indexOf(o)===-1){e.preventDefault(),se(e.shiftKey?i:a);return}e.shiftKey&&o===a?(e.preventDefault(),se(i)):!e.shiftKey&&o===i&&(e.preventDefault(),se(a))}}var ba="renuvexPrOverlay";function Yr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[ba]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function In(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[ba]===e.id)}function jr(e){if(In(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Bn(e){var r=e||(typeof navigator!="undefined"?navigator:null),t=r&&(r.connection||r.webkitConnection||r.mozConnection);if(t&&t.saveData===!0)return!1;var n=t&&typeof t.effectiveType=="string"?t.effectiveType.toLowerCase():"";return n!=="slow-2g"&&n!=="2g"}function Fn(e){var r=Number(e&&e.width),t=Number(e&&e.height),n=Number(e&&(e.bitrate||e.bandwidth));return Number.isFinite(r)||Number.isFinite(t)?(Number.isFinite(t)?t:0)*1e5+(Number.isFinite(r)?r:0):Number.isFinite(n)?n:0}function On(e,r,t){if(!Array.isArray(e)||!e.length)return-1;var n=t||(typeof window!="undefined"?window:null),a=r&&typeof r.getBoundingClientRect=="function"?r.getBoundingClientRect():{width:0,height:0},i=Math.max(Number(a.width)||0,Number(r&&r.clientWidth)||0,360),o=Math.max(Number(a.height)||0,Number(r&&r.clientHeight)||0,360),p=Number(n&&n.devicePixelRatio),l=Number.isFinite(p)&&p>0?Math.min(p,2):1,u=Math.round(i*l*1.15),v=Math.round(o*l*1.15),c=-1,s=-1,m=0,b=Number.POSITIVE_INFINITY;return e.forEach(function(d,x){var g=Fn(d);g<b&&(b=g,m=x);var y=Number(d&&d.width),w=Number(d&&d.height),A=!Number.isFinite(y)||y<=u,h=!Number.isFinite(w)||w<=v;A&&h&&g>s&&(s=g,c=x)}),c>=0?c:m}function Un(e,r,t){if(Bn()){var n=e&&e.Events&&e.Events.MANIFEST_PARSED;if(!(!n||!r||typeof r.on!="function")){var a=function(){typeof r.off=="function"&&r.off(n,a);var i=On(r.levels,t);if(i>=0)try{r.startLevel=i}catch(o){}};r.on(n,a)}}}function ya(e,r){var t=!1,n=null;return e.controls=!0,e.autoplay=!1,e.preload="metadata",e.playsInline=!0,e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.poster=We(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"",e.canPlayType("application/vnd.apple.mpegurl")?e.src=r.url:import("./hls-64XD2IDA.js").then(function(a){if(!t){var i=a.default||a;if(!i||!i.isSupported||!i.isSupported()){e.dispatchEvent(new Event("error"));return}n=new i({enableWorker:!0,lowLatencyMode:!1,capLevelToPlayerSize:!0,backBufferLength:30}),Un(i,n,e),n.loadSource(r.url),n.attachMedia(e)}}).catch(function(){t||e.dispatchEvent(new Event("error"))}),function(){t=!0;try{e.pause()}catch(i){}if(n){try{n.destroy()}catch(i){}n=null}e.removeAttribute("src");try{e.load()}catch(i){}}}function Xe(e){return Se(e)}function vt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function wa(e,r,t,n,a,i){e&&e.shadowRoot&&vt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),Hr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Er(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&se(a)}function Hn(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=we(e.rating,L);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=ke(e.createdAt),n.appendChild(a),n.appendChild(i),t.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-modal-author",p.textContent=e.author||"",t.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-modal-body",l.textContent=(e.comment||"").trim(),l.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(l);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var v=document.createElement("div");v.className="renuvex-pr-modal-reply-label",v.textContent=O(L&&L.merchantReplyLabel,"Ma\u011Faza Sahibi");var c=document.createElement("div");return c.className="renuvex-pr-modal-reply-text",c.textContent=e.merchantReply||"",u.appendChild(v),u.appendChild(c),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function ka(e,r,t){var n=t||L,a=e.querySelector(".renuvex-pr-modal-scroll-content"),i=a.querySelector(".renuvex-pr-modal-stars");i.innerHTML=we(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=ke(r.createdAt);var o=a.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var p=a.querySelector(".renuvex-pr-modal-body");p.textContent=(r.comment||"").trim(),p.style.display=r.comment&&r.comment.trim()?"":"none";var l=a.querySelector(".renuvex-pr-modal-reply");l.querySelector(".renuvex-pr-modal-reply-label").textContent=O(n&&n.merchantReplyLabel,"Ma\u011Faza Sahibi"),l.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",l.style.display=r.merchantReply?"":"none",e.scrollTop=0}function ct(e,r,t,n,a,i,o,p,l){var u=Xe(e),v=Math.max(0,Math.min(t||0,u.length-1)),c=u[v],s=document.createElement("div");s.className="renuvex-pr-modal-left";var m=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(c&&c.type==="video"){var b=document.createElement("video");b.className="renuvex-pr-modal-main-video"+(m?" renuvex-pr-modal-video-enter":""),b.setAttribute("aria-label","Yorum videosu"),b.addEventListener("error",function(){if(!s.querySelector(".renuvex-pr-modal-img-error")){var M=document.createElement("div");M.className="renuvex-pr-modal-img-error",M.setAttribute("role","status"),M.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",s.insertBefore(M,b)}}),s.__renuvexMediaCleanup=ya(b,c),s.appendChild(b)}else{var d=document.createElement("img");if(d.className="renuvex-pr-modal-main-img"+(m?" "+m:""),d.src=lt(c?c.url:""),d.decoding="async",d.width=ot,d.height=Math.round(ot*4/3),d.alt="Yorum foto\u011Fraf\u0131",!m){d.classList.add("renuvex-pr-modal-img-loading");var x=function(){d.classList.remove("renuvex-pr-modal-img-loading")};d.complete&&d.naturalWidth>0?x():(d.addEventListener("load",x,{once:!0}),d.addEventListener("error",x,{once:!0}))}ra(d,function(M){if(M.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var R=document.createElement("div");R.className="renuvex-pr-modal-img-error",R.setAttribute("role","status"),R.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(R,M)}}),s.appendChild(d)}var g=document.createElement("button");g.className="renuvex-pr-modal-close-mobile";var y=$(ye);y&&g.appendChild(y),g.setAttribute("aria-label","Kapat"),g.onclick=function(M){M.stopPropagation(),i()},s.appendChild(g);var w=0;if(s.addEventListener("touchstart",function(M){w=M.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(M){var R=w-M.changedTouches[0].clientX;if(!(Math.abs(R)<50)){if(R>0){if(k)Ce(e,r,v+1,n,a,i,!0,"next",p,l);else if(C){var B=n[r+1];Ce(B,r+1,0,n,a,i,!1,"next",p,l)}}else if(h)Ce(e,r,v-1,n,a,i,!0,"prev",p,l);else if(z){var _=n[r-1],U=Xe(_);Ce(_,r-1,U.length-1,n,a,i,!1,"prev",p,l)}}},{passive:!0}),u.length>1){var A=document.createElement("div");A.className="renuvex-pr-modal-thumbs",u.forEach(function(M,R){var B=M.type==="video"?M.posterUrl:M.url,_=document.createElement("img"),U=_r(B,Lr);_.src=U.src,_.srcset=U.srcset,_.loading="lazy",_.decoding="async",_.width=Lr,_.height=Lr,_.className="renuvex-pr-modal-thumb"+(R===v?" renuvex-pr-modal-thumb-active":""),_.alt="K\xFC\xE7\xFCk resim "+(R+1),Rr(_),_.tabIndex=0,_.setAttribute("role","button"),_.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(R+1)+" se\xE7"),R===v&&_.setAttribute("aria-current","true"),(function(V){function q(){Ce(e,r,V,n,a,i,!0,null,p,l)}_.onclick=q,_.onkeydown=function(Y){(Y.key==="Enter"||Y.key===" ")&&(Y.preventDefault(),q())}})(R),A.appendChild(_)}),s.appendChild(A)}var h=v>0,k=v<u.length-1,z=r>0,C=r<n.length-1,T=h||z,E=k||C;if(T){var f=document.createElement("button");f.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var P=$(je);P&&f.appendChild(P),f.setAttribute("aria-label","\xD6nceki"),f.onclick=function(M){if(M.stopPropagation(),h)Ce(e,r,v-1,n,a,i,!0,"prev",p,l);else if(z){var R=n[r-1],B=Xe(R);Ce(R,r-1,B.length-1,n,a,i,!1,"prev",p,l)}},s.appendChild(f)}if(E){var N=document.createElement("button");N.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var S=$(Tr);S&&N.appendChild(S),N.setAttribute("aria-label","Sonraki"),N.onclick=function(M){if(M.stopPropagation(),k)Ce(e,r,v+1,n,a,i,!0,"next",p,l);else if(C){var R=n[r+1];Ce(R,r+1,0,n,a,i,!1,"next",p,l)}},s.appendChild(N)}return s}function za(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Xe(n);a[0]&&a[0].type==="image"&&(new Image().src=lt(a[0].url))}})}function st(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Vn(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){st(t),st(n),st(a)}i(),t&&se(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Ce(e,r,t,n,a,i,o,p,l,u){if(u&&(u.currentReview=e),o){var v=ct(e,r,t,n,a,i,p,l,u);a.firstChild&&(vt(a.firstChild),a.replaceChild(v,a.firstChild))}else{var v=ct(e,r,t,n,a,i,p,l,u),c=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&(vt(a.firstChild),a.replaceChild(v,a.firstChild)),c&&ka(c,e,u&&u.currentSettings),Vn(l,a)}za(r,n)}function ge(e,r,t){var n=Xe(e);if(!n.length)return;var a=(t||[]).filter(function(C){return Xe(C).length>0}),i=a.findIndex(function(C){return C===e||C.id===e.id});i===-1&&(a.unshift(e),i=0);var o=n.findIndex(function(C){return C.url===r});o<0&&(o=0);var p=document.createElement("div");p.className="renuvex-pr-modal-overlay";var l=document.createElement("div");l.className="renuvex-pr-modal";var u=!1,v=null,c=Vr(),s=Pe(),m=Ur(),b=Yr(),d={currentReview:e,currentSettings:L},x=null;function g(C){var T=C&&C.detail&&C.detail.settings;if(!(T&&T===x)){x=T||null,d.currentSettings=T||L;var E=l.querySelector(".renuvex-pr-modal-right");!E||!d.currentReview||ka(E,d.currentReview,d.currentSettings)}}function y(){u||(u=!0,window.removeEventListener(Fe,g),wa(v&&v.host,w,y,m,c,s))}function w(C){if(C.key==="Escape"){A();return}Dr(C,p,v&&v.root)}function A(){u||(u=!0,window.removeEventListener(Fe,g),wa(v&&v.host,w,y,m,c,s),jr(b))}document.addEventListener("keydown",w),window.addEventListener("popstate",y),window.addEventListener(Fe,g),p.onclick=function(){A()},l.onclick=function(C){C.stopPropagation()},l.appendChild(ct(e,i,o,a,l,A,null,p,d)),l.appendChild(Hn(e)),za(i,a);var h=document.createElement("div");h.className="renuvex-pr-modal-wrap",h.tabIndex=-1,h.setAttribute("role","dialog"),h.setAttribute("aria-modal","true"),h.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),h.appendChild(l);var k=document.createElement("button");k.className="renuvex-pr-modal-close";var z=$(ye);z&&k.appendChild(z),k.setAttribute("aria-label","Kapat"),k.onclick=function(C){C.stopPropagation(),A()},h.appendChild(k),p.appendChild(h),v=Fr(),Ge(v.root,qe+Ye+Or),v.root.appendChild(p),Be(v.root),se(h)}function pr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(n){(n.key==="Enter"||n.key===" "||n.key==="Spacebar")&&(n.preventDefault(),r())})}var wt={};Ae(wt,{css:()=>wi,meta:()=>yi,render:()=>ki});function Je(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,i=e.onFilterChange;Ne(n);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var p=5;p>=1;p--){var l=r[p-1]||0,u=t>0?Math.round(l/t*100):0,v=a===p,c=l>0,s=O(L&&L.countLabel,"Yorum"),m=document.createElement("div");m.className="renuvex-pr-bar-row"+(c?"":" renuvex-pr-bar-empty")+(v?" renuvex-pr-bar-active":"")+(a&&!v?" renuvex-pr-bar-dimmed":""),c?(m.setAttribute("role","button"),m.setAttribute("tabindex","0"),m.setAttribute("aria-pressed",v?"true":"false"),m.setAttribute("aria-label",p+" y\u0131ld\u0131z, "+l.toLocaleString("tr-TR")+" "+s+", "+(v?"filtreyi kald\u0131r":"filtrele"))):m.setAttribute("aria-label",p+" y\u0131ld\u0131z, 0 "+s);for(var b="",d=1;d<=5;d++){var x=d<=p;b+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(x?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(x?"full":"outline")+"</span>"}m.innerHTML='<span class="renuvex-pr-bar-label">'+b+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+l.toLocaleString("tr-TR")+")</span>",c&&(function(g){function y(){i(g)}m.onclick=y,m.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Space"||w.key==="Spacebar")&&(w.preventDefault(),y())}})(p),o.appendChild(m)}return o}var Ea="data-renuvex-pr-dismiss-gesture",Ue=[],Sa=!1,Wr=!1,ur=[],Ze=null;function Ca(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function mt(){for(var e=Ue.length-1;e>=0;e--){var r=Ue[e].element;r&&r.isConnected===!1&&Ue.splice(e,1)}return Ue}function Dn(e){!e||typeof e.setAttribute!="function"||(ur.indexOf(e)===-1&&ur.push(e),e.setAttribute(Ea,""))}function Ta(){for(var e=0;e<ur.length;e++){var r=ur[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Ea)}ur=[],Ze&&typeof clearTimeout=="function"&&clearTimeout(Ze),Ze=null}function Yn(e){if(Wr){Wr=!1,Ta(),e.preventDefault(),e.stopPropagation();return}for(var r=mt(),t=!1,n=r.length-1;n>=0;n--){var a=r[n];Ca(e,a.trigger)||Ca(e,a.element)||a.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function jn(e){if(e.key==="Escape")for(var r=mt(),t=r.length-1;t>=0;t--)r[t].close()}function Aa(){Sa||typeof document=="undefined"||(document.addEventListener("click",Yn,!0),document.addEventListener("keydown",jn),Sa=!0)}function Wn(e){Aa(),Wr=!0,Dn(e),Ze&&typeof clearTimeout=="function"&&clearTimeout(Ze),typeof setTimeout=="function"&&(Ze=setTimeout(function(){Wr=!1,Ta()},700))}function ft(e){Wn(e)}function qr(e){Aa();var r={trigger:e.trigger,element:e.element,close:e.close};return Ue.push(r),{unregister:function(){var t=Ue.indexOf(r);t!==-1&&Ue.splice(t,1)},notifyOpening:function(){for(var t=mt(),n=0;n<t.length;n++)t[n]!==r&&t[n].close()}}}function oe(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var p=document.createElement("button");p.className="renuvex-pr-write-btn",p.textContent=O(L&&L.writeButtonText,"Yorum Yap"),p.onclick=a,o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var v=L&&L.filterIcon||"lines";u.innerHTML=de(Xt(v));var c=document.createElement("div");c.className="renuvex-pr-filter-menu",c.setAttribute("role","menu");var s=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],m=!1;function b(){return r&&r.parentNode||r||null}function d(w,A){if(!(A===!0||!w)){if(w.type==="touchstart"){ft(b());return}if(w.type==="pointerdown"){var h=w.pointerType||"";h&&h!=="mouse"&&ft(b());return}}}function x(w){var A=c.classList.contains("renuvex-pr-open");c.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var h=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(A&&h)try{u.focus({preventScroll:!0})}catch(k){try{u.focus()}catch(z){}}return A}function g(){y.notifyOpening(),c.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var w=c.querySelector(".renuvex-pr-filter-item-active")||c.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(A){try{w.focus()}catch(h){}}})}s.forEach(function(w){var A=w[2],h=A?n:!n&&(t||"newest")===w[0],k=document.createElement("button");k.type="button",k.className="renuvex-pr-filter-item"+(h?" renuvex-pr-filter-item-active":""),k.setAttribute("role","menuitem"),k.textContent=w[1];var z=!1;function C(T,E){T&&(T.preventDefault(),T.stopPropagation()),!z&&(z=!0,m=!0,d(T,E),x({restoreFocus:E}),i(w[0],A),setTimeout(function(){z=!1,m=!1},0))}k.addEventListener("pointerdown",function(T){T.button!==void 0&&T.button!==0||T.pointerType!=="mouse"&&C(T,!1)}),typeof window!="undefined"&&!window.PointerEvent&&k.addEventListener("touchstart",function(T){C(T,!1)},{passive:!1}),k.addEventListener("keydown",function(T){(T.key==="Enter"||T.key===" ")&&C(T,!0)}),k.onclick=function(T){C(T,!1)},c.appendChild(k)}),u.onclick=function(){c.classList.contains("renuvex-pr-open")?x({restoreFocus:"auto"}):g()},l.addEventListener("keydown",function(w){w.key==="Escape"&&c.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),x({restoreFocus:!0}))}),l.addEventListener("focusout",function(w){if(c.classList.contains("renuvex-pr-open")&&!m){var A=w.relatedTarget;A&&l.contains(A)||x()}});var y=qr({trigger:l,element:c,close:x});return l.appendChild(u),l.appendChild(c),o.appendChild(l),o}var Pa=`
...
`;function Ma(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,n=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,a=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",o.appendChild(p);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var u=$(ye);u&&l.appendChild(u),o.appendChild(l);var v=!1,c=null,s=null,m=!1;function b(){se(i)}function d(z){Dr(z,i,c&&c.root)}function x(){if(!v){if(v=!0,document.removeEventListener("keydown",g),i.removeEventListener("click",y),l.removeEventListener("click",x),m)se(s);else{var z=c&&c.root?c.root.activeElement:null;if(z&&typeof z.blur=="function")try{z.blur()}catch(C){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){c?(Er(c.root),c.host&&c.host.parentNode&&c.host.parentNode.removeChild(c.host)):i.parentNode&&i.parentNode.removeChild(i),Hr();try{r()}catch(C){}},200)}}function g(z){if(z.key==="Escape"){x();return}d(z)}function y(z){z.target===i&&a&&x()}document.addEventListener("keydown",g),i.addEventListener("click",y),l.addEventListener("click",x);function w(z){s=t||Vr(),m=n===null?Pe():n,z&&p.appendChild(z),c=Fr(),Ge(c.root,qe+Ye+Pa),c.root.appendChild(i),Be(c.root),Ur(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),b()})}var A=null,h=null;function k(z,C){if(C=C||"error",A){try{A.remove()}catch(T){}A=null}h&&(clearTimeout(h),h=null),A=document.createElement("div"),A.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+C,A.textContent=z,o.appendChild(A),h=setTimeout(function(){A&&(A.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(A){try{A.remove()}catch(T){}A=null}},300))},4e3)}return{open:w,close:x,content:p,setAllowOutsideClose:function(z){a=!!z},setStepAttr:function(z){o.setAttribute("data-step",String(z))},showToast:k}}var xt=4;function $e(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Na(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(i){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<xt&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(i){return i!==a})}}}}function La(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",p.setAttribute("aria-label","Geri"),p.innerHTML=de(je)+"<span>Geri</span>",p.addEventListener("click",function(){n()}),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-footer-progress";for(var u=[],v=0;v<xt;v++){var c=document.createElement("span");c.className="renuvex-pr-fwizard-progress-seg",l.appendChild(c),u.push(c)}o.appendChild(l);var s=document.createElement("button");s.type="button";var m=null;function b(x){m&&s.removeEventListener("click",m),m=x,x&&s.addEventListener("click",x)}o.appendChild(s);function d(x,g){var y=r.indexOf(x)!==-1,w=t.indexOf(x)!==-1,A=g&&(g.images&&g.images.length>0||g.pendingImages&&g.pendingImages.length>0||!!g.videoUpload);if(y)x===2&&A?(s.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",s.setAttribute("aria-label","Devam Et"),s.innerHTML="Devam Et",b(function(){i()})):(s.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",s.setAttribute("aria-label","Atla"),s.innerHTML="<span>Atla</span>",b(function(){a()})),s.disabled=!1,s.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),s.style.visibility="",s.tabIndex=0;else if(w){s.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",s.setAttribute("aria-label","Sonraki"),s.innerHTML="Sonraki",s.style.visibility="",s.tabIndex=0;var h=$e(x,g);s.disabled=!h,s.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!h),b(function(){s.disabled||i()})}else s.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",s.innerHTML="",s.style.visibility="hidden",s.tabIndex=-1,s.disabled=!0,b(null)}return{el:o,update:function(x,g){u.forEach(function(w,A){A+1<=x?w.classList.add("renuvex-pr-fwizard-progress-seg-active"):w.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var y=x<=1;p.style.visibility=y?"hidden":"",p.style.pointerEvents=y?"none":"",p.tabIndex=y?-1:0,d(x,g)},setNextDisabled:function(x){s.classList.contains("renuvex-pr-fwizard-cta-btn")&&(s.disabled=!!x,s.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!x))},setThanksState:function(x){p.style.visibility="hidden",l.style.visibility="hidden",s.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",s.setAttribute("aria-label","Devam Et"),s.innerHTML="Devam Et",s.style.visibility="",s.disabled=!1,s.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),b(x)}}}var qn={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ve(e){var r=L&&L[e];return!r&&e==="formStepMediaTitle"&&(r=L&&L.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=L&&L.formStepPhotosSubtitle),O(r,qn[e])}function _a(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ve("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var p=or(L||{});Ne(p);var l=[];function u(x){l.forEach(function(g,y){var w=y<x;g.classList.toggle("renuvex-pr-fwizard-star-active",w),g.setAttribute("aria-checked",y+1===x?"true":"false"),g.innerHTML=w?ue("full"):ue("outline")})}function v(x){e.set({rating:x}),u(x)}function c(x){var g=l[x-1];if(g)try{g.focus()}catch(y){}}function s(x,g){g&&typeof g.preventDefault=="function"&&g.preventDefault(),g&&typeof g.stopPropagation=="function"&&g.stopPropagation(),!n&&(n=!0,v(x),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var m=1;m<=5;m++)(function(x){var g=document.createElement("button");g.type="button",g.className="renuvex-pr-fwizard-star",g.setAttribute("role","radio"),g.setAttribute("aria-label",x+" y\u0131ld\u0131z"),g.innerHTML=ue("outline"),g.addEventListener("mouseenter",function(){u(x)}),g.addEventListener("mouseleave",function(){u(e.get().rating)}),g.addEventListener("pointerdown",function(y){y.button&&y.button!==0||s(x,y)}),typeof window!="undefined"&&!window.PointerEvent&&g.addEventListener("touchstart",function(y){s(x,y)},{passive:!1}),g.addEventListener("mousedown",function(y){window.PointerEvent||s(x,y)}),g.addEventListener("keydown",function(y){if(y.key==="Enter"||y.key===" "){s(x,y);return}var w=0;y.key==="ArrowRight"||y.key==="ArrowUp"?w=Math.min(5,x+1):y.key==="ArrowLeft"||y.key==="ArrowDown"?w=Math.max(1,x-1):y.key==="Home"?w=1:y.key==="End"&&(w=5),w&&(y.preventDefault(),v(w),c(w))}),g.addEventListener("click",function(y){s(x,y)}),l.push(g),o.appendChild(g)})(m);u(e.get().rating);var b=null,d=function(x){var g=x&&x.detail&&x.detail.settings;g&&g===b||(b=g||null,p=or(g||L||{}),u(e.get().rating))};return window.addEventListener(Fe,d),t.appendChild(o),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Fe,d)}}}var Gr=3,Gn=10*1024*1024;function Kr(e,r){r=r||{};var t=!1,n=r.hideAddButton===!0,a=r.revealAddButtonAfterMedia===!0,i=!n||a,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=ve("formStepPhotosTitle"),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=ve("formStepPhotosSubtitle"),o.appendChild(l)}var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&u.classList.add("renuvex-pr-fwizard-photo-card--embedded");var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-photo-add",v.setAttribute("aria-label","Foto\u011Fraf ekle");var c=document.createElement("input");c.type="file",c.accept="image/*",c.multiple=!0,c.style.display="none",i&&u.appendChild(v),u.appendChild(c);var s=document.createElement("div");s.className="renuvex-pr-fwizard-photo-previews",s.setAttribute("aria-live","polite"),u.appendChild(s),o.appendChild(u);var m=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},b=r.blobMap||{},d=r.urlToFinger||{};function x(){if(!t){var h=e.get().images||[],k=e.get().pendingImages||[],z=h.map(function(C){return{url:C,isPending:!1}}).concat(k.map(function(C){return{url:C.url,file:C.file,isPending:!0,error:C.error}}));s.innerHTML="",z.forEach(function(C){var T=b[C.url]||C.url,E=g(C,T);s.appendChild(E)}),w()}}function g(h,k){var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-thumb";var C=document.createElement("img");C.src=k,C.alt="",C.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",z.appendChild(C);var T=document.createElement("div");T.className="renuvex-pr-fwizard-photo-loading",T.style.display="none",z.appendChild(T);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var f=$(ye);return f&&E.appendChild(f),z.appendChild(E),y(z,h,k),z}function y(h,k,z){var C=h.querySelector("img");C.src!==z&&(C.src=z);var T=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(k.isPending&&k.error){T.style.display="flex",T.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+k.error,T.appendChild(E)}else T.style.display="none",T.textContent="";var f=h.querySelector(".renuvex-pr-fwizard-photo-remove");f.onclick=function(){var P=d[k.url]||(k.file?k.file.name+"_"+k.file.size:null),N=b[k.url],S={};P&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(M){return M!==P})),k.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(M){return M.url!==k.url}):S.images=(e.get().images||[]).filter(function(M){return M!==k.url}),e.set(S),m(k.url),m(N),delete d[k.url],N&&delete d[N],b[k.url]&&delete b[k.url]}}function w(){var h=(e.get().images||[]).length,k=(e.get().pendingImages||[]).length,z=h+k,C=z>=Gr;u.classList.toggle("renuvex-pr-fwizard-photo-card--compact",z>0),i&&(v.innerHTML=z>0?de(Zt):de(Ar)+"<span>Foto\u011Fraf Ekle</span>"),C?(i&&(v.style.display="none"),v.disabled=!0,c.disabled=!0):(i&&(v.style.display=a&&z===0?"none":"flex"),v.disabled=!1,c.disabled=!1,v.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}v.addEventListener("click",function(){c.disabled||c.click()}),c.onchange=async function(h){var k=(e.get().images||[]).length+(e.get().pendingImages||[]).length,z=Array.from(h.target.files).slice(0,Gr-k);c.value="";var C=(e.get().pendingImages||[]).length,T=e.get().images||[],E=T.length;if(z.length!==0){for(var f=[],P=[],N=0;N<z.length;N++){var S=z[N],M=S.name+"_"+S.size,R=(e.get().fingerprints||[]).some(function(D){return D===M})||f.some(function(D){return D.file.name+"_"+D.file.size===M});if(!R){if(S.size>Gn){var B="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(B,"error"):alert(B);continue}var _=URL.createObjectURL(S);d[_]=M,f.push({url:_,file:S,error:null}),P.push({url:_,file:S});var U=(e.get().fingerprints||[]).slice();U.push(M),e.set({fingerprints:U})}}if(f.length!==0){var V=(e.get().pendingImages||[]).concat(f),q=async function(){for(var D=0;D<P.length;D++){var K=P[D],re=K.file,X=K.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var W=(e.get().pendingImages||[]).filter(function(Z){return Z.url!==X}),F=(e.get().images||[]).slice();F.push(X),e.set({pendingImages:W,images:F});continue}try{var j=await ze(be+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe})});if(!j.ok)throw j.status===429?new Error("rate_limit"):new Error("sign failed");var I=await j.json();if(!I.folder)throw new Error("sign folder missing");var le=new FormData;le.append("file",re),le.append("api_key",I.api_key),le.append("timestamp",I.timestamp),le.append("signature",I.signature),le.append("folder",I.folder);var ce=await fetch("https://api.cloudinary.com/v1_1/"+I.cloud_name+"/image/upload",{method:"POST",body:le}),J=await ce.json();if(J.secure_url&&Mr(J.secure_url)){var xr=(e.get().pendingImages||[]).some(function(Z){return Z.url===X});if(!xr)continue;b[J.secure_url]=X,d[J.secure_url]=d[X];var Te=(e.get().pendingImages||[]).filter(function(Z){return Z.url!==X}),H=(e.get().images||[]).slice();H.push(J.secure_url),e.set({pendingImages:Te,images:H});try{ze(be+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,secureUrl:J.secure_url,metadata:{assetId:J.asset_id,publicId:J.public_id,version:J.version,resourceType:J.resource_type,format:J.format,width:J.width,height:J.height,bytes:J.bytes,signature:J.signature}})}).catch(function(){})}catch(Z){}}else throw new Error("invalid image url")}catch(Z){console.error("[renuvex-pr] Image upload failed:",Z);var te=Z.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(te,"error");var me=(e.get().pendingImages||[]).map(function(he){return he.url===X?{url:he.url,file:he.file,error:te}:he});e.set({pendingImages:me})}}};if(E===0&&C===0){t=!0;var Y=!r.canNavigate||r.canNavigate();Y&&e.goNext()}e.set({pendingImages:V}),q()}}};var A=e.onChange(x);return x(),{el:o,openPicker:function(){c.disabled||c.click()},destroy:function(){t=!0,c.onchange=null,A&&A()}}}var Kn=150*1024*1024,Xn=2,Jn=60,Oa=8192,Ua=5,Zn=["video/mp4","video/quicktime"],$n="renuvex_pr_video_upload_",Ha="renuvex_pr_video_cancel_",dr=null,Ra=!1,Qn={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},ei={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},er=class extends Error{constructor(r,t,n){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=n||null}};function Va(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:Qn[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:ei[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function Da(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function gt(e){return new Promise(function(r){setTimeout(r,e)})}function Qe(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function vr(e){return Math.max(0,Math.round(Qe()-e))}function ri(e,r){return new Promise(function(t,n){var a=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(a),r&&r.removeEventListener("abort",o),n(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function ht(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function bt(e,r){return $n+pe+"_"+e+"_"+ht(r)}function Ya(e,r){try{var t=window.sessionStorage.getItem(bt(e,r)),n=t?JSON.parse(t):null;return!n||typeof n.token!="string"||!n.expiresAt||new Date(n.expiresAt).getTime()<=Date.now()?null:n}catch(a){return null}}function ti(e,r,t){try{window.sessionStorage.setItem(bt(e,r),JSON.stringify(t))}catch(n){}}function cr(e,r){try{window.sessionStorage.removeItem(bt(e,r))}catch(t){}}function ai(e,r){return Ha+pe+"_"+e+"_"+ht(r)}function ni(e,r,t,n){if(!(!e||!r||!t)){var a={token:e,productId:r,expiresAt:n||null};try{window.sessionStorage.setItem(ai(r,t),JSON.stringify(a))}catch(i){}}}function ii(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(Ha+pe+"_")!==0)){var n=window.sessionStorage.getItem(t),a=n?JSON.parse(n):null;if(!a||typeof a.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:a.token})}}}catch(i){}return e}function Ia(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function rr(e,r,t){var n=await ze(be+e,r,t||2e4),a=await n.json().catch(function(){return{}});if(!n.ok){var i=Number(n.headers.get("Retry-After"));throw new er(a.error||"video_request_failed",n.status,Number.isFinite(i)&&i>0?i:null)}return a.data||{}}async function sr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await rr("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:vr(r.startedAt),finalStatus:t})},4e3)}catch(n){}}async function oi(e){try{return await rr("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Ia(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Ia(e.key),!0):!1}}function Xr(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():dr||(dr=(async function(){for(var e=ii(),r=0;r<e.length;r+=1)await oi(e[r])})().finally(function(){dr=null}),dr)}function Jr(){typeof window=="undefined"||Ra||(Ra=!0,window.addEventListener("online",function(){Xr()}),Xr())}async function li(){var e=await import("./upchunk-QJXCGVJW.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function Ba(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}async function pi(e){var r=await li();return new Promise(function(t,n){var a=!1,i=null;function o(l){a||(a=!0,e.signal&&e.signal.removeEventListener("abort",p),l?n(l):t())}function p(){try{i&&i.abort()}catch(l){}o(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return n(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",p,{once:!0})}i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||Oa,attempts:e.chunkAttempts||Ua,dynamicChunkSize:!0}),i.on("attempt",function(){e.onStatus("uploading")}),i.on("attemptFailure",function(l){var u=l&&l.detail;e.onAttemptFailure&&e.onAttemptFailure(Ba(u)),e.onStatus("upload_retrying")}),i.on("progress",function(l){var u=Number(l&&l.detail);if(Number.isFinite(u)){var v=Math.min(95,Math.max(0,Math.round(u*.95)));Number.isFinite(e.minProgress)&&(v=Math.max(e.minProgress,v)),e.onProgress(v)}}),i.on("offline",function(){e.onStatus("uploading_offline")}),i.on("online",function(){e.onStatus("uploading")}),i.on("error",function(l){var u=l&&l.detail,v=u&&typeof u.message=="string"?u.message:"video_upload_failed";e.onUploadError&&e.onUploadError(Ba(u)),o(new Error(v))}),i.on("success",function(){e.onProgress(95),o()})})}function ui(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function Fa(e,r,t){for(var n=Date.now(),a=n+600*1e3,i=0;Date.now()<a;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-n;try{var p=await rr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":p.status||"processing"),p.status==="ready")return p;if(p.status==="failed"||p.status==="aborted")throw new er(p.errorCode||"video_processing_failed",409,null)}catch(l){if(r.aborted||l instanceof er&&l.status===409||Da(l)||(i+=1,i>=3))throw l}await ri(ui(o),r)}throw new er("video_processing_delayed",0,null)}async function di(e){for(var r=null,t=1;t<=3;t+=1)try{return await rr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(n){if(Da(n))return null;r=n,t<3&&await gt(400*t)}throw r||new Error("video_status_failed")}async function si(e,r,t,n){for(var a=10;a<=90;a+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(a),await gt(120)}return n("processing"),await gt(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function ja(e){return!e||Zn.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>Kn?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function Wa(e){return new Promise(function(r){var t=URL.createObjectURL(e),n=document.createElement("video"),a=!1;function i(o){if(!a){a=!0,n.removeAttribute("src");try{n.load()}catch(p){}URL.revokeObjectURL(t),r(o)}}n.preload="metadata",n.onloadedmetadata=function(){i(Number.isFinite(n.duration)?n.duration:null)},n.onerror=function(){i(null)},n.src=t,setTimeout(function(){i(null)},8e3)})}function qa(e){return e===null?{ok:!0}:e<Xn||e>Jn?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function Ga(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return si(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:Qe(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(d){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=d||"upload_attempt_failed")}function n(){cr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}Jr(),await Xr();var a=Ya(e.productId,e.file),i=a&&a.token,o=a;if(i){var p=await di(i);if(!p)n(),i=null,o=null;else{if(p.status==="ready")return e.onToken&&e.onToken(i),e.onProgress(100),cr(e.productId,e.file),await sr(i,r,"ready"),Object.assign({token:i},p);if(p.status==="uploaded"||p.status==="processing"){e.onToken&&e.onToken(i),e.onStatus("processing");var l=Qe(),u=await Fa(i,e.signal,e.onStatus);return r.processingPollMs=vr(l),cr(e.productId,e.file),e.onProgress(100),await sr(i,r,"ready"),Object.assign({token:i},u)}else(p.status==="failed"||p.status==="aborted")&&(n(),i=null,o=null)}i&&(!o||typeof o.uploadUrl!="string"||!o.uploadUrl)&&(n(),i=null,o=null)}if(!i){var v=await rr("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:ht(e.file)})});i=v.token,o=v,ti(e.productId,e.file,v)}e.onToken&&e.onToken(i),r.chunkSizeKb=o.chunkSize||Oa,r.chunkAttempts=o.chunkAttempts||Ua,e.onStatus("uploading");try{var c=Qe();await pi({uploadUrl:o.uploadUrl,file:e.file,chunkSize:o.chunkSize,chunkAttempts:o.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=vr(c),e.onStatus("processing");var s=Qe();await rr("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:i})},3e4),r.completeMs=vr(s);var m=Qe(),b=await Fa(i,e.signal,e.onStatus);return r.processingPollMs=vr(m),cr(e.productId,e.file),e.onProgress(100),await sr(i,r,"ready"),Object.assign({token:i},b)}catch(d){throw e.signal&&e.signal.aborted?(await sr(i,r,"aborted"),d):(await sr(i,r,"failed"),d)}}async function Zr(e,r,t){var n=r&&t?Ya(r,t):null;e&&r&&t&&ni(e,r,t,n&&n.expiresAt),r&&t&&cr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(Jr(),await Xr())}function Ka(){return"Video y\xFCklenemedi"}function Xa(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function vi(e){return e&&e.status==="uploading_offline"?"\u0130nternet ba\u011Flant\u0131s\u0131 yok":"Video y\xFCkleniyor"}function ci(e){return!(e&&e.status==="uploading_offline")}function Ja(e,r){r=r||{};var t=!1,n=null,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent=ve("formStepMediaTitle"),i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-subtitle",p.textContent=ve("formStepMediaSubtitle"),i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-media-card";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",u.setAttribute("aria-label","Foto\u011Fraf ekle"),u.innerHTML=de(Ar)+"<span>Foto\u011Fraf Ekle</span>";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",v.setAttribute("aria-label","Video ekle"),v.innerHTML=de(Pr)+"<span>Video Ekle</span>",l.appendChild(u),l.appendChild(v);var c=document.createElement("div");c.className="renuvex-pr-fwizard-media-content",l.appendChild(c),i.appendChild(l);var s=document.createElement("input");s.type="file",s.accept="video/mp4,video/quicktime,.mp4,.mov",s.style.display="none",i.appendChild(s);function m(){var f=e.get();return(f.images||[]).length>0||(f.pendingImages||[]).length>0}function b(){var f=e.get();return(f.images||[]).length+(f.pendingImages||[]).length}function d(){return e.get().videoUpload||null}function x(){if(!a){c.innerHTML="";return}a.retry.onclick=null,c.innerHTML="",a=null}function g(){n&&(n.destroy&&n.destroy(),n=null)}function y(f){g(),c.innerHTML="";var P=Xa(f),N=document.createElement("div");N.className=P==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":P==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var S=null,M=null,R=null,B=null,_=document.createElement("button");if(_.type="button",_.className="renuvex-pr-fwizard-video-retry",_.textContent="Tekrar dene",P==="ready"){var U=f.posterUrl||f.localUrl||"";U&&U!==f.localUrl?(S=document.createElement("img"),S.alt="",S.src=U):(S=document.createElement("video"),S.muted=!0,S.playsInline=!0,S.preload="metadata",S.src=f.localUrl||""),S.className="renuvex-pr-fwizard-video-preview",N.appendChild(S)}else P==="busy"?(B=document.createElement("div"),B.className="renuvex-pr-fwizard-video-uploading-status",B.setAttribute("role","status"),B.setAttribute("aria-live","polite"),N.appendChild(B)):(M=document.createElement("div"),M.className="renuvex-pr-fwizard-video-details renuvex-pr-fwizard-video-details--failed",B=document.createElement("div"),B.className="renuvex-pr-fwizard-video-status renuvex-pr-fwizard-video-status--error",B.setAttribute("role","alert"),B.setAttribute("aria-live","assertive"),M.appendChild(B),N.appendChild(M));if(P==="ready"){let D=function(K){K&&(K.preventDefault(),K.stopPropagation()),z()};var Y=D,V=document.createElement("button");V.type="button",V.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",V.setAttribute("aria-label","Videoyu kald\u0131r");var q=$(ye);q&&V.appendChild(q),V.addEventListener("pointerdown",D),V.addEventListener("click",D),N.appendChild(V)}c.appendChild(N),a={mode:P,card:N,preview:S,previewUrl:P==="ready"&&(f.posterUrl||f.localUrl)||"",details:M,name:R,status:B,retry:_}}function w(){if(!t){var f=d();if(!f){x();return}var P=Xa(f),N=P==="ready"&&(f.posterUrl||f.localUrl)||"";if((!a||a.mode!==P||a.previewUrl!==N)&&y(f),a.name&&(a.name.textContent=f.file?f.file.name:"Video"),a.status&&P==="busy"){var S=vi(f),M=ci(f)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+S+"</span>":"<span>"+S+"</span>";a.status.innerHTML!==M&&(a.status.innerHTML=M)}a.status&&P==="failed"&&(a.status.className="renuvex-pr-fwizard-video-status renuvex-pr-fwizard-video-status--error",a.status.setAttribute("role","alert"),a.status.textContent=Ka(f));var R=P==="failed"&&!!(f.error&&f.file&&f.retryable!==!1);a.retry.onclick=R?function(){k(f.file,f.localUrl,f.durationMs)}:null,R&&a.details&&!a.retry.isConnected?a.details.appendChild(a.retry):!R&&a.retry.isConnected&&a.retry.remove()}}function A(){var f=m(),P=b()>=Gr,N=!!d(),S=f||N;u.disabled=N||P,v.disabled=f||N,l.classList.toggle("renuvex-pr-fwizard-media-card--has-media",S),l.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",f),l.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",N),u.classList.toggle("renuvex-pr-fwizard-media-action--active",f),v.classList.toggle("renuvex-pr-fwizard-media-action--active",N)}function h(f){var P=d();if(P){var N=Object.keys(f),S=N.some(function(M){return P[M]!==f[M]});S&&e.set({videoUpload:Object.assign({},P,f)})}}async function k(f,P,N){var S=d(),M=!!(P&&S&&S.file===f),R=M?Math.max(0,Math.min(95,Number(S.progress)||0)):0,B=M?(Number(S.retryClicks)||0)+1:0,_=ja(f);if(!_.ok){r.showToast&&r.showToast(_.message,"error");return}var U=P||URL.createObjectURL(f),V=new AbortController;e.set({videoUpload:{file:f,localUrl:U,token:M&&S.token||null,status:"uploading",progress:R,durationMs:re===null?null:Math.round(re*1e3),error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:B,controller:V}});var q=null;if(typeof window!="undefined"&&typeof window.addEventListener=="function"){var Y=function(){var I=d();return!!(I&&I.controller===V)},D=function(){Y()&&h({status:"uploading_offline"})},K=function(){var I=d();Y()&&I&&I.status==="uploading_offline"&&h({status:"uploading"})};window.addEventListener("offline",D),window.addEventListener("online",K),q=function(){window.removeEventListener("offline",D),window.removeEventListener("online",K)},typeof navigator!="undefined"&&navigator.onLine===!1&&D()}!M&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var re=N!==void 0?Number.isFinite(N)?N/1e3:null:await Wa(f),X=qa(re);if(!X.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:X.message});var W=await Ga({file:f,productId:e.get().productId,signal:V.signal,minProgress:R,retryClicks:B,onToken:function(I){h({token:I})},onProgress:function(I){h({progress:I})},onStatus:function(I){h({status:I})},onSessionReset:function(){h({token:null,progress:0})}});if(W.previewOnly&&W.posterUrl&&W.posterUrl!==U)try{URL.revokeObjectURL(W.posterUrl)}catch(I){}h({token:W.token,status:"ready",progress:100,posterUrl:W.previewOnly?U:W.posterUrl,durationMs:W.durationMs||(re===null?null:Math.round(re*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),M&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(I){if(V.signal.aborted)return;var F=Va(I);if(I&&I.code==="invalid_video_duration"&&(F={code:"invalid_video_duration",message:I.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),h({status:"failed",error:F.message,errorCode:F.code,retryable:F.retryable,retryAfterSec:F.retryAfterSec,controller:null}),r.showToast){var j=F.code==="invalid_video_duration"?F.message:Ka();r.showToast(j,"error")}}finally{q&&q()}}function z(){var f=d();f&&(f.controller&&f.controller.abort(),Zr(f.token,e.get().productId,f.file),r.revokeBlobUrl&&r.revokeBlobUrl(f.localUrl),e.set({videoUpload:null}))}function C(f){if(n){f&&n.openPicker&&n.openPicker();return}a=null,c.innerHTML="",n=Kr(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),c.appendChild(n.el),f&&n.openPicker&&n.openPicker()}u.onclick=function(){u.disabled||C(!0)},v.onclick=function(){v.disabled||(g(),c.innerHTML="",s.click())},s.onchange=function(){var f=s.files&&s.files[0];s.value="",f&&k(f,null,void 0)};var T=!!d(),E=e.onChange(function(){A();var f=!!d();(f||T)&&w(),T=f});return A(),m()&&C(!1),d()&&w(),{el:i,destroy:function(){t=!0,u.onclick=null,v.onclick=null,s.onchange=null,n&&n.destroy&&n.destroy(),E&&E()}}}var yt=2e3,mi=60;function Za(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=ve("formStepContentTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=mi,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var p=document.createElement("textarea");p.className="renuvex-pr-fwizard-textarea",p.placeholder="Deneyiminizi anlat\u0131n\u2026",p.maxLength=yt,p.rows=6,p.setAttribute("aria-label","Yorum"),p.value=e.get().comment||"",i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-char-counter",l.setAttribute("aria-live","polite"),i.appendChild(l);function u(){var c=p.value.length;l.textContent=c+"/"+yt,l.classList.toggle("renuvex-pr-fwizard-char-counter--max",c>=yt)}function v(){return $e(3,e.get())}return p.addEventListener("input",function(){e.set({comment:p.value}),u(),t(v())}),n.appendChild(i),u(),setTimeout(function(){t(v())},0),{el:n,destroy:function(){}}}var fi=40;function $a(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ve("formStepAuthorTitle"),a.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var p=document.createElement("div");p.className="renuvex-pr-fwizard-field";var l=document.createElement("label");l.className="renuvex-pr-fwizard-label",l.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=fi,u.setAttribute("aria-required","true"),u.value=e.get().author||"",p.appendChild(l),p.appendChild(u),o.appendChild(p);var v=document.createElement("div");v.className="renuvex-pr-fwizard-field";var c=document.createElement("label");c.className="renuvex-pr-fwizard-label",c.textContent="E-posta (opsiyonel)";var s=document.createElement("input");s.type="email",s.className="renuvex-pr-fwizard-input",s.setAttribute("autocomplete","email"),s.value=e.get().email||"",v.appendChild(c),v.appendChild(s),o.appendChild(v);var m=document.createElement("div");m.className="renuvex-pr-fwizard-notice",m.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(m);var b=document.createElement("div");b.className="renuvex-pr-fwizard-msg",b.setAttribute("role","alert"),b.setAttribute("aria-live","assertive"),o.appendChild(b);var d=document.createElement("button");d.type="button",d.className="renuvex-pr-fwizard-submit-btn",d.textContent="G\xF6nder",o.appendChild(d),a.appendChild(o);function x(){return $e(4,e.get())}function g(){var h=!x(),k=(e.get().pendingImages||[]).length,z=k>0,C=e.get().videoUpload,T=!!(C&&C.status==="failed"),E=!!(C&&C.status!=="ready"&&C.status!=="failed");z||E||T?(d.disabled=!0,d.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),d.textContent=T?"Video Y\xFCklenemedi":E?"Video Haz\u0131rlan\u0131yor...":"Foto\u011Fraflar Y\xFCkleniyor..."):(d.disabled=h,d.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",h),d.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),g(),t(x())}),s.addEventListener("input",function(){e.set({email:s.value})}),g(),setTimeout(function(){t(x())},0);function y(){b.textContent=""}function w(h){y();var k=document.createElement("div");k.className="renuvex-pr-fwizard-msg-error",k.textContent=h||"",b.appendChild(k)}d.onclick=async function(){if(!d.disabled){var h=e.get(),k=(h.author||"").trim(),z=(h.comment||"").trim();if(s.value.trim()&&!s.checkValidity()){s.reportValidity();return}if(!k){w("Gerekli alan");return}if(!h.rating){w("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}d.disabled=!0,d.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var C=d.textContent;if(d.textContent="G\xF6nderiliyor\u2026",y(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){h.videoUpload&&h.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n()},600);return}try{var T=$t(window.location.href),E=h.productName||null,f=await ze(be+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,productId:h.productId||null,slug:T||null,productName:E,author:k,title:(h.title||"").trim()||null,comment:z||null,rating:h.rating,images:h.videoUpload?[]:h.images||[],videoToken:h.videoUpload&&h.videoUpload.status==="ready"?h.videoUpload.token:null})},15e3);if(f.ok)h.videoUpload&&h.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n();else{var P=await f.json().catch(function(){return{}});throw new Error(P.error||"Yorum kaydedilemedi.")}}catch(M){var N=M&&(M.name==="AbortError"||/signal/i.test(M.message||"")),S=N?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":M.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(S,"error"):w(S),d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),d.textContent=C}}};var A=e.onChange(g);return{el:a,destroy:function(){d.onclick=null,A&&A()}}}function xi(e,r,t){if(t=t||{},e===1)return _a(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return Ja(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return Kr(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Za(r,{onValidityChange:t.onValidityChange});if(e===4)return $a(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Qa(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function en(e){e=e||{},Jr();var r=Na({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:L&&L.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},n={},a={};function i(E){if(!(!E||typeof E!="string"||!E.startsWith("blob:")||a[E])){a[E]=!0;try{URL.revokeObjectURL(E)}catch(f){}}}function o(){Object.keys(n).forEach(function(f){i(f)}),Object.keys(t).forEach(function(f){i(t[f])});var E=r.get();(E.pendingImages||[]).forEach(function(f){i(f&&f.url)}),(E.images||[]).forEach(function(f){i(f)}),E.videoUpload&&i(E.videoUpload.localUrl)}function p(){var E=r.get(),f=E.videoUpload;!f||E.videoSubmitted||(f.controller&&f.controller.abort(),Zr(f.token,E.productId,f.file))}var l=Ma({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",v),jr(u),p(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=Yr(),v=function(E){l&&l.close&&l.close()};window.addEventListener("popstate",v);var c=document.createElement("div");c.className="renuvex-pr-fwizard-step-wrap";var s=La({skippableSteps:[2],nextableSteps:[3],onBack:function(){d==="idle"&&r.goBack()},onSkip:function(){d==="idle"&&r.goNext()},onNext:function(){d==="idle"&&r.goNext()}}),m=document.createElement("div");m.className="renuvex-pr-fwizard-layout",m.appendChild(c),m.appendChild(s.el);var b=null,d="idle",x=null,g=!0,y=null;function w(E,f){c.innerHTML="";var P=xi(E,r,{canNavigate:function(){return d==="idle"},blobMap:t,urlToFinger:n,revokeBlobUrl:i,onValidityChange:function(M){s.setNextDisabled(!M)},onSuccess:h,showToast:l.showToast});if(b=P,s.update(E,r.get()),f){d="entering",P.el.classList.add("renuvex-pr-fwizard-step--enter");var N=null,S=function(){N&&clearTimeout(N),P.el.removeEventListener("animationend",S),P.el.classList.remove("renuvex-pr-fwizard-step--enter"),d="idle",x!==null&&k()};P.el.addEventListener("animationend",S),N=setTimeout(S,700)}else d="idle";c.appendChild(P.el),l.setStepAttr&&l.setStepAttr(E),E===3&&s.setNextDisabled(!0)}var A=!1;function h(){if(!A){if(A=!0,!b){c.innerHTML="";var E=Qa();E.classList.add("renuvex-pr-fwizard-step--enter"),c.appendChild(E),l.setStepAttr("thanks"),s.setThanksState(l.close);return}var f=b;d="exiting",f.el.classList.add("renuvex-pr-fwizard-step--exit");var P=function(){if(y&&clearTimeout(y),f.el.removeEventListener("animationend",P),f.destroy)try{f.destroy()}catch(S){}b===f&&(b=null),c.innerHTML="";var N=Qa();N.classList.add("renuvex-pr-fwizard-step--enter"),c.appendChild(N),l.setStepAttr("thanks"),s.setThanksState(l.close),d="idle"};f.el.addEventListener("animationend",P),y=setTimeout(P,300)}}function k(){var E=r.get().currentStep;if(d!=="idle"){x=E;return}if(!b){var f=!g;g=!1,w(E,f);return}var P=b;d="exiting",P.el.classList.add("renuvex-pr-fwizard-step--exit");var N=function(){if(y&&clearTimeout(y),P.el.removeEventListener("animationend",N),P.destroy)try{P.destroy()}catch(M){}if(b===P){c.innerHTML="",b=null;var S=x!==null?x:r.get().currentStep;x=null,w(S,!0),d="idle"}};P.el.addEventListener("animationend",N),y=setTimeout(N,350)}k();var z=r.get().currentStep,C=r.onChange(function(E){E.currentStep!==z?(z=E.currentStep,k()):s.update(E.currentStep,E)}),T=l.close;return l.close=function(){C&&C(),typeof y!="undefined"&&y&&clearTimeout(y),T()},l.open(m),{close:l.close}}var gi=4e3;async function rn(){var e=await ze(be+"/api/public/upload/video/capability?storeId="+encodeURIComponent(pe),{method:"GET",cache:"no-store"},gi);if(!e.ok)throw new Error("video_capability_unavailable");var r=await e.json().catch(function(){return{}}),t=r&&r.data;if(!t||typeof t.enabled!="boolean")throw new Error("video_capability_invalid");return{enabled:t.enabled===!0,reason:typeof t.reason=="string"?t.reason:null}}var $r=null;function hi(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function bi(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:L&&L.videoReviewsEnabled===!0,reason:null};else try{t=await rn()}catch(n){t={enabled:!1,reason:"capability_unavailable"}}en({productId:G||"",productName:Re||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function ee(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=hi(r);return $r||($r=bi(r,Pe()).finally(function(){$r=null})),$r.finally(t)}var tn=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var yi={id:"classic",name:"Klasik (A\xE7\u0131k)"},wi=tn;function ki(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,v=e.currentHasImages,c=e.onFilterChange,s=e.onSortChange;Ne(a);var m=document.createElement("div");m.className="renuvex-pr-summary";var b=(o[3]||0)+(o[4]||0),d=i>0?Math.round(b/i*100):0,x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",m.appendChild(x);var g=document.createElement("div");if(g.className="renuvex-pr-summary-block renuvex-pr-summary-count",g.textContent=i.toLocaleString("tr-TR")+" "+O(n.countLabel,"Yorum"),m.appendChild(g),n.showRecommendation!==!1&&d>0){var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",y.innerHTML='<span class="renuvex-pr-recommend-pct">%'+d+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",m.appendChild(y)}return m.appendChild(Je({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:c})),m.appendChild(oe({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:ee,onSortChange:s})),m}var kt={};Ae(kt,{css:()=>Si,meta:()=>zi,render:()=>Ai});var an=`
...
`;var zi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Si=an,Ci="__unknown_product__",mr=Object.create(null);function Ei(e){return e?String(e):Ci}var He=null,fr=null;function Ti(){!He||!fr||(He.removeEventListener?He.removeEventListener("change",fr):He.removeListener&&He.removeListener(fr),He=null,fr=null)}function Ai(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,v=e.currentHasImages,c=e.onFilterChange,s=e.onSortChange,m=Ei(t),b=document.createElement("div");b.className="renuvex-pr-summary renuvex-pr-summary-compact";var d=document.createElement("div");d.className="renuvex-pr-compact-header";var x=document.createElement("div");x.className="renuvex-pr-compact-trigger-wrap";var g=document.createElement("button");g.className="renuvex-pr-compact-trigger",g.type="button",g.setAttribute("aria-expanded","false"),g.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Le(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+de(Jt)+"</span>";var y=g.querySelector(".renuvex-pr-compact-trigger-text"),w=g.querySelector(".renuvex-pr-compact-chevron");if(y&&(y.textContent=i.toLocaleString("tr-TR")+" "+O(n.countLabel,"Yorum")),y&&w){var A=document.createElement("span");A.className="renuvex-pr-compact-trigger-count",g.insertBefore(A,y),A.appendChild(y),A.appendChild(w)}x.appendChild(g),d.appendChild(x);var h=oe({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:ee,onSortChange:s}),k=h.querySelector(".renuvex-pr-filter-wrap"),z=h.querySelector(".renuvex-pr-write-btn"),C=document.createElement("div");C.className="renuvex-pr-compact-actions-slot",z&&C.appendChild(z),k&&C.appendChild(k),d.appendChild(C),b.appendChild(d);var T=document.createElement("div");T.className="renuvex-pr-compact-panel",T.setAttribute("role","dialog"),T.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),T.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="renuvex-pr-compact-panel-inner";var f=document.createElement("div");f.className="renuvex-pr-compact-avg",f.innerHTML='<span class="renuvex-pr-icon">'+ue("full")+"</span><span>"+p+"</span>",E.appendChild(f),E.appendChild(Je({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(F){N()&&T.classList.contains("renuvex-pr-open")&&(mr[m]=!0),c(F)}})),T.appendChild(E);var P=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function N(){return!!(P&&P.matches)}function S(F){F?T.classList.add("renuvex-pr-open"):T.classList.remove("renuvex-pr-open"),T.setAttribute("aria-hidden",F?"false":"true"),g.setAttribute("aria-expanded",F?"true":"false")}function M(F){var j=F?b:x;if(T.parentNode!==j){var I=!!T.parentNode;T.classList.contains("renuvex-pr-open")&&S(!1),I&&(mr[m]=!1),j.appendChild(T)}}M(P?P.matches:!1);var R=oe({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:ee,onSortChange:s}),B=R.querySelector(".renuvex-pr-filter-wrap"),_=R.querySelector(".renuvex-pr-write-btn"),U=document.createElement("div");U.className="renuvex-pr-compact-write-row",_&&U.appendChild(_),B&&U.appendChild(B),b.appendChild(U);function V(){var F=T.classList.contains("renuvex-pr-open");return S(!1),N()&&(mr[m]=!1),F}function q(){Y&&Y.notifyOpening(),S(!0),N()&&(mr[m]=!0)}g.onclick=function(){T.classList.contains("renuvex-pr-open")?V():q()};var Y=null;function D(F){Y&&(Y.unregister(),Y=null),F||(Y=qr({trigger:x,element:T,close:V}))}if(D(P?P.matches:!1),Ti(),P){var K=function(F){M(F.matches),D(F.matches)};P.addEventListener?P.addEventListener("change",K):P.addListener&&P.addListener(K),He=P,fr=K}if(N()&&mr[m]&&S(!0),n.showRecommendation!==!1){var re=(o[3]||0)+(o[4]||0),X=i>0?Math.round(re/i*100):0;if(X>0){var W=document.createElement("div");W.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="renuvex-pr-recommend-pct">%'+X+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(W)}}return b}var zt={};Ae(zt,{css:()=>Mi,meta:()=>Pi,render:()=>Ni});var nn=`
...
`;var Pi={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Mi=nn;function Ni(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,p=e.currentRatingFilter,l=e.currentOrderBy,u=e.currentHasImages,v=e.onFilterChange,c=e.onSortChange;Ne(n);var s=document.createElement("div");s.className="renuvex-pr-summary renuvex-pr-summary-split";var m=document.createElement("div");m.className="renuvex-pr-split-col renuvex-pr-split-left";var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",m.appendChild(b);var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",d.textContent=a.toLocaleString("tr-TR")+" "+O(t.countLabel,"Yorum"),m.appendChild(d),s.appendChild(m);var x=document.createElement("div");x.className="renuvex-pr-split-col renuvex-pr-split-mid",x.appendChild(Je({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:p,onFilterChange:v})),s.appendChild(x);var g=oe({widget:r,currentOrderBy:l,currentHasImages:u,onWriteClick:ee,onSortChange:c}),y=g.querySelector(".renuvex-pr-filter-wrap"),w=g.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-split-col renuvex-pr-split-right",w&&A.appendChild(w),y&&A.appendChild(y),s.appendChild(A);var h=(i[3]||0)+(i[4]||0),k=a>0?Math.round(h/a*100):0,z=document.createElement("div");z.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",z.innerHTML='<span class="renuvex-pr-recommend-pct">%'+k+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var C=t.showRecommendation===!1||k===0;return C&&z.classList.add("renuvex-pr-split-rec-hidden"),m.appendChild(z),s}var St={};Ae(St,{css:()=>_i,meta:()=>Li,render:()=>Ri});var on=`
...
`;var Li={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},_i=on;function Ri(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-minimal";var v=document.createElement("div");v.className="renuvex-pr-minimal-info";var c=document.createElement("div");c.className="renuvex-pr-minimal-row";var s=document.createElement("span");s.className="renuvex-pr-minimal-avg",s.textContent=i,c.appendChild(s);var m=document.createElement("span");m.className="renuvex-pr-minimal-stars",m.innerHTML=Le(i,n),c.appendChild(m);var b=document.createElement("span");b.className="renuvex-pr-minimal-count",b.textContent=a.toLocaleString("tr-TR")+" "+O(t.countLabel,"Yorum"),c.appendChild(b),v.appendChild(c),u.appendChild(v);var d=oe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:ee,onSortChange:l}),x=d.querySelector(".renuvex-pr-filter-wrap"),g=d.querySelector(".renuvex-pr-write-btn"),y=document.createElement("div");y.className="renuvex-pr-minimal-actions",g&&y.appendChild(g),x&&y.appendChild(x),u.appendChild(y);var w=oe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:ee,onSortChange:l}),A=w.querySelector(".renuvex-pr-filter-wrap"),h=w.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");return k.className="renuvex-pr-minimal-write-row",h&&k.appendChild(h),A&&k.appendChild(A),u.appendChild(k),u}var Ct={};Ae(Ct,{css:()=>Bi,meta:()=>Ii,render:()=>Fi});var ln=`
...
`;var Ii={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},Bi=ln;function Fi(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var v=document.createElement("div");v.className="renuvex-pr-hero-info";var c=document.createElement("div");c.className="renuvex-pr-hero-rating-col";var s=document.createElement("span");s.className="renuvex-pr-hero-avg",s.textContent=i,c.appendChild(s);var m=document.createElement("div");m.className="renuvex-pr-hero-meta-row";var b=document.createElement("span");b.className="renuvex-pr-hero-stars",b.innerHTML=Le(i,n),m.appendChild(b);var d=document.createElement("div");d.className="renuvex-pr-hero-count",d.textContent=a.toLocaleString("tr-TR")+" "+O(t.countLabel,"Yorum"),m.appendChild(d),c.appendChild(m),v.appendChild(c),u.appendChild(v);var x=oe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:ee,onSortChange:l}),g=x.querySelector(".renuvex-pr-filter-wrap"),y=x.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",y&&w.appendChild(y),g&&w.appendChild(g),u.appendChild(w);var A=oe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:ee,onSortChange:l}),h=A.querySelector(".renuvex-pr-filter-wrap"),k=A.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-hero-write-row",k&&z.appendChild(k),h&&z.appendChild(h),u.appendChild(z),u}var pn=`
  .renuvex-pr-summary{
...
`;var Oi={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},Ui=dn;function Hi(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var n=document.createElement("div");n.className="renuvex-pr-review-top";var a=document.createElement("div");a.className="renuvex-pr-review-top-left";var i=document.createElement("span");i.className="renuvex-pr-review-stars",i.innerHTML=we(e.rating,L),a.appendChild(i);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=ke(e.createdAt),n.appendChild(a),n.appendChild(o),t.appendChild(n),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-title",p.textContent=e.title,t.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-author",l.textContent=e.author||"",t.appendChild(l);var u=(e.comment||"").trim();u&&t.appendChild(tr(u,"renuvex-pr-body").fragment);var v=Se(e);if(v.length){var c=document.createElement("div");c.className="renuvex-pr-gallery",v.forEach(function(m){var b=_e(m,{className:"renuvex-pr-img",sourceWidth:ie,width:ie,height:ie,onOpen:function(){ge(e,m.url,r)}});b&&c.appendChild(b)}),t.appendChild(c)}var s=ar(e.merchantReply);return s&&t.appendChild(s),t}var Tt={};Ae(Tt,{css:()=>Di,meta:()=>Vi,render:()=>Yi});var sn=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var Vi={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},Di=sn;function Yi(e,r){var t=Se(e),n=t.length>0,a=document.createElement("article");a.className="renuvex-pr-review-list"+(n?"":" renuvex-pr-review-list--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=we(e.rating,L),i.appendChild(o);var p=document.createElement("span");p.className="renuvex-pr-review-list-author-name",p.textContent=e.author||"",i.appendChild(p);var l=document.createElement("time");l.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=ke(e.createdAt),i.appendChild(l),a.appendChild(i);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var v=document.createElement("div");v.className="renuvex-pr-review-list-title",v.textContent=e.title,u.appendChild(v)}var c=(e.comment||"").trim();c&&u.appendChild(tr(c,"renuvex-pr-review-list-body").fragment);var s=ar(e.merchantReply);if(s&&u.appendChild(s),a.appendChild(u),n){var m=document.createElement("div");m.className="renuvex-pr-review-list-media",t.forEach(function(b){var d=_e(b,{sourceWidth:ie,width:ie,height:Math.round(ie*4/3),onOpen:function(){ge(e,b.url,r)}});d&&m.appendChild(d)}),a.appendChild(m)}return a}var At={};Ae(At,{css:()=>Wi,meta:()=>ji,render:()=>qi});var vn=`
...
`;var ji={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Wi=vn;function qi(e,r){var t=Br(e),n=!!t,a=document.createElement("article");a.className="renuvex-pr-review-gallery"+(n?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=we(e.rating,L),i.appendChild(o),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-gallery-title",p.textContent=e.title,i.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-review-gallery-author",l.textContent=e.author||"",i.appendChild(l);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=ke(e.createdAt),i.appendChild(u);var v=(e.comment||"").trim();if(v&&i.appendChild(tr(v,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ge(e,t.url,r)}}:null).fragment),a.appendChild(i),n){var c=document.createElement("div");c.className="renuvex-pr-review-gallery-media";var s=_e(t,{sourceWidth:Nr,width:Nr,height:Math.round(Nr*4/3),onOpen:function(){ge(e,t.url,r)}});s&&c.appendChild(s),a.appendChild(c)}var m=ar(e.merchantReply,t?function(){ge(e,t.url,r)}:null);return m&&(m.classList.add("renuvex-pr-review-gallery-reply"),a.appendChild(m)),a}var rt={card:Et,list:Tt,gallery:At};function tt(e){return rt[e]||rt.card}function cn(){return Object.keys(rt).map(function(e){return rt[e].css||""}).join(`
`)}var Pt=0;function Ve(){return Pt++,Pt}function De(e,r){return e!==Pt?!1:r?!(r.productId!==void 0&&G!==r.productId||r.orderBy!==void 0&&Q!==r.orderBy||r.page!==void 0&&ir!==r.page||r.ratingFilter!==void 0&&ae!==r.ratingFilter||r.hasImages!==void 0&&ne!==r.hasImages||r.nextCursor!==void 0&&wr!==r.nextCursor):!0}var Mt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Nt={small:80,medium:110,large:140},Lt={small:80,medium:100,large:110};function mn(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",n=document.createElementNS(t,"svg");n.setAttribute("width","32"),n.setAttribute("height","32"),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.style.cssText="color:#6e6d7a;margin-bottom:4px;";var a=document.createElementNS(t,"path");a.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),n.appendChild(a),n.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var p=document.createElement("div");return p.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",p.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(n),r.appendChild(o),r.appendChild(p),r}function fn(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var n=document.createElement("div");n.className="renuvex-pr-empty-state-stars",n.innerHTML=Le(0,e.iconPair),t.appendChild(n);var a=document.createElement("p");a.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),a.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(a),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function xn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function gn(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="renuvex-pr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var a=document.createElement("button");return a.type="button",a.className="renuvex-pr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},t.appendChild(a),t}function Ee(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),a=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+n+","+a+","+i+","+r+")"}function at(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function _t(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function hn(e){return .2126*_t(e.r)+.7152*_t(e.g)+.0722*_t(e.b)}function bn(e,r){var t=hn(e),n=hn(r),a=Math.max(t,n),i=Math.min(t,n);return(a+.05)/(i+.05)}function Gi(e){var r=at(e)||at("#ffffff"),t=at("#111111"),n=at("#ffffff");return bn(t,r)>=bn(n,r)?"#111111":"#ffffff"}function Ki(e){return Ee(e,e==="#ffffff"?.1:.06)}function yn(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",p=r.barTrackColor||"#e5e7eb",l=r.barCountColor||"#111111",u=Ee(o,.06),v=r.reviewStarColor||"#f59e0b",c=r.btnBgColor||"#111111",s=r.btnTextColor||"#ffffff",m=r.btnBorderColor||"#111111",b=r.filterBtnBgColor||"#111111",d=r.filterBtnTextColor||"#ffffff",x=r.filterBtnBorderColor||"#111111",g=r.filterMenuBgColor||"#ffffff",y=r.filterMenuBorderColor||"#e5e7eb",w=r.filterItemTextColor||"#111111",A=r.filterItemHoverBgColor||"#f3f4f6",h=r.filterItemActiveColor||"#111111",k=r.reviewTitleColor||"#111111",z=r.reviewAuthorColor||"#111111",C=r.reviewDateColor||"#5e5e5e",T=r.reviewBodyColor||"#111111",E=r.reviewBorderColor||"#e5e7eb",f=Ee(T,.65),P=r.replyBgColor||"#f9fafb",N=r.replyBorderColor||"#747474",S=r.replyLabelColor||"#111111",M=r.replyTextColor||"#111111",R=r.photoTitleColor||"#111111",B=Ee("#111111",.05),_=r.photoArrowBgColor||"#ffffff",U=r.photoArrowTextColor||"#111111",V=Ee("#111111",.12),q=r.formBgColor||"#ffffff",Y=r.formPrimaryTextColor||"#111111",D=r.formSecondaryTextColor||"#3b3b3b",K=r.inputTextColor||Y,re=r.inputBorderColor||"#d1d5db",X=r.placeholderColor||"#9ca3af",W=r.formStepBarColor||"#111111",F=r.formBtnBgColor||"#111111",j=r.formBtnTextColor||"#ffffff",I=r.formBtnBorderColor||"#111111",le=Ee(F,.06),ce=Ee(F,.18),J=Ee(j,.85),xr=Ee(Y,.06),Te=Gi(q),H=Ki(Te),te=r.loadMoreBgColor||"#ffffff",me=r.loadMoreTextColor||"#111111",Z=r.loadMoreBorderColor||"#111111",he=r.paginationBgColor||"#ffffff",gr=r.paginationTextColor||"#111111",hr=r.paginationBorderColor||"#e5e7eb",br=r.paginationActiveBgColor||"#111111",yr=r.paginationActiveTextColor||"#ffffff",fe={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":n,"--renuvex-pr-header-count":a,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":p,"--renuvex-pr-bar-count":l,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":c,"--renuvex-pr-btn-text":s,"--renuvex-pr-btn-border":m,"--renuvex-pr-filter-btn-bg":b,"--renuvex-pr-filter-btn-text":d,"--renuvex-pr-filter-btn-border":x,"--renuvex-pr-filter-menu-bg":g,"--renuvex-pr-filter-menu-border":y,"--renuvex-pr-filter-item-text":w,"--renuvex-pr-filter-item-hover-bg":A,"--renuvex-pr-filter-item-active":h,"--renuvex-pr-review-title":k,"--renuvex-pr-review-author":z,"--renuvex-pr-review-date":C,"--renuvex-pr-review-body":T,"--renuvex-pr-review-border":E,"--renuvex-pr-state-text":f,"--renuvex-pr-review-star-color":v,"--renuvex-pr-reply-bg-color":P,"--renuvex-pr-reply-border":N,"--renuvex-pr-reply-label":S,"--renuvex-pr-reply-text":M,"--renuvex-pr-photo-title":R,"--renuvex-pr-photo-image-border":B,"--renuvex-pr-photo-arrow-bg":_,"--renuvex-pr-photo-arrow-text":U,"--renuvex-pr-photo-arrow-border":V,"--renuvex-pr-fwizard-bg":q,"--renuvex-pr-fwizard-text":Y,"--renuvex-pr-fwizard-secondary-text":D,"--renuvex-pr-fwizard-input-bg":q,"--renuvex-pr-fwizard-input-text":K,"--renuvex-pr-fwizard-input-border":re,"--renuvex-pr-fwizard-placeholder":X,"--renuvex-pr-fwizard-close-text":Te,"--renuvex-pr-fwizard-close-hover-bg":H,"--renuvex-pr-fwizard-progress-bg":xr,"--renuvex-pr-fwizard-progress-active":W,"--renuvex-pr-fwizard-btn-bg":F,"--renuvex-pr-fwizard-btn-text":j,"--renuvex-pr-fwizard-btn-border":I,"--renuvex-pr-fwizard-btn-disabled-bg":ce,"--renuvex-pr-fwizard-btn-disabled-text":J,"--renuvex-pr-fwizard-nav-hover-bg":le,"--renuvex-pr-load-more-bg":te,"--renuvex-pr-load-more-text":me,"--renuvex-pr-load-more-border":Z,"--renuvex-pr-pagination-bg":he,"--renuvex-pr-pagination-text":gr,"--renuvex-pr-pagination-border":hr,"--renuvex-pr-pagination-active-bg":br,"--renuvex-pr-pagination-active-text":yr};Object.keys(fe).forEach(function(nr){e.style.setProperty(nr,fe[nr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function wn(e){var r=e.settings,t=e.root,n=e.currentHasImages,a=e.openReviewModal,i=(e.photoStripReviews||[]).filter(function(w){return Se(w).length>0});if(!(r.showPhotoGallery!==!1&&!n&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var p=O(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),l=document.createElement("div");l.className="renuvex-pr-photo-title",l.textContent=p,o.appendChild(l)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",u);var v=document.createElement("div");v.className="renuvex-pr-photo-strip";var c=ie,s=r.reviewLayout==="card"?ie:Math.round(ie*4/3),m=0;i.forEach(function(w){if(!(m>=15)){var A=Br(w);if(A){var h=_e(A,{className:"renuvex-pr-photo-strip-thumb",sourceWidth:ie,width:c,height:s,loading:m<3?"eager":"lazy",onOpen:function(){a(w,A.url,i)}});h&&(v.appendChild(h),m++)}}});var b=document.createElement("button");b.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var d=$(je);d&&b.appendChild(d),b.setAttribute("aria-label","\xD6nceki"),b.onclick=function(){v.scrollBy({left:-200,behavior:"smooth"})};var x=document.createElement("button");x.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var g=$(Tr);g&&x.appendChild(g),x.setAttribute("aria-label","Sonraki"),x.onclick=function(){v.scrollBy({left:200,behavior:"smooth"})};var y=document.createElement("div");return y.className="renuvex-pr-photo-strip-wrap",y.appendChild(b),y.appendChild(v),y.appendChild(x),o.appendChild(y),o}var Xi=1,Ji=7,Rt="\u2026";function Zi(e,r){var t=Math.max(1,Math.floor(Number(r))||1),n=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Ji){for(var a=[],i=1;i<=t;i++)a.push(i);return a}for(var o=[],p=1;p<=t;p++)(p===1||p===t||Math.abs(p-n)<=Xi)&&o.push(p);for(var l=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&l.push(Rt),l.push(o[u]);return l}function kn(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),n=typeof e.onPageChange=="function"?e.onPageChange:function(){},a=document.createElement("nav");a.className="renuvex-pr-pagination",a.setAttribute("aria-label","Yorum sayfalar\u0131");function i(l){a.setAttribute("aria-busy","true");for(var u=a.querySelectorAll("button"),v=0;v<u.length;v++)u[v].disabled=!0;n(l)}function o(l,u){var v=document.createElement("span");v.className="renuvex-pr-pagination-label",v.setAttribute("aria-hidden","true"),v.textContent=u,l.appendChild(v)}function p(l,u,v,c){var s=document.createElement("button");return s.type="button",s.className="renuvex-pr-pagination-arrow",s.setAttribute("aria-label",l),o(s,u),c?s.disabled=!0:s.onclick=function(){i(v)},s}return a.appendChild(p("\xD6nceki sayfa","\u2039",t-1,t<=1)),Zi(t,r).forEach(function(l){if(l===Rt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=Rt,a.appendChild(u);return}var v=document.createElement("button");v.type="button",v.className="renuvex-pr-pagination-btn",v.setAttribute("aria-label","Sayfa "+l),o(v,String(l)),l===t?v.setAttribute("aria-current","page"):v.onclick=function(){i(l)},a.appendChild(v)}),a.appendChild(p("Sonraki sayfa","\u203A",t+1,t>=r)),a}function zn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Sn(e){var r=e.render;async function t(){var o=Ve(),p=G,l=Q,u=ae,v=ne;Me(null);var c=await Oe(G,Q,1,ae,ne);De(o,{productId:p,orderBy:l,ratingFilter:u,hasImages:v})&&await r(G,L,c,Re,Q,1,Bt)}async function n(o){var p=Ve(),l=ae===o?null:o,u=G,v=Q,c=ne;Ot(l),Ie(1),Me(null);var s=await Oe(G,Q,1,l,ne);De(p,{productId:u,orderBy:v,page:1,ratingFilter:l,hasImages:c})&&await r(G,L,s,Re,Q,1)}async function a(o,p){var l=Ve(),u=G,v=ae;Ie(1),Me(null);var c=o,s=!1;p&&(s=!0,c="newest"),Ut(s),kr(c);var m=await Oe(G,c,1,ae,s);De(l,{productId:u,orderBy:c,page:1,ratingFilter:v,hasImages:s})&&await r(G,L,m,Re,c,1)}async function i(o){var p=Ve(),l=G,u=Q,v=ae,c=ne;Ie(o),Me(null);var s=await Oe(G,Q,o,ae,ne);if(De(p,{productId:l,orderBy:u,page:o,ratingFilter:v,hasImages:c})){await r(G,L,s,Re,Q,o);var m=document.getElementById("renuvex-reviews"),b=m&&m.shadowRoot,d=b&&b.querySelector&&b.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(d){try{d.focus({preventScroll:!0})}catch(y){try{d.focus()}catch(w){}}zn(b,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var x=document.getElementById("renuvex-reviews");if(x&&typeof x.scrollIntoView=="function"){var g=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;x.scrollIntoView({behavior:g?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:n,onSortChange:a,onPageChange:i}}function $i(){return na()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Qi(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=ta({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),aa(t,{surface:"reviews",productId:r||""}),t}async function It(e,r,t,n,a,i,o){if(Kt){Cr({productId:e,settings:r,reviewsData:t,productName:n,orderBy:a,page:i,badgeSettings:o});return}Sr(!0),Ht(e),Vt(r),o!==void 0&&Dt(o),Yt(n),a&&kr(a),i&&Ie(i),t!=null&&(jt(t),Me(t&&t.data?t.data.nextCursor:null));var p=Sn({render:It});try{let Te=function(H,te){if(!(!H||!H.meta||!H.meta.sizeOverrides)){var me=H.meta.sizeOverrides[te];me&&Object.keys(me).forEach(function(Z){m.style.setProperty(Z,me[Z])})}};var J=Te,l=et(r.summaryLayout),u=!(l.meta&&l.meta.supports&&l.meta.supports.title===!1),v=r.showTitle!==!1,c=O(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),s=u&&v?c:"",m=document.documentElement;yn(m,r);var b=r.borderRadius!==void 0?r.borderRadius:8,d=Mt[r.size]||Mt.medium,x=Nt[r.thumbnailSize]||Nt.medium,g=x;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(g=Lt[r.thumbnailSize]||Lt.medium),m.style.setProperty("--renuvex-pr-title-size",d.titleSize+"px"),m.style.setProperty("--renuvex-pr-review-text-size",d.reviewTextSize+"px"),m.style.setProperty("--renuvex-pr-review-title-size",d.reviewTitleSize+"px"),m.style.setProperty("--renuvex-pr-author-size",d.authorSize+"px"),m.style.setProperty("--renuvex-pr-reply-name-size",d.replyNameSize+"px"),m.style.setProperty("--renuvex-pr-reply-text-size",d.replyTextSize+"px"),m.style.setProperty("--renuvex-pr-radius",b+"px"),m.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,b-4)+"px"),m.style.setProperty("--renuvex-pr-photo-title-size",d.photoTitleSize+"px"),m.style.setProperty("--renuvex-pr-avg-rating-size",d.avgRatingSize+"px"),m.style.setProperty("--renuvex-pr-review-count-size",d.reviewCountSize+"px"),m.style.setProperty("--renuvex-pr-compact-count-size",d.compactCountSize+"px"),m.style.setProperty("--renuvex-pr-recommend-size",d.recommendSize+"px"),m.style.setProperty("--renuvex-pr-btn-text-size",d.btnTextSize+"px"),m.style.setProperty("--renuvex-pr-bar-label-size",d.barLabelSize+"px"),m.style.setProperty("--renuvex-pr-minimal-avg-size",d.minimalAvgSize+"px"),m.style.setProperty("--renuvex-pr-hero-avg-size",d.heroAvgSize+"px"),m.style.setProperty("--renuvex-pr-minimal-count-size",d.minimalCountSize+"px"),m.style.setProperty("--renuvex-pr-hero-count-size",d.heroCountSize+"px"),m.style.setProperty("--renuvex-pr-bar-count-size",d.barCountSize+"px"),m.style.setProperty("--renuvex-pr-review-date-size",d.reviewDateSize+"px"),m.style.setProperty("--renuvex-pr-filter-text-size",d.filterTextSize+"px"),m.style.setProperty("--renuvex-pr-load-more-size",d.loadMoreSize+"px"),m.style.setProperty("--renuvex-pr-load-more-min-height",d.loadMoreMinHeight+"px"),m.style.setProperty("--renuvex-pr-load-more-pad-y",d.loadMorePadY+"px"),m.style.setProperty("--renuvex-pr-load-more-pad-x",d.loadMorePadX+"px"),m.style.setProperty("--renuvex-pr-load-more-mobile-min-height",d.loadMoreMobileMinHeight+"px"),m.style.setProperty("--renuvex-pr-pagination-button-size",d.paginationButtonSize+"px"),m.style.setProperty("--renuvex-pr-pagination-pad-x",d.paginationPadX+"px"),m.style.setProperty("--renuvex-pr-pagination-gap",d.paginationGap+"px"),m.style.setProperty("--renuvex-pr-pagination-margin-top",d.paginationMarginTop+"px"),m.style.setProperty("--renuvex-pr-pagination-gap-min",d.paginationGapMin+"px"),m.style.setProperty("--renuvex-pr-pagination-mobile-button-size",d.paginationMobileButtonSize+"px"),m.style.setProperty("--renuvex-pr-pagination-mobile-font-size",d.paginationMobileFontSize+"px"),m.style.setProperty("--renuvex-pr-pagination-mobile-gap",d.paginationMobileGap+"px"),m.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",d.paginationMobileMarginTop+"px"),m.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",d.paginationMobileGapMin+"px"),m.style.setProperty("--renuvex-pr-read-more-size",d.readMoreSize+"px"),m.style.setProperty("--renuvex-pr-thumbnail-size",x+"px"),m.style.setProperty("--renuvex-pr-thumbnail-size-mobile",g+"px");var y=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";m.style.setProperty("--renuvex-pr-review-star-color",y),m.style.setProperty("--renuvex-pr-star-size",d.reviewStarSize+"px"),m.style.setProperty("--renuvex-pr-avg-star-size",d.avgStarSize+"px"),Te(et(r.summaryLayout),r.size),Te(tt(r.reviewLayout),r.size);var w=or(r),A=$i();if(!A)return;var h=Qi(A,e),k=document.getElementById("renuvex-reviews");k||(k=document.createElement("div"),k.id="renuvex-reviews",k.style.minHeight="200px"),k.parentNode!==h&&h.appendChild(k);var z=pa(k),C=qe+Ye+Or+un()+cn();Ge(z,C);var T=da(z);if(r.enabled===!1){k.style.minHeight="auto",T.replaceChildren(mn(r.borderRadius!==void 0?r.borderRadius:8)),Sr(!1);var E=zr;Cr(null),E&&It(E.productId,E.settings,E.reviewsData,E.productName,E.orderBy,E.page,E.badgeSettings);return}try{var f=t||{},P=pt(f),N=P?[]:f.data&&f.data.reviews||[];Wt(N),T.replaceChildren();var S=document.createElement("section");if(S.id="renuvex-reviews-widget",S.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),S.className="renuvex-pr-reviews-widget",S.setAttribute("data-renuvex-surface","reviews"),e&&S.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),s){var M=document.createElement("div"),R=r.summaryLayout||"classic";M.className="renuvex-pr-title renuvex-pr-title-"+R,M.textContent=s,S.appendChild(M)}if(P){S.appendChild(gn(f.message,p.onRetry)),T.appendChild(S),Be(z),nt(S,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return z.getElementById("renuvex-reviews-widget")});return}var B=f.data&&f.data.allCount||0,_=f.data&&f.data.ratingCounts||null,U=_||[0,0,0,0,0],V=f.data&&f.data.avgRating||"0.0";if(!_&&N.length>0){N.forEach(function(H){H.rating>=1&&H.rating<=5&&U[H.rating-1]++});var q=N.reduce(function(H,te){return H+te.rating},0);V=(q/N.length).toFixed(1)}if(B===0)S.classList.add("renuvex-pr-reviews-empty"),S.appendChild(fn({iconPair:w,writeButtonText:O(r.writeButtonText,"Yorum Yap"),emptyStateText:O(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:ee}));else{var Y=et(r.summaryLayout),D=Y.render({widget:S,productId:e,data:f,settings:r,iconPair:w,allCount:B,ratingCounts:U,avgRatingVal:V,currentRatingFilter:ae,currentOrderBy:Q,currentHasImages:ne,onFilterChange:p.onFilterChange,onSortChange:p.onSortChange});S.appendChild(D);var K=wn({settings:r,root:m,currentHasImages:ne,photoStripReviews:Ft,openReviewModal:ge,wireLightboxTrigger:pr});if(K&&S.appendChild(K),N.length===0)S.appendChild(xn());else{var re=tt(r.reviewLayout);N.forEach(function(H){S.appendChild(re.render(H,it))})}var X=r.paginationMode==="numbered"?"numbered":"loadMore";if(X==="numbered"){var W=f.data&&f.data.totalPages||1;W>1&&S.appendChild(kn({page:f.data&&f.data.page||ir||1,totalPages:W,onPageChange:p.onPageChange}))}var F=X==="loadMore"&&f.data&&f.data.hasMore;if(F){let H=function(te){I.textContent=te,j.setAttribute("aria-label",te)};var xr=H,j=document.createElement("button");j.className="renuvex-pr-load-more";var I=document.createElement("span");I.className="renuvex-pr-load-more-label",I.setAttribute("aria-hidden","true"),j.appendChild(I),H("Daha Fazla G\xF6ster"),j.onclick=async function(){j.disabled=!0,H("Y\xFCkleniyor...");var te=Ve(),me=G,Z=Q,he=ir,gr=ae,hr=ne,br=wr,yr=he+1,fe=await Oe(me,Z,yr,gr,hr,null,br);if(De(te,{productId:me,orderBy:Z,page:he,ratingFilter:gr,hasImages:hr,nextCursor:br}))if(fe&&!pt(fe)&&fe.data&&Array.isArray(fe.data.reviews)){var nr=qt(fe.data.reviews);Gt(nr),Ie(yr),Me(fe.data.nextCursor||null);var Cn=tt(L.reviewLayout);nr.forEach(function(En){S.insertBefore(Cn.render(En,it),j)}),fe.data.hasMore?(j.disabled=!1,H("Daha Fazla G\xF6ster")):j.remove()}else j.disabled=!1,H("Tekrar Dene")},S.appendChild(j)}}T.appendChild(S),Be(z),nt(S,"reviews-widget",{productId:e||""},function(){return z.getElementById("renuvex-reviews-widget")})}catch(H){console.error("[renuvex-pr] render error:",H);var le=document.createElement("p");le.style.cssText="text-align:center;color:#dc2626;",le.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",T&&T.replaceChildren(le)}}finally{if(Sr(!1),zr){var ce=zr;Cr(null),It(ce.productId,ce.settings,ce.reviewsData,ce.productName,ce.orderBy,ce.page,ce.badgeSettings)}}}export{It as render};
