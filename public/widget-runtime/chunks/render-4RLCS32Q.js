...
`;var Sr=[Ht,Pt,Dt,jt,Wt,Vt,Ut,Yt].join(`
`);function Ia(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function de(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function Ba(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Ma(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=Ba()&&!n;if(a>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function _a(e){var r=document.body.style,t=document.documentElement.style;de(t,"overflow",e.rootOverflow,e.rootOverflowPriority),de(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),de(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),de(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),de(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),de(r,"position",e.bodyPosition,e.bodyPositionPriority),de(r,"top",e.bodyTop,e.bodyTopPriority),de(r,"left",e.bodyLeft,e.bodyLeftPriority),de(r,"right",e.bodyRight,e.bodyRightPriority),de(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var ar=0,Ve=null;function Er(){return ar+=1,ar>1||(Ve=Ia(),Ma(Ve)),Ve}function Tr(){if(ar!==0&&(ar-=1,!(ar>0))){var e=Ve;Ve=null,e&&_a(e)}}function Fa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Ar(){var e=Fa();return!e||e===document.body||e===document.documentElement?null:e}function te(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Oa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Vr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Oa)}function Ha(e,r){var t=e,a=Vr(e);!a.length&&r&&(t=r,a=Vr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;te(n)}function Lr(e,r,t){if(e.key==="Tab"){var a=Vr(r);if(!a.length){e.preventDefault(),Ha(r);return}var n=a[0],l=a[a.length-1],o=Ft(t);if(!r.contains(o)){e.preventDefault(),te(n);return}if(a.indexOf(o)===-1){e.preventDefault(),te(e.shiftKey?l:n);return}e.shiftKey&&o===n?(e.preventDefault(),te(l)):!e.shiftKey&&o===l&&(e.preventDefault(),te(n))}}var qt="renuvexPrOverlay";function Pr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[qt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Ya(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[qt]===e.id)}function Nr(e){if(Ya(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Ue(e){return Se(e)}function Gt(e,r,t,a,n,l){Tr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&br(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),l&&te(n)}function Da(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=xe(e.rating,R);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-modal-reply";var g=document.createElement("div");g.className="renuvex-pr-modal-reply-label",g.textContent=M(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",p.appendChild(g),p.appendChild(v),p.style.display=e.merchantReply?"":"none",t.appendChild(p),r.appendChild(t),r}function Kt(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),l=n.querySelector(".renuvex-pr-modal-stars");l.innerHTML=xe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=fe(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=M(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function qr(e,r,t,a,n,l,o,i,d){var p=Ue(e),g=Math.max(0,Math.min(t||0,p.length-1)),v=document.createElement("div");v.className="renuvex-pr-modal-left";var u=document.createElement("img"),s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(u.className="renuvex-pr-modal-main-img"+(s?" "+s:""),u.src=jr(p[g]||""),u.decoding="async",u.width=Dr,u.height=Math.round(Dr*4/3),u.alt="Yorum foto\u011Fraf\u0131",!s){u.classList.add("renuvex-pr-modal-img-loading");var y=function(){u.classList.remove("renuvex-pr-modal-img-loading")};u.complete&&u.naturalWidth>0?y():(u.addEventListener("load",y,{once:!0}),u.addEventListener("error",y,{once:!0}))}Rt(u,function(P){if(P.style.display="none",!v.querySelector(".renuvex-pr-modal-img-error")){var S=document.createElement("div");S.className="renuvex-pr-modal-img-error",S.setAttribute("role","status"),S.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",v.insertBefore(S,P)}}),v.appendChild(u);var c=document.createElement("button");c.className="renuvex-pr-modal-close-mobile";var h=re(Re);h&&c.appendChild(h),c.setAttribute("aria-label","Kapat"),c.onclick=function(P){P.stopPropagation(),l()},v.appendChild(c);var x=0;if(v.addEventListener("touchstart",function(P){x=P.touches[0].clientX},{passive:!0}),v.addEventListener("touchend",function(P){var S=x-P.changedTouches[0].clientX;if(!(Math.abs(S)<50)){if(S>0){if(k)ge(e,r,g+1,a,n,l,!0,"next",i,d);else if(z){var N=a[r+1];ge(N,r+1,0,a,n,l,!1,"next",i,d)}}else if(m)ge(e,r,g-1,a,n,l,!0,"prev",i,d);else if(b){var D=a[r-1],G=Ue(D);ge(D,r-1,G.length-1,a,n,l,!1,"prev",i,d)}}},{passive:!0}),p.length>1){var f=document.createElement("div");f.className="renuvex-pr-modal-thumbs",p.forEach(function(P,S){var N=document.createElement("img"),D=pe(P,kr);N.src=D.src,N.srcset=D.srcset,N.loading="lazy",N.decoding="async",N.width=kr,N.height=kr,N.className="renuvex-pr-modal-thumb"+(S===g?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(S+1),ue(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(S+1)+" se\xE7"),S===g&&N.setAttribute("aria-current","true"),(function(G){function Q(){ge(e,r,G,a,n,l,!0,null,i,d)}N.onclick=Q,N.onkeydown=function(j){(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),Q())}})(S),f.appendChild(N)}),v.appendChild(f)}var m=g>0,k=g<p.length-1,b=r>0,z=r<a.length-1,E=m||b,A=k||z;if(E){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var T=re(De);T&&w.appendChild(T),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(P){if(P.stopPropagation(),m)ge(e,r,g-1,a,n,l,!0,"prev",i,d);else if(b){var S=a[r-1],N=Ue(S);ge(S,r-1,N.length-1,a,n,l,!1,"prev",i,d)}},v.appendChild(w)}if(A){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=re(yr);L&&C.appendChild(L),C.setAttribute("aria-label","Sonraki"),C.onclick=function(P){if(P.stopPropagation(),k)ge(e,r,g+1,a,n,l,!0,"next",i,d);else if(z){var S=a[r+1];ge(S,r+1,0,a,n,l,!1,"next",i,d)}},v.appendChild(C)}return v}function Xt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=Ue(a);n[0]&&(new Image().src=jr(n[0]))}})}function Ur(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function ja(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Ur(t),Ur(a),Ur(n)}l(),t&&te(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ge(e,r,t,a,n,l,o,i,d,p){if(p&&(p.currentReview=e),o){var g=qr(e,r,t,a,n,l,i,d,p);n.firstChild&&n.replaceChild(g,n.firstChild)}else{var g=qr(e,r,t,a,n,l,i,d,p),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(g,n.firstChild),v&&Kt(v,e,p&&p.currentSettings),ja(d,n)}Xt(r,a)}function se(e,r,t){var a=Ue(e);if(!a.length)return;var n=(t||[]).filter(function(A){return Ue(A).length>0}),l=n.findIndex(function(A){return A===e||A.id===e.id});l===-1&&(n.unshift(e),l=0);var o=a.indexOf(r);o<0&&(o=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var p=!1,g=null,v=Ar(),u=Ye(),s=Er(),y=Pr(),c={currentReview:e,currentSettings:R},h=null;function x(A){var w=A&&A.detail&&A.detail.settings;if(!(w&&w===h)){h=w||null,c.currentSettings=w||R;var T=d.querySelector(".renuvex-pr-modal-right");!T||!c.currentReview||Kt(T,c.currentReview,c.currentSettings)}}function f(){p||(p=!0,window.removeEventListener(Ie,x),Gt(g&&g.host,m,f,s,v,u))}function m(A){if(A.key==="Escape"){k();return}Lr(A,i,g&&g.root)}function k(){p||(p=!0,window.removeEventListener(Ie,x),Gt(g&&g.host,m,f,s,v,u),Nr(y))}document.addEventListener("keydown",m),window.addEventListener("popstate",f),window.addEventListener(Ie,x),i.onclick=function(){k()},d.onclick=function(A){A.stopPropagation()},d.appendChild(qr(e,l,o,n,d,k,null,i,c)),d.appendChild(Da(e)),Xt(l,n);var b=document.createElement("div");b.className="renuvex-pr-modal-wrap",b.tabIndex=-1,b.setAttribute("role","dialog"),b.setAttribute("aria-modal","true"),b.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),b.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var E=re(Re);E&&z.appendChild(E),z.setAttribute("aria-label","Kapat"),z.onclick=function(A){A.stopPropagation(),k()},b.appendChild(z),i.appendChild(b),g=Cr(),We(g.root,je+He+Sr),g.root.appendChild(i),Ne(g.root),te(b)}function Ee(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Zr={};we(Zr,{css:()=>Qa,meta:()=>$a,render:()=>en});function qe(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,l=e.onFilterChange;ke(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,p=t>0?Math.round(d/t*100):0,g=n===i,v=d>0,u=M(R&&R.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(g?" renuvex-pr-bar-active":"")+(n&&!g?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",g?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+u+", "+(g?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",i+" y\u0131ld\u0131z, 0 "+u);for(var y="",c=1;c<=5;c++){var h=c<=i;y+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(h?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ee(h?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+y+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+p+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",v&&(function(x){function f(){l(x)}s.onclick=f,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),f())}})(i),o.appendChild(s)}return o}var $t="data-renuvex-pr-dismiss-gesture",Me=[],Jt=!1,Rr=!1,nr=[],Ge=null;function Zt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Gr(){for(var e=Me.length-1;e>=0;e--){var r=Me[e].element;r&&r.isConnected===!1&&Me.splice(e,1)}return Me}function Wa(e){!e||typeof e.setAttribute!="function"||(nr.indexOf(e)===-1&&nr.push(e),e.setAttribute($t,""))}function Qt(){for(var e=0;e<nr.length;e++){var r=nr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute($t)}nr=[],Ge&&typeof clearTimeout=="function"&&clearTimeout(Ge),Ge=null}function Va(e){if(Rr){Rr=!1,Qt(),e.preventDefault(),e.stopPropagation();return}for(var r=Gr(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Zt(e,n.trigger)||Zt(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Ua(e){if(e.key==="Escape")for(var r=Gr(),t=r.length-1;t>=0;t--)r[t].close()}function ea(){Jt||typeof document=="undefined"||(document.addEventListener("click",Va,!0),document.addEventListener("keydown",Ua),Jt=!0)}function qa(e){ea(),Rr=!0,Wa(e),Ge&&typeof clearTimeout=="function"&&clearTimeout(Ge),typeof setTimeout=="function"&&(Ge=setTimeout(function(){Rr=!1,Qt()},700))}function Kr(e){qa(e)}function Ir(e){ea();var r={trigger:e.trigger,element:e.element,close:e.close};return Me.push(r),{unregister:function(){var t=Me.indexOf(r);t!==-1&&Me.splice(t,1)},notifyOpening:function(){for(var t=Gr(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function $(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,l=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=M(R&&R.writeButtonText,"Yorum Yap"),i.onclick=n,o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-filter-btn",p.setAttribute("aria-label","Filtrele"),p.setAttribute("aria-haspopup","menu"),p.setAttribute("aria-expanded","false");var g=R&&R.filterIcon||"lines";p.innerHTML=me(St(g));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],s=!1;function y(){return r&&r.parentNode||r||null}function c(m,k){if(!(k===!0||!m)){if(m.type==="touchstart"){Kr(y());return}if(m.type==="pointerdown"){var b=m.pointerType||"";b&&b!=="mouse"&&Kr(y());return}}}function h(m){var k=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),p.classList.remove("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","false");var b=m&&(m.restoreFocus===!0||m.restoreFocus==="auto"&&Ye());if(k&&b)try{p.focus({preventScroll:!0})}catch(z){try{p.focus()}catch(E){}}return k}function x(){f.notifyOpening(),v.classList.add("renuvex-pr-open"),p.classList.add("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","true");var m=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");m&&requestAnimationFrame(function(){try{m.focus({preventScroll:!0})}catch(k){try{m.focus()}catch(b){}}})}u.forEach(function(m){var k=m[2],b=k?a:!a&&(t||"newest")===m[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(b?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=m[1];var E=!1;function A(w,T){w&&(w.preventDefault(),w.stopPropagation()),!E&&(E=!0,s=!0,c(w,T),h({restoreFocus:T}),l(m[0],k),setTimeout(function(){E=!1,s=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&A(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){A(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&A(w,!0)}),z.onclick=function(w){A(w,!1)},v.appendChild(z)}),p.onclick=function(){v.classList.contains("renuvex-pr-open")?h({restoreFocus:"auto"}):x()},d.addEventListener("keydown",function(m){m.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(m.stopPropagation(),h({restoreFocus:!0}))}),d.addEventListener("focusout",function(m){if(v.classList.contains("renuvex-pr-open")&&!s){var k=m.relatedTarget;k&&d.contains(k)||h()}});var f=Ir({trigger:d,element:v,close:h});return d.appendChild(p),d.appendChild(v),o.appendChild(d),o}var ra=`
...
`;function ta(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",n.appendChild(l);var o=document.createElement("button");o.className="renuvex-pr-fwizard-close",o.type="button",o.setAttribute("aria-label","Kapat");var i=re(Re);i&&o.appendChild(i),n.appendChild(o);var d=!1,p=null,g=null,v=!1;function u(){te(a)}function s(b){Lr(b,a,p&&p.root)}function y(){if(!d){if(d=!0,document.removeEventListener("keydown",c),a.removeEventListener("click",h),o.removeEventListener("click",y),v)te(g);else{var b=p&&p.root?p.root.activeElement:null;if(b&&typeof b.blur=="function")try{b.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){p?(br(p.root),p.host&&p.host.parentNode&&p.host.parentNode.removeChild(p.host)):a.parentNode&&a.parentNode.removeChild(a),Tr();try{r()}catch(z){}},200)}}function c(b){if(b.key==="Escape"){y();return}s(b)}function h(b){b.target===a&&t&&y()}document.addEventListener("keydown",c),a.addEventListener("click",h),o.addEventListener("click",y);function x(b){g=Ar(),v=Ye(),b&&l.appendChild(b),p=Cr(),We(p.root,je+He+ra),p.root.appendChild(a),Ne(p.root),Er(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),u()})}var f=null,m=null;function k(b,z){if(z=z||"error",f){try{f.remove()}catch(E){}f=null}m&&(clearTimeout(m),m=null),f=document.createElement("div"),f.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,f.textContent=b,n.appendChild(f),m=setTimeout(function(){f&&(f.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(f){try{f.remove()}catch(E){}f=null}},300))},4e3)}return{open:x,close:y,content:l,setAllowOutsideClose:function(b){t=!!b},setStepAttr:function(b){n.setAttribute("data-step",String(b))},showToast:k}}var Xr=4;function Ke(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function aa(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(l){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Xr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(l){return l!==n})}}}}function na(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},l=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=me(De)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var p=[],g=0;g<Xr;g++){var v=document.createElement("span");v.className="renuvex-pr-fwizard-progress-seg",d.appendChild(v),p.push(v)}o.appendChild(d);var u=document.createElement("button");u.type="button";var s=null;function y(h){s&&u.removeEventListener("click",s),s=h,h&&u.addEventListener("click",h)}o.appendChild(u);function c(h,x){var f=r.indexOf(h)!==-1,m=t.indexOf(h)!==-1,k=x&&(x.images&&x.images.length>0||x.pendingImages&&x.pendingImages.length>0);if(f)h===2&&k?(u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",y(function(){l()})):(u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.setAttribute("aria-label","Atla"),u.innerHTML="<span>Atla</span>",y(function(){n()})),u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),u.style.visibility="",u.tabIndex=0;else if(m){u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Sonraki"),u.innerHTML="Sonraki",u.style.visibility="",u.tabIndex=0;var b=Ke(h,x);u.disabled=!b,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!b),y(function(){u.disabled||l()})}else u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.innerHTML="",u.style.visibility="hidden",u.tabIndex=-1,u.disabled=!0,y(null)}return{el:o,update:function(h,x){p.forEach(function(m,k){k+1<=h?m.classList.add("renuvex-pr-fwizard-progress-seg-active"):m.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var f=h<=1;i.style.visibility=f?"hidden":"",i.style.pointerEvents=f?"none":"",i.tabIndex=f?-1:0,c(h,x)},setNextDisabled:function(h){u.classList.contains("renuvex-pr-fwizard-cta-btn")&&(u.disabled=!!h,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!h))},setThanksState:function(h){i.style.visibility="hidden",d.style.visibility="hidden",u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",u.style.visibility="",u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),y(h)}}}var Ga={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function he(e){return M(R&&R[e],Ga[e])}function ia(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent=he("formStepRatingTitle"),t.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=rr(R||{});ke(i);var d=[];function p(h){d.forEach(function(x,f){var m=f<h;x.classList.toggle("renuvex-pr-fwizard-star-active",m),x.setAttribute("aria-checked",f+1===h?"true":"false"),x.innerHTML=m?ee("full"):ee("outline")})}function g(h){e.set({rating:h}),p(h)}function v(h){var x=d[h-1];if(x)try{x.focus()}catch(f){}}function u(h,x){x&&typeof x.preventDefault=="function"&&x.preventDefault(),x&&typeof x.stopPropagation=="function"&&x.stopPropagation(),!a&&(a=!0,g(h),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var s=1;s<=5;s++)(function(h){var x=document.createElement("button");x.type="button",x.className="renuvex-pr-fwizard-star",x.setAttribute("role","radio"),x.setAttribute("aria-label",h+" y\u0131ld\u0131z"),x.innerHTML=ee("outline"),x.addEventListener("mouseenter",function(){p(h)}),x.addEventListener("mouseleave",function(){p(e.get().rating)}),x.addEventListener("pointerdown",function(f){f.button&&f.button!==0||u(h,f)}),typeof window!="undefined"&&!window.PointerEvent&&x.addEventListener("touchstart",function(f){u(h,f)},{passive:!1}),x.addEventListener("mousedown",function(f){window.PointerEvent||u(h,f)}),x.addEventListener("keydown",function(f){if(f.key==="Enter"||f.key===" "){u(h,f);return}var m=0;f.key==="ArrowRight"||f.key==="ArrowUp"?m=Math.min(5,h+1):f.key==="ArrowLeft"||f.key==="ArrowDown"?m=Math.max(1,h-1):f.key==="Home"?m=1:f.key==="End"&&(m=5),m&&(f.preventDefault(),g(m),v(m))}),x.addEventListener("click",function(f){u(h,f)}),d.push(x),o.appendChild(x)})(s);p(e.get().rating);var y=null,c=function(h){var x=h&&h.detail&&h.detail.settings;x&&x===y||(y=x||null,i=rr(x||R||{}),p(e.get().rating))};return window.addEventListener(Ie,c),t.appendChild(o),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ie,c)}}}var oa=3,Ka=10*1024*1024;function la(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=he("formStepPhotosTitle"),a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=he("formStepPhotosSubtitle"),a.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",o.appendChild(i),o.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),o.appendChild(p),a.appendChild(o);var g=r.revokeBlobUrl||function(f){f&&typeof f=="string"&&f.startsWith("blob:")&&URL.revokeObjectURL(f)},v=r.blobMap||{},u=r.urlToFinger||{};function s(){if(!t){var f=e.get().images||[],m=e.get().pendingImages||[],k=f.map(function(b){return{url:b,isPending:!1}}).concat(m.map(function(b){return{url:b.url,file:b.file,isPending:!0,error:b.error}}));p.innerHTML="",k.forEach(function(b){var z=v[b.url]||b.url,E=y(b,z);p.appendChild(E)}),h()}}function y(f,m){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var b=document.createElement("img");b.src=m,b.alt="",b.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(b);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",k.appendChild(z);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var A=re(Re);return A&&E.appendChild(A),k.appendChild(E),c(k,f,m),k}function c(f,m,k){var b=f.querySelector("img");b.src!==k&&(b.src=k);var z=f.querySelector(".renuvex-pr-fwizard-photo-loading");if(m.isPending&&m.error){z.style.display="flex",z.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+m.error,z.appendChild(E)}else z.style.display="none",z.textContent="";var A=f.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var w=u[m.url]||(m.file?m.file.name+"_"+m.file.size:null),T=v[m.url],C={};w&&(C.fingerprints=(e.get().fingerprints||[]).filter(function(L){return L!==w})),m.isPending?C.pendingImages=(e.get().pendingImages||[]).filter(function(L){return L.url!==m.url}):C.images=(e.get().images||[]).filter(function(L){return L!==m.url}),e.set(C),g(m.url),g(T),delete u[m.url],T&&delete u[T],v[m.url]&&delete v[m.url]}}function h(){var f=(e.get().images||[]).length,m=(e.get().pendingImages||[]).length,k=f+m,b=k>=oa;k>0?(o.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(At)):(o.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(Tt)+"<span>Foto\u011Fraf Ekle</span>"),b?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(f){var m=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(f.target.files).slice(0,oa-m);d.value="";var b=(e.get().pendingImages||[]).length,z=e.get().images||[],E=z.length;if(k.length!==0){for(var A=[],w=[],T=0;T<k.length;T++){var C=k[T],L=C.name+"_"+C.size,P=(e.get().fingerprints||[]).some(function(H){return H===L})||A.some(function(H){return H.file.name+"_"+H.file.size===L});if(!P){if(C.size>Ka){var S="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(S,"error"):alert(S);continue}var N=URL.createObjectURL(C);u[N]=L,A.push({url:N,file:C,error:null}),w.push({url:N,file:C});var D=(e.get().fingerprints||[]).slice();D.push(L),e.set({fingerprints:D})}}if(A.length!==0){var G=(e.get().pendingImages||[]).concat(A),Q=async function(){for(var H=0;H<w.length;H++){var ne=w[H],U=ne.file,q=ne.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ie=(e.get().pendingImages||[]).filter(function(O){return O.url!==q}),oe=(e.get().images||[]).slice();oe.push(q),e.set({pendingImages:ie,images:oe});continue}try{var le=await tr(Qe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:$e})});if(!le.ok)throw le.status===429?new Error("rate_limit"):new Error("sign failed");var Y=await le.json();if(!Y.folder)throw new Error("sign folder missing");var B=new FormData;B.append("file",U),B.append("api_key",Y.api_key),B.append("timestamp",Y.timestamp),B.append("signature",Y.signature),B.append("folder",Y.folder);var ve=await fetch("https://api.cloudinary.com/v1_1/"+Y.cloud_name+"/image/upload",{method:"POST",body:B}),I=await ve.json();if(I.secure_url&&Nt(I.secure_url)){var Te=(e.get().pendingImages||[]).some(function(O){return O.url===q});if(!Te)continue;v[I.secure_url]=q,u[I.secure_url]=u[q];var ae=(e.get().pendingImages||[]).filter(function(O){return O.url!==q}),Ze=(e.get().images||[]).slice();Ze.push(I.secure_url),e.set({pendingImages:ae,images:Ze});try{tr(Qe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:$e,secureUrl:I.secure_url,metadata:{assetId:I.asset_id,publicId:I.public_id,version:I.version,resourceType:I.resource_type,format:I.format,width:I.width,height:I.height,bytes:I.bytes,signature:I.signature}})}).catch(function(){})}catch(O){}}else throw new Error("invalid image url")}catch(O){console.error("[renuvex-pr] Image upload failed:",O);var ye=O.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ye,"error");var _=(e.get().pendingImages||[]).map(function(K){return K.url===q?{url:K.url,file:K.file,error:ye}:K});e.set({pendingImages:_})}}};if(E===0&&b===0){t=!0;var j=!r.canNavigate||r.canNavigate();j&&e.goNext()}e.set({pendingImages:G}),Q()}}};var x=e.onChange(s);return s(),{el:a,destroy:function(){t=!0,d.onchange=null,x&&x()}}}var Jr=2e3,Xa=60;function pa(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=he("formStepContentTitle"),a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Xa,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),l.appendChild(o);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Jr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),l.appendChild(d);function p(){var v=i.value.length;d.textContent=v+"/"+Jr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",v>=Jr)}function g(){return Ke(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),p(),t(g())}),a.appendChild(l),p(),setTimeout(function(){t(g())},0),{el:a,destroy:function(){}}}var Ja=40;function ua(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=he("formStepAuthorTitle"),n.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.maxLength=Ja,p.setAttribute("aria-required","true"),p.value=e.get().author||"",i.appendChild(d),i.appendChild(p),o.appendChild(i);var g=document.createElement("div");g.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.textContent="E-posta (opsiyonel)";var u=document.createElement("input");u.type="email",u.className="renuvex-pr-fwizard-input",u.setAttribute("autocomplete","email"),u.value=e.get().email||"",g.appendChild(v),g.appendChild(u),o.appendChild(g);var s=document.createElement("div");s.className="renuvex-pr-fwizard-notice",s.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(s);var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg",y.setAttribute("role","alert"),y.setAttribute("aria-live","assertive"),o.appendChild(y);var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-submit-btn",c.textContent="G\xF6nder",o.appendChild(c),n.appendChild(o);function h(){return Ke(4,e.get())}function x(){var b=!h(),z=(e.get().pendingImages||[]).length,E=z>0;E?(c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(c.disabled=b,c.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",b),c.textContent="G\xF6nder")}p.addEventListener("input",function(){e.set({author:p.value}),x(),t(h())}),u.addEventListener("input",function(){e.set({email:u.value})}),x(),setTimeout(function(){t(h())},0);function f(){y.textContent=""}function m(b){f();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=b||"",y.appendChild(z)}c.onclick=async function(){if(!c.disabled){var b=e.get(),z=(b.author||"").trim(),E=(b.comment||"").trim();if(u.value.trim()&&!u.checkValidity()){u.reportValidity();return}if(!z){m("Gerekli alan");return}if(!b.rating){m("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=c.textContent;if(c.textContent="G\xF6nderiliyor\u2026",f(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var w=Lt(window.location.href),T=b.productName||null,C=await tr(Qe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:$e,productId:b.productId||null,slug:w||null,productName:T,author:z,title:(b.title||"").trim()||null,comment:E||null,rating:b.rating,images:b.images||[]})},15e3);if(C.ok)a();else{var L=await C.json().catch(function(){return{}});throw new Error(L.error||"Yorum kaydedilemedi.")}}catch(N){var P=N&&(N.name==="AbortError"||/signal/i.test(N.message||"")),S=P?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":N.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(S,"error"):m(S),c.disabled=!1,c.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent=A}}};var k=e.onChange(x);return{el:n,destroy:function(){c.onclick=null,k&&k()}}}function Za(e,r,t){if(t=t||{},e===1)return ia(r,{canNavigate:t.canNavigate});if(e===2)return la(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return pa(r,{onValidityChange:t.onValidityChange});if(e===4)return ua(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function da(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function sa(e){e=e||{};var r=aa({productId:e.productId,productName:e.productName}),t={},a={},n={};function l(w){if(!(!w||typeof w!="string"||!w.startsWith("blob:")||n[w])){n[w]=!0;try{URL.revokeObjectURL(w)}catch(T){}}}function o(){Object.keys(a).forEach(function(T){l(T)}),Object.keys(t).forEach(function(T){l(t[T])});var w=r.get();(w.pendingImages||[]).forEach(function(T){l(T&&T.url)}),(w.images||[]).forEach(function(T){l(T)})}var i=ta({onClose:function(){window.removeEventListener("popstate",p),Nr(d),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=Pr(),p=function(w){i&&i.close&&i.close()};window.addEventListener("popstate",p);var g=document.createElement("div");g.className="renuvex-pr-fwizard-step-wrap";var v=na({skippableSteps:[2],nextableSteps:[3],onBack:function(){y==="idle"&&r.goBack()},onSkip:function(){y==="idle"&&r.goNext()},onNext:function(){y==="idle"&&r.goNext()}}),u=document.createElement("div");u.className="renuvex-pr-fwizard-layout",u.appendChild(g),u.appendChild(v.el);var s=null,y="idle",c=null,h=!0,x=null;function f(w,T){g.innerHTML="";var C=Za(w,r,{canNavigate:function(){return y==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:l,onValidityChange:function(S){v.setNextDisabled(!S)},onSuccess:k,showToast:i.showToast});if(s=C,v.update(w,r.get()),T){y="entering",C.el.classList.add("renuvex-pr-fwizard-step--enter");var L=null,P=function(){L&&clearTimeout(L),C.el.removeEventListener("animationend",P),C.el.classList.remove("renuvex-pr-fwizard-step--enter"),y="idle",c!==null&&b()};C.el.addEventListener("animationend",P),L=setTimeout(P,700)}else y="idle";g.appendChild(C.el),i.setStepAttr&&i.setStepAttr(w),w===3&&v.setNextDisabled(!0)}var m=!1;function k(){if(!m){if(m=!0,!s){g.innerHTML="";var w=da();w.classList.add("renuvex-pr-fwizard-step--enter"),g.appendChild(w),i.setStepAttr("thanks"),v.setThanksState(i.close);return}var T=s;y="exiting",T.el.classList.add("renuvex-pr-fwizard-step--exit");var C=function(){if(x&&clearTimeout(x),T.el.removeEventListener("animationend",C),T.destroy)try{T.destroy()}catch(P){}s===T&&(s=null),g.innerHTML="";var L=da();L.classList.add("renuvex-pr-fwizard-step--enter"),g.appendChild(L),i.setStepAttr("thanks"),v.setThanksState(i.close),y="idle"};T.el.addEventListener("animationend",C),x=setTimeout(C,300)}}function b(){var w=r.get().currentStep;if(y!=="idle"){c=w;return}if(!s){var T=!h;h=!1,f(w,T);return}var C=s;y="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(x&&clearTimeout(x),C.el.removeEventListener("animationend",L),C.destroy)try{C.destroy()}catch(S){}if(s===C){g.innerHTML="",s=null;var P=c!==null?c:r.get().currentStep;c=null,f(P,!0),y="idle"}};C.el.addEventListener("animationend",L),x=setTimeout(L,350)}b();var z=r.get().currentStep,E=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,b()):v.update(w.currentStep,w)}),A=i.close;return i.close=function(){E&&E(),typeof x!="undefined"&&x&&clearTimeout(x),A()},i.open(u),{close:i.close}}function V(){sa({productId:F||"",productName:Le||""})}var va=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var $a={id:"classic",name:"Klasik (A\xE7\u0131k)"},Qa=va;function en(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,l=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,g=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange;ke(n);var s=document.createElement("div");s.className="renuvex-pr-summary";var y=(o[3]||0)+(o[4]||0),c=l>0?Math.round(y/l*100):0,h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-avg",h.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ee("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",s.appendChild(h);var x=document.createElement("div");if(x.className="renuvex-pr-summary-block renuvex-pr-summary-count",x.textContent=l.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum"),s.appendChild(x),a.showRecommendation!==!1&&c>0){var f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",f.innerHTML='<span class="renuvex-pr-recommend-pct">%'+c+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",s.appendChild(f)}return s.appendChild(qe({ratingCounts:o,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:v})),s.appendChild($({widget:r,currentOrderBy:p,currentHasImages:g,onWriteClick:V,onSortChange:u})),s}var $r={};we($r,{css:()=>tn,meta:()=>rn,render:()=>ln});var ca=`
...
`;var rn={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},tn=ca,an="__unknown_product__",ir=Object.create(null);function nn(e){return e?String(e):an}var _e=null,or=null;function on(){!_e||!or||(_e.removeEventListener?_e.removeEventListener("change",or):_e.removeListener&&_e.removeListener(or),_e=null,or=null)}function ln(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,l=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,g=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange,s=nn(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var h=document.createElement("div");h.className="renuvex-pr-compact-trigger-wrap";var x=document.createElement("button");x.className="renuvex-pr-compact-trigger",x.type="button",x.setAttribute("aria-expanded","false"),x.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Ce(i,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+me(Et)+"</span>";var f=x.querySelector(".renuvex-pr-compact-trigger-text"),m=x.querySelector(".renuvex-pr-compact-chevron");if(f&&(f.textContent=l.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum")),f&&m){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",x.insertBefore(k,f),k.appendChild(f),k.appendChild(m)}h.appendChild(x),c.appendChild(h);var b=$({widget:r,currentOrderBy:p,currentHasImages:g,onWriteClick:V,onSortChange:u}),z=b.querySelector(".renuvex-pr-filter-wrap"),E=b.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+ee("full")+"</span><span>"+i+"</span>",T.appendChild(C),T.appendChild(qe({ratingCounts:o,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:function(B){P()&&w.classList.contains("renuvex-pr-open")&&(ir[s]=!0),v(B)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function S(B){B?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",B?"false":"true"),x.setAttribute("aria-expanded",B?"true":"false")}function N(B){var ve=B?y:h;if(w.parentNode!==ve){var I=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&S(!1),I&&(ir[s]=!1),ve.appendChild(w)}}N(L?L.matches:!1);var D=$({widget:r,currentOrderBy:p,currentHasImages:g,onWriteClick:V,onSortChange:u}),G=D.querySelector(".renuvex-pr-filter-wrap"),Q=D.querySelector(".renuvex-pr-write-btn"),j=document.createElement("div");j.className="renuvex-pr-compact-write-row",Q&&j.appendChild(Q),G&&j.appendChild(G),y.appendChild(j);function H(){var B=w.classList.contains("renuvex-pr-open");return S(!1),P()&&(ir[s]=!1),B}function ne(){U&&U.notifyOpening(),S(!0),P()&&(ir[s]=!0)}x.onclick=function(){w.classList.contains("renuvex-pr-open")?H():ne()};var U=null;function q(B){U&&(U.unregister(),U=null),B||(U=Ir({trigger:h,element:w,close:H}))}if(q(L?L.matches:!1),on(),L){var ie=function(B){N(B.matches),q(B.matches)};L.addEventListener?L.addEventListener("change",ie):L.addListener&&L.addListener(ie),_e=L,or=ie}if(P()&&ir[s]&&S(!0),a.showRecommendation!==!1){var oe=(o[3]||0)+(o[4]||0),le=l>0?Math.round(oe/l*100):0;if(le>0){var Y=document.createElement("div");Y.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",Y.style.marginTop="8px",Y.innerHTML='<span class="renuvex-pr-recommend-pct">%'+le+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(Y)}}return y}var Qr={};we(Qr,{css:()=>un,meta:()=>pn,render:()=>dn});var ma=`
...
`;var pn={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},un=ma;function dn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,o=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,p=e.currentHasImages,g=e.onFilterChange,v=e.onSortChange;ke(a);var u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",y.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ee("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",c.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),s.appendChild(c),u.appendChild(s);var h=document.createElement("div");h.className="renuvex-pr-split-col renuvex-pr-split-mid",h.appendChild(qe({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:g})),u.appendChild(h);var x=$({widget:r,currentOrderBy:d,currentHasImages:p,onWriteClick:V,onSortChange:v}),f=x.querySelector(".renuvex-pr-filter-wrap"),m=x.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-right",m&&k.appendChild(m),f&&k.appendChild(f),u.appendChild(k);var b=(l[3]||0)+(l[4]||0),z=n>0?Math.round(b/n*100):0,E=document.createElement("div");E.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",E.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||z===0;return A&&E.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(E),u}var et={};we(et,{css:()=>vn,meta:()=>sn,render:()=>cn});var xa=`
...
`;var sn={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},vn=xa;function cn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.avgRatingVal,o=e.currentOrderBy,i=e.currentHasImages,d=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-minimal";var g=document.createElement("div");g.className="renuvex-pr-minimal-info";var v=document.createElement("div");v.className="renuvex-pr-minimal-row";var u=document.createElement("span");u.className="renuvex-pr-minimal-avg",u.textContent=l,v.appendChild(u);var s=document.createElement("span");s.className="renuvex-pr-minimal-stars",s.innerHTML=Ce(l,a),v.appendChild(s);var y=document.createElement("span");y.className="renuvex-pr-minimal-count",y.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),v.appendChild(y),g.appendChild(v),p.appendChild(g);var c=$({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),h=c.querySelector(".renuvex-pr-filter-wrap"),x=c.querySelector(".renuvex-pr-write-btn"),f=document.createElement("div");f.className="renuvex-pr-minimal-actions",x&&f.appendChild(x),h&&f.appendChild(h),p.appendChild(f);var m=$({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),k=m.querySelector(".renuvex-pr-filter-wrap"),b=m.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-minimal-write-row",b&&z.appendChild(b),k&&z.appendChild(k),p.appendChild(z),p}var rt={};we(rt,{css:()=>xn,meta:()=>mn,render:()=>fn});var fa=`
...
`;var mn={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},xn=fa;function fn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.avgRatingVal,o=e.currentOrderBy,i=e.currentHasImages,d=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-hero";var g=document.createElement("div");g.className="renuvex-pr-hero-info";var v=document.createElement("div");v.className="renuvex-pr-hero-rating-col";var u=document.createElement("span");u.className="renuvex-pr-hero-avg",u.textContent=l,v.appendChild(u);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var y=document.createElement("span");y.className="renuvex-pr-hero-stars",y.innerHTML=Ce(l,a),s.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-hero-count",c.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),s.appendChild(c),v.appendChild(s),g.appendChild(v),p.appendChild(g);var h=$({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),x=h.querySelector(".renuvex-pr-filter-wrap"),f=h.querySelector(".renuvex-pr-write-btn"),m=document.createElement("div");m.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",f&&m.appendChild(f),x&&m.appendChild(x),p.appendChild(m);var k=$({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),b=k.querySelector(".renuvex-pr-filter-wrap"),z=k.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");return E.className="renuvex-pr-hero-write-row",z&&E.appendChild(z),b&&E.appendChild(b),p.appendChild(E),p}var ga=`
  .renuvex-pr-summary{
...
`;var gn={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},hn=ba;function bn(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var l=document.createElement("span");l.className="renuvex-pr-review-stars",l.innerHTML=xe(e.rating,R),n.appendChild(l);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var p=(e.comment||"").trim();p&&t.appendChild(Xe(p,"renuvex-pr-body").fragment);var g=Se(e);if(g.length){var v=document.createElement("div");v.className="renuvex-pr-gallery",g.forEach(function(s){var y=document.createElement("img"),c=pe(s,Z);y.src=c.src,y.srcset=c.srcset,y.loading="lazy",y.decoding="async",y.width=Z,y.height=Z,y.className="renuvex-pr-img",ue(y),y.setAttribute("data-renuvex-img-url",s),(function(h){Ee(y,function(){se(e,h,r)})})(s),v.appendChild(y)}),t.appendChild(v)}var u=Je(e.merchantReply);return u&&t.appendChild(u),t}var at={};we(at,{css:()=>wn,meta:()=>yn,render:()=>zn});var ya=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var yn={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},wn=ya;function zn(e,r){var t=Se(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=xe(e.rating,R),l.appendChild(o);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",l.appendChild(i);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=fe(e.createdAt),l.appendChild(d),n.appendChild(l);var p=document.createElement("div");if(p.className="renuvex-pr-review-list-content",e.title){var g=document.createElement("div");g.className="renuvex-pr-review-list-title",g.textContent=e.title,p.appendChild(g)}var v=(e.comment||"").trim();v&&p.appendChild(Xe(v,"renuvex-pr-review-list-body").fragment);var u=Je(e.merchantReply);if(u&&p.appendChild(u),n.appendChild(p),a){var s=document.createElement("div");s.className="renuvex-pr-review-list-media",t.forEach(function(y){var c=document.createElement("img"),h=pe(y,Z);c.src=h.src,c.srcset=h.srcset,c.loading="lazy",c.decoding="async",c.width=Z,c.height=Math.round(Z*4/3),c.setAttribute("data-renuvex-img-url",y),ue(c),(function(x){Ee(c,function(){se(e,x,r)})})(y),s.appendChild(c)}),n.appendChild(s)}return n}var nt={};we(nt,{css:()=>Cn,meta:()=>kn,render:()=>Sn});var wa=`
...
`;var kn={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Cn=wa;function Sn(e,r){var t=wr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=xe(e.rating,R),l.appendChild(o),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,l.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",l.appendChild(d);var p=document.createElement("time");p.className="renuvex-pr-review-gallery-date",p.style.display="block",e.createdAt&&p.setAttribute("datetime",e.createdAt),p.textContent=fe(e.createdAt),l.appendChild(p);var g=(e.comment||"").trim();if(g&&l.appendChild(Xe(g,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){se(e,t,r)}}:null).fragment),n.appendChild(l),a){var v=document.createElement("div");v.className="renuvex-pr-review-gallery-media";var u=document.createElement("img"),s=pe(t,zr);u.src=s.src,u.srcset=s.srcset,u.loading="lazy",u.decoding="async",u.width=zr,u.height=Math.round(zr*4/3),ue(u),u.setAttribute("data-renuvex-img-url",t),Ee(u,function(){se(e,t,r)}),v.appendChild(u),n.appendChild(v)}var y=Je(e.merchantReply,t?function(){se(e,t,r)}:null);return y&&(y.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(y)),n}var _r={card:tt,list:at,gallery:nt};function Fr(e){return _r[e]||_r.card}function za(){return Object.keys(_r).map(function(e){return _r[e].css||""}).join(`
`)}var it=0;function Fe(){return it++,it}function Oe(e,r){return e!==it?!1:r?!(r.productId!==void 0&&F!==r.productId||r.orderBy!==void 0&&W!==r.orderBy||r.page!==void 0&&er!==r.page||r.ratingFilter!==void 0&&X!==r.ratingFilter||r.hasImages!==void 0&&J!==r.hasImages||r.nextCursor!==void 0&&mr!==r.nextCursor):!0}var ot={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},lt={small:80,medium:110,large:140},pt={small:80,medium:100,large:110};function ka(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),a.appendChild(n),a.appendChild(l);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(i),r}function Ca(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var a=document.createElement("div");a.className="renuvex-pr-empty-state-title",a.textContent="Bu \xFCr\xFCn i\xE7in hen\xFCz yorum yok",t.appendChild(a);var n=document.createElement("div");n.className="renuvex-pr-empty-state-stars",n.innerHTML=Ce(0,e.iconPair),t.appendChild(n);var l=document.createElement("p");l.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",l.setAttribute("role","status"),l.setAttribute("aria-live","polite"),l.textContent="\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(l),r.appendChild(t);var o=document.createElement("button");return o.type="button",o.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",o.textContent=e.writeButtonText||"Yorum Yap",o.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(o),r}function Sa(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function be(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+a+","+n+","+l+","+r+")"}function Or(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function ut(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function Ea(e){return .2126*ut(e.r)+.7152*ut(e.g)+.0722*ut(e.b)}function Ta(e,r){var t=Ea(e),a=Ea(r),n=Math.max(t,a),l=Math.min(t,a);return(n+.05)/(l+.05)}function En(e){var r=Or(e)||Or("#ffffff"),t=Or("#111111"),a=Or("#ffffff");return Ta(t,r)>=Ta(a,r)?"#111111":"#ffffff"}function Tn(e){return be(e,e==="#ffffff"?.1:.06)}function Aa(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",p=be(o,.06),g=r.reviewStarColor||"#f59e0b",v=r.btnBgColor||"#111111",u=r.btnTextColor||"#ffffff",s=r.btnBorderColor||"#111111",y=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",h=r.filterBtnBorderColor||"#111111",x=r.filterMenuBgColor||"#ffffff",f=r.filterMenuBorderColor||"#e5e7eb",m=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",b=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",E=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",w=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",C=be(w,.65),L=r.replyBgColor||"#f9fafb",P=r.replyBorderColor||"#747474",S=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",D=r.photoTitleColor||"#111111",G=be("#111111",.05),Q=r.photoArrowBgColor||"#ffffff",j=r.photoArrowTextColor||"#111111",H=be("#111111",.12),ne=r.formBgColor||"#ffffff",U=r.formPrimaryTextColor||"#111111",q=r.formSecondaryTextColor||"#3b3b3b",ie=r.inputTextColor||U,oe=r.inputBorderColor||"#d1d5db",le=r.placeholderColor||"#9ca3af",Y=r.formStepBarColor||"#111111",B=r.formBtnBgColor||"#111111",ve=r.formBtnTextColor||"#ffffff",I=r.formBtnBorderColor||"#111111",Te=be(B,.06),ae=be(B,.18),Ze=be(ve,.85),ye=be(U,.06),_=En(ne),O=Tn(_),K=r.loadMoreBgColor||"#ffffff",Ae=r.loadMoreTextColor||"#111111",lr=r.loadMoreBorderColor||"#111111",pr=r.paginationBgColor||"#ffffff",ur=r.paginationTextColor||"#111111",dr=r.paginationBorderColor||"#e5e7eb",ce=r.paginationActiveBgColor||"#111111",sr=r.paginationActiveTextColor||"#ffffff",vr={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":p,"--renuvex-pr-btn-bg":v,"--renuvex-pr-btn-text":u,"--renuvex-pr-btn-border":s,"--renuvex-pr-filter-btn-bg":y,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":h,"--renuvex-pr-filter-menu-bg":x,"--renuvex-pr-filter-menu-border":f,"--renuvex-pr-filter-item-text":m,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":b,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":E,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":w,"--renuvex-pr-review-border":T,"--renuvex-pr-state-text":C,"--renuvex-pr-review-star-color":g,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":P,"--renuvex-pr-reply-label":S,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":D,"--renuvex-pr-photo-image-border":G,"--renuvex-pr-photo-arrow-bg":Q,"--renuvex-pr-photo-arrow-text":j,"--renuvex-pr-photo-arrow-border":H,"--renuvex-pr-fwizard-bg":ne,"--renuvex-pr-fwizard-text":U,"--renuvex-pr-fwizard-secondary-text":q,"--renuvex-pr-fwizard-input-bg":ne,"--renuvex-pr-fwizard-input-text":ie,"--renuvex-pr-fwizard-input-border":oe,"--renuvex-pr-fwizard-placeholder":le,"--renuvex-pr-fwizard-close-text":_,"--renuvex-pr-fwizard-close-hover-bg":O,"--renuvex-pr-fwizard-progress-bg":ye,"--renuvex-pr-fwizard-progress-active":Y,"--renuvex-pr-fwizard-btn-bg":B,"--renuvex-pr-fwizard-btn-text":ve,"--renuvex-pr-fwizard-btn-border":I,"--renuvex-pr-fwizard-btn-disabled-bg":ae,"--renuvex-pr-fwizard-btn-disabled-text":Ze,"--renuvex-pr-fwizard-nav-hover-bg":Te,"--renuvex-pr-load-more-bg":K,"--renuvex-pr-load-more-text":Ae,"--renuvex-pr-load-more-border":lr,"--renuvex-pr-pagination-bg":pr,"--renuvex-pr-pagination-text":ur,"--renuvex-pr-pagination-border":dr,"--renuvex-pr-pagination-active-bg":ce,"--renuvex-pr-pagination-active-text":sr};Object.keys(vr).forEach(function(cr){e.style.setProperty(cr,vr[cr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function La(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,l=e.wireLightboxTrigger,o=(e.photoStripReviews||[]).filter(function(k){return Se(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&o.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=M(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),p=document.createElement("div");p.className="renuvex-pr-photo-title",p.textContent=d,i.appendChild(p)}var g=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",g);var v=document.createElement("div");v.className="renuvex-pr-photo-strip";var u=Z,s=r.reviewLayout==="card"?Z:Math.round(Z*4/3),y=0;o.forEach(function(k){if(!(y>=15)){var b=wr(k);if(b){var z=document.createElement("img"),E=pe(b,Z);z.src=E.src,z.srcset=E.srcset,z.loading=y<3?"eager":"lazy",z.decoding="async",z.width=u,z.height=s,z.className="renuvex-pr-photo-strip-thumb",z.alt="Yorum foto\u011Fraf\u0131",ue(z),(function(A,w){l(z,function(){n(w,A,o)})})(b,k),v.appendChild(z),y++}}});var c=document.createElement("button");c.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var h=re(De);h&&c.appendChild(h),c.setAttribute("aria-label","\xD6nceki"),c.onclick=function(){v.scrollBy({left:-200,behavior:"smooth"})};var x=document.createElement("button");x.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var f=re(yr);f&&x.appendChild(f),x.setAttribute("aria-label","Sonraki"),x.onclick=function(){v.scrollBy({left:200,behavior:"smooth"})};var m=document.createElement("div");return m.className="renuvex-pr-photo-strip-wrap",m.appendChild(c),m.appendChild(v),m.appendChild(x),i.appendChild(m),i}var An=1,Ln=7,dt="\u2026";function Pn(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Ln){for(var n=[],l=1;l<=t;l++)n.push(l);return n}for(var o=[],i=1;i<=t;i++)(i===1||i===t||Math.abs(i-a)<=An)&&o.push(i);for(var d=[],p=0;p<o.length;p++)p>0&&o[p]-o[p-1]>1&&d.push(dt),d.push(o[p]);return d}function Pa(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function l(i){n.setAttribute("aria-busy","true");for(var d=n.querySelectorAll("button"),p=0;p<d.length;p++)d[p].disabled=!0;a(i)}function o(i,d,p,g){var v=document.createElement("button");return v.type="button",v.className="renuvex-pr-pagination-arrow",v.setAttribute("aria-label",i),v.textContent=d,g?v.disabled=!0:v.onclick=function(){l(p)},v}return n.appendChild(o("\xD6nceki sayfa","\u2039",t-1,t<=1)),Pn(t,r).forEach(function(i){if(i===dt){var d=document.createElement("span");d.className="renuvex-pr-pagination-gap",d.setAttribute("aria-hidden","true"),d.textContent=dt,n.appendChild(d);return}var p=document.createElement("button");p.type="button",p.className="renuvex-pr-pagination-btn",p.textContent=String(i),p.setAttribute("aria-label","Sayfa "+i),i===t?p.setAttribute("aria-current","page"):p.onclick=function(){l(i)},n.appendChild(p)}),n.appendChild(o("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Na(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Ra(e){var r=e.render;async function t(){var o=Fe(),i=F,d=W,p=X,g=J;ze(null);var v=await Be(F,W,1,X,J);Oe(o,{productId:i,orderBy:d,ratingFilter:p,hasImages:g})&&await r(F,R,v,Le,W,1,vt)}async function a(o){var i=Fe(),d=X===o?null:o,p=F,g=W,v=J;mt(d),Pe(1),ze(null);var u=await Be(F,W,1,d,J);Oe(i,{productId:p,orderBy:g,page:1,ratingFilter:d,hasImages:v})&&await r(F,R,u,Le,W,1)}async function n(o,i){var d=Fe(),p=F,g=X;Pe(1),ze(null);var v=o,u=!1;i&&(u=!0,v="newest"),xt(u),xr(v);var s=await Be(F,v,1,X,u);Oe(d,{productId:p,orderBy:v,page:1,ratingFilter:g,hasImages:u})&&await r(F,R,s,Le,v,1)}async function l(o){var i=Fe(),d=F,p=W,g=X,v=J;Pe(o),ze(null);var u=await Be(F,W,o,X,J);if(Oe(i,{productId:d,orderBy:p,page:o,ratingFilter:g,hasImages:v})){await r(F,R,u,Le,W,o);var s=document.getElementById("renuvex-reviews"),y=s&&s.shadowRoot,c=y&&y.querySelector&&y.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(c){try{c.focus({preventScroll:!0})}catch(f){try{c.focus()}catch(m){}}Na(y,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var h=document.getElementById("renuvex-reviews");if(h&&typeof h.scrollIntoView=="function"){var x=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;h.scrollIntoView({behavior:x?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:l}}function Nn(){return Mt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Rn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=It({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),Bt(t,{surface:"reviews",productId:r||""}),t}async function st(e,r,t,a,n,l,o){if(Ct){hr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:l,badgeSettings:o});return}gr(!0),ft(e),gt(r),o!==void 0&&ht(o),bt(a),n&&xr(n),l&&Pe(l),t!=null&&(yt(t),ze(t&&t.data?t.data.nextCursor:null));var i=Ra({render:st});try{let ye=function(_,O){if(!(!_||!_.meta||!_.meta.sizeOverrides)){var K=_.meta.sizeOverrides[O];K&&Object.keys(K).forEach(function(Ae){s.style.setProperty(Ae,K[Ae])})}};var Ze=ye,d=Mr(r.summaryLayout),p=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),g=r.showTitle!==!1,v=M(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),u=p&&g?v:"",s=document.documentElement;Aa(s,r);var y=r.borderRadius!==void 0?r.borderRadius:8,c=ot[r.size]||ot.medium,h=lt[r.thumbnailSize]||lt.medium,x=h;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(x=pt[r.thumbnailSize]||pt.medium),s.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),s.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),s.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),s.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),s.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),s.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),s.style.setProperty("--renuvex-pr-radius",y+"px"),s.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),s.style.setProperty("--renuvex-pr-photo-title-size",c.photoTitleSize+"px"),s.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),s.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),s.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),s.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),s.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),s.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),s.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),s.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),s.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),s.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),s.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),s.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),s.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),s.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),s.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size",h+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size-mobile",x+"px");var f=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";s.style.setProperty("--renuvex-pr-review-star-color",f),s.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),s.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),ye(Mr(r.summaryLayout),r.size),ye(Fr(r.reviewLayout),r.size);var m=rr(r),k=Nn();if(!k)return;var b=Rn(k,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==b&&b.appendChild(z);var E=_t(z),A=je+He+Sr+ha()+za();We(E,A);var w=Ot(E);if(r.enabled===!1){z.style.minHeight="auto",w.replaceChildren(ka(r.borderRadius!==void 0?r.borderRadius:8)),gr(!1);var T=fr;hr(null),T&&st(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var C=t||{},L=Wr(C),P=L?[]:C.data&&C.data.reviews||[];wt(P),w.replaceChildren();var S=document.createElement("section");if(S.id="renuvex-reviews-widget",S.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),S.className="renuvex-pr-reviews-widget",S.setAttribute("data-renuvex-surface","reviews"),e&&S.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),u){var N=document.createElement("div"),D=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+D,N.textContent=u,S.appendChild(N)}if(L){S.appendChild(Sa(C.message,i.onRetry)),w.appendChild(S),Ne(E),Hr(S,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return E.getElementById("renuvex-reviews-widget")});return}var G=C.data&&C.data.allCount||0,Q=C.data&&C.data.ratingCounts||null,j=Q||[0,0,0,0,0],H=C.data&&C.data.avgRating||"0.0";if(!Q&&P.length>0){P.forEach(function(_){_.rating>=1&&_.rating<=5&&j[_.rating-1]++});var ne=P.reduce(function(_,O){return _+O.rating},0);H=(ne/P.length).toFixed(1)}if(G===0)S.appendChild(Ca({iconPair:m,writeButtonText:M(r.writeButtonText,"Yorum Yap"),onWriteClick:V}));else{var U=Mr(r.summaryLayout),q=U.render({widget:S,productId:e,data:C,settings:r,iconPair:m,allCount:G,ratingCounts:j,avgRatingVal:H,currentRatingFilter:X,currentOrderBy:W,currentHasImages:J,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});S.appendChild(q);var ie=La({settings:r,root:s,currentHasImages:J,photoStripReviews:ct,openReviewModal:se,wireLightboxTrigger:Ee});if(ie&&S.appendChild(ie),P.length===0){var oe=document.createElement("p");oe.className="renuvex-pr-state-msg",oe.textContent="Hen\xFCz yorum yok.",S.appendChild(oe)}else{var le=Fr(r.reviewLayout);P.forEach(function(_){S.appendChild(le.render(_,Yr))})}var Y=r.paginationMode==="numbered"?"numbered":"loadMore";if(Y==="numbered"){var B=C.data&&C.data.totalPages||1;B>1&&S.appendChild(Pa({page:C.data&&C.data.page||er||1,totalPages:B,onPageChange:i.onPageChange}))}var ve=Y==="loadMore"&&C.data&&C.data.hasMore;if(ve){var I=document.createElement("button");I.className="renuvex-pr-load-more",I.textContent="Daha Fazla G\xF6ster",I.onclick=async function(){I.disabled=!0,I.textContent="Y\xFCkleniyor...";var _=Fe(),O=F,K=W,Ae=er,lr=X,pr=J,ur=mr,dr=Ae+1,ce=await Be(O,K,dr,lr,pr,null,ur);if(Oe(_,{productId:O,orderBy:K,page:Ae,ratingFilter:lr,hasImages:pr,nextCursor:ur}))if(ce&&!Wr(ce)&&ce.data&&Array.isArray(ce.data.reviews)){var sr=zt(ce.data.reviews);kt(sr),Pe(dr),ze(ce.data.nextCursor||null);var vr=Fr(R.reviewLayout);sr.forEach(function(cr){S.insertBefore(vr.render(cr,Yr),I)}),ce.data.hasMore?(I.disabled=!1,I.textContent="Daha Fazla G\xF6ster"):I.remove()}else I.disabled=!1,I.textContent="Tekrar Dene"},S.appendChild(I)}}w.appendChild(S),Ne(E),Hr(S,"reviews-widget",{productId:e||""},function(){return E.getElementById("renuvex-reviews-widget")})}catch(_){console.error("[renuvex-pr] render error:",_);var Te=document.createElement("p");Te.style.cssText="text-align:center;color:#dc2626;",Te.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",w&&w.replaceChildren(Te)}}finally{if(gr(!1),fr){var ae=fr;hr(null),st(ae.productId,ae.settings,ae.reviewsData,ae.productName,ae.orderBy,ae.page,ae.badgeSettings)}}}export{st as render};
