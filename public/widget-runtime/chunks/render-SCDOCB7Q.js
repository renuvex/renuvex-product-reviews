...
`;function Qt(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function ea(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function ra(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",l=ea()&&!a;if(n>0){var p=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",p+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ta(e){var r=document.body.style,t=document.documentElement.style;ie(t,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Qe=0,Fe=null;function mr(){return Qe+=1,Qe>1||(Fe=Qt(),ra(Fe)),Fe}function xr(){if(Qe!==0&&(Qe-=1,!(Qe>0))){var e=Fe;Fe=null,e&&ta(e)}}function aa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function fr(){var e=aa();return!e||e===document.body||e===document.documentElement?null:e}function ve(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function na(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Fr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(na)}function er(e,r){var t=e,n=Fr(e);!n.length&&r&&(t=r,n=Fr(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;ve(a)}function gr(e,r,t){if(e.key==="Tab"){var n=Fr(r);if(!n.length){e.preventDefault(),er(r);return}var a=n[0],l=n[n.length-1],p=wt(t);if(!r.contains(p)){e.preventDefault(),ve(a);return}e.shiftKey&&p===a?(e.preventDefault(),ve(l)):!e.shiftKey&&p===l&&(e.preventDefault(),ve(a))}}var zt="renuvexPrOverlay";function hr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[zt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function ia(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[zt]===e.id)}function br(e){if(ia(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Oe(e){return ge(e)}function Ct(e,r,t,n,a){xr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&lr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),ve(a)}function oa(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ue(e.rating,A);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=se(e.createdAt),n.appendChild(a),n.appendChild(l),t.appendChild(n);var p=document.createElement("div");p.className="renuvex-pr-modal-title",p.textContent=e.title||"",p.style.display=e.title?"":"none",t.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-modal-author",o.textContent=e.author||"",t.appendChild(o);var v=document.createElement("div");v.className="renuvex-pr-modal-body",v.textContent=(e.comment||"").trim(),v.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(v);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var g=document.createElement("div");g.className="renuvex-pr-modal-reply-label",g.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var m=document.createElement("div");return m.className="renuvex-pr-modal-reply-text",m.textContent=e.merchantReply||"",u.appendChild(g),u.appendChild(m),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function St(e,r,t){var n=t||A,a=e.querySelector(".renuvex-pr-modal-scroll-content"),l=a.querySelector(".renuvex-pr-modal-stars");l.innerHTML=ue(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=se(r.createdAt);var p=a.querySelector(".renuvex-pr-modal-title");p.textContent=r.title||"",p.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var o=a.querySelector(".renuvex-pr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var v=a.querySelector(".renuvex-pr-modal-reply");v.querySelector(".renuvex-pr-modal-reply-label").textContent=n&&n.merchantReplyLabel||"Ma\u011Faza Sahibi",v.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",v.style.display=r.merchantReply?"":"none",e.scrollTop=0}function _r(e,r,t,n,a,l,p,o,v){var u=Oe(e),g=Math.max(0,Math.min(t||0,u.length-1)),m=document.createElement("div");m.className="renuvex-pr-modal-left";var i=document.createElement("img"),z=p==="next"?"renuvex-pr-modal-img-enter-right":p==="prev"?"renuvex-pr-modal-img-enter-left":"";i.className="renuvex-pr-modal-main-img"+(z?" "+z:""),i.src=Ir(u[g]||""),i.decoding="async",i.width=Br,i.height=Math.round(Br*4/3),i.alt="Yorum foto\u011Fraf\u0131",ft(i,function(N){if(N.style.display="none",!m.querySelector(".renuvex-pr-modal-img-error")){var S=document.createElement("div");S.className="renuvex-pr-modal-img-error",S.setAttribute("role","status"),S.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",m.insertBefore(S,N)}}),m.appendChild(i);var s=document.createElement("button");s.className="renuvex-pr-modal-close-mobile";var h=Z(Ce);h&&s.appendChild(h),s.setAttribute("aria-label","Kapat"),s.onclick=function(N){N.stopPropagation(),l()},m.appendChild(s);var x=0;if(m.addEventListener("touchstart",function(N){x=N.touches[0].clientX},{passive:!0}),m.addEventListener("touchend",function(N){var S=x-N.changedTouches[0].clientX;if(!(Math.abs(S)<50)){if(S>0){if(y)ce(e,r,g+1,n,a,l,!0,"next",o,v);else if(w){var T=n[r+1];ce(T,r+1,0,n,a,l,!1,"next",o,v)}}else if(d)ce(e,r,g-1,n,a,l,!0,"prev",o,v);else if(b){var I=n[r-1],L=Oe(I);ce(I,r-1,L.length-1,n,a,l,!1,"prev",o,v)}}},{passive:!0}),u.length>1){var c=document.createElement("div");c.className="renuvex-pr-modal-thumbs",u.forEach(function(N,S){var T=document.createElement("img"),I=ae(N,sr);T.src=I.src,T.srcset=I.srcset,T.loading="lazy",T.decoding="async",T.width=sr,T.height=sr,T.className="renuvex-pr-modal-thumb"+(S===g?" renuvex-pr-modal-thumb-active":""),T.alt="K\xFC\xE7\xFCk resim "+(S+1),ne(T),T.tabIndex=0,T.setAttribute("role","button"),T.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(S+1)+" se\xE7"),S===g&&T.setAttribute("aria-current","true"),(function(L){function U(){ce(e,r,L,n,a,l,!0,null,o,v)}T.onclick=U,T.onkeydown=function(G){(G.key==="Enter"||G.key===" ")&&(G.preventDefault(),U())}})(S),c.appendChild(T)}),m.appendChild(c)}var d=g>0,y=g<u.length-1,b=r>0,w=r<n.length-1,k=d||b,f=y||w;if(k){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var P=Z(Re);P&&C.appendChild(P),C.setAttribute("aria-label","\xD6nceki"),C.onclick=function(N){if(N.stopPropagation(),d)ce(e,r,g-1,n,a,l,!0,"prev",o,v);else if(b){var S=n[r-1],T=Oe(S);ce(S,r-1,T.length-1,n,a,l,!1,"prev",o,v)}},m.appendChild(C)}if(f){var E=document.createElement("button");E.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var R=Z(pr);R&&E.appendChild(R),E.setAttribute("aria-label","Sonraki"),E.onclick=function(N){if(N.stopPropagation(),y)ce(e,r,g+1,n,a,l,!0,"next",o,v);else if(w){var S=n[r+1];ce(S,r+1,0,n,a,l,!1,"next",o,v)}},m.appendChild(E)}return m}function Et(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Oe(n);a[0]&&(new Image().src=Ir(a[0]))}})}function Or(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function la(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Or(t),Or(n),Or(a)}l(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ce(e,r,t,n,a,l,p,o,v,u){if(u&&(u.currentReview=e),p){var g=_r(e,r,t,n,a,l,o,v,u);a.firstChild&&a.replaceChild(g,a.firstChild)}else{var g=_r(e,r,t,n,a,l,o,v,u),m=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&a.replaceChild(g,a.firstChild),m&&St(m,e,u&&u.currentSettings),la(v,a)}Et(r,n)}function oe(e,r,t){var n=Oe(e);if(!n.length)return;var a=(t||[]).filter(function(f){return Oe(f).length>0}),l=a.findIndex(function(f){return f===e||f.id===e.id});l===-1&&(a.unshift(e),l=0);var p=n.indexOf(r);p<0&&(p=0);var o=document.createElement("div");o.className="renuvex-pr-modal-overlay";var v=document.createElement("div");v.className="renuvex-pr-modal";var u=!1,g=null,m=fr(),i=mr(),z=hr(),s={currentReview:e,currentSettings:A},h=null;function x(f){var C=f&&f.detail&&f.detail.settings;if(!(C&&C===h)){h=C||null,s.currentSettings=C||A;var P=v.querySelector(".renuvex-pr-modal-right");!P||!s.currentReview||St(P,s.currentReview,s.currentSettings)}}function c(){u||(u=!0,window.removeEventListener(Se,x),Ct(g&&g.host,d,c,i,m))}function d(f){if(f.key==="Escape"){y();return}gr(f,o,g&&g.root)}function y(){u||(u=!0,window.removeEventListener(Se,x),Ct(g&&g.host,d,c,i,m),br(z))}document.addEventListener("keydown",d),window.addEventListener("popstate",c),window.addEventListener(Se,x),o.onclick=function(){y()},v.onclick=function(f){f.stopPropagation()},v.appendChild(_r(e,l,p,a,v,y,null,o,s)),v.appendChild(oa(e)),Et(l,a);var b=document.createElement("div");b.className="renuvex-pr-modal-wrap",b.tabIndex=-1,b.setAttribute("role","dialog"),b.setAttribute("aria-modal","true"),b.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),b.appendChild(v);var w=document.createElement("button");w.className="renuvex-pr-modal-close";var k=Z(Ce);k&&w.appendChild(k),w.setAttribute("aria-label","Kapat"),w.onclick=function(f){f.stopPropagation(),y()},b.appendChild(w),o.appendChild(b),g=vr(),Me(g.root,Ie+Ae+cr),g.root.appendChild(o),ze(g.root),er(o)}var Dr={};xe(Dr,{meta:()=>xa,render:()=>fa});function _e(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,l=e.onFilterChange;fe(n);var p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var o=5;o>=1;o--){var v=r[o-1]||0,u=t>0?Math.round(v/t*100):0,g=a===o,m=document.createElement("div");m.className="renuvex-pr-bar-row"+(g?" renuvex-pr-bar-active":""),a&&!g&&(m.style.opacity="0.35");for(var i="",z=1;z<=5;z++){var s=z<=o;i+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(s?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+J(s?"full":"outline")+"</span>"}m.innerHTML='<span class="renuvex-pr-bar-label">'+i+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+v.toLocaleString("tr-TR")+")</span>",(function(h){m.onclick=function(){l(h)}})(o),p.appendChild(m)}return p}var le=[],Tt=!1,yr=!1;function At(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function pa(e){if(yr){yr=!1,e.preventDefault(),e.stopPropagation();return}for(var r=!1,t=le.length-1;t>=0;t--){var n=le[t];At(e,n.trigger)||At(e,n.element)||n.close()&&(r=!0)}r&&(e.preventDefault(),e.stopPropagation())}function da(e){if(e.key==="Escape")for(var r=le.length-1;r>=0;r--)le[r].close()}function ua(){Tt||typeof document=="undefined"||(document.addEventListener("click",pa,!0),document.addEventListener("keydown",da),Tt=!0)}function wr(e){for(var r=0;r<le.length;r++)le[r]!==e&&le[r].close()}function Lt(){yr=!0,typeof setTimeout=="function"&&setTimeout(function(){yr=!1},700)}function kr(e){ua();var r={trigger:e.trigger,element:e.element,close:e.close};return le.push(r),function(){var n=le.indexOf(r);n!==-1&&le.splice(n,1)}}function Q(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,l=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var o=document.createElement("button");o.className="renuvex-pr-write-btn",o.textContent=A&&A.writeButtonText||"Yorum Yap",o.onclick=a,p.appendChild(o);var v=document.createElement("div");v.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var g=A&&A.filterIcon||"lines";u.innerHTML=de(dt(g));var m=document.createElement("div");m.className="renuvex-pr-filter-menu",m.setAttribute("role","menu");var i=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],z=!1;function s(c){var d=m.classList.contains("renuvex-pr-open");m.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var y=c&&(c.restoreFocus===!0||c.restoreFocus==="auto"&&ar());if(d&&y)try{u.focus({preventScroll:!0})}catch(b){try{u.focus()}catch(w){}}return d}function h(){wr(x),m.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var c=m.querySelector(".renuvex-pr-filter-item-active")||m.querySelector(".renuvex-pr-filter-item");c&&requestAnimationFrame(function(){try{c.focus({preventScroll:!0})}catch(d){try{c.focus()}catch(y){}}})}i.forEach(function(c){var d=c[2],y=d?n:!n&&(t||"newest")===c[0],b=document.createElement("button");b.type="button",b.className="renuvex-pr-filter-item"+(y?" renuvex-pr-filter-item-active":""),b.setAttribute("role","menuitem"),b.textContent=c[1];var w=!1;function k(f,C){f&&(f.preventDefault(),f.stopPropagation()),!w&&(w=!0,z=!0,C!==!0&&Lt(),s({restoreFocus:C}),l(c[0],d),setTimeout(function(){w=!1,z=!1},0))}b.addEventListener("pointerdown",function(f){f.button!==void 0&&f.button!==0||k(f,!1)}),typeof window!="undefined"&&!window.PointerEvent&&b.addEventListener("touchstart",function(f){k(f,!1)},{passive:!1}),b.addEventListener("mousedown",function(f){f.button!==void 0&&f.button!==0||k(f,!1)}),b.addEventListener("keydown",function(f){(f.key==="Enter"||f.key===" ")&&k(f,!0)}),b.onclick=function(f){k(f,!1)},m.appendChild(b)}),u.onclick=function(){m.classList.contains("renuvex-pr-open")?s({restoreFocus:"auto"}):h()},v.addEventListener("keydown",function(c){c.key==="Escape"&&m.classList.contains("renuvex-pr-open")&&(c.stopPropagation(),s({restoreFocus:!0}))}),v.addEventListener("focusout",function(c){if(m.classList.contains("renuvex-pr-open")&&!z){var d=c.relatedTarget;d&&v.contains(d)||s()}});var x=kr({trigger:v,element:m,close:s});return v.appendChild(u),v.appendChild(m),p.appendChild(v),p}var Nt=`
...
`;function Pt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,n=document.createElement("div");n.className="renuvex-pr-fwizard-overlay",n.tabIndex=-1,n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Yorum yapma formu");var a=document.createElement("div");a.className="renuvex-pr-fwizard",n.appendChild(a);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var p=Z(Ce);p&&l.appendChild(p),a.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content",a.appendChild(o);var v=!1,u=null,g=null,m=!1;function i(){er(o,n)}function z(w){gr(w,n,u&&u.root)}function s(){if(!v){if(v=!0,document.removeEventListener("keydown",h),n.removeEventListener("click",x),l.removeEventListener("click",s),m)ve(g);else{var w=u&&u.root?u.root.activeElement:null;if(w&&typeof w.blur=="function")try{w.blur()}catch(k){}}n.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(lr(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):n.parentNode&&n.parentNode.removeChild(n),xr();try{r()}catch(k){}},200)}}function h(w){if(w.key==="Escape"){s();return}z(w)}function x(w){w.target===n&&t&&s()}document.addEventListener("keydown",h),n.addEventListener("click",x),l.addEventListener("click",s);function c(w){g=fr(),m=ar(),w&&o.appendChild(w),u=vr(),Me(u.root,Ie+Ae+Nt),u.root.appendChild(n),ze(u.root),mr(),requestAnimationFrame(function(){n.classList.add("renuvex-pr-fwizard-open"),i()})}var d=null,y=null;function b(w,k){if(k=k||"error",d){try{d.remove()}catch(f){}d=null}y&&(clearTimeout(y),y=null),d=document.createElement("div"),d.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+k,d.textContent=w,a.appendChild(d),y=setTimeout(function(){d&&(d.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(d){try{d.remove()}catch(f){}d=null}},300))},4e3)}return{open:c,close:s,content:o,setAllowOutsideClose:function(w){t=!!w},setStepAttr:function(w){a.setAttribute("data-step",String(w))},focusFirstControl:i,showToast:b}}var Hr=4;function He(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Rt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(l){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<Hr&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(l){return l!==a})}}}}function Bt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},l=e.onNext||function(){},p=document.createElement("div");p.className="renuvex-pr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=de(Re)+"<span>Geri</span>",o.addEventListener("click",function(){n()}),p.appendChild(o);var v=document.createElement("div");v.className="renuvex-pr-fwizard-footer-progress";for(var u=[],g=0;g<Hr;g++){var m=document.createElement("span");m.className="renuvex-pr-fwizard-progress-seg",v.appendChild(m),u.push(m)}p.appendChild(v);var i=document.createElement("button");i.type="button";var z=null;function s(x){z&&i.removeEventListener("click",z),z=x,x&&i.addEventListener("click",x)}p.appendChild(i);function h(x,c){var d=r.indexOf(x)!==-1,y=t.indexOf(x)!==-1,b=c&&(c.images&&c.images.length>0||c.pendingImages&&c.pendingImages.length>0);if(d)x===2&&b?(i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",s(function(){l()})):(i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.setAttribute("aria-label","Atla"),i.innerHTML="<span>Atla</span>",s(function(){a()})),i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),i.style.visibility="",i.tabIndex=0;else if(y){i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Sonraki"),i.innerHTML="Sonraki",i.style.visibility="",i.tabIndex=0;var w=He(x,c);i.disabled=!w,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!w),s(function(){i.disabled||l()})}else i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.innerHTML="",i.style.visibility="hidden",i.tabIndex=-1,i.disabled=!0,s(null)}return{el:p,update:function(x,c){u.forEach(function(y,b){b+1<=x?y.classList.add("renuvex-pr-fwizard-progress-seg-active"):y.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var d=x<=1;o.style.visibility=d?"hidden":"",o.style.pointerEvents=d?"none":"",o.tabIndex=d?-1:0,h(x,c)},setNextDisabled:function(x){i.classList.contains("renuvex-pr-fwizard-cta-btn")&&(i.disabled=!!x,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!x))},setThanksState:function(x){o.style.visibility="hidden",v.style.visibility="hidden",i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",i.style.visibility="",i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),s(x)}}}function It(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-stars",p.setAttribute("role","radiogroup"),p.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var o=Je(A||{});fe(o);var v=[];function u(x){v.forEach(function(c,d){var y=d<x;c.classList.toggle("renuvex-pr-fwizard-star-active",y),c.setAttribute("aria-checked",d+1===x?"true":"false"),c.innerHTML=y?J("full"):J("outline")})}function g(x){e.set({rating:x}),u(x)}function m(x){var c=v[x-1];if(c)try{c.focus()}catch(d){}}function i(x,c){c&&typeof c.preventDefault=="function"&&c.preventDefault(),c&&typeof c.stopPropagation=="function"&&c.stopPropagation(),!n&&(n=!0,g(x),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var z=1;z<=5;z++)(function(x){var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-star",c.setAttribute("role","radio"),c.setAttribute("aria-label",x+" y\u0131ld\u0131z"),c.innerHTML=J("outline"),c.addEventListener("mouseenter",function(){u(x)}),c.addEventListener("mouseleave",function(){u(e.get().rating)}),c.addEventListener("pointerdown",function(d){d.button&&d.button!==0||i(x,d)}),typeof window!="undefined"&&!window.PointerEvent&&c.addEventListener("touchstart",function(d){i(x,d)},{passive:!1}),c.addEventListener("mousedown",function(d){window.PointerEvent||i(x,d)}),c.addEventListener("keydown",function(d){if(d.key==="Enter"||d.key===" "){i(x,d);return}var y=0;d.key==="ArrowRight"||d.key==="ArrowUp"?y=Math.min(5,x+1):d.key==="ArrowLeft"||d.key==="ArrowDown"?y=Math.max(1,x-1):d.key==="Home"?y=1:d.key==="End"&&(y=5),y&&(d.preventDefault(),g(y),m(y))}),c.addEventListener("click",function(d){i(x,d)}),v.push(c),p.appendChild(c)})(z);u(e.get().rating);var s=null,h=function(x){var c=x&&x.detail&&x.detail.settings;c&&c===s||(s=c||null,o=Je(c||A||{}),u(e.get().rating))};return window.addEventListener(Se,h),t.appendChild(p),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Se,h)}}}var Mt=3,sa=10*1024*1024;function Ft(e,r){r=r||{};var t=!1,n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",n.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",n.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle");var v=document.createElement("input");v.type="file",v.accept="image/*",v.multiple=!0,v.style.display="none",p.appendChild(o),p.appendChild(v);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),p.appendChild(u),n.appendChild(p);var g=r.blobMap||{},m=r.urlToFinger||{};function i(){if(!t){var c=e.get().images||[],d=e.get().pendingImages||[],y=c.map(function(b){return{url:b,isPending:!1}}).concat(d.map(function(b){return{url:b.url,file:b.file,isPending:!0,error:b.error}}));u.innerHTML="",y.forEach(function(b){var w=g[b.url]||b.url,k=z(b,w);u.appendChild(k)}),h()}}function z(c,d){var y=document.createElement("div");y.className="renuvex-pr-fwizard-photo-thumb";var b=document.createElement("img");b.src=d,b.alt="",b.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",y.appendChild(b);var w=document.createElement("div");w.className="renuvex-pr-fwizard-photo-loading",w.style.display="none",y.appendChild(w);var k=document.createElement("button");k.type="button",k.className="renuvex-pr-fwizard-photo-remove",k.setAttribute("aria-label","Kald\u0131r");var f=Z(Ce);return f&&k.appendChild(f),y.appendChild(k),s(y,c,d),y}function s(c,d,y){var b=c.querySelector("img");b.src!==y&&(b.src=y);var w=c.querySelector(".renuvex-pr-fwizard-photo-loading");if(d.isPending&&d.error){w.style.display="flex",w.textContent="";var k=document.createElement("span");k.className="renuvex-pr-upload-error",k.textContent="\u2717 "+d.error,w.appendChild(k)}else w.style.display="none",w.textContent="";var f=c.querySelector(".renuvex-pr-fwizard-photo-remove");f.onclick=function(){var C=m[d.url]||(d.file?d.file.name+"_"+d.file.size:null);if(d.url.startsWith("blob:")&&URL.revokeObjectURL(d.url),C){var P=(e.get().fingerprints||[]).filter(function(N){return N!==C});e.set({fingerprints:P})}if(d.isPending){var E=(e.get().pendingImages||[]).filter(function(N){return N.url!==d.url});e.set({pendingImages:E})}else{var R=(e.get().images||[]).filter(function(N){return N!==d.url});e.set({images:R})}}}function h(){var c=(e.get().images||[]).length,d=(e.get().pendingImages||[]).length,y=c+d,b=y>=Mt;y>0?(p.classList.add("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=de(vt)):(p.classList.remove("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=de(st)+"<span>Foto\u011Fraf Ekle</span>"),b?(o.style.display="none",o.disabled=!0,v.disabled=!0):(o.style.display="flex",o.disabled=!1,v.disabled=!1,o.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){v.disabled||v.click()}),v.onchange=async function(c){var d=(e.get().images||[]).length+(e.get().pendingImages||[]).length,y=Array.from(c.target.files).slice(0,Mt-d);v.value="";var b=(e.get().pendingImages||[]).length,w=e.get().images||[],k=w.length;if(y.length!==0){for(var f=[],C=[],P=0;P<y.length;P++){var E=y[P],R=E.name+"_"+E.size,N=(e.get().fingerprints||[]).some(function(O){return O===R})||f.some(function(O){return O.file.name+"_"+O.file.size===R});if(N){console.log("[renuvex-pr] Duplicate file detected, skipping:",E.name);continue}if(E.size>sa){var S="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(S,"error"):alert(S);continue}var T=URL.createObjectURL(E);m[T]=R,f.push({url:T,file:E,error:null}),C.push({url:T,file:E});var I=(e.get().fingerprints||[]).slice();I.push(R),e.set({fingerprints:I})}if(f.length!==0){var L=(e.get().pendingImages||[]).concat(f),U=async function(){for(var O=0;O<C.length;O++){var _=C[O],W=_.file,q=_.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var je=(e.get().pendingImages||[]).filter(function(H){return H.url!==q}),Te=(e.get().images||[]).slice();Te.push(q),e.set({pendingImages:je,images:Te});continue}try{var he=await Ze(Xe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:qe})});if(!he.ok)throw he.status===429?new Error("rate_limit"):new Error("sign failed");var D=await he.json();if(!D.folder)throw new Error("sign folder missing");var j=new FormData;j.append("file",W),j.append("api_key",D.api_key),j.append("timestamp",D.timestamp),j.append("signature",D.signature),j.append("folder",D.folder);var pe=await fetch("https://api.cloudinary.com/v1_1/"+D.cloud_name+"/image/upload",{method:"POST",body:j}),ee=await pe.json();if(ee.secure_url&&xt(ee.secure_url)){var be=(e.get().pendingImages||[]).some(function(H){return H.url===q});if(!be){console.log("[renuvex-pr] Upload finished but image was already deleted by user. Aborting state update.");return}g[ee.secure_url]=q,m[ee.secure_url]=m[q];var Ve=(e.get().pendingImages||[]).filter(function(H){return H.url!==q}),re=(e.get().images||[]).slice();re.push(ee.secure_url),e.set({pendingImages:Ve,images:re});try{Ze(Xe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:qe,secureUrl:ee.secure_url})}).catch(function(){})}catch(H){}}else throw new Error("invalid image url")}catch(H){console.error("[renuvex-pr] Image upload failed:",H);var ye=H.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ye,"error");var Ue=(e.get().pendingImages||[]).map(function(X){return X.url===q?{url:X.url,file:X.file,error:ye}:X});e.set({pendingImages:Ue})}}};if(k===0&&b===0){t=!0;var G=!r.canNavigate||r.canNavigate();G&&e.goNext()}e.set({pendingImages:L}),U()}}};var x=e.onChange(i);return i(),{el:n,destroy:function(){t=!0,v.onchange=null,x&&x()}}}var Yr=2e3,va=60;function Ot(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",n.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",p.maxLength=va,p.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),p.value=e.get().title||"",p.addEventListener("input",function(){e.set({title:p.value})}),l.appendChild(p);var o=document.createElement("textarea");o.className="renuvex-pr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=Yr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",l.appendChild(o);var v=document.createElement("div");v.className="renuvex-pr-fwizard-char-counter",v.setAttribute("aria-live","polite"),l.appendChild(v);function u(){var m=o.value.length;v.textContent=m+"/"+Yr,v.classList.toggle("renuvex-pr-fwizard-char-counter--max",m>=Yr)}function g(){return He(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),u(),t(g())}),n.appendChild(l),u(),setTimeout(function(){t(g())},0),{el:n,destroy:function(){}}}var ca=40;function _t(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",a.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-author-form";var o=document.createElement("div");o.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=ca,u.setAttribute("aria-required","true"),u.value=e.get().author||"",o.appendChild(v),o.appendChild(u),p.appendChild(o);var g=document.createElement("div");g.className="renuvex-pr-fwizard-field";var m=document.createElement("label");m.className="renuvex-pr-fwizard-label",m.textContent="E-posta (opsiyonel)";var i=document.createElement("input");i.type="email",i.className="renuvex-pr-fwizard-input",i.setAttribute("autocomplete","email"),i.value=e.get().email||"",g.appendChild(m),g.appendChild(i),p.appendChild(g);var z=document.createElement("div");z.className="renuvex-pr-fwizard-notice",z.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",p.appendChild(z);var s=document.createElement("div");s.className="renuvex-pr-fwizard-msg",s.setAttribute("role","alert"),s.setAttribute("aria-live","assertive"),p.appendChild(s);var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-submit-btn",h.textContent="G\xF6nder",p.appendChild(h),a.appendChild(p);function x(){return He(4,e.get())}function c(){var w=!x(),k=(e.get().pendingImages||[]).length,f=k>0;f?(h.disabled=!0,h.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),h.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(h.disabled=w,h.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",w),h.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),c(),t(x())}),i.addEventListener("input",function(){e.set({email:i.value})}),c(),setTimeout(function(){t(x())},0);function d(){s.textContent=""}function y(w){d();var k=document.createElement("div");k.className="renuvex-pr-fwizard-msg-error",k.textContent=w||"",s.appendChild(k)}h.onclick=async function(){if(!h.disabled){var w=e.get(),k=(w.author||"").trim(),f=(w.comment||"").trim();if(i.value.trim()&&!i.checkValidity()){i.reportValidity();return}if(!k){y("Gerekli alan");return}if(!w.rating){y("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}h.disabled=!0,h.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var C=h.textContent;if(h.textContent="G\xF6nderiliyor\u2026",d(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){n()},600);return}try{var P=ct(window.location.href),E=w.productName||null,R=await Ze(Xe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:qe,productId:w.productId||null,slug:P||null,productName:E,author:k,title:(w.title||"").trim()||null,comment:f||null,rating:w.rating,images:w.images||[]})},15e3);if(R.ok)n();else{var N=await R.json().catch(function(){return{}});throw new Error(N.error||"Yorum kaydedilemedi.")}}catch(I){var S=I&&(I.name==="AbortError"||/signal/i.test(I.message||"")),T=S?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":I.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(T,"error"):y(T),h.disabled=!1,h.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),h.textContent=C}}};var b=e.onChange(c);return{el:a,destroy:function(){h.onclick=null,b&&b()}}}function ma(e,r,t){if(t=t||{},e===1)return It(r,{canNavigate:t.canNavigate});if(e===2)return Ft(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,showToast:t.showToast});if(e===3)return Ot(r,{onValidityChange:t.onValidityChange});if(e===4)return _t(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Ht(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Yt(e){e=e||{};var r=Rt({productId:e.productId,productName:e.productName}),t={},n={},a=Pt({onClose:function(){window.removeEventListener("popstate",p),br(l),Object.keys(t).forEach(function(k){var f=t[k];f&&f.startsWith("blob:")&&URL.revokeObjectURL(f)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),l=hr(),p=function(k){a&&a.close&&a.close()};window.addEventListener("popstate",p);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-wrap";var v=Bt({skippableSteps:[2],nextableSteps:[3],onBack:function(){m==="idle"&&r.goBack()},onSkip:function(){m==="idle"&&r.goNext()},onNext:function(){m==="idle"&&r.goNext()}}),u=document.createElement("div");u.className="renuvex-pr-fwizard-layout",u.appendChild(o),u.appendChild(v.el);var g=null,m="idle",i=null,z=!0,s=null;function h(k,f){o.innerHTML="";var C=ma(k,r,{canNavigate:function(){return m==="idle"},blobMap:t,urlToFinger:n,onValidityChange:function(R){v.setNextDisabled(!R)},onSuccess:c,showToast:a.showToast});if(g=C,v.update(k,r.get()),f){m="entering",C.el.classList.add("renuvex-pr-fwizard-step--enter");var P=null,E=function(){P&&clearTimeout(P),C.el.removeEventListener("animationend",E),C.el.classList.remove("renuvex-pr-fwizard-step--enter"),m="idle",i!==null&&d()};C.el.addEventListener("animationend",E),P=setTimeout(E,700)}else m="idle";o.appendChild(C.el),a.setStepAttr&&a.setStepAttr(k),k===3&&v.setNextDisabled(!0)}var x=!1;function c(){if(!x){if(x=!0,!g){o.innerHTML="";var k=Ht();k.classList.add("renuvex-pr-fwizard-step--enter"),o.appendChild(k),a.setStepAttr("thanks"),v.setThanksState(a.close);return}var f=g;m="exiting",f.el.classList.add("renuvex-pr-fwizard-step--exit");var C=function(){if(s&&clearTimeout(s),f.el.removeEventListener("animationend",C),f.destroy)try{f.destroy()}catch(E){}g===f&&(g=null),o.innerHTML="";var P=Ht();P.classList.add("renuvex-pr-fwizard-step--enter"),o.appendChild(P),a.setStepAttr("thanks"),v.setThanksState(a.close),m="idle"};f.el.addEventListener("animationend",C),s=setTimeout(C,300)}}function d(){var k=r.get().currentStep;if(m!=="idle"){i=k;return}if(!g){var f=!z;z=!1,h(k,f);return}var C=g;m="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var P=function(){if(s&&clearTimeout(s),C.el.removeEventListener("animationend",P),C.destroy)try{C.destroy()}catch(R){}if(g===C){o.innerHTML="",g=null;var E=i!==null?i:r.get().currentStep;i=null,h(E,!0),m="idle"}};C.el.addEventListener("animationend",P),s=setTimeout(P,350)}d();var y=r.get().currentStep,b=r.onChange(function(k){k.currentStep!==y?(y=k.currentStep,d()):v.update(k.currentStep,k)}),w=a.close;return a.close=function(){b&&b(),typeof s!="undefined"&&s&&clearTimeout(s),w()},a.open(u),{close:a.close}}function Y(){Yt({productId:te||"",productName:Pe||""})}var xa={id:"classic",name:"Klasik (A\xE7\u0131k)"};function fa(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,l=e.allCount,p=e.ratingCounts,o=e.avgRatingVal,v=e.currentRatingFilter,u=e.currentOrderBy,g=e.currentHasImages,m=e.onFilterChange,i=e.onSortChange;fe(a);var z=document.createElement("div");z.className="renuvex-pr-summary";var s=(p[3]||0)+(p[4]||0),h=l>0?Math.round(s/l*100):0,x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+J("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",z.appendChild(x);var c=document.createElement("div");if(c.className="renuvex-pr-summary-block renuvex-pr-summary-count",c.textContent=l.toLocaleString("tr-TR")+" Yorum",z.appendChild(c),n.showRecommendation!==!1&&h>0){var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",d.innerHTML='<span class="renuvex-pr-recommend-pct">%'+h+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(d)}return z.appendChild(_e({ratingCounts:p,allCount:l,iconPair:a,currentRatingFilter:v,onFilterChange:m})),z.appendChild(Q({widget:r,currentOrderBy:u,currentHasImages:g,onWriteClick:Y,onSortChange:i})),z}var jr={};xe(jr,{css:()=>ha,meta:()=>ga,render:()=>ba});var Dt=`
...
`;var Ra={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-w-mobile":"80px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-w-mobile":"100px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-w-mobile":"110px"}}},Ba=Wt;function Ia(e,r){var t=ge(e),n=t.length>0,a=document.createElement("article");a.className="renuvex-pr-review-list"+(n?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var p=document.createElement("span");p.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",p.innerHTML=ue(e.rating,A),l.appendChild(p);var o=document.createElement("span");o.className="renuvex-pr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var v=document.createElement("time");v.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&v.setAttribute("datetime",e.createdAt),v.textContent=se(e.createdAt),l.appendChild(v),a.appendChild(l);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var g=document.createElement("div");g.className="renuvex-pr-review-list-title",g.textContent=e.title,u.appendChild(g)}var m=(e.comment||"").trim();m&&u.appendChild(Ye(m,"renuvex-pr-review-list-body").fragment);var i=De(e.merchantReply);if(i&&u.appendChild(i),a.appendChild(u),n){var z=document.createElement("div");z.className="renuvex-pr-review-list-media",t.forEach(function(s){var h=document.createElement("img"),x=ae(s,V);h.src=x.src,h.srcset=x.srcset,h.loading="lazy",h.decoding="async",h.width=V,h.height=Math.round(V*4/3),h.setAttribute("data-renuvex-img-url",s),ne(h),h.setAttribute("role","button"),h.setAttribute("tabindex","0"),h.setAttribute("aria-label","Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),(function(c){var d=function(){oe(e,c,r)};h.onclick=d,h.onkeydown=function(y){(y.key==="Enter"||y.key===" "||y.key==="Spacebar")&&(y.preventDefault(),d())}})(s),z.appendChild(h)}),a.appendChild(z)}return a}var Xr={};xe(Xr,{css:()=>Fa,meta:()=>Ma,render:()=>Oa});var qt=`
