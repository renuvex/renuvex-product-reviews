...
`;var Kn={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Xn=Ha,Jn="__unknown_product__",pr=Object.create(null);function Zn(e){return e?String(e):Jn}var Fe=null,ur=null;function $n(){!Fe||!ur||(Fe.removeEventListener?Fe.removeEventListener("change",ur):Fe.removeListener&&Fe.removeListener(ur),Fe=null,ur=null)}function Qn(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,v=e.currentHasImages,c=e.onFilterChange,s=e.onSortChange,d=Zn(t),w=document.createElement("div");w.className="renuvex-pr-summary renuvex-pr-summary-compact";var m=document.createElement("div");m.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var b=document.createElement("button");b.className="renuvex-pr-compact-trigger",b.type="button",b.setAttribute("aria-expanded","false"),b.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Ae(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+ae(Ht)+"</span>";var h=b.querySelector(".renuvex-pr-compact-trigger-text"),g=b.querySelector(".renuvex-pr-compact-chevron");if(h&&(h.textContent=i.toLocaleString("tr-TR")+" "+O(n.countLabel,"Yorum")),h&&g){var z=document.createElement("span");z.className="renuvex-pr-compact-trigger-count",b.insertBefore(z,h),z.appendChild(h),z.appendChild(g)}f.appendChild(b),m.appendChild(f);var y=re({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:X,onSortChange:s}),x=y.querySelector(".renuvex-pr-filter-wrap"),k=y.querySelector(".renuvex-pr-write-btn"),T=document.createElement("div");T.className="renuvex-pr-compact-actions-slot",k&&T.appendChild(k),x&&T.appendChild(x),m.appendChild(T),w.appendChild(m);var C=document.createElement("div");C.className="renuvex-pr-compact-panel",C.setAttribute("role","dialog"),C.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),C.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+te("full")+"</span><span>"+p+"</span>",E.appendChild(S),E.appendChild(Ge({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(B){L()&&C.classList.contains("renuvex-pr-open")&&(pr[d]=!0),c(B)}})),C.appendChild(E);var P=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function L(){return!!(P&&P.matches)}function A(B){B?C.classList.add("renuvex-pr-open"):C.classList.remove("renuvex-pr-open"),C.setAttribute("aria-hidden",B?"false":"true"),b.setAttribute("aria-expanded",B?"true":"false")}function M(B){var Y=B?w:f;if(C.parentNode!==Y){var F=!!C.parentNode;C.classList.contains("renuvex-pr-open")&&A(!1),F&&(pr[d]=!1),Y.appendChild(C)}}M(P?P.matches:!1);var _=re({widget:r,currentOrderBy:u,currentHasImages:v,onWriteClick:X,onSortChange:s}),H=_.querySelector(".renuvex-pr-filter-wrap"),I=_.querySelector(".renuvex-pr-write-btn"),j=document.createElement("div");j.className="renuvex-pr-compact-write-row",I&&j.appendChild(I),H&&j.appendChild(H),w.appendChild(j);function D(){var B=C.classList.contains("renuvex-pr-open");return A(!1),L()&&(pr[d]=!1),B}function Z(){V&&V.notifyOpening(),A(!0),L()&&(pr[d]=!0)}b.onclick=function(){C.classList.contains("renuvex-pr-open")?D():Z()};var V=null;function J(B){V&&(V.unregister(),V=null),B||(V=Hr({trigger:f,element:C,close:D}))}if(J(P?P.matches:!1),$n(),P){var pe=function(B){M(B.matches),J(B.matches)};P.addEventListener?P.addEventListener("change",pe):P.addListener&&P.addListener(pe),Fe=P,ur=pe}if(L()&&pr[d]&&A(!0),n.showRecommendation!==!1){var we=(o[3]||0)+(o[4]||0),oe=i>0?Math.round(we/i*100):0;if(oe>0){var W=document.createElement("div");W.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="renuvex-pr-recommend-pct">%'+oe+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(W)}}return w}var vt={};Se(vt,{css:()=>ri,meta:()=>ei,render:()=>ti});var Ua=`
