...
import{a as Ae,d as Qe}from"./chunk-FW6W6ZQL.js";import{b as Ar,c as Ie}from"./chunk-ZM24JLBV.js";import{A as ar,B as nr,a as X,b as er,c as $,d as Q,e as Y,f as P,g as Jr,h as Le,j as Sr,k as Zr,l as rr,m as Ne,n as $r,o as Qr,p as et,q as rt,r as tt,s as at,t as nt,v as it,w as ot,x as lt,y as pt,z as tr}from"./chunk-NQF4A7IV.js";import{A as xe,B as lr,C as W,D as pr,E as ur,F as Er,G as Tr,H as ae,I as ft,J as ne,K as gt,L as ht,c as kr,e as me,f as K,g as ue,h as J,i as ye,j as ir,k as Ke,l as ut,m as Pe,n as or,o as dt,p as ze,q as st,r as vt,t as ct,u as de,v as Re,x as mt,y as se,z as xt}from"./chunk-NQS3OUJA.js";import{a as Je}from"./chunk-GSBAPHFO.js";import{a as ce,b as Ge,c as Xe,k as bt,l as Ce}from"./chunk-YCWIZ2SG.js";var Be=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function wt(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function _e(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function dr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function yt(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function zt(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var Ct=`
...
`;var sr=[Ct,mt,St,Et,Tt,At,kt].join(`
`);function da(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function sa(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function va(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=sa()&&!n;if(a>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ca(e){var r=document.body.style,t=document.documentElement.style;ie(t,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Ze=0,Me=null;function vr(){return Ze+=1,Ze>1||(Me=da(),va(Me)),Me}function cr(){if(Ze!==0&&(Ze-=1,!(Ze>0))){var e=Me;Me=null,e&&ca(e)}}function ma(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function mr(){var e=ma();return!e||e===document.body||e===document.documentElement?null:e}function Z(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function xa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Lr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(xa)}function fa(e,r){var t=e,a=Lr(e);!a.length&&r&&(t=r,a=Lr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;Z(n)}function xr(e,r,t){if(e.key==="Tab"){var a=Lr(r);if(!a.length){e.preventDefault(),fa(r);return}var n=a[0],l=a[a.length-1],o=yt(t);if(!r.contains(o)){e.preventDefault(),Z(n);return}if(a.indexOf(o)===-1){e.preventDefault(),Z(e.shiftKey?l:n);return}e.shiftKey&&o===n?(e.preventDefault(),Z(l)):!e.shiftKey&&o===l&&(e.preventDefault(),Z(n))}}var Lt="renuvexPrOverlay";function fr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Lt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function ga(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Lt]===e.id)}function gr(e){if(ga(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Oe(e){return xe(e)}function Nt(e,r,t,a,n){cr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&ir(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),Z(n)}function ha(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=de(e.rating,P);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=se(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=P&&P.merchantReplyLabel||"Ma\u011Faza Sahibi";var c=document.createElement("div");return c.className="renuvex-pr-modal-reply-text",c.textContent=e.merchantReply||"",u.appendChild(f),u.appendChild(c),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Pt(e,r,t){var a=t||P,n=e.querySelector(".renuvex-pr-modal-scroll-content"),l=n.querySelector(".renuvex-pr-modal-stars");l.innerHTML=de(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=se(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Pr(e,r,t,a,n,l,o,i,d){var u=Oe(e),f=Math.max(0,Math.min(t||0,u.length-1)),c=document.createElement("div");c.className="renuvex-pr-modal-left";var p=document.createElement("img"),x=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";p.className="renuvex-pr-modal-main-img"+(x?" "+x:""),p.src=Tr(u[f]||""),p.decoding="async",p.width=Er,p.height=Math.round(Er*4/3),p.alt="Yorum foto\u011Fraf\u0131",ft(p,function(S){if(S.style.display="none",!c.querySelector(".renuvex-pr-modal-img-error")){var N=document.createElement("div");N.className="renuvex-pr-modal-img-error",N.setAttribute("role","status"),N.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",c.insertBefore(N,S)}}),c.appendChild(p);var g=document.createElement("button");g.className="renuvex-pr-modal-close-mobile";var v=J(ze);v&&g.appendChild(v),g.setAttribute("aria-label","Kapat"),g.onclick=function(S){S.stopPropagation(),l()},c.appendChild(g);var b=0;if(c.addEventListener("touchstart",function(S){b=S.touches[0].clientX},{passive:!0}),c.addEventListener("touchend",function(S){var N=b-S.changedTouches[0].clientX;if(!(Math.abs(N)<50)){if(N>0){if(w)ve(e,r,f+1,a,n,l,!0,"next",i,d);else if(h){var E=a[r+1];ve(E,r+1,0,a,n,l,!1,"next",i,d)}}else if(m)ve(e,r,f-1,a,n,l,!0,"prev",i,d);else if(y){var B=a[r-1],M=Oe(B);ve(B,r-1,M.length-1,a,n,l,!1,"prev",i,d)}}},{passive:!0}),u.length>1){var s=document.createElement("div");s.className="renuvex-pr-modal-thumbs",u.forEach(function(S,N){var E=document.createElement("img"),B=ae(S,ur);E.src=B.src,E.srcset=B.srcset,E.loading="lazy",E.decoding="async",E.width=ur,E.height=ur,E.className="renuvex-pr-modal-thumb"+(N===f?" renuvex-pr-modal-thumb-active":""),E.alt="K\xFC\xE7\xFCk resim "+(N+1),ne(E),E.tabIndex=0,E.setAttribute("role","button"),E.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(N+1)+" se\xE7"),N===f&&E.setAttribute("aria-current","true"),(function(M){function R(){ve(e,r,M,a,n,l,!0,null,i,d)}E.onclick=R,E.onkeydown=function(j){(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),R())}})(N),s.appendChild(E)}),c.appendChild(s)}var m=f>0,w=f<u.length-1,y=r>0,h=r<a.length-1,C=m||y,z=w||h;if(C){var A=document.createElement("button");A.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var k=J(Pe);k&&A.appendChild(k),A.setAttribute("aria-label","\xD6nceki"),A.onclick=function(S){if(S.stopPropagation(),m)ve(e,r,f-1,a,n,l,!0,"prev",i,d);else if(y){var N=a[r-1],E=Oe(N);ve(N,r-1,E.length-1,a,n,l,!1,"prev",i,d)}},c.appendChild(A)}if(z){var L=document.createElement("button");L.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var T=J(or);T&&L.appendChild(T),L.setAttribute("aria-label","Sonraki"),L.onclick=function(S){if(S.stopPropagation(),w)ve(e,r,f+1,a,n,l,!0,"next",i,d);else if(h){var N=a[r+1];ve(N,r+1,0,a,n,l,!1,"next",i,d)}},c.appendChild(L)}return c}function Rt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=Oe(a);n[0]&&(new Image().src=Tr(n[0]))}})}function Nr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function ba(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Nr(t),Nr(a),Nr(n)}l(),t&&Z(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ve(e,r,t,a,n,l,o,i,d,u){if(u&&(u.currentReview=e),o){var f=Pr(e,r,t,a,n,l,i,d,u);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=Pr(e,r,t,a,n,l,i,d,u),c=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),c&&Pt(c,e,u&&u.currentSettings),ba(d,n)}Rt(r,a)}function oe(e,r,t){var a=Oe(e);if(!a.length)return;var n=(t||[]).filter(function(z){return Oe(z).length>0}),l=n.findIndex(function(z){return z===e||z.id===e.id});l===-1&&(n.unshift(e),l=0);var o=a.indexOf(r);o<0&&(o=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var u=!1,f=null,c=mr(),p=vr(),x=fr(),g={currentReview:e,currentSettings:P},v=null;function b(z){var A=z&&z.detail&&z.detail.settings;if(!(A&&A===v)){v=A||null,g.currentSettings=A||P;var k=d.querySelector(".renuvex-pr-modal-right");!k||!g.currentReview||Pt(k,g.currentReview,g.currentSettings)}}function s(){u||(u=!0,window.removeEventListener(Ce,b),Nt(f&&f.host,m,s,p,c))}function m(z){if(z.key==="Escape"){w();return}xr(z,i,f&&f.root)}function w(){u||(u=!0,window.removeEventListener(Ce,b),Nt(f&&f.host,m,s,p,c),gr(x))}document.addEventListener("keydown",m),window.addEventListener("popstate",s),window.addEventListener(Ce,b),i.onclick=function(){w()},d.onclick=function(z){z.stopPropagation()},d.appendChild(Pr(e,l,o,n,d,w,null,i,g)),d.appendChild(ha(e)),Rt(l,n);var y=document.createElement("div");y.className="renuvex-pr-modal-wrap",y.tabIndex=-1,y.setAttribute("role","dialog"),y.setAttribute("aria-modal","true"),y.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),y.appendChild(d);var h=document.createElement("button");h.className="renuvex-pr-modal-close";var C=J(ze);C&&h.appendChild(C),h.setAttribute("aria-label","Kapat"),h.onclick=function(z){z.stopPropagation(),w()},y.appendChild(h),i.appendChild(y),f=dr(),_e(f.root,Be+Ae+sr),f.root.appendChild(i),ye(f.root),Z(y)}function fe(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Br={};ce(Br,{css:()=>Aa,meta:()=>Ta,render:()=>La});function Fe(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,l=e.onFilterChange;me(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,u=t>0?Math.round(d/t*100):0,f=n===i,c=document.createElement("div");c.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":""),n&&!f&&(c.style.opacity="0.35");for(var p="",x=1;x<=5;x++){var g=x<=i;p+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(g?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+K(g?"full":"outline")+"</span>"}c.innerHTML='<span class="renuvex-pr-bar-label">'+p+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(v){c.onclick=function(){l(v)}})(i),o.appendChild(c)}return o}var le=[],It=!1,hr=!1;function Bt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function wa(e){if(hr){hr=!1,e.preventDefault(),e.stopPropagation();return}for(var r=!1,t=le.length-1;t>=0;t--){var a=le[t];Bt(e,a.trigger)||Bt(e,a.element)||a.close()&&(r=!0)}r&&(e.preventDefault(),e.stopPropagation())}function ya(e){if(e.key==="Escape")for(var r=le.length-1;r>=0;r--)le[r].close()}function za(){It||typeof document=="undefined"||(document.addEventListener("click",wa,!0),document.addEventListener("keydown",ya),It=!0)}function br(e){for(var r=0;r<le.length;r++)le[r]!==e&&le[r].close()}function _t(){hr=!0,typeof setTimeout=="function"&&setTimeout(function(){hr=!1},700)}function wr(e){za();var r={trigger:e.trigger,element:e.element,close:e.close};return le.push(r),function(){var a=le.indexOf(r);a!==-1&&le.splice(a,1)}}function ee(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,l=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=P&&P.writeButtonText||"Yorum Yap",i.onclick=n,o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var f=P&&P.filterIcon||"lines";u.innerHTML=ue(ut(f));var c=document.createElement("div");c.className="renuvex-pr-filter-menu",c.setAttribute("role","menu");var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],x=!1;function g(s){var m=c.classList.contains("renuvex-pr-open");c.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var w=s&&(s.restoreFocus===!0||s.restoreFocus==="auto"&&Qe());if(m&&w)try{u.focus({preventScroll:!0})}catch(y){try{u.focus()}catch(h){}}return m}function v(){br(b),c.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var s=c.querySelector(".renuvex-pr-filter-item-active")||c.querySelector(".renuvex-pr-filter-item");s&&requestAnimationFrame(function(){try{s.focus({preventScroll:!0})}catch(m){try{s.focus()}catch(w){}}})}p.forEach(function(s){var m=s[2],w=m?a:!a&&(t||"newest")===s[0],y=document.createElement("button");y.type="button",y.className="renuvex-pr-filter-item"+(w?" renuvex-pr-filter-item-active":""),y.setAttribute("role","menuitem"),y.textContent=s[1];var h=!1;function C(z,A){z&&(z.preventDefault(),z.stopPropagation()),!h&&(h=!0,x=!0,A!==!0&&_t(),g({restoreFocus:A}),l(s[0],m),setTimeout(function(){h=!1,x=!1},0))}y.addEventListener("pointerdown",function(z){z.button!==void 0&&z.button!==0||C(z,!1)}),typeof window!="undefined"&&!window.PointerEvent&&y.addEventListener("touchstart",function(z){C(z,!1)},{passive:!1}),y.addEventListener("mousedown",function(z){z.button!==void 0&&z.button!==0||C(z,!1)}),y.addEventListener("keydown",function(z){(z.key==="Enter"||z.key===" ")&&C(z,!0)}),y.onclick=function(z){C(z,!1)},c.appendChild(y)}),u.onclick=function(){c.classList.contains("renuvex-pr-open")?g({restoreFocus:"auto"}):v()},d.addEventListener("keydown",function(s){s.key==="Escape"&&c.classList.contains("renuvex-pr-open")&&(s.stopPropagation(),g({restoreFocus:!0}))}),d.addEventListener("focusout",function(s){if(c.classList.contains("renuvex-pr-open")&&!x){var m=s.relatedTarget;m&&d.contains(m)||g()}});var b=wr({trigger:d,element:c,close:g});return d.appendChild(u),d.appendChild(c),o.appendChild(d),o}var Mt=`
...
`;function Ot(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",n.appendChild(l);var o=document.createElement("button");o.className="renuvex-pr-fwizard-close",o.type="button",o.setAttribute("aria-label","Kapat");var i=J(ze);i&&o.appendChild(i),n.appendChild(o);var d=!1,u=null,f=null,c=!1;function p(){Z(a)}function x(h){xr(h,a,u&&u.root)}function g(){if(!d){if(d=!0,document.removeEventListener("keydown",v),a.removeEventListener("click",b),o.removeEventListener("click",g),c)Z(f);else{var h=u&&u.root?u.root.activeElement:null;if(h&&typeof h.blur=="function")try{h.blur()}catch(C){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(ir(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):a.parentNode&&a.parentNode.removeChild(a),cr();try{r()}catch(C){}},200)}}function v(h){if(h.key==="Escape"){g();return}x(h)}function b(h){h.target===a&&t&&g()}document.addEventListener("keydown",v),a.addEventListener("click",b),o.addEventListener("click",g);function s(h){f=mr(),c=Qe(),h&&l.appendChild(h),u=dr(),_e(u.root,Be+Ae+Mt),u.root.appendChild(a),ye(u.root),vr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),p()})}var m=null,w=null;function y(h,C){if(C=C||"error",m){try{m.remove()}catch(z){}m=null}w&&(clearTimeout(w),w=null),m=document.createElement("div"),m.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+C,m.textContent=h,n.appendChild(m),w=setTimeout(function(){m&&(m.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(m){try{m.remove()}catch(z){}m=null}},300))},4e3)}return{open:s,close:g,content:l,setAllowOutsideClose:function(h){t=!!h},setStepAttr:function(h){n.setAttribute("data-step",String(h))},showToast:y}}var Rr=4;function He(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Ft(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(l){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Rr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(l){return l!==n})}}}}function Ht(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},l=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=ue(Pe)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var u=[],f=0;f<Rr;f++){var c=document.createElement("span");c.className="renuvex-pr-fwizard-progress-seg",d.appendChild(c),u.push(c)}o.appendChild(d);var p=document.createElement("button");p.type="button";var x=null;function g(b){x&&p.removeEventListener("click",x),x=b,b&&p.addEventListener("click",b)}o.appendChild(p);function v(b,s){var m=r.indexOf(b)!==-1,w=t.indexOf(b)!==-1,y=s&&(s.images&&s.images.length>0||s.pendingImages&&s.pendingImages.length>0);if(m)b===2&&y?(p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",g(function(){l()})):(p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.setAttribute("aria-label","Atla"),p.innerHTML="<span>Atla</span>",g(function(){n()})),p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),p.style.visibility="",p.tabIndex=0;else if(w){p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Sonraki"),p.innerHTML="Sonraki",p.style.visibility="",p.tabIndex=0;var h=He(b,s);p.disabled=!h,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!h),g(function(){p.disabled||l()})}else p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.innerHTML="",p.style.visibility="hidden",p.tabIndex=-1,p.disabled=!0,g(null)}return{el:o,update:function(b,s){u.forEach(function(w,y){y+1<=b?w.classList.add("renuvex-pr-fwizard-progress-seg-active"):w.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var m=b<=1;i.style.visibility=m?"hidden":"",i.style.pointerEvents=m?"none":"",i.tabIndex=m?-1:0,v(b,s)},setNextDisabled:function(b){p.classList.contains("renuvex-pr-fwizard-cta-btn")&&(p.disabled=!!b,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!b))},setThanksState:function(b){i.style.visibility="hidden",d.style.visibility="hidden",p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",p.style.visibility="",p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),g(b)}}}function Yt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=Ke(P||{});me(i);var d=[];function u(b){d.forEach(function(s,m){var w=m<b;s.classList.toggle("renuvex-pr-fwizard-star-active",w),s.setAttribute("aria-checked",m+1===b?"true":"false"),s.innerHTML=w?K("full"):K("outline")})}function f(b){e.set({rating:b}),u(b)}function c(b){var s=d[b-1];if(s)try{s.focus()}catch(m){}}function p(b,s){s&&typeof s.preventDefault=="function"&&s.preventDefault(),s&&typeof s.stopPropagation=="function"&&s.stopPropagation(),!a&&(a=!0,f(b),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var x=1;x<=5;x++)(function(b){var s=document.createElement("button");s.type="button",s.className="renuvex-pr-fwizard-star",s.setAttribute("role","radio"),s.setAttribute("aria-label",b+" y\u0131ld\u0131z"),s.innerHTML=K("outline"),s.addEventListener("mouseenter",function(){u(b)}),s.addEventListener("mouseleave",function(){u(e.get().rating)}),s.addEventListener("pointerdown",function(m){m.button&&m.button!==0||p(b,m)}),typeof window!="undefined"&&!window.PointerEvent&&s.addEventListener("touchstart",function(m){p(b,m)},{passive:!1}),s.addEventListener("mousedown",function(m){window.PointerEvent||p(b,m)}),s.addEventListener("keydown",function(m){if(m.key==="Enter"||m.key===" "){p(b,m);return}var w=0;m.key==="ArrowRight"||m.key==="ArrowUp"?w=Math.min(5,b+1):m.key==="ArrowLeft"||m.key==="ArrowDown"?w=Math.max(1,b-1):m.key==="Home"?w=1:m.key==="End"&&(w=5),w&&(m.preventDefault(),f(w),c(w))}),s.addEventListener("click",function(m){p(b,m)}),d.push(s),o.appendChild(s)})(x);u(e.get().rating);var g=null,v=function(b){var s=b&&b.detail&&b.detail.settings;s&&s===g||(g=s||null,i=Ke(s||P||{}),u(e.get().rating))};return window.addEventListener(Ce,v),t.appendChild(o),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ce,v)}}}var Dt=3,Ca=10*1024*1024;function jt(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",o.appendChild(i),o.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),o.appendChild(u),a.appendChild(o);var f=r.revokeBlobUrl||function(m){m&&typeof m=="string"&&m.startsWith("blob:")&&URL.revokeObjectURL(m)},c=r.blobMap||{},p=r.urlToFinger||{};function x(){if(!t){var m=e.get().images||[],w=e.get().pendingImages||[],y=m.map(function(h){return{url:h,isPending:!1}}).concat(w.map(function(h){return{url:h.url,file:h.file,isPending:!0,error:h.error}}));u.innerHTML="",y.forEach(function(h){var C=c[h.url]||h.url,z=g(h,C);u.appendChild(z)}),b()}}function g(m,w){var y=document.createElement("div");y.className="renuvex-pr-fwizard-photo-thumb";var h=document.createElement("img");h.src=w,h.alt="",h.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",y.appendChild(h);var C=document.createElement("div");C.className="renuvex-pr-fwizard-photo-loading",C.style.display="none",y.appendChild(C);var z=document.createElement("button");z.type="button",z.className="renuvex-pr-fwizard-photo-remove",z.setAttribute("aria-label","Kald\u0131r");var A=J(ze);return A&&z.appendChild(A),y.appendChild(z),v(y,m,w),y}function v(m,w,y){var h=m.querySelector("img");h.src!==y&&(h.src=y);var C=m.querySelector(".renuvex-pr-fwizard-photo-loading");if(w.isPending&&w.error){C.style.display="flex",C.textContent="";var z=document.createElement("span");z.className="renuvex-pr-upload-error",z.textContent="\u2717 "+w.error,C.appendChild(z)}else C.style.display="none",C.textContent="";var A=m.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var k=p[w.url]||(w.file?w.file.name+"_"+w.file.size:null),L=c[w.url],T={};k&&(T.fingerprints=(e.get().fingerprints||[]).filter(function(S){return S!==k})),w.isPending?T.pendingImages=(e.get().pendingImages||[]).filter(function(S){return S.url!==w.url}):T.images=(e.get().images||[]).filter(function(S){return S!==w.url}),e.set(T),f(w.url),f(L),delete p[w.url],L&&delete p[L],c[w.url]&&delete c[w.url]}}function b(){var m=(e.get().images||[]).length,w=(e.get().pendingImages||[]).length,y=m+w,h=y>=Dt;y>0?(o.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=ue(vt)):(o.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=ue(st)+"<span>Foto\u011Fraf Ekle</span>"),h?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(m){var w=(e.get().images||[]).length+(e.get().pendingImages||[]).length,y=Array.from(m.target.files).slice(0,Dt-w);d.value="";var h=(e.get().pendingImages||[]).length,C=e.get().images||[],z=C.length;if(y.length!==0){for(var A=[],k=[],L=0;L<y.length;L++){var T=y[L],S=T.name+"_"+T.size,N=(e.get().fingerprints||[]).some(function(_){return _===S})||A.some(function(_){return _.file.name+"_"+_.file.size===S});if(!N){if(T.size>Ca){var E="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(E,"error"):alert(E);continue}var B=URL.createObjectURL(T);p[B]=S,A.push({url:B,file:T,error:null}),k.push({url:B,file:T});var M=(e.get().fingerprints||[]).slice();M.push(S),e.set({fingerprints:M})}}if(A.length!==0){var R=(e.get().pendingImages||[]).concat(A),j=async function(){for(var _=0;_<k.length;_++){var V=k[_],Se=V.file,q=V.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Ue=(e.get().pendingImages||[]).filter(function(I){return I.url!==q}),Ee=(e.get().images||[]).slice();Ee.push(q),e.set({pendingImages:Ue,images:Ee});continue}try{var ge=await Je(Xe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ge})});if(!ge.ok)throw ge.status===429?new Error("rate_limit"):new Error("sign failed");var O=await ge.json();if(!O.folder)throw new Error("sign folder missing");var G=new FormData;G.append("file",Se),G.append("api_key",O.api_key),G.append("timestamp",O.timestamp),G.append("signature",O.signature),G.append("folder",O.folder);var he=await fetch("https://api.cloudinary.com/v1_1/"+O.cloud_name+"/image/upload",{method:"POST",body:G}),te=await he.json();if(te.secure_url&&xt(te.secure_url)){var F=(e.get().pendingImages||[]).some(function(I){return I.url===q});if(!F)continue;c[te.secure_url]=q,p[te.secure_url]=p[q];var be=(e.get().pendingImages||[]).filter(function(I){return I.url!==q}),U=(e.get().images||[]).slice();U.push(te.secure_url),e.set({pendingImages:be,images:U});try{Je(Xe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ge,secureUrl:te.secure_url})}).catch(function(){})}catch(I){}}else throw new Error("invalid image url")}catch(I){console.error("[renuvex-pr] Image upload failed:",I);var We=I.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(We,"error");var we=(e.get().pendingImages||[]).map(function(H){return H.url===q?{url:H.url,file:H.file,error:We}:H});e.set({pendingImages:we})}}};if(z===0&&h===0){t=!0;var re=!r.canNavigate||r.canNavigate();re&&e.goNext()}e.set({pendingImages:R}),j()}}};var s=e.onChange(x);return x(),{el:a,destroy:function(){t=!0,d.onchange=null,s&&s()}}}var Ir=2e3,ka=60;function Vt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=ka,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),l.appendChild(o);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Ir,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),l.appendChild(d);function u(){var c=i.value.length;d.textContent=c+"/"+Ir,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",c>=Ir)}function f(){return He(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),u(),t(f())}),a.appendChild(l),u(),setTimeout(function(){t(f())},0),{el:a,destroy:function(){}}}var Sa=40;function Ut(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",n.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Sa,u.setAttribute("aria-required","true"),u.value=e.get().author||"",i.appendChild(d),i.appendChild(u),o.appendChild(i);var f=document.createElement("div");f.className="renuvex-pr-fwizard-field";var c=document.createElement("label");c.className="renuvex-pr-fwizard-label",c.textContent="E-posta (opsiyonel)";var p=document.createElement("input");p.type="email",p.className="renuvex-pr-fwizard-input",p.setAttribute("autocomplete","email"),p.value=e.get().email||"",f.appendChild(c),f.appendChild(p),o.appendChild(f);var x=document.createElement("div");x.className="renuvex-pr-fwizard-notice",x.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(x);var g=document.createElement("div");g.className="renuvex-pr-fwizard-msg",g.setAttribute("role","alert"),g.setAttribute("aria-live","assertive"),o.appendChild(g);var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-submit-btn",v.textContent="G\xF6nder",o.appendChild(v),n.appendChild(o);function b(){return He(4,e.get())}function s(){var h=!b(),C=(e.get().pendingImages||[]).length,z=C>0;z?(v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=h,v.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",h),v.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),s(),t(b())}),p.addEventListener("input",function(){e.set({email:p.value})}),s(),setTimeout(function(){t(b())},0);function m(){g.textContent=""}function w(h){m();var C=document.createElement("div");C.className="renuvex-pr-fwizard-msg-error",C.textContent=h||"",g.appendChild(C)}v.onclick=async function(){if(!v.disabled){var h=e.get(),C=(h.author||"").trim(),z=(h.comment||"").trim();if(p.value.trim()&&!p.checkValidity()){p.reportValidity();return}if(!C){w("Gerekli alan");return}if(!h.rating){w("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",m(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var k=ct(window.location.href),L=h.productName||null,T=await Je(Xe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ge,productId:h.productId||null,slug:k||null,productName:L,author:C,title:(h.title||"").trim()||null,comment:z||null,rating:h.rating,images:h.images||[]})},15e3);if(T.ok)a();else{var S=await T.json().catch(function(){return{}});throw new Error(S.error||"Yorum kaydedilemedi.")}}catch(B){var N=B&&(B.name==="AbortError"||/signal/i.test(B.message||"")),E=N?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":B.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(E,"error"):w(E),v.disabled=!1,v.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent=A}}};var y=e.onChange(s);return{el:n,destroy:function(){v.onclick=null,y&&y()}}}function Ea(e,r,t){if(t=t||{},e===1)return Yt(r,{canNavigate:t.canNavigate});if(e===2)return jt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Vt(r,{onValidityChange:t.onValidityChange});if(e===4)return Ut(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function Wt(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function qt(e){e=e||{};var r=Ft({productId:e.productId,productName:e.productName}),t={},a={},n={};function l(k){if(!(!k||typeof k!="string"||!k.startsWith("blob:")||n[k])){n[k]=!0;try{URL.revokeObjectURL(k)}catch(L){}}}function o(){Object.keys(a).forEach(function(L){l(L)}),Object.keys(t).forEach(function(L){l(t[L])});var k=r.get();(k.pendingImages||[]).forEach(function(L){l(L&&L.url)}),(k.images||[]).forEach(function(L){l(L)})}var i=Ot({onClose:function(){window.removeEventListener("popstate",u),gr(d),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=fr(),u=function(k){i&&i.close&&i.close()};window.addEventListener("popstate",u);var f=document.createElement("div");f.className="renuvex-pr-fwizard-step-wrap";var c=Ht({skippableSteps:[2],nextableSteps:[3],onBack:function(){g==="idle"&&r.goBack()},onSkip:function(){g==="idle"&&r.goNext()},onNext:function(){g==="idle"&&r.goNext()}}),p=document.createElement("div");p.className="renuvex-pr-fwizard-layout",p.appendChild(f),p.appendChild(c.el);var x=null,g="idle",v=null,b=!0,s=null;function m(k,L){f.innerHTML="";var T=Ea(k,r,{canNavigate:function(){return g==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:l,onValidityChange:function(E){c.setNextDisabled(!E)},onSuccess:y,showToast:i.showToast});if(x=T,c.update(k,r.get()),L){g="entering",T.el.classList.add("renuvex-pr-fwizard-step--enter");var S=null,N=function(){S&&clearTimeout(S),T.el.removeEventListener("animationend",N),T.el.classList.remove("renuvex-pr-fwizard-step--enter"),g="idle",v!==null&&h()};T.el.addEventListener("animationend",N),S=setTimeout(N,700)}else g="idle";f.appendChild(T.el),i.setStepAttr&&i.setStepAttr(k),k===3&&c.setNextDisabled(!0)}var w=!1;function y(){if(!w){if(w=!0,!x){f.innerHTML="";var k=Wt();k.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(k),i.setStepAttr("thanks"),c.setThanksState(i.close);return}var L=x;g="exiting",L.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(s&&clearTimeout(s),L.el.removeEventListener("animationend",T),L.destroy)try{L.destroy()}catch(N){}x===L&&(x=null),f.innerHTML="";var S=Wt();S.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(S),i.setStepAttr("thanks"),c.setThanksState(i.close),g="idle"};L.el.addEventListener("animationend",T),s=setTimeout(T,300)}}function h(){var k=r.get().currentStep;if(g!=="idle"){v=k;return}if(!x){var L=!b;b=!1,m(k,L);return}var T=x;g="exiting",T.el.classList.add("renuvex-pr-fwizard-step--exit");var S=function(){if(s&&clearTimeout(s),T.el.removeEventListener("animationend",S),T.destroy)try{T.destroy()}catch(E){}if(x===T){f.innerHTML="",x=null;var N=v!==null?v:r.get().currentStep;v=null,m(N,!0),g="idle"}};T.el.addEventListener("animationend",S),s=setTimeout(S,350)}h();var C=r.get().currentStep,z=r.onChange(function(k){k.currentStep!==C?(C=k.currentStep,h()):c.update(k.currentStep,k)}),A=i.close;return i.close=function(){z&&z(),typeof s!="undefined"&&s&&clearTimeout(s),A()},i.open(p),{close:i.close}}function D(){qt({productId:Y||"",productName:Le||""})}var Gt=`
...
`;var Ta={id:"classic",name:"Klasik (A\xE7\u0131k)"},Aa=Gt;function La(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,l=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,c=e.onFilterChange,p=e.onSortChange;me(n);var x=document.createElement("div");x.className="renuvex-pr-summary";var g=(o[3]||0)+(o[4]||0),v=l>0?Math.round(g/l*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+K("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",x.appendChild(b);var s=document.createElement("div");if(s.className="renuvex-pr-summary-block renuvex-pr-summary-count",s.textContent=l.toLocaleString("tr-TR")+" Yorum",x.appendChild(s),a.showRecommendation!==!1&&v>0){var m=document.createElement("div");m.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",m.innerHTML='<span class="renuvex-pr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",x.appendChild(m)}return x.appendChild(Fe({ratingCounts:o,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:c})),x.appendChild(ee({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:D,onSortChange:p})),x}var _r={};ce(_r,{css:()=>Pa,meta:()=>Na,render:()=>Ra});var Xt=`
...
`;var Na={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Pa=Xt;function Ra(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,o=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentHasImages,f=e.onFilterChange,c=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-compact";var x=document.createElement("div");x.className="renuvex-pr-compact-header";var g=document.createElement("div");g.className="renuvex-pr-compact-trigger-wrap";var v=document.createElement("button");v.className="renuvex-pr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Re(o,a)+'</span><span class="renuvex-pr-compact-trigger-text">'+n.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+ue(dt)+"</span>",g.appendChild(v),x.appendChild(g);var b=ee({widget:r,currentOrderBy:d,currentHasImages:u,onWriteClick:D,onSortChange:c}),s=b.querySelector(".renuvex-pr-filter-wrap"),m=b.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-compact-actions-slot",m&&w.appendChild(m),s&&w.appendChild(s),x.appendChild(w),p.appendChild(x);var y=document.createElement("div");y.className="renuvex-pr-compact-panel",y.setAttribute("role","dialog"),y.setAttribute("aria-hidden","true");var h=document.createElement("div");h.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+K("full")+"</span><span>"+o+"</span>",h.appendChild(C),h.appendChild(Fe({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),y.appendChild(h);var z=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function A(_){var V=_?p:g;y.parentNode!==V&&(y.classList.contains("renuvex-pr-open")&&(y.classList.remove("renuvex-pr-open"),y.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),V.appendChild(y))}if(A(z?z.matches:!1),z){var k=function(_){A(_.matches)};z.addEventListener?z.addEventListener("change",k):z.addListener&&z.addListener(k)}if(m){var L=document.createElement("button");L.className="renuvex-pr-write-btn",L.textContent=P&&P.writeButtonText||"Yorum Yap",L.onclick=D;var T=document.createElement("div");T.className="renuvex-pr-compact-write-row",T.appendChild(L),p.appendChild(T)}function S(){y.classList.remove("renuvex-pr-open"),y.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function N(){br(E),y.classList.add("renuvex-pr-open"),y.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){y.classList.contains("renuvex-pr-open")?S():N()};var E=null;function B(_){E&&(E(),E=null),_||(E=wr({trigger:g,element:y,close:S}))}if(B(z?z.matches:!1),z){var M=function(_){B(_.matches)};z.addEventListener?z.addEventListener("change",M):z.addListener&&z.addListener(M)}if(t.showRecommendation!==!1){var R=(l[3]||0)+(l[4]||0),j=n>0?Math.round(R/n*100):0;if(j>0){var re=document.createElement("div");re.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",re.style.marginTop="8px",re.innerHTML='<span class="renuvex-pr-recommend-pct">%'+j+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",h.appendChild(re)}}return p}var Mr={};ce(Mr,{css:()=>Ba,meta:()=>Ia,render:()=>_a});var Kt=`
...
`;var Ia={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ba=Kt;function _a(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,o=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentHasImages,f=e.onFilterChange,c=e.onSortChange;me(a);var p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-split";var x=document.createElement("div");x.className="renuvex-pr-split-col renuvex-pr-split-left";var g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",g.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+K("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",x.appendChild(g);var v=document.createElement("div");v.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",v.textContent=n.toLocaleString("tr-TR")+" Yorum",x.appendChild(v),p.appendChild(x);var b=document.createElement("div");b.className="renuvex-pr-split-col renuvex-pr-split-mid",b.appendChild(Fe({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),p.appendChild(b);var s=ee({widget:r,currentOrderBy:d,currentHasImages:u,onWriteClick:D,onSortChange:c}),m=s.querySelector(".renuvex-pr-filter-wrap"),w=s.querySelector(".renuvex-pr-write-btn"),y=document.createElement("div");y.className="renuvex-pr-split-col renuvex-pr-split-right",w&&y.appendChild(w),m&&y.appendChild(m),p.appendChild(y);var h=(l[3]||0)+(l[4]||0),C=n>0?Math.round(h/n*100):0,z=document.createElement("div");z.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",z.innerHTML='<span class="renuvex-pr-recommend-pct">%'+C+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||C===0;return A&&z.classList.add("renuvex-pr-split-rec-hidden"),x.appendChild(z),p}var Or={};ce(Or,{css:()=>Oa,meta:()=>Ma,render:()=>Fa});var Jt=`
...
`;var ja={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},Va=Qt;function Ua(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var l=document.createElement("span");l.className="renuvex-pr-review-stars",l.innerHTML=de(e.rating,P),n.appendChild(l);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=se(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var u=(e.comment||"").trim();u&&t.appendChild(Ye(u,"renuvex-pr-body").fragment);var f=xe(e);if(f.length){var c=document.createElement("div");c.className="renuvex-pr-gallery",f.forEach(function(x){var g=document.createElement("img"),v=ae(x,W);g.src=v.src,g.srcset=v.srcset,g.loading="lazy",g.decoding="async",g.width=W,g.height=W,g.className="renuvex-pr-img",ne(g),g.setAttribute("data-renuvex-img-url",x),(function(b){fe(g,function(){oe(e,b,r)})})(x),c.appendChild(g)}),t.appendChild(c)}var p=De(e.merchantReply);return p&&t.appendChild(p),t}var Yr={};ce(Yr,{css:()=>qa,meta:()=>Wa,render:()=>Ga});var ea=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var Wa={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-w-mobile":"80px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-w-mobile":"100px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-w-mobile":"110px"}}},qa=ea;function Ga(e,r){var t=xe(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=de(e.rating,P),l.appendChild(o);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",l.appendChild(i);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=se(e.createdAt),l.appendChild(d),n.appendChild(l);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var f=document.createElement("div");f.className="renuvex-pr-review-list-title",f.textContent=e.title,u.appendChild(f)}var c=(e.comment||"").trim();c&&u.appendChild(Ye(c,"renuvex-pr-review-list-body").fragment);var p=De(e.merchantReply);if(p&&u.appendChild(p),n.appendChild(u),a){var x=document.createElement("div");x.className="renuvex-pr-review-list-media",t.forEach(function(g){var v=document.createElement("img"),b=ae(g,W);v.src=b.src,v.srcset=b.srcset,v.loading="lazy",v.decoding="async",v.width=W,v.height=Math.round(W*4/3),v.setAttribute("data-renuvex-img-url",g),ne(v),(function(s){fe(v,function(){oe(e,s,r)})})(g),x.appendChild(v)}),n.appendChild(x)}return n}var Dr={};ce(Dr,{css:()=>Ka,meta:()=>Xa,render:()=>Ja});var ra=`
...
`;var Xa={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Ka=ra;function Ja(e,r){var t=lr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=de(e.rating,P),l.appendChild(o),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,l.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",l.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=se(e.createdAt),l.appendChild(u);var f=(e.comment||"").trim();if(f&&l.appendChild(Ye(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){oe(e,t,r)}}:null).fragment),n.appendChild(l),a){var c=document.createElement("div");c.className="renuvex-pr-review-gallery-media";var p=document.createElement("img"),x=ae(t,pr);p.src=x.src,p.srcset=x.srcset,p.loading="lazy",p.decoding="async",p.width=pr,p.height=Math.round(pr*4/3),ne(p),p.setAttribute("data-renuvex-img-url",t),fe(p,function(){oe(e,t,r)}),c.appendChild(p),n.appendChild(c)}var g=De(e.merchantReply,t?function(){oe(e,t,r)}:null);return g&&(g.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(g)),n}var Cr={card:Hr,list:Yr,gallery:Dr};function $e(e){return Cr[e]||Cr.card}function ta(){return Object.keys(Cr).map(function(e){return Cr[e].css||""}).join(`
`)}var jr=0;function je(){return jr++,jr}function Ve(e,r){return e!==jr?!1:r?!(r.productId!==void 0&&Y!==r.productId||r.orderBy!==void 0&&X!==r.orderBy||r.page!==void 0&&er!==r.page||r.ratingFilter!==void 0&&$!==r.ratingFilter||r.hasImages!==void 0&&Q!==r.hasImages):!0}var Vr={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Ur={small:80,medium:110,large:140};function aa(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),a.appendChild(n),a.appendChild(l);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(i),r}function na(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function ke(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+a+","+n+","+l+","+r+")"}function ia(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=ke(o,.06),f=r.reviewStarColor||"#f59e0b",c=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",x=r.btnBorderColor||"#111111",g=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",b=r.filterBtnBorderColor||"#111111",s=r.filterMenuBgColor||"#ffffff",m=r.filterMenuBorderColor||"#e5e7eb",w=r.filterItemTextColor||"#111111",y=r.filterItemHoverBgColor||"#f3f4f6",h=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",z=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",k=r.reviewBodyColor||"#111111",L=r.reviewBorderColor||"#e5e7eb",T=r.replyBgColor||"#f9fafb",S=r.replyBorderColor||"#747474",N=r.replyLabelColor||"#111111",E=r.replyTextColor||"#111111",B=r.photoTitleColor||"#111111",M=ke("#111111",.05),R=r.photoArrowBgColor||"#ffffff",j=r.photoArrowTextColor||"#111111",re=ke("#111111",.12),_=r.formBgColor||"#ffffff",V=r.formPrimaryTextColor||"#111111",Se=r.formSecondaryTextColor||"#3b3b3b",q=r.inputTextColor||V,Ue=r.inputBorderColor||"#d1d5db",Ee=r.placeholderColor||"#9ca3af",ge=r.formStepBarColor||"#111111",O=r.formBtnBgColor||"#111111",G=r.formBtnTextColor||"#ffffff",he=r.formBtnBorderColor||"#111111",te=ke(O,.06),F=ke(O,.18),be=ke(G,.85),U=ke(V,.06),We=r.loadMoreBgColor||"#ffffff",we=r.loadMoreTextColor||"#111111",I=r.loadMoreBorderColor||"#111111",H={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":c,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":x,"--renuvex-pr-filter-btn-bg":g,"--renuvex-pr-filter-btn-text":v,"--renuvex-pr-filter-btn-border":b,"--renuvex-pr-filter-menu-bg":s,"--renuvex-pr-filter-menu-border":m,"--renuvex-pr-filter-item-text":w,"--renuvex-pr-filter-item-hover-bg":y,"--renuvex-pr-filter-item-active":h,"--renuvex-pr-review-title":C,"--renuvex-pr-review-author":z,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":k,"--renuvex-pr-review-border":L,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":T,"--renuvex-pr-reply-border":S,"--renuvex-pr-reply-label":N,"--renuvex-pr-reply-text":E,"--renuvex-pr-photo-title":B,"--renuvex-pr-photo-image-border":M,"--renuvex-pr-photo-arrow-bg":R,"--renuvex-pr-photo-arrow-text":j,"--renuvex-pr-photo-arrow-border":re,"--renuvex-pr-fwizard-bg":_,"--renuvex-pr-fwizard-text":V,"--renuvex-pr-fwizard-secondary-text":Se,"--renuvex-pr-fwizard-input-bg":_,"--renuvex-pr-fwizard-input-text":q,"--renuvex-pr-fwizard-input-border":Ue,"--renuvex-pr-fwizard-placeholder":Ee,"--renuvex-pr-fwizard-close-text":V,"--renuvex-pr-fwizard-close-hover-bg":U,"--renuvex-pr-fwizard-progress-bg":U,"--renuvex-pr-fwizard-progress-active":ge,"--renuvex-pr-fwizard-btn-bg":O,"--renuvex-pr-fwizard-btn-text":G,"--renuvex-pr-fwizard-btn-border":he,"--renuvex-pr-fwizard-btn-disabled-bg":F,"--renuvex-pr-fwizard-btn-disabled-text":be,"--renuvex-pr-fwizard-nav-hover-bg":te,"--renuvex-pr-load-more-bg":We,"--renuvex-pr-load-more-text":we,"--renuvex-pr-load-more-border":I};Object.keys(H).forEach(function(pe){e.style.setProperty(pe,H[pe])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function oa(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,l=e.wireLightboxTrigger,o=(e.photoStripReviews||[]).filter(function(y){return xe(y).length>0});if(!(r.showPhotoGallery!==!1&&!a&&o.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",u=document.createElement("div");u.className="renuvex-pr-photo-title",u.textContent=d,i.appendChild(u)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var c=document.createElement("div");c.className="renuvex-pr-photo-strip";var p=W,x=r.reviewLayout==="card"?W:Math.round(W*4/3),g=0;o.forEach(function(y){if(!(g>=15)){var h=lr(y);if(h){var C=document.createElement("img"),z=ae(h,W);C.src=z.src,C.srcset=z.srcset,C.loading=g<3?"eager":"lazy",C.decoding="async",C.width=p,C.height=x,C.className="renuvex-pr-photo-strip-thumb",C.alt="Yorum foto\u011Fraf\u0131",ne(C),(function(A,k){l(C,function(){n(k,A,o)})})(h,y),c.appendChild(C),g++}}});var v=document.createElement("button");v.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var b=J(Pe);b&&v.appendChild(b),v.setAttribute("aria-label","\xD6nceki"),v.onclick=function(){c.scrollBy({left:-200,behavior:"smooth"})};var s=document.createElement("button");s.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var m=J(or);m&&s.appendChild(m),s.setAttribute("aria-label","Sonraki"),s.onclick=function(){c.scrollBy({left:200,behavior:"smooth"})};var w=document.createElement("div");return w.className="renuvex-pr-photo-strip-wrap",w.appendChild(v),w.appendChild(c),w.appendChild(s),i.appendChild(w),i}function la(e){var r=e.render;async function t(){var l=je(),o=Y,i=X,d=$,u=Q,f=await Ie(Y,X,1,$,Q);Ve(l,{productId:o,orderBy:i,ratingFilter:d,hasImages:u})&&await r(Y,P,f,Le,X,1,Jr)}async function a(l){var o=je(),i=$===l?null:l,d=Y,u=X,f=Q;$r(i),Ne(1);var c=await Ie(Y,X,1,i,Q);Ve(o,{productId:d,orderBy:u,page:1,ratingFilter:i,hasImages:f})&&await r(Y,P,c,Le,X,1)}async function n(l,o){var i=je(),d=Y,u=$;Ne(1);var f=l,c=!1;o&&(c=!0,f="newest"),Qr(c),rr(f);var p=await Ie(Y,f,1,$,c);Ve(i,{productId:d,orderBy:f,page:1,ratingFilter:u,hasImages:c})&&await r(Y,P,p,Le,f,1)}return{onRetry:t,onFilterChange:a,onSortChange:n}}function Za(){return bt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function $a(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=gt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),ht(t,{surface:"reviews",productId:r||""}),t}async function Wr(e,r,t,a,n,l,o){if(pt){nr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:l,badgeSettings:o});return}ar(!0),et(e),rt(r),o!==void 0&&tt(o),at(a),n&&rr(n),l&&Ne(l),t!=null&&nt(t);var i=la({render:Wr});try{let we=function(I,H){if(!(!I||!I.meta||!I.meta.sizeOverrides)){var pe=I.meta.sizeOverrides[H];pe&&Object.keys(pe).forEach(function(qe){x.style.setProperty(qe,pe[qe])})}};var We=we,d=zr(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,c=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",p=u&&f?c:"",x=document.documentElement;ia(x,r);var g=r.borderRadius!==void 0?r.borderRadius:8,v=Vr[r.size]||Vr.medium,b=Ur[r.thumbnailSize]||Ur.medium,s=$e(r.reviewLayout);if(s.meta&&s.meta.sizeOverrides&&s.meta.sizeOverrides[r.size]){var m=s.meta.sizeOverrides[r.size],w=m["--renuvex-pr-list-photo-w"]||m["--renuvex-pr-gallery-photo-w"];w&&(b=parseInt(w))}x.style.setProperty("--renuvex-pr-title-size",v.titleSize+"px"),x.style.setProperty("--renuvex-pr-review-text-size",v.reviewTextSize+"px"),x.style.setProperty("--renuvex-pr-review-title-size",v.reviewTitleSize+"px"),x.style.setProperty("--renuvex-pr-author-size",v.authorSize+"px"),x.style.setProperty("--renuvex-pr-reply-name-size",v.replyNameSize+"px"),x.style.setProperty("--renuvex-pr-reply-text-size",v.replyTextSize+"px"),x.style.setProperty("--renuvex-pr-radius",g+"px"),x.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,g-4)+"px"),x.style.setProperty("--renuvex-pr-photo-title-size",v.photoTitleSize+"px"),x.style.setProperty("--renuvex-pr-avg-rating-size",v.avgRatingSize+"px"),x.style.setProperty("--renuvex-pr-review-count-size",v.reviewCountSize+"px"),x.style.setProperty("--renuvex-pr-compact-count-size",v.compactCountSize+"px"),x.style.setProperty("--renuvex-pr-recommend-size",v.recommendSize+"px"),x.style.setProperty("--renuvex-pr-btn-text-size",v.btnTextSize+"px"),x.style.setProperty("--renuvex-pr-bar-label-size",v.barLabelSize+"px"),x.style.setProperty("--renuvex-pr-minimal-avg-size",v.minimalAvgSize+"px"),x.style.setProperty("--renuvex-pr-hero-avg-size",v.heroAvgSize+"px"),x.style.setProperty("--renuvex-pr-bar-count-size",v.barCountSize+"px"),x.style.setProperty("--renuvex-pr-review-date-size",v.reviewDateSize+"px"),x.style.setProperty("--renuvex-pr-filter-text-size",v.filterTextSize+"px"),x.style.setProperty("--renuvex-pr-load-more-size",v.loadMoreSize+"px"),x.style.setProperty("--renuvex-pr-read-more-size",v.readMoreSize+"px"),x.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var y=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";x.style.setProperty("--renuvex-pr-review-star-color",y),x.style.setProperty("--renuvex-pr-star-size",v.reviewStarSize+"px"),x.style.setProperty("--renuvex-pr-avg-star-size",v.avgStarSize+"px"),we(zr(r.summaryLayout),r.size),we($e(r.reviewLayout),r.size);var h=Ke(r),C=Za();if(!C)return;var z=$a(C,e),A=document.getElementById("renuvex-reviews");A||(A=document.createElement("div"),A.id="renuvex-reviews",A.style.minHeight="200px"),A.parentNode!==z&&z.appendChild(A);var k=wt(A),L=Be+Ae+sr+$t()+ta();_e(k,L);var T=zt(k);if(r.enabled===!1){A.style.minHeight="auto",T.replaceChildren(aa(r.borderRadius!==void 0?r.borderRadius:8)),ar(!1);var S=tr;nr(null),S&&Wr(S.productId,S.settings,S.reviewsData,S.productName,S.orderBy,S.page,S.badgeSettings);return}var N=document.createElement("p");N.className="renuvex-pr-state-msg renuvex-pr-state-loading",N.textContent="Yorumlar y\xFCkleniyor...",T.replaceChildren(N);try{var E=t||{},B=Ar(E),M=B?[]:E.data&&E.data.reviews||[];it(M),T.replaceChildren();var R=document.createElement("section");if(R.id="renuvex-reviews-widget",R.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),R.className="renuvex-pr-reviews-widget",R.setAttribute("data-renuvex-surface","reviews"),e&&R.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(R.style.width="100%",R.style.maxWidth="100%",R.style.marginLeft="0",R.style.marginRight="0"),p){var j=document.createElement("div"),re=r.summaryLayout||"classic";j.className="renuvex-pr-title renuvex-pr-title-"+re,j.textContent=p,R.appendChild(j)}if(B){R.appendChild(na(E.message,i.onRetry)),T.appendChild(R),ye(k),kr(R,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return k.getElementById("renuvex-reviews-widget")});return}var _=E.data&&E.data.allCount||0,V=E.data&&E.data.ratingCounts||null,Se=V||[0,0,0,0,0],q=E.data&&E.data.avgRating||"0.0";if(!V&&M.length>0){M.forEach(function(I){I.rating>=1&&I.rating<=5&&Se[I.rating-1]++});var Ue=M.reduce(function(I,H){return I+H.rating},0);q=(Ue/M.length).toFixed(1)}if(_>0){var Ee=zr(r.summaryLayout),ge=Ee.render({widget:R,data:E,settings:r,iconPair:h,allCount:_,ratingCounts:Se,avgRatingVal:q,currentRatingFilter:$,currentOrderBy:X,currentHasImages:Q,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});R.appendChild(ge)}else{var O=document.createElement("button");O.className="renuvex-pr-write-btn",O.style.cssText="display:block;margin:16px auto 0;",O.textContent=r.writeButtonText||"Yorum Yap",O.onclick=D,R.appendChild(O)}var G=oa({settings:r,root:x,currentHasImages:Q,photoStripReviews:Zr,openReviewModal:oe,wireLightboxTrigger:fe});if(G&&R.appendChild(G),M.length===0){var he=document.createElement("p");he.className="renuvex-pr-state-msg",he.textContent="Hen\xFCz yorum yok.",R.appendChild(he)}else{var s=$e(r.reviewLayout);M.forEach(function(H){R.appendChild(s.render(H,Sr))})}var te=E.data&&E.data.hasMore;if(te){var F=document.createElement("button");F.className="renuvex-pr-load-more",F.textContent="Daha Fazla G\xF6ster",F.onclick=async function(){F.disabled=!0,F.textContent="Y\xFCkleniyor...";var I=je(),H=Y,pe=X,qe=er,qr=$,Gr=Q,Xr=qe+1,Te=await Ie(H,pe,Xr,qr,Gr);if(Ve(I,{productId:H,orderBy:pe,page:qe,ratingFilter:qr,hasImages:Gr}))if(Te&&!Ar(Te)&&Te.data&&Array.isArray(Te.data.reviews)){var Kr=ot(Te.data.reviews);lt(Kr),Ne(Xr);var pa=$e(P.reviewLayout);Kr.forEach(function(ua){R.insertBefore(pa.render(ua,Sr),F)}),Te.data.hasMore?(F.disabled=!1,F.textContent="Daha Fazla G\xF6ster"):F.remove()}else F.disabled=!1,F.textContent="Tekrar Dene"},R.appendChild(F)}T.appendChild(R),ye(k),kr(R,"reviews-widget",{productId:e||""},function(){return k.getElementById("renuvex-reviews-widget")})}catch(I){console.error("[renuvex-pr] render error:",I);var be=document.createElement("p");be.style.cssText="text-align:center;color:#dc2626;",be.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",T&&T.replaceChildren(be)}}finally{if(ar(!1),tr){var U=tr;nr(null),Wr(U.productId,U.settings,U.reviewsData,U.productName,U.orderBy,U.page,U.badgeSettings)}}}export{Wr as render};
