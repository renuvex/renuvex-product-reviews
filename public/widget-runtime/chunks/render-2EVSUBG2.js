...
import{a as Ne,d as ar}from"./chunk-FW6W6ZQL.js";import{b as Mr,c as Qe}from"./chunk-ZM24JLBV.js";import{A as or,a as ke,b as Jr,c as Pe,d as Re,e as ae,f as R,g as Zr,h as Be,j as Pr,k as $r,l as Rr,m as Je,n as Qr,o as et,p as rt,q as tt,r as at,s as nt,t as it,v as ot,w as lt,x as pt,y as nr,z as ir}from"./chunk-4OXLOSZH.js";import{A as ge,B as dr,C as U,D as ur,E as sr,F as Br,G as Ir,H as ne,I as ft,J as ie,K as gt,L as ht,c as Nr,e as fe,f as X,g as ue,h as K,i as ze,j as lr,k as Ze,l as dt,m as Ie,n as pr,o as ut,p as Ce,q as st,r as vt,t as ct,u as se,v as Me,x as mt,y as ve,z as xt}from"./chunk-5AYZP6CT.js";import{a as $e}from"./chunk-GSBAPHFO.js";import{a as xe,b as Xe,c as Ke,k as bt,l as Se}from"./chunk-YCWIZ2SG.js";var Fe=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function yt(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Oe(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function vr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function wt(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function kt(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var cr=`
...
`;function Qt(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function oe(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function ea(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function ra(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=ea()&&!n;if(a>0){var p=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",p+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ta(e){var r=document.body.style,t=document.documentElement.style;oe(t,"overflow",e.rootOverflow,e.rootOverflowPriority),oe(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),oe(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),oe(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),oe(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),oe(r,"position",e.bodyPosition,e.bodyPositionPriority),oe(r,"top",e.bodyTop,e.bodyTopPriority),oe(r,"left",e.bodyLeft,e.bodyLeftPriority),oe(r,"right",e.bodyRight,e.bodyRightPriority),oe(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var er=0,_e=null;function mr(){return er+=1,er>1||(_e=Qt(),ra(_e)),_e}function xr(){if(er!==0&&(er-=1,!(er>0))){var e=_e;_e=null,e&&ta(e)}}function aa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function fr(){var e=aa();return!e||e===document.body||e===document.documentElement?null:e}function J(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function na(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Fr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(na)}function ia(e,r){var t=e,a=Fr(e);!a.length&&r&&(t=r,a=Fr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;J(n)}function gr(e,r,t){if(e.key==="Tab"){var a=Fr(r);if(!a.length){e.preventDefault(),ia(r);return}var n=a[0],l=a[a.length-1],p=wt(t);if(!r.contains(p)){e.preventDefault(),J(n);return}if(a.indexOf(p)===-1){e.preventDefault(),J(e.shiftKey?l:n);return}e.shiftKey&&p===n?(e.preventDefault(),J(l)):!e.shiftKey&&p===l&&(e.preventDefault(),J(n))}}var zt="renuvexPrOverlay";function hr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[zt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function oa(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[zt]===e.id)}function br(e){if(oa(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function He(e){return ge(e)}function Ct(e,r,t,a,n){xr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&lr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),J(n)}function la(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=se(e.rating,R);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=ve(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a);var p=document.createElement("div");p.className="renuvex-pr-modal-title",p.textContent=e.title||"",p.style.display=e.title?"":"none",t.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-modal-author",o.textContent=e.author||"",t.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-modal-body",s.textContent=(e.comment||"").trim(),s.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(s);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var x=document.createElement("div");x.className="renuvex-pr-modal-reply-label",x.textContent=R&&R.merchantReplyLabel||"Ma\u011Faza Sahibi";var m=document.createElement("div");return m.className="renuvex-pr-modal-reply-text",m.textContent=e.merchantReply||"",u.appendChild(x),u.appendChild(m),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function St(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),l=n.querySelector(".renuvex-pr-modal-stars");l.innerHTML=se(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=ve(r.createdAt);var p=n.querySelector(".renuvex-pr-modal-title");p.textContent=r.title||"",p.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var o=n.querySelector(".renuvex-pr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var s=n.querySelector(".renuvex-pr-modal-reply");s.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",s.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",s.style.display=r.merchantReply?"":"none",e.scrollTop=0}function _r(e,r,t,a,n,l,p,o,s){var u=He(e),x=Math.max(0,Math.min(t||0,u.length-1)),m=document.createElement("div");m.className="renuvex-pr-modal-left";var i=document.createElement("img"),k=p==="next"?"renuvex-pr-modal-img-enter-right":p==="prev"?"renuvex-pr-modal-img-enter-left":"";i.className="renuvex-pr-modal-main-img"+(k?" "+k:""),i.src=Ir(u[x]||""),i.decoding="async",i.width=Br,i.height=Math.round(Br*4/3),i.alt="Yorum foto\u011Fraf\u0131",ft(i,function(T){if(T.style.display="none",!m.querySelector(".renuvex-pr-modal-img-error")){var L=document.createElement("div");L.className="renuvex-pr-modal-img-error",L.setAttribute("role","status"),L.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",m.insertBefore(L,T)}}),m.appendChild(i);var d=document.createElement("button");d.className="renuvex-pr-modal-close-mobile";var b=K(Ce);b&&d.appendChild(b),d.setAttribute("aria-label","Kapat"),d.onclick=function(T){T.stopPropagation(),l()},m.appendChild(d);var f=0;if(m.addEventListener("touchstart",function(T){f=T.touches[0].clientX},{passive:!0}),m.addEventListener("touchend",function(T){var L=f-T.changedTouches[0].clientX;if(!(Math.abs(L)<50)){if(L>0){if(y)ce(e,r,x+1,a,n,l,!0,"next",o,s);else if(g){var N=a[r+1];ce(N,r+1,0,a,n,l,!1,"next",o,s)}}else if(c)ce(e,r,x-1,a,n,l,!0,"prev",o,s);else if(w){var B=a[r-1],P=He(B);ce(B,r-1,P.length-1,a,n,l,!1,"prev",o,s)}}},{passive:!0}),u.length>1){var v=document.createElement("div");v.className="renuvex-pr-modal-thumbs",u.forEach(function(T,L){var N=document.createElement("img"),B=ne(T,sr);N.src=B.src,N.srcset=B.srcset,N.loading="lazy",N.decoding="async",N.width=sr,N.height=sr,N.className="renuvex-pr-modal-thumb"+(L===x?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(L+1),ie(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(L+1)+" se\xE7"),L===x&&N.setAttribute("aria-current","true"),(function(P){function V(){ce(e,r,P,a,n,l,!0,null,o,s)}N.onclick=V,N.onkeydown=function(G){(G.key==="Enter"||G.key===" ")&&(G.preventDefault(),V())}})(L),v.appendChild(N)}),m.appendChild(v)}var c=x>0,y=x<u.length-1,w=r>0,g=r<a.length-1,z=c||w,h=y||g;if(z){var A=document.createElement("button");A.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var E=K(Ie);E&&A.appendChild(E),A.setAttribute("aria-label","\xD6nceki"),A.onclick=function(T){if(T.stopPropagation(),c)ce(e,r,x-1,a,n,l,!0,"prev",o,s);else if(w){var L=a[r-1],N=He(L);ce(L,r-1,N.length-1,a,n,l,!1,"prev",o,s)}},m.appendChild(A)}if(h){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var S=K(pr);S&&C.appendChild(S),C.setAttribute("aria-label","Sonraki"),C.onclick=function(T){if(T.stopPropagation(),y)ce(e,r,x+1,a,n,l,!0,"next",o,s);else if(g){var L=a[r+1];ce(L,r+1,0,a,n,l,!1,"next",o,s)}},m.appendChild(C)}return m}function Et(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=He(a);n[0]&&(new Image().src=Ir(n[0]))}})}function Or(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function pa(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Or(t),Or(a),Or(n)}l(),t&&J(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ce(e,r,t,a,n,l,p,o,s,u){if(u&&(u.currentReview=e),p){var x=_r(e,r,t,a,n,l,o,s,u);n.firstChild&&n.replaceChild(x,n.firstChild)}else{var x=_r(e,r,t,a,n,l,o,s,u),m=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(x,n.firstChild),m&&St(m,e,u&&u.currentSettings),pa(s,n)}Et(r,a)}function le(e,r,t){var a=He(e);if(!a.length)return;var n=(t||[]).filter(function(h){return He(h).length>0}),l=n.findIndex(function(h){return h===e||h.id===e.id});l===-1&&(n.unshift(e),l=0);var p=a.indexOf(r);p<0&&(p=0);var o=document.createElement("div");o.className="renuvex-pr-modal-overlay";var s=document.createElement("div");s.className="renuvex-pr-modal";var u=!1,x=null,m=fr(),i=mr(),k=hr(),d={currentReview:e,currentSettings:R},b=null;function f(h){var A=h&&h.detail&&h.detail.settings;if(!(A&&A===b)){b=A||null,d.currentSettings=A||R;var E=s.querySelector(".renuvex-pr-modal-right");!E||!d.currentReview||St(E,d.currentReview,d.currentSettings)}}function v(){u||(u=!0,window.removeEventListener(Se,f),Ct(x&&x.host,c,v,i,m))}function c(h){if(h.key==="Escape"){y();return}gr(h,o,x&&x.root)}function y(){u||(u=!0,window.removeEventListener(Se,f),Ct(x&&x.host,c,v,i,m),br(k))}document.addEventListener("keydown",c),window.addEventListener("popstate",v),window.addEventListener(Se,f),o.onclick=function(){y()},s.onclick=function(h){h.stopPropagation()},s.appendChild(_r(e,l,p,n,s,y,null,o,d)),s.appendChild(la(e)),Et(l,n);var w=document.createElement("div");w.className="renuvex-pr-modal-wrap",w.tabIndex=-1,w.setAttribute("role","dialog"),w.setAttribute("aria-modal","true"),w.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),w.appendChild(s);var g=document.createElement("button");g.className="renuvex-pr-modal-close";var z=K(Ce);z&&g.appendChild(z),g.setAttribute("aria-label","Kapat"),g.onclick=function(h){h.stopPropagation(),y()},w.appendChild(g),o.appendChild(w),x=vr(),Oe(x.root,Fe+Ne+cr),x.root.appendChild(o),ze(x.root),J(w)}function he(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Dr={};xe(Dr,{meta:()=>fa,render:()=>ga});function Ye(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,l=e.onFilterChange;fe(a);var p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var o=5;o>=1;o--){var s=r[o-1]||0,u=t>0?Math.round(s/t*100):0,x=n===o,m=document.createElement("div");m.className="renuvex-pr-bar-row"+(x?" renuvex-pr-bar-active":""),n&&!x&&(m.style.opacity="0.35");for(var i="",k=1;k<=5;k++){var d=k<=o;i+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(d?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+X(d?"full":"outline")+"</span>"}m.innerHTML='<span class="renuvex-pr-bar-label">'+i+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(b){m.onclick=function(){l(b)}})(o),p.appendChild(m)}return p}var pe=[],Tt=!1,yr=!1;function Lt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function da(e){if(yr){yr=!1,e.preventDefault(),e.stopPropagation();return}for(var r=!1,t=pe.length-1;t>=0;t--){var a=pe[t];Lt(e,a.trigger)||Lt(e,a.element)||a.close()&&(r=!0)}r&&(e.preventDefault(),e.stopPropagation())}function ua(e){if(e.key==="Escape")for(var r=pe.length-1;r>=0;r--)pe[r].close()}function sa(){Tt||typeof document=="undefined"||(document.addEventListener("click",da,!0),document.addEventListener("keydown",ua),Tt=!0)}function wr(e){for(var r=0;r<pe.length;r++)pe[r]!==e&&pe[r].close()}function At(){yr=!0,typeof setTimeout=="function"&&setTimeout(function(){yr=!1},700)}function kr(e){sa();var r={trigger:e.trigger,element:e.element,close:e.close};return pe.push(r),function(){var a=pe.indexOf(r);a!==-1&&pe.splice(a,1)}}function re(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,l=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var o=document.createElement("button");o.className="renuvex-pr-write-btn",o.textContent=R&&R.writeButtonText||"Yorum Yap",o.onclick=n,p.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var x=R&&R.filterIcon||"lines";u.innerHTML=ue(dt(x));var m=document.createElement("div");m.className="renuvex-pr-filter-menu",m.setAttribute("role","menu");var i=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],k=!1;function d(v){var c=m.classList.contains("renuvex-pr-open");m.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var y=v&&(v.restoreFocus===!0||v.restoreFocus==="auto"&&ar());if(c&&y)try{u.focus({preventScroll:!0})}catch(w){try{u.focus()}catch(g){}}return c}function b(){wr(f),m.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var v=m.querySelector(".renuvex-pr-filter-item-active")||m.querySelector(".renuvex-pr-filter-item");v&&requestAnimationFrame(function(){try{v.focus({preventScroll:!0})}catch(c){try{v.focus()}catch(y){}}})}i.forEach(function(v){var c=v[2],y=c?a:!a&&(t||"newest")===v[0],w=document.createElement("button");w.type="button",w.className="renuvex-pr-filter-item"+(y?" renuvex-pr-filter-item-active":""),w.setAttribute("role","menuitem"),w.textContent=v[1];var g=!1;function z(h,A){h&&(h.preventDefault(),h.stopPropagation()),!g&&(g=!0,k=!0,A!==!0&&At(),d({restoreFocus:A}),l(v[0],c),setTimeout(function(){g=!1,k=!1},0))}w.addEventListener("pointerdown",function(h){h.button!==void 0&&h.button!==0||z(h,!1)}),typeof window!="undefined"&&!window.PointerEvent&&w.addEventListener("touchstart",function(h){z(h,!1)},{passive:!1}),w.addEventListener("mousedown",function(h){h.button!==void 0&&h.button!==0||z(h,!1)}),w.addEventListener("keydown",function(h){(h.key==="Enter"||h.key===" ")&&z(h,!0)}),w.onclick=function(h){z(h,!1)},m.appendChild(w)}),u.onclick=function(){m.classList.contains("renuvex-pr-open")?d({restoreFocus:"auto"}):b()},s.addEventListener("keydown",function(v){v.key==="Escape"&&m.classList.contains("renuvex-pr-open")&&(v.stopPropagation(),d({restoreFocus:!0}))}),s.addEventListener("focusout",function(v){if(m.classList.contains("renuvex-pr-open")&&!k){var c=v.relatedTarget;c&&s.contains(c)||d()}});var f=kr({trigger:s,element:m,close:d});return s.appendChild(u),s.appendChild(m),p.appendChild(s),p}var Nt=`
...
`;function Pt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",n.appendChild(l);var p=document.createElement("button");p.className="renuvex-pr-fwizard-close",p.type="button",p.setAttribute("aria-label","Kapat");var o=K(Ce);o&&p.appendChild(o),n.appendChild(p);var s=!1,u=null,x=null,m=!1;function i(){J(a)}function k(g){gr(g,a,u&&u.root)}function d(){if(!s){if(s=!0,document.removeEventListener("keydown",b),a.removeEventListener("click",f),p.removeEventListener("click",d),m)J(x);else{var g=u&&u.root?u.root.activeElement:null;if(g&&typeof g.blur=="function")try{g.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(lr(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):a.parentNode&&a.parentNode.removeChild(a),xr();try{r()}catch(z){}},200)}}function b(g){if(g.key==="Escape"){d();return}k(g)}function f(g){g.target===a&&t&&d()}document.addEventListener("keydown",b),a.addEventListener("click",f),p.addEventListener("click",d);function v(g){x=fr(),m=ar(),g&&l.appendChild(g),u=vr(),Oe(u.root,Fe+Ne+Nt),u.root.appendChild(a),ze(u.root),mr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),i()})}var c=null,y=null;function w(g,z){if(z=z||"error",c){try{c.remove()}catch(h){}c=null}y&&(clearTimeout(y),y=null),c=document.createElement("div"),c.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,c.textContent=g,n.appendChild(c),y=setTimeout(function(){c&&(c.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(c){try{c.remove()}catch(h){}c=null}},300))},4e3)}return{open:v,close:d,content:l,setAllowOutsideClose:function(g){t=!!g},setStepAttr:function(g){n.setAttribute("data-step",String(g))},showToast:w}}var Hr=4;function De(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Rt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(l){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Hr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(l){return l!==n})}}}}function Bt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},l=e.onNext||function(){},p=document.createElement("div");p.className="renuvex-pr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=ue(Ie)+"<span>Geri</span>",o.addEventListener("click",function(){a()}),p.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-fwizard-footer-progress";for(var u=[],x=0;x<Hr;x++){var m=document.createElement("span");m.className="renuvex-pr-fwizard-progress-seg",s.appendChild(m),u.push(m)}p.appendChild(s);var i=document.createElement("button");i.type="button";var k=null;function d(f){k&&i.removeEventListener("click",k),k=f,f&&i.addEventListener("click",f)}p.appendChild(i);function b(f,v){var c=r.indexOf(f)!==-1,y=t.indexOf(f)!==-1,w=v&&(v.images&&v.images.length>0||v.pendingImages&&v.pendingImages.length>0);if(c)f===2&&w?(i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",d(function(){l()})):(i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.setAttribute("aria-label","Atla"),i.innerHTML="<span>Atla</span>",d(function(){n()})),i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),i.style.visibility="",i.tabIndex=0;else if(y){i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Sonraki"),i.innerHTML="Sonraki",i.style.visibility="",i.tabIndex=0;var g=De(f,v);i.disabled=!g,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!g),d(function(){i.disabled||l()})}else i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.innerHTML="",i.style.visibility="hidden",i.tabIndex=-1,i.disabled=!0,d(null)}return{el:p,update:function(f,v){u.forEach(function(y,w){w+1<=f?y.classList.add("renuvex-pr-fwizard-progress-seg-active"):y.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var c=f<=1;o.style.visibility=c?"hidden":"",o.style.pointerEvents=c?"none":"",o.tabIndex=c?-1:0,b(f,v)},setNextDisabled:function(f){i.classList.contains("renuvex-pr-fwizard-cta-btn")&&(i.disabled=!!f,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!f))},setThanksState:function(f){o.style.visibility="hidden",s.style.visibility="hidden",i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",i.style.visibility="",i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),d(f)}}}function It(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-stars",p.setAttribute("role","radiogroup"),p.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var o=Ze(R||{});fe(o);var s=[];function u(f){s.forEach(function(v,c){var y=c<f;v.classList.toggle("renuvex-pr-fwizard-star-active",y),v.setAttribute("aria-checked",c+1===f?"true":"false"),v.innerHTML=y?X("full"):X("outline")})}function x(f){e.set({rating:f}),u(f)}function m(f){var v=s[f-1];if(v)try{v.focus()}catch(c){}}function i(f,v){v&&typeof v.preventDefault=="function"&&v.preventDefault(),v&&typeof v.stopPropagation=="function"&&v.stopPropagation(),!a&&(a=!0,x(f),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var k=1;k<=5;k++)(function(f){var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-star",v.setAttribute("role","radio"),v.setAttribute("aria-label",f+" y\u0131ld\u0131z"),v.innerHTML=X("outline"),v.addEventListener("mouseenter",function(){u(f)}),v.addEventListener("mouseleave",function(){u(e.get().rating)}),v.addEventListener("pointerdown",function(c){c.button&&c.button!==0||i(f,c)}),typeof window!="undefined"&&!window.PointerEvent&&v.addEventListener("touchstart",function(c){i(f,c)},{passive:!1}),v.addEventListener("mousedown",function(c){window.PointerEvent||i(f,c)}),v.addEventListener("keydown",function(c){if(c.key==="Enter"||c.key===" "){i(f,c);return}var y=0;c.key==="ArrowRight"||c.key==="ArrowUp"?y=Math.min(5,f+1):c.key==="ArrowLeft"||c.key==="ArrowDown"?y=Math.max(1,f-1):c.key==="Home"?y=1:c.key==="End"&&(y=5),y&&(c.preventDefault(),x(y),m(y))}),v.addEventListener("click",function(c){i(f,c)}),s.push(v),p.appendChild(v)})(k);u(e.get().rating);var d=null,b=function(f){var v=f&&f.detail&&f.detail.settings;v&&v===d||(d=v||null,o=Ze(v||R||{}),u(e.get().rating))};return window.addEventListener(Se,b),t.appendChild(p),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Se,b)}}}var Mt=3,va=10*1024*1024;function Ft(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle");var s=document.createElement("input");s.type="file",s.accept="image/*",s.multiple=!0,s.style.display="none",p.appendChild(o),p.appendChild(s);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),p.appendChild(u),a.appendChild(p);var x=r.revokeBlobUrl||function(c){c&&typeof c=="string"&&c.startsWith("blob:")&&URL.revokeObjectURL(c)},m=r.blobMap||{},i=r.urlToFinger||{};function k(){if(!t){var c=e.get().images||[],y=e.get().pendingImages||[],w=c.map(function(g){return{url:g,isPending:!1}}).concat(y.map(function(g){return{url:g.url,file:g.file,isPending:!0,error:g.error}}));u.innerHTML="",w.forEach(function(g){var z=m[g.url]||g.url,h=d(g,z);u.appendChild(h)}),f()}}function d(c,y){var w=document.createElement("div");w.className="renuvex-pr-fwizard-photo-thumb";var g=document.createElement("img");g.src=y,g.alt="",g.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",w.appendChild(g);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",w.appendChild(z);var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-photo-remove",h.setAttribute("aria-label","Kald\u0131r");var A=K(Ce);return A&&h.appendChild(A),w.appendChild(h),b(w,c,y),w}function b(c,y,w){var g=c.querySelector("img");g.src!==w&&(g.src=w);var z=c.querySelector(".renuvex-pr-fwizard-photo-loading");if(y.isPending&&y.error){z.style.display="flex",z.textContent="";var h=document.createElement("span");h.className="renuvex-pr-upload-error",h.textContent="\u2717 "+y.error,z.appendChild(h)}else z.style.display="none",z.textContent="";var A=c.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var E=i[y.url]||(y.file?y.file.name+"_"+y.file.size:null),C=m[y.url],S={};E&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(T){return T!==E})),y.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(T){return T.url!==y.url}):S.images=(e.get().images||[]).filter(function(T){return T!==y.url}),e.set(S),x(y.url),x(C),delete i[y.url],C&&delete i[C],m[y.url]&&delete m[y.url]}}function f(){var c=(e.get().images||[]).length,y=(e.get().pendingImages||[]).length,w=c+y,g=w>=Mt;w>0?(p.classList.add("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=ue(vt)):(p.classList.remove("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=ue(st)+"<span>Foto\u011Fraf Ekle</span>"),g?(o.style.display="none",o.disabled=!0,s.disabled=!0):(o.style.display="flex",o.disabled=!1,s.disabled=!1,o.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){s.disabled||s.click()}),s.onchange=async function(c){var y=(e.get().images||[]).length+(e.get().pendingImages||[]).length,w=Array.from(c.target.files).slice(0,Mt-y);s.value="";var g=(e.get().pendingImages||[]).length,z=e.get().images||[],h=z.length;if(w.length!==0){for(var A=[],E=[],C=0;C<w.length;C++){var S=w[C],T=S.name+"_"+S.size,L=(e.get().fingerprints||[]).some(function(F){return F===T})||A.some(function(F){return F.file.name+"_"+F.file.size===T});if(L){console.log("[renuvex-pr] Duplicate file detected, skipping:",S.name);continue}if(S.size>va){var N="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(N,"error"):alert(N);continue}var B=URL.createObjectURL(S);i[B]=T,A.push({url:B,file:S,error:null}),E.push({url:B,file:S});var P=(e.get().fingerprints||[]).slice();P.push(T),e.set({fingerprints:P})}if(A.length!==0){var V=(e.get().pendingImages||[]).concat(A),G=async function(){for(var F=0;F<E.length;F++){var j=E[F],Te=j.file,$=j.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Ve=(e.get().pendingImages||[]).filter(function(_){return _.url!==$}),Le=(e.get().images||[]).slice();Le.push($),e.set({pendingImages:Ve,images:Le});continue}try{var Q=await $e(Ke+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Xe})});if(!Q.ok)throw Q.status===429?new Error("rate_limit"):new Error("sign failed");var Y=await Q.json();if(!Y.folder)throw new Error("sign folder missing");var D=new FormData;D.append("file",Te),D.append("api_key",Y.api_key),D.append("timestamp",Y.timestamp),D.append("signature",Y.signature),D.append("folder",Y.folder);var Ge=await fetch("https://api.cloudinary.com/v1_1/"+Y.cloud_name+"/image/upload",{method:"POST",body:D}),W=await Ge.json();if(W.secure_url&&xt(W.secure_url)){var We=(e.get().pendingImages||[]).some(function(_){return _.url===$});if(!We){console.log("[renuvex-pr] Upload finished but image was already deleted by user. Skipping state update.");continue}m[W.secure_url]=$,i[W.secure_url]=i[$];var de=(e.get().pendingImages||[]).filter(function(_){return _.url!==$}),be=(e.get().images||[]).slice();be.push(W.secure_url),e.set({pendingImages:de,images:be});try{$e(Ke+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Xe,secureUrl:W.secure_url})}).catch(function(){})}catch(_){}}else throw new Error("invalid image url")}catch(_){console.error("[renuvex-pr] Image upload failed:",_);var Ae=_.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(Ae,"error");var ye=(e.get().pendingImages||[]).map(function(te){return te.url===$?{url:te.url,file:te.file,error:Ae}:te});e.set({pendingImages:ye})}}};if(h===0&&g===0){t=!0;var Z=!r.canNavigate||r.canNavigate();Z&&e.goNext()}e.set({pendingImages:V}),G()}}};var v=e.onChange(k);return k(),{el:a,destroy:function(){t=!0,s.onchange=null,v&&v()}}}var Yr=2e3,ca=60;function Ot(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",p.maxLength=ca,p.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),p.value=e.get().title||"",p.addEventListener("input",function(){e.set({title:p.value})}),l.appendChild(p);var o=document.createElement("textarea");o.className="renuvex-pr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=Yr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",l.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-fwizard-char-counter",s.setAttribute("aria-live","polite"),l.appendChild(s);function u(){var m=o.value.length;s.textContent=m+"/"+Yr,s.classList.toggle("renuvex-pr-fwizard-char-counter--max",m>=Yr)}function x(){return De(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),u(),t(x())}),a.appendChild(l),u(),setTimeout(function(){t(x())},0),{el:a,destroy:function(){}}}var ma=40;function _t(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",n.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-author-form";var o=document.createElement("div");o.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=ma,u.setAttribute("aria-required","true"),u.value=e.get().author||"",o.appendChild(s),o.appendChild(u),p.appendChild(o);var x=document.createElement("div");x.className="renuvex-pr-fwizard-field";var m=document.createElement("label");m.className="renuvex-pr-fwizard-label",m.textContent="E-posta (opsiyonel)";var i=document.createElement("input");i.type="email",i.className="renuvex-pr-fwizard-input",i.setAttribute("autocomplete","email"),i.value=e.get().email||"",x.appendChild(m),x.appendChild(i),p.appendChild(x);var k=document.createElement("div");k.className="renuvex-pr-fwizard-notice",k.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",p.appendChild(k);var d=document.createElement("div");d.className="renuvex-pr-fwizard-msg",d.setAttribute("role","alert"),d.setAttribute("aria-live","assertive"),p.appendChild(d);var b=document.createElement("button");b.type="button",b.className="renuvex-pr-fwizard-submit-btn",b.textContent="G\xF6nder",p.appendChild(b),n.appendChild(p);function f(){return De(4,e.get())}function v(){var g=!f(),z=(e.get().pendingImages||[]).length,h=z>0;h?(b.disabled=!0,b.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),b.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(b.disabled=g,b.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",g),b.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),v(),t(f())}),i.addEventListener("input",function(){e.set({email:i.value})}),v(),setTimeout(function(){t(f())},0);function c(){d.textContent=""}function y(g){c();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=g||"",d.appendChild(z)}b.onclick=async function(){if(!b.disabled){var g=e.get(),z=(g.author||"").trim(),h=(g.comment||"").trim();if(i.value.trim()&&!i.checkValidity()){i.reportValidity();return}if(!z){y("Gerekli alan");return}if(!g.rating){y("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}b.disabled=!0,b.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=b.textContent;if(b.textContent="G\xF6nderiliyor\u2026",c(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var E=ct(window.location.href),C=g.productName||null,S=await $e(Ke+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Xe,productId:g.productId||null,slug:E||null,productName:C,author:z,title:(g.title||"").trim()||null,comment:h||null,rating:g.rating,images:g.images||[]})},15e3);if(S.ok)a();else{var T=await S.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(B){var L=B&&(B.name==="AbortError"||/signal/i.test(B.message||"")),N=L?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":B.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(N,"error"):y(N),b.disabled=!1,b.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),b.textContent=A}}};var w=e.onChange(v);return{el:n,destroy:function(){b.onclick=null,w&&w()}}}function xa(e,r,t){if(t=t||{},e===1)return It(r,{canNavigate:t.canNavigate});if(e===2)return Ft(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Ot(r,{onValidityChange:t.onValidityChange});if(e===4)return _t(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function Ht(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Yt(e){e=e||{};var r=Rt({productId:e.productId,productName:e.productName}),t={},a={},n={};function l(E){if(!(!E||typeof E!="string"||!E.startsWith("blob:")||n[E])){n[E]=!0;try{URL.revokeObjectURL(E)}catch(C){}}}function p(){Object.keys(a).forEach(function(C){l(C)}),Object.keys(t).forEach(function(C){l(t[C])});var E=r.get();(E.pendingImages||[]).forEach(function(C){l(C&&C.url)}),(E.images||[]).forEach(function(C){l(C)})}var o=Pt({onClose:function(){window.removeEventListener("popstate",u),br(s),p(),e.onClose&&e.onClose()},allowOutsideClose:!1}),s=hr(),u=function(E){o&&o.close&&o.close()};window.addEventListener("popstate",u);var x=document.createElement("div");x.className="renuvex-pr-fwizard-step-wrap";var m=Bt({skippableSteps:[2],nextableSteps:[3],onBack:function(){d==="idle"&&r.goBack()},onSkip:function(){d==="idle"&&r.goNext()},onNext:function(){d==="idle"&&r.goNext()}}),i=document.createElement("div");i.className="renuvex-pr-fwizard-layout",i.appendChild(x),i.appendChild(m.el);var k=null,d="idle",b=null,f=!0,v=null;function c(E,C){x.innerHTML="";var S=xa(E,r,{canNavigate:function(){return d==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:l,onValidityChange:function(N){m.setNextDisabled(!N)},onSuccess:w,showToast:o.showToast});if(k=S,m.update(E,r.get()),C){d="entering",S.el.classList.add("renuvex-pr-fwizard-step--enter");var T=null,L=function(){T&&clearTimeout(T),S.el.removeEventListener("animationend",L),S.el.classList.remove("renuvex-pr-fwizard-step--enter"),d="idle",b!==null&&g()};S.el.addEventListener("animationend",L),T=setTimeout(L,700)}else d="idle";x.appendChild(S.el),o.setStepAttr&&o.setStepAttr(E),E===3&&m.setNextDisabled(!0)}var y=!1;function w(){if(!y){if(y=!0,!k){x.innerHTML="";var E=Ht();E.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(E),o.setStepAttr("thanks"),m.setThanksState(o.close);return}var C=k;d="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var S=function(){if(v&&clearTimeout(v),C.el.removeEventListener("animationend",S),C.destroy)try{C.destroy()}catch(L){}k===C&&(k=null),x.innerHTML="";var T=Ht();T.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(T),o.setStepAttr("thanks"),m.setThanksState(o.close),d="idle"};C.el.addEventListener("animationend",S),v=setTimeout(S,300)}}function g(){var E=r.get().currentStep;if(d!=="idle"){b=E;return}if(!k){var C=!f;f=!1,c(E,C);return}var S=k;d="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(v&&clearTimeout(v),S.el.removeEventListener("animationend",T),S.destroy)try{S.destroy()}catch(N){}if(k===S){x.innerHTML="",k=null;var L=b!==null?b:r.get().currentStep;b=null,c(L,!0),d="idle"}};S.el.addEventListener("animationend",T),v=setTimeout(T,350)}g();var z=r.get().currentStep,h=r.onChange(function(E){E.currentStep!==z?(z=E.currentStep,g()):m.update(E.currentStep,E)}),A=o.close;return o.close=function(){h&&h(),typeof v!="undefined"&&v&&clearTimeout(v),A()},o.open(i),{close:o.close}}function H(){Yt({productId:ae||"",productName:Be||""})}var fa={id:"classic",name:"Klasik (A\xE7\u0131k)"};function ga(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,l=e.allCount,p=e.ratingCounts,o=e.avgRatingVal,s=e.currentRatingFilter,u=e.currentOrderBy,x=e.currentHasImages,m=e.onFilterChange,i=e.onSortChange;fe(n);var k=document.createElement("div");k.className="renuvex-pr-summary";var d=(p[3]||0)+(p[4]||0),b=l>0?Math.round(d/l*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-avg",f.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+X("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",k.appendChild(f);var v=document.createElement("div");if(v.className="renuvex-pr-summary-block renuvex-pr-summary-count",v.textContent=l.toLocaleString("tr-TR")+" Yorum",k.appendChild(v),a.showRecommendation!==!1&&b>0){var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",c.innerHTML='<span class="renuvex-pr-recommend-pct">%'+b+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(c)}return k.appendChild(Ye({ratingCounts:p,allCount:l,iconPair:n,currentRatingFilter:s,onFilterChange:m})),k.appendChild(re({widget:r,currentOrderBy:u,currentHasImages:x,onWriteClick:H,onSortChange:i})),k}var jr={};xe(jr,{css:()=>ba,meta:()=>ha,render:()=>ya});var Dt=`
...
`;var ha={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ba=Dt;function ya(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,p=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,u=e.currentHasImages,x=e.onFilterChange,m=e.onSortChange,i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-compact";var k=document.createElement("div");k.className="renuvex-pr-compact-header";var d=document.createElement("div");d.className="renuvex-pr-compact-trigger-wrap";var b=document.createElement("button");b.className="renuvex-pr-compact-trigger",b.type="button",b.setAttribute("aria-expanded","false"),b.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Me(p,a)+'</span><span class="renuvex-pr-compact-trigger-text">'+n.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+ue(ut)+"</span>",d.appendChild(b),k.appendChild(d);var f=re({widget:r,currentOrderBy:s,currentHasImages:u,onWriteClick:H,onSortChange:m}),v=f.querySelector(".renuvex-pr-filter-wrap"),c=f.querySelector(".renuvex-pr-write-btn"),y=document.createElement("div");y.className="renuvex-pr-compact-actions-slot",c&&y.appendChild(c),v&&y.appendChild(v),k.appendChild(y),i.appendChild(k);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-hidden","true");var g=document.createElement("div");g.className="renuvex-pr-compact-panel-inner";var z=document.createElement("div");z.className="renuvex-pr-compact-avg",z.innerHTML='<span class="renuvex-pr-icon">'+X("full")+"</span><span>"+p+"</span>",g.appendChild(z),g.appendChild(Ye({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:o,onFilterChange:x})),w.appendChild(g);var h=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function A(F){var j=F?i:d;w.parentNode!==j&&(w.classList.contains("renuvex-pr-open")&&(w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden","true"),b.setAttribute("aria-expanded","false")),j.appendChild(w))}if(A(h?h.matches:!1),h){var E=function(F){A(F.matches)};h.addEventListener?h.addEventListener("change",E):h.addListener&&h.addListener(E)}if(c){var C=document.createElement("button");C.className="renuvex-pr-write-btn",C.textContent=R&&R.writeButtonText||"Yorum Yap",C.onclick=H;var S=document.createElement("div");S.className="renuvex-pr-compact-write-row",S.appendChild(C),i.appendChild(S)}function T(){w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden","true"),b.setAttribute("aria-expanded","false")}function L(){wr(N),w.classList.add("renuvex-pr-open"),w.setAttribute("aria-hidden","false"),b.setAttribute("aria-expanded","true")}b.onclick=function(){w.classList.contains("renuvex-pr-open")?T():L()};var N=null;function B(F){N&&(N(),N=null),F||(N=kr({trigger:d,element:w,close:T}))}if(B(h?h.matches:!1),h){var P=function(F){B(F.matches)};h.addEventListener?h.addEventListener("change",P):h.addListener&&h.addListener(P)}if(t.showRecommendation!==!1){var V=(l[3]||0)+(l[4]||0),G=n>0?Math.round(V/n*100):0;if(G>0){var Z=document.createElement("div");Z.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",Z.style.marginTop="8px",Z.innerHTML='<span class="renuvex-pr-recommend-pct">%'+G+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",g.appendChild(Z)}}return i}var Ur={};xe(Ur,{css:()=>ka,meta:()=>wa,render:()=>za});var jt=`
...
`;var wa={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},ka=jt;function za(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,p=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,u=e.currentHasImages,x=e.onFilterChange,m=e.onSortChange;fe(a);var i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-split";var k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-left";var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",d.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+X("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",k.appendChild(d);var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",b.textContent=n.toLocaleString("tr-TR")+" Yorum",k.appendChild(b),i.appendChild(k);var f=document.createElement("div");f.className="renuvex-pr-split-col renuvex-pr-split-mid",f.appendChild(Ye({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:o,onFilterChange:x})),i.appendChild(f);var v=re({widget:r,currentOrderBy:s,currentHasImages:u,onWriteClick:H,onSortChange:m}),c=v.querySelector(".renuvex-pr-filter-wrap"),y=v.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-split-col renuvex-pr-split-right",y&&w.appendChild(y),c&&w.appendChild(c),i.appendChild(w);var g=(l[3]||0)+(l[4]||0),z=n>0?Math.round(g/n*100):0,h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||z===0;return A&&h.classList.add("renuvex-pr-split-rec-hidden"),k.appendChild(h),i}var Vr={};xe(Vr,{css:()=>Sa,meta:()=>Ca,render:()=>Ea});var Ut=`
...
`;var Ba={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-w-mobile":"80px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-w-mobile":"100px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-w-mobile":"110px"}}},Ia=Wt;function Ma(e,r){var t=ge(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var p=document.createElement("span");p.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",p.innerHTML=se(e.rating,R),l.appendChild(p);var o=document.createElement("span");o.className="renuvex-pr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var s=document.createElement("time");s.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&s.setAttribute("datetime",e.createdAt),s.textContent=ve(e.createdAt),l.appendChild(s),n.appendChild(l);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var x=document.createElement("div");x.className="renuvex-pr-review-list-title",x.textContent=e.title,u.appendChild(x)}var m=(e.comment||"").trim();m&&u.appendChild(je(m,"renuvex-pr-review-list-body").fragment);var i=Ue(e.merchantReply);if(i&&u.appendChild(i),n.appendChild(u),a){var k=document.createElement("div");k.className="renuvex-pr-review-list-media",t.forEach(function(d){var b=document.createElement("img"),f=ne(d,U);b.src=f.src,b.srcset=f.srcset,b.loading="lazy",b.decoding="async",b.width=U,b.height=Math.round(U*4/3),b.setAttribute("data-renuvex-img-url",d),ie(b),(function(v){he(b,function(){le(e,v,r)})})(d),k.appendChild(b)}),n.appendChild(k)}return n}var Xr={};xe(Xr,{css:()=>Oa,meta:()=>Fa,render:()=>_a});var qt=`
...
`;var Fa={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Oa=qt;function _a(e,r){var t=dr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var p=document.createElement("span");if(p.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",p.innerHTML=se(e.rating,R),l.appendChild(p),e.title){var o=document.createElement("div");o.className="renuvex-pr-review-gallery-title",o.textContent=e.title,l.appendChild(o)}var s=document.createElement("div");s.className="renuvex-pr-review-gallery-author",s.textContent=e.author||"",l.appendChild(s);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=ve(e.createdAt),l.appendChild(u);var x=(e.comment||"").trim();if(x&&l.appendChild(je(x,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){le(e,t,r)}}:null).fragment),n.appendChild(l),a){var m=document.createElement("div");m.className="renuvex-pr-review-gallery-media";var i=document.createElement("img"),k=ne(t,ur);i.src=k.src,i.srcset=k.srcset,i.loading="lazy",i.decoding="async",i.width=ur,i.height=Math.round(ur*4/3),ie(i),i.setAttribute("data-renuvex-img-url",t),he(i,function(){le(e,t,r)}),m.appendChild(i),n.appendChild(m)}var d=Ue(e.merchantReply,t?function(){le(e,t,r)}:null);return d&&(d.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(d)),n}var Sr={card:Wr,list:qr,gallery:Xr};function rr(e){return Sr[e]||Sr.card}function Xt(){return Object.keys(Sr).map(function(e){return Sr[e].css||""}).join(`
`)}function Ee(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+a+","+n+","+l+","+r+")"}function Ha(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),a.appendChild(n),a.appendChild(l);var p=document.createElement("div");p.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",p.textContent="Widget \u015Fu anda Pasif durumda";var o=document.createElement("div");return o.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",o.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(p),r.appendChild(o),r}function Ya(){return bt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Da(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=gt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),ht(t,{surface:"reviews",productId:r||""}),t}var Kt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Jt={small:80,medium:110,large:140};function ja(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function Ua(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",p=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",s=r.barCountColor||"#111111",u=Ee(p,.06),x=r.reviewStarColor||"#f59e0b",m=r.btnBgColor||"#111111",i=r.btnTextColor||"#ffffff",k=r.btnBorderColor||"#111111",d=r.filterBtnBgColor||"#111111",b=r.filterBtnTextColor||"#ffffff",f=r.filterBtnBorderColor||"#111111",v=r.filterMenuBgColor||"#ffffff",c=r.filterMenuBorderColor||"#e5e7eb",y=r.filterItemTextColor||"#111111",w=r.filterItemHoverBgColor||"#f3f4f6",g=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",h=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",E=r.reviewBodyColor||"#111111",C=r.reviewBorderColor||"#e5e7eb",S=r.replyBgColor||"#f9fafb",T=r.replyBorderColor||"#747474",L=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",B=r.photoTitleColor||"#111111",P=Ee("#111111",.05),V=r.photoArrowBgColor||"#ffffff",G=r.photoArrowTextColor||"#111111",Z=Ee("#111111",.12),F=r.formBgColor||"#ffffff",j=r.formPrimaryTextColor||"#111111",Te=r.formSecondaryTextColor||"#3b3b3b",$=r.inputTextColor||j,Ve=r.inputBorderColor||"#d1d5db",Le=r.placeholderColor||"#9ca3af",Q=r.formStepBarColor||"#111111",Y=r.formBtnBgColor||"#111111",D=r.formBtnTextColor||"#ffffff",Ge=r.formBtnBorderColor||"#111111",W=Ee(Y,.06),We=Ee(Y,.18),de=Ee(D,.85),be=Ee(j,.06),Ae=r.loadMoreBgColor||"#ffffff",ye=r.loadMoreTextColor||"#111111",_=r.loadMoreBorderColor||"#111111",te={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":p,"--renuvex-pr-bar-track":o,"--renuvex-pr-bar-count":s,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":m,"--renuvex-pr-btn-text":i,"--renuvex-pr-btn-border":k,"--renuvex-pr-filter-btn-bg":d,"--renuvex-pr-filter-btn-text":b,"--renuvex-pr-filter-btn-border":f,"--renuvex-pr-filter-menu-bg":v,"--renuvex-pr-filter-menu-border":c,"--renuvex-pr-filter-item-text":y,"--renuvex-pr-filter-item-hover-bg":w,"--renuvex-pr-filter-item-active":g,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":h,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":E,"--renuvex-pr-review-border":C,"--renuvex-pr-review-star-color":x,"--renuvex-pr-reply-bg-color":S,"--renuvex-pr-reply-border":T,"--renuvex-pr-reply-label":L,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":B,"--renuvex-pr-photo-image-border":P,"--renuvex-pr-photo-arrow-bg":V,"--renuvex-pr-photo-arrow-text":G,"--renuvex-pr-photo-arrow-border":Z,"--renuvex-pr-fwizard-bg":F,"--renuvex-pr-fwizard-text":j,"--renuvex-pr-fwizard-secondary-text":Te,"--renuvex-pr-fwizard-input-bg":F,"--renuvex-pr-fwizard-input-text":$,"--renuvex-pr-fwizard-input-border":Ve,"--renuvex-pr-fwizard-placeholder":Le,"--renuvex-pr-fwizard-close-text":j,"--renuvex-pr-fwizard-close-hover-bg":be,"--renuvex-pr-fwizard-progress-bg":be,"--renuvex-pr-fwizard-progress-active":Q,"--renuvex-pr-fwizard-btn-bg":Y,"--renuvex-pr-fwizard-btn-text":D,"--renuvex-pr-fwizard-btn-border":Ge,"--renuvex-pr-fwizard-btn-disabled-bg":We,"--renuvex-pr-fwizard-btn-disabled-text":de,"--renuvex-pr-fwizard-nav-hover-bg":W,"--renuvex-pr-load-more-bg":Ae,"--renuvex-pr-load-more-text":ye,"--renuvex-pr-load-more-border":_};Object.keys(te).forEach(function(me){e.style.setProperty(me,te[me])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function tr(e,r,t,a,n,l,p){if(pt){or({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:l,badgeSettings:p});return}ir(!0),rt(e),tt(r),p!==void 0&&at(p),nt(a),n&&Rr(n),l&&Je(l),t!=null&&it(t);try{let Lr=function(I,O){if(!(!I||!I.meta||!I.meta.sizeOverrides)){var M=I.meta.sizeOverrides[O];M&&Object.keys(M).forEach(function(ee){i.style.setProperty(ee,M[ee])})}};var Va=Lr,o=Cr(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),u=r.showTitle!==!1,x=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",m=s&&u?x:"",i=document.documentElement;Ua(i,r);var k=r.borderRadius!==void 0?r.borderRadius:8,d=Kt[r.size]||Kt.medium,b=Jt[r.thumbnailSize]||Jt.medium,f=rr(r.reviewLayout);if(f.meta&&f.meta.sizeOverrides&&f.meta.sizeOverrides[r.size]){var v=f.meta.sizeOverrides[r.size],c=v["--renuvex-pr-list-photo-w"]||v["--renuvex-pr-gallery-photo-w"];c&&(b=parseInt(c))}i.style.setProperty("--renuvex-pr-title-size",d.titleSize+"px"),i.style.setProperty("--renuvex-pr-review-text-size",d.reviewTextSize+"px"),i.style.setProperty("--renuvex-pr-review-title-size",d.reviewTitleSize+"px"),i.style.setProperty("--renuvex-pr-author-size",d.authorSize+"px"),i.style.setProperty("--renuvex-pr-reply-name-size",d.replyNameSize+"px"),i.style.setProperty("--renuvex-pr-reply-text-size",d.replyTextSize+"px"),i.style.setProperty("--renuvex-pr-radius",k+"px"),i.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,k-4)+"px"),i.style.setProperty("--renuvex-pr-photo-title-size",d.photoTitleSize+"px"),i.style.setProperty("--renuvex-pr-avg-rating-size",d.avgRatingSize+"px"),i.style.setProperty("--renuvex-pr-review-count-size",d.reviewCountSize+"px"),i.style.setProperty("--renuvex-pr-compact-count-size",d.compactCountSize+"px"),i.style.setProperty("--renuvex-pr-recommend-size",d.recommendSize+"px"),i.style.setProperty("--renuvex-pr-btn-text-size",d.btnTextSize+"px"),i.style.setProperty("--renuvex-pr-bar-label-size",d.barLabelSize+"px"),i.style.setProperty("--renuvex-pr-minimal-avg-size",d.minimalAvgSize+"px"),i.style.setProperty("--renuvex-pr-hero-avg-size",d.heroAvgSize+"px"),i.style.setProperty("--renuvex-pr-bar-count-size",d.barCountSize+"px"),i.style.setProperty("--renuvex-pr-review-date-size",d.reviewDateSize+"px"),i.style.setProperty("--renuvex-pr-filter-text-size",d.filterTextSize+"px"),i.style.setProperty("--renuvex-pr-load-more-size",d.loadMoreSize+"px"),i.style.setProperty("--renuvex-pr-read-more-size",d.readMoreSize+"px"),i.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var y=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";i.style.setProperty("--renuvex-pr-review-star-color",y),i.style.setProperty("--renuvex-pr-star-size",d.reviewStarSize+"px"),i.style.setProperty("--renuvex-pr-avg-star-size",d.avgStarSize+"px"),Lr(Cr(r.summaryLayout),r.size),Lr(rr(r.reviewLayout),r.size);var w=Ze(r),g=Ya();if(!g)return;var z=Da(g,e),h=document.getElementById("renuvex-reviews");h||(h=document.createElement("div"),h.id="renuvex-reviews",h.style.minHeight="200px"),h.parentNode!==z&&z.appendChild(h);var A=yt(h),E=Fe+Ne+cr+Gt()+Xt();Oe(A,E);var C=kt(A);if(r.enabled===!1){h.style.minHeight="auto",C.replaceChildren(Ha(r.borderRadius!==void 0?r.borderRadius:8)),ir(!1);var S=nr;or(null),S&&tr(S.productId,S.settings,S.reviewsData,S.productName,S.orderBy,S.page,S.badgeSettings);return}var T=document.createElement("p");T.className="renuvex-pr-state-msg renuvex-pr-state-loading",T.textContent="Yorumlar y\xFCkleniyor...",C.replaceChildren(T);try{var L=t||{},N=Mr(L),B=N?[]:L.data&&L.data.reviews||[];ot(B),C.replaceChildren();var P=document.createElement("section");if(P.id="renuvex-reviews-widget",P.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),P.className="renuvex-pr-reviews-widget",P.setAttribute("data-renuvex-surface","reviews"),e&&P.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(P.style.width="100%",P.style.maxWidth="100%",P.style.marginLeft="0",P.style.marginRight="0"),m){var V=document.createElement("div"),G=r.summaryLayout||"classic";V.className="renuvex-pr-title renuvex-pr-title-"+G,V.textContent=m,P.appendChild(V)}if(N){P.appendChild(ja(L.message,async function(){var I=await Qe(ae,ke,1,Pe,Re);await tr(ae,R,I,Be,ke,1,Zr)})),C.appendChild(P),ze(A),Nr(P,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return A.getElementById("renuvex-reviews-widget")});return}var Z=L.data&&L.data.allCount||0,F=L.data&&L.data.ratingCounts||null,j=F||[0,0,0,0,0],Te=L.data&&L.data.avgRating||"0.0";if(!F&&B.length>0){B.forEach(function(I){I.rating>=1&&I.rating<=5&&j[I.rating-1]++});var $=B.reduce(function(I,O){return I+O.rating},0);Te=($/B.length).toFixed(1)}if(Z>0){var Ve=Cr(r.summaryLayout),Le=Ve.render({widget:P,data:L,settings:r,iconPair:w,allCount:Z,ratingCounts:j,avgRatingVal:Te,currentRatingFilter:Pe,currentOrderBy:ke,currentHasImages:Re,onFilterChange:async function(I){var O=Pe===I?null:I;Qr(O),Je(1);var M=await Qe(ae,ke,1,O,Re);await tr(ae,R,M,Be,ke,1)},onSortChange:async function(I,O){Je(1);var M=I,ee=!1;O&&(ee=!0,M="newest"),et(ee),Rr(M);var Ar=await Qe(ae,M,1,Pe,ee);await tr(ae,R,Ar,Be,M,1)}});P.appendChild(Le)}else{var Q=document.createElement("button");Q.className="renuvex-pr-write-btn",Q.style.cssText="display:block;margin:16px auto 0;",Q.textContent=r.writeButtonText||"Yorum Yap",Q.onclick=H,P.appendChild(Q)}var Y=($r||[]).filter(function(I){return ge(I).length>0});if(r.showPhotoGallery!==!1&&!Re&&Y.length>0){var D=document.createElement("div");if(D.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var Ge=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",W=document.createElement("div");W.className="renuvex-pr-photo-title",W.textContent=Ge,D.appendChild(W)}var We=r.reviewLayout==="card"?"1/1":"3/4";i.style.setProperty("--renuvex-pr-photo-thumb-aspect",We);var de=document.createElement("div");de.className="renuvex-pr-photo-strip";var be=U,Ae=r.reviewLayout==="card"?U:Math.round(U*4/3),ye=0;Y.forEach(function(I){if(!(ye>=15)){var O=dr(I);if(O){var M=document.createElement("img"),ee=ne(O,U);M.src=ee.src,M.srcset=ee.srcset,M.loading=ye<3?"eager":"lazy",M.decoding="async",M.width=be,M.height=Ae,M.className="renuvex-pr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",ie(M),(function(Ar,$t){he(M,function(){le($t,Ar,Y)})})(O,I),de.appendChild(M),ye++}}});var _=document.createElement("button");_.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var te=K(Ie);te&&_.appendChild(te),_.setAttribute("aria-label","\xD6nceki"),_.onclick=function(){de.scrollBy({left:-200,behavior:"smooth"})};var me=document.createElement("button");me.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var Kr=K(pr);Kr&&me.appendChild(Kr),me.setAttribute("aria-label","Sonraki"),me.onclick=function(){de.scrollBy({left:200,behavior:"smooth"})};var qe=document.createElement("div");qe.className="renuvex-pr-photo-strip-wrap",qe.appendChild(_),qe.appendChild(de),qe.appendChild(me),D.appendChild(qe),P.appendChild(D)}if(B.length===0){var Er=document.createElement("p");Er.className="renuvex-pr-state-msg",Er.textContent="Hen\xFCz yorum yok.",P.appendChild(Er)}else{var f=rr(r.reviewLayout);B.forEach(function(O){P.appendChild(f.render(O,Pr))})}var Zt=L.data&&L.data.hasMore;if(Zt){var q=document.createElement("button");q.className="renuvex-pr-load-more",q.textContent="Daha Fazla G\xF6ster",q.onclick=async function(){q.disabled=!0,q.textContent="Y\xFCkleniyor...";var I=Jr+1,O=await Qe(ae,ke,I,Pe,Re);if(O&&!Mr(O)&&O.data&&Array.isArray(O.data.reviews)){lt(O.data.reviews),Je(I);var M=rr(R.reviewLayout);O.data.reviews.forEach(function(ee){P.insertBefore(M.render(ee,Pr),q)}),O.data.hasMore?(q.disabled=!1,q.textContent="Daha Fazla G\xF6ster"):q.remove()}else q.disabled=!1,q.textContent="Tekrar Dene"},P.appendChild(q)}C.appendChild(P),ze(A),Nr(P,"reviews-widget",{productId:e||""},function(){return A.getElementById("renuvex-reviews-widget")})}catch(I){console.error("[renuvex-pr] render error:",I);var Tr=document.createElement("p");Tr.style.cssText="text-align:center;color:#dc2626;",Tr.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",C&&C.replaceChildren(Tr)}}finally{if(ir(!1),nr){var we=nr;or(null),tr(we.productId,we.settings,we.reviewsData,we.productName,we.orderBy,we.page,we.badgeSettings)}}}export{tr as render};
