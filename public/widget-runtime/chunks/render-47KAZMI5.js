...
`;function Vt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content",n.appendChild(o);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var i=Z(Ce);i&&l.appendChild(i),n.appendChild(l);var d=!1,u=null,f=null,s=!1;function p(){$(a)}function c(m){yr(m,a,u&&u.root)}function w(){if(!d){if(d=!0,document.removeEventListener("keydown",v),a.removeEventListener("click",b),l.removeEventListener("click",w),s)$(f);else{var m=u&&u.root?u.root.activeElement:null;if(m&&typeof m.blur=="function")try{m.blur()}catch(y){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(dr(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):a.parentNode&&a.parentNode.removeChild(a),hr();try{r()}catch(y){}},200)}}function v(m){if(m.key==="Escape"){w();return}c(m)}function b(m){m.target===a&&t&&w()}document.addEventListener("keydown",v),a.addEventListener("click",b),l.addEventListener("click",w);function x(m){f=br(),s=Pe(),m&&o.appendChild(m),u=xr(),Fe(u.root,Me+Le+Ut),u.root.appendChild(a),Se(u.root),gr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),p()})}var h=null,g=null;function k(m,y){if(y=y||"error",h){try{h.remove()}catch(T){}h=null}g&&(clearTimeout(g),g=null),h=document.createElement("div"),h.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+y,h.textContent=m,n.appendChild(h),g=setTimeout(function(){h&&(h.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(h){try{h.remove()}catch(T){}h=null}},300))},4e3)}return{open:x,close:w,content:o,setAllowOutsideClose:function(m){t=!!m},setStepAttr:function(m){n.setAttribute("data-step",String(m))},showToast:k}}var Yr=4;function je(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Wt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(o){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Yr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(o){return o!==n})}}}}function qt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},o=e.onNext||function(){},l=document.createElement("div");l.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=ce(Ie)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var u=[],f=0;f<Yr;f++){var s=document.createElement("span");s.className="renuvex-pr-fwizard-progress-seg",d.appendChild(s),u.push(s)}l.appendChild(d);var p=document.createElement("button");p.type="button";var c=null;function w(b){c&&p.removeEventListener("click",c),c=b,b&&p.addEventListener("click",b)}l.appendChild(p);function v(b,x){var h=r.indexOf(b)!==-1,g=t.indexOf(b)!==-1,k=x&&(x.images&&x.images.length>0||x.pendingImages&&x.pendingImages.length>0);if(h)b===2&&k?(p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",w(function(){o()})):(p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.setAttribute("aria-label","Atla"),p.innerHTML="<span>Atla</span>",w(function(){n()})),p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),p.style.visibility="",p.tabIndex=0;else if(g){p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Sonraki"),p.innerHTML="Sonraki",p.style.visibility="",p.tabIndex=0;var m=je(b,x);p.disabled=!m,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!m),w(function(){p.disabled||o()})}else p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.innerHTML="",p.style.visibility="hidden",p.tabIndex=-1,p.disabled=!0,w(null)}return{el:l,update:function(b,x){u.forEach(function(g,k){k+1<=b?g.classList.add("renuvex-pr-fwizard-progress-seg-active"):g.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var h=b<=1;i.style.visibility=h?"hidden":"",i.style.pointerEvents=h?"none":"",i.tabIndex=h?-1:0,v(b,x)},setNextDisabled:function(b){p.classList.contains("renuvex-pr-fwizard-cta-btn")&&(p.disabled=!!b,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!b))},setThanksState:function(b){i.style.visibility="hidden",d.style.visibility="hidden",p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",p.style.visibility="",p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),w(b)}}}function Gt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title",o.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-stars",l.setAttribute("role","radiogroup"),l.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=Je(R||{});ye(i);var d=[];function u(b){d.forEach(function(x,h){var g=h<b;x.classList.toggle("renuvex-pr-fwizard-star-active",g),x.setAttribute("aria-checked",h+1===b?"true":"false"),x.innerHTML=g?J("full"):J("outline")})}function f(b){e.set({rating:b}),u(b)}function s(b){var x=d[b-1];if(x)try{x.focus()}catch(h){}}function p(b,x){x&&typeof x.preventDefault=="function"&&x.preventDefault(),x&&typeof x.stopPropagation=="function"&&x.stopPropagation(),!a&&(a=!0,f(b),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var c=1;c<=5;c++)(function(b){var x=document.createElement("button");x.type="button",x.className="renuvex-pr-fwizard-star",x.setAttribute("role","radio"),x.setAttribute("aria-label",b+" y\u0131ld\u0131z"),x.innerHTML=J("outline"),x.addEventListener("mouseenter",function(){u(b)}),x.addEventListener("mouseleave",function(){u(e.get().rating)}),x.addEventListener("pointerdown",function(h){h.button&&h.button!==0||p(b,h)}),typeof window!="undefined"&&!window.PointerEvent&&x.addEventListener("touchstart",function(h){p(b,h)},{passive:!1}),x.addEventListener("mousedown",function(h){window.PointerEvent||p(b,h)}),x.addEventListener("keydown",function(h){if(h.key==="Enter"||h.key===" "){p(b,h);return}var g=0;h.key==="ArrowRight"||h.key==="ArrowUp"?g=Math.min(5,b+1):h.key==="ArrowLeft"||h.key==="ArrowDown"?g=Math.max(1,b-1):h.key==="Home"?g=1:h.key==="End"&&(g=5),g&&(h.preventDefault(),f(g),s(g))}),x.addEventListener("click",function(h){p(b,h)}),d.push(x),l.appendChild(x)})(c);u(e.get().rating);var w=null,v=function(b){var x=b&&b.detail&&b.detail.settings;x&&x===w||(w=x||null,i=Je(x||R||{}),u(e.get().rating))};return window.addEventListener(Ee,v),t.appendChild(l),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ee,v)}}}var Kt=3,Ba=10*1024*1024;function Xt(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-subtitle",o.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",l.appendChild(i),l.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),l.appendChild(u),a.appendChild(l);var f=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},s=r.blobMap||{},p=r.urlToFinger||{};function c(){if(!t){var h=e.get().images||[],g=e.get().pendingImages||[],k=h.map(function(m){return{url:m,isPending:!1}}).concat(g.map(function(m){return{url:m.url,file:m.file,isPending:!0,error:m.error}}));u.innerHTML="",k.forEach(function(m){var y=s[m.url]||m.url,T=w(m,y);u.appendChild(T)}),b()}}function w(h,g){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var m=document.createElement("img");m.src=g,m.alt="",m.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(m);var y=document.createElement("div");y.className="renuvex-pr-fwizard-photo-loading",y.style.display="none",k.appendChild(y);var T=document.createElement("button");T.type="button",T.className="renuvex-pr-fwizard-photo-remove",T.setAttribute("aria-label","Kald\u0131r");var E=Z(Ce);return E&&T.appendChild(E),k.appendChild(T),v(k,h,g),k}function v(h,g,k){var m=h.querySelector("img");m.src!==k&&(m.src=k);var y=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(g.isPending&&g.error){y.style.display="flex",y.textContent="";var T=document.createElement("span");T.className="renuvex-pr-upload-error",T.textContent="\u2717 "+g.error,y.appendChild(T)}else y.style.display="none",y.textContent="";var E=h.querySelector(".renuvex-pr-fwizard-photo-remove");E.onclick=function(){var z=p[g.url]||(g.file?g.file.name+"_"+g.file.size:null),S=s[g.url],A={};z&&(A.fingerprints=(e.get().fingerprints||[]).filter(function(L){return L!==z})),g.isPending?A.pendingImages=(e.get().pendingImages||[]).filter(function(L){return L.url!==g.url}):A.images=(e.get().images||[]).filter(function(L){return L!==g.url}),e.set(A),f(g.url),f(S),delete p[g.url],S&&delete p[S],s[g.url]&&delete s[g.url]}}function b(){var h=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,k=h+g,m=k>=Kt;k>0?(l.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=ce(gt)):(l.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=ce(ft)+"<span>Foto\u011Fraf Ekle</span>"),m?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(h){var g=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(h.target.files).slice(0,Kt-g);d.value="";var m=(e.get().pendingImages||[]).length,y=e.get().images||[],T=y.length;if(k.length!==0){for(var E=[],z=[],S=0;S<k.length;S++){var A=k[S],L=A.name+"_"+A.size,C=(e.get().fingerprints||[]).some(function(j){return j===L})||E.some(function(j){return j.file.name+"_"+j.file.size===L});if(!C){if(A.size>Ba){var P="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(P,"error"):alert(P);continue}var N=URL.createObjectURL(A);p[N]=L,E.push({url:N,file:A,error:null}),z.push({url:N,file:A});var M=(e.get().fingerprints||[]).slice();M.push(L),e.set({fingerprints:M})}}if(E.length!==0){var V=(e.get().pendingImages||[]).concat(E),Q=async function(){for(var j=0;j<z.length;j++){var G=z[j],de=G.file,F=G.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ee=(e.get().pendingImages||[]).filter(function(H){return H.url!==F}),I=(e.get().images||[]).slice();I.push(F),e.set({pendingImages:ee,images:I});continue}try{var ie=await Ze(Xe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke})});if(!ie.ok)throw ie.status===429?new Error("rate_limit"):new Error("sign failed");var K=await ie.json();if(!K.folder)throw new Error("sign folder missing");var B=new FormData;B.append("file",de),B.append("api_key",K.api_key),B.append("timestamp",K.timestamp),B.append("signature",K.signature),B.append("folder",K.folder);var he=await fetch("https://api.cloudinary.com/v1_1/"+K.cloud_name+"/image/upload",{method:"POST",body:B}),Y=await he.json();if(Y.secure_url&&yt(Y.secure_url)){var tr=(e.get().pendingImages||[]).some(function(H){return H.url===F});if(!tr)continue;s[Y.secure_url]=F,p[Y.secure_url]=p[F];var ke=(e.get().pendingImages||[]).filter(function(H){return H.url!==F}),_=(e.get().images||[]).slice();_.push(Y.secure_url),e.set({pendingImages:ke,images:_});try{Ze(Xe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke,secureUrl:Y.secure_url})}).catch(function(){})}catch(H){}}else throw new Error("invalid image url")}catch(H){console.error("[renuvex-pr] Image upload failed:",H);var re=H.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(re,"error");var te=(e.get().pendingImages||[]).map(function(se){return se.url===F?{url:se.url,file:se.file,error:re}:se});e.set({pendingImages:te})}}};if(T===0&&m===0){t=!0;var O=!r.canNavigate||r.canNavigate();O&&e.goNext()}e.set({pendingImages:V}),Q()}}};var x=e.onChange(c);return c(),{el:a,destroy:function(){t=!0,d.onchange=null,x&&x()}}}var Dr=2e3,_a=60;function Jt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content-form";var l=document.createElement("input");l.type="text",l.className="renuvex-pr-fwizard-input",l.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",l.maxLength=_a,l.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),l.value=e.get().title||"",l.addEventListener("input",function(){e.set({title:l.value})}),o.appendChild(l);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Dr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),o.appendChild(d);function u(){var s=i.value.length;d.textContent=s+"/"+Dr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",s>=Dr)}function f(){return je(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),u(),t(f())}),a.appendChild(o),u(),setTimeout(function(){t(f())},0),{el:a,destroy:function(){}}}var Ma=40;function Zt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent="Hakk\u0131n\u0131zda",n.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Ma,u.setAttribute("aria-required","true"),u.value=e.get().author||"",i.appendChild(d),i.appendChild(u),l.appendChild(i);var f=document.createElement("div");f.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.textContent="E-posta (opsiyonel)";var p=document.createElement("input");p.type="email",p.className="renuvex-pr-fwizard-input",p.setAttribute("autocomplete","email"),p.value=e.get().email||"",f.appendChild(s),f.appendChild(p),l.appendChild(f);var c=document.createElement("div");c.className="renuvex-pr-fwizard-notice",c.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",l.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-fwizard-msg",w.setAttribute("role","alert"),w.setAttribute("aria-live","assertive"),l.appendChild(w);var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-submit-btn",v.textContent="G\xF6nder",l.appendChild(v),n.appendChild(l);function b(){return je(4,e.get())}function x(){var m=!b(),y=(e.get().pendingImages||[]).length,T=y>0;T?(v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=m,v.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",m),v.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),x(),t(b())}),p.addEventListener("input",function(){e.set({email:p.value})}),x(),setTimeout(function(){t(b())},0);function h(){w.textContent=""}function g(m){h();var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg-error",y.textContent=m||"",w.appendChild(y)}v.onclick=async function(){if(!v.disabled){var m=e.get(),y=(m.author||"").trim(),T=(m.comment||"").trim();if(p.value.trim()&&!p.checkValidity()){p.reportValidity();return}if(!y){g("Gerekli alan");return}if(!m.rating){g("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var E=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",h(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var z=ht(window.location.href),S=m.productName||null,A=await Ze(Xe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke,productId:m.productId||null,slug:z||null,productName:S,author:y,title:(m.title||"").trim()||null,comment:T||null,rating:m.rating,images:m.images||[]})},15e3);if(A.ok)a();else{var L=await A.json().catch(function(){return{}});throw new Error(L.error||"Yorum kaydedilemedi.")}}catch(N){var C=N&&(N.name==="AbortError"||/signal/i.test(N.message||"")),P=C?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":N.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(P,"error"):g(P),v.disabled=!1,v.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent=E}}};var k=e.onChange(x);return{el:n,destroy:function(){v.onclick=null,k&&k()}}}function Fa(e,r,t){if(t=t||{},e===1)return Gt(r,{canNavigate:t.canNavigate});if(e===2)return Xt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Jt(r,{onValidityChange:t.onValidityChange});if(e===4)return Zt(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function $t(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Qt(e){e=e||{};var r=Wt({productId:e.productId,productName:e.productName}),t={},a={},n={};function o(z){if(!(!z||typeof z!="string"||!z.startsWith("blob:")||n[z])){n[z]=!0;try{URL.revokeObjectURL(z)}catch(S){}}}function l(){Object.keys(a).forEach(function(S){o(S)}),Object.keys(t).forEach(function(S){o(t[S])});var z=r.get();(z.pendingImages||[]).forEach(function(S){o(S&&S.url)}),(z.images||[]).forEach(function(S){o(S)})}var i=Vt({onClose:function(){window.removeEventListener("popstate",u),zr(d),l(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=wr(),u=function(z){i&&i.close&&i.close()};window.addEventListener("popstate",u);var f=document.createElement("div");f.className="renuvex-pr-fwizard-step-wrap";var s=qt({skippableSteps:[2],nextableSteps:[3],onBack:function(){w==="idle"&&r.goBack()},onSkip:function(){w==="idle"&&r.goNext()},onNext:function(){w==="idle"&&r.goNext()}}),p=document.createElement("div");p.className="renuvex-pr-fwizard-layout",p.appendChild(f),p.appendChild(s.el);var c=null,w="idle",v=null,b=!0,x=null;function h(z,S){f.innerHTML="";var A=Fa(z,r,{canNavigate:function(){return w==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:o,onValidityChange:function(P){s.setNextDisabled(!P)},onSuccess:k,showToast:i.showToast});if(c=A,s.update(z,r.get()),S){w="entering",A.el.classList.add("renuvex-pr-fwizard-step--enter");var L=null,C=function(){L&&clearTimeout(L),A.el.removeEventListener("animationend",C),A.el.classList.remove("renuvex-pr-fwizard-step--enter"),w="idle",v!==null&&m()};A.el.addEventListener("animationend",C),L=setTimeout(C,700)}else w="idle";f.appendChild(A.el),i.setStepAttr&&i.setStepAttr(z),z===3&&s.setNextDisabled(!0)}var g=!1;function k(){if(!g){if(g=!0,!c){f.innerHTML="";var z=$t();z.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(z),i.setStepAttr("thanks"),s.setThanksState(i.close);return}var S=c;w="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var A=function(){if(x&&clearTimeout(x),S.el.removeEventListener("animationend",A),S.destroy)try{S.destroy()}catch(C){}c===S&&(c=null),f.innerHTML="";var L=$t();L.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(L),i.setStepAttr("thanks"),s.setThanksState(i.close),w="idle"};S.el.addEventListener("animationend",A),x=setTimeout(A,300)}}function m(){var z=r.get().currentStep;if(w!=="idle"){v=z;return}if(!c){var S=!b;b=!1,h(z,S);return}var A=c;w="exiting",A.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(x&&clearTimeout(x),A.el.removeEventListener("animationend",L),A.destroy)try{A.destroy()}catch(P){}if(c===A){f.innerHTML="",c=null;var C=v!==null?v:r.get().currentStep;v=null,h(C,!0),w="idle"}};A.el.addEventListener("animationend",L),x=setTimeout(L,350)}m();var y=r.get().currentStep,T=r.onChange(function(z){z.currentStep!==y?(y=z.currentStep,m()):s.update(z.currentStep,z)}),E=i.close;return i.close=function(){T&&T(),typeof x!="undefined"&&x&&clearTimeout(x),E()},i.open(p),{close:i.close}}function U(){Qt({productId:D||"",productName:Ne||""})}var ea=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Oa={id:"classic",name:"Klasik (A\xE7\u0131k)"},Ha=ea;function Ya(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange;ye(n);var c=document.createElement("div");c.className="renuvex-pr-summary";var w=(l[3]||0)+(l[4]||0),v=o>0?Math.round(w/o*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+J("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",c.appendChild(b);var x=document.createElement("div");if(x.className="renuvex-pr-summary-block renuvex-pr-summary-count",x.textContent=o.toLocaleString("tr-TR")+" Yorum",c.appendChild(x),a.showRecommendation!==!1&&v>0){var h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",c.appendChild(h)}return c.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:s})),c.appendChild(q({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p})),c}var Ur={};be(Ur,{css:()=>ja,meta:()=>Da,render:()=>qa});var ra=`
...
`;var Da={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ja=ra,Ua="__unknown_product__",er=Object.create(null);function Va(e){return e?String(e):Ua}var Ae=null,rr=null;function Wa(){!Ae||!rr||(Ae.removeEventListener?Ae.removeEventListener("change",rr):Ae.removeListener&&Ae.removeListener(rr),Ae=null,rr=null)}function qa(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange,c=Va(t),w=document.createElement("div");w.className="renuvex-pr-summary renuvex-pr-summary-compact";var v=document.createElement("div");v.className="renuvex-pr-compact-header";var b=document.createElement("div");b.className="renuvex-pr-compact-trigger-wrap";var x=document.createElement("button");x.className="renuvex-pr-compact-trigger",x.type="button",x.setAttribute("aria-expanded","false"),x.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Be(i,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+o.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+ce(xt)+"</span>",b.appendChild(x),v.appendChild(b);var h=q({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p}),g=h.querySelector(".renuvex-pr-filter-wrap"),k=h.querySelector(".renuvex-pr-write-btn"),m=document.createElement("div");m.className="renuvex-pr-compact-actions-slot",k&&m.appendChild(k),g&&m.appendChild(g),v.appendChild(m),w.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-compact-panel",y.setAttribute("role","dialog"),y.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),y.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var E=document.createElement("div");E.className="renuvex-pr-compact-avg",E.innerHTML='<span class="renuvex-pr-icon">'+J("full")+"</span><span>"+i+"</span>",T.appendChild(E),T.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){S()&&y.classList.contains("renuvex-pr-open")&&(er[c]=!0),s(I)}})),y.appendChild(T);var z=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function S(){return!!(z&&z.matches)}function A(I){I?y.classList.add("renuvex-pr-open"):y.classList.remove("renuvex-pr-open"),y.setAttribute("aria-hidden",I?"false":"true"),x.setAttribute("aria-expanded",I?"true":"false")}function L(I){var ie=I?w:b;if(y.parentNode!==ie){var K=!!y.parentNode;y.classList.contains("renuvex-pr-open")&&A(!1),K&&(er[c]=!1),ie.appendChild(y)}}L(z?z.matches:!1);var C=q({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p}),P=C.querySelector(".renuvex-pr-filter-wrap"),N=C.querySelector(".renuvex-pr-write-btn"),M=document.createElement("div");M.className="renuvex-pr-compact-write-row",N&&M.appendChild(N),P&&M.appendChild(P),w.appendChild(M);function V(){var I=y.classList.contains("renuvex-pr-open");return A(!1),S()&&(er[c]=!1),I}function Q(){O&&O.notifyOpening(),A(!0),S()&&(er[c]=!0)}x.onclick=function(){y.classList.contains("renuvex-pr-open")?V():Q()};var O=null;function j(I){O&&(O.unregister(),O=null),I||(O=Sr({trigger:b,element:y,close:V}))}if(j(z?z.matches:!1),Wa(),z){var G=function(I){L(I.matches),j(I.matches)};z.addEventListener?z.addEventListener("change",G):z.addListener&&z.addListener(G),Ae=z,rr=G}if(S()&&er[c]&&A(!0),a.showRecommendation!==!1){var de=(l[3]||0)+(l[4]||0),F=o>0?Math.round(de/o*100):0;if(F>0){var ee=document.createElement("div");ee.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",ee.style.marginTop="8px",ee.innerHTML='<span class="renuvex-pr-recommend-pct">%'+F+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(ee)}}return w}var Vr={};be(Vr,{css:()=>Ka,meta:()=>Ga,render:()=>Xa});var ta=`
...
`;var Qa={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},en=na;function rn(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,i=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-hero";var u=document.createElement("div");u.className="renuvex-pr-hero-info";var f=document.createElement("div");f.className="renuvex-pr-hero-rating-col";var s=document.createElement("span");s.className="renuvex-pr-hero-avg",s.textContent=n,f.appendChild(s);var p=document.createElement("div");p.className="renuvex-pr-hero-meta-row";var c=document.createElement("span");c.className="renuvex-pr-hero-stars",c.innerHTML=Be(n,t),p.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-hero-count",w.textContent=a.toLocaleString("tr-TR")+" Yorum",p.appendChild(w),f.appendChild(p),u.appendChild(f),d.appendChild(u);var v=q({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:U,onSortChange:i}),b=v.querySelector(".renuvex-pr-filter-wrap"),x=v.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");h.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",x&&h.appendChild(x),b&&h.appendChild(b),d.appendChild(h);var g=q({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:U,onSortChange:i}),k=g.querySelector(".renuvex-pr-filter-wrap"),m=g.querySelector(".renuvex-pr-write-btn"),y=document.createElement("div");return y.className="renuvex-pr-hero-write-row",m&&y.appendChild(m),k&&y.appendChild(k),d.appendChild(y),d}var ia=`
  .renuvex-pr-summary{
...
`;var tn={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},an=la;function nn(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var o=document.createElement("span");o.className="renuvex-pr-review-stars",o.innerHTML=me(e.rating,R),n.appendChild(o);var l=document.createElement("time");if(l.className="renuvex-pr-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=xe(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var u=(e.comment||"").trim();u&&t.appendChild(Ue(u,"renuvex-pr-body").fragment);var f=we(e);if(f.length){var s=document.createElement("div");s.className="renuvex-pr-gallery",f.forEach(function(c){var w=document.createElement("img"),v=oe(c,W);w.src=v.src,w.srcset=v.srcset,w.loading="lazy",w.decoding="async",w.width=W,w.height=W,w.className="renuvex-pr-img",le(w),w.setAttribute("data-renuvex-img-url",c),(function(b){ze(w,function(){ue(e,b,r)})})(c),s.appendChild(w)}),t.appendChild(s)}var p=Ve(e.merchantReply);return p&&t.appendChild(p),t}var Kr={};be(Kr,{css:()=>ln,meta:()=>on,render:()=>pn});var pa=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var un={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},dn=ua;function sn(e,r){var t=vr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-gallery-content";var l=document.createElement("span");if(l.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",l.innerHTML=me(e.rating,R),o.appendChild(l),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,o.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",o.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=xe(e.createdAt),o.appendChild(u);var f=(e.comment||"").trim();if(f&&o.appendChild(Ue(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ue(e,t,r)}}:null).fragment),n.appendChild(o),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var p=document.createElement("img"),c=oe(t,cr);p.src=c.src,p.srcset=c.srcset,p.loading="lazy",p.decoding="async",p.width=cr,p.height=Math.round(cr*4/3),le(p),p.setAttribute("data-renuvex-img-url",t),ze(p,function(){ue(e,t,r)}),s.appendChild(p),n.appendChild(s)}var w=Ve(e.merchantReply,t?function(){ue(e,t,r)}:null);return w&&(w.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(w)),n}var Tr={card:Gr,list:Kr,gallery:Xr};function Ar(e){return Tr[e]||Tr.card}function da(){return Object.keys(Tr).map(function(e){return Tr[e].css||""}).join(`
`)}var Jr=0;function We(){return Jr++,Jr}function qe(e,r){return e!==Jr?!1:r?!(r.productId!==void 0&&D!==r.productId||r.orderBy!==void 0&&X!==r.orderBy||r.page!==void 0&&ir!==r.page||r.ratingFilter!==void 0&&ae!==r.ratingFilter||r.hasImages!==void 0&&ne!==r.hasImages):!0}var Zr={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},$r={small:80,medium:110,large:140};function sa(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var o=document.createElementNS(t,"line");o.setAttribute("x1","1"),o.setAttribute("y1","1"),o.setAttribute("x2","23"),o.setAttribute("y2","23"),a.appendChild(n),a.appendChild(o);var l=document.createElement("div");l.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",l.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(l),r.appendChild(i),r}function va(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function ge(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),o=parseInt(t[3],16);return"rgba("+a+","+n+","+o+","+r+")"}function Lr(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Qr(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function ca(e){return .2126*Qr(e.r)+.7152*Qr(e.g)+.0722*Qr(e.b)}function ma(e,r){var t=ca(e),a=ca(r),n=Math.max(t,a),o=Math.min(t,a);return(n+.05)/(o+.05)}function vn(e){var r=Lr(e)||Lr("#ffffff"),t=Lr("#111111"),a=Lr("#ffffff");return ma(t,r)>=ma(a,r)?"#111111":"#ffffff"}function cn(e){return ge(e,e==="#ffffff"?.1:.06)}function xa(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",o=r.headerRecommendColor||"#111111",l=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=ge(l,.06),f=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",c=r.btnBorderColor||"#111111",w=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",b=r.filterBtnBorderColor||"#111111",x=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",g=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",m=r.filterItemActiveColor||"#111111",y=r.reviewTitleColor||"#111111",T=r.reviewAuthorColor||"#111111",E=r.reviewDateColor||"#5e5e5e",z=r.reviewBodyColor||"#111111",S=r.reviewBorderColor||"#e5e7eb",A=ge(z,.65),L=r.replyBgColor||"#f9fafb",C=r.replyBorderColor||"#747474",P=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",M=r.photoTitleColor||"#111111",V=ge("#111111",.05),Q=r.photoArrowBgColor||"#ffffff",O=r.photoArrowTextColor||"#111111",j=ge("#111111",.12),G=r.formBgColor||"#ffffff",de=r.formPrimaryTextColor||"#111111",F=r.formSecondaryTextColor||"#3b3b3b",ee=r.inputTextColor||de,I=r.inputBorderColor||"#d1d5db",ie=r.placeholderColor||"#9ca3af",K=r.formStepBarColor||"#111111",B=r.formBtnBgColor||"#111111",he=r.formBtnTextColor||"#ffffff",Y=r.formBtnBorderColor||"#111111",tr=ge(B,.06),ke=ge(B,.18),_=ge(he,.85),re=ge(de,.06),te=vn(G),H=cn(te),se=r.loadMoreBgColor||"#ffffff",ar=r.loadMoreTextColor||"#111111",nr=r.loadMoreBorderColor||"#111111",ve={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":o,"--renuvex-pr-bar-fill":l,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":c,"--renuvex-pr-filter-btn-bg":w,"--renuvex-pr-filter-btn-text":v,"--renuvex-pr-filter-btn-border":b,"--renuvex-pr-filter-menu-bg":x,"--renuvex-pr-filter-menu-border":h,"--renuvex-pr-filter-item-text":g,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":m,"--renuvex-pr-review-title":y,"--renuvex-pr-review-author":T,"--renuvex-pr-review-date":E,"--renuvex-pr-review-body":z,"--renuvex-pr-review-border":S,"--renuvex-pr-state-text":A,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":C,"--renuvex-pr-reply-label":P,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":M,"--renuvex-pr-photo-image-border":V,"--renuvex-pr-photo-arrow-bg":Q,"--renuvex-pr-photo-arrow-text":O,"--renuvex-pr-photo-arrow-border":j,"--renuvex-pr-fwizard-bg":G,"--renuvex-pr-fwizard-text":de,"--renuvex-pr-fwizard-secondary-text":F,"--renuvex-pr-fwizard-input-bg":G,"--renuvex-pr-fwizard-input-text":ee,"--renuvex-pr-fwizard-input-border":I,"--renuvex-pr-fwizard-placeholder":ie,"--renuvex-pr-fwizard-close-text":te,"--renuvex-pr-fwizard-close-hover-bg":H,"--renuvex-pr-fwizard-progress-bg":re,"--renuvex-pr-fwizard-progress-active":K,"--renuvex-pr-fwizard-btn-bg":B,"--renuvex-pr-fwizard-btn-text":he,"--renuvex-pr-fwizard-btn-border":Y,"--renuvex-pr-fwizard-btn-disabled-bg":ke,"--renuvex-pr-fwizard-btn-disabled-text":_,"--renuvex-pr-fwizard-nav-hover-bg":tr,"--renuvex-pr-load-more-bg":se,"--renuvex-pr-load-more-text":ar,"--renuvex-pr-load-more-border":nr};Object.keys(ve).forEach(function(Ge){e.style.setProperty(Ge,ve[Ge])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function fa(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,o=e.wireLightboxTrigger,l=(e.photoStripReviews||[]).filter(function(k){return we(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&l.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",u=document.createElement("div");u.className="renuvex-pr-photo-title",u.textContent=d,i.appendChild(u)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var p=W,c=r.reviewLayout==="card"?W:Math.round(W*4/3),w=0;l.forEach(function(k){if(!(w>=15)){var m=vr(k);if(m){var y=document.createElement("img"),T=oe(m,W);y.src=T.src,y.srcset=T.srcset,y.loading=w<3?"eager":"lazy",y.decoding="async",y.width=p,y.height=c,y.className="renuvex-pr-photo-strip-thumb",y.alt="Yorum foto\u011Fraf\u0131",le(y),(function(E,z){o(y,function(){n(z,E,l)})})(m,k),s.appendChild(y),w++}}});var v=document.createElement("button");v.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var b=Z(Ie);b&&v.appendChild(b),v.setAttribute("aria-label","\xD6nceki"),v.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var x=document.createElement("button");x.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=Z(sr);h&&x.appendChild(h),x.setAttribute("aria-label","Sonraki"),x.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var g=document.createElement("div");return g.className="renuvex-pr-photo-strip-wrap",g.appendChild(v),g.appendChild(s),g.appendChild(x),i.appendChild(g),i}function ga(e){var r=e.render;async function t(){var o=We(),l=D,i=X,d=ae,u=ne,f=await _e(D,X,1,ae,ne);qe(o,{productId:l,orderBy:i,ratingFilter:d,hasImages:u})&&await r(D,R,f,Ne,X,1,rt)}async function a(o){var l=We(),i=ae===o?null:o,d=D,u=X,f=ne;at(i),Re(1);var s=await _e(D,X,1,i,ne);qe(l,{productId:d,orderBy:u,page:1,ratingFilter:i,hasImages:f})&&await r(D,R,s,Ne,X,1)}async function n(o,l){var i=We(),d=D,u=ae;Re(1);var f=o,s=!1;l&&(s=!0,f="newest"),nt(s),or(f);var p=await _e(D,f,1,ae,s);qe(i,{productId:d,orderBy:f,page:1,ratingFilter:u,hasImages:s})&&await r(D,R,p,Ne,f,1)}return{onRetry:t,onFilterChange:a,onSortChange:n}}function mn(){return St()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function xn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=zt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),kt(t,{surface:"reviews",productId:r||""}),t}async function et(e,r,t,a,n,o,l){if(ct){ur({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:o,badgeSettings:l});return}pr(!0),it(e),ot(r),l!==void 0&&lt(l),pt(a),n&&or(n),o&&Re(o),t!=null&&ut(t);var i=ga({render:et});try{let ke=function(_,re){if(!(!_||!_.meta||!_.meta.sizeOverrides)){var te=_.meta.sizeOverrides[re];te&&Object.keys(te).forEach(function(H){c.style.setProperty(H,te[H])})}};var tr=ke,d=Er(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,s=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",p=u&&f?s:"",c=document.documentElement;xa(c,r);var w=r.borderRadius!==void 0?r.borderRadius:8,v=Zr[r.size]||Zr.medium,b=$r[r.thumbnailSize]||$r.medium;c.style.setProperty("--renuvex-pr-title-size",v.titleSize+"px"),c.style.setProperty("--renuvex-pr-review-text-size",v.reviewTextSize+"px"),c.style.setProperty("--renuvex-pr-review-title-size",v.reviewTitleSize+"px"),c.style.setProperty("--renuvex-pr-author-size",v.authorSize+"px"),c.style.setProperty("--renuvex-pr-reply-name-size",v.replyNameSize+"px"),c.style.setProperty("--renuvex-pr-reply-text-size",v.replyTextSize+"px"),c.style.setProperty("--renuvex-pr-radius",w+"px"),c.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,w-4)+"px"),c.style.setProperty("--renuvex-pr-photo-title-size",v.photoTitleSize+"px"),c.style.setProperty("--renuvex-pr-avg-rating-size",v.avgRatingSize+"px"),c.style.setProperty("--renuvex-pr-review-count-size",v.reviewCountSize+"px"),c.style.setProperty("--renuvex-pr-compact-count-size",v.compactCountSize+"px"),c.style.setProperty("--renuvex-pr-recommend-size",v.recommendSize+"px"),c.style.setProperty("--renuvex-pr-btn-text-size",v.btnTextSize+"px"),c.style.setProperty("--renuvex-pr-bar-label-size",v.barLabelSize+"px"),c.style.setProperty("--renuvex-pr-minimal-avg-size",v.minimalAvgSize+"px"),c.style.setProperty("--renuvex-pr-hero-avg-size",v.heroAvgSize+"px"),c.style.setProperty("--renuvex-pr-bar-count-size",v.barCountSize+"px"),c.style.setProperty("--renuvex-pr-review-date-size",v.reviewDateSize+"px"),c.style.setProperty("--renuvex-pr-filter-text-size",v.filterTextSize+"px"),c.style.setProperty("--renuvex-pr-load-more-size",v.loadMoreSize+"px"),c.style.setProperty("--renuvex-pr-read-more-size",v.readMoreSize+"px"),c.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var x=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";c.style.setProperty("--renuvex-pr-review-star-color",x),c.style.setProperty("--renuvex-pr-star-size",v.reviewStarSize+"px"),c.style.setProperty("--renuvex-pr-avg-star-size",v.avgStarSize+"px"),ke(Er(r.summaryLayout),r.size),ke(Ar(r.reviewLayout),r.size);var h=Je(r),g=mn();if(!g)return;var k=xn(g,e),m=document.getElementById("renuvex-reviews");m||(m=document.createElement("div"),m.id="renuvex-reviews",m.style.minHeight="200px"),m.parentNode!==k&&k.appendChild(m);var y=Ct(m),T=Me+Le+fr+oa()+da();Fe(y,T);var E=Tt(y);if(r.enabled===!1){m.style.minHeight="auto",E.replaceChildren(sa(r.borderRadius!==void 0?r.borderRadius:8)),pr(!1);var z=lr;ur(null),z&&et(z.productId,z.settings,z.reviewsData,z.productName,z.orderBy,z.page,z.badgeSettings);return}try{var S=t||{},A=Br(S),L=A?[]:S.data&&S.data.reviews||[];dt(L),E.replaceChildren();var C=document.createElement("section");if(C.id="renuvex-reviews-widget",C.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),C.className="renuvex-pr-reviews-widget",C.setAttribute("data-renuvex-surface","reviews"),e&&C.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(C.style.width="100%",C.style.maxWidth="100%",C.style.marginLeft="0",C.style.marginRight="0"),p){var P=document.createElement("div"),N=r.summaryLayout||"classic";P.className="renuvex-pr-title renuvex-pr-title-"+N,P.textContent=p,C.appendChild(P)}if(A){C.appendChild(va(S.message,i.onRetry)),E.appendChild(C),Se(y),Pr(C,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return y.getElementById("renuvex-reviews-widget")});return}var M=S.data&&S.data.allCount||0,V=S.data&&S.data.ratingCounts||null,Q=V||[0,0,0,0,0],O=S.data&&S.data.avgRating||"0.0";if(!V&&L.length>0){L.forEach(function(_){_.rating>=1&&_.rating<=5&&Q[_.rating-1]++});var j=L.reduce(function(_,re){return _+re.rating},0);O=(j/L.length).toFixed(1)}if(M>0){var G=Er(r.summaryLayout),de=G.render({widget:C,productId:e,data:S,settings:r,iconPair:h,allCount:M,ratingCounts:Q,avgRatingVal:O,currentRatingFilter:ae,currentOrderBy:X,currentHasImages:ne,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});C.appendChild(de)}else{var F=document.createElement("button");F.className="renuvex-pr-write-btn",F.style.cssText="display:block;margin:16px auto 0;",F.textContent=r.writeButtonText||"Yorum Yap",F.onclick=U,C.appendChild(F)}var ee=fa({settings:r,root:c,currentHasImages:ne,photoStripReviews:tt,openReviewModal:ue,wireLightboxTrigger:ze});if(ee&&C.appendChild(ee),L.length===0){var I=document.createElement("p");I.className="renuvex-pr-state-msg",I.textContent="Hen\xFCz yorum yok.",C.appendChild(I)}else{var ie=Ar(r.reviewLayout);L.forEach(function(_){C.appendChild(ie.render(_,Nr))})}var K=S.data&&S.data.hasMore;if(K){var B=document.createElement("button");B.className="renuvex-pr-load-more",B.textContent="Daha Fazla G\xF6ster",B.onclick=async function(){B.disabled=!0,B.textContent="Y\xFCkleniyor...";var _=We(),re=D,te=X,H=ir,se=ae,ar=ne,nr=H+1,ve=await _e(re,te,nr,se,ar);if(qe(_,{productId:re,orderBy:te,page:H,ratingFilter:se,hasImages:ar}))if(ve&&!Br(ve)&&ve.data&&Array.isArray(ve.data.reviews)){var Ge=st(ve.data.reviews);vt(Ge),Re(nr);var ha=Ar(R.reviewLayout);Ge.forEach(function(ba){C.insertBefore(ha.render(ba,Nr),B)}),ve.data.hasMore?(B.disabled=!1,B.textContent="Daha Fazla G\xF6ster"):B.remove()}else B.disabled=!1,B.textContent="Tekrar Dene"},C.appendChild(B)}E.appendChild(C),Se(y),Pr(C,"reviews-widget",{productId:e||""},function(){return y.getElementById("renuvex-reviews-widget")})}catch(_){console.error("[renuvex-pr] render error:",_);var he=document.createElement("p");he.style.cssText="text-align:center;color:#dc2626;",he.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",E&&E.replaceChildren(he)}}finally{if(pr(!1),lr){var Y=lr;ur(null),et(Y.productId,Y.settings,Y.reviewsData,Y.productName,Y.orderBy,Y.page,Y.badgeSettings)}}}export{et as render};
