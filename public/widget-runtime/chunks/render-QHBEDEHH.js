...
`;function Ma(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,n=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,a=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",o.appendChild(p);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var u=Z(ye);u&&l.appendChild(u),o.appendChild(l);var m=!1,v=null,s=null,c=!1;function g(){se(i)}function d(k){Dr(k,i,v&&v.root)}function x(){if(!m){if(m=!0,document.removeEventListener("keydown",h),i.removeEventListener("click",b),l.removeEventListener("click",x),c)se(s);else{var k=v&&v.root?v.root.activeElement:null;if(k&&typeof k.blur=="function")try{k.blur()}catch(C){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){v?(Er(v.root),v.host&&v.host.parentNode&&v.host.parentNode.removeChild(v.host)):i.parentNode&&i.parentNode.removeChild(i),Hr();try{r()}catch(C){}},200)}}function h(k){if(k.key==="Escape"){x();return}d(k)}function b(k){k.target===i&&a&&x()}document.addEventListener("keydown",h),i.addEventListener("click",b),l.addEventListener("click",x);function w(k){s=t||Vr(),c=n===null?Me():n,k&&p.appendChild(k),v=Fr(),Ke(v.root,Ge+je+Pa),v.root.appendChild(i),Fe(v.root),Ur(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),g()})}var A=null,y=null;function z(k,C){if(C=C||"error",A){try{A.remove()}catch(T){}A=null}y&&(clearTimeout(y),y=null),A=document.createElement("div"),A.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+C,A.textContent=k,o.appendChild(A),y=setTimeout(function(){A&&(A.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(A){try{A.remove()}catch(T){}A=null}},300))},4e3)}return{open:w,close:x,content:p,setAllowOutsideClose:function(k){a=!!k},setStepAttr:function(k){o.setAttribute("data-step",String(k))},showToast:z}}var xt=4;function Qe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function _a(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(i){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<xt&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(i){return i!==a})}}}}function Na(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",p.setAttribute("aria-label","Geri"),p.innerHTML=ue(We)+"<span>Geri</span>",p.addEventListener("click",function(){n()}),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-footer-progress";for(var u=[],m=0;m<xt;m++){var v=document.createElement("span");v.className="renuvex-pr-fwizard-progress-seg",l.appendChild(v),u.push(v)}o.appendChild(l);var s=document.createElement("button");s.type="button";var c=null;function g(x){c&&s.removeEventListener("click",c),c=x,x&&s.addEventListener("click",x)}o.appendChild(s);function d(x,h){var b=r.indexOf(x)!==-1,w=t.indexOf(x)!==-1,A=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0||!!h.videoUpload);if(b)x===2&&A?(s.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",s.setAttribute("aria-label","Devam Et"),s.innerHTML="Devam Et",g(function(){i()})):(s.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",s.setAttribute("aria-label","Atla"),s.innerHTML="<span>Atla</span>",g(function(){a()})),s.disabled=!1,s.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),s.style.visibility="",s.tabIndex=0;else if(w){s.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",s.setAttribute("aria-label","Sonraki"),s.innerHTML="Sonraki",s.style.visibility="",s.tabIndex=0;var y=Qe(x,h);s.disabled=!y,s.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!y),g(function(){s.disabled||i()})}else s.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",s.innerHTML="",s.style.visibility="hidden",s.tabIndex=-1,s.disabled=!0,g(null)}return{el:o,update:function(x,h){u.forEach(function(w,A){A+1<=x?w.classList.add("renuvex-pr-fwizard-progress-seg-active"):w.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var b=x<=1;p.style.visibility=b?"hidden":"",p.style.pointerEvents=b?"none":"",p.tabIndex=b?-1:0,d(x,h)},setNextDisabled:function(x){s.classList.contains("renuvex-pr-fwizard-cta-btn")&&(s.disabled=!!x,s.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!x))},setThanksState:function(x){p.style.visibility="hidden",l.style.visibility="hidden",s.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",s.setAttribute("aria-label","Devam Et"),s.innerHTML="Devam Et",s.style.visibility="",s.disabled=!1,s.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),g(x)}}}var qn={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ve(e){var r=N&&N[e];return!r&&e==="formStepMediaTitle"&&(r=N&&N.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=N&&N.formStepPhotosSubtitle),B(r,qn[e])}function La(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ve("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var p=lr(N||{});Ne(p);var l=[];function u(x){l.forEach(function(h,b){var w=b<x;h.classList.toggle("renuvex-pr-fwizard-star-active",w),h.setAttribute("aria-checked",b+1===x?"true":"false"),h.innerHTML=w?de("full"):de("outline")})}function m(x){e.set({rating:x}),u(x)}function v(x){var h=l[x-1];if(h)try{h.focus()}catch(b){}}function s(x,h){h&&typeof h.preventDefault=="function"&&h.preventDefault(),h&&typeof h.stopPropagation=="function"&&h.stopPropagation(),!n&&(n=!0,m(x),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var c=1;c<=5;c++)(function(x){var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",x+" y\u0131ld\u0131z"),h.innerHTML=de("outline"),h.addEventListener("mouseenter",function(){u(x)}),h.addEventListener("mouseleave",function(){u(e.get().rating)}),h.addEventListener("pointerdown",function(b){b.button&&b.button!==0||s(x,b)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){s(x,b)},{passive:!1}),h.addEventListener("mousedown",function(b){window.PointerEvent||s(x,b)}),h.addEventListener("keydown",function(b){if(b.key==="Enter"||b.key===" "){s(x,b);return}var w=0;b.key==="ArrowRight"||b.key==="ArrowUp"?w=Math.min(5,x+1):b.key==="ArrowLeft"||b.key==="ArrowDown"?w=Math.max(1,x-1):b.key==="Home"?w=1:b.key==="End"&&(w=5),w&&(b.preventDefault(),m(w),v(w))}),h.addEventListener("click",function(b){s(x,b)}),l.push(h),o.appendChild(h)})(c);u(e.get().rating);var g=null,d=function(x){var h=x&&x.detail&&x.detail.settings;h&&h===g||(g=h||null,p=lr(h||N||{}),u(e.get().rating))};return window.addEventListener(Oe,d),t.appendChild(o),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Oe,d)}}}var Gr=3,Gn=10*1024*1024;function Kr(e,r){r=r||{};var t=!1,n=r.hideAddButton===!0,a=r.revealAddButtonAfterMedia===!0,i=!n||a,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=ve("formStepPhotosTitle"),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=ve("formStepPhotosSubtitle"),o.appendChild(l)}var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&u.classList.add("renuvex-pr-fwizard-photo-card--embedded");var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add",m.setAttribute("aria-label","Foto\u011Fraf ekle");var v=document.createElement("input");v.type="file",v.accept="image/*",v.multiple=!0,v.style.display="none",i&&u.appendChild(m),u.appendChild(v);var s=document.createElement("div");s.className="renuvex-pr-fwizard-photo-previews",s.setAttribute("aria-live","polite"),u.appendChild(s),o.appendChild(u);var c=r.revokeBlobUrl||function(y){y&&typeof y=="string"&&y.startsWith("blob:")&&URL.revokeObjectURL(y)},g=r.blobMap||{},d=r.urlToFinger||{};function x(){if(!t){var y=e.get().images||[],z=e.get().pendingImages||[],k=y.map(function(C){return{url:C,isPending:!1}}).concat(z.map(function(C){return{url:C.url,file:C.file,isPending:!0,error:C.error}}));s.innerHTML="",k.forEach(function(C){var T=g[C.url]||C.url,E=h(C,T);s.appendChild(E)}),w()}}function h(y,z){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var C=document.createElement("img");C.src=z,C.alt="",C.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(C);var T=document.createElement("div");T.className="renuvex-pr-fwizard-photo-loading",T.style.display="none",k.appendChild(T);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var f=Z(ye);return f&&E.appendChild(f),k.appendChild(E),b(k,y,z),k}function b(y,z,k){var C=y.querySelector("img");C.src!==k&&(C.src=k);var T=y.querySelector(".renuvex-pr-fwizard-photo-loading");if(z.isPending&&z.error){T.style.display="flex",T.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+z.error,T.appendChild(E)}else T.style.display="none",T.textContent="";var f=y.querySelector(".renuvex-pr-fwizard-photo-remove");f.onclick=function(){var P=d[z.url]||(z.file?z.file.name+"_"+z.file.size:null),_=g[z.url],S={};P&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(M){return M!==P})),z.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(M){return M.url!==z.url}):S.images=(e.get().images||[]).filter(function(M){return M!==z.url}),e.set(S),c(z.url),c(_),delete d[z.url],_&&delete d[_],g[z.url]&&delete g[z.url]}}function w(){var y=(e.get().images||[]).length,z=(e.get().pendingImages||[]).length,k=y+z,C=k>=Gr;u.classList.toggle("renuvex-pr-fwizard-photo-card--compact",k>0),i&&(m.innerHTML=k>0?ue(Zt):ue(Ar)+"<span>Foto\u011Fraf Ekle</span>"),C?(i&&(m.style.display="none"),m.disabled=!0,v.disabled=!0):(i&&(m.style.display=a&&k===0?"none":"flex"),m.disabled=!1,v.disabled=!1,m.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}m.addEventListener("click",function(){v.disabled||v.click()}),v.onchange=async function(y){var z=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(y.target.files).slice(0,Gr-z);v.value="";var C=(e.get().pendingImages||[]).length,T=e.get().images||[],E=T.length;if(k.length!==0){for(var f=[],P=[],_=0;_<k.length;_++){var S=k[_],M=S.name+"_"+S.size,R=(e.get().fingerprints||[]).some(function(Y){return Y===M})||f.some(function(Y){return Y.file.name+"_"+Y.file.size===M});if(!R){if(S.size>Gn){var I="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(I,"error"):alert(I);continue}var L=URL.createObjectURL(S);d[L]=M,f.push({url:L,file:S,error:null}),P.push({url:L,file:S});var F=(e.get().fingerprints||[]).slice();F.push(M),e.set({fingerprints:F})}}if(f.length!==0){var j=(e.get().pendingImages||[]).concat(f),q=async function(){for(var Y=0;Y<P.length;Y++){var U=P[Y],$=U.file,X=U.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var V=(e.get().pendingImages||[]).filter(function(J){return J.url!==X}),D=(e.get().images||[]).slice();D.push(X),e.set({pendingImages:V,images:D});continue}try{var W=await ke(be+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe})});if(!W.ok)throw W.status===429?new Error("rate_limit"):new Error("sign failed");var Q=await W.json();if(!Q.folder)throw new Error("sign folder missing");var le=new FormData;le.append("file",$),le.append("api_key",Q.api_key),le.append("timestamp",Q.timestamp),le.append("signature",Q.signature),le.append("folder",Q.folder);var ce=await fetch("https://api.cloudinary.com/v1_1/"+Q.cloud_name+"/image/upload",{method:"POST",body:le}),K=await ce.json();if(K.secure_url&&Mr(K.secure_url)){var xr=(e.get().pendingImages||[]).some(function(J){return J.url===X});if(!xr)continue;g[K.secure_url]=X,d[K.secure_url]=d[X];var Ae=(e.get().pendingImages||[]).filter(function(J){return J.url!==X}),O=(e.get().images||[]).slice();O.push(K.secure_url),e.set({pendingImages:Ae,images:O});try{ke(be+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,secureUrl:K.secure_url,metadata:{assetId:K.asset_id,publicId:K.public_id,version:K.version,resourceType:K.resource_type,format:K.format,width:K.width,height:K.height,bytes:K.bytes,signature:K.signature}})}).catch(function(){})}catch(J){}}else throw new Error("invalid image url")}catch(J){console.error("[renuvex-pr] Image upload failed:",J);var te=J.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(te,"error");var me=(e.get().pendingImages||[]).map(function(he){return he.url===X?{url:he.url,file:he.file,error:te}:he});e.set({pendingImages:me})}}};if(E===0&&C===0){t=!0;var H=!r.canNavigate||r.canNavigate();H&&e.goNext()}e.set({pendingImages:j}),q()}}};var A=e.onChange(x);return x(),{el:o,openPicker:function(){v.disabled||v.click()},destroy:function(){t=!0,v.onchange=null,A&&A()}}}var Kn=150*1024*1024,Xn=2,Jn=60,Oa=8192,Ua=5,Zn=3e4,$n=["video/mp4","video/quicktime"],Qn="renuvex_pr_video_upload_",Ha="renuvex_pr_video_cancel_",sr=null,Ra=!1,ei={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},ri={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},Ee=class extends Error{constructor(r,t,n){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=n||null}};function Va(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:ei[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:ri[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function Da(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function gt(e){return new Promise(function(r){setTimeout(r,e)})}function er(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function rr(e){return Math.max(0,Math.round(er()-e))}function ti(){if(typeof window!="undefined"){var e=Number(window.__renuvexPrVideoUploadStallMs);if(Number.isFinite(e)&&e>=250)return e}return Zn}function ai(e,r){return new Promise(function(t,n){var a=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(a),r&&r.removeEventListener("abort",o),n(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function ht(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function bt(e,r){return Qn+pe+"_"+e+"_"+ht(r)}function Ya(e,r){try{var t=window.sessionStorage.getItem(bt(e,r)),n=t?JSON.parse(t):null;return!n||typeof n.token!="string"||!n.expiresAt||new Date(n.expiresAt).getTime()<=Date.now()?null:n}catch(a){return null}}function ni(e,r,t){try{window.sessionStorage.setItem(bt(e,r),JSON.stringify(t))}catch(n){}}function cr(e,r){try{window.sessionStorage.removeItem(bt(e,r))}catch(t){}}function ii(e,r){return Ha+pe+"_"+e+"_"+ht(r)}function oi(e,r,t,n){if(!(!e||!r||!t)){var a={token:e,productId:r,expiresAt:n||null};try{window.sessionStorage.setItem(ii(r,t),JSON.stringify(a))}catch(i){}}}function li(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(Ha+pe+"_")!==0)){var n=window.sessionStorage.getItem(t),a=n?JSON.parse(n):null;if(!a||typeof a.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:a.token})}}}catch(i){}return e}function Ia(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function tr(e,r,t){var n=await ke(be+e,r,t||2e4),a=await n.json().catch(function(){return{}});if(!n.ok){var i=Number(n.headers.get("Retry-After"));throw new Ee(a.error||"video_request_failed",n.status,Number.isFinite(i)&&i>0?i:null)}return a.data||{}}async function vr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await tr("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:rr(r.startedAt),finalStatus:t})},4e3)}catch(n){}}async function pi(e){try{return await tr("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Ia(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Ia(e.key),!0):!1}}function Xr(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():sr||(sr=(async function(){for(var e=li(),r=0;r<e.length;r+=1)await pi(e[r])})().finally(function(){sr=null}),sr)}function Jr(){typeof window=="undefined"||Ra||(Ra=!0,window.addEventListener("online",function(){Xr()}),Xr())}async function di(){var e=await import("./upchunk-QJXCGVJW.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function Ba(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}async function ui(e){var r=await di();return new Promise(function(t,n){var a=!1,i=null,o=null,p=ti(),l=null;function u(g){a||(a=!0,o&&clearTimeout(o),e.signal&&e.signal.removeEventListener("abort",c),l&&l(),g?n(g):t())}function m(g){a||(o&&clearTimeout(o),!(!g&&typeof navigator!="undefined"&&navigator.onLine===!1)&&(o=setTimeout(function(){if(!a){e.onUploadError&&e.onUploadError("video_upload_stalled"),u(new Ee("video_upload_stalled",0,null));try{i&&i.abort()}catch(d){}}},p)))}function v(){a||m()}function s(){if(!a){e.onUploadError&&e.onUploadError("video_upload_offline"),u(new Ee("video_upload_offline",0,null));try{i&&i.abort()}catch(g){}}}function c(){try{i&&i.abort()}catch(g){}u(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return n(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",c,{once:!0})}if(i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||Oa,attempts:e.chunkAttempts||Ua,dynamicChunkSize:!0}),typeof window!="undefined"&&typeof window.addEventListener=="function"&&typeof window.removeEventListener=="function"&&(window.addEventListener("offline",s),l=function(){window.removeEventListener("offline",s)}),typeof navigator!="undefined"&&navigator.onLine===!1){s();return}m(),i.on("attempt",function(){v(),e.onStatus("uploading")}),i.on("attemptFailure",function(g){v();var d=g&&g.detail;e.onAttemptFailure&&e.onAttemptFailure(Ba(d)),e.onStatus("upload_retrying")}),i.on("chunkSuccess",function(){v()}),i.on("progress",function(g){v();var d=Number(g&&g.detail);if(Number.isFinite(d)){var x=Math.min(95,Math.max(0,Math.round(d*.95)));Number.isFinite(e.minProgress)&&(x=Math.max(e.minProgress,x)),e.onProgress(x)}}),i.on("offline",s),i.on("error",function(g){v();var d=g&&g.detail,x=Ba(d);e.onUploadError&&e.onUploadError(x),u(new Ee(x,0,null))}),i.on("success",function(){v(),e.onProgress(95),u()})})}function si(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function Fa(e,r,t){for(var n=Date.now(),a=n+600*1e3,i=0;Date.now()<a;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-n;try{var p=await tr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":p.status||"processing"),p.status==="ready")return p;if(p.status==="failed"||p.status==="aborted")throw new Ee(p.errorCode||"video_processing_failed",409,null)}catch(l){if(r.aborted||l instanceof Ee&&l.status===409||Da(l)||(i+=1,i>=3))throw l}await ai(si(o),r)}throw new Ee("video_processing_delayed",0,null)}async function vi(e){for(var r=null,t=1;t<=3;t+=1)try{return await tr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(n){if(Da(n))return null;r=n,t<3&&await gt(400*t)}throw r||new Error("video_status_failed")}async function ci(e,r,t,n){for(var a=10;a<=90;a+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(a),await gt(120)}return n("processing"),await gt(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function ja(e){return!e||$n.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>Kn?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function Wa(e){return new Promise(function(r){var t=URL.createObjectURL(e),n=document.createElement("video"),a=!1;function i(o){if(!a){a=!0,n.removeAttribute("src");try{n.load()}catch(p){}URL.revokeObjectURL(t),r(o)}}n.preload="metadata",n.onloadedmetadata=function(){i(Number.isFinite(n.duration)?n.duration:null)},n.onerror=function(){i(null)},n.src=t,setTimeout(function(){i(null)},8e3)})}function qa(e){return e===null?{ok:!0}:e<Xn||e>Jn?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function Ga(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return ci(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:er(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(g){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=g||"upload_attempt_failed")}function n(){cr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}async function a(g,d){var x=await vi(g);if(!x)return{action:"discard"};if(x.status==="ready")return e.onToken&&e.onToken(g),e.onProgress(100),cr(e.productId,e.file),await vr(g,r,"ready"),{action:"return",value:Object.assign({token:g},x)};if(x.status==="uploaded"||x.status==="processing"){e.onToken&&e.onToken(g),e.onStatus("processing");var h=er(),b=await Fa(g,e.signal,e.onStatus);return r.processingPollMs=rr(h),cr(e.productId,e.file),e.onProgress(100),await vr(g,r,"ready"),{action:"return",value:Object.assign({token:g},b)}}return x.status==="failed"||x.status==="aborted"?{action:"discard"}:!d||typeof d.uploadUrl!="string"||!d.uploadUrl?{action:"discard"}:{action:"upload"}}Jr(),await Xr();var i=Ya(e.productId,e.file),o=i&&i.token,p=i;if(o){var l=await a(o,p);if(l.action==="return")return l.value;l.action==="discard"&&(n(),o=null,p=null)}for(;;){if(!o){var u=await tr("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:ht(e.file)})});o=u.token,p=u,ni(e.productId,e.file,u)}e.onToken&&e.onToken(o),r.chunkSizeKb=p.chunkSize||Oa,r.chunkAttempts=p.chunkAttempts||Ua,e.onStatus("uploading");var m=er();try{await ui({uploadUrl:p.uploadUrl,file:e.file,chunkSize:p.chunkSize,chunkAttempts:p.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=(r.directUploadMs||0)+rr(m),e.onStatus("processing");var v=er();await tr("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:o})},3e4),r.completeMs=rr(v);var s=er(),c=await Fa(o,e.signal,e.onStatus);return r.processingPollMs=rr(s),cr(e.productId,e.file),e.onProgress(100),await vr(o,r,"ready"),Object.assign({token:o},c)}catch(g){throw r.directUploadMs=(r.directUploadMs||0)+rr(m),e.signal&&e.signal.aborted?(await vr(o,r,"aborted"),g):(await vr(o,r,"failed"),g)}}}async function Zr(e,r,t){var n=r&&t?Ya(r,t):null;e&&r&&t&&oi(e,r,t,n&&n.expiresAt),r&&t&&cr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(Jr(),await Xr())}function Ka(){return"Video y\xFCklenemedi"}function Xa(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function mi(e){return"Video y\xFCkleniyor"}function fi(e){return!0}function Ja(e,r){r=r||{};var t=!1,n=null,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent=ve("formStepMediaTitle"),i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-subtitle",p.textContent=ve("formStepMediaSubtitle"),i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-media-card";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",u.setAttribute("aria-label","Foto\u011Fraf ekle"),u.innerHTML=ue(Ar)+"<span>Foto\u011Fraf Ekle</span>";var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",m.setAttribute("aria-label","Video ekle"),m.innerHTML=ue(Pr)+"<span>Video Ekle</span>",l.appendChild(u),l.appendChild(m);var v=document.createElement("div");v.className="renuvex-pr-fwizard-media-content",l.appendChild(v),i.appendChild(l);var s=document.createElement("input");s.type="file",s.accept="video/mp4,video/quicktime,.mp4,.mov",s.style.display="none",i.appendChild(s);function c(){var f=e.get();return(f.images||[]).length>0||(f.pendingImages||[]).length>0}function g(){var f=e.get();return(f.images||[]).length+(f.pendingImages||[]).length}function d(){return e.get().videoUpload||null}function x(){if(!a){v.innerHTML="";return}a.retry.onclick=null,v.innerHTML="",a=null}function h(){n&&(n.destroy&&n.destroy(),n=null)}function b(f){h(),v.innerHTML="";var P=Xa(f),_=document.createElement("div");_.className=P==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":P==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var S=null,M=null,R=null,I=null,L=document.createElement("button");if(L.type="button",L.className="renuvex-pr-fwizard-video-retry",L.textContent="Tekrar dene",P==="ready"){var F=f.posterUrl||f.localUrl||"";F&&F!==f.localUrl?(S=document.createElement("img"),S.alt="",S.src=F):(S=document.createElement("video"),S.muted=!0,S.playsInline=!0,S.preload="metadata",S.src=f.localUrl||""),S.className="renuvex-pr-fwizard-video-preview",_.appendChild(S)}else P==="busy"?(I=document.createElement("div"),I.className="renuvex-pr-fwizard-video-uploading-status",I.setAttribute("role","status"),I.setAttribute("aria-live","polite"),_.appendChild(I)):(M=document.createElement("div"),M.className="renuvex-pr-fwizard-video-details renuvex-pr-fwizard-video-details--failed",I=document.createElement("div"),I.className="renuvex-pr-fwizard-video-status renuvex-pr-fwizard-video-status--error",I.setAttribute("role","alert"),I.setAttribute("aria-live","assertive"),M.appendChild(I),_.appendChild(M));if(P==="ready"){let Y=function(U){U&&(U.preventDefault(),U.stopPropagation()),k()};var H=Y,j=document.createElement("button");j.type="button",j.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",j.setAttribute("aria-label","Videoyu kald\u0131r");var q=Z(ye);q&&j.appendChild(q),j.addEventListener("pointerdown",Y),j.addEventListener("click",Y),_.appendChild(j)}v.appendChild(_),a={mode:P,card:_,preview:S,previewUrl:P==="ready"&&(f.posterUrl||f.localUrl)||"",details:M,name:R,status:I,retry:L}}function w(){if(!t){var f=d();if(!f){x();return}var P=Xa(f),_=P==="ready"&&(f.posterUrl||f.localUrl)||"";if((!a||a.mode!==P||a.previewUrl!==_)&&b(f),a.name&&(a.name.textContent=f.file?f.file.name:"Video"),a.status&&P==="busy"){var S=mi(f),M=fi(f)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+S+"</span>":"<span>"+S+"</span>";a.status.innerHTML!==M&&(a.status.innerHTML=M)}a.status&&P==="failed"&&(a.status.className="renuvex-pr-fwizard-video-status renuvex-pr-fwizard-video-status--error",a.status.setAttribute("role","alert"),a.status.textContent=Ka(f));var R=P==="failed"&&!!(f.error&&f.file&&f.retryable!==!1);a.retry.onclick=R?function(){z(f.file,f.localUrl,f.durationMs)}:null,R&&a.details&&!a.retry.isConnected?a.details.appendChild(a.retry):!R&&a.retry.isConnected&&a.retry.remove()}}function A(){var f=c(),P=g()>=Gr,_=!!d(),S=f||_;u.disabled=_||P,m.disabled=f||_,l.classList.toggle("renuvex-pr-fwizard-media-card--has-media",S),l.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",f),l.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",_),u.classList.toggle("renuvex-pr-fwizard-media-action--active",f),m.classList.toggle("renuvex-pr-fwizard-media-action--active",_)}function y(f){var P=d();if(P){var _=Object.keys(f),S=_.some(function(M){return P[M]!==f[M]});S&&e.set({videoUpload:Object.assign({},P,f)})}}async function z(f,P,_){var S=d(),M=!!(P&&S&&S.file===f),R=M?Math.max(0,Math.min(95,Number(S.progress)||0)):0,I=M?(Number(S.retryClicks)||0)+1:0,L=ja(f);if(!L.ok){r.showToast&&r.showToast(L.message,"error");return}var F=P||URL.createObjectURL(f),j=Number.isFinite(_)?_:null,q=new AbortController;e.set({videoUpload:{file:f,localUrl:F,token:M&&S.token||null,status:"uploading",progress:R,durationMs:j,error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:I,controller:q}}),!M&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var H=_!==void 0?Number.isFinite(_)?_/1e3:null:await Wa(f),Y=qa(H);if(!Y.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:Y.message});var U=await Ga({file:f,productId:e.get().productId,signal:q.signal,minProgress:R,retryClicks:I,onToken:function(V){y({token:V})},onProgress:function(V){y({progress:V})},onStatus:function(V){y({status:V})},onSessionReset:function(){y({token:null,progress:0})}});if(U.previewOnly&&U.posterUrl&&U.posterUrl!==F)try{URL.revokeObjectURL(U.posterUrl)}catch(V){}y({token:U.token,status:"ready",progress:100,posterUrl:U.previewOnly?F:U.posterUrl,durationMs:U.durationMs||(H===null?null:Math.round(H*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),M&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(V){if(q.signal.aborted)return;var $=Va(V);if(V&&V.code==="invalid_video_duration"&&($={code:"invalid_video_duration",message:V.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),y({status:"failed",error:$.message,errorCode:$.code,retryable:$.retryable,retryAfterSec:$.retryAfterSec,controller:null}),r.showToast){var X=$.code==="invalid_video_duration"?$.message:Ka();r.showToast(X,"error")}}}function k(){var f=d();f&&(f.controller&&f.controller.abort(),Zr(f.token,e.get().productId,f.file),r.revokeBlobUrl&&r.revokeBlobUrl(f.localUrl),e.set({videoUpload:null}))}function C(f){if(n){f&&n.openPicker&&n.openPicker();return}a=null,v.innerHTML="",n=Kr(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),v.appendChild(n.el),f&&n.openPicker&&n.openPicker()}u.onclick=function(){u.disabled||C(!0)},m.onclick=function(){m.disabled||(h(),v.innerHTML="",s.click())},s.onchange=function(){var f=s.files&&s.files[0];s.value="",f&&z(f,null,void 0)};var T=!!d(),E=e.onChange(function(){A();var f=!!d();(f||T)&&w(),T=f});return A(),c()&&C(!1),d()&&w(),{el:i,destroy:function(){t=!0,u.onclick=null,m.onclick=null,s.onchange=null,n&&n.destroy&&n.destroy(),E&&E()}}}var yt=2e3,xi=60;function Za(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=ve("formStepContentTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=xi,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var p=document.createElement("textarea");p.className="renuvex-pr-fwizard-textarea",p.placeholder="Deneyiminizi anlat\u0131n\u2026",p.maxLength=yt,p.rows=6,p.setAttribute("aria-label","Yorum"),p.value=e.get().comment||"",i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-char-counter",l.setAttribute("aria-live","polite"),i.appendChild(l);function u(){var v=p.value.length;l.textContent=v+"/"+yt,l.classList.toggle("renuvex-pr-fwizard-char-counter--max",v>=yt)}function m(){return Qe(3,e.get())}return p.addEventListener("input",function(){e.set({comment:p.value}),u(),t(m())}),n.appendChild(i),u(),setTimeout(function(){t(m())},0),{el:n,destroy:function(){}}}var gi=40;function $a(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ve("formStepAuthorTitle"),a.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var p=document.createElement("div");p.className="renuvex-pr-fwizard-field";var l=document.createElement("label");l.className="renuvex-pr-fwizard-label",l.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=gi,u.setAttribute("aria-required","true"),u.value=e.get().author||"",p.appendChild(l),p.appendChild(u),o.appendChild(p);var m=document.createElement("div");m.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.textContent="E-posta (opsiyonel)";var s=document.createElement("input");s.type="email",s.className="renuvex-pr-fwizard-input",s.setAttribute("autocomplete","email"),s.value=e.get().email||"",m.appendChild(v),m.appendChild(s),o.appendChild(m);var c=document.createElement("div");c.className="renuvex-pr-fwizard-notice",c.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(c);var g=document.createElement("div");g.className="renuvex-pr-fwizard-msg",g.setAttribute("role","alert"),g.setAttribute("aria-live","assertive"),o.appendChild(g);var d=document.createElement("button");d.type="button",d.className="renuvex-pr-fwizard-submit-btn",d.textContent="G\xF6nder",o.appendChild(d),a.appendChild(o);function x(){return Qe(4,e.get())}function h(){var y=!x(),z=(e.get().pendingImages||[]).length,k=z>0,C=e.get().videoUpload,T=!!(C&&C.status==="failed"),E=!!(C&&C.status!=="ready"&&C.status!=="failed");k||E||T?(d.disabled=!0,d.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),d.textContent=T?"Video Y\xFCklenemedi":E?"Video Haz\u0131rlan\u0131yor...":"Foto\u011Fraflar Y\xFCkleniyor..."):(d.disabled=y,d.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",y),d.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),h(),t(x())}),s.addEventListener("input",function(){e.set({email:s.value})}),h(),setTimeout(function(){t(x())},0);function b(){g.textContent=""}function w(y){b();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=y||"",g.appendChild(z)}d.onclick=async function(){if(!d.disabled){var y=e.get(),z=(y.author||"").trim(),k=(y.comment||"").trim();if(s.value.trim()&&!s.checkValidity()){s.reportValidity();return}if(!z){w("Gerekli alan");return}if(!y.rating){w("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}d.disabled=!0,d.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var C=d.textContent;if(d.textContent="G\xF6nderiliyor\u2026",b(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){y.videoUpload&&y.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n()},600);return}try{var T=$t(window.location.href),E=y.productName||null,f=await ke(be+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:pe,productId:y.productId||null,slug:T||null,productName:E,author:z,title:(y.title||"").trim()||null,comment:k||null,rating:y.rating,images:y.videoUpload?[]:y.images||[],videoToken:y.videoUpload&&y.videoUpload.status==="ready"?y.videoUpload.token:null})},15e3);if(f.ok)y.videoUpload&&y.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n();else{var P=await f.json().catch(function(){return{}});throw new Error(P.error||"Yorum kaydedilemedi.")}}catch(M){var _=M&&(M.name==="AbortError"||/signal/i.test(M.message||"")),S=_?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":M.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(S,"error"):w(S),d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),d.textContent=C}}};var A=e.onChange(h);return{el:a,destroy:function(){d.onclick=null,A&&A()}}}function hi(e,r,t){if(t=t||{},e===1)return La(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return Ja(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return Kr(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Za(r,{onValidityChange:t.onValidityChange});if(e===4)return $a(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Qa(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function en(e){e=e||{},Jr();var r=_a({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:N&&N.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},n={},a={};function i(E){if(!(!E||typeof E!="string"||!E.startsWith("blob:")||a[E])){a[E]=!0;try{URL.revokeObjectURL(E)}catch(f){}}}function o(){Object.keys(n).forEach(function(f){i(f)}),Object.keys(t).forEach(function(f){i(t[f])});var E=r.get();(E.pendingImages||[]).forEach(function(f){i(f&&f.url)}),(E.images||[]).forEach(function(f){i(f)}),E.videoUpload&&i(E.videoUpload.localUrl)}function p(){var E=r.get(),f=E.videoUpload;!f||E.videoSubmitted||(f.controller&&f.controller.abort(),Zr(f.token,E.productId,f.file))}var l=Ma({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",m),jr(u),p(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=Yr(),m=function(E){l&&l.close&&l.close()};window.addEventListener("popstate",m);var v=document.createElement("div");v.className="renuvex-pr-fwizard-step-wrap";var s=Na({skippableSteps:[2],nextableSteps:[3],onBack:function(){d==="idle"&&r.goBack()},onSkip:function(){d==="idle"&&r.goNext()},onNext:function(){d==="idle"&&r.goNext()}}),c=document.createElement("div");c.className="renuvex-pr-fwizard-layout",c.appendChild(v),c.appendChild(s.el);var g=null,d="idle",x=null,h=!0,b=null;function w(E,f){v.innerHTML="";var P=hi(E,r,{canNavigate:function(){return d==="idle"},blobMap:t,urlToFinger:n,revokeBlobUrl:i,onValidityChange:function(M){s.setNextDisabled(!M)},onSuccess:y,showToast:l.showToast});if(g=P,s.update(E,r.get()),f){d="entering",P.el.classList.add("renuvex-pr-fwizard-step--enter");var _=null,S=function(){_&&clearTimeout(_),P.el.removeEventListener("animationend",S),P.el.classList.remove("renuvex-pr-fwizard-step--enter"),d="idle",x!==null&&z()};P.el.addEventListener("animationend",S),_=setTimeout(S,700)}else d="idle";v.appendChild(P.el),l.setStepAttr&&l.setStepAttr(E),E===3&&s.setNextDisabled(!0)}var A=!1;function y(){if(!A){if(A=!0,!g){v.innerHTML="";var E=Qa();E.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(E),l.setStepAttr("thanks"),s.setThanksState(l.close);return}var f=g;d="exiting",f.el.classList.add("renuvex-pr-fwizard-step--exit");var P=function(){if(b&&clearTimeout(b),f.el.removeEventListener("animationend",P),f.destroy)try{f.destroy()}catch(S){}g===f&&(g=null),v.innerHTML="";var _=Qa();_.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(_),l.setStepAttr("thanks"),s.setThanksState(l.close),d="idle"};f.el.addEventListener("animationend",P),b=setTimeout(P,300)}}function z(){var E=r.get().currentStep;if(d!=="idle"){x=E;return}if(!g){var f=!h;h=!1,w(E,f);return}var P=g;d="exiting",P.el.classList.add("renuvex-pr-fwizard-step--exit");var _=function(){if(b&&clearTimeout(b),P.el.removeEventListener("animationend",_),P.destroy)try{P.destroy()}catch(M){}if(g===P){v.innerHTML="",g=null;var S=x!==null?x:r.get().currentStep;x=null,w(S,!0),d="idle"}};P.el.addEventListener("animationend",_),b=setTimeout(_,350)}z();var k=r.get().currentStep,C=r.onChange(function(E){E.currentStep!==k?(k=E.currentStep,z()):s.update(E.currentStep,E)}),T=l.close;return l.close=function(){C&&C(),typeof b!="undefined"&&b&&clearTimeout(b),T()},l.open(c),{close:l.close}}var bi=4e3;async function rn(){var e=await ke(be+"/api/public/upload/video/capability?storeId="+encodeURIComponent(pe),{method:"GET",cache:"no-store"},bi);if(!e.ok)throw new Error("video_capability_unavailable");var r=await e.json().catch(function(){return{}}),t=r&&r.data;if(!t||typeof t.enabled!="boolean")throw new Error("video_capability_invalid");return{enabled:t.enabled===!0,reason:typeof t.reason=="string"?t.reason:null}}var $r=null;function yi(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function wi(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:N&&N.videoReviewsEnabled===!0,reason:null};else try{t=await rn()}catch(n){t={enabled:!1,reason:"capability_unavailable"}}en({productId:G||"",productName:Ie||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function re(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=yi(r);return $r||($r=wi(r,Me()).finally(function(){$r=null})),$r.finally(t)}var tn=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var zi={id:"classic",name:"Klasik (A\xE7\u0131k)"},ki=tn;function Si(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,s=e.onSortChange;Ne(a);var c=document.createElement("div");c.className="renuvex-pr-summary";var g=(o[3]||0)+(o[4]||0),d=i>0?Math.round(g/i*100):0,x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+de("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",c.appendChild(x);var h=document.createElement("div");if(h.className="renuvex-pr-summary-block renuvex-pr-summary-count",h.textContent=i.toLocaleString("tr-TR")+" "+B(n.countLabel,"Yorum"),c.appendChild(h),n.showRecommendation!==!1&&d>0){var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",b.innerHTML='<span class="renuvex-pr-recommend-pct">%'+d+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",c.appendChild(b)}return c.appendChild(Ze({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:v})),c.appendChild(oe({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:re,onSortChange:s})),c}var zt={};Pe(zt,{css:()=>Ei,meta:()=>Ci,render:()=>Mi});var an=`
...
`;var Ci={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Ei=an,Ti="__unknown_product__",mr=Object.create(null);function Ai(e){return e?String(e):Ti}var Ve=null,fr=null;function Pi(){!Ve||!fr||(Ve.removeEventListener?Ve.removeEventListener("change",fr):Ve.removeListener&&Ve.removeListener(fr),Ve=null,fr=null)}function Mi(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,s=e.onSortChange,c=Ai(t),g=document.createElement("div");g.className="renuvex-pr-summary renuvex-pr-summary-compact";var d=document.createElement("div");d.className="renuvex-pr-compact-header";var x=document.createElement("div");x.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Le(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+ue(Jt)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),w=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+B(n.countLabel,"Yorum")),b&&w){var A=document.createElement("span");A.className="renuvex-pr-compact-trigger-count",h.insertBefore(A,b),A.appendChild(b),A.appendChild(w)}x.appendChild(h),d.appendChild(x);var y=oe({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:re,onSortChange:s}),z=y.querySelector(".renuvex-pr-filter-wrap"),k=y.querySelector(".renuvex-pr-write-btn"),C=document.createElement("div");C.className="renuvex-pr-compact-actions-slot",k&&C.appendChild(k),z&&C.appendChild(z),d.appendChild(C),g.appendChild(d);var T=document.createElement("div");T.className="renuvex-pr-compact-panel",T.setAttribute("role","dialog"),T.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),T.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="renuvex-pr-compact-panel-inner";var f=document.createElement("div");f.className="renuvex-pr-compact-avg",f.innerHTML='<span class="renuvex-pr-icon">'+de("full")+"</span><span>"+p+"</span>",E.appendChild(f),E.appendChild(Ze({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(D){_()&&T.classList.contains("renuvex-pr-open")&&(mr[c]=!0),v(D)}})),T.appendChild(E);var P=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function _(){return!!(P&&P.matches)}function S(D){D?T.classList.add("renuvex-pr-open"):T.classList.remove("renuvex-pr-open"),T.setAttribute("aria-hidden",D?"false":"true"),h.setAttribute("aria-expanded",D?"true":"false")}function M(D){var W=D?g:x;if(T.parentNode!==W){var Q=!!T.parentNode;T.classList.contains("renuvex-pr-open")&&S(!1),Q&&(mr[c]=!1),W.appendChild(T)}}M(P?P.matches:!1);var R=oe({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:re,onSortChange:s}),I=R.querySelector(".renuvex-pr-filter-wrap"),L=R.querySelector(".renuvex-pr-write-btn"),F=document.createElement("div");F.className="renuvex-pr-compact-write-row",L&&F.appendChild(L),I&&F.appendChild(I),g.appendChild(F);function j(){var D=T.classList.contains("renuvex-pr-open");return S(!1),_()&&(mr[c]=!1),D}function q(){H&&H.notifyOpening(),S(!0),_()&&(mr[c]=!0)}h.onclick=function(){T.classList.contains("renuvex-pr-open")?j():q()};var H=null;function Y(D){H&&(H.unregister(),H=null),D||(H=qr({trigger:x,element:T,close:j}))}if(Y(P?P.matches:!1),Pi(),P){var U=function(D){M(D.matches),Y(D.matches)};P.addEventListener?P.addEventListener("change",U):P.addListener&&P.addListener(U),Ve=P,fr=U}if(_()&&mr[c]&&S(!0),n.showRecommendation!==!1){var $=(o[3]||0)+(o[4]||0),X=i>0?Math.round($/i*100):0;if(X>0){var V=document.createElement("div");V.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",V.style.marginTop="8px",V.innerHTML='<span class="renuvex-pr-recommend-pct">%'+X+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(V)}}return g}var kt={};Pe(kt,{css:()=>Ni,meta:()=>_i,render:()=>Li});var nn=`
...
`;var _i={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ni=nn;function Li(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,p=e.currentRatingFilter,l=e.currentOrderBy,u=e.currentHasImages,m=e.onFilterChange,v=e.onSortChange;Ne(n);var s=document.createElement("div");s.className="renuvex-pr-summary renuvex-pr-summary-split";var c=document.createElement("div");c.className="renuvex-pr-split-col renuvex-pr-split-left";var g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",g.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+de("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",c.appendChild(g);var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",d.textContent=a.toLocaleString("tr-TR")+" "+B(t.countLabel,"Yorum"),c.appendChild(d),s.appendChild(c);var x=document.createElement("div");x.className="renuvex-pr-split-col renuvex-pr-split-mid",x.appendChild(Ze({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:p,onFilterChange:m})),s.appendChild(x);var h=oe({widget:r,currentOrderBy:l,currentHasImages:u,onWriteClick:re,onSortChange:v}),b=h.querySelector(".renuvex-pr-filter-wrap"),w=h.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-split-col renuvex-pr-split-right",w&&A.appendChild(w),b&&A.appendChild(b),s.appendChild(A);var y=(i[3]||0)+(i[4]||0),z=a>0?Math.round(y/a*100):0,k=document.createElement("div");k.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",k.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var C=t.showRecommendation===!1||z===0;return C&&k.classList.add("renuvex-pr-split-rec-hidden"),c.appendChild(k),s}var St={};Pe(St,{css:()=>Ii,meta:()=>Ri,render:()=>Bi});var on=`
...
`;var Hi={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},Vi=un;function Di(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var n=document.createElement("div");n.className="renuvex-pr-review-top";var a=document.createElement("div");a.className="renuvex-pr-review-top-left";var i=document.createElement("span");i.className="renuvex-pr-review-stars",i.innerHTML=we(e.rating,N),a.appendChild(i);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=ze(e.createdAt),n.appendChild(a),n.appendChild(o),t.appendChild(n),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-title",p.textContent=e.title,t.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-author",l.textContent=e.author||"",t.appendChild(l);var u=(e.comment||"").trim();u&&t.appendChild(ar(u,"renuvex-pr-body").fragment);var m=Se(e);if(m.length){var v=document.createElement("div");v.className="renuvex-pr-gallery",m.forEach(function(c){var g=Re(c,{className:"renuvex-pr-img",sourceWidth:ie,width:ie,height:ie,onOpen:function(){ge(e,c.url,r)}});g&&v.appendChild(g)}),t.appendChild(v)}var s=nr(e.merchantReply);return s&&t.appendChild(s),t}var Tt={};Pe(Tt,{css:()=>ji,meta:()=>Yi,render:()=>Wi});var sn=`
  .renuvex-pr-review-list{
    display:grid;
