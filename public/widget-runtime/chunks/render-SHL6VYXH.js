...
`);function ya(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function de(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function wa(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function za(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",o=wa()&&!n;if(a>0){var l=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",l+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ka(e){var r=document.body.style,t=document.documentElement.style;de(t,"overflow",e.rootOverflow,e.rootOverflowPriority),de(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),de(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),de(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),de(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),de(r,"position",e.bodyPosition,e.bodyPositionPriority),de(r,"top",e.bodyTop,e.bodyTopPriority),de(r,"left",e.bodyLeft,e.bodyLeftPriority),de(r,"right",e.bodyRight,e.bodyRightPriority),de(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var $e=0,Oe=null;function gr(){return $e+=1,$e>1||(Oe=ya(),za(Oe)),Oe}function hr(){if($e!==0&&($e-=1,!($e>0))){var e=Oe;Oe=null,e&&ka(e)}}function Sa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function br(){var e=Sa();return!e||e===document.body||e===document.documentElement?null:e}function $(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Ca(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Mr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Ca)}function Ea(e,r){var t=e,a=Mr(e);!a.length&&r&&(t=r,a=Mr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;$(n)}function yr(e,r,t){if(e.key==="Tab"){var a=Mr(r);if(!a.length){e.preventDefault(),Ea(r);return}var n=a[0],o=a[a.length-1],l=Et(t);if(!r.contains(l)){e.preventDefault(),$(n);return}if(a.indexOf(l)===-1){e.preventDefault(),$(e.shiftKey?o:n);return}e.shiftKey&&l===n?(e.preventDefault(),$(o)):!e.shiftKey&&l===o&&(e.preventDefault(),$(n))}}var Bt="renuvexPrOverlay";function wr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Bt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Ta(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Bt]===e.id)}function zr(e){if(Ta(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function He(e){return we(e)}function _t(e,r,t,a,n,o){hr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&dr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),o&&$(n)}function Aa(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=xe(e.rating,I);var o=document.createElement("span");o.className="renuvex-pr-modal-date",o.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-modal-title",l.textContent=e.title||"",l.style.display=e.title?"":"none",t.appendChild(l);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=I&&I.merchantReplyLabel||"Ma\u011Faza Sahibi";var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",u.appendChild(f),u.appendChild(s),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Mt(e,r,t){var a=t||I,n=e.querySelector(".renuvex-pr-modal-scroll-content"),o=n.querySelector(".renuvex-pr-modal-stars");o.innerHTML=xe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=fe(r.createdAt);var l=n.querySelector(".renuvex-pr-modal-title");l.textContent=r.title||"",l.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Or(e,r,t,a,n,o,l,i,d){var u=He(e),f=Math.max(0,Math.min(t||0,u.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var p=document.createElement("img"),c=l==="next"?"renuvex-pr-modal-img-enter-right":l==="prev"?"renuvex-pr-modal-img-enter-left":"";if(p.className="renuvex-pr-modal-main-img"+(c?" "+c:""),p.src=Br(u[f]||""),p.decoding="async",p.width=Ir,p.height=Math.round(Ir*4/3),p.alt="Yorum foto\u011Fraf\u0131",!c){p.classList.add("renuvex-pr-modal-img-loading");var y=function(){p.classList.remove("renuvex-pr-modal-img-loading")};p.complete&&p.naturalWidth>0?y():(p.addEventListener("load",y,{once:!0}),p.addEventListener("error",y,{once:!0}))}wt(p,function(C){if(C.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var P=document.createElement("div");P.className="renuvex-pr-modal-img-error",P.setAttribute("role","status"),P.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(P,C)}}),s.appendChild(p);var v=document.createElement("button");v.className="renuvex-pr-modal-close-mobile";var b=Z(Ce);b&&v.appendChild(b),v.setAttribute("aria-label","Kapat"),v.onclick=function(C){C.stopPropagation(),o()},s.appendChild(v);var m=0;if(s.addEventListener("touchstart",function(C){m=C.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(C){var P=m-C.changedTouches[0].clientX;if(!(Math.abs(P)<50)){if(P>0){if(k)ge(e,r,f+1,a,n,o,!0,"next",i,d);else if(z){var R=a[r+1];ge(R,r+1,0,a,n,o,!1,"next",i,d)}}else if(g)ge(e,r,f-1,a,n,o,!0,"prev",i,d);else if(x){var O=a[r-1],W=He(O);ge(O,r-1,W.length-1,a,n,o,!1,"prev",i,d)}}},{passive:!0}),u.length>1){var h=document.createElement("div");h.className="renuvex-pr-modal-thumbs",u.forEach(function(C,P){var R=document.createElement("img"),O=pe(C,mr);R.src=O.src,R.srcset=O.srcset,R.loading="lazy",R.decoding="async",R.width=mr,R.height=mr,R.className="renuvex-pr-modal-thumb"+(P===f?" renuvex-pr-modal-thumb-active":""),R.alt="K\xFC\xE7\xFCk resim "+(P+1),ue(R),R.tabIndex=0,R.setAttribute("role","button"),R.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(P+1)+" se\xE7"),P===f&&R.setAttribute("aria-current","true"),(function(W){function K(){ge(e,r,W,a,n,o,!0,null,i,d)}R.onclick=K,R.onkeydown=function(Y){(Y.key==="Enter"||Y.key===" ")&&(Y.preventDefault(),K())}})(P),h.appendChild(R)}),s.appendChild(h)}var g=f>0,k=f<u.length-1,x=r>0,z=r<a.length-1,A=g||x,E=k||z;if(A){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var S=Z(Ie);S&&w.appendChild(S),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(C){if(C.stopPropagation(),g)ge(e,r,f-1,a,n,o,!0,"prev",i,d);else if(x){var P=a[r-1],R=He(P);ge(P,r-1,R.length-1,a,n,o,!1,"prev",i,d)}},s.appendChild(w)}if(E){var L=document.createElement("button");L.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var T=Z(sr);T&&L.appendChild(T),L.setAttribute("aria-label","Sonraki"),L.onclick=function(C){if(C.stopPropagation(),k)ge(e,r,f+1,a,n,o,!0,"next",i,d);else if(z){var P=a[r+1];ge(P,r+1,0,a,n,o,!1,"next",i,d)}},s.appendChild(L)}return s}function Ft(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=He(a);n[0]&&(new Image().src=Br(n[0]))}})}function Fr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function La(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function o(){Fr(t),Fr(a),Fr(n)}o(),t&&$(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function ge(e,r,t,a,n,o,l,i,d,u){if(u&&(u.currentReview=e),l){var f=Or(e,r,t,a,n,o,i,d,u);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=Or(e,r,t,a,n,o,i,d,u),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),s&&Mt(s,e,u&&u.currentSettings),La(d,n)}Ft(r,a)}function se(e,r,t){var a=He(e);if(!a.length)return;var n=(t||[]).filter(function(E){return He(E).length>0}),o=n.findIndex(function(E){return E===e||E.id===e.id});o===-1&&(n.unshift(e),o=0);var l=a.indexOf(r);l<0&&(l=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var u=!1,f=null,s=br(),p=Pe(),c=gr(),y=wr(),v={currentReview:e,currentSettings:I},b=null;function m(E){var w=E&&E.detail&&E.detail.settings;if(!(w&&w===b)){b=w||null,v.currentSettings=w||I;var S=d.querySelector(".renuvex-pr-modal-right");!S||!v.currentReview||Mt(S,v.currentReview,v.currentSettings)}}function h(){u||(u=!0,window.removeEventListener(Ee,m),_t(f&&f.host,g,h,c,s,p))}function g(E){if(E.key==="Escape"){k();return}yr(E,i,f&&f.root)}function k(){u||(u=!0,window.removeEventListener(Ee,m),_t(f&&f.host,g,h,c,s,p),zr(y))}document.addEventListener("keydown",g),window.addEventListener("popstate",h),window.addEventListener(Ee,m),i.onclick=function(){k()},d.onclick=function(E){E.stopPropagation()},d.appendChild(Or(e,o,l,n,d,k,null,i,v)),d.appendChild(Aa(e)),Ft(o,n);var x=document.createElement("div");x.className="renuvex-pr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var A=Z(Ce);A&&z.appendChild(A),z.setAttribute("aria-label","Kapat"),z.onclick=function(E){E.stopPropagation(),k()},x.appendChild(z),i.appendChild(x),f=xr(),Fe(f.root,Me+Le+fr),f.root.appendChild(i),Se(f.root),$(x)}function ze(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Ur={};be(Ur,{css:()=>Ha,meta:()=>Oa,render:()=>Ya});function Ye(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,o=e.onFilterChange;ye(a);var l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,u=t>0?Math.round(d/t*100):0,f=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":"")+(n&&!f?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",f?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" yorum, "+(f?"filtreyi kald\u0131r":"filtrele"));for(var p="",c=1;c<=5;c++){var y=c<=i;p+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+J(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+p+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(v){function b(){o(v)}s.onclick=b,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),b())}})(i),l.appendChild(s)}return l}var Yt="data-renuvex-pr-dismiss-gesture",Te=[],Ot=!1,kr=!1,Qe=[],De=null;function Ht(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Hr(){for(var e=Te.length-1;e>=0;e--){var r=Te[e].element;r&&r.isConnected===!1&&Te.splice(e,1)}return Te}function Pa(e){!e||typeof e.setAttribute!="function"||(Qe.indexOf(e)===-1&&Qe.push(e),e.setAttribute(Yt,""))}function Dt(){for(var e=0;e<Qe.length;e++){var r=Qe[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Yt)}Qe=[],De&&typeof clearTimeout=="function"&&clearTimeout(De),De=null}function Na(e){if(kr){kr=!1,Dt(),e.preventDefault(),e.stopPropagation();return}for(var r=Hr(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Ht(e,n.trigger)||Ht(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Ra(e){if(e.key==="Escape")for(var r=Hr(),t=r.length-1;t>=0;t--)r[t].close()}function jt(){Ot||typeof document=="undefined"||(document.addEventListener("click",Na,!0),document.addEventListener("keydown",Ra),Ot=!0)}function Ia(e){jt(),kr=!0,Pa(e),De&&typeof clearTimeout=="function"&&clearTimeout(De),typeof setTimeout=="function"&&(De=setTimeout(function(){kr=!1,Dt()},700))}function Yr(e){Ia(e)}function Sr(e){jt();var r={trigger:e.trigger,element:e.element,close:e.close};return Te.push(r),{unregister:function(){var t=Te.indexOf(r);t!==-1&&Te.splice(t,1)},notifyOpening:function(){for(var t=Hr(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function G(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,o=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=I&&I.writeButtonText||"Yorum Yap",i.onclick=n,l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var f=I&&I.filterIcon||"lines";u.innerHTML=me(mt(f));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var p=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],c=!1;function y(){return r&&r.parentNode||r||null}function v(g,k){if(!(k===!0||!g)){if(g.type==="touchstart"){Yr(y());return}if(g.type==="pointerdown"){var x=g.pointerType||"";x&&x!=="mouse"&&Yr(y());return}}}function b(g){var k=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var x=g&&(g.restoreFocus===!0||g.restoreFocus==="auto"&&Pe());if(k&&x)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(A){}}return k}function m(){h.notifyOpening(),s.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var g=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");g&&requestAnimationFrame(function(){try{g.focus({preventScroll:!0})}catch(k){try{g.focus()}catch(x){}}})}p.forEach(function(g){var k=g[2],x=k?a:!a&&(t||"newest")===g[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(x?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=g[1];var A=!1;function E(w,S){w&&(w.preventDefault(),w.stopPropagation()),!A&&(A=!0,c=!0,v(w,S),b({restoreFocus:S}),o(g[0],k),setTimeout(function(){A=!1,c=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&E(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){E(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&E(w,!0)}),z.onclick=function(w){E(w,!1)},s.appendChild(z)}),u.onclick=function(){s.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(g){g.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(g.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(g){if(s.classList.contains("renuvex-pr-open")&&!c){var k=g.relatedTarget;k&&d.contains(k)||b()}});var h=Sr({trigger:d,element:s,close:b});return d.appendChild(u),d.appendChild(s),l.appendChild(d),l}var Ut=`
...
`;function Vt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content",n.appendChild(o);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var i=Z(Ce);i&&l.appendChild(i),n.appendChild(l);var d=!1,u=null,f=null,s=!1;function p(){$(a)}function c(x){yr(x,a,u&&u.root)}function y(){if(!d){if(d=!0,document.removeEventListener("keydown",v),a.removeEventListener("click",b),l.removeEventListener("click",y),s)$(f);else{var x=u&&u.root?u.root.activeElement:null;if(x&&typeof x.blur=="function")try{x.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(dr(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):a.parentNode&&a.parentNode.removeChild(a),hr();try{r()}catch(z){}},200)}}function v(x){if(x.key==="Escape"){y();return}c(x)}function b(x){x.target===a&&t&&y()}document.addEventListener("keydown",v),a.addEventListener("click",b),l.addEventListener("click",y);function m(x){f=br(),s=Pe(),x&&o.appendChild(x),u=xr(),Fe(u.root,Me+Le+Ut),u.root.appendChild(a),Se(u.root),gr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),p()})}var h=null,g=null;function k(x,z){if(z=z||"error",h){try{h.remove()}catch(A){}h=null}g&&(clearTimeout(g),g=null),h=document.createElement("div"),h.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,h.textContent=x,n.appendChild(h),g=setTimeout(function(){h&&(h.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(h){try{h.remove()}catch(A){}h=null}},300))},4e3)}return{open:m,close:y,content:o,setAllowOutsideClose:function(x){t=!!x},setStepAttr:function(x){n.setAttribute("data-step",String(x))},showToast:k}}var Dr=4;function je(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Wt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(o){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Dr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(o){return o!==n})}}}}function qt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},o=e.onNext||function(){},l=document.createElement("div");l.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=me(Ie)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var u=[],f=0;f<Dr;f++){var s=document.createElement("span");s.className="renuvex-pr-fwizard-progress-seg",d.appendChild(s),u.push(s)}l.appendChild(d);var p=document.createElement("button");p.type="button";var c=null;function y(b){c&&p.removeEventListener("click",c),c=b,b&&p.addEventListener("click",b)}l.appendChild(p);function v(b,m){var h=r.indexOf(b)!==-1,g=t.indexOf(b)!==-1,k=m&&(m.images&&m.images.length>0||m.pendingImages&&m.pendingImages.length>0);if(h)b===2&&k?(p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",y(function(){o()})):(p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.setAttribute("aria-label","Atla"),p.innerHTML="<span>Atla</span>",y(function(){n()})),p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),p.style.visibility="",p.tabIndex=0;else if(g){p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Sonraki"),p.innerHTML="Sonraki",p.style.visibility="",p.tabIndex=0;var x=je(b,m);p.disabled=!x,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!x),y(function(){p.disabled||o()})}else p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",p.innerHTML="",p.style.visibility="hidden",p.tabIndex=-1,p.disabled=!0,y(null)}return{el:l,update:function(b,m){u.forEach(function(g,k){k+1<=b?g.classList.add("renuvex-pr-fwizard-progress-seg-active"):g.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var h=b<=1;i.style.visibility=h?"hidden":"",i.style.pointerEvents=h?"none":"",i.tabIndex=h?-1:0,v(b,m)},setNextDisabled:function(b){p.classList.contains("renuvex-pr-fwizard-cta-btn")&&(p.disabled=!!b,p.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!b))},setThanksState:function(b){i.style.visibility="hidden",d.style.visibility="hidden",p.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",p.setAttribute("aria-label","Devam Et"),p.innerHTML="Devam Et",p.style.visibility="",p.disabled=!1,p.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),y(b)}}}function Gt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title",o.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-stars",l.setAttribute("role","radiogroup"),l.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=Je(I||{});ye(i);var d=[];function u(b){d.forEach(function(m,h){var g=h<b;m.classList.toggle("renuvex-pr-fwizard-star-active",g),m.setAttribute("aria-checked",h+1===b?"true":"false"),m.innerHTML=g?J("full"):J("outline")})}function f(b){e.set({rating:b}),u(b)}function s(b){var m=d[b-1];if(m)try{m.focus()}catch(h){}}function p(b,m){m&&typeof m.preventDefault=="function"&&m.preventDefault(),m&&typeof m.stopPropagation=="function"&&m.stopPropagation(),!a&&(a=!0,f(b),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var c=1;c<=5;c++)(function(b){var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-star",m.setAttribute("role","radio"),m.setAttribute("aria-label",b+" y\u0131ld\u0131z"),m.innerHTML=J("outline"),m.addEventListener("mouseenter",function(){u(b)}),m.addEventListener("mouseleave",function(){u(e.get().rating)}),m.addEventListener("pointerdown",function(h){h.button&&h.button!==0||p(b,h)}),typeof window!="undefined"&&!window.PointerEvent&&m.addEventListener("touchstart",function(h){p(b,h)},{passive:!1}),m.addEventListener("mousedown",function(h){window.PointerEvent||p(b,h)}),m.addEventListener("keydown",function(h){if(h.key==="Enter"||h.key===" "){p(b,h);return}var g=0;h.key==="ArrowRight"||h.key==="ArrowUp"?g=Math.min(5,b+1):h.key==="ArrowLeft"||h.key==="ArrowDown"?g=Math.max(1,b-1):h.key==="Home"?g=1:h.key==="End"&&(g=5),g&&(h.preventDefault(),f(g),s(g))}),m.addEventListener("click",function(h){p(b,h)}),d.push(m),l.appendChild(m)})(c);u(e.get().rating);var y=null,v=function(b){var m=b&&b.detail&&b.detail.settings;m&&m===y||(y=m||null,i=Je(m||I||{}),u(e.get().rating))};return window.addEventListener(Ee,v),t.appendChild(l),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ee,v)}}}var Kt=3,Ba=10*1024*1024;function Xt(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-subtitle",o.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",l.appendChild(i),l.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),l.appendChild(u),a.appendChild(l);var f=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},s=r.blobMap||{},p=r.urlToFinger||{};function c(){if(!t){var h=e.get().images||[],g=e.get().pendingImages||[],k=h.map(function(x){return{url:x,isPending:!1}}).concat(g.map(function(x){return{url:x.url,file:x.file,isPending:!0,error:x.error}}));u.innerHTML="",k.forEach(function(x){var z=s[x.url]||x.url,A=y(x,z);u.appendChild(A)}),b()}}function y(h,g){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var x=document.createElement("img");x.src=g,x.alt="",x.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(x);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",k.appendChild(z);var A=document.createElement("button");A.type="button",A.className="renuvex-pr-fwizard-photo-remove",A.setAttribute("aria-label","Kald\u0131r");var E=Z(Ce);return E&&A.appendChild(E),k.appendChild(A),v(k,h,g),k}function v(h,g,k){var x=h.querySelector("img");x.src!==k&&(x.src=k);var z=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(g.isPending&&g.error){z.style.display="flex",z.textContent="";var A=document.createElement("span");A.className="renuvex-pr-upload-error",A.textContent="\u2717 "+g.error,z.appendChild(A)}else z.style.display="none",z.textContent="";var E=h.querySelector(".renuvex-pr-fwizard-photo-remove");E.onclick=function(){var w=p[g.url]||(g.file?g.file.name+"_"+g.file.size:null),S=s[g.url],L={};w&&(L.fingerprints=(e.get().fingerprints||[]).filter(function(T){return T!==w})),g.isPending?L.pendingImages=(e.get().pendingImages||[]).filter(function(T){return T.url!==g.url}):L.images=(e.get().images||[]).filter(function(T){return T!==g.url}),e.set(L),f(g.url),f(S),delete p[g.url],S&&delete p[S],s[g.url]&&delete s[g.url]}}function b(){var h=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,k=h+g,x=k>=Kt;k>0?(l.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(gt)):(l.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(ft)+"<span>Foto\u011Fraf Ekle</span>"),x?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(h){var g=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(h.target.files).slice(0,Kt-g);d.value="";var x=(e.get().pendingImages||[]).length,z=e.get().images||[],A=z.length;if(k.length!==0){for(var E=[],w=[],S=0;S<k.length;S++){var L=k[S],T=L.name+"_"+L.size,C=(e.get().fingerprints||[]).some(function(D){return D===T})||E.some(function(D){return D.file.name+"_"+D.file.size===T});if(!C){if(L.size>Ba){var P="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(P,"error"):alert(P);continue}var R=URL.createObjectURL(L);p[R]=T,E.push({url:R,file:L,error:null}),w.push({url:R,file:L});var O=(e.get().fingerprints||[]).slice();O.push(T),e.set({fingerprints:O})}}if(E.length!==0){var W=(e.get().pendingImages||[]).concat(E),K=async function(){for(var D=0;D<w.length;D++){var ne=w[D],V=ne.file,_=ne.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ie=(e.get().pendingImages||[]).filter(function(F){return F.url!==_}),oe=(e.get().images||[]).slice();oe.push(_),e.set({pendingImages:ie,images:oe});continue}try{var le=await Ze(Xe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke})});if(!le.ok)throw le.status===429?new Error("rate_limit"):new Error("sign failed");var j=await le.json();if(!j.folder)throw new Error("sign folder missing");var N=new FormData;N.append("file",V),N.append("api_key",j.api_key),N.append("timestamp",j.timestamp),N.append("signature",j.signature),N.append("folder",j.folder);var Q=await fetch("https://api.cloudinary.com/v1_1/"+j.cloud_name+"/image/upload",{method:"POST",body:N}),M=await Q.json();if(M.secure_url&&yt(M.secure_url)){var tr=(e.get().pendingImages||[]).some(function(F){return F.url===_});if(!tr)continue;s[M.secure_url]=_,p[M.secure_url]=p[_];var ke=(e.get().pendingImages||[]).filter(function(F){return F.url!==_}),B=(e.get().images||[]).slice();B.push(M.secure_url),e.set({pendingImages:ke,images:B});try{Ze(Xe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke,secureUrl:M.secure_url})}).catch(function(){})}catch(F){}}else throw new Error("invalid image url")}catch(F){console.error("[renuvex-pr] Image upload failed:",F);var ee=F.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ee,"error");var re=(e.get().pendingImages||[]).map(function(ve){return ve.url===_?{url:ve.url,file:ve.file,error:ee}:ve});e.set({pendingImages:re})}}};if(A===0&&x===0){t=!0;var Y=!r.canNavigate||r.canNavigate();Y&&e.goNext()}e.set({pendingImages:W}),K()}}};var m=e.onChange(c);return c(),{el:a,destroy:function(){t=!0,d.onchange=null,m&&m()}}}var jr=2e3,_a=60;function Jt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content-form";var l=document.createElement("input");l.type="text",l.className="renuvex-pr-fwizard-input",l.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",l.maxLength=_a,l.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),l.value=e.get().title||"",l.addEventListener("input",function(){e.set({title:l.value})}),o.appendChild(l);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=jr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),o.appendChild(d);function u(){var s=i.value.length;d.textContent=s+"/"+jr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",s>=jr)}function f(){return je(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),u(),t(f())}),a.appendChild(o),u(),setTimeout(function(){t(f())},0),{el:a,destroy:function(){}}}var Ma=40;function Zt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent="Hakk\u0131n\u0131zda",n.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Ma,u.setAttribute("aria-required","true"),u.value=e.get().author||"",i.appendChild(d),i.appendChild(u),l.appendChild(i);var f=document.createElement("div");f.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.textContent="E-posta (opsiyonel)";var p=document.createElement("input");p.type="email",p.className="renuvex-pr-fwizard-input",p.setAttribute("autocomplete","email"),p.value=e.get().email||"",f.appendChild(s),f.appendChild(p),l.appendChild(f);var c=document.createElement("div");c.className="renuvex-pr-fwizard-notice",c.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",l.appendChild(c);var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg",y.setAttribute("role","alert"),y.setAttribute("aria-live","assertive"),l.appendChild(y);var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-submit-btn",v.textContent="G\xF6nder",l.appendChild(v),n.appendChild(l);function b(){return je(4,e.get())}function m(){var x=!b(),z=(e.get().pendingImages||[]).length,A=z>0;A?(v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=x,v.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",x),v.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),m(),t(b())}),p.addEventListener("input",function(){e.set({email:p.value})}),m(),setTimeout(function(){t(b())},0);function h(){y.textContent=""}function g(x){h();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=x||"",y.appendChild(z)}v.onclick=async function(){if(!v.disabled){var x=e.get(),z=(x.author||"").trim(),A=(x.comment||"").trim();if(p.value.trim()&&!p.checkValidity()){p.reportValidity();return}if(!z){g("Gerekli alan");return}if(!x.rating){g("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var E=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",h(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var w=ht(window.location.href),S=x.productName||null,L=await Ze(Xe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Ke,productId:x.productId||null,slug:w||null,productName:S,author:z,title:(x.title||"").trim()||null,comment:A||null,rating:x.rating,images:x.images||[]})},15e3);if(L.ok)a();else{var T=await L.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(R){var C=R&&(R.name==="AbortError"||/signal/i.test(R.message||"")),P=C?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":R.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(P,"error"):g(P),v.disabled=!1,v.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent=E}}};var k=e.onChange(m);return{el:n,destroy:function(){v.onclick=null,k&&k()}}}function Fa(e,r,t){if(t=t||{},e===1)return Gt(r,{canNavigate:t.canNavigate});if(e===2)return Xt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Jt(r,{onValidityChange:t.onValidityChange});if(e===4)return Zt(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function $t(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Qt(e){e=e||{};var r=Wt({productId:e.productId,productName:e.productName}),t={},a={},n={};function o(w){if(!(!w||typeof w!="string"||!w.startsWith("blob:")||n[w])){n[w]=!0;try{URL.revokeObjectURL(w)}catch(S){}}}function l(){Object.keys(a).forEach(function(S){o(S)}),Object.keys(t).forEach(function(S){o(t[S])});var w=r.get();(w.pendingImages||[]).forEach(function(S){o(S&&S.url)}),(w.images||[]).forEach(function(S){o(S)})}var i=Vt({onClose:function(){window.removeEventListener("popstate",u),zr(d),l(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=wr(),u=function(w){i&&i.close&&i.close()};window.addEventListener("popstate",u);var f=document.createElement("div");f.className="renuvex-pr-fwizard-step-wrap";var s=qt({skippableSteps:[2],nextableSteps:[3],onBack:function(){y==="idle"&&r.goBack()},onSkip:function(){y==="idle"&&r.goNext()},onNext:function(){y==="idle"&&r.goNext()}}),p=document.createElement("div");p.className="renuvex-pr-fwizard-layout",p.appendChild(f),p.appendChild(s.el);var c=null,y="idle",v=null,b=!0,m=null;function h(w,S){f.innerHTML="";var L=Fa(w,r,{canNavigate:function(){return y==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:o,onValidityChange:function(P){s.setNextDisabled(!P)},onSuccess:k,showToast:i.showToast});if(c=L,s.update(w,r.get()),S){y="entering",L.el.classList.add("renuvex-pr-fwizard-step--enter");var T=null,C=function(){T&&clearTimeout(T),L.el.removeEventListener("animationend",C),L.el.classList.remove("renuvex-pr-fwizard-step--enter"),y="idle",v!==null&&x()};L.el.addEventListener("animationend",C),T=setTimeout(C,700)}else y="idle";f.appendChild(L.el),i.setStepAttr&&i.setStepAttr(w),w===3&&s.setNextDisabled(!0)}var g=!1;function k(){if(!g){if(g=!0,!c){f.innerHTML="";var w=$t();w.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(w),i.setStepAttr("thanks"),s.setThanksState(i.close);return}var S=c;y="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(m&&clearTimeout(m),S.el.removeEventListener("animationend",L),S.destroy)try{S.destroy()}catch(C){}c===S&&(c=null),f.innerHTML="";var T=$t();T.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(T),i.setStepAttr("thanks"),s.setThanksState(i.close),y="idle"};S.el.addEventListener("animationend",L),m=setTimeout(L,300)}}function x(){var w=r.get().currentStep;if(y!=="idle"){v=w;return}if(!c){var S=!b;b=!1,h(w,S);return}var L=c;y="exiting",L.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(m&&clearTimeout(m),L.el.removeEventListener("animationend",T),L.destroy)try{L.destroy()}catch(P){}if(c===L){f.innerHTML="",c=null;var C=v!==null?v:r.get().currentStep;v=null,h(C,!0),y="idle"}};L.el.addEventListener("animationend",T),m=setTimeout(T,350)}x();var z=r.get().currentStep,A=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,x()):s.update(w.currentStep,w)}),E=i.close;return i.close=function(){A&&A(),typeof m!="undefined"&&m&&clearTimeout(m),E()},i.open(p),{close:i.close}}function U(){Qt({productId:H||"",productName:Ne||""})}var ea=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Oa={id:"classic",name:"Klasik (A\xE7\u0131k)"},Ha=ea;function Ya(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange;ye(n);var c=document.createElement("div");c.className="renuvex-pr-summary";var y=(l[3]||0)+(l[4]||0),v=o>0?Math.round(y/o*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+J("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",c.appendChild(b);var m=document.createElement("div");if(m.className="renuvex-pr-summary-block renuvex-pr-summary-count",m.textContent=o.toLocaleString("tr-TR")+" Yorum",c.appendChild(m),a.showRecommendation!==!1&&v>0){var h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",c.appendChild(h)}return c.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:s})),c.appendChild(G({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p})),c}var Vr={};be(Vr,{css:()=>ja,meta:()=>Da,render:()=>qa});var ra=`
...
`;var Da={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ja=ra,Ua="__unknown_product__",er=Object.create(null);function Va(e){return e?String(e):Ua}var Ae=null,rr=null;function Wa(){!Ae||!rr||(Ae.removeEventListener?Ae.removeEventListener("change",rr):Ae.removeListener&&Ae.removeListener(rr),Ae=null,rr=null)}function qa(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,p=e.onSortChange,c=Va(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var v=document.createElement("div");v.className="renuvex-pr-compact-header";var b=document.createElement("div");b.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Be(i,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+o.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+me(xt)+"</span>";var h=m.querySelector(".renuvex-pr-compact-trigger-text"),g=m.querySelector(".renuvex-pr-compact-chevron");if(h&&g){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",m.insertBefore(k,h),k.appendChild(h),k.appendChild(g)}b.appendChild(m),v.appendChild(b);var x=G({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p}),z=x.querySelector(".renuvex-pr-filter-wrap"),A=x.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");E.className="renuvex-pr-compact-actions-slot",A&&E.appendChild(A),z&&E.appendChild(z),v.appendChild(E),y.appendChild(v);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="renuvex-pr-compact-panel-inner";var L=document.createElement("div");L.className="renuvex-pr-compact-avg",L.innerHTML='<span class="renuvex-pr-icon">'+J("full")+"</span><span>"+i+"</span>",S.appendChild(L),S.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:function(N){C()&&w.classList.contains("renuvex-pr-open")&&(er[c]=!0),s(N)}})),w.appendChild(S);var T=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(){return!!(T&&T.matches)}function P(N){N?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",N?"false":"true"),m.setAttribute("aria-expanded",N?"true":"false")}function R(N){var Q=N?y:b;if(w.parentNode!==Q){var M=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&P(!1),M&&(er[c]=!1),Q.appendChild(w)}}R(T?T.matches:!1);var O=G({widget:r,currentOrderBy:u,currentHasImages:f,onWriteClick:U,onSortChange:p}),W=O.querySelector(".renuvex-pr-filter-wrap"),K=O.querySelector(".renuvex-pr-write-btn"),Y=document.createElement("div");Y.className="renuvex-pr-compact-write-row",K&&Y.appendChild(K),W&&Y.appendChild(W),y.appendChild(Y);function D(){var N=w.classList.contains("renuvex-pr-open");return P(!1),C()&&(er[c]=!1),N}function ne(){V&&V.notifyOpening(),P(!0),C()&&(er[c]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?D():ne()};var V=null;function _(N){V&&(V.unregister(),V=null),N||(V=Sr({trigger:b,element:w,close:D}))}if(_(T?T.matches:!1),Wa(),T){var ie=function(N){R(N.matches),_(N.matches)};T.addEventListener?T.addEventListener("change",ie):T.addListener&&T.addListener(ie),Ae=T,rr=ie}if(C()&&er[c]&&P(!0),a.showRecommendation!==!1){var oe=(l[3]||0)+(l[4]||0),le=o>0?Math.round(oe/o*100):0;if(le>0){var j=document.createElement("div");j.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="renuvex-pr-recommend-pct">%'+le+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild(j)}}return y}var Wr={};be(Wr,{css:()=>Ka,meta:()=>Ga,render:()=>Xa});var ta=`
...
`;var Ga={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ka=ta;function Xa(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,u=e.currentHasImages,f=e.onFilterChange,s=e.onSortChange;ye(a);var p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-split";var c=document.createElement("div");c.className="renuvex-pr-split-col renuvex-pr-split-left";var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",y.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+J("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",c.appendChild(y);var v=document.createElement("div");v.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",v.textContent=n.toLocaleString("tr-TR")+" Yorum",c.appendChild(v),p.appendChild(c);var b=document.createElement("div");b.className="renuvex-pr-split-col renuvex-pr-split-mid",b.appendChild(Ye({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),p.appendChild(b);var m=G({widget:r,currentOrderBy:d,currentHasImages:u,onWriteClick:U,onSortChange:s}),h=m.querySelector(".renuvex-pr-filter-wrap"),g=m.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-right",g&&k.appendChild(g),h&&k.appendChild(h),p.appendChild(k);var x=(o[3]||0)+(o[4]||0),z=n>0?Math.round(x/n*100):0,A=document.createElement("div");A.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",A.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var E=t.showRecommendation===!1||z===0;return E&&A.classList.add("renuvex-pr-split-rec-hidden"),c.appendChild(A),p}var qr={};be(qr,{css:()=>Za,meta:()=>Ja,render:()=>$a});var aa=`
...
`;var Qa={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},en=na;function rn(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,i=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-hero";var u=document.createElement("div");u.className="renuvex-pr-hero-info";var f=document.createElement("div");f.className="renuvex-pr-hero-rating-col";var s=document.createElement("span");s.className="renuvex-pr-hero-avg",s.textContent=n,f.appendChild(s);var p=document.createElement("div");p.className="renuvex-pr-hero-meta-row";var c=document.createElement("span");c.className="renuvex-pr-hero-stars",c.innerHTML=Be(n,t),p.appendChild(c);var y=document.createElement("div");y.className="renuvex-pr-hero-count",y.textContent=a.toLocaleString("tr-TR")+" Yorum",p.appendChild(y),f.appendChild(p),u.appendChild(f),d.appendChild(u);var v=G({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:U,onSortChange:i}),b=v.querySelector(".renuvex-pr-filter-wrap"),m=v.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");h.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",m&&h.appendChild(m),b&&h.appendChild(b),d.appendChild(h);var g=G({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:U,onSortChange:i}),k=g.querySelector(".renuvex-pr-filter-wrap"),x=g.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-hero-write-row",x&&z.appendChild(x),k&&z.appendChild(k),d.appendChild(z),d}var ia=`
  .renuvex-pr-summary{
...
`;var tn={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},an=la;function nn(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var o=document.createElement("span");o.className="renuvex-pr-review-stars",o.innerHTML=xe(e.rating,I),n.appendChild(o);var l=document.createElement("time");if(l.className="renuvex-pr-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var u=(e.comment||"").trim();u&&t.appendChild(Ue(u,"renuvex-pr-body").fragment);var f=we(e);if(f.length){var s=document.createElement("div");s.className="renuvex-pr-gallery",f.forEach(function(c){var y=document.createElement("img"),v=pe(c,q);y.src=v.src,y.srcset=v.srcset,y.loading="lazy",y.decoding="async",y.width=q,y.height=q,y.className="renuvex-pr-img",ue(y),y.setAttribute("data-renuvex-img-url",c),(function(b){ze(y,function(){se(e,b,r)})})(c),s.appendChild(y)}),t.appendChild(s)}var p=Ve(e.merchantReply);return p&&t.appendChild(p),t}var Xr={};be(Xr,{css:()=>ln,meta:()=>on,render:()=>pn});var pa=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var on={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},ln=pa;function pn(e,r){var t=we(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-list-author";var l=document.createElement("span");l.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",l.innerHTML=xe(e.rating,I),o.appendChild(l);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",o.appendChild(i);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=fe(e.createdAt),o.appendChild(d),n.appendChild(o);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var f=document.createElement("div");f.className="renuvex-pr-review-list-title",f.textContent=e.title,u.appendChild(f)}var s=(e.comment||"").trim();s&&u.appendChild(Ue(s,"renuvex-pr-review-list-body").fragment);var p=Ve(e.merchantReply);if(p&&u.appendChild(p),n.appendChild(u),a){var c=document.createElement("div");c.className="renuvex-pr-review-list-media",t.forEach(function(y){var v=document.createElement("img"),b=pe(y,q);v.src=b.src,v.srcset=b.srcset,v.loading="lazy",v.decoding="async",v.width=q,v.height=Math.round(q*4/3),v.setAttribute("data-renuvex-img-url",y),ue(v),(function(m){ze(v,function(){se(e,m,r)})})(y),c.appendChild(v)}),n.appendChild(c)}return n}var Jr={};be(Jr,{css:()=>dn,meta:()=>un,render:()=>sn});var ua=`
...
`;var un={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},dn=ua;function sn(e,r){var t=vr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-gallery-content";var l=document.createElement("span");if(l.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",l.innerHTML=xe(e.rating,I),o.appendChild(l),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,o.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",o.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=fe(e.createdAt),o.appendChild(u);var f=(e.comment||"").trim();if(f&&o.appendChild(Ue(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){se(e,t,r)}}:null).fragment),n.appendChild(o),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var p=document.createElement("img"),c=pe(t,cr);p.src=c.src,p.srcset=c.srcset,p.loading="lazy",p.decoding="async",p.width=cr,p.height=Math.round(cr*4/3),ue(p),p.setAttribute("data-renuvex-img-url",t),ze(p,function(){se(e,t,r)}),s.appendChild(p),n.appendChild(s)}var y=Ve(e.merchantReply,t?function(){se(e,t,r)}:null);return y&&(y.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(y)),n}var Tr={card:Kr,list:Xr,gallery:Jr};function Ar(e){return Tr[e]||Tr.card}function da(){return Object.keys(Tr).map(function(e){return Tr[e].css||""}).join(`
`)}var Zr=0;function We(){return Zr++,Zr}function qe(e,r){return e!==Zr?!1:r?!(r.productId!==void 0&&H!==r.productId||r.orderBy!==void 0&&X!==r.orderBy||r.page!==void 0&&ir!==r.page||r.ratingFilter!==void 0&&te!==r.ratingFilter||r.hasImages!==void 0&&ae!==r.hasImages):!0}var $r={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Lr={small:80,medium:110,large:140};function sa(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var o=document.createElementNS(t,"line");o.setAttribute("x1","1"),o.setAttribute("y1","1"),o.setAttribute("x2","23"),o.setAttribute("y2","23"),a.appendChild(n),a.appendChild(o);var l=document.createElement("div");l.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",l.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(l),r.appendChild(i),r}function va(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function he(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),o=parseInt(t[3],16);return"rgba("+a+","+n+","+o+","+r+")"}function Pr(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Qr(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function ca(e){return .2126*Qr(e.r)+.7152*Qr(e.g)+.0722*Qr(e.b)}function ma(e,r){var t=ca(e),a=ca(r),n=Math.max(t,a),o=Math.min(t,a);return(n+.05)/(o+.05)}function vn(e){var r=Pr(e)||Pr("#ffffff"),t=Pr("#111111"),a=Pr("#ffffff");return ma(t,r)>=ma(a,r)?"#111111":"#ffffff"}function cn(e){return he(e,e==="#ffffff"?.1:.06)}function xa(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",o=r.headerRecommendColor||"#111111",l=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=he(l,.06),f=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",c=r.btnBorderColor||"#111111",y=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",b=r.filterBtnBorderColor||"#111111",m=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",g=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",x=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",A=r.reviewAuthorColor||"#111111",E=r.reviewDateColor||"#5e5e5e",w=r.reviewBodyColor||"#111111",S=r.reviewBorderColor||"#e5e7eb",L=he(w,.65),T=r.replyBgColor||"#f9fafb",C=r.replyBorderColor||"#747474",P=r.replyLabelColor||"#111111",R=r.replyTextColor||"#111111",O=r.photoTitleColor||"#111111",W=he("#111111",.05),K=r.photoArrowBgColor||"#ffffff",Y=r.photoArrowTextColor||"#111111",D=he("#111111",.12),ne=r.formBgColor||"#ffffff",V=r.formPrimaryTextColor||"#111111",_=r.formSecondaryTextColor||"#3b3b3b",ie=r.inputTextColor||V,oe=r.inputBorderColor||"#d1d5db",le=r.placeholderColor||"#9ca3af",j=r.formStepBarColor||"#111111",N=r.formBtnBgColor||"#111111",Q=r.formBtnTextColor||"#ffffff",M=r.formBtnBorderColor||"#111111",tr=he(N,.06),ke=he(N,.18),B=he(Q,.85),ee=he(V,.06),re=vn(ne),F=cn(re),ve=r.loadMoreBgColor||"#ffffff",ar=r.loadMoreTextColor||"#111111",nr=r.loadMoreBorderColor||"#111111",ce={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":o,"--renuvex-pr-bar-fill":l,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":c,"--renuvex-pr-filter-btn-bg":y,"--renuvex-pr-filter-btn-text":v,"--renuvex-pr-filter-btn-border":b,"--renuvex-pr-filter-menu-bg":m,"--renuvex-pr-filter-menu-border":h,"--renuvex-pr-filter-item-text":g,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":x,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":A,"--renuvex-pr-review-date":E,"--renuvex-pr-review-body":w,"--renuvex-pr-review-border":S,"--renuvex-pr-state-text":L,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":T,"--renuvex-pr-reply-border":C,"--renuvex-pr-reply-label":P,"--renuvex-pr-reply-text":R,"--renuvex-pr-photo-title":O,"--renuvex-pr-photo-image-border":W,"--renuvex-pr-photo-arrow-bg":K,"--renuvex-pr-photo-arrow-text":Y,"--renuvex-pr-photo-arrow-border":D,"--renuvex-pr-fwizard-bg":ne,"--renuvex-pr-fwizard-text":V,"--renuvex-pr-fwizard-secondary-text":_,"--renuvex-pr-fwizard-input-bg":ne,"--renuvex-pr-fwizard-input-text":ie,"--renuvex-pr-fwizard-input-border":oe,"--renuvex-pr-fwizard-placeholder":le,"--renuvex-pr-fwizard-close-text":re,"--renuvex-pr-fwizard-close-hover-bg":F,"--renuvex-pr-fwizard-progress-bg":ee,"--renuvex-pr-fwizard-progress-active":j,"--renuvex-pr-fwizard-btn-bg":N,"--renuvex-pr-fwizard-btn-text":Q,"--renuvex-pr-fwizard-btn-border":M,"--renuvex-pr-fwizard-btn-disabled-bg":ke,"--renuvex-pr-fwizard-btn-disabled-text":B,"--renuvex-pr-fwizard-nav-hover-bg":tr,"--renuvex-pr-load-more-bg":ve,"--renuvex-pr-load-more-text":ar,"--renuvex-pr-load-more-border":nr};Object.keys(ce).forEach(function(Ge){e.style.setProperty(Ge,ce[Ge])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function fa(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,o=e.wireLightboxTrigger,l=(e.photoStripReviews||[]).filter(function(k){return we(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&l.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",u=document.createElement("div");u.className="renuvex-pr-photo-title",u.textContent=d,i.appendChild(u)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var p=q,c=r.reviewLayout==="card"?q:Math.round(q*4/3),y=0;l.forEach(function(k){if(!(y>=15)){var x=vr(k);if(x){var z=document.createElement("img"),A=pe(x,q);z.src=A.src,z.srcset=A.srcset,z.loading=y<3?"eager":"lazy",z.decoding="async",z.width=p,z.height=c,z.className="renuvex-pr-photo-strip-thumb",z.alt="Yorum foto\u011Fraf\u0131",ue(z),(function(E,w){o(z,function(){n(w,E,l)})})(x,k),s.appendChild(z),y++}}});var v=document.createElement("button");v.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var b=Z(Ie);b&&v.appendChild(b),v.setAttribute("aria-label","\xD6nceki"),v.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=Z(sr);h&&m.appendChild(h),m.setAttribute("aria-label","Sonraki"),m.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var g=document.createElement("div");return g.className="renuvex-pr-photo-strip-wrap",g.appendChild(v),g.appendChild(s),g.appendChild(m),i.appendChild(g),i}function ga(e){var r=e.render;async function t(){var o=We(),l=H,i=X,d=te,u=ae,f=await _e(H,X,1,te,ae);qe(o,{productId:l,orderBy:i,ratingFilter:d,hasImages:u})&&await r(H,I,f,Ne,X,1,rt)}async function a(o){var l=We(),i=te===o?null:o,d=H,u=X,f=ae;at(i),Re(1);var s=await _e(H,X,1,i,ae);qe(l,{productId:d,orderBy:u,page:1,ratingFilter:i,hasImages:f})&&await r(H,I,s,Ne,X,1)}async function n(o,l){var i=We(),d=H,u=te;Re(1);var f=o,s=!1;l&&(s=!0,f="newest"),nt(s),or(f);var p=await _e(H,f,1,te,s);qe(i,{productId:d,orderBy:f,page:1,ratingFilter:u,hasImages:s})&&await r(H,I,p,Ne,f,1)}return{onRetry:t,onFilterChange:a,onSortChange:n}}function mn(){return St()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function xn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=zt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),kt(t,{surface:"reviews",productId:r||""}),t}async function et(e,r,t,a,n,o,l){if(ct){ur({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:o,badgeSettings:l});return}pr(!0),it(e),ot(r),l!==void 0&&lt(l),pt(a),n&&or(n),o&&Re(o),t!=null&&ut(t);var i=ga({render:et});try{let ke=function(B,ee){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var re=B.meta.sizeOverrides[ee];re&&Object.keys(re).forEach(function(F){c.style.setProperty(F,re[F])})}};var tr=ke,d=Er(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,s=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",p=u&&f?s:"",c=document.documentElement;xa(c,r);var y=r.borderRadius!==void 0?r.borderRadius:8,v=$r[r.size]||$r.medium,b=Lr[r.thumbnailSize]||Lr.medium;r.thumbnailSize==="large"&&(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(b=Lr.medium),c.style.setProperty("--renuvex-pr-title-size",v.titleSize+"px"),c.style.setProperty("--renuvex-pr-review-text-size",v.reviewTextSize+"px"),c.style.setProperty("--renuvex-pr-review-title-size",v.reviewTitleSize+"px"),c.style.setProperty("--renuvex-pr-author-size",v.authorSize+"px"),c.style.setProperty("--renuvex-pr-reply-name-size",v.replyNameSize+"px"),c.style.setProperty("--renuvex-pr-reply-text-size",v.replyTextSize+"px"),c.style.setProperty("--renuvex-pr-radius",y+"px"),c.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),c.style.setProperty("--renuvex-pr-photo-title-size",v.photoTitleSize+"px"),c.style.setProperty("--renuvex-pr-avg-rating-size",v.avgRatingSize+"px"),c.style.setProperty("--renuvex-pr-review-count-size",v.reviewCountSize+"px"),c.style.setProperty("--renuvex-pr-compact-count-size",v.compactCountSize+"px"),c.style.setProperty("--renuvex-pr-recommend-size",v.recommendSize+"px"),c.style.setProperty("--renuvex-pr-btn-text-size",v.btnTextSize+"px"),c.style.setProperty("--renuvex-pr-bar-label-size",v.barLabelSize+"px"),c.style.setProperty("--renuvex-pr-minimal-avg-size",v.minimalAvgSize+"px"),c.style.setProperty("--renuvex-pr-hero-avg-size",v.heroAvgSize+"px"),c.style.setProperty("--renuvex-pr-bar-count-size",v.barCountSize+"px"),c.style.setProperty("--renuvex-pr-review-date-size",v.reviewDateSize+"px"),c.style.setProperty("--renuvex-pr-filter-text-size",v.filterTextSize+"px"),c.style.setProperty("--renuvex-pr-load-more-size",v.loadMoreSize+"px"),c.style.setProperty("--renuvex-pr-read-more-size",v.readMoreSize+"px"),c.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var m=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";c.style.setProperty("--renuvex-pr-review-star-color",m),c.style.setProperty("--renuvex-pr-star-size",v.reviewStarSize+"px"),c.style.setProperty("--renuvex-pr-avg-star-size",v.avgStarSize+"px"),ke(Er(r.summaryLayout),r.size),ke(Ar(r.reviewLayout),r.size);var h=Je(r),g=mn();if(!g)return;var k=xn(g,e),x=document.getElementById("renuvex-reviews");x||(x=document.createElement("div"),x.id="renuvex-reviews",x.style.minHeight="200px"),x.parentNode!==k&&k.appendChild(x);var z=Ct(x),A=Me+Le+fr+oa()+da();Fe(z,A);var E=Tt(z);if(r.enabled===!1){x.style.minHeight="auto",E.replaceChildren(sa(r.borderRadius!==void 0?r.borderRadius:8)),pr(!1);var w=lr;ur(null),w&&et(w.productId,w.settings,w.reviewsData,w.productName,w.orderBy,w.page,w.badgeSettings);return}try{var S=t||{},L=_r(S),T=L?[]:S.data&&S.data.reviews||[];dt(T),E.replaceChildren();var C=document.createElement("section");if(C.id="renuvex-reviews-widget",C.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),C.className="renuvex-pr-reviews-widget",C.setAttribute("data-renuvex-surface","reviews"),e&&C.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(C.style.width="100%",C.style.maxWidth="100%",C.style.marginLeft="0",C.style.marginRight="0"),p){var P=document.createElement("div"),R=r.summaryLayout||"classic";P.className="renuvex-pr-title renuvex-pr-title-"+R,P.textContent=p,C.appendChild(P)}if(L){C.appendChild(va(S.message,i.onRetry)),E.appendChild(C),Se(z),Nr(C,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return z.getElementById("renuvex-reviews-widget")});return}var O=S.data&&S.data.allCount||0,W=S.data&&S.data.ratingCounts||null,K=W||[0,0,0,0,0],Y=S.data&&S.data.avgRating||"0.0";if(!W&&T.length>0){T.forEach(function(B){B.rating>=1&&B.rating<=5&&K[B.rating-1]++});var D=T.reduce(function(B,ee){return B+ee.rating},0);Y=(D/T.length).toFixed(1)}if(O>0){var ne=Er(r.summaryLayout),V=ne.render({widget:C,productId:e,data:S,settings:r,iconPair:h,allCount:O,ratingCounts:K,avgRatingVal:Y,currentRatingFilter:te,currentOrderBy:X,currentHasImages:ae,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});C.appendChild(V)}else{var _=document.createElement("button");_.className="renuvex-pr-write-btn",_.style.cssText="display:block;margin:16px auto 0;",_.textContent=r.writeButtonText||"Yorum Yap",_.onclick=U,C.appendChild(_)}var ie=fa({settings:r,root:c,currentHasImages:ae,photoStripReviews:tt,openReviewModal:se,wireLightboxTrigger:ze});if(ie&&C.appendChild(ie),T.length===0){var oe=document.createElement("p");oe.className="renuvex-pr-state-msg",oe.textContent="Hen\xFCz yorum yok.",C.appendChild(oe)}else{var le=Ar(r.reviewLayout);T.forEach(function(B){C.appendChild(le.render(B,Rr))})}var j=S.data&&S.data.hasMore;if(j){var N=document.createElement("button");N.className="renuvex-pr-load-more",N.textContent="Daha Fazla G\xF6ster",N.onclick=async function(){N.disabled=!0,N.textContent="Y\xFCkleniyor...";var B=We(),ee=H,re=X,F=ir,ve=te,ar=ae,nr=F+1,ce=await _e(ee,re,nr,ve,ar);if(qe(B,{productId:ee,orderBy:re,page:F,ratingFilter:ve,hasImages:ar}))if(ce&&!_r(ce)&&ce.data&&Array.isArray(ce.data.reviews)){var Ge=st(ce.data.reviews);vt(Ge),Re(nr);var ha=Ar(I.reviewLayout);Ge.forEach(function(ba){C.insertBefore(ha.render(ba,Rr),N)}),ce.data.hasMore?(N.disabled=!1,N.textContent="Daha Fazla G\xF6ster"):N.remove()}else N.disabled=!1,N.textContent="Tekrar Dene"},C.appendChild(N)}E.appendChild(C),Se(z),Nr(C,"reviews-widget",{productId:e||""},function(){return z.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var Q=document.createElement("p");Q.style.cssText="text-align:center;color:#dc2626;",Q.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",E&&E.replaceChildren(Q)}}finally{if(pr(!1),lr){var M=lr;ur(null),et(M.productId,M.settings,M.reviewsData,M.productName,M.orderBy,M.page,M.badgeSettings)}}}export{et as render};
