...
`;var Vt=`
  ...
  .renuvex-pr-empty-state-title{margin:0;font-size:18px;font-weight:600;line-height:1.35;color:var(--renuvex-pr-title-color,#111111);overflow-wrap:anywhere;}
...
`;var tn={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},an=ca,nn="__unknown_product__",ar=Object.create(null);function on(e){return e?String(e):nn}var Me=null,nr=null;function ln(){!Me||!nr||(Me.removeEventListener?Me.removeEventListener("change",nr):Me.removeListener&&Me.removeListener(nr),Me=null,nr=null)}function pn(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,l=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,g=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange,s=on(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var h=document.createElement("div");h.className="renuvex-pr-compact-trigger-wrap";var x=document.createElement("button");x.className="renuvex-pr-compact-trigger",x.type="button",x.setAttribute("aria-expanded","false"),x.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Se(i,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+me(Et)+"</span>";var f=x.querySelector(".renuvex-pr-compact-trigger-text"),m=x.querySelector(".renuvex-pr-compact-chevron");if(f&&(f.textContent=l.toLocaleString("tr-TR")+" "+B(a.countLabel,"Yorum")),f&&m){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",x.insertBefore(k,f),k.appendChild(f),k.appendChild(m)}h.appendChild(x),c.appendChild(h);var b=$({widget:r,currentOrderBy:p,currentHasImages:g,onWriteClick:U,onSortChange:u}),z=b.querySelector(".renuvex-pr-filter-wrap"),E=b.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+re("full")+"</span><span>"+i+"</span>",T.appendChild(C),T.appendChild(Ue({ratingCounts:o,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){P()&&w.classList.contains("renuvex-pr-open")&&(ar[s]=!0),v(I)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function S(I){I?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",I?"false":"true"),x.setAttribute("aria-expanded",I?"true":"false")}function N(I){var F=I?y:h;if(w.parentNode!==F){var M=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&S(!1),M&&(ar[s]=!1),F.appendChild(w)}}N(L?L.matches:!1);var j=$({widget:r,currentOrderBy:p,currentHasImages:g,onWriteClick:U,onSortChange:u}),K=j.querySelector(".renuvex-pr-filter-wrap"),Q=j.querySelector(".renuvex-pr-write-btn"),W=document.createElement("div");W.className="renuvex-pr-compact-write-row",Q&&W.appendChild(Q),K&&W.appendChild(K),y.appendChild(W);function Y(){var I=w.classList.contains("renuvex-pr-open");return S(!1),P()&&(ar[s]=!1),I}function le(){q&&q.notifyOpening(),S(!0),P()&&(ar[s]=!0)}x.onclick=function(){w.classList.contains("renuvex-pr-open")?Y():le()};var q=null;function G(I){q&&(q.unregister(),q=null),I||(q=Nr({trigger:h,element:w,close:Y}))}if(G(L?L.matches:!1),ln(),L){var pe=function(I){N(I.matches),G(I.matches)};L.addEventListener?L.addEventListener("change",pe):L.addListener&&L.addListener(pe),Me=L,nr=pe}if(P()&&ar[s]&&S(!0),a.showRecommendation!==!1){var ye=(o[3]||0)+(o[4]||0),ne=l>0?Math.round(ye/l*100):0;if(ne>0){var D=document.createElement("div");D.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",D.style.marginTop="8px",D.innerHTML='<span class="renuvex-pr-recommend-pct">%'+ne+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(D)}}return y}var $r={};ze($r,{css:()=>dn,meta:()=>un,render:()=>sn});var ma=`
