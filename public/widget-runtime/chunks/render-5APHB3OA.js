...
`);function Na(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function se(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function Ra(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Ia(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=Ra()&&!n;if(a>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Ba(e){var r=document.body.style,t=document.documentElement.style;se(t,"overflow",e.rootOverflow,e.rootOverflowPriority),se(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),se(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),se(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),se(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),se(r,"position",e.bodyPosition,e.bodyPositionPriority),se(r,"top",e.bodyTop,e.bodyTopPriority),se(r,"left",e.bodyLeft,e.bodyLeftPriority),se(r,"right",e.bodyRight,e.bodyRightPriority),se(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var ir=0,We=null;function Cr(){return ir+=1,ir>1||(We=Na(),Ia(We)),We}function Sr(){if(ir!==0&&(ir-=1,!(ir>0))){var e=We;We=null,e&&Ba(e)}}function Ma(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Er(){var e=Ma();return!e||e===document.body||e===document.documentElement?null:e}function ie(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function _a(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function jr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(_a)}function Fa(e,r){var t=e,a=jr(e);!a.length&&r&&(t=r,a=jr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;ie(n)}function Tr(e,r,t){if(e.key==="Tab"){var a=jr(r);if(!a.length){e.preventDefault(),Fa(r);return}var n=a[0],l=a[a.length-1],o=_t(t);if(!r.contains(o)){e.preventDefault(),ie(n);return}if(a.indexOf(o)===-1){e.preventDefault(),ie(e.shiftKey?l:n);return}e.shiftKey&&o===n?(e.preventDefault(),ie(l)):!e.shiftKey&&o===l&&(e.preventDefault(),ie(n))}}var Vt="renuvexPrOverlay";function Ar(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Vt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Oa(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Vt]===e.id)}function Lr(e){if(Oa(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function qe(e){return Se(e)}function Wt(e,r,t,a,n,l){Sr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&gr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),l&&ie(n)}function Ha(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=xe(e.rating,R);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-modal-reply";var x=document.createElement("div");x.className="renuvex-pr-modal-reply-label",x.textContent=M(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi");var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",p.appendChild(x),p.appendChild(s),p.style.display=e.merchantReply?"":"none",t.appendChild(p),r.appendChild(t),r}function qt(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),l=n.querySelector(".renuvex-pr-modal-stars");l.innerHTML=xe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=fe(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=M(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Vr(e,r,t,a,n,l,o,i,d){var p=qe(e),x=Math.max(0,Math.min(t||0,p.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var u=document.createElement("img"),v=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(u.className="renuvex-pr-modal-main-img"+(v?" "+v:""),u.src=Yr(p[x]||""),u.decoding="async",u.width=Hr,u.height=Math.round(Hr*4/3),u.alt="Yorum foto\u011Fraf\u0131",!v){u.classList.add("renuvex-pr-modal-img-loading");var y=function(){u.classList.remove("renuvex-pr-modal-img-loading")};u.complete&&u.naturalWidth>0?y():(u.addEventListener("load",y,{once:!0}),u.addEventListener("error",y,{once:!0}))}Nt(u,function(P){if(P.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var S=document.createElement("div");S.className="renuvex-pr-modal-img-error",S.setAttribute("role","status"),S.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(S,P)}}),s.appendChild(u);var c=document.createElement("button");c.className="renuvex-pr-modal-close-mobile";var b=ne(Re);b&&c.appendChild(b),c.setAttribute("aria-label","Kapat"),c.onclick=function(P){P.stopPropagation(),l()},s.appendChild(c);var m=0;if(s.addEventListener("touchstart",function(P){m=P.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(P){var S=m-P.changedTouches[0].clientX;if(!(Math.abs(S)<50)){if(S>0){if(k)ge(e,r,x+1,a,n,l,!0,"next",i,d);else if(z){var N=a[r+1];ge(N,r+1,0,a,n,l,!1,"next",i,d)}}else if(f)ge(e,r,x-1,a,n,l,!0,"prev",i,d);else if(h){var Y=a[r-1],G=qe(Y);ge(Y,r-1,G.length-1,a,n,l,!1,"prev",i,d)}}},{passive:!0}),p.length>1){var g=document.createElement("div");g.className="renuvex-pr-modal-thumbs",p.forEach(function(P,S){var N=document.createElement("img"),Y=ue(P,wr);N.src=Y.src,N.srcset=Y.srcset,N.loading="lazy",N.decoding="async",N.width=wr,N.height=wr,N.className="renuvex-pr-modal-thumb"+(S===x?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(S+1),de(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(S+1)+" se\xE7"),S===x&&N.setAttribute("aria-current","true"),(function(G){function ee(){ge(e,r,G,a,n,l,!0,null,i,d)}N.onclick=ee,N.onkeydown=function(D){(D.key==="Enter"||D.key===" ")&&(D.preventDefault(),ee())}})(S),g.appendChild(N)}),s.appendChild(g)}var f=x>0,k=x<p.length-1,h=r>0,z=r<a.length-1,E=f||h,A=k||z;if(E){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var T=ne(De);T&&w.appendChild(T),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(P){if(P.stopPropagation(),f)ge(e,r,x-1,a,n,l,!0,"prev",i,d);else if(h){var S=a[r-1],N=qe(S);ge(S,r-1,N.length-1,a,n,l,!1,"prev",i,d)}},s.appendChild(w)}if(A){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=ne(hr);L&&C.appendChild(L),C.setAttribute("aria-label","Sonraki"),C.onclick=function(P){if(P.stopPropagation(),k)ge(e,r,x+1,a,n,l,!0,"next",i,d);else if(z){var S=a[r+1];ge(S,r+1,0,a,n,l,!1,"next",i,d)}},s.appendChild(C)}return s}function Gt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=qe(a);n[0]&&(new Image().src=Yr(n[0]))}})}function Ur(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Ya(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Ur(t),Ur(a),Ur(n)}l(),t&&ie(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ge(e,r,t,a,n,l,o,i,d,p){if(p&&(p.currentReview=e),o){var x=Vr(e,r,t,a,n,l,i,d,p);n.firstChild&&n.replaceChild(x,n.firstChild)}else{var x=Vr(e,r,t,a,n,l,i,d,p),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(x,n.firstChild),s&&qt(s,e,p&&p.currentSettings),Ya(d,n)}Gt(r,a)}function ve(e,r,t){var a=qe(e);if(!a.length)return;var n=(t||[]).filter(function(A){return qe(A).length>0}),l=n.findIndex(function(A){return A===e||A.id===e.id});l===-1&&(n.unshift(e),l=0);var o=a.indexOf(r);o<0&&(o=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var p=!1,x=null,s=Er(),u=Ye(),v=Cr(),y=Ar(),c={currentReview:e,currentSettings:R},b=null;function m(A){var w=A&&A.detail&&A.detail.settings;if(!(w&&w===b)){b=w||null,c.currentSettings=w||R;var T=d.querySelector(".renuvex-pr-modal-right");!T||!c.currentReview||qt(T,c.currentReview,c.currentSettings)}}function g(){p||(p=!0,window.removeEventListener(Ie,m),Wt(x&&x.host,f,g,v,s,u))}function f(A){if(A.key==="Escape"){k();return}Tr(A,i,x&&x.root)}function k(){p||(p=!0,window.removeEventListener(Ie,m),Wt(x&&x.host,f,g,v,s,u),Lr(y))}document.addEventListener("keydown",f),window.addEventListener("popstate",g),window.addEventListener(Ie,m),i.onclick=function(){k()},d.onclick=function(A){A.stopPropagation()},d.appendChild(Vr(e,l,o,n,d,k,null,i,c)),d.appendChild(Ha(e)),Gt(l,n);var h=document.createElement("div");h.className="renuvex-pr-modal-wrap",h.tabIndex=-1,h.setAttribute("role","dialog"),h.setAttribute("aria-modal","true"),h.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),h.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var E=ne(Re);E&&z.appendChild(E),z.setAttribute("aria-label","Kapat"),z.onclick=function(A){A.stopPropagation(),k()},h.appendChild(z),i.appendChild(h),x=zr(),Ve(x.root,Ue+He+kr),x.root.appendChild(i),Ne(x.root),ie(h)}function Ee(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Xr={};ze(Xr,{css:()=>Za,meta:()=>Ja,render:()=>$a});function Ge(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,l=e.onFilterChange;Ce(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,p=t>0?Math.round(d/t*100):0,x=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(x?" renuvex-pr-bar-active":"")+(n&&!x?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",x?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+M(R&&R.countLabel,"Yorum")+", "+(x?"filtreyi kald\u0131r":"filtrele"));for(var u="",v=1;v<=5;v++){var y=v<=i;u+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ae(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+u+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+p+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(c){function b(){l(c)}s.onclick=b,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),b())}})(i),o.appendChild(s)}return o}var Jt="data-renuvex-pr-dismiss-gesture",Me=[],Kt=!1,Pr=!1,or=[],Ke=null;function Xt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Wr(){for(var e=Me.length-1;e>=0;e--){var r=Me[e].element;r&&r.isConnected===!1&&Me.splice(e,1)}return Me}function Da(e){!e||typeof e.setAttribute!="function"||(or.indexOf(e)===-1&&or.push(e),e.setAttribute(Jt,""))}function Zt(){for(var e=0;e<or.length;e++){var r=or[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Jt)}or=[],Ke&&typeof clearTimeout=="function"&&clearTimeout(Ke),Ke=null}function ja(e){if(Pr){Pr=!1,Zt(),e.preventDefault(),e.stopPropagation();return}for(var r=Wr(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Xt(e,n.trigger)||Xt(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Ua(e){if(e.key==="Escape")for(var r=Wr(),t=r.length-1;t>=0;t--)r[t].close()}function $t(){Kt||typeof document=="undefined"||(document.addEventListener("click",ja,!0),document.addEventListener("keydown",Ua),Kt=!0)}function Va(e){$t(),Pr=!0,Da(e),Ke&&typeof clearTimeout=="function"&&clearTimeout(Ke),typeof setTimeout=="function"&&(Ke=setTimeout(function(){Pr=!1,Zt()},700))}function qr(e){Va(e)}function Nr(e){$t();var r={trigger:e.trigger,element:e.element,close:e.close};return Me.push(r),{unregister:function(){var t=Me.indexOf(r);t!==-1&&Me.splice(t,1)},notifyOpening:function(){for(var t=Wr(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function Q(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,l=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=M(R&&R.writeButtonText,"Yorum Yap"),i.onclick=n,o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-filter-btn",p.setAttribute("aria-label","Filtrele"),p.setAttribute("aria-haspopup","menu"),p.setAttribute("aria-expanded","false");var x=R&&R.filterIcon||"lines";p.innerHTML=me(Ct(x));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function y(){return r&&r.parentNode||r||null}function c(f,k){if(!(k===!0||!f)){if(f.type==="touchstart"){qr(y());return}if(f.type==="pointerdown"){var h=f.pointerType||"";h&&h!=="mouse"&&qr(y());return}}}function b(f){var k=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),p.classList.remove("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","false");var h=f&&(f.restoreFocus===!0||f.restoreFocus==="auto"&&Ye());if(k&&h)try{p.focus({preventScroll:!0})}catch(z){try{p.focus()}catch(E){}}return k}function m(){g.notifyOpening(),s.classList.add("renuvex-pr-open"),p.classList.add("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","true");var f=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");f&&requestAnimationFrame(function(){try{f.focus({preventScroll:!0})}catch(k){try{f.focus()}catch(h){}}})}u.forEach(function(f){var k=f[2],h=k?a:!a&&(t||"newest")===f[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(h?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=f[1];var E=!1;function A(w,T){w&&(w.preventDefault(),w.stopPropagation()),!E&&(E=!0,v=!0,c(w,T),b({restoreFocus:T}),l(f[0],k),setTimeout(function(){E=!1,v=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&A(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){A(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&A(w,!0)}),z.onclick=function(w){A(w,!1)},s.appendChild(z)}),p.onclick=function(){s.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(f){f.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(f.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(f){if(s.classList.contains("renuvex-pr-open")&&!v){var k=f.relatedTarget;k&&d.contains(k)||b()}});var g=Nr({trigger:d,element:s,close:b});return d.appendChild(p),d.appendChild(s),o.appendChild(d),o}var Qt=`
...
`;function ea(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",n.appendChild(l);var o=document.createElement("button");o.className="renuvex-pr-fwizard-close",o.type="button",o.setAttribute("aria-label","Kapat");var i=ne(Re);i&&o.appendChild(i),n.appendChild(o);var d=!1,p=null,x=null,s=!1;function u(){ie(a)}function v(h){Tr(h,a,p&&p.root)}function y(){if(!d){if(d=!0,document.removeEventListener("keydown",c),a.removeEventListener("click",b),o.removeEventListener("click",y),s)ie(x);else{var h=p&&p.root?p.root.activeElement:null;if(h&&typeof h.blur=="function")try{h.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){p?(gr(p.root),p.host&&p.host.parentNode&&p.host.parentNode.removeChild(p.host)):a.parentNode&&a.parentNode.removeChild(a),Sr();try{r()}catch(z){}},200)}}function c(h){if(h.key==="Escape"){y();return}v(h)}function b(h){h.target===a&&t&&y()}document.addEventListener("keydown",c),a.addEventListener("click",b),o.addEventListener("click",y);function m(h){x=Er(),s=Ye(),h&&l.appendChild(h),p=zr(),Ve(p.root,Ue+He+Qt),p.root.appendChild(a),Ne(p.root),Cr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),u()})}var g=null,f=null;function k(h,z){if(z=z||"error",g){try{g.remove()}catch(E){}g=null}f&&(clearTimeout(f),f=null),g=document.createElement("div"),g.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,g.textContent=h,n.appendChild(g),f=setTimeout(function(){g&&(g.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(g){try{g.remove()}catch(E){}g=null}},300))},4e3)}return{open:m,close:y,content:l,setAllowOutsideClose:function(h){t=!!h},setStepAttr:function(h){n.setAttribute("data-step",String(h))},showToast:k}}var Gr=4;function Xe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function ra(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(l){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Gr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(l){return l!==n})}}}}function ta(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},l=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=me(De)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var p=[],x=0;x<Gr;x++){var s=document.createElement("span");s.className="renuvex-pr-fwizard-progress-seg",d.appendChild(s),p.push(s)}o.appendChild(d);var u=document.createElement("button");u.type="button";var v=null;function y(b){v&&u.removeEventListener("click",v),v=b,b&&u.addEventListener("click",b)}o.appendChild(u);function c(b,m){var g=r.indexOf(b)!==-1,f=t.indexOf(b)!==-1,k=m&&(m.images&&m.images.length>0||m.pendingImages&&m.pendingImages.length>0);if(g)b===2&&k?(u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",y(function(){l()})):(u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.setAttribute("aria-label","Atla"),u.innerHTML="<span>Atla</span>",y(function(){n()})),u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),u.style.visibility="",u.tabIndex=0;else if(f){u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Sonraki"),u.innerHTML="Sonraki",u.style.visibility="",u.tabIndex=0;var h=Xe(b,m);u.disabled=!h,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!h),y(function(){u.disabled||l()})}else u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.innerHTML="",u.style.visibility="hidden",u.tabIndex=-1,u.disabled=!0,y(null)}return{el:o,update:function(b,m){p.forEach(function(f,k){k+1<=b?f.classList.add("renuvex-pr-fwizard-progress-seg-active"):f.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var g=b<=1;i.style.visibility=g?"hidden":"",i.style.pointerEvents=g?"none":"",i.tabIndex=g?-1:0,c(b,m)},setNextDisabled:function(b){u.classList.contains("renuvex-pr-fwizard-cta-btn")&&(u.disabled=!!b,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!b))},setThanksState:function(b){i.style.visibility="hidden",d.style.visibility="hidden",u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",u.style.visibility="",u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),y(b)}}}var Wa={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function he(e){return M(R&&R[e],Wa[e])}function aa(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent=he("formStepRatingTitle"),t.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=ar(R||{});Ce(i);var d=[];function p(b){d.forEach(function(m,g){var f=g<b;m.classList.toggle("renuvex-pr-fwizard-star-active",f),m.setAttribute("aria-checked",g+1===b?"true":"false"),m.innerHTML=f?ae("full"):ae("outline")})}function x(b){e.set({rating:b}),p(b)}function s(b){var m=d[b-1];if(m)try{m.focus()}catch(g){}}function u(b,m){m&&typeof m.preventDefault=="function"&&m.preventDefault(),m&&typeof m.stopPropagation=="function"&&m.stopPropagation(),!a&&(a=!0,x(b),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var v=1;v<=5;v++)(function(b){var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-star",m.setAttribute("role","radio"),m.setAttribute("aria-label",b+" y\u0131ld\u0131z"),m.innerHTML=ae("outline"),m.addEventListener("mouseenter",function(){p(b)}),m.addEventListener("mouseleave",function(){p(e.get().rating)}),m.addEventListener("pointerdown",function(g){g.button&&g.button!==0||u(b,g)}),typeof window!="undefined"&&!window.PointerEvent&&m.addEventListener("touchstart",function(g){u(b,g)},{passive:!1}),m.addEventListener("mousedown",function(g){window.PointerEvent||u(b,g)}),m.addEventListener("keydown",function(g){if(g.key==="Enter"||g.key===" "){u(b,g);return}var f=0;g.key==="ArrowRight"||g.key==="ArrowUp"?f=Math.min(5,b+1):g.key==="ArrowLeft"||g.key==="ArrowDown"?f=Math.max(1,b-1):g.key==="Home"?f=1:g.key==="End"&&(f=5),f&&(g.preventDefault(),x(f),s(f))}),m.addEventListener("click",function(g){u(b,g)}),d.push(m),o.appendChild(m)})(v);p(e.get().rating);var y=null,c=function(b){var m=b&&b.detail&&b.detail.settings;m&&m===y||(y=m||null,i=ar(m||R||{}),p(e.get().rating))};return window.addEventListener(Ie,c),t.appendChild(o),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ie,c)}}}var na=3,qa=10*1024*1024;function ia(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=he("formStepPhotosTitle"),a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=he("formStepPhotosSubtitle"),a.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",o.appendChild(i),o.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),o.appendChild(p),a.appendChild(o);var x=r.revokeBlobUrl||function(g){g&&typeof g=="string"&&g.startsWith("blob:")&&URL.revokeObjectURL(g)},s=r.blobMap||{},u=r.urlToFinger||{};function v(){if(!t){var g=e.get().images||[],f=e.get().pendingImages||[],k=g.map(function(h){return{url:h,isPending:!1}}).concat(f.map(function(h){return{url:h.url,file:h.file,isPending:!0,error:h.error}}));p.innerHTML="",k.forEach(function(h){var z=s[h.url]||h.url,E=y(h,z);p.appendChild(E)}),b()}}function y(g,f){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var h=document.createElement("img");h.src=f,h.alt="",h.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(h);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",k.appendChild(z);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var A=ne(Re);return A&&E.appendChild(A),k.appendChild(E),c(k,g,f),k}function c(g,f,k){var h=g.querySelector("img");h.src!==k&&(h.src=k);var z=g.querySelector(".renuvex-pr-fwizard-photo-loading");if(f.isPending&&f.error){z.style.display="flex",z.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+f.error,z.appendChild(E)}else z.style.display="none",z.textContent="";var A=g.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var w=u[f.url]||(f.file?f.file.name+"_"+f.file.size:null),T=s[f.url],C={};w&&(C.fingerprints=(e.get().fingerprints||[]).filter(function(L){return L!==w})),f.isPending?C.pendingImages=(e.get().pendingImages||[]).filter(function(L){return L.url!==f.url}):C.images=(e.get().images||[]).filter(function(L){return L!==f.url}),e.set(C),x(f.url),x(T),delete u[f.url],T&&delete u[T],s[f.url]&&delete s[f.url]}}function b(){var g=(e.get().images||[]).length,f=(e.get().pendingImages||[]).length,k=g+f,h=k>=na;k>0?(o.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(Tt)):(o.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(Et)+"<span>Foto\u011Fraf Ekle</span>"),h?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(g){var f=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(g.target.files).slice(0,na-f);d.value="";var h=(e.get().pendingImages||[]).length,z=e.get().images||[],E=z.length;if(k.length!==0){for(var A=[],w=[],T=0;T<k.length;T++){var C=k[T],L=C.name+"_"+C.size,P=(e.get().fingerprints||[]).some(function(O){return O===L})||A.some(function(O){return O.file.name+"_"+O.file.size===L});if(!P){if(C.size>qa){var S="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(S,"error"):alert(S);continue}var N=URL.createObjectURL(C);u[N]=L,A.push({url:N,file:C,error:null}),w.push({url:N,file:C});var Y=(e.get().fingerprints||[]).slice();Y.push(L),e.set({fingerprints:Y})}}if(A.length!==0){var G=(e.get().pendingImages||[]).concat(A),ee=async function(){for(var O=0;O<w.length;O++){var oe=w[O],W=oe.file,q=oe.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var K=(e.get().pendingImages||[]).filter(function(B){return B.url!==q}),ce=(e.get().images||[]).slice();ce.push(q),e.set({pendingImages:K,images:ce});continue}try{var re=await nr(rr+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:er})});if(!re.ok)throw re.status===429?new Error("rate_limit"):new Error("sign failed");var j=await re.json();if(!j.folder)throw new Error("sign folder missing");var I=new FormData;I.append("file",W),I.append("api_key",j.api_key),I.append("timestamp",j.timestamp),I.append("signature",j.signature),I.append("folder",j.folder);var le=await fetch("https://api.cloudinary.com/v1_1/"+j.cloud_name+"/image/upload",{method:"POST",body:I}),_=await le.json();if(_.secure_url&&Pt(_.secure_url)){var H=(e.get().pendingImages||[]).some(function(B){return B.url===q});if(!H)continue;s[_.secure_url]=q,u[_.secure_url]=u[q];var Te=(e.get().pendingImages||[]).filter(function(B){return B.url!==q}),te=(e.get().images||[]).slice();te.push(_.secure_url),e.set({pendingImages:Te,images:te});try{nr(rr+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:er,secureUrl:_.secure_url,metadata:{assetId:_.asset_id,publicId:_.public_id,version:_.version,resourceType:_.resource_type,format:_.format,width:_.width,height:_.height,bytes:_.bytes,signature:_.signature}})}).catch(function(){})}catch(B){}}else throw new Error("invalid image url")}catch(B){console.error("[renuvex-pr] Image upload failed:",B);var $e=B.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast($e,"error");var ye=(e.get().pendingImages||[]).map(function(X){return X.url===q?{url:X.url,file:X.file,error:$e}:X});e.set({pendingImages:ye})}}};if(E===0&&h===0){t=!0;var D=!r.canNavigate||r.canNavigate();D&&e.goNext()}e.set({pendingImages:G}),ee()}}};var m=e.onChange(v);return v(),{el:a,destroy:function(){t=!0,d.onchange=null,m&&m()}}}var Kr=2e3,Ga=60;function oa(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=he("formStepContentTitle"),a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Ga,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),l.appendChild(o);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Kr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),l.appendChild(d);function p(){var s=i.value.length;d.textContent=s+"/"+Kr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",s>=Kr)}function x(){return Xe(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),p(),t(x())}),a.appendChild(l),p(),setTimeout(function(){t(x())},0),{el:a,destroy:function(){}}}var Ka=40;function la(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent=he("formStepAuthorTitle"),n.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.maxLength=Ka,p.setAttribute("aria-required","true"),p.value=e.get().author||"",i.appendChild(d),i.appendChild(p),o.appendChild(i);var x=document.createElement("div");x.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.textContent="E-posta (opsiyonel)";var u=document.createElement("input");u.type="email",u.className="renuvex-pr-fwizard-input",u.setAttribute("autocomplete","email"),u.value=e.get().email||"",x.appendChild(s),x.appendChild(u),o.appendChild(x);var v=document.createElement("div");v.className="renuvex-pr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg",y.setAttribute("role","alert"),y.setAttribute("aria-live","assertive"),o.appendChild(y);var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-submit-btn",c.textContent="G\xF6nder",o.appendChild(c),n.appendChild(o);function b(){return Xe(4,e.get())}function m(){var h=!b(),z=(e.get().pendingImages||[]).length,E=z>0;E?(c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(c.disabled=h,c.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",h),c.textContent="G\xF6nder")}p.addEventListener("input",function(){e.set({author:p.value}),m(),t(b())}),u.addEventListener("input",function(){e.set({email:u.value})}),m(),setTimeout(function(){t(b())},0);function g(){y.textContent=""}function f(h){g();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=h||"",y.appendChild(z)}c.onclick=async function(){if(!c.disabled){var h=e.get(),z=(h.author||"").trim(),E=(h.comment||"").trim();if(u.value.trim()&&!u.checkValidity()){u.reportValidity();return}if(!z){f("Gerekli alan");return}if(!h.rating){f("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=c.textContent;if(c.textContent="G\xF6nderiliyor\u2026",g(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var w=At(window.location.href),T=h.productName||null,C=await nr(rr+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:er,productId:h.productId||null,slug:w||null,productName:T,author:z,title:(h.title||"").trim()||null,comment:E||null,rating:h.rating,images:h.images||[]})},15e3);if(C.ok)a();else{var L=await C.json().catch(function(){return{}});throw new Error(L.error||"Yorum kaydedilemedi.")}}catch(N){var P=N&&(N.name==="AbortError"||/signal/i.test(N.message||"")),S=P?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":N.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(S,"error"):f(S),c.disabled=!1,c.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent=A}}};var k=e.onChange(m);return{el:n,destroy:function(){c.onclick=null,k&&k()}}}function Xa(e,r,t){if(t=t||{},e===1)return aa(r,{canNavigate:t.canNavigate});if(e===2)return ia(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return oa(r,{onValidityChange:t.onValidityChange});if(e===4)return la(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function pa(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function ua(e){e=e||{};var r=ra({productId:e.productId,productName:e.productName}),t={},a={},n={};function l(w){if(!(!w||typeof w!="string"||!w.startsWith("blob:")||n[w])){n[w]=!0;try{URL.revokeObjectURL(w)}catch(T){}}}function o(){Object.keys(a).forEach(function(T){l(T)}),Object.keys(t).forEach(function(T){l(t[T])});var w=r.get();(w.pendingImages||[]).forEach(function(T){l(T&&T.url)}),(w.images||[]).forEach(function(T){l(T)})}var i=ea({onClose:function(){window.removeEventListener("popstate",p),Lr(d),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=Ar(),p=function(w){i&&i.close&&i.close()};window.addEventListener("popstate",p);var x=document.createElement("div");x.className="renuvex-pr-fwizard-step-wrap";var s=ta({skippableSteps:[2],nextableSteps:[3],onBack:function(){y==="idle"&&r.goBack()},onSkip:function(){y==="idle"&&r.goNext()},onNext:function(){y==="idle"&&r.goNext()}}),u=document.createElement("div");u.className="renuvex-pr-fwizard-layout",u.appendChild(x),u.appendChild(s.el);var v=null,y="idle",c=null,b=!0,m=null;function g(w,T){x.innerHTML="";var C=Xa(w,r,{canNavigate:function(){return y==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:l,onValidityChange:function(S){s.setNextDisabled(!S)},onSuccess:k,showToast:i.showToast});if(v=C,s.update(w,r.get()),T){y="entering",C.el.classList.add("renuvex-pr-fwizard-step--enter");var L=null,P=function(){L&&clearTimeout(L),C.el.removeEventListener("animationend",P),C.el.classList.remove("renuvex-pr-fwizard-step--enter"),y="idle",c!==null&&h()};C.el.addEventListener("animationend",P),L=setTimeout(P,700)}else y="idle";x.appendChild(C.el),i.setStepAttr&&i.setStepAttr(w),w===3&&s.setNextDisabled(!0)}var f=!1;function k(){if(!f){if(f=!0,!v){x.innerHTML="";var w=pa();w.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(w),i.setStepAttr("thanks"),s.setThanksState(i.close);return}var T=v;y="exiting",T.el.classList.add("renuvex-pr-fwizard-step--exit");var C=function(){if(m&&clearTimeout(m),T.el.removeEventListener("animationend",C),T.destroy)try{T.destroy()}catch(P){}v===T&&(v=null),x.innerHTML="";var L=pa();L.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(L),i.setStepAttr("thanks"),s.setThanksState(i.close),y="idle"};T.el.addEventListener("animationend",C),m=setTimeout(C,300)}}function h(){var w=r.get().currentStep;if(y!=="idle"){c=w;return}if(!v){var T=!b;b=!1,g(w,T);return}var C=v;y="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(m&&clearTimeout(m),C.el.removeEventListener("animationend",L),C.destroy)try{C.destroy()}catch(S){}if(v===C){x.innerHTML="",v=null;var P=c!==null?c:r.get().currentStep;c=null,g(P,!0),y="idle"}};C.el.addEventListener("animationend",L),m=setTimeout(L,350)}h();var z=r.get().currentStep,E=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,h()):s.update(w.currentStep,w)}),A=i.close;return i.close=function(){E&&E(),typeof m!="undefined"&&m&&clearTimeout(m),A()},i.open(u),{close:i.close}}function V(){ua({productId:F||"",productName:Le||""})}var da=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Ja={id:"classic",name:"Klasik (A\xE7\u0131k)"},Za=da;function $a(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,l=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,x=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange;Ce(n);var v=document.createElement("div");v.className="renuvex-pr-summary";var y=(o[3]||0)+(o[4]||0),c=l>0?Math.round(y/l*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ae("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",v.appendChild(b);var m=document.createElement("div");if(m.className="renuvex-pr-summary-block renuvex-pr-summary-count",m.textContent=l.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum"),v.appendChild(m),a.showRecommendation!==!1&&c>0){var g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",g.innerHTML='<span class="renuvex-pr-recommend-pct">%'+c+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(g)}return v.appendChild(Ge({ratingCounts:o,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:s})),v.appendChild(Q({widget:r,currentOrderBy:p,currentHasImages:x,onWriteClick:V,onSortChange:u})),v}var Jr={};ze(Jr,{css:()=>en,meta:()=>Qa,render:()=>nn});var sa=`
...
`;var Qa={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},en=sa,rn="__unknown_product__",lr=Object.create(null);function tn(e){return e?String(e):rn}var _e=null,pr=null;function an(){!_e||!pr||(_e.removeEventListener?_e.removeEventListener("change",pr):_e.removeListener&&_e.removeListener(pr),_e=null,pr=null)}function nn(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,l=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,x=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange,v=tn(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var b=document.createElement("div");b.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+je(i,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+me(St)+"</span>";var g=m.querySelector(".renuvex-pr-compact-trigger-text"),f=m.querySelector(".renuvex-pr-compact-chevron");if(g&&(g.textContent=l.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum")),g&&f){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",m.insertBefore(k,g),k.appendChild(g),k.appendChild(f)}b.appendChild(m),c.appendChild(b);var h=Q({widget:r,currentOrderBy:p,currentHasImages:x,onWriteClick:V,onSortChange:u}),z=h.querySelector(".renuvex-pr-filter-wrap"),E=h.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+ae("full")+"</span><span>"+i+"</span>",T.appendChild(C),T.appendChild(Ge({ratingCounts:o,allCount:l,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){P()&&w.classList.contains("renuvex-pr-open")&&(lr[v]=!0),s(I)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function S(I){I?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",I?"false":"true"),m.setAttribute("aria-expanded",I?"true":"false")}function N(I){var le=I?y:b;if(w.parentNode!==le){var _=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&S(!1),_&&(lr[v]=!1),le.appendChild(w)}}N(L?L.matches:!1);var Y=Q({widget:r,currentOrderBy:p,currentHasImages:x,onWriteClick:V,onSortChange:u}),G=Y.querySelector(".renuvex-pr-filter-wrap"),ee=Y.querySelector(".renuvex-pr-write-btn"),D=document.createElement("div");D.className="renuvex-pr-compact-write-row",ee&&D.appendChild(ee),G&&D.appendChild(G),y.appendChild(D);function O(){var I=w.classList.contains("renuvex-pr-open");return S(!1),P()&&(lr[v]=!1),I}function oe(){W&&W.notifyOpening(),S(!0),P()&&(lr[v]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?O():oe()};var W=null;function q(I){W&&(W.unregister(),W=null),I||(W=Nr({trigger:b,element:w,close:O}))}if(q(L?L.matches:!1),an(),L){var K=function(I){N(I.matches),q(I.matches)};L.addEventListener?L.addEventListener("change",K):L.addListener&&L.addListener(K),_e=L,pr=K}if(P()&&lr[v]&&S(!0),a.showRecommendation!==!1){var ce=(o[3]||0)+(o[4]||0),re=l>0?Math.round(ce/l*100):0;if(re>0){var j=document.createElement("div");j.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="renuvex-pr-recommend-pct">%'+re+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(j)}}return y}var Zr={};ze(Zr,{css:()=>ln,meta:()=>on,render:()=>pn});var va=`
...
`;var on={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},ln=va;function pn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,o=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,p=e.currentHasImages,x=e.onFilterChange,s=e.onSortChange;Ce(a);var u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-split";var v=document.createElement("div");v.className="renuvex-pr-split-col renuvex-pr-split-left";var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",y.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ae("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",c.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),v.appendChild(c),u.appendChild(v);var b=document.createElement("div");b.className="renuvex-pr-split-col renuvex-pr-split-mid",b.appendChild(Ge({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:x})),u.appendChild(b);var m=Q({widget:r,currentOrderBy:d,currentHasImages:p,onWriteClick:V,onSortChange:s}),g=m.querySelector(".renuvex-pr-filter-wrap"),f=m.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-right",f&&k.appendChild(f),g&&k.appendChild(g),u.appendChild(k);var h=(l[3]||0)+(l[4]||0),z=n>0?Math.round(h/n*100):0,E=document.createElement("div");E.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",E.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||z===0;return A&&E.classList.add("renuvex-pr-split-rec-hidden"),v.appendChild(E),u}var $r={};ze($r,{css:()=>dn,meta:()=>un,render:()=>sn});var ca=`
...
`;var un={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},dn=ca;function sn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.avgRatingVal,o=e.currentOrderBy,i=e.currentHasImages,d=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-minimal";var x=document.createElement("div");x.className="renuvex-pr-minimal-info";var s=document.createElement("div");s.className="renuvex-pr-minimal-row";var u=document.createElement("span");u.className="renuvex-pr-minimal-avg",u.textContent=l,s.appendChild(u);var v=document.createElement("span");v.className="renuvex-pr-minimal-stars",v.innerHTML=je(l,a),s.appendChild(v);var y=document.createElement("span");y.className="renuvex-pr-minimal-count",y.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),s.appendChild(y),x.appendChild(s),p.appendChild(x);var c=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),b=c.querySelector(".renuvex-pr-filter-wrap"),m=c.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");g.className="renuvex-pr-minimal-actions",m&&g.appendChild(m),b&&g.appendChild(b),p.appendChild(g);var f=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),k=f.querySelector(".renuvex-pr-filter-wrap"),h=f.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-minimal-write-row",h&&z.appendChild(h),k&&z.appendChild(k),p.appendChild(z),p}var Qr={};ze(Qr,{css:()=>cn,meta:()=>vn,render:()=>mn});var ma=`
...
`;var vn={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},cn=ma;function mn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.avgRatingVal,o=e.currentOrderBy,i=e.currentHasImages,d=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary renuvex-pr-summary-hero";var x=document.createElement("div");x.className="renuvex-pr-hero-info";var s=document.createElement("div");s.className="renuvex-pr-hero-rating-col";var u=document.createElement("span");u.className="renuvex-pr-hero-avg",u.textContent=l,s.appendChild(u);var v=document.createElement("div");v.className="renuvex-pr-hero-meta-row";var y=document.createElement("span");y.className="renuvex-pr-hero-stars",y.innerHTML=je(l,a),v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-hero-count",c.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),v.appendChild(c),s.appendChild(v),x.appendChild(s),p.appendChild(x);var b=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),m=b.querySelector(".renuvex-pr-filter-wrap"),g=b.querySelector(".renuvex-pr-write-btn"),f=document.createElement("div");f.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",g&&f.appendChild(g),m&&f.appendChild(m),p.appendChild(f);var k=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),h=k.querySelector(".renuvex-pr-filter-wrap"),z=k.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");return E.className="renuvex-pr-hero-write-row",z&&E.appendChild(z),h&&E.appendChild(h),p.appendChild(E),p}var xa=`
  .renuvex-pr-summary{
...
`;var hn={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},bn=ha;function yn(e,r){var t=Se(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=xe(e.rating,R),l.appendChild(o);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",l.appendChild(i);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=fe(e.createdAt),l.appendChild(d),n.appendChild(l);var p=document.createElement("div");if(p.className="renuvex-pr-review-list-content",e.title){var x=document.createElement("div");x.className="renuvex-pr-review-list-title",x.textContent=e.title,p.appendChild(x)}var s=(e.comment||"").trim();s&&p.appendChild(Je(s,"renuvex-pr-review-list-body").fragment);var u=Ze(e.merchantReply);if(u&&p.appendChild(u),n.appendChild(p),a){var v=document.createElement("div");v.className="renuvex-pr-review-list-media",t.forEach(function(y){var c=document.createElement("img"),b=ue(y,$);c.src=b.src,c.srcset=b.srcset,c.loading="lazy",c.decoding="async",c.width=$,c.height=Math.round($*4/3),c.setAttribute("data-renuvex-img-url",y),de(c),(function(m){Ee(c,function(){ve(e,m,r)})})(y),v.appendChild(c)}),n.appendChild(v)}return n}var tt={};ze(tt,{css:()=>zn,meta:()=>wn,render:()=>kn});var ba=`
...
`;var wn={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},zn=ba;function kn(e,r){var t=br(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=xe(e.rating,R),l.appendChild(o),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,l.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",l.appendChild(d);var p=document.createElement("time");p.className="renuvex-pr-review-gallery-date",p.style.display="block",e.createdAt&&p.setAttribute("datetime",e.createdAt),p.textContent=fe(e.createdAt),l.appendChild(p);var x=(e.comment||"").trim();if(x&&l.appendChild(Je(x,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ve(e,t,r)}}:null).fragment),n.appendChild(l),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var u=document.createElement("img"),v=ue(t,yr);u.src=v.src,u.srcset=v.srcset,u.loading="lazy",u.decoding="async",u.width=yr,u.height=Math.round(yr*4/3),de(u),u.setAttribute("data-renuvex-img-url",t),Ee(u,function(){ve(e,t,r)}),s.appendChild(u),n.appendChild(s)}var y=Ze(e.merchantReply,t?function(){ve(e,t,r)}:null);return y&&(y.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(y)),n}var Br={card:et,list:rt,gallery:tt};function Mr(e){return Br[e]||Br.card}function ya(){return Object.keys(Br).map(function(e){return Br[e].css||""}).join(`
`)}var at=0;function Fe(){return at++,at}function Oe(e,r){return e!==at?!1:r?!(r.productId!==void 0&&F!==r.productId||r.orderBy!==void 0&&U!==r.orderBy||r.page!==void 0&&tr!==r.page||r.ratingFilter!==void 0&&J!==r.ratingFilter||r.hasImages!==void 0&&Z!==r.hasImages||r.nextCursor!==void 0&&vr!==r.nextCursor):!0}var nt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},it={small:80,medium:110,large:140},ot={small:80,medium:100,large:110};function wa(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),a.appendChild(n),a.appendChild(l);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(i),r}function za(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function be(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+a+","+n+","+l+","+r+")"}function _r(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function lt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function ka(e){return .2126*lt(e.r)+.7152*lt(e.g)+.0722*lt(e.b)}function Ca(e,r){var t=ka(e),a=ka(r),n=Math.max(t,a),l=Math.min(t,a);return(n+.05)/(l+.05)}function Cn(e){var r=_r(e)||_r("#ffffff"),t=_r("#111111"),a=_r("#ffffff");return Ca(t,r)>=Ca(a,r)?"#111111":"#ffffff"}function Sn(e){return be(e,e==="#ffffff"?.1:.06)}function Sa(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",p=be(o,.06),x=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",u=r.btnTextColor||"#ffffff",v=r.btnBorderColor||"#111111",y=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",b=r.filterBtnBorderColor||"#111111",m=r.filterMenuBgColor||"#ffffff",g=r.filterMenuBorderColor||"#e5e7eb",f=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",h=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",E=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",w=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",C=be(w,.65),L=r.replyBgColor||"#f9fafb",P=r.replyBorderColor||"#747474",S=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",Y=r.photoTitleColor||"#111111",G=be("#111111",.05),ee=r.photoArrowBgColor||"#ffffff",D=r.photoArrowTextColor||"#111111",O=be("#111111",.12),oe=r.formBgColor||"#ffffff",W=r.formPrimaryTextColor||"#111111",q=r.formSecondaryTextColor||"#3b3b3b",K=r.inputTextColor||W,ce=r.inputBorderColor||"#d1d5db",re=r.placeholderColor||"#9ca3af",j=r.formStepBarColor||"#111111",I=r.formBtnBgColor||"#111111",le=r.formBtnTextColor||"#ffffff",_=r.formBtnBorderColor||"#111111",H=be(I,.06),Te=be(I,.18),te=be(le,.85),$e=be(W,.06),ye=Cn(oe),B=Sn(ye),X=r.loadMoreBgColor||"#ffffff",we=r.loadMoreTextColor||"#111111",Ae=r.loadMoreBorderColor||"#111111",ur=r.paginationBgColor||"#ffffff",dr=r.paginationTextColor||"#111111",sr=r.paginationBorderColor||"#e5e7eb",Qe={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":p,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":u,"--renuvex-pr-btn-border":v,"--renuvex-pr-filter-btn-bg":y,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":b,"--renuvex-pr-filter-menu-bg":m,"--renuvex-pr-filter-menu-border":g,"--renuvex-pr-filter-item-text":f,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":h,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":E,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":w,"--renuvex-pr-review-border":T,"--renuvex-pr-state-text":C,"--renuvex-pr-review-star-color":x,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":P,"--renuvex-pr-reply-label":S,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":Y,"--renuvex-pr-photo-image-border":G,"--renuvex-pr-photo-arrow-bg":ee,"--renuvex-pr-photo-arrow-text":D,"--renuvex-pr-photo-arrow-border":O,"--renuvex-pr-fwizard-bg":oe,"--renuvex-pr-fwizard-text":W,"--renuvex-pr-fwizard-secondary-text":q,"--renuvex-pr-fwizard-input-bg":oe,"--renuvex-pr-fwizard-input-text":K,"--renuvex-pr-fwizard-input-border":ce,"--renuvex-pr-fwizard-placeholder":re,"--renuvex-pr-fwizard-close-text":ye,"--renuvex-pr-fwizard-close-hover-bg":B,"--renuvex-pr-fwizard-progress-bg":$e,"--renuvex-pr-fwizard-progress-active":j,"--renuvex-pr-fwizard-btn-bg":I,"--renuvex-pr-fwizard-btn-text":le,"--renuvex-pr-fwizard-btn-border":_,"--renuvex-pr-fwizard-btn-disabled-bg":Te,"--renuvex-pr-fwizard-btn-disabled-text":te,"--renuvex-pr-fwizard-nav-hover-bg":H,"--renuvex-pr-load-more-bg":X,"--renuvex-pr-load-more-text":we,"--renuvex-pr-load-more-border":Ae,"--renuvex-pr-pagination-bg":ur,"--renuvex-pr-pagination-text":dr,"--renuvex-pr-pagination-border":sr};Object.keys(Qe).forEach(function(pe){e.style.setProperty(pe,Qe[pe])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Ea(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,l=e.wireLightboxTrigger,o=(e.photoStripReviews||[]).filter(function(k){return Se(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&o.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=M(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),p=document.createElement("div");p.className="renuvex-pr-photo-title",p.textContent=d,i.appendChild(p)}var x=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",x);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var u=$,v=r.reviewLayout==="card"?$:Math.round($*4/3),y=0;o.forEach(function(k){if(!(y>=15)){var h=br(k);if(h){var z=document.createElement("img"),E=ue(h,$);z.src=E.src,z.srcset=E.srcset,z.loading=y<3?"eager":"lazy",z.decoding="async",z.width=u,z.height=v,z.className="renuvex-pr-photo-strip-thumb",z.alt="Yorum foto\u011Fraf\u0131",de(z),(function(A,w){l(z,function(){n(w,A,o)})})(h,k),s.appendChild(z),y++}}});var c=document.createElement("button");c.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var b=ne(De);b&&c.appendChild(b),c.setAttribute("aria-label","\xD6nceki"),c.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var g=ne(hr);g&&m.appendChild(g),m.setAttribute("aria-label","Sonraki"),m.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var f=document.createElement("div");return f.className="renuvex-pr-photo-strip-wrap",f.appendChild(c),f.appendChild(s),f.appendChild(m),i.appendChild(f),i}function Ta(e){var r=e.render;async function t(){var o=Fe(),i=F,d=U,p=J,x=Z;ke(null);var s=await Be(F,U,1,J,Z);Oe(o,{productId:i,orderBy:d,ratingFilter:p,hasImages:x})&&await r(F,R,s,Le,U,1,st)}async function a(o){var i=Fe(),d=J===o?null:o,p=F,x=U,s=Z;ct(d),Pe(1),ke(null);var u=await Be(F,U,1,d,Z);Oe(i,{productId:p,orderBy:x,page:1,ratingFilter:d,hasImages:s})&&await r(F,R,u,Le,U,1)}async function n(o,i){var d=Fe(),p=F,x=J;Pe(1),ke(null);var s=o,u=!1;i&&(u=!0,s="newest"),mt(u),cr(s);var v=await Be(F,s,1,J,u);Oe(d,{productId:p,orderBy:s,page:1,ratingFilter:x,hasImages:u})&&await r(F,R,v,Le,s,1)}async function l(o){var i=Fe(),d=F,p=U,x=J,s=Z;Pe(o),ke(null);var u=await Be(F,U,o,J,Z);if(Oe(i,{productId:d,orderBy:p,page:o,ratingFilter:x,hasImages:s})&&(await r(F,R,u,Le,U,o),typeof window!="undefined"&&!window.__ikasPreviewMode)){var v=document.getElementById("renuvex-reviews");v&&typeof v.scrollIntoView=="function"&&v.scrollIntoView({behavior:"smooth",block:"start"})}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:l}}var En=1,Tn=7,pt="\u2026";function An(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Tn){for(var n=[],l=1;l<=t;l++)n.push(l);return n}for(var o=[],i=1;i<=t;i++)(i===1||i===t||Math.abs(i-a)<=En)&&o.push(i);for(var d=[],p=0;p<o.length;p++)p>0&&o[p]-o[p-1]>1&&d.push(pt),d.push(o[p]);return d}function Aa(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function l(o,i,d,p){var x=document.createElement("button");return x.type="button",x.className="renuvex-pr-pagination-arrow",x.setAttribute("aria-label",o),x.textContent=i,p?x.disabled=!0:x.onclick=function(){a(d)},x}return n.appendChild(l("\xD6nceki sayfa","\u2039",t-1,t<=1)),An(t,r).forEach(function(o){if(o===pt){var i=document.createElement("span");i.className="renuvex-pr-pagination-gap",i.setAttribute("aria-hidden","true"),i.textContent=pt,n.appendChild(i);return}var d=document.createElement("button");d.type="button",d.className="renuvex-pr-pagination-btn",d.textContent=String(o),d.setAttribute("aria-label","Sayfa "+o),o===t?d.setAttribute("aria-current","page"):d.onclick=function(){a(o)},n.appendChild(d)}),n.appendChild(l("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Ln(){return Bt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Pn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=Rt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),It(t,{surface:"reviews",productId:r||""}),t}async function ut(e,r,t,a,n,l,o){if(kt){fr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:l,badgeSettings:o});return}xr(!0),xt(e),ft(r),o!==void 0&&gt(o),ht(a),n&&cr(n),l&&Pe(l),t!=null&&(bt(t),ke(t&&t.data?t.data.nextCursor:null));var i=Ta({render:ut});try{let ye=function(B,X){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var we=B.meta.sizeOverrides[X];we&&Object.keys(we).forEach(function(Ae){v.style.setProperty(Ae,we[Ae])})}};var $e=ye,d=Ir(r.summaryLayout),p=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),x=r.showTitle!==!1,s=M(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),u=p&&x?s:"",v=document.documentElement;Sa(v,r);var y=r.borderRadius!==void 0?r.borderRadius:8,c=nt[r.size]||nt.medium,b=it[r.thumbnailSize]||it.medium,m=b;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(m=ot[r.thumbnailSize]||ot.medium),v.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),v.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),v.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),v.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),v.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),v.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),v.style.setProperty("--renuvex-pr-radius",y+"px"),v.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),v.style.setProperty("--renuvex-pr-photo-title-size",c.photoTitleSize+"px"),v.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),v.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),v.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),v.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),v.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),v.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),v.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),v.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),v.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),v.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),v.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),v.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),v.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),v.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),v.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size",b+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size-mobile",m+"px");var g=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";v.style.setProperty("--renuvex-pr-review-star-color",g),v.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),v.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),ye(Ir(r.summaryLayout),r.size),ye(Mr(r.reviewLayout),r.size);var f=ar(r),k=Ln();if(!k)return;var h=Pn(k,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==h&&h.appendChild(z);var E=Mt(z),A=Ue+He+kr+fa()+ya();Ve(E,A);var w=Ft(E);if(r.enabled===!1){z.style.minHeight="auto",w.replaceChildren(wa(r.borderRadius!==void 0?r.borderRadius:8)),xr(!1);var T=mr;fr(null),T&&ut(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var C=t||{},L=Dr(C),P=L?[]:C.data&&C.data.reviews||[];yt(P),w.replaceChildren();var S=document.createElement("section");if(S.id="renuvex-reviews-widget",S.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),S.className="renuvex-pr-reviews-widget",S.setAttribute("data-renuvex-surface","reviews"),e&&S.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(S.style.width="100%",S.style.maxWidth="100%",S.style.marginLeft="0",S.style.marginRight="0"),u){var N=document.createElement("div"),Y=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+Y,N.textContent=u,S.appendChild(N)}if(L){S.appendChild(za(C.message,i.onRetry)),w.appendChild(S),Ne(E),Fr(S,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return E.getElementById("renuvex-reviews-widget")});return}var G=C.data&&C.data.allCount||0,ee=C.data&&C.data.ratingCounts||null,D=ee||[0,0,0,0,0],O=C.data&&C.data.avgRating||"0.0";if(!ee&&P.length>0){P.forEach(function(B){B.rating>=1&&B.rating<=5&&D[B.rating-1]++});var oe=P.reduce(function(B,X){return B+X.rating},0);O=(oe/P.length).toFixed(1)}if(G>0){var W=Ir(r.summaryLayout),q=W.render({widget:S,productId:e,data:C,settings:r,iconPair:f,allCount:G,ratingCounts:D,avgRatingVal:O,currentRatingFilter:J,currentOrderBy:U,currentHasImages:Z,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});S.appendChild(q)}else{var K=document.createElement("button");K.className="renuvex-pr-write-btn",K.style.cssText="display:block;margin:16px auto 0;",K.textContent=M(r.writeButtonText,"Yorum Yap"),K.onclick=V,S.appendChild(K)}var ce=Ea({settings:r,root:v,currentHasImages:Z,photoStripReviews:vt,openReviewModal:ve,wireLightboxTrigger:Ee});if(ce&&S.appendChild(ce),P.length===0){var re=document.createElement("p");re.className="renuvex-pr-state-msg",re.textContent="Hen\xFCz yorum yok.",S.appendChild(re)}else{var j=Mr(r.reviewLayout);P.forEach(function(B){S.appendChild(j.render(B,Or))})}var I=r.paginationMode==="numbered"?"numbered":"loadMore";if(I==="numbered"){var le=C.data&&C.data.totalPages||1;le>1&&S.appendChild(Aa({page:C.data&&C.data.page||tr||1,totalPages:le,onPageChange:i.onPageChange}))}var _=I==="loadMore"&&C.data&&C.data.hasMore;if(_){var H=document.createElement("button");H.className="renuvex-pr-load-more",H.textContent="Daha Fazla G\xF6ster",H.onclick=async function(){H.disabled=!0,H.textContent="Y\xFCkleniyor...";var B=Fe(),X=F,we=U,Ae=tr,ur=J,dr=Z,sr=vr,Qe=Ae+1,pe=await Be(X,we,Qe,ur,dr,null,sr);if(Oe(B,{productId:X,orderBy:we,page:Ae,ratingFilter:ur,hasImages:dr,nextCursor:sr}))if(pe&&!Dr(pe)&&pe.data&&Array.isArray(pe.data.reviews)){var dt=wt(pe.data.reviews);zt(dt),Pe(Qe),ke(pe.data.nextCursor||null);var La=Mr(R.reviewLayout);dt.forEach(function(Pa){S.insertBefore(La.render(Pa,Or),H)}),pe.data.hasMore?(H.disabled=!1,H.textContent="Daha Fazla G\xF6ster"):H.remove()}else H.disabled=!1,H.textContent="Tekrar Dene"},S.appendChild(H)}w.appendChild(S),Ne(E),Fr(S,"reviews-widget",{productId:e||""},function(){return E.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var Te=document.createElement("p");Te.style.cssText="text-align:center;color:#dc2626;",Te.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",w&&w.replaceChildren(Te)}}finally{if(xr(!1),mr){var te=mr;fr(null),ut(te.productId,te.settings,te.reviewsData,te.productName,te.orderBy,te.page,te.badgeSettings)}}}export{ut as render};
