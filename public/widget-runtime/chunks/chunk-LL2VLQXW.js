...
import{b as Xe}from"./chunk-Z7432DLE.js";import{a as ze,b as ni,c as ar,d as nr,e as oi,f as Ue,g as li}from"./chunk-VT5MVFWO.js";import{$ as xe,A as Gr,B as qr,C as Ur,D as Kr,E as Xr,F as Ze,G as $e,H as Qe,N as ye,O as W,P as G,Q as Ge,R as Jr,T as Zr,U as ue,V as we,W as $r,X as Qr,Y as fe,Z as ei,_ as ri,a as ge,aa as er,b as he,ba as j,c as be,ca as rr,da as ir,e as je,ea as hr,f as Ve,fa as br,g as _r,ga as ie,h as Te,ha as ii,i as Or,ia as te,j as Re,ja as ti,k as Be,ka as qe,l as K,la as ai,m as A,n as kr,na as tr,o as Ie,q as gr,r as Hr,s as We,t as Le,u as Je,v as Dr,w as Yr,x as jr,y as Vr,z as Wr}from"./chunk-73OPMLEB.js";var Vi=15,Wi=60*1e3,di="__ikrReviewsFetchError",yr={};function or(e){return{type:di,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function wr(e){return!!(e&&e.type===di)}async function Ne(e,r,i,t,a,o){if(window.__ikasPreviewMode){try{var s=window.__ikasPreviewBaseUrl||be,l=s+"/api/preview/reviews?page="+encodeURIComponent(i||1),c=await ze(l);if(c.ok)return await c.json()}catch(k){}return or()}r=r||"newest",i=i||1;var m=o?"_l"+o:"",v="ikr_reviews_"+he+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(a?"1":"0")+m,p=null,n=ti(v);if(n)try{var f=JSON.parse(n);if(f&&f.t!==void 0&&f.v){if(Date.now()-f.t<Wi)return f.v;p=f.v,qe(v,"")}else qe(v,"")}catch(k){qe(v,"")}try{var d=be+"/api/public/reviews?storeId="+encodeURIComponent(he)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(a?"&hasImages=true":"")+(o?"&limit="+encodeURIComponent(o):""),u=await ze(d);if(!u.ok)return p||or();var g=await u.json();return qe(v,JSON.stringify({t:Date.now(),v:g})),g}catch(k){return console.error("[ikr] fetchReviews error:",k),p||or()}}async function Gi(e){var r=await Ne(e,"newest",1,null,!0,Vi);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function Xt(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!yr[e]){yr[e]=!0;var a={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},o={enabled:!0,size:"medium"};try{var s=await ni();if(!s)return;var l=s.widgets&&s.widgets.reviews||a,c=s.widgets&&s.widgets.badge||o;if(l.enabled===!1)return;We("newest"),Le(1),Je(null);var m=await Promise.all([Ne(e,"newest",1,null),Gi(e)]),v=m[0];qr(m[1]),await Ce(e,l,v,r,"newest",1,c)}catch(p){console.error("[ikr] bootstrap error:",p),await Ce(e,a,or(),r,void 0,void 0,o)}finally{delete yr[e]}}}function Me(e){return xe(e)}function qi(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ae(e,r,i,t){i?e.setProperty(r,i,t||""):e.removeProperty(r)}function Ui(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",i=navigator.maxTouchPoints||0,t=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&i>1;return t&&/AppleWebKit/i.test(r)}function Ki(){var e=qi(),r=document.body.style,i=document.documentElement.style,t=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",o=Ui()&&!a;if(t>0){var s=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",s+t+"px","important")}return i.setProperty("overflow","hidden","important"),i.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important")),e}function Xi(e){if(e){var r=document.body.style,i=document.documentElement.style;ae(i,"overflow",e.rootOverflow,e.rootOverflowPriority),ae(i,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ae(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ae(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ae(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ae(r,"position",e.bodyPosition,e.bodyPositionPriority),ae(r,"top",e.bodyTop,e.bodyTopPriority),ae(r,"left",e.bodyLeft,e.bodyLeftPriority),ae(r,"right",e.bodyRight,e.bodyRightPriority),ae(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}}function Ji(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function Fe(e){if(!(!e||!document.contains(e)||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(i){}}}function Zi(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function ci(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Zi)}function pi(e){var r=ci(e),i=r[0]||e.querySelector('[role="dialog"]')||e;Fe(i)}function $i(e,r){if(e.key==="Tab"){var i=ci(r);if(!i.length){e.preventDefault(),pi(r);return}var t=i[0],a=i[i.length-1],o=document.activeElement;if(!r.contains(o)){e.preventDefault(),Fe(t);return}e.shiftKey&&o===t?(e.preventDefault(),Fe(a)):!e.shiftKey&&o===a&&(e.preventDefault(),Fe(t))}}function Qi(){var e={id:"ikr-modal-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state,history.pushState({ikrModal:e.id},"",e.url),e.pushed=!0}catch(r){}return e}function et(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state.ikrModal===e.id)}function rt(e){if(et(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function si(e,r,i,t,a){Xi(t),document.removeEventListener("keydown",r),window.removeEventListener("popstate",i),e.parentNode&&e.parentNode.removeChild(e),Fe(a)}function it(e){var r=document.createElement("div");r.className="ikr-modal-right";var i=document.createElement("div");i.className="ikr-modal-scroll-content";var t=document.createElement("div");t.className="ikr-modal-top-row";var a=document.createElement("div");a.className="ikr-modal-stars",a.innerHTML=ue(e.rating,A);var o=document.createElement("span");o.className="ikr-modal-date",o.textContent=fe(e.createdAt),t.appendChild(a),t.appendChild(o),i.appendChild(t);var s=document.createElement("div");s.className="ikr-modal-title",s.textContent=e.title||"",s.style.display=e.title?"":"none",i.appendChild(s);var l=document.createElement("div");l.className="ikr-modal-author",l.textContent=e.author||"",i.appendChild(l);var c=document.createElement("div");c.className="ikr-modal-body",c.textContent=(e.comment||"").trim(),c.style.display=e.comment&&e.comment.trim()?"":"none",i.appendChild(c);var m=document.createElement("div");m.className="ikr-modal-reply";var v=document.createElement("div");v.className="ikr-modal-reply-label",v.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var p=document.createElement("div");return p.className="ikr-modal-reply-text",p.textContent=e.merchantReply||"",m.appendChild(v),m.appendChild(p),m.style.display=e.merchantReply?"":"none",i.appendChild(m),r.appendChild(i),r}function mi(e,r,i){var t=i||A,a=e.querySelector(".ikr-modal-scroll-content"),o=a.querySelector(".ikr-modal-stars");o.innerHTML=ue(r.rating,t),a.querySelector(".ikr-modal-date").textContent=fe(r.createdAt);var s=a.querySelector(".ikr-modal-title");s.textContent=r.title||"",s.style.display=r.title?"":"none",a.querySelector(".ikr-modal-author").textContent=r.author||"";var l=a.querySelector(".ikr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var c=a.querySelector(".ikr-modal-reply");c.querySelector(".ikr-modal-reply-label").textContent=t&&t.merchantReplyLabel||"Ma\u011Faza Sahibi",c.querySelector(".ikr-modal-reply-text").textContent=r.merchantReply||"",c.style.display=r.merchantReply?"":"none",e.scrollTop=0}function zr(e,r,i,t,a,o,s,l,c){var m=Me(e),v=Math.max(0,Math.min(i||0,m.length-1)),p=document.createElement("div");p.className="ikr-modal-left";var n=document.createElement("img"),f=s==="next"?"ikr-modal-img-enter-right":s==="prev"?"ikr-modal-img-enter-left":"";n.className="ikr-modal-main-img"+(f?" "+f:""),n.src=br(m[v]||""),n.decoding="async",n.width=hr,n.height=Math.round(hr*4/3),n.alt="Yorum foto\u011Fraf\u0131",ii(n,function(S){if(S.style.display="none",!p.querySelector(".ikr-modal-img-error")){var T=document.createElement("div");T.className="ikr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(T,S)}}),p.appendChild(n);var d=document.createElement("button");d.className="ikr-modal-close-mobile",d.textContent="\u2715",d.setAttribute("aria-label","Kapat"),d.onclick=function(S){S.stopPropagation(),o()},p.appendChild(d);var u=0;if(p.addEventListener("touchstart",function(S){u=S.touches[0].clientX},{passive:!0}),p.addEventListener("touchend",function(S){var T=u-S.changedTouches[0].clientX;if(!(Math.abs(T)<50)){if(T>0){if(x)ve(e,r,v+1,t,a,o,!0,"next",l,c);else if(h){var y=t[r+1];ve(y,r+1,0,t,a,o,!1,"next",l,c)}}else if(k)ve(e,r,v-1,t,a,o,!0,"prev",l,c);else if(z){var L=t[r-1],P=Me(L);ve(L,r-1,P.length-1,t,a,o,!1,"prev",l,c)}}},{passive:!0}),m.length>1){var g=document.createElement("div");g.className="ikr-modal-thumbs",m.forEach(function(S,T){var y=document.createElement("img"),L=ie(S,ir);y.src=L.src,y.srcset=L.srcset,y.loading="lazy",y.decoding="async",y.width=ir,y.height=ir,y.className="ikr-modal-thumb"+(T===v?" ikr-modal-thumb-active":""),y.alt="K\xFC\xE7\xFCk resim "+(T+1),te(y),y.tabIndex=0,y.setAttribute("role","button"),y.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(T+1)+" se\xE7"),T===v&&y.setAttribute("aria-current","true"),(function(P){function N(){ve(e,r,P,t,a,o,!0,null,l,c)}y.onclick=N,y.onkeydown=function(M){(M.key==="Enter"||M.key===" ")&&(M.preventDefault(),N())}})(T),g.appendChild(y)}),p.appendChild(g)}var k=v>0,x=v<m.length-1,z=r>0,h=r<t.length-1,E=k||z,w=x||h;if(E){var b=document.createElement("button");b.className="ikr-modal-nav ikr-modal-nav-prev",b.innerHTML="&#8249;",b.setAttribute("aria-label","\xD6nceki"),b.onclick=function(S){if(S.stopPropagation(),k)ve(e,r,v-1,t,a,o,!0,"prev",l,c);else if(z){var T=t[r-1],y=Me(T);ve(T,r-1,y.length-1,t,a,o,!1,"prev",l,c)}},p.appendChild(b)}if(w){var C=document.createElement("button");C.className="ikr-modal-nav ikr-modal-nav-next",C.innerHTML="&#8250;",C.setAttribute("aria-label","Sonraki"),C.onclick=function(S){if(S.stopPropagation(),x)ve(e,r,v+1,t,a,o,!0,"next",l,c);else if(h){var T=t[r+1];ve(T,r+1,0,t,a,o,!1,"next",l,c)}},p.appendChild(C)}return p}function ui(e,r){[-1,1].forEach(function(i){var t=r[e+i];if(t){var a=Me(t);a[0]&&(new Image().src=br(a[0]))}})}function xr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function tt(e,r){var i=e&&e.querySelector(".ikr-modal-wrap"),t=r&&r.querySelector(".ikr-modal-right"),a=r&&r.querySelector(".ikr-modal-scroll-content");function o(){xr(i),xr(t),xr(a)}o(),i&&Fe(i),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function ve(e,r,i,t,a,o,s,l,c,m){if(m&&(m.currentReview=e),s){var v=zr(e,r,i,t,a,o,l,c,m);a.firstChild&&a.replaceChild(v,a.firstChild)}else{var v=zr(e,r,i,t,a,o,l,c,m),p=a.querySelector(".ikr-modal-right");a.firstChild&&a.replaceChild(v,a.firstChild),p&&mi(p,e,m&&m.currentSettings),tt(c,a)}ui(r,t)}function ne(e,r,i){var t=Me(e);if(!t.length)return;var a=(i||[]).filter(function(h){return Me(h).length>0}),o=a.findIndex(function(h){return h===e||h.id===e.id});o===-1&&(a.unshift(e),o=0);var s=t.indexOf(r);s<0&&(s=0);var l=document.createElement("div");l.className="ikr-modal-overlay";var c=document.createElement("div");c.className="ikr-modal";var m=!1,v=Ji(),p=Ki(),n=Qi(),f={currentReview:e,currentSettings:A};function d(h){var E=h&&h.detail&&h.detail.settings;f.currentSettings=E||A;var w=c.querySelector(".ikr-modal-right");!w||!f.currentReview||mi(w,f.currentReview,f.currentSettings)}function u(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),si(l,g,u,p,v))}function g(h){if(h.key==="Escape"){k();return}$i(h,l)}function k(){m||(m=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),si(l,g,u,p,v),rt(n))}document.addEventListener("keydown",g),window.addEventListener("popstate",u),window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",d),l.onclick=function(){k()},c.onclick=function(h){h.stopPropagation()},c.appendChild(zr(e,o,s,a,c,k,null,l,f)),c.appendChild(it(e)),ui(o,a);var x=document.createElement("div");x.className="ikr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(c);var z=document.createElement("button");z.className="ikr-modal-close",z.textContent="\u2715",z.setAttribute("aria-label","Kapat"),z.onclick=function(h){h.stopPropagation(),k()},x.appendChild(z),l.appendChild(x),document.body.appendChild(l),pi(l)}function fi(e){var r=tr();if(r&&typeof r.findProductTitle=="function")try{var i=r.findProductTitle(e);if(i)return i}catch(s){}if(e)for(var t=document.querySelectorAll("h1,h2,h3,h4,h5,h6,div,span,p"),a=0;a<t.length;a++){var o=t[a];if(o.children.length===0&&o.textContent.trim()===e&&o.tagName!=="TITLE"&&!o.closest("[data-ikr-listing-badge]")&&!o.closest("[data-renuvex-slot]")&&!o.closest("#ikas-reviews")&&!o.closest("nav")&&!o.closest("header")&&!o.closest('[class*="breadcrumb"]')&&!o.closest('[aria-label*="breadcrumb"]'))return o}return document.querySelector("h1")}function vi(e){return!e||!e.parentNode?null:{parent:e.parentNode,anchorEl:e,position:"after"}}function Cr(e){return!e||!e.parent?null:e.position==="after"&&e.anchorEl?{parent:e.parent,anchorEl:e.anchorEl,position:"after"}:{parent:e.parent,beforeEl:e.beforeEl||null,position:"before"}}function ki(e,r){var i=Cr(r);return!e||!i||e.parentNode!==i.parent?!1:i.position==="after"?i.anchorEl&&i.anchorEl.parentNode===i.parent&&i.anchorEl.nextSibling===e:i.beforeEl&&i.beforeEl.parentNode===i.parent?e.nextSibling===i.beforeEl:e.nextSibling===null}function Sr(e,r){var i=Cr(r);if(!e||!i||!i.parent||ki(e,i))return!1;if(i.position==="after")return!i.anchorEl||i.anchorEl.parentNode!==i.parent?!1:(i.parent.insertBefore(e,i.anchorEl.nextSibling||null),!0);var t=i.beforeEl&&i.beforeEl.parentNode===i.parent?i.beforeEl:null;return i.parent.insertBefore(e,t),!0}function gi(e,r,i){i=i||{};var t=Cr(r);if(typeof MutationObserver=="undefined"||!e||!t||!t.parent)return null;var a=0,o=!1,s=typeof i.maxCorrections=="number"?i.maxCorrections:3,l=typeof i.durationMs=="number"?i.durationMs:15e3,c=i.surface||"owned-slot",m=i.reason||"position_reanchored",v=i.message||"Owned storefront slot reordered after render",p=i.extra||{},n=new MutationObserver(function(){if(!e.isConnected||!t.parent.isConnected){n.disconnect();return}if(t.position==="after"&&(!t.anchorEl||!t.anchorEl.isConnected||t.anchorEl.parentNode!==t.parent)){n.disconnect();return}ki(e,t)||(a+=1,Sr(e,t),o||(o=!0,je("dom-conflict",v,Object.assign({surface:c,reason:m},p))),a>=s&&n.disconnect())});return n.observe(t.parent,{childList:!0}),setTimeout(function(){n.disconnect()},l),n}var lr=null,dr=null;function at(e,r){return we(e,r)}function nt(e){var r=tr();if(r&&typeof r.getProductBadgeMountPoint=="function")try{var i=r.getProductBadgeMountPoint(e);if(i&&i.parent)return i}catch(t){}return vi(e)}function Er(e,r,i,t,a,o,s){lr&&(lr.disconnect(),lr=null),dr&&(dr.disconnect(),dr=null),oi("product-title-rating","product-title-badge");var l=document.querySelector(".ikr-rating-badge--pdp");if(l&&l.remove(),!!e&&!(t&&t.enabled===!1)){var c=document.getElementById("ikr-jsonld");c&&c.remove();var m=document.createElement("script");m.id="ikr-jsonld",m.type="application/ld+json",m.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Product",name:i||document.title,url:window.location.href,aggregateRating:{"@type":"AggregateRating",ratingValue:e,reviewCount:r,bestRating:"5",worstRating:"1"}}),document.head.appendChild(m);var v=fi(i);if(!v||!v.parentNode){je("dom-conflict","PDP product title could not be found for badge placement",{surface:"pdp-badge",reason:"title_not_found",productName:i||"",productId:o||""});return}var p=nt(v);if(!p||!p.parent){je("dom-conflict","PDP badge mount point could not be resolved",{surface:"pdp-badge",reason:"mount_not_found",productName:i||"",productId:o||""});return}var n=t&&t.size||"medium",f=Ue[n]||Ue.medium,d=null;if(t&&t.mobileOverride===!0){var u=t.mobileSize||"small";d=Ue[u]||Ue.small}li(f,d);var g=ar({slot:"product-title-rating",legacySlot:"product-title-badge",className:"renuvex-pr-product-badge-slot ikr-product-badge-slot",context:{surface:"pdp",productId:o||""}}),k=document.createElement("a");k.className="renuvex-pr-rating-badge ikr-rating-badge ikr-rating-badge--pdp",k.href="#ikas-reviews";var x=$r(e,r);k.setAttribute("aria-labelledby",x.id),k.setAttribute("data-ikr-surface","pdp"),k.setAttribute("data-renuvex-surface","pdp"),k.setAttribute("data-ikr-rating",String(e)),k.setAttribute("data-renuvex-rating",String(e)),k.setAttribute("data-ikr-count",String(r)),k.setAttribute("data-renuvex-count",String(r)),nr(k,{surface:"pdp",productId:o||""});var z=window.getComputedStyle(v).textAlign,h=z==="center"?"center":z==="right"?"right":"left";k.setAttribute("data-ikr-align",h),k.insertAdjacentHTML("beforeend",x.html+at(e,a));var E=document.createElement("span");E.className="ikr-rating-badge__label",E.textContent=e+" ("+r+" yorum)",k.appendChild(E),k.onclick=function(w){w.preventDefault();var b=document.getElementById("ikas-reviews-widget")||document.getElementById("ikas-reviews");if(b){var C=document.querySelector("header"),S=C?C.getBoundingClientRect().height:0,T=b.getBoundingClientRect().top+window.pageYOffset-S-16;window.scrollTo({top:T,behavior:"smooth"})}},g.appendChild(k),Sr(g,p),dr=gi(g,p,{surface:"pdp-badge",reason:"position_reanchored",message:"PDP badge slot reordered after render",extra:{productName:i||"",productId:o||""}}),Ve(g,"pdp-badge",{productName:i||"",productId:o||""}),s||(lr=_r(g,"pdp-badge",function(){Er(e,r,i,t,a,o,!0)},{productName:i||"",productId:o||""}))}}var hi=`
...
`;var Nr={};ge(Nr,{meta:()=>vt,render:()=>kt});function _e(e){var r=e.ratingCounts,i=e.allCount,t=e.iconPair,a=e.currentRatingFilter,o=e.onFilterChange;ye(t);var s=document.createElement("div");s.className="ikr-summary-block ikr-summary-bars";for(var l=5;l>=1;l--){var c=r[l-1]||0,m=i>0?Math.round(c/i*100):0,v=a===l,p=document.createElement("div");p.className="ikr-bar-row"+(v?" ikr-bar-active":""),a&&!v&&(p.style.opacity="0.35");for(var n="",f=1;f<=5;f++){var d=f<=l;n+='<span class="ikr-bar-star ikr-icon '+(d?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+W(d?"full":"outline")+"</span>"}p.innerHTML='<span class="ikr-bar-label">'+n+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+m+'%;"></div></div><span class="ikr-bar-count">('+c.toLocaleString("tr-TR")+")</span>",(function(u){p.onclick=function(){o(u)}})(l),s.appendChild(p)}return s}var oe=[],bi=!1;function ot(e){for(var r=oe.length-1;r>=0;r--){var i=oe[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function lt(e){if(e.key==="Escape")for(var r=oe.length-1;r>=0;r--)oe[r].close()}function dt(){bi||typeof document=="undefined"||(document.addEventListener("click",ot,!0),document.addEventListener("keydown",lt),bi=!0)}function sr(e){for(var r=0;r<oe.length;r++)oe[r]!==e&&oe[r].close()}function cr(e){dt();var r={trigger:e.trigger,element:e.element,close:e.close};return oe.push(r),function(){var t=oe.indexOf(r);t!==-1&&oe.splice(t,1)}}function X(e){var r=e.widget,i=e.currentOrderBy,t=e.currentHasImages,a=e.onWriteClick,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary-block ikr-summary-actions";var l=document.createElement("button");l.className="ikr-write-btn",l.textContent=A&&A.writeButtonText||"Yorum Yap",l.onclick=a,s.appendChild(l);var c=document.createElement("div");c.className="ikr-filter-wrap";var m=document.createElement("button");m.type="button",m.className="ikr-filter-btn",m.setAttribute("aria-label","Filtrele"),m.setAttribute("aria-haspopup","menu"),m.setAttribute("aria-expanded","false");var v=A&&A.filterIcon||"lines";m.innerHTML=G(Jr(v));var p=document.createElement("div");p.className="ikr-filter-menu",p.setAttribute("role","menu");var n=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],f=!1;function d(k){var x=p.classList.contains("ikr-open");p.classList.remove("ikr-open"),m.classList.remove("ikr-filter-btn-active"),m.setAttribute("aria-expanded","false");var z=k&&(k.restoreFocus===!0||k.restoreFocus==="auto"&&Xe());if(x&&z)try{m.focus({preventScroll:!0})}catch(h){try{m.focus()}catch(E){}}}function u(){sr(g),p.classList.add("ikr-open"),m.classList.add("ikr-filter-btn-active"),m.setAttribute("aria-expanded","true");var k=p.querySelector(".ikr-filter-item-active")||p.querySelector(".ikr-filter-item");k&&requestAnimationFrame(function(){try{k.focus({preventScroll:!0})}catch(x){try{k.focus()}catch(z){}}})}n.forEach(function(k){var x=k[2],z=x?t:!t&&(i||"newest")===k[0],h=document.createElement("button");h.type="button",h.className="ikr-filter-item"+(z?" ikr-filter-item-active":""),h.setAttribute("role","menuitem"),h.textContent=k[1];var E=!1;function w(b,C){b&&(b.preventDefault(),b.stopPropagation()),!E&&(E=!0,f=!0,d({restoreFocus:C}),o(k[0],x),setTimeout(function(){E=!1,f=!1},0))}h.addEventListener("pointerdown",function(b){b.button!==void 0&&b.button!==0||w(b,!1)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){w(b,!1)},{passive:!1}),h.addEventListener("mousedown",function(b){b.button!==void 0&&b.button!==0||w(b,!1)}),h.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&w(b,!0)}),h.onclick=function(b){w(b,!1)},p.appendChild(h)}),m.onclick=function(){p.classList.contains("ikr-open")?d({restoreFocus:"auto"}):u()},c.addEventListener("keydown",function(k){k.key==="Escape"&&p.classList.contains("ikr-open")&&(k.stopPropagation(),d({restoreFocus:!0}))}),c.addEventListener("focusout",function(k){if(p.classList.contains("ikr-open")&&!f){var x=k.relatedTarget;x&&c.contains(x)||d()}});var g=cr({trigger:c,element:p,close:d});return c.appendChild(m),c.appendChild(p),s.appendChild(c),s}function yi(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,t=document.createElement("div");t.className="ikr-fwizard-overlay",t.tabIndex=-1,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Yorum yapma formu");var a=document.createElement("div");a.className="ikr-fwizard",t.appendChild(a);var o=document.createElement("button");o.className="ikr-fwizard-close",o.type="button",o.setAttribute("aria-label","Kapat"),o.innerHTML=G('<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>'),a.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-content",a.appendChild(s);var l=!1,c=null,m=!1,v="",p="";function n(){var y=document.activeElement;return!y||y===document.body||y===document.documentElement?null:y}function f(y){if(!(!y||!document.contains(y)||typeof y.focus!="function"))try{y.focus({preventScroll:!0})}catch(L){try{y.focus()}catch(P){}}}function d(y){if(!y||y.disabled||y.getAttribute("aria-hidden")==="true")return!1;var L=window.getComputedStyle?window.getComputedStyle(y):null;return L&&(L.display==="none"||L.visibility==="hidden")?!1:!!(y.offsetWidth||y.offsetHeight||y.getClientRects().length)}function u(y){var L=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(y.querySelectorAll(L)).filter(d)}function g(){var y=u(s),L=u(t),P=y[0]||L[0]||t;f(P)}function k(y){if(y.key==="Tab"){var L=u(t);if(!L.length){y.preventDefault(),f(t);return}var P=L[0],N=L[L.length-1],M=document.activeElement;if(!t.contains(M)){y.preventDefault(),f(P);return}y.shiftKey&&M===P?(y.preventDefault(),f(N)):!y.shiftKey&&M===N&&(y.preventDefault(),f(P))}}function x(){var y=window.innerWidth-document.documentElement.clientWidth;v=document.body.style.overflow,p=document.body.style.paddingRight,document.body.style.overflow="hidden",y>0&&(document.body.style.paddingRight=y+"px")}function z(){document.body.style.overflow=v,document.body.style.paddingRight=p}function h(){l||(l=!0,document.removeEventListener("keydown",E),t.removeEventListener("click",w),o.removeEventListener("click",h),t.classList.remove("ikr-fwizard-open"),setTimeout(function(){t.parentNode&&t.parentNode.removeChild(t),z(),m&&f(c);try{r()}catch(y){}},200))}function E(y){if(y.key==="Escape"){h();return}k(y)}function w(y){y.target===t&&i&&h()}document.addEventListener("keydown",E),t.addEventListener("click",w),o.addEventListener("click",h);function b(y){c=n(),m=Xe(),y&&s.appendChild(y),document.body.appendChild(t),x(),requestAnimationFrame(function(){t.classList.add("ikr-fwizard-open"),g()})}var C=null,S=null;function T(y,L){if(L=L||"error",C){try{C.remove()}catch(P){}C=null}S&&(clearTimeout(S),S=null),C=document.createElement("div"),C.className="ikr-fwizard-toast ikr-fwizard-toast--"+L,C.textContent=y,a.appendChild(C),S=setTimeout(function(){C&&(C.classList.add("ikr-fwizard-toast--exit"),setTimeout(function(){if(C){try{C.remove()}catch(P){}C=null}},300))},4e3)}return{open:b,close:h,content:s,setAllowOutsideClose:function(y){i=!!y},setStepAttr:function(y){a.setAttribute("data-step",String(y))},focusFirstControl:g,showToast:T}}var wi=`
...
`;var Tr=4;function Oe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function xi(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function t(){r.forEach(function(a){try{a(i)}catch(o){}})}return{get:function(){return i},set:function(a){Object.assign(i,a),t()},goNext:function(){i.currentStep<Tr&&(i.currentStep+=1,t())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,t())},onChange:function(a){return r.push(a),function(){r=r.filter(function(o){return o!==a})}}}}var st='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function zi(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],t=e.onBack||function(){},a=e.onSkip||function(){},o=e.onNext||function(){},s=document.createElement("div");s.className="ikr-fwizard-footer";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",l.setAttribute("aria-label","Geri"),l.innerHTML=G(st)+"<span>Geri</span>",l.addEventListener("click",function(){t()}),s.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-footer-progress";for(var m=[],v=0;v<Tr;v++){var p=document.createElement("span");p.className="ikr-fwizard-progress-seg",c.appendChild(p),m.push(p)}s.appendChild(c);var n=document.createElement("button");n.type="button";var f=null;function d(g){f&&n.removeEventListener("click",f),f=g,g&&n.addEventListener("click",g)}s.appendChild(n);function u(g,k){var x=r.indexOf(g)!==-1,z=i.indexOf(g)!==-1,h=k&&(k.images&&k.images.length>0||k.pendingImages&&k.pendingImages.length>0);if(x)g===2&&h?(n.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",n.setAttribute("aria-label","Devam Et"),n.innerHTML="Devam Et",d(function(){o()})):(n.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",n.setAttribute("aria-label","Atla"),n.innerHTML="<span>Atla</span>",d(function(){a()})),n.disabled=!1,n.classList.remove("ikr-fwizard-cta-btn--disabled"),n.style.visibility="",n.tabIndex=0;else if(z){n.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",n.setAttribute("aria-label","Sonraki"),n.innerHTML="Sonraki",n.style.visibility="",n.tabIndex=0;var E=Oe(g,k);n.disabled=!E,n.classList.toggle("ikr-fwizard-cta-btn--disabled",!E),d(function(){n.disabled||o()})}else n.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",n.innerHTML="",n.style.visibility="hidden",n.tabIndex=-1,n.disabled=!0,d(null)}return{el:s,update:function(g,k){m.forEach(function(z,h){h+1<=g?z.classList.add("ikr-fwizard-progress-seg-active"):z.classList.remove("ikr-fwizard-progress-seg-active")});var x=g<=1;l.style.visibility=x?"hidden":"",l.style.pointerEvents=x?"none":"",l.tabIndex=x?-1:0,u(g,k)},setNextDisabled:function(g){n.classList.contains("ikr-fwizard-cta-btn")&&(n.disabled=!!g,n.classList.toggle("ikr-fwizard-cta-btn--disabled",!!g))},setThanksState:function(g){l.style.visibility="hidden",c.style.visibility="hidden",n.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",n.setAttribute("aria-label","Devam Et"),n.innerHTML="Devam Et",n.style.visibility="",n.disabled=!1,n.classList.remove("ikr-fwizard-cta-btn--disabled"),d(g)}}}function Ci(e,r){r=r||{};var i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-rating";var t=!1,a=null,o=document.createElement("div");o.className="ikr-fwizard-step-title",o.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",i.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-stars",s.setAttribute("role","radiogroup"),s.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var l=Ge(A||{});ye(l);var c=[];function m(f){c.forEach(function(d,u){var g=u<f;d.classList.toggle("ikr-fwizard-star-active",g),d.setAttribute("aria-checked",u+1===f?"true":"false"),d.innerHTML=g?W("full"):W("outline")})}function v(f,d){d&&typeof d.preventDefault=="function"&&d.preventDefault(),d&&typeof d.stopPropagation=="function"&&d.stopPropagation(),!t&&(t=!0,e.set({rating:f}),m(f),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var p=1;p<=5;p++)(function(f){var d=document.createElement("button");d.type="button",d.className="ikr-fwizard-star",d.setAttribute("role","radio"),d.setAttribute("aria-label",f+" y\u0131ld\u0131z"),d.innerHTML=W("outline"),d.addEventListener("mouseenter",function(){m(f)}),d.addEventListener("mouseleave",function(){m(e.get().rating)}),d.addEventListener("pointerdown",function(u){u.button&&u.button!==0||v(f,u)}),typeof window!="undefined"&&!window.PointerEvent&&d.addEventListener("touchstart",function(u){v(f,u)},{passive:!1}),d.addEventListener("mousedown",function(u){window.PointerEvent||v(f,u)}),d.addEventListener("keydown",function(u){(u.key==="Enter"||u.key===" ")&&v(f,u)}),d.addEventListener("click",function(u){v(f,u)}),c.push(d),s.appendChild(d)})(p);m(e.get().rating);var n=function(f){var d=f&&f.detail&&f.detail.settings;l=Ge(d||A||{}),m(e.get().rating)};return window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",n),i.appendChild(s),{el:i,destroy:function(){a&&clearTimeout(a),window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",n)}}}var Si=3,ct=10*1024*1024;function Ei(e,r){r=r||{};var i=!1,t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-photos";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",t.appendChild(a);var o=document.createElement("div");o.className="ikr-fwizard-step-subtitle",o.textContent="Foto\u011Fraf ekleyebilirsiniz.",t.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-photo-card";var l=document.createElement("button");l.type="button",l.className="ikr-fwizard-photo-add",l.setAttribute("aria-label","Foto\u011Fraf ekle"),l.innerHTML=G('<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>')+"<span>Foto\u011Fraf Ekle</span>";var c=document.createElement("input");c.type="file",c.accept="image/*",c.multiple=!0,c.style.display="none",s.appendChild(l),s.appendChild(c);var m=document.createElement("div");m.className="ikr-fwizard-photo-previews",m.setAttribute("aria-live","polite"),s.appendChild(m),t.appendChild(s);var v=r.blobMap||{},p=r.urlToFinger||{};function n(){if(!i){var z=e.get().images||[],h=e.get().pendingImages||[],E=z.map(function(w){return{url:w,isPending:!1}}).concat(h.map(function(w){return{url:w.url,file:w.file,isPending:!0,error:w.error}}));m.innerHTML="",E.forEach(function(w){var b=v[w.url]||w.url,C=f(w,b);m.appendChild(C)}),k()}}function f(z,h){var E=document.createElement("div");E.className="ikr-fwizard-photo-thumb";var w=document.createElement("img");w.src=h,w.alt="",w.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",E.appendChild(w);var b=document.createElement("div");b.className="ikr-fwizard-photo-loading",b.style.display="none",E.appendChild(b);var C=document.createElement("button");return C.type="button",C.className="ikr-fwizard-photo-remove",C.innerHTML="&#x2715;",E.appendChild(C),d(E,z,h),E}function d(z,h,E){var w=z.querySelector("img");w.src!==E&&(w.src=E);var b=z.querySelector(".ikr-fwizard-photo-loading");h.isPending&&h.error?(b.style.display="flex",b.innerHTML='<span class="ikr-upload-error">\u2717 '+h.error+"</span>"):b.style.display="none";var C=z.querySelector(".ikr-fwizard-photo-remove");C.onclick=function(){var S=p[h.url]||(h.file?h.file.name+"_"+h.file.size:null);if(h.url.startsWith("blob:")&&URL.revokeObjectURL(h.url),S){var T=(e.get().fingerprints||[]).filter(function(P){return P!==S});e.set({fingerprints:T})}if(h.isPending){var y=(e.get().pendingImages||[]).filter(function(P){return P.url!==h.url});e.set({pendingImages:y})}else{var L=(e.get().images||[]).filter(function(P){return P!==h.url});e.set({images:L})}}}var u='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',g='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function k(){var z=(e.get().images||[]).length,h=(e.get().pendingImages||[]).length,E=z+h,w=E>=Si;E>0?(s.classList.add("ikr-fwizard-photo-card--compact"),l.innerHTML=G(g)):(s.classList.remove("ikr-fwizard-photo-card--compact"),l.innerHTML=G(u)+"<span>Foto\u011Fraf Ekle</span>"),w?(l.style.display="none",l.disabled=!0,c.disabled=!0):(l.style.display="flex",l.disabled=!1,c.disabled=!1,l.classList.remove("ikr-fwizard-photo-add--disabled"))}l.addEventListener("click",function(){c.disabled||c.click()}),c.onchange=async function(z){var h=(e.get().images||[]).length+(e.get().pendingImages||[]).length,E=Array.from(z.target.files).slice(0,Si-h);c.value="";var w=(e.get().pendingImages||[]).length,b=e.get().images||[],C=b.length;if(E.length!==0){for(var S=[],T=[],y=0;y<E.length;y++){var L=E[y],P=L.name+"_"+L.size,N=(e.get().fingerprints||[]).some(function(F){return F===P})||S.some(function(F){return F.file.name+"_"+F.file.size===P});if(N){console.log("[ikr] Duplicate file detected, skipping:",L.name);continue}if(L.size>ct){var M="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(M,"error"):alert(M);continue}var J=URL.createObjectURL(L);p[J]=P,S.push({url:J,file:L,error:null}),T.push({url:J,file:L});var Z=(e.get().fingerprints||[]).slice();Z.push(P),e.set({fingerprints:Z})}if(S.length!==0){var le=(e.get().pendingImages||[]).concat(S),q=async function(){for(var F=0;F<T.length;F++){var Ae=T[F],De=Ae.file,H=Ae.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Se=(e.get().pendingImages||[]).filter(function(O){return O.url!==H}),de=(e.get().images||[]).slice();de.push(H),e.set({pendingImages:Se,images:de});continue}try{var se=await ze(be+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:he})});if(!se.ok)throw se.status===429?new Error("rate_limit"):new Error("sign failed");var Y=await se.json();if(!Y.folder)throw new Error("sign folder missing");var $=new FormData;$.append("file",De),$.append("api_key",Y.api_key),$.append("timestamp",Y.timestamp),$.append("signature",Y.signature),$.append("folder",Y.folder);var ce=await fetch("https://api.cloudinary.com/v1_1/"+Y.cloud_name+"/image/upload",{method:"POST",body:$}),Q=await ce.json();if(Q.secure_url&&ri(Q.secure_url)){var Ye=(e.get().pendingImages||[]).some(function(O){return O.url===H});if(!Ye){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}v[Q.secure_url]=H,p[Q.secure_url]=p[H];var ke=(e.get().pendingImages||[]).filter(function(O){return O.url!==H}),ee=(e.get().images||[]).slice();ee.push(Q.secure_url),e.set({pendingImages:ke,images:ee});try{ze(be+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:he,secureUrl:Q.secure_url})}).catch(function(){})}catch(O){}}else throw new Error("invalid image url")}catch(O){console.error("[ikr] Image upload failed:",O);var re=O.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(re,"error");var pe=(e.get().pendingImages||[]).map(function(me){return me.url===H?{url:me.url,file:me.file,error:re}:me});e.set({pendingImages:pe})}}};if(C===0&&w===0){i=!0;var _=!r.canNavigate||r.canNavigate();_&&e.goNext()}e.set({pendingImages:le}),q()}}};var x=e.onChange(n);return n(),{el:t,destroy:function(){i=!0,c.onchange=null,x&&x()}}}var Lr=2e3,pt=60;function Ti(e,r){r=r||{};var i=r.onValidityChange||function(){},t=document.createElement("div");t.className="ikr-fwizard-step ikr-fwizard-step-content";var a=document.createElement("div");a.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",t.appendChild(a);var o=document.createElement("div");o.className="ikr-fwizard-content-form";var s=document.createElement("input");s.type="text",s.className="ikr-fwizard-input",s.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",s.maxLength=pt,s.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),s.value=e.get().title||"",s.addEventListener("input",function(){e.set({title:s.value})}),o.appendChild(s);var l=document.createElement("textarea");l.className="ikr-fwizard-textarea",l.placeholder="Deneyiminizi anlat\u0131n\u2026",l.maxLength=Lr,l.rows=6,l.setAttribute("aria-label","Yorum"),l.value=e.get().comment||"",o.appendChild(l);var c=document.createElement("div");c.className="ikr-fwizard-char-counter",c.setAttribute("aria-live","polite"),o.appendChild(c);function m(){var p=l.value.length;c.textContent=p+"/"+Lr,c.classList.toggle("ikr-fwizard-char-counter--max",p>=Lr)}function v(){return Oe(3,e.get())}return l.addEventListener("input",function(){e.set({comment:l.value}),m(),i(v())}),t.appendChild(o),m(),setTimeout(function(){i(v())},0),{el:t,destroy:function(){}}}var mt=40;function Li(e,r){r=r||{};var i=r.onValidityChange||function(){},t=r.onSuccess||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-author";var o=document.createElement("div");o.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",o.textContent="Hakk\u0131n\u0131zda",a.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-author-form";var l=document.createElement("div");l.className="ikr-fwizard-field";var c=document.createElement("label");c.className="ikr-fwizard-label",c.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var m=document.createElement("input");m.type="text",m.className="ikr-fwizard-input",m.maxLength=mt,m.setAttribute("aria-required","true"),m.value=e.get().author||"",l.appendChild(c),l.appendChild(m),s.appendChild(l);var v=document.createElement("div");v.className="ikr-fwizard-field";var p=document.createElement("label");p.className="ikr-fwizard-label",p.textContent="E-posta (opsiyonel)";var n=document.createElement("input");n.type="email",n.className="ikr-fwizard-input",n.setAttribute("autocomplete","email"),n.value=e.get().email||"",v.appendChild(p),v.appendChild(n),s.appendChild(v);var f=document.createElement("div");f.className="ikr-fwizard-notice",f.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",s.appendChild(f);var d=document.createElement("div");d.className="ikr-fwizard-msg",d.setAttribute("role","alert"),d.setAttribute("aria-live","assertive"),s.appendChild(d);var u=document.createElement("button");u.type="button",u.className="ikr-fwizard-submit-btn",u.textContent="G\xF6nder",s.appendChild(u),a.appendChild(s);function g(){return Oe(4,e.get())}function k(){var z=!g(),h=(e.get().pendingImages||[]).length,E=h>0;E?(u.disabled=!0,u.classList.add("ikr-fwizard-submit-btn--disabled"),u.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(u.disabled=z,u.classList.toggle("ikr-fwizard-submit-btn--disabled",z),u.textContent="G\xF6nder")}m.addEventListener("input",function(){e.set({author:m.value}),k(),i(g())}),n.addEventListener("input",function(){e.set({email:n.value})}),k(),setTimeout(function(){i(g())},0),u.onclick=async function(){if(!u.disabled){var z=e.get(),h=(z.author||"").trim(),E=(z.comment||"").trim();if(n.value.trim()&&!n.checkValidity()){n.reportValidity();return}if(!h){d.innerHTML='<div class="ikr-fwizard-msg-error">Gerekli alan</div>';return}if(!z.rating){d.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}u.disabled=!0,u.classList.add("ikr-fwizard-submit-btn--disabled");var w=u.textContent;if(u.textContent="G\xF6nderiliyor\u2026",d.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){t()},600);return}try{var b=Zr(window.location.href),C=z.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),S=await ze(be+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:he,productId:z.productId||null,slug:b||null,productName:C,author:h,title:(z.title||"").trim()||null,comment:E||null,rating:z.rating,images:z.images||[]})},15e3);if(S.ok)t();else{var T=await S.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(P){var y=P&&(P.name==="AbortError"||/signal/i.test(P.message||"")),L=y?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":P.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(L,"error"):d.innerHTML='<div class="ikr-fwizard-msg-error">'+L+"</div>",u.disabled=!1,u.classList.remove("ikr-fwizard-submit-btn--disabled"),u.textContent=w}}};var x=e.onChange(k);return{el:a,destroy:function(){u.onclick=null,x&&x()}}}var Ni=!1;function ut(){if(!Ni){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=wi,document.head.appendChild(e),Ni=!0}}function ft(e,r,i){if(i=i||{},e===1)return Ci(r,{canNavigate:i.canNavigate});if(e===2)return Ei(r,{canNavigate:i.canNavigate,blobMap:i.blobMap,urlToFinger:i.urlToFinger,showToast:i.showToast});if(e===3)return Ti(r,{onValidityChange:i.onValidityChange});if(e===4)return Li(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess,showToast:i.showToast});var t=document.createElement("div");return t.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:t,destroy:function(){}}}function Pi(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Ai(e){e=e||{},ut();var r=xi({productId:e.productId,productName:e.productName}),i={},t={},a=yi({onClose:function(){window.removeEventListener("popstate",s),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(i).forEach(function(w){var b=i[w];b&&b.startsWith("blob:")&&URL.revokeObjectURL(b)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),o={ikrReviewModal:!0};window.history.pushState(o,null,"");var s=function(w){a&&a.close&&a.close()};window.addEventListener("popstate",s);var l=document.createElement("div");l.className="ikr-fwizard-step-wrap";var c=zi({skippableSteps:[2],nextableSteps:[3],onBack:function(){p==="idle"&&r.goBack()},onSkip:function(){p==="idle"&&r.goNext()},onNext:function(){p==="idle"&&r.goNext()}}),m=document.createElement("div");m.className="ikr-fwizard-layout",m.appendChild(l),m.appendChild(c.el);var v=null,p="idle",n=null,f=!0,d=null;function u(w,b){l.innerHTML="";var C=ft(w,r,{canNavigate:function(){return p==="idle"},blobMap:i,urlToFinger:t,onValidityChange:function(y){c.setNextDisabled(!y)},onSuccess:k,showToast:a.showToast});if(v=C,c.update(w,r.get()),b){p="entering",C.el.classList.add("ikr-fwizard-step--enter");var S=null,T=function(){S&&clearTimeout(S),C.el.removeEventListener("animationend",T),C.el.classList.remove("ikr-fwizard-step--enter"),p="idle",n!==null&&x()};C.el.addEventListener("animationend",T),S=setTimeout(T,700)}else p="idle";l.appendChild(C.el),a.setStepAttr&&a.setStepAttr(w),w===3&&c.setNextDisabled(!0)}var g=!1;function k(){if(!g){if(g=!0,!v){l.innerHTML="";var w=Pi();w.classList.add("ikr-fwizard-step--enter"),l.appendChild(w),a.setStepAttr("thanks"),c.setThanksState(a.close);return}var b=v;p="exiting",b.el.classList.add("ikr-fwizard-step--exit");var C=function(){if(d&&clearTimeout(d),b.el.removeEventListener("animationend",C),b.destroy)try{b.destroy()}catch(T){}v===b&&(v=null),l.innerHTML="";var S=Pi();S.classList.add("ikr-fwizard-step--enter"),l.appendChild(S),a.setStepAttr("thanks"),c.setThanksState(a.close),p="idle"};b.el.addEventListener("animationend",C),d=setTimeout(C,300)}}function x(){var w=r.get().currentStep;if(p!=="idle"){n=w;return}if(!v){var b=!f;f=!1,u(w,b);return}var C=v;p="exiting",C.el.classList.add("ikr-fwizard-step--exit");var S=function(){if(d&&clearTimeout(d),C.el.removeEventListener("animationend",S),C.destroy)try{C.destroy()}catch(y){}if(v===C){l.innerHTML="",v=null;var T=n!==null?n:r.get().currentStep;n=null,u(T,!0),p="idle"}};C.el.addEventListener("animationend",S),d=setTimeout(S,350)}x();var z=r.get().currentStep,h=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,x()):c.update(w.currentStep,w)}),E=a.close;return a.close=function(){h&&h(),typeof d!="undefined"&&d&&clearTimeout(d),E()},a.open(m),{close:a.close}}function D(){Ai({productId:K||"",productName:Ie||""})}var vt={id:"classic",name:"Klasik (A\xE7\u0131k)"};function kt(e){var r=e.widget,i=e.data,t=e.settings,a=e.iconPair,o=e.allCount,s=e.ratingCounts,l=e.avgRatingVal,c=e.currentRatingFilter,m=e.currentOrderBy,v=e.currentHasImages,p=e.onFilterChange,n=e.onSortChange;ye(a);var f=document.createElement("div");f.className="ikr-summary";var d=(s[3]||0)+(s[4]||0),u=o>0?Math.round(d/o*100):0,g=document.createElement("div");g.className="ikr-summary-block ikr-summary-avg",g.innerHTML='<span class="ikr-avg-star ikr-icon">'+W("full")+'</span><span class="ikr-avg-num">'+l+"</span>",f.appendChild(g);var k=document.createElement("div");if(k.className="ikr-summary-block ikr-summary-count",k.textContent=o.toLocaleString("tr-TR")+" Yorum",f.appendChild(k),t.showRecommendation!==!1&&u>0){var x=document.createElement("div");x.className="ikr-summary-block ikr-summary-recommend",x.innerHTML='<span class="ikr-recommend-pct">%'+u+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",f.appendChild(x)}return f.appendChild(_e({ratingCounts:s,allCount:o,iconPair:a,currentRatingFilter:c,onFilterChange:p})),f.appendChild(X({widget:r,currentOrderBy:m,currentHasImages:v,onWriteClick:D,onSortChange:n})),f}var Pr={};ge(Pr,{css:()=>ht,meta:()=>gt,render:()=>bt});var Ri=`
...
`;var gt={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},ht=Ri;function bt(e){var r=e.widget,i=e.settings,t=e.iconPair,a=e.allCount,o=e.ratingCounts,s=e.avgRatingVal,l=e.currentRatingFilter,c=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,p=e.onSortChange,n=document.createElement("div");n.className="ikr-summary ikr-summary-compact";var f=document.createElement("div");f.className="ikr-compact-header";var d=document.createElement("div");d.className="ikr-compact-trigger-wrap";var u=document.createElement("button");u.className="ikr-compact-trigger",u.type="button",u.setAttribute("aria-expanded","false"),u.innerHTML='<span class="ikr-compact-trigger-stars">'+we(s,t)+'</span><span class="ikr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron">'+G('<svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg>')+"</span>",d.appendChild(u),f.appendChild(d);var g=X({widget:r,currentOrderBy:c,currentHasImages:m,onWriteClick:D,onSortChange:p}),k=g.querySelector(".ikr-filter-wrap"),x=g.querySelector(".ikr-write-btn"),z=document.createElement("div");z.className="ikr-compact-actions-slot",x&&z.appendChild(x),k&&z.appendChild(k),f.appendChild(z),n.appendChild(f);var h=document.createElement("div");h.className="ikr-compact-panel",h.setAttribute("role","dialog"),h.setAttribute("aria-hidden","true");var E=document.createElement("div");E.className="ikr-compact-panel-inner";var w=document.createElement("div");w.className="ikr-compact-avg",w.innerHTML='<span class="ikr-icon">'+W("full")+"</span><span>"+s+"</span>",E.appendChild(w),E.appendChild(_e({ratingCounts:o,allCount:a,iconPair:t,currentRatingFilter:l,onFilterChange:v})),h.appendChild(E);var b=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(_){var F=_?n:d;h.parentNode!==F&&(h.classList.contains("ikr-open")&&(h.classList.remove("ikr-open"),h.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")),F.appendChild(h))}if(C(b?b.matches:!1),b){var S=function(_){C(_.matches)};b.addEventListener?b.addEventListener("change",S):b.addListener&&b.addListener(S)}if(x){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent=A&&A.writeButtonText||"Yorum Yap",T.onclick=D;var y=document.createElement("div");y.className="ikr-compact-write-row",y.appendChild(T),n.appendChild(y)}function L(){h.classList.remove("ikr-open"),h.setAttribute("aria-hidden","true"),u.setAttribute("aria-expanded","false")}function P(){sr(N),h.classList.add("ikr-open"),h.setAttribute("aria-hidden","false"),u.setAttribute("aria-expanded","true")}u.onclick=function(){h.classList.contains("ikr-open")?L():P()};var N=null;function M(_){N&&(N(),N=null),_||(N=cr({trigger:d,element:h,close:L}))}if(M(b?b.matches:!1),b){var J=function(_){M(_.matches)};b.addEventListener?b.addEventListener("change",J):b.addListener&&b.addListener(J)}if(i.showRecommendation!==!1){var Z=(o[3]||0)+(o[4]||0),le=a>0?Math.round(Z/a*100):0;if(le>0){var q=document.createElement("div");q.className="ikr-summary-block ikr-summary-recommend",q.style.marginTop="8px",q.innerHTML='<span class="ikr-recommend-pct">%'+le+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",E.appendChild(q)}}return n}var Ar={};ge(Ar,{css:()=>wt,meta:()=>yt,render:()=>xt});var Bi=`
...
`;var zt={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Ct=Ii;function St(e){var r=e.widget,i=e.iconPair,t=e.allCount,a=e.avgRatingVal,o=e.currentOrderBy,s=e.currentHasImages,l=e.onSortChange,c=document.createElement("div");c.className="ikr-summary ikr-summary-minimal";var m=document.createElement("div");m.className="ikr-minimal-info";var v=document.createElement("div");v.className="ikr-minimal-row";var p=document.createElement("span");p.className="ikr-minimal-avg",p.textContent=a,v.appendChild(p);var n=document.createElement("span");n.className="ikr-minimal-stars",n.innerHTML=we(a,i),v.appendChild(n);var f=document.createElement("span");f.className="ikr-minimal-count",f.textContent=t.toLocaleString("tr-TR")+" Yorum",v.appendChild(f),m.appendChild(v),c.appendChild(m);var d=X({widget:r,currentOrderBy:o,currentHasImages:s,onWriteClick:D,onSortChange:l}),u=d.querySelector(".ikr-filter-wrap"),g=d.querySelector(".ikr-write-btn"),k=document.createElement("div");if(k.className="ikr-minimal-actions",g&&k.appendChild(g),u&&k.appendChild(u),c.appendChild(k),g){var x=document.createElement("button");x.className="ikr-write-btn",x.textContent=A&&A.writeButtonText||"Yorum Yap",x.onclick=D;var z=document.createElement("div");z.className="ikr-minimal-write-row",z.appendChild(x),c.appendChild(z)}return c}var Br={};ge(Br,{css:()=>Tt,meta:()=>Et,render:()=>Lt});var Mi=`
...
`;var Rt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"80px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"110px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},Bt=_i;function It(e,r){var i=xe(e),t=i.length>0,a=document.createElement("div");a.className="ikr-review-list"+(t?"":" ikr-review-list--no-media");var o=document.createElement("div");o.className="ikr-review-list-author";var s=document.createElement("span");s.className="ikr-review-stars ikr-review-list-author-stars",s.innerHTML=ue(e.rating,A),o.appendChild(s);var l=document.createElement("span");l.className="ikr-review-list-author-name",l.textContent=e.author||"",o.appendChild(l);var c=document.createElement("span");c.className="ikr-date ikr-review-list-author-date",c.textContent=fe(e.createdAt),o.appendChild(c),a.appendChild(o);var m=document.createElement("div");if(m.className="ikr-review-list-content",e.title){var v=document.createElement("div");v.className="ikr-review-list-title",v.textContent=e.title,m.appendChild(v)}var p=(e.comment||"").trim();if(p){var n=document.createElement("div");n.className="ikr-review-list-body ikr-body-clamped",n.textContent=p,m.appendChild(n);var f=document.createElement("span");f.className="ikr-read-more",f.textContent="Devam\u0131n\u0131 oku",f.style.display="none",m.appendChild(f),requestAnimationFrame(function(){if(n.scrollHeight>n.clientHeight+2){f.style.display="inline";var g=!1;f.onclick=function(){g=!g,n.classList.toggle("ikr-body-clamped",!g),f.textContent=g?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var d=He(e.merchantReply);if(d&&m.appendChild(d),a.appendChild(m),t){var u=document.createElement("div");u.className="ikr-review-list-media",i.forEach(function(g){var k=document.createElement("img"),x=ie(g,j);k.src=x.src,k.srcset=x.srcset,k.loading="lazy",k.decoding="async",k.width=j,k.height=Math.round(j*4/3),k.setAttribute("data-ikr-img-url",g),te(k),(function(z){k.onclick=function(){ne(e,z,r)}})(g),u.appendChild(k)}),a.appendChild(u)}return a}var Fr={};ge(Fr,{css:()=>Ft,meta:()=>Mt,render:()=>_t});var Oi=`
