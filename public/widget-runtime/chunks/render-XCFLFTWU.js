...
import{a as He,d as Ye}from"./chunk-N7KC6W47.js";import{b as Dr,c as Be}from"./chunk-I4DUUQZH.js";import{A as zt,B as kt,C as mr,D as xr,E as fr,a as U,b as tr,c as J,d as Z,e as F,f as R,g as st,h as Le,j as vr,k as Or,l as vt,m as cr,n as Pe,o as ct,p as mt,q as xt,r as ft,s as gt,t as ht,u as bt,v as ke,y as yt,z as wt}from"./chunk-H43GKW4S.js";import{A as Pt,B as Ce,C as br,D as $,E as yr,F as wr,G as Hr,H as Yr,I as ue,J as Nt,K as de,L as Rt,M as It,c as Fr,e as Se,f as ae,g as me,h as ne,i as Ne,j as gr,k as ar,l as St,m as De,n as hr,o as Ct,p as Re,q as Et,r as Tt,t as M,u as At,v as xe,w as je,y as Lt,z as fe}from"./chunk-KMKCI4F7.js";import{c as nr}from"./chunk-WWGCW5YN.js";import{a as ze,b as er,c as rr,i as Bt,j as Ie}from"./chunk-GTR5JH7S.js";var Ue=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function Mt(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Ve(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function zr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function _t(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function Ft(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var Ot=`
...
`;var kr=[Ot,Lt,Yt,Dt,jt,Ut,Ht].join(`
`);function Ra(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function se(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function Ia(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function Ba(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",p=Ia()&&!n;if(a>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),p&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Ma(e){var r=document.body.style,t=document.documentElement.style;se(t,"overflow",e.rootOverflow,e.rootOverflowPriority),se(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),se(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),se(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),se(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),se(r,"position",e.bodyPosition,e.bodyPositionPriority),se(r,"top",e.bodyTop,e.bodyTopPriority),se(r,"left",e.bodyLeft,e.bodyLeftPriority),se(r,"right",e.bodyRight,e.bodyRightPriority),se(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var ir=0,We=null;function Sr(){return ir+=1,ir>1||(We=Ra(),Ba(We)),We}function Cr(){if(ir!==0&&(ir-=1,!(ir>0))){var e=We;We=null,e&&Ma(e)}}function _a(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Er(){var e=_a();return!e||e===document.body||e===document.documentElement?null:e}function ie(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Fa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function jr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Fa)}function Oa(e,r){var t=e,a=jr(e);!a.length&&r&&(t=r,a=jr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;ie(n)}function Tr(e,r,t){if(e.key==="Tab"){var a=jr(r);if(!a.length){e.preventDefault(),Oa(r);return}var n=a[0],p=a[a.length-1],o=_t(t);if(!r.contains(o)){e.preventDefault(),ie(n);return}if(a.indexOf(o)===-1){e.preventDefault(),ie(e.shiftKey?p:n);return}e.shiftKey&&o===n?(e.preventDefault(),ie(p)):!e.shiftKey&&o===p&&(e.preventDefault(),ie(n))}}var Vt="renuvexPrOverlay";function Ar(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Vt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Ha(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Vt]===e.id)}function Lr(e){if(Ha(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function qe(e){return Ce(e)}function Wt(e,r,t,a,n,p){Cr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&gr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),p&&ie(n)}function Ya(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=xe(e.rating,R);var p=document.createElement("span");p.className="renuvex-pr-modal-date",p.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(p),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var l=document.createElement("div");l.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=M(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi");var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",l.appendChild(f),l.appendChild(s),l.style.display=e.merchantReply?"":"none",t.appendChild(l),r.appendChild(t),r}function qt(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),p=n.querySelector(".renuvex-pr-modal-stars");p.innerHTML=xe(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=fe(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=M(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Vr(e,r,t,a,n,p,o,i,d){var l=qe(e),f=Math.max(0,Math.min(t||0,l.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var u=document.createElement("img"),v=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(u.className="renuvex-pr-modal-main-img"+(v?" "+v:""),u.src=Yr(l[f]||""),u.decoding="async",u.width=Hr,u.height=Math.round(Hr*4/3),u.alt="Yorum foto\u011Fraf\u0131",!v){u.classList.add("renuvex-pr-modal-img-loading");var y=function(){u.classList.remove("renuvex-pr-modal-img-loading")};u.complete&&u.naturalWidth>0?y():(u.addEventListener("load",y,{once:!0}),u.addEventListener("error",y,{once:!0}))}Nt(u,function(P){if(P.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var C=document.createElement("div");C.className="renuvex-pr-modal-img-error",C.setAttribute("role","status"),C.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(C,P)}}),s.appendChild(u);var c=document.createElement("button");c.className="renuvex-pr-modal-close-mobile";var g=ne(Re);g&&c.appendChild(g),c.setAttribute("aria-label","Kapat"),c.onclick=function(P){P.stopPropagation(),p()},s.appendChild(c);var m=0;if(s.addEventListener("touchstart",function(P){m=P.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(P){var C=m-P.changedTouches[0].clientX;if(!(Math.abs(C)<50)){if(C>0){if(k)ge(e,r,f+1,a,n,p,!0,"next",i,d);else if(z){var N=a[r+1];ge(N,r+1,0,a,n,p,!1,"next",i,d)}}else if(x)ge(e,r,f-1,a,n,p,!0,"prev",i,d);else if(b){var Y=a[r-1],G=qe(Y);ge(Y,r-1,G.length-1,a,n,p,!1,"prev",i,d)}}},{passive:!0}),l.length>1){var h=document.createElement("div");h.className="renuvex-pr-modal-thumbs",l.forEach(function(P,C){var N=document.createElement("img"),Y=ue(P,wr);N.src=Y.src,N.srcset=Y.srcset,N.loading="lazy",N.decoding="async",N.width=wr,N.height=wr,N.className="renuvex-pr-modal-thumb"+(C===f?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(C+1),de(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(C+1)+" se\xE7"),C===f&&N.setAttribute("aria-current","true"),(function(G){function ee(){ge(e,r,G,a,n,p,!0,null,i,d)}N.onclick=ee,N.onkeydown=function(D){(D.key==="Enter"||D.key===" ")&&(D.preventDefault(),ee())}})(C),h.appendChild(N)}),s.appendChild(h)}var x=f>0,k=f<l.length-1,b=r>0,z=r<a.length-1,E=x||b,A=k||z;if(E){var w=document.createElement("button");w.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var T=ne(De);T&&w.appendChild(T),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(P){if(P.stopPropagation(),x)ge(e,r,f-1,a,n,p,!0,"prev",i,d);else if(b){var C=a[r-1],N=qe(C);ge(C,r-1,N.length-1,a,n,p,!1,"prev",i,d)}},s.appendChild(w)}if(A){var S=document.createElement("button");S.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=ne(hr);L&&S.appendChild(L),S.setAttribute("aria-label","Sonraki"),S.onclick=function(P){if(P.stopPropagation(),k)ge(e,r,f+1,a,n,p,!0,"next",i,d);else if(z){var C=a[r+1];ge(C,r+1,0,a,n,p,!1,"next",i,d)}},s.appendChild(S)}return s}function Gt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=qe(a);n[0]&&(new Image().src=Yr(n[0]))}})}function Ur(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Da(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function p(){Ur(t),Ur(a),Ur(n)}p(),t&&ie(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){p(),requestAnimationFrame(p)}):setTimeout(p,0)}function ge(e,r,t,a,n,p,o,i,d,l){if(l&&(l.currentReview=e),o){var f=Vr(e,r,t,a,n,p,i,d,l);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=Vr(e,r,t,a,n,p,i,d,l),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),s&&qt(s,e,l&&l.currentSettings),Da(d,n)}Gt(r,a)}function ve(e,r,t){var a=qe(e);if(!a.length)return;var n=(t||[]).filter(function(A){return qe(A).length>0}),p=n.findIndex(function(A){return A===e||A.id===e.id});p===-1&&(n.unshift(e),p=0);var o=a.indexOf(r);o<0&&(o=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var l=!1,f=null,s=Er(),u=Ye(),v=Sr(),y=Ar(),c={currentReview:e,currentSettings:R},g=null;function m(A){var w=A&&A.detail&&A.detail.settings;if(!(w&&w===g)){g=w||null,c.currentSettings=w||R;var T=d.querySelector(".renuvex-pr-modal-right");!T||!c.currentReview||qt(T,c.currentReview,c.currentSettings)}}function h(){l||(l=!0,window.removeEventListener(Ie,m),Wt(f&&f.host,x,h,v,s,u))}function x(A){if(A.key==="Escape"){k();return}Tr(A,i,f&&f.root)}function k(){l||(l=!0,window.removeEventListener(Ie,m),Wt(f&&f.host,x,h,v,s,u),Lr(y))}document.addEventListener("keydown",x),window.addEventListener("popstate",h),window.addEventListener(Ie,m),i.onclick=function(){k()},d.onclick=function(A){A.stopPropagation()},d.appendChild(Vr(e,p,o,n,d,k,null,i,c)),d.appendChild(Ya(e)),Gt(p,n);var b=document.createElement("div");b.className="renuvex-pr-modal-wrap",b.tabIndex=-1,b.setAttribute("role","dialog"),b.setAttribute("aria-modal","true"),b.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),b.appendChild(d);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var E=ne(Re);E&&z.appendChild(E),z.setAttribute("aria-label","Kapat"),z.onclick=function(A){A.stopPropagation(),k()},b.appendChild(z),i.appendChild(b),f=zr(),Ve(f.root,Ue+He+kr),f.root.appendChild(i),Ne(f.root),ie(b)}function Ee(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Xr={};ze(Xr,{css:()=>$a,meta:()=>Za,render:()=>Qa});function Ge(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,p=e.onFilterChange;Se(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,l=t>0?Math.round(d/t*100):0,f=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":"")+(n&&!f?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",f?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+M(R&&R.countLabel,"Yorum")+", "+(f?"filtreyi kald\u0131r":"filtrele"));for(var u="",v=1;v<=5;v++){var y=v<=i;u+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ae(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+u+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+l+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(c){function g(){p(c)}s.onclick=g,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),g())}})(i),o.appendChild(s)}return o}var Jt="data-renuvex-pr-dismiss-gesture",Me=[],Kt=!1,Pr=!1,or=[],Ke=null;function Xt(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Wr(){for(var e=Me.length-1;e>=0;e--){var r=Me[e].element;r&&r.isConnected===!1&&Me.splice(e,1)}return Me}function ja(e){!e||typeof e.setAttribute!="function"||(or.indexOf(e)===-1&&or.push(e),e.setAttribute(Jt,""))}function Zt(){for(var e=0;e<or.length;e++){var r=or[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Jt)}or=[],Ke&&typeof clearTimeout=="function"&&clearTimeout(Ke),Ke=null}function Ua(e){if(Pr){Pr=!1,Zt(),e.preventDefault(),e.stopPropagation();return}for(var r=Wr(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Xt(e,n.trigger)||Xt(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Va(e){if(e.key==="Escape")for(var r=Wr(),t=r.length-1;t>=0;t--)r[t].close()}function $t(){Kt||typeof document=="undefined"||(document.addEventListener("click",Ua,!0),document.addEventListener("keydown",Va),Kt=!0)}function Wa(e){$t(),Pr=!0,ja(e),Ke&&typeof clearTimeout=="function"&&clearTimeout(Ke),typeof setTimeout=="function"&&(Ke=setTimeout(function(){Pr=!1,Zt()},700))}function qr(e){Wa(e)}function Nr(e){$t();var r={trigger:e.trigger,element:e.element,close:e.close};return Me.push(r),{unregister:function(){var t=Me.indexOf(r);t!==-1&&Me.splice(t,1)},notifyOpening:function(){for(var t=Wr(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function Q(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,p=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=M(R&&R.writeButtonText,"Yorum Yap"),i.onclick=n,o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var l=document.createElement("button");l.type="button",l.className="renuvex-pr-filter-btn",l.setAttribute("aria-label","Filtrele"),l.setAttribute("aria-haspopup","menu"),l.setAttribute("aria-expanded","false");var f=R&&R.filterIcon||"lines";l.innerHTML=me(St(f));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function y(){return r&&r.parentNode||r||null}function c(x,k){if(!(k===!0||!x)){if(x.type==="touchstart"){qr(y());return}if(x.type==="pointerdown"){var b=x.pointerType||"";b&&b!=="mouse"&&qr(y());return}}}function g(x){var k=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),l.classList.remove("renuvex-pr-filter-btn-active"),l.setAttribute("aria-expanded","false");var b=x&&(x.restoreFocus===!0||x.restoreFocus==="auto"&&Ye());if(k&&b)try{l.focus({preventScroll:!0})}catch(z){try{l.focus()}catch(E){}}return k}function m(){h.notifyOpening(),s.classList.add("renuvex-pr-open"),l.classList.add("renuvex-pr-filter-btn-active"),l.setAttribute("aria-expanded","true");var x=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");x&&requestAnimationFrame(function(){try{x.focus({preventScroll:!0})}catch(k){try{x.focus()}catch(b){}}})}u.forEach(function(x){var k=x[2],b=k?a:!a&&(t||"newest")===x[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(b?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=x[1];var E=!1;function A(w,T){w&&(w.preventDefault(),w.stopPropagation()),!E&&(E=!0,v=!0,c(w,T),g({restoreFocus:T}),p(x[0],k),setTimeout(function(){E=!1,v=!1},0))}z.addEventListener("pointerdown",function(w){w.button!==void 0&&w.button!==0||w.pointerType!=="mouse"&&A(w,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(w){A(w,!1)},{passive:!1}),z.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&A(w,!0)}),z.onclick=function(w){A(w,!1)},s.appendChild(z)}),l.onclick=function(){s.classList.contains("renuvex-pr-open")?g({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(x){x.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(x.stopPropagation(),g({restoreFocus:!0}))}),d.addEventListener("focusout",function(x){if(s.classList.contains("renuvex-pr-open")&&!v){var k=x.relatedTarget;k&&d.contains(k)||g()}});var h=Nr({trigger:d,element:s,close:g});return d.appendChild(l),d.appendChild(s),o.appendChild(d),o}var Qt=`
...
`;function ea(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",n.appendChild(p);var o=document.createElement("button");o.className="renuvex-pr-fwizard-close",o.type="button",o.setAttribute("aria-label","Kapat");var i=ne(Re);i&&o.appendChild(i),n.appendChild(o);var d=!1,l=null,f=null,s=!1;function u(){ie(a)}function v(b){Tr(b,a,l&&l.root)}function y(){if(!d){if(d=!0,document.removeEventListener("keydown",c),a.removeEventListener("click",g),o.removeEventListener("click",y),s)ie(f);else{var b=l&&l.root?l.root.activeElement:null;if(b&&typeof b.blur=="function")try{b.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){l?(gr(l.root),l.host&&l.host.parentNode&&l.host.parentNode.removeChild(l.host)):a.parentNode&&a.parentNode.removeChild(a),Cr();try{r()}catch(z){}},200)}}function c(b){if(b.key==="Escape"){y();return}v(b)}function g(b){b.target===a&&t&&y()}document.addEventListener("keydown",c),a.addEventListener("click",g),o.addEventListener("click",y);function m(b){f=Er(),s=Ye(),b&&p.appendChild(b),l=zr(),Ve(l.root,Ue+He+Qt),l.root.appendChild(a),Ne(l.root),Sr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),u()})}var h=null,x=null;function k(b,z){if(z=z||"error",h){try{h.remove()}catch(E){}h=null}x&&(clearTimeout(x),x=null),h=document.createElement("div"),h.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,h.textContent=b,n.appendChild(h),x=setTimeout(function(){h&&(h.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(h){try{h.remove()}catch(E){}h=null}},300))},4e3)}return{open:m,close:y,content:p,setAllowOutsideClose:function(b){t=!!b},setStepAttr:function(b){n.setAttribute("data-step",String(b))},showToast:k}}var Gr=4;function Xe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function ra(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(p){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Gr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(p){return p!==n})}}}}function ta(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},p=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=me(De)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var l=[],f=0;f<Gr;f++){var s=document.createElement("span");s.className="renuvex-pr-fwizard-progress-seg",d.appendChild(s),l.push(s)}o.appendChild(d);var u=document.createElement("button");u.type="button";var v=null;function y(g){v&&u.removeEventListener("click",v),v=g,g&&u.addEventListener("click",g)}o.appendChild(u);function c(g,m){var h=r.indexOf(g)!==-1,x=t.indexOf(g)!==-1,k=m&&(m.images&&m.images.length>0||m.pendingImages&&m.pendingImages.length>0);if(h)g===2&&k?(u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",y(function(){p()})):(u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.setAttribute("aria-label","Atla"),u.innerHTML="<span>Atla</span>",y(function(){n()})),u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),u.style.visibility="",u.tabIndex=0;else if(x){u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Sonraki"),u.innerHTML="Sonraki",u.style.visibility="",u.tabIndex=0;var b=Xe(g,m);u.disabled=!b,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!b),y(function(){u.disabled||p()})}else u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.innerHTML="",u.style.visibility="hidden",u.tabIndex=-1,u.disabled=!0,y(null)}return{el:o,update:function(g,m){l.forEach(function(x,k){k+1<=g?x.classList.add("renuvex-pr-fwizard-progress-seg-active"):x.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var h=g<=1;i.style.visibility=h?"hidden":"",i.style.pointerEvents=h?"none":"",i.tabIndex=h?-1:0,c(g,m)},setNextDisabled:function(g){u.classList.contains("renuvex-pr-fwizard-cta-btn")&&(u.disabled=!!g,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!g))},setThanksState:function(g){i.style.visibility="hidden",d.style.visibility="hidden",u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",u.style.visibility="",u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),y(g)}}}var qa={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function he(e){return M(R&&R[e],qa[e])}function aa(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title",p.textContent=he("formStepRatingTitle"),t.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=ar(R||{});Se(i);var d=[];function l(g){d.forEach(function(m,h){var x=h<g;m.classList.toggle("renuvex-pr-fwizard-star-active",x),m.setAttribute("aria-checked",h+1===g?"true":"false"),m.innerHTML=x?ae("full"):ae("outline")})}function f(g){e.set({rating:g}),l(g)}function s(g){var m=d[g-1];if(m)try{m.focus()}catch(h){}}function u(g,m){m&&typeof m.preventDefault=="function"&&m.preventDefault(),m&&typeof m.stopPropagation=="function"&&m.stopPropagation(),!a&&(a=!0,f(g),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var v=1;v<=5;v++)(function(g){var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-star",m.setAttribute("role","radio"),m.setAttribute("aria-label",g+" y\u0131ld\u0131z"),m.innerHTML=ae("outline"),m.addEventListener("mouseenter",function(){l(g)}),m.addEventListener("mouseleave",function(){l(e.get().rating)}),m.addEventListener("pointerdown",function(h){h.button&&h.button!==0||u(g,h)}),typeof window!="undefined"&&!window.PointerEvent&&m.addEventListener("touchstart",function(h){u(g,h)},{passive:!1}),m.addEventListener("mousedown",function(h){window.PointerEvent||u(g,h)}),m.addEventListener("keydown",function(h){if(h.key==="Enter"||h.key===" "){u(g,h);return}var x=0;h.key==="ArrowRight"||h.key==="ArrowUp"?x=Math.min(5,g+1):h.key==="ArrowLeft"||h.key==="ArrowDown"?x=Math.max(1,g-1):h.key==="Home"?x=1:h.key==="End"&&(x=5),x&&(h.preventDefault(),f(x),s(x))}),m.addEventListener("click",function(h){u(g,h)}),d.push(m),o.appendChild(m)})(v);l(e.get().rating);var y=null,c=function(g){var m=g&&g.detail&&g.detail.settings;m&&m===y||(y=m||null,i=ar(m||R||{}),l(e.get().rating))};return window.addEventListener(Ie,c),t.appendChild(o),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ie,c)}}}var na=3,Ga=10*1024*1024;function ia(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=he("formStepPhotosTitle"),a.appendChild(n);var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-subtitle",p.textContent=he("formStepPhotosSubtitle"),a.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",o.appendChild(i),o.appendChild(d);var l=document.createElement("div");l.className="renuvex-pr-fwizard-photo-previews",l.setAttribute("aria-live","polite"),o.appendChild(l),a.appendChild(o);var f=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},s=r.blobMap||{},u=r.urlToFinger||{};function v(){if(!t){var h=e.get().images||[],x=e.get().pendingImages||[],k=h.map(function(b){return{url:b,isPending:!1}}).concat(x.map(function(b){return{url:b.url,file:b.file,isPending:!0,error:b.error}}));l.innerHTML="",k.forEach(function(b){var z=s[b.url]||b.url,E=y(b,z);l.appendChild(E)}),g()}}function y(h,x){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var b=document.createElement("img");b.src=x,b.alt="",b.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(b);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",k.appendChild(z);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var A=ne(Re);return A&&E.appendChild(A),k.appendChild(E),c(k,h,x),k}function c(h,x,k){var b=h.querySelector("img");b.src!==k&&(b.src=k);var z=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(x.isPending&&x.error){z.style.display="flex",z.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+x.error,z.appendChild(E)}else z.style.display="none",z.textContent="";var A=h.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var w=u[x.url]||(x.file?x.file.name+"_"+x.file.size:null),T=s[x.url],S={};w&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(L){return L!==w})),x.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(L){return L.url!==x.url}):S.images=(e.get().images||[]).filter(function(L){return L!==x.url}),e.set(S),f(x.url),f(T),delete u[x.url],T&&delete u[T],s[x.url]&&delete s[x.url]}}function g(){var h=(e.get().images||[]).length,x=(e.get().pendingImages||[]).length,k=h+x,b=k>=na;k>0?(o.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(Tt)):(o.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=me(Et)+"<span>Foto\u011Fraf Ekle</span>"),b?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(h){var x=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(h.target.files).slice(0,na-x);d.value="";var b=(e.get().pendingImages||[]).length,z=e.get().images||[],E=z.length;if(k.length!==0){for(var A=[],w=[],T=0;T<k.length;T++){var S=k[T],L=S.name+"_"+S.size,P=(e.get().fingerprints||[]).some(function(O){return O===L})||A.some(function(O){return O.file.name+"_"+O.file.size===L});if(!P){if(S.size>Ga){var C="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(C,"error"):alert(C);continue}var N=URL.createObjectURL(S);u[N]=L,A.push({url:N,file:S,error:null}),w.push({url:N,file:S});var Y=(e.get().fingerprints||[]).slice();Y.push(L),e.set({fingerprints:Y})}}if(A.length!==0){var G=(e.get().pendingImages||[]).concat(A),ee=async function(){for(var O=0;O<w.length;O++){var oe=w[O],W=oe.file,q=oe.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var K=(e.get().pendingImages||[]).filter(function(B){return B.url!==q}),ce=(e.get().images||[]).slice();ce.push(q),e.set({pendingImages:K,images:ce});continue}try{var re=await nr(rr+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:er})});if(!re.ok)throw re.status===429?new Error("rate_limit"):new Error("sign failed");var j=await re.json();if(!j.folder)throw new Error("sign folder missing");var I=new FormData;I.append("file",W),I.append("api_key",j.api_key),I.append("timestamp",j.timestamp),I.append("signature",j.signature),I.append("folder",j.folder);var le=await fetch("https://api.cloudinary.com/v1_1/"+j.cloud_name+"/image/upload",{method:"POST",body:I}),_=await le.json();if(_.secure_url&&Pt(_.secure_url)){var H=(e.get().pendingImages||[]).some(function(B){return B.url===q});if(!H)continue;s[_.secure_url]=q,u[_.secure_url]=u[q];var Te=(e.get().pendingImages||[]).filter(function(B){return B.url!==q}),te=(e.get().images||[]).slice();te.push(_.secure_url),e.set({pendingImages:Te,images:te});try{nr(rr+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:er,secureUrl:_.secure_url,metadata:{assetId:_.asset_id,publicId:_.public_id,version:_.version,resourceType:_.resource_type,format:_.format,width:_.width,height:_.height,bytes:_.bytes,signature:_.signature}})}).catch(function(){})}catch(B){}}else throw new Error("invalid image url")}catch(B){console.error("[renuvex-pr] Image upload failed:",B);var $e=B.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast($e,"error");var ye=(e.get().pendingImages||[]).map(function(X){return X.url===q?{url:X.url,file:X.file,error:$e}:X});e.set({pendingImages:ye})}}};if(E===0&&b===0){t=!0;var D=!r.canNavigate||r.canNavigate();D&&e.goNext()}e.set({pendingImages:G}),ee()}}};var m=e.onChange(v);return v(),{el:a,destroy:function(){t=!0,d.onchange=null,m&&m()}}}var Kr=2e3,Ka=60;function oa(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent=he("formStepContentTitle"),a.appendChild(n);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Ka,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),p.appendChild(o);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Kr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",p.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),p.appendChild(d);function l(){var s=i.value.length;d.textContent=s+"/"+Kr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",s>=Kr)}function f(){return Xe(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),l(),t(f())}),a.appendChild(p),l(),setTimeout(function(){t(f())},0),{el:a,destroy:function(){}}}var Xa=40;function la(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=he("formStepAuthorTitle"),n.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var l=document.createElement("input");l.type="text",l.className="renuvex-pr-fwizard-input",l.maxLength=Xa,l.setAttribute("aria-required","true"),l.value=e.get().author||"",i.appendChild(d),i.appendChild(l),o.appendChild(i);var f=document.createElement("div");f.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.textContent="E-posta (opsiyonel)";var u=document.createElement("input");u.type="email",u.className="renuvex-pr-fwizard-input",u.setAttribute("autocomplete","email"),u.value=e.get().email||"",f.appendChild(s),f.appendChild(u),o.appendChild(f);var v=document.createElement("div");v.className="renuvex-pr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg",y.setAttribute("role","alert"),y.setAttribute("aria-live","assertive"),o.appendChild(y);var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-submit-btn",c.textContent="G\xF6nder",o.appendChild(c),n.appendChild(o);function g(){return Xe(4,e.get())}function m(){var b=!g(),z=(e.get().pendingImages||[]).length,E=z>0;E?(c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(c.disabled=b,c.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",b),c.textContent="G\xF6nder")}l.addEventListener("input",function(){e.set({author:l.value}),m(),t(g())}),u.addEventListener("input",function(){e.set({email:u.value})}),m(),setTimeout(function(){t(g())},0);function h(){y.textContent=""}function x(b){h();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=b||"",y.appendChild(z)}c.onclick=async function(){if(!c.disabled){var b=e.get(),z=(b.author||"").trim(),E=(b.comment||"").trim();if(u.value.trim()&&!u.checkValidity()){u.reportValidity();return}if(!z){x("Gerekli alan");return}if(!b.rating){x("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=c.textContent;if(c.textContent="G\xF6nderiliyor\u2026",h(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var w=At(window.location.href),T=b.productName||null,S=await nr(rr+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:er,productId:b.productId||null,slug:w||null,productName:T,author:z,title:(b.title||"").trim()||null,comment:E||null,rating:b.rating,images:b.images||[]})},15e3);if(S.ok)a();else{var L=await S.json().catch(function(){return{}});throw new Error(L.error||"Yorum kaydedilemedi.")}}catch(N){var P=N&&(N.name==="AbortError"||/signal/i.test(N.message||"")),C=P?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":N.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(C,"error"):x(C),c.disabled=!1,c.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent=A}}};var k=e.onChange(m);return{el:n,destroy:function(){c.onclick=null,k&&k()}}}function Ja(e,r,t){if(t=t||{},e===1)return aa(r,{canNavigate:t.canNavigate});if(e===2)return ia(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return oa(r,{onValidityChange:t.onValidityChange});if(e===4)return la(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function pa(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function ua(e){e=e||{};var r=ra({productId:e.productId,productName:e.productName}),t={},a={},n={};function p(w){if(!(!w||typeof w!="string"||!w.startsWith("blob:")||n[w])){n[w]=!0;try{URL.revokeObjectURL(w)}catch(T){}}}function o(){Object.keys(a).forEach(function(T){p(T)}),Object.keys(t).forEach(function(T){p(t[T])});var w=r.get();(w.pendingImages||[]).forEach(function(T){p(T&&T.url)}),(w.images||[]).forEach(function(T){p(T)})}var i=ea({onClose:function(){window.removeEventListener("popstate",l),Lr(d),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=Ar(),l=function(w){i&&i.close&&i.close()};window.addEventListener("popstate",l);var f=document.createElement("div");f.className="renuvex-pr-fwizard-step-wrap";var s=ta({skippableSteps:[2],nextableSteps:[3],onBack:function(){y==="idle"&&r.goBack()},onSkip:function(){y==="idle"&&r.goNext()},onNext:function(){y==="idle"&&r.goNext()}}),u=document.createElement("div");u.className="renuvex-pr-fwizard-layout",u.appendChild(f),u.appendChild(s.el);var v=null,y="idle",c=null,g=!0,m=null;function h(w,T){f.innerHTML="";var S=Ja(w,r,{canNavigate:function(){return y==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:p,onValidityChange:function(C){s.setNextDisabled(!C)},onSuccess:k,showToast:i.showToast});if(v=S,s.update(w,r.get()),T){y="entering",S.el.classList.add("renuvex-pr-fwizard-step--enter");var L=null,P=function(){L&&clearTimeout(L),S.el.removeEventListener("animationend",P),S.el.classList.remove("renuvex-pr-fwizard-step--enter"),y="idle",c!==null&&b()};S.el.addEventListener("animationend",P),L=setTimeout(P,700)}else y="idle";f.appendChild(S.el),i.setStepAttr&&i.setStepAttr(w),w===3&&s.setNextDisabled(!0)}var x=!1;function k(){if(!x){if(x=!0,!v){f.innerHTML="";var w=pa();w.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(w),i.setStepAttr("thanks"),s.setThanksState(i.close);return}var T=v;y="exiting",T.el.classList.add("renuvex-pr-fwizard-step--exit");var S=function(){if(m&&clearTimeout(m),T.el.removeEventListener("animationend",S),T.destroy)try{T.destroy()}catch(P){}v===T&&(v=null),f.innerHTML="";var L=pa();L.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(L),i.setStepAttr("thanks"),s.setThanksState(i.close),y="idle"};T.el.addEventListener("animationend",S),m=setTimeout(S,300)}}function b(){var w=r.get().currentStep;if(y!=="idle"){c=w;return}if(!v){var T=!g;g=!1,h(w,T);return}var S=v;y="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(m&&clearTimeout(m),S.el.removeEventListener("animationend",L),S.destroy)try{S.destroy()}catch(C){}if(v===S){f.innerHTML="",v=null;var P=c!==null?c:r.get().currentStep;c=null,h(P,!0),y="idle"}};S.el.addEventListener("animationend",L),m=setTimeout(L,350)}b();var z=r.get().currentStep,E=r.onChange(function(w){w.currentStep!==z?(z=w.currentStep,b()):s.update(w.currentStep,w)}),A=i.close;return i.close=function(){E&&E(),typeof m!="undefined"&&m&&clearTimeout(m),A()},i.open(u),{close:i.close}}function V(){ua({productId:F||"",productName:Le||""})}var da=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Za={id:"classic",name:"Klasik (A\xE7\u0131k)"},$a=da;function Qa(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,p=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,l=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange;Se(n);var v=document.createElement("div");v.className="renuvex-pr-summary";var y=(o[3]||0)+(o[4]||0),c=p>0?Math.round(y/p*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-avg",g.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ae("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",v.appendChild(g);var m=document.createElement("div");if(m.className="renuvex-pr-summary-block renuvex-pr-summary-count",m.textContent=p.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum"),v.appendChild(m),a.showRecommendation!==!1&&c>0){var h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+c+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(h)}return v.appendChild(Ge({ratingCounts:o,allCount:p,iconPair:n,currentRatingFilter:d,onFilterChange:s})),v.appendChild(Q({widget:r,currentOrderBy:l,currentHasImages:f,onWriteClick:V,onSortChange:u})),v}var Jr={};ze(Jr,{css:()=>rn,meta:()=>en,render:()=>on});var sa=`
...
`;var en={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},rn=sa,tn="__unknown_product__",lr=Object.create(null);function an(e){return e?String(e):tn}var _e=null,pr=null;function nn(){!_e||!pr||(_e.removeEventListener?_e.removeEventListener("change",pr):_e.removeListener&&_e.removeListener(pr),_e=null,pr=null)}function on(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,p=e.allCount,o=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,l=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange,v=an(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var g=document.createElement("div");g.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+je(i,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+me(Ct)+"</span>";var h=m.querySelector(".renuvex-pr-compact-trigger-text"),x=m.querySelector(".renuvex-pr-compact-chevron");if(h&&(h.textContent=p.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum")),h&&x){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",m.insertBefore(k,h),k.appendChild(h),k.appendChild(x)}g.appendChild(m),c.appendChild(g);var b=Q({widget:r,currentOrderBy:l,currentHasImages:f,onWriteClick:V,onSortChange:u}),z=b.querySelector(".renuvex-pr-filter-wrap"),E=b.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+ae("full")+"</span><span>"+i+"</span>",T.appendChild(S),T.appendChild(Ge({ratingCounts:o,allCount:p,iconPair:n,currentRatingFilter:d,onFilterChange:function(I){P()&&w.classList.contains("renuvex-pr-open")&&(lr[v]=!0),s(I)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function C(I){I?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",I?"false":"true"),m.setAttribute("aria-expanded",I?"true":"false")}function N(I){var le=I?y:g;if(w.parentNode!==le){var _=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&C(!1),_&&(lr[v]=!1),le.appendChild(w)}}N(L?L.matches:!1);var Y=Q({widget:r,currentOrderBy:l,currentHasImages:f,onWriteClick:V,onSortChange:u}),G=Y.querySelector(".renuvex-pr-filter-wrap"),ee=Y.querySelector(".renuvex-pr-write-btn"),D=document.createElement("div");D.className="renuvex-pr-compact-write-row",ee&&D.appendChild(ee),G&&D.appendChild(G),y.appendChild(D);function O(){var I=w.classList.contains("renuvex-pr-open");return C(!1),P()&&(lr[v]=!1),I}function oe(){W&&W.notifyOpening(),C(!0),P()&&(lr[v]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?O():oe()};var W=null;function q(I){W&&(W.unregister(),W=null),I||(W=Nr({trigger:g,element:w,close:O}))}if(q(L?L.matches:!1),nn(),L){var K=function(I){N(I.matches),q(I.matches)};L.addEventListener?L.addEventListener("change",K):L.addListener&&L.addListener(K),_e=L,pr=K}if(P()&&lr[v]&&C(!0),a.showRecommendation!==!1){var ce=(o[3]||0)+(o[4]||0),re=p>0?Math.round(ce/p*100):0;if(re>0){var j=document.createElement("div");j.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",j.style.marginTop="8px",j.innerHTML='<span class="renuvex-pr-recommend-pct">%'+re+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(j)}}return y}var Zr={};ze(Zr,{css:()=>pn,meta:()=>ln,render:()=>un});var va=`
...
`;var ln={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},pn=va;function un(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,p=e.ratingCounts,o=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,l=e.currentHasImages,f=e.onFilterChange,s=e.onSortChange;Se(a);var u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-split";var v=document.createElement("div");v.className="renuvex-pr-split-col renuvex-pr-split-left";var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",y.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ae("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",c.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),v.appendChild(c),u.appendChild(v);var g=document.createElement("div");g.className="renuvex-pr-split-col renuvex-pr-split-mid",g.appendChild(Ge({ratingCounts:p,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),u.appendChild(g);var m=Q({widget:r,currentOrderBy:d,currentHasImages:l,onWriteClick:V,onSortChange:s}),h=m.querySelector(".renuvex-pr-filter-wrap"),x=m.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-right",x&&k.appendChild(x),h&&k.appendChild(h),u.appendChild(k);var b=(p[3]||0)+(p[4]||0),z=n>0?Math.round(b/n*100):0,E=document.createElement("div");E.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",E.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||z===0;return A&&E.classList.add("renuvex-pr-split-rec-hidden"),v.appendChild(E),u}var $r={};ze($r,{css:()=>sn,meta:()=>dn,render:()=>vn});var ca=`
...
`;var dn={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},sn=ca;function vn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,p=e.avgRatingVal,o=e.currentOrderBy,i=e.currentHasImages,d=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary renuvex-pr-summary-minimal";var f=document.createElement("div");f.className="renuvex-pr-minimal-info";var s=document.createElement("div");s.className="renuvex-pr-minimal-row";var u=document.createElement("span");u.className="renuvex-pr-minimal-avg",u.textContent=p,s.appendChild(u);var v=document.createElement("span");v.className="renuvex-pr-minimal-stars",v.innerHTML=je(p,a),s.appendChild(v);var y=document.createElement("span");y.className="renuvex-pr-minimal-count",y.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),s.appendChild(y),f.appendChild(s),l.appendChild(f);var c=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),g=c.querySelector(".renuvex-pr-filter-wrap"),m=c.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");h.className="renuvex-pr-minimal-actions",m&&h.appendChild(m),g&&h.appendChild(g),l.appendChild(h);var x=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),k=x.querySelector(".renuvex-pr-filter-wrap"),b=x.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-minimal-write-row",b&&z.appendChild(b),k&&z.appendChild(k),l.appendChild(z),l}var Qr={};ze(Qr,{css:()=>mn,meta:()=>cn,render:()=>xn});var ma=`
...
`;var cn={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},mn=ma;function xn(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,p=e.avgRatingVal,o=e.currentOrderBy,i=e.currentHasImages,d=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary renuvex-pr-summary-hero";var f=document.createElement("div");f.className="renuvex-pr-hero-info";var s=document.createElement("div");s.className="renuvex-pr-hero-rating-col";var u=document.createElement("span");u.className="renuvex-pr-hero-avg",u.textContent=p,s.appendChild(u);var v=document.createElement("div");v.className="renuvex-pr-hero-meta-row";var y=document.createElement("span");y.className="renuvex-pr-hero-stars",y.innerHTML=je(p,a),v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-hero-count",c.textContent=n.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),v.appendChild(c),s.appendChild(v),f.appendChild(s),l.appendChild(f);var g=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),m=g.querySelector(".renuvex-pr-filter-wrap"),h=g.querySelector(".renuvex-pr-write-btn"),x=document.createElement("div");x.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",h&&x.appendChild(h),m&&x.appendChild(m),l.appendChild(x);var k=Q({widget:r,currentOrderBy:o,currentHasImages:i,onWriteClick:V,onSortChange:d}),b=k.querySelector(".renuvex-pr-filter-wrap"),z=k.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");return E.className="renuvex-pr-hero-write-row",z&&E.appendChild(z),b&&E.appendChild(b),l.appendChild(E),l}var xa=`
  .renuvex-pr-summary{
...
`;var Rr={classic:Xr,compact:Jr,split:Zr,minimal:$r,hero:Qr};function Ir(e){return Rr[e]||Rr.classic}function fa(){var e=Object.keys(Rr).map(function(r){return Rr[r].css||""}).join(`
`);return xa+`
`+e}var et={};ze(et,{css:()=>gn,meta:()=>fn,render:()=>hn});function Je(e,r,t){var a=t||{},n=document.createDocumentFragment(),p=document.createElement("div");p.className=r+" renuvex-pr-body-clamped",p.textContent=e,n.appendChild(p);var o=document.createElement("button");return o.type="button",o.className="renuvex-pr-read-more",o.textContent="Devam\u0131n\u0131 oku",o.style.display="none",n.appendChild(o),requestAnimationFrame(function(){if(p.scrollHeight>p.clientHeight+2)if(o.style.display="inline-block",typeof a.onReadMore=="function")o.onclick=a.onReadMore;else{var i=!1;o.onclick=function(){i=!i,p.classList.toggle("renuvex-pr-body-clamped",!i),o.textContent=i?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),{fragment:n,body:p,readMore:o}}function Ze(e,r){if(!e)return null;var t=document.createElement("div");t.className="renuvex-pr-reply";var a=document.createElement("div");a.className="renuvex-pr-reply-header";var n=document.createElement("span");n.className="renuvex-pr-reply-label",n.textContent=M(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi"),a.appendChild(n),t.appendChild(a);var p=document.createElement("div");p.className="renuvex-pr-reply-text renuvex-pr-reply-text-clamped",p.textContent=e,t.appendChild(p);var o=document.createElement("button");return o.type="button",o.className="renuvex-pr-read-more renuvex-pr-reply-read-more",o.textContent="Devam\u0131n\u0131 oku",o.style.display="none",t.appendChild(o),requestAnimationFrame(function(){if(p.scrollHeight>p.clientHeight+2)if(o.style.display="inline",typeof r=="function")o.onclick=r;else{var i=!1;o.onclick=function(){i=!i,p.classList.toggle("renuvex-pr-reply-text-clamped",!i),o.textContent=i?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),t}var ga=`
...
`;var fn={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},gn=ga;function hn(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var p=document.createElement("span");p.className="renuvex-pr-review-stars",p.innerHTML=xe(e.rating,R),n.appendChild(p);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=fe(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-author",d.textContent=e.author||"",t.appendChild(d);var l=(e.comment||"").trim();l&&t.appendChild(Je(l,"renuvex-pr-body").fragment);var f=Ce(e);if(f.length){var s=document.createElement("div");s.className="renuvex-pr-gallery",f.forEach(function(v){var y=document.createElement("img"),c=ue(v,$);y.src=c.src,y.srcset=c.srcset,y.loading="lazy",y.decoding="async",y.width=$,y.height=$,y.className="renuvex-pr-img",de(y),y.setAttribute("data-renuvex-img-url",v),(function(g){Ee(y,function(){ve(e,g,r)})})(v),s.appendChild(y)}),t.appendChild(s)}var u=Ze(e.merchantReply);return u&&t.appendChild(u),t}var rt={};ze(rt,{css:()=>yn,meta:()=>bn,render:()=>wn});var ha=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var bn={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},yn=ha;function wn(e,r){var t=Ce(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var p=document.createElement("div");p.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=xe(e.rating,R),p.appendChild(o);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",p.appendChild(i);var d=document.createElement("time");d.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&d.setAttribute("datetime",e.createdAt),d.textContent=fe(e.createdAt),p.appendChild(d),n.appendChild(p);var l=document.createElement("div");if(l.className="renuvex-pr-review-list-content",e.title){var f=document.createElement("div");f.className="renuvex-pr-review-list-title",f.textContent=e.title,l.appendChild(f)}var s=(e.comment||"").trim();s&&l.appendChild(Je(s,"renuvex-pr-review-list-body").fragment);var u=Ze(e.merchantReply);if(u&&l.appendChild(u),n.appendChild(l),a){var v=document.createElement("div");v.className="renuvex-pr-review-list-media",t.forEach(function(y){var c=document.createElement("img"),g=ue(y,$);c.src=g.src,c.srcset=g.srcset,c.loading="lazy",c.decoding="async",c.width=$,c.height=Math.round($*4/3),c.setAttribute("data-renuvex-img-url",y),de(c),(function(m){Ee(c,function(){ve(e,m,r)})})(y),v.appendChild(c)}),n.appendChild(v)}return n}var tt={};ze(tt,{css:()=>kn,meta:()=>zn,render:()=>Sn});var ba=`
...
`;var zn={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},kn=ba;function Sn(e,r){var t=br(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var p=document.createElement("div");p.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=xe(e.rating,R),p.appendChild(o),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-gallery-title",i.textContent=e.title,p.appendChild(i)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",p.appendChild(d);var l=document.createElement("time");l.className="renuvex-pr-review-gallery-date",l.style.display="block",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=fe(e.createdAt),p.appendChild(l);var f=(e.comment||"").trim();if(f&&p.appendChild(Je(f,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ve(e,t,r)}}:null).fragment),n.appendChild(p),a){var s=document.createElement("div");s.className="renuvex-pr-review-gallery-media";var u=document.createElement("img"),v=ue(t,yr);u.src=v.src,u.srcset=v.srcset,u.loading="lazy",u.decoding="async",u.width=yr,u.height=Math.round(yr*4/3),de(u),u.setAttribute("data-renuvex-img-url",t),Ee(u,function(){ve(e,t,r)}),s.appendChild(u),n.appendChild(s)}var y=Ze(e.merchantReply,t?function(){ve(e,t,r)}:null);return y&&(y.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(y)),n}var Br={card:et,list:rt,gallery:tt};function Mr(e){return Br[e]||Br.card}function ya(){return Object.keys(Br).map(function(e){return Br[e].css||""}).join(`
`)}var at=0;function Fe(){return at++,at}function Oe(e,r){return e!==at?!1:r?!(r.productId!==void 0&&F!==r.productId||r.orderBy!==void 0&&U!==r.orderBy||r.page!==void 0&&tr!==r.page||r.ratingFilter!==void 0&&J!==r.ratingFilter||r.hasImages!==void 0&&Z!==r.hasImages||r.nextCursor!==void 0&&vr!==r.nextCursor):!0}var nt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},it={small:80,medium:110,large:140},ot={small:80,medium:100,large:110};function wa(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var p=document.createElementNS(t,"line");p.setAttribute("x1","1"),p.setAttribute("y1","1"),p.setAttribute("x2","23"),p.setAttribute("y2","23"),a.appendChild(n),a.appendChild(p);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var i=document.createElement("div");return i.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",i.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(i),r}function za(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function be(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),p=parseInt(t[3],16);return"rgba("+a+","+n+","+p+","+r+")"}function _r(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function lt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function ka(e){return .2126*lt(e.r)+.7152*lt(e.g)+.0722*lt(e.b)}function Sa(e,r){var t=ka(e),a=ka(r),n=Math.max(t,a),p=Math.min(t,a);return(n+.05)/(p+.05)}function Cn(e){var r=_r(e)||_r("#ffffff"),t=_r("#111111"),a=_r("#ffffff");return Sa(t,r)>=Sa(a,r)?"#111111":"#ffffff"}function En(e){return be(e,e==="#ffffff"?.1:.06)}function Ca(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",p=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",i=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",l=be(o,.06),f=r.reviewStarColor||"#f59e0b",s=r.btnBgColor||"#111111",u=r.btnTextColor||"#ffffff",v=r.btnBorderColor||"#111111",y=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",g=r.filterBtnBorderColor||"#111111",m=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",x=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",b=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",E=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",w=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",S=be(w,.65),L=r.replyBgColor||"#f9fafb",P=r.replyBorderColor||"#747474",C=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",Y=r.photoTitleColor||"#111111",G=be("#111111",.05),ee=r.photoArrowBgColor||"#ffffff",D=r.photoArrowTextColor||"#111111",O=be("#111111",.12),oe=r.formBgColor||"#ffffff",W=r.formPrimaryTextColor||"#111111",q=r.formSecondaryTextColor||"#3b3b3b",K=r.inputTextColor||W,ce=r.inputBorderColor||"#d1d5db",re=r.placeholderColor||"#9ca3af",j=r.formStepBarColor||"#111111",I=r.formBtnBgColor||"#111111",le=r.formBtnTextColor||"#ffffff",_=r.formBtnBorderColor||"#111111",H=be(I,.06),Te=be(I,.18),te=be(le,.85),$e=be(W,.06),ye=Cn(oe),B=En(ye),X=r.loadMoreBgColor||"#ffffff",we=r.loadMoreTextColor||"#111111",Ae=r.loadMoreBorderColor||"#111111",ur=r.paginationBgColor||"#ffffff",dr=r.paginationTextColor||"#111111",sr=r.paginationBorderColor||"#e5e7eb",Qe={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":p,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":i,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":l,"--renuvex-pr-btn-bg":s,"--renuvex-pr-btn-text":u,"--renuvex-pr-btn-border":v,"--renuvex-pr-filter-btn-bg":y,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":g,"--renuvex-pr-filter-menu-bg":m,"--renuvex-pr-filter-menu-border":h,"--renuvex-pr-filter-item-text":x,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":b,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":E,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":w,"--renuvex-pr-review-border":T,"--renuvex-pr-state-text":S,"--renuvex-pr-review-star-color":f,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":P,"--renuvex-pr-reply-label":C,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":Y,"--renuvex-pr-photo-image-border":G,"--renuvex-pr-photo-arrow-bg":ee,"--renuvex-pr-photo-arrow-text":D,"--renuvex-pr-photo-arrow-border":O,"--renuvex-pr-fwizard-bg":oe,"--renuvex-pr-fwizard-text":W,"--renuvex-pr-fwizard-secondary-text":q,"--renuvex-pr-fwizard-input-bg":oe,"--renuvex-pr-fwizard-input-text":K,"--renuvex-pr-fwizard-input-border":ce,"--renuvex-pr-fwizard-placeholder":re,"--renuvex-pr-fwizard-close-text":ye,"--renuvex-pr-fwizard-close-hover-bg":B,"--renuvex-pr-fwizard-progress-bg":$e,"--renuvex-pr-fwizard-progress-active":j,"--renuvex-pr-fwizard-btn-bg":I,"--renuvex-pr-fwizard-btn-text":le,"--renuvex-pr-fwizard-btn-border":_,"--renuvex-pr-fwizard-btn-disabled-bg":Te,"--renuvex-pr-fwizard-btn-disabled-text":te,"--renuvex-pr-fwizard-nav-hover-bg":H,"--renuvex-pr-load-more-bg":X,"--renuvex-pr-load-more-text":we,"--renuvex-pr-load-more-border":Ae,"--renuvex-pr-pagination-bg":ur,"--renuvex-pr-pagination-text":dr,"--renuvex-pr-pagination-border":sr};Object.keys(Qe).forEach(function(pe){e.style.setProperty(pe,Qe[pe])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Ea(e){var r=e.settings,t=e.root,a=e.currentHasImages,n=e.openReviewModal,p=e.wireLightboxTrigger,o=(e.photoStripReviews||[]).filter(function(k){return Ce(k).length>0});if(!(r.showPhotoGallery!==!1&&!a&&o.length>0))return null;var i=document.createElement("div");if(i.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var d=M(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),l=document.createElement("div");l.className="renuvex-pr-photo-title",l.textContent=d,i.appendChild(l)}var f=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",f);var s=document.createElement("div");s.className="renuvex-pr-photo-strip";var u=$,v=r.reviewLayout==="card"?$:Math.round($*4/3),y=0;o.forEach(function(k){if(!(y>=15)){var b=br(k);if(b){var z=document.createElement("img"),E=ue(b,$);z.src=E.src,z.srcset=E.srcset,z.loading=y<3?"eager":"lazy",z.decoding="async",z.width=u,z.height=v,z.className="renuvex-pr-photo-strip-thumb",z.alt="Yorum foto\u011Fraf\u0131",de(z),(function(A,w){p(z,function(){n(w,A,o)})})(b,k),s.appendChild(z),y++}}});var c=document.createElement("button");c.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var g=ne(De);g&&c.appendChild(g),c.setAttribute("aria-label","\xD6nceki"),c.onclick=function(){s.scrollBy({left:-200,behavior:"smooth"})};var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=ne(hr);h&&m.appendChild(h),m.setAttribute("aria-label","Sonraki"),m.onclick=function(){s.scrollBy({left:200,behavior:"smooth"})};var x=document.createElement("div");return x.className="renuvex-pr-photo-strip-wrap",x.appendChild(c),x.appendChild(s),x.appendChild(m),i.appendChild(x),i}var Tn=1,An=7,pt="\u2026";function Ln(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=An){for(var n=[],p=1;p<=t;p++)n.push(p);return n}for(var o=[],i=1;i<=t;i++)(i===1||i===t||Math.abs(i-a)<=Tn)&&o.push(i);for(var d=[],l=0;l<o.length;l++)l>0&&o[l]-o[l-1]>1&&d.push(pt),d.push(o[l]);return d}function Ta(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function p(i){n.setAttribute("aria-busy","true");for(var d=n.querySelectorAll("button"),l=0;l<d.length;l++)d[l].disabled=!0;a(i)}function o(i,d,l,f){var s=document.createElement("button");return s.type="button",s.className="renuvex-pr-pagination-arrow",s.setAttribute("aria-label",i),s.textContent=d,f?s.disabled=!0:s.onclick=function(){p(l)},s}return n.appendChild(o("\xD6nceki sayfa","\u2039",t-1,t<=1)),Ln(t,r).forEach(function(i){if(i===pt){var d=document.createElement("span");d.className="renuvex-pr-pagination-gap",d.setAttribute("aria-hidden","true"),d.textContent=pt,n.appendChild(d);return}var l=document.createElement("button");l.type="button",l.className="renuvex-pr-pagination-btn",l.textContent=String(i),l.setAttribute("aria-label","Sayfa "+i),i===t?l.setAttribute("aria-current","page"):l.onclick=function(){p(i)},n.appendChild(l)}),n.appendChild(o("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Aa(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function La(e){var r=e.render;async function t(){var o=Fe(),i=F,d=U,l=J,f=Z;ke(null);var s=await Be(F,U,1,J,Z);Oe(o,{productId:i,orderBy:d,ratingFilter:l,hasImages:f})&&await r(F,R,s,Le,U,1,st)}async function a(o){var i=Fe(),d=J===o?null:o,l=F,f=U,s=Z;ct(d),Pe(1),ke(null);var u=await Be(F,U,1,d,Z);Oe(i,{productId:l,orderBy:f,page:1,ratingFilter:d,hasImages:s})&&await r(F,R,u,Le,U,1)}async function n(o,i){var d=Fe(),l=F,f=J;Pe(1),ke(null);var s=o,u=!1;i&&(u=!0,s="newest"),mt(u),cr(s);var v=await Be(F,s,1,J,u);Oe(d,{productId:l,orderBy:s,page:1,ratingFilter:f,hasImages:u})&&await r(F,R,v,Le,s,1)}async function p(o){var i=Fe(),d=F,l=U,f=J,s=Z;Pe(o),ke(null);var u=await Be(F,U,o,J,Z);if(Oe(i,{productId:d,orderBy:l,page:o,ratingFilter:f,hasImages:s})){await r(F,R,u,Le,U,o);var v=document.getElementById("renuvex-reviews"),y=v&&v.shadowRoot,c=y&&y.querySelector&&y.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(c){try{c.focus({preventScroll:!0})}catch(h){try{c.focus()}catch(x){}}Aa(y,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var g=document.getElementById("renuvex-reviews");if(g&&typeof g.scrollIntoView=="function"){var m=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;g.scrollIntoView({behavior:m?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:p}}function Pn(){return Bt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Nn(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=Rt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),It(t,{surface:"reviews",productId:r||""}),t}async function ut(e,r,t,a,n,p,o){if(kt){fr({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:p,badgeSettings:o});return}xr(!0),xt(e),ft(r),o!==void 0&&gt(o),ht(a),n&&cr(n),p&&Pe(p),t!=null&&(bt(t),ke(t&&t.data?t.data.nextCursor:null));var i=La({render:ut});try{let ye=function(B,X){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var we=B.meta.sizeOverrides[X];we&&Object.keys(we).forEach(function(Ae){v.style.setProperty(Ae,we[Ae])})}};var $e=ye,d=Ir(r.summaryLayout),l=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),f=r.showTitle!==!1,s=M(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),u=l&&f?s:"",v=document.documentElement;Ca(v,r);var y=r.borderRadius!==void 0?r.borderRadius:8,c=nt[r.size]||nt.medium,g=it[r.thumbnailSize]||it.medium,m=g;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(m=ot[r.thumbnailSize]||ot.medium),v.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),v.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),v.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),v.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),v.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),v.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),v.style.setProperty("--renuvex-pr-radius",y+"px"),v.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,y-4)+"px"),v.style.setProperty("--renuvex-pr-photo-title-size",c.photoTitleSize+"px"),v.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),v.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),v.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),v.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),v.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),v.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),v.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),v.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),v.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),v.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),v.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),v.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),v.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),v.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),v.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size",g+"px"),v.style.setProperty("--renuvex-pr-thumbnail-size-mobile",m+"px");var h=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";v.style.setProperty("--renuvex-pr-review-star-color",h),v.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),v.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),ye(Ir(r.summaryLayout),r.size),ye(Mr(r.reviewLayout),r.size);var x=ar(r),k=Pn();if(!k)return;var b=Nn(k,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==b&&b.appendChild(z);var E=Mt(z),A=Ue+He+kr+fa()+ya();Ve(E,A);var w=Ft(E);if(r.enabled===!1){z.style.minHeight="auto",w.replaceChildren(wa(r.borderRadius!==void 0?r.borderRadius:8)),xr(!1);var T=mr;fr(null),T&&ut(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var S=t||{},L=Dr(S),P=L?[]:S.data&&S.data.reviews||[];yt(P),w.replaceChildren();var C=document.createElement("section");if(C.id="renuvex-reviews-widget",C.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),C.className="renuvex-pr-reviews-widget",C.setAttribute("data-renuvex-surface","reviews"),e&&C.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(C.style.width="100%",C.style.maxWidth="100%",C.style.marginLeft="0",C.style.marginRight="0"),u){var N=document.createElement("div"),Y=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+Y,N.textContent=u,C.appendChild(N)}if(L){C.appendChild(za(S.message,i.onRetry)),w.appendChild(C),Ne(E),Fr(C,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return E.getElementById("renuvex-reviews-widget")});return}var G=S.data&&S.data.allCount||0,ee=S.data&&S.data.ratingCounts||null,D=ee||[0,0,0,0,0],O=S.data&&S.data.avgRating||"0.0";if(!ee&&P.length>0){P.forEach(function(B){B.rating>=1&&B.rating<=5&&D[B.rating-1]++});var oe=P.reduce(function(B,X){return B+X.rating},0);O=(oe/P.length).toFixed(1)}if(G>0){var W=Ir(r.summaryLayout),q=W.render({widget:C,productId:e,data:S,settings:r,iconPair:x,allCount:G,ratingCounts:D,avgRatingVal:O,currentRatingFilter:J,currentOrderBy:U,currentHasImages:Z,onFilterChange:i.onFilterChange,onSortChange:i.onSortChange});C.appendChild(q)}else{var K=document.createElement("button");K.className="renuvex-pr-write-btn",K.style.cssText="display:block;margin:16px auto 0;",K.textContent=M(r.writeButtonText,"Yorum Yap"),K.onclick=V,C.appendChild(K)}var ce=Ea({settings:r,root:v,currentHasImages:Z,photoStripReviews:vt,openReviewModal:ve,wireLightboxTrigger:Ee});if(ce&&C.appendChild(ce),P.length===0){var re=document.createElement("p");re.className="renuvex-pr-state-msg",re.textContent="Hen\xFCz yorum yok.",C.appendChild(re)}else{var j=Mr(r.reviewLayout);P.forEach(function(B){C.appendChild(j.render(B,Or))})}var I=r.paginationMode==="numbered"?"numbered":"loadMore";if(I==="numbered"){var le=S.data&&S.data.totalPages||1;le>1&&C.appendChild(Ta({page:S.data&&S.data.page||tr||1,totalPages:le,onPageChange:i.onPageChange}))}var _=I==="loadMore"&&S.data&&S.data.hasMore;if(_){var H=document.createElement("button");H.className="renuvex-pr-load-more",H.textContent="Daha Fazla G\xF6ster",H.onclick=async function(){H.disabled=!0,H.textContent="Y\xFCkleniyor...";var B=Fe(),X=F,we=U,Ae=tr,ur=J,dr=Z,sr=vr,Qe=Ae+1,pe=await Be(X,we,Qe,ur,dr,null,sr);if(Oe(B,{productId:X,orderBy:we,page:Ae,ratingFilter:ur,hasImages:dr,nextCursor:sr}))if(pe&&!Dr(pe)&&pe.data&&Array.isArray(pe.data.reviews)){var dt=wt(pe.data.reviews);zt(dt),Pe(Qe),ke(pe.data.nextCursor||null);var Pa=Mr(R.reviewLayout);dt.forEach(function(Na){C.insertBefore(Pa.render(Na,Or),H)}),pe.data.hasMore?(H.disabled=!1,H.textContent="Daha Fazla G\xF6ster"):H.remove()}else H.disabled=!1,H.textContent="Tekrar Dene"},C.appendChild(H)}w.appendChild(C),Ne(E),Fr(C,"reviews-widget",{productId:e||""},function(){return E.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var Te=document.createElement("p");Te.style.cssText="text-align:center;color:#dc2626;",Te.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",w&&w.replaceChildren(Te)}}finally{if(xr(!1),mr){var te=mr;fr(null),ut(te.productId,te.settings,te.reviewsData,te.productName,te.orderBy,te.page,te.badgeSettings)}}}export{ut as render};
