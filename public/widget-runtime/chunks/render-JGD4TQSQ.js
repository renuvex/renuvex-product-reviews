...
`;function Qt(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function ea(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function ra(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",l=ea()&&!a;if(n>0){var d=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",d+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ta(e){var r=document.body.style,t=document.documentElement.style;ie(t,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var Qe=0,Fe=null;function mr(){return Qe+=1,Qe>1||(Fe=Qt(),ra(Fe)),Fe}function xr(){if(Qe!==0&&(Qe-=1,!(Qe>0))){var e=Fe;Fe=null,e&&ta(e)}}function aa(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function fr(){var e=aa();return!e||e===document.body||e===document.documentElement?null:e}function ve(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function na(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Fr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(na)}function er(e,r){var t=e,n=Fr(e);!n.length&&r&&(t=r,n=Fr(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;ve(a)}function gr(e,r,t){if(e.key==="Tab"){var n=Fr(r);if(!n.length){e.preventDefault(),er(r);return}var a=n[0],l=n[n.length-1],d=wt(t);if(!r.contains(d)){e.preventDefault(),ve(a);return}e.shiftKey&&d===a?(e.preventDefault(),ve(l)):!e.shiftKey&&d===l&&(e.preventDefault(),ve(a))}}var zt="renuvexPrOverlay";function hr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[zt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function ia(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[zt]===e.id)}function br(e){if(ia(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Oe(e){return ge(e)}function Ct(e,r,t,n,a){xr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&lr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),ve(a)}function oa(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ue(e.rating,A);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=se(e.createdAt),n.appendChild(a),n.appendChild(l),t.appendChild(n);var d=document.createElement("div");d.className="renuvex-pr-modal-title",d.textContent=e.title||"",d.style.display=e.title?"":"none",t.appendChild(d);var o=document.createElement("div");o.className="renuvex-pr-modal-author",o.textContent=e.author||"",t.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-modal-body",s.textContent=(e.comment||"").trim(),s.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(s);var v=document.createElement("div");v.className="renuvex-pr-modal-reply";var h=document.createElement("div");h.className="renuvex-pr-modal-reply-label",h.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var m=document.createElement("div");return m.className="renuvex-pr-modal-reply-text",m.textContent=e.merchantReply||"",v.appendChild(h),v.appendChild(m),v.style.display=e.merchantReply?"":"none",t.appendChild(v),r.appendChild(t),r}function St(e,r,t){var n=t||A,a=e.querySelector(".renuvex-pr-modal-scroll-content"),l=a.querySelector(".renuvex-pr-modal-stars");l.innerHTML=ue(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=se(r.createdAt);var d=a.querySelector(".renuvex-pr-modal-title");d.textContent=r.title||"",d.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var o=a.querySelector(".renuvex-pr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var s=a.querySelector(".renuvex-pr-modal-reply");s.querySelector(".renuvex-pr-modal-reply-label").textContent=n&&n.merchantReplyLabel||"Ma\u011Faza Sahibi",s.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",s.style.display=r.merchantReply?"":"none",e.scrollTop=0}function _r(e,r,t,n,a,l,d,o,s){var v=Oe(e),h=Math.max(0,Math.min(t||0,v.length-1)),m=document.createElement("div");m.className="renuvex-pr-modal-left";var i=document.createElement("img"),k=d==="next"?"renuvex-pr-modal-img-enter-right":d==="prev"?"renuvex-pr-modal-img-enter-left":"";i.className="renuvex-pr-modal-main-img"+(k?" "+k:""),i.src=Br(v[h]||""),i.decoding="async",i.width=Ir,i.height=Math.round(Ir*4/3),i.alt="Yorum foto\u011Fraf\u0131",ft(i,function(N){if(N.style.display="none",!m.querySelector(".renuvex-pr-modal-img-error")){var S=document.createElement("div");S.className="renuvex-pr-modal-img-error",S.setAttribute("role","status"),S.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",m.insertBefore(S,N)}}),m.appendChild(i);var u=document.createElement("button");u.className="renuvex-pr-modal-close-mobile";var b=Z(Ce);b&&u.appendChild(b),u.setAttribute("aria-label","Kapat"),u.onclick=function(N){N.stopPropagation(),l()},m.appendChild(u);var w=0;if(m.addEventListener("touchstart",function(N){w=N.touches[0].clientX},{passive:!0}),m.addEventListener("touchend",function(N){var S=w-N.changedTouches[0].clientX;if(!(Math.abs(S)<50)){if(S>0){if(x)ce(e,r,h+1,n,a,l,!0,"next",o,s);else if(y){var T=n[r+1];ce(T,r+1,0,n,a,l,!1,"next",o,s)}}else if(p)ce(e,r,h-1,n,a,l,!0,"prev",o,s);else if(g){var B=n[r-1],L=Oe(B);ce(B,r-1,L.length-1,n,a,l,!1,"prev",o,s)}}},{passive:!0}),v.length>1){var c=document.createElement("div");c.className="renuvex-pr-modal-thumbs",v.forEach(function(N,S){var T=document.createElement("img"),B=ae(N,sr);T.src=B.src,T.srcset=B.srcset,T.loading="lazy",T.decoding="async",T.width=sr,T.height=sr,T.className="renuvex-pr-modal-thumb"+(S===h?" renuvex-pr-modal-thumb-active":""),T.alt="K\xFC\xE7\xFCk resim "+(S+1),ne(T),T.tabIndex=0,T.setAttribute("role","button"),T.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(S+1)+" se\xE7"),S===h&&T.setAttribute("aria-current","true"),(function(L){function U(){ce(e,r,L,n,a,l,!0,null,o,s)}T.onclick=U,T.onkeydown=function(G){(G.key==="Enter"||G.key===" ")&&(G.preventDefault(),U())}})(S),c.appendChild(T)}),m.appendChild(c)}var p=h>0,x=h<v.length-1,g=r>0,y=r<n.length-1,z=p||g,f=x||y;if(z){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var P=Z(Re);P&&C.appendChild(P),C.setAttribute("aria-label","\xD6nceki"),C.onclick=function(N){if(N.stopPropagation(),p)ce(e,r,h-1,n,a,l,!0,"prev",o,s);else if(g){var S=n[r-1],T=Oe(S);ce(S,r-1,T.length-1,n,a,l,!1,"prev",o,s)}},m.appendChild(C)}if(f){var E=document.createElement("button");E.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var R=Z(pr);R&&E.appendChild(R),E.setAttribute("aria-label","Sonraki"),E.onclick=function(N){if(N.stopPropagation(),x)ce(e,r,h+1,n,a,l,!0,"next",o,s);else if(y){var S=n[r+1];ce(S,r+1,0,n,a,l,!1,"next",o,s)}},m.appendChild(E)}return m}function Et(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Oe(n);a[0]&&(new Image().src=Br(a[0]))}})}function Or(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function la(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Or(t),Or(n),Or(a)}l(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ce(e,r,t,n,a,l,d,o,s,v){if(v&&(v.currentReview=e),d){var h=_r(e,r,t,n,a,l,o,s,v);a.firstChild&&a.replaceChild(h,a.firstChild)}else{var h=_r(e,r,t,n,a,l,o,s,v),m=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&a.replaceChild(h,a.firstChild),m&&St(m,e,v&&v.currentSettings),la(s,a)}Et(r,n)}function oe(e,r,t){var n=Oe(e);if(!n.length)return;var a=(t||[]).filter(function(f){return Oe(f).length>0}),l=a.findIndex(function(f){return f===e||f.id===e.id});l===-1&&(a.unshift(e),l=0);var d=n.indexOf(r);d<0&&(d=0);var o=document.createElement("div");o.className="renuvex-pr-modal-overlay";var s=document.createElement("div");s.className="renuvex-pr-modal";var v=!1,h=null,m=fr(),i=mr(),k=hr(),u={currentReview:e,currentSettings:A},b=null;function w(f){var C=f&&f.detail&&f.detail.settings;if(!(C&&C===b)){b=C||null,u.currentSettings=C||A;var P=s.querySelector(".renuvex-pr-modal-right");!P||!u.currentReview||St(P,u.currentReview,u.currentSettings)}}function c(){v||(v=!0,window.removeEventListener(Se,w),Ct(h&&h.host,p,c,i,m))}function p(f){if(f.key==="Escape"){x();return}gr(f,o,h&&h.root)}function x(){v||(v=!0,window.removeEventListener(Se,w),Ct(h&&h.host,p,c,i,m),br(k))}document.addEventListener("keydown",p),window.addEventListener("popstate",c),window.addEventListener(Se,w),o.onclick=function(){x()},s.onclick=function(f){f.stopPropagation()},s.appendChild(_r(e,l,d,a,s,x,null,o,u)),s.appendChild(oa(e)),Et(l,a);var g=document.createElement("div");g.className="renuvex-pr-modal-wrap",g.tabIndex=-1,g.setAttribute("role","dialog"),g.setAttribute("aria-modal","true"),g.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),g.appendChild(s);var y=document.createElement("button");y.className="renuvex-pr-modal-close";var z=Z(Ce);z&&y.appendChild(z),y.setAttribute("aria-label","Kapat"),y.onclick=function(f){f.stopPropagation(),x()},g.appendChild(y),o.appendChild(g),h=vr(),Me(h.root,Be+Ae+cr),h.root.appendChild(o),ze(h.root),er(o)}var Dr={};xe(Dr,{meta:()=>xa,render:()=>fa});function _e(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,l=e.onFilterChange;fe(n);var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var o=5;o>=1;o--){var s=r[o-1]||0,v=t>0?Math.round(s/t*100):0,h=a===o,m=document.createElement("div");m.className="renuvex-pr-bar-row"+(h?" renuvex-pr-bar-active":""),a&&!h&&(m.style.opacity="0.35");for(var i="",k=1;k<=5;k++){var u=k<=o;i+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(u?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+J(u?"full":"outline")+"</span>"}m.innerHTML='<span class="renuvex-pr-bar-label">'+i+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+v+'%;"></div></div><span class="renuvex-pr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(b){m.onclick=function(){l(b)}})(o),d.appendChild(m)}return d}var le=[],Tt=!1,yr=!1;function At(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function pa(e){if(yr){yr=!1,e.preventDefault(),e.stopPropagation();return}for(var r=!1,t=le.length-1;t>=0;t--){var n=le[t];At(e,n.trigger)||At(e,n.element)||n.close()&&(r=!0)}r&&(e.preventDefault(),e.stopPropagation())}function da(e){if(e.key==="Escape")for(var r=le.length-1;r>=0;r--)le[r].close()}function ua(){Tt||typeof document=="undefined"||(document.addEventListener("click",pa,!0),document.addEventListener("keydown",da),Tt=!0)}function wr(e){for(var r=0;r<le.length;r++)le[r]!==e&&le[r].close()}function Lt(){yr=!0,typeof setTimeout=="function"&&setTimeout(function(){yr=!1},700)}function kr(e){ua();var r={trigger:e.trigger,element:e.element,close:e.close};return le.push(r),function(){var n=le.indexOf(r);n!==-1&&le.splice(n,1)}}function Q(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,l=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var o=document.createElement("button");o.className="renuvex-pr-write-btn",o.textContent=A&&A.writeButtonText||"Yorum Yap",o.onclick=a,d.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-filter-wrap";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-filter-btn",v.setAttribute("aria-label","Filtrele"),v.setAttribute("aria-haspopup","menu"),v.setAttribute("aria-expanded","false");var h=A&&A.filterIcon||"lines";v.innerHTML=de(dt(h));var m=document.createElement("div");m.className="renuvex-pr-filter-menu",m.setAttribute("role","menu");var i=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],k=!1;function u(c){var p=m.classList.contains("renuvex-pr-open");m.classList.remove("renuvex-pr-open"),v.classList.remove("renuvex-pr-filter-btn-active"),v.setAttribute("aria-expanded","false");var x=c&&(c.restoreFocus===!0||c.restoreFocus==="auto"&&ar());if(p&&x)try{v.focus({preventScroll:!0})}catch(g){try{v.focus()}catch(y){}}return p}function b(){wr(w),m.classList.add("renuvex-pr-open"),v.classList.add("renuvex-pr-filter-btn-active"),v.setAttribute("aria-expanded","true");var c=m.querySelector(".renuvex-pr-filter-item-active")||m.querySelector(".renuvex-pr-filter-item");c&&requestAnimationFrame(function(){try{c.focus({preventScroll:!0})}catch(p){try{c.focus()}catch(x){}}})}i.forEach(function(c){var p=c[2],x=p?n:!n&&(t||"newest")===c[0],g=document.createElement("button");g.type="button",g.className="renuvex-pr-filter-item"+(x?" renuvex-pr-filter-item-active":""),g.setAttribute("role","menuitem"),g.textContent=c[1];var y=!1;function z(f,C){f&&(f.preventDefault(),f.stopPropagation()),!y&&(y=!0,k=!0,C!==!0&&Lt(),u({restoreFocus:C}),l(c[0],p),setTimeout(function(){y=!1,k=!1},0))}g.addEventListener("pointerdown",function(f){f.button!==void 0&&f.button!==0||z(f,!1)}),typeof window!="undefined"&&!window.PointerEvent&&g.addEventListener("touchstart",function(f){z(f,!1)},{passive:!1}),g.addEventListener("mousedown",function(f){f.button!==void 0&&f.button!==0||z(f,!1)}),g.addEventListener("keydown",function(f){(f.key==="Enter"||f.key===" ")&&z(f,!0)}),g.onclick=function(f){z(f,!1)},m.appendChild(g)}),v.onclick=function(){m.classList.contains("renuvex-pr-open")?u({restoreFocus:"auto"}):b()},s.addEventListener("keydown",function(c){c.key==="Escape"&&m.classList.contains("renuvex-pr-open")&&(c.stopPropagation(),u({restoreFocus:!0}))}),s.addEventListener("focusout",function(c){if(m.classList.contains("renuvex-pr-open")&&!k){var p=c.relatedTarget;p&&s.contains(p)||u()}});var w=kr({trigger:s,element:m,close:u});return s.appendChild(v),s.appendChild(m),d.appendChild(s),d}var Nt=`
...
`;function Pt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,n=document.createElement("div");n.className="renuvex-pr-fwizard-overlay",n.tabIndex=-1,n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Yorum yapma formu");var a=document.createElement("div");a.className="renuvex-pr-fwizard",n.appendChild(a);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var d=Z(Ce);d&&l.appendChild(d),a.appendChild(l);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content",a.appendChild(o);var s=!1,v=null,h=null,m=!1;function i(){er(o,n)}function k(y){gr(y,n,v&&v.root)}function u(){s||(s=!0,document.removeEventListener("keydown",b),n.removeEventListener("click",w),l.removeEventListener("click",u),n.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){v?(lr(v.root),v.host&&v.host.parentNode&&v.host.parentNode.removeChild(v.host)):n.parentNode&&n.parentNode.removeChild(n),xr(),m&&ve(h);try{r()}catch(y){}},200))}function b(y){if(y.key==="Escape"){u();return}k(y)}function w(y){y.target===n&&t&&u()}document.addEventListener("keydown",b),n.addEventListener("click",w),l.addEventListener("click",u);function c(y){h=fr(),m=ar(),y&&o.appendChild(y),v=vr(),Me(v.root,Be+Ae+Nt),v.root.appendChild(n),ze(v.root),mr(),requestAnimationFrame(function(){n.classList.add("renuvex-pr-fwizard-open"),i()})}var p=null,x=null;function g(y,z){if(z=z||"error",p){try{p.remove()}catch(f){}p=null}x&&(clearTimeout(x),x=null),p=document.createElement("div"),p.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,p.textContent=y,a.appendChild(p),x=setTimeout(function(){p&&(p.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(p){try{p.remove()}catch(f){}p=null}},300))},4e3)}return{open:c,close:u,content:o,setAllowOutsideClose:function(y){t=!!y},setStepAttr:function(y){a.setAttribute("data-step",String(y))},focusFirstControl:i,showToast:g}}var Hr=4;function He(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Rt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(l){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<Hr&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(l){return l!==a})}}}}function It(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},l=e.onNext||function(){},d=document.createElement("div");d.className="renuvex-pr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=de(Re)+"<span>Geri</span>",o.addEventListener("click",function(){n()}),d.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-fwizard-footer-progress";for(var v=[],h=0;h<Hr;h++){var m=document.createElement("span");m.className="renuvex-pr-fwizard-progress-seg",s.appendChild(m),v.push(m)}d.appendChild(s);var i=document.createElement("button");i.type="button";var k=null;function u(w){k&&i.removeEventListener("click",k),k=w,w&&i.addEventListener("click",w)}d.appendChild(i);function b(w,c){var p=r.indexOf(w)!==-1,x=t.indexOf(w)!==-1,g=c&&(c.images&&c.images.length>0||c.pendingImages&&c.pendingImages.length>0);if(p)w===2&&g?(i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",u(function(){l()})):(i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.setAttribute("aria-label","Atla"),i.innerHTML="<span>Atla</span>",u(function(){a()})),i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),i.style.visibility="",i.tabIndex=0;else if(x){i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Sonraki"),i.innerHTML="Sonraki",i.style.visibility="",i.tabIndex=0;var y=He(w,c);i.disabled=!y,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!y),u(function(){i.disabled||l()})}else i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.innerHTML="",i.style.visibility="hidden",i.tabIndex=-1,i.disabled=!0,u(null)}return{el:d,update:function(w,c){v.forEach(function(x,g){g+1<=w?x.classList.add("renuvex-pr-fwizard-progress-seg-active"):x.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var p=w<=1;o.style.visibility=p?"hidden":"",o.style.pointerEvents=p?"none":"",o.tabIndex=p?-1:0,b(w,c)},setNextDisabled:function(w){i.classList.contains("renuvex-pr-fwizard-cta-btn")&&(i.disabled=!!w,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!w))},setThanksState:function(w){o.style.visibility="hidden",s.style.visibility="hidden",i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",i.style.visibility="",i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),u(w)}}}function Bt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-stars",d.setAttribute("role","radiogroup"),d.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var o=Je(A||{});fe(o);var s=[];function v(c){s.forEach(function(p,x){var g=x<c;p.classList.toggle("renuvex-pr-fwizard-star-active",g),p.setAttribute("aria-checked",x+1===c?"true":"false"),p.innerHTML=g?J("full"):J("outline")})}function h(c){s.forEach(function(p,x){p.tabIndex=x===c?0:-1})}function m(c){e.set({rating:c}),v(c),h(c-1)}function i(c){var p=s[c-1];if(p)try{p.focus()}catch(x){}}function k(c,p){p&&typeof p.preventDefault=="function"&&p.preventDefault(),p&&typeof p.stopPropagation=="function"&&p.stopPropagation(),!n&&(n=!0,m(c),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var u=1;u<=5;u++)(function(c){var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-star",p.setAttribute("role","radio"),p.setAttribute("aria-label",c+" y\u0131ld\u0131z"),p.innerHTML=J("outline"),p.addEventListener("mouseenter",function(){v(c)}),p.addEventListener("mouseleave",function(){v(e.get().rating)}),p.addEventListener("pointerdown",function(x){x.button&&x.button!==0||k(c,x)}),typeof window!="undefined"&&!window.PointerEvent&&p.addEventListener("touchstart",function(x){k(c,x)},{passive:!1}),p.addEventListener("mousedown",function(x){window.PointerEvent||k(c,x)}),p.addEventListener("keydown",function(x){if(x.key==="Enter"||x.key===" "){k(c,x);return}var g=0;x.key==="ArrowRight"||x.key==="ArrowUp"?g=Math.min(5,c+1):x.key==="ArrowLeft"||x.key==="ArrowDown"?g=Math.max(1,c-1):x.key==="Home"?g=1:x.key==="End"&&(g=5),g&&(x.preventDefault(),m(g),i(g))}),p.addEventListener("click",function(x){k(c,x)}),s.push(p),d.appendChild(p)})(u);v(e.get().rating),h(e.get().rating>0?e.get().rating-1:0);var b=null,w=function(c){var p=c&&c.detail&&c.detail.settings;p&&p===b||(b=p||null,o=Je(p||A||{}),v(e.get().rating))};return window.addEventListener(Se,w),t.appendChild(d),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Se,w)}}}var Mt=3,sa=10*1024*1024;function Ft(e,r){r=r||{};var t=!1,n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",n.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",n.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle");var s=document.createElement("input");s.type="file",s.accept="image/*",s.multiple=!0,s.style.display="none",d.appendChild(o),d.appendChild(s);var v=document.createElement("div");v.className="renuvex-pr-fwizard-photo-previews",v.setAttribute("aria-live","polite"),d.appendChild(v),n.appendChild(d);var h=r.blobMap||{},m=r.urlToFinger||{};function i(){if(!t){var c=e.get().images||[],p=e.get().pendingImages||[],x=c.map(function(g){return{url:g,isPending:!1}}).concat(p.map(function(g){return{url:g.url,file:g.file,isPending:!0,error:g.error}}));v.innerHTML="",x.forEach(function(g){var y=h[g.url]||g.url,z=k(g,y);v.appendChild(z)}),b()}}function k(c,p){var x=document.createElement("div");x.className="renuvex-pr-fwizard-photo-thumb";var g=document.createElement("img");g.src=p,g.alt="",g.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",x.appendChild(g);var y=document.createElement("div");y.className="renuvex-pr-fwizard-photo-loading",y.style.display="none",x.appendChild(y);var z=document.createElement("button");z.type="button",z.className="renuvex-pr-fwizard-photo-remove",z.setAttribute("aria-label","Kald\u0131r");var f=Z(Ce);return f&&z.appendChild(f),x.appendChild(z),u(x,c,p),x}function u(c,p,x){var g=c.querySelector("img");g.src!==x&&(g.src=x);var y=c.querySelector(".renuvex-pr-fwizard-photo-loading");if(p.isPending&&p.error){y.style.display="flex",y.textContent="";var z=document.createElement("span");z.className="renuvex-pr-upload-error",z.textContent="\u2717 "+p.error,y.appendChild(z)}else y.style.display="none",y.textContent="";var f=c.querySelector(".renuvex-pr-fwizard-photo-remove");f.onclick=function(){var C=m[p.url]||(p.file?p.file.name+"_"+p.file.size:null);if(p.url.startsWith("blob:")&&URL.revokeObjectURL(p.url),C){var P=(e.get().fingerprints||[]).filter(function(N){return N!==C});e.set({fingerprints:P})}if(p.isPending){var E=(e.get().pendingImages||[]).filter(function(N){return N.url!==p.url});e.set({pendingImages:E})}else{var R=(e.get().images||[]).filter(function(N){return N!==p.url});e.set({images:R})}}}function b(){var c=(e.get().images||[]).length,p=(e.get().pendingImages||[]).length,x=c+p,g=x>=Mt;x>0?(d.classList.add("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=de(vt)):(d.classList.remove("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=de(st)+"<span>Foto\u011Fraf Ekle</span>"),g?(o.style.display="none",o.disabled=!0,s.disabled=!0):(o.style.display="flex",o.disabled=!1,s.disabled=!1,o.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){s.disabled||s.click()}),s.onchange=async function(c){var p=(e.get().images||[]).length+(e.get().pendingImages||[]).length,x=Array.from(c.target.files).slice(0,Mt-p);s.value="";var g=(e.get().pendingImages||[]).length,y=e.get().images||[],z=y.length;if(x.length!==0){for(var f=[],C=[],P=0;P<x.length;P++){var E=x[P],R=E.name+"_"+E.size,N=(e.get().fingerprints||[]).some(function(O){return O===R})||f.some(function(O){return O.file.name+"_"+O.file.size===R});if(N){console.log("[renuvex-pr] Duplicate file detected, skipping:",E.name);continue}if(E.size>sa){var S="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(S,"error"):alert(S);continue}var T=URL.createObjectURL(E);m[T]=R,f.push({url:T,file:E,error:null}),C.push({url:T,file:E});var B=(e.get().fingerprints||[]).slice();B.push(R),e.set({fingerprints:B})}if(f.length!==0){var L=(e.get().pendingImages||[]).concat(f),U=async function(){for(var O=0;O<C.length;O++){var _=C[O],W=_.file,q=_.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var je=(e.get().pendingImages||[]).filter(function(H){return H.url!==q}),Te=(e.get().images||[]).slice();Te.push(q),e.set({pendingImages:je,images:Te});continue}try{var he=await Ze(Xe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:qe})});if(!he.ok)throw he.status===429?new Error("rate_limit"):new Error("sign failed");var D=await he.json();if(!D.folder)throw new Error("sign folder missing");var j=new FormData;j.append("file",W),j.append("api_key",D.api_key),j.append("timestamp",D.timestamp),j.append("signature",D.signature),j.append("folder",D.folder);var pe=await fetch("https://api.cloudinary.com/v1_1/"+D.cloud_name+"/image/upload",{method:"POST",body:j}),ee=await pe.json();if(ee.secure_url&&xt(ee.secure_url)){var be=(e.get().pendingImages||[]).some(function(H){return H.url===q});if(!be){console.log("[renuvex-pr] Upload finished but image was already deleted by user. Aborting state update.");return}h[ee.secure_url]=q,m[ee.secure_url]=m[q];var Ve=(e.get().pendingImages||[]).filter(function(H){return H.url!==q}),re=(e.get().images||[]).slice();re.push(ee.secure_url),e.set({pendingImages:Ve,images:re});try{Ze(Xe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:qe,secureUrl:ee.secure_url})}).catch(function(){})}catch(H){}}else throw new Error("invalid image url")}catch(H){console.error("[renuvex-pr] Image upload failed:",H);var ye=H.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ye,"error");var Ue=(e.get().pendingImages||[]).map(function(X){return X.url===q?{url:X.url,file:X.file,error:ye}:X});e.set({pendingImages:Ue})}}};if(z===0&&g===0){t=!0;var G=!r.canNavigate||r.canNavigate();G&&e.goNext()}e.set({pendingImages:L}),U()}}};var w=e.onChange(i);return i(),{el:n,destroy:function(){t=!0,s.onchange=null,w&&w()}}}var Yr=2e3,va=60;function Ot(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent="Deneyiminizi anlat\u0131n",n.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var d=document.createElement("input");d.type="text",d.className="renuvex-pr-fwizard-input",d.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",d.maxLength=va,d.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),d.value=e.get().title||"",d.addEventListener("input",function(){e.set({title:d.value})}),l.appendChild(d);var o=document.createElement("textarea");o.className="renuvex-pr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=Yr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",l.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-fwizard-char-counter",s.setAttribute("aria-live","polite"),l.appendChild(s);function v(){var m=o.value.length;s.textContent=m+"/"+Yr,s.classList.toggle("renuvex-pr-fwizard-char-counter--max",m>=Yr)}function h(){return He(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),v(),t(h())}),n.appendChild(l),v(),setTimeout(function(){t(h())},0),{el:n,destroy:function(){}}}var ca=40;function _t(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",a.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-author-form";var o=document.createElement("div");o.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var v=document.createElement("input");v.type="text",v.className="renuvex-pr-fwizard-input",v.maxLength=ca,v.setAttribute("aria-required","true"),v.value=e.get().author||"",o.appendChild(s),o.appendChild(v),d.appendChild(o);var h=document.createElement("div");h.className="renuvex-pr-fwizard-field";var m=document.createElement("label");m.className="renuvex-pr-fwizard-label",m.textContent="E-posta (opsiyonel)";var i=document.createElement("input");i.type="email",i.className="renuvex-pr-fwizard-input",i.setAttribute("autocomplete","email"),i.value=e.get().email||"",h.appendChild(m),h.appendChild(i),d.appendChild(h);var k=document.createElement("div");k.className="renuvex-pr-fwizard-notice",k.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",d.appendChild(k);var u=document.createElement("div");u.className="renuvex-pr-fwizard-msg",u.setAttribute("role","alert"),u.setAttribute("aria-live","assertive"),d.appendChild(u);var b=document.createElement("button");b.type="button",b.className="renuvex-pr-fwizard-submit-btn",b.textContent="G\xF6nder",d.appendChild(b),a.appendChild(d);function w(){return He(4,e.get())}function c(){var y=!w(),z=(e.get().pendingImages||[]).length,f=z>0;f?(b.disabled=!0,b.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),b.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(b.disabled=y,b.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",y),b.textContent="G\xF6nder")}v.addEventListener("input",function(){e.set({author:v.value}),c(),t(w())}),i.addEventListener("input",function(){e.set({email:i.value})}),c(),setTimeout(function(){t(w())},0);function p(){u.textContent=""}function x(y){p();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=y||"",u.appendChild(z)}b.onclick=async function(){if(!b.disabled){var y=e.get(),z=(y.author||"").trim(),f=(y.comment||"").trim();if(i.value.trim()&&!i.checkValidity()){i.reportValidity();return}if(!z){x("Gerekli alan");return}if(!y.rating){x("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}b.disabled=!0,b.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var C=b.textContent;if(b.textContent="G\xF6nderiliyor\u2026",p(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){n()},600);return}try{var P=ct(window.location.href),E=y.productName||null,R=await Ze(Xe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:qe,productId:y.productId||null,slug:P||null,productName:E,author:z,title:(y.title||"").trim()||null,comment:f||null,rating:y.rating,images:y.images||[]})},15e3);if(R.ok)n();else{var N=await R.json().catch(function(){return{}});throw new Error(N.error||"Yorum kaydedilemedi.")}}catch(B){var S=B&&(B.name==="AbortError"||/signal/i.test(B.message||"")),T=S?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":B.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(T,"error"):x(T),b.disabled=!1,b.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),b.textContent=C}}};var g=e.onChange(c);return{el:a,destroy:function(){b.onclick=null,g&&g()}}}function ma(e,r,t){if(t=t||{},e===1)return Bt(r,{canNavigate:t.canNavigate});if(e===2)return Ft(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,showToast:t.showToast});if(e===3)return Ot(r,{onValidityChange:t.onValidityChange});if(e===4)return _t(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Ht(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Yt(e){e=e||{};var r=Rt({productId:e.productId,productName:e.productName}),t={},n={},a=Pt({onClose:function(){window.removeEventListener("popstate",d),br(l),Object.keys(t).forEach(function(z){var f=t[z];f&&f.startsWith("blob:")&&URL.revokeObjectURL(f)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),l=hr(),d=function(z){a&&a.close&&a.close()};window.addEventListener("popstate",d);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-wrap";var s=It({skippableSteps:[2],nextableSteps:[3],onBack:function(){m==="idle"&&r.goBack()},onSkip:function(){m==="idle"&&r.goNext()},onNext:function(){m==="idle"&&r.goNext()}}),v=document.createElement("div");v.className="renuvex-pr-fwizard-layout",v.appendChild(o),v.appendChild(s.el);var h=null,m="idle",i=null,k=!0,u=null;function b(z,f){o.innerHTML="";var C=ma(z,r,{canNavigate:function(){return m==="idle"},blobMap:t,urlToFinger:n,onValidityChange:function(R){s.setNextDisabled(!R)},onSuccess:c,showToast:a.showToast});if(h=C,s.update(z,r.get()),f){m="entering",C.el.classList.add("renuvex-pr-fwizard-step--enter");var P=null,E=function(){P&&clearTimeout(P),C.el.removeEventListener("animationend",E),C.el.classList.remove("renuvex-pr-fwizard-step--enter"),m="idle",i!==null&&p()};C.el.addEventListener("animationend",E),P=setTimeout(E,700)}else m="idle";o.appendChild(C.el),a.setStepAttr&&a.setStepAttr(z),z===3&&s.setNextDisabled(!0)}var w=!1;function c(){if(!w){if(w=!0,!h){o.innerHTML="";var z=Ht();z.classList.add("renuvex-pr-fwizard-step--enter"),o.appendChild(z),a.setStepAttr("thanks"),s.setThanksState(a.close);return}var f=h;m="exiting",f.el.classList.add("renuvex-pr-fwizard-step--exit");var C=function(){if(u&&clearTimeout(u),f.el.removeEventListener("animationend",C),f.destroy)try{f.destroy()}catch(E){}h===f&&(h=null),o.innerHTML="";var P=Ht();P.classList.add("renuvex-pr-fwizard-step--enter"),o.appendChild(P),a.setStepAttr("thanks"),s.setThanksState(a.close),m="idle"};f.el.addEventListener("animationend",C),u=setTimeout(C,300)}}function p(){var z=r.get().currentStep;if(m!=="idle"){i=z;return}if(!h){var f=!k;k=!1,b(z,f);return}var C=h;m="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var P=function(){if(u&&clearTimeout(u),C.el.removeEventListener("animationend",P),C.destroy)try{C.destroy()}catch(R){}if(h===C){o.innerHTML="",h=null;var E=i!==null?i:r.get().currentStep;i=null,b(E,!0),m="idle"}};C.el.addEventListener("animationend",P),u=setTimeout(P,350)}p();var x=r.get().currentStep,g=r.onChange(function(z){z.currentStep!==x?(x=z.currentStep,p()):s.update(z.currentStep,z)}),y=a.close;return a.close=function(){g&&g(),typeof u!="undefined"&&u&&clearTimeout(u),y()},a.open(v),{close:a.close}}function Y(){Yt({productId:te||"",productName:Pe||""})}var xa={id:"classic",name:"Klasik (A\xE7\u0131k)"};function fa(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,l=e.allCount,d=e.ratingCounts,o=e.avgRatingVal,s=e.currentRatingFilter,v=e.currentOrderBy,h=e.currentHasImages,m=e.onFilterChange,i=e.onSortChange;fe(a);var k=document.createElement("div");k.className="renuvex-pr-summary";var u=(d[3]||0)+(d[4]||0),b=l>0?Math.round(u/l*100):0,w=document.createElement("div");w.className="renuvex-pr-summary-block renuvex-pr-summary-avg",w.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+J("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",k.appendChild(w);var c=document.createElement("div");if(c.className="renuvex-pr-summary-block renuvex-pr-summary-count",c.textContent=l.toLocaleString("tr-TR")+" Yorum",k.appendChild(c),n.showRecommendation!==!1&&b>0){var p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",p.innerHTML='<span class="renuvex-pr-recommend-pct">%'+b+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(p)}return k.appendChild(_e({ratingCounts:d,allCount:l,iconPair:a,currentRatingFilter:s,onFilterChange:m})),k.appendChild(Q({widget:r,currentOrderBy:v,currentHasImages:h,onWriteClick:Y,onSortChange:i})),k}var jr={};xe(jr,{css:()=>ha,meta:()=>ga,render:()=>ba});var Dt=`
...
`;var ga={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ha=Dt;function ba(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,l=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,v=e.currentHasImages,h=e.onFilterChange,m=e.onSortChange,i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-compact";var k=document.createElement("div");k.className="renuvex-pr-compact-header";var u=document.createElement("div");u.className="renuvex-pr-compact-trigger-wrap";var b=document.createElement("button");b.className="renuvex-pr-compact-trigger",b.type="button",b.setAttribute("aria-expanded","false"),b.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Ie(d,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+a.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+de(ut)+"</span>",u.appendChild(b),k.appendChild(u);var w=Q({widget:r,currentOrderBy:s,currentHasImages:v,onWriteClick:Y,onSortChange:m}),c=w.querySelector(".renuvex-pr-filter-wrap"),p=w.querySelector(".renuvex-pr-write-btn"),x=document.createElement("div");x.className="renuvex-pr-compact-actions-slot",p&&x.appendChild(p),c&&x.appendChild(c),k.appendChild(x),i.appendChild(k);var g=document.createElement("div");g.className="renuvex-pr-compact-panel",g.setAttribute("role","dialog"),g.setAttribute("aria-hidden","true");var y=document.createElement("div");y.className="renuvex-pr-compact-panel-inner";var z=document.createElement("div");z.className="renuvex-pr-compact-avg",z.innerHTML='<span class="renuvex-pr-icon">'+J("full")+"</span><span>"+d+"</span>",y.appendChild(z),y.appendChild(_e({ratingCounts:l,allCount:a,iconPair:n,currentRatingFilter:o,onFilterChange:h})),g.appendChild(y);var f=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(_){var W=_?i:u;g.parentNode!==W&&(g.classList.contains("renuvex-pr-open")&&(g.classList.remove("renuvex-pr-open"),g.setAttribute("aria-hidden","true"),b.setAttribute("aria-expanded","false")),W.appendChild(g))}if(C(f?f.matches:!1),f){var P=function(_){C(_.matches)};f.addEventListener?f.addEventListener("change",P):f.addListener&&f.addListener(P)}if(p){var E=document.createElement("button");E.className="renuvex-pr-write-btn",E.textContent=A&&A.writeButtonText||"Yorum Yap",E.onclick=Y;var R=document.createElement("div");R.className="renuvex-pr-compact-write-row",R.appendChild(E),i.appendChild(R)}function N(){g.classList.remove("renuvex-pr-open"),g.setAttribute("aria-hidden","true"),b.setAttribute("aria-expanded","false")}function S(){wr(T),g.classList.add("renuvex-pr-open"),g.setAttribute("aria-hidden","false"),b.setAttribute("aria-expanded","true")}b.onclick=function(){g.classList.contains("renuvex-pr-open")?N():S()};var T=null;function B(_){T&&(T(),T=null),_||(T=kr({trigger:u,element:g,close:N}))}if(B(f?f.matches:!1),f){var L=function(_){B(_.matches)};f.addEventListener?f.addEventListener("change",L):f.addListener&&f.addListener(L)}if(t.showRecommendation!==!1){var U=(l[3]||0)+(l[4]||0),G=a>0?Math.round(U/a*100):0;if(G>0){var O=document.createElement("div");O.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",O.style.marginTop="8px",O.innerHTML='<span class="renuvex-pr-recommend-pct">%'+G+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",y.appendChild(O)}}return i}var Vr={};xe(Vr,{css:()=>wa,meta:()=>ya,render:()=>ka});var jt=`
...
`;var ya={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},wa=jt;function ka(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,l=e.ratingCounts,d=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,v=e.currentHasImages,h=e.onFilterChange,m=e.onSortChange;fe(n);var i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-split";var k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-left";var u=document.createElement("div");u.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",u.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+J("full")+'</span><span class="renuvex-pr-avg-num">'+d+"</span>",k.appendChild(u);var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",b.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(b),i.appendChild(k);var w=document.createElement("div");w.className="renuvex-pr-split-col renuvex-pr-split-mid",w.appendChild(_e({ratingCounts:l,allCount:a,iconPair:n,currentRatingFilter:o,onFilterChange:h})),i.appendChild(w);var c=Q({widget:r,currentOrderBy:s,currentHasImages:v,onWriteClick:Y,onSortChange:m}),p=c.querySelector(".renuvex-pr-filter-wrap"),x=c.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");g.className="renuvex-pr-split-col renuvex-pr-split-right",x&&g.appendChild(x),p&&g.appendChild(p),i.appendChild(g);var y=(l[3]||0)+(l[4]||0),z=a>0?Math.round(y/a*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",f.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var C=t.showRecommendation===!1||z===0;return C&&f.classList.add("renuvex-pr-split-rec-hidden"),k.appendChild(f),i}var Ur={};xe(Ur,{css:()=>Ca,meta:()=>za,render:()=>Sa});var Vt=`
...
`;var za={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Ca=Vt;function Sa(e){var r=e.widget,t=e.iconPair,n=e.allCount,a=e.avgRatingVal,l=e.currentOrderBy,d=e.currentHasImages,o=e.onSortChange,s=document.createElement("div");s.className="renuvex-pr-summary renuvex-pr-summary-minimal";var v=document.createElement("div");v.className="renuvex-pr-minimal-info";var h=document.createElement("div");h.className="renuvex-pr-minimal-row";var m=document.createElement("span");m.className="renuvex-pr-minimal-avg",m.textContent=a,h.appendChild(m);var i=document.createElement("span");i.className="renuvex-pr-minimal-stars",i.innerHTML=Ie(a,t),h.appendChild(i);var k=document.createElement("span");k.className="renuvex-pr-minimal-count",k.textContent=n.toLocaleString("tr-TR")+" Yorum",h.appendChild(k),v.appendChild(h),s.appendChild(v);var u=Q({widget:r,currentOrderBy:l,currentHasImages:d,onWriteClick:Y,onSortChange:o}),b=u.querySelector(".renuvex-pr-filter-wrap"),w=u.querySelector(".renuvex-pr-write-btn"),c=document.createElement("div");if(c.className="renuvex-pr-minimal-actions",w&&c.appendChild(w),b&&c.appendChild(b),s.appendChild(c),w){var p=document.createElement("button");p.className="renuvex-pr-write-btn",p.textContent=A&&A.writeButtonText||"Yorum Yap",p.onclick=Y;var x=document.createElement("div");x.className="renuvex-pr-minimal-write-row",x.appendChild(p),s.appendChild(x)}return s}var Gr={};xe(Gr,{css:()=>Ta,meta:()=>Ea,render:()=>Aa});var Ut=`
...
`;var Ra={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-w-mobile":"80px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-w-mobile":"100px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-w-mobile":"110px"}}},Ia=Wt;function Ba(e,r){var t=ge(e),n=t.length>0,a=document.createElement("article");a.className="renuvex-pr-review-list"+(n?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var d=document.createElement("span");d.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",d.innerHTML=ue(e.rating,A),l.appendChild(d);var o=document.createElement("span");o.className="renuvex-pr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var s=document.createElement("time");s.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&s.setAttribute("datetime",e.createdAt),s.textContent=se(e.createdAt),l.appendChild(s),a.appendChild(l);var v=document.createElement("div");if(v.className="renuvex-pr-review-list-content",e.title){var h=document.createElement("div");h.className="renuvex-pr-review-list-title",h.textContent=e.title,v.appendChild(h)}var m=(e.comment||"").trim();m&&v.appendChild(Ye(m,"renuvex-pr-review-list-body").fragment);var i=De(e.merchantReply);if(i&&v.appendChild(i),a.appendChild(v),n){var k=document.createElement("div");k.className="renuvex-pr-review-list-media",t.forEach(function(u){var b=document.createElement("img"),w=ae(u,V);b.src=w.src,b.srcset=w.srcset,b.loading="lazy",b.decoding="async",b.width=V,b.height=Math.round(V*4/3),b.setAttribute("data-renuvex-img-url",u),ne(b),b.setAttribute("role","button"),b.setAttribute("tabindex","0"),b.setAttribute("aria-label","Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),(function(c){var p=function(){oe(e,c,r)};b.onclick=p,b.onkeydown=function(x){(x.key==="Enter"||x.key===" "||x.key==="Spacebar")&&(x.preventDefault(),p())}})(u),k.appendChild(b)}),a.appendChild(k)}return a}var Xr={};xe(Xr,{css:()=>Fa,meta:()=>Ma,render:()=>Oa});var qt=`
...
`;var Ma={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Fa=qt;function Oa(e,r){var t=dr(e),n=!!t,a=document.createElement("article");a.className="renuvex-pr-review-gallery"+(n?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var d=document.createElement("span");if(d.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",d.innerHTML=ue(e.rating,A),l.appendChild(d),e.title){var o=document.createElement("div");o.className="renuvex-pr-review-gallery-title",o.textContent=e.title,l.appendChild(o)}var s=document.createElement("div");s.className="renuvex-pr-review-gallery-author",s.textContent=e.author||"",l.appendChild(s);var v=document.createElement("time");v.className="renuvex-pr-review-gallery-date",v.style.display="block",e.createdAt&&v.setAttribute("datetime",e.createdAt),v.textContent=se(e.createdAt),l.appendChild(v);var h=(e.comment||"").trim();if(h&&l.appendChild(Ye(h,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){oe(e,t,r)}}:null).fragment),a.appendChild(l),n){var m=document.createElement("div");m.className="renuvex-pr-review-gallery-media";var i=document.createElement("img"),k=ae(t,ur);i.src=k.src,i.srcset=k.srcset,i.loading="lazy",i.decoding="async",i.width=ur,i.height=Math.round(ur*4/3),ne(i),i.setAttribute("data-renuvex-img-url",t),i.setAttribute("role","button"),i.setAttribute("tabindex","0"),i.setAttribute("aria-label","Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt");var u=function(){oe(e,t,r)};i.onclick=u,i.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Spacebar")&&(w.preventDefault(),u())},m.appendChild(i),a.appendChild(m)}var b=De(e.merchantReply,t?function(){oe(e,t,r)}:null);return b&&(b.classList.add("renuvex-pr-review-gallery-reply"),a.appendChild(b)),a}var Sr={card:Wr,list:qr,gallery:Xr};function rr(e){return Sr[e]||Sr.card}function Xt(){return Object.keys(Sr).map(function(e){return Sr[e].css||""}).join(`
`)}function Ee(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),a=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+n+","+a+","+l+","+r+")"}function _a(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",n=document.createElementNS(t,"svg");n.setAttribute("width","32"),n.setAttribute("height","32"),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.style.cssText="color:#6e6d7a;margin-bottom:4px;";var a=document.createElementNS(t,"path");a.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),n.appendChild(a),n.appendChild(l);var d=document.createElement("div");d.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",d.textContent="Widget \u015Fu anda Pasif durumda";var o=document.createElement("div");return o.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",o.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(n),r.appendChild(d),r.appendChild(o),r}function Ha(){return bt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Ya(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=gt({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),ht(t,{surface:"reviews",productId:r||""}),t}var Kt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},Jt={small:80,medium:110,large:140};function Da(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="renuvex-pr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var a=document.createElement("button");return a.type="button",a.className="renuvex-pr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},t.appendChild(a),t}function ja(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",d=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",s=r.barCountColor||"#111111",v=Ee(d,.06),h=r.reviewStarColor||"#f59e0b",m=r.btnBgColor||"#111111",i=r.btnTextColor||"#ffffff",k=r.btnBorderColor||"#111111",u=r.filterBtnBgColor||"#111111",b=r.filterBtnTextColor||"#ffffff",w=r.filterBtnBorderColor||"#111111",c=r.filterMenuBgColor||"#ffffff",p=r.filterMenuBorderColor||"#e5e7eb",x=r.filterItemTextColor||"#111111",g=r.filterItemHoverBgColor||"#f3f4f6",y=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",f=r.reviewAuthorColor||"#111111",C=r.reviewDateColor||"#5e5e5e",P=r.reviewBodyColor||"#111111",E=r.reviewBorderColor||"#e5e7eb",R=r.replyBgColor||"#f9fafb",N=r.replyBorderColor||"#747474",S=r.replyLabelColor||"#111111",T=r.replyTextColor||"#111111",B=r.photoTitleColor||"#111111",L=Ee("#111111",.05),U=r.photoArrowBgColor||"#ffffff",G=r.photoArrowTextColor||"#111111",O=Ee("#111111",.12),_=r.formBgColor||"#ffffff",W=r.formPrimaryTextColor||"#111111",q=r.formSecondaryTextColor||"#3b3b3b",je=r.inputTextColor||W,Te=r.inputBorderColor||"#d1d5db",he=r.placeholderColor||"#9ca3af",D=r.formStepBarColor||"#111111",j=r.formBtnBgColor||"#111111",pe=r.formBtnTextColor||"#ffffff",ee=r.formBtnBorderColor||"#111111",be=Ee(j,.06),Ve=Ee(j,.18),re=Ee(pe,.85),ye=Ee(W,.06),Ue=r.loadMoreBgColor||"#ffffff",H=r.loadMoreTextColor||"#111111",X=r.loadMoreBorderColor||"#111111",Ge={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":n,"--renuvex-pr-header-count":a,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":d,"--renuvex-pr-bar-track":o,"--renuvex-pr-bar-count":s,"--renuvex-pr-bar-hover-bg":v,"--renuvex-pr-btn-bg":m,"--renuvex-pr-btn-text":i,"--renuvex-pr-btn-border":k,"--renuvex-pr-filter-btn-bg":u,"--renuvex-pr-filter-btn-text":b,"--renuvex-pr-filter-btn-border":w,"--renuvex-pr-filter-menu-bg":c,"--renuvex-pr-filter-menu-border":p,"--renuvex-pr-filter-item-text":x,"--renuvex-pr-filter-item-hover-bg":g,"--renuvex-pr-filter-item-active":y,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":f,"--renuvex-pr-review-date":C,"--renuvex-pr-review-body":P,"--renuvex-pr-review-border":E,"--renuvex-pr-review-star-color":h,"--renuvex-pr-reply-bg-color":R,"--renuvex-pr-reply-border":N,"--renuvex-pr-reply-label":S,"--renuvex-pr-reply-text":T,"--renuvex-pr-photo-title":B,"--renuvex-pr-photo-image-border":L,"--renuvex-pr-photo-arrow-bg":U,"--renuvex-pr-photo-arrow-text":G,"--renuvex-pr-photo-arrow-border":O,"--renuvex-pr-fwizard-bg":_,"--renuvex-pr-fwizard-text":W,"--renuvex-pr-fwizard-secondary-text":q,"--renuvex-pr-fwizard-input-bg":_,"--renuvex-pr-fwizard-input-text":je,"--renuvex-pr-fwizard-input-border":Te,"--renuvex-pr-fwizard-placeholder":he,"--renuvex-pr-fwizard-close-text":W,"--renuvex-pr-fwizard-close-hover-bg":ye,"--renuvex-pr-fwizard-progress-bg":ye,"--renuvex-pr-fwizard-progress-active":D,"--renuvex-pr-fwizard-btn-bg":j,"--renuvex-pr-fwizard-btn-text":pe,"--renuvex-pr-fwizard-btn-border":ee,"--renuvex-pr-fwizard-btn-disabled-bg":Ve,"--renuvex-pr-fwizard-btn-disabled-text":re,"--renuvex-pr-fwizard-nav-hover-bg":be,"--renuvex-pr-load-more-bg":Ue,"--renuvex-pr-load-more-text":H,"--renuvex-pr-load-more-border":X};Object.keys(Ge).forEach(function(me){e.style.setProperty(me,Ge[me])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function tr(e,r,t,n,a,l,d){if(pt){or({productId:e,settings:r,reviewsData:t,productName:n,orderBy:a,page:l,badgeSettings:d});return}ir(!0),rt(e),tt(r),d!==void 0&&at(d),nt(n),a&&Rr(a),l&&Ke(l),t!=null&&it(t);try{let Ar=function(I,F){if(!(!I||!I.meta||!I.meta.sizeOverrides)){var M=I.meta.sizeOverrides[F];M&&Object.keys(M).forEach(function($){i.style.setProperty($,M[$])})}};var Va=Ar,o=Cr(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),v=r.showTitle!==!1,h=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",m=s&&v?h:"",i=document.documentElement;ja(i,r);var k=r.borderRadius!==void 0?r.borderRadius:8,u=Kt[r.size]||Kt.medium,b=Jt[r.thumbnailSize]||Jt.medium,w=rr(r.reviewLayout);if(w.meta&&w.meta.sizeOverrides&&w.meta.sizeOverrides[r.size]){var c=w.meta.sizeOverrides[r.size],p=c["--renuvex-pr-list-photo-w"]||c["--renuvex-pr-gallery-photo-w"];p&&(b=parseInt(p))}i.style.setProperty("--renuvex-pr-title-size",u.titleSize+"px"),i.style.setProperty("--renuvex-pr-review-text-size",u.reviewTextSize+"px"),i.style.setProperty("--renuvex-pr-review-title-size",u.reviewTitleSize+"px"),i.style.setProperty("--renuvex-pr-author-size",u.authorSize+"px"),i.style.setProperty("--renuvex-pr-reply-name-size",u.replyNameSize+"px"),i.style.setProperty("--renuvex-pr-reply-text-size",u.replyTextSize+"px"),i.style.setProperty("--renuvex-pr-radius",k+"px"),i.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,k-4)+"px"),i.style.setProperty("--renuvex-pr-photo-title-size",u.photoTitleSize+"px"),i.style.setProperty("--renuvex-pr-avg-rating-size",u.avgRatingSize+"px"),i.style.setProperty("--renuvex-pr-review-count-size",u.reviewCountSize+"px"),i.style.setProperty("--renuvex-pr-compact-count-size",u.compactCountSize+"px"),i.style.setProperty("--renuvex-pr-recommend-size",u.recommendSize+"px"),i.style.setProperty("--renuvex-pr-btn-text-size",u.btnTextSize+"px"),i.style.setProperty("--renuvex-pr-bar-label-size",u.barLabelSize+"px"),i.style.setProperty("--renuvex-pr-minimal-avg-size",u.minimalAvgSize+"px"),i.style.setProperty("--renuvex-pr-hero-avg-size",u.heroAvgSize+"px"),i.style.setProperty("--renuvex-pr-bar-count-size",u.barCountSize+"px"),i.style.setProperty("--renuvex-pr-review-date-size",u.reviewDateSize+"px"),i.style.setProperty("--renuvex-pr-filter-text-size",u.filterTextSize+"px"),i.style.setProperty("--renuvex-pr-load-more-size",u.loadMoreSize+"px"),i.style.setProperty("--renuvex-pr-read-more-size",u.readMoreSize+"px"),i.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var x=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";i.style.setProperty("--renuvex-pr-review-star-color",x),i.style.setProperty("--renuvex-pr-star-size",u.reviewStarSize+"px"),i.style.setProperty("--renuvex-pr-avg-star-size",u.avgStarSize+"px"),Ar(Cr(r.summaryLayout),r.size),Ar(rr(r.reviewLayout),r.size);var g=Je(r),y=Ha();if(!y)return;var z=Ya(y,e),f=document.getElementById("renuvex-reviews");f||(f=document.createElement("div"),f.id="renuvex-reviews",f.style.minHeight="200px"),f.parentNode!==z&&z.appendChild(f);var C=yt(f),P=Be+Ae+cr+Gt()+Xt();Me(C,P);var E=kt(C);if(r.enabled===!1){f.style.minHeight="auto",E.replaceChildren(_a(r.borderRadius!==void 0?r.borderRadius:8)),ir(!1);var R=nr;or(null),R&&tr(R.productId,R.settings,R.reviewsData,R.productName,R.orderBy,R.page,R.badgeSettings);return}var N=document.createElement("p");N.className="renuvex-pr-state-msg renuvex-pr-state-loading",N.textContent="Yorumlar y\xFCkleniyor...",E.replaceChildren(N);try{var S=t||{},T=Mr(S),B=T?[]:S.data&&S.data.reviews||[];ot(B),E.replaceChildren();var L=document.createElement("section");if(L.id="renuvex-reviews-widget",L.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),L.className="renuvex-pr-reviews-widget",L.setAttribute("data-renuvex-surface","reviews"),e&&L.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(L.style.width="100%",L.style.maxWidth="100%",L.style.marginLeft="0",L.style.marginRight="0"),m){var U=document.createElement("div"),G=r.summaryLayout||"classic";U.className="renuvex-pr-title renuvex-pr-title-"+G,U.textContent=m,L.appendChild(U)}if(T){L.appendChild(Da(S.message,async function(){var I=await $e(te,ke,1,Le,Ne);await tr(te,A,I,Pe,ke,1,Zr)})),E.appendChild(L),ze(C),Nr(L,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return C.getElementById("renuvex-reviews-widget")});return}var O=S.data&&S.data.allCount||0,_=S.data&&S.data.ratingCounts||null,W=_||[0,0,0,0,0],q=S.data&&S.data.avgRating||"0.0";if(!_&&B.length>0){B.forEach(function(I){I.rating>=1&&I.rating<=5&&W[I.rating-1]++});var je=B.reduce(function(I,F){return I+F.rating},0);q=(je/B.length).toFixed(1)}if(O>0){var Te=Cr(r.summaryLayout),he=Te.render({widget:L,data:S,settings:r,iconPair:g,allCount:O,ratingCounts:W,avgRatingVal:q,currentRatingFilter:Le,currentOrderBy:ke,currentHasImages:Ne,onFilterChange:async function(I){var F=Le===I?null:I;Qr(F),Ke(1);var M=await $e(te,ke,1,F,Ne);await tr(te,A,M,Pe,ke,1)},onSortChange:async function(I,F){Ke(1);var M=I,$=!1;F&&($=!0,M="newest"),et($),Rr(M);var Lr=await $e(te,M,1,Le,$);await tr(te,A,Lr,Pe,M,1)}});L.appendChild(he)}else{var D=document.createElement("button");D.className="renuvex-pr-write-btn",D.style.cssText="display:block;margin:16px auto 0;",D.textContent=r.writeButtonText||"Yorum Yap",D.onclick=Y,L.appendChild(D)}var j=($r||[]).filter(function(I){return ge(I).length>0});if(r.showPhotoGallery!==!1&&!Ne&&j.length>0){var pe=document.createElement("div");if(pe.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var ee=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",be=document.createElement("div");be.className="renuvex-pr-photo-title",be.textContent=ee,pe.appendChild(be)}var Ve=r.reviewLayout==="card"?"1/1":"3/4";i.style.setProperty("--renuvex-pr-photo-thumb-aspect",Ve);var re=document.createElement("div");re.className="renuvex-pr-photo-strip";var ye=V,Ue=r.reviewLayout==="card"?V:Math.round(V*4/3),H=0;j.forEach(function(I){if(!(H>=15)){var F=dr(I);if(F){var M=document.createElement("img"),$=ae(F,V);M.src=$.src,M.srcset=$.srcset,M.loading=H<3?"eager":"lazy",M.decoding="async",M.width=ye,M.height=Ue,M.className="renuvex-pr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",ne(M),(function(Lr,$t){M.onclick=function(){oe($t,Lr,j)}})(F,I),re.appendChild(M),H++}}});var X=document.createElement("button");X.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var Ge=Z(Re);Ge&&X.appendChild(Ge),X.setAttribute("aria-label","\xD6nceki"),X.onclick=function(){re.scrollBy({left:-200,behavior:"smooth"})};var me=document.createElement("button");me.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var Kr=Z(pr);Kr&&me.appendChild(Kr),me.setAttribute("aria-label","Sonraki"),me.onclick=function(){re.scrollBy({left:200,behavior:"smooth"})};var We=document.createElement("div");We.className="renuvex-pr-photo-strip-wrap",We.appendChild(X),We.appendChild(re),We.appendChild(me),pe.appendChild(We),L.appendChild(pe)}if(B.length===0){var Er=document.createElement("p");Er.className="renuvex-pr-state-msg",Er.textContent="Hen\xFCz yorum yok.",L.appendChild(Er)}else{var w=rr(r.reviewLayout);B.forEach(function(F){L.appendChild(w.render(F,Pr))})}var Zt=S.data&&S.data.hasMore;if(Zt){var K=document.createElement("button");K.className="renuvex-pr-load-more",K.textContent="Daha Fazla G\xF6ster",K.onclick=async function(){K.disabled=!0,K.textContent="Y\xFCkleniyor...";var I=Jr+1,F=await $e(te,ke,I,Le,Ne);if(F&&!Mr(F)&&F.data&&Array.isArray(F.data.reviews)){lt(F.data.reviews),Ke(I);var M=rr(A.reviewLayout);F.data.reviews.forEach(function($){L.insertBefore(M.render($,Pr),K)}),F.data.hasMore?(K.disabled=!1,K.textContent="Daha Fazla G\xF6ster"):K.remove()}else K.disabled=!1,K.textContent="Tekrar Dene"},L.appendChild(K)}E.appendChild(L),ze(C),Nr(L,"reviews-widget",{productId:e||""},function(){return C.getElementById("renuvex-reviews-widget")})}catch(I){console.error("[renuvex-pr] render error:",I);var Tr=document.createElement("p");Tr.style.cssText="text-align:center;color:#dc2626;",Tr.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",E&&E.replaceChildren(Tr)}}finally{if(ir(!1),nr){var we=nr;or(null),tr(we.productId,we.settings,we.reviewsData,we.productName,we.orderBy,we.page,we.badgeSettings)}}}export{tr as render};
