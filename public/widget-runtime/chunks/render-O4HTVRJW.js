...
`);function yn(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function se(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function wn(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function kn(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",i=wn()&&!a;if(n>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),i&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Sn(e){var r=document.body.style,t=document.documentElement.style;se(t,"overflow",e.rootOverflow,e.rootOverflowPriority),se(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),se(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),se(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),se(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),se(r,"position",e.bodyPosition,e.bodyPositionPriority),se(r,"top",e.bodyTop,e.bodyTopPriority),se(r,"left",e.bodyLeft,e.bodyLeftPriority),se(r,"right",e.bodyRight,e.bodyRightPriority),se(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var or=0,qe=null;function Br(){return or+=1,or>1||(qe=yn(),kn(qe)),qe}function Or(){if(or!==0&&(or-=1,!(or>0))){var e=qe;qe=null,e&&Sn(e)}}function zn(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Fr(){var e=zn();return!e||e===document.body||e===document.documentElement?null:e}function ie(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Cn(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function ot(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Cn)}function En(e,r){var t=e,n=ot(e);!n.length&&r&&(t=r,n=ot(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;ie(a)}function Ur(e,r,t){if(e.key==="Tab"){var n=ot(r);if(!n.length){e.preventDefault(),En(r);return}var a=n[0],i=n[n.length-1],o=ia(t);if(!r.contains(o)){e.preventDefault(),ie(a);return}if(n.indexOf(o)===-1){e.preventDefault(),ie(e.shiftKey?i:a);return}e.shiftKey&&o===a?(e.preventDefault(),ie(i)):!e.shiftKey&&o===i&&(e.preventDefault(),ie(a))}}var fa="renuvexPrOverlay";function Hr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[fa]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Tn(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[fa]===e.id)}function Vr(e){if(Tn(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function An(e){var r=e||(typeof navigator!="undefined"?navigator:null),t=r&&(r.connection||r.webkitConnection||r.mozConnection);if(t&&t.saveData===!0)return!1;var n=t&&typeof t.effectiveType=="string"?t.effectiveType.toLowerCase():"";return n!=="slow-2g"&&n!=="2g"}function Pn(e){var r=Number(e&&e.width),t=Number(e&&e.height),n=Number(e&&(e.bitrate||e.bandwidth));return Number.isFinite(r)||Number.isFinite(t)?(Number.isFinite(t)?t:0)*1e5+(Number.isFinite(r)?r:0):Number.isFinite(n)?n:0}function Nn(e,r,t){if(!Array.isArray(e)||!e.length)return-1;var n=t||(typeof window!="undefined"?window:null),a=r&&typeof r.getBoundingClientRect=="function"?r.getBoundingClientRect():{width:0,height:0},i=Math.max(Number(a.width)||0,Number(r&&r.clientWidth)||0,360),o=Math.max(Number(a.height)||0,Number(r&&r.clientHeight)||0,360),p=Number(n&&n.devicePixelRatio),l=Number.isFinite(p)&&p>0?Math.min(p,2):1,u=Math.round(i*l*1.15),m=Math.round(o*l*1.15),c=-1,d=-1,s=0,w=Number.POSITIVE_INFINITY;return e.forEach(function(v,g){var b=Pn(v);b<w&&(w=b,s=g);var h=Number(v&&v.width),x=Number(v&&v.height),k=!Number.isFinite(h)||h<=u,y=!Number.isFinite(x)||x<=m;k&&y&&b>d&&(d=b,c=g)}),c>=0?c:s}function Mn(e,r,t){if(An()){var n=e&&e.Events&&e.Events.MANIFEST_PARSED;if(!(!n||!r||typeof r.on!="function")){var a=function(){typeof r.off=="function"&&r.off(n,a);var i=Nn(r.levels,t);if(i>=0)try{r.startLevel=i}catch(o){}};r.on(n,a)}}}function xa(e,r){var t=!1,n=null;return e.controls=!0,e.autoplay=!1,e.preload="metadata",e.playsInline=!0,e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.poster=Ye(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"",e.canPlayType("application/vnd.apple.mpegurl")?e.src=r.url:import("./hls-64XD2IDA.js").then(function(a){if(!t){var i=a.default||a;if(!i||!i.isSupported||!i.isSupported()){e.dispatchEvent(new Event("error"));return}n=new i({enableWorker:!0,lowLatencyMode:!1,capLevelToPlayerSize:!0,backBufferLength:30}),Mn(i,n,e),n.loadSource(r.url),n.attachMedia(e)}}).catch(function(){t||e.dispatchEvent(new Event("error"))}),function(){t=!0;try{e.pause()}catch(i){}if(n){try{n.destroy()}catch(i){}n=null}e.removeAttribute("src");try{e.load()}catch(i){}}}function Ge(e){return he(e)}function pt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function ga(e,r,t,n,a,i){e&&e.shadowRoot&&pt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),Or(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Sr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ie(a)}function Ln(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=fe(e.rating,L);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=xe(e.createdAt),n.appendChild(a),n.appendChild(i),t.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-modal-author",p.textContent=e.author||"",t.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-modal-body",l.textContent=(e.comment||"").trim(),l.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(l);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=U(L&&L.merchantReplyLabel,"Ma\u011Faza Sahibi");var c=document.createElement("div");return c.className="renuvex-pr-modal-reply-text",c.textContent=e.merchantReply||"",u.appendChild(m),u.appendChild(c),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function ha(e,r,t){var n=t||L,a=e.querySelector(".renuvex-pr-modal-scroll-content"),i=a.querySelector(".renuvex-pr-modal-stars");i.innerHTML=fe(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=xe(r.createdAt);var o=a.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var p=a.querySelector(".renuvex-pr-modal-body");p.textContent=(r.comment||"").trim(),p.style.display=r.comment&&r.comment.trim()?"":"none";var l=a.querySelector(".renuvex-pr-modal-reply");l.querySelector(".renuvex-pr-modal-reply-label").textContent=U(n&&n.merchantReplyLabel,"Ma\u011Faza Sahibi"),l.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",l.style.display=r.merchantReply?"":"none",e.scrollTop=0}function ut(e,r,t,n,a,i,o,p,l){var u=Ge(e),m=Math.max(0,Math.min(t||0,u.length-1)),c=u[m],d=document.createElement("div");d.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(c&&c.type==="video"){var w=document.createElement("video");w.className="renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":""),w.setAttribute("aria-label","Yorum videosu"),w.addEventListener("error",function(){if(!d.querySelector(".renuvex-pr-modal-img-error")){var N=document.createElement("div");N.className="renuvex-pr-modal-img-error",N.setAttribute("role","status"),N.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",d.insertBefore(N,w)}}),d.__renuvexMediaCleanup=xa(w,c),d.appendChild(w)}else{var v=document.createElement("img");if(v.className="renuvex-pr-modal-main-img"+(s?" "+s:""),v.src=at(c?c.url:""),v.decoding="async",v.width=tt,v.height=Math.round(tt*4/3),v.alt="Yorum foto\u011Fraf\u0131",!s){v.classList.add("renuvex-pr-modal-img-loading");var g=function(){v.classList.remove("renuvex-pr-modal-img-loading")};v.complete&&v.naturalWidth>0?g():(v.addEventListener("load",g,{once:!0}),v.addEventListener("error",g,{once:!0}))}Zt(v,function(N){if(N.style.display="none",!d.querySelector(".renuvex-pr-modal-img-error")){var R=document.createElement("div");R.className="renuvex-pr-modal-img-error",R.setAttribute("role","status"),R.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",d.insertBefore(R,N)}}),d.appendChild(v)}var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var h=q(me);h&&b.appendChild(h),b.setAttribute("aria-label","Kapat"),b.onclick=function(N){N.stopPropagation(),i()},d.appendChild(b);var x=0;if(d.addEventListener("touchstart",function(N){x=N.touches[0].clientX},{passive:!0}),d.addEventListener("touchend",function(N){var R=x-N.changedTouches[0].clientX;if(!(Math.abs(R)<50)){if(R>0){if(C)be(e,r,m+1,n,a,i,!0,"next",p,l);else if(T){var I=n[r+1];be(I,r+1,0,n,a,i,!1,"next",p,l)}}else if(y)be(e,r,m-1,n,a,i,!0,"prev",p,l);else if(E){var _=n[r-1],O=Ge(_);be(_,r-1,O.length-1,n,a,i,!1,"prev",p,l)}}},{passive:!0}),u.length>1){var k=document.createElement("div");k.className="renuvex-pr-modal-thumbs",u.forEach(function(N,R){var I=N.type==="video"?N.posterUrl:N.url,_=document.createElement("img"),O=Nr(I,Pr);_.src=O.src,_.srcset=O.srcset,_.loading="lazy",_.decoding="async",_.width=Pr,_.height=Pr,_.className="renuvex-pr-modal-thumb"+(R===m?" renuvex-pr-modal-thumb-active":""),_.alt="K\xFC\xE7\xFCk resim "+(R+1),Mr(_),_.tabIndex=0,_.setAttribute("role","button"),_.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(R+1)+" se\xE7"),R===m&&_.setAttribute("aria-current","true"),(function(V){function Z(){be(e,r,V,n,a,i,!0,null,p,l)}_.onclick=Z,_.onkeydown=function(Y){(Y.key==="Enter"||Y.key===" ")&&(Y.preventDefault(),Z())}})(R),k.appendChild(_)}),d.appendChild(k)}var y=m>0,C=m<u.length-1,E=r>0,T=r<n.length-1,f=y||E,z=C||T;if(f){var S=document.createElement("button");S.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var A=q(De);A&&S.appendChild(A),S.setAttribute("aria-label","\xD6nceki"),S.onclick=function(N){if(N.stopPropagation(),y)be(e,r,m-1,n,a,i,!0,"prev",p,l);else if(E){var R=n[r-1],I=Ge(R);be(R,r-1,I.length-1,n,a,i,!1,"prev",p,l)}},d.appendChild(S)}if(z){var M=document.createElement("button");M.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var P=q(zr);P&&M.appendChild(P),M.setAttribute("aria-label","Sonraki"),M.onclick=function(N){if(N.stopPropagation(),C)be(e,r,m+1,n,a,i,!0,"next",p,l);else if(T){var R=n[r+1];be(R,r+1,0,n,a,i,!1,"next",p,l)}},d.appendChild(M)}return d}function ba(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Ge(n);a[0]&&a[0].type==="image"&&(new Image().src=at(a[0].url))}})}function lt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function _n(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){lt(t),lt(n),lt(a)}i(),t&&ie(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function be(e,r,t,n,a,i,o,p,l,u){if(u&&(u.currentReview=e),o){var m=ut(e,r,t,n,a,i,p,l,u);a.firstChild&&(pt(a.firstChild),a.replaceChild(m,a.firstChild))}else{var m=ut(e,r,t,n,a,i,p,l,u),c=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&(pt(a.firstChild),a.replaceChild(m,a.firstChild)),c&&ha(c,e,u&&u.currentSettings),_n(l,a)}ba(r,n)}function ve(e,r,t){var n=Ge(e);if(!n.length)return;var a=(t||[]).filter(function(T){return Ge(T).length>0}),i=a.findIndex(function(T){return T===e||T.id===e.id});i===-1&&(a.unshift(e),i=0);var o=n.findIndex(function(T){return T.url===r});o<0&&(o=0);var p=document.createElement("div");p.className="renuvex-pr-modal-overlay";var l=document.createElement("div");l.className="renuvex-pr-modal";var u=!1,m=null,c=Fr(),d=Ce(),s=Br(),w=Hr(),v={currentReview:e,currentSettings:L},g=null;function b(T){var f=T&&T.detail&&T.detail.settings;if(!(f&&f===g)){g=f||null,v.currentSettings=f||L;var z=l.querySelector(".renuvex-pr-modal-right");!z||!v.currentReview||ha(z,v.currentReview,v.currentSettings)}}function h(){u||(u=!0,window.removeEventListener(Ie,b),ga(m&&m.host,x,h,s,c,d))}function x(T){if(T.key==="Escape"){k();return}Ur(T,p,m&&m.root)}function k(){u||(u=!0,window.removeEventListener(Ie,b),ga(m&&m.host,x,h,s,c,d),Vr(w))}document.addEventListener("keydown",x),window.addEventListener("popstate",h),window.addEventListener(Ie,b),p.onclick=function(){k()},l.onclick=function(T){T.stopPropagation()},l.appendChild(ut(e,i,o,a,l,k,null,p,v)),l.appendChild(Ln(e)),ba(i,a);var y=document.createElement("div");y.className="renuvex-pr-modal-wrap",y.tabIndex=-1,y.setAttribute("role","dialog"),y.setAttribute("aria-modal","true"),y.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),y.appendChild(l);var C=document.createElement("button");C.className="renuvex-pr-modal-close";var E=q(me);E&&C.appendChild(E),C.setAttribute("aria-label","Kapat"),C.onclick=function(T){T.stopPropagation(),k()},y.appendChild(C),p.appendChild(y),m=Rr(),We(m.root,je+Ve+Ir),m.root.appendChild(p),Re(m.root),ie(y)}function lr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(n){(n.key==="Enter"||n.key===" "||n.key==="Spacebar")&&(n.preventDefault(),r())})}var gt={};ze(gt,{css:()=>vi,meta:()=>si,render:()=>ci});function Ke(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,i=e.onFilterChange;Te(n);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var p=5;p>=1;p--){var l=r[p-1]||0,u=t>0?Math.round(l/t*100):0,m=a===p,c=l>0,d=U(L&&L.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(c?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(a&&!m?" renuvex-pr-bar-dimmed":""),c?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",p+" y\u0131ld\u0131z, "+l.toLocaleString("tr-TR")+" "+d+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",p+" y\u0131ld\u0131z, 0 "+d);for(var w="",v=1;v<=5;v++){var g=v<=p;w+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(g?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ae(g?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+w+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+l.toLocaleString("tr-TR")+")</span>",c&&(function(b){function h(){i(b)}s.onclick=h,s.onkeydown=function(x){(x.key==="Enter"||x.key===" "||x.key==="Space"||x.key==="Spacebar")&&(x.preventDefault(),h())}})(p),o.appendChild(s)}return o}var ka="data-renuvex-pr-dismiss-gesture",Oe=[],ya=!1,Dr=!1,pr=[],Xe=null;function wa(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function dt(){for(var e=Oe.length-1;e>=0;e--){var r=Oe[e].element;r&&r.isConnected===!1&&Oe.splice(e,1)}return Oe}function Rn(e){!e||typeof e.setAttribute!="function"||(pr.indexOf(e)===-1&&pr.push(e),e.setAttribute(ka,""))}function Sa(){for(var e=0;e<pr.length;e++){var r=pr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(ka)}pr=[],Xe&&typeof clearTimeout=="function"&&clearTimeout(Xe),Xe=null}function In(e){if(Dr){Dr=!1,Sa(),e.preventDefault(),e.stopPropagation();return}for(var r=dt(),t=!1,n=r.length-1;n>=0;n--){var a=r[n];wa(e,a.trigger)||wa(e,a.element)||a.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Bn(e){if(e.key==="Escape")for(var r=dt(),t=r.length-1;t>=0;t--)r[t].close()}function za(){ya||typeof document=="undefined"||(document.addEventListener("click",In,!0),document.addEventListener("keydown",Bn),ya=!0)}function On(e){za(),Dr=!0,Rn(e),Xe&&typeof clearTimeout=="function"&&clearTimeout(Xe),typeof setTimeout=="function"&&(Xe=setTimeout(function(){Dr=!1,Sa()},700))}function st(e){On(e)}function Yr(e){za();var r={trigger:e.trigger,element:e.element,close:e.close};return Oe.push(r),{unregister:function(){var t=Oe.indexOf(r);t!==-1&&Oe.splice(t,1)},notifyOpening:function(){for(var t=dt(),n=0;n<t.length;n++)t[n]!==r&&t[n].close()}}}function re(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var p=document.createElement("button");p.className="renuvex-pr-write-btn",p.textContent=U(L&&L.writeButtonText,"Yorum Yap"),p.onclick=a,o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var m=L&&L.filterIcon||"lines";u.innerHTML=ne(Wt(m));var c=document.createElement("div");c.className="renuvex-pr-filter-menu",c.setAttribute("role","menu");var d=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],s=!1;function w(){return r&&r.parentNode||r||null}function v(x,k){if(!(k===!0||!x)){if(x.type==="touchstart"){st(w());return}if(x.type==="pointerdown"){var y=x.pointerType||"";y&&y!=="mouse"&&st(w());return}}}function g(x){var k=c.classList.contains("renuvex-pr-open");c.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var y=x&&(x.restoreFocus===!0||x.restoreFocus==="auto"&&Ce());if(k&&y)try{u.focus({preventScroll:!0})}catch(C){try{u.focus()}catch(E){}}return k}function b(){h.notifyOpening(),c.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var x=c.querySelector(".renuvex-pr-filter-item-active")||c.querySelector(".renuvex-pr-filter-item");x&&requestAnimationFrame(function(){try{x.focus({preventScroll:!0})}catch(k){try{x.focus()}catch(y){}}})}d.forEach(function(x){var k=x[2],y=k?n:!n&&(t||"newest")===x[0],C=document.createElement("button");C.type="button",C.className="renuvex-pr-filter-item"+(y?" renuvex-pr-filter-item-active":""),C.setAttribute("role","menuitem"),C.textContent=x[1];var E=!1;function T(f,z){f&&(f.preventDefault(),f.stopPropagation()),!E&&(E=!0,s=!0,v(f,z),g({restoreFocus:z}),i(x[0],k),setTimeout(function(){E=!1,s=!1},0))}C.addEventListener("pointerdown",function(f){f.button!==void 0&&f.button!==0||f.pointerType!=="mouse"&&T(f,!1)}),typeof window!="undefined"&&!window.PointerEvent&&C.addEventListener("touchstart",function(f){T(f,!1)},{passive:!1}),C.addEventListener("keydown",function(f){(f.key==="Enter"||f.key===" ")&&T(f,!0)}),C.onclick=function(f){T(f,!1)},c.appendChild(C)}),u.onclick=function(){c.classList.contains("renuvex-pr-open")?g({restoreFocus:"auto"}):b()},l.addEventListener("keydown",function(x){x.key==="Escape"&&c.classList.contains("renuvex-pr-open")&&(x.stopPropagation(),g({restoreFocus:!0}))}),l.addEventListener("focusout",function(x){if(c.classList.contains("renuvex-pr-open")&&!s){var k=x.relatedTarget;k&&l.contains(k)||g()}});var h=Yr({trigger:l,element:c,close:g});return l.appendChild(u),l.appendChild(c),o.appendChild(l),o}var Ca=`
...
`;function Ea(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,n=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,a=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",o.appendChild(p);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var u=q(me);u&&l.appendChild(u),o.appendChild(l);var m=!1,c=null,d=null,s=!1;function w(){ie(i)}function v(E){Ur(E,i,c&&c.root)}function g(){if(!m){if(m=!0,document.removeEventListener("keydown",b),i.removeEventListener("click",h),l.removeEventListener("click",g),s)ie(d);else{var E=c&&c.root?c.root.activeElement:null;if(E&&typeof E.blur=="function")try{E.blur()}catch(T){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){c?(Sr(c.root),c.host&&c.host.parentNode&&c.host.parentNode.removeChild(c.host)):i.parentNode&&i.parentNode.removeChild(i),Or();try{r()}catch(T){}},200)}}function b(E){if(E.key==="Escape"){g();return}v(E)}function h(E){E.target===i&&a&&g()}document.addEventListener("keydown",b),i.addEventListener("click",h),l.addEventListener("click",g);function x(E){d=t||Fr(),s=n===null?Ce():n,E&&p.appendChild(E),c=Rr(),We(c.root,je+Ve+Ca),c.root.appendChild(i),Re(c.root),Br(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),w()})}var k=null,y=null;function C(E,T){if(T=T||"error",k){try{k.remove()}catch(f){}k=null}y&&(clearTimeout(y),y=null),k=document.createElement("div"),k.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+T,k.textContent=E,o.appendChild(k),y=setTimeout(function(){k&&(k.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(k){try{k.remove()}catch(f){}k=null}},300))},4e3)}return{open:x,close:g,content:p,setAllowOutsideClose:function(E){a=!!E},setStepAttr:function(E){o.setAttribute("data-step",String(E))},showToast:C}}var vt=4;function Je(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Ta(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(i){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<vt&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(i){return i!==a})}}}}function Aa(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",p.setAttribute("aria-label","Geri"),p.innerHTML=ne(De)+"<span>Geri</span>",p.addEventListener("click",function(){n()}),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-footer-progress";for(var u=[],m=0;m<vt;m++){var c=document.createElement("span");c.className="renuvex-pr-fwizard-progress-seg",l.appendChild(c),u.push(c)}o.appendChild(l);var d=document.createElement("button");d.type="button";var s=null;function w(g){s&&d.removeEventListener("click",s),s=g,g&&d.addEventListener("click",g)}o.appendChild(d);function v(g,b){var h=r.indexOf(g)!==-1,x=t.indexOf(g)!==-1,k=b&&(b.images&&b.images.length>0||b.pendingImages&&b.pendingImages.length>0);if(h)g===2&&k?(d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",w(function(){i()})):(d.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",d.setAttribute("aria-label","Atla"),d.innerHTML="<span>Atla</span>",w(function(){a()})),d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),d.style.visibility="",d.tabIndex=0;else if(x){d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Sonraki"),d.innerHTML="Sonraki",d.style.visibility="",d.tabIndex=0;var y=Je(g,b);d.disabled=!y,d.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!y),w(function(){d.disabled||i()})}else d.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",d.innerHTML="",d.style.visibility="hidden",d.tabIndex=-1,d.disabled=!0,w(null)}return{el:o,update:function(g,b){u.forEach(function(x,k){k+1<=g?x.classList.add("renuvex-pr-fwizard-progress-seg-active"):x.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var h=g<=1;p.style.visibility=h?"hidden":"",p.style.pointerEvents=h?"none":"",p.tabIndex=h?-1:0,v(g,b)},setNextDisabled:function(g){d.classList.contains("renuvex-pr-fwizard-cta-btn")&&(d.disabled=!!g,d.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!g))},setThanksState:function(g){p.style.visibility="hidden",l.style.visibility="hidden",d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",d.style.visibility="",d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),w(g)}}}var Fn={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function oe(e){var r=L&&L[e];return!r&&e==="formStepMediaTitle"&&(r=L&&L.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=L&&L.formStepPhotosSubtitle),U(r,Fn[e])}function Pa(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=oe("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var p=ir(L||{});Te(p);var l=[];function u(g){l.forEach(function(b,h){var x=h<g;b.classList.toggle("renuvex-pr-fwizard-star-active",x),b.setAttribute("aria-checked",h+1===g?"true":"false"),b.innerHTML=x?ae("full"):ae("outline")})}function m(g){e.set({rating:g}),u(g)}function c(g){var b=l[g-1];if(b)try{b.focus()}catch(h){}}function d(g,b){b&&typeof b.preventDefault=="function"&&b.preventDefault(),b&&typeof b.stopPropagation=="function"&&b.stopPropagation(),!n&&(n=!0,m(g),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var s=1;s<=5;s++)(function(g){var b=document.createElement("button");b.type="button",b.className="renuvex-pr-fwizard-star",b.setAttribute("role","radio"),b.setAttribute("aria-label",g+" y\u0131ld\u0131z"),b.innerHTML=ae("outline"),b.addEventListener("mouseenter",function(){u(g)}),b.addEventListener("mouseleave",function(){u(e.get().rating)}),b.addEventListener("pointerdown",function(h){h.button&&h.button!==0||d(g,h)}),typeof window!="undefined"&&!window.PointerEvent&&b.addEventListener("touchstart",function(h){d(g,h)},{passive:!1}),b.addEventListener("mousedown",function(h){window.PointerEvent||d(g,h)}),b.addEventListener("keydown",function(h){if(h.key==="Enter"||h.key===" "){d(g,h);return}var x=0;h.key==="ArrowRight"||h.key==="ArrowUp"?x=Math.min(5,g+1):h.key==="ArrowLeft"||h.key==="ArrowDown"?x=Math.max(1,g-1):h.key==="Home"?x=1:h.key==="End"&&(x=5),x&&(h.preventDefault(),m(x),c(x))}),b.addEventListener("click",function(h){d(g,h)}),l.push(b),o.appendChild(b)})(s);u(e.get().rating);var w=null,v=function(g){var b=g&&g.detail&&g.detail.settings;b&&b===w||(w=b||null,p=ir(b||L||{}),u(e.get().rating))};return window.addEventListener(Ie,v),t.appendChild(o),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Ie,v)}}}var Na=3,Un=10*1024*1024;function jr(e,r){r=r||{};var t=!1,n=document.createElement("div");if(n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=oe("formStepPhotosTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-subtitle",i.textContent=oe("formStepPhotosSubtitle"),n.appendChild(i)}var o=document.createElement("div");o.className="renuvex-pr-fwizard-photo-card";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-photo-add",p.setAttribute("aria-label","Foto\u011Fraf ekle");var l=document.createElement("input");l.type="file",l.accept="image/*",l.multiple=!0,l.style.display="none",o.appendChild(p),o.appendChild(l);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),o.appendChild(u),n.appendChild(o);var m=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},c=r.blobMap||{},d=r.urlToFinger||{};function s(){if(!t){var h=e.get().images||[],x=e.get().pendingImages||[],k=h.map(function(y){return{url:y,isPending:!1}}).concat(x.map(function(y){return{url:y.url,file:y.file,isPending:!0,error:y.error}}));u.innerHTML="",k.forEach(function(y){var C=c[y.url]||y.url,E=w(y,C);u.appendChild(E)}),g()}}function w(h,x){var k=document.createElement("div");k.className="renuvex-pr-fwizard-photo-thumb";var y=document.createElement("img");y.src=x,y.alt="",y.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",k.appendChild(y);var C=document.createElement("div");C.className="renuvex-pr-fwizard-photo-loading",C.style.display="none",k.appendChild(C);var E=document.createElement("button");E.type="button",E.className="renuvex-pr-fwizard-photo-remove",E.setAttribute("aria-label","Kald\u0131r");var T=q(me);return T&&E.appendChild(T),k.appendChild(E),v(k,h,x),k}function v(h,x,k){var y=h.querySelector("img");y.src!==k&&(y.src=k);var C=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(x.isPending&&x.error){C.style.display="flex",C.textContent="";var E=document.createElement("span");E.className="renuvex-pr-upload-error",E.textContent="\u2717 "+x.error,C.appendChild(E)}else C.style.display="none",C.textContent="";var T=h.querySelector(".renuvex-pr-fwizard-photo-remove");T.onclick=function(){var f=d[x.url]||(x.file?x.file.name+"_"+x.file.size:null),z=c[x.url],S={};f&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(A){return A!==f})),x.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(A){return A.url!==x.url}):S.images=(e.get().images||[]).filter(function(A){return A!==x.url}),e.set(S),m(x.url),m(z),delete d[x.url],z&&delete d[z],c[x.url]&&delete c[x.url]}}function g(){var h=(e.get().images||[]).length,x=(e.get().pendingImages||[]).length,k=h+x,y=k>=Na;k>0?(o.classList.add("renuvex-pr-fwizard-photo-card--compact"),p.innerHTML=ne(Gt)):(o.classList.remove("renuvex-pr-fwizard-photo-card--compact"),p.innerHTML=ne(Cr)+"<span>Foto\u011Fraf Ekle</span>"),y?(p.style.display="none",p.disabled=!0,l.disabled=!0):(p.style.display="flex",p.disabled=!1,l.disabled=!1,p.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}p.addEventListener("click",function(){l.disabled||l.click()}),l.onchange=async function(h){var x=(e.get().images||[]).length+(e.get().pendingImages||[]).length,k=Array.from(h.target.files).slice(0,Na-x);l.value="";var y=(e.get().pendingImages||[]).length,C=e.get().images||[],E=C.length;if(k.length!==0){for(var T=[],f=[],z=0;z<k.length;z++){var S=k[z],A=S.name+"_"+S.size,M=(e.get().fingerprints||[]).some(function(V){return V===A})||T.some(function(V){return V.file.name+"_"+V.file.size===A});if(!M){if(S.size>Un){var P="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(P,"error"):alert(P);continue}var N=URL.createObjectURL(S);d[N]=A,T.push({url:N,file:S,error:null}),f.push({url:N,file:S});var R=(e.get().fingerprints||[]).slice();R.push(A),e.set({fingerprints:R})}}if(T.length!==0){var I=(e.get().pendingImages||[]).concat(T),_=async function(){for(var V=0;V<f.length;V++){var Z=f[V],Y=Z.file,J=Z.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ue=(e.get().pendingImages||[]).filter(function(B){return B.url!==J}),we=(e.get().images||[]).slice();we.push(J),e.set({pendingImages:ue,images:we});continue}try{var le=await ge(ce+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:te})});if(!le.ok)throw le.status===429?new Error("rate_limit"):new Error("sign failed");var W=await le.json();if(!W.folder)throw new Error("sign folder missing");var F=new FormData;F.append("file",Y),F.append("api_key",W.api_key),F.append("timestamp",W.timestamp),F.append("signature",W.signature),F.append("folder",W.folder);var j=await fetch("https://api.cloudinary.com/v1_1/"+W.cloud_name+"/image/upload",{method:"POST",body:F}),H=await j.json();if(H.secure_url&&Tr(H.secure_url)){var Ne=(e.get().pendingImages||[]).some(function(B){return B.url===J});if(!Ne)continue;c[H.secure_url]=J,d[H.secure_url]=d[J];var pe=(e.get().pendingImages||[]).filter(function(B){return B.url!==J}),rr=(e.get().images||[]).slice();rr.push(H.secure_url),e.set({pendingImages:pe,images:rr});try{ge(ce+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:te,secureUrl:H.secure_url,metadata:{assetId:H.asset_id,publicId:H.public_id,version:H.version,resourceType:H.resource_type,format:H.format,width:H.width,height:H.height,bytes:H.bytes,signature:H.signature}})}).catch(function(){})}catch(B){}}else throw new Error("invalid image url")}catch(B){console.error("[renuvex-pr] Image upload failed:",B);var tr=B.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(tr,"error");var ke=(e.get().pendingImages||[]).map(function(G){return G.url===J?{url:G.url,file:G.file,error:tr}:G});e.set({pendingImages:ke})}}};if(E===0&&y===0){t=!0;var O=!r.canNavigate||r.canNavigate();O&&e.goNext()}e.set({pendingImages:I}),_()}}};var b=e.onChange(s);return s(),{el:n,openPicker:function(){l.disabled||l.click()},destroy:function(){t=!0,l.onchange=null,b&&b()}}}var Hn=150*1024*1024,Vn=2,Dn=60,Yn=["video/mp4","video/quicktime"],jn="renuvex_pr_video_upload_",Ra="renuvex_pr_video_cancel_",ur=null,Ma=!1,Wn={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},qn={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},$e=class extends Error{constructor(r,t,n){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=n||null}};function Ia(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:Wn[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:qn[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function Ba(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function ct(e){return new Promise(function(r){setTimeout(r,e)})}function Gn(e,r){return new Promise(function(t,n){var a=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(a),r&&r.removeEventListener("abort",o),n(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function mt(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function ft(e,r){return jn+te+"_"+e+"_"+mt(r)}function Oa(e,r){try{var t=window.sessionStorage.getItem(ft(e,r)),n=t?JSON.parse(t):null;return!n||typeof n.token!="string"||!n.expiresAt||new Date(n.expiresAt).getTime()<=Date.now()?null:n}catch(a){return null}}function Kn(e,r,t){try{window.sessionStorage.setItem(ft(e,r),JSON.stringify(t))}catch(n){}}function Ze(e,r){try{window.sessionStorage.removeItem(ft(e,r))}catch(t){}}function Xn(e,r){return Ra+te+"_"+e+"_"+mt(r)}function Jn(e,r,t,n){if(!(!e||!r||!t)){var a={token:e,productId:r,expiresAt:n||null};try{window.sessionStorage.setItem(Xn(r,t),JSON.stringify(a))}catch(i){}}}function Zn(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(Ra+te+"_")!==0)){var n=window.sessionStorage.getItem(t),a=n?JSON.parse(n):null;if(!a||typeof a.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:a.token})}}}catch(i){}return e}function La(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function dr(e,r,t){var n=await ge(ce+e,r,t||2e4),a=await n.json().catch(function(){return{}});if(!n.ok){var i=Number(n.headers.get("Retry-After"));throw new $e(a.error||"video_request_failed",n.status,Number.isFinite(i)&&i>0?i:null)}return a.data||{}}async function $n(e){try{return await dr("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),La(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(La(e.key),!0):!1}}function Wr(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():ur||(ur=(async function(){for(var e=Zn(),r=0;r<e.length;r+=1)await $n(e[r])})().finally(function(){ur=null}),ur)}function qr(){typeof window=="undefined"||Ma||(Ma=!0,window.addEventListener("online",function(){Wr()}),Wr())}async function Qn(){var e=await import("./upchunk-QJXCGVJW.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}async function ei(e){var r=await Qn();return new Promise(function(t,n){var a=!1,i=null;function o(l){a||(a=!0,e.signal&&e.signal.removeEventListener("abort",p),l?n(l):t())}function p(){try{i&&i.abort()}catch(l){}o(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return n(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",p,{once:!0})}i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||30720,attempts:3,dynamicChunkSize:!0}),i.on("progress",function(l){var u=Number(l&&l.detail);Number.isFinite(u)&&e.onProgress(Math.min(95,Math.max(0,Math.round(u*.95))))}),i.on("offline",function(){e.onStatus("uploading_offline")}),i.on("online",function(){e.onStatus("uploading")}),i.on("error",function(l){var u=l&&l.detail,m=u&&typeof u.message=="string"?u.message:"video_upload_failed";o(new Error(m))}),i.on("success",function(){e.onProgress(95),o()})})}function ri(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function _a(e,r,t){for(var n=Date.now(),a=n+600*1e3,i=0;Date.now()<a;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-n;try{var p=await dr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":p.status||"processing"),p.status==="ready")return p;if(p.status==="failed"||p.status==="aborted")throw new $e(p.errorCode||"video_processing_failed",409,null)}catch(l){if(r.aborted||l instanceof $e&&l.status===409||Ba(l)||(i+=1,i>=3))throw l}await Gn(ri(o),r)}throw new $e("video_processing_delayed",0,null)}async function ti(e){for(var r=null,t=1;t<=3;t+=1)try{return await dr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(n){if(Ba(n))return null;r=n,t<3&&await ct(400*t)}throw r||new Error("video_status_failed")}async function ai(e,r,t,n){for(var a=10;a<=90;a+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(a),await ct(120)}return n("processing"),await ct(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function Fa(e){return!e||Yn.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>Hn?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function Ua(e){return new Promise(function(r){var t=URL.createObjectURL(e),n=document.createElement("video"),a=!1;function i(o){if(!a){a=!0,n.removeAttribute("src");try{n.load()}catch(p){}URL.revokeObjectURL(t),r(o)}}n.preload="metadata",n.onloadedmetadata=function(){i(Number.isFinite(n.duration)?n.duration:null)},n.onerror=function(){i(null)},n.src=t,setTimeout(function(){i(null)},8e3)})}function Ha(e){return e===null?{ok:!0}:e<Vn||e>Dn?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function Va(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return ai(e.file,e.signal,e.onProgress,e.onStatus);qr(),await Wr();var r=Oa(e.productId,e.file),t=r&&r.token,n=r;if(t){var a=await ti(t);if(!a)Ze(e.productId,e.file),t=null,n=null;else{if(a.status==="ready")return e.onToken&&e.onToken(t),e.onProgress(100),Object.assign({token:t},a);if(a.status==="uploaded"||a.status==="processing"){e.onToken&&e.onToken(t),e.onStatus("processing");var i=await _a(t,e.signal,e.onStatus);return Ze(e.productId,e.file),e.onProgress(100),Object.assign({token:t},i)}else(a.status==="failed"||a.status==="aborted")&&(Ze(e.productId,e.file),t=null,n=null)}t&&(!n||typeof n.uploadUrl!="string"||!n.uploadUrl)&&(Ze(e.productId,e.file),t=null,n=null)}if(!t){var o=await dr("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:te,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:mt(e.file)})});t=o.token,n=o,Kn(e.productId,e.file,o)}e.onToken&&e.onToken(t),e.onStatus("uploading"),await ei({uploadUrl:n.uploadUrl,file:e.file,chunkSize:n.chunkSize,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus}),e.onStatus("processing"),await dr("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})},3e4);var p=await _a(t,e.signal,e.onStatus);return Ze(e.productId,e.file),e.onProgress(100),Object.assign({token:t},p)}async function Gr(e,r,t){var n=r&&t?Oa(r,t):null;e&&r&&t&&Jn(e,r,t,n&&n.expiresAt),r&&t&&Ze(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(qr(),await Wr())}function ni(e){return e?e.error?e.error:e.status==="processing"?"Video i\u015Fleniyor...":e.status==="processing_slow"?"Video haz\u0131rlan\u0131yor. Bu i\u015Flem biraz s\xFCrebilir.":e.status==="ready"?"Video haz\u0131r":"Video y\xFCkleniyor: %"+Math.max(0,Math.min(100,e.progress||0)):""}function Da(e,r){r=r||{};var t=!1,n=null,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent=oe("formStepMediaTitle"),i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-subtitle",p.textContent=oe("formStepMediaSubtitle"),i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-media-choices";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-fwizard-media-choice",u.innerHTML=ne(Cr)+"<span>Foto\u011Fraf Ekle</span>";var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-media-choice",m.innerHTML=ne(Er)+"<span>Video Ekle</span>",l.appendChild(u),l.appendChild(m),i.appendChild(l);var c=document.createElement("div");c.className="renuvex-pr-fwizard-media-content",i.appendChild(c);var d=document.createElement("input");d.type="file",d.accept="video/mp4,video/quicktime,.mp4,.mov",d.style.display="none",i.appendChild(d);function s(){var f=e.get();return(f.images||[]).length>0||(f.pendingImages||[]).length>0}function w(){return e.get().videoUpload||null}function v(){if(!a){c.innerHTML="";return}a.retry.onclick=null,c.innerHTML="",a=null}function g(f){c.innerHTML="";var z=document.createElement("div");z.className="renuvex-pr-fwizard-video-card";var S=document.createElement("video");S.className="renuvex-pr-fwizard-video-preview",S.muted=!0,S.playsInline=!0,S.preload="metadata",S.src=f.localUrl||"",z.appendChild(S);var A=document.createElement("div");A.className="renuvex-pr-fwizard-video-details";var M=document.createElement("div");M.className="renuvex-pr-fwizard-video-name",M.textContent=f.file?f.file.name:"Video";var P=document.createElement("div");P.className="renuvex-pr-fwizard-video-status",P.setAttribute("role","status"),P.setAttribute("aria-live","polite"),A.appendChild(M),A.appendChild(P);var N=document.createElement("progress");N.className="renuvex-pr-fwizard-video-progress",N.max=100,N.setAttribute("aria-label","Video y\xFCkleme ilerlemesi"),A.appendChild(N);var R=document.createElement("button");R.type="button",R.className="renuvex-pr-fwizard-video-retry",R.textContent="Tekrar Dene",z.appendChild(A);var I=document.createElement("button");I.type="button",I.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",I.setAttribute("aria-label","Videoyu kald\u0131r");var _=q(me);_&&I.appendChild(_);function O(V){V&&(V.preventDefault(),V.stopPropagation()),y()}I.addEventListener("pointerdown",O),I.addEventListener("click",O),z.appendChild(I),c.appendChild(z),a={card:z,preview:S,localUrl:f.localUrl||"",details:A,name:M,status:P,progress:N,retry:R,remove:I}}function b(){if(!t){var f=w();if(!f){v();return}(!a||a.localUrl!==(f.localUrl||""))&&g(f),a.name.textContent=f.file?f.file.name:"Video",a.status.className="renuvex-pr-fwizard-video-status"+(f.error?" renuvex-pr-fwizard-video-status--error":""),a.status.setAttribute("role",f.error?"alert":"status"),a.status.textContent=ni(f);var z=f.status==="uploading";a.progress.hidden=!z,a.progress.value=f.progress||0;var S=!!(f.error&&f.file&&f.retryable!==!1);a.retry.onclick=S?function(){k(f.file,f.localUrl,f.durationMs)}:null,S&&!a.retry.isConnected?a.details.appendChild(a.retry):!S&&a.retry.isConnected&&a.retry.remove()}}function h(){var f=s(),z=!!w();u.disabled=z,m.disabled=f||z,u.classList.toggle("renuvex-pr-fwizard-media-choice--active",f),m.classList.toggle("renuvex-pr-fwizard-media-choice--active",z)}function x(f){var z=w();if(z){var S=Object.keys(f),A=S.some(function(M){return z[M]!==f[M]});A&&e.set({videoUpload:Object.assign({},z,f)})}}async function k(f,z,S){var A=Fa(f);if(!A.ok){r.showToast&&r.showToast(A.message,"error");return}var M=S!==void 0?Number.isFinite(S)?S/1e3:null:await Ua(f),P=Ha(M);if(!P.ok){r.showToast&&r.showToast(P.message,"error");return}var N=z||URL.createObjectURL(f),R=new AbortController;e.set({videoUpload:{file:f,localUrl:N,token:null,status:"uploading",progress:0,durationMs:M===null?null:Math.round(M*1e3),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:R}});try{var I=await Va({file:f,productId:e.get().productId,signal:R.signal,onToken:function(O){x({token:O})},onProgress:function(O){x({progress:O})},onStatus:function(O){x({status:O})}});if(I.previewOnly&&I.posterUrl&&I.posterUrl!==N)try{URL.revokeObjectURL(I.posterUrl)}catch(O){}x({token:I.token,status:"ready",progress:100,posterUrl:I.previewOnly?N:I.posterUrl,durationMs:I.durationMs||(M===null?null:Math.round(M*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(O){if(R.signal.aborted)return;var _=Ia(O);x({status:"failed",error:_.message,errorCode:_.code,retryable:_.retryable,retryAfterSec:_.retryAfterSec,controller:null}),r.showToast&&r.showToast(_.message,"error")}}function y(){var f=w();f&&(f.controller&&f.controller.abort(),Gr(f.token,e.get().productId,f.file),r.revokeBlobUrl&&r.revokeBlobUrl(f.localUrl),e.set({videoUpload:null}))}function C(f){n||(a=null,c.innerHTML="",n=jr(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0}),c.appendChild(n.el),f&&n.openPicker&&n.openPicker())}u.onclick=function(){u.disabled||C(!0)},m.onclick=function(){m.disabled||d.click()},d.onchange=function(){var f=d.files&&d.files[0];d.value="",f&&k(f,null,void 0)};var E=!!w(),T=e.onChange(function(){h();var f=!!w();(f||E)&&b(),E=f});return h(),s()&&C(!1),w()&&b(),{el:i,destroy:function(){t=!0,u.onclick=null,m.onclick=null,d.onchange=null,n&&n.destroy&&n.destroy(),T&&T()}}}var xt=2e3,ii=60;function Ya(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=oe("formStepContentTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=ii,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var p=document.createElement("textarea");p.className="renuvex-pr-fwizard-textarea",p.placeholder="Deneyiminizi anlat\u0131n\u2026",p.maxLength=xt,p.rows=6,p.setAttribute("aria-label","Yorum"),p.value=e.get().comment||"",i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-char-counter",l.setAttribute("aria-live","polite"),i.appendChild(l);function u(){var c=p.value.length;l.textContent=c+"/"+xt,l.classList.toggle("renuvex-pr-fwizard-char-counter--max",c>=xt)}function m(){return Je(3,e.get())}return p.addEventListener("input",function(){e.set({comment:p.value}),u(),t(m())}),n.appendChild(i),u(),setTimeout(function(){t(m())},0),{el:n,destroy:function(){}}}var oi=40;function ja(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=oe("formStepAuthorTitle"),a.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var p=document.createElement("div");p.className="renuvex-pr-fwizard-field";var l=document.createElement("label");l.className="renuvex-pr-fwizard-label",l.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=oi,u.setAttribute("aria-required","true"),u.value=e.get().author||"",p.appendChild(l),p.appendChild(u),o.appendChild(p);var m=document.createElement("div");m.className="renuvex-pr-fwizard-field";var c=document.createElement("label");c.className="renuvex-pr-fwizard-label",c.textContent="E-posta (opsiyonel)";var d=document.createElement("input");d.type="email",d.className="renuvex-pr-fwizard-input",d.setAttribute("autocomplete","email"),d.value=e.get().email||"",m.appendChild(c),m.appendChild(d),o.appendChild(m);var s=document.createElement("div");s.className="renuvex-pr-fwizard-notice",s.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(s);var w=document.createElement("div");w.className="renuvex-pr-fwizard-msg",w.setAttribute("role","alert"),w.setAttribute("aria-live","assertive"),o.appendChild(w);var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-submit-btn",v.textContent="G\xF6nder",o.appendChild(v),a.appendChild(o);function g(){return Je(4,e.get())}function b(){var y=!g(),C=(e.get().pendingImages||[]).length,E=C>0,T=e.get().videoUpload,f=!!(T&&T.status!=="ready");E||f?(v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent=f?"Video Haz\u0131rlan\u0131yor...":"Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=y,v.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",y),v.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),b(),t(g())}),d.addEventListener("input",function(){e.set({email:d.value})}),b(),setTimeout(function(){t(g())},0);function h(){w.textContent=""}function x(y){h();var C=document.createElement("div");C.className="renuvex-pr-fwizard-msg-error",C.textContent=y||"",w.appendChild(C)}v.onclick=async function(){if(!v.disabled){var y=e.get(),C=(y.author||"").trim(),E=(y.comment||"").trim();if(d.value.trim()&&!d.checkValidity()){d.reportValidity();return}if(!C){x("Gerekli alan");return}if(!y.rating){x("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}v.disabled=!0,v.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var T=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",h(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){y.videoUpload&&y.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n()},600);return}try{var f=Kt(window.location.href),z=y.productName||null,S=await ge(ce+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:te,productId:y.productId||null,slug:f||null,productName:z,author:C,title:(y.title||"").trim()||null,comment:E||null,rating:y.rating,images:y.videoUpload?[]:y.images||[],videoToken:y.videoUpload&&y.videoUpload.status==="ready"?y.videoUpload.token:null})},15e3);if(S.ok)y.videoUpload&&y.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n();else{var A=await S.json().catch(function(){return{}});throw new Error(A.error||"Yorum kaydedilemedi.")}}catch(N){var M=N&&(N.name==="AbortError"||/signal/i.test(N.message||"")),P=M?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":N.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(P,"error"):x(P),v.disabled=!1,v.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),v.textContent=T}}};var k=e.onChange(b);return{el:a,destroy:function(){v.onclick=null,k&&k()}}}function li(e,r,t){if(t=t||{},e===1)return Pa(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return Da(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return jr(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Ya(r,{onValidityChange:t.onValidityChange});if(e===4)return ja(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function Wa(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function qa(e){e=e||{},qr();var r=Ta({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:L&&L.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},n={},a={};function i(z){if(!(!z||typeof z!="string"||!z.startsWith("blob:")||a[z])){a[z]=!0;try{URL.revokeObjectURL(z)}catch(S){}}}function o(){Object.keys(n).forEach(function(S){i(S)}),Object.keys(t).forEach(function(S){i(t[S])});var z=r.get();(z.pendingImages||[]).forEach(function(S){i(S&&S.url)}),(z.images||[]).forEach(function(S){i(S)}),z.videoUpload&&i(z.videoUpload.localUrl)}function p(){var z=r.get(),S=z.videoUpload;!S||z.videoSubmitted||(S.controller&&S.controller.abort(),Gr(S.token,z.productId,S.file))}var l=Ea({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",m),Vr(u),p(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=Hr(),m=function(z){l&&l.close&&l.close()};window.addEventListener("popstate",m);var c=document.createElement("div");c.className="renuvex-pr-fwizard-step-wrap";var d=Aa({skippableSteps:[2],nextableSteps:[3],onBack:function(){v==="idle"&&r.goBack()},onSkip:function(){v==="idle"&&r.goNext()},onNext:function(){v==="idle"&&r.goNext()}}),s=document.createElement("div");s.className="renuvex-pr-fwizard-layout",s.appendChild(c),s.appendChild(d.el);var w=null,v="idle",g=null,b=!0,h=null;function x(z,S){c.innerHTML="";var A=li(z,r,{canNavigate:function(){return v==="idle"},blobMap:t,urlToFinger:n,revokeBlobUrl:i,onValidityChange:function(N){d.setNextDisabled(!N)},onSuccess:y,showToast:l.showToast});if(w=A,d.update(z,r.get()),S){v="entering",A.el.classList.add("renuvex-pr-fwizard-step--enter");var M=null,P=function(){M&&clearTimeout(M),A.el.removeEventListener("animationend",P),A.el.classList.remove("renuvex-pr-fwizard-step--enter"),v="idle",g!==null&&C()};A.el.addEventListener("animationend",P),M=setTimeout(P,700)}else v="idle";c.appendChild(A.el),l.setStepAttr&&l.setStepAttr(z),z===3&&d.setNextDisabled(!0)}var k=!1;function y(){if(!k){if(k=!0,!w){c.innerHTML="";var z=Wa();z.classList.add("renuvex-pr-fwizard-step--enter"),c.appendChild(z),l.setStepAttr("thanks"),d.setThanksState(l.close);return}var S=w;v="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var A=function(){if(h&&clearTimeout(h),S.el.removeEventListener("animationend",A),S.destroy)try{S.destroy()}catch(P){}w===S&&(w=null),c.innerHTML="";var M=Wa();M.classList.add("renuvex-pr-fwizard-step--enter"),c.appendChild(M),l.setStepAttr("thanks"),d.setThanksState(l.close),v="idle"};S.el.addEventListener("animationend",A),h=setTimeout(A,300)}}function C(){var z=r.get().currentStep;if(v!=="idle"){g=z;return}if(!w){var S=!b;b=!1,x(z,S);return}var A=w;v="exiting",A.el.classList.add("renuvex-pr-fwizard-step--exit");var M=function(){if(h&&clearTimeout(h),A.el.removeEventListener("animationend",M),A.destroy)try{A.destroy()}catch(N){}if(w===A){c.innerHTML="",w=null;var P=g!==null?g:r.get().currentStep;g=null,x(P,!0),v="idle"}};A.el.addEventListener("animationend",M),h=setTimeout(M,350)}C();var E=r.get().currentStep,T=r.onChange(function(z){z.currentStep!==E?(E=z.currentStep,C()):d.update(z.currentStep,z)}),f=l.close;return l.close=function(){T&&T(),typeof h!="undefined"&&h&&clearTimeout(h),f()},l.open(s),{close:l.close}}var pi=4e3;async function Ga(){var e=await ge(ce+"/api/public/upload/video/capability?storeId="+encodeURIComponent(te),{method:"GET",cache:"no-store"},pi);if(!e.ok)throw new Error("video_capability_unavailable");var r=await e.json().catch(function(){return{}}),t=r&&r.data;if(!t||typeof t.enabled!="boolean")throw new Error("video_capability_invalid");return{enabled:t.enabled===!0,reason:typeof t.reason=="string"?t.reason:null}}var Kr=null;function ui(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function di(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:L&&L.videoReviewsEnabled===!0,reason:null};else try{t=await Ga()}catch(n){t={enabled:!1,reason:"capability_unavailable"}}qa({productId:D||"",productName:Le||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function X(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=ui(r);return Kr||(Kr=di(r,Ce()).finally(function(){Kr=null})),Kr.finally(t)}var Ka=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var si={id:"classic",name:"Klasik (A\xE7\u0131k)"},vi=Ka;function ci(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentHasImages,c=e.onFilterChange,d=e.onSortChange;Te(a);var s=document.createElement("div");s.className="renuvex-pr-summary";var w=(o[3]||0)+(o[4]||0),v=i>0?Math.round(w/i*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-avg",g.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ae("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",s.appendChild(g);var b=document.createElement("div");if(b.className="renuvex-pr-summary-block renuvex-pr-summary-count",b.textContent=i.toLocaleString("tr-TR")+" "+U(n.countLabel,"Yorum"),s.appendChild(b),n.showRecommendation!==!1&&v>0){var h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",s.appendChild(h)}return s.appendChild(Ke({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:c})),s.appendChild(re({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:X,onSortChange:d})),s}var ht={};ze(ht,{css:()=>fi,meta:()=>mi,render:()=>bi});var Xa=`
...
`;var mi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},fi=Xa,xi="__unknown_product__",sr=Object.create(null);function gi(e){return e?String(e):xi}var Fe=null,vr=null;function hi(){!Fe||!vr||(Fe.removeEventListener?Fe.removeEventListener("change",vr):Fe.removeListener&&Fe.removeListener(vr),Fe=null,vr=null)}function bi(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentHasImages,c=e.onFilterChange,d=e.onSortChange,s=gi(t),w=document.createElement("div");w.className="renuvex-pr-summary renuvex-pr-summary-compact";var v=document.createElement("div");v.className="renuvex-pr-compact-header";var g=document.createElement("div");g.className="renuvex-pr-compact-trigger-wrap";var b=document.createElement("button");b.className="renuvex-pr-compact-trigger",b.type="button",b.setAttribute("aria-expanded","false"),b.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Ae(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+ne(qt)+"</span>";var h=b.querySelector(".renuvex-pr-compact-trigger-text"),x=b.querySelector(".renuvex-pr-compact-chevron");if(h&&(h.textContent=i.toLocaleString("tr-TR")+" "+U(n.countLabel,"Yorum")),h&&x){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",b.insertBefore(k,h),k.appendChild(h),k.appendChild(x)}g.appendChild(b),v.appendChild(g);var y=re({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:X,onSortChange:d}),C=y.querySelector(".renuvex-pr-filter-wrap"),E=y.querySelector(".renuvex-pr-write-btn"),T=document.createElement("div");T.className="renuvex-pr-compact-actions-slot",E&&T.appendChild(E),C&&T.appendChild(C),v.appendChild(T),w.appendChild(v);var f=document.createElement("div");f.className="renuvex-pr-compact-panel",f.setAttribute("role","dialog"),f.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),f.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+ae("full")+"</span><span>"+p+"</span>",z.appendChild(S),z.appendChild(Ke({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(F){M()&&f.classList.contains("renuvex-pr-open")&&(sr[s]=!0),c(F)}})),f.appendChild(z);var A=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function M(){return!!(A&&A.matches)}function P(F){F?f.classList.add("renuvex-pr-open"):f.classList.remove("renuvex-pr-open"),f.setAttribute("aria-hidden",F?"false":"true"),b.setAttribute("aria-expanded",F?"true":"false")}function N(F){var j=F?w:g;if(f.parentNode!==j){var H=!!f.parentNode;f.classList.contains("renuvex-pr-open")&&P(!1),H&&(sr[s]=!1),j.appendChild(f)}}N(A?A.matches:!1);var R=re({widget:r,currentOrderBy:u,currentHasImages:m,onWriteClick:X,onSortChange:d}),I=R.querySelector(".renuvex-pr-filter-wrap"),_=R.querySelector(".renuvex-pr-write-btn"),O=document.createElement("div");O.className="renuvex-pr-compact-write-row",_&&O.appendChild(_),I&&O.appendChild(I),w.appendChild(O);function V(){var F=f.classList.contains("renuvex-pr-open");return P(!1),M()&&(sr[s]=!1),F}function Z(){Y&&Y.notifyOpening(),P(!0),M()&&(sr[s]=!0)}b.onclick=function(){f.classList.contains("renuvex-pr-open")?V():Z()};var Y=null;function J(F){Y&&(Y.unregister(),Y=null),F||(Y=Yr({trigger:g,element:f,close:V}))}if(J(A?A.matches:!1),hi(),A){var ue=function(F){N(F.matches),J(F.matches)};A.addEventListener?A.addEventListener("change",ue):A.addListener&&A.addListener(ue),Fe=A,vr=ue}if(M()&&sr[s]&&P(!0),n.showRecommendation!==!1){var we=(o[3]||0)+(o[4]||0),le=i>0?Math.round(we/i*100):0;if(le>0){var W=document.createElement("div");W.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="renuvex-pr-recommend-pct">%'+le+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(W)}}return w}var bt={};ze(bt,{css:()=>wi,meta:()=>yi,render:()=>ki});var Ja=`
...
`;var yi={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},wi=Ja;function ki(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,p=e.currentRatingFilter,l=e.currentOrderBy,u=e.currentHasImages,m=e.onFilterChange,c=e.onSortChange;Te(n);var d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var w=document.createElement("div");w.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",w.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ae("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(w);var v=document.createElement("div");v.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",v.textContent=a.toLocaleString("tr-TR")+" "+U(t.countLabel,"Yorum"),s.appendChild(v),d.appendChild(s);var g=document.createElement("div");g.className="renuvex-pr-split-col renuvex-pr-split-mid",g.appendChild(Ke({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:p,onFilterChange:m})),d.appendChild(g);var b=re({widget:r,currentOrderBy:l,currentHasImages:u,onWriteClick:X,onSortChange:c}),h=b.querySelector(".renuvex-pr-filter-wrap"),x=b.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-right",x&&k.appendChild(x),h&&k.appendChild(h),d.appendChild(k);var y=(i[3]||0)+(i[4]||0),C=a>0?Math.round(y/a*100):0,E=document.createElement("div");E.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",E.innerHTML='<span class="renuvex-pr-recommend-pct">%'+C+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var T=t.showRecommendation===!1||C===0;return T&&E.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(E),d}var yt={};ze(yt,{css:()=>zi,meta:()=>Si,render:()=>Ci});var Za=`
...
`;var Si={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},zi=Za;function Ci(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-minimal";var m=document.createElement("div");m.className="renuvex-pr-minimal-info";var c=document.createElement("div");c.className="renuvex-pr-minimal-row";var d=document.createElement("span");d.className="renuvex-pr-minimal-avg",d.textContent=i,c.appendChild(d);var s=document.createElement("span");s.className="renuvex-pr-minimal-stars",s.innerHTML=Ae(i,n),c.appendChild(s);var w=document.createElement("span");w.className="renuvex-pr-minimal-count",w.textContent=a.toLocaleString("tr-TR")+" "+U(t.countLabel,"Yorum"),c.appendChild(w),m.appendChild(c),u.appendChild(m);var v=re({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:X,onSortChange:l}),g=v.querySelector(".renuvex-pr-filter-wrap"),b=v.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");h.className="renuvex-pr-minimal-actions",b&&h.appendChild(b),g&&h.appendChild(g),u.appendChild(h);var x=re({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:X,onSortChange:l}),k=x.querySelector(".renuvex-pr-filter-wrap"),y=x.querySelector(".renuvex-pr-write-btn"),C=document.createElement("div");return C.className="renuvex-pr-minimal-write-row",y&&C.appendChild(y),k&&C.appendChild(k),u.appendChild(C),u}var wt={};ze(wt,{css:()=>Ti,meta:()=>Ei,render:()=>Ai});var $a=`
...
`;var Ei={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},Ti=$a;function Ai(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var m=document.createElement("div");m.className="renuvex-pr-hero-info";var c=document.createElement("div");c.className="renuvex-pr-hero-rating-col";var d=document.createElement("span");d.className="renuvex-pr-hero-avg",d.textContent=i,c.appendChild(d);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var w=document.createElement("span");w.className="renuvex-pr-hero-stars",w.innerHTML=Ae(i,n),s.appendChild(w);var v=document.createElement("div");v.className="renuvex-pr-hero-count",v.textContent=a.toLocaleString("tr-TR")+" "+U(t.countLabel,"Yorum"),s.appendChild(v),c.appendChild(s),m.appendChild(c),u.appendChild(m);var g=re({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:X,onSortChange:l}),b=g.querySelector(".renuvex-pr-filter-wrap"),h=g.querySelector(".renuvex-pr-write-btn"),x=document.createElement("div");x.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",h&&x.appendChild(h),b&&x.appendChild(b),u.appendChild(x);var k=re({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:X,onSortChange:l}),y=k.querySelector(".renuvex-pr-filter-wrap"),C=k.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");return E.className="renuvex-pr-hero-write-row",C&&E.appendChild(C),y&&E.appendChild(y),u.appendChild(E),u}var Qa=`
  .renuvex-pr-summary{
...
`;var Ii={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Bi=an;function Oi(e,r){var t=_r(e),n=!!t,a=document.createElement("article");a.className="renuvex-pr-review-gallery"+(n?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=fe(e.rating,L),i.appendChild(o),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-gallery-title",p.textContent=e.title,i.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-review-gallery-author",l.textContent=e.author||"",i.appendChild(l);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=xe(e.createdAt),i.appendChild(u);var m=(e.comment||"").trim();if(m&&i.appendChild(Qe(m,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ve(e,t.url,r)}}:null).fragment),a.appendChild(i),n){var c=document.createElement("div");c.className="renuvex-pr-review-gallery-media";var d=Pe(t,{sourceWidth:Ar,width:Ar,height:Math.round(Ar*4/3),onOpen:function(){ve(e,t.url,r)}});d&&c.appendChild(d),a.appendChild(c)}var s=er(e.merchantReply,t?function(){ve(e,t.url,r)}:null);return s&&(s.classList.add("renuvex-pr-review-gallery-reply"),a.appendChild(s)),a}var Zr={card:kt,list:St,gallery:zt};function $r(e){return Zr[e]||Zr.card}function nn(){return Object.keys(Zr).map(function(e){return Zr[e].css||""}).join(`
`)}var Ct=0;function Ue(){return Ct++,Ct}function He(e,r){return e!==Ct?!1:r?!(r.productId!==void 0&&D!==r.productId||r.orderBy!==void 0&&K!==r.orderBy||r.page!==void 0&&nr!==r.page||r.ratingFilter!==void 0&&$!==r.ratingFilter||r.hasImages!==void 0&&Q!==r.hasImages||r.nextCursor!==void 0&&hr!==r.nextCursor):!0}var Et={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Tt={small:80,medium:110,large:140},At={small:80,medium:100,large:110};function on(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",n=document.createElementNS(t,"svg");n.setAttribute("width","32"),n.setAttribute("height","32"),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.style.cssText="color:#6e6d7a;margin-bottom:4px;";var a=document.createElementNS(t,"path");a.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),n.appendChild(a),n.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var p=document.createElement("div");return p.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",p.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(n),r.appendChild(o),r.appendChild(p),r}function ln(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var n=document.createElement("div");n.className="renuvex-pr-empty-state-stars",n.innerHTML=Ae(0,e.iconPair),t.appendChild(n);var a=document.createElement("p");a.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),a.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(a),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function pn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function un(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="renuvex-pr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var a=document.createElement("button");return a.type="button",a.className="renuvex-pr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},t.appendChild(a),t}function ye(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),a=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+n+","+a+","+i+","+r+")"}function Qr(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Pt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function dn(e){return .2126*Pt(e.r)+.7152*Pt(e.g)+.0722*Pt(e.b)}function sn(e,r){var t=dn(e),n=dn(r),a=Math.max(t,n),i=Math.min(t,n);return(a+.05)/(i+.05)}function Fi(e){var r=Qr(e)||Qr("#ffffff"),t=Qr("#111111"),n=Qr("#ffffff");return sn(t,r)>=sn(n,r)?"#111111":"#ffffff"}function Ui(e){return ye(e,e==="#ffffff"?.1:.06)}function vn(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",p=r.barTrackColor||"#e5e7eb",l=r.barCountColor||"#111111",u=ye(o,.06),m=r.reviewStarColor||"#f59e0b",c=r.btnBgColor||"#111111",d=r.btnTextColor||"#ffffff",s=r.btnBorderColor||"#111111",w=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",g=r.filterBtnBorderColor||"#111111",b=r.filterMenuBgColor||"#ffffff",h=r.filterMenuBorderColor||"#e5e7eb",x=r.filterItemTextColor||"#111111",k=r.filterItemHoverBgColor||"#f3f4f6",y=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",E=r.reviewAuthorColor||"#111111",T=r.reviewDateColor||"#5e5e5e",f=r.reviewBodyColor||"#111111",z=r.reviewBorderColor||"#e5e7eb",S=ye(f,.65),A=r.replyBgColor||"#f9fafb",M=r.replyBorderColor||"#747474",P=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",R=r.photoTitleColor||"#111111",I=ye("#111111",.05),_=r.photoArrowBgColor||"#ffffff",O=r.photoArrowTextColor||"#111111",V=ye("#111111",.12),Z=r.formBgColor||"#ffffff",Y=r.formPrimaryTextColor||"#111111",J=r.formSecondaryTextColor||"#3b3b3b",ue=r.inputTextColor||Y,we=r.inputBorderColor||"#d1d5db",le=r.placeholderColor||"#9ca3af",W=r.formStepBarColor||"#111111",F=r.formBtnBgColor||"#111111",j=r.formBtnTextColor||"#ffffff",H=r.formBtnBorderColor||"#111111",Ne=ye(F,.06),pe=ye(F,.18),rr=ye(j,.85),tr=ye(Y,.06),ke=Fi(Z),B=Ui(ke),G=r.loadMoreBgColor||"#ffffff",Se=r.loadMoreTextColor||"#111111",Me=r.loadMoreBorderColor||"#111111",cr=r.paginationBgColor||"#ffffff",mr=r.paginationTextColor||"#111111",fr=r.paginationBorderColor||"#e5e7eb",xr=r.paginationActiveBgColor||"#111111",gr=r.paginationActiveTextColor||"#ffffff",de={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":n,"--renuvex-pr-header-count":a,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":p,"--renuvex-pr-bar-count":l,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":c,"--renuvex-pr-btn-text":d,"--renuvex-pr-btn-border":s,"--renuvex-pr-filter-btn-bg":w,"--renuvex-pr-filter-btn-text":v,"--renuvex-pr-filter-btn-border":g,"--renuvex-pr-filter-menu-bg":b,"--renuvex-pr-filter-menu-border":h,"--renuvex-pr-filter-item-text":x,"--renuvex-pr-filter-item-hover-bg":k,"--renuvex-pr-filter-item-active":y,"--renuvex-pr-review-title":C,"--renuvex-pr-review-author":E,"--renuvex-pr-review-date":T,"--renuvex-pr-review-body":f,"--renuvex-pr-review-border":z,"--renuvex-pr-state-text":S,"--renuvex-pr-review-star-color":m,"--renuvex-pr-reply-bg-color":A,"--renuvex-pr-reply-border":M,"--renuvex-pr-reply-label":P,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":R,"--renuvex-pr-photo-image-border":I,"--renuvex-pr-photo-arrow-bg":_,"--renuvex-pr-photo-arrow-text":O,"--renuvex-pr-photo-arrow-border":V,"--renuvex-pr-fwizard-bg":Z,"--renuvex-pr-fwizard-text":Y,"--renuvex-pr-fwizard-secondary-text":J,"--renuvex-pr-fwizard-input-bg":Z,"--renuvex-pr-fwizard-input-text":ue,"--renuvex-pr-fwizard-input-border":we,"--renuvex-pr-fwizard-placeholder":le,"--renuvex-pr-fwizard-close-text":ke,"--renuvex-pr-fwizard-close-hover-bg":B,"--renuvex-pr-fwizard-progress-bg":tr,"--renuvex-pr-fwizard-progress-active":W,"--renuvex-pr-fwizard-btn-bg":F,"--renuvex-pr-fwizard-btn-text":j,"--renuvex-pr-fwizard-btn-border":H,"--renuvex-pr-fwizard-btn-disabled-bg":pe,"--renuvex-pr-fwizard-btn-disabled-text":rr,"--renuvex-pr-fwizard-nav-hover-bg":Ne,"--renuvex-pr-load-more-bg":G,"--renuvex-pr-load-more-text":Se,"--renuvex-pr-load-more-border":Me,"--renuvex-pr-pagination-bg":cr,"--renuvex-pr-pagination-text":mr,"--renuvex-pr-pagination-border":fr,"--renuvex-pr-pagination-active-bg":xr,"--renuvex-pr-pagination-active-text":gr};Object.keys(de).forEach(function(ar){e.style.setProperty(ar,de[ar])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function cn(e){var r=e.settings,t=e.root,n=e.currentHasImages,a=e.openReviewModal,i=(e.photoStripReviews||[]).filter(function(x){return he(x).length>0});if(!(r.showPhotoGallery!==!1&&!n&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var p=U(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),l=document.createElement("div");l.className="renuvex-pr-photo-title",l.textContent=p,o.appendChild(l)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",u);var m=document.createElement("div");m.className="renuvex-pr-photo-strip";var c=ee,d=r.reviewLayout==="card"?ee:Math.round(ee*4/3),s=0;i.forEach(function(x){if(!(s>=15)){var k=_r(x);if(k){var y=Pe(k,{className:"renuvex-pr-photo-strip-thumb",sourceWidth:ee,width:c,height:d,loading:s<3?"eager":"lazy",onOpen:function(){a(x,k.url,i)}});y&&(m.appendChild(y),s++)}}});var w=document.createElement("button");w.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var v=q(De);v&&w.appendChild(v),w.setAttribute("aria-label","\xD6nceki"),w.onclick=function(){m.scrollBy({left:-200,behavior:"smooth"})};var g=document.createElement("button");g.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var b=q(zr);b&&g.appendChild(b),g.setAttribute("aria-label","Sonraki"),g.onclick=function(){m.scrollBy({left:200,behavior:"smooth"})};var h=document.createElement("div");return h.className="renuvex-pr-photo-strip-wrap",h.appendChild(w),h.appendChild(m),h.appendChild(g),o.appendChild(h),o}var Hi=1,Vi=7,Nt="\u2026";function Di(e,r){var t=Math.max(1,Math.floor(Number(r))||1),n=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Vi){for(var a=[],i=1;i<=t;i++)a.push(i);return a}for(var o=[],p=1;p<=t;p++)(p===1||p===t||Math.abs(p-n)<=Hi)&&o.push(p);for(var l=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&l.push(Nt),l.push(o[u]);return l}function mn(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),n=typeof e.onPageChange=="function"?e.onPageChange:function(){},a=document.createElement("nav");a.className="renuvex-pr-pagination",a.setAttribute("aria-label","Yorum sayfalar\u0131");function i(l){a.setAttribute("aria-busy","true");for(var u=a.querySelectorAll("button"),m=0;m<u.length;m++)u[m].disabled=!0;n(l)}function o(l,u){var m=document.createElement("span");m.className="renuvex-pr-pagination-label",m.setAttribute("aria-hidden","true"),m.textContent=u,l.appendChild(m)}function p(l,u,m,c){var d=document.createElement("button");return d.type="button",d.className="renuvex-pr-pagination-arrow",d.setAttribute("aria-label",l),o(d,u),c?d.disabled=!0:d.onclick=function(){i(m)},d}return a.appendChild(p("\xD6nceki sayfa","\u2039",t-1,t<=1)),Di(t,r).forEach(function(l){if(l===Nt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=Nt,a.appendChild(u);return}var m=document.createElement("button");m.type="button",m.className="renuvex-pr-pagination-btn",m.setAttribute("aria-label","Sayfa "+l),o(m,String(l)),l===t?m.setAttribute("aria-current","page"):m.onclick=function(){i(l)},a.appendChild(m)}),a.appendChild(p("Sonraki sayfa","\u203A",t+1,t>=r)),a}function fn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function xn(e){var r=e.render;async function t(){var o=Ue(),p=D,l=K,u=$,m=Q;Ee(null);var c=await Be(D,K,1,$,Q);He(o,{productId:p,orderBy:l,ratingFilter:u,hasImages:m})&&await r(D,L,c,Le,K,1,Lt)}async function n(o){var p=Ue(),l=$===o?null:o,u=D,m=K,c=Q;Rt(l),_e(1),Ee(null);var d=await Be(D,K,1,l,Q);He(p,{productId:u,orderBy:m,page:1,ratingFilter:l,hasImages:c})&&await r(D,L,d,Le,K,1)}async function a(o,p){var l=Ue(),u=D,m=$;_e(1),Ee(null);var c=o,d=!1;p&&(d=!0,c="newest"),It(d),br(c);var s=await Be(D,c,1,$,d);He(l,{productId:u,orderBy:c,page:1,ratingFilter:m,hasImages:d})&&await r(D,L,s,Le,c,1)}async function i(o){var p=Ue(),l=D,u=K,m=$,c=Q;_e(o),Ee(null);var d=await Be(D,K,o,$,Q);if(He(p,{productId:l,orderBy:u,page:o,ratingFilter:m,hasImages:c})){await r(D,L,d,Le,K,o);var s=document.getElementById("renuvex-reviews"),w=s&&s.shadowRoot,v=w&&w.querySelector&&w.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(v){try{v.focus({preventScroll:!0})}catch(h){try{v.focus()}catch(x){}}fn(w,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var g=document.getElementById("renuvex-reviews");if(g&&typeof g.scrollIntoView=="function"){var b=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;g.scrollIntoView({behavior:b?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:n,onSortChange:a,onPageChange:i}}function Yi(){return ea()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function ji(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=$t({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),Qt(t,{surface:"reviews",productId:r||""}),t}async function Mt(e,r,t,n,a,i,o){if(jt){kr({productId:e,settings:r,reviewsData:t,productName:n,orderBy:a,page:i,badgeSettings:o});return}wr(!0),Bt(e),Ot(r),o!==void 0&&Ft(o),Ut(n),a&&br(a),i&&_e(i),t!=null&&(Ht(t),Ee(t&&t.data?t.data.nextCursor:null));var p=xn({render:Mt});try{let ke=function(B,G){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var Se=B.meta.sizeOverrides[G];Se&&Object.keys(Se).forEach(function(Me){s.style.setProperty(Me,Se[Me])})}};var rr=ke,l=Jr(r.summaryLayout),u=!(l.meta&&l.meta.supports&&l.meta.supports.title===!1),m=r.showTitle!==!1,c=U(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),d=u&&m?c:"",s=document.documentElement;vn(s,r);var w=r.borderRadius!==void 0?r.borderRadius:8,v=Et[r.size]||Et.medium,g=Tt[r.thumbnailSize]||Tt.medium,b=g;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(b=At[r.thumbnailSize]||At.medium),s.style.setProperty("--renuvex-pr-title-size",v.titleSize+"px"),s.style.setProperty("--renuvex-pr-review-text-size",v.reviewTextSize+"px"),s.style.setProperty("--renuvex-pr-review-title-size",v.reviewTitleSize+"px"),s.style.setProperty("--renuvex-pr-author-size",v.authorSize+"px"),s.style.setProperty("--renuvex-pr-reply-name-size",v.replyNameSize+"px"),s.style.setProperty("--renuvex-pr-reply-text-size",v.replyTextSize+"px"),s.style.setProperty("--renuvex-pr-radius",w+"px"),s.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,w-4)+"px"),s.style.setProperty("--renuvex-pr-photo-title-size",v.photoTitleSize+"px"),s.style.setProperty("--renuvex-pr-avg-rating-size",v.avgRatingSize+"px"),s.style.setProperty("--renuvex-pr-review-count-size",v.reviewCountSize+"px"),s.style.setProperty("--renuvex-pr-compact-count-size",v.compactCountSize+"px"),s.style.setProperty("--renuvex-pr-recommend-size",v.recommendSize+"px"),s.style.setProperty("--renuvex-pr-btn-text-size",v.btnTextSize+"px"),s.style.setProperty("--renuvex-pr-bar-label-size",v.barLabelSize+"px"),s.style.setProperty("--renuvex-pr-minimal-avg-size",v.minimalAvgSize+"px"),s.style.setProperty("--renuvex-pr-hero-avg-size",v.heroAvgSize+"px"),s.style.setProperty("--renuvex-pr-minimal-count-size",v.minimalCountSize+"px"),s.style.setProperty("--renuvex-pr-hero-count-size",v.heroCountSize+"px"),s.style.setProperty("--renuvex-pr-bar-count-size",v.barCountSize+"px"),s.style.setProperty("--renuvex-pr-review-date-size",v.reviewDateSize+"px"),s.style.setProperty("--renuvex-pr-filter-text-size",v.filterTextSize+"px"),s.style.setProperty("--renuvex-pr-load-more-size",v.loadMoreSize+"px"),s.style.setProperty("--renuvex-pr-load-more-min-height",v.loadMoreMinHeight+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-y",v.loadMorePadY+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-x",v.loadMorePadX+"px"),s.style.setProperty("--renuvex-pr-load-more-mobile-min-height",v.loadMoreMobileMinHeight+"px"),s.style.setProperty("--renuvex-pr-pagination-button-size",v.paginationButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-pad-x",v.paginationPadX+"px"),s.style.setProperty("--renuvex-pr-pagination-gap",v.paginationGap+"px"),s.style.setProperty("--renuvex-pr-pagination-margin-top",v.paginationMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-gap-min",v.paginationGapMin+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-button-size",v.paginationMobileButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-font-size",v.paginationMobileFontSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap",v.paginationMobileGap+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",v.paginationMobileMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",v.paginationMobileGapMin+"px"),s.style.setProperty("--renuvex-pr-read-more-size",v.readMoreSize+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size",g+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size-mobile",b+"px");var h=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";s.style.setProperty("--renuvex-pr-review-star-color",h),s.style.setProperty("--renuvex-pr-star-size",v.reviewStarSize+"px"),s.style.setProperty("--renuvex-pr-avg-star-size",v.avgStarSize+"px"),ke(Jr(r.summaryLayout),r.size),ke($r(r.reviewLayout),r.size);var x=ir(r),k=Yi();if(!k)return;var y=ji(k,e),C=document.getElementById("renuvex-reviews");C||(C=document.createElement("div"),C.id="renuvex-reviews",C.style.minHeight="200px"),C.parentNode!==y&&y.appendChild(C);var E=na(C),T=je+Ve+Ir+en()+nn();We(E,T);var f=oa(E);if(r.enabled===!1){C.style.minHeight="auto",f.replaceChildren(on(r.borderRadius!==void 0?r.borderRadius:8)),wr(!1);var z=yr;kr(null),z&&Mt(z.productId,z.settings,z.reviewsData,z.productName,z.orderBy,z.page,z.badgeSettings);return}try{var S=t||{},A=nt(S),M=A?[]:S.data&&S.data.reviews||[];Vt(M),f.replaceChildren();var P=document.createElement("section");if(P.id="renuvex-reviews-widget",P.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),P.className="renuvex-pr-reviews-widget",P.setAttribute("data-renuvex-surface","reviews"),e&&P.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(P.style.width="100%",P.style.maxWidth="100%",P.style.marginLeft="0",P.style.marginRight="0"),d){var N=document.createElement("div"),R=r.summaryLayout||"classic";N.className="renuvex-pr-title renuvex-pr-title-"+R,N.textContent=d,P.appendChild(N)}if(A){P.appendChild(un(S.message,p.onRetry)),f.appendChild(P),Re(E),et(P,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return E.getElementById("renuvex-reviews-widget")});return}var I=S.data&&S.data.allCount||0,_=S.data&&S.data.ratingCounts||null,O=_||[0,0,0,0,0],V=S.data&&S.data.avgRating||"0.0";if(!_&&M.length>0){M.forEach(function(B){B.rating>=1&&B.rating<=5&&O[B.rating-1]++});var Z=M.reduce(function(B,G){return B+G.rating},0);V=(Z/M.length).toFixed(1)}if(I===0)P.classList.add("renuvex-pr-reviews-empty"),P.appendChild(ln({iconPair:x,writeButtonText:U(r.writeButtonText,"Yorum Yap"),emptyStateText:U(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:X}));else{var Y=Jr(r.summaryLayout),J=Y.render({widget:P,productId:e,data:S,settings:r,iconPair:x,allCount:I,ratingCounts:O,avgRatingVal:V,currentRatingFilter:$,currentOrderBy:K,currentHasImages:Q,onFilterChange:p.onFilterChange,onSortChange:p.onSortChange});P.appendChild(J);var ue=cn({settings:r,root:s,currentHasImages:Q,photoStripReviews:_t,openReviewModal:ve,wireLightboxTrigger:lr});if(ue&&P.appendChild(ue),M.length===0)P.appendChild(pn());else{var we=$r(r.reviewLayout);M.forEach(function(B){P.appendChild(we.render(B,rt))})}var le=r.paginationMode==="numbered"?"numbered":"loadMore";if(le==="numbered"){var W=S.data&&S.data.totalPages||1;W>1&&P.appendChild(mn({page:S.data&&S.data.page||nr||1,totalPages:W,onPageChange:p.onPageChange}))}var F=le==="loadMore"&&S.data&&S.data.hasMore;if(F){let B=function(G){H.textContent=G,j.setAttribute("aria-label",G)};var tr=B,j=document.createElement("button");j.className="renuvex-pr-load-more";var H=document.createElement("span");H.className="renuvex-pr-load-more-label",H.setAttribute("aria-hidden","true"),j.appendChild(H),B("Daha Fazla G\xF6ster"),j.onclick=async function(){j.disabled=!0,B("Y\xFCkleniyor...");var G=Ue(),Se=D,Me=K,cr=nr,mr=$,fr=Q,xr=hr,gr=cr+1,de=await Be(Se,Me,gr,mr,fr,null,xr);if(He(G,{productId:Se,orderBy:Me,page:cr,ratingFilter:mr,hasImages:fr,nextCursor:xr}))if(de&&!nt(de)&&de.data&&Array.isArray(de.data.reviews)){var ar=Dt(de.data.reviews);Yt(ar),_e(gr),Ee(de.data.nextCursor||null);var gn=$r(L.reviewLayout);ar.forEach(function(hn){P.insertBefore(gn.render(hn,rt),j)}),de.data.hasMore?(j.disabled=!1,B("Daha Fazla G\xF6ster")):j.remove()}else j.disabled=!1,B("Tekrar Dene")},P.appendChild(j)}}f.appendChild(P),Re(E),et(P,"reviews-widget",{productId:e||""},function(){return E.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var Ne=document.createElement("p");Ne.style.cssText="text-align:center;color:#dc2626;",Ne.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",f&&f.replaceChildren(Ne)}}finally{if(wr(!1),yr){var pe=yr;kr(null),Mt(pe.productId,pe.settings,pe.reviewsData,pe.productName,pe.orderBy,pe.page,pe.badgeSettings)}}}export{Mt as render};
