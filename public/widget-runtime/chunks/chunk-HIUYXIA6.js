...
import{b as je}from"./chunk-Z7432DLE.js";import{a as be,b as Yr}from"./chunk-RCD3736S.js";import{$ as _r,A as Rr,B as Ge,C as We,D as qe,J as Oe,K as Ir,M as Br,N as pe,O as he,P as Mr,Q as me,R as Fr,S as Hr,T as ye,U as Ke,V,W as Ue,X as Xe,Y as or,Z as lr,_ as Q,a as ke,aa as ee,b as ve,ba as Or,c as ge,ca as Ye,d as ce,e as xr,f as Se,g as Ee,ga as Dr,h as $,i as P,j as tr,k as Ae,m as ar,n as zr,o as Re,p as Te,q as Ve,r as nr,s as Cr,t as Sr,u as Er,v as Tr,w as Lr,x as Nr,y as Pr,z as Ar}from"./chunk-PN4W5YOG.js";var zi=15,Ci=60*1e3,jr="__ikrReviewsFetchError",dr={};function Je(e){return{type:jr,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function sr(e){return!!(e&&e.type===jr)}async function Le(e,r,i,t,n,l){if(window.__ikasPreviewMode){try{var c=window.__ikasPreviewBaseUrl||ge,o=c+"/api/preview/reviews?page="+encodeURIComponent(i||1),s=await be(o);if(s.ok)return await s.json()}catch(y){}return Je()}r=r||"newest",i=i||1;var p=l?"_l"+l:"",f="ikr_reviews_"+ve+"_"+e+"_"+r+"_"+i+"_"+(t||"")+"_"+(n?"1":"0")+p,d=null,a=Or(f);if(a)try{var k=JSON.parse(a);if(k&&k.t!==void 0&&k.v){if(Date.now()-k.t<Ci)return k.v;d=k.v,Ye(f,"")}else Ye(f,"")}catch(y){Ye(f,"")}try{var u=ge+"/api/public/reviews?storeId="+encodeURIComponent(ve)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(t?"&rating="+encodeURIComponent(t):"")+(n?"&hasImages=true":"")+(l?"&limit="+encodeURIComponent(l):""),v=await be(u);if(!v.ok)return d||Je();var m=await v.json();return Ye(f,JSON.stringify({t:Date.now(),v:m})),m}catch(y){return console.error("[ikr] fetchReviews error:",y),d||Je()}}async function Si(e){var r=await Le(e,"newest",1,null,!0,zi);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function Tt(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var t=document.getElementById("ikr-jsonld");if(t&&t.remove(),!dr[e]){dr[e]=!0;var n={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},l={enabled:!0,size:"medium"};try{var c=await Yr();if(!c)return;var o=c.widgets&&c.widgets.reviews||n,s=c.widgets&&c.widgets.badge||l;if(o.enabled===!1)return;Re("newest"),Te(1),Ve(null);var p=await Promise.all([Le(e,"newest",1,null),Si(e)]),f=p[0];Nr(p[1]),await we(e,o,f,r,"newest",1,s)}catch(d){console.error("[ikr] bootstrap error:",d),await we(e,n,Je(),r,void 0,void 0,l)}finally{delete dr[e]}}}function Ie(e){return ye(e)}function Ei(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function re(e,r,i,t){i?e.setProperty(r,i,t||""):e.removeProperty(r)}function Ti(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",i=navigator.maxTouchPoints||0,t=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&i>1;return t&&/AppleWebKit/i.test(r)}function Li(){var e=Ei(),r=document.body.style,i=document.documentElement.style,t=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=Ti()&&!n;if(t>0){var c=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",c+t+"px","important")}return i.setProperty("overflow","hidden","important"),i.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important")),e}function Ni(e){if(e){var r=document.body.style,i=document.documentElement.style;re(i,"overflow",e.rootOverflow,e.rootOverflowPriority),re(i,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),re(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),re(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),re(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),re(r,"position",e.bodyPosition,e.bodyPositionPriority),re(r,"top",e.bodyTop,e.bodyTopPriority),re(r,"left",e.bodyLeft,e.bodyLeftPriority),re(r,"right",e.bodyRight,e.bodyRightPriority),re(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}}function Pi(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function Be(e){if(!(!e||!document.contains(e)||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(i){}}}function Ai(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function Gr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Ai)}function Wr(e){var r=Gr(e),i=r[0]||e.querySelector('[role="dialog"]')||e;Be(i)}function Ri(e,r){if(e.key==="Tab"){var i=Gr(r);if(!i.length){e.preventDefault(),Wr(r);return}var t=i[0],n=i[i.length-1],l=document.activeElement;if(!r.contains(l)){e.preventDefault(),Be(t);return}e.shiftKey&&l===t?(e.preventDefault(),Be(n)):!e.shiftKey&&l===n&&(e.preventDefault(),Be(t))}}function Ii(){var e={id:"ikr-modal-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state,history.pushState({ikrModal:e.id},"",e.url),e.pushed=!0}catch(r){}return e}function Bi(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state.ikrModal===e.id)}function Mi(e){if(Bi(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Vr(e,r,i,t,n){Ni(t),document.removeEventListener("keydown",r),window.removeEventListener("popstate",i),e.parentNode&&e.parentNode.removeChild(e),Be(n)}function Fi(e){var r=document.createElement("div");r.className="ikr-modal-right";var i=document.createElement("div");i.className="ikr-modal-scroll-content";var t=document.createElement("div");t.className="ikr-modal-top-row";var n=document.createElement("div");n.className="ikr-modal-stars",n.innerHTML=pe(e.rating,P);var l=document.createElement("span");l.className="ikr-modal-date",l.textContent=me(e.createdAt),t.appendChild(n),t.appendChild(l),i.appendChild(t);var c=document.createElement("div");c.className="ikr-modal-title",c.textContent=e.title||"",c.style.display=e.title?"":"none",i.appendChild(c);var o=document.createElement("div");o.className="ikr-modal-author",o.textContent=e.author||"",i.appendChild(o);var s=document.createElement("div");s.className="ikr-modal-body",s.textContent=(e.comment||"").trim(),s.style.display=e.comment&&e.comment.trim()?"":"none",i.appendChild(s);var p=document.createElement("div");p.className="ikr-modal-reply";var f=document.createElement("div");f.className="ikr-modal-reply-label",f.textContent=P&&P.merchantReplyLabel||"Ma\u011Faza Sahibi";var d=document.createElement("div");return d.className="ikr-modal-reply-text",d.textContent=e.merchantReply||"",p.appendChild(f),p.appendChild(d),p.style.display=e.merchantReply?"":"none",i.appendChild(p),r.appendChild(i),r}function qr(e,r,i){var t=i||P,n=e.querySelector(".ikr-modal-scroll-content"),l=n.querySelector(".ikr-modal-stars");l.innerHTML=pe(r.rating,t),n.querySelector(".ikr-modal-date").textContent=me(r.createdAt);var c=n.querySelector(".ikr-modal-title");c.textContent=r.title||"",c.style.display=r.title?"":"none",n.querySelector(".ikr-modal-author").textContent=r.author||"";var o=n.querySelector(".ikr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var s=n.querySelector(".ikr-modal-reply");s.querySelector(".ikr-modal-reply-label").textContent=t&&t.merchantReplyLabel||"Ma\u011Faza Sahibi",s.querySelector(".ikr-modal-reply-text").textContent=r.merchantReply||"",s.style.display=r.merchantReply?"":"none",e.scrollTop=0}function pr(e,r,i,t,n,l,c,o,s){var p=Ie(e),f=Math.max(0,Math.min(i||0,p.length-1)),d=document.createElement("div");d.className="ikr-modal-left";var a=document.createElement("img"),k=c==="next"?"ikr-modal-img-enter-right":c==="prev"?"ikr-modal-img-enter-left":"";a.className="ikr-modal-main-img"+(k?" "+k:""),a.src=lr(p[f]||""),a.decoding="async",a.width=or,a.height=Math.round(or*4/3),a.alt="Yorum foto\u011Fraf\u0131",_r(a,function(E){if(E.style.display="none",!d.querySelector(".ikr-modal-img-error")){var T=document.createElement("div");T.className="ikr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",d.insertBefore(T,E)}}),d.appendChild(a);var u=document.createElement("button");u.className="ikr-modal-close-mobile",u.textContent="\u2715",u.setAttribute("aria-label","Kapat"),u.onclick=function(E){E.stopPropagation(),l()},d.appendChild(u);var v=0;if(d.addEventListener("touchstart",function(E){v=E.touches[0].clientX},{passive:!0}),d.addEventListener("touchend",function(E){var T=v-E.changedTouches[0].clientX;if(!(Math.abs(T)<50)){if(T>0){if(x)ue(e,r,f+1,t,n,l,!0,"next",o,s);else if(g){var h=t[r+1];ue(h,r+1,0,t,n,l,!1,"next",o,s)}}else if(y)ue(e,r,f-1,t,n,l,!0,"prev",o,s);else if(b){var N=t[r-1],L=Ie(N);ue(N,r-1,L.length-1,t,n,l,!1,"prev",o,s)}}},{passive:!0}),p.length>1){var m=document.createElement("div");m.className="ikr-modal-thumbs",p.forEach(function(E,T){var h=document.createElement("img"),N=Q(E,Xe);h.src=N.src,h.srcset=N.srcset,h.loading="lazy",h.decoding="async",h.width=Xe,h.height=Xe,h.className="ikr-modal-thumb"+(T===f?" ikr-modal-thumb-active":""),h.alt="K\xFC\xE7\xFCk resim "+(T+1),ee(h),h.tabIndex=0,h.setAttribute("role","button"),h.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(T+1)+" se\xE7"),T===f&&h.setAttribute("aria-current","true"),(function(L){function B(){ue(e,r,L,t,n,l,!0,null,o,s)}h.onclick=B,h.onkeydown=function(F){(F.key==="Enter"||F.key===" ")&&(F.preventDefault(),B())}})(T),m.appendChild(h)}),d.appendChild(m)}var y=f>0,x=f<p.length-1,b=r>0,g=r<t.length-1,S=y||b,z=x||g;if(S){var C=document.createElement("button");C.className="ikr-modal-nav ikr-modal-nav-prev",C.innerHTML="&#8249;",C.setAttribute("aria-label","\xD6nceki"),C.onclick=function(E){if(E.stopPropagation(),y)ue(e,r,f-1,t,n,l,!0,"prev",o,s);else if(b){var T=t[r-1],h=Ie(T);ue(T,r-1,h.length-1,t,n,l,!1,"prev",o,s)}},d.appendChild(C)}if(z){var w=document.createElement("button");w.className="ikr-modal-nav ikr-modal-nav-next",w.innerHTML="&#8250;",w.setAttribute("aria-label","Sonraki"),w.onclick=function(E){if(E.stopPropagation(),x)ue(e,r,f+1,t,n,l,!0,"next",o,s);else if(g){var T=t[r+1];ue(T,r+1,0,t,n,l,!1,"next",o,s)}},d.appendChild(w)}return d}function Kr(e,r){[-1,1].forEach(function(i){var t=r[e+i];if(t){var n=Ie(t);n[0]&&(new Image().src=lr(n[0]))}})}function cr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Hi(e,r){var i=e&&e.querySelector(".ikr-modal-wrap"),t=r&&r.querySelector(".ikr-modal-right"),n=r&&r.querySelector(".ikr-modal-scroll-content");function l(){cr(i),cr(t),cr(n)}l(),i&&Be(i),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function ue(e,r,i,t,n,l,c,o,s,p){if(p&&(p.currentReview=e),c){var f=pr(e,r,i,t,n,l,o,s,p);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=pr(e,r,i,t,n,l,o,s,p),d=n.querySelector(".ikr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),d&&qr(d,e,p&&p.currentSettings),Hi(s,n)}Kr(r,t)}function ie(e,r,i){var t=Ie(e);if(!t.length)return;var n=(i||[]).filter(function(g){return Ie(g).length>0}),l=n.findIndex(function(g){return g===e||g.id===e.id});l===-1&&(n.unshift(e),l=0);var c=t.indexOf(r);c<0&&(c=0);var o=document.createElement("div");o.className="ikr-modal-overlay";var s=document.createElement("div");s.className="ikr-modal";var p=!1,f=Pi(),d=Li(),a=Ii(),k={currentReview:e,currentSettings:P};function u(g){var S=g&&g.detail&&g.detail.settings;k.currentSettings=S||P;var z=s.querySelector(".ikr-modal-right");!z||!k.currentReview||qr(z,k.currentReview,k.currentSettings)}function v(){p||(p=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),Vr(o,m,v,d,f))}function m(g){if(g.key==="Escape"){y();return}Ri(g,o)}function y(){p||(p=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),Vr(o,m,v,d,f),Mi(a))}document.addEventListener("keydown",m),window.addEventListener("popstate",v),window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),o.onclick=function(){y()},s.onclick=function(g){g.stopPropagation()},s.appendChild(pr(e,l,c,n,s,y,null,o,k)),s.appendChild(Fi(e)),Kr(l,n);var x=document.createElement("div");x.className="ikr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(s);var b=document.createElement("button");b.className="ikr-modal-close",b.textContent="\u2715",b.setAttribute("aria-label","Kapat"),b.onclick=function(g){g.stopPropagation(),y()},x.appendChild(b),o.appendChild(x),document.body.appendChild(o),Wr(o)}function Ur(e){if(e)for(var r=document.querySelectorAll("h1,h2,h3,h4,h5,h6,div,span,p"),i=0;i<r.length;i++){var t=r[i];if(t.children.length===0&&t.textContent.trim()===e&&t.tagName!=="TITLE"&&!t.closest("[data-ikr-listing-badge]")&&!t.closest("#ikas-reviews")&&!t.closest("nav")&&!t.closest("header")&&!t.closest('[class*="breadcrumb"]')&&!t.closest('[aria-label*="breadcrumb"]'))return t}return document.querySelector("h1")}var Xr={small:{icon:14,text:"12px"},medium:{icon:16,text:"14px"},large:{icon:20,text:"16px"}};function _i(e,r,i){var t="width:"+i+"px;height:"+i+"px;";return he(e,r,{sizeStyle:t})}function Jr(e,r,i,t,n){var l=document.getElementById("ikr-rating-badge");if(l&&l.remove(),!!e&&!(t&&t.enabled===!1)){var c=document.getElementById("ikr-jsonld");c&&c.remove();var o=document.createElement("script");o.id="ikr-jsonld",o.type="application/ld+json",o.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Product",name:i||document.title,url:window.location.href,aggregateRating:{"@type":"AggregateRating",ratingValue:e,reviewCount:r,bestRating:"5",worstRating:"1"}}),document.head.appendChild(o);var s=Ur(i);if(!(!s||!s.parentNode)){var p=t&&t.size||"medium",f=Xr[p]||Xr.medium,d=document.createElement("a");d.id="ikr-rating-badge",d.href="#ikas-reviews";var a=window.getComputedStyle(s).textAlign,k=a==="center"?"center":a==="right"?"flex-end":"flex-start";d.style.cssText="display:flex;align-items:center;gap:5px;text-decoration:none;margin-bottom:10px;cursor:pointer;font-weight:400;justify-content:"+k+";",d.innerHTML=_i(e,n,f.icon)+'<span style="font-size:'+f.text+';font-weight:400;color:#555;">'+e+" ("+r+" yorum)</span>",d.onclick=function(u){u.preventDefault();var v=document.getElementById("ikas-reviews-widget")||document.getElementById("ikas-reviews");if(v){var m=document.querySelector("header"),y=m?m.getBoundingClientRect().height:0,x=v.getBoundingClientRect().top+window.pageYOffset-y-16;window.scrollTo({top:x,behavior:"smooth"})}},s.parentNode.insertBefore(d,s.nextSibling)}}}var Zr=`
...
`;var it={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},tt=ui;function at(e){var r=e.widget,i=e.iconPair,t=e.allCount,n=e.avgRatingVal,l=e.currentOrderBy,c=e.currentHasImages,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var p=document.createElement("div");p.className="ikr-minimal-info";var f=document.createElement("div");f.className="ikr-minimal-row";var d=document.createElement("span");d.className="ikr-minimal-avg",d.textContent=n,f.appendChild(d);var a=document.createElement("span");a.className="ikr-minimal-stars",a.innerHTML=he(n,i),f.appendChild(a);var k=document.createElement("span");k.className="ikr-minimal-count",k.textContent=t.toLocaleString("tr-TR")+" Yorum",f.appendChild(k),p.appendChild(f),s.appendChild(p);var u=U({widget:r,currentOrderBy:l,currentHasImages:c,onWriteClick:O,onSortChange:o}),v=u.querySelector(".ikr-filter-wrap"),m=u.querySelector(".ikr-write-btn"),y=document.createElement("div");if(y.className="ikr-minimal-actions",m&&y.appendChild(m),v&&y.appendChild(v),s.appendChild(y),m){var x=document.createElement("button");x.className="ikr-write-btn",x.textContent=P&&P.writeButtonText||"Yorum Yap",x.onclick=O;var b=document.createElement("div");b.className="ikr-minimal-write-row",b.appendChild(x),s.appendChild(b)}return s}var hr={};ke(hr,{css:()=>ot,meta:()=>nt,render:()=>lt});var fi=`
...
`;var pt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"80px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"110px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},mt=vi;function ut(e,r){var i=ye(e),t=i.length>0,n=document.createElement("div");n.className="ikr-review-list"+(t?"":" ikr-review-list--no-media");var l=document.createElement("div");l.className="ikr-review-list-author";var c=document.createElement("span");c.className="ikr-review-stars ikr-review-list-author-stars",c.innerHTML=pe(e.rating,P),l.appendChild(c);var o=document.createElement("span");o.className="ikr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var s=document.createElement("span");s.className="ikr-date ikr-review-list-author-date",s.textContent=me(e.createdAt),l.appendChild(s),n.appendChild(l);var p=document.createElement("div");if(p.className="ikr-review-list-content",e.title){var f=document.createElement("div");f.className="ikr-review-list-title",f.textContent=e.title,p.appendChild(f)}var d=(e.comment||"").trim();if(d){var a=document.createElement("div");a.className="ikr-review-list-body ikr-body-clamped",a.textContent=d,p.appendChild(a);var k=document.createElement("span");k.className="ikr-read-more",k.textContent="Devam\u0131n\u0131 oku",k.style.display="none",p.appendChild(k),requestAnimationFrame(function(){if(a.scrollHeight>a.clientHeight+2){k.style.display="inline";var m=!1;k.onclick=function(){m=!m,a.classList.toggle("ikr-body-clamped",!m),k.textContent=m?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var u=He(e.merchantReply);if(u&&p.appendChild(u),n.appendChild(p),t){var v=document.createElement("div");v.className="ikr-review-list-media",i.forEach(function(m){var y=document.createElement("img"),x=Q(m,V);y.src=x.src,y.srcset=x.srcset,y.loading="lazy",y.decoding="async",y.width=V,y.height=Math.round(V*4/3),y.setAttribute("data-ikr-img-url",m),ee(y),(function(b){y.onclick=function(){ie(e,b,r)}})(m),v.appendChild(y)}),n.appendChild(v)}return n}var wr={};ke(wr,{css:()=>kt,meta:()=>ft,render:()=>vt});var gi=`
...
`;var ft={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"80px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"110px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},kt=gi;function vt(e,r){var i=Ke(e),t=!!i,n=document.createElement("div");n.className="ikr-review-gallery"+(t?"":" ikr-review-gallery--no-media");var l=document.createElement("div");l.className="ikr-review-gallery-content";var c=document.createElement("span");if(c.className="ikr-review-stars ikr-review-gallery-stars",c.innerHTML=pe(e.rating,P),l.appendChild(c),e.title){var o=document.createElement("div");o.className="ikr-review-gallery-title",o.textContent=e.title,l.appendChild(o)}var s=document.createElement("div");s.className="ikr-review-gallery-author",s.textContent=e.author||"",l.appendChild(s);var p=document.createElement("div");p.className="ikr-review-gallery-date",p.textContent=me(e.createdAt),l.appendChild(p);var f=(e.comment||"").trim();if(f){var d=document.createElement("div");d.className="ikr-review-gallery-body ikr-body-clamped",d.textContent=f,l.appendChild(d);var a=document.createElement("span");a.className="ikr-read-more",a.textContent="Devam\u0131n\u0131 oku",a.style.display="none",a.style.cursor="pointer";var k=!1;a.onclick=function(){if(i){ie(e,i,r);return}k=!k,d.classList.toggle("ikr-body-clamped",!k),a.textContent=k?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"},l.appendChild(a),requestAnimationFrame(function(){d.scrollHeight>d.clientHeight+2&&(a.style.display="inline")})}if(n.appendChild(l),t){var u=document.createElement("div");u.className="ikr-review-gallery-media";var v=document.createElement("img"),m=Q(i,Ue);v.src=m.src,v.srcset=m.srcset,v.loading="lazy",v.decoding="async",v.width=Ue,v.height=Math.round(Ue*4/3),ee(v),v.setAttribute("data-ikr-img-url",i),v.onclick=function(){ie(e,i,r)},u.appendChild(v),n.appendChild(u)}var y=He(e.merchantReply,i?function(){ie(e,i,r)}:null);return y&&(y.classList.add("ikr-review-gallery-reply"),n.appendChild(y)),n}var rr={card:yr,list:br,gallery:wr};function De(e){return rr[e]||rr.card}function hi(){return Object.keys(rr).map(function(e){return rr[e].css||""}).join(`
`)}function Ne(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var t=parseInt(i[1],16),n=parseInt(i[2],16),l=parseInt(i[3],16);return"rgba("+t+","+n+","+l+","+r+")"}function gt(){var e=document.getElementById("ikas-reviews-anchor");if(e)return e;e=document.createElement("div"),e.id="ikas-reviews-anchor",e.setAttribute("data-ikr-auto-anchor","1");var r=null;try{r=document.querySelector(Dr)}catch(t){}if(r&&r.parentNode)return r.parentNode.insertBefore(e,r.nextSibling),e;var i=document.querySelector("main")||document.body;return i?(i.appendChild(e),e):null}var yi={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},bi={small:80,medium:110,large:140};function ht(e,r){var i=document.createElement("div");i.className="ikr-state-msg ikr-state-error",i.setAttribute("role","status"),i.setAttribute("aria-live","polite");var t=document.createElement("div");t.className="ikr-state-error-text",t.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",i.appendChild(t);var n=document.createElement("button");return n.type="button",n.className="ikr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},i.appendChild(n),i}function yt(e,r){var i=r.headerTitleColor||"#111111",t=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",c=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",s=r.barCountColor||"#111111",p=Ne(c,.06),f=r.reviewStarColor||"#f59e0b",d=f,a=r.btnBgColor||"#111111",k=r.btnTextColor||"#ffffff",u=r.btnBorderColor||"#111111",v=r.filterBtnBgColor||"#111111",m=r.filterBtnTextColor||"#ffffff",y=r.filterBtnBorderColor||"#111111",x=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",g=r.filterItemTextColor||"#111111",S=r.filterItemHoverBgColor||"#f3f4f6",z=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",w=r.reviewAuthorColor||"#111111",E=r.reviewDateColor||"#5e5e5e",T=r.reviewBodyColor||"#111111",h=r.reviewBorderColor||"#e5e7eb",N=r.replyBgColor||"#f9fafb",L=r.replyBorderColor||"#747474",B=r.replyLabelColor||"#111111",F=r.replyTextColor||"#111111",G=r.photoTitleColor||"#111111",ae=Ne("#111111",.05),ne=r.photoArrowBgColor||"#ffffff",W=r.photoArrowTextColor||"#111111",Y=Ne("#111111",.12),H=r.formBgColor||"#ffffff",oe=r.formPrimaryTextColor||"#111111",le=r.formSecondaryTextColor||"#3b3b3b",D=r.inputTextColor||oe,fe=r.inputBorderColor||"#d1d5db",Pe=r.placeholderColor||"#9ca3af",de=r.formStepBarColor||"#111111",q=r.formBtnBgColor||"#111111",_=r.formBtnTextColor||"#ffffff",_e=r.formBtnBorderColor||"#111111",X=Ne(q,.06),xe=Ne(q,.18),se=Ne(_,.85),K=Ne(oe,.06),J=r.loadMoreBgColor||"#ffffff",ze=r.loadMoreTextColor||"#111111",j=r.loadMoreBorderColor||"#111111",I={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":i,"--ikr-header-avg":t,"--ikr-header-count":n,"--ikr-header-recommend":l,"--ikr-bar-fill":c,"--ikr-bar-track":o,"--ikr-star-empty-color":d,"--ikr-bar-count":s,"--ikr-bar-hover-bg":p,"--ikr-btn-bg":a,"--ikr-btn-text":k,"--ikr-btn-border":u,"--ikr-filter-btn-bg":v,"--ikr-filter-btn-text":m,"--ikr-filter-btn-border":y,"--ikr-filter-menu-bg":x,"--ikr-filter-menu-border":b,"--ikr-filter-item-text":g,"--ikr-filter-item-hover-bg":S,"--ikr-filter-item-active":z,"--ikr-review-title":C,"--ikr-review-author":w,"--ikr-review-date":E,"--ikr-review-body":T,"--ikr-review-border":h,"--ikr-review-star-color":f,"--ikr-reply-bg-color":N,"--ikr-reply-border":L,"--ikr-reply-label":B,"--ikr-reply-text":F,"--ikr-photo-title":G,"--ikr-photo-image-border":ae,"--ikr-photo-arrow-bg":ne,"--ikr-photo-arrow-text":W,"--ikr-photo-arrow-border":Y,"--ikr-fwizard-bg":H,"--ikr-fwizard-text":oe,"--ikr-fwizard-secondary-text":le,"--ikr-fwizard-input-bg":H,"--ikr-fwizard-input-text":D,"--ikr-fwizard-input-border":fe,"--ikr-fwizard-placeholder":Pe,"--ikr-fwizard-close-text":oe,"--ikr-fwizard-close-hover-bg":K,"--ikr-fwizard-progress-bg":K,"--ikr-fwizard-progress-active":de,"--ikr-fwizard-btn-bg":q,"--ikr-fwizard-btn-text":_,"--ikr-fwizard-btn-border":_e,"--ikr-fwizard-btn-disabled-bg":xe,"--ikr-fwizard-btn-disabled-text":se,"--ikr-fwizard-nav-hover-bg":X,"--ikr-load-more-bg":J,"--ikr-load-more-text":ze,"--ikr-load-more-border":j};Object.keys(I).forEach(function(Z){e.style.setProperty(Z,I[Z])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function we(e,r,i,t,n,l,c){if(Rr){qe({productId:e,settings:r,reviewsData:i,productName:t,orderBy:n,page:l,badgeSettings:c});return}We(!0),Cr(e),Sr(r),c!==void 0&&Er(c),Tr(t),n&&Re(n),l&&Te(l),i!=null&&Lr(i);try{let ir=function(A,R){if(!(!A||!A.meta||!A.meta.sizeOverrides)){var M=A.meta.sizeOverrides[R];M&&Object.keys(M).forEach(function(Ce){a.style.setProperty(Ce,M[Ce])})}};var bt=ir,o=er(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),p=r.showTitle!==!1,f=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",d=s&&p?f:"",a=document.documentElement;yt(a,r),Fr("#111111",Zr+ki()+hi());var k=r.borderRadius!==void 0?r.borderRadius:8,u=yi[r.size]||yi.medium,v=bi[r.thumbnailSize]||bi.medium,m=De(r.reviewLayout);if(m.meta&&m.meta.sizeOverrides&&m.meta.sizeOverrides[r.size]){var y=m.meta.sizeOverrides[r.size],x=y["--ikr-list-photo-w"]||y["--ikr-gallery-photo-w"];x&&(v=parseInt(x))}a.style.setProperty("--ikr-title-size",u.titleSize+"px"),a.style.setProperty("--ikr-review-text-size",u.reviewTextSize+"px"),a.style.setProperty("--ikr-review-title-size",u.reviewTitleSize+"px"),a.style.setProperty("--ikr-author-size",u.authorSize+"px"),a.style.setProperty("--ikr-reply-name-size",u.replyNameSize+"px"),a.style.setProperty("--ikr-reply-text-size",u.replyTextSize+"px"),a.style.setProperty("--ikr-radius",k+"px"),a.style.setProperty("--ikr-radius-sm",Math.max(0,k-4)+"px"),a.style.setProperty("--ikr-photo-title-size",u.photoTitleSize+"px"),a.style.setProperty("--ikr-avg-rating-size",u.avgRatingSize+"px"),a.style.setProperty("--ikr-review-count-size",u.reviewCountSize+"px"),a.style.setProperty("--ikr-compact-count-size",u.compactCountSize+"px"),a.style.setProperty("--ikr-recommend-size",u.recommendSize+"px"),a.style.setProperty("--ikr-btn-text-size",u.btnTextSize+"px"),a.style.setProperty("--ikr-bar-label-size",u.barLabelSize+"px"),a.style.setProperty("--ikr-minimal-avg-size",u.minimalAvgSize+"px"),a.style.setProperty("--ikr-hero-avg-size",u.heroAvgSize+"px"),a.style.setProperty("--ikr-bar-count-size",u.barCountSize+"px"),a.style.setProperty("--ikr-review-date-size",u.reviewDateSize+"px"),a.style.setProperty("--ikr-filter-text-size",u.filterTextSize+"px"),a.style.setProperty("--ikr-load-more-size",u.loadMoreSize+"px"),a.style.setProperty("--ikr-read-more-size",u.readMoreSize+"px"),a.style.setProperty("--ikr-thumbnail-size",v+"px");var b=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";a.style.setProperty("--ikr-review-star-color",b),a.style.setProperty("--ikr-star-empty-color",b),a.style.setProperty("--ikr-star-size",u.reviewStarSize+"px"),a.style.setProperty("--ikr-avg-star-size",u.avgStarSize+"px"),ir(er(r.summaryLayout),r.size),ir(De(r.reviewLayout),r.size);var g=Oe(r),S=document.getElementById("ikas-reviews");if(!S){var z=gt();if(!z)return;S=document.createElement("div"),S.id="ikas-reviews",S.style.minHeight="200px",z.appendChild(S)}if(r.enabled===!1){S.style.minHeight="auto",S.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',We(!1);var C=Ge;qe(null),C&&we(C.productId,C.settings,C.reviewsData,C.productName,C.orderBy,C.page,C.badgeSettings);return}S.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var w=i||{},E=sr(w),T=E?[]:w.data&&w.data.reviews||[],h=E?0:w.data&&w.data.totalCount||0;Pr(T);var N=S.cloneNode(!1);S.parentNode.replaceChild(N,S),S=N;var L=document.createElement("div");if(L.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(L.style.width="100%",L.style.maxWidth="100%",L.style.marginLeft="0",L.style.marginRight="0"),d){var B=document.createElement("div"),F=r.summaryLayout||"classic";B.className="ikr-title ikr-title-"+F,B.textContent=d,L.appendChild(B)}if(E){L.appendChild(ht(w.message,async function(){var A=await Le($,ce,1,Se,Ee);await we($,P,A,Ae,ce,1,tr)})),S.appendChild(L);return}var G=w.data&&w.data.allCount||0,ae=w.data&&w.data.ratingCounts||null,ne=ae||[0,0,0,0,0],W=w.data&&w.data.avgRating||"0.0";if(!ae&&T.length>0){T.forEach(function(A){A.rating>=1&&A.rating<=5&&ne[A.rating-1]++});var Y=T.reduce(function(A,R){return A+R.rating},0);W=(Y/T.length).toFixed(1)}if(G>0){var H=er(r.summaryLayout),oe=H.render({widget:L,data:w,settings:r,iconPair:g,allCount:G,ratingCounts:ne,avgRatingVal:W,currentRatingFilter:Se,currentOrderBy:ce,currentHasImages:Ee,onFilterChange:async function(A){Ve(Se===A?null:A),Te(1);var R=await Le($,ce,1,Se,Ee);await we($,P,R,Ae,ce,1)},onSortChange:async function(A,R){Te(1),R?(nr(!0),Re("newest")):(nr(!1),Re(A));var M=await Le($,ce,1,Se,Ee);await we($,P,M,Ae,ce,1)}});L.appendChild(oe)}else{var le=document.createElement("button");le.className="ikr-write-btn",le.style.cssText="display:block;margin:16px auto 0;",le.textContent=r.writeButtonText||"Yorum Yap",le.onclick=O,L.appendChild(le)}var D=(zr||[]).filter(function(A){return ye(A).length>0});if(r.showPhotoGallery!==!1&&!Ee&&D.length>0){var fe=document.createElement("div");if(fe.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var Pe=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",de=document.createElement("div");de.className="ikr-photo-title",de.textContent=Pe,fe.appendChild(de)}var q=r.reviewLayout==="card"?"1/1":"3/4";a.style.setProperty("--ikr-photo-thumb-aspect",q);var _=document.createElement("div");_.className="ikr-photo-strip";var _e=V,X=r.reviewLayout==="card"?V:Math.round(V*4/3),xe=0;D.forEach(function(A){if(!(xe>=15)){var R=Ke(A);if(R){var M=document.createElement("img"),Ce=Q(R,V);M.src=Ce.src,M.srcset=Ce.srcset,M.loading=xe<3?"eager":"lazy",M.decoding="async",M.width=_e,M.height=X,M.className="ikr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",ee(M),(function(wi,xi){M.onclick=function(){ie(xi,wi,D)}})(R,A),_.appendChild(M),xe++}}});var se=document.createElement("button");se.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",se.innerHTML="&#8249;",se.setAttribute("aria-label","\xD6nceki"),se.onclick=function(){_.scrollBy({left:-200,behavior:"smooth"})};var K=document.createElement("button");K.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",K.innerHTML="&#8250;",K.setAttribute("aria-label","Sonraki"),K.onclick=function(){_.scrollBy({left:200,behavior:"smooth"})};var J=document.createElement("div");J.className="ikr-photo-strip-wrap",J.appendChild(se),J.appendChild(_),J.appendChild(K),fe.appendChild(J),L.appendChild(fe)}if(T.length===0){var ze=document.createElement("p");ze.className="ikr-state-msg",ze.textContent="Hen\xFCz yorum yok.",L.appendChild(ze)}else{var m=De(r.reviewLayout);T.forEach(function(R){L.appendChild(m.render(R,ar))})}var j=w.data&&w.data.hasMore;if(j){var I=document.createElement("button");I.className="ikr-load-more",I.textContent="Daha Fazla G\xF6ster",I.onclick=async function(){I.disabled=!0,I.textContent="Y\xFCkleniyor...";var A=xr+1,R=await Le($,ce,A,Se,Ee);if(R&&!sr(R)&&R.data&&Array.isArray(R.data.reviews)){Ar(R.data.reviews),Te(A);var M=De(P.reviewLayout);R.data.reviews.forEach(function(Ce){L.insertBefore(M.render(Ce,ar),I)}),R.data.hasMore?(I.disabled=!1,I.textContent="Daha Fazla G\xF6ster"):I.remove()}else I.disabled=!1,I.textContent="Tekrar Dene"},L.appendChild(I)}S.appendChild(L),Jr(G>0?W:null,h,t,tr,g)}catch(A){console.error("[ikr] render error:",A),S.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(We(!1),Ge){var Z=Ge;qe(null),we(Z.productId,Z.settings,Z.reviewsData,Z.productName,Z.orderBy,Z.page,Z.badgeSettings)}}}export{we as a,Je as b,sr as c,Le as d,Si as e,Tt as f};
