...
`}var ll=Ra(ri),ti=Ra(gr);function ai(e,r){var d;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let a=t.get("media-theme-gerwig"),n=a==null?void 0:a.template;if(!a||!(n instanceof HTMLTemplateElement))return;let i=n.cloneNode(!0);i.id=e,(d=i.content.querySelector("media-controller"))==null||d.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class l extends a{}l.template=i,t.define(e,l)}function ni(e,r){return typeof window=="undefined"?Promise.resolve():($r!=null||($r=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),$r.then(()=>{ai(e,r)}))}function Na(){return ni(ei,ti)}var yt=null,Fa="--center-play-button";function ii(){return yt||(yt=Na()),yt}function oi(e){return new Promise(function(r){function t(a){if(a<=0){r();return}requestAnimationFrame(function(){t(a-1)})}t(e)})}function li(e){e.style.setProperty(Fa,"none")}function Ba(e){e.style.removeProperty(Fa)}function di(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=ha(e.url);return r&&t&&r!==t?"":r||t}function pi(e,r){var t=di(r);if(!t)return!1;var a=Xe(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("nohotkeys",""),e.setAttribute("lang","tr"),e.setAttribute("theme",La),e.setAttribute("accent-color",gr.controlForeground),e.setAttribute("primary-color",gr.controlForeground),e.setAttribute("secondary-color",gr.controlBackground),a&&e.setAttribute("poster",a),e.setAttribute("playback-id",t),!0}function Ia(e){e.preventDefault()}function Oa(e,r){var t=!1,a=document.createElement("mux-player");a.className=r||"renuvex-pr-modal-main-video",a.setAttribute("aria-label","Yorum videosu"),li(a),a.addEventListener("contextmenu",Ia);var n=pi(a,e);return n?ii().then(function(){if(window.customElements&&typeof window.customElements.whenDefined=="function")return window.customElements.whenDefined("mux-player")}).then(function(){if(!t){try{typeof a.pause=="function"&&a.pause()}catch(i){}return oi(2)}}).then(function(){t||Ba(a)}).catch(function(){t||a.dispatchEvent(new Event("error"))}):setTimeout(function(){t||a.dispatchEvent(new Event("error"))},0),{element:a,cleanup:function(){t=!0;try{typeof a.pause=="function"&&a.pause()}catch(o){}a.removeAttribute("playback-id"),a.removeAttribute("playback-token"),a.removeAttribute("thumbnail-token"),a.removeAttribute("poster"),Ba(a),a.removeEventListener("contextmenu",Ia)}}}function er(e){return Ne(e)}function Ha(e){return e&&e.source==="mediaGallery"}function ui(e,r){if(!Ha(r))return er(e);var t=xe(e);return t?[t]:[]}function si(e,r){return(e||[]).filter(function(t){return r==="mediaGallery"?!!xe(t):er(t).length>0})}function kt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Ua(e,r,t,a,n,i){e&&e.shadowRoot&&kt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),jr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Ir(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(n)}function vi(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ze(e.rating,I);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Se(e.createdAt),a.appendChild(n),a.appendChild(i),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=V(I&&I.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",u.appendChild(m),u.appendChild(v),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Va(e,r,t){var a=t||I,n=e.querySelector(".renuvex-pr-modal-scroll-content"),i=n.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ze(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=Se(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=n.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=V(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}var ci=112;function zt(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function mi(e){var r=e&&e.target;return!!(r&&typeof r.closest=="function"&&r.closest(".renuvex-pr-modal-thumbs"))}function fi(e,r,t){if(!r||r.type!=="video"||!t)return!1;var a=zt(e);if(!a)return!1;var n=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!n||typeof n.getBoundingClientRect!="function")return!1;var i=n.getBoundingClientRect();if(!i.width||!i.height||a.clientX<i.left||a.clientX>i.right||a.clientY<i.top||a.clientY>i.bottom)return!1;var o=Math.min(ci,Math.max(72,i.height*.2));return a.clientY>=i.bottom-o}function xi(e){var r=e&&e.type==="video"?e.posterUrl:e&&e.url;if(e&&e.type==="video"){var t={width:Ce,height:Ce,fit:"crop"};return{src:Xe(r,t),srcset:Hr(r,t)}}return mr(r,Ce)}function gi(e,r,t){var a=e&&e.media;if(!a)return null;var n=document.createElement("button");n.type="button",n.className="renuvex-pr-modal-thumb renuvex-pr-modal-thumb-button"+(a.type==="video"?" renuvex-pr-modal-thumb-video":"")+(r?" renuvex-pr-modal-thumb-active":""),n.setAttribute("aria-label","Galeri medyas\u0131 "+(e.index+1)+" se\xE7"),r&&n.setAttribute("aria-current","true");var i=document.createElement("img");i.className="renuvex-pr-modal-thumb-img";var o=xi(a);if(i.src=o.src,o.srcset&&(i.srcset=o.srcset),i.loading="lazy",i.decoding="async",i.width=Ce,i.height=Ce,i.alt="",fr(i),n.appendChild(i),a.type==="video"){var l=document.createElement("span");l.className="renuvex-pr-modal-thumb-play";var d=re(Ke);d&&l.appendChild(d),n.appendChild(l)}return n.onclick=t,n}function hi(e){var r=[];return(e||[]).forEach(function(t,a){var n=xe(t);n&&r.push({review:t,reviewIdx:a,media:n,index:r.length})}),r}function St(e,r,t,a,n,i,o,l,d){var u=ui(e,d),m=Math.max(0,Math.min(t||0,u.length-1)),v=u[m],p=document.createElement("div");p.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Oa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),c=x.element;c.addEventListener("error",function(){if(!p.querySelector(".renuvex-pr-modal-img-error")){var L=document.createElement("div");L.className="renuvex-pr-modal-img-error",L.setAttribute("role","status"),L.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",p.insertBefore(L,c)}});var f=!1,h=function(){p.classList.add("renuvex-pr-modal-left-video-playing")},b=function(){f=!0,h()},E=function(){f&&h()},P=function(){f=!1,p.classList.remove("renuvex-pr-modal-left-video-playing")};c.addEventListener("play",b),c.addEventListener("playing",b),c.addEventListener("pause",E),c.addEventListener("ended",P),p.__renuvexMediaCleanup=function(){c.removeEventListener("play",b),c.removeEventListener("playing",b),c.removeEventListener("pause",E),c.removeEventListener("ended",P),P(),x.cleanup()},p.appendChild(c)}else{var w=document.createElement("img");if(w.className="renuvex-pr-modal-main-img"+(s?" "+s:""),w.src=xt(v?v.url:""),w.decoding="async",w.width=ft,w.height=Math.round(ft*4/3),w.alt="Yorum foto\u011Fraf\u0131",!s){w.classList.add("renuvex-pr-modal-img-loading");var C=function(){w.classList.remove("renuvex-pr-modal-img-loading")};w.complete&&w.naturalWidth>0?C():(w.addEventListener("load",C,{once:!0}),w.addEventListener("error",C,{once:!0}))}ma(w,function(L){if(L.style.display="none",!p.querySelector(".renuvex-pr-modal-img-error")){var N=document.createElement("div");N.className="renuvex-pr-modal-img-error",N.setAttribute("role","status"),N.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",p.insertBefore(N,L)}}),p.appendChild(w)}var g=document.createElement("button");g.className="renuvex-pr-modal-close-mobile";var z=re(ke);z&&g.appendChild(z),g.setAttribute("aria-label","Kapat"),g.onclick=function(L){L.stopPropagation(),i()},p.appendChild(g);var M=0,k=!1,S=!1;if(p.addEventListener("touchstart",function(L){var N=zt(L);N&&(S=mi(L),M=N.clientX,k=!S&&fi(L,v,p))},{passive:!0}),p.addEventListener("touchend",function(L){if(S){S=!1,k=!1;return}if(k){k=!1;return}var N=zt(L);if(N){var G=M-N.clientX;if(!(Math.abs(G)<50)){if(G>0){if(A)he(e,r,m+1,a,n,i,!0,"next",l,d);else if(F){var B=a[r+1];he(B,r+1,0,a,n,i,!1,"next",l,d)}}else if(y)he(e,r,m-1,a,n,i,!0,"prev",l,d);else if(R){var D=a[r-1],$=er(D);he(D,r-1,$.length-1,a,n,i,!1,"prev",l,d)}}}},{passive:!0}),Ha(d)){var T=hi(a);if(T.length>1){var _=document.createElement("div");_.className="renuvex-pr-modal-thumbs renuvex-pr-modal-thumbs--gallery",T.forEach(function(L){var N=gi(L,L.reviewIdx===r,function(){he(L.review,L.reviewIdx,0,a,n,i,!1,null,l,d)});N&&_.appendChild(N)}),p.appendChild(_)}}else if(u.length>1){var O=document.createElement("div");O.className="renuvex-pr-modal-thumbs",u.forEach(function(L,N){var G=L.type==="video"?L.posterUrl:L.url,B=document.createElement("img"),D=mr(G,Ce);B.src=D.src,B.srcset=D.srcset,B.loading="lazy",B.decoding="async",B.width=Ce,B.height=Ce,B.className="renuvex-pr-modal-thumb"+(N===m?" renuvex-pr-modal-thumb-active":""),B.alt="K\xFC\xE7\xFCk resim "+(N+1),fr(B),B.tabIndex=0,B.setAttribute("role","button"),B.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(N+1)+" se\xE7"),N===m&&B.setAttribute("aria-current","true"),(function($){function Y(){he(e,r,$,a,n,i,!0,null,l,d)}B.onclick=Y,B.onkeydown=function(q){(q.key==="Enter"||q.key===" ")&&(q.preventDefault(),Y())}})(N),O.appendChild(B)}),p.appendChild(O)}var y=m>0,A=m<u.length-1,R=r>0,F=r<a.length-1,U=y||R,Z=A||F;if(U){var X=document.createElement("button");X.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var j=re(qe);j&&X.appendChild(j),X.setAttribute("aria-label","\xD6nceki"),X.onclick=function(L){if(L.stopPropagation(),y)he(e,r,m-1,a,n,i,!0,"prev",l,d);else if(R){var N=a[r-1],G=er(N);he(N,r-1,G.length-1,a,n,i,!1,"prev",l,d)}},p.appendChild(X)}if(Z){var H=document.createElement("button");H.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var W=re(Fr);W&&H.appendChild(W),H.setAttribute("aria-label","Sonraki"),H.onclick=function(L){if(L.stopPropagation(),A)he(e,r,m+1,a,n,i,!0,"next",l,d);else if(F){var N=a[r+1];he(N,r+1,0,a,n,i,!1,"next",l,d)}},p.appendChild(H)}return p}function Da(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=er(a);n[0]&&n[0].type==="image"&&(new Image().src=xt(n[0].url))}})}function wt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function bi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){wt(t),wt(a),wt(n)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function he(e,r,t,a,n,i,o,l,d,u){if(u&&(u.currentReview=e),o){var m=St(e,r,t,a,n,i,l,d,u);n.firstChild&&(kt(n.firstChild),n.replaceChild(m,n.firstChild))}else{var m=St(e,r,t,a,n,i,l,d,u),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&(kt(n.firstChild),n.replaceChild(m,n.firstChild)),v&&Va(v,e,u&&u.currentSettings),bi(d,n)}Da(r,a)}function fe(e,r,t,a){var n=a&&a.source==="mediaGallery"?"mediaGallery":"review",i=n==="mediaGallery"?xe(e)?[xe(e)]:[]:er(e);if(!i.length)return;var o=si(t,n),l=o.findIndex(function(k){return k===e||k.id===e.id});l===-1&&(o.unshift(e),l=0);var d=i.findIndex(function(k){return k.url===r});d<0&&(d=0);var u=document.createElement("div");u.className="renuvex-pr-modal-overlay";var m=document.createElement("div");m.className="renuvex-pr-modal";var v=!1,p=null,s=Wr(),x=Pe(),c=Yr(),f=qr(),h={currentReview:e,currentSettings:I,source:n},b=null;function E(k){var S=k&&k.detail&&k.detail.settings;if(!(S&&S===b)){b=S||null,h.currentSettings=S||I;var T=m.querySelector(".renuvex-pr-modal-right");!T||!h.currentReview||Va(T,h.currentReview,h.currentSettings)}}function P(){v||(v=!0,window.removeEventListener(He,E),Ua(p&&p.host,w,P,c,s,x))}function w(k){if(k.key==="Escape"){C();return}Gr(k,u,p&&p.root)}function C(){v||(v=!0,window.removeEventListener(He,E),Ua(p&&p.host,w,P,c,s,x),Kr(f))}document.addEventListener("keydown",w),window.addEventListener("popstate",P),window.addEventListener(He,E),u.onclick=function(){C()},m.onclick=function(k){k.stopPropagation()},m.appendChild(St(e,l,d,o,m,C,null,u,h)),m.appendChild(vi(e)),Da(l,o);var g=document.createElement("div");g.className="renuvex-pr-modal-wrap",g.tabIndex=-1,g.setAttribute("role","dialog"),g.setAttribute("aria-modal","true"),g.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),g.appendChild(m);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var M=re(ke);M&&z.appendChild(M),z.setAttribute("aria-label","Kapat"),z.onclick=function(k){k.stopPropagation(),C()},g.appendChild(z),u.appendChild(g),p=Vr(),Je(p.root,$e+Ge+Dr),p.root.appendChild(u),Ue(p.root),ve(g)}function rr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Lt={};Me(Lt,{css:()=>no,meta:()=>ao,render:()=>io});function tr(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,i=e.onFilterChange;Le(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var d=r[l-1]||0,u=t>0?Math.round(d/t*100):0,m=n===l,v=d>0,p=V(I&&I.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(n&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" "+p+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+p);for(var x="",c=1;c<=5;c++){var f=c<=l;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(f?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(E){(E.key==="Enter"||E.key===" "||E.key==="Space"||E.key==="Spacebar")&&(E.preventDefault(),b())}})(l),o.appendChild(s)}return o}var Wa="data-renuvex-pr-dismiss-gesture",De=[],Ya=!1,Jr=!1,hr=[],ar=null;function ja(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Ct(){for(var e=De.length-1;e>=0;e--){var r=De[e].element;r&&r.isConnected===!1&&De.splice(e,1)}return De}function yi(e){!e||typeof e.setAttribute!="function"||(hr.indexOf(e)===-1&&hr.push(e),e.setAttribute(Wa,""))}function Ga(){for(var e=0;e<hr.length;e++){var r=hr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Wa)}hr=[],ar&&typeof clearTimeout=="function"&&clearTimeout(ar),ar=null}function wi(e){if(Jr){Jr=!1,Ga(),e.preventDefault(),e.stopPropagation();return}for(var r=Ct(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];ja(e,n.trigger)||ja(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function ki(e){if(e.key==="Escape")for(var r=Ct(),t=r.length-1;t>=0;t--)r[t].close()}function qa(){Ya||typeof document=="undefined"||(document.addEventListener("click",wi,!0),document.addEventListener("keydown",ki),Ya=!0)}function zi(e){qa(),Jr=!0,yi(e),ar&&typeof clearTimeout=="function"&&clearTimeout(ar),typeof setTimeout=="function"&&(ar=setTimeout(function(){Jr=!1,Ga()},700))}function Et(e){zi(e)}function Zr(e){qa();var r={trigger:e.trigger,element:e.element,close:e.close};return De.push(r),{unregister:function(){var t=De.indexOf(r);t!==-1&&De.splice(t,1)},notifyOpening:function(){for(var t=Ct(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function de(e){var r=e.widget,t=e.currentOrderBy,a=e.currentMediaFilter||"none",n=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=V(I&&I.writeButtonText,"Yorum Yap"),l.onclick=n,o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var m=I&&I.filterIcon||"lines";u.innerHTML=se(da(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var p=$t===!0?"media":"images",s=p==="media"?"Foto\u011Fraf ve Video":"Foto\u011Frafl\u0131",x=[{orderBy:"newest",label:"En Yeni",mediaFilter:"none"},{orderBy:"highest",label:"En Y\xFCksek Puan",mediaFilter:"none"},{orderBy:"lowest",label:"En D\xFC\u015F\xFCk Puan",mediaFilter:"none"},{orderBy:"newest",label:s,mediaFilter:p}],c=!1;function f(){return r&&r.parentNode||r||null}function h(w,C){if(!(C===!0||!w)){if(w.type==="touchstart"){Et(f());return}if(w.type==="pointerdown"){var g=w.pointerType||"";g&&g!=="mouse"&&Et(f())}}}function b(w){var C=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var g=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(C&&g)try{u.focus({preventScroll:!0})}catch(z){try{u.focus()}catch(M){}}return C}function E(){P.notifyOpening(),v.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var w=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(C){try{w.focus()}catch(g){}}})}x.forEach(function(w){var C=w.mediaFilter!=="none",g=C?a===w.mediaFilter:a==="none"&&(t||"newest")===w.orderBy,z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(g?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=w.label;var M=!1;function k(S,T){S&&(S.preventDefault(),S.stopPropagation()),!M&&(M=!0,c=!0,h(S,T),b({restoreFocus:T}),i(w.orderBy,w.mediaFilter),setTimeout(function(){M=!1,c=!1},0))}z.addEventListener("pointerdown",function(S){S.button!==void 0&&S.button!==0||S.pointerType!=="mouse"&&k(S,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(S){k(S,!1)},{passive:!1}),z.addEventListener("keydown",function(S){(S.key==="Enter"||S.key===" ")&&k(S,!0)}),z.onclick=function(S){k(S,!1)},v.appendChild(z)}),u.onclick=function(){v.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):E()},d.addEventListener("keydown",function(w){w.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(w){if(v.classList.contains("renuvex-pr-open")&&!c){var C=w.relatedTarget;C&&d.contains(C)||b()}});var P=Zr({trigger:d,element:v,close:b});return d.appendChild(u),d.appendChild(v),o.appendChild(d),o}var Ka=`
...
`;var oo={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},lo=zn,po="__unknown_product__",kr=Object.create(null);function uo(e){return e?String(e):po}var Ye=null,zr=null;function so(){!Ye||!zr||(Ye.removeEventListener?Ye.removeEventListener("change",zr):Ye.removeListener&&Ye.removeListener(zr),Ye=null,zr=null)}function vo(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,d=e.currentRatingFilter,u=e.currentOrderBy,m=e.currentMediaFilter,v=e.onFilterChange,p=e.onSortChange,s=uo(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Re(l,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(pa)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),E=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+V(a.countLabel,"Yorum")),b&&E){var P=document.createElement("span");P.className="renuvex-pr-compact-trigger-count",h.insertBefore(P,b),P.appendChild(b),P.appendChild(E)}f.appendChild(h),c.appendChild(f);var w=de({widget:r,currentOrderBy:u,currentMediaFilter:m,onWriteClick:ae,onSortChange:p}),C=w.querySelector(".renuvex-pr-filter-wrap"),g=w.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");z.className="renuvex-pr-compact-actions-slot",g&&z.appendChild(g),C&&z.appendChild(C),c.appendChild(z),x.appendChild(c);var M=document.createElement("div");M.className="renuvex-pr-compact-panel",M.setAttribute("role","dialog"),M.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),M.setAttribute("aria-hidden","true");var k=document.createElement("div");k.className="renuvex-pr-compact-panel-inner";var S=document.createElement("div");S.className="renuvex-pr-compact-avg",S.innerHTML='<span class="renuvex-pr-icon">'+ue("full")+"</span><span>"+l+"</span>",k.appendChild(S),k.appendChild(tr({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:d,onFilterChange:function(B){_()&&M.classList.contains("renuvex-pr-open")&&(kr[s]=!0),v(B)}})),M.appendChild(k);var T=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function _(){return!!(T&&T.matches)}function O(B){B?M.classList.add("renuvex-pr-open"):M.classList.remove("renuvex-pr-open"),M.setAttribute("aria-hidden",B?"false":"true"),h.setAttribute("aria-expanded",B?"true":"false")}function y(B){var D=B?x:f;if(M.parentNode!==D){var $=!!M.parentNode;M.classList.contains("renuvex-pr-open")&&O(!1),$&&(kr[s]=!1),D.appendChild(M)}}y(T?T.matches:!1);var A=de({widget:r,currentOrderBy:u,currentMediaFilter:m,onWriteClick:ae,onSortChange:p}),R=A.querySelector(".renuvex-pr-filter-wrap"),F=A.querySelector(".renuvex-pr-write-btn"),U=document.createElement("div");U.className="renuvex-pr-compact-write-row",F&&U.appendChild(F),R&&U.appendChild(R),x.appendChild(U);function Z(){var B=M.classList.contains("renuvex-pr-open");return O(!1),_()&&(kr[s]=!1),B}function X(){j&&j.notifyOpening(),O(!0),_()&&(kr[s]=!0)}h.onclick=function(){M.classList.contains("renuvex-pr-open")?Z():X()};var j=null;function H(B){j&&(j.unregister(),j=null),B||(j=Zr({trigger:f,element:M,close:Z}))}if(H(T?T.matches:!1),so(),T){var W=function(B){y(B.matches),H(B.matches)};T.addEventListener?T.addEventListener("change",W):T.addListener&&T.addListener(W),Ye=T,zr=W}if(_()&&kr[s]&&O(!0),a.showRecommendation!==!1){var L=(o[3]||0)+(o[4]||0),N=i>0?Math.round(L/i*100):0;if(N>0){var G=document.createElement("div");G.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",G.style.marginTop="8px",G.innerHTML='<span class="renuvex-pr-recommend-pct">%'+N+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(G)}}return x}var Nt={};Me(Nt,{css:()=>mo,meta:()=>co,render:()=>fo});var Sn=`
...
`;var it={classic:Lt,compact:Rt,split:Nt,minimal:Bt,hero:It};function ot(e){return it[e]||it.classic}function An(){var e=Object.keys(it).map(function(r){return it[r].css||""}).join(`
`);return Tn+`
`+e}var Ft={};Me(Ft,{css:()=>zo,meta:()=>ko,render:()=>So});function Be(e,r){r=r||{};var t=e&&e.type==="video"?{width:r.width||r.sourceWidth||0,height:r.height||r.width||r.sourceWidth||0,fit:"crop"}:null,a=t?Xe(e.posterUrl,t):ba(e);if(!a)return null;var n=document.createElement("img"),i=e.type==="image"?mr(a,r.sourceWidth):{src:a,srcset:Hr(e.posterUrl,t)};if(n.src=i.src,i.srcset&&(n.srcset=i.srcset),n.loading=r.loading||"lazy",n.decoding="async",e.type==="image"&&n.setAttribute("data-renuvex-img-url",e.url),r.width&&(n.width=r.width),r.height&&(n.height=r.height),n.alt="",fr(n),e.type!=="video")return n.className=r.className||"",rr(n,r.onOpen,r.imageLabel||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),n;var o=document.createElement("button");o.type="button",o.className=(r.className||"")+" renuvex-pr-media-video-thumb",n.className="renuvex-pr-media-poster",o.appendChild(n);var l=document.createElement("span");l.className="renuvex-pr-media-play";var d=re(Ke);return d&&l.appendChild(d),o.appendChild(l),rr(o,r.onOpen,r.videoLabel||"Yorum videosunu oynat"),o}function dr(e,r,t){var a=t||{},n=document.createDocumentFragment(),i=document.createElement("div");i.className=r+" renuvex-pr-body-clamped",i.textContent=e,n.appendChild(i);var o=document.createElement("button");return o.type="button",o.className="renuvex-pr-read-more",o.textContent="Devam\u0131n\u0131 oku",o.style.display="none",n.appendChild(o),requestAnimationFrame(function(){if(i.scrollHeight>i.clientHeight+2)if(o.style.display="inline-block",typeof a.onReadMore=="function")o.onclick=a.onReadMore;else{var l=!1;o.onclick=function(){l=!l,i.classList.toggle("renuvex-pr-body-clamped",!l),o.textContent=l?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),{fragment:n,body:i,readMore:o}}function pr(e,r){if(!e)return null;var t=document.createElement("div");t.className="renuvex-pr-reply";var a=document.createElement("div");a.className="renuvex-pr-reply-header";var n=document.createElement("span");n.className="renuvex-pr-reply-label",n.textContent=V(I&&I.merchantReplyLabel,"Ma\u011Faza Sahibi"),a.appendChild(n),t.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-reply-text renuvex-pr-reply-text-clamped",i.textContent=e,t.appendChild(i);var o=document.createElement("button");return o.type="button",o.className="renuvex-pr-read-more renuvex-pr-reply-read-more",o.textContent="Devam\u0131n\u0131 oku",o.style.display="none",t.appendChild(o),requestAnimationFrame(function(){if(i.scrollHeight>i.clientHeight+2)if(o.style.display="inline",typeof r=="function")o.onclick=r;else{var l=!1;o.onclick=function(){l=!l,i.classList.toggle("renuvex-pr-reply-text-clamped",!l),o.textContent=l?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),t}var Mn=`
...
`;var Ao={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Mo=_n;function Po(e,r){var t=xe(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=ze(e.rating,I),i.appendChild(o),e.title){var l=document.createElement("div");l.className="renuvex-pr-review-gallery-title",l.textContent=e.title,i.appendChild(l)}var d=document.createElement("div");d.className="renuvex-pr-review-gallery-author",d.textContent=e.author||"",i.appendChild(d);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=Se(e.createdAt),i.appendChild(u);var m=(e.comment||"").trim();if(m&&i.appendChild(dr(m,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){fe(e,t.url,r)}}:null).fragment),n.appendChild(i),a){var v=document.createElement("div");v.className="renuvex-pr-review-gallery-media";var p=Be(t,{sourceWidth:Ur,width:Ur,height:Math.round(Ur*4/3),onOpen:function(){fe(e,t.url,r)}});p&&v.appendChild(p),n.appendChild(v)}var s=pr(e.merchantReply,t?function(){fe(e,t.url,r)}:null);return s&&(s.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(s)),n}var lt={card:Ft,list:Ot,gallery:Ut};function dt(e){return lt[e]||lt.card}function Ln(){return Object.keys(lt).map(function(e){return lt[e].css||""}).join(`
`)}var Ht=0;function je(){return Ht++,Ht}function We(e,r){return e!==Ht?!1:r?!(r.productId!==void 0&&ee!==r.productId||r.orderBy!==void 0&&te!==r.orderBy||r.page!==void 0&&vr!==r.page||r.ratingFilter!==void 0&&oe!==r.ratingFilter||r.mediaFilter!==void 0&&ne!==r.mediaFilter||r.nextCursor!==void 0&&_r!==r.nextCursor):!0}var Vt={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,mediaGalleryTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,mediaGalleryTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,mediaGalleryTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Dt={small:80,medium:110,large:140},Yt={small:80,medium:100,large:110};function Rn(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),a.appendChild(n),a.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var l=document.createElement("div");return l.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",l.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(o),r.appendChild(l),r}function Nn(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var a=document.createElement("div");a.className="renuvex-pr-empty-state-stars",a.innerHTML=Re(0,e.iconPair),t.appendChild(a);var n=document.createElement("p");n.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",n.setAttribute("role","status"),n.setAttribute("aria-live","polite"),n.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(n),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function Bn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function In(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function Te(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+a+","+n+","+i+","+r+")"}function pt(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function jt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function Fn(e){return .2126*jt(e.r)+.7152*jt(e.g)+.0722*jt(e.b)}function On(e,r){var t=Fn(e),a=Fn(r),n=Math.max(t,a),i=Math.min(t,a);return(n+.05)/(i+.05)}function _o(e){var r=pt(e)||pt("#ffffff"),t=pt("#111111"),a=pt("#ffffff");return On(t,r)>=On(a,r)?"#111111":"#ffffff"}function Lo(e){return Te(e,e==="#ffffff"?.1:.06)}function Un(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",l=r.barTrackColor||"#e5e7eb",d=r.barCountColor||"#111111",u=Te(o,.06),m=r.reviewStarColor||"#f59e0b",v=r.btnBgColor||"#111111",p=r.btnTextColor||"#ffffff",s=r.btnBorderColor||"#111111",x=r.filterBtnBgColor||"#111111",c=r.filterBtnTextColor||"#ffffff",f=r.filterBtnBorderColor||"#111111",h=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",E=r.filterItemTextColor||"#111111",P=r.filterItemHoverBgColor||"#f3f4f6",w=r.filterItemActiveColor||"#111111",C=r.reviewTitleColor||"#111111",g=r.reviewAuthorColor||"#111111",z=r.reviewDateColor||"#5e5e5e",M=r.reviewBodyColor||"#111111",k=r.reviewBorderColor||"#e5e7eb",S=Te(M,.65),T=r.replyBgColor||"#f9fafb",_=r.replyBorderColor||"#747474",O=r.replyLabelColor||"#111111",y=r.replyTextColor||"#111111",A=r.mediaGalleryTitleColor||"#111111",R=Te("#111111",.05),F=r.mediaGalleryArrowBgColor||"#ffffff",U=r.mediaGalleryArrowTextColor||"#111111",Z=Te("#111111",.12),X=r.reviewLightboxVideoIconColor||"#ffffff",j=r.reviewLightboxVideoProgressColor||"#ffffff",H=r.reviewLightboxVideoProgressTrackColor||"#000000",W=r.formBgColor||"#ffffff",L=r.formPrimaryTextColor||"#111111",N=r.formSecondaryTextColor||"#3b3b3b",G=r.inputTextColor||L,B=r.inputBorderColor||"#d1d5db",D=r.placeholderColor||"#9ca3af",$=r.formStepBarColor||"#111111",Y=r.formBtnBgColor||"#111111",q=r.formBtnTextColor||"#ffffff",J=r.formBtnBorderColor||"#111111",me=Te(Y,.06),Sr=Te(Y,.18),ur=Te(q,.85),Ae=Te(L,.06),K=_o(W),Q=Lo(K),ie=r.loadMoreBgColor||"#ffffff",Ie=r.loadMoreTextColor||"#111111",Cr=r.loadMoreBorderColor||"#111111",Er=r.paginationBgColor||"#ffffff",Tr=r.paginationTextColor||"#111111",Ar=r.paginationBorderColor||"#e5e7eb",Mr=r.paginationActiveBgColor||"#111111",ye=r.paginationActiveTextColor||"#ffffff",sr={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":l,"--renuvex-pr-bar-count":d,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":v,"--renuvex-pr-btn-text":p,"--renuvex-pr-btn-border":s,"--renuvex-pr-filter-btn-bg":x,"--renuvex-pr-filter-btn-text":c,"--renuvex-pr-filter-btn-border":f,"--renuvex-pr-filter-menu-bg":h,"--renuvex-pr-filter-menu-border":b,"--renuvex-pr-filter-item-text":E,"--renuvex-pr-filter-item-hover-bg":P,"--renuvex-pr-filter-item-active":w,"--renuvex-pr-review-title":C,"--renuvex-pr-review-author":g,"--renuvex-pr-review-date":z,"--renuvex-pr-review-body":M,"--renuvex-pr-review-border":k,"--renuvex-pr-state-text":S,"--renuvex-pr-review-star-color":m,"--renuvex-pr-reply-bg-color":T,"--renuvex-pr-reply-border":_,"--renuvex-pr-reply-label":O,"--renuvex-pr-reply-text":y,"--renuvex-pr-media-gallery-title":A,"--renuvex-pr-media-gallery-image-border":R,"--renuvex-pr-media-gallery-arrow-bg":F,"--renuvex-pr-media-gallery-arrow-text":U,"--renuvex-pr-media-gallery-arrow-border":Z,"--renuvex-pr-review-lightbox-video-icon":X,"--renuvex-pr-review-lightbox-video-progress":j,"--renuvex-pr-review-lightbox-video-progress-track":H,"--renuvex-pr-fwizard-bg":W,"--renuvex-pr-fwizard-text":L,"--renuvex-pr-fwizard-secondary-text":N,"--renuvex-pr-fwizard-input-bg":W,"--renuvex-pr-fwizard-input-text":G,"--renuvex-pr-fwizard-input-border":B,"--renuvex-pr-fwizard-placeholder":D,"--renuvex-pr-fwizard-close-text":K,"--renuvex-pr-fwizard-close-hover-bg":Q,"--renuvex-pr-fwizard-progress-bg":Ae,"--renuvex-pr-fwizard-progress-active":$,"--renuvex-pr-fwizard-btn-bg":Y,"--renuvex-pr-fwizard-btn-text":q,"--renuvex-pr-fwizard-btn-border":J,"--renuvex-pr-fwizard-btn-disabled-bg":Sr,"--renuvex-pr-fwizard-btn-disabled-text":ur,"--renuvex-pr-fwizard-nav-hover-bg":me,"--renuvex-pr-load-more-bg":ie,"--renuvex-pr-load-more-text":Ie,"--renuvex-pr-load-more-border":Cr,"--renuvex-pr-pagination-bg":Er,"--renuvex-pr-pagination-text":Tr,"--renuvex-pr-pagination-border":Ar,"--renuvex-pr-pagination-active-bg":Mr,"--renuvex-pr-pagination-active-text":ye};Object.keys(sr).forEach(function(Pr){e.style.setProperty(Pr,sr[Pr])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Wt(e){var r=e.settings,t=e.root,a=e.currentMediaFilter||"none",n=e.openReviewModal,i=(e.mediaStripReviews||[]).filter(function(E){return Ne(E).length>0});if(!(r.showMediaGallery!==!1&&a==="none"&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-media-gallery-section",r.showMediaGalleryTitle!==!1){var l=V(r.mediaGalleryTitle,"M\xFC\u015Fteri G\xF6rselleri"),d=document.createElement("div");d.className="renuvex-pr-media-gallery-title",d.textContent=l,o.appendChild(d)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-media-gallery-thumb-aspect",u);var m=document.createElement("div");m.className="renuvex-pr-media-gallery-strip";var v=le,p=r.reviewLayout==="card"?le:Math.round(le*4/3),s=0;i.forEach(function(E){if(!(s>=15)){var P=xe(E);if(P){var w=Be(P,{className:"renuvex-pr-media-gallery-thumb",sourceWidth:le,width:v,height:p,loading:s<3?"eager":"lazy",onOpen:function(){n(E,P.url,i,{source:"mediaGallery"})}});w&&(m.appendChild(w),s++)}}});var x=document.createElement("button");x.className="renuvex-pr-media-gallery-arrow renuvex-pr-media-gallery-arrow-prev";var c=re(qe);c&&x.appendChild(c),x.setAttribute("aria-label","\xD6nceki"),x.onclick=function(){m.scrollBy({left:-200,behavior:"smooth"})};var f=document.createElement("button");f.className="renuvex-pr-media-gallery-arrow renuvex-pr-media-gallery-arrow-next";var h=re(Fr);h&&f.appendChild(h),f.setAttribute("aria-label","Sonraki"),f.onclick=function(){m.scrollBy({left:200,behavior:"smooth"})};var b=document.createElement("div");return b.className="renuvex-pr-media-gallery-strip-wrap",b.appendChild(x),b.appendChild(m),b.appendChild(f),o.appendChild(b),o}var Ro=1,No=7,Gt="\u2026";function Bo(e,r){var t=Math.max(1,Math.floor(Number(r))||1),a=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=No){for(var n=[],i=1;i<=t;i++)n.push(i);return n}for(var o=[],l=1;l<=t;l++)(l===1||l===t||Math.abs(l-a)<=Ro)&&o.push(l);for(var d=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&d.push(Gt),d.push(o[u]);return d}function Hn(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),a=typeof e.onPageChange=="function"?e.onPageChange:function(){},n=document.createElement("nav");n.className="renuvex-pr-pagination",n.setAttribute("aria-label","Yorum sayfalar\u0131");function i(d){n.setAttribute("aria-busy","true");for(var u=n.querySelectorAll("button"),m=0;m<u.length;m++)u[m].disabled=!0;a(d)}function o(d,u){var m=document.createElement("span");m.className="renuvex-pr-pagination-label",m.setAttribute("aria-hidden","true"),m.textContent=u,d.appendChild(m)}function l(d,u,m,v){var p=document.createElement("button");return p.type="button",p.className="renuvex-pr-pagination-arrow",p.setAttribute("aria-label",d),o(p,u),v?p.disabled=!0:p.onclick=function(){i(m)},p}return n.appendChild(l("\xD6nceki sayfa","\u2039",t-1,t<=1)),Bo(t,r).forEach(function(d){if(d===Gt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=Gt,n.appendChild(u);return}var m=document.createElement("button");m.type="button",m.className="renuvex-pr-pagination-btn",m.setAttribute("aria-label","Sayfa "+d),o(m,String(d)),d===t?m.setAttribute("aria-current","page"):m.onclick=function(){i(d)},n.appendChild(m)}),n.appendChild(l("Sonraki sayfa","\u203A",t+1,t>=r)),n}function Vn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Dn(e){var r=e.render;async function t(){var o=je(),l=ee,d=te,u=oe,m=ne;_e(null);var v=await Ve(ee,te,1,oe,ne);We(o,{productId:l,orderBy:d,ratingFilter:u,mediaFilter:m})&&await r(ee,I,v,Fe,te,1,Xt)}async function a(o){var l=je(),d=oe===o?null:o,u=ee,m=te,v=ne;Jt(d),Oe(1),_e(null);var p=await Ve(ee,te,1,d,ne);We(l,{productId:u,orderBy:m,page:1,ratingFilter:d,mediaFilter:v})&&await r(ee,I,p,Fe,te,1)}async function n(o,l){var d=je(),u=ee,m=oe;Oe(1),_e(null);var v=o,p=l==="images"||l==="media"?l:"none";p!=="none"&&(v="newest"),Zt(p),Lr(v);var s=await Ve(ee,v,1,oe,p);We(d,{productId:u,orderBy:v,page:1,ratingFilter:m,mediaFilter:p})&&await r(ee,I,s,Fe,v,1)}async function i(o){var l=je(),d=ee,u=te,m=oe,v=ne;Oe(o),_e(null);var p=await Ve(ee,te,o,oe,ne);if(We(l,{productId:d,orderBy:u,page:o,ratingFilter:m,mediaFilter:v})){await r(ee,I,p,Fe,te,o);var s=document.getElementById("renuvex-reviews"),x=s&&s.shadowRoot,c=x&&x.querySelector&&x.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(c){try{c.focus({preventScroll:!0})}catch(b){try{c.focus()}catch(E){}}Vn(x,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var f=document.getElementById("renuvex-reviews");if(f&&typeof f.scrollIntoView=="function"){var h=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;f.scrollIntoView({behavior:h?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:a,onSortChange:n,onPageChange:i}}function Io(){return ga()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Fo(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=fa({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),xa(t,{surface:"reviews",productId:r||""}),t}function Yn(e){return Math.round(Math.max(36,Math.min(52,e*.38)))}function jn(e){return Math.round(e*.5)}function Oo(e){return e.querySelector(".renuvex-pr-review, .renuvex-pr-review-list, .renuvex-pr-review-gallery, .renuvex-pr-state-msg, .renuvex-pr-load-more, .renuvex-pr-pagination")}function ds(e,r){if(String(ee||"")!==String(e||""))return!1;var t=document.getElementById("renuvex-reviews"),a=t&&t.shadowRoot,n=a&&a.getElementById("renuvex-reviews-widget");if(!n||n.getAttribute("data-renuvex-product-id")!==String(e||""))return!1;var i=n.querySelector(".renuvex-pr-media-gallery-section");i&&i.remove();var o=Wt({settings:r,root:document.documentElement,currentMediaFilter:ne,mediaStripReviews:mt,openReviewModal:fe,wireLightboxTrigger:rr});return o?(n.insertBefore(o,Oo(n)),!0):!1}async function qt(e,r,t,a,n,i,o){if(la){Br({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:i,badgeSettings:o});return}Nr(!0),Qt(e),ea(r),o!==void 0&&ra(o),ta(a),n&&Lr(n),i&&Oe(i),t!=null&&(aa(t),_e(t&&t.data?t.data.nextCursor:null));var l=Dn({render:qt});try{let Ae=function(K,Q){if(!(!K||!K.meta||!K.meta.sizeOverrides)){var ie=K.meta.sizeOverrides[Q];ie&&Object.keys(ie).forEach(function(Ie){s.style.setProperty(Ie,ie[Ie])})}};var Sr=Ae,d=ot(r.summaryLayout),u=!(d.meta&&d.meta.supports&&d.meta.supports.title===!1),m=r.showTitle!==!1,v=V(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),p=u&&m?v:"",s=document.documentElement;Un(s,r);var x=r.borderRadius!==void 0?r.borderRadius:8,c=Vt[r.size]||Vt.medium,f=Dt[r.thumbnailSize]||Dt.medium,h=f;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(h=Yt[r.thumbnailSize]||Yt.medium),s.style.setProperty("--renuvex-pr-title-size",c.titleSize+"px"),s.style.setProperty("--renuvex-pr-review-text-size",c.reviewTextSize+"px"),s.style.setProperty("--renuvex-pr-review-title-size",c.reviewTitleSize+"px"),s.style.setProperty("--renuvex-pr-author-size",c.authorSize+"px"),s.style.setProperty("--renuvex-pr-reply-name-size",c.replyNameSize+"px"),s.style.setProperty("--renuvex-pr-reply-text-size",c.replyTextSize+"px"),s.style.setProperty("--renuvex-pr-radius",x+"px"),s.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,x-4)+"px"),s.style.setProperty("--renuvex-pr-media-gallery-title-size",c.mediaGalleryTitleSize+"px"),s.style.setProperty("--renuvex-pr-avg-rating-size",c.avgRatingSize+"px"),s.style.setProperty("--renuvex-pr-review-count-size",c.reviewCountSize+"px"),s.style.setProperty("--renuvex-pr-compact-count-size",c.compactCountSize+"px"),s.style.setProperty("--renuvex-pr-recommend-size",c.recommendSize+"px"),s.style.setProperty("--renuvex-pr-btn-text-size",c.btnTextSize+"px"),s.style.setProperty("--renuvex-pr-bar-label-size",c.barLabelSize+"px"),s.style.setProperty("--renuvex-pr-minimal-avg-size",c.minimalAvgSize+"px"),s.style.setProperty("--renuvex-pr-hero-avg-size",c.heroAvgSize+"px"),s.style.setProperty("--renuvex-pr-minimal-count-size",c.minimalCountSize+"px"),s.style.setProperty("--renuvex-pr-hero-count-size",c.heroCountSize+"px"),s.style.setProperty("--renuvex-pr-bar-count-size",c.barCountSize+"px"),s.style.setProperty("--renuvex-pr-review-date-size",c.reviewDateSize+"px"),s.style.setProperty("--renuvex-pr-filter-text-size",c.filterTextSize+"px"),s.style.setProperty("--renuvex-pr-load-more-size",c.loadMoreSize+"px"),s.style.setProperty("--renuvex-pr-load-more-min-height",c.loadMoreMinHeight+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-y",c.loadMorePadY+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-x",c.loadMorePadX+"px"),s.style.setProperty("--renuvex-pr-load-more-mobile-min-height",c.loadMoreMobileMinHeight+"px"),s.style.setProperty("--renuvex-pr-pagination-button-size",c.paginationButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-pad-x",c.paginationPadX+"px"),s.style.setProperty("--renuvex-pr-pagination-gap",c.paginationGap+"px"),s.style.setProperty("--renuvex-pr-pagination-margin-top",c.paginationMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-gap-min",c.paginationGapMin+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-button-size",c.paginationMobileButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-font-size",c.paginationMobileFontSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap",c.paginationMobileGap+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",c.paginationMobileMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",c.paginationMobileGapMin+"px"),s.style.setProperty("--renuvex-pr-read-more-size",c.readMoreSize+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size",f+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size-mobile",h+"px");var b=Yn(f),E=Yn(h);s.style.setProperty("--renuvex-pr-media-play-size",b+"px"),s.style.setProperty("--renuvex-pr-media-play-icon-size",jn(b)+"px"),s.style.setProperty("--renuvex-pr-media-play-size-mobile",E+"px"),s.style.setProperty("--renuvex-pr-media-play-icon-size-mobile",jn(E)+"px");var P=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";s.style.setProperty("--renuvex-pr-review-star-color",P),s.style.setProperty("--renuvex-pr-star-size",c.reviewStarSize+"px"),s.style.setProperty("--renuvex-pr-avg-star-size",c.avgStarSize+"px"),Ae(ot(r.summaryLayout),r.size),Ae(dt(r.reviewLayout),r.size);var w=cr(r),C=Io();if(!C)return;var g=Fo(C,e),z=document.getElementById("renuvex-reviews");z||(z=document.createElement("div"),z.id="renuvex-reviews",z.style.minHeight="200px"),z.parentNode!==g&&g.appendChild(z);var M=ya(z),k=$e+Ge+Dr+An()+Ln();Je(M,k);var S=ka(M);if(r.enabled===!1){z.style.minHeight="auto",S.replaceChildren(Rn(r.borderRadius!==void 0?r.borderRadius:8)),Nr(!1);var T=Rr;Br(null),T&&qt(T.productId,T.settings,T.reviewsData,T.productName,T.orderBy,T.page,T.badgeSettings);return}try{var _=t||{},O=gt(_),y=O?[]:_.data&&_.data.reviews||[];na(y),S.replaceChildren();var A=document.createElement("section");if(A.id="renuvex-reviews-widget",A.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),A.className="renuvex-pr-reviews-widget",A.setAttribute("data-renuvex-surface","reviews"),e&&A.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(A.style.width="100%",A.style.maxWidth="100%",A.style.marginLeft="0",A.style.marginRight="0"),p){var R=document.createElement("div"),F=r.summaryLayout||"classic";R.className="renuvex-pr-title renuvex-pr-title-"+F,R.textContent=p,A.appendChild(R)}if(O){A.appendChild(In(_.message,l.onRetry)),S.appendChild(A),Ue(M),st(A,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return M.getElementById("renuvex-reviews-widget")}),vt("reviews-widget-visible");return}var U=_.data&&_.data.allCount||0,Z=_.data&&_.data.ratingCounts||null,X=Z||[0,0,0,0,0],j=_.data&&_.data.avgRating||"0.0";if(!Z&&y.length>0){y.forEach(function(K){K.rating>=1&&K.rating<=5&&X[K.rating-1]++});var H=y.reduce(function(K,Q){return K+Q.rating},0);j=(H/y.length).toFixed(1)}if(U===0)A.classList.add("renuvex-pr-reviews-empty"),A.appendChild(Nn({iconPair:w,writeButtonText:V(r.writeButtonText,"Yorum Yap"),emptyStateText:V(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:ae}));else{var W=ot(r.summaryLayout),L=W.render({widget:A,productId:e,data:_,settings:r,iconPair:w,allCount:U,ratingCounts:X,avgRatingVal:j,currentRatingFilter:oe,currentOrderBy:te,currentMediaFilter:ne,onFilterChange:l.onFilterChange,onSortChange:l.onSortChange});A.appendChild(L);var N=Wt({settings:r,root:s,currentMediaFilter:ne,mediaStripReviews:mt,openReviewModal:fe,wireLightboxTrigger:rr});if(N&&A.appendChild(N),y.length===0)A.appendChild(Bn());else{var G=dt(r.reviewLayout);y.forEach(function(K){A.appendChild(G.render(K,ct))})}var B=r.paginationMode==="numbered"?"numbered":"loadMore";if(B==="numbered"){var D=_.data&&_.data.totalPages||1;D>1&&A.appendChild(Hn({page:_.data&&_.data.page||vr||1,totalPages:D,onPageChange:l.onPageChange}))}var $=B==="loadMore"&&_.data&&_.data.hasMore;if($){let K=function(Q){q.textContent=Q,Y.setAttribute("aria-label",Q)};var ur=K,Y=document.createElement("button");Y.className="renuvex-pr-load-more";var q=document.createElement("span");q.className="renuvex-pr-load-more-label",q.setAttribute("aria-hidden","true"),Y.appendChild(q),K("Daha Fazla G\xF6ster"),Y.onclick=async function(){Y.disabled=!0,K("Y\xFCkleniyor...");var Q=je(),ie=ee,Ie=te,Cr=vr,Er=oe,Tr=ne,Ar=_r,Mr=Cr+1,ye=await Ve(ie,Ie,Mr,Er,Tr,null,Ar);if(We(Q,{productId:ie,orderBy:Ie,page:Cr,ratingFilter:Er,mediaFilter:Tr,nextCursor:Ar}))if(ye&&!gt(ye)&&ye.data&&Array.isArray(ye.data.reviews)){var sr=ia(ye.data.reviews);oa(sr),Oe(Mr),_e(ye.data.nextCursor||null);var Pr=dt(I.reviewLayout);sr.forEach(function(Wn){A.insertBefore(Pr.render(Wn,ct),Y)}),ye.data.hasMore?(Y.disabled=!1,K("Daha Fazla G\xF6ster")):Y.remove()}else Y.disabled=!1,K("Tekrar Dene")},A.appendChild(Y)}}S.appendChild(A),Ue(M),st(A,"reviews-widget",{productId:e||""},function(){return M.getElementById("renuvex-reviews-widget")}),vt("reviews-widget-visible")}catch(K){console.error("[renuvex-pr] render error:",K);var J=document.createElement("p");J.style.cssText="text-align:center;color:#dc2626;",J.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",S&&S.replaceChildren(J)}}finally{if(Nr(!1),Rr){var me=Rr;Br(null),qt(me.productId,me.settings,me.reviewsData,me.productName,me.orderBy,me.page,me.badgeSettings)}}}export{qt as render,ds as renderDeferredMediaGallery};
