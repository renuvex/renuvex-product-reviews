...
`;var nn={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},on=pa;function ln(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,o=e.avgRatingVal,l=e.currentOrderBy,i=e.currentHasImages,s=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var f=document.createElement("div");f.className="renuvex-pr-hero-info";var d=document.createElement("div");d.className="renuvex-pr-hero-rating-col";var p=document.createElement("span");p.className="renuvex-pr-hero-avg",p.textContent=o,d.appendChild(p);var v=document.createElement("div");v.className="renuvex-pr-hero-meta-row";var y=document.createElement("span");y.className="renuvex-pr-hero-stars",y.innerHTML=Me(o,a),v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-hero-count",c.textContent=n.toLocaleString("tr-TR")+" "+B(t.countLabel,"Yorum"),v.appendChild(c),d.appendChild(v),f.appendChild(d),u.appendChild(f);var b=J({widget:r,currentOrderBy:l,currentHasImages:i,onWriteClick:U,onSortChange:s}),m=b.querySelector(".renuvex-pr-filter-wrap"),g=b.querySelector(".renuvex-pr-write-btn"),x=document.createElement("div");x.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",g&&x.appendChild(g),m&&x.appendChild(m),u.appendChild(x);var k=J({widget:r,currentOrderBy:l,currentHasImages:i,onWriteClick:U,onSortChange:s}),h=k.querySelector(".renuvex-pr-filter-wrap"),z=k.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");return E.className="renuvex-pr-hero-write-row",z&&E.appendChild(z),h&&E.appendChild(h),u.appendChild(E),u}var ua=`
  .renuvex-pr-summary{
...
`;var pn={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},un=sa;function dn(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var o=document.createElement("span");o.className="renuvex-pr-review-stars",o.innerHTML=fe(e.rating,N),n.appendChild(o);var l=document.createElement("time");if(l.className="renuvex-pr-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=ge(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a),e.title){var i=document.createElement("div");i.className="renuvex-pr-review-title",i.textContent=e.title,t.appendChild(i)}var s=document.createElement("div");s.className="renuvex-pr-author",s.textContent=e.author||"",t.appendChild(s);var u=(e.comment||"").trim();u&&t.appendChild(We(u,"renuvex-pr-body").fragment);var f=Se(e);if(f.length){var d=document.createElement("div");d.className="renuvex-pr-gallery",f.forEach(function(v){var y=document.createElement("img"),c=ue(v,X);y.src=c.src,y.srcset=c.srcset,y.loading="lazy",y.decoding="async",y.width=X,y.height=X,y.className="renuvex-pr-img",de(y),y.setAttribute("data-renuvex-img-url",v),(function(b){Ce(y,function(){ve(e,b,r)})})(v),d.appendChild(y)}),t.appendChild(d)}var p=qe(e.merchantReply);return p&&t.appendChild(p),t}var Jr={};ze(Jr,{css:()=>vn,meta:()=>sn,render:()=>cn});var va=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var sn={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},vn=va;function cn(e,r){var t=Se(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var o=document.createElement("div");o.className="renuvex-pr-review-list-author";var l=document.createElement("span");l.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",l.innerHTML=fe(e.rating,N),o.appendChild(l);var i=document.createElement("span");i.className="renuvex-pr-review-list-author-name",i.textContent=e.author||"",o.appendChild(i);var s=document.createElement("time");s.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&s.setAttribute("datetime",e.createdAt),s.textContent=ge(e.createdAt),o.appendChild(s),n.appendChild(o);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var f=document.createElement("div");f.className="renuvex-pr-review-list-title",f.textContent=e.title,u.appendChild(f)}var d=(e.comment||"").trim();d&&u.appendChild(We(d,"renuvex-pr-review-list-body").fragment);var p=qe(e.merchantReply);if(p&&u.appendChild(p),n.appendChild(u),a){var v=document.createElement("div");v.className="renuvex-pr-review-list-media",t.forEach(function(y){var c=document.createElement("img"),b=ue(y,X);c.src=b.src,c.srcset=b.srcset,c.loading="lazy",c.decoding="async",c.width=X,c.height=Math.round(X*4/3),c.setAttribute("data-renuvex-img-url",y),de(c),(function(m){Ce(c,function(){ve(e,m,r)})})(y),v.appendChild(c)}),n.appendChild(v)}return n}var Zr={};ze(Zr,{css:()=>xn,meta:()=>mn,render:()=>fn});var ca=`
