...
`;function ua(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function de(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function sa(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function va(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",l=sa()&&!n;if(a>0){var p=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",p+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),l&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function ca(e){var r=document.body.style,t=document.documentElement.style;de(t,"overflow",e.rootOverflow,e.rootOverflowPriority),de(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),de(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),de(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),de(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),de(r,"position",e.bodyPosition,e.bodyPositionPriority),de(r,"top",e.bodyTop,e.bodyTopPriority),de(r,"left",e.bodyLeft,e.bodyLeftPriority),de(r,"right",e.bodyRight,e.bodyRightPriority),de(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var nr=0,je=null;function hr(){return nr+=1,nr>1||(je=ua(),va(je)),je}function br(){if(nr!==0&&(nr-=1,!(nr>0))){var e=je;je=null,e&&ca(e)}}function ma(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function yr(){var e=ma();return!e||e===document.body||e===document.documentElement?null:e}function Q(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function xa(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function jr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(xa)}function fa(e,r){var t=e,a=jr(e);!a.length&&r&&(t=r,a=jr(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;Q(n)}function wr(e,r,t){if(e.key==="Tab"){var a=jr(r);if(!a.length){e.preventDefault(),fa(r);return}var n=a[0],l=a[a.length-1],p=At(t);if(!r.contains(p)){e.preventDefault(),Q(n);return}if(a.indexOf(p)===-1){e.preventDefault(),Q(e.shiftKey?l:n);return}e.shiftKey&&p===n?(e.preventDefault(),Q(l)):!e.shiftKey&&p===l&&(e.preventDefault(),Q(n))}}var Pt="renuvexPrOverlay";function kr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Pt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function ga(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Pt]===e.id)}function zr(e){if(ga(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Ue(e){return Ce(e)}function Rt(e,r,t,a,n){br(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&sr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),Q(n)}function ha(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ge(e.rating,R);var l=document.createElement("span");l.className="renuvex-pr-modal-date",l.textContent=he(e.createdAt),a.appendChild(n),a.appendChild(l),t.appendChild(a);var p=document.createElement("div");p.className="renuvex-pr-modal-title",p.textContent=e.title||"",p.style.display=e.title?"":"none",t.appendChild(p);var o=document.createElement("div");o.className="renuvex-pr-modal-author",o.textContent=e.author||"",t.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-modal-body",s.textContent=(e.comment||"").trim(),s.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(s);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var x=document.createElement("div");x.className="renuvex-pr-modal-reply-label",x.textContent=R&&R.merchantReplyLabel||"Ma\u011Faza Sahibi";var m=document.createElement("div");return m.className="renuvex-pr-modal-reply-text",m.textContent=e.merchantReply||"",u.appendChild(x),u.appendChild(m),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function It(e,r,t){var a=t||R,n=e.querySelector(".renuvex-pr-modal-scroll-content"),l=n.querySelector(".renuvex-pr-modal-stars");l.innerHTML=ge(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=he(r.createdAt);var p=n.querySelector(".renuvex-pr-modal-title");p.textContent=r.title||"",p.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var o=n.querySelector(".renuvex-pr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var s=n.querySelector(".renuvex-pr-modal-reply");s.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",s.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",s.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Vr(e,r,t,a,n,l,p,o,s){var u=Ue(e),x=Math.max(0,Math.min(t||0,u.length-1)),m=document.createElement("div");m.className="renuvex-pr-modal-left";var i=document.createElement("img"),k=p==="next"?"renuvex-pr-modal-img-enter-right":p==="prev"?"renuvex-pr-modal-img-enter-left":"";i.className="renuvex-pr-modal-main-img"+(k?" "+k:""),i.src=Yr(u[x]||""),i.decoding="async",i.width=Hr,i.height=Math.round(Hr*4/3),i.alt="Yorum foto\u011Fraf\u0131",Ct(i,function(T){if(T.style.display="none",!m.querySelector(".renuvex-pr-modal-img-error")){var L=document.createElement("div");L.className="renuvex-pr-modal-img-error",L.setAttribute("role","status"),L.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",m.insertBefore(L,T)}}),m.appendChild(i);var d=document.createElement("button");d.className="renuvex-pr-modal-close-mobile";var b=$(Ne);b&&d.appendChild(b),d.setAttribute("aria-label","Kapat"),d.onclick=function(T){T.stopPropagation(),l()},m.appendChild(d);var f=0;if(m.addEventListener("touchstart",function(T){f=T.touches[0].clientX},{passive:!0}),m.addEventListener("touchend",function(T){var L=f-T.changedTouches[0].clientX;if(!(Math.abs(L)<50)){if(L>0){if(y)be(e,r,x+1,a,n,l,!0,"next",o,s);else if(g){var N=a[r+1];be(N,r+1,0,a,n,l,!1,"next",o,s)}}else if(c)be(e,r,x-1,a,n,l,!0,"prev",o,s);else if(w){var I=a[r-1],P=Ue(I);be(I,r-1,P.length-1,a,n,l,!1,"prev",o,s)}}},{passive:!0}),u.length>1){var v=document.createElement("div");v.className="renuvex-pr-modal-thumbs",u.forEach(function(T,L){var N=document.createElement("img"),I=le(T,xr);N.src=I.src,N.srcset=I.srcset,N.loading="lazy",N.decoding="async",N.width=xr,N.height=xr,N.className="renuvex-pr-modal-thumb"+(L===x?" renuvex-pr-modal-thumb-active":""),N.alt="K\xFC\xE7\xFCk resim "+(L+1),pe(N),N.tabIndex=0,N.setAttribute("role","button"),N.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(L+1)+" se\xE7"),L===x&&N.setAttribute("aria-current","true"),(function(P){function q(){be(e,r,P,a,n,l,!0,null,o,s)}N.onclick=q,N.onkeydown=function(X){(X.key==="Enter"||X.key===" ")&&(X.preventDefault(),q())}})(L),v.appendChild(N)}),m.appendChild(v)}var c=x>0,y=x<u.length-1,w=r>0,g=r<a.length-1,z=c||w,h=y||g;if(z){var A=document.createElement("button");A.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var E=$(Oe);E&&A.appendChild(E),A.setAttribute("aria-label","\xD6nceki"),A.onclick=function(T){if(T.stopPropagation(),c)be(e,r,x-1,a,n,l,!0,"prev",o,s);else if(w){var L=a[r-1],N=Ue(L);be(L,r-1,N.length-1,a,n,l,!1,"prev",o,s)}},m.appendChild(A)}if(h){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var S=$(vr);S&&C.appendChild(S),C.setAttribute("aria-label","Sonraki"),C.onclick=function(T){if(T.stopPropagation(),y)be(e,r,x+1,a,n,l,!0,"next",o,s);else if(g){var L=a[r+1];be(L,r+1,0,a,n,l,!1,"next",o,s)}},m.appendChild(C)}return m}function Bt(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=Ue(a);n[0]&&(new Image().src=Yr(n[0]))}})}function Ur(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function ba(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function l(){Ur(t),Ur(a),Ur(n)}l(),t&&Q(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){l(),requestAnimationFrame(l)}):setTimeout(l,0)}function be(e,r,t,a,n,l,p,o,s,u){if(u&&(u.currentReview=e),p){var x=Vr(e,r,t,a,n,l,o,s,u);n.firstChild&&n.replaceChild(x,n.firstChild)}else{var x=Vr(e,r,t,a,n,l,o,s,u),m=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(x,n.firstChild),m&&It(m,e,u&&u.currentSettings),ba(s,n)}Bt(r,a)}function ue(e,r,t){var a=Ue(e);if(!a.length)return;var n=(t||[]).filter(function(h){return Ue(h).length>0}),l=n.findIndex(function(h){return h===e||h.id===e.id});l===-1&&(n.unshift(e),l=0);var p=a.indexOf(r);p<0&&(p=0);var o=document.createElement("div");o.className="renuvex-pr-modal-overlay";var s=document.createElement("div");s.className="renuvex-pr-modal";var u=!1,x=null,m=yr(),i=hr(),k=kr(),d={currentReview:e,currentSettings:R},b=null;function f(h){var A=h&&h.detail&&h.detail.settings;if(!(A&&A===b)){b=A||null,d.currentSettings=A||R;var E=s.querySelector(".renuvex-pr-modal-right");!E||!d.currentReview||It(E,d.currentReview,d.currentSettings)}}function v(){u||(u=!0,window.removeEventListener(Pe,f),Rt(x&&x.host,c,v,i,m))}function c(h){if(h.key==="Escape"){y();return}wr(h,o,x&&x.root)}function y(){u||(u=!0,window.removeEventListener(Pe,f),Rt(x&&x.host,c,v,i,m),zr(k))}document.addEventListener("keydown",c),window.addEventListener("popstate",v),window.addEventListener(Pe,f),o.onclick=function(){y()},s.onclick=function(h){h.stopPropagation()},s.appendChild(Vr(e,l,p,n,s,y,null,o,d)),s.appendChild(ha(e)),Bt(l,n);var w=document.createElement("div");w.className="renuvex-pr-modal-wrap",w.tabIndex=-1,w.setAttribute("role","dialog"),w.setAttribute("aria-modal","true"),w.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),w.appendChild(s);var g=document.createElement("button");g.className="renuvex-pr-modal-close";var z=$(Ne);z&&g.appendChild(z),g.setAttribute("aria-label","Kapat"),g.onclick=function(h){h.stopPropagation(),y()},w.appendChild(g),o.appendChild(w),x=fr(),De(x.root,Ye+Fe+gr),x.root.appendChild(o),Ae(x.root),Q(w)}function Se(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var qr={};ke(qr,{css:()=>La,meta:()=>Ta,render:()=>Aa});function Ve(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,l=e.onFilterChange;ze(a);var p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var o=5;o>=1;o--){var s=r[o-1]||0,u=t>0?Math.round(s/t*100):0,x=n===o,m=document.createElement("div");m.className="renuvex-pr-bar-row"+(x?" renuvex-pr-bar-active":""),n&&!x&&(m.style.opacity="0.35");for(var i="",k=1;k<=5;k++){var d=k<=o;i+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(d?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+Z(d?"full":"outline")+"</span>"}m.innerHTML='<span class="renuvex-pr-bar-label">'+i+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(b){m.onclick=function(){l(b)}})(o),p.appendChild(m)}return p}var se=[],Mt=!1,Cr=!1;function Ft(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function ya(e){if(Cr){Cr=!1,e.preventDefault(),e.stopPropagation();return}for(var r=!1,t=se.length-1;t>=0;t--){var a=se[t];Ft(e,a.trigger)||Ft(e,a.element)||a.close()&&(r=!0)}r&&(e.preventDefault(),e.stopPropagation())}function wa(e){if(e.key==="Escape")for(var r=se.length-1;r>=0;r--)se[r].close()}function ka(){Mt||typeof document=="undefined"||(document.addEventListener("click",ya,!0),document.addEventListener("keydown",wa),Mt=!0)}function Sr(e){for(var r=0;r<se.length;r++)se[r]!==e&&se[r].close()}function _t(){Cr=!0,typeof setTimeout=="function"&&setTimeout(function(){Cr=!1},700)}function Er(e){ka();var r={trigger:e.trigger,element:e.element,close:e.close};return se.push(r),function(){var a=se.indexOf(r);a!==-1&&se.splice(a,1)}}function ae(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,l=e.onSortChange,p=document.createElement("div");p.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var o=document.createElement("button");o.className="renuvex-pr-write-btn",o.textContent=R&&R.writeButtonText||"Yorum Yap",o.onclick=n,p.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var x=R&&R.filterIcon||"lines";u.innerHTML=fe(gt(x));var m=document.createElement("div");m.className="renuvex-pr-filter-menu",m.setAttribute("role","menu");var i=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],k=!1;function d(v){var c=m.classList.contains("renuvex-pr-open");m.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var y=v&&(v.restoreFocus===!0||v.restoreFocus==="auto"&&lr());if(c&&y)try{u.focus({preventScroll:!0})}catch(w){try{u.focus()}catch(g){}}return c}function b(){Sr(f),m.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var v=m.querySelector(".renuvex-pr-filter-item-active")||m.querySelector(".renuvex-pr-filter-item");v&&requestAnimationFrame(function(){try{v.focus({preventScroll:!0})}catch(c){try{v.focus()}catch(y){}}})}i.forEach(function(v){var c=v[2],y=c?a:!a&&(t||"newest")===v[0],w=document.createElement("button");w.type="button",w.className="renuvex-pr-filter-item"+(y?" renuvex-pr-filter-item-active":""),w.setAttribute("role","menuitem"),w.textContent=v[1];var g=!1;function z(h,A){h&&(h.preventDefault(),h.stopPropagation()),!g&&(g=!0,k=!0,A!==!0&&_t(),d({restoreFocus:A}),l(v[0],c),setTimeout(function(){g=!1,k=!1},0))}w.addEventListener("pointerdown",function(h){h.button!==void 0&&h.button!==0||z(h,!1)}),typeof window!="undefined"&&!window.PointerEvent&&w.addEventListener("touchstart",function(h){z(h,!1)},{passive:!1}),w.addEventListener("mousedown",function(h){h.button!==void 0&&h.button!==0||z(h,!1)}),w.addEventListener("keydown",function(h){(h.key==="Enter"||h.key===" ")&&z(h,!0)}),w.onclick=function(h){z(h,!1)},m.appendChild(w)}),u.onclick=function(){m.classList.contains("renuvex-pr-open")?d({restoreFocus:"auto"}):b()},s.addEventListener("keydown",function(v){v.key==="Escape"&&m.classList.contains("renuvex-pr-open")&&(v.stopPropagation(),d({restoreFocus:!0}))}),s.addEventListener("focusout",function(v){if(m.classList.contains("renuvex-pr-open")&&!k){var c=v.relatedTarget;c&&s.contains(c)||d()}});var f=Er({trigger:s,element:m,close:d});return s.appendChild(u),s.appendChild(m),p.appendChild(s),p}var Ot=`
...
`;function Ht(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content",n.appendChild(l);var p=document.createElement("button");p.className="renuvex-pr-fwizard-close",p.type="button",p.setAttribute("aria-label","Kapat");var o=$(Ne);o&&p.appendChild(o),n.appendChild(p);var s=!1,u=null,x=null,m=!1;function i(){Q(a)}function k(g){wr(g,a,u&&u.root)}function d(){if(!s){if(s=!0,document.removeEventListener("keydown",b),a.removeEventListener("click",f),p.removeEventListener("click",d),m)Q(x);else{var g=u&&u.root?u.root.activeElement:null;if(g&&typeof g.blur=="function")try{g.blur()}catch(z){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){u?(sr(u.root),u.host&&u.host.parentNode&&u.host.parentNode.removeChild(u.host)):a.parentNode&&a.parentNode.removeChild(a),br();try{r()}catch(z){}},200)}}function b(g){if(g.key==="Escape"){d();return}k(g)}function f(g){g.target===a&&t&&d()}document.addEventListener("keydown",b),a.addEventListener("click",f),p.addEventListener("click",d);function v(g){x=yr(),m=lr(),g&&l.appendChild(g),u=fr(),De(u.root,Ye+Fe+Ot),u.root.appendChild(a),Ae(u.root),hr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),i()})}var c=null,y=null;function w(g,z){if(z=z||"error",c){try{c.remove()}catch(h){}c=null}y&&(clearTimeout(y),y=null),c=document.createElement("div"),c.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+z,c.textContent=g,n.appendChild(c),y=setTimeout(function(){c&&(c.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(c){try{c.remove()}catch(h){}c=null}},300))},4e3)}return{open:v,close:d,content:l,setAllowOutsideClose:function(g){t=!!g},setStepAttr:function(g){n.setAttribute("data-step",String(g))},showToast:w}}var Gr=4;function Ge(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Yt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(l){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Gr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(l){return l!==n})}}}}function Dt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},l=e.onNext||function(){},p=document.createElement("div");p.className="renuvex-pr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=fe(Oe)+"<span>Geri</span>",o.addEventListener("click",function(){a()}),p.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-fwizard-footer-progress";for(var u=[],x=0;x<Gr;x++){var m=document.createElement("span");m.className="renuvex-pr-fwizard-progress-seg",s.appendChild(m),u.push(m)}p.appendChild(s);var i=document.createElement("button");i.type="button";var k=null;function d(f){k&&i.removeEventListener("click",k),k=f,f&&i.addEventListener("click",f)}p.appendChild(i);function b(f,v){var c=r.indexOf(f)!==-1,y=t.indexOf(f)!==-1,w=v&&(v.images&&v.images.length>0||v.pendingImages&&v.pendingImages.length>0);if(c)f===2&&w?(i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",d(function(){l()})):(i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.setAttribute("aria-label","Atla"),i.innerHTML="<span>Atla</span>",d(function(){n()})),i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),i.style.visibility="",i.tabIndex=0;else if(y){i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Sonraki"),i.innerHTML="Sonraki",i.style.visibility="",i.tabIndex=0;var g=Ge(f,v);i.disabled=!g,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!g),d(function(){i.disabled||l()})}else i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",i.innerHTML="",i.style.visibility="hidden",i.tabIndex=-1,i.disabled=!0,d(null)}return{el:p,update:function(f,v){u.forEach(function(y,w){w+1<=f?y.classList.add("renuvex-pr-fwizard-progress-seg-active"):y.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var c=f<=1;o.style.visibility=c?"hidden":"",o.style.pointerEvents=c?"none":"",o.tabIndex=c?-1:0,b(f,v)},setNextDisabled:function(f){i.classList.contains("renuvex-pr-fwizard-cta-btn")&&(i.disabled=!!f,i.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!f))},setThanksState:function(f){o.style.visibility="hidden",s.style.visibility="hidden",i.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",i.setAttribute("aria-label","Devam Et"),i.innerHTML="Devam Et",i.style.visibility="",i.disabled=!1,i.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),d(f)}}}function jt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title",l.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-stars",p.setAttribute("role","radiogroup"),p.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var o=rr(R||{});ze(o);var s=[];function u(f){s.forEach(function(v,c){var y=c<f;v.classList.toggle("renuvex-pr-fwizard-star-active",y),v.setAttribute("aria-checked",c+1===f?"true":"false"),v.innerHTML=y?Z("full"):Z("outline")})}function x(f){e.set({rating:f}),u(f)}function m(f){var v=s[f-1];if(v)try{v.focus()}catch(c){}}function i(f,v){v&&typeof v.preventDefault=="function"&&v.preventDefault(),v&&typeof v.stopPropagation=="function"&&v.stopPropagation(),!a&&(a=!0,x(f),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var k=1;k<=5;k++)(function(f){var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-star",v.setAttribute("role","radio"),v.setAttribute("aria-label",f+" y\u0131ld\u0131z"),v.innerHTML=Z("outline"),v.addEventListener("mouseenter",function(){u(f)}),v.addEventListener("mouseleave",function(){u(e.get().rating)}),v.addEventListener("pointerdown",function(c){c.button&&c.button!==0||i(f,c)}),typeof window!="undefined"&&!window.PointerEvent&&v.addEventListener("touchstart",function(c){i(f,c)},{passive:!1}),v.addEventListener("mousedown",function(c){window.PointerEvent||i(f,c)}),v.addEventListener("keydown",function(c){if(c.key==="Enter"||c.key===" "){i(f,c);return}var y=0;c.key==="ArrowRight"||c.key==="ArrowUp"?y=Math.min(5,f+1):c.key==="ArrowLeft"||c.key==="ArrowDown"?y=Math.max(1,f-1):c.key==="Home"?y=1:c.key==="End"&&(y=5),y&&(c.preventDefault(),x(y),m(y))}),v.addEventListener("click",function(c){i(f,c)}),s.push(v),p.appendChild(v)})(k);u(e.get().rating);var d=null,b=function(f){var v=f&&f.detail&&f.detail.settings;v&&v===d||(d=v||null,o=rr(v||R||{}),u(e.get().rating))};return window.addEventListener(Pe,b),t.appendChild(p),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Pe,b)}}}var Ut=3,za=10*1024*1024;function Vt(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="renuvex-pr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle");var s=document.createElement("input");s.type="file",s.accept="image/*",s.multiple=!0,s.style.display="none",p.appendChild(o),p.appendChild(s);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),p.appendChild(u),a.appendChild(p);var x=r.revokeBlobUrl||function(c){c&&typeof c=="string"&&c.startsWith("blob:")&&URL.revokeObjectURL(c)},m=r.blobMap||{},i=r.urlToFinger||{};function k(){if(!t){var c=e.get().images||[],y=e.get().pendingImages||[],w=c.map(function(g){return{url:g,isPending:!1}}).concat(y.map(function(g){return{url:g.url,file:g.file,isPending:!0,error:g.error}}));u.innerHTML="",w.forEach(function(g){var z=m[g.url]||g.url,h=d(g,z);u.appendChild(h)}),f()}}function d(c,y){var w=document.createElement("div");w.className="renuvex-pr-fwizard-photo-thumb";var g=document.createElement("img");g.src=y,g.alt="",g.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",w.appendChild(g);var z=document.createElement("div");z.className="renuvex-pr-fwizard-photo-loading",z.style.display="none",w.appendChild(z);var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-photo-remove",h.setAttribute("aria-label","Kald\u0131r");var A=$(Ne);return A&&h.appendChild(A),w.appendChild(h),b(w,c,y),w}function b(c,y,w){var g=c.querySelector("img");g.src!==w&&(g.src=w);var z=c.querySelector(".renuvex-pr-fwizard-photo-loading");if(y.isPending&&y.error){z.style.display="flex",z.textContent="";var h=document.createElement("span");h.className="renuvex-pr-upload-error",h.textContent="\u2717 "+y.error,z.appendChild(h)}else z.style.display="none",z.textContent="";var A=c.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var E=i[y.url]||(y.file?y.file.name+"_"+y.file.size:null),C=m[y.url],S={};E&&(S.fingerprints=(e.get().fingerprints||[]).filter(function(T){return T!==E})),y.isPending?S.pendingImages=(e.get().pendingImages||[]).filter(function(T){return T.url!==y.url}):S.images=(e.get().images||[]).filter(function(T){return T!==y.url}),e.set(S),x(y.url),x(C),delete i[y.url],C&&delete i[C],m[y.url]&&delete m[y.url]}}function f(){var c=(e.get().images||[]).length,y=(e.get().pendingImages||[]).length,w=c+y,g=w>=Ut;w>0?(p.classList.add("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=fe(yt)):(p.classList.remove("renuvex-pr-fwizard-photo-card--compact"),o.innerHTML=fe(bt)+"<span>Foto\u011Fraf Ekle</span>"),g?(o.style.display="none",o.disabled=!0,s.disabled=!0):(o.style.display="flex",o.disabled=!1,s.disabled=!1,o.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){s.disabled||s.click()}),s.onchange=async function(c){var y=(e.get().images||[]).length+(e.get().pendingImages||[]).length,w=Array.from(c.target.files).slice(0,Ut-y);s.value="";var g=(e.get().pendingImages||[]).length,z=e.get().images||[],h=z.length;if(w.length!==0){for(var A=[],E=[],C=0;C<w.length;C++){var S=w[C],T=S.name+"_"+S.size,L=(e.get().fingerprints||[]).some(function(F){return F===T})||A.some(function(F){return F.file.name+"_"+F.file.size===T});if(L){console.log("[renuvex-pr] Duplicate file detected, skipping:",S.name);continue}if(S.size>za){var N="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(N,"error"):alert(N);continue}var I=URL.createObjectURL(S);i[I]=T,A.push({url:I,file:S,error:null}),E.push({url:I,file:S});var P=(e.get().fingerprints||[]).slice();P.push(T),e.set({fingerprints:P})}if(A.length!==0){var q=(e.get().pendingImages||[]).concat(A),X=async function(){for(var F=0;F<E.length;F++){var G=E[F],Ie=G.file,re=G.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var Xe=(e.get().pendingImages||[]).filter(function(O){return O.url!==re}),Be=(e.get().images||[]).slice();Be.push(re),e.set({pendingImages:Xe,images:Be});continue}try{var te=await tr(Qe+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:$e})});if(!te.ok)throw te.status===429?new Error("rate_limit"):new Error("sign failed");var Y=await te.json();if(!Y.folder)throw new Error("sign folder missing");var D=new FormData;D.append("file",Ie),D.append("api_key",Y.api_key),D.append("timestamp",Y.timestamp),D.append("signature",Y.signature),D.append("folder",Y.folder);var Ke=await fetch("https://api.cloudinary.com/v1_1/"+Y.cloud_name+"/image/upload",{method:"POST",body:D}),K=await Ke.json();if(K.secure_url&&zt(K.secure_url)){var Je=(e.get().pendingImages||[]).some(function(O){return O.url===re});if(!Je){console.log("[renuvex-pr] Upload finished but image was already deleted by user. Skipping state update.");continue}m[K.secure_url]=re,i[K.secure_url]=i[re];var ve=(e.get().pendingImages||[]).filter(function(O){return O.url!==re}),Ee=(e.get().images||[]).slice();Ee.push(K.secure_url),e.set({pendingImages:ve,images:Ee});try{tr(Qe+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:$e,secureUrl:K.secure_url})}).catch(function(){})}catch(O){}}else throw new Error("invalid image url")}catch(O){console.error("[renuvex-pr] Image upload failed:",O);var Me=O.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(Me,"error");var Te=(e.get().pendingImages||[]).map(function(ne){return ne.url===re?{url:ne.url,file:ne.file,error:Me}:ne});e.set({pendingImages:Te})}}};if(h===0&&g===0){t=!0;var ee=!r.canNavigate||r.canNavigate();ee&&e.goNext()}e.set({pendingImages:q}),X()}}};var v=e.onChange(k);return k(),{el:a,destroy:function(){t=!0,s.onchange=null,v&&v()}}}var Wr=2e3,Ca=60;function Gt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var l=document.createElement("div");l.className="renuvex-pr-fwizard-content-form";var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",p.maxLength=Ca,p.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),p.value=e.get().title||"",p.addEventListener("input",function(){e.set({title:p.value})}),l.appendChild(p);var o=document.createElement("textarea");o.className="renuvex-pr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=Wr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",l.appendChild(o);var s=document.createElement("div");s.className="renuvex-pr-fwizard-char-counter",s.setAttribute("aria-live","polite"),l.appendChild(s);function u(){var m=o.value.length;s.textContent=m+"/"+Wr,s.classList.toggle("renuvex-pr-fwizard-char-counter--max",m>=Wr)}function x(){return Ge(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),u(),t(x())}),a.appendChild(l),u(),setTimeout(function(){t(x())},0),{el:a,destroy:function(){}}}var Sa=40;function Wt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",l.textContent="Hakk\u0131n\u0131zda",n.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-fwizard-author-form";var o=document.createElement("div");o.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Sa,u.setAttribute("aria-required","true"),u.value=e.get().author||"",o.appendChild(s),o.appendChild(u),p.appendChild(o);var x=document.createElement("div");x.className="renuvex-pr-fwizard-field";var m=document.createElement("label");m.className="renuvex-pr-fwizard-label",m.textContent="E-posta (opsiyonel)";var i=document.createElement("input");i.type="email",i.className="renuvex-pr-fwizard-input",i.setAttribute("autocomplete","email"),i.value=e.get().email||"",x.appendChild(m),x.appendChild(i),p.appendChild(x);var k=document.createElement("div");k.className="renuvex-pr-fwizard-notice",k.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",p.appendChild(k);var d=document.createElement("div");d.className="renuvex-pr-fwizard-msg",d.setAttribute("role","alert"),d.setAttribute("aria-live","assertive"),p.appendChild(d);var b=document.createElement("button");b.type="button",b.className="renuvex-pr-fwizard-submit-btn",b.textContent="G\xF6nder",p.appendChild(b),n.appendChild(p);function f(){return Ge(4,e.get())}function v(){var g=!f(),z=(e.get().pendingImages||[]).length,h=z>0;h?(b.disabled=!0,b.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),b.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(b.disabled=g,b.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",g),b.textContent="G\xF6nder")}u.addEventListener("input",function(){e.set({author:u.value}),v(),t(f())}),i.addEventListener("input",function(){e.set({email:i.value})}),v(),setTimeout(function(){t(f())},0);function c(){d.textContent=""}function y(g){c();var z=document.createElement("div");z.className="renuvex-pr-fwizard-msg-error",z.textContent=g||"",d.appendChild(z)}b.onclick=async function(){if(!b.disabled){var g=e.get(),z=(g.author||"").trim(),h=(g.comment||"").trim();if(i.value.trim()&&!i.checkValidity()){i.reportValidity();return}if(!z){y("Gerekli alan");return}if(!g.rating){y("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}b.disabled=!0,b.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var A=b.textContent;if(b.textContent="G\xF6nderiliyor\u2026",c(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var E=wt(window.location.href),C=g.productName||null,S=await tr(Qe+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:$e,productId:g.productId||null,slug:E||null,productName:C,author:z,title:(g.title||"").trim()||null,comment:h||null,rating:g.rating,images:g.images||[]})},15e3);if(S.ok)a();else{var T=await S.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(I){var L=I&&(I.name==="AbortError"||/signal/i.test(I.message||"")),N=L?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":I.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(N,"error"):y(N),b.disabled=!1,b.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),b.textContent=A}}};var w=e.onChange(v);return{el:n,destroy:function(){b.onclick=null,w&&w()}}}function Ea(e,r,t){if(t=t||{},e===1)return jt(r,{canNavigate:t.canNavigate});if(e===2)return Vt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Gt(r,{onValidityChange:t.onValidityChange});if(e===4)return Wt(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function qt(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Xt(e){e=e||{};var r=Yt({productId:e.productId,productName:e.productName}),t={},a={},n={};function l(E){if(!(!E||typeof E!="string"||!E.startsWith("blob:")||n[E])){n[E]=!0;try{URL.revokeObjectURL(E)}catch(C){}}}function p(){Object.keys(a).forEach(function(C){l(C)}),Object.keys(t).forEach(function(C){l(t[C])});var E=r.get();(E.pendingImages||[]).forEach(function(C){l(C&&C.url)}),(E.images||[]).forEach(function(C){l(C)})}var o=Ht({onClose:function(){window.removeEventListener("popstate",u),zr(s),p(),e.onClose&&e.onClose()},allowOutsideClose:!1}),s=kr(),u=function(E){o&&o.close&&o.close()};window.addEventListener("popstate",u);var x=document.createElement("div");x.className="renuvex-pr-fwizard-step-wrap";var m=Dt({skippableSteps:[2],nextableSteps:[3],onBack:function(){d==="idle"&&r.goBack()},onSkip:function(){d==="idle"&&r.goNext()},onNext:function(){d==="idle"&&r.goNext()}}),i=document.createElement("div");i.className="renuvex-pr-fwizard-layout",i.appendChild(x),i.appendChild(m.el);var k=null,d="idle",b=null,f=!0,v=null;function c(E,C){x.innerHTML="";var S=Ea(E,r,{canNavigate:function(){return d==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:l,onValidityChange:function(N){m.setNextDisabled(!N)},onSuccess:w,showToast:o.showToast});if(k=S,m.update(E,r.get()),C){d="entering",S.el.classList.add("renuvex-pr-fwizard-step--enter");var T=null,L=function(){T&&clearTimeout(T),S.el.removeEventListener("animationend",L),S.el.classList.remove("renuvex-pr-fwizard-step--enter"),d="idle",b!==null&&g()};S.el.addEventListener("animationend",L),T=setTimeout(L,700)}else d="idle";x.appendChild(S.el),o.setStepAttr&&o.setStepAttr(E),E===3&&m.setNextDisabled(!0)}var y=!1;function w(){if(!y){if(y=!0,!k){x.innerHTML="";var E=qt();E.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(E),o.setStepAttr("thanks"),m.setThanksState(o.close);return}var C=k;d="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var S=function(){if(v&&clearTimeout(v),C.el.removeEventListener("animationend",S),C.destroy)try{C.destroy()}catch(L){}k===C&&(k=null),x.innerHTML="";var T=qt();T.classList.add("renuvex-pr-fwizard-step--enter"),x.appendChild(T),o.setStepAttr("thanks"),m.setThanksState(o.close),d="idle"};C.el.addEventListener("animationend",S),v=setTimeout(S,300)}}function g(){var E=r.get().currentStep;if(d!=="idle"){b=E;return}if(!k){var C=!f;f=!1,c(E,C);return}var S=k;d="exiting",S.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(v&&clearTimeout(v),S.el.removeEventListener("animationend",T),S.destroy)try{S.destroy()}catch(N){}if(k===S){x.innerHTML="",k=null;var L=b!==null?b:r.get().currentStep;b=null,c(L,!0),d="idle"}};S.el.addEventListener("animationend",T),v=setTimeout(T,350)}g();var z=r.get().currentStep,h=r.onChange(function(E){E.currentStep!==z?(z=E.currentStep,g()):m.update(E.currentStep,E)}),A=o.close;return o.close=function(){h&&h(),typeof v!="undefined"&&v&&clearTimeout(v),A()},o.open(i),{close:o.close}}function H(){Xt({productId:V||"",productName:_e||""})}var Kt=`
...
`;var Ta={id:"classic",name:"Klasik (A\xE7\u0131k)"},La=Kt;function Aa(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,l=e.allCount,p=e.ratingCounts,o=e.avgRatingVal,s=e.currentRatingFilter,u=e.currentOrderBy,x=e.currentHasImages,m=e.onFilterChange,i=e.onSortChange;ze(n);var k=document.createElement("div");k.className="renuvex-pr-summary";var d=(p[3]||0)+(p[4]||0),b=l>0?Math.round(d/l*100):0,f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-avg",f.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+Z("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",k.appendChild(f);var v=document.createElement("div");if(v.className="renuvex-pr-summary-block renuvex-pr-summary-count",v.textContent=l.toLocaleString("tr-TR")+" Yorum",k.appendChild(v),a.showRecommendation!==!1&&b>0){var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",c.innerHTML='<span class="renuvex-pr-recommend-pct">%'+b+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",k.appendChild(c)}return k.appendChild(Ve({ratingCounts:p,allCount:l,iconPair:n,currentRatingFilter:s,onFilterChange:m})),k.appendChild(ae({widget:r,currentOrderBy:u,currentHasImages:x,onWriteClick:H,onSortChange:i})),k}var Xr={};ke(Xr,{css:()=>Pa,meta:()=>Na,render:()=>Ra});var Jt=`
...
`;var Na={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Pa=Jt;function Ra(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,p=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,u=e.currentHasImages,x=e.onFilterChange,m=e.onSortChange,i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-compact";var k=document.createElement("div");k.className="renuvex-pr-compact-header";var d=document.createElement("div");d.className="renuvex-pr-compact-trigger-wrap";var b=document.createElement("button");b.className="renuvex-pr-compact-trigger",b.type="button",b.setAttribute("aria-expanded","false"),b.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+He(p,a)+'</span><span class="renuvex-pr-compact-trigger-text">'+n.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+fe(ht)+"</span>",d.appendChild(b),k.appendChild(d);var f=ae({widget:r,currentOrderBy:s,currentHasImages:u,onWriteClick:H,onSortChange:m}),v=f.querySelector(".renuvex-pr-filter-wrap"),c=f.querySelector(".renuvex-pr-write-btn"),y=document.createElement("div");y.className="renuvex-pr-compact-actions-slot",c&&y.appendChild(c),v&&y.appendChild(v),k.appendChild(y),i.appendChild(k);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-hidden","true");var g=document.createElement("div");g.className="renuvex-pr-compact-panel-inner";var z=document.createElement("div");z.className="renuvex-pr-compact-avg",z.innerHTML='<span class="renuvex-pr-icon">'+Z("full")+"</span><span>"+p+"</span>",g.appendChild(z),g.appendChild(Ve({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:o,onFilterChange:x})),w.appendChild(g);var h=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function A(F){var G=F?i:d;w.parentNode!==G&&(w.classList.contains("renuvex-pr-open")&&(w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden","true"),b.setAttribute("aria-expanded","false")),G.appendChild(w))}if(A(h?h.matches:!1),h){var E=function(F){A(F.matches)};h.addEventListener?h.addEventListener("change",E):h.addListener&&h.addListener(E)}if(c){var C=document.createElement("button");C.className="renuvex-pr-write-btn",C.textContent=R&&R.writeButtonText||"Yorum Yap",C.onclick=H;var S=document.createElement("div");S.className="renuvex-pr-compact-write-row",S.appendChild(C),i.appendChild(S)}function T(){w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden","true"),b.setAttribute("aria-expanded","false")}function L(){Sr(N),w.classList.add("renuvex-pr-open"),w.setAttribute("aria-hidden","false"),b.setAttribute("aria-expanded","true")}b.onclick=function(){w.classList.contains("renuvex-pr-open")?T():L()};var N=null;function I(F){N&&(N(),N=null),F||(N=Er({trigger:d,element:w,close:T}))}if(I(h?h.matches:!1),h){var P=function(F){I(F.matches)};h.addEventListener?h.addEventListener("change",P):h.addListener&&h.addListener(P)}if(t.showRecommendation!==!1){var q=(l[3]||0)+(l[4]||0),X=n>0?Math.round(q/n*100):0;if(X>0){var ee=document.createElement("div");ee.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",ee.style.marginTop="8px",ee.innerHTML='<span class="renuvex-pr-recommend-pct">%'+X+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",g.appendChild(ee)}}return i}var Kr={};ke(Kr,{css:()=>Ba,meta:()=>Ia,render:()=>Ma});var Zt=`
...
`;var Ia={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Ba=Zt;function Ma(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,l=e.ratingCounts,p=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,u=e.currentHasImages,x=e.onFilterChange,m=e.onSortChange;ze(a);var i=document.createElement("div");i.className="renuvex-pr-summary renuvex-pr-summary-split";var k=document.createElement("div");k.className="renuvex-pr-split-col renuvex-pr-split-left";var d=document.createElement("div");d.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",d.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+Z("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",k.appendChild(d);var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",b.textContent=n.toLocaleString("tr-TR")+" Yorum",k.appendChild(b),i.appendChild(k);var f=document.createElement("div");f.className="renuvex-pr-split-col renuvex-pr-split-mid",f.appendChild(Ve({ratingCounts:l,allCount:n,iconPair:a,currentRatingFilter:o,onFilterChange:x})),i.appendChild(f);var v=ae({widget:r,currentOrderBy:s,currentHasImages:u,onWriteClick:H,onSortChange:m}),c=v.querySelector(".renuvex-pr-filter-wrap"),y=v.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-split-col renuvex-pr-split-right",y&&w.appendChild(y),c&&w.appendChild(c),i.appendChild(w);var g=(l[3]||0)+(l[4]||0),z=n>0?Math.round(g/n*100):0,h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var A=t.showRecommendation===!1||z===0;return A&&h.classList.add("renuvex-pr-split-rec-hidden"),k.appendChild(h),i}var Jr={};ke(Jr,{css:()=>_a,meta:()=>Fa,render:()=>Oa});var $t=`
...
`;var Fa={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},_a=$t;function Oa(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,l=e.currentOrderBy,p=e.currentHasImages,o=e.onSortChange,s=document.createElement("div");s.className="renuvex-pr-summary renuvex-pr-summary-minimal";var u=document.createElement("div");u.className="renuvex-pr-minimal-info";var x=document.createElement("div");x.className="renuvex-pr-minimal-row";var m=document.createElement("span");m.className="renuvex-pr-minimal-avg",m.textContent=n,x.appendChild(m);var i=document.createElement("span");i.className="renuvex-pr-minimal-stars",i.innerHTML=He(n,t),x.appendChild(i);var k=document.createElement("span");k.className="renuvex-pr-minimal-count",k.textContent=a.toLocaleString("tr-TR")+" Yorum",x.appendChild(k),u.appendChild(x),s.appendChild(u);var d=ae({widget:r,currentOrderBy:l,currentHasImages:p,onWriteClick:H,onSortChange:o}),b=d.querySelector(".renuvex-pr-filter-wrap"),f=d.querySelector(".renuvex-pr-write-btn"),v=document.createElement("div");if(v.className="renuvex-pr-minimal-actions",f&&v.appendChild(f),b&&v.appendChild(b),s.appendChild(v),f){var c=document.createElement("button");c.className="renuvex-pr-write-btn",c.textContent=R&&R.writeButtonText||"Yorum Yap",c.onclick=H;var y=document.createElement("div");y.className="renuvex-pr-minimal-write-row",y.appendChild(c),s.appendChild(y)}return s}var Zr={};ke(Zr,{css:()=>Ya,meta:()=>Ha,render:()=>Da});var Qt=`
...
`;var ja={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},Ua=ra;function Va(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var a=document.createElement("div");a.className="renuvex-pr-review-top";var n=document.createElement("div");n.className="renuvex-pr-review-top-left";var l=document.createElement("span");l.className="renuvex-pr-review-stars",l.innerHTML=ge(e.rating,R),n.appendChild(l);var p=document.createElement("time");if(p.className="renuvex-pr-date",e.createdAt&&p.setAttribute("datetime",e.createdAt),p.textContent=he(e.createdAt),a.appendChild(n),a.appendChild(p),t.appendChild(a),e.title){var o=document.createElement("div");o.className="renuvex-pr-review-title",o.textContent=e.title,t.appendChild(o)}var s=document.createElement("div");s.className="renuvex-pr-author",s.textContent=e.author||"",t.appendChild(s);var u=(e.comment||"").trim();u&&t.appendChild(We(u,"renuvex-pr-body").fragment);var x=Ce(e);if(x.length){var m=document.createElement("div");m.className="renuvex-pr-gallery",x.forEach(function(k){var d=document.createElement("img"),b=le(k,W);d.src=b.src,d.srcset=b.srcset,d.loading="lazy",d.decoding="async",d.width=W,d.height=W,d.className="renuvex-pr-img",pe(d),d.setAttribute("data-renuvex-img-url",k),(function(f){Se(d,function(){ue(e,f,r)})})(k),m.appendChild(d)}),t.appendChild(m)}var i=qe(e.merchantReply);return i&&t.appendChild(i),t}var Qr={};ke(Qr,{css:()=>Wa,meta:()=>Ga,render:()=>qa});var ta=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var Ga={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-w-mobile":"80px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-w-mobile":"100px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-w-mobile":"110px"}}},Wa=ta;function qa(e,r){var t=Ce(e),a=t.length>0,n=document.createElement("article");n.className="renuvex-pr-review-list"+(a?"":" renuvex-pr-review-list--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-list-author";var p=document.createElement("span");p.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",p.innerHTML=ge(e.rating,R),l.appendChild(p);var o=document.createElement("span");o.className="renuvex-pr-review-list-author-name",o.textContent=e.author||"",l.appendChild(o);var s=document.createElement("time");s.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&s.setAttribute("datetime",e.createdAt),s.textContent=he(e.createdAt),l.appendChild(s),n.appendChild(l);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var x=document.createElement("div");x.className="renuvex-pr-review-list-title",x.textContent=e.title,u.appendChild(x)}var m=(e.comment||"").trim();m&&u.appendChild(We(m,"renuvex-pr-review-list-body").fragment);var i=qe(e.merchantReply);if(i&&u.appendChild(i),n.appendChild(u),a){var k=document.createElement("div");k.className="renuvex-pr-review-list-media",t.forEach(function(d){var b=document.createElement("img"),f=le(d,W);b.src=f.src,b.srcset=f.srcset,b.loading="lazy",b.decoding="async",b.width=W,b.height=Math.round(W*4/3),b.setAttribute("data-renuvex-img-url",d),pe(b),(function(v){Se(b,function(){ue(e,v,r)})})(d),k.appendChild(b)}),n.appendChild(k)}return n}var et={};ke(et,{css:()=>Ka,meta:()=>Xa,render:()=>Ja});var aa=`
...
`;var Xa={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},Ka=aa;function Ja(e,r){var t=cr(e),a=!!t,n=document.createElement("article");n.className="renuvex-pr-review-gallery"+(a?"":" renuvex-pr-review-gallery--no-media");var l=document.createElement("div");l.className="renuvex-pr-review-gallery-content";var p=document.createElement("span");if(p.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",p.innerHTML=ge(e.rating,R),l.appendChild(p),e.title){var o=document.createElement("div");o.className="renuvex-pr-review-gallery-title",o.textContent=e.title,l.appendChild(o)}var s=document.createElement("div");s.className="renuvex-pr-review-gallery-author",s.textContent=e.author||"",l.appendChild(s);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=he(e.createdAt),l.appendChild(u);var x=(e.comment||"").trim();if(x&&l.appendChild(We(x,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ue(e,t,r)}}:null).fragment),n.appendChild(l),a){var m=document.createElement("div");m.className="renuvex-pr-review-gallery-media";var i=document.createElement("img"),k=le(t,mr);i.src=k.src,i.srcset=k.srcset,i.loading="lazy",i.decoding="async",i.width=mr,i.height=Math.round(mr*4/3),pe(i),i.setAttribute("data-renuvex-img-url",t),Se(i,function(){ue(e,t,r)}),m.appendChild(i),n.appendChild(m)}var d=qe(e.merchantReply,t?function(){ue(e,t,r)}:null);return d&&(d.classList.add("renuvex-pr-review-gallery-reply"),n.appendChild(d)),n}var Ar={card:$r,list:Qr,gallery:et};function ir(e){return Ar[e]||Ar.card}function na(){return Object.keys(Ar).map(function(e){return Ar[e].css||""}).join(`
`)}function Re(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var a=parseInt(t[1],16),n=parseInt(t[2],16),l=parseInt(t[3],16);return"rgba("+a+","+n+","+l+","+r+")"}function Za(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",a=document.createElementNS(t,"svg");a.setAttribute("width","32"),a.setAttribute("height","32"),a.setAttribute("viewBox","0 0 24 24"),a.setAttribute("fill","none"),a.setAttribute("stroke","currentColor"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-linecap","round"),a.setAttribute("stroke-linejoin","round"),a.style.cssText="color:#6e6d7a;margin-bottom:4px;";var n=document.createElementNS(t,"path");n.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var l=document.createElementNS(t,"line");l.setAttribute("x1","1"),l.setAttribute("y1","1"),l.setAttribute("x2","23"),l.setAttribute("y2","23"),a.appendChild(n),a.appendChild(l);var p=document.createElement("div");p.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",p.textContent="Widget \u015Fu anda Pasif durumda";var o=document.createElement("div");return o.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",o.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(a),r.appendChild(p),r.appendChild(o),r}function $a(){return Tt()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Qa(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=St({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),Et(t,{surface:"reviews",productId:r||""}),t}var ia={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},oa={small:80,medium:110,large:140},rt=0;function Nr(){return rt++,rt}function Pr(e,r){return e!==rt?!1:r?!(r.productId!==void 0&&V!==r.productId||r.orderBy!==void 0&&oe!==r.orderBy||r.page!==void 0&&Fr!==r.page||r.ratingFilter!==void 0&&me!==r.ratingFilter||r.hasImages!==void 0&&xe!==r.hasImages):!0}function en(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="renuvex-pr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="renuvex-pr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},t.appendChild(n),t}function rn(e,r){var t=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",l=r.headerRecommendColor||"#111111",p=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",s=r.barCountColor||"#111111",u=Re(p,.06),x=r.reviewStarColor||"#f59e0b",m=r.btnBgColor||"#111111",i=r.btnTextColor||"#ffffff",k=r.btnBorderColor||"#111111",d=r.filterBtnBgColor||"#111111",b=r.filterBtnTextColor||"#ffffff",f=r.filterBtnBorderColor||"#111111",v=r.filterMenuBgColor||"#ffffff",c=r.filterMenuBorderColor||"#e5e7eb",y=r.filterItemTextColor||"#111111",w=r.filterItemHoverBgColor||"#f3f4f6",g=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",h=r.reviewAuthorColor||"#111111",A=r.reviewDateColor||"#5e5e5e",E=r.reviewBodyColor||"#111111",C=r.reviewBorderColor||"#e5e7eb",S=r.replyBgColor||"#f9fafb",T=r.replyBorderColor||"#747474",L=r.replyLabelColor||"#111111",N=r.replyTextColor||"#111111",I=r.photoTitleColor||"#111111",P=Re("#111111",.05),q=r.photoArrowBgColor||"#ffffff",X=r.photoArrowTextColor||"#111111",ee=Re("#111111",.12),F=r.formBgColor||"#ffffff",G=r.formPrimaryTextColor||"#111111",Ie=r.formSecondaryTextColor||"#3b3b3b",re=r.inputTextColor||G,Xe=r.inputBorderColor||"#d1d5db",Be=r.placeholderColor||"#9ca3af",te=r.formStepBarColor||"#111111",Y=r.formBtnBgColor||"#111111",D=r.formBtnTextColor||"#ffffff",Ke=r.formBtnBorderColor||"#111111",K=Re(Y,.06),Je=Re(Y,.18),ve=Re(D,.85),Ee=Re(G,.06),Me=r.loadMoreBgColor||"#ffffff",Te=r.loadMoreTextColor||"#111111",O=r.loadMoreBorderColor||"#111111",ne={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":a,"--renuvex-pr-header-count":n,"--renuvex-pr-header-recommend":l,"--renuvex-pr-bar-fill":p,"--renuvex-pr-bar-track":o,"--renuvex-pr-bar-count":s,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":m,"--renuvex-pr-btn-text":i,"--renuvex-pr-btn-border":k,"--renuvex-pr-filter-btn-bg":d,"--renuvex-pr-filter-btn-text":b,"--renuvex-pr-filter-btn-border":f,"--renuvex-pr-filter-menu-bg":v,"--renuvex-pr-filter-menu-border":c,"--renuvex-pr-filter-item-text":y,"--renuvex-pr-filter-item-hover-bg":w,"--renuvex-pr-filter-item-active":g,"--renuvex-pr-review-title":z,"--renuvex-pr-review-author":h,"--renuvex-pr-review-date":A,"--renuvex-pr-review-body":E,"--renuvex-pr-review-border":C,"--renuvex-pr-review-star-color":x,"--renuvex-pr-reply-bg-color":S,"--renuvex-pr-reply-border":T,"--renuvex-pr-reply-label":L,"--renuvex-pr-reply-text":N,"--renuvex-pr-photo-title":I,"--renuvex-pr-photo-image-border":P,"--renuvex-pr-photo-arrow-bg":q,"--renuvex-pr-photo-arrow-text":X,"--renuvex-pr-photo-arrow-border":ee,"--renuvex-pr-fwizard-bg":F,"--renuvex-pr-fwizard-text":G,"--renuvex-pr-fwizard-secondary-text":Ie,"--renuvex-pr-fwizard-input-bg":F,"--renuvex-pr-fwizard-input-text":re,"--renuvex-pr-fwizard-input-border":Xe,"--renuvex-pr-fwizard-placeholder":Be,"--renuvex-pr-fwizard-close-text":G,"--renuvex-pr-fwizard-close-hover-bg":Ee,"--renuvex-pr-fwizard-progress-bg":Ee,"--renuvex-pr-fwizard-progress-active":te,"--renuvex-pr-fwizard-btn-bg":Y,"--renuvex-pr-fwizard-btn-text":D,"--renuvex-pr-fwizard-btn-border":Ke,"--renuvex-pr-fwizard-btn-disabled-bg":Je,"--renuvex-pr-fwizard-btn-disabled-text":ve,"--renuvex-pr-fwizard-nav-hover-bg":K,"--renuvex-pr-load-more-bg":Me,"--renuvex-pr-load-more-text":Te,"--renuvex-pr-load-more-border":O};Object.keys(ne).forEach(function(ye){e.style.setProperty(ye,ne[ye])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function or(e,r,t,a,n,l,p){if(ft){ur({productId:e,settings:r,reviewsData:t,productName:a,orderBy:n,page:l,badgeSettings:p});return}dr(!0),pt(e),dt(r),p!==void 0&&ut(p),st(a),n&&Or(n),l&&er(l),t!=null&&vt(t);try{let Br=function(B,_){if(!(!B||!B.meta||!B.meta.sizeOverrides)){var M=B.meta.sizeOverrides[_];M&&Object.keys(M).forEach(function(j){i.style.setProperty(j,M[j])})}};var tn=Br,o=Lr(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),u=r.showTitle!==!1,x=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",m=s&&u?x:"",i=document.documentElement;rn(i,r);var k=r.borderRadius!==void 0?r.borderRadius:8,d=ia[r.size]||ia.medium,b=oa[r.thumbnailSize]||oa.medium,f=ir(r.reviewLayout);if(f.meta&&f.meta.sizeOverrides&&f.meta.sizeOverrides[r.size]){var v=f.meta.sizeOverrides[r.size],c=v["--renuvex-pr-list-photo-w"]||v["--renuvex-pr-gallery-photo-w"];c&&(b=parseInt(c))}i.style.setProperty("--renuvex-pr-title-size",d.titleSize+"px"),i.style.setProperty("--renuvex-pr-review-text-size",d.reviewTextSize+"px"),i.style.setProperty("--renuvex-pr-review-title-size",d.reviewTitleSize+"px"),i.style.setProperty("--renuvex-pr-author-size",d.authorSize+"px"),i.style.setProperty("--renuvex-pr-reply-name-size",d.replyNameSize+"px"),i.style.setProperty("--renuvex-pr-reply-text-size",d.replyTextSize+"px"),i.style.setProperty("--renuvex-pr-radius",k+"px"),i.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,k-4)+"px"),i.style.setProperty("--renuvex-pr-photo-title-size",d.photoTitleSize+"px"),i.style.setProperty("--renuvex-pr-avg-rating-size",d.avgRatingSize+"px"),i.style.setProperty("--renuvex-pr-review-count-size",d.reviewCountSize+"px"),i.style.setProperty("--renuvex-pr-compact-count-size",d.compactCountSize+"px"),i.style.setProperty("--renuvex-pr-recommend-size",d.recommendSize+"px"),i.style.setProperty("--renuvex-pr-btn-text-size",d.btnTextSize+"px"),i.style.setProperty("--renuvex-pr-bar-label-size",d.barLabelSize+"px"),i.style.setProperty("--renuvex-pr-minimal-avg-size",d.minimalAvgSize+"px"),i.style.setProperty("--renuvex-pr-hero-avg-size",d.heroAvgSize+"px"),i.style.setProperty("--renuvex-pr-bar-count-size",d.barCountSize+"px"),i.style.setProperty("--renuvex-pr-review-date-size",d.reviewDateSize+"px"),i.style.setProperty("--renuvex-pr-filter-text-size",d.filterTextSize+"px"),i.style.setProperty("--renuvex-pr-load-more-size",d.loadMoreSize+"px"),i.style.setProperty("--renuvex-pr-read-more-size",d.readMoreSize+"px"),i.style.setProperty("--renuvex-pr-thumbnail-size",b+"px");var y=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";i.style.setProperty("--renuvex-pr-review-star-color",y),i.style.setProperty("--renuvex-pr-star-size",d.reviewStarSize+"px"),i.style.setProperty("--renuvex-pr-avg-star-size",d.avgStarSize+"px"),Br(Lr(r.summaryLayout),r.size),Br(ir(r.reviewLayout),r.size);var w=rr(r),g=$a();if(!g)return;var z=Qa(g,e),h=document.getElementById("renuvex-reviews");h||(h=document.createElement("div"),h.id="renuvex-reviews",h.style.minHeight="200px"),h.parentNode!==z&&z.appendChild(h);var A=Lt(h),E=Ye+Fe+gr+ea()+na();De(A,E);var C=Nt(A);if(r.enabled===!1){h.style.minHeight="auto",C.replaceChildren(Za(r.borderRadius!==void 0?r.borderRadius:8)),dr(!1);var S=pr;ur(null),S&&or(S.productId,S.settings,S.reviewsData,S.productName,S.orderBy,S.page,S.badgeSettings);return}var T=document.createElement("p");T.className="renuvex-pr-state-msg renuvex-pr-state-loading",T.textContent="Yorumlar y\xFCkleniyor...",C.replaceChildren(T);try{var L=t||{},N=Dr(L),I=N?[]:L.data&&L.data.reviews||[];ct(I),C.replaceChildren();var P=document.createElement("section");if(P.id="renuvex-reviews-widget",P.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),P.className="renuvex-pr-reviews-widget",P.setAttribute("data-renuvex-surface","reviews"),e&&P.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(P.style.width="100%",P.style.maxWidth="100%",P.style.marginLeft="0",P.style.marginRight="0"),m){var q=document.createElement("div"),X=r.summaryLayout||"classic";q.className="renuvex-pr-title renuvex-pr-title-"+X,q.textContent=m,P.appendChild(q)}if(N){P.appendChild(en(L.message,async function(){var B=Nr(),_=V,M=oe,j=me,ie=xe,U=await ar(V,oe,1,me,xe);Pr(B,{productId:_,orderBy:M,ratingFilter:j,hasImages:ie})&&await or(V,R,U,_e,oe,1,nt)})),C.appendChild(P),Ae(A),Mr(P,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return A.getElementById("renuvex-reviews-widget")});return}var ee=L.data&&L.data.allCount||0,F=L.data&&L.data.ratingCounts||null,G=F||[0,0,0,0,0],Ie=L.data&&L.data.avgRating||"0.0";if(!F&&I.length>0){I.forEach(function(B){B.rating>=1&&B.rating<=5&&G[B.rating-1]++});var re=I.reduce(function(B,_){return B+_.rating},0);Ie=(re/I.length).toFixed(1)}if(ee>0){var Xe=Lr(r.summaryLayout),Be=Xe.render({widget:P,data:L,settings:r,iconPair:w,allCount:ee,ratingCounts:G,avgRatingVal:Ie,currentRatingFilter:me,currentOrderBy:oe,currentHasImages:xe,onFilterChange:async function(B){var _=Nr(),M=me===B?null:B,j=V,ie=oe,U=xe;ot(M),er(1);var ce=await ar(V,oe,1,M,xe);Pr(_,{productId:j,orderBy:ie,page:1,ratingFilter:M,hasImages:U})&&await or(V,R,ce,_e,oe,1)},onSortChange:async function(B,_){var M=Nr(),j=V,ie=me;er(1);var U=B,ce=!1;_&&(ce=!0,U="newest"),lt(ce),Or(U);var we=await ar(V,U,1,me,ce);Pr(M,{productId:j,orderBy:U,page:1,ratingFilter:ie,hasImages:ce})&&await or(V,R,we,_e,U,1)}});P.appendChild(Be)}else{var te=document.createElement("button");te.className="renuvex-pr-write-btn",te.style.cssText="display:block;margin:16px auto 0;",te.textContent=r.writeButtonText||"Yorum Yap",te.onclick=H,P.appendChild(te)}var Y=(it||[]).filter(function(B){return Ce(B).length>0});if(r.showPhotoGallery!==!1&&!xe&&Y.length>0){var D=document.createElement("div");if(D.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var Ke=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",K=document.createElement("div");K.className="renuvex-pr-photo-title",K.textContent=Ke,D.appendChild(K)}var Je=r.reviewLayout==="card"?"1/1":"3/4";i.style.setProperty("--renuvex-pr-photo-thumb-aspect",Je);var ve=document.createElement("div");ve.className="renuvex-pr-photo-strip";var Ee=W,Me=r.reviewLayout==="card"?W:Math.round(W*4/3),Te=0;Y.forEach(function(B){if(!(Te>=15)){var _=cr(B);if(_){var M=document.createElement("img"),j=le(_,W);M.src=j.src,M.srcset=j.srcset,M.loading=Te<3?"eager":"lazy",M.decoding="async",M.width=Ee,M.height=Me,M.className="renuvex-pr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",pe(M),(function(ie,U){Se(M,function(){ue(U,ie,Y)})})(_,B),ve.appendChild(M),Te++}}});var O=document.createElement("button");O.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var ne=$(Oe);ne&&O.appendChild(ne),O.setAttribute("aria-label","\xD6nceki"),O.onclick=function(){ve.scrollBy({left:-200,behavior:"smooth"})};var ye=document.createElement("button");ye.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var tt=$(vr);tt&&ye.appendChild(tt),ye.setAttribute("aria-label","Sonraki"),ye.onclick=function(){ve.scrollBy({left:200,behavior:"smooth"})};var Ze=document.createElement("div");Ze.className="renuvex-pr-photo-strip-wrap",Ze.appendChild(O),Ze.appendChild(ve),Ze.appendChild(ye),D.appendChild(Ze),P.appendChild(D)}if(I.length===0){var Rr=document.createElement("p");Rr.className="renuvex-pr-state-msg",Rr.textContent="Hen\xFCz yorum yok.",P.appendChild(Rr)}else{var f=ir(r.reviewLayout);I.forEach(function(_){P.appendChild(f.render(_,_r))})}var la=L.data&&L.data.hasMore;if(la){var J=document.createElement("button");J.className="renuvex-pr-load-more",J.textContent="Daha Fazla G\xF6ster",J.onclick=async function(){J.disabled=!0,J.textContent="Y\xFCkleniyor...";var B=Nr(),_=V,M=oe,j=Fr,ie=me,U=xe,ce=j+1,we=await ar(_,M,ce,ie,U);if(Pr(B,{productId:_,orderBy:M,page:j,ratingFilter:ie,hasImages:U}))if(we&&!Dr(we)&&we.data&&Array.isArray(we.data.reviews)){var at=mt(we.data.reviews);xt(at),er(ce);var pa=ir(R.reviewLayout);at.forEach(function(da){P.insertBefore(pa.render(da,_r),J)}),we.data.hasMore?(J.disabled=!1,J.textContent="Daha Fazla G\xF6ster"):J.remove()}else J.disabled=!1,J.textContent="Tekrar Dene"},P.appendChild(J)}C.appendChild(P),Ae(A),Mr(P,"reviews-widget",{productId:e||""},function(){return A.getElementById("renuvex-reviews-widget")})}catch(B){console.error("[renuvex-pr] render error:",B);var Ir=document.createElement("p");Ir.style.cssText="text-align:center;color:#dc2626;",Ir.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",C&&C.replaceChildren(Ir)}}finally{if(dr(!1),pr){var Le=pr;ur(null),or(Le.productId,Le.settings,Le.reviewsData,Le.productName,Le.orderBy,Le.page,Le.badgeSettings)}}}export{or as render};
