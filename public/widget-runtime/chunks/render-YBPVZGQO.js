...
`}var gl=Ua(vi),ci=Ua(_r);function mi(e,r){var p;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let a=t.get("media-theme-gerwig"),n=a==null?void 0:a.template;if(!a||!(n instanceof HTMLTemplateElement))return;let i=n.cloneNode(!0);i.id=e,(p=i.content.querySelector("media-controller"))==null||p.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class l extends a{}l.template=i,t.define(e,l)}function fi(e,r){return typeof window=="undefined"?Promise.resolve():(at!=null||(at=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),at.then(()=>{mi(e,r)}))}function Ha(){return fi(si,ci)}var Et=null,Ya="--center-play-button";function xi(){return Et||(Et=Ha()),Et}function gi(e){return new Promise(function(r){function t(a){if(a<=0){r();return}requestAnimationFrame(function(){t(a-1)})}t(e)})}function hi(e){e.style.setProperty(Ya,"none")}function Da(e){e.style.removeProperty(Ya)}function bi(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=ka(e.url);return r&&t&&r!==t?"":r||t}function yi(e,r){var t=bi(r);if(!t)return!1;var a=lr(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("nohotkeys",""),e.setAttribute("lang","tr"),e.setAttribute("theme",Oa),e.setAttribute("accent-color",_r.controlForeground),e.setAttribute("primary-color",_r.controlForeground),e.setAttribute("secondary-color",_r.controlBackground),a&&e.setAttribute("poster",a),e.setAttribute("playback-id",t),!0}function Va(e){e.preventDefault()}function Wa(e,r){var t=!1,a=document.createElement("mux-player");a.className=r||"renuvex-pr-modal-main-video",a.setAttribute("aria-label","Yorum videosu"),hi(a),a.addEventListener("contextmenu",Va);var n=yi(a,e);return n?xi().then(function(){if(window.customElements&&typeof window.customElements.whenDefined=="function")return window.customElements.whenDefined("mux-player")}).then(function(){if(!t){try{typeof a.pause=="function"&&a.pause()}catch(i){}return gi(2)}}).then(function(){t||Da(a)}).catch(function(){t||a.dispatchEvent(new Event("error"))}):setTimeout(function(){t||a.dispatchEvent(new Event("error"))},0),{element:a,cleanup:function(){t=!0;try{typeof a.pause=="function"&&a.pause()}catch(o){}a.removeAttribute("playback-id"),a.removeAttribute("playback-token"),a.removeAttribute("thumbnail-token"),a.removeAttribute("poster"),Da(a),a.removeEventListener("contextmenu",Va)}}}function vr(e){return Ue(e)}function ja(e){return e&&e.source==="mediaGallery"}function wi(e,r){if(!ja(r))return vr(e);var t=we(e);return t?[t]:[]}function ki(e,r){return(e||[]).filter(function(t){return r==="mediaGallery"?!!we(t):vr(t).length>0})}function At(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Ga(e,r,t,a,n,i){e&&e.shadowRoot&&At(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),Jr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Vr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&fe(n)}function Si(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=Te(e.rating,F);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Ae(e.createdAt),a.appendChild(n),a.appendChild(i),t.appendChild(a);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-modal-author",l.textContent=e.author||"",t.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-modal-body",p.textContent=(e.comment||"").trim(),p.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(p);var d=document.createElement("div");d.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=D(F&&F.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",d.appendChild(m),d.appendChild(v),d.style.display=e.merchantReply?"":"none",t.appendChild(d),r.appendChild(t),r}function Ka(e,r,t){var a=t||F,n=e.querySelector(".renuvex-pr-modal-scroll-content"),i=n.querySelector(".renuvex-pr-modal-stars");i.innerHTML=Te(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=Ae(r.createdAt);var o=n.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var l=n.querySelector(".renuvex-pr-modal-body");l.textContent=(r.comment||"").trim(),l.style.display=r.comment&&r.comment.trim()?"":"none";var p=n.querySelector(".renuvex-pr-modal-reply");p.querySelector(".renuvex-pr-modal-reply-label").textContent=D(a&&a.merchantReplyLabel,"Ma\u011Faza Sahibi"),p.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",p.style.display=r.merchantReply?"":"none",e.scrollTop=0}var zi=112;function Mt(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function Ci(e){var r=e&&e.target;return!!(r&&typeof r.closest=="function"&&r.closest(".renuvex-pr-modal-thumbs"))}function Ei(e,r,t){if(!r||r.type!=="video"||!t)return!1;var a=Mt(e);if(!a)return!1;var n=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!n||typeof n.getBoundingClientRect!="function")return!1;var i=n.getBoundingClientRect();if(!i.width||!i.height||a.clientX<i.left||a.clientX>i.right||a.clientY<i.top||a.clientY>i.bottom)return!1;var o=Math.min(zi,Math.max(72,i.height*.2));return a.clientY>=i.bottom-o}function qa(e){var r=e&&e.type==="video"?e.posterUrl:e&&e.url;if(e&&e.type==="video"){var t={width:Oe,height:Oe,fit:"crop"};return{src:lr(r,t),srcset:jr(r,t)}}return Ar(e,Oe)}function Ti(e,r,t){var a=e&&e.media;if(!a)return null;var n=document.createElement("button");n.type="button",n.className="renuvex-pr-modal-thumb renuvex-pr-modal-thumb-button"+(a.type==="video"?" renuvex-pr-modal-thumb-video":"")+(r?" renuvex-pr-modal-thumb-active":""),n.setAttribute("aria-label","Galeri medyas\u0131 "+(e.index+1)+" se\xE7"),r&&n.setAttribute("aria-current","true");var i=document.createElement("img");i.className="renuvex-pr-modal-thumb-img";var o=qa(a);if(i.src=o.src,o.srcset&&(i.srcset=o.srcset),i.loading="lazy",i.decoding="async",i.width=Oe,i.height=Oe,i.alt="",Tr(i),n.appendChild(i),a.type==="video"){var l=document.createElement("span");l.className="renuvex-pr-modal-thumb-play";var p=re(nr);p&&l.appendChild(p),n.appendChild(l)}return n.onclick=t,n}function Ai(e){var r=[];return(e||[]).forEach(function(t,a){var n=we(t);n&&r.push({review:t,reviewIdx:a,media:n,index:r.length})}),r}function _t(e,r,t,a,n,i,o,l,p){var d=wi(e,p),m=Math.max(0,Math.min(t||0,d.length-1)),v=d[m],u=document.createElement("div");u.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var g=Wa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),c=g.element;c.addEventListener("error",function(){if(!u.querySelector(".renuvex-pr-modal-img-error")){var I=document.createElement("div");I.className="renuvex-pr-modal-img-error",I.setAttribute("role","status"),I.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",u.insertBefore(I,c)}});var f=!1,b=function(){u.classList.add("renuvex-pr-modal-left-video-playing")},w=function(){f=!0,b()},E=function(){f&&b()},M=function(){f=!1,u.classList.remove("renuvex-pr-modal-left-video-playing")};c.addEventListener("play",w),c.addEventListener("playing",w),c.addEventListener("pause",E),c.addEventListener("ended",M),u.__renuvexMediaCleanup=function(){c.removeEventListener("play",w),c.removeEventListener("playing",w),c.removeEventListener("pause",E),c.removeEventListener("ended",M),M(),g.cleanup()},u.appendChild(c)}else{var S=document.createElement("img");S.className="renuvex-pr-modal-main-img"+(s?" "+s:"");var R=Ar(v,Gr,{preferFullSize:!0});if(S.src=R.src,R.srcset&&(S.srcset=R.srcset),S.decoding="async",S.width=Gr,S.height=Math.round(Gr*4/3),S.alt="Yorum foto\u011Fraf\u0131",!s){S.classList.add("renuvex-pr-modal-img-loading");var y=function(){S.classList.remove("renuvex-pr-modal-img-loading")};S.complete&&S.naturalWidth>0?y():(S.addEventListener("load",y,{once:!0}),S.addEventListener("error",y,{once:!0}))}ya(S,function(I){if(I.style.display="none",!u.querySelector(".renuvex-pr-modal-img-error")){var P=document.createElement("div");P.className="renuvex-pr-modal-img-error",P.setAttribute("role","status"),P.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",u.insertBefore(P,I)}}),u.appendChild(S)}var A=document.createElement("button");A.className="renuvex-pr-modal-close-mobile";var k=re(Ee);k&&A.appendChild(k),A.setAttribute("aria-label","Kapat"),A.onclick=function(I){I.stopPropagation(),i()},u.appendChild(A);var C=0,T=!1,h=!1;if(u.addEventListener("touchstart",function(I){var P=Mt(I);P&&(h=Ci(I),C=P.clientX,T=!h&&Ei(I,v,u))},{passive:!0}),u.addEventListener("touchend",function(I){if(h){h=!1,T=!1;return}if(T){T=!1;return}var P=Mt(I);if(P){var O=C-P.clientX;if(!(Math.abs(O)<50)){if(O>0){if(_)Se(e,r,m+1,a,n,i,!0,"next",l,p);else if(L){var $=a[r+1];Se($,r+1,0,a,n,i,!1,"next",l,p)}}else if(x)Se(e,r,m-1,a,n,i,!0,"prev",l,p);else if(N){var G=a[r-1],Y=vr(G);Se(G,r-1,Y.length-1,a,n,i,!1,"prev",l,p)}}}},{passive:!0}),ja(p)){var z=Ai(a);if(z.length>1){var B=document.createElement("div");B.className="renuvex-pr-modal-thumbs renuvex-pr-modal-thumbs--gallery",z.forEach(function(I){var P=Ti(I,I.reviewIdx===r,function(){Se(I.review,I.reviewIdx,0,a,n,i,!1,null,l,p)});P&&B.appendChild(P)}),u.appendChild(B)}}else if(d.length>1){var U=document.createElement("div");U.className="renuvex-pr-modal-thumbs",d.forEach(function(I,P){var O=document.createElement("img"),$=qa(I);O.src=$.src,O.srcset=$.srcset,O.loading="lazy",O.decoding="async",O.width=Oe,O.height=Oe,O.className="renuvex-pr-modal-thumb"+(P===m?" renuvex-pr-modal-thumb-active":""),O.alt="K\xFC\xE7\xFCk resim "+(P+1),Tr(O),O.tabIndex=0,O.setAttribute("role","button"),O.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(P+1)+" se\xE7"),P===m&&O.setAttribute("aria-current","true"),(function(G){function Y(){Se(e,r,G,a,n,i,!0,null,l,p)}O.onclick=Y,O.onkeydown=function(J){(J.key==="Enter"||J.key===" ")&&(J.preventDefault(),Y())}})(P),U.appendChild(O)}),u.appendChild(U)}var x=m>0,_=m<d.length-1,N=r>0,L=r<a.length-1,V=x||N,j=_||L;if(V){var H=document.createElement("button");H.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var X=re(ar);X&&H.appendChild(X),H.setAttribute("aria-label","\xD6nceki"),H.onclick=function(I){if(I.stopPropagation(),x)Se(e,r,m-1,a,n,i,!0,"prev",l,p);else if(N){var P=a[r-1],O=vr(P);Se(P,r-1,O.length-1,a,n,i,!1,"prev",l,p)}},u.appendChild(H)}if(j){var W=document.createElement("button");W.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var q=re(Yr);q&&W.appendChild(q),W.setAttribute("aria-label","Sonraki"),W.onclick=function(I){if(I.stopPropagation(),_)Se(e,r,m+1,a,n,i,!0,"next",l,p);else if(L){var P=a[r+1];Se(P,r+1,0,a,n,i,!1,"next",l,p)}},u.appendChild(W)}return u}function Xa(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=vr(a);n[0]&&n[0].type==="image"&&(new Image().src=ba(n[0].url))}})}function Tt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function Mi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){Tt(t),Tt(a),Tt(n)}i(),t&&fe(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Se(e,r,t,a,n,i,o,l,p,d){if(d&&(d.currentReview=e),o){var m=_t(e,r,t,a,n,i,l,p,d);n.firstChild&&(At(n.firstChild),n.replaceChild(m,n.firstChild))}else{var m=_t(e,r,t,a,n,i,l,p,d),v=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&(At(n.firstChild),n.replaceChild(m,n.firstChild)),v&&Ka(v,e,d&&d.currentSettings),Mi(p,n)}Xa(r,a)}function ge(e,r,t,a){var n=a&&a.source==="mediaGallery"?"mediaGallery":"review",i=n==="mediaGallery"?we(e)?[we(e)]:[]:vr(e);if(!i.length)return;var o=ki(t,n),l=o.findIndex(function(C){return C===e||C.id===e.id});l===-1&&(o.unshift(e),l=0);var p=i.findIndex(function(C){return C.url===r});p<0&&(p=0);var d=document.createElement("div");d.className="renuvex-pr-modal-overlay";var m=document.createElement("div");m.className="renuvex-pr-modal";var v=!1,u=null,s=Zr(),g=Ne(),c=$r(),f=et(),b={currentReview:e,currentSettings:F,source:n},w=null;function E(C){var T=C&&C.detail&&C.detail.settings;if(!(T&&T===w)){w=T||null,b.currentSettings=T||F;var h=m.querySelector(".renuvex-pr-modal-right");!h||!b.currentReview||Ka(h,b.currentReview,b.currentSettings)}}function M(){v||(v=!0,window.removeEventListener(je,E),Ga(u&&u.host,S,M,c,s,g))}function S(C){if(C.key==="Escape"){R();return}Qr(C,d,u&&u.root)}function R(){v||(v=!0,window.removeEventListener(je,E),Ga(u&&u.host,S,M,c,s,g),rt(f))}document.addEventListener("keydown",S),window.addEventListener("popstate",M),window.addEventListener(je,E),d.onclick=function(){R()},m.onclick=function(C){C.stopPropagation()},m.appendChild(_t(e,l,p,o,m,R,null,d,b)),m.appendChild(Si(e)),Xa(l,o);var y=document.createElement("div");y.className="renuvex-pr-modal-wrap",y.tabIndex=-1,y.setAttribute("role","dialog"),y.setAttribute("aria-modal","true"),y.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),y.appendChild(m);var A=document.createElement("button");A.className="renuvex-pr-modal-close";var k=re(Ee);k&&A.appendChild(k),A.setAttribute("aria-label","Kapat"),A.onclick=function(C){C.stopPropagation(),R()},y.appendChild(A),d.appendChild(y),u=qr(),pr(u.root,dr+tr+Xr),Kr(u.root,d),Ge(u.root),fe(y)}function cr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var Ot={};Re(Ot,{css:()=>xo,meta:()=>fo,render:()=>go});function mr(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,i=e.onFilterChange;Ie(a);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var l=5;l>=1;l--){var p=r[l-1]||0,d=t>0?Math.round(p/t*100):0,m=n===l,v=p>0,u=D(F&&F.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(n&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",l+" y\u0131ld\u0131z, "+p.toLocaleString("tr-TR")+" "+u+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",l+" y\u0131ld\u0131z, 0 "+u);for(var g="",c=1;c<=5;c++){var f=c<=l;g+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(f?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ve(f?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+g+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+d+'%;"></div></div><span class="renuvex-pr-bar-count">('+p.toLocaleString("tr-TR")+")</span>",v&&(function(b){function w(){i(b)}s.onclick=w,s.onkeydown=function(E){(E.key==="Enter"||E.key===" "||E.key==="Space"||E.key==="Spacebar")&&(E.preventDefault(),w())}})(l),o.appendChild(s)}return o}var Za="data-renuvex-pr-dismiss-gesture",qe=[],$a=!1,nt=!1,Pr=[],fr=null;function Ja(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Pt(){for(var e=qe.length-1;e>=0;e--){var r=qe[e].element;r&&r.isConnected===!1&&qe.splice(e,1)}return qe}function _i(e){!e||typeof e.setAttribute!="function"||(Pr.indexOf(e)===-1&&Pr.push(e),e.setAttribute(Za,""))}function Qa(){for(var e=0;e<Pr.length;e++){var r=Pr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Za)}Pr=[],fr&&typeof clearTimeout=="function"&&clearTimeout(fr),fr=null}function Pi(e){if(nt){nt=!1,Qa(),e.preventDefault(),e.stopPropagation();return}for(var r=Pt(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Ja(e,n.trigger)||Ja(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Li(e){if(e.key==="Escape")for(var r=Pt(),t=r.length-1;t>=0;t--)r[t].close()}function en(){$a||typeof document=="undefined"||(document.addEventListener("click",Pi,!0),document.addEventListener("keydown",Li),$a=!0)}function Ri(e){en(),nt=!0,_i(e),fr&&typeof clearTimeout=="function"&&clearTimeout(fr),typeof setTimeout=="function"&&(fr=setTimeout(function(){nt=!1,Qa()},700))}function Lt(e){Ri(e)}function it(e){en();var r={trigger:e.trigger,element:e.element,close:e.close};return qe.push(r),{unregister:function(){var t=qe.indexOf(r);t!==-1&&qe.splice(t,1)},notifyOpening:function(){for(var t=Pt(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function ue(e){var r=e.widget,t=e.currentOrderBy,a=e.currentMediaFilter||"none",n=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var l=document.createElement("button");l.className="renuvex-pr-write-btn",l.textContent=D(F&&F.writeButtonText,"Yorum Yap"),l.onclick=n,o.appendChild(l);var p=document.createElement("div");p.className="renuvex-pr-filter-wrap";var d=document.createElement("button");d.type="button",d.className="renuvex-pr-filter-btn",d.setAttribute("aria-label","Filtrele"),d.setAttribute("aria-haspopup","menu"),d.setAttribute("aria-expanded","false");var m=F&&F.filterIcon||"lines";d.innerHTML=ce(ma(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var u=ta===!0?"media":"images",s=u==="media"?"Foto\u011Fraf ve Video":"Foto\u011Frafl\u0131",g=[{orderBy:"newest",label:"En Yeni",mediaFilter:"none"},{orderBy:"highest",label:"En Y\xFCksek Puan",mediaFilter:"none"},{orderBy:"lowest",label:"En D\xFC\u015F\xFCk Puan",mediaFilter:"none"},{orderBy:"newest",label:s,mediaFilter:u}],c=!1;function f(){return r&&r.parentNode||r||null}function b(S,R){if(!(R===!0||!S)){if(S.type==="touchstart"){Lt(f());return}if(S.type==="pointerdown"){var y=S.pointerType||"";y&&y!=="mouse"&&Lt(f())}}}function w(S){var R=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),d.classList.remove("renuvex-pr-filter-btn-active"),d.setAttribute("aria-expanded","false");var y=S&&(S.restoreFocus===!0||S.restoreFocus==="auto"&&Ne());if(R&&y)try{d.focus({preventScroll:!0})}catch(A){try{d.focus()}catch(k){}}return R}function E(){M.notifyOpening(),v.classList.add("renuvex-pr-open"),d.classList.add("renuvex-pr-filter-btn-active"),d.setAttribute("aria-expanded","true");var S=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");S&&requestAnimationFrame(function(){try{S.focus({preventScroll:!0})}catch(R){try{S.focus()}catch(y){}}})}g.forEach(function(S){var R=S.mediaFilter!=="none",y=R?a===S.mediaFilter:a==="none"&&(t||"newest")===S.orderBy,A=document.createElement("button");A.type="button",A.className="renuvex-pr-filter-item"+(y?" renuvex-pr-filter-item-active":""),A.setAttribute("role","menuitem"),A.textContent=S.label;var k=!1;function C(T,h){T&&(T.preventDefault(),T.stopPropagation()),!k&&(k=!0,c=!0,b(T,h),w({restoreFocus:h}),i(S.orderBy,S.mediaFilter),setTimeout(function(){k=!1,c=!1},0))}A.addEventListener("pointerdown",function(T){T.button!==void 0&&T.button!==0||T.pointerType!=="mouse"&&C(T,!1)}),typeof window!="undefined"&&!window.PointerEvent&&A.addEventListener("touchstart",function(T){C(T,!1)},{passive:!1}),A.addEventListener("keydown",function(T){(T.key==="Enter"||T.key===" ")&&C(T,!0)}),A.onclick=function(T){C(T,!1)},v.appendChild(A)}),d.onclick=function(){v.classList.contains("renuvex-pr-open")?w({restoreFocus:"auto"}):E()},p.addEventListener("keydown",function(S){S.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(S.stopPropagation(),w({restoreFocus:!0}))}),p.addEventListener("focusout",function(S){if(v.classList.contains("renuvex-pr-open")&&!c){var R=S.relatedTarget;R&&p.contains(R)||w()}});var M=it({trigger:p,element:v,close:w});return p.appendChild(d),p.appendChild(v),o.appendChild(p),o}var rn=`
...
`;var ho={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},bo=Ln,yo="__unknown_product__",Br=Object.create(null);function wo(e){return e?String(e):yo}var $e=null,Ir=null;function ko(){!$e||!Ir||($e.removeEventListener?$e.removeEventListener("change",Ir):$e.removeListener&&$e.removeListener(Ir),$e=null,Ir=null)}function So(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,i=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,p=e.currentRatingFilter,d=e.currentOrderBy,m=e.currentMediaFilter,v=e.onFilterChange,u=e.onSortChange,s=wo(t),g=document.createElement("div");g.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var f=document.createElement("div");f.className="renuvex-pr-compact-trigger-wrap";var b=document.createElement("button");b.className="renuvex-pr-compact-trigger",b.type="button",b.setAttribute("aria-expanded","false"),b.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Fe(l,n)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+ce(fa)+"</span>";var w=b.querySelector(".renuvex-pr-compact-trigger-text"),E=b.querySelector(".renuvex-pr-compact-chevron");if(w&&(w.textContent=i.toLocaleString("tr-TR")+" "+D(a.countLabel,"Yorum")),w&&E){var M=document.createElement("span");M.className="renuvex-pr-compact-trigger-count",b.insertBefore(M,w),M.appendChild(w),M.appendChild(E)}f.appendChild(b),c.appendChild(f);var S=ue({widget:r,currentOrderBy:d,currentMediaFilter:m,onWriteClick:le,onSortChange:u}),R=S.querySelector(".renuvex-pr-filter-wrap"),y=S.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",y&&A.appendChild(y),R&&A.appendChild(R),c.appendChild(A),g.appendChild(c);var k=document.createElement("div");k.className="renuvex-pr-compact-panel",k.setAttribute("role","dialog"),k.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),k.setAttribute("aria-hidden","true");var C=document.createElement("div");C.className="renuvex-pr-compact-panel-inner";var T=document.createElement("div");T.className="renuvex-pr-compact-avg",T.innerHTML='<span class="renuvex-pr-icon">'+ve("full")+"</span><span>"+l+"</span>",C.appendChild(T),C.appendChild(mr({ratingCounts:o,allCount:i,iconPair:n,currentRatingFilter:p,onFilterChange:function(P){z()&&k.classList.contains("renuvex-pr-open")&&(Br[s]=!0),v(P)}})),k.appendChild(C);var h=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function z(){return!!(h&&h.matches)}function B(P){P?k.classList.add("renuvex-pr-open"):k.classList.remove("renuvex-pr-open"),k.setAttribute("aria-hidden",P?"false":"true"),b.setAttribute("aria-expanded",P?"true":"false")}function U(P){var O=P?g:f;if(k.parentNode!==O){var $=!!k.parentNode;k.classList.contains("renuvex-pr-open")&&B(!1),$&&(Br[s]=!1),O.appendChild(k)}}U(h?h.matches:!1);var x=ue({widget:r,currentOrderBy:d,currentMediaFilter:m,onWriteClick:le,onSortChange:u}),_=x.querySelector(".renuvex-pr-filter-wrap"),N=x.querySelector(".renuvex-pr-write-btn"),L=document.createElement("div");L.className="renuvex-pr-compact-write-row",N&&L.appendChild(N),_&&L.appendChild(_),g.appendChild(L);function V(){var P=k.classList.contains("renuvex-pr-open");return B(!1),z()&&(Br[s]=!1),P}function j(){H&&H.notifyOpening(),B(!0),z()&&(Br[s]=!0)}b.onclick=function(){k.classList.contains("renuvex-pr-open")?V():j()};var H=null;function X(P){H&&(H.unregister(),H=null),P||(H=it({trigger:f,element:k,close:V}))}if(X(h?h.matches:!1),ko(),h){var W=function(P){U(P.matches),X(P.matches)};h.addEventListener?h.addEventListener("change",W):h.addListener&&h.addListener(W),$e=h,Ir=W}if(z()&&Br[s]&&B(!0),a.showRecommendation!==!1){var q=yr(o,i);if(q>0){var I=wr(a,q);I.style.marginTop="8px",C.appendChild(I)}}return g}var Ht={};Re(Ht,{css:()=>Co,meta:()=>zo,render:()=>Eo});var Rn=`
