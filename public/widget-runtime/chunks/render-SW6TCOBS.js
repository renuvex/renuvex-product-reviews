...
`;var yi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},wi=rn,ki="__unknown_product__",cr=Object.create(null);function Si(e){return e?String(e):ki}var Oe=null,mr=null;function zi(){!Oe||!mr||(Oe.removeEventListener?Oe.removeEventListener("change",mr):Oe.removeListener&&Oe.removeListener(mr),Oe=null,mr=null)}function Ci(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,c=e.currentHasImages,m=e.onFilterChange,d=e.onSortChange,v=Si(t),k=document.createElement("div");k.className="renuvex-pr-summary renuvex-pr-summary-compact";var s=document.createElement("div");s.className="renuvex-pr-compact-header";var x=document.createElement("div");x.className="renuvex-pr-compact-trigger-wrap";var g=document.createElement("button");g.className="renuvex-pr-compact-trigger",g.type="button",g.setAttribute("aria-expanded","false"),g.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Pe(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+le(Jt)+"</span>";var y=g.querySelector(".renuvex-pr-compact-trigger-text"),h=g.querySelector(".renuvex-pr-compact-chevron");if(y&&(y.textContent=i.toLocaleString("tr-TR")+" "+O(n.countLabel,"Yorum")),y&&h){var w=document.createElement("span");w.className="renuvex-pr-compact-trigger-count",g.insertBefore(w,y),w.appendChild(y),w.appendChild(h)}x.appendChild(g),s.appendChild(x);var b=ne({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:$,onSortChange:d}),S=b.querySelector(".renuvex-pr-filter-wrap"),z=b.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",z&&A.appendChild(z),S&&A.appendChild(S),s.appendChild(A),k.appendChild(s);var C=document.createElement("div");C.className="renuvex-pr-compact-panel",C.setAttribute("role","dialog"),C.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),C.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var f=document.createElement("div");f.className="renuvex-pr-compact-avg",f.innerHTML='<span class="renuvex-pr-icon">'+oe("full")+"</span><span>"+p+"</span>",T.appendChild(f),T.appendChild(Ke({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(F){P()&&C.classList.contains("renuvex-pr-open")&&(cr[v]=!0),m(F)}})),C.appendChild(T);var E=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(E&&E.matches)}function M(F){F?C.classList.add("renuvex-pr-open"):C.classList.remove("renuvex-pr-open"),C.setAttribute("aria-hidden",F?"false":"true"),g.setAttribute("aria-expanded",F?"true":"false")}function N(F){var D=F?k:x;if(C.parentNode!==D){var ve=!!C.parentNode;C.classList.contains("renuvex-pr-open")&&M(!1),ve&&(cr[v]=!1),D.appendChild(C)}}N(E?E.matches:!1);var L=ne({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:$,onSortChange:d}),H=L.querySelector(".renuvex-pr-filter-wrap"),R=L.querySelector(".renuvex-pr-write-btn"),I=document.createElement("div");I.className="renuvex-pr-compact-write-row",R&&I.appendChild(R),H&&I.appendChild(H),k.appendChild(I);function G(){var F=C.classList.contains("renuvex-pr-open");return M(!1),P()&&(cr[v]=!1),F}function U(){B&&B.notifyOpening(),M(!0),P()&&(cr[v]=!0)}g.onclick=function(){C.classList.contains("renuvex-pr-open")?G():U()};var B=null;function K(F){B&&(B.unregister(),B=null),F||(B=qr({trigger:x,element:C,close:G}))}if(K(E?E.matches:!1),zi(),E){var Y=function(F){N(F.matches),K(F.matches)};E.addEventListener?E.addEventListener("change",Y):E.addListener&&E.addListener(Y),Oe=E,mr=Y}if(P()&&cr[v]&&M(!0),n.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),se=i>0?Math.round(X/i*100):0;if(se>0){var Q=document.createElement("div");Q.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",Q.style.marginTop="8px",Q.innerHTML='<span class="renuvex-pr-recommend-pct">%'+se+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(Q)}}return k}var St={};Ce(St,{css:()=>Ti,meta:()=>Ei,render:()=>Ai});var tn=`
