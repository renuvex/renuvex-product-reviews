...
import{b as xt,c as Ue}from"./chunk-W6RJS6FO.js";import{c as ze}from"./chunk-WWGCW5YN.js";import{a as We,d as Pe}from"./chunk-N7KC6W47.js";import{A as oa,B as la,C as Er,D as Tr,E as Ar,a as re,b as pr,c as ie,d as oe,e as Z,f as N,g as Xt,h as Be,j as zr,k as ct,l as $t,m as Cr,n as Ie,o as Jt,p as Zt,q as Qt,r as ea,s as ra,t as ta,u as aa,v as _e,y as na,z as ia}from"./chunk-H43GKW4S.js";import{A as Se,B as Rr,C as ca,D as le,E as Nr,F as Br,G as mt,H as ft,I as Ir,J as ma,K as Or,L as fa,M as xa,c as vt,e as Me,f as de,g as se,h as ee,i as Oe,j as Pr,k as ur,l as pa,m as qe,n as _r,o as ua,p as we,q as Mr,r as da,s as Lr,u as H,v as sa,w as ke,x as Le,z as va}from"./chunk-4HUG5ZRS.js";import{a as ue,b as ye,h as ga,i as Fe}from"./chunk-UOBLDAJF.js";import"./chunk-W53BN4EO.js";import{a as st,b as Kt,d as Ae}from"./chunk-D4BSMMIO.js";function gt(e){if(typeof e!="string"||!e)return!1;try{var r=new URL(e);if(r.protocol!=="https:"||r.username||r.password)return!1;var t=r.hostname.toLowerCase();return t==="stream.mux.com"||t==="image.mux.com"}catch(n){return!1}}function Yn(e){return!e||!gt(e.href)?!1:e.hostname.toLowerCase()==="image.mux.com"?/\/thumbnail\.(jpg|jpeg|png|webp)$/i.test(e.pathname):!1}function Fr(e){if(typeof e!="string"||!e)return"";try{var r=new URL(e);if(r.protocol!=="https:"||r.username||r.password)return"";var t=r.hostname.toLowerCase();if(t!=="stream.mux.com"&&t!=="image.mux.com")return"";var n=r.pathname.split("/").filter(Boolean);return t==="stream.mux.com"&&n.length===1&&n[0].endsWith(".m3u8")?decodeURIComponent(n[0].slice(0,-5)):t==="image.mux.com"&&n.length>=2&&/^thumbnail\.(jpg|jpeg|png|webp)$/i.test(n[1])?decodeURIComponent(n[0]):""}catch(a){return""}}function Ur(e){var r=Number(e);return Number.isFinite(r)&&r>0?Math.round(r):0}function Ge(e,r){if(r=r||{},typeof e!="string"||!e)return"";var t;try{t=new URL(e)}catch(i){return e}if(!Yn(t))return e;var n=Ur(r.width),a=Ur(r.height);return n&&t.searchParams.set("width",String(n)),a&&t.searchParams.set("height",String(a)),t.hostname.toLowerCase()==="image.mux.com"&&(r.fit==="crop"||r.fit==="smartcrop"||r.fit==="pad"||r.fit==="stretch"||r.fit==="preserve"?t.searchParams.set("fit_mode",r.fit):r.fit&&t.searchParams.set("fit_mode","preserve")),t.href}function ha(e,r){r=r||{};var t=Ur(r.width),n=Ur(r.height);if(!t&&!n)return"";var a=Ge(e,{width:t,height:n,fit:r.fit}),i=Ge(e,{width:t?t*2:0,height:n?n*2:0,fit:r.fit});return!a||!i||a===e||i===e?"":a+" 1x, "+i+" 2x"}function Ce(e){var r=[],t={},n=e&&Array.isArray(e.media)?e.media:[];return n.forEach(function(a){if(!(!a||typeof a!="object")){if(a.type==="video"){if(!gt(a.url)||!gt(a.posterUrl||a.thumbnailUrl))return;var i=typeof a.playbackId=="string"?a.playbackId.trim():"",o=Fr(a.url);if(i&&o&&i!==o||(i=i||o,!i))return;var p=Fr(a.posterUrl||a.thumbnailUrl);if(p!==i)return;var l="video:"+a.url;if(t[l])return;t[l]=!0,r.push({type:"video",url:a.url,playbackId:i,posterUrl:a.posterUrl||a.thumbnailUrl,thumbnailUrl:a.thumbnailUrl||a.posterUrl,durationMs:typeof a.durationMs=="number"?a.durationMs:null,width:typeof a.width=="number"?a.width:null,height:typeof a.height=="number"?a.height:null,position:typeof a.position=="number"?a.position:r.length});return}if(a.type==="image"&&Rr(a.url)){var u="image:"+a.url.trim();if(t[u])return;t[u]=!0,r.push({type:"image",url:a.url.trim(),thumbnailUrl:a.thumbnailUrl||null,posterUrl:null,durationMs:null,width:typeof a.width=="number"?a.width:null,height:typeof a.height=="number"?a.height:null,position:typeof a.position=="number"?a.position:r.length})}}}),ca(e).forEach(function(a){var i="image:"+a;t[i]||(t[i]=!0,r.push({type:"image",url:a,thumbnailUrl:null,posterUrl:null,durationMs:null,width:null,height:null,position:r.length}))}),r.sort(function(a,i){return a.position-i.position})}function Hr(e){var r=Ce(e);return r.length?r[0]:null}function ba(e){return e&&e.type==="video"?e.posterUrl:e&&e.url}function ya(e){if(typeof e!="number"||e<=0)return"";var r=Math.max(0,Math.round(e/1e3)),t=Math.floor(r/60),n=String(r%60).padStart(2,"0");return t+":"+n}var Ke=":host{display:block;box-sizing:border-box;-webkit-tap-highlight-color:transparent;font-family:inherit;color:inherit;line-height:inherit;font-size:inherit;letter-spacing:inherit;text-align:start;}:host *,:host *::before,:host *::after{box-sizing:border-box;}";function wa(e){return e?e.shadowRoot||e.attachShadow({mode:"open"}):null}function Xe(e,r){if(e){var t=e.querySelector("style[data-renuvex-shadow-style]");t||(t=document.createElement("style"),t.setAttribute("data-renuvex-shadow-style",""),e.appendChild(t)),t.textContent=r||""}}function Vr(){var e=document.createElement("div");e.setAttribute("data-renuvex-shadow-overlay",""),document.body.appendChild(e);var r=e.attachShadow({mode:"open"});return{host:e,root:r}}function ka(e){var r=document.activeElement;return e&&r===e.host&&e.activeElement||r}function Sa(e){if(!e)return null;var r=e.querySelector("[data-renuvex-shadow-content]");return r||(r=document.createElement("div"),r.setAttribute("data-renuvex-shadow-content",""),e.appendChild(r),r)}var za=`
...
`;var _a=`
  ...
  .renuvex-pr-modal-main-video{border:0;--media-object-fit:contain;--media-object-position:center;--seek-backward-button:none;--seek-forward-button:none;--airplay-button:none;--pip-button:none;--cast-button:none;--playback-rate-button:none;--rendition-menu-button:none;--audio-track-menu-button:none;--controls-backdrop-color:rgba(0,0,0,0.58);--media-primary-color:var(--renuvex-pr-review-lightbox-video-icon,#ffffff);--media-secondary-color:var(--renuvex-pr-review-lightbox-video-button-bg,#000000);}
...
`;var Dr=[za,va,Ea,Ta,Aa,Pa,Ma,_a,Ca].join(`
`);function jn(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function xe(e,r,t,n){t?e.setProperty(r,t,n||""):e.removeProperty(r)}function Wn(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,n=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return n&&/AppleWebKit/i.test(r)}function qn(e){var r=document.body.style,t=document.documentElement.style,n=Math.max(0,window.innerWidth-document.documentElement.clientWidth),a=window.getComputedStyle(document.body).position==="fixed",i=Wn()&&!a;if(n>0){var o=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",o+n+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),i&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Gn(e){var r=document.body.style,t=document.documentElement.style;xe(t,"overflow",e.rootOverflow,e.rootOverflowPriority),xe(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),xe(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),xe(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),xe(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),xe(r,"position",e.bodyPosition,e.bodyPositionPriority),xe(r,"top",e.bodyTop,e.bodyTopPriority),xe(r,"left",e.bodyLeft,e.bodyLeftPriority),xe(r,"right",e.bodyRight,e.bodyRightPriority),xe(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var dr=0,$e=null;function Yr(){return dr+=1,dr>1||($e=jn(),qn($e)),$e}function jr(){if(dr!==0&&(dr-=1,!(dr>0))){var e=$e;$e=null,e&&Gn(e)}}function Kn(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function Wr(){var e=Kn();return!e||e===document.body||e===document.documentElement?null:e}function ve(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function Xn(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function ht(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Xn)}function $n(e,r){var t=e,n=ht(e);!n.length&&r&&(t=r,n=ht(r));var a=n[0]||t&&t.querySelector('[role="dialog"]')||t;ve(a)}function qr(e,r,t){if(e.key==="Tab"){var n=ht(r);if(!n.length){e.preventDefault(),$n(r);return}var a=n[0],i=n[n.length-1],o=ka(t);if(!r.contains(o)){e.preventDefault(),ve(a);return}if(n.indexOf(o)===-1){e.preventDefault(),ve(e.shiftKey?i:a);return}e.shiftKey&&o===a?(e.preventDefault(),ve(i)):!e.shiftKey&&o===i&&(e.preventDefault(),ve(a))}}var La="renuvexPrOverlay";function Gr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[La]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Jn(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[La]===e.id)}function Kr(e){if(Jn(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}var Zn="media-theme-renuvex-review-storefront";var Ra="renuvex-review-storefront",He={controlForeground:"#ffffff",controlBackground:"#000000",controlHoverBackground:"rgba(0,0,0,0.84)",controlsBackdrop:"rgba(0,0,0,0.58)",menuBackground:"#000000",menuBorder:"rgba(255,255,255,0.18)",menuText:"#ffffff",menuCheckedText:"#ffffff",menuHoverBackground:"rgba(255,255,255,0.12)",menuCheckedBackground:"rgba(255,255,255,0.18)",menuHoverOutline:"rgba(255,255,255,0.54) solid 1px",progressPlayed:"#ffffff",progressTrack:"#000000",progressPointer:"rgba(255,255,255,0.72)",progressBuffered:"rgba(255,255,255,0.28)",progressThumbBorder:"1px solid rgba(255,255,255,0.72)",progressThumbShadow:"0 0 0 1px rgba(0,0,0,0.45)",progressPointerBorder:"1px solid rgba(0,0,0,0.55)"};function Je(e,r){return`var(--renuvex-pr-review-lightbox-video-${e}, ${r})`}var Qn=st({},He),sr=Kt(st({},He),{controlForeground:Je("icon",He.controlForeground),controlBackground:Je("button-bg",He.controlBackground),controlHoverBackground:Je("button-hover-bg","#222222"),progressPlayed:Je("progress",He.progressPlayed),progressTrack:Je("progress-track",He.progressTrack),progressThumbBorder:`1px solid ${Je("progress",He.progressPlayed)}`}),Xr=null;function Na(e){return`
  :host {
...
`}var Qo=Na(Qn),ei=Na(sr);function ri(e,r){var l;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let n=t.get("media-theme-gerwig"),a=n==null?void 0:n.template;if(!n||!(a instanceof HTMLTemplateElement))return;let i=a.cloneNode(!0);i.id=e,(l=i.content.querySelector("media-controller"))==null||l.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class p extends n{}p.template=i,t.define(e,p)}function ti(e,r){return typeof window=="undefined"?Promise.resolve():(Xr!=null||(Xr=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),Xr.then(()=>{ri(e,r)}))}function Ba(){return ti(Zn,ei)}var yt=null;function ai(){return yt||(yt=Ba()),yt}function ni(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=Fr(e.url);return r&&t&&r!==t?"":r||t}function ii(e,r){var t=ni(r);if(!t)return!1;var n=Ge(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("playsinline",""),e.setAttribute("hotkeys","noarrowleft noarrowright"),e.setAttribute("lang","tr"),e.setAttribute("theme",Ra),e.setAttribute("accent-color",sr.controlForeground),e.setAttribute("primary-color",sr.controlForeground),e.setAttribute("secondary-color",sr.controlBackground),n&&e.setAttribute("poster",n),e.setAttribute("playback-id",t),!0}function Ia(e){e.preventDefault()}function oi(e){if(!e||typeof e.getFullscreenElement!="function")return null;var r=e.getFullscreenElement();return r&&typeof r.querySelector=="function"?r:null}function li(e,r){var t=oi(r),n=e&&e.mediaController;return!t||!t.isConnected||!n||!("fullscreenElement"in n)?!1:(n.fullscreenElement=t,!0)}function Oa(e,r,t){var n=!1,a=null,i=document.createElement("mux-player");i.className=r||"renuvex-pr-modal-main-video",i.setAttribute("aria-label","Yorum videosu"),i.addEventListener("contextmenu",Ia);function o(){a&&(clearTimeout(a),a=null)}function p(u){o(),!(n||li(i,t))&&(u>=10||(a=setTimeout(function(){p(u+1)},50)))}var l=ii(i,e);return l?ai().then(function(){p(0)}).catch(function(){n||i.dispatchEvent(new Event("error"))}):setTimeout(function(){n||i.dispatchEvent(new Event("error"))},0),{element:i,cleanup:function(){n=!0,o();try{typeof i.pause=="function"&&i.pause()}catch(c){}i.removeAttribute("playback-id"),i.removeAttribute("playback-token"),i.removeAttribute("thumbnail-token"),i.removeAttribute("poster"),i.removeEventListener("contextmenu",Ia)}}}function Ze(e){return Ce(e)}function pi(e){return e&&e.fullscreenElement?e.fullscreenElement:null}function kt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Fa(e,r,t,n,a,i){e&&e.shadowRoot&&kt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),jr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Pr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(a)}function ui(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ke(e.rating,N);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Se(e.createdAt),n.appendChild(a),n.appendChild(i),t.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-modal-author",p.textContent=e.author||"",t.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-modal-body",l.textContent=(e.comment||"").trim(),l.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(l);var u=document.createElement("div");u.className="renuvex-pr-modal-reply";var c=document.createElement("div");c.className="renuvex-pr-modal-reply-label",c.textContent=H(N&&N.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",u.appendChild(c),u.appendChild(v),u.style.display=e.merchantReply?"":"none",t.appendChild(u),r.appendChild(t),r}function Ua(e,r,t){var n=t||N,a=e.querySelector(".renuvex-pr-modal-scroll-content"),i=a.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ke(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=Se(r.createdAt);var o=a.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var p=a.querySelector(".renuvex-pr-modal-body");p.textContent=(r.comment||"").trim(),p.style.display=r.comment&&r.comment.trim()?"":"none";var l=a.querySelector(".renuvex-pr-modal-reply");l.querySelector(".renuvex-pr-modal-reply-label").textContent=H(n&&n.merchantReplyLabel,"Ma\u011Faza Sahibi"),l.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",l.style.display=r.merchantReply?"":"none",e.scrollTop=0}function St(e,r,t,n,a,i,o,p,l){var u=Ze(e),c=Math.max(0,Math.min(t||0,u.length-1)),v=u[c],d=document.createElement("div");d.className="renuvex-pr-modal-left",l&&(l.fullscreenElement=d);var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Oa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":""),{getFullscreenElement:function(){return pi(l)||d}}),f=x.element;f.addEventListener("error",function(){if(!d.querySelector(".renuvex-pr-modal-img-error")){var M=document.createElement("div");M.className="renuvex-pr-modal-img-error",M.setAttribute("role","status"),M.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",d.insertBefore(M,f)}}),d.__renuvexMediaCleanup=x.cleanup,d.appendChild(f)}else{var m=document.createElement("img");if(m.className="renuvex-pr-modal-main-img"+(s?" "+s:""),m.src=ft(v?v.url:""),m.decoding="async",m.width=mt,m.height=Math.round(mt*4/3),m.alt="Yorum foto\u011Fraf\u0131",!s){m.classList.add("renuvex-pr-modal-img-loading");var h=function(){m.classList.remove("renuvex-pr-modal-img-loading")};m.complete&&m.naturalWidth>0?h():(m.addEventListener("load",h,{once:!0}),m.addEventListener("error",h,{once:!0}))}ma(m,function(M){if(M.style.display="none",!d.querySelector(".renuvex-pr-modal-img-error")){var P=document.createElement("div");P.className="renuvex-pr-modal-img-error",P.setAttribute("role","status"),P.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",d.insertBefore(P,M)}}),d.appendChild(m)}var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var w=ee(we);w&&b.appendChild(w),b.setAttribute("aria-label","Kapat"),b.onclick=function(M){M.stopPropagation(),i()},d.appendChild(b);var E=0;if(d.addEventListener("touchstart",function(M){E=M.touches[0].clientX},{passive:!0}),d.addEventListener("touchend",function(M){var P=E-M.changedTouches[0].clientX;if(!(Math.abs(P)<50)){if(P>0){if(g)Ee(e,r,c+1,n,a,i,!0,"next",p,l);else if(C){var B=n[r+1];Ee(B,r+1,0,n,a,i,!1,"next",p,l)}}else if(S)Ee(e,r,c-1,n,a,i,!0,"prev",p,l);else if(k){var R=n[r-1],j=Ze(R);Ee(R,r-1,j.length-1,n,a,i,!1,"prev",p,l)}}},{passive:!0}),u.length>1){var T=document.createElement("div");T.className="renuvex-pr-modal-thumbs",u.forEach(function(M,P){var B=M.type==="video"?M.posterUrl:M.url,R=document.createElement("img"),j=Ir(B,Br);R.src=j.src,R.srcset=j.srcset,R.loading="lazy",R.decoding="async",R.width=Br,R.height=Br,R.className="renuvex-pr-modal-thumb"+(P===c?" renuvex-pr-modal-thumb-active":""),R.alt="K\xFC\xE7\xFCk resim "+(P+1),Or(R),R.tabIndex=0,R.setAttribute("role","button"),R.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(P+1)+" se\xE7"),P===c&&R.setAttribute("aria-current","true"),(function(J){function Y(){Ee(e,r,J,n,a,i,!0,null,p,l)}R.onclick=Y,R.onkeydown=function(U){(U.key==="Enter"||U.key===" ")&&(U.preventDefault(),Y())}})(P),T.appendChild(R)}),d.appendChild(T)}var S=c>0,g=c<u.length-1,k=r>0,C=r<n.length-1,z=S||k,A=g||C;if(z){var L=document.createElement("button");L.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var I=ee(qe);I&&L.appendChild(I),L.setAttribute("aria-label","\xD6nceki"),L.onclick=function(M){if(M.stopPropagation(),S)Ee(e,r,c-1,n,a,i,!0,"prev",p,l);else if(k){var P=n[r-1],B=Ze(P);Ee(P,r-1,B.length-1,n,a,i,!1,"prev",p,l)}},d.appendChild(L)}if(A){var _=document.createElement("button");_.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var y=ee(_r);y&&_.appendChild(y),_.setAttribute("aria-label","Sonraki"),_.onclick=function(M){if(M.stopPropagation(),g)Ee(e,r,c+1,n,a,i,!0,"next",p,l);else if(C){var P=n[r+1];Ee(P,r+1,0,n,a,i,!1,"next",p,l)}},d.appendChild(_)}return d}function Ha(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Ze(n);a[0]&&a[0].type==="image"&&(new Image().src=ft(a[0].url))}})}function wt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function di(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){wt(t),wt(n),wt(a)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Ee(e,r,t,n,a,i,o,p,l,u){if(u&&(u.currentReview=e),o){var c=St(e,r,t,n,a,i,p,l,u);a.firstChild&&(kt(a.firstChild),a.replaceChild(c,a.firstChild))}else{var c=St(e,r,t,n,a,i,p,l,u),v=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&(kt(a.firstChild),a.replaceChild(c,a.firstChild)),v&&Ua(v,e,u&&u.currentSettings),di(l,a)}Ha(r,n)}function ge(e,r,t){var n=Ze(e);if(!n.length)return;var a=(t||[]).filter(function(k){return Ze(k).length>0}),i=a.findIndex(function(k){return k===e||k.id===e.id});i===-1&&(a.unshift(e),i=0);var o=n.findIndex(function(k){return k.url===r});o<0&&(o=0);var p=document.createElement("div");p.className="renuvex-pr-modal-overlay";var l=document.createElement("div");l.className="renuvex-pr-modal";var u=!1,c=null,v=Wr(),d=Pe(),s=Yr(),x=Gr(),f={currentReview:e,currentSettings:N,fullscreenElement:null},m=null;function h(k){var C=k&&k.detail&&k.detail.settings;if(!(C&&C===m)){m=C||null,f.currentSettings=C||N;var z=l.querySelector(".renuvex-pr-modal-right");!z||!f.currentReview||Ua(z,f.currentReview,f.currentSettings)}}function b(){u||(u=!0,window.removeEventListener(Fe,h),Fa(c&&c.host,w,b,s,v,d))}function w(k){if(k.key==="Escape"){E();return}qr(k,p,c&&c.root)}function E(){u||(u=!0,window.removeEventListener(Fe,h),Fa(c&&c.host,w,b,s,v,d),Kr(x))}document.addEventListener("keydown",w),window.addEventListener("popstate",b),window.addEventListener(Fe,h),p.onclick=function(){E()},l.onclick=function(k){k.stopPropagation()},l.appendChild(St(e,i,o,a,l,E,null,p,f)),l.appendChild(ui(e)),Ha(i,a);var T=document.createElement("div");T.className="renuvex-pr-modal-wrap",T.tabIndex=-1,T.setAttribute("role","dialog"),T.setAttribute("aria-modal","true"),T.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),T.appendChild(l);var S=document.createElement("button");S.className="renuvex-pr-modal-close";var g=ee(we);g&&S.appendChild(g),S.setAttribute("aria-label","Kapat"),S.onclick=function(k){k.stopPropagation(),E()},T.appendChild(S),p.appendChild(T),c=Vr(),Xe(c.root,Ke+We+Dr),c.root.appendChild(p),Oe(c.root),ve(T)}function vr(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(n){(n.key==="Enter"||n.key===" "||n.key==="Spacebar")&&(n.preventDefault(),r())})}var Mt={};Ae(Mt,{css:()=>Xi,meta:()=>Ki,render:()=>$i});function Qe(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,i=e.onFilterChange;Me(n);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var p=5;p>=1;p--){var l=r[p-1]||0,u=t>0?Math.round(l/t*100):0,c=a===p,v=l>0,d=H(N&&N.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(c?" renuvex-pr-bar-active":"")+(a&&!c?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",c?"true":"false"),s.setAttribute("aria-label",p+" y\u0131ld\u0131z, "+l.toLocaleString("tr-TR")+" "+d+", "+(c?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",p+" y\u0131ld\u0131z, 0 "+d);for(var x="",f=1;f<=5;f++){var m=f<=p;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(m?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+de(m?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+u+'%;"></div></div><span class="renuvex-pr-bar-count">('+l.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Space"||w.key==="Spacebar")&&(w.preventDefault(),b())}})(p),o.appendChild(s)}return o}var Ya="data-renuvex-pr-dismiss-gesture",Ve=[],Va=!1,$r=!1,cr=[],er=null;function Da(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function zt(){for(var e=Ve.length-1;e>=0;e--){var r=Ve[e].element;r&&r.isConnected===!1&&Ve.splice(e,1)}return Ve}function si(e){!e||typeof e.setAttribute!="function"||(cr.indexOf(e)===-1&&cr.push(e),e.setAttribute(Ya,""))}function ja(){for(var e=0;e<cr.length;e++){var r=cr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Ya)}cr=[],er&&typeof clearTimeout=="function"&&clearTimeout(er),er=null}function vi(e){if($r){$r=!1,ja(),e.preventDefault(),e.stopPropagation();return}for(var r=zt(),t=!1,n=r.length-1;n>=0;n--){var a=r[n];Da(e,a.trigger)||Da(e,a.element)||a.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function ci(e){if(e.key==="Escape")for(var r=zt(),t=r.length-1;t>=0;t--)r[t].close()}function Wa(){Va||typeof document=="undefined"||(document.addEventListener("click",vi,!0),document.addEventListener("keydown",ci),Va=!0)}function mi(e){Wa(),$r=!0,si(e),er&&typeof clearTimeout=="function"&&clearTimeout(er),typeof setTimeout=="function"&&(er=setTimeout(function(){$r=!1,ja()},700))}function Ct(e){mi(e)}function Jr(e){Wa();var r={trigger:e.trigger,element:e.element,close:e.close};return Ve.push(r),{unregister:function(){var t=Ve.indexOf(r);t!==-1&&Ve.splice(t,1)},notifyOpening:function(){for(var t=zt(),n=0;n<t.length;n++)t[n]!==r&&t[n].close()}}}function pe(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var p=document.createElement("button");p.className="renuvex-pr-write-btn",p.textContent=H(N&&N.writeButtonText,"Yorum Yap"),p.onclick=a,o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-filter-wrap";var u=document.createElement("button");u.type="button",u.className="renuvex-pr-filter-btn",u.setAttribute("aria-label","Filtrele"),u.setAttribute("aria-haspopup","menu"),u.setAttribute("aria-expanded","false");var c=N&&N.filterIcon||"lines";u.innerHTML=se(pa(c));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var d=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],s=!1;function x(){return r&&r.parentNode||r||null}function f(w,E){if(!(E===!0||!w)){if(w.type==="touchstart"){Ct(x());return}if(w.type==="pointerdown"){var T=w.pointerType||"";T&&T!=="mouse"&&Ct(x());return}}}function m(w){var E=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),u.classList.remove("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","false");var T=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(E&&T)try{u.focus({preventScroll:!0})}catch(S){try{u.focus()}catch(g){}}return E}function h(){b.notifyOpening(),v.classList.add("renuvex-pr-open"),u.classList.add("renuvex-pr-filter-btn-active"),u.setAttribute("aria-expanded","true");var w=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(E){try{w.focus()}catch(T){}}})}d.forEach(function(w){var E=w[2],T=E?n:!n&&(t||"newest")===w[0],S=document.createElement("button");S.type="button",S.className="renuvex-pr-filter-item"+(T?" renuvex-pr-filter-item-active":""),S.setAttribute("role","menuitem"),S.textContent=w[1];var g=!1;function k(C,z){C&&(C.preventDefault(),C.stopPropagation()),!g&&(g=!0,s=!0,f(C,z),m({restoreFocus:z}),i(w[0],E),setTimeout(function(){g=!1,s=!1},0))}S.addEventListener("pointerdown",function(C){C.button!==void 0&&C.button!==0||C.pointerType!=="mouse"&&k(C,!1)}),typeof window!="undefined"&&!window.PointerEvent&&S.addEventListener("touchstart",function(C){k(C,!1)},{passive:!1}),S.addEventListener("keydown",function(C){(C.key==="Enter"||C.key===" ")&&k(C,!0)}),S.onclick=function(C){k(C,!1)},v.appendChild(S)}),u.onclick=function(){v.classList.contains("renuvex-pr-open")?m({restoreFocus:"auto"}):h()},l.addEventListener("keydown",function(w){w.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),m({restoreFocus:!0}))}),l.addEventListener("focusout",function(w){if(v.classList.contains("renuvex-pr-open")&&!s){var E=w.relatedTarget;E&&l.contains(E)||m()}});var b=Jr({trigger:l,element:v,close:m});return l.appendChild(u),l.appendChild(v),o.appendChild(l),o}var qa=`
...
`;function Ga(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,n=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,a=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",o.appendChild(p);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var u=ee(we);u&&l.appendChild(u),o.appendChild(l);var c=!1,v=null,d=null,s=!1;function x(){ve(i)}function f(g){qr(g,i,v&&v.root)}function m(){if(!c){if(c=!0,document.removeEventListener("keydown",h),i.removeEventListener("click",b),l.removeEventListener("click",m),s)ve(d);else{var g=v&&v.root?v.root.activeElement:null;if(g&&typeof g.blur=="function")try{g.blur()}catch(k){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){v?(Pr(v.root),v.host&&v.host.parentNode&&v.host.parentNode.removeChild(v.host)):i.parentNode&&i.parentNode.removeChild(i),jr();try{r()}catch(k){}},200)}}function h(g){if(g.key==="Escape"){m();return}f(g)}function b(g){g.target===i&&a&&m()}document.addEventListener("keydown",h),i.addEventListener("click",b),l.addEventListener("click",m);function w(g){d=t||Wr(),s=n===null?Pe():n,g&&p.appendChild(g),v=Vr(),Xe(v.root,Ke+We+qa),v.root.appendChild(i),Oe(v.root),Yr(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),x()})}var E=null,T=null;function S(g,k){if(k=k||"error",E){try{E.remove()}catch(C){}E=null}T&&(clearTimeout(T),T=null),E=document.createElement("div"),E.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+k,E.textContent=g,o.appendChild(E),T=setTimeout(function(){E&&(E.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(E){try{E.remove()}catch(C){}E=null}},300))},4e3)}return{open:w,close:m,content:p,setAllowOutsideClose:function(g){a=!!g},setStepAttr:function(g){o.setAttribute("data-step",String(g))},showToast:S}}var Et=4;function rr(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Ka(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(i){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<Et&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(i){return i!==a})}}}}function Xa(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",p.setAttribute("aria-label","Geri"),p.innerHTML=se(qe)+"<span>Geri</span>",p.addEventListener("click",function(){n()}),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-footer-progress";for(var u=[],c=0;c<Et;c++){var v=document.createElement("span");v.className="renuvex-pr-fwizard-progress-seg",l.appendChild(v),u.push(v)}o.appendChild(l);var d=document.createElement("button");d.type="button";var s=null;function x(m){s&&d.removeEventListener("click",s),s=m,m&&d.addEventListener("click",m)}o.appendChild(d);function f(m,h){var b=r.indexOf(m)!==-1,w=t.indexOf(m)!==-1,E=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0||!!h.videoUpload);if(b)m===2&&E?(d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",x(function(){i()})):(d.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",d.setAttribute("aria-label","Atla"),d.innerHTML="<span>Atla</span>",x(function(){a()})),d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),d.style.visibility="",d.tabIndex=0;else if(w){d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Sonraki"),d.innerHTML="Sonraki",d.style.visibility="",d.tabIndex=0;var T=rr(m,h);d.disabled=!T,d.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!T),x(function(){d.disabled||i()})}else d.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",d.innerHTML="",d.style.visibility="hidden",d.tabIndex=-1,d.disabled=!0,x(null)}return{el:o,update:function(m,h){u.forEach(function(w,E){E+1<=m?w.classList.add("renuvex-pr-fwizard-progress-seg-active"):w.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var b=m<=1;p.style.visibility=b?"hidden":"",p.style.pointerEvents=b?"none":"",p.tabIndex=b?-1:0,f(m,h)},setNextDisabled:function(m){d.classList.contains("renuvex-pr-fwizard-cta-btn")&&(d.disabled=!!m,d.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!m))},setThanksState:function(m){p.style.visibility="hidden",l.style.visibility="hidden",d.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",d.setAttribute("aria-label","Devam Et"),d.innerHTML="Devam Et",d.style.visibility="",d.disabled=!1,d.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),x(m)}}}var fi={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ce(e){var r=N&&N[e];return!r&&e==="formStepMediaTitle"&&(r=N&&N.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=N&&N.formStepPhotosSubtitle),H(r,fi[e])}function $a(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ce("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var p=ur(N||{});Me(p);var l=[];function u(m){l.forEach(function(h,b){var w=b<m;h.classList.toggle("renuvex-pr-fwizard-star-active",w),h.setAttribute("aria-checked",b+1===m?"true":"false"),h.innerHTML=w?de("full"):de("outline")})}function c(m){e.set({rating:m}),u(m)}function v(m){var h=l[m-1];if(h)try{h.focus()}catch(b){}}function d(m,h){h&&typeof h.preventDefault=="function"&&h.preventDefault(),h&&typeof h.stopPropagation=="function"&&h.stopPropagation(),!n&&(n=!0,c(m),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var s=1;s<=5;s++)(function(m){var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",m+" y\u0131ld\u0131z"),h.innerHTML=de("outline"),h.addEventListener("mouseenter",function(){u(m)}),h.addEventListener("mouseleave",function(){u(e.get().rating)}),h.addEventListener("pointerdown",function(b){b.button&&b.button!==0||d(m,b)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){d(m,b)},{passive:!1}),h.addEventListener("mousedown",function(b){window.PointerEvent||d(m,b)}),h.addEventListener("keydown",function(b){if(b.key==="Enter"||b.key===" "){d(m,b);return}var w=0;b.key==="ArrowRight"||b.key==="ArrowUp"?w=Math.min(5,m+1):b.key==="ArrowLeft"||b.key==="ArrowDown"?w=Math.max(1,m-1):b.key==="Home"?w=1:b.key==="End"&&(w=5),w&&(b.preventDefault(),c(w),v(w))}),h.addEventListener("click",function(b){d(m,b)}),l.push(h),o.appendChild(h)})(s);u(e.get().rating);var x=null,f=function(m){var h=m&&m.detail&&m.detail.settings;h&&h===x||(x=h||null,p=ur(h||N||{}),u(e.get().rating))};return window.addEventListener(Fe,f),t.appendChild(o),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Fe,f)}}}var Zr=3,xi=10*1024*1024;function Qr(e,r){r=r||{};var t=!1,n=r.hideAddButton===!0,a=r.revealAddButtonAfterMedia===!0,i=!n||a,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=ce("formStepPhotosTitle"),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=ce("formStepPhotosSubtitle"),o.appendChild(l)}var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&u.classList.add("renuvex-pr-fwizard-photo-card--embedded");var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-photo-add",c.setAttribute("aria-label","Foto\u011Fraf ekle");var v=document.createElement("input");v.type="file",v.accept="image/*",v.multiple=!0,v.style.display="none",i&&u.appendChild(c),u.appendChild(v);var d=document.createElement("div");d.className="renuvex-pr-fwizard-photo-previews",d.setAttribute("aria-live","polite"),u.appendChild(d),o.appendChild(u);var s=r.revokeBlobUrl||function(T){T&&typeof T=="string"&&T.startsWith("blob:")&&URL.revokeObjectURL(T)},x=r.blobMap||{},f=r.urlToFinger||{};function m(){if(!t){var T=e.get().images||[],S=e.get().pendingImages||[],g=T.map(function(k){return{url:k,isPending:!1}}).concat(S.map(function(k){return{url:k.url,file:k.file,isPending:!0,error:k.error}}));d.innerHTML="",g.forEach(function(k){var C=x[k.url]||k.url,z=h(k,C);d.appendChild(z)}),w()}}function h(T,S){var g=document.createElement("div");g.className="renuvex-pr-fwizard-photo-thumb";var k=document.createElement("img");k.src=S,k.alt="",k.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",g.appendChild(k);var C=document.createElement("div");C.className="renuvex-pr-fwizard-photo-loading",C.style.display="none",g.appendChild(C);var z=document.createElement("button");z.type="button",z.className="renuvex-pr-fwizard-photo-remove",z.setAttribute("aria-label","Kald\u0131r");var A=ee(we);return A&&z.appendChild(A),g.appendChild(z),b(g,T,S),g}function b(T,S,g){var k=T.querySelector("img");k.src!==g&&(k.src=g);var C=T.querySelector(".renuvex-pr-fwizard-photo-loading");if(S.isPending&&S.error){C.style.display="flex",C.textContent="";var z=document.createElement("span");z.className="renuvex-pr-upload-error",z.textContent="\u2717 "+S.error,C.appendChild(z)}else C.style.display="none",C.textContent="";var A=T.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var L=f[S.url]||(S.file?S.file.name+"_"+S.file.size:null),I=x[S.url],_={};L&&(_.fingerprints=(e.get().fingerprints||[]).filter(function(y){return y!==L})),S.isPending?_.pendingImages=(e.get().pendingImages||[]).filter(function(y){return y.url!==S.url}):_.images=(e.get().images||[]).filter(function(y){return y!==S.url}),e.set(_),s(S.url),s(I),delete f[S.url],I&&delete f[I],x[S.url]&&delete x[S.url]}}function w(){var T=(e.get().images||[]).length,S=(e.get().pendingImages||[]).length,g=T+S,k=g>=Zr;u.classList.toggle("renuvex-pr-fwizard-photo-card--compact",g>0),i&&(c.innerHTML=g>0?se(da):se(Mr)+"<span>Foto\u011Fraf Ekle</span>"),k?(i&&(c.style.display="none"),c.disabled=!0,v.disabled=!0):(i&&(c.style.display=a&&g===0?"none":"flex"),c.disabled=!1,v.disabled=!1,c.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}c.addEventListener("click",function(){v.disabled||v.click()}),v.onchange=async function(T){var S=(e.get().images||[]).length+(e.get().pendingImages||[]).length,g=Array.from(T.target.files).slice(0,Zr-S);v.value="";var k=(e.get().pendingImages||[]).length,C=e.get().images||[],z=C.length;if(g.length!==0){for(var A=[],L=[],I=0;I<g.length;I++){var _=g[I],y=_.name+"_"+_.size,M=(e.get().fingerprints||[]).some(function(U){return U===y})||A.some(function(U){return U.file.name+"_"+U.file.size===y});if(!M){if(_.size>xi){var P="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(P,"error"):alert(P);continue}var B=URL.createObjectURL(_);f[B]=y,A.push({url:B,file:_,error:null}),L.push({url:B,file:_});var R=(e.get().fingerprints||[]).slice();R.push(y),e.set({fingerprints:R})}}if(A.length!==0){var j=(e.get().pendingImages||[]).concat(A),J=async function(){for(var U=0;U<L.length;U++){var G=L[U],X=G.file,V=G.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var K=(e.get().pendingImages||[]).filter(function(Q){return Q.url!==V}),O=(e.get().images||[]).slice();O.push(V),e.set({pendingImages:K,images:O});continue}try{var F=await ze(ye+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue})});if(!F.ok)throw F.status===429?new Error("rate_limit"):new Error("sign failed");var W=await F.json();if(!W.folder)throw new Error("sign folder missing");var ae=new FormData;ae.append("file",X),ae.append("api_key",W.api_key),ae.append("timestamp",W.timestamp),ae.append("signature",W.signature),ae.append("folder",W.folder);var q=await fetch("https://api.cloudinary.com/v1_1/"+W.cloud_name+"/image/upload",{method:"POST",body:ae}),$=await q.json();if($.secure_url&&Rr($.secure_url)){var lr=(e.get().pendingImages||[]).some(function(Q){return Q.url===V});if(!lr)continue;x[$.secure_url]=V,f[$.secure_url]=f[V];var Ne=(e.get().pendingImages||[]).filter(function(Q){return Q.url!==V}),D=(e.get().images||[]).slice();D.push($.secure_url),e.set({pendingImages:Ne,images:D});try{ze(ye+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue,secureUrl:$.secure_url,metadata:{assetId:$.asset_id,publicId:$.public_id,version:$.version,resourceType:$.resource_type,format:$.format,width:$.width,height:$.height,bytes:$.bytes,signature:$.signature}})}).catch(function(){})}catch(Q){}}else throw new Error("invalid image url")}catch(Q){console.error("[renuvex-pr] Image upload failed:",Q);var ne=Q.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ne,"error");var me=(e.get().pendingImages||[]).map(function(fe){return fe.url===V?{url:fe.url,file:fe.file,error:ne}:fe});e.set({pendingImages:me})}}};if(z===0&&k===0){t=!0;var Y=!r.canNavigate||r.canNavigate();Y&&e.goNext()}e.set({pendingImages:j}),J()}}};var E=e.onChange(m);return m(),{el:o,openPicker:function(){v.disabled||v.click()},destroy:function(){t=!0,v.onchange=null,E&&E()}}}var gi=150*1024*1024,hi=2,bi=60,rn=8192,tn=5,yi=3e4,wi=["video/mp4","video/quicktime"],ki="renuvex_pr_video_upload_",an="renuvex_pr_video_cancel_",mr=null,Ja=!1,Si={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},zi={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},he=class extends Error{constructor(r,t,n){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=n||null}};function nn(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:Si[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:zi[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function on(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function Tt(e){return new Promise(function(r){setTimeout(r,e)})}function tr(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function ar(e){return Math.max(0,Math.round(tr()-e))}function Ci(){if(typeof window!="undefined"){var e=Number(window.__renuvexPrVideoUploadStallMs);if(Number.isFinite(e)&&e>=250)return e}return yi}function Ei(e,r){return new Promise(function(t,n){var a=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(a),r&&r.removeEventListener("abort",o),n(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function At(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function Pt(e,r){return ki+ue+"_"+e+"_"+At(r)}function ln(e,r){try{var t=window.sessionStorage.getItem(Pt(e,r)),n=t?JSON.parse(t):null;return!n||typeof n.token!="string"||!n.expiresAt||new Date(n.expiresAt).getTime()<=Date.now()?null:n}catch(a){return null}}function Ti(e,r,t){try{window.sessionStorage.setItem(Pt(e,r),JSON.stringify(t))}catch(n){}}function xr(e,r){try{window.sessionStorage.removeItem(Pt(e,r))}catch(t){}}function Ai(e,r){return an+ue+"_"+e+"_"+At(r)}function Pi(e,r,t,n){if(!(!e||!r||!t)){var a={token:e,productId:r,expiresAt:n||null};try{window.sessionStorage.setItem(Ai(r,t),JSON.stringify(a))}catch(i){}}}function _i(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(an+ue+"_")!==0)){var n=window.sessionStorage.getItem(t),a=n?JSON.parse(n):null;if(!a||typeof a.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:a.token})}}}catch(i){}return e}function Za(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function nr(e,r,t){var n=await ze(ye+e,r,t||2e4),a=await n.json().catch(function(){return{}});if(!n.ok){var i=Number(n.headers.get("Retry-After"));throw new he(a.error||"video_request_failed",n.status,Number.isFinite(i)&&i>0?i:null)}return a.data||{}}async function fr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await nr("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:ar(r.startedAt),finalStatus:t})},4e3)}catch(n){}}async function Mi(e){try{return await nr("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Za(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Za(e.key),!0):!1}}function et(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():mr||(mr=(async function(){for(var e=_i(),r=0;r<e.length;r+=1)await Mi(e[r])})().finally(function(){mr=null}),mr)}function rt(){typeof window=="undefined"||Ja||(Ja=!0,window.addEventListener("online",function(){et()}),et())}async function Li(){var e=await import("./upchunk-KBSCWYRQ.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function Qa(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}var Ri={http_408:!0,http_502:!0,http_503:!0,http_504:!0};function Ni(e){return Ri[e]!==!0}async function Bi(e){var r=await Li();return new Promise(function(t,n){var a=!1,i=null,o=null,p=Ci(),l=null;function u(x){a||(a=!0,o&&clearTimeout(o),e.signal&&e.signal.removeEventListener("abort",s),l&&l(),x?n(x):t())}function c(x){a||(o&&clearTimeout(o),!(!x&&typeof navigator!="undefined"&&navigator.onLine===!1)&&(o=setTimeout(function(){if(!a){e.onUploadError&&e.onUploadError("video_upload_stalled"),u(new he("video_upload_stalled",0,null));try{i&&i.abort()}catch(f){}}},p)))}function v(){return a?!1:(c(),!0)}function d(){if(!a){e.onUploadError&&e.onUploadError("video_upload_offline"),u(new he("video_upload_offline",0,null));try{i&&i.abort()}catch(x){}}}function s(){try{i&&i.abort()}catch(x){}u(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return n(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",s,{once:!0})}if(i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||rn,attempts:e.chunkAttempts||tn,dynamicChunkSize:!0}),typeof window!="undefined"&&typeof window.addEventListener=="function"&&typeof window.removeEventListener=="function"&&(window.addEventListener("offline",d),l=function(){window.removeEventListener("offline",d)}),typeof navigator!="undefined"&&navigator.onLine===!1){d();return}c(),i.on("attempt",function(){v()&&e.onStatus("uploading")}),i.on("attemptFailure",function(x){if(v()){var f=x&&x.detail,m=Qa(f);if(e.onAttemptFailure&&e.onAttemptFailure(m),Ni(m)){e.onUploadError&&e.onUploadError(m),u(new he(m,0,null));try{i&&i.abort()}catch(h){}return}e.onStatus("upload_retrying")}}),i.on("chunkSuccess",function(){v()}),i.on("progress",function(x){if(v()){var f=Number(x&&x.detail);if(Number.isFinite(f)){var m=Math.min(95,Math.max(0,Math.round(f*.95)));Number.isFinite(e.minProgress)&&(m=Math.max(e.minProgress,m)),e.onProgress(m)}}}),i.on("offline",d),i.on("error",function(x){if(v()){var f=x&&x.detail,m=Qa(f);e.onUploadError&&e.onUploadError(m),u(new he(m,0,null))}}),i.on("success",function(){v()&&(e.onProgress(95),u())})})}function Ii(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function en(e,r,t){for(var n=Date.now(),a=n+600*1e3,i=0;Date.now()<a;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-n;try{var p=await nr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":p.status||"processing"),p.status==="ready")return p;if(p.status==="failed"||p.status==="aborted")throw new he(p.errorCode||"video_processing_failed",409,null)}catch(l){if(r.aborted||l instanceof he&&l.status===409||on(l)||(i+=1,i>=3))throw l}await Ei(Ii(o),r)}throw new he("video_processing_delayed",0,null)}async function Oi(e){for(var r=null,t=1;t<=3;t+=1)try{return await nr("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(n){if(on(n))return null;r=n,t<3&&await Tt(400*t)}throw r||new Error("video_status_failed")}async function Fi(e,r,t,n){for(var a=10;a<=90;a+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(a),await Tt(120)}return n("processing"),await Tt(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function pn(e){return!e||wi.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>gi?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function un(e){return new Promise(function(r){var t=URL.createObjectURL(e),n=document.createElement("video"),a=!1;function i(o){if(!a){a=!0,n.removeAttribute("src");try{n.load()}catch(p){}URL.revokeObjectURL(t),r(o)}}n.preload="metadata",n.onloadedmetadata=function(){i(Number.isFinite(n.duration)?n.duration:null)},n.onerror=function(){i(null)},n.src=t,setTimeout(function(){i(null)},8e3)})}function dn(e){return e===null?{ok:!0}:e<hi||e>bi?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function sn(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return Fi(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:tr(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(x){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=x||"upload_attempt_failed")}function n(){xr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}async function a(x,f){var m=await Oi(x);if(!m)return{action:"discard"};if(m.status==="ready")return e.onToken&&e.onToken(x),e.onProgress(100),xr(e.productId,e.file),await fr(x,r,"ready"),{action:"return",value:Object.assign({token:x},m)};if(m.status==="uploaded"||m.status==="processing"){e.onToken&&e.onToken(x),e.onStatus("processing");var h=tr(),b=await en(x,e.signal,e.onStatus);return r.processingPollMs=ar(h),xr(e.productId,e.file),e.onProgress(100),await fr(x,r,"ready"),{action:"return",value:Object.assign({token:x},b)}}return m.status==="failed"||m.status==="aborted"?{action:"discard"}:!f||typeof f.uploadUrl!="string"||!f.uploadUrl?{action:"discard"}:{action:"upload"}}rt(),await et();var i=ln(e.productId,e.file),o=i&&i.token,p=i;if(o){var l=await a(o,p);if(l.action==="return")return l.value;l.action==="discard"&&(n(),o=null,p=null)}for(;;){if(!o){var u=await nr("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:At(e.file)})});o=u.token,p=u,Ti(e.productId,e.file,u)}e.onToken&&e.onToken(o),r.chunkSizeKb=p.chunkSize||rn,r.chunkAttempts=p.chunkAttempts||tn,e.onStatus("uploading");var c=tr();try{await Bi({uploadUrl:p.uploadUrl,file:e.file,chunkSize:p.chunkSize,chunkAttempts:p.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=(r.directUploadMs||0)+ar(c),e.onStatus("processing");var v=tr();await nr("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:o})},3e4),r.completeMs=ar(v);var d=tr(),s=await en(o,e.signal,e.onStatus);return r.processingPollMs=ar(d),xr(e.productId,e.file),e.onProgress(100),await fr(o,r,"ready"),Object.assign({token:o},s)}catch(x){throw r.directUploadMs=(r.directUploadMs||0)+ar(c),e.signal&&e.signal.aborted?(await fr(o,r,"aborted"),x):(await fr(o,r,"failed"),x)}}}async function tt(e,r,t){var n=r&&t?ln(r,t):null;e&&r&&t&&Pi(e,r,t,n&&n.expiresAt),r&&t&&xr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(rt(),await et())}function vn(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function Ui(e){return"Video Y\xFCkleniyor"}function Hi(e){return!0}function cn(e,r){r=r||{};var t=!1,n=null,a=null,i=0,o=document.createElement("div");o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=ce("formStepMediaTitle"),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=ce("formStepMediaSubtitle"),o.appendChild(l);var u=document.createElement("div");u.className="renuvex-pr-fwizard-media-card";var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",c.setAttribute("aria-label","Foto\u011Fraf ekle"),c.innerHTML=se(Mr)+"<span>Foto\u011Fraf Ekle</span>";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",v.setAttribute("aria-label","Video ekle"),v.innerHTML=se(Lr)+"<span>Video Ekle</span>",u.appendChild(c),u.appendChild(v);var d=document.createElement("div");d.className="renuvex-pr-fwizard-media-content",u.appendChild(d),o.appendChild(u);var s=document.createElement("input");s.type="file",s.accept="video/mp4,video/quicktime,.mp4,.mov",s.style.display="none",o.appendChild(s);function x(){var y=e.get();return(y.images||[]).length>0||(y.pendingImages||[]).length>0}function f(){var y=e.get();return(y.images||[]).length+(y.pendingImages||[]).length}function m(){return e.get().videoUpload||null}function h(){return i+=1,i}function b(y,M){var P=m();return i===y&&!!P&&P.controller===M}function w(){if(!a){d.innerHTML="";return}a.retry.onclick=null,d.innerHTML="",a=null}function E(){n&&(n.destroy&&n.destroy(),n=null)}function T(y){E(),d.innerHTML="";var M=vn(y),P=document.createElement("div");P.className=M==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":M==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var B=null,R=null,j=null,J=null,Y=document.createElement("button");if(Y.type="button",Y.className="renuvex-pr-fwizard-video-retry",Y.textContent="Tekrar dene",Y.setAttribute("aria-label","Video y\xFCklenemedi, tekrar dene"),M==="ready"){var U=y.posterUrl||y.localUrl||"";U&&U!==y.localUrl?(B=document.createElement("img"),B.alt="",B.src=U):(B=document.createElement("video"),B.muted=!0,B.playsInline=!0,B.preload="metadata",B.src=y.localUrl||""),B.className="renuvex-pr-fwizard-video-preview",P.appendChild(B)}else M==="busy"?(J=document.createElement("div"),J.className="renuvex-pr-fwizard-video-uploading-status",J.setAttribute("role","status"),J.setAttribute("aria-live","polite"),P.appendChild(J)):R=P;if(M==="ready"){let K=function(O){O&&(O.preventDefault(),O.stopPropagation()),A()};var V=K,G=document.createElement("button");G.type="button",G.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",G.setAttribute("aria-label","Videoyu kald\u0131r");var X=ee(we);X&&G.appendChild(X),G.addEventListener("pointerdown",K),G.addEventListener("click",K),P.appendChild(G)}d.appendChild(P),a={mode:M,card:P,preview:B,previewUrl:M==="ready"&&(y.posterUrl||y.localUrl)||"",details:R,name:j,status:J,retry:Y}}function S(){if(!t){var y=m();if(!y){w();return}var M=vn(y),P=M==="ready"&&(y.posterUrl||y.localUrl)||"";if((!a||a.mode!==M||a.previewUrl!==P)&&T(y),a.name&&(a.name.textContent=y.file?y.file.name:"Video"),a.status&&M==="busy"){var B=Ui(y),R=Hi(y)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+B+"</span>":"<span>"+B+"</span>";a.status.innerHTML!==R&&(a.status.innerHTML=R)}var j=M==="failed"&&!!(y.error&&y.file&&y.retryable!==!1);a.retry.onclick=j?function(){z(y.file,y.localUrl,y.durationMs)}:null,j&&a.details&&!a.retry.isConnected?a.details.appendChild(a.retry):!j&&a.retry.isConnected&&a.retry.remove()}}function g(){var y=x(),M=f()>=Zr,P=!!m(),B=y||P;c.hidden=B,v.hidden=B,c.disabled=P||M,v.disabled=y||P,u.classList.toggle("renuvex-pr-fwizard-media-card--has-media",B),u.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",y),u.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",P),c.classList.toggle("renuvex-pr-fwizard-media-action--active",y),v.classList.toggle("renuvex-pr-fwizard-media-action--active",P)}function k(y){var M=m();if(M){var P=Object.keys(y),B=P.some(function(R){return M[R]!==y[R]});B&&e.set({videoUpload:Object.assign({},M,y)})}}function C(y,M,P){b(y,M)&&k(P)}async function z(y,M,P){var B=m(),R=!!(M&&B&&B.file===y),j=R?Math.max(0,Math.min(95,Number(B.progress)||0)):0,J=R?(Number(B.retryClicks)||0)+1:0,Y=pn(y);if(!Y.ok){r.showToast&&r.showToast(Y.message,"error");return}var U=M||URL.createObjectURL(y),G=Number.isFinite(P)?P:null,X=new AbortController,V=h();e.set({videoUpload:{file:y,localUrl:U,token:R&&B.token||null,status:"uploading",progress:j,durationMs:G,error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:J,controller:X}}),!R&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var K=P!==void 0?Number.isFinite(P)?P/1e3:null:await un(y),O=dn(K);if(!O.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:O.message});var F=await sn({file:y,productId:e.get().productId,signal:X.signal,minProgress:j,retryClicks:J,onToken:function(q){C(V,X,{token:q})},onProgress:function(q){C(V,X,{progress:q})},onStatus:function(q){C(V,X,{status:q})},onSessionReset:function(){C(V,X,{token:null,progress:0})}});if(!b(V,X))return;if(F.previewOnly&&F.posterUrl&&F.posterUrl!==U)try{URL.revokeObjectURL(F.posterUrl)}catch(q){}k({token:F.token,status:"ready",progress:100,posterUrl:F.previewOnly?U:F.posterUrl,durationMs:F.durationMs||(K===null?null:Math.round(K*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),R&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(q){if(X.signal.aborted||!b(V,X))return;var W=nn(q);if(q&&q.code==="invalid_video_duration"&&(W={code:"invalid_video_duration",message:q.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),k({status:"failed",error:W.message,errorCode:W.code,retryable:W.retryable,retryAfterSec:W.retryAfterSec,controller:null}),r.showToast){var ae=W.code==="invalid_video_duration"?W.message:"Video y\xFCklenemedi";r.showToast(ae,"error")}}}function A(){var y=m();y&&(h(),y.controller&&y.controller.abort(),tt(y.token,e.get().productId,y.file),r.revokeBlobUrl&&r.revokeBlobUrl(y.localUrl),e.set({videoUpload:null}))}function L(y){if(n){y&&n.openPicker&&n.openPicker();return}a=null,d.innerHTML="",n=Qr(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),d.appendChild(n.el),y&&n.openPicker&&n.openPicker()}c.onclick=function(){c.disabled||L(!0)},v.onclick=function(){v.disabled||(E(),d.innerHTML="",s.click())},s.onchange=function(){var y=s.files&&s.files[0];s.value="",y&&z(y,null,void 0)};var I=!!m(),_=e.onChange(function(){g();var y=!!m();(y||I)&&S(),I=y});return g(),x()&&L(!1),m()&&S(),{el:o,destroy:function(){t=!0,c.onclick=null,v.onclick=null,s.onchange=null,n&&n.destroy&&n.destroy(),_&&_()}}}var _t=2e3,Vi=60;function mn(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=ce("formStepContentTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Vi,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var p=document.createElement("textarea");p.className="renuvex-pr-fwizard-textarea",p.placeholder="Deneyiminizi anlat\u0131n\u2026",p.maxLength=_t,p.rows=6,p.setAttribute("aria-label","Yorum"),p.value=e.get().comment||"",i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-char-counter",l.setAttribute("aria-live","polite"),i.appendChild(l);function u(){var v=p.value.length;l.textContent=v+"/"+_t,l.classList.toggle("renuvex-pr-fwizard-char-counter--max",v>=_t)}function c(){return rr(3,e.get())}return p.addEventListener("input",function(){e.set({comment:p.value}),u(),t(c())}),n.appendChild(i),u(),setTimeout(function(){t(c())},0),{el:n,destroy:function(){}}}var Di=40;function fn(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ce("formStepAuthorTitle"),a.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var p=document.createElement("div");p.className="renuvex-pr-fwizard-field";var l=document.createElement("label");l.className="renuvex-pr-fwizard-label",l.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var u=document.createElement("input");u.type="text",u.className="renuvex-pr-fwizard-input",u.maxLength=Di,u.setAttribute("aria-required","true"),u.value=e.get().author||"",p.appendChild(l),p.appendChild(u),o.appendChild(p);var c=document.createElement("div");c.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.textContent="E-posta (opsiyonel)";var d=document.createElement("input");d.type="email",d.className="renuvex-pr-fwizard-input",d.setAttribute("autocomplete","email"),d.value=e.get().email||"",c.appendChild(v),c.appendChild(d),o.appendChild(c);var s=document.createElement("div");s.className="renuvex-pr-fwizard-notice",s.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(s);var x=document.createElement("div");x.className="renuvex-pr-fwizard-msg",x.setAttribute("role","alert"),x.setAttribute("aria-live","assertive"),o.appendChild(x);var f=document.createElement("button");f.type="button",f.className="renuvex-pr-fwizard-submit-btn",f.textContent="G\xF6nder",o.appendChild(f),a.appendChild(o);function m(){return rr(4,e.get())}function h(g){f.classList.remove("renuvex-pr-fwizard-submit-btn--video-pending"),f.textContent=g}function b(){f.classList.add("renuvex-pr-fwizard-submit-btn--video-pending"),f.textContent="";var g=document.createElement("span");g.className="renuvex-pr-fwizard-video-dots",g.setAttribute("aria-hidden","true"),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span"));var k=document.createElement("span");k.textContent="Video Haz\u0131rlan\u0131yor",f.appendChild(g),f.appendChild(k)}function w(){var g=!m(),k=(e.get().pendingImages||[]).length,C=k>0,z=e.get().videoUpload,A=!!(z&&z.status==="failed"),L=!!(z&&z.status!=="ready"&&z.status!=="failed");C||L||A?(f.disabled=!0,f.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),A?h("Video Y\xFCklenemedi"):L?b():h("Foto\u011Fraflar Y\xFCkleniyor...")):(f.disabled=g,f.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",g),h("G\xF6nder"))}u.addEventListener("input",function(){e.set({author:u.value}),w(),t(m())}),d.addEventListener("input",function(){e.set({email:d.value})}),w(),setTimeout(function(){t(m())},0);function E(){x.textContent=""}function T(g){E();var k=document.createElement("div");k.className="renuvex-pr-fwizard-msg-error",k.textContent=g||"",x.appendChild(k)}f.onclick=async function(){if(!f.disabled){var g=e.get(),k=(g.author||"").trim(),C=(g.comment||"").trim();if(d.value.trim()&&!d.checkValidity()){d.reportValidity();return}if(!k){T("Gerekli alan");return}if(!g.rating){T("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}f.disabled=!0,f.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var z=f.textContent;if(f.textContent="G\xF6nderiliyor\u2026",E(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n()},600);return}try{var A=sa(window.location.href),L=g.productName||null,I=await ze(ye+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:ue,productId:g.productId||null,slug:A||null,productName:L,author:k,title:(g.title||"").trim()||null,comment:C||null,rating:g.rating,images:g.videoUpload?[]:g.images||[],videoToken:g.videoUpload&&g.videoUpload.status==="ready"?g.videoUpload.token:null})},15e3);if(I.ok)g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n();else{var _=await I.json().catch(function(){return{}});throw new Error(_.error||"Yorum kaydedilemedi.")}}catch(P){var y=P&&(P.name==="AbortError"||/signal/i.test(P.message||"")),M=y?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":P.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(M,"error"):T(M),f.disabled=!1,f.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),f.textContent=z}}};var S=e.onChange(w);return{el:a,destroy:function(){f.onclick=null,S&&S()}}}function Yi(e,r,t){if(t=t||{},e===1)return $a(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return cn(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return Qr(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return mn(r,{onValidityChange:t.onValidityChange});if(e===4)return fn(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function xn(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function gn(e){e=e||{},rt();var r=Ka({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:N&&N.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},n={},a={};function i(z){if(!(!z||typeof z!="string"||!z.startsWith("blob:")||a[z])){a[z]=!0;try{URL.revokeObjectURL(z)}catch(A){}}}function o(){Object.keys(n).forEach(function(A){i(A)}),Object.keys(t).forEach(function(A){i(t[A])});var z=r.get();(z.pendingImages||[]).forEach(function(A){i(A&&A.url)}),(z.images||[]).forEach(function(A){i(A)}),z.videoUpload&&i(z.videoUpload.localUrl)}function p(){var z=r.get(),A=z.videoUpload;!A||z.videoSubmitted||(A.controller&&A.controller.abort(),tt(A.token,z.productId,A.file))}var l=Ga({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",c),Kr(u),p(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),u=Gr(),c=function(z){l&&l.close&&l.close()};window.addEventListener("popstate",c);var v=document.createElement("div");v.className="renuvex-pr-fwizard-step-wrap";var d=Xa({skippableSteps:[2],nextableSteps:[3],onBack:function(){f==="idle"&&r.goBack()},onSkip:function(){f==="idle"&&r.goNext()},onNext:function(){f==="idle"&&r.goNext()}}),s=document.createElement("div");s.className="renuvex-pr-fwizard-layout",s.appendChild(v),s.appendChild(d.el);var x=null,f="idle",m=null,h=!0,b=null;function w(z,A){v.innerHTML="";var L=Yi(z,r,{canNavigate:function(){return f==="idle"},blobMap:t,urlToFinger:n,revokeBlobUrl:i,onValidityChange:function(y){d.setNextDisabled(!y)},onSuccess:T,showToast:l.showToast});if(x=L,d.update(z,r.get()),A){f="entering",L.el.classList.add("renuvex-pr-fwizard-step--enter");var I=null,_=function(){I&&clearTimeout(I),L.el.removeEventListener("animationend",_),L.el.classList.remove("renuvex-pr-fwizard-step--enter"),f="idle",m!==null&&S()};L.el.addEventListener("animationend",_),I=setTimeout(_,700)}else f="idle";v.appendChild(L.el),l.setStepAttr&&l.setStepAttr(z),z===3&&d.setNextDisabled(!0)}var E=!1;function T(){if(!E){if(E=!0,!x){v.innerHTML="";var z=xn();z.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(z),l.setStepAttr("thanks"),d.setThanksState(l.close);return}var A=x;f="exiting",A.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(b&&clearTimeout(b),A.el.removeEventListener("animationend",L),A.destroy)try{A.destroy()}catch(_){}x===A&&(x=null),v.innerHTML="";var I=xn();I.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(I),l.setStepAttr("thanks"),d.setThanksState(l.close),f="idle"};A.el.addEventListener("animationend",L),b=setTimeout(L,300)}}function S(){var z=r.get().currentStep;if(f!=="idle"){m=z;return}if(!x){var A=!h;h=!1,w(z,A);return}var L=x;f="exiting",L.el.classList.add("renuvex-pr-fwizard-step--exit");var I=function(){if(b&&clearTimeout(b),L.el.removeEventListener("animationend",I),L.destroy)try{L.destroy()}catch(y){}if(x===L){v.innerHTML="",x=null;var _=m!==null?m:r.get().currentStep;m=null,w(_,!0),f="idle"}};L.el.addEventListener("animationend",I),b=setTimeout(I,350)}S();var g=r.get().currentStep,k=r.onChange(function(z){z.currentStep!==g?(g=z.currentStep,S()):d.update(z.currentStep,z)}),C=l.close;return l.close=function(){k&&k(),typeof b!="undefined"&&b&&clearTimeout(b),C()},l.open(s),{close:l.close}}var ji=4e3;async function hn(){var e=await ze(ye+"/api/public/upload/video/capability?storeId="+encodeURIComponent(ue),{method:"GET",cache:"no-store"},ji);if(!e.ok){var r=new Error("video_capability_unavailable");throw r.code="video_capability_http",r.status=e.status,r}var t=await e.json().catch(function(){return{}}),n=t&&t.data;if(!n||typeof n.enabled!="boolean"){var a=new Error("video_capability_invalid");throw a.code="video_capability_invalid",a}return{enabled:n.enabled===!0,reason:typeof n.reason=="string"?n.reason:null}}var at=null;function bn(){return N&&N.videoReviewsEnabled===!0}function Wi(e){var r=e&&Number(e.status),t=Number.isFinite(r)&&r>=100;return bn()&&!t?{enabled:!0,reason:"capability_unavailable"}:{enabled:!1,reason:"capability_unavailable"}}function qi(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function Gi(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:bn(),reason:null};else try{t=await hn()}catch(n){t=Wi(n)}gn({productId:Z||"",productName:Be||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function te(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=qi(r);return at||(at=Gi(r,Pe()).finally(function(){at=null})),at.finally(t)}var yn=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Ki={id:"classic",name:"Klasik (A\xE7\u0131k)"},Xi=yn;function $i(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,c=e.currentHasImages,v=e.onFilterChange,d=e.onSortChange;Me(a);var s=document.createElement("div");s.className="renuvex-pr-summary";var x=(o[3]||0)+(o[4]||0),f=i>0?Math.round(x/i*100):0,m=document.createElement("div");m.className="renuvex-pr-summary-block renuvex-pr-summary-avg",m.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+de("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",s.appendChild(m);var h=document.createElement("div");if(h.className="renuvex-pr-summary-block renuvex-pr-summary-count",h.textContent=i.toLocaleString("tr-TR")+" "+H(n.countLabel,"Yorum"),s.appendChild(h),n.showRecommendation!==!1&&f>0){var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",b.innerHTML='<span class="renuvex-pr-recommend-pct">%'+f+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",s.appendChild(b)}return s.appendChild(Qe({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:v})),s.appendChild(pe({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:te,onSortChange:d})),s}var Lt={};Ae(Lt,{css:()=>Zi,meta:()=>Ji,render:()=>to});var wn=`
...
`;var Ji={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},Zi=wn,Qi="__unknown_product__",gr=Object.create(null);function eo(e){return e?String(e):Qi}var De=null,hr=null;function ro(){!De||!hr||(De.removeEventListener?De.removeEventListener("change",hr):De.removeListener&&De.removeListener(hr),De=null,hr=null)}function to(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,u=e.currentOrderBy,c=e.currentHasImages,v=e.onFilterChange,d=e.onSortChange,s=eo(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var f=document.createElement("div");f.className="renuvex-pr-compact-header";var m=document.createElement("div");m.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Le(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(ua)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),w=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+H(n.countLabel,"Yorum")),b&&w){var E=document.createElement("span");E.className="renuvex-pr-compact-trigger-count",h.insertBefore(E,b),E.appendChild(b),E.appendChild(w)}m.appendChild(h),f.appendChild(m);var T=pe({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:te,onSortChange:d}),S=T.querySelector(".renuvex-pr-filter-wrap"),g=T.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-compact-actions-slot",g&&k.appendChild(g),S&&k.appendChild(S),f.appendChild(k),x.appendChild(f);var C=document.createElement("div");C.className="renuvex-pr-compact-panel",C.setAttribute("role","dialog"),C.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),C.setAttribute("aria-hidden","true");var z=document.createElement("div");z.className="renuvex-pr-compact-panel-inner";var A=document.createElement("div");A.className="renuvex-pr-compact-avg",A.innerHTML='<span class="renuvex-pr-icon">'+de("full")+"</span><span>"+p+"</span>",z.appendChild(A),z.appendChild(Qe({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(O){I()&&C.classList.contains("renuvex-pr-open")&&(gr[s]=!0),v(O)}})),C.appendChild(z);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function I(){return!!(L&&L.matches)}function _(O){O?C.classList.add("renuvex-pr-open"):C.classList.remove("renuvex-pr-open"),C.setAttribute("aria-hidden",O?"false":"true"),h.setAttribute("aria-expanded",O?"true":"false")}function y(O){var F=O?x:m;if(C.parentNode!==F){var W=!!C.parentNode;C.classList.contains("renuvex-pr-open")&&_(!1),W&&(gr[s]=!1),F.appendChild(C)}}y(L?L.matches:!1);var M=pe({widget:r,currentOrderBy:u,currentHasImages:c,onWriteClick:te,onSortChange:d}),P=M.querySelector(".renuvex-pr-filter-wrap"),B=M.querySelector(".renuvex-pr-write-btn"),R=document.createElement("div");R.className="renuvex-pr-compact-write-row",B&&R.appendChild(B),P&&R.appendChild(P),x.appendChild(R);function j(){var O=C.classList.contains("renuvex-pr-open");return _(!1),I()&&(gr[s]=!1),O}function J(){Y&&Y.notifyOpening(),_(!0),I()&&(gr[s]=!0)}h.onclick=function(){C.classList.contains("renuvex-pr-open")?j():J()};var Y=null;function U(O){Y&&(Y.unregister(),Y=null),O||(Y=Jr({trigger:m,element:C,close:j}))}if(U(L?L.matches:!1),ro(),L){var G=function(O){y(O.matches),U(O.matches)};L.addEventListener?L.addEventListener("change",G):L.addListener&&L.addListener(G),De=L,hr=G}if(I()&&gr[s]&&_(!0),n.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),V=i>0?Math.round(X/i*100):0;if(V>0){var K=document.createElement("div");K.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",K.style.marginTop="8px",K.innerHTML='<span class="renuvex-pr-recommend-pct">%'+V+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",z.appendChild(K)}}return x}var Rt={};Ae(Rt,{css:()=>no,meta:()=>ao,render:()=>io});var kn=`
...
`;var ao={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},no=kn;function io(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,p=e.currentRatingFilter,l=e.currentOrderBy,u=e.currentHasImages,c=e.onFilterChange,v=e.onSortChange;Me(n);var d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+de("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(x);var f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",f.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),s.appendChild(f),d.appendChild(s);var m=document.createElement("div");m.className="renuvex-pr-split-col renuvex-pr-split-mid",m.appendChild(Qe({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:p,onFilterChange:c})),d.appendChild(m);var h=pe({widget:r,currentOrderBy:l,currentHasImages:u,onWriteClick:te,onSortChange:v}),b=h.querySelector(".renuvex-pr-filter-wrap"),w=h.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");E.className="renuvex-pr-split-col renuvex-pr-split-right",w&&E.appendChild(w),b&&E.appendChild(b),d.appendChild(E);var T=(i[3]||0)+(i[4]||0),S=a>0?Math.round(T/a*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",g.innerHTML='<span class="renuvex-pr-recommend-pct">%'+S+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var k=t.showRecommendation===!1||S===0;return k&&g.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(g),d}var Nt={};Ae(Nt,{css:()=>lo,meta:()=>oo,render:()=>po});var Sn=`
...
`;var oo={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},lo=Sn;function po(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-minimal";var c=document.createElement("div");c.className="renuvex-pr-minimal-info";var v=document.createElement("div");v.className="renuvex-pr-minimal-row";var d=document.createElement("span");d.className="renuvex-pr-minimal-avg",d.textContent=i,v.appendChild(d);var s=document.createElement("span");s.className="renuvex-pr-minimal-stars",s.innerHTML=Le(i,n),v.appendChild(s);var x=document.createElement("span");x.className="renuvex-pr-minimal-count",x.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),v.appendChild(x),c.appendChild(v),u.appendChild(c);var f=pe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:te,onSortChange:l}),m=f.querySelector(".renuvex-pr-filter-wrap"),h=f.querySelector(".renuvex-pr-write-btn"),b=document.createElement("div");b.className="renuvex-pr-minimal-actions",h&&b.appendChild(h),m&&b.appendChild(m),u.appendChild(b);var w=pe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:te,onSortChange:l}),E=w.querySelector(".renuvex-pr-filter-wrap"),T=w.querySelector(".renuvex-pr-write-btn"),S=document.createElement("div");return S.className="renuvex-pr-minimal-write-row",T&&S.appendChild(T),E&&S.appendChild(E),u.appendChild(S),u}var Bt={};Ae(Bt,{css:()=>so,meta:()=>uo,render:()=>vo});var zn=`
...
`;var uo={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},so=zn;function vo(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-hero";var c=document.createElement("div");c.className="renuvex-pr-hero-info";var v=document.createElement("div");v.className="renuvex-pr-hero-rating-col";var d=document.createElement("span");d.className="renuvex-pr-hero-avg",d.textContent=i,v.appendChild(d);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var x=document.createElement("span");x.className="renuvex-pr-hero-stars",x.innerHTML=Le(i,n),s.appendChild(x);var f=document.createElement("div");f.className="renuvex-pr-hero-count",f.textContent=a.toLocaleString("tr-TR")+" "+H(t.countLabel,"Yorum"),s.appendChild(f),v.appendChild(s),c.appendChild(v),u.appendChild(c);var m=pe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:te,onSortChange:l}),h=m.querySelector(".renuvex-pr-filter-wrap"),b=m.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",b&&w.appendChild(b),h&&w.appendChild(h),u.appendChild(w);var E=pe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:te,onSortChange:l}),T=E.querySelector(".renuvex-pr-filter-wrap"),S=E.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");return g.className="renuvex-pr-hero-write-row",S&&g.appendChild(S),T&&g.appendChild(T),u.appendChild(g),u}var Cn=`
  .renuvex-pr-summary{
...
`;var co={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},mo=Tn;function fo(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var n=document.createElement("div");n.className="renuvex-pr-review-top";var a=document.createElement("div");a.className="renuvex-pr-review-top-left";var i=document.createElement("span");i.className="renuvex-pr-review-stars",i.innerHTML=ke(e.rating,N),a.appendChild(i);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=Se(e.createdAt),n.appendChild(a),n.appendChild(o),t.appendChild(n),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-title",p.textContent=e.title,t.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-author",l.textContent=e.author||"",t.appendChild(l);var u=(e.comment||"").trim();u&&t.appendChild(ir(u,"renuvex-pr-body").fragment);var c=Ce(e);if(c.length){var v=document.createElement("div");v.className="renuvex-pr-gallery",c.forEach(function(s){var x=Re(s,{className:"renuvex-pr-img",sourceWidth:le,width:le,height:le,onOpen:function(){ge(e,s.url,r)}});x&&v.appendChild(x)}),t.appendChild(v)}var d=or(e.merchantReply);return d&&t.appendChild(d),t}var Ot={};Ae(Ot,{css:()=>go,meta:()=>xo,render:()=>ho});var An=`
  .renuvex-pr-review-list{
    display:grid;
...
`;var xo={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--renuvex-pr-list-photo-w":"80px","--renuvex-pr-list-photo-h":"106.67px","--renuvex-pr-list-photo-w-mobile":"80px","--renuvex-pr-list-photo-h-mobile":"106.67px"},medium:{"--renuvex-pr-list-photo-w":"110px","--renuvex-pr-list-photo-h":"146.67px","--renuvex-pr-list-photo-w-mobile":"100px","--renuvex-pr-list-photo-h-mobile":"133.33px"},large:{"--renuvex-pr-list-photo-w":"140px","--renuvex-pr-list-photo-h":"186.67px","--renuvex-pr-list-photo-w-mobile":"110px","--renuvex-pr-list-photo-h-mobile":"146.67px"}}},go=An;function ho(e,r){var t=Ce(e),n=t.length>0,a=document.createElement("article");a.className="renuvex-pr-review-list"+(n?"":" renuvex-pr-review-list--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-list-author";var o=document.createElement("span");o.className="renuvex-pr-review-stars renuvex-pr-review-list-author-stars",o.innerHTML=ke(e.rating,N),i.appendChild(o);var p=document.createElement("span");p.className="renuvex-pr-review-list-author-name",p.textContent=e.author||"",i.appendChild(p);var l=document.createElement("time");l.className="renuvex-pr-date renuvex-pr-review-list-author-date",e.createdAt&&l.setAttribute("datetime",e.createdAt),l.textContent=Se(e.createdAt),i.appendChild(l),a.appendChild(i);var u=document.createElement("div");if(u.className="renuvex-pr-review-list-content",e.title){var c=document.createElement("div");c.className="renuvex-pr-review-list-title",c.textContent=e.title,u.appendChild(c)}var v=(e.comment||"").trim();v&&u.appendChild(ir(v,"renuvex-pr-review-list-body").fragment);var d=or(e.merchantReply);if(d&&u.appendChild(d),a.appendChild(u),n){var s=document.createElement("div");s.className="renuvex-pr-review-list-media",t.forEach(function(x){var f=Re(x,{sourceWidth:le,width:le,height:Math.round(le*4/3),onOpen:function(){ge(e,x.url,r)}});f&&s.appendChild(f)}),a.appendChild(s)}return a}var Ft={};Ae(Ft,{css:()=>yo,meta:()=>bo,render:()=>wo});var Pn=`
...
`;var bo={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--renuvex-pr-gallery-photo-w":"80px","--renuvex-pr-gallery-photo-w-mobile":"80px"},medium:{"--renuvex-pr-gallery-photo-w":"110px","--renuvex-pr-gallery-photo-w-mobile":"100px"},large:{"--renuvex-pr-gallery-photo-w":"140px","--renuvex-pr-gallery-photo-w-mobile":"110px"}}},yo=Pn;function wo(e,r){var t=Hr(e),n=!!t,a=document.createElement("article");a.className="renuvex-pr-review-gallery"+(n?"":" renuvex-pr-review-gallery--no-media");var i=document.createElement("div");i.className="renuvex-pr-review-gallery-content";var o=document.createElement("span");if(o.className="renuvex-pr-review-stars renuvex-pr-review-gallery-stars",o.innerHTML=ke(e.rating,N),i.appendChild(o),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-gallery-title",p.textContent=e.title,i.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-review-gallery-author",l.textContent=e.author||"",i.appendChild(l);var u=document.createElement("time");u.className="renuvex-pr-review-gallery-date",u.style.display="block",e.createdAt&&u.setAttribute("datetime",e.createdAt),u.textContent=Se(e.createdAt),i.appendChild(u);var c=(e.comment||"").trim();if(c&&i.appendChild(ir(c,"renuvex-pr-review-gallery-body",t?{onReadMore:function(){ge(e,t.url,r)}}:null).fragment),a.appendChild(i),n){var v=document.createElement("div");v.className="renuvex-pr-review-gallery-media";var d=Re(t,{sourceWidth:Nr,width:Nr,height:Math.round(Nr*4/3),onOpen:function(){ge(e,t.url,r)}});d&&v.appendChild(d),a.appendChild(v)}var s=or(e.merchantReply,t?function(){ge(e,t.url,r)}:null);return s&&(s.classList.add("renuvex-pr-review-gallery-reply"),a.appendChild(s)),a}var ot={card:It,list:Ot,gallery:Ft};function lt(e){return ot[e]||ot.card}function _n(){return Object.keys(ot).map(function(e){return ot[e].css||""}).join(`
`)}var Ut=0;function Ye(){return Ut++,Ut}function je(e,r){return e!==Ut?!1:r?!(r.productId!==void 0&&Z!==r.productId||r.orderBy!==void 0&&re!==r.orderBy||r.page!==void 0&&pr!==r.page||r.ratingFilter!==void 0&&ie!==r.ratingFilter||r.hasImages!==void 0&&oe!==r.hasImages||r.nextCursor!==void 0&&zr!==r.nextCursor):!0}var Ht={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,loadMoreMinHeight:32,loadMorePadY:7,loadMorePadX:20,loadMoreMobileMinHeight:36,paginationButtonSize:32,paginationPadX:7,paginationGap:4,paginationMarginTop:16,paginationGapMin:18,paginationMobileButtonSize:34,paginationMobileFontSize:12,paginationMobileGap:0,paginationMobileMarginTop:14,paginationMobileGapMin:14,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74,minimalCountSize:14,heroCountSize:14},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:13,loadMoreMinHeight:36,loadMorePadY:8,loadMorePadX:24,loadMoreMobileMinHeight:38,paginationButtonSize:36,paginationPadX:8,paginationGap:5,paginationMarginTop:18,paginationGapMin:20,paginationMobileButtonSize:36,paginationMobileFontSize:13,paginationMobileGap:2,paginationMobileMarginTop:16,paginationMobileGapMin:16,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90,minimalCountSize:16,heroCountSize:16},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:14,loadMoreMinHeight:40,loadMorePadY:9,loadMorePadX:28,loadMoreMobileMinHeight:40,paginationButtonSize:40,paginationPadX:10,paginationGap:6,paginationMarginTop:20,paginationGapMin:22,paginationMobileButtonSize:40,paginationMobileFontSize:14,paginationMobileGap:2,paginationMobileMarginTop:18,paginationMobileGapMin:18,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106,minimalCountSize:18,heroCountSize:18}},Vt={small:80,medium:110,large:140},Dt={small:80,medium:100,large:110};function Mn(e){var r=document.createElement("div");r.style.cssText="padding:40px 20px;margin-top:24px;text-align:center;color:#6e6d7a;font-family:Inter,sans-serif;border:1px dashed #e3e1e5;border-radius:"+e+"px;background:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;";var t="http://www.w3.org/2000/svg",n=document.createElementNS(t,"svg");n.setAttribute("width","32"),n.setAttribute("height","32"),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","2"),n.setAttribute("stroke-linecap","round"),n.setAttribute("stroke-linejoin","round"),n.style.cssText="color:#6e6d7a;margin-bottom:4px;";var a=document.createElementNS(t,"path");a.setAttribute("d","M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24");var i=document.createElementNS(t,"line");i.setAttribute("x1","1"),i.setAttribute("y1","1"),i.setAttribute("x2","23"),i.setAttribute("y2","23"),n.appendChild(a),n.appendChild(i);var o=document.createElement("div");o.style.cssText="font-weight:500;font-size:18px;color:#1a191a;letter-spacing:-0.01em;",o.textContent="Widget \u015Fu anda Pasif durumda";var p=document.createElement("div");return p.style.cssText="font-size:16px;color:#6e6d7a;max-width:380px;line-height:1.5;",p.textContent="Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.",r.appendChild(n),r.appendChild(o),r.appendChild(p),r}function Ln(e){e=e||{};var r=document.createElement("div");r.className="renuvex-pr-empty-state";var t=document.createElement("div");t.className="renuvex-pr-empty-state-content";var n=document.createElement("div");n.className="renuvex-pr-empty-state-stars",n.innerHTML=Le(0,e.iconPair),t.appendChild(n);var a=document.createElement("p");a.className="renuvex-pr-state-msg renuvex-pr-empty-state-text",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),a.textContent=e.emptyStateText||"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun.",t.appendChild(a),r.appendChild(t);var i=document.createElement("button");return i.type="button",i.className="renuvex-pr-write-btn renuvex-pr-empty-state-cta",i.textContent=e.writeButtonText||"Yorum Yap",i.onclick=typeof e.onWriteClick=="function"?e.onWriteClick:null,r.appendChild(i),r}function Rn(){var e=document.createElement("p");return e.className="renuvex-pr-state-msg renuvex-pr-filter-empty-state",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.textContent="Hen\xFCz yorum yok.",e}function Nn(e,r){var t=document.createElement("div");t.className="renuvex-pr-state-msg renuvex-pr-state-error",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");var n=document.createElement("div");n.className="renuvex-pr-state-error-text",n.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",t.appendChild(n);var a=document.createElement("button");return a.type="button",a.className="renuvex-pr-state-retry",a.textContent="Tekrar Dene",a.onclick=async function(){a.disabled=!0,a.textContent="Tekrar deneniyor...",await r()},t.appendChild(a),t}function Te(e,r){var t=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!t)return"rgba(0,0,0,"+r+")";var n=parseInt(t[1],16),a=parseInt(t[2],16),i=parseInt(t[3],16);return"rgba("+n+","+a+","+i+","+r+")"}function pt(e){var r=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e||"");return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}function Yt(e){var r=e/255;return r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4)}function Bn(e){return .2126*Yt(e.r)+.7152*Yt(e.g)+.0722*Yt(e.b)}function In(e,r){var t=Bn(e),n=Bn(r),a=Math.max(t,n),i=Math.min(t,n);return(a+.05)/(i+.05)}function ko(e){var r=pt(e)||pt("#ffffff"),t=pt("#111111"),n=pt("#ffffff");return In(t,r)>=In(n,r)?"#111111":"#ffffff"}function So(e){return Te(e,e==="#ffffff"?.1:.06)}function On(e,r){var t=r.headerTitleColor||"#111111",n=r.headerAvgColor||"#111111",a=r.headerCountColor||"#111111",i=r.headerRecommendColor||"#111111",o=r.barFillColor||"#111111",p=r.barTrackColor||"#e5e7eb",l=r.barCountColor||"#111111",u=Te(o,.06),c=r.reviewStarColor||"#f59e0b",v=r.btnBgColor||"#111111",d=r.btnTextColor||"#ffffff",s=r.btnBorderColor||"#111111",x=r.filterBtnBgColor||"#111111",f=r.filterBtnTextColor||"#ffffff",m=r.filterBtnBorderColor||"#111111",h=r.filterMenuBgColor||"#ffffff",b=r.filterMenuBorderColor||"#e5e7eb",w=r.filterItemTextColor||"#111111",E=r.filterItemHoverBgColor||"#f3f4f6",T=r.filterItemActiveColor||"#111111",S=r.reviewTitleColor||"#111111",g=r.reviewAuthorColor||"#111111",k=r.reviewDateColor||"#5e5e5e",C=r.reviewBodyColor||"#111111",z=r.reviewBorderColor||"#e5e7eb",A=Te(C,.65),L=r.replyBgColor||"#f9fafb",I=r.replyBorderColor||"#747474",_=r.replyLabelColor||"#111111",y=r.replyTextColor||"#111111",M=r.photoTitleColor||"#111111",P=Te("#111111",.05),B=r.photoArrowBgColor||"#ffffff",R=r.photoArrowTextColor||"#111111",j=Te("#111111",.12),J=r.reviewLightboxVideoIconColor||"#ffffff",Y=r.reviewLightboxVideoButtonBgColor||"#000000",U=r.reviewLightboxVideoButtonHoverBgColor||"#222222",G=r.reviewLightboxVideoProgressColor||"#ffffff",X=r.reviewLightboxVideoProgressTrackColor||"#000000",V=r.formBgColor||"#ffffff",K=r.formPrimaryTextColor||"#111111",O=r.formSecondaryTextColor||"#3b3b3b",F=r.inputTextColor||K,W=r.inputBorderColor||"#d1d5db",ae=r.placeholderColor||"#9ca3af",q=r.formStepBarColor||"#111111",$=r.formBtnBgColor||"#111111",lr=r.formBtnTextColor||"#ffffff",Ne=r.formBtnBorderColor||"#111111",D=Te($,.06),ne=Te($,.18),me=Te(lr,.85),Q=Te(K,.06),fe=ko(V),br=So(fe),yr=r.loadMoreBgColor||"#ffffff",wr=r.loadMoreTextColor||"#111111",kr=r.loadMoreBorderColor||"#111111",be=r.paginationBgColor||"#ffffff",Sr=r.paginationTextColor||"#111111",ut=r.paginationBorderColor||"#e5e7eb",dt=r.paginationActiveBgColor||"#111111",Dn=r.paginationActiveTextColor||"#ffffff",qt={"--renuvex-pr-widget-bg":"#ffffff00","--renuvex-pr-widget-border":"#ffffff00","--renuvex-pr-header-title":t,"--renuvex-pr-header-avg":n,"--renuvex-pr-header-count":a,"--renuvex-pr-header-recommend":i,"--renuvex-pr-bar-fill":o,"--renuvex-pr-bar-track":p,"--renuvex-pr-bar-count":l,"--renuvex-pr-bar-hover-bg":u,"--renuvex-pr-btn-bg":v,"--renuvex-pr-btn-text":d,"--renuvex-pr-btn-border":s,"--renuvex-pr-filter-btn-bg":x,"--renuvex-pr-filter-btn-text":f,"--renuvex-pr-filter-btn-border":m,"--renuvex-pr-filter-menu-bg":h,"--renuvex-pr-filter-menu-border":b,"--renuvex-pr-filter-item-text":w,"--renuvex-pr-filter-item-hover-bg":E,"--renuvex-pr-filter-item-active":T,"--renuvex-pr-review-title":S,"--renuvex-pr-review-author":g,"--renuvex-pr-review-date":k,"--renuvex-pr-review-body":C,"--renuvex-pr-review-border":z,"--renuvex-pr-state-text":A,"--renuvex-pr-review-star-color":c,"--renuvex-pr-reply-bg-color":L,"--renuvex-pr-reply-border":I,"--renuvex-pr-reply-label":_,"--renuvex-pr-reply-text":y,"--renuvex-pr-photo-title":M,"--renuvex-pr-photo-image-border":P,"--renuvex-pr-photo-arrow-bg":B,"--renuvex-pr-photo-arrow-text":R,"--renuvex-pr-photo-arrow-border":j,"--renuvex-pr-review-lightbox-video-icon":J,"--renuvex-pr-review-lightbox-video-button-bg":Y,"--renuvex-pr-review-lightbox-video-button-hover-bg":U,"--renuvex-pr-review-lightbox-video-progress":G,"--renuvex-pr-review-lightbox-video-progress-track":X,"--renuvex-pr-fwizard-bg":V,"--renuvex-pr-fwizard-text":K,"--renuvex-pr-fwizard-secondary-text":O,"--renuvex-pr-fwizard-input-bg":V,"--renuvex-pr-fwizard-input-text":F,"--renuvex-pr-fwizard-input-border":W,"--renuvex-pr-fwizard-placeholder":ae,"--renuvex-pr-fwizard-close-text":fe,"--renuvex-pr-fwizard-close-hover-bg":br,"--renuvex-pr-fwizard-progress-bg":Q,"--renuvex-pr-fwizard-progress-active":q,"--renuvex-pr-fwizard-btn-bg":$,"--renuvex-pr-fwizard-btn-text":lr,"--renuvex-pr-fwizard-btn-border":Ne,"--renuvex-pr-fwizard-btn-disabled-bg":ne,"--renuvex-pr-fwizard-btn-disabled-text":me,"--renuvex-pr-fwizard-nav-hover-bg":D,"--renuvex-pr-load-more-bg":yr,"--renuvex-pr-load-more-text":wr,"--renuvex-pr-load-more-border":kr,"--renuvex-pr-pagination-bg":be,"--renuvex-pr-pagination-text":Sr,"--renuvex-pr-pagination-border":ut,"--renuvex-pr-pagination-active-bg":dt,"--renuvex-pr-pagination-active-text":Dn};Object.keys(qt).forEach(function(Gt){e.style.setProperty(Gt,qt[Gt])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}function Fn(e){var r=e.settings,t=e.root,n=e.currentHasImages,a=e.openReviewModal,i=(e.photoStripReviews||[]).filter(function(w){return Ce(w).length>0});if(!(r.showPhotoGallery!==!1&&!n&&i.length>0))return null;var o=document.createElement("div");if(o.className="renuvex-pr-photo-section",r.showPhotoGalleryTitle!==!1){var p=H(r.photoGalleryTitle,"Foto\u011Frafl\u0131 Yorumlar"),l=document.createElement("div");l.className="renuvex-pr-photo-title",l.textContent=p,o.appendChild(l)}var u=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--renuvex-pr-photo-thumb-aspect",u);var c=document.createElement("div");c.className="renuvex-pr-photo-strip";var v=le,d=r.reviewLayout==="card"?le:Math.round(le*4/3),s=0;i.forEach(function(w){if(!(s>=15)){var E=Hr(w);if(E){var T=Re(E,{className:"renuvex-pr-photo-strip-thumb",sourceWidth:le,width:v,height:d,loading:s<3?"eager":"lazy",onOpen:function(){a(w,E.url,i)}});T&&(c.appendChild(T),s++)}}});var x=document.createElement("button");x.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-prev";var f=ee(qe);f&&x.appendChild(f),x.setAttribute("aria-label","\xD6nceki"),x.onclick=function(){c.scrollBy({left:-200,behavior:"smooth"})};var m=document.createElement("button");m.className="renuvex-pr-photo-strip-arrow renuvex-pr-photo-strip-arrow-next";var h=ee(_r);h&&m.appendChild(h),m.setAttribute("aria-label","Sonraki"),m.onclick=function(){c.scrollBy({left:200,behavior:"smooth"})};var b=document.createElement("div");return b.className="renuvex-pr-photo-strip-wrap",b.appendChild(x),b.appendChild(c),b.appendChild(m),o.appendChild(b),o}var zo=1,Co=7,jt="\u2026";function Eo(e,r){var t=Math.max(1,Math.floor(Number(r))||1),n=Math.min(Math.max(1,Math.floor(Number(e))||1),t);if(t<=Co){for(var a=[],i=1;i<=t;i++)a.push(i);return a}for(var o=[],p=1;p<=t;p++)(p===1||p===t||Math.abs(p-n)<=zo)&&o.push(p);for(var l=[],u=0;u<o.length;u++)u>0&&o[u]-o[u-1]>1&&l.push(jt),l.push(o[u]);return l}function Un(e){var r=Math.max(1,Math.floor(Number(e.totalPages))||1),t=Math.min(Math.max(1,Math.floor(Number(e.page))||1),r),n=typeof e.onPageChange=="function"?e.onPageChange:function(){},a=document.createElement("nav");a.className="renuvex-pr-pagination",a.setAttribute("aria-label","Yorum sayfalar\u0131");function i(l){a.setAttribute("aria-busy","true");for(var u=a.querySelectorAll("button"),c=0;c<u.length;c++)u[c].disabled=!0;n(l)}function o(l,u){var c=document.createElement("span");c.className="renuvex-pr-pagination-label",c.setAttribute("aria-hidden","true"),c.textContent=u,l.appendChild(c)}function p(l,u,c,v){var d=document.createElement("button");return d.type="button",d.className="renuvex-pr-pagination-arrow",d.setAttribute("aria-label",l),o(d,u),v?d.disabled=!0:d.onclick=function(){i(c)},d}return a.appendChild(p("\xD6nceki sayfa","\u2039",t-1,t<=1)),Eo(t,r).forEach(function(l){if(l===jt){var u=document.createElement("span");u.className="renuvex-pr-pagination-gap",u.setAttribute("aria-hidden","true"),u.textContent=jt,a.appendChild(u);return}var c=document.createElement("button");c.type="button",c.className="renuvex-pr-pagination-btn",c.setAttribute("aria-label","Sayfa "+l),o(c,String(l)),l===t?c.setAttribute("aria-current","page"):c.onclick=function(){i(l)},a.appendChild(c)}),a.appendChild(p("Sonraki sayfa","\u203A",t+1,t>=r)),a}function Hn(e,r){if(e){var t=e.getElementById&&e.getElementById("renuvex-pr-pagination-live");t||(t=document.createElement("div"),t.id="renuvex-pr-pagination-live",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText="position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0;",e.appendChild(t)),t.textContent="Sayfa "+r}}function Vn(e){var r=e.render;async function t(){var o=Ye(),p=Z,l=re,u=ie,c=oe;_e(null);var v=await Ue(Z,re,1,ie,oe);je(o,{productId:p,orderBy:l,ratingFilter:u,hasImages:c})&&await r(Z,N,v,Be,re,1,Xt)}async function n(o){var p=Ye(),l=ie===o?null:o,u=Z,c=re,v=oe;Jt(l),Ie(1),_e(null);var d=await Ue(Z,re,1,l,oe);je(p,{productId:u,orderBy:c,page:1,ratingFilter:l,hasImages:v})&&await r(Z,N,d,Be,re,1)}async function a(o,p){var l=Ye(),u=Z,c=ie;Ie(1),_e(null);var v=o,d=!1;p&&(d=!0,v="newest"),Zt(d),Cr(v);var s=await Ue(Z,v,1,ie,d);je(l,{productId:u,orderBy:v,page:1,ratingFilter:c,hasImages:d})&&await r(Z,N,s,Be,v,1)}async function i(o){var p=Ye(),l=Z,u=re,c=ie,v=oe;Ie(o),_e(null);var d=await Ue(Z,re,o,ie,oe);if(je(p,{productId:l,orderBy:u,page:o,ratingFilter:c,hasImages:v})){await r(Z,N,d,Be,re,o);var s=document.getElementById("renuvex-reviews"),x=s&&s.shadowRoot,f=x&&x.querySelector&&x.querySelector('.renuvex-pr-pagination-btn[aria-current="page"]');if(f){try{f.focus({preventScroll:!0})}catch(b){try{f.focus()}catch(w){}}Hn(x,o)}if(typeof window!="undefined"&&!window.__ikasPreviewMode){var m=document.getElementById("renuvex-reviews");if(m&&typeof m.scrollIntoView=="function"){var h=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;m.scrollIntoView({behavior:h?"auto":"smooth",block:"start"})}}}}return{onRetry:t,onFilterChange:n,onSortChange:a,onPageChange:i}}function To(){return ga()?document.querySelector('[data-renuvex-widget="reviews"]'):null}function Ao(e,r){var t=e.querySelector('[data-renuvex-slot="product-reviews"]');return t||(t=fa({slot:"product-reviews",className:"renuvex-pr-reviews-slot",context:{surface:"reviews",productId:r||""}}),e.appendChild(t)),xa(t,{surface:"reviews",productId:r||""}),t}async function Wt(e,r,t,n,a,i,o){if(la){Ar({productId:e,settings:r,reviewsData:t,productName:n,orderBy:a,page:i,badgeSettings:o});return}Tr(!0),Qt(e),ea(r),o!==void 0&&ra(o),ta(n),a&&Cr(a),i&&Ie(i),t!=null&&(aa(t),_e(t&&t.data?t.data.nextCursor:null));var p=Vn({render:Wt});try{let Ne=function(D,ne){if(!(!D||!D.meta||!D.meta.sizeOverrides)){var me=D.meta.sizeOverrides[ne];me&&Object.keys(me).forEach(function(Q){s.style.setProperty(Q,me[Q])})}};var $=Ne,l=it(r.summaryLayout),u=!(l.meta&&l.meta.supports&&l.meta.supports.title===!1),c=r.showTitle!==!1,v=H(r.title,"M\xFC\u015Fteri Yorumlar\u0131"),d=u&&c?v:"",s=document.documentElement;On(s,r);var x=r.borderRadius!==void 0?r.borderRadius:8,f=Ht[r.size]||Ht.medium,m=Vt[r.thumbnailSize]||Vt.medium,h=m;(r.reviewLayout==="list"||r.reviewLayout==="gallery")&&(h=Dt[r.thumbnailSize]||Dt.medium),s.style.setProperty("--renuvex-pr-title-size",f.titleSize+"px"),s.style.setProperty("--renuvex-pr-review-text-size",f.reviewTextSize+"px"),s.style.setProperty("--renuvex-pr-review-title-size",f.reviewTitleSize+"px"),s.style.setProperty("--renuvex-pr-author-size",f.authorSize+"px"),s.style.setProperty("--renuvex-pr-reply-name-size",f.replyNameSize+"px"),s.style.setProperty("--renuvex-pr-reply-text-size",f.replyTextSize+"px"),s.style.setProperty("--renuvex-pr-radius",x+"px"),s.style.setProperty("--renuvex-pr-radius-sm",Math.max(0,x-4)+"px"),s.style.setProperty("--renuvex-pr-photo-title-size",f.photoTitleSize+"px"),s.style.setProperty("--renuvex-pr-avg-rating-size",f.avgRatingSize+"px"),s.style.setProperty("--renuvex-pr-review-count-size",f.reviewCountSize+"px"),s.style.setProperty("--renuvex-pr-compact-count-size",f.compactCountSize+"px"),s.style.setProperty("--renuvex-pr-recommend-size",f.recommendSize+"px"),s.style.setProperty("--renuvex-pr-btn-text-size",f.btnTextSize+"px"),s.style.setProperty("--renuvex-pr-bar-label-size",f.barLabelSize+"px"),s.style.setProperty("--renuvex-pr-minimal-avg-size",f.minimalAvgSize+"px"),s.style.setProperty("--renuvex-pr-hero-avg-size",f.heroAvgSize+"px"),s.style.setProperty("--renuvex-pr-minimal-count-size",f.minimalCountSize+"px"),s.style.setProperty("--renuvex-pr-hero-count-size",f.heroCountSize+"px"),s.style.setProperty("--renuvex-pr-bar-count-size",f.barCountSize+"px"),s.style.setProperty("--renuvex-pr-review-date-size",f.reviewDateSize+"px"),s.style.setProperty("--renuvex-pr-filter-text-size",f.filterTextSize+"px"),s.style.setProperty("--renuvex-pr-load-more-size",f.loadMoreSize+"px"),s.style.setProperty("--renuvex-pr-load-more-min-height",f.loadMoreMinHeight+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-y",f.loadMorePadY+"px"),s.style.setProperty("--renuvex-pr-load-more-pad-x",f.loadMorePadX+"px"),s.style.setProperty("--renuvex-pr-load-more-mobile-min-height",f.loadMoreMobileMinHeight+"px"),s.style.setProperty("--renuvex-pr-pagination-button-size",f.paginationButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-pad-x",f.paginationPadX+"px"),s.style.setProperty("--renuvex-pr-pagination-gap",f.paginationGap+"px"),s.style.setProperty("--renuvex-pr-pagination-margin-top",f.paginationMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-gap-min",f.paginationGapMin+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-button-size",f.paginationMobileButtonSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-font-size",f.paginationMobileFontSize+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap",f.paginationMobileGap+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-margin-top",f.paginationMobileMarginTop+"px"),s.style.setProperty("--renuvex-pr-pagination-mobile-gap-min",f.paginationMobileGapMin+"px"),s.style.setProperty("--renuvex-pr-read-more-size",f.readMoreSize+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size",m+"px"),s.style.setProperty("--renuvex-pr-thumbnail-size-mobile",h+"px");var b=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";s.style.setProperty("--renuvex-pr-review-star-color",b),s.style.setProperty("--renuvex-pr-star-size",f.reviewStarSize+"px"),s.style.setProperty("--renuvex-pr-avg-star-size",f.avgStarSize+"px"),Ne(it(r.summaryLayout),r.size),Ne(lt(r.reviewLayout),r.size);var w=ur(r),E=To();if(!E)return;var T=Ao(E,e),S=document.getElementById("renuvex-reviews");S||(S=document.createElement("div"),S.id="renuvex-reviews",S.style.minHeight="200px"),S.parentNode!==T&&T.appendChild(S);var g=wa(S),k=Ke+We+Dr+En()+_n();Xe(g,k);var C=Sa(g);if(r.enabled===!1){S.style.minHeight="auto",C.replaceChildren(Mn(r.borderRadius!==void 0?r.borderRadius:8)),Tr(!1);var z=Er;Ar(null),z&&Wt(z.productId,z.settings,z.reviewsData,z.productName,z.orderBy,z.page,z.badgeSettings);return}try{var A=t||{},L=xt(A),I=L?[]:A.data&&A.data.reviews||[];na(I),C.replaceChildren();var _=document.createElement("section");if(_.id="renuvex-reviews-widget",_.setAttribute("aria-label","\xDCr\xFCn yorumlar\u0131"),_.className="renuvex-pr-reviews-widget",_.setAttribute("data-renuvex-surface","reviews"),e&&_.setAttribute("data-renuvex-product-id",String(e)),typeof window!="undefined"&&window.__ikasPreviewMode&&(_.style.width="100%",_.style.maxWidth="100%",_.style.marginLeft="0",_.style.marginRight="0"),d){var y=document.createElement("div"),M=r.summaryLayout||"classic";y.className="renuvex-pr-title renuvex-pr-title-"+M,y.textContent=d,_.appendChild(y)}if(L){_.appendChild(Nn(A.message,p.onRetry)),C.appendChild(_),Oe(g),vt(_,"reviews-widget",{productId:e||"",reason:"fetch_error"},function(){return g.getElementById("renuvex-reviews-widget")});return}var P=A.data&&A.data.allCount||0,B=A.data&&A.data.ratingCounts||null,R=B||[0,0,0,0,0],j=A.data&&A.data.avgRating||"0.0";if(!B&&I.length>0){I.forEach(function(D){D.rating>=1&&D.rating<=5&&R[D.rating-1]++});var J=I.reduce(function(D,ne){return D+ne.rating},0);j=(J/I.length).toFixed(1)}if(P===0)_.classList.add("renuvex-pr-reviews-empty"),_.appendChild(Ln({iconPair:w,writeButtonText:H(r.writeButtonText,"Yorum Yap"),emptyStateText:H(r.emptyStateText,"\u0130lk yorumu yazarak di\u011Fer m\xFC\u015Fterilere yard\u0131mc\u0131 olun."),onWriteClick:te}));else{var Y=it(r.summaryLayout),U=Y.render({widget:_,productId:e,data:A,settings:r,iconPair:w,allCount:P,ratingCounts:R,avgRatingVal:j,currentRatingFilter:ie,currentOrderBy:re,currentHasImages:oe,onFilterChange:p.onFilterChange,onSortChange:p.onSortChange});_.appendChild(U);var G=Fn({settings:r,root:s,currentHasImages:oe,photoStripReviews:$t,openReviewModal:ge,wireLightboxTrigger:vr});if(G&&_.appendChild(G),I.length===0)_.appendChild(Rn());else{var X=lt(r.reviewLayout);I.forEach(function(D){_.appendChild(X.render(D,ct))})}var V=r.paginationMode==="numbered"?"numbered":"loadMore";if(V==="numbered"){var K=A.data&&A.data.totalPages||1;K>1&&_.appendChild(Un({page:A.data&&A.data.page||pr||1,totalPages:K,onPageChange:p.onPageChange}))}var O=V==="loadMore"&&A.data&&A.data.hasMore;if(O){let D=function(ne){W.textContent=ne,F.setAttribute("aria-label",ne)};var lr=D,F=document.createElement("button");F.className="renuvex-pr-load-more";var W=document.createElement("span");W.className="renuvex-pr-load-more-label",W.setAttribute("aria-hidden","true"),F.appendChild(W),D("Daha Fazla G\xF6ster"),F.onclick=async function(){F.disabled=!0,D("Y\xFCkleniyor...");var ne=Ye(),me=Z,Q=re,fe=pr,br=ie,yr=oe,wr=zr,kr=fe+1,be=await Ue(me,Q,kr,br,yr,null,wr);if(je(ne,{productId:me,orderBy:Q,page:fe,ratingFilter:br,hasImages:yr,nextCursor:wr}))if(be&&!xt(be)&&be.data&&Array.isArray(be.data.reviews)){var Sr=ia(be.data.reviews);oa(Sr),Ie(kr),_e(be.data.nextCursor||null);var ut=lt(N.reviewLayout);Sr.forEach(function(dt){_.insertBefore(ut.render(dt,ct),F)}),be.data.hasMore?(F.disabled=!1,D("Daha Fazla G\xF6ster")):F.remove()}else F.disabled=!1,D("Tekrar Dene")},_.appendChild(F)}}C.appendChild(_),Oe(g),vt(_,"reviews-widget",{productId:e||""},function(){return g.getElementById("renuvex-reviews-widget")})}catch(D){console.error("[renuvex-pr] render error:",D);var ae=document.createElement("p");ae.style.cssText="text-align:center;color:#dc2626;",ae.textContent="Yorumlar y\xFCklenirken bir hata olu\u015Ftu.",C&&C.replaceChildren(ae)}}finally{if(Tr(!1),Er){var q=Er;Ar(null),Wt(q.productId,q.settings,q.reviewsData,q.productName,q.orderBy,q.page,q.badgeSettings)}}}export{Wt as render};
