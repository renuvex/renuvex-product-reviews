...
import{b as De}from"./chunk-Z7432DLE.js";import{a as he,b as jr,c as dr,d as Dr}from"./chunk-HEKEBJUA.js";import{$ as Or,A as Ir,B as Ge,C as We,D as qe,J as Oe,K as Br,M as Mr,N as se,O as ve,P as Fr,Q as ce,R as Hr,S as _r,T as ge,U as Ke,V,W as Ue,X as Xe,Y as or,Z as lr,_ as ee,a as ue,aa as re,b as fe,ba as Yr,c as ke,ca as Ye,d as de,e as zr,f as Ce,g as Se,ga as Vr,h as Q,i as A,j as tr,k as Pe,m as ar,n as Cr,o as Re,p as Ee,q as Ve,r as nr,s as Sr,t as Er,u as Tr,v as Lr,w as Nr,x as Ar,y as Pr,z as Rr}from"./chunk-B6GLB6KJ.js";var Ci=15,Si=60*1e3,Gr="__ikrReviewsFetchError",sr={};function Je(e){return{type:Gr,message:e||"Yorumlar \u015Fu anda y\xFCklenemiyor."}}function cr(e){return!!(e&&e.type===Gr)}async function Te(e,r,i,a,n,d){if(window.__ikasPreviewMode){try{var c=window.__ikasPreviewBaseUrl||ke,o=c+"/api/preview/reviews?page="+encodeURIComponent(i||1),s=await he(o);if(s.ok)return await s.json()}catch(b){}return Je()}r=r||"newest",i=i||1;var p=d?"_l"+d:"",k="ikr_reviews_"+fe+"_"+e+"_"+r+"_"+i+"_"+(a||"")+"_"+(n?"1":"0")+p,l=null,t=Yr(k);if(t)try{var f=JSON.parse(t);if(f&&f.t!==void 0&&f.v){if(Date.now()-f.t<Si)return f.v;l=f.v,Ye(k,"")}else Ye(k,"")}catch(b){Ye(k,"")}try{var u=ke+"/api/public/reviews?storeId="+encodeURIComponent(fe)+"&productId="+encodeURIComponent(e)+"&orderBy="+encodeURIComponent(r)+"&page="+encodeURIComponent(i)+(a?"&rating="+encodeURIComponent(a):"")+(n?"&hasImages=true":"")+(d?"&limit="+encodeURIComponent(d):""),v=await he(u);if(!v.ok)return l||Je();var m=await v.json();return Ye(k,JSON.stringify({t:Date.now(),v:m})),m}catch(b){return console.error("[ikr] fetchReviews error:",b),l||Je()}}async function Ei(e){var r=await Te(e,"newest",1,null,!0,Ci);return!r||!r.data||!Array.isArray(r.data.reviews)?[]:r.data.reviews}async function Lt(e,r){var i=document.getElementById("ikr-rating-badge");i&&i.remove();var a=document.getElementById("ikr-jsonld");if(a&&a.remove(),!sr[e]){sr[e]=!0;var n={title:"M\xFC\u015Fteri Yorumlar\u0131",enabled:!0},d={enabled:!0,size:"medium"};try{var c=await jr();if(!c)return;var o=c.widgets&&c.widgets.reviews||n,s=c.widgets&&c.widgets.badge||d;if(o.enabled===!1)return;Re("newest"),Ee(1),Ve(null);var p=await Promise.all([Te(e,"newest",1,null),Ei(e)]),k=p[0];Ar(p[1]),await be(e,o,k,r,"newest",1,s)}catch(l){console.error("[ikr] bootstrap error:",l),await be(e,n,Je(),r,void 0,void 0,d)}finally{delete sr[e]}}}function Ie(e){return ge(e)}function Ti(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function ie(e,r,i,a){i?e.setProperty(r,i,a||""):e.removeProperty(r)}function Li(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",i=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&i>1;return a&&/AppleWebKit/i.test(r)}function Ni(){var e=Ti(),r=document.body.style,i=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",d=Li()&&!n;if(a>0){var c=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",c+a+"px","important")}return i.setProperty("overflow","hidden","important"),i.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),d&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important")),e}function Ai(e){if(e){var r=document.body.style,i=document.documentElement.style;ie(i,"overflow",e.rootOverflow,e.rootOverflowPriority),ie(i,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),ie(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),ie(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),ie(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),ie(r,"position",e.bodyPosition,e.bodyPositionPriority),ie(r,"top",e.bodyTop,e.bodyTopPriority),ie(r,"left",e.bodyLeft,e.bodyLeftPriority),ie(r,"right",e.bodyRight,e.bodyRightPriority),ie(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}}function Pi(){var e=document.activeElement;return!e||e===document.body||e===document.documentElement?null:e}function Be(e){if(!(!e||!document.contains(e)||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(i){}}}function Ri(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function qr(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(Ri)}function Kr(e){var r=qr(e),i=r[0]||e.querySelector('[role="dialog"]')||e;Be(i)}function Ii(e,r){if(e.key==="Tab"){var i=qr(r);if(!i.length){e.preventDefault(),Kr(r);return}var a=i[0],n=i[i.length-1],d=document.activeElement;if(!r.contains(d)){e.preventDefault(),Be(a);return}e.shiftKey&&d===a?(e.preventDefault(),Be(n)):!e.shiftKey&&d===n&&(e.preventDefault(),Be(a))}}function Bi(){var e={id:"ikr-modal-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state,history.pushState({ikrModal:e.id},"",e.url),e.pushed=!0}catch(r){}return e}function Mi(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state.ikrModal===e.id)}function Fi(e){if(Mi(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function Wr(e,r,i,a,n){Ai(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",i),e.parentNode&&e.parentNode.removeChild(e),Be(n)}function Hi(e){var r=document.createElement("div");r.className="ikr-modal-right";var i=document.createElement("div");i.className="ikr-modal-scroll-content";var a=document.createElement("div");a.className="ikr-modal-top-row";var n=document.createElement("div");n.className="ikr-modal-stars",n.innerHTML=se(e.rating,A);var d=document.createElement("span");d.className="ikr-modal-date",d.textContent=ce(e.createdAt),a.appendChild(n),a.appendChild(d),i.appendChild(a);var c=document.createElement("div");c.className="ikr-modal-title",c.textContent=e.title||"",c.style.display=e.title?"":"none",i.appendChild(c);var o=document.createElement("div");o.className="ikr-modal-author",o.textContent=e.author||"",i.appendChild(o);var s=document.createElement("div");s.className="ikr-modal-body",s.textContent=(e.comment||"").trim(),s.style.display=e.comment&&e.comment.trim()?"":"none",i.appendChild(s);var p=document.createElement("div");p.className="ikr-modal-reply";var k=document.createElement("div");k.className="ikr-modal-reply-label",k.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi";var l=document.createElement("div");return l.className="ikr-modal-reply-text",l.textContent=e.merchantReply||"",p.appendChild(k),p.appendChild(l),p.style.display=e.merchantReply?"":"none",i.appendChild(p),r.appendChild(i),r}function Ur(e,r,i){var a=i||A,n=e.querySelector(".ikr-modal-scroll-content"),d=n.querySelector(".ikr-modal-stars");d.innerHTML=se(r.rating,a),n.querySelector(".ikr-modal-date").textContent=ce(r.createdAt);var c=n.querySelector(".ikr-modal-title");c.textContent=r.title||"",c.style.display=r.title?"":"none",n.querySelector(".ikr-modal-author").textContent=r.author||"";var o=n.querySelector(".ikr-modal-body");o.textContent=(r.comment||"").trim(),o.style.display=r.comment&&r.comment.trim()?"":"none";var s=n.querySelector(".ikr-modal-reply");s.querySelector(".ikr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",s.querySelector(".ikr-modal-reply-text").textContent=r.merchantReply||"",s.style.display=r.merchantReply?"":"none",e.scrollTop=0}function mr(e,r,i,a,n,d,c,o,s){var p=Ie(e),k=Math.max(0,Math.min(i||0,p.length-1)),l=document.createElement("div");l.className="ikr-modal-left";var t=document.createElement("img"),f=c==="next"?"ikr-modal-img-enter-right":c==="prev"?"ikr-modal-img-enter-left":"";t.className="ikr-modal-main-img"+(f?" "+f:""),t.src=lr(p[k]||""),t.decoding="async",t.width=or,t.height=Math.round(or*4/3),t.alt="Yorum foto\u011Fraf\u0131",Or(t,function(E){if(E.style.display="none",!l.querySelector(".ikr-modal-img-error")){var T=document.createElement("div");T.className="ikr-modal-img-error",T.setAttribute("role","status"),T.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",l.insertBefore(T,E)}}),l.appendChild(t);var u=document.createElement("button");u.className="ikr-modal-close-mobile",u.textContent="\u2715",u.setAttribute("aria-label","Kapat"),u.onclick=function(E){E.stopPropagation(),d()},l.appendChild(u);var v=0;if(l.addEventListener("touchstart",function(E){v=E.touches[0].clientX},{passive:!0}),l.addEventListener("touchend",function(E){var T=v-E.changedTouches[0].clientX;if(!(Math.abs(T)<50)){if(T>0){if(x)pe(e,r,k+1,a,n,d,!0,"next",o,s);else if(g){var h=a[r+1];pe(h,r+1,0,a,n,d,!1,"next",o,s)}}else if(b)pe(e,r,k-1,a,n,d,!0,"prev",o,s);else if(y){var N=a[r-1],L=Ie(N);pe(N,r-1,L.length-1,a,n,d,!1,"prev",o,s)}}},{passive:!0}),p.length>1){var m=document.createElement("div");m.className="ikr-modal-thumbs",p.forEach(function(E,T){var h=document.createElement("img"),N=ee(E,Xe);h.src=N.src,h.srcset=N.srcset,h.loading="lazy",h.decoding="async",h.width=Xe,h.height=Xe,h.className="ikr-modal-thumb"+(T===k?" ikr-modal-thumb-active":""),h.alt="K\xFC\xE7\xFCk resim "+(T+1),re(h),h.tabIndex=0,h.setAttribute("role","button"),h.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(T+1)+" se\xE7"),T===k&&h.setAttribute("aria-current","true"),(function(L){function B(){pe(e,r,L,a,n,d,!0,null,o,s)}h.onclick=B,h.onkeydown=function(H){(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),B())}})(T),m.appendChild(h)}),l.appendChild(m)}var b=k>0,x=k<p.length-1,y=r>0,g=r<a.length-1,S=b||y,z=x||g;if(S){var C=document.createElement("button");C.className="ikr-modal-nav ikr-modal-nav-prev",C.innerHTML="&#8249;",C.setAttribute("aria-label","\xD6nceki"),C.onclick=function(E){if(E.stopPropagation(),b)pe(e,r,k-1,a,n,d,!0,"prev",o,s);else if(y){var T=a[r-1],h=Ie(T);pe(T,r-1,h.length-1,a,n,d,!1,"prev",o,s)}},l.appendChild(C)}if(z){var w=document.createElement("button");w.className="ikr-modal-nav ikr-modal-nav-next",w.innerHTML="&#8250;",w.setAttribute("aria-label","Sonraki"),w.onclick=function(E){if(E.stopPropagation(),x)pe(e,r,k+1,a,n,d,!0,"next",o,s);else if(g){var T=a[r+1];pe(T,r+1,0,a,n,d,!1,"next",o,s)}},l.appendChild(w)}return l}function Xr(e,r){[-1,1].forEach(function(i){var a=r[e+i];if(a){var n=Ie(a);n[0]&&(new Image().src=lr(n[0]))}})}function pr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function _i(e,r){var i=e&&e.querySelector(".ikr-modal-wrap"),a=r&&r.querySelector(".ikr-modal-right"),n=r&&r.querySelector(".ikr-modal-scroll-content");function d(){pr(i),pr(a),pr(n)}d(),i&&Be(i),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){d(),requestAnimationFrame(d)}):setTimeout(d,0)}function pe(e,r,i,a,n,d,c,o,s,p){if(p&&(p.currentReview=e),c){var k=mr(e,r,i,a,n,d,o,s,p);n.firstChild&&n.replaceChild(k,n.firstChild)}else{var k=mr(e,r,i,a,n,d,o,s,p),l=n.querySelector(".ikr-modal-right");n.firstChild&&n.replaceChild(k,n.firstChild),l&&Ur(l,e,p&&p.currentSettings),_i(s,n)}Xr(r,a)}function te(e,r,i){var a=Ie(e);if(!a.length)return;var n=(i||[]).filter(function(g){return Ie(g).length>0}),d=n.findIndex(function(g){return g===e||g.id===e.id});d===-1&&(n.unshift(e),d=0);var c=a.indexOf(r);c<0&&(c=0);var o=document.createElement("div");o.className="ikr-modal-overlay";var s=document.createElement("div");s.className="ikr-modal";var p=!1,k=Pi(),l=Ni(),t=Bi(),f={currentReview:e,currentSettings:A};function u(g){var S=g&&g.detail&&g.detail.settings;f.currentSettings=S||A;var z=s.querySelector(".ikr-modal-right");!z||!f.currentReview||Ur(z,f.currentReview,f.currentSettings)}function v(){p||(p=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),Wr(o,m,v,l,k))}function m(g){if(g.key==="Escape"){b();return}Ii(g,o)}function b(){p||(p=!0,window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),Wr(o,m,v,l,k),Fi(t))}document.addEventListener("keydown",m),window.addEventListener("popstate",v),window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",u),o.onclick=function(){b()},s.onclick=function(g){g.stopPropagation()},s.appendChild(mr(e,d,c,n,s,b,null,o,f)),s.appendChild(Hi(e)),Xr(d,n);var x=document.createElement("div");x.className="ikr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(s);var y=document.createElement("button");y.className="ikr-modal-close",y.textContent="\u2715",y.setAttribute("aria-label","Kapat"),y.onclick=function(g){g.stopPropagation(),b()},x.appendChild(y),o.appendChild(x),document.body.appendChild(o),Kr(o)}function Jr(e){if(e)for(var r=document.querySelectorAll("h1,h2,h3,h4,h5,h6,div,span,p"),i=0;i<r.length;i++){var a=r[i];if(a.children.length===0&&a.textContent.trim()===e&&a.tagName!=="TITLE"&&!a.closest("[data-ikr-listing-badge]")&&!a.closest("#ikas-reviews")&&!a.closest("nav")&&!a.closest("header")&&!a.closest('[class*="breadcrumb"]')&&!a.closest('[aria-label*="breadcrumb"]'))return a}return document.querySelector("h1")}function Oi(e,r){return ve(e,r)}function Zr(e,r,i,a,n){var d=document.getElementById("ikr-rating-badge");if(d&&d.remove(),!!e&&!(a&&a.enabled===!1)){var c=document.getElementById("ikr-jsonld");c&&c.remove();var o=document.createElement("script");o.id="ikr-jsonld",o.type="application/ld+json",o.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Product",name:i||document.title,url:window.location.href,aggregateRating:{"@type":"AggregateRating",ratingValue:e,reviewCount:r,bestRating:"5",worstRating:"1"}}),document.head.appendChild(o);var s=Jr(i);if(!(!s||!s.parentNode)){var p=a&&a.size||"medium",k=dr[p]||dr.medium;Dr(k);var l=document.createElement("a");l.id="ikr-rating-badge",l.className="ikr-rating-badge ikr-rating-badge--pdp",l.href="#ikas-reviews",l.setAttribute("role","figure"),l.setAttribute("aria-label",e+" \xFCzerinden 5 y\u0131ld\u0131z, "+r+" yorum"),l.setAttribute("data-ikr-surface","pdp"),l.setAttribute("data-ikr-rating",String(e)),l.setAttribute("data-ikr-count",String(r));var t=window.getComputedStyle(s).textAlign,f=t==="center"?"center":t==="right"?"flex-end":"flex-start";l.style.cssText="justify-content:"+f+";",l.insertAdjacentHTML("beforeend",Oi(e,n));var u=document.createElement("span");u.className="ikr-rating-badge__label",u.textContent=e+" ("+r+" yorum)",l.appendChild(u),l.onclick=function(v){v.preventDefault();var m=document.getElementById("ikas-reviews-widget")||document.getElementById("ikas-reviews");if(m){var b=document.querySelector("header"),x=b?b.getBoundingClientRect().height:0,y=m.getBoundingClientRect().top+window.pageYOffset-x-16;window.scrollTo({top:y,behavior:"smooth"})}},s.parentNode.insertBefore(l,s.nextSibling)}}}var $r=`
...
`;var kr={};ue(kr,{meta:()=>Xi,render:()=>Ji});function Me(e){var r=e.ratingCounts,i=e.allCount,a=e.iconPair,n=e.currentRatingFilter,d=e.onFilterChange,c=document.createElement("div");c.className="ikr-summary-block ikr-summary-bars";for(var o=5;o>=1;o--){var s=r[o-1]||0,p=i>0?Math.round(s/i*100):0,k=n===o,l=document.createElement("div");l.className="ikr-bar-row"+(k?" ikr-bar-active":""),n&&!k&&(l.style.opacity="0.35");for(var t="",f=1;f<=5;f++){var u=f<=o;t+='<span class="ikr-bar-star ikr-icon '+(u?"ikr-bar-star-filled":"ikr-bar-star-empty")+'">'+(u?a.filled:a.empty)+"</span>"}l.innerHTML='<span class="ikr-bar-label">'+t+'</span><div class="ikr-bar-track"><div class="ikr-bar-fill" style="width:'+p+'%;"></div></div><span class="ikr-bar-count">('+s.toLocaleString("tr-TR")+")</span>",(function(v){l.onclick=function(){d(v)}})(o),c.appendChild(l)}return c}var ae=[],Qr=!1;function Yi(e){for(var r=ae.length-1;r>=0;r--){var i=ae[r];i.trigger&&i.trigger.contains(e.target)||i.element&&i.element.contains(e.target)||i.close()}}function ji(e){if(e.key==="Escape")for(var r=ae.length-1;r>=0;r--)ae[r].close()}function Di(){Qr||typeof document=="undefined"||(document.addEventListener("click",Yi,!0),document.addEventListener("keydown",ji),Qr=!0)}function Ze(e){for(var r=0;r<ae.length;r++)ae[r]!==e&&ae[r].close()}function $e(e){Di();var r={trigger:e.trigger,element:e.element,close:e.close};return ae.push(r),function(){var a=ae.indexOf(r);a!==-1&&ae.splice(a,1)}}function U(e){var r=e.widget,i=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,d=e.onSortChange,c=document.createElement("div");c.className="ikr-summary-block ikr-summary-actions";var o=document.createElement("button");o.className="ikr-write-btn",o.textContent=A&&A.writeButtonText||"Yorum Yap",o.onclick=n,c.appendChild(o);var s=document.createElement("div");s.className="ikr-filter-wrap";var p=document.createElement("button");p.type="button",p.className="ikr-filter-btn",p.setAttribute("aria-label","Filtrele"),p.setAttribute("aria-haspopup","menu"),p.setAttribute("aria-expanded","false");var k=A&&A.filterIcon||"lines";p.innerHTML=Br(k);var l=document.createElement("div");l.className="ikr-filter-menu",l.setAttribute("role","menu");var t=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]];function f(m){var b=l.classList.contains("ikr-open");l.classList.remove("ikr-open"),p.classList.remove("ikr-filter-btn-active"),p.setAttribute("aria-expanded","false");var x=m&&(m.restoreFocus===!0||m.restoreFocus==="auto"&&De());if(b&&x)try{p.focus({preventScroll:!0})}catch(y){try{p.focus()}catch(g){}}}function u(){Ze(v),l.classList.add("ikr-open"),p.classList.add("ikr-filter-btn-active"),p.setAttribute("aria-expanded","true");var m=l.querySelector(".ikr-filter-item-active")||l.querySelector(".ikr-filter-item");m&&requestAnimationFrame(function(){try{m.focus({preventScroll:!0})}catch(b){try{m.focus()}catch(x){}}})}t.forEach(function(m){var b=m[2],x=b?a:!a&&(i||"newest")===m[0],y=document.createElement("button");y.type="button",y.className="ikr-filter-item"+(x?" ikr-filter-item-active":""),y.setAttribute("role","menuitem"),y.textContent=m[1],y.onclick=function(){f({restoreFocus:"auto"}),d(m[0],b)},l.appendChild(y)}),p.onclick=function(){l.classList.contains("ikr-open")?f({restoreFocus:"auto"}):u()},s.addEventListener("keydown",function(m){m.key==="Escape"&&l.classList.contains("ikr-open")&&(m.stopPropagation(),f({restoreFocus:!0}))}),s.addEventListener("focusout",function(m){if(l.classList.contains("ikr-open")){var b=m.relatedTarget;b&&s.contains(b)||f()}});var v=$e({trigger:s,element:l,close:f});return s.appendChild(p),s.appendChild(l),c.appendChild(s),c}function ei(e){var r=e&&e.onClose?e.onClose:function(){},i=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="ikr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="ikr-fwizard",a.appendChild(n);var d=document.createElement("button");d.className="ikr-fwizard-close",d.type="button",d.setAttribute("aria-label","Kapat"),d.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',n.appendChild(d);var c=document.createElement("div");c.className="ikr-fwizard-content",n.appendChild(c);var o=!1,s=null,p=!1,k="",l="";function t(){var h=document.activeElement;return!h||h===document.body||h===document.documentElement?null:h}function f(h){if(!(!h||!document.contains(h)||typeof h.focus!="function"))try{h.focus({preventScroll:!0})}catch(N){try{h.focus()}catch(L){}}}function u(h){if(!h||h.disabled||h.getAttribute("aria-hidden")==="true")return!1;var N=window.getComputedStyle?window.getComputedStyle(h):null;return N&&(N.display==="none"||N.visibility==="hidden")?!1:!!(h.offsetWidth||h.offsetHeight||h.getClientRects().length)}function v(h){var N=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(h.querySelectorAll(N)).filter(u)}function m(){var h=v(c),N=v(a),L=h[0]||N[0]||a;f(L)}function b(h){if(h.key==="Tab"){var N=v(a);if(!N.length){h.preventDefault(),f(a);return}var L=N[0],B=N[N.length-1],H=document.activeElement;if(!a.contains(H)){h.preventDefault(),f(L);return}h.shiftKey&&H===L?(h.preventDefault(),f(B)):!h.shiftKey&&H===B&&(h.preventDefault(),f(L))}}function x(){var h=window.innerWidth-document.documentElement.clientWidth;k=document.body.style.overflow,l=document.body.style.paddingRight,document.body.style.overflow="hidden",h>0&&(document.body.style.paddingRight=h+"px")}function y(){document.body.style.overflow=k,document.body.style.paddingRight=l}function g(){o||(o=!0,document.removeEventListener("keydown",S),a.removeEventListener("click",z),d.removeEventListener("click",g),a.classList.remove("ikr-fwizard-open"),setTimeout(function(){a.parentNode&&a.parentNode.removeChild(a),y(),p&&f(s);try{r()}catch(h){}},200))}function S(h){if(h.key==="Escape"){g();return}b(h)}function z(h){h.target===a&&i&&g()}document.addEventListener("keydown",S),a.addEventListener("click",z),d.addEventListener("click",g);function C(h){s=t(),p=De(),h&&c.appendChild(h),document.body.appendChild(a),x(),requestAnimationFrame(function(){a.classList.add("ikr-fwizard-open"),m()})}var w=null,E=null;function T(h,N){if(N=N||"error",w){try{w.remove()}catch(L){}w=null}E&&(clearTimeout(E),E=null),w=document.createElement("div"),w.className="ikr-fwizard-toast ikr-fwizard-toast--"+N,w.textContent=h,n.appendChild(w),E=setTimeout(function(){w&&(w.classList.add("ikr-fwizard-toast--exit"),setTimeout(function(){if(w){try{w.remove()}catch(L){}w=null}},300))},4e3)}return{open:C,close:g,content:c,setAllowOutsideClose:function(h){i=!!h},setStepAttr:function(h){n.setAttribute("data-step",String(h))},focusFirstControl:m,showToast:T}}var ri=`
...
`;var ur=4;function Fe(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function ii(e){e=e||{};var r=[],i={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(i)}catch(d){}})}return{get:function(){return i},set:function(n){Object.assign(i,n),a()},goNext:function(){i.currentStep<ur&&(i.currentStep+=1,a())},goBack:function(){i.currentStep>1&&(i.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(d){return d!==n})}}}}var Vi='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function ti(e){e=e||{};var r=e.skippableSteps||[],i=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},d=e.onNext||function(){},c=document.createElement("div");c.className="ikr-fwizard-footer";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-nav-btn ikr-fwizard-footer-back",o.setAttribute("aria-label","Geri"),o.innerHTML=Vi+"<span>Geri</span>",o.addEventListener("click",function(){a()}),c.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-footer-progress";for(var p=[],k=0;k<ur;k++){var l=document.createElement("span");l.className="ikr-fwizard-progress-seg",s.appendChild(l),p.push(l)}c.appendChild(s);var t=document.createElement("button");t.type="button";var f=null;function u(m){f&&t.removeEventListener("click",f),f=m,m&&t.addEventListener("click",m)}c.appendChild(t);function v(m,b){var x=r.indexOf(m)!==-1,y=i.indexOf(m)!==-1,g=b&&(b.images&&b.images.length>0||b.pendingImages&&b.pendingImages.length>0);if(x)m===2&&g?(t.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",t.setAttribute("aria-label","Devam Et"),t.innerHTML="Devam Et",u(function(){d()})):(t.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",t.setAttribute("aria-label","Atla"),t.innerHTML="<span>Atla</span>",u(function(){n()})),t.disabled=!1,t.classList.remove("ikr-fwizard-cta-btn--disabled"),t.style.visibility="",t.tabIndex=0;else if(y){t.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",t.setAttribute("aria-label","Sonraki"),t.innerHTML="Sonraki",t.style.visibility="",t.tabIndex=0;var S=Fe(m,b);t.disabled=!S,t.classList.toggle("ikr-fwizard-cta-btn--disabled",!S),u(function(){t.disabled||d()})}else t.className="ikr-fwizard-nav-btn ikr-fwizard-footer-skip",t.innerHTML="",t.style.visibility="hidden",t.tabIndex=-1,t.disabled=!0,u(null)}return{el:c,update:function(m,b){p.forEach(function(y,g){g+1<=m?y.classList.add("ikr-fwizard-progress-seg-active"):y.classList.remove("ikr-fwizard-progress-seg-active")});var x=m<=1;o.style.visibility=x?"hidden":"",o.style.pointerEvents=x?"none":"",o.tabIndex=x?-1:0,v(m,b)},setNextDisabled:function(m){t.classList.contains("ikr-fwizard-cta-btn")&&(t.disabled=!!m,t.classList.toggle("ikr-fwizard-cta-btn--disabled",!!m))},setThanksState:function(m){o.style.visibility="hidden",s.style.visibility="hidden",t.className="ikr-fwizard-cta-btn ikr-fwizard-footer-next",t.setAttribute("aria-label","Devam Et"),t.innerHTML="Devam Et",t.style.visibility="",t.disabled=!1,t.classList.remove("ikr-fwizard-cta-btn--disabled"),u(m)}}}function ai(e,r){r=r||{};var i=document.createElement("div");i.className="ikr-fwizard-step ikr-fwizard-step-rating";var a=!1,n=document.createElement("div");n.className="ikr-fwizard-step-title",n.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",i.appendChild(n);var d=document.createElement("div");d.className="ikr-fwizard-stars",d.setAttribute("role","radiogroup"),d.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var c=Oe(A||{}),o=[];function s(l){o.forEach(function(t,f){var u=f<l;t.classList.toggle("ikr-fwizard-star-active",u),t.setAttribute("aria-checked",f+1===l?"true":"false"),t.innerHTML=u?c.filled:c.empty})}for(var p=1;p<=5;p++)(function(l){var t=document.createElement("button");t.type="button",t.className="ikr-fwizard-star",t.setAttribute("role","radio"),t.setAttribute("aria-label",l+" y\u0131ld\u0131z"),t.innerHTML=c.empty,t.addEventListener("mouseenter",function(){s(l)}),t.addEventListener("mouseleave",function(){s(e.get().rating)}),t.addEventListener("click",function(){a||(a=!0,e.set({rating:l}),s(l),setTimeout(function(){var f=!r.canNavigate||r.canNavigate();f&&e.goNext()},400))}),o.push(t),d.appendChild(t)})(p);s(e.get().rating);var k=function(l){var t=l&&l.detail&&l.detail.settings;c=Oe(t||A||{}),s(e.get().rating)};return window.addEventListener("IKR_SETTINGS_UPDATED_PREVIEW",k),i.appendChild(d),{el:i,destroy:function(){window.removeEventListener("IKR_SETTINGS_UPDATED_PREVIEW",k)}}}var ni=3,Gi=10*1024*1024;function oi(e,r){r=r||{};var i=!1,a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-photos";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var d=document.createElement("div");d.className="ikr-fwizard-step-subtitle",d.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(d);var c=document.createElement("div");c.className="ikr-fwizard-photo-card";var o=document.createElement("button");o.type="button",o.className="ikr-fwizard-photo-add",o.setAttribute("aria-label","Foto\u011Fraf ekle"),o.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><span>Foto\u011Fraf Ekle</span>';var s=document.createElement("input");s.type="file",s.accept="image/*",s.multiple=!0,s.style.display="none",c.appendChild(o),c.appendChild(s);var p=document.createElement("div");p.className="ikr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),c.appendChild(p),a.appendChild(c);var k=r.blobMap||{},l=r.urlToFinger||{};function t(){if(!i){var y=e.get().images||[],g=e.get().pendingImages||[],S=y.map(function(z){return{url:z,isPending:!1}}).concat(g.map(function(z){return{url:z.url,file:z.file,isPending:!0,error:z.error}}));p.innerHTML="",S.forEach(function(z){var C=k[z.url]||z.url,w=f(z,C);p.appendChild(w)}),b()}}function f(y,g){var S=document.createElement("div");S.className="ikr-fwizard-photo-thumb";var z=document.createElement("img");z.src=g,z.alt="",z.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",S.appendChild(z);var C=document.createElement("div");C.className="ikr-fwizard-photo-loading",C.style.display="none",S.appendChild(C);var w=document.createElement("button");return w.type="button",w.className="ikr-fwizard-photo-remove",w.innerHTML="&#x2715;",S.appendChild(w),u(S,y,g),S}function u(y,g,S){var z=y.querySelector("img");z.src!==S&&(z.src=S);var C=y.querySelector(".ikr-fwizard-photo-loading");g.isPending&&g.error?(C.style.display="flex",C.innerHTML='<span class="ikr-upload-error">\u2717 '+g.error+"</span>"):C.style.display="none";var w=y.querySelector(".ikr-fwizard-photo-remove");w.onclick=function(){var E=l[g.url]||(g.file?g.file.name+"_"+g.file.size:null);if(g.url.startsWith("blob:")&&URL.revokeObjectURL(g.url),E){var T=(e.get().fingerprints||[]).filter(function(L){return L!==E});e.set({fingerprints:T})}if(g.isPending){var h=(e.get().pendingImages||[]).filter(function(L){return L.url!==g.url});e.set({pendingImages:h})}else{var N=(e.get().images||[]).filter(function(L){return L!==g.url});e.set({images:N})}}}var v='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',m='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>';function b(){var y=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,S=y+g,z=S>=ni;S>0?(c.classList.add("ikr-fwizard-photo-card--compact"),o.innerHTML=m):(c.classList.remove("ikr-fwizard-photo-card--compact"),o.innerHTML=v+"<span>Foto\u011Fraf Ekle</span>"),z?(o.style.display="none",o.disabled=!0,s.disabled=!0):(o.style.display="flex",o.disabled=!1,s.disabled=!1,o.classList.remove("ikr-fwizard-photo-add--disabled"))}o.addEventListener("click",function(){s.disabled||s.click()}),s.onchange=async function(y){var g=(e.get().images||[]).length+(e.get().pendingImages||[]).length,S=Array.from(y.target.files).slice(0,ni-g);s.value="";var z=(e.get().pendingImages||[]).length,C=e.get().images||[],w=C.length;if(S.length!==0){for(var E=[],T=[],h=0;h<S.length;h++){var N=S[h],L=N.name+"_"+N.size,B=(e.get().fingerprints||[]).some(function(F){return F===L})||E.some(function(F){return F.file.name+"_"+F.file.size===L});if(B){console.log("[ikr] Duplicate file detected, skipping:",N.name);continue}if(N.size>Gi){var H="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(H,"error"):alert(H);continue}var G=URL.createObjectURL(N);l[G]=L,E.push({url:G,file:N,error:null}),T.push({url:G,file:N});var ne=(e.get().fingerprints||[]).slice();ne.push(L),e.set({fingerprints:ne})}if(E.length!==0){var oe=(e.get().pendingImages||[]).concat(E),W=async function(){for(var F=0;F<T.length;F++){var Ne=T[F],le=Ne.file,D=Ne.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var me=(e.get().pendingImages||[]).filter(function(j){return j.url!==D}),Ae=(e.get().images||[]).slice();Ae.push(D),e.set({pendingImages:me,images:Ae});continue}try{var q=await he(ke+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:fe})});if(!q.ok)throw q.status===429?new Error("rate_limit"):new Error("sign failed");var K=await q.json();if(!K.folder)throw new Error("sign folder missing");var Y=new FormData;Y.append("file",le),Y.append("api_key",K.api_key),Y.append("timestamp",K.timestamp),Y.append("signature",K.signature),Y.append("folder",K.folder);var _e=await fetch("https://api.cloudinary.com/v1_1/"+K.cloud_name+"/image/upload",{method:"POST",body:Y}),X=await _e.json();if(X.secure_url&&_r(X.secure_url)){var ye=(e.get().pendingImages||[]).some(function(j){return j.url===D});if(!ye){console.log("[ikr] Upload finished but image was already deleted by user. Aborting state update.");return}k[X.secure_url]=D,l[X.secure_url]=l[D];var J=(e.get().pendingImages||[]).filter(function(j){return j.url!==D}),Z=(e.get().images||[]).slice();Z.push(X.secure_url),e.set({pendingImages:J,images:Z});try{he(ke+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:fe,secureUrl:X.secure_url})}).catch(function(){})}catch(j){}}else throw new Error("invalid image url")}catch(j){console.error("[ikr] Image upload failed:",j);var $=j.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast($,"error");var we=(e.get().pendingImages||[]).map(function(I){return I.url===D?{url:I.url,file:I.file,error:$}:I});e.set({pendingImages:we})}}};if(w===0&&z===0){i=!0;var O=!r.canNavigate||r.canNavigate();O&&e.goNext()}e.set({pendingImages:oe}),W()}}};var x=e.onChange(t);return t(),{el:a,destroy:function(){i=!0,s.onchange=null,x&&x()}}}var fr=2e3,Wi=60;function li(e,r){r=r||{};var i=r.onValidityChange||function(){},a=document.createElement("div");a.className="ikr-fwizard-step ikr-fwizard-step-content";var n=document.createElement("div");n.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var d=document.createElement("div");d.className="ikr-fwizard-content-form";var c=document.createElement("input");c.type="text",c.className="ikr-fwizard-input",c.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",c.maxLength=Wi,c.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),c.value=e.get().title||"",c.addEventListener("input",function(){e.set({title:c.value})}),d.appendChild(c);var o=document.createElement("textarea");o.className="ikr-fwizard-textarea",o.placeholder="Deneyiminizi anlat\u0131n\u2026",o.maxLength=fr,o.rows=6,o.setAttribute("aria-label","Yorum"),o.value=e.get().comment||"",d.appendChild(o);var s=document.createElement("div");s.className="ikr-fwizard-char-counter",s.setAttribute("aria-live","polite"),d.appendChild(s);function p(){var l=o.value.length;s.textContent=l+"/"+fr,s.classList.toggle("ikr-fwizard-char-counter--max",l>=fr)}function k(){return Fe(3,e.get())}return o.addEventListener("input",function(){e.set({comment:o.value}),p(),i(k())}),a.appendChild(d),p(),setTimeout(function(){i(k())},0),{el:a,destroy:function(){}}}var qi=40;function di(e,r){r=r||{};var i=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="ikr-fwizard-step ikr-fwizard-step-author";var d=document.createElement("div");d.className="ikr-fwizard-step-title ikr-fwizard-step-title--lg",d.textContent="Hakk\u0131n\u0131zda",n.appendChild(d);var c=document.createElement("div");c.className="ikr-fwizard-author-form";var o=document.createElement("div");o.className="ikr-fwizard-field";var s=document.createElement("label");s.className="ikr-fwizard-label",s.innerHTML='Ad\u0131n\u0131z <span class="ikr-fwizard-required" aria-hidden="true">*</span>';var p=document.createElement("input");p.type="text",p.className="ikr-fwizard-input",p.maxLength=qi,p.setAttribute("aria-required","true"),p.value=e.get().author||"",o.appendChild(s),o.appendChild(p),c.appendChild(o);var k=document.createElement("div");k.className="ikr-fwizard-field";var l=document.createElement("label");l.className="ikr-fwizard-label",l.textContent="E-posta (opsiyonel)";var t=document.createElement("input");t.type="email",t.className="ikr-fwizard-input",t.setAttribute("autocomplete","email"),t.value=e.get().email||"",k.appendChild(l),k.appendChild(t),c.appendChild(k);var f=document.createElement("div");f.className="ikr-fwizard-notice",f.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",c.appendChild(f);var u=document.createElement("div");u.className="ikr-fwizard-msg",u.setAttribute("role","alert"),u.setAttribute("aria-live","assertive"),c.appendChild(u);var v=document.createElement("button");v.type="button",v.className="ikr-fwizard-submit-btn",v.textContent="G\xF6nder",c.appendChild(v),n.appendChild(c);function m(){return Fe(4,e.get())}function b(){var y=!m(),g=(e.get().pendingImages||[]).length,S=g>0;S?(v.disabled=!0,v.classList.add("ikr-fwizard-submit-btn--disabled"),v.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(v.disabled=y,v.classList.toggle("ikr-fwizard-submit-btn--disabled",y),v.textContent="G\xF6nder")}p.addEventListener("input",function(){e.set({author:p.value}),b(),i(m())}),t.addEventListener("input",function(){e.set({email:t.value})}),b(),setTimeout(function(){i(m())},0),v.onclick=async function(){if(!v.disabled){var y=e.get(),g=(y.author||"").trim(),S=(y.comment||"").trim();if(t.value.trim()&&!t.checkValidity()){t.reportValidity();return}if(!g){u.innerHTML='<div class="ikr-fwizard-msg-error">Gerekli alan</div>';return}if(!y.rating){u.innerHTML='<div class="ikr-fwizard-msg-error">L\xFCtfen bir y\u0131ld\u0131z se\xE7in.</div>';return}v.disabled=!0,v.classList.add("ikr-fwizard-submit-btn--disabled");var z=v.textContent;if(v.textContent="G\xF6nderiliyor\u2026",u.innerHTML="",typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var C=Mr(window.location.href),w=y.productName||(document.querySelector("h1")?document.querySelector("h1").innerText.trim():null),E=await he(ke+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:fe,productId:y.productId||null,slug:C||null,productName:w,author:g,title:(y.title||"").trim()||null,comment:S||null,rating:y.rating,images:y.images||[]})},15e3);if(E.ok)a();else{var T=await E.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(L){var h=L&&(L.name==="AbortError"||/signal/i.test(L.message||"")),N=h?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":L.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(N,"error"):u.innerHTML='<div class="ikr-fwizard-msg-error">'+N+"</div>",v.disabled=!1,v.classList.remove("ikr-fwizard-submit-btn--disabled"),v.textContent=z}}};var x=e.onChange(b);return{el:n,destroy:function(){v.onclick=null,x&&x()}}}var si=!1;function Ki(){if(!si){var e=document.createElement("style");e.setAttribute("data-ikr-fwizard",""),e.textContent=ri,document.head.appendChild(e),si=!0}}function Ui(e,r,i){if(i=i||{},e===1)return ai(r,{canNavigate:i.canNavigate});if(e===2)return oi(r,{canNavigate:i.canNavigate,blobMap:i.blobMap,urlToFinger:i.urlToFinger,showToast:i.showToast});if(e===3)return li(r,{onValidityChange:i.onValidityChange});if(e===4)return di(r,{onValidityChange:i.onValidityChange,onSuccess:i.onSuccess,showToast:i.showToast});var a=document.createElement("div");return a.className="ikr-fwizard-step ikr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function ci(){var e=document.createElement("div");return e.className="ikr-fwizard-step ikr-fwizard-step-thanks",e.innerHTML='<div class="ikr-fwizard-step-title ikr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="ikr-fwizard-step-subtitle ikr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function pi(e){e=e||{},Ki();var r=ii({productId:e.productId,productName:e.productName}),i={},a={},n=ei({onClose:function(){window.removeEventListener("popstate",c),window.history.state&&window.history.state.ikrReviewModal&&window.history.back(),Object.keys(i).forEach(function(z){var C=i[z];C&&C.startsWith("blob:")&&URL.revokeObjectURL(C)}),e.onClose&&e.onClose()},allowOutsideClose:!1}),d={ikrReviewModal:!0};window.history.pushState(d,null,"");var c=function(z){n&&n.close&&n.close()};window.addEventListener("popstate",c);var o=document.createElement("div");o.className="ikr-fwizard-step-wrap";var s=ti({skippableSteps:[2],nextableSteps:[3],onBack:function(){l==="idle"&&r.goBack()},onSkip:function(){l==="idle"&&r.goNext()},onNext:function(){l==="idle"&&r.goNext()}}),p=document.createElement("div");p.className="ikr-fwizard-layout",p.appendChild(o),p.appendChild(s.el);var k=null,l="idle",t=null,f=!0,u=null;function v(z,C){o.innerHTML="";var w=Ui(z,r,{canNavigate:function(){return l==="idle"},blobMap:i,urlToFinger:a,onValidityChange:function(h){s.setNextDisabled(!h)},onSuccess:b,showToast:n.showToast});if(k=w,s.update(z,r.get()),C){l="entering",w.el.classList.add("ikr-fwizard-step--enter");var E=null,T=function(){E&&clearTimeout(E),w.el.removeEventListener("animationend",T),w.el.classList.remove("ikr-fwizard-step--enter"),l="idle",t!==null&&x()};w.el.addEventListener("animationend",T),E=setTimeout(T,700)}else l="idle";o.appendChild(w.el),n.setStepAttr&&n.setStepAttr(z),z===3&&s.setNextDisabled(!0)}var m=!1;function b(){if(!m){if(m=!0,!k){o.innerHTML="";var z=ci();z.classList.add("ikr-fwizard-step--enter"),o.appendChild(z),n.setStepAttr("thanks"),s.setThanksState(n.close);return}var C=k;l="exiting",C.el.classList.add("ikr-fwizard-step--exit");var w=function(){if(u&&clearTimeout(u),C.el.removeEventListener("animationend",w),C.destroy)try{C.destroy()}catch(T){}k===C&&(k=null),o.innerHTML="";var E=ci();E.classList.add("ikr-fwizard-step--enter"),o.appendChild(E),n.setStepAttr("thanks"),s.setThanksState(n.close),l="idle"};C.el.addEventListener("animationend",w),u=setTimeout(w,300)}}function x(){var z=r.get().currentStep;if(l!=="idle"){t=z;return}if(!k){var C=!f;f=!1,v(z,C);return}var w=k;l="exiting",w.el.classList.add("ikr-fwizard-step--exit");var E=function(){if(u&&clearTimeout(u),w.el.removeEventListener("animationend",E),w.destroy)try{w.destroy()}catch(h){}if(k===w){o.innerHTML="",k=null;var T=t!==null?t:r.get().currentStep;t=null,v(T,!0),l="idle"}};w.el.addEventListener("animationend",E),u=setTimeout(E,350)}x();var y=r.get().currentStep,g=r.onChange(function(z){z.currentStep!==y?(y=z.currentStep,x()):s.update(z.currentStep,z)}),S=n.close;return n.close=function(){g&&g(),typeof u!="undefined"&&u&&clearTimeout(u),S()},n.open(p),{close:n.close}}function _(){pi({productId:Q||"",productName:Pe||""})}var Xi={id:"classic",name:"Klasik (A\xE7\u0131k)"};function Ji(e){var r=e.widget,i=e.data,a=e.settings,n=e.iconPair,d=e.allCount,c=e.ratingCounts,o=e.avgRatingVal,s=e.currentRatingFilter,p=e.currentOrderBy,k=e.currentHasImages,l=e.onFilterChange,t=e.onSortChange,f=document.createElement("div");f.className="ikr-summary";var u=(c[3]||0)+(c[4]||0),v=d>0?Math.round(u/d*100):0,m=document.createElement("div");m.className="ikr-summary-block ikr-summary-avg",m.innerHTML='<span class="ikr-avg-star ikr-icon">'+n.filled+'</span><span class="ikr-avg-num">'+o+"</span>",f.appendChild(m);var b=document.createElement("div");if(b.className="ikr-summary-block ikr-summary-count",b.textContent=d.toLocaleString("tr-TR")+" Yorum",f.appendChild(b),a.showRecommendation!==!1&&v>0){var x=document.createElement("div");x.className="ikr-summary-block ikr-summary-recommend",x.innerHTML='<span class="ikr-recommend-pct">%'+v+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",f.appendChild(x)}return f.appendChild(Me({ratingCounts:c,allCount:d,iconPair:n,currentRatingFilter:s,onFilterChange:l})),f.appendChild(U({widget:r,currentOrderBy:p,currentHasImages:k,onWriteClick:_,onSortChange:t})),f}var vr={};ue(vr,{css:()=>$i,meta:()=>Zi,render:()=>Qi});var mi=`
...
`;var Zi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--ikr-compact-star-size":"20px"},medium:{"--ikr-compact-star-size":"24px"},large:{"--ikr-compact-star-size":"28px"}}},$i=mi;function Qi(e){var r=e.widget,i=e.settings,a=e.iconPair,n=e.allCount,d=e.ratingCounts,c=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,p=e.currentHasImages,k=e.onFilterChange,l=e.onSortChange,t=document.createElement("div");t.className="ikr-summary ikr-summary-compact";var f=document.createElement("div");f.className="ikr-compact-header";var u=document.createElement("div");u.className="ikr-compact-trigger-wrap";var v=document.createElement("button");v.className="ikr-compact-trigger",v.type="button",v.setAttribute("aria-expanded","false"),v.innerHTML='<span class="ikr-compact-trigger-stars">'+ve(c,a)+'</span><span class="ikr-compact-trigger-text">'+n.toLocaleString("tr-TR")+' Yorum</span><span class="ikr-compact-chevron"><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7.11 5.16L2.16 0.21L0.75 1.62L7.11 7.98L13.48 1.62L12.06 0.21L7.11 5.16Z" fill="currentColor"/></svg></span>',u.appendChild(v),f.appendChild(u);var m=U({widget:r,currentOrderBy:s,currentHasImages:p,onWriteClick:_,onSortChange:l}),b=m.querySelector(".ikr-filter-wrap"),x=m.querySelector(".ikr-write-btn"),y=document.createElement("div");y.className="ikr-compact-actions-slot",x&&y.appendChild(x),b&&y.appendChild(b),f.appendChild(y),t.appendChild(f);var g=document.createElement("div");g.className="ikr-compact-panel",g.setAttribute("role","dialog"),g.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="ikr-compact-panel-inner";var z=document.createElement("div");z.className="ikr-compact-avg",z.innerHTML='<span class="ikr-icon">'+a.filled+"</span><span>"+c+"</span>",S.appendChild(z),S.appendChild(Me({ratingCounts:d,allCount:n,iconPair:a,currentRatingFilter:o,onFilterChange:k})),g.appendChild(S);var C=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function w(O){var F=O?t:u;g.parentNode!==F&&(g.classList.contains("ikr-open")&&(g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")),F.appendChild(g))}if(w(C?C.matches:!1),C){var E=function(O){w(O.matches)};C.addEventListener?C.addEventListener("change",E):C.addListener&&C.addListener(E)}if(x){var T=document.createElement("button");T.className="ikr-write-btn",T.textContent=A&&A.writeButtonText||"Yorum Yap",T.onclick=_;var h=document.createElement("div");h.className="ikr-compact-write-row",h.appendChild(T),t.appendChild(h)}function N(){g.classList.remove("ikr-open"),g.setAttribute("aria-hidden","true"),v.setAttribute("aria-expanded","false")}function L(){Ze(B),g.classList.add("ikr-open"),g.setAttribute("aria-hidden","false"),v.setAttribute("aria-expanded","true")}v.onclick=function(){g.classList.contains("ikr-open")?N():L()};var B=null;function H(O){B&&(B(),B=null),O||(B=$e({trigger:u,element:g,close:N}))}if(H(C?C.matches:!1),C){var G=function(O){H(O.matches)};C.addEventListener?C.addEventListener("change",G):C.addListener&&C.addListener(G)}if(i.showRecommendation!==!1){var ne=(d[3]||0)+(d[4]||0),oe=n>0?Math.round(ne/n*100):0;if(oe>0){var W=document.createElement("div");W.className="ikr-summary-block ikr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="ikr-recommend-pct">%'+oe+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild(W)}}return t}var gr={};ue(gr,{css:()=>rt,meta:()=>et,render:()=>it});var ui=`
...
`;var et={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},rt=ui;function it(e){var r=e.widget,i=e.settings,a=e.iconPair,n=e.allCount,d=e.ratingCounts,c=e.avgRatingVal,o=e.currentRatingFilter,s=e.currentOrderBy,p=e.currentHasImages,k=e.onFilterChange,l=e.onSortChange,t=document.createElement("div");t.className="ikr-summary ikr-summary-split";var f=document.createElement("div");f.className="ikr-split-col ikr-split-left";var u=document.createElement("div");u.className="ikr-summary-block ikr-summary-avg ikr-split-left-avg-block",u.innerHTML='<span class="ikr-avg-star ikr-icon">'+a.filled+'</span><span class="ikr-avg-num">'+c+"</span>",f.appendChild(u);var v=document.createElement("div");v.className="ikr-summary-block ikr-summary-count ikr-split-left-count",v.textContent=n.toLocaleString("tr-TR")+" Yorum",f.appendChild(v),t.appendChild(f);var m=document.createElement("div");m.className="ikr-split-col ikr-split-mid",m.appendChild(Me({ratingCounts:d,allCount:n,iconPair:a,currentRatingFilter:o,onFilterChange:k})),t.appendChild(m);var b=U({widget:r,currentOrderBy:s,currentHasImages:p,onWriteClick:_,onSortChange:l}),x=b.querySelector(".ikr-filter-wrap"),y=b.querySelector(".ikr-write-btn"),g=document.createElement("div");g.className="ikr-split-col ikr-split-right",y&&g.appendChild(y),x&&g.appendChild(x),t.appendChild(g);var S=(d[3]||0)+(d[4]||0),z=n>0?Math.round(S/n*100):0,C=document.createElement("div");C.className="ikr-summary-block ikr-summary-recommend",C.innerHTML='<span class="ikr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var w=i.showRecommendation===!1||z===0;return w&&C.classList.add("ikr-split-rec-hidden"),f.appendChild(C),t}var hr={};ue(hr,{css:()=>at,meta:()=>tt,render:()=>nt});var fi=`
...
`;var tt={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},at=fi;function nt(e){var r=e.widget,i=e.iconPair,a=e.allCount,n=e.avgRatingVal,d=e.currentOrderBy,c=e.currentHasImages,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-minimal";var p=document.createElement("div");p.className="ikr-minimal-info";var k=document.createElement("div");k.className="ikr-minimal-row";var l=document.createElement("span");l.className="ikr-minimal-avg",l.textContent=n,k.appendChild(l);var t=document.createElement("span");t.className="ikr-minimal-stars",t.innerHTML=ve(n,i),k.appendChild(t);var f=document.createElement("span");f.className="ikr-minimal-count",f.textContent=a.toLocaleString("tr-TR")+" Yorum",k.appendChild(f),p.appendChild(k),s.appendChild(p);var u=U({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:_,onSortChange:o}),v=u.querySelector(".ikr-filter-wrap"),m=u.querySelector(".ikr-write-btn"),b=document.createElement("div");if(b.className="ikr-minimal-actions",m&&b.appendChild(m),v&&b.appendChild(v),s.appendChild(b),m){var x=document.createElement("button");x.className="ikr-write-btn",x.textContent=A&&A.writeButtonText||"Yorum Yap",x.onclick=_;var y=document.createElement("div");y.className="ikr-minimal-write-row",y.appendChild(x),s.appendChild(y)}return s}var br={};ue(br,{css:()=>lt,meta:()=>ot,render:()=>dt});var ki=`
...
`;var ot={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},lt=ki;function dt(e){var r=e.widget,i=e.iconPair,a=e.allCount,n=e.avgRatingVal,d=e.currentOrderBy,c=e.currentHasImages,o=e.onSortChange,s=document.createElement("div");s.className="ikr-summary ikr-summary-hero";var p=document.createElement("div");p.className="ikr-hero-info";var k=document.createElement("div");k.className="ikr-hero-rating-col";var l=document.createElement("span");l.className="ikr-hero-avg",l.textContent=n,k.appendChild(l);var t=document.createElement("div");t.className="ikr-hero-meta-row";var f=document.createElement("span");f.className="ikr-hero-stars",f.innerHTML=ve(n,i),t.appendChild(f);var u=document.createElement("div");u.className="ikr-hero-count",u.textContent=a.toLocaleString("tr-TR")+" Yorum",t.appendChild(u),k.appendChild(t),p.appendChild(k),s.appendChild(p);var v=U({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:_,onSortChange:o}),m=v.querySelector(".ikr-filter-wrap"),b=v.querySelector(".ikr-write-btn"),x=document.createElement("div");x.className="ikr-hero-actions ikr-desktop-only",b&&x.appendChild(b),m&&x.appendChild(m),s.appendChild(x);var y=U({widget:r,currentOrderBy:d,currentHasImages:c,onWriteClick:_,onSortChange:o}),g=y.querySelector(".ikr-filter-wrap"),S=y.querySelector(".ikr-write-btn"),z=document.createElement("div");return z.className="ikr-hero-write-row",S&&z.appendChild(S),g&&z.appendChild(g),s.appendChild(z),s}var Qe={classic:kr,compact:vr,split:gr,minimal:hr,hero:br};function er(e){return Qe[e]||Qe.classic}function vi(){return Object.keys(Qe).map(function(e){return Qe[e].css||""}).join(`
`)}var yr={};ue(yr,{css:()=>ct,meta:()=>st,render:()=>pt});function He(e,r){if(!e)return null;var i=document.createElement("div");i.className="ikr-reply";var a=document.createElement("div");a.className="ikr-reply-header";var n=document.createElement("span");n.className="ikr-reply-label",n.textContent=A&&A.merchantReplyLabel||"Ma\u011Faza Sahibi",a.appendChild(n),i.appendChild(a);var d=document.createElement("div");d.className="ikr-reply-text ikr-reply-text-clamped",d.textContent=e,i.appendChild(d);var c=document.createElement("span");return c.className="ikr-read-more ikr-reply-read-more",c.textContent="Devam\u0131n\u0131 oku",c.style.display="none",i.appendChild(c),requestAnimationFrame(function(){if(d.scrollHeight>d.clientHeight+2)if(c.style.display="inline",typeof r=="function")c.onclick=r;else{var o=!1;c.onclick=function(){o=!o,d.classList.toggle("ikr-reply-text-clamped",!o),c.textContent=o?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}}),i}var st={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--ikr-card-photo-w":"80px"},medium:{"--ikr-card-photo-w":"110px"},large:{"--ikr-card-photo-w":"140px"}}},ct="";function pt(e,r){var i=document.createElement("div");i.className="ikr-review ikr-review-card";var a=document.createElement("div");a.className="ikr-review-top";var n=document.createElement("div");n.className="ikr-review-top-left";var d=document.createElement("span");d.className="ikr-review-stars",d.innerHTML=se(e.rating,A),n.appendChild(d);var c=document.createElement("span");if(c.className="ikr-date",c.textContent=ce(e.createdAt),a.appendChild(n),a.appendChild(c),i.appendChild(a),e.title){var o=document.createElement("div");o.className="ikr-review-title",o.textContent=e.title,i.appendChild(o)}var s=document.createElement("div");s.className="ikr-author",s.textContent=e.author||"",i.appendChild(s);var p=(e.comment||"").trim();if(p){var k=document.createElement("div");k.className="ikr-body ikr-body-clamped",k.textContent=p,i.appendChild(k);var l=document.createElement("span");l.className="ikr-read-more",l.textContent="Devam\u0131n\u0131 oku",l.style.display="none",i.appendChild(l),requestAnimationFrame(function(){if(k.scrollHeight>k.clientHeight+2){l.style.display="inline";var v=!1;l.onclick=function(){v=!v,k.classList.toggle("ikr-body-clamped",!v),l.textContent=v?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var t=ge(e);if(t.length){var f=document.createElement("div");f.className="ikr-gallery",t.forEach(function(v){var m=document.createElement("img"),b=ee(v,V);m.src=b.src,m.srcset=b.srcset,m.loading="lazy",m.decoding="async",m.width=V,m.height=V,m.className="ikr-img",re(m),m.setAttribute("data-ikr-img-url",v),(function(x){m.onclick=function(){te(e,x,r)}})(v),f.appendChild(m)}),i.appendChild(f)}var u=He(e.merchantReply);return u&&i.appendChild(u),i}var wr={};ue(wr,{css:()=>ut,meta:()=>mt,render:()=>ft});var gi=`
  .ikr-review-list{
    display:grid;
...
`;var mt={id:"list",name:"Liste",supports:{},sizeOverrides:{small:{"--ikr-list-photo-w":"80px","--ikr-list-photo-w-mobile":"80px"},medium:{"--ikr-list-photo-w":"110px","--ikr-list-photo-w-mobile":"100px"},large:{"--ikr-list-photo-w":"140px","--ikr-list-photo-w-mobile":"110px"}}},ut=gi;function ft(e,r){var i=ge(e),a=i.length>0,n=document.createElement("div");n.className="ikr-review-list"+(a?"":" ikr-review-list--no-media");var d=document.createElement("div");d.className="ikr-review-list-author";var c=document.createElement("span");c.className="ikr-review-stars ikr-review-list-author-stars",c.innerHTML=se(e.rating,A),d.appendChild(c);var o=document.createElement("span");o.className="ikr-review-list-author-name",o.textContent=e.author||"",d.appendChild(o);var s=document.createElement("span");s.className="ikr-date ikr-review-list-author-date",s.textContent=ce(e.createdAt),d.appendChild(s),n.appendChild(d);var p=document.createElement("div");if(p.className="ikr-review-list-content",e.title){var k=document.createElement("div");k.className="ikr-review-list-title",k.textContent=e.title,p.appendChild(k)}var l=(e.comment||"").trim();if(l){var t=document.createElement("div");t.className="ikr-review-list-body ikr-body-clamped",t.textContent=l,p.appendChild(t);var f=document.createElement("span");f.className="ikr-read-more",f.textContent="Devam\u0131n\u0131 oku",f.style.display="none",p.appendChild(f),requestAnimationFrame(function(){if(t.scrollHeight>t.clientHeight+2){f.style.display="inline";var m=!1;f.onclick=function(){m=!m,t.classList.toggle("ikr-body-clamped",!m),f.textContent=m?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"}}})}var u=He(e.merchantReply);if(u&&p.appendChild(u),n.appendChild(p),a){var v=document.createElement("div");v.className="ikr-review-list-media",i.forEach(function(m){var b=document.createElement("img"),x=ee(m,V);b.src=x.src,b.srcset=x.srcset,b.loading="lazy",b.decoding="async",b.width=V,b.height=Math.round(V*4/3),b.setAttribute("data-ikr-img-url",m),re(b),(function(y){b.onclick=function(){te(e,y,r)}})(m),v.appendChild(b)}),n.appendChild(v)}return n}var xr={};ue(xr,{css:()=>vt,meta:()=>kt,render:()=>gt});var hi=`
...
`;var kt={id:"gallery",name:"Galeri",supports:{},sizeOverrides:{small:{"--ikr-gallery-photo-w":"80px","--ikr-gallery-photo-w-mobile":"80px"},medium:{"--ikr-gallery-photo-w":"110px","--ikr-gallery-photo-w-mobile":"100px"},large:{"--ikr-gallery-photo-w":"140px","--ikr-gallery-photo-w-mobile":"110px"}}},vt=hi;function gt(e,r){var i=Ke(e),a=!!i,n=document.createElement("div");n.className="ikr-review-gallery"+(a?"":" ikr-review-gallery--no-media");var d=document.createElement("div");d.className="ikr-review-gallery-content";var c=document.createElement("span");if(c.className="ikr-review-stars ikr-review-gallery-stars",c.innerHTML=se(e.rating,A),d.appendChild(c),e.title){var o=document.createElement("div");o.className="ikr-review-gallery-title",o.textContent=e.title,d.appendChild(o)}var s=document.createElement("div");s.className="ikr-review-gallery-author",s.textContent=e.author||"",d.appendChild(s);var p=document.createElement("div");p.className="ikr-review-gallery-date",p.textContent=ce(e.createdAt),d.appendChild(p);var k=(e.comment||"").trim();if(k){var l=document.createElement("div");l.className="ikr-review-gallery-body ikr-body-clamped",l.textContent=k,d.appendChild(l);var t=document.createElement("span");t.className="ikr-read-more",t.textContent="Devam\u0131n\u0131 oku",t.style.display="none",t.style.cursor="pointer";var f=!1;t.onclick=function(){if(i){te(e,i,r);return}f=!f,l.classList.toggle("ikr-body-clamped",!f),t.textContent=f?"Daha az g\xF6ster":"Devam\u0131n\u0131 oku"},d.appendChild(t),requestAnimationFrame(function(){l.scrollHeight>l.clientHeight+2&&(t.style.display="inline")})}if(n.appendChild(d),a){var u=document.createElement("div");u.className="ikr-review-gallery-media";var v=document.createElement("img"),m=ee(i,Ue);v.src=m.src,v.srcset=m.srcset,v.loading="lazy",v.decoding="async",v.width=Ue,v.height=Math.round(Ue*4/3),re(v),v.setAttribute("data-ikr-img-url",i),v.onclick=function(){te(e,i,r)},u.appendChild(v),n.appendChild(u)}var b=He(e.merchantReply,i?function(){te(e,i,r)}:null);return b&&(b.classList.add("ikr-review-gallery-reply"),n.appendChild(b)),n}var rr={card:yr,list:wr,gallery:xr};function je(e){return rr[e]||rr.card}function bi(){return Object.keys(rr).map(function(e){return rr[e].css||""}).join(`
`)}function Le(e,r){var i=/^#([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})?$/.exec(e);if(!i)return"rgba(0,0,0,"+r+")";var a=parseInt(i[1],16),n=parseInt(i[2],16),d=parseInt(i[3],16);return"rgba("+a+","+n+","+d+","+r+")"}function ht(){var e=document.getElementById("ikas-reviews-anchor");if(e)return e;e=document.createElement("div"),e.id="ikas-reviews-anchor",e.setAttribute("data-ikr-auto-anchor","1");var r=null;try{r=document.querySelector(Vr)}catch(a){}if(r&&r.parentNode)return r.parentNode.insertBefore(e,r.nextSibling),e;var i=document.querySelector("main")||document.body;return i?(i.appendChild(e),e):null}var yi={small:{titleSize:20,reviewTextSize:12,reviewTitleSize:14,authorSize:12,replyNameSize:12,replyTextSize:12,photoTitleSize:14,avgRatingSize:36,avgStarSize:48,reviewCountSize:16,recommendSize:12,compactCountSize:14,btnTextSize:12,barLabelSize:18,barCountSize:12,reviewDateSize:10,filterTextSize:12,loadMoreSize:12,readMoreSize:10,reviewStarSize:18,minimalAvgSize:18,heroAvgSize:74},medium:{titleSize:24,reviewTextSize:14,reviewTitleSize:16,authorSize:14,replyNameSize:13,replyTextSize:13,photoTitleSize:16,avgRatingSize:46,avgStarSize:58,reviewCountSize:20,recommendSize:14,compactCountSize:16,btnTextSize:14,barLabelSize:22,barCountSize:14,reviewDateSize:12,filterTextSize:14,loadMoreSize:14,readMoreSize:12,reviewStarSize:22,minimalAvgSize:22,heroAvgSize:90},large:{titleSize:28,reviewTextSize:16,reviewTitleSize:18,authorSize:16,replyNameSize:15,replyTextSize:15,photoTitleSize:18,avgRatingSize:56,avgStarSize:68,reviewCountSize:22,recommendSize:16,compactCountSize:18,btnTextSize:16,barLabelSize:26,barCountSize:16,reviewDateSize:14,filterTextSize:16,loadMoreSize:16,readMoreSize:14,reviewStarSize:26,minimalAvgSize:26,heroAvgSize:106}},wi={small:80,medium:110,large:140};function bt(e,r){var i=document.createElement("div");i.className="ikr-state-msg ikr-state-error",i.setAttribute("role","status"),i.setAttribute("aria-live","polite");var a=document.createElement("div");a.className="ikr-state-error-text",a.textContent=e||"Yorumlar \u015Fu anda y\xFCklenemiyor.",i.appendChild(a);var n=document.createElement("button");return n.type="button",n.className="ikr-state-retry",n.textContent="Tekrar Dene",n.onclick=async function(){n.disabled=!0,n.textContent="Tekrar deneniyor...",await r()},i.appendChild(n),i}function yt(e,r){var i=r.headerTitleColor||"#111111",a=r.headerAvgColor||"#111111",n=r.headerCountColor||"#111111",d=r.headerRecommendColor||"#111111",c=r.barFillColor||"#111111",o=r.barTrackColor||"#e5e7eb",s=r.barCountColor||"#111111",p=Le(c,.06),k=r.reviewStarColor||"#f59e0b",l=r.btnBgColor||"#111111",t=r.btnTextColor||"#ffffff",f=r.btnBorderColor||"#111111",u=r.filterBtnBgColor||"#111111",v=r.filterBtnTextColor||"#ffffff",m=r.filterBtnBorderColor||"#111111",b=r.filterMenuBgColor||"#ffffff",x=r.filterMenuBorderColor||"#e5e7eb",y=r.filterItemTextColor||"#111111",g=r.filterItemHoverBgColor||"#f3f4f6",S=r.filterItemActiveColor||"#111111",z=r.reviewTitleColor||"#111111",C=r.reviewAuthorColor||"#111111",w=r.reviewDateColor||"#5e5e5e",E=r.reviewBodyColor||"#111111",T=r.reviewBorderColor||"#e5e7eb",h=r.replyBgColor||"#f9fafb",N=r.replyBorderColor||"#747474",L=r.replyLabelColor||"#111111",B=r.replyTextColor||"#111111",H=r.photoTitleColor||"#111111",G=Le("#111111",.05),ne=r.photoArrowBgColor||"#ffffff",oe=r.photoArrowTextColor||"#111111",W=Le("#111111",.12),O=r.formBgColor||"#ffffff",F=r.formPrimaryTextColor||"#111111",Ne=r.formSecondaryTextColor||"#3b3b3b",le=r.inputTextColor||F,D=r.inputBorderColor||"#d1d5db",me=r.placeholderColor||"#9ca3af",Ae=r.formStepBarColor||"#111111",q=r.formBtnBgColor||"#111111",K=r.formBtnTextColor||"#ffffff",Y=r.formBtnBorderColor||"#111111",_e=Le(q,.06),X=Le(q,.18),ye=Le(K,.85),J=Le(F,.06),Z=r.loadMoreBgColor||"#ffffff",$=r.loadMoreTextColor||"#111111",we=r.loadMoreBorderColor||"#111111",j={"--ikr-widget-bg":"#ffffff00","--ikr-widget-border":"#ffffff00","--ikr-header-title":i,"--ikr-header-avg":a,"--ikr-header-count":n,"--ikr-header-recommend":d,"--ikr-bar-fill":c,"--ikr-bar-track":o,"--ikr-bar-count":s,"--ikr-bar-hover-bg":p,"--ikr-btn-bg":l,"--ikr-btn-text":t,"--ikr-btn-border":f,"--ikr-filter-btn-bg":u,"--ikr-filter-btn-text":v,"--ikr-filter-btn-border":m,"--ikr-filter-menu-bg":b,"--ikr-filter-menu-border":x,"--ikr-filter-item-text":y,"--ikr-filter-item-hover-bg":g,"--ikr-filter-item-active":S,"--ikr-review-title":z,"--ikr-review-author":C,"--ikr-review-date":w,"--ikr-review-body":E,"--ikr-review-border":T,"--ikr-review-star-color":k,"--ikr-reply-bg-color":h,"--ikr-reply-border":N,"--ikr-reply-label":L,"--ikr-reply-text":B,"--ikr-photo-title":H,"--ikr-photo-image-border":G,"--ikr-photo-arrow-bg":ne,"--ikr-photo-arrow-text":oe,"--ikr-photo-arrow-border":W,"--ikr-fwizard-bg":O,"--ikr-fwizard-text":F,"--ikr-fwizard-secondary-text":Ne,"--ikr-fwizard-input-bg":O,"--ikr-fwizard-input-text":le,"--ikr-fwizard-input-border":D,"--ikr-fwizard-placeholder":me,"--ikr-fwizard-close-text":F,"--ikr-fwizard-close-hover-bg":J,"--ikr-fwizard-progress-bg":J,"--ikr-fwizard-progress-active":Ae,"--ikr-fwizard-btn-bg":q,"--ikr-fwizard-btn-text":K,"--ikr-fwizard-btn-border":Y,"--ikr-fwizard-btn-disabled-bg":X,"--ikr-fwizard-btn-disabled-text":ye,"--ikr-fwizard-nav-hover-bg":_e,"--ikr-load-more-bg":Z,"--ikr-load-more-text":$,"--ikr-load-more-border":we};Object.keys(j).forEach(function(I){e.style.setProperty(I,j[I])}),typeof window!="undefined"&&window.__ikasPreviewMode&&document.body&&(document.body.style.background="transparent",document.documentElement.style.background="transparent")}async function be(e,r,i,a,n,d,c){if(Ir){qe({productId:e,settings:r,reviewsData:i,productName:a,orderBy:n,page:d,badgeSettings:c});return}We(!0),Sr(e),Er(r),c!==void 0&&Tr(c),Lr(a),n&&Re(n),d&&Ee(d),i!=null&&Nr(i);try{let ir=function(P,R){if(!(!P||!P.meta||!P.meta.sizeOverrides)){var M=P.meta.sizeOverrides[R];M&&Object.keys(M).forEach(function(ze){t.style.setProperty(ze,M[ze])})}};var wt=ir,o=er(r.summaryLayout),s=!(o.meta&&o.meta.supports&&o.meta.supports.title===!1),p=r.showTitle!==!1,k=(r.title||"").trim()||"M\xFC\u015Fteri Yorumlar\u0131",l=s&&p?k:"",t=document.documentElement;yt(t,r),Hr("#111111",$r+vi()+bi());var f=r.borderRadius!==void 0?r.borderRadius:8,u=yi[r.size]||yi.medium,v=wi[r.thumbnailSize]||wi.medium,m=je(r.reviewLayout);if(m.meta&&m.meta.sizeOverrides&&m.meta.sizeOverrides[r.size]){var b=m.meta.sizeOverrides[r.size],x=b["--ikr-list-photo-w"]||b["--ikr-gallery-photo-w"];x&&(v=parseInt(x))}t.style.setProperty("--ikr-title-size",u.titleSize+"px"),t.style.setProperty("--ikr-review-text-size",u.reviewTextSize+"px"),t.style.setProperty("--ikr-review-title-size",u.reviewTitleSize+"px"),t.style.setProperty("--ikr-author-size",u.authorSize+"px"),t.style.setProperty("--ikr-reply-name-size",u.replyNameSize+"px"),t.style.setProperty("--ikr-reply-text-size",u.replyTextSize+"px"),t.style.setProperty("--ikr-radius",f+"px"),t.style.setProperty("--ikr-radius-sm",Math.max(0,f-4)+"px"),t.style.setProperty("--ikr-photo-title-size",u.photoTitleSize+"px"),t.style.setProperty("--ikr-avg-rating-size",u.avgRatingSize+"px"),t.style.setProperty("--ikr-review-count-size",u.reviewCountSize+"px"),t.style.setProperty("--ikr-compact-count-size",u.compactCountSize+"px"),t.style.setProperty("--ikr-recommend-size",u.recommendSize+"px"),t.style.setProperty("--ikr-btn-text-size",u.btnTextSize+"px"),t.style.setProperty("--ikr-bar-label-size",u.barLabelSize+"px"),t.style.setProperty("--ikr-minimal-avg-size",u.minimalAvgSize+"px"),t.style.setProperty("--ikr-hero-avg-size",u.heroAvgSize+"px"),t.style.setProperty("--ikr-bar-count-size",u.barCountSize+"px"),t.style.setProperty("--ikr-review-date-size",u.reviewDateSize+"px"),t.style.setProperty("--ikr-filter-text-size",u.filterTextSize+"px"),t.style.setProperty("--ikr-load-more-size",u.loadMoreSize+"px"),t.style.setProperty("--ikr-read-more-size",u.readMoreSize+"px"),t.style.setProperty("--ikr-thumbnail-size",v+"px");var y=/^#[0-9A-Fa-f]{6}([0-9A-Fa-f]{2})?$/.test(r.reviewStarColor||"")?r.reviewStarColor:"#f59e0b";t.style.setProperty("--ikr-review-star-color",y),t.style.setProperty("--ikr-star-size",u.reviewStarSize+"px"),t.style.setProperty("--ikr-avg-star-size",u.avgStarSize+"px"),ir(er(r.summaryLayout),r.size),ir(je(r.reviewLayout),r.size);var g=Oe(r),S=document.getElementById("ikas-reviews");if(!S){var z=ht();if(!z)return;S=document.createElement("div"),S.id="ikas-reviews",S.style.minHeight="200px",z.appendChild(S)}if(r.enabled===!1){S.style.minHeight="auto",S.innerHTML='<div style="padding: 40px 20px; margin-top: 24px; text-align: center; color: #6e6d7a; font-family: Inter, sans-serif; border: 1px dashed #e3e1e5; border-radius: '+(r.borderRadius!==void 0?r.borderRadius:8)+'px; background: #fafafa; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6e6d7a; margin-bottom: 4px;"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg><div style="font-weight: 500; font-size: 18px; color: #1a191a; letter-spacing: -0.01em;">Widget \u015Fu anda Pasif durumda</div><div style="font-size: 16px; color: #6e6d7a; max-width: 380px; line-height: 1.5;">Canl\u0131 ma\u011Fazan\u0131zda m\xFC\u015Fterileriniz hi\xE7bir yorum alan\u0131 g\xF6rmeyecektir.</div></div>',We(!1);var C=Ge;qe(null),C&&be(C.productId,C.settings,C.reviewsData,C.productName,C.orderBy,C.page,C.badgeSettings);return}S.innerHTML='<p class="ikr-state-msg ikr-state-loading">Yorumlar y\xFCkleniyor...</p>';try{var w=i||{},E=cr(w),T=E?[]:w.data&&w.data.reviews||[],h=E?0:w.data&&w.data.totalCount||0;Pr(T);var N=S.cloneNode(!1);S.parentNode.replaceChild(N,S),S=N;var L=document.createElement("div");if(L.id="ikas-reviews-widget",typeof window!="undefined"&&window.__ikasPreviewMode&&(L.style.width="100%",L.style.maxWidth="100%",L.style.marginLeft="0",L.style.marginRight="0"),l){var B=document.createElement("div"),H=r.summaryLayout||"classic";B.className="ikr-title ikr-title-"+H,B.textContent=l,L.appendChild(B)}if(E){L.appendChild(bt(w.message,async function(){var P=await Te(Q,de,1,Ce,Se);await be(Q,A,P,Pe,de,1,tr)})),S.appendChild(L);return}var G=w.data&&w.data.allCount||0,ne=w.data&&w.data.ratingCounts||null,oe=ne||[0,0,0,0,0],W=w.data&&w.data.avgRating||"0.0";if(!ne&&T.length>0){T.forEach(function(P){P.rating>=1&&P.rating<=5&&oe[P.rating-1]++});var O=T.reduce(function(P,R){return P+R.rating},0);W=(O/T.length).toFixed(1)}if(G>0){var F=er(r.summaryLayout),Ne=F.render({widget:L,data:w,settings:r,iconPair:g,allCount:G,ratingCounts:oe,avgRatingVal:W,currentRatingFilter:Ce,currentOrderBy:de,currentHasImages:Se,onFilterChange:async function(P){Ve(Ce===P?null:P),Ee(1);var R=await Te(Q,de,1,Ce,Se);await be(Q,A,R,Pe,de,1)},onSortChange:async function(P,R){Ee(1),R?(nr(!0),Re("newest")):(nr(!1),Re(P));var M=await Te(Q,de,1,Ce,Se);await be(Q,A,M,Pe,de,1)}});L.appendChild(Ne)}else{var le=document.createElement("button");le.className="ikr-write-btn",le.style.cssText="display:block;margin:16px auto 0;",le.textContent=r.writeButtonText||"Yorum Yap",le.onclick=_,L.appendChild(le)}var D=(Cr||[]).filter(function(P){return ge(P).length>0});if(r.showPhotoGallery!==!1&&!Se&&D.length>0){var me=document.createElement("div");if(me.className="ikr-photo-section",r.showPhotoGalleryTitle!==!1){var Ae=(r.photoGalleryTitle||"").trim()||"Foto\u011Frafl\u0131 Yorumlar",q=document.createElement("div");q.className="ikr-photo-title",q.textContent=Ae,me.appendChild(q)}var K=r.reviewLayout==="card"?"1/1":"3/4";t.style.setProperty("--ikr-photo-thumb-aspect",K);var Y=document.createElement("div");Y.className="ikr-photo-strip";var _e=V,X=r.reviewLayout==="card"?V:Math.round(V*4/3),ye=0;D.forEach(function(P){if(!(ye>=15)){var R=Ke(P);if(R){var M=document.createElement("img"),ze=ee(R,V);M.src=ze.src,M.srcset=ze.srcset,M.loading=ye<3?"eager":"lazy",M.decoding="async",M.width=_e,M.height=X,M.className="ikr-photo-strip-thumb",M.alt="Yorum foto\u011Fraf\u0131",re(M),(function(xi,zi){M.onclick=function(){te(zi,xi,D)}})(R,P),Y.appendChild(M),ye++}}});var J=document.createElement("button");J.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-prev",J.innerHTML="&#8249;",J.setAttribute("aria-label","\xD6nceki"),J.onclick=function(){Y.scrollBy({left:-200,behavior:"smooth"})};var Z=document.createElement("button");Z.className="ikr-photo-strip-arrow ikr-photo-strip-arrow-next",Z.innerHTML="&#8250;",Z.setAttribute("aria-label","Sonraki"),Z.onclick=function(){Y.scrollBy({left:200,behavior:"smooth"})};var $=document.createElement("div");$.className="ikr-photo-strip-wrap",$.appendChild(J),$.appendChild(Y),$.appendChild(Z),me.appendChild($),L.appendChild(me)}if(T.length===0){var we=document.createElement("p");we.className="ikr-state-msg",we.textContent="Hen\xFCz yorum yok.",L.appendChild(we)}else{var m=je(r.reviewLayout);T.forEach(function(R){L.appendChild(m.render(R,ar))})}var j=w.data&&w.data.hasMore;if(j){var I=document.createElement("button");I.className="ikr-load-more",I.textContent="Daha Fazla G\xF6ster",I.onclick=async function(){I.disabled=!0,I.textContent="Y\xFCkleniyor...";var P=zr+1,R=await Te(Q,de,P,Ce,Se);if(R&&!cr(R)&&R.data&&Array.isArray(R.data.reviews)){Rr(R.data.reviews),Ee(P);var M=je(A.reviewLayout);R.data.reviews.forEach(function(ze){L.insertBefore(M.render(ze,ar),I)}),R.data.hasMore?(I.disabled=!1,I.textContent="Daha Fazla G\xF6ster"):I.remove()}else I.disabled=!1,I.textContent="Tekrar Dene"},L.appendChild(I)}S.appendChild(L),Zr(G>0?W:null,h,a,tr,g)}catch(P){console.error("[ikr] render error:",P),S.innerHTML='<p style="text-align:center;color:#dc2626;">Yorumlar y\xFCklenirken bir hata olu\u015Ftu.</p>'}}finally{if(We(!1),Ge){var xe=Ge;qe(null),be(xe.productId,xe.settings,xe.reviewsData,xe.productName,xe.orderBy,xe.page,xe.badgeSettings)}}}export{be as a,Je as b,cr as c,Te as d,Ei as e,Lt as f};
