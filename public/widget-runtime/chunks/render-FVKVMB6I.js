...
`;var en={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},rn=va,tn="__unknown_product__",ir=Object.create(null);function an(e){return e?String(e):tn}var Me=null,or=null;function nn(){!Me||!or||(Me.removeEventListener?Me.removeEventListener("change",or):Me.removeListener&&Me.removeListener(or),Me=null,or=null)}function on(e){var r=e.widget,t=e.productId,a=e.settings,i=e.iconPair,p=e.allCount,o=e.ratingCounts,n=e.avgRatingVal,d=e.currentRatingFilter,l=e.currentOrderBy,g=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange,s=an(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var h=document.createElement("div");h.className="renuvex-pr-compact-trigger-wrap";var x=document.createElement("button");x.className="renuvex-pr-compact-trigger",x.type="button",x.setAttribute("aria-expanded","false"),x.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+De(n,i)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+me(Et)+"</span>";var f=x.querySelector(".renuvex-pr-compact-trigger-text"),m=x.querySelector(".renuvex-pr-compact-chevron");if(f&&(f.textContent=p.toLocaleString("tr-TR")+" "+M(a.countLabel,"Yorum")),f&&m){var k=document.createElement("span");k.className="renuvex-pr-compact-trigger-count",x.insertBefore(k,f),k.appendChild(f),k.appendChild(m)}h.appendChild(x),c.appendChild(h);var b=$({widget:r,currentOrderBy:l,currentHasImages:g,onWriteClick:U,onSortChange:u}),z=b.querySelector(".renuvex-pr-filter-wrap"),E=b.querySelector(".renuvex-pr-write-btn"),A=document.createElement("div");A.className="renuvex-pr-compact-actions-slot",E&&A.appendChild(E),z&&A.appendChild(z),c.appendChild(A),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var T=document.createElement("div");T.className="renuvex-pr-compact-panel-inner";var C=document.createElement("div");C.className="renuvex-pr-compact-avg",C.innerHTML='<span class="renuvex-pr-icon">'+ee("full")+"</span><span>"+n+"</span>",T.appendChild(C),T.appendChild(qe({ratingCounts:o,allCount:p,iconPair:i,currentRatingFilter:d,onFilterChange:function(B){P()&&w.classList.contains("renuvex-pr-open")&&(ir[s]=!0),v(B)}})),w.appendChild(T);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function P(){return!!(L&&L.matches)}function S(B){B?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",B?"false":"true"),x.setAttribute("aria-expanded",B?"true":"false")}function N(B){var ve=B?y:h;if(w.parentNode!==ve){var I=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&S(!1),I&&(ir[s]=!1),ve.appendChild(w)}}N(L?L.matches:!1);var D=$({widget:r,currentOrderBy:l,currentHasImages:g,onWriteClick:U,onSortChange:u}),G=D.querySelector(".renuvex-pr-filter-wrap"),Q=D.querySelector(".renuvex-pr-write-btn"),j=document.createElement("div");j.className="renuvex-pr-compact-write-row",Q&&j.appendChild(Q),G&&j.appendChild(G),y.appendChild(j);function H(){var B=w.classList.contains("renuvex-pr-open");return S(!1),P()&&(ir[s]=!1),B}function ne(){V&&V.notifyOpening(),S(!0),P()&&(ir[s]=!0)}x.onclick=function(){w.classList.contains("renuvex-pr-open")?H():ne()};var V=null;function q(B){V&&(V.unregister(),V=null),B||(V=Ir({trigger:h,element:w,close:H}))}if(q(L?L.matches:!1),nn(),L){var ie=function(B){N(B.matches),q(B.matches)};L.addEventListener?L.addEventListener("change",ie):L.addListener&&L.addListener(ie),Me=L,or=ie}if(P()&&ir[s]&&S(!0),a.showRecommendation!==!1){var oe=(o[3]||0)+(o[4]||0),le=p>0?Math.round(oe/p*100):0;if(le>0){var Y=document.createElement("div");Y.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",Y.style.marginTop="8px",Y.innerHTML='<span class="renuvex-pr-recommend-pct">%'+le+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",T.appendChild(Y)}}return y}var Qr={};we(Qr,{css:()=>pn,meta:()=>ln,render:()=>un});var ca=`
...
`;var dn={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},sn=ma;function vn(e){var r=e.widget,t=e.settings,a=e.iconPair,i=e.allCount,p=e.avgRatingVal,o=e.currentOrderBy,n=e.currentHasImages,d=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary renuvex-pr-summary-minimal";var g=document.createElement("div");g.className="renuvex-pr-minimal-info";var v=document.createElement("div");v.className="renuvex-pr-minimal-row";var u=document.createElement("span");u.className="renuvex-pr-minimal-avg",u.textContent=p,v.appendChild(u);var s=document.createElement("span");s.className="renuvex-pr-minimal-stars",s.innerHTML=De(p,a),v.appendChild(s);var y=document.createElement("span");y.className="renuvex-pr-minimal-count",y.textContent=i.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),v.appendChild(y),g.appendChild(v),l.appendChild(g);var c=$({widget:r,currentOrderBy:o,currentHasImages:n,onWriteClick:U,onSortChange:d}),h=c.querySelector(".renuvex-pr-filter-wrap"),x=c.querySelector(".renuvex-pr-write-btn"),f=document.createElement("div");f.className="renuvex-pr-minimal-actions",x&&f.appendChild(x),h&&f.appendChild(h),l.appendChild(f);var m=$({widget:r,currentOrderBy:o,currentHasImages:n,onWriteClick:U,onSortChange:d}),k=m.querySelector(".renuvex-pr-filter-wrap"),b=m.querySelector(".renuvex-pr-write-btn"),z=document.createElement("div");return z.className="renuvex-pr-minimal-write-row",b&&z.appendChild(b),k&&z.appendChild(k),l.appendChild(z),l}var rt={};we(rt,{css:()=>mn,meta:()=>cn,render:()=>xn});var xa=`
...
`;var cn={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},mn=xa;function xn(e){var r=e.widget,t=e.settings,a=e.iconPair,i=e.allCount,p=e.avgRatingVal,o=e.currentOrderBy,n=e.currentHasImages,d=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary renuvex-pr-summary-hero";var g=document.createElement("div");g.className="renuvex-pr-hero-info";var v=document.createElement("div");v.className="renuvex-pr-hero-rating-col";var u=document.createElement("span");u.className="renuvex-pr-hero-avg",u.textContent=p,v.appendChild(u);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var y=document.createElement("span");y.className="renuvex-pr-hero-stars",y.innerHTML=De(p,a),s.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-hero-count",c.textContent=i.toLocaleString("tr-TR")+" "+M(t.countLabel,"Yorum"),s.appendChild(c),v.appendChild(s),g.appendChild(v),l.appendChild(g);var h=$({widget:r,currentOrderBy:o,currentHasImages:n,onWriteClick:U,onSortChange:d}),x=h.querySelector(".renuvex-pr-filter-wrap"),f=h.querySelector(".renuvex-pr-write-btn"),m=document.createElement("div");m.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",f&&m.appendChild(f),x&&m.appendChild(x),l.appendChild(m);var k=$({widget:r,currentOrderBy:o,currentHasImages:n,onWriteClick:U,onSortChange:d}),b=k.querySelector(".renuvex-pr-filter-wrap"),z=k.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");return E.className="renuvex-pr-hero-write-row",z&&E.appendChild(z),b&&E.appendChild(b),l.appendChild(E),l}var fa=`
  .renuvex-pr-summary{
