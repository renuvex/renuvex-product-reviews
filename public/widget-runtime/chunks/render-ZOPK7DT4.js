...
`);function ya(){var e=document.body.style,r=document.documentElement.style;return{scrollX:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0,scrollY:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,fixedBodyLock:!1,bodyOverflow:e.getPropertyValue("overflow"),bodyOverflowPriority:e.getPropertyPriority("overflow"),bodyPaddingRight:e.getPropertyValue("padding-right"),bodyPaddingRightPriority:e.getPropertyPriority("padding-right"),bodyPosition:e.getPropertyValue("position"),bodyPositionPriority:e.getPropertyPriority("position"),bodyTop:e.getPropertyValue("top"),bodyTopPriority:e.getPropertyPriority("top"),bodyLeft:e.getPropertyValue("left"),bodyLeftPriority:e.getPropertyPriority("left"),bodyRight:e.getPropertyValue("right"),bodyRightPriority:e.getPropertyPriority("right"),bodyWidth:e.getPropertyValue("width"),bodyWidthPriority:e.getPropertyPriority("width"),bodyOverscrollBehaviorY:e.getPropertyValue("overscroll-behavior-y"),bodyOverscrollBehaviorYPriority:e.getPropertyPriority("overscroll-behavior-y"),rootOverflow:r.getPropertyValue("overflow"),rootOverflowPriority:r.getPropertyPriority("overflow"),rootOverscrollBehaviorY:r.getPropertyValue("overscroll-behavior-y"),rootOverscrollBehaviorYPriority:r.getPropertyPriority("overscroll-behavior-y")}}function le(e,r,t,a){t?e.setProperty(r,t,a||""):e.removeProperty(r)}function wa(){if(typeof navigator=="undefined")return!1;var e=navigator.platform||"",r=navigator.userAgent||"",t=navigator.maxTouchPoints||0,a=/iP(ad|hone|od)/.test(e)||e==="MacIntel"&&t>1;return a&&/AppleWebKit/i.test(r)}function za(e){var r=document.body.style,t=document.documentElement.style,a=Math.max(0,window.innerWidth-document.documentElement.clientWidth),n=window.getComputedStyle(document.body).position==="fixed",o=wa()&&!n;if(a>0){var l=parseFloat(window.getComputedStyle(document.body).paddingRight)||0;r.setProperty("padding-right",l+a+"px","important")}t.setProperty("overflow","hidden","important"),t.setProperty("overscroll-behavior-y","none","important"),r.setProperty("overflow","hidden","important"),r.setProperty("overscroll-behavior-y","none","important"),o&&(e.fixedBodyLock=!0,r.setProperty("position","fixed","important"),r.setProperty("top",-e.scrollY+"px","important"),r.setProperty("left",-e.scrollX+"px","important"),r.setProperty("right","0","important"),r.setProperty("width","100%","important"))}function Sa(e){var r=document.body.style,t=document.documentElement.style;le(t,"overflow",e.rootOverflow,e.rootOverflowPriority),le(t,"overscroll-behavior-y",e.rootOverscrollBehaviorY,e.rootOverscrollBehaviorYPriority),le(r,"overflow",e.bodyOverflow,e.bodyOverflowPriority),le(r,"padding-right",e.bodyPaddingRight,e.bodyPaddingRightPriority),le(r,"overscroll-behavior-y",e.bodyOverscrollBehaviorY,e.bodyOverscrollBehaviorYPriority),le(r,"position",e.bodyPosition,e.bodyPositionPriority),le(r,"top",e.bodyTop,e.bodyTopPriority),le(r,"left",e.bodyLeft,e.bodyLeftPriority),le(r,"right",e.bodyRight,e.bodyRightPriority),le(r,"width",e.bodyWidth,e.bodyWidthPriority),e.fixedBodyLock&&window.scrollTo(e.scrollX,e.scrollY)}var $e=0,Oe=null;function gr(){return $e+=1,$e>1||(Oe=ya(),za(Oe)),Oe}function hr(){if($e!==0&&($e-=1,!($e>0))){var e=Oe;Oe=null,e&&Sa(e)}}function Ca(){for(var e=document.activeElement;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function br(){var e=Ca();return!e||e===document.body||e===document.documentElement?null:e}function K(e){if(!(!e||!e.isConnected||typeof e.focus!="function"))try{e.focus({preventScroll:!0})}catch(r){try{e.focus()}catch(t){}}}function ka(e){return!e||e.disabled||e.getAttribute("aria-hidden")==="true"||typeof e.tabIndex=="number"&&e.tabIndex<0?!1:!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)}function _r(e){var r=["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");return Array.prototype.slice.call(e.querySelectorAll(r)).filter(ka)}function Ea(e,r){var t=e,a=_r(e);!a.length&&r&&(t=r,a=_r(r));var n=a[0]||t&&t.querySelector('[role="dialog"]')||t;K(n)}function yr(e,r,t){if(e.key==="Tab"){var a=_r(r);if(!a.length){e.preventDefault(),Ea(r);return}var n=a[0],o=a[a.length-1],l=Et(t);if(!r.contains(l)){e.preventDefault(),K(n);return}if(a.indexOf(l)===-1){e.preventDefault(),K(e.shiftKey?o:n);return}e.shiftKey&&l===n?(e.preventDefault(),K(o)):!e.shiftKey&&l===o&&(e.preventDefault(),K(n))}}var Bt="renuvexPrOverlay";function wr(){var e={id:"renuvex-pr-overlay-"+Date.now()+"-"+Math.random().toString(36).slice(2),previousState:null,pushed:!1,url:window.location.href};try{e.previousState=history.state;var r={};r[Bt]=e.id,history.pushState(r,"",e.url),e.pushed=!0}catch(t){}return e}function Ta(e){return!!(e&&e.pushed&&window.location.href===e.url&&history.state&&history.state[Bt]===e.id)}function zr(e){if(Ta(e))try{history.replaceState(e.previousState,"",e.url)}catch(r){}}function He(e){return ye(e)}function _t(e,r,t,a,n,o){hr(a),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&dr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),o&&K(n)}function Aa(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var a=document.createElement("div");a.className="renuvex-pr-modal-top-row";var n=document.createElement("div");n.className="renuvex-pr-modal-stars",n.innerHTML=ce(e.rating,N);var o=document.createElement("span");o.className="renuvex-pr-modal-date",o.textContent=me(e.createdAt),a.appendChild(n),a.appendChild(o),t.appendChild(a);var l=document.createElement("div");l.className="renuvex-pr-modal-title",l.textContent=e.title||"",l.style.display=e.title?"":"none",t.appendChild(l);var i=document.createElement("div");i.className="renuvex-pr-modal-author",i.textContent=e.author||"",t.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-modal-body",d.textContent=(e.comment||"").trim(),d.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-modal-reply";var f=document.createElement("div");f.className="renuvex-pr-modal-reply-label",f.textContent=N&&N.merchantReplyLabel||"Ma\u011Faza Sahibi";var s=document.createElement("div");return s.className="renuvex-pr-modal-reply-text",s.textContent=e.merchantReply||"",p.appendChild(f),p.appendChild(s),p.style.display=e.merchantReply?"":"none",t.appendChild(p),r.appendChild(t),r}function Mt(e,r,t){var a=t||N,n=e.querySelector(".renuvex-pr-modal-scroll-content"),o=n.querySelector(".renuvex-pr-modal-stars");o.innerHTML=ce(r.rating,a),n.querySelector(".renuvex-pr-modal-date").textContent=me(r.createdAt);var l=n.querySelector(".renuvex-pr-modal-title");l.textContent=r.title||"",l.style.display=r.title?"":"none",n.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var i=n.querySelector(".renuvex-pr-modal-body");i.textContent=(r.comment||"").trim(),i.style.display=r.comment&&r.comment.trim()?"":"none";var d=n.querySelector(".renuvex-pr-modal-reply");d.querySelector(".renuvex-pr-modal-reply-label").textContent=a&&a.merchantReplyLabel||"Ma\u011Faza Sahibi",d.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",d.style.display=r.merchantReply?"":"none",e.scrollTop=0}function Fr(e,r,t,a,n,o,l,i,d){var p=He(e),f=Math.max(0,Math.min(t||0,p.length-1)),s=document.createElement("div");s.className="renuvex-pr-modal-left";var u=document.createElement("img"),v=l==="next"?"renuvex-pr-modal-img-enter-right":l==="prev"?"renuvex-pr-modal-img-enter-left":"";u.className="renuvex-pr-modal-main-img"+(v?" "+v:""),u.src=Ir(p[f]||""),u.decoding="async",u.width=Rr,u.height=Math.round(Rr*4/3),u.alt="Yorum foto\u011Fraf\u0131",wt(u,function(T){if(T.style.display="none",!s.querySelector(".renuvex-pr-modal-img-error")){var k=document.createElement("div");k.className="renuvex-pr-modal-img-error",k.setAttribute("role","status"),k.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",s.insertBefore(k,T)}}),s.appendChild(u);var y=document.createElement("button");y.className="renuvex-pr-modal-close-mobile";var c=X(ke);c&&y.appendChild(c),y.setAttribute("aria-label","Kapat"),y.onclick=function(T){T.stopPropagation(),o()},s.appendChild(y);var b=0;if(s.addEventListener("touchstart",function(T){b=T.touches[0].clientX},{passive:!0}),s.addEventListener("touchend",function(T){var k=b-T.changedTouches[0].clientX;if(!(Math.abs(k)<50)){if(k>0){if(g)xe(e,r,f+1,a,n,o,!0,"next",i,d);else if(x){var P=a[r+1];xe(P,r+1,0,a,n,o,!1,"next",i,d)}}else if(h)xe(e,r,f-1,a,n,o,!0,"prev",i,d);else if(S){var B=a[r-1],j=He(B);xe(B,r-1,j.length-1,a,n,o,!1,"prev",i,d)}}},{passive:!0}),p.length>1){var m=document.createElement("div");m.className="renuvex-pr-modal-thumbs",p.forEach(function(T,k){var P=document.createElement("img"),B=ie(T,mr);P.src=B.src,P.srcset=B.srcset,P.loading="lazy",P.decoding="async",P.width=mr,P.height=mr,P.className="renuvex-pr-modal-thumb"+(k===f?" renuvex-pr-modal-thumb-active":""),P.alt="K\xFC\xE7\xFCk resim "+(k+1),oe(P),P.tabIndex=0,P.setAttribute("role","button"),P.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(k+1)+" se\xE7"),k===f&&P.setAttribute("aria-current","true"),(function(j){function F(){xe(e,r,j,a,n,o,!0,null,i,d)}P.onclick=F,P.onkeydown=function(U){(U.key==="Enter"||U.key===" ")&&(U.preventDefault(),F())}})(k),m.appendChild(P)}),s.appendChild(m)}var h=f>0,g=f<p.length-1,S=r>0,x=r<a.length-1,w=h||S,A=g||x;if(w){var E=document.createElement("button");E.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var z=X(Ie);z&&E.appendChild(z),E.setAttribute("aria-label","\xD6nceki"),E.onclick=function(T){if(T.stopPropagation(),h)xe(e,r,f-1,a,n,o,!0,"prev",i,d);else if(S){var k=a[r-1],P=He(k);xe(k,r-1,P.length-1,a,n,o,!1,"prev",i,d)}},s.appendChild(E)}if(A){var C=document.createElement("button");C.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var L=X(sr);L&&C.appendChild(L),C.setAttribute("aria-label","Sonraki"),C.onclick=function(T){if(T.stopPropagation(),g)xe(e,r,f+1,a,n,o,!0,"next",i,d);else if(x){var k=a[r+1];xe(k,r+1,0,a,n,o,!1,"next",i,d)}},s.appendChild(C)}return s}function Ft(e,r){[-1,1].forEach(function(t){var a=r[e+t];if(a){var n=He(a);n[0]&&(new Image().src=Ir(n[0]))}})}function Mr(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function La(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),a=r&&r.querySelector(".renuvex-pr-modal-right"),n=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function o(){Mr(t),Mr(a),Mr(n)}o(),t&&K(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){o(),requestAnimationFrame(o)}):setTimeout(o,0)}function xe(e,r,t,a,n,o,l,i,d,p){if(p&&(p.currentReview=e),l){var f=Fr(e,r,t,a,n,o,i,d,p);n.firstChild&&n.replaceChild(f,n.firstChild)}else{var f=Fr(e,r,t,a,n,o,i,d,p),s=n.querySelector(".renuvex-pr-modal-right");n.firstChild&&n.replaceChild(f,n.firstChild),s&&Mt(s,e,p&&p.currentSettings),La(d,n)}Ft(r,a)}function pe(e,r,t){var a=He(e);if(!a.length)return;var n=(t||[]).filter(function(E){return He(E).length>0}),o=n.findIndex(function(E){return E===e||E.id===e.id});o===-1&&(n.unshift(e),o=0);var l=a.indexOf(r);l<0&&(l=0);var i=document.createElement("div");i.className="renuvex-pr-modal-overlay";var d=document.createElement("div");d.className="renuvex-pr-modal";var p=!1,f=null,s=br(),u=Pe(),v=gr(),y=wr(),c={currentReview:e,currentSettings:N},b=null;function m(E){var z=E&&E.detail&&E.detail.settings;if(!(z&&z===b)){b=z||null,c.currentSettings=z||N;var C=d.querySelector(".renuvex-pr-modal-right");!C||!c.currentReview||Mt(C,c.currentReview,c.currentSettings)}}function h(){p||(p=!0,window.removeEventListener(Ee,m),_t(f&&f.host,g,h,v,s,u))}function g(E){if(E.key==="Escape"){S();return}yr(E,i,f&&f.root)}function S(){p||(p=!0,window.removeEventListener(Ee,m),_t(f&&f.host,g,h,v,s,u),zr(y))}document.addEventListener("keydown",g),window.addEventListener("popstate",h),window.addEventListener(Ee,m),i.onclick=function(){S()},d.onclick=function(E){E.stopPropagation()},d.appendChild(Fr(e,o,l,n,d,S,null,i,c)),d.appendChild(Aa(e)),Ft(o,n);var x=document.createElement("div");x.className="renuvex-pr-modal-wrap",x.tabIndex=-1,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true"),x.setAttribute("aria-label","Yorum foto\u011Fraf\u0131 detay\u0131"),x.appendChild(d);var w=document.createElement("button");w.className="renuvex-pr-modal-close";var A=X(ke);A&&w.appendChild(A),w.setAttribute("aria-label","Kapat"),w.onclick=function(E){E.stopPropagation(),S()},x.appendChild(w),i.appendChild(x),f=xr(),Fe(f.root,Me+Le+fr),f.root.appendChild(i),Ce(f.root),K(x)}function we(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(a){(a.key==="Enter"||a.key===" "||a.key==="Spacebar")&&(a.preventDefault(),r())})}var jr={};he(jr,{css:()=>Ha,meta:()=>Oa,render:()=>Ya});function Ye(e){var r=e.ratingCounts,t=e.allCount,a=e.iconPair,n=e.currentRatingFilter,o=e.onFilterChange;be(a);var l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var i=5;i>=1;i--){var d=r[i-1]||0,p=t>0?Math.round(d/t*100):0,f=n===i,s=document.createElement("div");s.className="renuvex-pr-bar-row"+(f?" renuvex-pr-bar-active":"")+(n&&!f?" renuvex-pr-bar-dimmed":""),s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",f?"true":"false"),s.setAttribute("aria-label",i+" y\u0131ld\u0131z, "+d.toLocaleString("tr-TR")+" yorum, "+(f?"filtreyi kald\u0131r":"filtrele"));for(var u="",v=1;v<=5;v++){var y=v<=i;u+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(y?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+G(y?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+u+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+p+'%;"></div></div><span class="renuvex-pr-bar-count">('+d.toLocaleString("tr-TR")+")</span>",(function(c){function b(){o(c)}s.onclick=b,s.onkeydown=function(m){(m.key==="Enter"||m.key===" "||m.key==="Space"||m.key==="Spacebar")&&(m.preventDefault(),b())}})(i),l.appendChild(s)}return l}var Yt="data-renuvex-pr-dismiss-gesture",Te=[],Ot=!1,Sr=!1,Qe=[],De=null;function Ht(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Or(){for(var e=Te.length-1;e>=0;e--){var r=Te[e].element;r&&r.isConnected===!1&&Te.splice(e,1)}return Te}function Pa(e){!e||typeof e.setAttribute!="function"||(Qe.indexOf(e)===-1&&Qe.push(e),e.setAttribute(Yt,""))}function Dt(){for(var e=0;e<Qe.length;e++){var r=Qe[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Yt)}Qe=[],De&&typeof clearTimeout=="function"&&clearTimeout(De),De=null}function Na(e){if(Sr){Sr=!1,Dt(),e.preventDefault(),e.stopPropagation();return}for(var r=Or(),t=!1,a=r.length-1;a>=0;a--){var n=r[a];Ht(e,n.trigger)||Ht(e,n.element)||n.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Ra(e){if(e.key==="Escape")for(var r=Or(),t=r.length-1;t>=0;t--)r[t].close()}function jt(){Ot||typeof document=="undefined"||(document.addEventListener("click",Na,!0),document.addEventListener("keydown",Ra),Ot=!0)}function Ia(e){jt(),Sr=!0,Pa(e),De&&typeof clearTimeout=="function"&&clearTimeout(De),typeof setTimeout=="function"&&(De=setTimeout(function(){Sr=!1,Dt()},700))}function Hr(e){Ia(e)}function Cr(e){jt();var r={trigger:e.trigger,element:e.element,close:e.close};return Te.push(r),{unregister:function(){var t=Te.indexOf(r);t!==-1&&Te.splice(t,1)},notifyOpening:function(){for(var t=Or(),a=0;a<t.length;a++)t[a]!==r&&t[a].close()}}}function re(e){var r=e.widget,t=e.currentOrderBy,a=e.currentHasImages,n=e.onWriteClick,o=e.onSortChange,l=document.createElement("div");l.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var i=document.createElement("button");i.className="renuvex-pr-write-btn",i.textContent=N&&N.writeButtonText||"Yorum Yap",i.onclick=n,l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-filter-wrap";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-filter-btn",p.setAttribute("aria-label","Filtrele"),p.setAttribute("aria-haspopup","menu"),p.setAttribute("aria-expanded","false");var f=N&&N.filterIcon||"lines";p.innerHTML=ve(mt(f));var s=document.createElement("div");s.className="renuvex-pr-filter-menu",s.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],v=!1;function y(){return r&&r.parentNode||r||null}function c(g,S){if(!(S===!0||!g)){if(g.type==="touchstart"){Hr(y());return}if(g.type==="pointerdown"){var x=g.pointerType||"";x&&x!=="mouse"&&Hr(y());return}}}function b(g){var S=s.classList.contains("renuvex-pr-open");s.classList.remove("renuvex-pr-open"),p.classList.remove("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","false");var x=g&&(g.restoreFocus===!0||g.restoreFocus==="auto"&&Pe());if(S&&x)try{p.focus({preventScroll:!0})}catch(w){try{p.focus()}catch(A){}}return S}function m(){h.notifyOpening(),s.classList.add("renuvex-pr-open"),p.classList.add("renuvex-pr-filter-btn-active"),p.setAttribute("aria-expanded","true");var g=s.querySelector(".renuvex-pr-filter-item-active")||s.querySelector(".renuvex-pr-filter-item");g&&requestAnimationFrame(function(){try{g.focus({preventScroll:!0})}catch(S){try{g.focus()}catch(x){}}})}u.forEach(function(g){var S=g[2],x=S?a:!a&&(t||"newest")===g[0],w=document.createElement("button");w.type="button",w.className="renuvex-pr-filter-item"+(x?" renuvex-pr-filter-item-active":""),w.setAttribute("role","menuitem"),w.textContent=g[1];var A=!1;function E(z,C){z&&(z.preventDefault(),z.stopPropagation()),!A&&(A=!0,v=!0,c(z,C),b({restoreFocus:C}),o(g[0],S),setTimeout(function(){A=!1,v=!1},0))}w.addEventListener("pointerdown",function(z){z.button!==void 0&&z.button!==0||z.pointerType!=="mouse"&&E(z,!1)}),typeof window!="undefined"&&!window.PointerEvent&&w.addEventListener("touchstart",function(z){E(z,!1)},{passive:!1}),w.addEventListener("keydown",function(z){(z.key==="Enter"||z.key===" ")&&E(z,!0)}),w.onclick=function(z){E(z,!1)},s.appendChild(w)}),p.onclick=function(){s.classList.contains("renuvex-pr-open")?b({restoreFocus:"auto"}):m()},d.addEventListener("keydown",function(g){g.key==="Escape"&&s.classList.contains("renuvex-pr-open")&&(g.stopPropagation(),b({restoreFocus:!0}))}),d.addEventListener("focusout",function(g){if(s.classList.contains("renuvex-pr-open")&&!v){var S=g.relatedTarget;S&&d.contains(S)||b()}});var h=Cr({trigger:d,element:s,close:b});return d.appendChild(p),d.appendChild(s),l.appendChild(d),l}var Ut=`
...
`;function Vt(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.allowOutsideClose!==!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-overlay",a.tabIndex=-1,a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","Yorum yapma formu");var n=document.createElement("div");n.className="renuvex-pr-fwizard",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content",n.appendChild(o);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var i=X(ke);i&&l.appendChild(i),n.appendChild(l);var d=!1,p=null,f=null,s=!1;function u(){K(a)}function v(x){yr(x,a,p&&p.root)}function y(){if(!d){if(d=!0,document.removeEventListener("keydown",c),a.removeEventListener("click",b),l.removeEventListener("click",y),s)K(f);else{var x=p&&p.root?p.root.activeElement:null;if(x&&typeof x.blur=="function")try{x.blur()}catch(w){}}a.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){p?(dr(p.root),p.host&&p.host.parentNode&&p.host.parentNode.removeChild(p.host)):a.parentNode&&a.parentNode.removeChild(a),hr();try{r()}catch(w){}},200)}}function c(x){if(x.key==="Escape"){y();return}v(x)}function b(x){x.target===a&&t&&y()}document.addEventListener("keydown",c),a.addEventListener("click",b),l.addEventListener("click",y);function m(x){f=br(),s=Pe(),x&&o.appendChild(x),p=xr(),Fe(p.root,Me+Le+Ut),p.root.appendChild(a),Ce(p.root),gr(),requestAnimationFrame(function(){a.classList.add("renuvex-pr-fwizard-open"),u()})}var h=null,g=null;function S(x,w){if(w=w||"error",h){try{h.remove()}catch(A){}h=null}g&&(clearTimeout(g),g=null),h=document.createElement("div"),h.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+w,h.textContent=x,n.appendChild(h),g=setTimeout(function(){h&&(h.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(h){try{h.remove()}catch(A){}h=null}},300))},4e3)}return{open:m,close:y,content:o,setAllowOutsideClose:function(x){t=!!x},setStepAttr:function(x){n.setAttribute("data-step",String(x))},showToast:S}}var Yr=4;function je(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Wt(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],fingerprints:[],productId:e.productId||"",productName:e.productName||""};function a(){r.forEach(function(n){try{n(t)}catch(o){}})}return{get:function(){return t},set:function(n){Object.assign(t,n),a()},goNext:function(){t.currentStep<Yr&&(t.currentStep+=1,a())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,a())},onChange:function(n){return r.push(n),function(){r=r.filter(function(o){return o!==n})}}}}function qt(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],a=e.onBack||function(){},n=e.onSkip||function(){},o=e.onNext||function(){},l=document.createElement("div");l.className="renuvex-pr-fwizard-footer";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",i.setAttribute("aria-label","Geri"),i.innerHTML=ve(Ie)+"<span>Geri</span>",i.addEventListener("click",function(){a()}),l.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-footer-progress";for(var p=[],f=0;f<Yr;f++){var s=document.createElement("span");s.className="renuvex-pr-fwizard-progress-seg",d.appendChild(s),p.push(s)}l.appendChild(d);var u=document.createElement("button");u.type="button";var v=null;function y(b){v&&u.removeEventListener("click",v),v=b,b&&u.addEventListener("click",b)}l.appendChild(u);function c(b,m){var h=r.indexOf(b)!==-1,g=t.indexOf(b)!==-1,S=m&&(m.images&&m.images.length>0||m.pendingImages&&m.pendingImages.length>0);if(h)b===2&&S?(u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",y(function(){o()})):(u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.setAttribute("aria-label","Atla"),u.innerHTML="<span>Atla</span>",y(function(){n()})),u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),u.style.visibility="",u.tabIndex=0;else if(g){u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Sonraki"),u.innerHTML="Sonraki",u.style.visibility="",u.tabIndex=0;var x=je(b,m);u.disabled=!x,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!x),y(function(){u.disabled||o()})}else u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.innerHTML="",u.style.visibility="hidden",u.tabIndex=-1,u.disabled=!0,y(null)}return{el:l,update:function(b,m){p.forEach(function(g,S){S+1<=b?g.classList.add("renuvex-pr-fwizard-progress-seg-active"):g.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var h=b<=1;i.style.visibility=h?"hidden":"",i.style.pointerEvents=h?"none":"",i.tabIndex=h?-1:0,c(b,m)},setNextDisabled:function(b){u.classList.contains("renuvex-pr-fwizard-cta-btn")&&(u.disabled=!!b,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!b))},setThanksState:function(b){i.style.visibility="hidden",d.style.visibility="hidden",u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",u.style.visibility="",u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),y(b)}}}function Gt(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var a=!1,n=null,o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title",o.textContent="Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",t.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-stars",l.setAttribute("role","radiogroup"),l.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var i=Je(N||{});be(i);var d=[];function p(b){d.forEach(function(m,h){var g=h<b;m.classList.toggle("renuvex-pr-fwizard-star-active",g),m.setAttribute("aria-checked",h+1===b?"true":"false"),m.innerHTML=g?G("full"):G("outline")})}function f(b){e.set({rating:b}),p(b)}function s(b){var m=d[b-1];if(m)try{m.focus()}catch(h){}}function u(b,m){m&&typeof m.preventDefault=="function"&&m.preventDefault(),m&&typeof m.stopPropagation=="function"&&m.stopPropagation(),!a&&(a=!0,f(b),n&&clearTimeout(n),n=setTimeout(function(){e.goNext()},280))}for(var v=1;v<=5;v++)(function(b){var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-star",m.setAttribute("role","radio"),m.setAttribute("aria-label",b+" y\u0131ld\u0131z"),m.innerHTML=G("outline"),m.addEventListener("mouseenter",function(){p(b)}),m.addEventListener("mouseleave",function(){p(e.get().rating)}),m.addEventListener("pointerdown",function(h){h.button&&h.button!==0||u(b,h)}),typeof window!="undefined"&&!window.PointerEvent&&m.addEventListener("touchstart",function(h){u(b,h)},{passive:!1}),m.addEventListener("mousedown",function(h){window.PointerEvent||u(b,h)}),m.addEventListener("keydown",function(h){if(h.key==="Enter"||h.key===" "){u(b,h);return}var g=0;h.key==="ArrowRight"||h.key==="ArrowUp"?g=Math.min(5,b+1):h.key==="ArrowLeft"||h.key==="ArrowDown"?g=Math.max(1,b-1):h.key==="Home"?g=1:h.key==="End"&&(g=5),g&&(h.preventDefault(),f(g),s(g))}),m.addEventListener("click",function(h){u(b,h)}),d.push(m),l.appendChild(m)})(v);p(e.get().rating);var y=null,c=function(b){var m=b&&b.detail&&b.detail.settings;m&&m===y||(y=m||null,i=Je(m||N||{}),p(e.get().rating))};return window.addEventListener(Ee,c),t.appendChild(l),{el:t,destroy:function(){n&&clearTimeout(n),window.removeEventListener(Ee,c)}}}var Xt=3,Ba=10*1024*1024;function Kt(e,r){r=r||{};var t=!1,a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Foto\u011Frafl\u0131 de\u011Ferlendirme",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-subtitle",o.textContent="Foto\u011Fraf ekleyebilirsiniz.",a.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-photo-card";var i=document.createElement("button");i.type="button",i.className="renuvex-pr-fwizard-photo-add",i.setAttribute("aria-label","Foto\u011Fraf ekle");var d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.style.display="none",l.appendChild(i),l.appendChild(d);var p=document.createElement("div");p.className="renuvex-pr-fwizard-photo-previews",p.setAttribute("aria-live","polite"),l.appendChild(p),a.appendChild(l);var f=r.revokeBlobUrl||function(h){h&&typeof h=="string"&&h.startsWith("blob:")&&URL.revokeObjectURL(h)},s=r.blobMap||{},u=r.urlToFinger||{};function v(){if(!t){var h=e.get().images||[],g=e.get().pendingImages||[],S=h.map(function(x){return{url:x,isPending:!1}}).concat(g.map(function(x){return{url:x.url,file:x.file,isPending:!0,error:x.error}}));p.innerHTML="",S.forEach(function(x){var w=s[x.url]||x.url,A=y(x,w);p.appendChild(A)}),b()}}function y(h,g){var S=document.createElement("div");S.className="renuvex-pr-fwizard-photo-thumb";var x=document.createElement("img");x.src=g,x.alt="",x.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",S.appendChild(x);var w=document.createElement("div");w.className="renuvex-pr-fwizard-photo-loading",w.style.display="none",S.appendChild(w);var A=document.createElement("button");A.type="button",A.className="renuvex-pr-fwizard-photo-remove",A.setAttribute("aria-label","Kald\u0131r");var E=X(ke);return E&&A.appendChild(E),S.appendChild(A),c(S,h,g),S}function c(h,g,S){var x=h.querySelector("img");x.src!==S&&(x.src=S);var w=h.querySelector(".renuvex-pr-fwizard-photo-loading");if(g.isPending&&g.error){w.style.display="flex",w.textContent="";var A=document.createElement("span");A.className="renuvex-pr-upload-error",A.textContent="\u2717 "+g.error,w.appendChild(A)}else w.style.display="none",w.textContent="";var E=h.querySelector(".renuvex-pr-fwizard-photo-remove");E.onclick=function(){var z=u[g.url]||(g.file?g.file.name+"_"+g.file.size:null),C=s[g.url],L={};z&&(L.fingerprints=(e.get().fingerprints||[]).filter(function(T){return T!==z})),g.isPending?L.pendingImages=(e.get().pendingImages||[]).filter(function(T){return T.url!==g.url}):L.images=(e.get().images||[]).filter(function(T){return T!==g.url}),e.set(L),f(g.url),f(C),delete u[g.url],C&&delete u[C],s[g.url]&&delete s[g.url]}}function b(){var h=(e.get().images||[]).length,g=(e.get().pendingImages||[]).length,S=h+g,x=S>=Xt;S>0?(l.classList.add("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=ve(gt)):(l.classList.remove("renuvex-pr-fwizard-photo-card--compact"),i.innerHTML=ve(ft)+"<span>Foto\u011Fraf Ekle</span>"),x?(i.style.display="none",i.disabled=!0,d.disabled=!0):(i.style.display="flex",i.disabled=!1,d.disabled=!1,i.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}i.addEventListener("click",function(){d.disabled||d.click()}),d.onchange=async function(h){var g=(e.get().images||[]).length+(e.get().pendingImages||[]).length,S=Array.from(h.target.files).slice(0,Xt-g);d.value="";var x=(e.get().pendingImages||[]).length,w=e.get().images||[],A=w.length;if(S.length!==0){for(var E=[],z=[],C=0;C<S.length;C++){var L=S[C],T=L.name+"_"+L.size,k=(e.get().fingerprints||[]).some(function(D){return D===T})||E.some(function(D){return D.file.name+"_"+D.file.size===T});if(!k){if(L.size>Ba){var P="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(P,"error"):alert(P);continue}var B=URL.createObjectURL(L);u[B]=T,E.push({url:B,file:L,error:null}),z.push({url:B,file:L});var j=(e.get().fingerprints||[]).slice();j.push(T),e.set({fingerprints:j})}}if(E.length!==0){var F=(e.get().pendingImages||[]).concat(E),U=async function(){for(var D=0;D<z.length;D++){var J=z[D],W=J.file,R=J.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var ue=(e.get().pendingImages||[]).filter(function(M){return M.url!==R}),ae=(e.get().images||[]).slice();ae.push(R),e.set({pendingImages:ue,images:ae});continue}try{var ze=await Ze(Ke+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Xe})});if(!ze.ok)throw ze.status===429?new Error("rate_limit"):new Error("sign failed");var ne=await ze.json();if(!ne.folder)throw new Error("sign folder missing");var I=new FormData;I.append("file",W),I.append("api_key",ne.api_key),I.append("timestamp",ne.timestamp),I.append("signature",ne.signature),I.append("folder",ne.folder);var ge=await fetch("https://api.cloudinary.com/v1_1/"+ne.cloud_name+"/image/upload",{method:"POST",body:I}),O=await ge.json();if(O.secure_url&&yt(O.secure_url)){var tr=(e.get().pendingImages||[]).some(function(M){return M.url===R});if(!tr)continue;s[O.secure_url]=R,u[O.secure_url]=u[R];var Se=(e.get().pendingImages||[]).filter(function(M){return M.url!==R}),_=(e.get().images||[]).slice();_.push(O.secure_url),e.set({pendingImages:Se,images:_});try{Ze(Ke+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Xe,secureUrl:O.secure_url})}).catch(function(){})}catch(M){}}else throw new Error("invalid image url")}catch(M){console.error("[renuvex-pr] Image upload failed:",M);var Z=M.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(Z,"error");var $=(e.get().pendingImages||[]).map(function(de){return de.url===R?{url:de.url,file:de.file,error:Z}:de});e.set({pendingImages:$})}}};if(A===0&&x===0){t=!0;var te=!r.canNavigate||r.canNavigate();te&&e.goNext()}e.set({pendingImages:F}),U()}}};var m=e.onChange(v);return v(),{el:a,destroy:function(){t=!0,d.onchange=null,m&&m()}}}var Dr=2e3,_a=60;function Jt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var n=document.createElement("div");n.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",n.textContent="Deneyiminizi anlat\u0131n",a.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-fwizard-content-form";var l=document.createElement("input");l.type="text",l.className="renuvex-pr-fwizard-input",l.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",l.maxLength=_a,l.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),l.value=e.get().title||"",l.addEventListener("input",function(){e.set({title:l.value})}),o.appendChild(l);var i=document.createElement("textarea");i.className="renuvex-pr-fwizard-textarea",i.placeholder="Deneyiminizi anlat\u0131n\u2026",i.maxLength=Dr,i.rows=6,i.setAttribute("aria-label","Yorum"),i.value=e.get().comment||"",o.appendChild(i);var d=document.createElement("div");d.className="renuvex-pr-fwizard-char-counter",d.setAttribute("aria-live","polite"),o.appendChild(d);function p(){var s=i.value.length;d.textContent=s+"/"+Dr,d.classList.toggle("renuvex-pr-fwizard-char-counter--max",s>=Dr)}function f(){return je(3,e.get())}return i.addEventListener("input",function(){e.set({comment:i.value}),p(),t(f())}),a.appendChild(o),p(),setTimeout(function(){t(f())},0),{el:a,destroy:function(){}}}var Ma=40;function Zt(e,r){r=r||{};var t=r.onValidityChange||function(){},a=r.onSuccess||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var o=document.createElement("div");o.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",o.textContent="Hakk\u0131n\u0131zda",n.appendChild(o);var l=document.createElement("div");l.className="renuvex-pr-fwizard-author-form";var i=document.createElement("div");i.className="renuvex-pr-fwizard-field";var d=document.createElement("label");d.className="renuvex-pr-fwizard-label",d.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var p=document.createElement("input");p.type="text",p.className="renuvex-pr-fwizard-input",p.maxLength=Ma,p.setAttribute("aria-required","true"),p.value=e.get().author||"",i.appendChild(d),i.appendChild(p),l.appendChild(i);var f=document.createElement("div");f.className="renuvex-pr-fwizard-field";var s=document.createElement("label");s.className="renuvex-pr-fwizard-label",s.textContent="E-posta (opsiyonel)";var u=document.createElement("input");u.type="email",u.className="renuvex-pr-fwizard-input",u.setAttribute("autocomplete","email"),u.value=e.get().email||"",f.appendChild(s),f.appendChild(u),l.appendChild(f);var v=document.createElement("div");v.className="renuvex-pr-fwizard-notice",v.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",l.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-fwizard-msg",y.setAttribute("role","alert"),y.setAttribute("aria-live","assertive"),l.appendChild(y);var c=document.createElement("button");c.type="button",c.className="renuvex-pr-fwizard-submit-btn",c.textContent="G\xF6nder",l.appendChild(c),n.appendChild(l);function b(){return je(4,e.get())}function m(){var x=!b(),w=(e.get().pendingImages||[]).length,A=w>0;A?(c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent="Foto\u011Fraflar Y\xFCkleniyor..."):(c.disabled=x,c.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",x),c.textContent="G\xF6nder")}p.addEventListener("input",function(){e.set({author:p.value}),m(),t(b())}),u.addEventListener("input",function(){e.set({email:u.value})}),m(),setTimeout(function(){t(b())},0);function h(){y.textContent=""}function g(x){h();var w=document.createElement("div");w.className="renuvex-pr-fwizard-msg-error",w.textContent=x||"",y.appendChild(w)}c.onclick=async function(){if(!c.disabled){var x=e.get(),w=(x.author||"").trim(),A=(x.comment||"").trim();if(u.value.trim()&&!u.checkValidity()){u.reportValidity();return}if(!w){g("Gerekli alan");return}if(!x.rating){g("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}c.disabled=!0,c.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var E=c.textContent;if(c.textContent="G\xF6nderiliyor\u2026",h(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){a()},600);return}try{var z=ht(window.location.href),C=x.productName||null,L=await Ze(Ke+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:Xe,productId:x.productId||null,slug:z||null,productName:C,author:w,title:(x.title||"").trim()||null,comment:A||null,rating:x.rating,images:x.images||[]})},15e3);if(L.ok)a();else{var T=await L.json().catch(function(){return{}});throw new Error(T.error||"Yorum kaydedilemedi.")}}catch(B){var k=B&&(B.name==="AbortError"||/signal/i.test(B.message||"")),P=k?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":B.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(P,"error"):g(P),c.disabled=!1,c.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),c.textContent=E}}};var S=e.onChange(m);return{el:n,destroy:function(){c.onclick=null,S&&S()}}}function Fa(e,r,t){if(t=t||{},e===1)return Gt(r,{canNavigate:t.canNavigate});if(e===2)return Kt(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return Jt(r,{onValidityChange:t.onValidityChange});if(e===4)return Zt(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var a=document.createElement("div");return a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:a,destroy:function(){}}}function $t(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function Qt(e){e=e||{};var r=Wt({productId:e.productId,productName:e.productName}),t={},a={},n={};function o(z){if(!(!z||typeof z!="string"||!z.startsWith("blob:")||n[z])){n[z]=!0;try{URL.revokeObjectURL(z)}catch(C){}}}function l(){Object.keys(a).forEach(function(C){o(C)}),Object.keys(t).forEach(function(C){o(t[C])});var z=r.get();(z.pendingImages||[]).forEach(function(C){o(C&&C.url)}),(z.images||[]).forEach(function(C){o(C)})}var i=Vt({onClose:function(){window.removeEventListener("popstate",p),zr(d),l(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=wr(),p=function(z){i&&i.close&&i.close()};window.addEventListener("popstate",p);var f=document.createElement("div");f.className="renuvex-pr-fwizard-step-wrap";var s=qt({skippableSteps:[2],nextableSteps:[3],onBack:function(){y==="idle"&&r.goBack()},onSkip:function(){y==="idle"&&r.goNext()},onNext:function(){y==="idle"&&r.goNext()}}),u=document.createElement("div");u.className="renuvex-pr-fwizard-layout",u.appendChild(f),u.appendChild(s.el);var v=null,y="idle",c=null,b=!0,m=null;function h(z,C){f.innerHTML="";var L=Fa(z,r,{canNavigate:function(){return y==="idle"},blobMap:t,urlToFinger:a,revokeBlobUrl:o,onValidityChange:function(P){s.setNextDisabled(!P)},onSuccess:S,showToast:i.showToast});if(v=L,s.update(z,r.get()),C){y="entering",L.el.classList.add("renuvex-pr-fwizard-step--enter");var T=null,k=function(){T&&clearTimeout(T),L.el.removeEventListener("animationend",k),L.el.classList.remove("renuvex-pr-fwizard-step--enter"),y="idle",c!==null&&x()};L.el.addEventListener("animationend",k),T=setTimeout(k,700)}else y="idle";f.appendChild(L.el),i.setStepAttr&&i.setStepAttr(z),z===3&&s.setNextDisabled(!0)}var g=!1;function S(){if(!g){if(g=!0,!v){f.innerHTML="";var z=$t();z.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(z),i.setStepAttr("thanks"),s.setThanksState(i.close);return}var C=v;y="exiting",C.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(m&&clearTimeout(m),C.el.removeEventListener("animationend",L),C.destroy)try{C.destroy()}catch(k){}v===C&&(v=null),f.innerHTML="";var T=$t();T.classList.add("renuvex-pr-fwizard-step--enter"),f.appendChild(T),i.setStepAttr("thanks"),s.setThanksState(i.close),y="idle"};C.el.addEventListener("animationend",L),m=setTimeout(L,300)}}function x(){var z=r.get().currentStep;if(y!=="idle"){c=z;return}if(!v){var C=!b;b=!1,h(z,C);return}var L=v;y="exiting",L.el.classList.add("renuvex-pr-fwizard-step--exit");var T=function(){if(m&&clearTimeout(m),L.el.removeEventListener("animationend",T),L.destroy)try{L.destroy()}catch(P){}if(v===L){f.innerHTML="",v=null;var k=c!==null?c:r.get().currentStep;c=null,h(k,!0),y="idle"}};L.el.addEventListener("animationend",T),m=setTimeout(T,350)}x();var w=r.get().currentStep,A=r.onChange(function(z){z.currentStep!==w?(w=z.currentStep,x()):s.update(z.currentStep,z)}),E=i.close;return i.close=function(){A&&A(),typeof m!="undefined"&&m&&clearTimeout(m),E()},i.open(u),{close:i.close}}function Y(){Qt({productId:H||"",productName:Ne||""})}var ea=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var Oa={id:"classic",name:"Klasik (A\xE7\u0131k)"},Ha=ea;function Ya(e){var r=e.widget,t=e.data,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange;be(n);var v=document.createElement("div");v.className="renuvex-pr-summary";var y=(l[3]||0)+(l[4]||0),c=o>0?Math.round(y/o*100):0,b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-avg",b.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+G("full")+'</span><span class="renuvex-pr-avg-num">'+i+"</span>",v.appendChild(b);var m=document.createElement("div");if(m.className="renuvex-pr-summary-block renuvex-pr-summary-count",m.textContent=o.toLocaleString("tr-TR")+" Yorum",v.appendChild(m),a.showRecommendation!==!1&&c>0){var h=document.createElement("div");h.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",h.innerHTML='<span class="renuvex-pr-recommend-pct">%'+c+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",v.appendChild(h)}return v.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:s})),v.appendChild(re({widget:r,currentOrderBy:p,currentHasImages:f,onWriteClick:Y,onSortChange:u})),v}var Ur={};he(Ur,{css:()=>ja,meta:()=>Da,render:()=>qa});var ra=`
...
`;var Da={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},ja=ra,Ua="__unknown_product__",er=Object.create(null);function Va(e){return e?String(e):Ua}var Ae=null,rr=null;function Wa(){!Ae||!rr||(Ae.removeEventListener?Ae.removeEventListener("change",rr):Ae.removeListener&&Ae.removeListener(rr),Ae=null,rr=null)}function qa(e){var r=e.widget,t=e.productId,a=e.settings,n=e.iconPair,o=e.allCount,l=e.ratingCounts,i=e.avgRatingVal,d=e.currentRatingFilter,p=e.currentOrderBy,f=e.currentHasImages,s=e.onFilterChange,u=e.onSortChange,v=Va(t),y=document.createElement("div");y.className="renuvex-pr-summary renuvex-pr-summary-compact";var c=document.createElement("div");c.className="renuvex-pr-compact-header";var b=document.createElement("div");b.className="renuvex-pr-compact-trigger-wrap";var m=document.createElement("button");m.className="renuvex-pr-compact-trigger",m.type="button",m.setAttribute("aria-expanded","false"),m.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Be(i,n)+'</span><span class="renuvex-pr-compact-trigger-text">'+o.toLocaleString("tr-TR")+' Yorum</span><span class="renuvex-pr-compact-chevron">'+ve(xt)+"</span>",b.appendChild(m),c.appendChild(b);var h=re({widget:r,currentOrderBy:p,currentHasImages:f,onWriteClick:Y,onSortChange:u}),g=h.querySelector(".renuvex-pr-filter-wrap"),S=h.querySelector(".renuvex-pr-write-btn"),x=document.createElement("div");x.className="renuvex-pr-compact-actions-slot",S&&x.appendChild(S),g&&x.appendChild(g),c.appendChild(x),y.appendChild(c);var w=document.createElement("div");w.className="renuvex-pr-compact-panel",w.setAttribute("role","dialog"),w.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),w.setAttribute("aria-hidden","true");var A=document.createElement("div");A.className="renuvex-pr-compact-panel-inner";var E=document.createElement("div");E.className="renuvex-pr-compact-avg",E.innerHTML='<span class="renuvex-pr-icon">'+G("full")+"</span><span>"+i+"</span>",A.appendChild(E),A.appendChild(Ye({ratingCounts:l,allCount:o,iconPair:n,currentRatingFilter:d,onFilterChange:function(R){C()&&w.classList.contains("renuvex-pr-open")&&(er[v]=!0),s(R)}})),w.appendChild(A);var z=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function C(){return!!(z&&z.matches)}function L(R){R?w.classList.add("renuvex-pr-open"):w.classList.remove("renuvex-pr-open"),w.setAttribute("aria-hidden",R?"false":"true"),m.setAttribute("aria-expanded",R?"true":"false")}function T(R){var ue=R?y:b;if(w.parentNode!==ue){var ae=!!w.parentNode;w.classList.contains("renuvex-pr-open")&&L(!1),ae&&(er[v]=!1),ue.appendChild(w)}}if(T(z?z.matches:!1),S){var k=document.createElement("button");k.className="renuvex-pr-write-btn",k.textContent=N&&N.writeButtonText||"Yorum Yap",k.onclick=Y;var P=document.createElement("div");P.className="renuvex-pr-compact-write-row",P.appendChild(k),y.appendChild(P)}function B(){var R=w.classList.contains("renuvex-pr-open");return L(!1),C()&&(er[v]=!1),R}function j(){F&&F.notifyOpening(),L(!0),C()&&(er[v]=!0)}m.onclick=function(){w.classList.contains("renuvex-pr-open")?B():j()};var F=null;function U(R){F&&(F.unregister(),F=null),R||(F=Cr({trigger:b,element:w,close:B}))}if(U(z?z.matches:!1),Wa(),z){var te=function(R){T(R.matches),U(R.matches)};z.addEventListener?z.addEventListener("change",te):z.addListener&&z.addListener(te),Ae=z,rr=te}if(C()&&er[v]&&L(!0),a.showRecommendation!==!1){var D=(l[3]||0)+(l[4]||0),J=o>0?Math.round(D/o*100):0;if(J>0){var W=document.createElement("div");W.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",W.style.marginTop="8px",W.innerHTML='<span class="renuvex-pr-recommend-pct">%'+J+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",A.appendChild(W)}}return y}var Vr={};he(Vr,{css:()=>Xa,meta:()=>Ga,render:()=>Ka});var ta=`
...
`;var Ga={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},Xa=ta;function Ka(e){var r=e.widget,t=e.settings,a=e.iconPair,n=e.allCount,o=e.ratingCounts,l=e.avgRatingVal,i=e.currentRatingFilter,d=e.currentOrderBy,p=e.currentHasImages,f=e.onFilterChange,s=e.onSortChange;be(a);var u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-split";var v=document.createElement("div");v.className="renuvex-pr-split-col renuvex-pr-split-left";var y=document.createElement("div");y.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",y.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+G("full")+'</span><span class="renuvex-pr-avg-num">'+l+"</span>",v.appendChild(y);var c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",c.textContent=n.toLocaleString("tr-TR")+" Yorum",v.appendChild(c),u.appendChild(v);var b=document.createElement("div");b.className="renuvex-pr-split-col renuvex-pr-split-mid",b.appendChild(Ye({ratingCounts:o,allCount:n,iconPair:a,currentRatingFilter:i,onFilterChange:f})),u.appendChild(b);var m=re({widget:r,currentOrderBy:d,currentHasImages:p,onWriteClick:Y,onSortChange:s}),h=m.querySelector(".renuvex-pr-filter-wrap"),g=m.querySelector(".renuvex-pr-write-btn"),S=document.createElement("div");S.className="renuvex-pr-split-col renuvex-pr-split-right",g&&S.appendChild(g),h&&S.appendChild(h),u.appendChild(S);var x=(o[3]||0)+(o[4]||0),w=n>0?Math.round(x/n*100):0,A=document.createElement("div");A.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",A.innerHTML='<span class="renuvex-pr-recommend-pct">%'+w+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var E=t.showRecommendation===!1||w===0;return E&&A.classList.add("renuvex-pr-split-rec-hidden"),v.appendChild(A),u}var Wr={};he(Wr,{css:()=>Za,meta:()=>Ja,render:()=>$a});var aa=`
...
`;var Ja={id:"minimal",name:"Minimal (Yal\u0131n)",supports:{recommendation:!1,barChart:!1}},Za=aa;function $a(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,i=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-minimal";var p=document.createElement("div");p.className="renuvex-pr-minimal-info";var f=document.createElement("div");f.className="renuvex-pr-minimal-row";var s=document.createElement("span");s.className="renuvex-pr-minimal-avg",s.textContent=n,f.appendChild(s);var u=document.createElement("span");u.className="renuvex-pr-minimal-stars",u.innerHTML=Be(n,t),f.appendChild(u);var v=document.createElement("span");v.className="renuvex-pr-minimal-count",v.textContent=a.toLocaleString("tr-TR")+" Yorum",f.appendChild(v),p.appendChild(f),d.appendChild(p);var y=re({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:Y,onSortChange:i}),c=y.querySelector(".renuvex-pr-filter-wrap"),b=y.querySelector(".renuvex-pr-write-btn"),m=document.createElement("div");if(m.className="renuvex-pr-minimal-actions",b&&m.appendChild(b),c&&m.appendChild(c),d.appendChild(m),b){var h=document.createElement("button");h.className="renuvex-pr-write-btn",h.textContent=N&&N.writeButtonText||"Yorum Yap",h.onclick=Y;var g=document.createElement("div");g.className="renuvex-pr-minimal-write-row",g.appendChild(h),d.appendChild(g)}return d}var qr={};he(qr,{css:()=>en,meta:()=>Qa,render:()=>rn});var na=`
...
`;var Qa={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},en=na;function rn(e){var r=e.widget,t=e.iconPair,a=e.allCount,n=e.avgRatingVal,o=e.currentOrderBy,l=e.currentHasImages,i=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-hero";var p=document.createElement("div");p.className="renuvex-pr-hero-info";var f=document.createElement("div");f.className="renuvex-pr-hero-rating-col";var s=document.createElement("span");s.className="renuvex-pr-hero-avg",s.textContent=n,f.appendChild(s);var u=document.createElement("div");u.className="renuvex-pr-hero-meta-row";var v=document.createElement("span");v.className="renuvex-pr-hero-stars",v.innerHTML=Be(n,t),u.appendChild(v);var y=document.createElement("div");y.className="renuvex-pr-hero-count",y.textContent=a.toLocaleString("tr-TR")+" Yorum",u.appendChild(y),f.appendChild(u),p.appendChild(f),d.appendChild(p);var c=re({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:Y,onSortChange:i}),b=c.querySelector(".renuvex-pr-filter-wrap"),m=c.querySelector(".renuvex-pr-write-btn"),h=document.createElement("div");h.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",m&&h.appendChild(m),b&&h.appendChild(b),d.appendChild(h);var g=re({widget:r,currentOrderBy:o,currentHasImages:l,onWriteClick:Y,onSortChange:i}),S=g.querySelector(".renuvex-pr-filter-wrap"),x=g.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");return w.className="renuvex-pr-hero-write-row",x&&w.appendChild(x),S&&w.appendChild(S),d.appendChild(w),d}var ia=`
  .renuvex-pr-summary{
