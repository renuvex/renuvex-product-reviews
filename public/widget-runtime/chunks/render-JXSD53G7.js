...
`}var Jo=Na(Zn),Qn=Na(dr);function ei(e,r){var l;if(typeof window=="undefined"||typeof document=="undefined")return;let t=window.customElements;if(t.get(e))return;let n=t.get("media-theme-gerwig"),a=n==null?void 0:n.template;if(!n||!(a instanceof HTMLTemplateElement))return;let i=a.cloneNode(!0);i.id=e,(l=i.content.querySelector("media-controller"))==null||l.setAttribute("lang","tr");let o=document.createElement("style");o.textContent=r,i.content.append(o);class p extends n{}p.template=i,t.define(e,p)}function ri(e,r){return typeof window=="undefined"?Promise.resolve():($r!=null||($r=import("./review-player-i18n-775ENPF7.js").then(()=>import("./dist-ESXZERR5.js")).then(()=>import("./menu-ZPT7P4I2.js")).then(()=>import("./gerwig-J4LRWRX2.js")).then(()=>import("./dist-F5RX6YFS.js")).then(()=>{})),$r.then(()=>{ei(e,r)}))}function Ba(){return ri(Jn,Qn)}var yt=null;function ti(){return yt||(yt=Ba()),yt}function ai(e){if(!e||typeof e!="object")return"";var r=typeof e.playbackId=="string"?e.playbackId.trim():"",t=Ur(e.url);return r&&t&&r!==t?"":r||t}function ni(e,r){var t=ai(r);if(!t)return!1;var n=qe(r.posterUrl||"",{width:1280,height:720,fit:"preserve"})||r.posterUrl||"";return e.setAttribute("disable-tracking",""),e.setAttribute("disable-cookies",""),e.setAttribute("preload","metadata"),e.setAttribute("stream-type","on-demand"),e.setAttribute("muted",""),e.setAttribute("playsinline",""),e.setAttribute("hotkeys","noarrowleft noarrowright"),e.setAttribute("lang","tr"),e.setAttribute("theme",Ra),e.setAttribute("accent-color",dr.controlForeground),e.setAttribute("primary-color",dr.controlForeground),e.setAttribute("secondary-color",dr.controlBackground),n&&e.setAttribute("poster",n),e.setAttribute("playback-id",t),!0}function Ia(e){e.preventDefault()}function Oa(e,r){var t=!1,n=document.createElement("mux-player");n.className=r||"renuvex-pr-modal-main-video",n.setAttribute("aria-label","Yorum videosu"),n.addEventListener("contextmenu",Ia);var a=ni(n,e);return a?ti().catch(function(){t||n.dispatchEvent(new Event("error"))}):setTimeout(function(){t||n.dispatchEvent(new Event("error"))},0),{element:n,cleanup:function(){t=!0;try{typeof n.pause=="function"&&n.pause()}catch(o){}n.removeAttribute("playback-id"),n.removeAttribute("playback-token"),n.removeAttribute("thumbnail-token"),n.removeAttribute("poster"),n.removeEventListener("contextmenu",Ia)}}}function Je(e){return Ce(e)}function kt(e){if(e&&typeof e.__renuvexMediaCleanup=="function"){try{e.__renuvexMediaCleanup()}catch(r){}e.__renuvexMediaCleanup=null}}function Ua(e,r,t,n,a,i){e&&e.shadowRoot&&kt(e.shadowRoot.querySelector(".renuvex-pr-modal-left")),jr(n),document.removeEventListener("keydown",r),window.removeEventListener("popstate",t),e&&e.shadowRoot&&Pr(e.shadowRoot),e&&e.parentNode&&e.parentNode.removeChild(e),i&&ve(a)}function ii(e){var r=document.createElement("div");r.className="renuvex-pr-modal-right";var t=document.createElement("div");t.className="renuvex-pr-modal-scroll-content";var n=document.createElement("div");n.className="renuvex-pr-modal-top-row";var a=document.createElement("div");a.className="renuvex-pr-modal-stars",a.innerHTML=ke(e.rating,R);var i=document.createElement("span");i.className="renuvex-pr-modal-date",i.textContent=Se(e.createdAt),n.appendChild(a),n.appendChild(i),t.appendChild(n);var o=document.createElement("div");o.className="renuvex-pr-modal-title",o.textContent=e.title||"",o.style.display=e.title?"":"none",t.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-modal-author",p.textContent=e.author||"",t.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-modal-body",l.textContent=(e.comment||"").trim(),l.style.display=e.comment&&e.comment.trim()?"":"none",t.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-modal-reply";var m=document.createElement("div");m.className="renuvex-pr-modal-reply-label",m.textContent=V(R&&R.merchantReplyLabel,"Ma\u011Faza Sahibi");var v=document.createElement("div");return v.className="renuvex-pr-modal-reply-text",v.textContent=e.merchantReply||"",d.appendChild(m),d.appendChild(v),d.style.display=e.merchantReply?"":"none",t.appendChild(d),r.appendChild(t),r}function Fa(e,r,t){var n=t||R,a=e.querySelector(".renuvex-pr-modal-scroll-content"),i=a.querySelector(".renuvex-pr-modal-stars");i.innerHTML=ke(r.rating,n),a.querySelector(".renuvex-pr-modal-date").textContent=Se(r.createdAt);var o=a.querySelector(".renuvex-pr-modal-title");o.textContent=r.title||"",o.style.display=r.title?"":"none",a.querySelector(".renuvex-pr-modal-author").textContent=r.author||"";var p=a.querySelector(".renuvex-pr-modal-body");p.textContent=(r.comment||"").trim(),p.style.display=r.comment&&r.comment.trim()?"":"none";var l=a.querySelector(".renuvex-pr-modal-reply");l.querySelector(".renuvex-pr-modal-reply-label").textContent=V(n&&n.merchantReplyLabel,"Ma\u011Faza Sahibi"),l.querySelector(".renuvex-pr-modal-reply-text").textContent=r.merchantReply||"",l.style.display=r.merchantReply?"":"none",e.scrollTop=0}var oi=112;function St(e){return e&&e.touches&&e.touches.length?e.touches[0]:e&&e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null}function li(e,r,t){if(!r||r.type!=="video"||!t)return!1;var n=St(e);if(!n)return!1;var a=t.querySelector("mux-player.renuvex-pr-modal-main-video");if(!a||typeof a.getBoundingClientRect!="function")return!1;var i=a.getBoundingClientRect();if(!i.width||!i.height||n.clientX<i.left||n.clientX>i.right||n.clientY<i.top||n.clientY>i.bottom)return!1;var o=Math.min(oi,Math.max(72,i.height*.2));return n.clientY>=i.bottom-o}function zt(e,r,t,n,a,i,o,p,l){var d=Je(e),m=Math.max(0,Math.min(t||0,d.length-1)),v=d[m],u=document.createElement("div");u.className="renuvex-pr-modal-left";var s=o==="next"?"renuvex-pr-modal-img-enter-right":o==="prev"?"renuvex-pr-modal-img-enter-left":"";if(v&&v.type==="video"){var x=Oa(v,"renuvex-pr-modal-main-video"+(s?" renuvex-pr-modal-video-enter":"")),f=x.element;f.addEventListener("error",function(){if(!u.querySelector(".renuvex-pr-modal-img-error")){var P=document.createElement("div");P.className="renuvex-pr-modal-img-error",P.setAttribute("role","status"),P.textContent="Bu video \u015Fu anda oynat\u0131lam\u0131yor.",u.insertBefore(P,f)}}),u.__renuvexMediaCleanup=x.cleanup,u.appendChild(f)}else{var c=document.createElement("img");if(c.className="renuvex-pr-modal-main-img"+(s?" "+s:""),c.src=ft(v?v.url:""),c.decoding="async",c.width=mt,c.height=Math.round(mt*4/3),c.alt="Yorum foto\u011Fraf\u0131",!s){c.classList.add("renuvex-pr-modal-img-loading");var h=function(){c.classList.remove("renuvex-pr-modal-img-loading")};c.complete&&c.naturalWidth>0?h():(c.addEventListener("load",h,{once:!0}),c.addEventListener("error",h,{once:!0}))}ma(c,function(P){if(P.style.display="none",!u.querySelector(".renuvex-pr-modal-img-error")){var _=document.createElement("div");_.className="renuvex-pr-modal-img-error",_.setAttribute("role","status"),_.textContent="Bu g\xF6rsel \u015Fu anda y\xFCklenemiyor.",u.insertBefore(_,P)}}),u.appendChild(c)}var b=document.createElement("button");b.className="renuvex-pr-modal-close-mobile";var w=re(we);w&&b.appendChild(w),b.setAttribute("aria-label","Kapat"),b.onclick=function(P){P.stopPropagation(),i()},u.appendChild(b);var E=0,T=!1;if(u.addEventListener("touchstart",function(P){var _=St(P);_&&(E=_.clientX,T=li(P,v,u))},{passive:!0}),u.addEventListener("touchend",function(P){if(T){T=!1;return}var _=St(P);if(_){var O=E-_.clientX;if(!(Math.abs(O)<50)){if(O>0){if(k)Ee(e,r,m+1,n,a,i,!0,"next",p,l);else if(S){var I=n[r+1];Ee(I,r+1,0,n,a,i,!1,"next",p,l)}}else if(g)Ee(e,r,m-1,n,a,i,!0,"prev",p,l);else if(C){var q=n[r-1],D=Je(q);Ee(q,r-1,D.length-1,n,a,i,!1,"prev",p,l)}}}},{passive:!0}),d.length>1){var z=document.createElement("div");z.className="renuvex-pr-modal-thumbs",d.forEach(function(P,_){var O=P.type==="video"?P.posterUrl:P.url,I=document.createElement("img"),q=Ir(O,Br);I.src=q.src,I.srcset=q.srcset,I.loading="lazy",I.decoding="async",I.width=Br,I.height=Br,I.className="renuvex-pr-modal-thumb"+(_===m?" renuvex-pr-modal-thumb-active":""),I.alt="K\xFC\xE7\xFCk resim "+(_+1),Or(I),I.tabIndex=0,I.setAttribute("role","button"),I.setAttribute("aria-label","K\xFC\xE7\xFCk resim "+(_+1)+" se\xE7"),_===m&&I.setAttribute("aria-current","true"),(function(D){function Y(){Ee(e,r,D,n,a,i,!0,null,p,l)}I.onclick=Y,I.onkeydown=function(H){(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),Y())}})(_),z.appendChild(I)}),u.appendChild(z)}var g=m>0,k=m<d.length-1,C=r>0,S=r<n.length-1,A=g||C,L=k||S;if(A){var N=document.createElement("button");N.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-prev";var M=re(We);M&&N.appendChild(M),N.setAttribute("aria-label","\xD6nceki"),N.onclick=function(P){if(P.stopPropagation(),g)Ee(e,r,m-1,n,a,i,!0,"prev",p,l);else if(C){var _=n[r-1],O=Je(_);Ee(_,r-1,O.length-1,n,a,i,!1,"prev",p,l)}},u.appendChild(N)}if(L){var y=document.createElement("button");y.className="renuvex-pr-modal-nav renuvex-pr-modal-nav-next";var B=re(_r);B&&y.appendChild(B),y.setAttribute("aria-label","Sonraki"),y.onclick=function(P){if(P.stopPropagation(),k)Ee(e,r,m+1,n,a,i,!0,"next",p,l);else if(S){var _=n[r+1];Ee(_,r+1,0,n,a,i,!1,"next",p,l)}},u.appendChild(y)}return u}function Ha(e,r){[-1,1].forEach(function(t){var n=r[e+t];if(n){var a=Je(n);a[0]&&a[0].type==="image"&&(new Image().src=ft(a[0].url))}})}function wt(e){if(e){if(typeof e.scrollTo=="function")try{e.scrollTo({top:0,left:0,behavior:"auto"});return}catch(r){}e.scrollTop=0,e.scrollLeft=0}}function pi(e,r){var t=e&&e.querySelector(".renuvex-pr-modal-wrap"),n=r&&r.querySelector(".renuvex-pr-modal-right"),a=r&&r.querySelector(".renuvex-pr-modal-scroll-content");function i(){wt(t),wt(n),wt(a)}i(),t&&ve(t),typeof requestAnimationFrame=="function"?requestAnimationFrame(function(){i(),requestAnimationFrame(i)}):setTimeout(i,0)}function Ee(e,r,t,n,a,i,o,p,l,d){if(d&&(d.currentReview=e),o){var m=zt(e,r,t,n,a,i,p,l,d);a.firstChild&&(kt(a.firstChild),a.replaceChild(m,a.firstChild))}else{var m=zt(e,r,t,n,a,i,p,l,d),v=a.querySelector(".renuvex-pr-modal-right");a.firstChild&&(kt(a.firstChild),a.replaceChild(m,a.firstChild)),v&&Fa(v,e,d&&d.currentSettings),pi(l,a)}Ha(r,n)}function xe(e,r,t){var n=Je(e);if(!n.length)return;var a=(t||[]).filter(function(k){return Je(k).length>0}),i=a.findIndex(function(k){return k===e||k.id===e.id});i===-1&&(a.unshift(e),i=0);var o=n.findIndex(function(k){return k.url===r});o<0&&(o=0);var p=document.createElement("div");p.className="renuvex-pr-modal-overlay";var l=document.createElement("div");l.className="renuvex-pr-modal";var d=!1,m=null,v=Wr(),u=Pe(),s=Dr(),x=Gr(),f={currentReview:e,currentSettings:R},c=null;function h(k){var C=k&&k.detail&&k.detail.settings;if(!(C&&C===c)){c=C||null,f.currentSettings=C||R;var S=l.querySelector(".renuvex-pr-modal-right");!S||!f.currentReview||Fa(S,f.currentReview,f.currentSettings)}}function b(){d||(d=!0,window.removeEventListener(Ue,h),Ua(m&&m.host,w,b,s,v,u))}function w(k){if(k.key==="Escape"){E();return}qr(k,p,m&&m.root)}function E(){d||(d=!0,window.removeEventListener(Ue,h),Ua(m&&m.host,w,b,s,v,u),Kr(x))}document.addEventListener("keydown",w),window.addEventListener("popstate",b),window.addEventListener(Ue,h),p.onclick=function(){E()},l.onclick=function(k){k.stopPropagation()},l.appendChild(zt(e,i,o,a,l,E,null,p,f)),l.appendChild(ii(e)),Ha(i,a);var T=document.createElement("div");T.className="renuvex-pr-modal-wrap",T.tabIndex=-1,T.setAttribute("role","dialog"),T.setAttribute("aria-modal","true"),T.setAttribute("aria-label","Yorum medyas\u0131 detay\u0131"),T.appendChild(l);var z=document.createElement("button");z.className="renuvex-pr-modal-close";var g=re(we);g&&z.appendChild(g),z.setAttribute("aria-label","Kapat"),z.onclick=function(k){k.stopPropagation(),E()},T.appendChild(z),p.appendChild(T),m=Vr(),Ke(m.root,Ge+je+Yr),m.root.appendChild(p),Oe(m.root),ve(T)}function ur(e,r,t){!e||typeof r!="function"||(e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t||"Yorum foto\u011Fraf\u0131n\u0131 b\xFCy\xFCt"),e.onclick=r,e.onkeydown=function(n){(n.key==="Enter"||n.key===" "||n.key==="Spacebar")&&(n.preventDefault(),r())})}var Lt={};Ae(Lt,{css:()=>Gi,meta:()=>qi,render:()=>Ki});function Ze(e){var r=e.ratingCounts,t=e.allCount,n=e.iconPair,a=e.currentRatingFilter,i=e.onFilterChange;Me(n);var o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-bars";for(var p=5;p>=1;p--){var l=r[p-1]||0,d=t>0?Math.round(l/t*100):0,m=a===p,v=l>0,u=V(R&&R.countLabel,"Yorum"),s=document.createElement("div");s.className="renuvex-pr-bar-row"+(v?"":" renuvex-pr-bar-empty")+(m?" renuvex-pr-bar-active":"")+(a&&!m?" renuvex-pr-bar-dimmed":""),v?(s.setAttribute("role","button"),s.setAttribute("tabindex","0"),s.setAttribute("aria-pressed",m?"true":"false"),s.setAttribute("aria-label",p+" y\u0131ld\u0131z, "+l.toLocaleString("tr-TR")+" "+u+", "+(m?"filtreyi kald\u0131r":"filtrele"))):s.setAttribute("aria-label",p+" y\u0131ld\u0131z, 0 "+u);for(var x="",f=1;f<=5;f++){var c=f<=p;x+='<span class="renuvex-pr-bar-star renuvex-pr-icon '+(c?"renuvex-pr-bar-star-filled":"renuvex-pr-bar-star-empty")+'">'+ue(c?"full":"outline")+"</span>"}s.innerHTML='<span class="renuvex-pr-bar-label">'+x+'</span><div class="renuvex-pr-bar-track"><div class="renuvex-pr-bar-fill" style="width:'+d+'%;"></div></div><span class="renuvex-pr-bar-count">('+l.toLocaleString("tr-TR")+")</span>",v&&(function(h){function b(){i(h)}s.onclick=b,s.onkeydown=function(w){(w.key==="Enter"||w.key===" "||w.key==="Space"||w.key==="Spacebar")&&(w.preventDefault(),b())}})(p),o.appendChild(s)}return o}var Da="data-renuvex-pr-dismiss-gesture",He=[],Va=!1,Jr=!1,sr=[],Qe=null;function Ya(e,r){if(!r)return!1;if(typeof e.composedPath=="function"){var t=e.composedPath();if(t&&t.length)return t.indexOf(r)!==-1}return r.contains(e.target)}function Ct(){for(var e=He.length-1;e>=0;e--){var r=He[e].element;r&&r.isConnected===!1&&He.splice(e,1)}return He}function di(e){!e||typeof e.setAttribute!="function"||(sr.indexOf(e)===-1&&sr.push(e),e.setAttribute(Da,""))}function ja(){for(var e=0;e<sr.length;e++){var r=sr[e];r&&typeof r.removeAttribute=="function"&&r.removeAttribute(Da)}sr=[],Qe&&typeof clearTimeout=="function"&&clearTimeout(Qe),Qe=null}function ui(e){if(Jr){Jr=!1,ja(),e.preventDefault(),e.stopPropagation();return}for(var r=Ct(),t=!1,n=r.length-1;n>=0;n--){var a=r[n];Ya(e,a.trigger)||Ya(e,a.element)||a.close()&&(t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function si(e){if(e.key==="Escape")for(var r=Ct(),t=r.length-1;t>=0;t--)r[t].close()}function Wa(){Va||typeof document=="undefined"||(document.addEventListener("click",ui,!0),document.addEventListener("keydown",si),Va=!0)}function vi(e){Wa(),Jr=!0,di(e),Qe&&typeof clearTimeout=="function"&&clearTimeout(Qe),typeof setTimeout=="function"&&(Qe=setTimeout(function(){Jr=!1,ja()},700))}function Et(e){vi(e)}function Zr(e){Wa();var r={trigger:e.trigger,element:e.element,close:e.close};return He.push(r),{unregister:function(){var t=He.indexOf(r);t!==-1&&He.splice(t,1)},notifyOpening:function(){for(var t=Ct(),n=0;n<t.length;n++)t[n]!==r&&t[n].close()}}}function pe(e){var r=e.widget,t=e.currentOrderBy,n=e.currentHasImages,a=e.onWriteClick,i=e.onSortChange,o=document.createElement("div");o.className="renuvex-pr-summary-block renuvex-pr-summary-actions";var p=document.createElement("button");p.className="renuvex-pr-write-btn",p.textContent=V(R&&R.writeButtonText,"Yorum Yap"),p.onclick=a,o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-filter-wrap";var d=document.createElement("button");d.type="button",d.className="renuvex-pr-filter-btn",d.setAttribute("aria-label","Filtrele"),d.setAttribute("aria-haspopup","menu"),d.setAttribute("aria-expanded","false");var m=R&&R.filterIcon||"lines";d.innerHTML=se(pa(m));var v=document.createElement("div");v.className="renuvex-pr-filter-menu",v.setAttribute("role","menu");var u=[["newest","En Yeni",!1],["highest","En Y\xFCksek Puan",!1],["lowest","En D\xFC\u015F\xFCk Puan",!1],["photos","Foto\u011Frafl\u0131",!0]],s=!1;function x(){return r&&r.parentNode||r||null}function f(w,E){if(!(E===!0||!w)){if(w.type==="touchstart"){Et(x());return}if(w.type==="pointerdown"){var T=w.pointerType||"";T&&T!=="mouse"&&Et(x());return}}}function c(w){var E=v.classList.contains("renuvex-pr-open");v.classList.remove("renuvex-pr-open"),d.classList.remove("renuvex-pr-filter-btn-active"),d.setAttribute("aria-expanded","false");var T=w&&(w.restoreFocus===!0||w.restoreFocus==="auto"&&Pe());if(E&&T)try{d.focus({preventScroll:!0})}catch(z){try{d.focus()}catch(g){}}return E}function h(){b.notifyOpening(),v.classList.add("renuvex-pr-open"),d.classList.add("renuvex-pr-filter-btn-active"),d.setAttribute("aria-expanded","true");var w=v.querySelector(".renuvex-pr-filter-item-active")||v.querySelector(".renuvex-pr-filter-item");w&&requestAnimationFrame(function(){try{w.focus({preventScroll:!0})}catch(E){try{w.focus()}catch(T){}}})}u.forEach(function(w){var E=w[2],T=E?n:!n&&(t||"newest")===w[0],z=document.createElement("button");z.type="button",z.className="renuvex-pr-filter-item"+(T?" renuvex-pr-filter-item-active":""),z.setAttribute("role","menuitem"),z.textContent=w[1];var g=!1;function k(C,S){C&&(C.preventDefault(),C.stopPropagation()),!g&&(g=!0,s=!0,f(C,S),c({restoreFocus:S}),i(w[0],E),setTimeout(function(){g=!1,s=!1},0))}z.addEventListener("pointerdown",function(C){C.button!==void 0&&C.button!==0||C.pointerType!=="mouse"&&k(C,!1)}),typeof window!="undefined"&&!window.PointerEvent&&z.addEventListener("touchstart",function(C){k(C,!1)},{passive:!1}),z.addEventListener("keydown",function(C){(C.key==="Enter"||C.key===" ")&&k(C,!0)}),z.onclick=function(C){k(C,!1)},v.appendChild(z)}),d.onclick=function(){v.classList.contains("renuvex-pr-open")?c({restoreFocus:"auto"}):h()},l.addEventListener("keydown",function(w){w.key==="Escape"&&v.classList.contains("renuvex-pr-open")&&(w.stopPropagation(),c({restoreFocus:!0}))}),l.addEventListener("focusout",function(w){if(v.classList.contains("renuvex-pr-open")&&!s){var E=w.relatedTarget;E&&l.contains(E)||c()}});var b=Zr({trigger:l,element:v,close:c});return l.appendChild(d),l.appendChild(v),o.appendChild(l),o}var qa=`
...
`;function Ga(e){var r=e&&e.onClose?e.onClose:function(){},t=e&&e.returnFocusElement?e.returnFocusElement:null,n=e&&typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,a=e&&e.allowOutsideClose!==!1,i=document.createElement("div");i.className="renuvex-pr-fwizard-overlay",i.tabIndex=-1,i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","Yorum yapma formu");var o=document.createElement("div");o.className="renuvex-pr-fwizard",i.appendChild(o);var p=document.createElement("div");p.className="renuvex-pr-fwizard-content",o.appendChild(p);var l=document.createElement("button");l.className="renuvex-pr-fwizard-close",l.type="button",l.setAttribute("aria-label","Kapat");var d=re(we);d&&l.appendChild(d),o.appendChild(l);var m=!1,v=null,u=null,s=!1;function x(){ve(i)}function f(g){qr(g,i,v&&v.root)}function c(){if(!m){if(m=!0,document.removeEventListener("keydown",h),i.removeEventListener("click",b),l.removeEventListener("click",c),s)ve(u);else{var g=v&&v.root?v.root.activeElement:null;if(g&&typeof g.blur=="function")try{g.blur()}catch(k){}}i.classList.remove("renuvex-pr-fwizard-open"),setTimeout(function(){v?(Pr(v.root),v.host&&v.host.parentNode&&v.host.parentNode.removeChild(v.host)):i.parentNode&&i.parentNode.removeChild(i),jr();try{r()}catch(k){}},200)}}function h(g){if(g.key==="Escape"){c();return}f(g)}function b(g){g.target===i&&a&&c()}document.addEventListener("keydown",h),i.addEventListener("click",b),l.addEventListener("click",c);function w(g){u=t||Wr(),s=n===null?Pe():n,g&&p.appendChild(g),v=Vr(),Ke(v.root,Ge+je+qa),v.root.appendChild(i),Oe(v.root),Dr(),requestAnimationFrame(function(){i.classList.add("renuvex-pr-fwizard-open"),x()})}var E=null,T=null;function z(g,k){if(k=k||"error",E){try{E.remove()}catch(C){}E=null}T&&(clearTimeout(T),T=null),E=document.createElement("div"),E.className="renuvex-pr-fwizard-toast renuvex-pr-fwizard-toast--"+k,E.textContent=g,o.appendChild(E),T=setTimeout(function(){E&&(E.classList.add("renuvex-pr-fwizard-toast--exit"),setTimeout(function(){if(E){try{E.remove()}catch(C){}E=null}},300))},4e3)}return{open:w,close:c,content:p,setAllowOutsideClose:function(g){a=!!g},setStepAttr:function(g){o.setAttribute("data-step",String(g))},showToast:z}}var Tt=4;function er(e,r){if(!r)return!1;switch(e){case 1:return r.rating>0;case 2:return!0;case 3:return!!(r.comment&&r.comment.trim().length>0);case 4:return!!(r.author&&r.author.trim().length>0);default:return!0}}function Ka(e){e=e||{};var r=[],t={currentStep:1,rating:0,title:"",comment:"",author:"",email:"",images:[],pendingImages:[],videoUpload:null,videoSubmitted:!1,videoEnabled:e.videoEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null,fingerprints:[],productId:e.productId||"",productName:e.productName||""};function n(){r.forEach(function(a){try{a(t)}catch(i){}})}return{get:function(){return t},set:function(a){Object.assign(t,a),n()},goNext:function(){t.currentStep<Tt&&(t.currentStep+=1,n())},goBack:function(){t.currentStep>1&&(t.currentStep-=1,n())},onChange:function(a){return r.push(a),function(){r=r.filter(function(i){return i!==a})}}}}function Xa(e){e=e||{};var r=e.skippableSteps||[],t=e.nextableSteps||[],n=e.onBack||function(){},a=e.onSkip||function(){},i=e.onNext||function(){},o=document.createElement("div");o.className="renuvex-pr-fwizard-footer";var p=document.createElement("button");p.type="button",p.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-back",p.setAttribute("aria-label","Geri"),p.innerHTML=se(We)+"<span>Geri</span>",p.addEventListener("click",function(){n()}),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-footer-progress";for(var d=[],m=0;m<Tt;m++){var v=document.createElement("span");v.className="renuvex-pr-fwizard-progress-seg",l.appendChild(v),d.push(v)}o.appendChild(l);var u=document.createElement("button");u.type="button";var s=null;function x(c){s&&u.removeEventListener("click",s),s=c,c&&u.addEventListener("click",c)}o.appendChild(u);function f(c,h){var b=r.indexOf(c)!==-1,w=t.indexOf(c)!==-1,E=h&&(h.images&&h.images.length>0||h.pendingImages&&h.pendingImages.length>0||!!h.videoUpload);if(b)c===2&&E?(u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",x(function(){i()})):(u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.setAttribute("aria-label","Atla"),u.innerHTML="<span>Atla</span>",x(function(){a()})),u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),u.style.visibility="",u.tabIndex=0;else if(w){u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Sonraki"),u.innerHTML="Sonraki",u.style.visibility="",u.tabIndex=0;var T=er(c,h);u.disabled=!T,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!T),x(function(){u.disabled||i()})}else u.className="renuvex-pr-fwizard-nav-btn renuvex-pr-fwizard-footer-skip",u.innerHTML="",u.style.visibility="hidden",u.tabIndex=-1,u.disabled=!0,x(null)}return{el:o,update:function(c,h){d.forEach(function(w,E){E+1<=c?w.classList.add("renuvex-pr-fwizard-progress-seg-active"):w.classList.remove("renuvex-pr-fwizard-progress-seg-active")});var b=c<=1;p.style.visibility=b?"hidden":"",p.style.pointerEvents=b?"none":"",p.tabIndex=b?-1:0,f(c,h)},setNextDisabled:function(c){u.classList.contains("renuvex-pr-fwizard-cta-btn")&&(u.disabled=!!c,u.classList.toggle("renuvex-pr-fwizard-cta-btn--disabled",!!c))},setThanksState:function(c){p.style.visibility="hidden",l.style.visibility="hidden",u.className="renuvex-pr-fwizard-cta-btn renuvex-pr-fwizard-footer-next",u.setAttribute("aria-label","Devam Et"),u.innerHTML="Devam Et",u.style.visibility="",u.disabled=!1,u.classList.remove("renuvex-pr-fwizard-cta-btn--disabled"),x(c)}}}var ci={formStepRatingTitle:"Bu \xFCr\xFCn\xFC nas\u0131l de\u011Ferlendirirsiniz?",formStepPhotosTitle:"Foto\u011Frafl\u0131 de\u011Ferlendirme",formStepPhotosSubtitle:"Foto\u011Fraf ekleyebilirsiniz.",formStepMediaTitle:"Foto\u011Fraf veya video ekleyin",formStepMediaSubtitle:"En fazla 3 foto\u011Fraf veya 60 saniyelik 1 video ekleyebilirsiniz.",formStepContentTitle:"Deneyiminizi anlat\u0131n",formStepAuthorTitle:"Hakk\u0131n\u0131zda"};function ce(e){var r=R&&R[e];return!r&&e==="formStepMediaTitle"&&(r=R&&R.formStepPhotosTitle),!r&&e==="formStepMediaSubtitle"&&(r=R&&R.formStepPhotosSubtitle),V(r,ci[e])}function $a(e,r){r=r||{};var t=document.createElement("div");t.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-rating";var n=!1,a=null,i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title",i.textContent=ce("formStepRatingTitle"),t.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-stars",o.setAttribute("role","radiogroup"),o.setAttribute("aria-label","Y\u0131ld\u0131z puan\u0131");var p=lr(R||{});Me(p);var l=[];function d(c){l.forEach(function(h,b){var w=b<c;h.classList.toggle("renuvex-pr-fwizard-star-active",w),h.setAttribute("aria-checked",b+1===c?"true":"false"),h.innerHTML=w?ue("full"):ue("outline")})}function m(c){e.set({rating:c}),d(c)}function v(c){var h=l[c-1];if(h)try{h.focus()}catch(b){}}function u(c,h){h&&typeof h.preventDefault=="function"&&h.preventDefault(),h&&typeof h.stopPropagation=="function"&&h.stopPropagation(),!n&&(n=!0,m(c),a&&clearTimeout(a),a=setTimeout(function(){e.goNext()},280))}for(var s=1;s<=5;s++)(function(c){var h=document.createElement("button");h.type="button",h.className="renuvex-pr-fwizard-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",c+" y\u0131ld\u0131z"),h.innerHTML=ue("outline"),h.addEventListener("mouseenter",function(){d(c)}),h.addEventListener("mouseleave",function(){d(e.get().rating)}),h.addEventListener("pointerdown",function(b){b.button&&b.button!==0||u(c,b)}),typeof window!="undefined"&&!window.PointerEvent&&h.addEventListener("touchstart",function(b){u(c,b)},{passive:!1}),h.addEventListener("mousedown",function(b){window.PointerEvent||u(c,b)}),h.addEventListener("keydown",function(b){if(b.key==="Enter"||b.key===" "){u(c,b);return}var w=0;b.key==="ArrowRight"||b.key==="ArrowUp"?w=Math.min(5,c+1):b.key==="ArrowLeft"||b.key==="ArrowDown"?w=Math.max(1,c-1):b.key==="Home"?w=1:b.key==="End"&&(w=5),w&&(b.preventDefault(),m(w),v(w))}),h.addEventListener("click",function(b){u(c,b)}),l.push(h),o.appendChild(h)})(s);d(e.get().rating);var x=null,f=function(c){var h=c&&c.detail&&c.detail.settings;h&&h===x||(x=h||null,p=lr(h||R||{}),d(e.get().rating))};return window.addEventListener(Ue,f),t.appendChild(o),{el:t,destroy:function(){a&&clearTimeout(a),window.removeEventListener(Ue,f)}}}var Qr=3,mi=10*1024*1024;function et(e,r){r=r||{};var t=!1,n=r.hideAddButton===!0,a=r.revealAddButtonAfterMedia===!0,i=!n||a,o=document.createElement("div");if(o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-photos",!r.hideHeading){var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=ce("formStepPhotosTitle"),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=ce("formStepPhotosSubtitle"),o.appendChild(l)}var d=document.createElement("div");d.className="renuvex-pr-fwizard-photo-card",r.embeddedMedia&&d.classList.add("renuvex-pr-fwizard-photo-card--embedded");var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add",m.setAttribute("aria-label","Foto\u011Fraf ekle");var v=document.createElement("input");v.type="file",v.accept="image/*",v.multiple=!0,v.style.display="none",i&&d.appendChild(m),d.appendChild(v);var u=document.createElement("div");u.className="renuvex-pr-fwizard-photo-previews",u.setAttribute("aria-live","polite"),d.appendChild(u),o.appendChild(d);var s=r.revokeBlobUrl||function(T){T&&typeof T=="string"&&T.startsWith("blob:")&&URL.revokeObjectURL(T)},x=r.blobMap||{},f=r.urlToFinger||{};function c(){if(!t){var T=e.get().images||[],z=e.get().pendingImages||[],g=T.map(function(k){return{url:k,isPending:!1}}).concat(z.map(function(k){return{url:k.url,file:k.file,isPending:!0,error:k.error}}));u.innerHTML="",g.forEach(function(k){var C=x[k.url]||k.url,S=h(k,C);u.appendChild(S)}),w()}}function h(T,z){var g=document.createElement("div");g.className="renuvex-pr-fwizard-photo-thumb";var k=document.createElement("img");k.src=z,k.alt="",k.style.cssText="width:100%; height:100%; object-fit:cover; display:block; pointer-events:none; -webkit-user-drag:none; user-select:none;",g.appendChild(k);var C=document.createElement("div");C.className="renuvex-pr-fwizard-photo-loading",C.style.display="none",g.appendChild(C);var S=document.createElement("button");S.type="button",S.className="renuvex-pr-fwizard-photo-remove",S.setAttribute("aria-label","Kald\u0131r");var A=re(we);return A&&S.appendChild(A),g.appendChild(S),b(g,T,z),g}function b(T,z,g){var k=T.querySelector("img");k.src!==g&&(k.src=g);var C=T.querySelector(".renuvex-pr-fwizard-photo-loading");if(z.isPending&&z.error){C.style.display="flex",C.textContent="";var S=document.createElement("span");S.className="renuvex-pr-upload-error",S.textContent="\u2717 "+z.error,C.appendChild(S)}else C.style.display="none",C.textContent="";var A=T.querySelector(".renuvex-pr-fwizard-photo-remove");A.onclick=function(){var L=f[z.url]||(z.file?z.file.name+"_"+z.file.size:null),N=x[z.url],M={};L&&(M.fingerprints=(e.get().fingerprints||[]).filter(function(y){return y!==L})),z.isPending?M.pendingImages=(e.get().pendingImages||[]).filter(function(y){return y.url!==z.url}):M.images=(e.get().images||[]).filter(function(y){return y!==z.url}),e.set(M),s(z.url),s(N),delete f[z.url],N&&delete f[N],x[z.url]&&delete x[z.url]}}function w(){var T=(e.get().images||[]).length,z=(e.get().pendingImages||[]).length,g=T+z,k=g>=Qr;d.classList.toggle("renuvex-pr-fwizard-photo-card--compact",g>0),i&&(m.innerHTML=g>0?se(ua):se(Mr)+"<span>Foto\u011Fraf Ekle</span>"),k?(i&&(m.style.display="none"),m.disabled=!0,v.disabled=!0):(i&&(m.style.display=a&&g===0?"none":"flex"),m.disabled=!1,v.disabled=!1,m.classList.remove("renuvex-pr-fwizard-photo-add--disabled"))}m.addEventListener("click",function(){v.disabled||v.click()}),v.onchange=async function(T){var z=(e.get().images||[]).length+(e.get().pendingImages||[]).length,g=Array.from(T.target.files).slice(0,Qr-z);v.value="";var k=(e.get().pendingImages||[]).length,C=e.get().images||[],S=C.length;if(g.length!==0){for(var A=[],L=[],N=0;N<g.length;N++){var M=g[N],y=M.name+"_"+M.size,B=(e.get().fingerprints||[]).some(function(Y){return Y===y})||A.some(function(Y){return Y.file.name+"_"+Y.file.size===y});if(!B){if(M.size>mi){var P="10MB'dan daha b\xFCy\xFCk foto\u011Fraflar\u0131 y\xFCkleyemezsin.";r.showToast?r.showToast(P,"error"):alert(P);continue}var _=URL.createObjectURL(M);f[_]=y,A.push({url:_,file:M,error:null}),L.push({url:_,file:M});var O=(e.get().fingerprints||[]).slice();O.push(y),e.set({fingerprints:O})}}if(A.length!==0){var I=(e.get().pendingImages||[]).concat(A),q=async function(){for(var Y=0;Y<L.length;Y++){var H=L[Y],X=H.file,G=H.url;if(typeof window!="undefined"&&window.__ikasPreviewMode){var $=(e.get().pendingImages||[]).filter(function(Q){return Q.url!==G}),U=(e.get().images||[]).slice();U.push(G),e.set({pendingImages:$,images:U});continue}try{var F=await ze(ye+"/api/public/upload/sign",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de})});if(!F.ok)throw F.status===429?new Error("rate_limit"):new Error("sign failed");var K=await F.json();if(!K.folder)throw new Error("sign folder missing");var ee=new FormData;ee.append("file",X),ee.append("api_key",K.api_key),ee.append("timestamp",K.timestamp),ee.append("signature",K.signature),ee.append("folder",K.folder);var W=await fetch("https://api.cloudinary.com/v1_1/"+K.cloud_name+"/image/upload",{method:"POST",body:ee}),Z=await W.json();if(Z.secure_url&&Rr(Z.secure_url)){var gr=(e.get().pendingImages||[]).some(function(Q){return Q.url===G});if(!gr)continue;x[Z.secure_url]=G,f[Z.secure_url]=f[G];var Ne=(e.get().pendingImages||[]).filter(function(Q){return Q.url!==G}),j=(e.get().images||[]).slice();j.push(Z.secure_url),e.set({pendingImages:Ne,images:j});try{ze(ye+"/api/public/upload/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de,secureUrl:Z.secure_url,metadata:{assetId:Z.asset_id,publicId:Z.public_id,version:Z.version,resourceType:Z.resource_type,format:Z.format,width:Z.width,height:Z.height,bytes:Z.bytes,signature:Z.signature}})}).catch(function(){})}catch(Q){}}else throw new Error("invalid image url")}catch(Q){console.error("[renuvex-pr] Image upload failed:",Q);var ne=Q.message==="rate_limit"?"\xC7ok fazla deneme. Bekleyin.":"Y\xFCkleme ba\u015Far\u0131s\u0131z.";r.showToast&&r.showToast(ne,"error");var me=(e.get().pendingImages||[]).map(function(he){return he.url===G?{url:he.url,file:he.file,error:ne}:he});e.set({pendingImages:me})}}};if(S===0&&k===0){t=!0;var D=!r.canNavigate||r.canNavigate();D&&e.goNext()}e.set({pendingImages:I}),q()}}};var E=e.onChange(c);return c(),{el:o,openPicker:function(){v.disabled||v.click()},destroy:function(){t=!0,v.onchange=null,E&&E()}}}var fi=150*1024*1024,xi=2,gi=60,rn=8192,tn=5,hi=3e4,bi=["video/mp4","video/quicktime"],yi="renuvex_pr_video_upload_",an="renuvex_pr_video_cancel_",vr=null,Ja=!1,wi={video_quota_exceeded:"Bu ma\u011Faza bu ayki video yorum limitine ula\u015Ft\u0131.",rate_limited:"\xC7ok fazla deneme yap\u0131ld\u0131. L\xFCtfen biraz sonra tekrar deneyin.",video_upload_disabled:"Video y\xFCkleme \u015Fu anda kullan\u0131lam\u0131yor.",video_provider_unavailable:"Video y\xFCkleme ge\xE7ici olarak kullan\u0131lam\u0131yor.",video_processing_delayed:"Video haz\u0131rlanmas\u0131 beklenenden uzun s\xFCr\xFCyor. Biraz sonra tekrar deneyin."},ki={video_quota_exceeded:!0,rate_limited:!0,video_upload_disabled:!0},ge=class extends Error{constructor(r,t,n){super(r||"video_request_failed"),this.name="VideoUploadRequestError",this.code=r||"video_request_failed",this.status=t||0,this.retryAfterSec=n||null}};function nn(e){var r=e&&typeof e.code=="string"?e.code:e&&typeof e.message=="string"?e.message:"video_request_failed";return{code:r,message:wi[r]||"Video y\xFCklenemedi. Tekrar deneyin.",retryable:ki[r]!==!0,retryAfterSec:e&&Number.isFinite(e.retryAfterSec)?e.retryAfterSec:null}}function on(e){return!e||Number(e.status)!==404?!1:e.code==="upload_not_found"||e.code==="invalid_or_expired_upload"}function At(e){return new Promise(function(r){setTimeout(r,e)})}function rr(){return typeof performance!="undefined"&&typeof performance.now=="function"?performance.now():Date.now()}function tr(e){return Math.max(0,Math.round(rr()-e))}function Si(){if(typeof window!="undefined"){var e=Number(window.__renuvexPrVideoUploadStallMs);if(Number.isFinite(e)&&e>=250)return e}return hi}function zi(e,r){return new Promise(function(t,n){var a=setTimeout(i,e);function i(){r&&r.removeEventListener("abort",o),t()}function o(){clearTimeout(a),r&&r.removeEventListener("abort",o),n(new DOMException("Aborted","AbortError"))}r&&r.addEventListener("abort",o,{once:!0})})}function Pt(e){return[e.name,e.size,e.lastModified,e.type].join("_").slice(0,128)}function _t(e,r){return yi+de+"_"+e+"_"+Pt(r)}function ln(e,r){try{var t=window.sessionStorage.getItem(_t(e,r)),n=t?JSON.parse(t):null;return!n||typeof n.token!="string"||!n.expiresAt||new Date(n.expiresAt).getTime()<=Date.now()?null:n}catch(a){return null}}function Ci(e,r,t){try{window.sessionStorage.setItem(_t(e,r),JSON.stringify(t))}catch(n){}}function mr(e,r){try{window.sessionStorage.removeItem(_t(e,r))}catch(t){}}function Ei(e,r){return an+de+"_"+e+"_"+Pt(r)}function Ti(e,r,t,n){if(!(!e||!r||!t)){var a={token:e,productId:r,expiresAt:n||null};try{window.sessionStorage.setItem(Ei(r,t),JSON.stringify(a))}catch(i){}}}function Ai(){var e=[];try{for(var r=0;r<window.sessionStorage.length;r+=1){var t=window.sessionStorage.key(r);if(!(!t||t.indexOf(an+de+"_")!==0)){var n=window.sessionStorage.getItem(t),a=n?JSON.parse(n):null;if(!a||typeof a.token!="string"){window.sessionStorage.removeItem(t),r-=1;continue}e.push({key:t,token:a.token})}}}catch(i){}return e}function Za(e){try{window.sessionStorage.removeItem(e)}catch(r){}}async function ar(e,r,t){var n=await ze(ye+e,r,t||2e4),a=await n.json().catch(function(){return{}});if(!n.ok){var i=Number(n.headers.get("Retry-After"));throw new ge(a.error||"video_request_failed",n.status,Number.isFinite(i)&&i>0?i:null)}return a.data||{}}async function cr(e,r,t){if(!(!e||typeof window=="undefined"||window.__ikasPreviewMode))try{await ar("/api/public/upload/video/metrics",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,chunkSizeKb:r.chunkSizeKb||0,chunkAttempts:r.chunkAttempts||0,retryClicks:r.retryClicks||0,upchunkErrors:r.upchunkErrors||0,firstErrorCode:r.firstErrorCode||null,directUploadMs:r.directUploadMs,completeMs:r.completeMs,processingPollMs:r.processingPollMs,totalClientMs:tr(r.startedAt),finalStatus:t})},4e3)}catch(n){}}async function Pi(e){try{return await ar("/api/public/upload/video",{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e.token})},8e3),Za(e.key),!0}catch(r){return r&&(Number(r.status)===404||Number(r.status)===409)?(Za(e.key),!0):!1}}function rt(){return typeof window=="undefined"||window.__ikasPreviewMode||typeof navigator!="undefined"&&navigator.onLine===!1?Promise.resolve():vr||(vr=(async function(){for(var e=Ai(),r=0;r<e.length;r+=1)await Pi(e[r])})().finally(function(){vr=null}),vr)}function tt(){typeof window=="undefined"||Ja||(Ja=!0,window.addEventListener("online",function(){rt()}),rt())}async function _i(){var e=await import("./upchunk-KBSCWYRQ.js");if(e&&typeof e.createUpload=="function")return e.createUpload;if(e&&e.UpChunk&&typeof e.UpChunk.createUpload=="function")return e.UpChunk.createUpload.bind(e.UpChunk);throw new Error("video_upload_sdk_unavailable")}function Qa(e){var r=e&&e.response,t=r&&Number(r.statusCode);return Number.isFinite(t)&&t>0?"http_"+t:e&&typeof e.message=="string"&&e.message?"upchunk_error":"upload_attempt_failed"}var Mi={http_408:!0,http_502:!0,http_503:!0,http_504:!0};function Li(e){return Mi[e]!==!0}async function Ri(e){var r=await _i();return new Promise(function(t,n){var a=!1,i=null,o=null,p=Si(),l=null;function d(x){a||(a=!0,o&&clearTimeout(o),e.signal&&e.signal.removeEventListener("abort",s),l&&l(),x?n(x):t())}function m(x){a||(o&&clearTimeout(o),!(!x&&typeof navigator!="undefined"&&navigator.onLine===!1)&&(o=setTimeout(function(){if(!a){e.onUploadError&&e.onUploadError("video_upload_stalled"),d(new ge("video_upload_stalled",0,null));try{i&&i.abort()}catch(f){}}},p)))}function v(){return a?!1:(m(),!0)}function u(){if(!a){e.onUploadError&&e.onUploadError("video_upload_offline"),d(new ge("video_upload_offline",0,null));try{i&&i.abort()}catch(x){}}}function s(){try{i&&i.abort()}catch(x){}d(new DOMException("Aborted","AbortError"))}if(e.signal){if(e.signal.aborted)return n(new DOMException("Aborted","AbortError"));e.signal.addEventListener("abort",s,{once:!0})}if(i=r({endpoint:e.uploadUrl,file:e.file,method:"PUT",chunkSize:e.chunkSize||rn,attempts:e.chunkAttempts||tn,dynamicChunkSize:!0}),typeof window!="undefined"&&typeof window.addEventListener=="function"&&typeof window.removeEventListener=="function"&&(window.addEventListener("offline",u),l=function(){window.removeEventListener("offline",u)}),typeof navigator!="undefined"&&navigator.onLine===!1){u();return}m(),i.on("attempt",function(){v()&&e.onStatus("uploading")}),i.on("attemptFailure",function(x){if(v()){var f=x&&x.detail,c=Qa(f);if(e.onAttemptFailure&&e.onAttemptFailure(c),Li(c)){e.onUploadError&&e.onUploadError(c),d(new ge(c,0,null));try{i&&i.abort()}catch(h){}return}e.onStatus("upload_retrying")}}),i.on("chunkSuccess",function(){v()}),i.on("progress",function(x){if(v()){var f=Number(x&&x.detail);if(Number.isFinite(f)){var c=Math.min(95,Math.max(0,Math.round(f*.95)));Number.isFinite(e.minProgress)&&(c=Math.max(e.minProgress,c)),e.onProgress(c)}}}),i.on("offline",u),i.on("error",function(x){if(v()){var f=x&&x.detail,c=Qa(f);e.onUploadError&&e.onUploadError(c),d(new ge(c,0,null))}}),i.on("success",function(){v()&&(e.onProgress(95),d())})})}function Ni(e){return e<30*1e3?2e3:e<120*1e3?5e3:10*1e3}async function en(e,r,t){for(var n=Date.now(),a=n+600*1e3,i=0;Date.now()<a;){if(r.aborted)throw new DOMException("Aborted","AbortError");var o=Date.now()-n;try{var p=await ar("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET",signal:r});if(i=0,t&&t(o>=30*1e3?"processing_slow":p.status||"processing"),p.status==="ready")return p;if(p.status==="failed"||p.status==="aborted")throw new ge(p.errorCode||"video_processing_failed",409,null)}catch(l){if(r.aborted||l instanceof ge&&l.status===409||on(l)||(i+=1,i>=3))throw l}await zi(Ni(o),r)}throw new ge("video_processing_delayed",0,null)}async function Bi(e){for(var r=null,t=1;t<=3;t+=1)try{return await ar("/api/public/upload/video/status?token="+encodeURIComponent(e),{method:"GET"},8e3)}catch(n){if(on(n))return null;r=n,t<3&&await At(400*t)}throw r||new Error("video_status_failed")}async function Ii(e,r,t,n){for(var a=10;a<=90;a+=20){if(r.aborted)throw new DOMException("Aborted","AbortError");t(a),await At(120)}return n("processing"),await At(500),t(100),{token:"preview-video-token-"+Date.now(),status:"ready",durationMs:null,posterUrl:URL.createObjectURL(e),previewOnly:!0}}function pn(e){return!e||bi.indexOf(String(e.type||"").toLowerCase())===-1?{ok:!1,message:"MP4 veya MOV format\u0131nda bir video se\xE7in."}:e.size<=0||e.size>fi?{ok:!1,message:"Video en fazla 150 MB olabilir."}:{ok:!0}}function dn(e){return new Promise(function(r){var t=URL.createObjectURL(e),n=document.createElement("video"),a=!1;function i(o){if(!a){a=!0,n.removeAttribute("src");try{n.load()}catch(p){}URL.revokeObjectURL(t),r(o)}}n.preload="metadata",n.onloadedmetadata=function(){i(Number.isFinite(n.duration)?n.duration:null)},n.onerror=function(){i(null)},n.src=t,setTimeout(function(){i(null)},8e3)})}function un(e){return e===null?{ok:!0}:e<xi||e>gi?{ok:!1,message:"Video 2 ile 60 saniye aras\u0131nda olmal\u0131."}:{ok:!0}}async function sn(e){if(typeof window!="undefined"&&window.__ikasPreviewMode)return Ii(e.file,e.signal,e.onProgress,e.onStatus);var r={startedAt:rr(),chunkSizeKb:0,chunkAttempts:0,retryClicks:e.retryClicks||0,upchunkErrors:0,firstErrorCode:null,directUploadMs:null,completeMs:null,processingPollMs:null};function t(x){r.upchunkErrors+=1,r.firstErrorCode||(r.firstErrorCode=x||"upload_attempt_failed")}function n(){mr(e.productId,e.file),e.onSessionReset&&e.onSessionReset()}async function a(x,f){var c=await Bi(x);if(!c)return{action:"discard"};if(c.status==="ready")return e.onToken&&e.onToken(x),e.onProgress(100),mr(e.productId,e.file),await cr(x,r,"ready"),{action:"return",value:Object.assign({token:x},c)};if(c.status==="uploaded"||c.status==="processing"){e.onToken&&e.onToken(x),e.onStatus("processing");var h=rr(),b=await en(x,e.signal,e.onStatus);return r.processingPollMs=tr(h),mr(e.productId,e.file),e.onProgress(100),await cr(x,r,"ready"),{action:"return",value:Object.assign({token:x},b)}}return c.status==="failed"||c.status==="aborted"?{action:"discard"}:!f||typeof f.uploadUrl!="string"||!f.uploadUrl?{action:"discard"}:{action:"upload"}}tt(),await rt();var i=ln(e.productId,e.file),o=i&&i.token,p=i;if(o){var l=await a(o,p);if(l.action==="return")return l.value;l.action==="discard"&&(n(),o=null,p=null)}for(;;){if(!o){var d=await ar("/api/public/upload/video/initiate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de,productId:e.productId,mimeType:e.file.type,bytes:e.file.size,fileFingerprint:Pt(e.file)})});o=d.token,p=d,Ci(e.productId,e.file,d)}e.onToken&&e.onToken(o),r.chunkSizeKb=p.chunkSize||rn,r.chunkAttempts=p.chunkAttempts||tn,e.onStatus("uploading");var m=rr();try{await Ri({uploadUrl:p.uploadUrl,file:e.file,chunkSize:p.chunkSize,chunkAttempts:p.chunkAttempts,minProgress:e.minProgress||0,signal:e.signal,onProgress:e.onProgress,onStatus:e.onStatus,onAttemptFailure:t,onUploadError:t}),r.directUploadMs=(r.directUploadMs||0)+tr(m),e.onStatus("processing");var v=rr();await ar("/api/public/upload/video/complete",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:o})},3e4),r.completeMs=tr(v);var u=rr(),s=await en(o,e.signal,e.onStatus);return r.processingPollMs=tr(u),mr(e.productId,e.file),e.onProgress(100),await cr(o,r,"ready"),Object.assign({token:o},s)}catch(x){throw r.directUploadMs=(r.directUploadMs||0)+tr(m),e.signal&&e.signal.aborted?(await cr(o,r,"aborted"),x):(await cr(o,r,"failed"),x)}}}async function at(e,r,t){var n=r&&t?ln(r,t):null;e&&r&&t&&Ti(e,r,t,n&&n.expiresAt),r&&t&&mr(r,t),!(!e||typeof window!="undefined"&&window.__ikasPreviewMode)&&(tt(),await rt())}function vn(e){return e?e.status==="ready"?"ready":e.status==="failed"?"failed":"busy":"empty"}function Oi(e){return"Video Y\xFCkleniyor"}function Ui(e){return!0}function cn(e,r){r=r||{};var t=!1,n=null,a=null,i=0,o=document.createElement("div");o.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-media";var p=document.createElement("div");p.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",p.textContent=ce("formStepMediaTitle"),o.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-step-subtitle",l.textContent=ce("formStepMediaSubtitle"),o.appendChild(l);var d=document.createElement("div");d.className="renuvex-pr-fwizard-media-card";var m=document.createElement("button");m.type="button",m.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",m.setAttribute("aria-label","Foto\u011Fraf ekle"),m.innerHTML=se(Mr)+"<span>Foto\u011Fraf Ekle</span>";var v=document.createElement("button");v.type="button",v.className="renuvex-pr-fwizard-photo-add renuvex-pr-fwizard-media-action",v.setAttribute("aria-label","Video ekle"),v.innerHTML=se(Lr)+"<span>Video Ekle</span>",d.appendChild(m),d.appendChild(v);var u=document.createElement("div");u.className="renuvex-pr-fwizard-media-content",d.appendChild(u),o.appendChild(d);var s=document.createElement("input");s.type="file",s.accept="video/mp4,video/quicktime,.mp4,.mov",s.style.display="none",o.appendChild(s);function x(){var y=e.get();return(y.images||[]).length>0||(y.pendingImages||[]).length>0}function f(){var y=e.get();return(y.images||[]).length+(y.pendingImages||[]).length}function c(){return e.get().videoUpload||null}function h(){return i+=1,i}function b(y,B){var P=c();return i===y&&!!P&&P.controller===B}function w(){if(!a){u.innerHTML="";return}a.retry.onclick=null,u.innerHTML="",a=null}function E(){n&&(n.destroy&&n.destroy(),n=null)}function T(y){E(),u.innerHTML="";var B=vn(y),P=document.createElement("div");P.className=B==="ready"?"renuvex-pr-fwizard-photo-thumb renuvex-pr-fwizard-video-thumb":B==="failed"?"renuvex-pr-fwizard-video-card renuvex-pr-fwizard-video-card--failed":"renuvex-pr-fwizard-video-uploading-card";var _=null,O=null,I=null,q=null,D=document.createElement("button");if(D.type="button",D.className="renuvex-pr-fwizard-video-retry",D.textContent="Tekrar dene",D.setAttribute("aria-label","Video y\xFCklenemedi, tekrar dene"),B==="ready"){var Y=y.posterUrl||y.localUrl||"";Y&&Y!==y.localUrl?(_=document.createElement("img"),_.alt="",_.src=Y):(_=document.createElement("video"),_.muted=!0,_.playsInline=!0,_.preload="metadata",_.src=y.localUrl||""),_.className="renuvex-pr-fwizard-video-preview",P.appendChild(_)}else B==="busy"?(q=document.createElement("div"),q.className="renuvex-pr-fwizard-video-uploading-status",q.setAttribute("role","status"),q.setAttribute("aria-live","polite"),P.appendChild(q)):O=P;if(B==="ready"){let $=function(U){U&&(U.preventDefault(),U.stopPropagation()),A()};var G=$,H=document.createElement("button");H.type="button",H.className="renuvex-pr-fwizard-photo-remove renuvex-pr-fwizard-video-remove",H.setAttribute("aria-label","Videoyu kald\u0131r");var X=re(we);X&&H.appendChild(X),H.addEventListener("pointerdown",$),H.addEventListener("click",$),P.appendChild(H)}u.appendChild(P),a={mode:B,card:P,preview:_,previewUrl:B==="ready"&&(y.posterUrl||y.localUrl)||"",details:O,name:I,status:q,retry:D}}function z(){if(!t){var y=c();if(!y){w();return}var B=vn(y),P=B==="ready"&&(y.posterUrl||y.localUrl)||"";if((!a||a.mode!==B||a.previewUrl!==P)&&T(y),a.name&&(a.name.textContent=y.file?y.file.name:"Video"),a.status&&B==="busy"){var _=Oi(y),O=Ui(y)?'<span class="renuvex-pr-fwizard-video-dots" aria-hidden="true"><span></span><span></span><span></span></span><span>'+_+"</span>":"<span>"+_+"</span>";a.status.innerHTML!==O&&(a.status.innerHTML=O)}var I=B==="failed"&&!!(y.error&&y.file&&y.retryable!==!1);a.retry.onclick=I?function(){S(y.file,y.localUrl,y.durationMs)}:null,I&&a.details&&!a.retry.isConnected?a.details.appendChild(a.retry):!I&&a.retry.isConnected&&a.retry.remove()}}function g(){var y=x(),B=f()>=Qr,P=!!c(),_=y||P;m.hidden=_,v.hidden=_,m.disabled=P||B,v.disabled=y||P,d.classList.toggle("renuvex-pr-fwizard-media-card--has-media",_),d.classList.toggle("renuvex-pr-fwizard-media-card--photo-selected",y),d.classList.toggle("renuvex-pr-fwizard-media-card--video-selected",P),m.classList.toggle("renuvex-pr-fwizard-media-action--active",y),v.classList.toggle("renuvex-pr-fwizard-media-action--active",P)}function k(y){var B=c();if(B){var P=Object.keys(y),_=P.some(function(O){return B[O]!==y[O]});_&&e.set({videoUpload:Object.assign({},B,y)})}}function C(y,B,P){b(y,B)&&k(P)}async function S(y,B,P){var _=c(),O=!!(B&&_&&_.file===y),I=O?Math.max(0,Math.min(95,Number(_.progress)||0)):0,q=O?(Number(_.retryClicks)||0)+1:0,D=pn(y);if(!D.ok){r.showToast&&r.showToast(D.message,"error");return}var Y=B||URL.createObjectURL(y),H=Number.isFinite(P)?P:null,X=new AbortController,G=h();e.set({videoUpload:{file:y,localUrl:Y,token:O&&_.token||null,status:"uploading",progress:I,durationMs:H,error:null,errorCode:null,retryable:!0,retryAfterSec:null,retryClicks:q,controller:X}}),!O&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext();try{var $=P!==void 0?Number.isFinite(P)?P/1e3:null:await dn(y),U=un($);if(!U.ok)throw Object.assign(new Error("invalid_video_duration"),{code:"invalid_video_duration",message:U.message});var F=await sn({file:y,productId:e.get().productId,signal:X.signal,minProgress:I,retryClicks:q,onToken:function(W){C(G,X,{token:W})},onProgress:function(W){C(G,X,{progress:W})},onStatus:function(W){C(G,X,{status:W})},onSessionReset:function(){C(G,X,{token:null,progress:0})}});if(!b(G,X))return;if(F.previewOnly&&F.posterUrl&&F.posterUrl!==Y)try{URL.revokeObjectURL(F.posterUrl)}catch(W){}k({token:F.token,status:"ready",progress:100,posterUrl:F.previewOnly?Y:F.posterUrl,durationMs:F.durationMs||($===null?null:Math.round($*1e3)),error:null,errorCode:null,retryable:!0,retryAfterSec:null,controller:null}),O&&!t&&(!r.canNavigate||r.canNavigate())&&e.goNext()}catch(W){if(X.signal.aborted||!b(G,X))return;var K=nn(W);if(W&&W.code==="invalid_video_duration"&&(K={code:"invalid_video_duration",message:W.message||"Video s\xFCresi ge\xE7ersiz.",retryable:!1,retryAfterSec:null}),k({status:"failed",error:K.message,errorCode:K.code,retryable:K.retryable,retryAfterSec:K.retryAfterSec,controller:null}),r.showToast){var ee=K.code==="invalid_video_duration"?K.message:"Video y\xFCklenemedi";r.showToast(ee,"error")}}}function A(){var y=c();y&&(h(),y.controller&&y.controller.abort(),at(y.token,e.get().productId,y.file),r.revokeBlobUrl&&r.revokeBlobUrl(y.localUrl),e.set({videoUpload:null}))}function L(y){if(n){y&&n.openPicker&&n.openPicker();return}a=null,u.innerHTML="",n=et(e,{canNavigate:r.canNavigate,blobMap:r.blobMap,urlToFinger:r.urlToFinger,revokeBlobUrl:r.revokeBlobUrl,showToast:r.showToast,hideHeading:!0,hideAddButton:!0,revealAddButtonAfterMedia:!0,embeddedMedia:!0}),u.appendChild(n.el),y&&n.openPicker&&n.openPicker()}m.onclick=function(){m.disabled||L(!0)},v.onclick=function(){v.disabled||(E(),u.innerHTML="",s.click())},s.onchange=function(){var y=s.files&&s.files[0];s.value="",y&&S(y,null,void 0)};var N=!!c(),M=e.onChange(function(){g();var y=!!c();(y||N)&&z(),N=y});return g(),x()&&L(!1),c()&&z(),{el:o,destroy:function(){t=!0,m.onclick=null,v.onclick=null,s.onchange=null,n&&n.destroy&&n.destroy(),M&&M()}}}var Mt=2e3,Fi=60;function mn(e,r){r=r||{};var t=r.onValidityChange||function(){},n=document.createElement("div");n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-content";var a=document.createElement("div");a.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",a.textContent=ce("formStepContentTitle"),n.appendChild(a);var i=document.createElement("div");i.className="renuvex-pr-fwizard-content-form";var o=document.createElement("input");o.type="text",o.className="renuvex-pr-fwizard-input",o.placeholder="K\u0131sa bir ba\u015Fl\u0131k (opsiyonel)",o.maxLength=Fi,o.setAttribute("aria-label","Yorum ba\u015Fl\u0131\u011F\u0131"),o.value=e.get().title||"",o.addEventListener("input",function(){e.set({title:o.value})}),i.appendChild(o);var p=document.createElement("textarea");p.className="renuvex-pr-fwizard-textarea",p.placeholder="Deneyiminizi anlat\u0131n\u2026",p.maxLength=Mt,p.rows=6,p.setAttribute("aria-label","Yorum"),p.value=e.get().comment||"",i.appendChild(p);var l=document.createElement("div");l.className="renuvex-pr-fwizard-char-counter",l.setAttribute("aria-live","polite"),i.appendChild(l);function d(){var v=p.value.length;l.textContent=v+"/"+Mt,l.classList.toggle("renuvex-pr-fwizard-char-counter--max",v>=Mt)}function m(){return er(3,e.get())}return p.addEventListener("input",function(){e.set({comment:p.value}),d(),t(m())}),n.appendChild(i),d(),setTimeout(function(){t(m())},0),{el:n,destroy:function(){}}}var Hi=40;function fn(e,r){r=r||{};var t=r.onValidityChange||function(){},n=r.onSuccess||function(){},a=document.createElement("div");a.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-author";var i=document.createElement("div");i.className="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-step-title--lg",i.textContent=ce("formStepAuthorTitle"),a.appendChild(i);var o=document.createElement("div");o.className="renuvex-pr-fwizard-author-form";var p=document.createElement("div");p.className="renuvex-pr-fwizard-field";var l=document.createElement("label");l.className="renuvex-pr-fwizard-label",l.innerHTML='Ad\u0131n\u0131z <span class="renuvex-pr-fwizard-required" aria-hidden="true">*</span>';var d=document.createElement("input");d.type="text",d.className="renuvex-pr-fwizard-input",d.maxLength=Hi,d.setAttribute("aria-required","true"),d.value=e.get().author||"",p.appendChild(l),p.appendChild(d),o.appendChild(p);var m=document.createElement("div");m.className="renuvex-pr-fwizard-field";var v=document.createElement("label");v.className="renuvex-pr-fwizard-label",v.textContent="E-posta (opsiyonel)";var u=document.createElement("input");u.type="email",u.className="renuvex-pr-fwizard-input",u.setAttribute("autocomplete","email"),u.value=e.get().email||"",m.appendChild(v),m.appendChild(u),o.appendChild(m);var s=document.createElement("div");s.className="renuvex-pr-fwizard-notice",s.textContent="G\xF6nder'e t\u0131klayarak yorumumun \xFCr\xFCn sayfas\u0131nda herkese a\xE7\u0131k \u015Fekilde yay\u0131nlanaca\u011F\u0131n\u0131 kabul ediyorum.",o.appendChild(s);var x=document.createElement("div");x.className="renuvex-pr-fwizard-msg",x.setAttribute("role","alert"),x.setAttribute("aria-live","assertive"),o.appendChild(x);var f=document.createElement("button");f.type="button",f.className="renuvex-pr-fwizard-submit-btn",f.textContent="G\xF6nder",o.appendChild(f),a.appendChild(o);function c(){return er(4,e.get())}function h(g){f.classList.remove("renuvex-pr-fwizard-submit-btn--video-pending"),f.textContent=g}function b(){f.classList.add("renuvex-pr-fwizard-submit-btn--video-pending"),f.textContent="";var g=document.createElement("span");g.className="renuvex-pr-fwizard-video-dots",g.setAttribute("aria-hidden","true"),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span")),g.appendChild(document.createElement("span"));var k=document.createElement("span");k.textContent="Video Haz\u0131rlan\u0131yor",f.appendChild(g),f.appendChild(k)}function w(){var g=!c(),k=(e.get().pendingImages||[]).length,C=k>0,S=e.get().videoUpload,A=!!(S&&S.status==="failed"),L=!!(S&&S.status!=="ready"&&S.status!=="failed");C||L||A?(f.disabled=!0,f.classList.add("renuvex-pr-fwizard-submit-btn--disabled"),A?h("Video Y\xFCklenemedi"):L?b():h("Foto\u011Fraflar Y\xFCkleniyor...")):(f.disabled=g,f.classList.toggle("renuvex-pr-fwizard-submit-btn--disabled",g),h("G\xF6nder"))}d.addEventListener("input",function(){e.set({author:d.value}),w(),t(c())}),u.addEventListener("input",function(){e.set({email:u.value})}),w(),setTimeout(function(){t(c())},0);function E(){x.textContent=""}function T(g){E();var k=document.createElement("div");k.className="renuvex-pr-fwizard-msg-error",k.textContent=g||"",x.appendChild(k)}f.onclick=async function(){if(!f.disabled){var g=e.get(),k=(g.author||"").trim(),C=(g.comment||"").trim();if(u.value.trim()&&!u.checkValidity()){u.reportValidity();return}if(!k){T("Gerekli alan");return}if(!g.rating){T("L\xFCtfen bir y\u0131ld\u0131z se\xE7in.");return}f.disabled=!0,f.classList.add("renuvex-pr-fwizard-submit-btn--disabled");var S=f.textContent;if(f.textContent="G\xF6nderiliyor\u2026",E(),typeof window!="undefined"&&window.__ikasPreviewMode){setTimeout(function(){g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n()},600);return}try{var A=sa(window.location.href),L=g.productName||null,N=await ze(ye+"/api/public/reviews",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({storeId:de,productId:g.productId||null,slug:A||null,productName:L,author:k,title:(g.title||"").trim()||null,comment:C||null,rating:g.rating,images:g.videoUpload?[]:g.images||[],videoToken:g.videoUpload&&g.videoUpload.status==="ready"?g.videoUpload.token:null})},15e3);if(N.ok)g.videoUpload&&g.videoUpload.status==="ready"&&e.set({videoSubmitted:!0}),n();else{var M=await N.json().catch(function(){return{}});throw new Error(M.error||"Yorum kaydedilemedi.")}}catch(P){var y=P&&(P.name==="AbortError"||/signal/i.test(P.message||"")),B=y?"Ba\u011Flant\u0131 yava\u015F, l\xFCtfen tekrar deneyin.":P.message||"Yorum g\xF6nderilemedi.";r.showToast?r.showToast(B,"error"):T(B),f.disabled=!1,f.classList.remove("renuvex-pr-fwizard-submit-btn--disabled"),f.textContent=S}}};var z=e.onChange(w);return{el:a,destroy:function(){f.onclick=null,z&&z()}}}function Vi(e,r,t){if(t=t||{},e===1)return $a(r,{canNavigate:t.canNavigate});if(e===2&&r.get().videoEnabled)return cn(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===2)return et(r,{canNavigate:t.canNavigate,blobMap:t.blobMap,urlToFinger:t.urlToFinger,revokeBlobUrl:t.revokeBlobUrl,showToast:t.showToast});if(e===3)return mn(r,{onValidityChange:t.onValidityChange});if(e===4)return fn(r,{onValidityChange:t.onValidityChange,onSuccess:t.onSuccess,showToast:t.showToast});var n=document.createElement("div");return n.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-placeholder",{el:n,destroy:function(){}}}function xn(){var e=document.createElement("div");return e.className="renuvex-pr-fwizard-step renuvex-pr-fwizard-step-thanks",e.innerHTML='<div class="renuvex-pr-fwizard-step-title renuvex-pr-fwizard-thanks-title">Te\u015Fekk\xFCrler</div><div class="renuvex-pr-fwizard-step-subtitle renuvex-pr-fwizard-thanks-subtitle">De\u011Ferlendirmeniz al\u0131nd\u0131.</div>',e}function gn(e){e=e||{},tt();var r=Ka({productId:e.productId,productName:e.productName,videoEnabled:typeof e.videoEnabled=="boolean"?e.videoEnabled:R&&R.videoReviewsEnabled===!0,videoUnavailableReason:e.videoUnavailableReason||null}),t={},n={},a={};function i(S){if(!(!S||typeof S!="string"||!S.startsWith("blob:")||a[S])){a[S]=!0;try{URL.revokeObjectURL(S)}catch(A){}}}function o(){Object.keys(n).forEach(function(A){i(A)}),Object.keys(t).forEach(function(A){i(t[A])});var S=r.get();(S.pendingImages||[]).forEach(function(A){i(A&&A.url)}),(S.images||[]).forEach(function(A){i(A)}),S.videoUpload&&i(S.videoUpload.localUrl)}function p(){var S=r.get(),A=S.videoUpload;!A||S.videoSubmitted||(A.controller&&A.controller.abort(),at(A.token,S.productId,A.file))}var l=Ga({returnFocusElement:e.returnFocusElement||null,openedByKeyboard:typeof e.openedByKeyboard=="boolean"?e.openedByKeyboard:null,onClose:function(){window.removeEventListener("popstate",m),Kr(d),p(),o(),e.onClose&&e.onClose()},allowOutsideClose:!1}),d=Gr(),m=function(S){l&&l.close&&l.close()};window.addEventListener("popstate",m);var v=document.createElement("div");v.className="renuvex-pr-fwizard-step-wrap";var u=Xa({skippableSteps:[2],nextableSteps:[3],onBack:function(){f==="idle"&&r.goBack()},onSkip:function(){f==="idle"&&r.goNext()},onNext:function(){f==="idle"&&r.goNext()}}),s=document.createElement("div");s.className="renuvex-pr-fwizard-layout",s.appendChild(v),s.appendChild(u.el);var x=null,f="idle",c=null,h=!0,b=null;function w(S,A){v.innerHTML="";var L=Vi(S,r,{canNavigate:function(){return f==="idle"},blobMap:t,urlToFinger:n,revokeBlobUrl:i,onValidityChange:function(y){u.setNextDisabled(!y)},onSuccess:T,showToast:l.showToast});if(x=L,u.update(S,r.get()),A){f="entering",L.el.classList.add("renuvex-pr-fwizard-step--enter");var N=null,M=function(){N&&clearTimeout(N),L.el.removeEventListener("animationend",M),L.el.classList.remove("renuvex-pr-fwizard-step--enter"),f="idle",c!==null&&z()};L.el.addEventListener("animationend",M),N=setTimeout(M,700)}else f="idle";v.appendChild(L.el),l.setStepAttr&&l.setStepAttr(S),S===3&&u.setNextDisabled(!0)}var E=!1;function T(){if(!E){if(E=!0,!x){v.innerHTML="";var S=xn();S.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(S),l.setStepAttr("thanks"),u.setThanksState(l.close);return}var A=x;f="exiting",A.el.classList.add("renuvex-pr-fwizard-step--exit");var L=function(){if(b&&clearTimeout(b),A.el.removeEventListener("animationend",L),A.destroy)try{A.destroy()}catch(M){}x===A&&(x=null),v.innerHTML="";var N=xn();N.classList.add("renuvex-pr-fwizard-step--enter"),v.appendChild(N),l.setStepAttr("thanks"),u.setThanksState(l.close),f="idle"};A.el.addEventListener("animationend",L),b=setTimeout(L,300)}}function z(){var S=r.get().currentStep;if(f!=="idle"){c=S;return}if(!x){var A=!h;h=!1,w(S,A);return}var L=x;f="exiting",L.el.classList.add("renuvex-pr-fwizard-step--exit");var N=function(){if(b&&clearTimeout(b),L.el.removeEventListener("animationend",N),L.destroy)try{L.destroy()}catch(y){}if(x===L){v.innerHTML="",x=null;var M=c!==null?c:r.get().currentStep;c=null,w(M,!0),f="idle"}};L.el.addEventListener("animationend",N),b=setTimeout(N,350)}z();var g=r.get().currentStep,k=r.onChange(function(S){S.currentStep!==g?(g=S.currentStep,z()):u.update(S.currentStep,S)}),C=l.close;return l.close=function(){k&&k(),typeof b!="undefined"&&b&&clearTimeout(b),C()},l.open(s),{close:l.close}}var Yi=4e3;async function hn(){var e=await ze(ye+"/api/public/upload/video/capability?storeId="+encodeURIComponent(de),{method:"GET",cache:"no-store"},Yi);if(!e.ok){var r=new Error("video_capability_unavailable");throw r.code="video_capability_http",r.status=e.status,r}var t=await e.json().catch(function(){return{}}),n=t&&t.data;if(!n||typeof n.enabled!="boolean"){var a=new Error("video_capability_invalid");throw a.code="video_capability_invalid",a}return{enabled:n.enabled===!0,reason:typeof n.reason=="string"?n.reason:null}}var nt=null;function bn(){return R&&R.videoReviewsEnabled===!0}function Di(e){var r=e&&Number(e.status),t=Number.isFinite(r)&&r>=100;return bn()&&!t?{enabled:!0,reason:"capability_unavailable"}:{enabled:!1,reason:"capability_unavailable"}}function ji(e){if(!e)return function(){};var r=e.disabled,t=e.getAttribute("aria-busy");return e.disabled=!0,e.setAttribute("aria-busy","true"),function(){e.disabled=r,t===null?e.removeAttribute("aria-busy"):e.setAttribute("aria-busy",t)}}async function Wi(e,r){var t;if(typeof window!="undefined"&&window.__ikasPreviewMode)t={enabled:bn(),reason:null};else try{t=await hn()}catch(n){t=Di(n)}gn({productId:J||"",productName:Be||"",videoEnabled:t.enabled,videoUnavailableReason:t.reason,returnFocusElement:e,openedByKeyboard:r})}function ae(e){var r=e&&e.currentTarget&&e.currentTarget.tagName==="BUTTON"?e.currentTarget:null,t=ji(r);return nt||(nt=Wi(r,Pe()).finally(function(){nt=null})),nt.finally(t)}var yn=`
  /* Classic layout title is centered; other layouts override their title class. */
  .renuvex-pr-title-classic{text-align:center;}
`;var qi={id:"classic",name:"Klasik (A\xE7\u0131k)"},Gi=yn;function Ki(e){var r=e.widget,t=e.data,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange;Me(a);var s=document.createElement("div");s.className="renuvex-pr-summary";var x=(o[3]||0)+(o[4]||0),f=i>0?Math.round(x/i*100):0,c=document.createElement("div");c.className="renuvex-pr-summary-block renuvex-pr-summary-avg",c.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+p+"</span>",s.appendChild(c);var h=document.createElement("div");if(h.className="renuvex-pr-summary-block renuvex-pr-summary-count",h.textContent=i.toLocaleString("tr-TR")+" "+V(n.countLabel,"Yorum"),s.appendChild(h),n.showRecommendation!==!1&&f>0){var b=document.createElement("div");b.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",b.innerHTML='<span class="renuvex-pr-recommend-pct">%'+f+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",s.appendChild(b)}return s.appendChild(Ze({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:v})),s.appendChild(pe({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:ae,onSortChange:u})),s}var Rt={};Ae(Rt,{css:()=>$i,meta:()=>Xi,render:()=>eo});var wn=`
...
`;var Xi={id:"compact",name:"Kompakt (A\xE7\u0131l\u0131r)",sizeOverrides:{small:{"--renuvex-pr-compact-star-size":"20px"},medium:{"--renuvex-pr-compact-star-size":"24px"},large:{"--renuvex-pr-compact-star-size":"28px"}}},$i=wn,Ji="__unknown_product__",fr=Object.create(null);function Zi(e){return e?String(e):Ji}var Ve=null,xr=null;function Qi(){!Ve||!xr||(Ve.removeEventListener?Ve.removeEventListener("change",xr):Ve.removeListener&&Ve.removeListener(xr),Ve=null,xr=null)}function eo(e){var r=e.widget,t=e.productId,n=e.settings,a=e.iconPair,i=e.allCount,o=e.ratingCounts,p=e.avgRatingVal,l=e.currentRatingFilter,d=e.currentOrderBy,m=e.currentHasImages,v=e.onFilterChange,u=e.onSortChange,s=Zi(t),x=document.createElement("div");x.className="renuvex-pr-summary renuvex-pr-summary-compact";var f=document.createElement("div");f.className="renuvex-pr-compact-header";var c=document.createElement("div");c.className="renuvex-pr-compact-trigger-wrap";var h=document.createElement("button");h.className="renuvex-pr-compact-trigger",h.type="button",h.setAttribute("aria-expanded","false"),h.innerHTML='<span class="renuvex-pr-compact-trigger-stars">'+Le(p,a)+'</span><span class="renuvex-pr-compact-trigger-text"></span><span class="renuvex-pr-compact-chevron">'+se(da)+"</span>";var b=h.querySelector(".renuvex-pr-compact-trigger-text"),w=h.querySelector(".renuvex-pr-compact-chevron");if(b&&(b.textContent=i.toLocaleString("tr-TR")+" "+V(n.countLabel,"Yorum")),b&&w){var E=document.createElement("span");E.className="renuvex-pr-compact-trigger-count",h.insertBefore(E,b),E.appendChild(b),E.appendChild(w)}c.appendChild(h),f.appendChild(c);var T=pe({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:ae,onSortChange:u}),z=T.querySelector(".renuvex-pr-filter-wrap"),g=T.querySelector(".renuvex-pr-write-btn"),k=document.createElement("div");k.className="renuvex-pr-compact-actions-slot",g&&k.appendChild(g),z&&k.appendChild(z),f.appendChild(k),x.appendChild(f);var C=document.createElement("div");C.className="renuvex-pr-compact-panel",C.setAttribute("role","dialog"),C.setAttribute("aria-label","Puan da\u011F\u0131l\u0131m\u0131"),C.setAttribute("aria-hidden","true");var S=document.createElement("div");S.className="renuvex-pr-compact-panel-inner";var A=document.createElement("div");A.className="renuvex-pr-compact-avg",A.innerHTML='<span class="renuvex-pr-icon">'+ue("full")+"</span><span>"+p+"</span>",S.appendChild(A),S.appendChild(Ze({ratingCounts:o,allCount:i,iconPair:a,currentRatingFilter:l,onFilterChange:function(U){N()&&C.classList.contains("renuvex-pr-open")&&(fr[s]=!0),v(U)}})),C.appendChild(S);var L=typeof window!="undefined"&&window.matchMedia?window.matchMedia("(max-width:600px)"):null;function N(){return!!(L&&L.matches)}function M(U){U?C.classList.add("renuvex-pr-open"):C.classList.remove("renuvex-pr-open"),C.setAttribute("aria-hidden",U?"false":"true"),h.setAttribute("aria-expanded",U?"true":"false")}function y(U){var F=U?x:c;if(C.parentNode!==F){var K=!!C.parentNode;C.classList.contains("renuvex-pr-open")&&M(!1),K&&(fr[s]=!1),F.appendChild(C)}}y(L?L.matches:!1);var B=pe({widget:r,currentOrderBy:d,currentHasImages:m,onWriteClick:ae,onSortChange:u}),P=B.querySelector(".renuvex-pr-filter-wrap"),_=B.querySelector(".renuvex-pr-write-btn"),O=document.createElement("div");O.className="renuvex-pr-compact-write-row",_&&O.appendChild(_),P&&O.appendChild(P),x.appendChild(O);function I(){var U=C.classList.contains("renuvex-pr-open");return M(!1),N()&&(fr[s]=!1),U}function q(){D&&D.notifyOpening(),M(!0),N()&&(fr[s]=!0)}h.onclick=function(){C.classList.contains("renuvex-pr-open")?I():q()};var D=null;function Y(U){D&&(D.unregister(),D=null),U||(D=Zr({trigger:c,element:C,close:I}))}if(Y(L?L.matches:!1),Qi(),L){var H=function(U){y(U.matches),Y(U.matches)};L.addEventListener?L.addEventListener("change",H):L.addListener&&L.addListener(H),Ve=L,xr=H}if(N()&&fr[s]&&M(!0),n.showRecommendation!==!1){var X=(o[3]||0)+(o[4]||0),G=i>0?Math.round(X/i*100):0;if(G>0){var $=document.createElement("div");$.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",$.style.marginTop="8px",$.innerHTML='<span class="renuvex-pr-recommend-pct">%'+G+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor",S.appendChild($)}}return x}var Nt={};Ae(Nt,{css:()=>to,meta:()=>ro,render:()=>ao});var kn=`
...
`;var ro={id:"split",name:"Yatay B\xF6l\xFCnm\xFC\u015F"},to=kn;function ao(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.ratingCounts,o=e.avgRatingVal,p=e.currentRatingFilter,l=e.currentOrderBy,d=e.currentHasImages,m=e.onFilterChange,v=e.onSortChange;Me(n);var u=document.createElement("div");u.className="renuvex-pr-summary renuvex-pr-summary-split";var s=document.createElement("div");s.className="renuvex-pr-split-col renuvex-pr-split-left";var x=document.createElement("div");x.className="renuvex-pr-summary-block renuvex-pr-summary-avg renuvex-pr-split-left-avg-block",x.innerHTML='<span class="renuvex-pr-avg-star renuvex-pr-icon">'+ue("full")+'</span><span class="renuvex-pr-avg-num">'+o+"</span>",s.appendChild(x);var f=document.createElement("div");f.className="renuvex-pr-summary-block renuvex-pr-summary-count renuvex-pr-split-left-count",f.textContent=a.toLocaleString("tr-TR")+" "+V(t.countLabel,"Yorum"),s.appendChild(f),u.appendChild(s);var c=document.createElement("div");c.className="renuvex-pr-split-col renuvex-pr-split-mid",c.appendChild(Ze({ratingCounts:i,allCount:a,iconPair:n,currentRatingFilter:p,onFilterChange:m})),u.appendChild(c);var h=pe({widget:r,currentOrderBy:l,currentHasImages:d,onWriteClick:ae,onSortChange:v}),b=h.querySelector(".renuvex-pr-filter-wrap"),w=h.querySelector(".renuvex-pr-write-btn"),E=document.createElement("div");E.className="renuvex-pr-split-col renuvex-pr-split-right",w&&E.appendChild(w),b&&E.appendChild(b),u.appendChild(E);var T=(i[3]||0)+(i[4]||0),z=a>0?Math.round(T/a*100):0,g=document.createElement("div");g.className="renuvex-pr-summary-block renuvex-pr-summary-recommend",g.innerHTML='<span class="renuvex-pr-recommend-pct">%'+z+"</span> bu \xFCr\xFCn\xFC tavsiye ediyor";var k=t.showRecommendation===!1||z===0;return k&&g.classList.add("renuvex-pr-split-rec-hidden"),s.appendChild(g),u}var Bt={};Ae(Bt,{css:()=>io,meta:()=>no,render:()=>oo});var Sn=`
...
`;var lo={id:"hero",name:"Vurgulu (B\xFCy\xFCk Puan)",supports:{recommendation:!1,barChart:!1}},po=zn;function uo(e){var r=e.widget,t=e.settings,n=e.iconPair,a=e.allCount,i=e.avgRatingVal,o=e.currentOrderBy,p=e.currentHasImages,l=e.onSortChange,d=document.createElement("div");d.className="renuvex-pr-summary renuvex-pr-summary-hero";var m=document.createElement("div");m.className="renuvex-pr-hero-info";var v=document.createElement("div");v.className="renuvex-pr-hero-rating-col";var u=document.createElement("span");u.className="renuvex-pr-hero-avg",u.textContent=i,v.appendChild(u);var s=document.createElement("div");s.className="renuvex-pr-hero-meta-row";var x=document.createElement("span");x.className="renuvex-pr-hero-stars",x.innerHTML=Le(i,n),s.appendChild(x);var f=document.createElement("div");f.className="renuvex-pr-hero-count",f.textContent=a.toLocaleString("tr-TR")+" "+V(t.countLabel,"Yorum"),s.appendChild(f),v.appendChild(s),m.appendChild(v),d.appendChild(m);var c=pe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:ae,onSortChange:l}),h=c.querySelector(".renuvex-pr-filter-wrap"),b=c.querySelector(".renuvex-pr-write-btn"),w=document.createElement("div");w.className="renuvex-pr-hero-actions renuvex-pr-hero-desktop-only",b&&w.appendChild(b),h&&w.appendChild(h),d.appendChild(w);var E=pe({widget:r,currentOrderBy:o,currentHasImages:p,onWriteClick:ae,onSortChange:l}),T=E.querySelector(".renuvex-pr-filter-wrap"),z=E.querySelector(".renuvex-pr-write-btn"),g=document.createElement("div");return g.className="renuvex-pr-hero-write-row",z&&g.appendChild(z),T&&g.appendChild(T),d.appendChild(g),d}var Cn=`
  .renuvex-pr-summary{
...
`;var so={id:"card",name:"Kart (Varsay\u0131lan)",sizeOverrides:{small:{"--renuvex-pr-card-photo-w":"80px"},medium:{"--renuvex-pr-card-photo-w":"110px"},large:{"--renuvex-pr-card-photo-w":"140px"}}},vo=Tn;function co(e,r){var t=document.createElement("article");t.className="renuvex-pr-review renuvex-pr-review-card";var n=document.createElement("div");n.className="renuvex-pr-review-top";var a=document.createElement("div");a.className="renuvex-pr-review-top-left";var i=document.createElement("span");i.className="renuvex-pr-review-stars",i.innerHTML=ke(e.rating,R),a.appendChild(i);var o=document.createElement("time");if(o.className="renuvex-pr-date",e.createdAt&&o.setAttribute("datetime",e.createdAt),o.textContent=Se(e.createdAt),n.appendChild(a),n.appendChild(o),t.appendChild(n),e.title){var p=document.createElement("div");p.className="renuvex-pr-review-title",p.textContent=e.title,t.appendChild(p)}var l=document.createElement("div");l.className="renuvex-pr-author",l.textContent=e.author||"",t.appendChild(l);var d=(e.comment||"").trim();d&&t.appendChild(nr(d,"renuvex-pr-body").fragment);var m=Ce(e);if(m.length){var v=document.createElement("div");v.className="renuvex-pr-gallery",m.forEach(function(s){var x=Re(s,{className:"renuvex-pr-img",sourceWidth:le,width:le,height:le,onOpen:function(){xe(e,s.url,r)}});x&&v.appendChild(x)}),t.appendChild(v)}var u=ir(e.merchantReply);return u&&t.appendChild(u),t}var Ut={};Ae(Ut,{css:()=>fo,meta:()=>mo,render:()=>xo});var An=`
  .renuvex-pr-review-list{
    display:grid;
